...
breadcrumb: Search <% get "Signaturetype" %> signatures at <% get "Fileformat" %> with <% get "ProgLang" %>
...
submenu:
    ...
    left:
        ...
        image: "https://cms.admin.containerize.com/templates/groupdocs/images/product-logos/90x90-noborder/groupdocsature-<% get "ProductCode" %>.png"
