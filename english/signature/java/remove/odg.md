...
############################# Head ############################
head_title: "Remove Digital Signatures from ODG in Java"
head_description: "Java library to clear &amp; remove digital signatures from ODG file using GroupDocs.Signature API - manipulate Image, Barcode, QR-Code, Stamp, Text, Optical &amp; Metadata signatures from digitally signed documents."

############################# Header ############################
title: "Remove Digital Signature from ODG via Java"
description: "Java eSignature library to remove digital signatures from ODG file. Easily manipulate Image, Barcode, QR-Code, Stamp, Text, Optical and Metadata signatures from digitally signed documents."
...
steps:
    enable: true
    title_left: "How to Remove Digital Signatures from ODG"
    content_left: |
        Below Java code example clearly demonstrates the steps to **delete text signatures from ODG file in Java** by adding just a few lines of code.
