...
############################# Head ############################
head_title: "How to Add Digital Signatures to WEBP Files in Java"
head_description: "Learn how to add digital signatures to a WEBP file in Java using GroupDocs.Siganture API - add customized electronic signatures to popular business documents and image file formats."

############################# Header ############################
title: "Add Digital Signatures to WEBP in Java"
description: "Secure your WEBP files by adding popular digital signature types using Java library. Manipulate electronic signatures properties and set up advance signing options within documents as you may need."
...
steps:
    enable: true
    title_left: "How to Add Digital Signatures in a WEBP File"
    content_left: |
        The below code example clearly demonstrates the steps about **how to add digital signatures to a WEBP file using [GroupDocs.Signature](https://products.groupdocs.com/signature/java) library in Java** by adding just a few lines of code.
...
demos:
    enable: true
    title: "Add WEBP Signature Live Demos"
    content: |
