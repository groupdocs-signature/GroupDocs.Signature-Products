...
############################# Head ############################
head_title: "Java Code Example to View &amp; Edit Digital Signatures from DCM Files"
head_description: "Java code example to view and edit digital signatures from a DCM file using GroupDocs.Siganture API - add customized electronic signatures to popular business documents and image file formats."

############################# Header ############################
title: "Edit Digital Signatures in DCM via Java"
description: "Java library to view &amp; edit digital signatures in a DCM file using popular electronic signature types. Manage dcm properties and customize signing options within documents and images."
...
steps:
    enable: true
    title_left: "How to Edit Digital Signatures in DCM"
    content_left: |
        The code example below clearly demonstrates the steps about **how to edit digital signatures in an already signed DCM file in Java** using [GroupDocs.Signature](https://products.groupdocs.com/signature/java) library by adding just a few lines of code.
    ...
    code: |
        ...
        try 
        {
            ...
            if (signatures.size() > 0)
            {
                ...
                boolean result = signature.update("sampleSigned-output.dcm",imageSignature);
                if (result)
                {
...
demos:
    enable: true
    title: "Edit DCM Signature Live Demos"
    content: |
        Add DCM file electronic signatures right now by visiting [GroupDocs.Signature Live Demos](https://products.groupdocs.app/signature/family) website.
