...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](https://products.groupdocs.com/signature/net) makes it easy for .NET developers to add Matrix2of5 barcodes to OTT files within their applications by implementing a few easy steps.
