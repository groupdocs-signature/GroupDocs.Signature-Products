...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](https://products.groupdocs.com/signature/net) makes it easy for .NET developers to add Dutchkix barcodes to CMX files within their applications by implementing a few easy steps.
