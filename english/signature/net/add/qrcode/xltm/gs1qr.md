...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](https://products.groupdocs.com/signature/net) makes it easy for .NET developers to add Gs1qr barcodes to XLTM files within their applications by implementing a few easy steps.
