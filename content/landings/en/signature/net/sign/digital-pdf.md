...
############################# Head ############################
head_title: "Adding DIGITAL signatures in a PDF file with C#"
head_description: "Put DIGITAL Signature on PDF file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Operating DIGITAL Signatures in .PDF files with C#"
...
overview:
    enable: true
    content: |
        Sign your PDF files with DIGITAL signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to sign PDF with DIGITAL in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign PDF documents with DIGITAL signatures quick and easily.
