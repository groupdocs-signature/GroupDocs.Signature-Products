...
############################# Header ############################
title: "Operating DIGITAL Signatures in .DOC files with C#"
...
overview:
    enable: true
    content: |
        Sign your DOC files with DIGITAL signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
        You can put DIGITAL on DOC file in a very convenient way and for free. Besides that it is possible to sign DOC files using advanced DIGITAL options. 
        ...
        * furthermore file can be encrypted with password or saved to memory stream.
        ...
        Signing DOC files with DIGITAL provides vast amount opportunities for users. Moreover there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc.
...
demos:
    ...
    content: |
       Sign DOC file with DIGITAL signature right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website. Free online demo waiting for you.
