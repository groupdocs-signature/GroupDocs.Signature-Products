...
############################# Head ############################
head_title: "Adding TEXT signatures in a TIFF file with C#"
head_description: "Put TEXT Signature on TIFF file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Operating TEXT Signatures in .TIFF files with C#"
...
overview:
    enable: true
    content: |
        Sign your TIFF files with TEXT signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign TIFF documents with TEXT signatures quick and easily.
