...
############################# Head ############################
head_title: "Tạo mã QR cho DOCX bằng Java"
head_description: "API GroupDocs.Signature cho phép tạo mã QR cho các tệp DOCX. Tạo mã QR từ nội dung của bạn và đặt chúng trên bất kỳ trang nào."
...
steps:
    enable: true
    title: "Các bước để tạo và đặt mã QR tại bất kỳ vị trí nào trong DOCX"
    content: |
      [GroupDocs.Signature](/signature/java/) có thể tạo mã QR trong nhiều định dạng phổ biến và đặt chúng trên các trang DOCX. Hơn 10 loại mã QR được hỗ trợ và có thể nhanh chóng tích hợp vào các ứng dụng Java. Sử dụng sản phẩm của chúng tôi để ký tài liệu với mã QR đã tạo.
      
      1. Lấy tệp hoặc luồng DOCX cần ký bằng mã QR.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cách tùy chỉnh mã QR được tạo"
      content: |
        Sử dụng ví dụ này để tìm hiểu cách đặt một mã QR mới trên trang DOCX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
