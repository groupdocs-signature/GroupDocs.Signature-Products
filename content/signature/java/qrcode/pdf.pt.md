...
############################# Head ############################
head_title: "Crie código QR para PDF com Java"
head_description: "A API GroupDocs.Signature permite a geração de códigos QR para arquivos PDF. Crie códigos QR a partir do seu conteúdo e insira-os em qualquer página."
...
steps:
    enable: true
    title: "Passos para gerar e colocar um código QR em qualquer localização em um PDF"
    content: |
      [GroupDocs.Signature](/signature/java/) pode gerar códigos QR em muitos formatos populares e inseri-los nas páginas de PDF. Mais de 10 tipos de códigos QR são suportados e podem ser rapidamente integrados em aplicações Java. Use nosso produto para assinar documentos com códigos QR gerados.
