...
############################# Head ############################
head_title: "Generate 2D Barcodes for PPTX Files with Java Apps"
head_description: "The GroupDocs.Signature API enables the generation of 2D barcodes for PPTX files. Create QR codes from your content and place them on any page."

############################# Header ############################
title: "Generate QR Codes for PPTX Using Java" 
...
steps:
    enable: true
    title: "Steps to Generate and Place a QR-Code on PPTX Pages"
    content: |
