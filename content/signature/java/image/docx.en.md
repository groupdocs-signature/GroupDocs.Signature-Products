...
head_description: "Put image signature on DOCX file for Java using a few lines of code. Use GroupDocs.Signature for Java API to add images."

############################# Header ############################
title: "Sign DOCX files with image signatures" 
...
steps:
    enable: true
    title: "Steps for adding an image to any place of a DOCX via Java"
    content: |
      ...
      1. Create an instance of Signature with the DOCX document.
