...
############################# Head ############################
head_title: "Adicionando assinaturas de imagem ao arquivo PDF com Java"
head_description: "Insira a assinatura de imagem em arquivos PDF para Java usando algumas linhas de código. Utilize a API GroupDocs.Signature for Java para adicionar imagens."

############################# Header ############################
title: "Assine arquivos PDF com assinaturas de imagem" 
...
steps:
    enable: true
    title: "Etapas para adicionar uma imagem a qualquer lugar de um PDF via Java"
    content: |
      [GroupDocs.Signature](/signature/java/) aprimora aplicações Java com a capacidade de adicionar assinaturas a qualquer página de documentos PDF de forma precisa. Melhore a funcionalidade do seu produto integrando nossa biblioteca.
