...
############################# Head ############################
head_title: "Ajout de signatures d'image à un fichier XLSX avec Java"
head_description: "Ajoutez une signature d'image à un fichier XLSX pour Java en quelques lignes de code. Utilisez l'API GroupDocs.Signature for Java pour ajouter des images."
...
steps:
    enable: true
    title: "Étapes pour ajouter une image à n'importe quel emplacement d'un XLSX via Java"
    content: |
      [GroupDocs.Signature](/signature/java/) améliore les applications Java avec la capacité d'ajouter des signatures à n'importe quelle page de documents XLSX avec précision. Augmentez la fonctionnalité de votre produit en intégrant notre bibliothèque.
