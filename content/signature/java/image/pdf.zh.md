...
############################# Head ############################
head_title: "使用 Java 向 PDF 文件添加图像签名"
head_description: "使用几行代码在 Java 的 PDF 文件上添加图像签名。使用 GroupDocs.Signature for Java API 添加图像。"
...
steps:
    enable: true
    title: "通过 Java 在 PDF 的任何位置添加图像的步骤"
    content: |
      [GroupDocs.Signature](/signature/java/) 为 Java 应用程序增强了向 PDF 文档的任何页面添加签名的能力。通过集成我们的库，提高产品的功能。
      
      1. 创建包含 PDF 文档的 Signature 实例。
