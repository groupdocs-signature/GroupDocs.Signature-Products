...
head_description: "Put image signature on PDF file for Java using a few lines of code. Use GroupDocs.Signature for Java API to add images."

############################# Header ############################
title: "Sign PDF files with image signatures" 
...
steps:
    enable: true
    title: "Steps for adding an image to any place of a PDF via Java"
    content: |
