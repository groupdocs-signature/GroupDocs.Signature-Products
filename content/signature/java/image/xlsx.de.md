...
############################# Head ############################
head_title: "Bildunterschriften zu XLSX-Dateien mit Java hinzufügen"
head_description: "Fügen Sie eine Bildunterschrift in eine XLSX-Datei für Java mit nur wenigen Codezeilen ein. Verwenden Sie die GroupDocs.Signature for Java-API, um Bilder hinzuzufügen."
...
steps:
    enable: true
    title: "Schritte zum Hinzufügen eines Bildes an jede Stelle einer XLSX-Datei mit Java"
    content: |
      [GroupDocs.Signature](/signature/java/) erweitert Java-Anwendungen um die Möglichkeit, Unterschriften präzise auf jede Seite von XLSX-Dokumenten hinzuzufügen. Erhöhen Sie die Funktionalität Ihres Produkts, indem Sie unsere Bibliothek integrieren.
      
      1. Erstellen Sie eine Instanz von Signature mit dem XLSX-Dokument.
