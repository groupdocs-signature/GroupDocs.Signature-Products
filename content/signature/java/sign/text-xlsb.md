...
head_description: "Put TEXT Signature on XLSB file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Operating TEXT Signatures in .XLSB files with Java"
...
steps:
    enable: true
    title_left: "Steps to sign XLSB with TEXT in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign XLSB documents with TEXT signatures quick and easily.
