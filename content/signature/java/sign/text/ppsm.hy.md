...
############################# Head ############################
head_title: "Ստեղծեք տեքստային էլեկտրոնային ստորագրություններ Ppsm ֆայլում Java-ով"
head_description: "Տեղադրեք Text eSignature-ը Ppsm ֆայլում Java-ի համար՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տասնյակ ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստորագրեք Ppsm ֆայլեր Text ստորագրություններով Java-ում"
...
steps:
    enable: true
    title_left: "Ppsm-ը Text-ով Java-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Ppsm փաստաթղթերը Text ստորագրություններով:
