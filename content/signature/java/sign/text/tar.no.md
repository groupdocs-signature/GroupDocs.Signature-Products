...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Tar med Java"
head_description: "Sett Text eSignature på Tar-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Tar-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Tar med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Tar-dokumenter med Text-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Tar dokumenter med Text Live Demo"
    content: |
