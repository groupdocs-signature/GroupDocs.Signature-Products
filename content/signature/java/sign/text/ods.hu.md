...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Ods fájlhoz a Java segítségével"
head_description: "Helyezze a Text eSignature-t a Java Ods fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Ods fájl aláírása Text aláírással a Java alkalmazásban"
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Ods dokumentumok gyors és egyszerű aláírását Text aláírással.
...
demos:
    enable: true
    title: "Ods dokumentumok aláírása Text élő bemutatóval"
    content: |
