...
############################# Head ############################
head_title: "Ustvarite besedilne elektronske podpise v datoteko Zip z Java"
head_description: "Vstavite e-podpis Text v datoteko Zip za Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Zip datoteke s podpisi Text v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Zip z Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Zip s podpisi Text.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Zip z Text Live Demo"
    content: |
