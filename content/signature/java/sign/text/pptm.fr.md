...
############################# Head ############################
head_title: "Créez des signatures électroniques de texte dans le fichier Pptm avec Java"
head_description: "Mettez Text eSignature sur le fichier Pptm pour Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "Signez des fichiers Pptm avec des signatures Text en Java"
...
steps:
    enable: true
    title_left: "Étapes pour signer Pptm avec Text dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Pptm avec des signatures Text.
...
demos:
    enable: true
    title: "Signature de documents Pptm avec Text Live Demo"
    content: |
