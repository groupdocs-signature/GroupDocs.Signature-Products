...
############################# Head ############################
head_title: "Δημιουργία ηλεκτρονικών υπογραφών κειμένου σε αρχείο Ots με Java"
head_description: "Τοποθετήστε το Text eSignature στο αρχείο Ots για το Java χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε δεκάδες μορφές αρχείων."

############################# Header ############################
title: "Υπογράψτε αρχεία Ots με υπογραφές Text στο Java"
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Ots με Text στο Java"
    content_left: |
        Το [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) παρέχει τη δυνατότητα υπογραφής εγγράφων Ots με υπογραφές Text γρήγορα και εύκολα.
