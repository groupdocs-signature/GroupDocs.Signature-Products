...
############################# Head ############################
head_title: "Ստեղծեք տեքստային էլեկտրոնային ստորագրություններ Xlsx ֆայլում Java-ով"
head_description: "Տեղադրեք Text eSignature-ը Xlsx ֆայլում Java-ի համար՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տասնյակ ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստորագրեք Xlsx ֆայլեր Text ստորագրություններով Java-ում"
...
steps:
    enable: true
    title_left: "Xlsx-ը Text-ով Java-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Xlsx փաստաթղթերը Text ստորագրություններով:
