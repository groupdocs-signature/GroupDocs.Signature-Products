...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Dotm käyttämällä Java"
head_description: "Aseta Text eSignature Dotm-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Dotm tiedostot Text allekirjoituksilla Java"
...
steps:
    enable: true
    title_left: "Vaiheet Dotm:n allekirjoittamiseen Text -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Dotm-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Dotm asiakirjoja Text Live-demolla"
    content: |
