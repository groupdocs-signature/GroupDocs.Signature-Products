...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Ots käyttämällä Java"
head_description: "Aseta Text eSignature Ots-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Ots tiedostot Text allekirjoituksilla Java"
...
steps:
    enable: true
    title_left: "Vaiheet Ots:n allekirjoittamiseen Text -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Ots-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
