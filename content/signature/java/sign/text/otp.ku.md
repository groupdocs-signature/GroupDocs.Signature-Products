...
############################# Head ############################
head_title: "Ji bo pelê Otp bi Java re îmzeyên elektronîkî yên nivîsê biafirînin"
head_description: "Ji bo Java Text eSignature li ser pela Otp bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Otp bi îmzeyên Text di Java de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Otp bi Text di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Otp bi îmzeyên Text zû û bi hêsanî peyda dike.
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Otp bi Text Demoya Zindî"
    content: |
