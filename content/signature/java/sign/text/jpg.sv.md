...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen Jpg med Java"
head_description: "Sätt Text eSignature på filen Jpg för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Jpg-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Jpg med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Jpg-dokument med Text-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Jpg dokument med Text Live Demo"
    content: |
