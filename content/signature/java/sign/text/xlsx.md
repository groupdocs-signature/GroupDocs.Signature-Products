...
breadcrumb: Create TEXT signature on XLSX for Java

############################# Head ############################
head_title: "Adding TEXT signatures in a XLSX file with Java"
head_description: "Put TEXT Signature on XLSX file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .XLSX files with TEXT signatures in Java"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your XLSX files with TEXT signatures using Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to sign XLSX with TEXT in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign XLSX documents with TEXT signatures quick and easily.
