...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Doc rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Doc, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Doc allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Doc allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Doc dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Doc allkirjastamine Text reaalajas demoga"
    content: |
