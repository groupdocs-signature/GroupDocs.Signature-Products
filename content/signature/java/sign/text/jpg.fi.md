...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Jpg käyttämällä Java"
head_description: "Aseta Text eSignature Jpg-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Jpg tiedostot Text allekirjoituksilla Java"
...
steps:
    enable: true
    title_left: "Vaiheet Jpg:n allekirjoittamiseen Text -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Jpg-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Jpg asiakirjoja Text Live-demolla"
    content: |
