...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen Tar med Java"
head_description: "Sätt Text eSignature på filen Tar för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Tar-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Tar med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Tar-dokument med Text-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Tar dokument med Text Live Demo"
    content: |
