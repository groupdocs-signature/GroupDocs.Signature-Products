...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Ots rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Ots, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Ots allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Ots allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Ots dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Ots allkirjastamine Text reaalajas demoga"
    content: |
