...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Jpg fájlhoz a Java segítségével"
head_description: "Helyezze a Text eSignature-t a Java Jpg fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Jpg fájl aláírása Text aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Jpg aláírásának lépései a Text segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Jpg dokumentumok gyors és egyszerű aláírását Text aláírással.
