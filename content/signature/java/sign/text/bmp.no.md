...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Bmp med Java"
head_description: "Sett Text eSignature på Bmp-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Bmp-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Bmp med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Bmp-dokumenter med Text-signaturer raskt og enkelt.
