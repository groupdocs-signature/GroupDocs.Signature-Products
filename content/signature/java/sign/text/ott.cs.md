...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Ott pomocí Java"
head_description: "Vložte elektronický podpis Text do souboru Ott pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Ott pomocí podpisů Text v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Ott pomocí Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Ott pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Ott pomocí živé ukázky Text"
    content: |
