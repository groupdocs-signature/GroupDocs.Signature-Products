...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen Svg med Java"
head_description: "Sätt Text eSignature på filen Svg för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Svg-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Svg med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Svg-dokument med Text-signaturer snabbt och enkelt.
