...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Ots pomocou Java"
head_description: "Vložte elektronický podpis Text do súboru Ots pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Ots pomocou podpisov Text v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Ots pomocou Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Ots pomocou podpisov Text.
