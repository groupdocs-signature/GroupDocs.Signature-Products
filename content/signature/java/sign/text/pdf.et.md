...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Pdf rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Pdf, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Pdf allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Pdf allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Pdf dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Pdf allkirjastamine Text reaalajas demoga"
    content: |
