...
############################# Head ############################
head_title: "Java を使用して 7z ファイルにテキスト電子署名を作成します"
head_description: "数行のコードを使用して、Java の 7z ファイルに Text 電子署名を配置します。 GroupDocs Document Signature API を使用して、多数のファイル形式に署名します。"

############################# Header ############################
title: "Java の Text 署名で 7z ファイルに署名します"
...
steps:
    enable: true
    title_left: "Java で Text を使用して 7z に署名する手順"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) は、7z ドキュメントに Text 署名ですばやく簡単に署名する機能を提供します。
...
demos:
    enable: true
    title: "Text ライブ デモで 7z ドキュメントに署名"
    content: |
