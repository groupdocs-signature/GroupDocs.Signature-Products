...
############################# Head ############################
head_title: "Crie assinaturas eletrônicas de texto para o arquivo Docx com Java"
head_description: "Coloque Text eSignature no arquivo Docx para Java usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Docx arquivos com assinaturas Text em Java"
...
steps:
    enable: true
    title_left: "Etapas para assinar Docx com Text em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Docx com assinaturas Text de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Docx documentos com Text Demonstração ao vivo"
    content: |
