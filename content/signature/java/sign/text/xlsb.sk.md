...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Xlsb pomocou Java"
head_description: "Vložte elektronický podpis Text do súboru Xlsb pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Xlsb pomocou podpisov Text v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xlsb pomocou Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xlsb pomocou podpisov Text.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Xlsb pomocou živej ukážky Text"
    content: |
