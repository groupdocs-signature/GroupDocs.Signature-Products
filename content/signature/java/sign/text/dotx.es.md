...
############################# Head ############################
head_title: "Agregando Text firmas al archivo Dotx con Java"
head_description: "Coloque la firma Text en el archivo Dotx para Java usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."
...
demos:
    enable: true
    title: "Firma de Dotx documentos con Text Live Demo"
    content: |
