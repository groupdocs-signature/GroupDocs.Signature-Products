...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Jpg pomocí Java"
head_description: "Vložte elektronický podpis Text do souboru Jpg pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Jpg pomocí podpisů Text v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Jpg pomocí Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Jpg pomocí podpisů Text.
