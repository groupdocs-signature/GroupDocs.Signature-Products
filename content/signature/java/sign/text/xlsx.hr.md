...
############################# Head ############################
head_title: "Stvorite tekstualne elektroničke potpise u datoteku Xlsx s Java"
head_description: "Stavite e-potpis Text na datoteku Xlsx za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Xlsx datoteke s Text potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xlsx s Text u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Xlsx dokumenata s Text potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Xlsx dokumenata s Text Live Demo"
    content: |
