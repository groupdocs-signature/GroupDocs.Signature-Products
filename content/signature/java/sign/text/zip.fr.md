...
############################# Head ############################
head_title: "Créez des signatures électroniques de texte dans le fichier Zip avec Java"
head_description: "Mettez Text eSignature sur le fichier Zip pour Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "Signez des fichiers Zip avec des signatures Text en Java"
...
steps:
    enable: true
    title_left: "Étapes pour signer Zip avec Text dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Zip avec des signatures Text.
...
demos:
    enable: true
    title: "Signature de documents Zip avec Text Live Demo"
    content: |
