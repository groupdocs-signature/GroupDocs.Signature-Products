...
############################# Head ############################
head_title: "Crie assinaturas eletrônicas de texto para o arquivo Xlsb com Java"
head_description: "Coloque Text eSignature no arquivo Xlsb para Java usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Xlsb arquivos com assinaturas Text em Java"
...
steps:
    enable: true
    title_left: "Etapas para assinar Xlsb com Text em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Xlsb com assinaturas Text de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Xlsb documentos com Text Demonstração ao vivo"
    content: |
