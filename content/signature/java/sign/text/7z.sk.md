...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru 7z pomocou Java"
head_description: "Vložte elektronický podpis Text do súboru 7z pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory 7z pomocou podpisov Text v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie 7z pomocou Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty 7z pomocou podpisov Text.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov 7z pomocou živej ukážky Text"
    content: |
