...
############################# Head ############################
head_title: "Creeu signatures electròniques de text al fitxer Dot amb Java"
head_description: "Posa Text eSignature al fitxer Dot per a Java utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "Signa fitxers Dot amb signatures Text a Java"
...
steps:
    enable: true
    title_left: "Passos per signar Dot amb Text a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Dot amb signatures Text de manera ràpida i senzilla.
...
demos:
    enable: true
    title: "Signant documents de Dot amb Text Demostració en directe"
    content: |
