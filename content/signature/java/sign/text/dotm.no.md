...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Dotm med Java"
head_description: "Sett Text eSignature på Dotm-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Dotm-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Dotm med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Dotm-dokumenter med Text-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Dotm dokumenter med Text Live Demo"
    content: |
