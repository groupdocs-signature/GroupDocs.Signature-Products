...
############################# Head ############################
head_title: "Crie assinaturas eletrônicas de texto para o arquivo Dotx com Java"
head_description: "Coloque Text eSignature no arquivo Dotx para Java usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Dotx arquivos com assinaturas Text em Java"
...
steps:
    enable: true
    title_left: "Etapas para assinar Dotx com Text em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Dotx com assinaturas Text de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Dotx documentos com Text Demonstração ao vivo"
    content: |
