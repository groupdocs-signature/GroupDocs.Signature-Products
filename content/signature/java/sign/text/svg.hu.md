...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Svg fájlhoz a Java segítségével"
head_description: "Helyezze a Text eSignature-t a Java Svg fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Svg fájl aláírása Text aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Svg aláírásának lépései a Text segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Svg dokumentumok gyors és egyszerű aláírását Text aláírással.
...
demos:
    enable: true
    title: "Svg dokumentumok aláírása Text élő bemutatóval"
    content: |
