...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Bmp rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Bmp, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Bmp allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Bmp allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Bmp dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Bmp allkirjastamine Text reaalajas demoga"
    content: |
