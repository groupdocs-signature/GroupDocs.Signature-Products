...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Svg rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Svg, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Svg allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Svg allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Svg dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Svg allkirjastamine Text reaalajas demoga"
    content: |
