...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Dotm lêer met Java"
head_description: "Plaas Text eSignature op Dotm lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Dotm lêers met Text handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Dotm met Text in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Dotm dokumente met Text handtekeninge vinnig en maklik te onderteken.
