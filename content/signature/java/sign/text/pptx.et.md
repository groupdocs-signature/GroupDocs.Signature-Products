...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Pptx rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Pptx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Pptx allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Pptx allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Pptx dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Pptx allkirjastamine Text reaalajas demoga"
    content: |
