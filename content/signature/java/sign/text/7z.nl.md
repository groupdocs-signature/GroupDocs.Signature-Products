...
############################# Head ############################
head_title: "Maak elektronische teksthandtekeningen naar een 7z-bestand met Java"
head_description: "Zet Text eSignature op 7z bestand voor Java met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken 7z bestanden met Text handtekeningen in Java"
...
steps:
    enable: true
    title_left: "Stappen om 7z te ondertekenen met Text in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om 7z documenten snel en gemakkelijk te ondertekenen met Text handtekeningen.
