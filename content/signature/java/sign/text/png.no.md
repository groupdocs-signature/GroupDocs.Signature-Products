...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Png med Java"
head_description: "Sett Text eSignature på Png-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Png-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Png med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Png-dokumenter med Text-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Png dokumenter med Text Live Demo"
    content: |
