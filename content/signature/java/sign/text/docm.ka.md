...
############################# Head ############################
head_title: "შექმენით ტექსტური ელექტრონული ხელმოწერები Docm ფაილზე Java-ით"
head_description: "განათავსეთ Text eSignature Docm ფაილზე Java კოდის რამდენიმე ხაზის გამოყენებით. გამოიყენეთ GroupDocs Document Signature API ათობით ფაილის ფორმატის ხელმოწერისთვის."

############################# Header ############################
title: "შედით Docm ფაილებში Text ხელმოწერებით Java-ში"
...
steps:
    enable: true
    title_left: "Docm-ით ხელმოწერის ნაბიჯები Text-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Docm დოკუმენტები Text ხელმოწერებით სწრაფად და მარტივად.
