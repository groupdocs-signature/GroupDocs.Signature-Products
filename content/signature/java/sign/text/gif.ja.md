...
############################# Head ############################
head_title: "Java を使用して Gif ファイルにテキスト電子署名を作成します"
head_description: "数行のコードを使用して、Java の Gif ファイルに Text 電子署名を配置します。 GroupDocs Document Signature API を使用して、多数のファイル形式に署名します。"

############################# Header ############################
title: "Java の Text 署名で Gif ファイルに署名します"
...
steps:
    enable: true
    title_left: "Java で Text を使用して Gif に署名する手順"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) は、Gif ドキュメントに Text 署名ですばやく簡単に署名する機能を提供します。
