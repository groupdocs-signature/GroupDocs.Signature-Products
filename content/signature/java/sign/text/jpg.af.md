...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Jpg lêer met Java"
head_description: "Plaas Text eSignature op Jpg lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Jpg lêers met Text handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Jpg met Text in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Jpg dokumente met Text handtekeninge vinnig en maklik te onderteken.
