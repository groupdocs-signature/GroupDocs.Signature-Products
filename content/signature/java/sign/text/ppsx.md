...
head_description: "Put TEXT Signature on PPSX file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .PPSX files with TEXT signatures in Java"
...
steps:
    enable: true
    title_left: "Steps to sign PPSX with TEXT in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign PPSX documents with TEXT signatures quick and easily.
