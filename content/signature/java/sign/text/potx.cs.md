...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Potx pomocí Java"
head_description: "Vložte elektronický podpis Text do souboru Potx pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Potx pomocí podpisů Text v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Potx pomocí Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Potx pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Potx pomocí živé ukázky Text"
    content: |
