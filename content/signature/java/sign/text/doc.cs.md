...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Doc pomocí Java"
head_description: "Vložte elektronický podpis Text do souboru Doc pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Doc pomocí podpisů Text v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Doc pomocí Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Doc pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Doc pomocí živé ukázky Text"
    content: |
