...
############################# Head ############################
head_title: "Creeu signatures electròniques de text al fitxer Gif amb Java"
head_description: "Posa Text eSignature al fitxer Gif per a Java utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "Signa fitxers Gif amb signatures Text a Java"
...
steps:
    enable: true
    title_left: "Passos per signar Gif amb Text a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Gif amb signatures Text de manera ràpida i senzilla.
