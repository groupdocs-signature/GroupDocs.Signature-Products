...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Jpg med Java"
head_description: "Sett Text eSignature på Jpg-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Jpg-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Jpg med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Jpg-dokumenter med Text-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Jpg dokumenter med Text Live Demo"
    content: |
