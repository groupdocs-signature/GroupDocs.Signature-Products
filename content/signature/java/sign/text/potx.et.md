...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Potx rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Potx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Potx allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Potx allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Potx dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Potx allkirjastamine Text reaalajas demoga"
    content: |
