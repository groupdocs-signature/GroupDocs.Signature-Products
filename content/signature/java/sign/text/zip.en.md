...
############################# Head ############################
head_title: "Create Text electronic signatures to Zip file with Java"
head_description: "Put Text eSignature on Zip file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "Sign Zip files with Text signatures in Java"
...
steps:
    enable: true
    title_left: "Steps to sign Zip with Text in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Zip documents with Text signatures quickly and easily.
