...
############################# Head ############################
head_title: "Créez des signatures électroniques de texte dans le fichier Dcm avec Java"
head_description: "Mettez Text eSignature sur le fichier Dcm pour Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "Signez des fichiers Dcm avec des signatures Text en Java"
...
steps:
    enable: true
    title_left: "Étapes pour signer Dcm avec Text dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Dcm avec des signatures Text.
