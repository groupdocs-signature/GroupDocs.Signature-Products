...
############################# Head ############################
head_title: "إنشاء توقيعات إلكترونية نصية إلى ملف Pptx باستخدام Java"
head_description: "ضع Text توقيعًا إلكترونيًا على ملف Pptx لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات Pptx بتوقيعات Text في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Pptx باستخدام Text في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Pptx بتوقيعات Text بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Pptx باستخدام العرض التوضيحي المباشر Text"
    content: |
