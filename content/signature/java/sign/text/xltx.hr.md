...
############################# Head ############################
head_title: "Stvorite tekstualne elektroničke potpise u datoteku Xltx s Java"
head_description: "Stavite e-potpis Text na datoteku Xltx za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Xltx datoteke s Text potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xltx s Text u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Xltx dokumenata s Text potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Xltx dokumenata s Text Live Demo"
    content: |
