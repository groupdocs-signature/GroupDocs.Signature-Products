...
############################# Head ############################
head_title: "Δημιουργία ηλεκτρονικών υπογραφών κειμένου σε αρχείο Gif με Java"
head_description: "Τοποθετήστε το Text eSignature στο αρχείο Gif για το Java χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε δεκάδες μορφές αρχείων."

############################# Header ############################
title: "Υπογράψτε αρχεία Gif με υπογραφές Text στο Java"
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Gif με Text στο Java"
    content_left: |
        Το [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) παρέχει τη δυνατότητα υπογραφής εγγράφων Gif με υπογραφές Text γρήγορα και εύκολα.
...
demos:
    enable: true
    title: "Υπογραφή εγγράφων Gif με Text Ζωντανή επίδειξη"
    content: |
