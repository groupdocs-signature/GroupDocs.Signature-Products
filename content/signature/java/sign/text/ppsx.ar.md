...
############################# Head ############################
head_title: "إنشاء توقيعات إلكترونية نصية إلى ملف Ppsx باستخدام Java"
head_description: "ضع Text توقيعًا إلكترونيًا على ملف Ppsx لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات Ppsx بتوقيعات Text في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Ppsx باستخدام Text في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Ppsx بتوقيعات Text بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Ppsx باستخدام العرض التوضيحي المباشر Text"
    content: |
