...
############################# Head ############################
head_title: "Stvorite tekstualne elektroničke potpise u datoteku Pdf s Java"
head_description: "Stavite e-potpis Text na datoteku Pdf za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Pdf datoteke s Text potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Pdf s Text u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Pdf dokumenata s Text potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Pdf dokumenata s Text Live Demo"
    content: |
