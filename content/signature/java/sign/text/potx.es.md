...
############################# Head ############################
head_title: "Cree firmas electrónicas de texto en un archivo Potx con Java"
head_description: "Coloque Text eSignature en el archivo Potx para Java usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "Firme Potx archivos con Text firmas en Java"
...
steps:
    enable: true
    title_left: "Pasos para firmar Potx con Text en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Potx con Text firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Potx documentos con Text Live Demo"
    content: |
