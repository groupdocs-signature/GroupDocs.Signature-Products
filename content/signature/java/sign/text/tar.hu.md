...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Tar fájlhoz a Java segítségével"
head_description: "Helyezze a Text eSignature-t a Java Tar fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Tar fájl aláírása Text aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Tar aláírásának lépései a Text segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Tar dokumentumok gyors és egyszerű aláírását Text aláírással.
...
demos:
    enable: true
    title: "Tar dokumentumok aláírása Text élő bemutatóval"
    content: |
