...
############################# Head ############################
head_title: "Cree firmas electrónicas de texto en un archivo Xls con Java"
head_description: "Coloque Text eSignature en el archivo Xls para Java usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "Firme Xls archivos con Text firmas en Java"
...
steps:
    enable: true
    title_left: "Pasos para firmar Xls con Text en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Xls con Text firmas de forma rápida y sencilla.
