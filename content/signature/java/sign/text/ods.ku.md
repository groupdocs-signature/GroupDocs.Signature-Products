...
############################# Head ############################
head_title: "Ji bo pelê Ods bi Java re îmzeyên elektronîkî yên nivîsê biafirînin"
head_description: "Ji bo Java Text eSignature li ser pela Ods bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Ods bi îmzeyên Text di Java de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Ods bi Text di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Ods bi îmzeyên Text zû û bi hêsanî peyda dike.
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Ods bi Text Demoya Zindî"
    content: |
