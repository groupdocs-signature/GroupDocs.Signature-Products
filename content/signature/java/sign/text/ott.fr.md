...
############################# Head ############################
head_title: "Créez des signatures électroniques de texte dans le fichier Ott avec Java"
head_description: "Mettez Text eSignature sur le fichier Ott pour Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "Signez des fichiers Ott avec des signatures Text en Java"
...
steps:
    enable: true
    title_left: "Étapes pour signer Ott avec Text dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Ott avec des signatures Text.
