...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru 7z pomocí Java"
head_description: "Vložte elektronický podpis Text do souboru 7z pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory 7z pomocí podpisů Text v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání 7z pomocí Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty 7z pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů 7z pomocí živé ukázky Text"
    content: |
