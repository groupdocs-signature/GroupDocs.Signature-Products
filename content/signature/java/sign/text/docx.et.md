...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Docx rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Docx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Docx allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Docx allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Docx dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Docx allkirjastamine Text reaalajas demoga"
    content: |
