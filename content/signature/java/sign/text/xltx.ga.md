...
############################# Head ############################
head_title: "Cruthaigh sínithe leictreonacha Téacs chun Xltx a chomhdú le Java"
head_description: "Cuir Text eSignature ar Xltx comhad le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Xltx comhad le sínithe Text in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Xltx a shíniú le Text in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Xltx a shíniú le sínithe Text go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Xltx doiciméad le Text Taispeántas Beo"
    content: |
