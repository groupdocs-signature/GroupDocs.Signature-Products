...
############################# Head ############################
head_title: "Izveidojiet teksta elektroniskos parakstus failam Rtf, izmantojot Java"
head_description: "Ievietojiet Text eParaksts Rtf failā Java, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Rtf failus ar Text parakstiem programmā Java"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Rtf ar Text programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Rtf dokumentus ar Text parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Rtf parakstīšana, izmantojot Text tiešraides demonstrāciju"
    content: |
