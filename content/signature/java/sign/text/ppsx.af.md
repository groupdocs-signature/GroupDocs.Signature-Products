...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Ppsx lêer met Java"
head_description: "Plaas Text eSignature op Ppsx lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Ppsx lêers met Text handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Ppsx met Text in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Ppsx dokumente met Text handtekeninge vinnig en maklik te onderteken.
