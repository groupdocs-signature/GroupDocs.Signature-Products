...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Tar rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Tar, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Tar allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Tar allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Tar dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Tar allkirjastamine Text reaalajas demoga"
    content: |
