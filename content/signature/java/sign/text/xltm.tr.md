...
############################# Head ############################
head_title: "Java ile Xltm dosyasına Metin elektronik imzaları oluşturun"
head_description: "Birkaç satır kod kullanarak Java için Xltm dosyasına Text eSignature koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Xltm dosyalarını Text imzasıyla Java içinde imzalayın"
...
steps:
    enable: true
    title_left: "Java içinde Text ile Xltm imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Xltm belgelerini Text imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Xltm dokümanı Text Canlı Demo ile imzalama"
    content: |
