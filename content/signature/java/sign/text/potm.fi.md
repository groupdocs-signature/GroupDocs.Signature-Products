...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Potm käyttämällä Java"
head_description: "Aseta Text eSignature Potm-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Potm tiedostot Text allekirjoituksilla Java"
...
steps:
    enable: true
    title_left: "Vaiheet Potm:n allekirjoittamiseen Text -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Potm-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Potm asiakirjoja Text Live-demolla"
    content: |
