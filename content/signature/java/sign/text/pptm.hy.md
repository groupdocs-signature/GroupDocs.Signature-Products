...
############################# Head ############################
head_title: "Ստեղծեք տեքստային էլեկտրոնային ստորագրություններ Pptm ֆայլում Java-ով"
head_description: "Տեղադրեք Text eSignature-ը Pptm ֆայլում Java-ի համար՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տասնյակ ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստորագրեք Pptm ֆայլեր Text ստորագրություններով Java-ում"
...
steps:
    enable: true
    title_left: "Pptm-ը Text-ով Java-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Pptm փաստաթղթերը Text ստորագրություններով:
...
demos:
    enable: true
    title: "Pptm փաստաթղթերի ստորագրում Text Live Demo-ով"
    content: |
