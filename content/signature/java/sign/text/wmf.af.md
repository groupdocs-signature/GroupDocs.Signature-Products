...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Wmf lêer met Java"
head_description: "Plaas Text eSignature op Wmf lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Wmf lêers met Text handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Wmf met Text in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Wmf dokumente met Text handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Wmf dokumente met Text Regstreekse Demo"
    content: |
