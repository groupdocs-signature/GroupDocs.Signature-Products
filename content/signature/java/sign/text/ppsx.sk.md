...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Ppsx pomocou Java"
head_description: "Vložte elektronický podpis Text do súboru Ppsx pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Ppsx pomocou podpisov Text v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Ppsx pomocou Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Ppsx pomocou podpisov Text.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Ppsx pomocou živej ukážky Text"
    content: |
