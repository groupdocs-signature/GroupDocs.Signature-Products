...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Dotx käyttämällä Java"
head_description: "Aseta Text eSignature Dotx-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Dotx tiedostot Text allekirjoituksilla Java"
...
steps:
    enable: true
    title_left: "Vaiheet Dotx:n allekirjoittamiseen Text -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Dotx-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Dotx asiakirjoja Text Live-demolla"
    content: |
