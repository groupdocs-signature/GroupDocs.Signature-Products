...
breadcrumb: Create TEXT signature on JPEG for Java

############################# Head ############################
head_title: "Adding TEXT signatures in a JPEG file with Java"
head_description: "Put TEXT Signature on JPEG file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .JPEG files with TEXT signatures in Java"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your JPEG files with TEXT signatures using Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to sign JPEG with TEXT in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign JPEG documents with TEXT signatures quick and easily.
