...
############################# Head ############################
head_title: "Создайте текстовые электронные подписи для файла Xlsx с помощью Java"
head_description: "Поместите электронную подпись Text в файл Xlsx для Java, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "Подпишите файлы Xlsx с подписями Text в Java"
...
steps:
    enable: true
    title_left: "Действия по подписанию Xlsx с помощью Text в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Xlsx с подписями Text.
...
demos:
    enable: true
    title: "Подписание Xlsx документов с помощью Text Live Demo"
    content: |
