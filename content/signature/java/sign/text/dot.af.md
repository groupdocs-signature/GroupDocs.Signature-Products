...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Dot lêer met Java"
head_description: "Plaas Text eSignature op Dot lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Dot lêers met Text handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Dot met Text in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Dot dokumente met Text handtekeninge vinnig en maklik te onderteken.
