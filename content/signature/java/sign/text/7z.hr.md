...
############################# Head ############################
head_title: "Stvorite tekstualne elektroničke potpise u datoteku 7z s Java"
head_description: "Stavite e-potpis Text na datoteku 7z za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite 7z datoteke s Text potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje 7z s Text u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja 7z dokumenata s Text potpisima.
...
demos:
    enable: true
    title: "Potpisivanje 7z dokumenata s Text Live Demo"
    content: |
