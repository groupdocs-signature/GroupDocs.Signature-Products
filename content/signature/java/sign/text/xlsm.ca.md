...
############################# Head ############################
head_title: "Creeu signatures electròniques de text al fitxer Xlsm amb Java"
head_description: "Posa Text eSignature al fitxer Xlsm per a Java utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "Signa fitxers Xlsm amb signatures Text a Java"
...
steps:
    enable: true
    title_left: "Passos per signar Xlsm amb Text a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Xlsm amb signatures Text de manera ràpida i senzilla.
