...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Otp pomocí Java"
head_description: "Vložte elektronický podpis Text do souboru Otp pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Otp pomocí podpisů Text v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Otp pomocí Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Otp pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Otp pomocí živé ukázky Text"
    content: |
