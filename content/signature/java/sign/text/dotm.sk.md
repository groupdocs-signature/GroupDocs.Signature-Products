...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Dotm pomocou Java"
head_description: "Vložte elektronický podpis Text do súboru Dotm pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Dotm pomocou podpisov Text v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Dotm pomocou Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Dotm pomocou podpisov Text.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Dotm pomocou živej ukážky Text"
    content: |
