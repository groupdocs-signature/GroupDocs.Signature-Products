...
############################# Head ############################
head_title: "Java ile Odp dosyasına Metin elektronik imzaları oluşturun"
head_description: "Birkaç satır kod kullanarak Java için Odp dosyasına Text eSignature koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Odp dosyalarını Text imzasıyla Java içinde imzalayın"
...
steps:
    enable: true
    title_left: "Java içinde Text ile Odp imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Odp belgelerini Text imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Odp dokümanı Text Canlı Demo ile imzalama"
    content: |
