...
############################# Head ############################
head_title: "Maak elektronische teksthandtekeningen naar een Ppsm-bestand met Java"
head_description: "Zet Text eSignature op Ppsm bestand voor Java met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Ppsm bestanden met Text handtekeningen in Java"
...
steps:
    enable: true
    title_left: "Stappen om Ppsm te ondertekenen met Text in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Ppsm documenten snel en gemakkelijk te ondertekenen met Text handtekeningen.
...
demos:
    enable: true
    title: "Ppsm documenten ondertekenen met Text Live Demo"
    content: |
