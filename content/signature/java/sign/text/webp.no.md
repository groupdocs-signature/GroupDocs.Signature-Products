...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Webp med Java"
head_description: "Sett Text eSignature på Webp-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Webp-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Webp med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Webp-dokumenter med Text-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Webp dokumenter med Text Live Demo"
    content: |
