...
############################# Head ############################
head_title: "Creați semnături electronice text în fișierul Pptx cu Java"
head_description: "Puneți Text eSignature pe fișierul Pptx pentru Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "Semnează fișiere Pptx cu semnături Text în Java"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Pptx cu Text în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Pptx cu semnături Text rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Pptx cu Text Live Demo"
    content: |
