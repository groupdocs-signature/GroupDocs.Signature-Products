...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Zip lêer met Java"
head_description: "Plaas Text eSignature op Zip lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Zip lêers met Text handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Zip met Text in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Zip dokumente met Text handtekeninge vinnig en maklik te onderteken.
