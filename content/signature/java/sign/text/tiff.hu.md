...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Tiff fájlhoz a Java segítségével"
head_description: "Helyezze a Text eSignature-t a Java Tiff fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Tiff fájl aláírása Text aláírással a Java alkalmazásban"
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Tiff dokumentumok gyors és egyszerű aláírását Text aláírással.
...
demos:
    enable: true
    title: "Tiff dokumentumok aláírása Text élő bemutatóval"
    content: |
