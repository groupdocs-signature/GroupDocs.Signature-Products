...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Docm pomocí Java"
head_description: "Vložte elektronický podpis Text do souboru Docm pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Docm pomocí podpisů Text v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Docm pomocí Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Docm pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Docm pomocí živé ukázky Text"
    content: |
