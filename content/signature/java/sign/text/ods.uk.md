...
############################# Head ############################
head_title: "Створіть текстові електронні підписи до файлу Ods за допомогою Java"
head_description: "Додайте електронний підпис Text у файл Ods для Java за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs, щоб підписувати десятки форматів файлів."

############################# Header ############################
title: "Підпишіть файли Ods підписами Text у Java"
...
steps:
    enable: true
    title_left: "Кроки для підпису Ods за допомогою Text у Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) надає можливість швидко та легко підписувати документи Ods за допомогою підписів Text.
