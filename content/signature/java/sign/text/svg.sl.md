...
############################# Head ############################
head_title: "Ustvarite besedilne elektronske podpise v datoteko Svg z Java"
head_description: "Vstavite e-podpis Text v datoteko Svg za Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Svg datoteke s podpisi Text v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Svg z Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Svg s podpisi Text.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Svg z Text Live Demo"
    content: |
