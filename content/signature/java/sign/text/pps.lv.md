...
############################# Head ############################
head_title: "Izveidojiet teksta elektroniskos parakstus failam Pps, izmantojot Java"
head_description: "Ievietojiet Text eParaksts Pps failā Java, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Pps failus ar Text parakstiem programmā Java"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Pps ar Text programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Pps dokumentus ar Text parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Pps parakstīšana, izmantojot Text tiešraides demonstrāciju"
    content: |
