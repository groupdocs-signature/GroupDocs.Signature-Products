...
############################# Head ############################
head_title: "የጽሁፍ ኤሌክትሮኒክ ፊርማዎችን ወደ Ppsm ፋይል በJava ይፍጠሩ"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም Text eSigntureን በPpsm ፋይል ላይ ለJava ያድርጉ። በደርዘን የሚቆጠሩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "Ppsm ፋይሎችን በText ፊርማዎች በJava ይፈርሙ"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የPpsm ሰነዶችን በText ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
...
demos:
    enable: true
    title: "Ppsm ሰነዶችን በText ቀጥታ ማሳያ በመፈረም ላይ"
    content: |
