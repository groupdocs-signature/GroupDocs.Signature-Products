...
############################# Head ############################
head_title: "สร้างลายเซ็นอิเล็กทรอนิกส์ข้อความไปยังไฟล์ Dot ด้วย Java"
head_description: "ใส่ Text eSignature ในไฟล์ Dot สำหรับ Java โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API เพื่อลงนามรูปแบบไฟล์มากมาย"

############################# Header ############################
title: "เซ็นชื่อไฟล์ Dot ด้วยลายเซ็น Text ใน Java"
...
steps:
    enable: true
    title_left: "ขั้นตอนในการลงนาม Dot กับ Text ใน Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ให้ความสามารถในการลงนามในเอกสาร Dot ด้วยลายเซ็น Text อย่างรวดเร็วและง่ายดาย
...
demos:
    enable: true
    title: "การลงนามเอกสาร Dot ด้วย Text Live Demo"
    content: |
