...
############################# Head ############################
head_title: "Cipta tandatangan elektronik Teks ke fail Png dengan Java"
head_description: "Letakkan Text eSignature pada fail Png untuk Java menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Png dengan tandatangan Text dalam Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Png dengan Text dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Png dengan tandatangan Text dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Png dengan Text Demo Langsung"
    content: |
