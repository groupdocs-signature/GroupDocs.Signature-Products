...
############################# Head ############################
head_title: "Cipta tandatangan elektronik Teks ke fail Pptm dengan Java"
head_description: "Letakkan Text eSignature pada fail Pptm untuk Java menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Pptm dengan tandatangan Text dalam Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pptm dengan Text dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Pptm dengan tandatangan Text dengan cepat dan mudah.
