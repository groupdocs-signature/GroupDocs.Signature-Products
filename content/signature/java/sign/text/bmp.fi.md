...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Bmp käyttämällä Java"
head_description: "Aseta Text eSignature Bmp-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Bmp tiedostot Text allekirjoituksilla Java"
...
steps:
    enable: true
    title_left: "Vaiheet Bmp:n allekirjoittamiseen Text -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Bmp-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
