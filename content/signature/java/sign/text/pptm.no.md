...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Pptm med Java"
head_description: "Sett Text eSignature på Pptm-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."
...
steps:
    enable: true
    title_left: "Trinn for å signere Pptm med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Pptm-dokumenter med Text-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Pptm dokumenter med Text Live Demo"
    content: |
