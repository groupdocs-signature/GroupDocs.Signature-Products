...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen Ots med Java"
head_description: "Sätt Text eSignature på filen Ots för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Ots-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Ots med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Ots-dokument med Text-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Ots dokument med Text Live Demo"
    content: |
