...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Tiff rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Tiff, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Tiff allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Tiff allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Tiff dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Tiff allkirjastamine Text reaalajas demoga"
    content: |
