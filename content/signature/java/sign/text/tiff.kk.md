...
############################# Head ############################
head_title: "Java көмегімен Tiff файлына мәтіндік электрондық қолтаңба жасау"
head_description: "Кодтың бірнеше жолын пайдаланып Java үшін Text eSignature Tiff файлына қойыңыз. Ондаған файл пішіміне қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "Tiff файлдарға Java жүйесінде Text қолтаңбаларымен қол қойыңыз"
...
steps:
    enable: true
    title_left: "Java жүйесінде Text арқылы Tiff файлына қол қою қадамдары"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) Tiff құжаттарға Text қолтаңбаларымен жылдам және оңай қол қою мүмкіндігін береді.
...
demos:
    enable: true
    title: "Tiff құжаттарға Text тікелей көрсетілімі арқылы қол қою"
    content: |
