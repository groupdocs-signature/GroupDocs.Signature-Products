...
############################# Head ############################
head_title: "Ji bo pelê Pdf bi Java re îmzeyên elektronîkî yên nivîsê biafirînin"
head_description: "Ji bo Java Text eSignature li ser pela Pdf bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Pdf bi îmzeyên Text di Java de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Pdf bi Text di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Pdf bi îmzeyên Text zû û bi hêsanî peyda dike.
