...
############################# Head ############################
head_title: "Cruthaigh sínithe leictreonacha Téacs chun Ott a chomhdú le Java"
head_description: "Cuir Text eSignature ar Ott comhad le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Ott comhad le sínithe Text in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Ott a shíniú le Text in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Ott a shíniú le sínithe Text go tapa agus go héasca.
