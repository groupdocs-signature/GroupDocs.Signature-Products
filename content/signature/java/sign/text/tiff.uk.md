...
############################# Head ############################
head_title: "Створіть текстові електронні підписи до файлу Tiff за допомогою Java"
head_description: "Додайте електронний підпис Text у файл Tiff для Java за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs, щоб підписувати десятки форматів файлів."

############################# Header ############################
title: "Підпишіть файли Tiff підписами Text у Java"
...
steps:
    enable: true
    title_left: "Кроки для підпису Tiff за допомогою Text у Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) надає можливість швидко та легко підписувати документи Tiff за допомогою підписів Text.
...
demos:
    enable: true
    title: "Підпис документів Tiff за допомогою Text Live Demo"
    content: |
