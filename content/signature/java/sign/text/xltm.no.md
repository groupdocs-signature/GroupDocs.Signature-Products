...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Xltm med Java"
head_description: "Sett Text eSignature på Xltm-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Xltm-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Xltm med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Xltm-dokumenter med Text-signaturer raskt og enkelt.
