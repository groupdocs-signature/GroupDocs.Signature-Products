...
############################# Head ############################
head_title: "Búðu til rafrænar undirskriftir í 7z skrá með Java"
head_description: "Settu Text eSignature á 7z skrá fyrir Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "Undirritaðu 7z skrár með Text undirskriftum í Java"
...
steps:
    enable: true
    title_left: "Skref til að undirrita 7z með Text í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita 7z skjöl með Text undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar 7z skjöl með Text lifandi kynningu"
    content: |
