...
############################# Head ############################
head_title: "Tạo chữ ký điện tử Văn bản vào tệp Docm với Java"
head_description: "Đặt Text eSignature vào tệp Docm cho Java bằng cách sử dụng một vài dòng mã. Sử dụng API chữ ký tài liệu GroupDocs để ký hàng chục định dạng tệp."

############################# Header ############################
title: "Ký các tệp Docm bằng chữ ký Text trong Java"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Docm bằng Text trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Docm bằng chữ ký Text một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Docm bằng Text Live Demo"
    content: |
