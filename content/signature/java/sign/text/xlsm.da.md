...
############################# Head ############################
head_title: "Opret elektroniske tekstsignaturer til filen Xlsm med Java"
head_description: "Sæt Text eSignature på filen Xlsm for Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Xlsm-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trin til at signere Xlsm med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Xlsm dokumenter med Text signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Xlsm dokumenter med Text Live Demo"
    content: |
