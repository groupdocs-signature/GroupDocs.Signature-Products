...
############################# Head ############################
head_title: "Cree firmas electrónicas de texto en un archivo Svg con Java"
head_description: "Coloque Text eSignature en el archivo Svg para Java usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "Firme Svg archivos con Text firmas en Java"
...
steps:
    enable: true
    title_left: "Pasos para firmar Svg con Text en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Svg con Text firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Svg documentos con Text Live Demo"
    content: |
