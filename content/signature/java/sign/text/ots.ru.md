...
############################# Head ############################
head_title: "Создайте текстовые электронные подписи для файла Ots с помощью Java"
head_description: "Поместите электронную подпись Text в файл Ots для Java, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "Подпишите файлы Ots с подписями Text в Java"
...
steps:
    enable: true
    title_left: "Действия по подписанию Ots с помощью Text в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Ots с подписями Text.
