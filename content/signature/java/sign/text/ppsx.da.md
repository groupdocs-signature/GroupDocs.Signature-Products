...
############################# Head ############################
head_title: "Opret elektroniske tekstsignaturer til filen Ppsx med Java"
head_description: "Sæt Text eSignature på filen Ppsx for Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Ppsx-filer med Text-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trin til at signere Ppsx med Text i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Ppsx dokumenter med Text signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Ppsx dokumenter med Text Live Demo"
    content: |
