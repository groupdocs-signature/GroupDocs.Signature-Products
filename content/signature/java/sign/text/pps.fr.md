...
############################# Head ############################
head_title: "Ajout de signatures Text au fichier Pps avec Java"
head_description: "Mettez Text Signature sur le fichier Pps pour Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."
...
demos:
    enable: true
    title: "Signature de documents Pps avec Text Live Demo"
    content: |
