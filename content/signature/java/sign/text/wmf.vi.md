...
############################# Head ############################
head_title: "Tạo chữ ký điện tử Văn bản vào tệp Wmf với Java"
head_description: "Đặt Text eSignature vào tệp Wmf cho Java bằng cách sử dụng một vài dòng mã. Sử dụng API chữ ký tài liệu GroupDocs để ký hàng chục định dạng tệp."

############################# Header ############################
title: "Ký các tệp Wmf bằng chữ ký Text trong Java"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Wmf bằng Text trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Wmf bằng chữ ký Text một cách nhanh chóng và dễ dàng.
