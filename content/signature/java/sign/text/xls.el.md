...
############################# Head ############################
head_title: "Δημιουργία ηλεκτρονικών υπογραφών κειμένου σε αρχείο Xls με Java"
head_description: "Τοποθετήστε το Text eSignature στο αρχείο Xls για το Java χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε δεκάδες μορφές αρχείων."

############################# Header ############################
title: "Υπογράψτε αρχεία Xls με υπογραφές Text στο Java"
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Xls με Text στο Java"
    content_left: |
        Το [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) παρέχει τη δυνατότητα υπογραφής εγγράφων Xls με υπογραφές Text γρήγορα και εύκολα.
