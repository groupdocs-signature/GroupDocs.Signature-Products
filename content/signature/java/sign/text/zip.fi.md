...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Zip käyttämällä Java"
head_description: "Aseta Text eSignature Zip-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Zip tiedostot Text allekirjoituksilla Java"
...
steps:
    enable: true
    title_left: "Vaiheet Zip:n allekirjoittamiseen Text -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Zip-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
