...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Dot rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Dot, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Dot allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Dot allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Dot dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Dot allkirjastamine Text reaalajas demoga"
    content: |
