...
############################# Head ############################
head_title: "Creați semnături electronice text în fișierul Dotm cu Java"
head_description: "Puneți Text eSignature pe fișierul Dotm pentru Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "Semnează fișiere Dotm cu semnături Text în Java"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Dotm cu Text în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Dotm cu semnături Text rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Dotm cu Text Live Demo"
    content: |
