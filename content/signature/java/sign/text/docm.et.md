...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Docm rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Docm, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Docm allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Docm allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Docm dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Docm allkirjastamine Text reaalajas demoga"
    content: |
