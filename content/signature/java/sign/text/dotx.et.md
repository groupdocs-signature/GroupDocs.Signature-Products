...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Dotx rakendusega Java"
head_description: "Pane Text e-allkiri Java-faili Dotx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Dotx allkirjadega Text rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Dotx allkirjastamiseks rakendusega Text rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Dotx dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Dotx allkirjastamine Text reaalajas demoga"
    content: |
