...
############################# Head ############################
head_title: "Cipta tandatangan elektronik Teks ke fail Xlsm dengan Java"
head_description: "Letakkan Text eSignature pada fail Xlsm untuk Java menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Xlsm dengan tandatangan Text dalam Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xlsm dengan Text dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Xlsm dengan tandatangan Text dengan cepat dan mudah.
