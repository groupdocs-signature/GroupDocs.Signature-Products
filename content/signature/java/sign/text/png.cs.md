...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Png pomocí Java"
head_description: "Vložte elektronický podpis Text do souboru Png pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Png pomocí podpisů Text v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Png pomocí Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Png pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Png pomocí živé ukázky Text"
    content: |
