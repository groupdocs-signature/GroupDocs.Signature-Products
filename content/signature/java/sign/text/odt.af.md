...
############################# Header ############################
title: "Teken Odt lêers met Text handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Odt met Text in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Odt dokumente met Text handtekeninge vinnig en maklik te onderteken.
