...
############################# Head ############################
head_title: "Buat tanda tangan elektronik Teks ke file Dot dengan Java"
head_description: "Letakkan Text eSignature pada file Dot untuk Java menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "Tanda tangani file Dot dengan tanda tangan Text di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Dot dengan Text di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Dot dengan Text tanda tangan dengan cepat dan mudah.
