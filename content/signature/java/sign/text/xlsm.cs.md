...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Xlsm pomocí Java"
head_description: "Vložte elektronický podpis Text do souboru Xlsm pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Xlsm pomocí podpisů Text v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsm pomocí Text v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Xlsm pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Xlsm pomocí živé ukázky Text"
    content: |
