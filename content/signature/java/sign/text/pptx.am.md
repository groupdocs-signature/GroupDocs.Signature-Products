...
############################# Head ############################
head_title: "የጽሁፍ ኤሌክትሮኒክ ፊርማዎችን ወደ Pptx ፋይል በJava ይፍጠሩ"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም Text eSigntureን በPptx ፋይል ላይ ለJava ያድርጉ። በደርዘን የሚቆጠሩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "Pptx ፋይሎችን በText ፊርማዎች በJava ይፈርሙ"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የPptx ሰነዶችን በText ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
...
demos:
    enable: true
    title: "Pptx ሰነዶችን በText ቀጥታ ማሳያ በመፈረም ላይ"
    content: |
