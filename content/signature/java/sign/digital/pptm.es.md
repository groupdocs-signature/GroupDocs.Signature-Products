...
############################# Head ############################
head_title: "Adición de firmas electrónicas digitales al archivo Pptm con Java"
head_description: "Coloque la firma digital en el archivo Pptm para Java usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "eSign Pptm archivos con Digital firmas en Java"
...
steps:
    enable: true
    title_left: "Pasos para firmar Pptm con Digital en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Pptm con Digital firmas de forma rápida y sencilla.
