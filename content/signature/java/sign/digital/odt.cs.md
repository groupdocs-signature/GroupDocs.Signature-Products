...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru Odt pomocí Java"
head_description: "Vložte digitální podpis do souboru Odt pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign Odt s podpisy Digital v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Odt pomocí Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Odt pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů Odt pomocí živé ukázky Digital"
    content: |
