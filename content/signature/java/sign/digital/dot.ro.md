...
############################# Head ############################
head_title: "Adăugarea semnăturilor electronice digitale la fișierul Dot cu Java"
head_description: "Puneți semnătura digitală pe fișierul Dot pentru Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "eSign fișiere Dot cu semnături Digital în Java"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Dot cu Digital în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Dot cu semnături Digital rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Dot cu Digital Live Demo"
    content: |
