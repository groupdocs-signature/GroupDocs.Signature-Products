...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Pptx z Java"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Pptx za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Pptx s podpisi Digital v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Pptx z Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Pptx s podpisi Digital.
