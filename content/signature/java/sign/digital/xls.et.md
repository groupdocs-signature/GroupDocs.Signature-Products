...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Xls rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Xls, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Xls failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Xls allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Xls dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Xls allkirjastamine Digital reaalajas demoga"
    content: |
