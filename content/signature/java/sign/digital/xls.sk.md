...
############################# Head ############################
head_title: "Pridanie digitálnych elektronických podpisov do súboru Xls pomocou Java"
head_description: "Vložte digitálny podpis do súboru Xls pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "eSign Xls súbory s Digital podpismi v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xls pomocou Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xls pomocou podpisov Digital.
