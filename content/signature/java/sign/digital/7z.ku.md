...
############################# Head ############################
head_title: "Zêdekirina îmzeyên elektronîkî yên dîjîtal li pelê 7z bi Java"
head_description: "Ji bo Java bi çend rêzikên kodê Îmzeya Dîjîtal bixin ser pelê 7z. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "eSign 7z pelên bi Digital di Java de"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina 7z bi Digital di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên 7z bi îmzeyên Digital zû û bi hêsanî peyda dike.
