...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Dot rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Dot, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Dot failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Dot allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Dot dokumente Digital allkirjaga.
