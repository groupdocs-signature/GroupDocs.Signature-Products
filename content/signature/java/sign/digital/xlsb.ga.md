...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad Xlsb le Java"
head_description: "Cuir Síniú Digiteach ar chomhad Xlsb le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh Xlsb comhaid le Digital sínithe in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Xlsb a shíniú le Digital in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Xlsb a shíniú le sínithe Digital go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Xlsb doiciméad le Digital Taispeántas Beo"
    content: |
