...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Xlsb rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Xlsb, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Xlsb failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Xlsb allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Xlsb dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Xlsb allkirjastamine Digital reaalajas demoga"
    content: |
