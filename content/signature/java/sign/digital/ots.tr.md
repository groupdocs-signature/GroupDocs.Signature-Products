...
############################# Head ############################
head_title: "Java ile Ots dosyasına Dijital elektronik imza ekleme"
head_description: "Birkaç satır kod kullanarak Dijital İmzayı Java için Ots dosyasına koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Digital imzalı Ots dosyalarını imzalayın"
...
steps:
    enable: true
    title_left: "Java içinde Digital ile Ots imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Ots belgelerini Digital imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Ots dokümanı Digital Canlı Demo ile imzalama"
    content: |
