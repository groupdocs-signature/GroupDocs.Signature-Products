...
############################# Head ############################
head_title: "Digitale elektronische handtekeningen toevoegen aan Pdf bestand met Java"
head_description: "Zet de digitale handtekening op het Pdf-bestand voor Java met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "eSign Pdf bestanden met Digital handtekeningen in Java"
...
steps:
    enable: true
    title_left: "Stappen om Pdf te ondertekenen met Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Pdf documenten snel en gemakkelijk te ondertekenen met Digital handtekeningen.
...
demos:
    enable: true
    title: "Pdf documenten ondertekenen met Digital Live Demo"
    content: |
