...
############################# Head ############################
head_title: "Skaitmeninių elektroninių parašų pridėjimas prie failo Xls naudojant Java"
head_description: "Įdėkite skaitmeninį parašą į Xls failą, skirtą Java, naudodami kelias kodo eilutes. Norėdami pasirašyti daugybę failų formatų, naudokite GroupDocs Document Signature API."

############################# Header ############################
title: "eSign Xls failai su Digital parašais Java"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Xls naudojant Digital programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Xls dokumentus su Digital parašais.
...
demos:
    enable: true
    title: "Dokumentų Xls pasirašymas naudojant Digital tiesioginę demonstraciją"
    content: |
