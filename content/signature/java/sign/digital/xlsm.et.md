...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Xlsm rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Xlsm, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Xlsm failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Xlsm allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Xlsm dokumente Digital allkirjaga.
