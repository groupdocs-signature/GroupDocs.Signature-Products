...
############################# Head ############################
head_title: "Tilføjelse af digitale elektroniske signaturer til filen Docx med Java"
head_description: "Sæt digital signatur på filen Docx for Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "eSign Docx filer med Digital signaturer i Java"
...
steps:
    enable: true
    title_left: "Trin til at signere Docx med Digital i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Docx dokumenter med Digital signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Docx dokumenter med Digital Live Demo"
    content: |
