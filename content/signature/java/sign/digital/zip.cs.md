...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru Zip pomocí Java"
head_description: "Vložte digitální podpis do souboru Zip pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign Zip s podpisy Digital v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Zip pomocí Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Zip pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů Zip pomocí živé ukázky Digital"
    content: |
