...
############################# Head ############################
head_title: "Pridanie digitálnych elektronických podpisov do súboru Xlsx pomocou Java"
head_description: "Vložte digitálny podpis do súboru Xlsx pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "eSign Xlsx súbory s Digital podpismi v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xlsx pomocou Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xlsx pomocou podpisov Digital.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Xlsx pomocou živej ukážky Digital"
    content: |
