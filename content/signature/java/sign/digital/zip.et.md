...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Zip rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Zip, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Zip failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Zip allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Zip dokumente Digital allkirjaga.
