...
############################# Head ############################
head_title: "Προσθήκη ψηφιακών ηλεκτρονικών υπογραφών στο αρχείο Dot με Java"
head_description: "Τοποθετήστε την ψηφιακή υπογραφή στο αρχείο Dot για το Java χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε δεκάδες μορφές αρχείων."

############################# Header ############################
title: "Αρχεία eSign Dot με υπογραφές Digital στο Java"
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Dot με Digital στο Java"
    content_left: |
        Το [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) παρέχει τη δυνατότητα υπογραφής εγγράφων Dot με υπογραφές Digital γρήγορα και εύκολα.
