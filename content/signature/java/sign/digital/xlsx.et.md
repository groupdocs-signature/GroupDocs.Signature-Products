...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Xlsx rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Xlsx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Xlsx failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Xlsx allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Xlsx dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Xlsx allkirjastamine Digital reaalajas demoga"
    content: |
