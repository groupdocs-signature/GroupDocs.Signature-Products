...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru Xlsm pomocí Java"
head_description: "Vložte digitální podpis do souboru Xlsm pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign Xlsm s podpisy Digital v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsm pomocí Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Xlsm pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů Xlsm pomocí živé ukázky Digital"
    content: |
