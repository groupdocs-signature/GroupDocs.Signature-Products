...
############################# Head ############################
head_title: "Legger til digitale elektroniske signaturer i filen Xltx med Java"
head_description: "Sett digital signatur på Xltx-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "eSign Xltx-filer med Digital-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Xltx med Digital i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Xltx-dokumenter med Digital-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Xltx dokumenter med Digital Live Demo"
    content: |
