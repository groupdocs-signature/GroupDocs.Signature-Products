...
############################# Head ############################
head_title: "Adăugarea semnăturilor electronice digitale la fișierul 7z cu Java"
head_description: "Puneți semnătura digitală pe fișierul 7z pentru Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "eSign fișiere 7z cu semnături Digital în Java"
...
steps:
    enable: true
    title_left: "Pași pentru a semna 7z cu Digital în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente 7z cu semnături Digital rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente 7z cu Digital Live Demo"
    content: |
