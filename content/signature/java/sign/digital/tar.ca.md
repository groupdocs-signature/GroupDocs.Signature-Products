...
############################# Head ############################
head_title: "Afegir signatures electròniques digitals al fitxer Tar amb Java"
head_description: "Col·loqueu la signatura digital al fitxer Tar per a Java utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "eSign fitxers Tar amb signatures Digital a Java"
...
steps:
    enable: true
    title_left: "Passos per signar Tar amb Digital a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Tar amb signatures Digital de manera ràpida i senzilla.
