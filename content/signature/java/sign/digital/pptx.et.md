...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Pptx rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Pptx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Pptx failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Pptx allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Pptx dokumente Digital allkirjaga.
