...
############################# Head ############################
head_title: "Digitale elektronische handtekeningen toevoegen aan Zip bestand met Java"
head_description: "Zet de digitale handtekening op het Zip-bestand voor Java met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "eSign Zip bestanden met Digital handtekeningen in Java"
...
steps:
    enable: true
    title_left: "Stappen om Zip te ondertekenen met Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Zip documenten snel en gemakkelijk te ondertekenen met Digital handtekeningen.
