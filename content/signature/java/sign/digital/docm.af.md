...
############################# Head ############################
head_title: "Voeg digitale elektroniese handtekeninge by Docm-lêer met Java"
head_description: "Plaas digitale handtekening op Docm-lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "eSign Docm lêers met Digital handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Docm met Digital in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Docm dokumente met Digital handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Docm dokumente met Digital Regstreekse Demo"
    content: |
