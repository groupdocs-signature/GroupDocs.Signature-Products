...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Pdf rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Pdf, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Pdf failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Pdf allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Pdf dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Pdf allkirjastamine Digital reaalajas demoga"
    content: |
