...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Xltm rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Xltm, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Xltm failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Xltm allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Xltm dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Xltm allkirjastamine Digital reaalajas demoga"
    content: |
