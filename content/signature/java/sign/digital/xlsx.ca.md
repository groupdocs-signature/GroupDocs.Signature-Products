...
############################# Head ############################
head_title: "Afegir signatures electròniques digitals al fitxer Xlsx amb Java"
head_description: "Col·loqueu la signatura digital al fitxer Xlsx per a Java utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "eSign fitxers Xlsx amb signatures Digital a Java"
...
steps:
    enable: true
    title_left: "Passos per signar Xlsx amb Digital a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Xlsx amb signatures Digital de manera ràpida i senzilla.
