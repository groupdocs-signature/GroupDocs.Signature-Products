...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Xltx rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Xltx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Xltx failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Xltx allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Xltx dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Xltx allkirjastamine Digital reaalajas demoga"
    content: |
