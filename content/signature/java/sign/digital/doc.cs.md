...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru Doc pomocí Java"
head_description: "Vložte digitální podpis do souboru Doc pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign Doc s podpisy Digital v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Doc pomocí Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Doc pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů Doc pomocí živé ukázky Digital"
    content: |
