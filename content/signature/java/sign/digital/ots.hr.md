...
############################# Head ############################
head_title: "Dodavanje digitalnih elektroničkih potpisa u datoteku Ots s Java"
head_description: "Stavite digitalni potpis na datoteku Ots za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "eSign Ots datoteke s Digital potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Ots s Digital u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Ots dokumenata s Digital potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Ots dokumenata s Digital Live Demo"
    content: |
