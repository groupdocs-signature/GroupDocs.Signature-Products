...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Docm rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Docm, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Docm failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Docm allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Docm dokumente Digital allkirjaga.
