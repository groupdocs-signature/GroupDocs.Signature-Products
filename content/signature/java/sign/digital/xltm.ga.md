...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad Xltm le Java"
head_description: "Cuir Síniú Digiteach ar chomhad Xltm le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh Xltm comhaid le {{ Signaturetype}} sínithe in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Xltm a shíniú le Digital in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Xltm a shíniú le sínithe Digital go tapa agus go héasca.
