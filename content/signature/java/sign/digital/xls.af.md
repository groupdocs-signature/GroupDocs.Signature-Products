...
############################# Head ############################
head_title: "Voeg digitale elektroniese handtekeninge by Xls-lêer met Java"
head_description: "Plaas digitale handtekening op Xls-lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "eSign Xls lêers met Digital handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Xls met Digital in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Xls dokumente met Digital handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Xls dokumente met Digital Regstreekse Demo"
    content: |
