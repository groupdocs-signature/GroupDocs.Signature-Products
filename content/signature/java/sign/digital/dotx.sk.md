...
############################# Head ############################
head_title: "Pridanie digitálnych elektronických podpisov do súboru Dotx pomocou Java"
head_description: "Vložte digitálny podpis do súboru Dotx pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "eSign Dotx súbory s Digital podpismi v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Dotx pomocou Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Dotx pomocou podpisov Digital.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Dotx pomocou živej ukážky Digital"
    content: |
