...
############################# Head ############################
head_title: "Lägger till digitala elektroniska signaturer i filen Dotx med Java"
head_description: "Lägg digital signatur på filen Dotx för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "eSign Dotx-filer med Digital-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Dotx med Digital i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Dotx-dokument med Digital-signaturer snabbt och enkelt.
