...
############################# Head ############################
head_title: "Adición de firmas electrónicas digitales al archivo Dotx con Java"
head_description: "Coloque la firma digital en el archivo Dotx para Java usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "eSign Dotx archivos con Digital firmas en Java"
...
steps:
    enable: true
    title_left: "Pasos para firmar Dotx con Digital en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Dotx con Digital firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Dotx documentos con Digital Live Demo"
    content: |
