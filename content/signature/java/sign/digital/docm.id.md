...
############################# Head ############################
head_title: "Menambahkan tanda tangan elektronik digital ke file Docm dengan Java"
head_description: "Letakkan Tanda Tangan Digital pada file Docm untuk Java menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "eSign Docm file dengan Digital tanda tangan di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Docm dengan Digital di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Docm dengan Digital tanda tangan dengan cepat dan mudah.
