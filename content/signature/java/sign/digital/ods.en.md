...
############################# Head ############################
head_title: "Adding Digital signatures in a Ods file with Java"
head_description: "Put Digital Signature on Ods file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .Ods files with Digital signatures in Java"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Ods files with Digital signatures using Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
