...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Dot z Java"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Dot za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Dot s podpisi Digital v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Dot z Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Dot s podpisi Digital.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Dot z Digital Live Demo"
    content: |
