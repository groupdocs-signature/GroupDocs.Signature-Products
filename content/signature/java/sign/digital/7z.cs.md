...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru 7z pomocí Java"
head_description: "Vložte digitální podpis do souboru 7z pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign 7z s podpisy Digital v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání 7z pomocí Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty 7z pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů 7z pomocí živé ukázky Digital"
    content: |
