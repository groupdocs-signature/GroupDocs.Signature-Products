...
############################# Head ############################
head_title: "إضافة التوقيعات الإلكترونية الرقمية إلى ملف Ods باستخدام Java"
head_description: "ضع التوقيع الرقمي على ملف Ods لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "ملفات eSign Ods ذات توقيعات Digital في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Ods باستخدام Digital في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Ods بتوقيعات Digital بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Ods باستخدام العرض التوضيحي المباشر Digital"
    content: |
