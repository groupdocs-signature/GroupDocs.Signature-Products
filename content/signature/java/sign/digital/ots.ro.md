...
############################# Head ############################
head_title: "Adăugarea semnăturilor electronice digitale la fișierul Ots cu Java"
head_description: "Puneți semnătura digitală pe fișierul Ots pentru Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "eSign fișiere Ots cu semnături Digital în Java"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Ots cu Digital în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Ots cu semnături Digital rapid și ușor.
