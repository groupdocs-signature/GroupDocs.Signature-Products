...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Tar rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Tar, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Tar failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Tar allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Tar dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Tar allkirjastamine Digital reaalajas demoga"
    content: |
