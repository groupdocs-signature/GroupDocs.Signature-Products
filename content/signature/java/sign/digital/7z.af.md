...
############################# Head ############################
head_title: "Voeg digitale elektroniese handtekeninge by 7z-lêer met Java"
head_description: "Plaas digitale handtekening op 7z-lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "eSign 7z lêers met Digital handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om 7z met Digital in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om 7z dokumente met Digital handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken 7z dokumente met Digital Regstreekse Demo"
    content: |
