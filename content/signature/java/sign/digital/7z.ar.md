...
############################# Head ############################
head_title: "إضافة التوقيعات الإلكترونية الرقمية إلى ملف 7z باستخدام Java"
head_description: "ضع التوقيع الرقمي على ملف 7z لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "ملفات eSign 7z ذات توقيعات Digital في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل 7z باستخدام Digital في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات 7z بتوقيعات Digital بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات 7z باستخدام العرض التوضيحي المباشر Digital"
    content: |
