...
############################# Head ############################
head_title: "Zêdekirina îmzeyên elektronîkî yên dîjîtal li pelê Pdf bi Java"
head_description: "Ji bo Java bi çend rêzikên kodê Îmzeya Dîjîtal bixin ser pelê Pdf. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "eSign Pdf pelên bi Digital di Java de"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Pdf bi Digital di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Pdf bi îmzeyên Digital zû û bi hêsanî peyda dike.
