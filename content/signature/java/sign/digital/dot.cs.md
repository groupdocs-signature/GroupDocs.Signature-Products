...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru Dot pomocí Java"
head_description: "Vložte digitální podpis do souboru Dot pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign Dot s podpisy Digital v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Dot pomocí Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Dot pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů Dot pomocí živé ukázky Digital"
    content: |
