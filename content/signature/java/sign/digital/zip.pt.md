...
############################# Head ############################
head_title: "Adicionando assinaturas eletrônicas digitais ao arquivo Zip com Java"
head_description: "Coloque a assinatura digital no arquivo Zip para Java usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "eSign Zip arquivos com assinaturas Digital em Java"
...
steps:
    enable: true
    title_left: "Etapas para assinar Zip com Digital em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Zip com assinaturas Digital de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Zip documentos com Digital Demonstração ao vivo"
    content: |
