...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Tar z Java"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Tar za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Tar s podpisi Digital v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Tar z Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Tar s podpisi Digital.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Tar z Digital Live Demo"
    content: |
