...
############################# Head ############################
head_title: "Lägger till digitala elektroniska signaturer i filen Zip med Java"
head_description: "Lägg digital signatur på filen Zip för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."
...
steps:
    enable: true
    title_left: "Steg för att signera Zip med Digital i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Zip-dokument med Digital-signaturer snabbt och enkelt.
