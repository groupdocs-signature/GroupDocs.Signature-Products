...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Xlsx z Java"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Xlsx za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Xlsx s podpisi Digital v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Xlsx z Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Xlsx s podpisi Digital.
