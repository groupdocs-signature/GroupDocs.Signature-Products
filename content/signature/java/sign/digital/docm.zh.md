...
############################# Head ############################
head_title: "使用 Java 将数字电子签名添加到 Docm 文件"
head_description: "使用几行代码为 Java 的 Docm 文件添加数字签名。使用 GroupDocs 文档签名 API 对数十种文件格式进行签名。"

############################# Header ############################
title: "在 Java 中使用 Digital 签名的 eSign Docm 文件"
