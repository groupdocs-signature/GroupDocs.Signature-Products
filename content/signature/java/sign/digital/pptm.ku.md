...
head_description: "Ji bo Java bi çend rêzikên kodê Îmzeya Dîjîtal bixin ser pelê Pptm. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Pptm bi Digital Demoya Zindî"
    content: |
