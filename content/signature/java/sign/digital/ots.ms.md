...
############################# Head ############################
head_title: "Menambahkan tandatangan elektronik Digital pada fail Ots dengan Java"
head_description: "Letakkan Tandatangan Digital pada fail Ots untuk Java menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "eSign Ots fail dengan Digital tandatangan dalam Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Ots dengan Digital dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Ots dengan tandatangan Digital dengan cepat dan mudah.
