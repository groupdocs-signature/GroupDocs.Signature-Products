...
############################# Head ############################
head_title: "Hinzufügen von Digital-Signaturen zur Pptx-Datei mit Java"
head_description: "Fügen Sie die Digital-Signatur in die Pptx-Datei für Java ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Pptx-Dateien mit Digital-Signaturen in Java"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Pptx mit Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Pptx-Dokumente mit Digital-Signaturen schnell und einfach zu signieren.
