...
############################# Head ############################
head_title: "Dodavanje digitalnih elektroničkih potpisa u datoteku Docm s Java"
head_description: "Stavite digitalni potpis na datoteku Docm za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "eSign Docm datoteke s Digital potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Docm s Digital u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Docm dokumenata s Digital potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Docm dokumenata s Digital Live Demo"
    content: |
