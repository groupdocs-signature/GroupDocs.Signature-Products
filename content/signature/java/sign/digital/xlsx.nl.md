...
############################# Head ############################
head_title: "Digitale elektronische handtekeningen toevoegen aan Xlsx bestand met Java"
head_description: "Zet de digitale handtekening op het Xlsx-bestand voor Java met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "eSign Xlsx bestanden met Digital handtekeningen in Java"
...
steps:
    enable: true
    title_left: "Stappen om Xlsx te ondertekenen met Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Xlsx documenten snel en gemakkelijk te ondertekenen met Digital handtekeningen.
...
demos:
    enable: true
    title: "Xlsx documenten ondertekenen met Digital Live Demo"
    content: |
