...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru Ots pomocí Java"
head_description: "Vložte digitální podpis do souboru Ots pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign Ots s podpisy Digital v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Ots pomocí Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Ots pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů Ots pomocí živé ukázky Digital"
    content: |
