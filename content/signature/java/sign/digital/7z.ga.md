...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad 7z le Java"
head_description: "Cuir Síniú Digiteach ar chomhad 7z le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh 7z comhaid le Digital sínithe in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun 7z a shíniú le Digital in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid 7z a shíniú le sínithe Digital go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú 7z doiciméad le Digital Taispeántas Beo"
    content: |
