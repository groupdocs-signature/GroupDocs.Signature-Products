...
############################# Head ############################
head_title: "使用 Java 将 Digital 签名添加到 Odt 文件"
head_description: "使用几行代码将 Digital 签名放在 Java 的 Odt 文件上。使用 GroupDocs 文档签名 API 对数十种文件格式进行签名。"

############################# Header ############################
title: "在 Java 中使用 Digital 签名对 Odt 文件进行签名"
...
steps:
    enable: true
    title_left: "在 Java 中使用 Digital 签署 Odt 的步骤"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) 提供使用 Digital 签名快速轻松地签署 Odt 文档的能力。
...
demos:
    enable: true
    title: "使用 Digital 现场演示签署 Odt 文档"
    content: |
