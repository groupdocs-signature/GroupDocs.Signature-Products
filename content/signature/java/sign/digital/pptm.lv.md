...
############################# Head ############################
head_title: "Digitālo elektronisko parakstu pievienošana failam Pptm, izmantojot Java"
head_description: "Ievietojiet digitālo parakstu Pptm failā Java, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "eSign Pptm faili ar Digital parakstiem programmā Java"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Pptm ar Digital programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Pptm dokumentus ar Digital parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Pptm parakstīšana, izmantojot Digital tiešraides demonstrāciju"
    content: |
