...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a Xlsm fájlhoz a Java segítségével"
head_description: "Helyezze el a digitális aláírást a Java Xlsm fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign Xlsm fájlok Digital aláírással a Java nyelven"
...
steps:
    enable: true
    title_left: "A Xlsm aláírásának lépései a Digital segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Xlsm dokumentumok gyors és egyszerű aláírását Digital aláírással.
...
demos:
    enable: true
    title: "Xlsm dokumentumok aláírása Digital élő bemutatóval"
    content: |
