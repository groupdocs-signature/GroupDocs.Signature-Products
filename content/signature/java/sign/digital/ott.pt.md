...
############################# Head ############################
head_title: "Adicionando assinaturas eletrônicas digitais ao arquivo Ott com Java"
head_description: "Coloque a assinatura digital no arquivo Ott para Java usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "eSign Ott arquivos com assinaturas Digital em Java"
...
steps:
    enable: true
    title_left: "Etapas para assinar Ott com Digital em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Ott com assinaturas Digital de forma rápida e fácil.
