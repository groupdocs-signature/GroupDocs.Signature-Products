...
############################# Head ############################
head_title: "Thêm chữ ký điện tử kỹ thuật số vào tệp Xlsx với Java"
head_description: "Đặt Chữ ký số vào tệp Xlsx cho Java bằng cách sử dụng một vài dòng mã. Sử dụng API chữ ký tài liệu GroupDocs để ký hàng chục định dạng tệp."

############################# Header ############################
title: "eSign các tệp Xlsx có chữ ký Digital trong Java"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Xlsx bằng Digital trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Xlsx bằng chữ ký Digital một cách nhanh chóng và dễ dàng.
