...
############################# Head ############################
head_title: "Ajout de signatures électroniques numériques au fichier Zip avec Java"
head_description: "Mettez la signature numérique sur le fichier Zip pour Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "eSign Zip fichiers avec Digital signatures en Java"
...
steps:
    enable: true
    title_left: "Étapes pour signer Zip avec Digital dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Zip avec des signatures Digital.
