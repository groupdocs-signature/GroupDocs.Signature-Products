...
############################# Head ############################
head_title: "使用 Java 将 Digital 签名添加到 Dotx 文件"
head_description: "使用几行代码将 Digital 签名放在 Java 的 Dotx 文件上。使用 GroupDocs 文档签名 API 对数十种文件格式进行签名。"

############################# Header ############################
title: "在 Java 中使用 Digital 签名对 Dotx 文件进行签名"
