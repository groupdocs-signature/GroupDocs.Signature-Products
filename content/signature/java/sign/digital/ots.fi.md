...
############################# Head ############################
head_title: "Digitaalisten sähköisten allekirjoitusten lisääminen tiedostoon Ots ohjelmalla Java"
head_description: "Aseta digitaalinen allekirjoitus Ots-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "eSign Ots tiedostot Digital allekirjoituksella Java"
...
steps:
    enable: true
    title_left: "Vaiheet Ots:n allekirjoittamiseen Digital -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Ots-asiakirjoja Digital-allekirjoituksella nopeasti ja helposti.
