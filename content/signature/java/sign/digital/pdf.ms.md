...
############################# Head ############################
head_title: "Menambahkan tandatangan elektronik Digital pada fail Pdf dengan Java"
head_description: "Letakkan Tandatangan Digital pada fail Pdf untuk Java menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "eSign Pdf fail dengan Digital tandatangan dalam Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pdf dengan Digital dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Pdf dengan tandatangan Digital dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Pdf dengan Digital Demo Langsung"
    content: |
