...
############################# Head ############################
head_title: "Menambahkan tanda tangan elektronik digital ke file Xlsm dengan Java"
head_description: "Letakkan Tanda Tangan Digital pada file Xlsm untuk Java menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "eSign Xlsm file dengan Digital tanda tangan di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xlsm dengan Digital di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Xlsm dengan Digital tanda tangan dengan cepat dan mudah.
