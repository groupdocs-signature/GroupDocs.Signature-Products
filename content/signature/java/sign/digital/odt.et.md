...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Odt rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Odt, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Odt failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Odt allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Odt dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Odt allkirjastamine Digital reaalajas demoga"
    content: |
