...
############################# Head ############################
head_title: "Java کے ساتھ Xltx فائل میں ڈیجیٹل الیکٹرانک دستخط شامل کرنا"
head_description: "کوڈ کی چند سطروں کا استعمال کرتے ہوئے Java کے لیے Xltx فائل پر ڈیجیٹل دستخط لگائیں۔ درجنوں فائل فارمیٹس پر دستخط کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "Java میں Digital دستخطوں کے ساتھ eSign Xltx فائلیں"
...
steps:
    enable: true
    title_left: "Java میں Digital کے ساتھ Xltx پر دستخط کرنے کے مراحل"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) جلد اور آسانی سے Digital دستخطوں کے ساتھ Xltx دستاویزات پر دستخط کرنے کی صلاحیت فراہم کرتا ہے۔
