...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Ods rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Ods, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Ods failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Ods allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Ods dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Ods allkirjastamine Digital reaalajas demoga"
    content: |
