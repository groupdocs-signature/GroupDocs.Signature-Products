...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Docx rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Docx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Docx failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Docx allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Docx dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Docx allkirjastamine Digital reaalajas demoga"
    content: |
