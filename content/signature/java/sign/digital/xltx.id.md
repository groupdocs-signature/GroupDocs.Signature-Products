...
############################# Head ############################
head_title: "Menambahkan tanda tangan elektronik digital ke file Xltx dengan Java"
head_description: "Letakkan Tanda Tangan Digital pada file Xltx untuk Java menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "eSign Xltx file dengan Digital tanda tangan di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xltx dengan Digital di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Xltx dengan Digital tanda tangan dengan cepat dan mudah.
