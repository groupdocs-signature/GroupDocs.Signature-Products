...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a Pptm fájlhoz a Java segítségével"
head_description: "Helyezze el a digitális aláírást a Java Pptm fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign Pptm fájlok Digital aláírással a Java nyelven"
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Pptm dokumentumok gyors és egyszerű aláírását Digital aláírással.
...
demos:
    enable: true
    title: "Pptm dokumentumok aláírása Digital élő bemutatóval"
    content: |
