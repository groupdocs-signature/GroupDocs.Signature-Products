...
############################# Head ############################
head_title: "Digitālo elektronisko parakstu pievienošana failam Dotx, izmantojot Java"
head_description: "Ievietojiet digitālo parakstu Dotx failā Java, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "eSign Dotx faili ar Digital parakstiem programmā Java"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Dotx ar Digital programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Dotx dokumentus ar Digital parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Dotx parakstīšana, izmantojot Digital tiešraides demonstrāciju"
    content: |
