...
############################# Head ############################
head_title: "Добавление цифровых электронных подписей в файл Xlsb с Java"
head_description: "Поместите цифровую подпись в файл Xlsb для Java, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "eSign Xlsb файлов с подписями Digital в Java"
...
steps:
    enable: true
    title_left: "Действия по подписанию Xlsb с помощью Digital в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Xlsb с подписями Digital.
...
demos:
    enable: true
    title: "Подписание Xlsb документов с помощью Digital Live Demo"
    content: |
