...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Pptm rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile Pptm, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Pptm failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Pptm allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Pptm dokumente Digital allkirjaga.
