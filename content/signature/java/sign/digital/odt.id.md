...
############################# Head ############################
head_title: "Menambahkan tanda tangan elektronik digital ke file Odt dengan Java"
head_description: "Letakkan Tanda Tangan Digital pada file Odt untuk Java menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "eSign Odt file dengan Digital tanda tangan di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Odt dengan Digital di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Odt dengan Digital tanda tangan dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Odt dengan Digital Demo Langsung"
    content: |
