...
############################# Head ############################
head_title: "Digitālo elektronisko parakstu pievienošana failam 7z, izmantojot Java"
head_description: "Ievietojiet digitālo parakstu 7z failā Java, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "eSign 7z faili ar Digital parakstiem programmā Java"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu 7z ar Digital programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt 7z dokumentus ar Digital parakstiem.
...
demos:
    enable: true
    title: "Dokumentu 7z parakstīšana, izmantojot Digital tiešraides demonstrāciju"
    content: |
