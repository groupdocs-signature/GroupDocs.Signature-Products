...
############################# Head ############################
head_title: "Digitale elektronische handtekeningen toevoegen aan Ots bestand met Java"
head_description: "Zet de digitale handtekening op het Ots-bestand voor Java met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "eSign Ots bestanden met Digital handtekeningen in Java"
...
steps:
    enable: true
    title_left: "Stappen om Ots te ondertekenen met Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Ots documenten snel en gemakkelijk te ondertekenen met Digital handtekeningen.
