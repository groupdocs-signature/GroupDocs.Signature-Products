...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Ots z Java"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Ots za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Ots s podpisi Digital v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Ots z Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Ots s podpisi Digital.
