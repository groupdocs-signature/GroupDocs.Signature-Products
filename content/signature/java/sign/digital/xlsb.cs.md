...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru Xlsb pomocí Java"
head_description: "Vložte digitální podpis do souboru Xlsb pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign Xlsb s podpisy Digital v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsb pomocí Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Xlsb pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů Xlsb pomocí živé ukázky Digital"
    content: |
