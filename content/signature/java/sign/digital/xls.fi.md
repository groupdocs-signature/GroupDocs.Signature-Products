...
############################# Head ############################
head_title: "Digitaalisten sähköisten allekirjoitusten lisääminen tiedostoon Xls ohjelmalla Java"
head_description: "Aseta digitaalinen allekirjoitus Xls-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "eSign Xls tiedostot Digital allekirjoituksella Java"
...
steps:
    enable: true
    title_left: "Vaiheet Xls:n allekirjoittamiseen Digital -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Xls-asiakirjoja Digital-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Xls asiakirjoja Digital Live-demolla"
    content: |
