...
############################# Head ############################
head_title: "Ajout de signatures électroniques numériques au fichier Dot avec Java"
head_description: "Mettez la signature numérique sur le fichier Dot pour Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "eSign Dot fichiers avec Digital signatures en Java"
...
steps:
    enable: true
    title_left: "Étapes pour signer Dot avec Digital dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Dot avec des signatures Digital.
