...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Xltm z Java"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Xltm za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Xltm s podpisi Digital v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Xltm z Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Xltm s podpisi Digital.
