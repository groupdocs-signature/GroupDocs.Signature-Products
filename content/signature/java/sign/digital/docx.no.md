...
############################# Head ############################
head_title: "Legger til digitale elektroniske signaturer i filen Docx med Java"
head_description: "Sett digital signatur på Docx-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."
...
steps:
    enable: true
    title_left: "Trinn for å signere Docx med Digital i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Docx-dokumenter med Digital-signaturer raskt og enkelt.
