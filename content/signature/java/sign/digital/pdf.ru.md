...
############################# Head ############################
head_title: "Добавление цифровых электронных подписей в файл Pdf с Java"
head_description: "Поместите цифровую подпись в файл Pdf для Java, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "eSign Pdf файлов с подписями Digital в Java"
...
steps:
    enable: true
    title_left: "Действия по подписанию Pdf с помощью Digital в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Pdf с подписями Digital.
