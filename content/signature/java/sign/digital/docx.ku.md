...
############################# Head ############################
head_title: "Zêdekirina îmzeyên elektronîkî yên dîjîtal li pelê Docx bi Java"
head_description: "Ji bo Java bi çend rêzikên kodê Îmzeya Dîjîtal bixin ser pelê Docx. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "eSign Docx pelên bi Digital di Java de"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Docx bi Digital di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Docx bi îmzeyên Digital zû û bi hêsanî peyda dike.
