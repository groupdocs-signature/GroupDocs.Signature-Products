...
############################# Head ############################
head_title: "إضافة التوقيعات الإلكترونية الرقمية إلى ملف Xls باستخدام Java"
head_description: "ضع التوقيع الرقمي على ملف Xls لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "ملفات eSign Xls ذات توقيعات Digital في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Xls باستخدام Digital في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Xls بتوقيعات Digital بسرعة وسهولة.
