...
############################# Head ############################
head_title: "Adding Digital electronic signatures to Tar file with Java"
head_description: "Put Digital Signature on Tar file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "eSign Tar files with Digital signatures in Java"
...
steps:
    enable: true
    title_left: "Steps to sign Tar with Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Tar documents with Digital signatures quickly and easily.
...
demos:
    enable: true
    title: "Signing Tar documents with Digital Live Demo"
    content: |
