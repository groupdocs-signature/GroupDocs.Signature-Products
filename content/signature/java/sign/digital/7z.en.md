...
############################# Head ############################
head_title: "Adding Digital electronic signatures to 7z file with Java"
head_description: "Put Digital Signature on 7z file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "eSign 7z files with Digital signatures in Java"
...
steps:
    enable: true
    title_left: "Steps to sign 7z with Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign 7z documents with Digital signatures quickly and easily.
...
demos:
    enable: true
    title: "Signing 7z documents with Digital Live Demo"
    content: |
