...
############################# Head ############################
head_title: "Bætir stafrænum rafrænum undirskriftum við 7z skrá með Java"
head_description: "Settu stafræna undirskrift á 7z skrá fyrir Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "eSign 7z skrár með Digital undirskriftum í Java"
...
steps:
    enable: true
    title_left: "Skref til að undirrita 7z með Digital í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita 7z skjöl með Digital undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar 7z skjöl með Digital lifandi kynningu"
    content: |
