...
############################# Head ############################
head_title: "Digitaalisten sähköisten allekirjoitusten lisääminen tiedostoon Ods ohjelmalla Java"
head_description: "Aseta digitaalinen allekirjoitus Ods-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "eSign Ods tiedostot Digital allekirjoituksella Java"
...
steps:
    enable: true
    title_left: "Vaiheet Ods:n allekirjoittamiseen Digital -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Ods-asiakirjoja Digital-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Ods asiakirjoja Digital Live-demolla"
    content: |
