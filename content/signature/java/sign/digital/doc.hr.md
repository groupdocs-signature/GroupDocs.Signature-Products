...
############################# Head ############################
head_title: "Dodavanje digitalnih elektroničkih potpisa u datoteku Doc s Java"
head_description: "Stavite digitalni potpis na datoteku Doc za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "eSign Doc datoteke s Digital potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Doc s Digital u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Doc dokumenata s Digital potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Doc dokumenata s Digital Live Demo"
    content: |
