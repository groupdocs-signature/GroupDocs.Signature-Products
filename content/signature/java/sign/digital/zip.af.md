...
############################# Head ############################
head_title: "Voeg digitale elektroniese handtekeninge by Zip-lêer met Java"
head_description: "Plaas digitale handtekening op Zip-lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "eSign Zip lêers met Digital handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Zip met Digital in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Zip dokumente met Digital handtekeninge vinnig en maklik te onderteken.
