...
############################# Head ############################
head_title: "使用 Java 将数字电子签名添加到 7z 文件"
head_description: "使用几行代码为 Java 的 7z 文件添加数字签名。使用 GroupDocs 文档签名 API 对数十种文件格式进行签名。"

############################# Header ############################
title: "在 Java 中使用 Digital 签名的 eSign 7z 文件"
...
steps:
    enable: true
    title_left: "在 Java 中使用 Digital 签署 7z 的步骤"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) 提供使用 Digital 签名快速轻松地签署 7z 文档的能力。
