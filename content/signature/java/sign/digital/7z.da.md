...
############################# Head ############################
head_title: "Tilføjelse af digitale elektroniske signaturer til filen 7z med Java"
head_description: "Sæt digital signatur på filen 7z for Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."
...
steps:
    enable: true
    title_left: "Trin til at signere 7z med Digital i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere 7z dokumenter med Digital signaturer hurtigt og nemt.
