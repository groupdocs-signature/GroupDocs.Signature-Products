...
############################# Head ############################
head_title: "Lägger till digitala elektroniska signaturer i filen Pptm med Java"
head_description: "Lägg digital signatur på filen Pptm för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "eSign Pptm-filer med Digital-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Pptm med Digital i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Pptm-dokument med Digital-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Pptm dokument med Digital Live Demo"
    content: |
