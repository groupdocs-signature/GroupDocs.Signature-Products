...
############################# Head ############################
head_title: "Adăugarea semnăturilor electronice digitale la fișierul Docx cu Java"
head_description: "Puneți semnătura digitală pe fișierul Docx pentru Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "eSign fișiere Docx cu semnături Digital în Java"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Docx cu Digital în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Docx cu semnături Digital rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Docx cu Digital Live Demo"
    content: |
