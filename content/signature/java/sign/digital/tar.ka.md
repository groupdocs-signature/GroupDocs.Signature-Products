...
############################# Head ############################
head_title: "ციფრული ელექტრონული ხელმოწერების დამატება Tar ფაილზე Java-ით"
head_description: "განათავსეთ ციფრული ხელმოწერა Tar ფაილზე Java კოდის რამდენიმე ხაზის გამოყენებით. გამოიყენეთ GroupDocs Document Signature API ათობით ფაილის ფორმატის ხელმოწერისთვის."

############################# Header ############################
title: "eSign Tar ფაილები Digital ხელმოწერებით Java-ში"
...
steps:
    enable: true
    title_left: "Tar-ით ხელმოწერის ნაბიჯები Digital-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Tar დოკუმენტები Digital ხელმოწერებით სწრაფად და მარტივად.
...
demos:
    enable: true
    title: "დოკუმენტების Tar ხელმოწერა Digital Live Demo-ით"
    content: |
