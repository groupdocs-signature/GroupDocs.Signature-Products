...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki 7z z Java"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko 7z za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign 7z s podpisi Digital v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis 7z z Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov 7z s podpisi Digital.
