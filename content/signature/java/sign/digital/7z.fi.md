...
############################# Head ############################
head_title: "Digitaalisten sähköisten allekirjoitusten lisääminen tiedostoon 7z ohjelmalla Java"
head_description: "Aseta digitaalinen allekirjoitus 7z-tiedostoon Java käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "eSign 7z tiedostot Digital allekirjoituksella Java"
...
steps:
    enable: true
    title_left: "Vaiheet 7z:n allekirjoittamiseen Digital -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa 7z-asiakirjoja Digital-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan 7z asiakirjoja Digital Live-demolla"
    content: |
