...
############################# Head ############################
head_title: "Digitālo elektronisko parakstu pievienošana failam Xlsx, izmantojot Java"
head_description: "Ievietojiet digitālo parakstu Xlsx failā Java, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "eSign Xlsx faili ar Digital parakstiem programmā Java"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Xlsx ar Digital programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Xlsx dokumentus ar Digital parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Xlsx parakstīšana, izmantojot Digital tiešraides demonstrāciju"
    content: |
