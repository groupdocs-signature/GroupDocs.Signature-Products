...
############################# Head ############################
head_title: "Добавяне на цифрови електронни подписи към файл 7z с Java"
head_description: "Поставете цифров подпис на файл 7z за Java, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature, за да подписвате десетки файлови формати."

############################# Header ############################
title: "eSign 7z файлове с Digital подписи в Java"
...
steps:
    enable: true
    title_left: "Стъпки за подписване на 7z с Digital в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на 7z документи с Digital подписи.
...
demos:
    enable: true
    title: "Подписване на 7z документи с Digital Демо на живо"
    content: |
