...
############################# Head ############################
head_title: "Pridanie digitálnych elektronických podpisov do súboru Tar pomocou Java"
head_description: "Vložte digitálny podpis do súboru Tar pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "eSign Tar súbory s Digital podpismi v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Tar pomocou Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Tar pomocou podpisov Digital.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Tar pomocou živej ukážky Digital"
    content: |
