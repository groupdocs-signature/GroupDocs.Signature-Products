...
############################# Head ############################
head_title: "Hinzufügen digitaler elektronischer Signaturen zur Ott-Datei mit Java"
head_description: "Fügen Sie der Ott-Datei für Java mit ein paar Codezeilen eine digitale Signatur hinzu. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "eSigniere Ott-Dateien mit Digital-Signaturen in Java"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Ott mit Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Ott-Dokumente mit Digital-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Ott-Dokumenten mit Digital Live-Demo"
    content: |
