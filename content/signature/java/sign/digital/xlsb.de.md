...
############################# Head ############################
head_title: "Hinzufügen von Digital-Signaturen zur Xlsb-Datei mit Java"
head_description: "Fügen Sie die Digital-Signatur in die Xlsb-Datei für Java ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Xlsb-Dateien mit Digital-Signaturen in Java"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Xlsb mit Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Xlsb-Dokumente mit Digital-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Xlsb-Dokumenten mit Digital Live-Demo"
    content: |
