...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Xlsm z Java"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Xlsm za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Xlsm s podpisi Digital v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Xlsm z Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Xlsm s podpisi Digital.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Xlsm z Digital Live Demo"
    content: |
