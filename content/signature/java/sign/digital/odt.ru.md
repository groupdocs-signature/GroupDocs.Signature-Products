...
############################# Head ############################
head_title: "Добавление цифровых электронных подписей в файл Odt с Java"
head_description: "Поместите цифровую подпись в файл Odt для Java, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "eSign Odt файлов с подписями Digital в Java"
...
steps:
    enable: true
    title_left: "Действия по подписанию Odt с помощью Digital в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Odt с подписями Digital.
...
demos:
    enable: true
    title: "Подписание Odt документов с помощью Digital Live Demo"
    content: |
