...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad Ods le Java"
head_description: "Cuir Síniú Digiteach ar chomhad Ods le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh Ods comhaid le Digital sínithe in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Ods a shíniú le Digital in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Ods a shíniú le sínithe Digital go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Ods doiciméad le Digital Taispeántas Beo"
    content: |
