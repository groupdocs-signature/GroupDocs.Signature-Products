...
############################# Head ############################
head_title: "Adding Digital electronic signatures to Zip file with Java"
head_description: "Put Digital Signature on Zip file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "eSign Zip files with Digital signatures in Java"
...
steps:
    enable: true
    title_left: "Steps to sign Zip with Digital in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Zip documents with Digital signatures quickly and easily.
...
demos:
    enable: true
    title: "Signing Zip documents with Digital Live Demo"
    content: |
