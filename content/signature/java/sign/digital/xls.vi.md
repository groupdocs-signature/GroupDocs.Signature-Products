...
############################# Head ############################
head_title: "Thêm chữ ký điện tử kỹ thuật số vào tệp Xls với Java"
head_description: "Đặt Chữ ký số vào tệp Xls cho Java bằng cách sử dụng một vài dòng mã. Sử dụng API chữ ký tài liệu GroupDocs để ký hàng chục định dạng tệp."

############################# Header ############################
title: "eSign các tệp Xls có chữ ký Digital trong Java"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Xls bằng Digital trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Xls bằng chữ ký Digital một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Xls bằng Digital Live Demo"
    content: |
