...
############################# Head ############################
head_title: "Dodawanie podpisów elektronicznych do pliku Ots za pomocą Java"
head_description: "Umieść podpis cyfrowy w pliku Ots dla Java, używając kilku linijek kodu. Użyj interfejsu GroupDocs Document Signature API, aby podpisać dziesiątki formatów plików."

############################# Header ############################
title: "eSign Ots pliki z podpisami Digital w Java"
...
steps:
    enable: true
    title_left: "Kroki do podpisania Ots za pomocą Digital w Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Ots za pomocą podpisów Digital.
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Ots za pomocą Digital Demo na żywo"
    content: |
