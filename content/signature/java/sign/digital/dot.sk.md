...
############################# Head ############################
head_title: "Pridanie digitálnych elektronických podpisov do súboru Dot pomocou Java"
head_description: "Vložte digitálny podpis do súboru Dot pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "eSign Dot súbory s Digital podpismi v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Dot pomocou Digital v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Dot pomocou podpisov Digital.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Dot pomocou živej ukážky Digital"
    content: |
