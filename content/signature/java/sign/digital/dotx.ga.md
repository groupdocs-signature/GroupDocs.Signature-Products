...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad Dotx le Java"
head_description: "Cuir Síniú Digiteach ar chomhad Dotx le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh Dotx comhaid le Digital sínithe in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Dotx a shíniú le Digital in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Dotx a shíniú le sínithe Digital go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Dotx doiciméad le Digital Taispeántas Beo"
    content: |
