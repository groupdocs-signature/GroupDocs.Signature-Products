...
############################# Head ############################
head_title: "Java ile Xltx dosyasına Dijital elektronik imza ekleme"
head_description: "Birkaç satır kod kullanarak Dijital İmzayı Java için Xltx dosyasına koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Digital imzalı Xltx dosyalarını imzalayın"
...
steps:
    enable: true
    title_left: "Java içinde Digital ile Xltx imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Xltx belgelerini Digital imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Xltx dokümanı Digital Canlı Demo ile imzalama"
    content: |
