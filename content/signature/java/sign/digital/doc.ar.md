...
############################# Head ############################
head_title: "إضافة التوقيعات الإلكترونية الرقمية إلى ملف Doc باستخدام Java"
head_description: "ضع التوقيع الرقمي على ملف Doc لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "ملفات eSign Doc ذات توقيعات Digital في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Doc باستخدام Digital في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Doc بتوقيعات Digital بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Doc باستخدام العرض التوضيحي المباشر Digital"
    content: |
