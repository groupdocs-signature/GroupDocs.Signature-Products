...
############################# Head ############################
head_title: "Adăugarea semnăturilor electronice digitale la fișierul Xlsm cu Java"
head_description: "Puneți semnătura digitală pe fișierul Xlsm pentru Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "eSign fișiere Xlsm cu semnături Digital în Java"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xlsm cu Digital în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Xlsm cu semnături Digital rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Xlsm cu Digital Live Demo"
    content: |
