...
############################# Head ############################
head_title: "Dodavanje digitalnih elektroničkih potpisa u datoteku Xlsm s Java"
head_description: "Stavite digitalni potpis na datoteku Xlsm za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "eSign Xlsm datoteke s Digital potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xlsm s Digital u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Xlsm dokumenata s Digital potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Xlsm dokumenata s Digital Live Demo"
    content: |
