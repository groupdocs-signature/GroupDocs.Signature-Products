...
############################# Head ############################
head_title: "Bætir stafrænum rafrænum undirskriftum við Xltx skrá með Java"
head_description: "Settu stafræna undirskrift á Xltx skrá fyrir Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "eSign Xltx skrár með Digital undirskriftum í Java"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Xltx með Digital í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Xltx skjöl með Digital undirskrift fljótt og auðveldlega.
