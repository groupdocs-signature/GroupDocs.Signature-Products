...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile 7z rakendusega Java"
head_description: "Sisestage digitaalallkiri toote Java failile 7z, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign 7z failid Digital allkirjaga rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud 7z allkirjastamiseks rakendusega Digital rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada 7z dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide 7z allkirjastamine Digital reaalajas demoga"
    content: |
