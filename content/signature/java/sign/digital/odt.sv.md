...
############################# Head ############################
head_title: "Lägger till digitala elektroniska signaturer i filen Odt med Java"
head_description: "Lägg digital signatur på filen Odt för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."
...
steps:
    enable: true
    title_left: "Steg för att signera Odt med Digital i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Odt-dokument med Digital-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Odt dokument med Digital Live Demo"
    content: |
