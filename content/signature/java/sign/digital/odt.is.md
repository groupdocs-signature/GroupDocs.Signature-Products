...
############################# Head ############################
head_title: "Bætir stafrænum rafrænum undirskriftum við Odt skrá með Java"
head_description: "Settu stafræna undirskrift á Odt skrá fyrir Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "eSign Odt skrár með Digital undirskriftum í Java"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Odt með Digital í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Odt skjöl með Digital undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Odt skjöl með Digital lifandi kynningu"
    content: |
