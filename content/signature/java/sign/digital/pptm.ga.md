...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad Pptm le Java"
head_description: "Cuir Síniú Digiteach ar chomhad Pptm le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh Pptm comhaid le Digital sínithe in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Pptm a shíniú le Digital in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Pptm a shíniú le sínithe Digital go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Pptm doiciméad le Digital Taispeántas Beo"
    content: |
