...
############################# Head ############################
head_title: "Adding Digital signatures in a Pptx file with Java"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Pptx files with Digital signatures using Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Pptx documents with Digital signatures quick and easily.
