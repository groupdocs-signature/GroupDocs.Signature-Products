...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad Pdf le Java"
head_description: "Cuir Síniú Digiteach ar chomhad Pdf le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh Pdf comhaid le Digital sínithe in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Pdf a shíniú le Digital in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Pdf a shíniú le sínithe Digital go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Pdf doiciméad le Digital Taispeántas Beo"
    content: |
