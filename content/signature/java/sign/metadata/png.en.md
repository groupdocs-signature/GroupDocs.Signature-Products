...
############################# Head ############################
head_title: "Append Metadata electronic signatures to Png documents via Java"
head_description: "Use Metadata as hidden electronic signatures inside your Png documents using a couple lines of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with Metadata information."

############################# Header ############################
title: "Metadata electronic signatures for Png document via Java are simple and easy for using!"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Png documents with Metadata signatures quickly and easily.
