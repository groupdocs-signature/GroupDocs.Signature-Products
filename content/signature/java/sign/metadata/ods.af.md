...
############################# Head ############################
head_title: "Voeg metadata elektroniese handtekeninge by Ods dokumente via Java"
head_description: "Gebruik Metadata as versteekte elektroniese handtekeninge binne jou Ods dokumente deur 'n paar reëls van Java kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en -lêers met Metadata-inligting te e-teken."

############################# Header ############################
title: "Metadata elektroniese handtekeninge vir Ods dokument via Java is eenvoudig en maklik om te gebruik!"
...
steps:
    enable: true
    title_left: "Stappe om Ods met Metadata in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Ods dokumente met Metadata handtekeninge vinnig en maklik te onderteken.
