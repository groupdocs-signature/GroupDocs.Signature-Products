...
############################# Head ############################
head_title: "Liitä metatietojen sähköiset allekirjoitukset Odp-asiakirjoihin Java:n kautta"
head_description: "Käytä metatietoja piilotettuina sähköisinä allekirjoituksina Odp-asiakirjoissasi käyttämällä pari riviä Java-koodia. Käytä GroupDocs Document Signature API:ta yrityksesi dokumenttien ja tiedostojen sähköiseen allekirjoittamiseen metatietotiedoilla."

############################# Header ############################
title: "Metatietojen sähköiset allekirjoitukset asiakirjalle Odp tuotteen Java kautta ovat yksinkertaisia ​​ja helppokäyttöisiä!"
...
steps:
    enable: true
    title_left: "Vaiheet Odp:n allekirjoittamiseen Metadata -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Odp-asiakirjoja Metadata-allekirjoituksella nopeasti ja helposti.
