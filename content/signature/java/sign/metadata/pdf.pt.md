...
############################# Head ############################
head_title: "Anexar assinaturas eletrônicas de metadados a documentos Pdf via Java"
head_description: "Use metadados como assinaturas eletrônicas ocultas dentro de seus documentos Pdf usando algumas linhas de código Java. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com informações de metadados."

############################# Header ############################
title: "Assinaturas eletrônicas de metadados para o documento Pdf via Java são simples e fáceis de usar!"
description: "Assine seus documentos e contratos Pdf com entradas de metadados ocultas. Gere metadados para PDFs, documentos do MS Word, pastas de trabalho do MS Excel, apresentações do MS PowerPoint e vários formatos de imagem sem problemas e codificação extra."
...
steps:
    enable: true
    title_left: "Etapas para assinar Pdf com Metadata em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Pdf com assinaturas Metadata de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Pdf documentos com Metadata Demonstração ao vivo"
    content: |
