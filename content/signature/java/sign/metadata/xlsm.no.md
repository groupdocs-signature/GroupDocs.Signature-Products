...
############################# Head ############################
head_title: "Legg til metadata elektroniske signaturer til Xlsm dokumenter via Java"
head_description: "Bruk Metadata som skjulte elektroniske signaturer i Xlsm-dokumentene dine ved å bruke et par linjer med Java-kode. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med metadatainformasjon."

############################# Header ############################
title: "Metadata elektroniske signaturer for Xlsm dokument via Java er enkle og enkle å bruke!"
description: "eSigner Xlsm-dokumentene og kontraktene dine med skjulte metadataoppføringer. Generer metadata for PDF-er, MS Word-dokumenter, MS Excel-arbeidsbøker, MS PowerPoint-presentasjoner og ulike bildeformater uten problemer og ekstra koding."
...
steps:
    enable: true
    title_left: "Trinn for å signere Xlsm med Metadata i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Xlsm-dokumenter med Metadata-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Xlsm dokumenter med Metadata Live Demo"
    content: |
