...
############################# Head ############################
head_title: "Dodajte elektronske podpise metapodatkov dokumentom Docm prek Java"
head_description: "Uporabite metapodatke kot skrite elektronske podpise znotraj svojih dokumentov Docm z nekaj vrsticami kode Java. Uporabite API za podpis dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek z informacijami o metapodatkih."

############################# Header ############################
title: "Elektronski podpisi metapodatkov za dokument Docm preko Java so preprosti in enostavni za uporabo!"
description: "e-Podpišite svoje Docm dokumente in pogodbe s skritimi vnosi metapodatkov. Ustvarite metapodatke za PDF-je, dokumente MS Word, delovne zvezke MS Excel, predstavitve MS PowerPoint in različne formate slik brez težav in dodatnega kodiranja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Docm z Metadata v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Docm s podpisi Metadata.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Docm z Metadata Live Demo"
    content: |
