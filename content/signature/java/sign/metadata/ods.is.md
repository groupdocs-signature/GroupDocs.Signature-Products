...
############################# Head ############################
head_title: "Bættu rafrænum undirskriftum lýsigagna við Ods skjöl í gegnum Java"
head_description: "Notaðu Lýsigögn sem falin rafræn undirskrift í Ods skjölunum þínum með því að nota nokkrar línur af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með upplýsingum um lýsigögn."

############################# Header ############################
title: "Rafrænar undirskriftir með lýsigögnum fyrir Ods skjal í gegnum Java eru einfaldar og auðveldar í notkun!"
description: "eSignaðu Ods skjölin þín og samninga með földum lýsigagnafærslum. Búðu til lýsigögn fyrir PDF skjöl, MS Word skjöl, MS Excel vinnubækur, MS PowerPoint kynningar og ýmis myndsnið án vandræða og aukakóðun."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Ods með Metadata í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Ods skjöl með Metadata undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Ods skjöl með Metadata lifandi kynningu"
    content: |
