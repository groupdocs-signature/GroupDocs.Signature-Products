...
############################# Head ############################
head_title: "Voeg elektronische handtekeningen met metagegevens toe aan Xls documenten via Java"
head_description: "Gebruik metadata als verborgen elektronische handtekeningen in uw Xls-documenten met een paar regels Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met metadata-informatie."

############################# Header ############################
title: "Metadata elektronische handtekeningen voor Xls document via Java zijn eenvoudig en gemakkelijk te gebruiken!"
...
steps:
    enable: true
    title_left: "Stappen om Xls te ondertekenen met Metadata in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Xls documenten snel en gemakkelijk te ondertekenen met Metadata handtekeningen.
