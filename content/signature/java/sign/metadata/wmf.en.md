...
############################# Head ############################
head_title: "Append Metadata electronic signatures to the Wmf documents via Java"
head_description: "Use Metadata as hidden electronic signatures incide the Wmf documents for Java using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with Metadata information."
