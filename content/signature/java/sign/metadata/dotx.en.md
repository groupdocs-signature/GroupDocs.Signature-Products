...
############################# Head ############################
head_title: "Append Metadata electronic signatures to Dotx documents via Java"
head_description: "Use Metadata as hidden electronic signatures inside your Dotx documents using a couple lines of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with Metadata information."

############################# Header ############################
title: "Metadata electronic signatures for Dotx document via Java are simple and easy for using!"
description: "eSign your Dotx documents and contracts with hidden Metadata entries. Generate Metadata for PDFs, MS Word documents, MS Excel workbooks, MS PowerPoint presentations and various image formats with no problems and extra coding."
...
steps:
    enable: true
    title_left: "Steps to sign Dotx with Metadata in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Dotx documents with Metadata signatures quickly and easily.
