...
steps:
    enable: true
    title_left: "Действия по подписанию Svg с помощью Metadata в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Svg с подписями Metadata.
