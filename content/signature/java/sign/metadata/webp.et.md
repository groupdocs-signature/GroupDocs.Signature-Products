...
############################# Head ############################
head_title: "Lisage metaandmete elektroonilised allkirjad Webp dokumentidele Java kaudu"
head_description: "Kasutage metaandmeid peidetud elektrooniliste allkirjadena oma Webp dokumentides, kasutades paari rida Java koodi. Kasutage GroupDocs Document Signature API-t, et oma äridokumente ja -faile metaandmetega e-allkirjastada."

############################# Header ############################
title: "Dokumendi Webp metaandmete elektroonilised allkirjad toote Java kaudu on lihtsad ja hõlpsasti kasutatavad!"
description: "eAllkirjasta oma Webp dokumendid ja lepingud peidetud metaandmete kirjetega. Genereerige metaandmeid PDF-ide, MS Wordi dokumentide, MS Exceli töövihikute, MS PowerPointi esitluste ja erinevate pildivormingute jaoks ilma probleemide ja täiendava kodeerimiseta."
...
steps:
    enable: true
    title_left: "Toimingud Webp allkirjastamiseks rakendusega Metadata rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Webp dokumente Metadata allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Webp allkirjastamine Metadata reaalajas demoga"
    content: |
