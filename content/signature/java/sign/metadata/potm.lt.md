...
############################# Head ############################
head_title: "Pridėkite metaduomenų elektroninius parašus prie Potm dokumentų per Java"
head_description: "Naudokite metaduomenis kaip paslėptus elektroninius parašus savo Potm dokumentuose naudodami kelias Java kodo eilutes. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus su metaduomenų informacija."

############################# Header ############################
title: "Dokumento Potm metaduomenų elektroniniai parašai naudojant Java yra paprasti ir lengvai naudojami!"
description: "e. Pasirašykite savo Potm dokumentus ir sutartis su paslėptais metaduomenų įrašais. Kurkite PDF, MS Word dokumentų, MS Excel darbaknygių, MS PowerPoint pristatymų ir įvairių vaizdo formatų metaduomenis be problemų ir papildomo kodavimo."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Potm naudojant Metadata programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Potm dokumentus su Metadata parašais.
...
demos:
    enable: true
    title: "Dokumentų Potm pasirašymas naudojant Metadata tiesioginę demonstraciją"
    content: |
