...
############################# Head ############################
head_title: "Append Metadata electronic signatures to Ods documents via Java"
head_description: "Use Metadata as hidden electronic signatures inside your Ods documents using a couple lines of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with Metadata information."

############################# Header ############################
title: "Metadata electronic signatures for Ods document via Java are simple and easy for using!"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Ods documents with Metadata signatures quickly and easily.
