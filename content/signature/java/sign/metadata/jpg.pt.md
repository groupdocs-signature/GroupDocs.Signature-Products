...
############################# Head ############################
head_title: "Anexar assinaturas eletrônicas de metadados a documentos Jpg via Java"
head_description: "Use metadados como assinaturas eletrônicas ocultas dentro de seus documentos Jpg usando algumas linhas de código Java. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com informações de metadados."

############################# Header ############################
title: "Assinaturas eletrônicas de metadados para o documento Jpg via Java são simples e fáceis de usar!"
...
steps:
    enable: true
    title_left: "Etapas para assinar Jpg com Metadata em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Jpg com assinaturas Metadata de forma rápida e fácil.
