...
steps:
    enable: true
    title_left: "Pasos para firmar Gif con Metadata en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Gif con Metadata firmas de forma rápida y sencilla.
