...
############################# Head ############################
head_title: "Pridėkite metaduomenų elektroninius parašus prie Xltx dokumentų per Java"
head_description: "Naudokite metaduomenis kaip paslėptus elektroninius parašus savo Xltx dokumentuose naudodami kelias Java kodo eilutes. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus su metaduomenų informacija."

############################# Header ############################
title: "Dokumento Xltx metaduomenų elektroniniai parašai naudojant Java yra paprasti ir lengvai naudojami!"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Xltx naudojant Metadata programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Xltx dokumentus su Metadata parašais.
