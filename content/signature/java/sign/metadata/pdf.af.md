...
############################# Head ############################
head_title: "Voeg metadata elektroniese handtekeninge by Pdf dokumente via Java"
...
############################# Header ############################
title: "Metadata elektroniese handtekeninge vir Pdf dokument via Java is eenvoudig en maklik om te gebruik!"
...
steps:
    enable: true
    title_left: "Stappe om Pdf met Metadata in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Pdf dokumente met Metadata handtekeninge vinnig en maklik te onderteken.
