...
############################# Head ############################
head_title: "Pievienojiet metadatu elektroniskos parakstus Ods dokumentiem, izmantojot Java"
head_description: "Izmantojiet metadatus kā slēptos elektroniskos parakstus savos Ods dokumentos, izmantojot dažas Java koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar metadatu informāciju."

############################# Header ############################
title: "Metadatu elektroniskie paraksti dokumentam Ods, izmantojot Java, ir vienkārši un ērti lietojami!"
description: "eParakstiet savus Ods dokumentus un līgumus ar slēptiem metadatu ierakstiem. Ģenerējiet metadatus PDF failiem, MS Word dokumentiem, MS Excel darbgrāmatām, MS PowerPoint prezentācijām un dažādiem attēlu formātiem bez problēmām un papildu kodēšanas."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Ods ar Metadata programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Ods dokumentus ar Metadata parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Ods parakstīšana, izmantojot Metadata tiešraides demonstrāciju"
    content: |
