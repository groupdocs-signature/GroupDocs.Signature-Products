...
############################# Head ############################
head_title: "Připojte elektronické podpisy metadat k dokumentům Docm prostřednictvím Java"
head_description: "Použijte metadata jako skryté elektronické podpisy ve svých dokumentech Docm pomocí několika řádků kódu Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí metadat."

############################# Header ############################
title: "Elektronické podpisy metadat pro dokument Docm prostřednictvím Java jsou jednoduché a snadno se používají!"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Docm pomocí Metadata v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Docm pomocí podpisů Metadata.
