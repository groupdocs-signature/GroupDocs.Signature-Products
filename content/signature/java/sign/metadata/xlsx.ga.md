...
############################# Head ############################
head_title: "Cuir sínithe leictreonacha Meiteashonraí i gceangal le doiciméid Xlsx trí Java"
head_description: "Úsáid Meiteashonraí mar shínithe leictreonacha folaithe i do dhoiciméid Xlsx ag baint úsáide as cúpla líne de chód Java. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid ghnó agus do chomhaid a ríomhshíniú le faisnéis Meiteashonraí."

############################# Header ############################
title: "Tá sínithe leictreonacha meiteashonraí do dhoiciméad Xlsx trí Java simplí agus éasca le húsáid!"
description: "eSigh do dhoiciméid agus do chonarthaí Xlsx le hiontrálacha Meiteashonraí folaithe. Gin Meiteashonraí do PDFs, doiciméid MS Word, leabhair oibre MS Excel, cur i láthair MS PowerPoint agus formáidí íomhá éagsúla gan aon fhadhbanna agus códú breise."
...
steps:
    enable: true
    title_left: "Céimeanna chun Xlsx a shíniú le Metadata in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Xlsx a shíniú le sínithe Metadata go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Xlsx doiciméad le Metadata Taispeántas Beo"
    content: |
