...
############################# Head ############################
head_title: "Dodajte elektroničke potpise metapodataka Potx dokumentima putem Java"
head_description: "Koristite metapodatke kao skrivene elektroničke potpise unutar svojih Potx dokumenata pomoću nekoliko redaka Java koda. Upotrijebite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka s informacijama o metapodacima."

############################# Header ############################
title: "Elektronički potpisi metapodataka za Potx dokument putem Java jednostavni su i laki za korištenje!"
description: "ePotpišite svoje Potx dokumente i ugovore sa skrivenim unosima metapodataka. Generirajte metapodatke za PDF-ove, MS Word dokumente, MS Excel radne knjige, MS PowerPoint prezentacije i razne formate slika bez problema i dodatnog kodiranja."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Potx s Metadata u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Potx dokumenata s Metadata potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Potx dokumenata s Metadata Live Demo"
    content: |
