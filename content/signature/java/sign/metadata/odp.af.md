...
############################# Head ############################
head_title: "Voeg metadata elektroniese handtekeninge by Odp dokumente via Java"
...
############################# Header ############################
title: "Metadata elektroniese handtekeninge vir Odp dokument via Java is eenvoudig en maklik om te gebruik!"
...
steps:
    enable: true
    title_left: "Stappe om Odp met Metadata in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Odp dokumente met Metadata handtekeninge vinnig en maklik te onderteken.
