...
############################# Head ############################
head_title: "Připojte elektronické podpisy metadat k dokumentům Pdf prostřednictvím Java"
head_description: "Použijte metadata jako skryté elektronické podpisy ve svých dokumentech Pdf pomocí několika řádků kódu Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí metadat."

############################# Header ############################
title: "Elektronické podpisy metadat pro dokument Pdf prostřednictvím Java jsou jednoduché a snadno se používají!"
description: "ePodepište své dokumenty a smlouvy Pdf se skrytými položkami metadat. Vytvářejte metadata pro soubory PDF, dokumenty MS Word, sešity MS Excel, prezentace MS PowerPoint a různé formáty obrázků bez problémů a navíc s kódováním."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Pdf pomocí Metadata v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Pdf pomocí podpisů Metadata.
...
demos:
    enable: true
    title: "Podepisování dokumentů Pdf pomocí živé ukázky Metadata"
    content: |
