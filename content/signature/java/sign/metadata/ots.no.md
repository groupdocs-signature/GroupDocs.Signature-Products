...
############################# Head ############################
head_title: "Legg til metadata elektroniske signaturer til Ots dokumenter via Java"
head_description: "Bruk Metadata som skjulte elektroniske signaturer i Ots-dokumentene dine ved å bruke et par linjer med Java-kode. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med metadatainformasjon."

############################# Header ############################
title: "Metadata elektroniske signaturer for Ots dokument via Java er enkle og enkle å bruke!"
description: "eSigner Ots-dokumentene og kontraktene dine med skjulte metadataoppføringer. Generer metadata for PDF-er, MS Word-dokumenter, MS Excel-arbeidsbøker, MS PowerPoint-presentasjoner og ulike bildeformater uten problemer og ekstra koding."
...
steps:
    enable: true
    title_left: "Trinn for å signere Ots med Metadata i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Ots-dokumenter med Metadata-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Ots dokumenter med Metadata Live Demo"
    content: |
