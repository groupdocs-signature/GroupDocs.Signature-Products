...
############################# Head ############################
head_title: "إلحاق التوقيعات الإلكترونية للبيانات الوصفية بمستندات Pps عبر Java"
head_description: "استخدم البيانات الوصفية كتوقيعات إلكترونية مخفية داخل مستندات Pps باستخدام سطرين من كود Java. استخدم GroupDocs Document Signature API للتوقيع الإلكتروني على مستندات العمل والملفات باستخدام معلومات البيانات الوصفية."

############################# Header ############################
title: "تعد التوقيعات الإلكترونية للبيانات الوصفية لمستند Pps عبر Java بسيطة وسهلة الاستخدام!"
description: "قم بتوقيع مستنداتك وعقود Pps باستخدام إدخالات البيانات الوصفية المخفية. قم بإنشاء بيانات وصفية لملفات PDF ومستندات MS Word ومصنفات MS Excel وعروض MS PowerPoint التقديمية وتنسيقات صور متنوعة بدون مشاكل وترميز إضافي."
...
steps:
    enable: true
    title_left: "خطوات تسجيل Pps باستخدام Metadata في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Pps بتوقيعات Metadata بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Pps باستخدام العرض التوضيحي المباشر Metadata"
    content: |
