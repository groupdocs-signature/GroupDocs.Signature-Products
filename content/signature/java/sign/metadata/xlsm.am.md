...
############################# Head ############################
head_title: "ሜታዳታ ኤሌክትሮኒካዊ ፊርማዎችን ወደ Xlsm ሰነዶች በJava በኩል ጨምር"
head_description: "የJava ኮድ ሁለት መስመሮችን በመጠቀም በXlsm ሰነዶችዎ ውስጥ ዲበ ውሂብን እንደ የተደበቀ ኤሌክትሮኒክ ፊርማ ይጠቀሙ። የንግድ ሰነዶችዎን እና ፋይሎችዎን በሜታዳታ መረጃ ለመፈረም የቡድንDocs ሰነድ ፊርማ ኤፒአይ ይጠቀሙ።"

############################# Header ############################
title: "የዲበ ውሂብ ኤሌክትሮኒክ ፊርማዎች ለXlsm ሰነድ በJava በኩል ቀላል እና ለመጠቀም ቀላል ናቸው!"
...
steps:
    enable: true
    title_left: "Xlsmን በMetadata በJava ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የXlsm ሰነዶችን በMetadata ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
