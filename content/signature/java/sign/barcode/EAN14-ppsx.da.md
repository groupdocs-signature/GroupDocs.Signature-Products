...
############################# Head ############################
head_title: "eSign Ppsx dokument med E A N14 stregkode i Java"
head_description: "Opret E A N14 stregkodesignatur og læg den på Ppsx dokument med Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer E A N14 Stregkodesignatur for Ppsx dokument i Java"
description: "eSignér dine Ppsx forretningsdokumenter med E A N14 stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
steps:
    enable: true
    title_left: "Trin til at signere Ppsx med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Ppsx dokumenter med Barcode signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Ppsx dokumenter med Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Europæisk artikelnummer eller EAN er en standard, der beskriver en stregkodesymbologi og et nummereringssystem, der bruges i global handel til at identificere en specifik detailprodukttype, i en specifik emballagekonfiguration, fra en specifik producent.
          characterset: |
             Numeriske cifre (0-9) og specialtegn.
          textcapacity: |
             Præcis 14 numeriske cifre.
          image: |
