...
############################# Head ############################
head_title: "eSign Otp document avec UPCE Barcode in Java"
head_description: "Créez UPCE Barcode Signature et placez-le sur le document Otp avec Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres UPCE pour le document Otp dans Java"
description: "Signez électroniquement vos documents commerciaux Otp avec UPCE Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
...
steps:
    enable: true
    title_left: "Étapes pour signer Otp avec Barcode dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Otp avec des signatures Barcode.
...
demos:
    enable: true
    title: "Signature de documents Otp avec Barcode Live Demo"
    content: |
