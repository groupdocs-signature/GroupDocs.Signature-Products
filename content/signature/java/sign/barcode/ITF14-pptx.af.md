...
############################# Head ############################
head_title: "eSign Pptx-dokument met I T F14 Strepiekode in Java"
head_description: "Skep I T F14 Strepiekode Handtekening en plaas dit op Pptx dokument met Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer I T F14 strepieskode-handtekening vir Pptx-dokument in Java"
description: "eTeken jou Pptx besigheidsdokumente met I T F14 Streepkode. Genereer strepieskode-handtekening vinnig en maklik met 'n paar reëls kode om ondertekenopsies op te stel."
...
steps:
    enable: true
    title_left: "Stappe om Pptx met Barcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Pptx dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 is die GS1-implementering van 'n Interleaved 2 of 5 (ITF) strepieskode om 'n Global Trade Item Number te enkodeer.
          characterset: |
             Numeriese syfers (0-9).
          textcapacity: |
             13 syfers + 1 kontrolesyfer.
          image: |
