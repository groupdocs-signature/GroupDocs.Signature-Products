...
############################# Head ############################
head_title: "وثيقة eSign Xlsb مع Interleaved2of5 رمز شريطي في Java"
head_description: "أنشئ Interleaved2of5 Barcode Signature وضعه في مستند Xlsb باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Interleaved2of5 توقيع الرمز الشريطي للمستند Xlsb في Java"
description: "قم بتوقيع Xlsb على مستندات الأعمال باستخدام الرمز الشريطي Interleaved2of5. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
