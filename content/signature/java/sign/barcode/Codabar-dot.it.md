...
############################# Head ############################
head_title: "eSign Dot documento con codice a barre Codabar in Java"
head_description: "Crea Codabar Firma codice a barre e inseriscilo nel documento Dot con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Codabar firma del codice a barre per il documento Dot in Java"
description: "Firma elettronicamente i tuoi documenti aziendali Dot con il codice a barre Codabar. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codabar è una simbologia di codici a barre lineare progettata per essere letta con precisione anche quando viene stampata su stampanti a matrice di punti per moduli multi-parte come fatture aeree FedEx e moduli di banca del sangue.
          characterset: |
