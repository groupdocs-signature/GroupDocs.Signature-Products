...
############################# Head ############################
head_title: "Document electrònic Docx amb codi de barres E A N13 a Java"
head_description: "Creeu la signatura de codi de barres E A N13 i poseu-la al document Docx amb Java utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu E A N13 signatura de codi de barres per al document Docx a Java"
description: "eSigne els vostres documents comercials de Docx amb el codi de barres E A N13. Genereu la signatura de codi de barres de manera ràpida i senzilla amb unes poques línies de codi per configurar les opcions de signatura."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            L'estàndard EAN més utilitzat és l'EAN-13 de tretze dígits, un superconjunt de l'estàndard original del codi de producte universal de 12 dígits.
          characterset: |
             Només dígits numèrics (0-9).
          textcapacity: |
             Capacitat del text en codi: exactament 12 dígits + 1 dígit de verificació.
          image: |
