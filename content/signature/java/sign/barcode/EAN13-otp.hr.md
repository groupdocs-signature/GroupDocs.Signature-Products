...
############################# Head ############################
head_title: "eSign Otp dokument s E A N13 crtičnim kodom u Java"
head_description: "Stvorite E A N13 potpis crtičnog koda i stavite ga na Otp dokument s Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje različitih formata datoteka."

############################# Header ############################
title: "Generirajte E A N13 potpis crtičnog koda za Otp dokument u Java"
description: "ePotpišite svoje Otp poslovne dokumente pomoću E A N13 crtičnog koda. Brzo i jednostavno generirajte potpis crtičnog koda s nekoliko redaka koda za postavljanje opcija potpisivanja."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Otp s Barcode u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Otp dokumenata s Barcode potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Otp dokumenata s Barcode Live Demo"
    content: |
