...
############################# Head ############################
head_title: "eSign Dotx-dokument met UPCA Strepiekode in Java"
head_description: "Skep UPCA Strepiekode Handtekening en plaas dit op Dotx dokument met Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer UPCA strepieskode-handtekening vir Dotx-dokument in Java"
description: "eTeken jou Dotx besigheidsdokumente met UPCA Streepkode. Genereer strepieskode-handtekening vinnig en maklik met 'n paar reëls kode om ondertekenopsies op te stel."
...
steps:
    enable: true
    title_left: "Stappe om Dotx met Barcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Dotx dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Dotx dokumente met Barcode Regstreekse Demo"
    content: |
