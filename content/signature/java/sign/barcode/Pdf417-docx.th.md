...
############################# Head ############################
head_title: "eSign Docx เอกสารด้วยบาร์โค้ด Pdf417 ใน Java"
head_description: "สร้าง Pdf417 Barcode Signature และใส่ลงในเอกสาร Docx ด้วย Java โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API สำหรับการลงนามรูปแบบไฟล์ต่างๆ"

############################# Header ############################
title: "สร้าง Pdf417 ลายเซ็นบาร์โค้ดสำหรับเอกสาร Docx ใน Java"
description: "eSign เอกสารทางธุรกิจ Docx ของคุณด้วยบาร์โค้ด Pdf417 สร้างลายเซ็นบาร์โค้ดอย่างรวดเร็วและง่ายดายด้วยรหัสสองสามบรรทัดเพื่อตั้งค่าตัวเลือกการเซ็นชื่อ"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 เป็นรูปแบบบาร์โค้ดเชิงเส้นแบบเรียงซ้อนที่ใช้ในแอปพลิเคชันต่างๆ เช่น การขนส่ง บัตรประจำตัว และการจัดการสินค้าคงคลัง
          characterset: |
