...
steps:
    ...
    code: |
        ...
        options.setEncodeType(BarcodeTypes.DEUTSCHEPOSTLEITCODE);
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with DEUTSCHEPOSTLEITCODE BARCODE using Java"
    content: |
        Java DEUTSCHEPOSTLEITCODE BARCODE signatures management API for documents and images. Add DEUTSCHEPOSTLEITCODE BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
