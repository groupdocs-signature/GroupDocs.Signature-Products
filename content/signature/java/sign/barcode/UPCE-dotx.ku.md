...
############################# Head ############################
head_title: "eSign Dotx belgeya bi UPCE Barcode di Java"
head_description: "Îmzeya barkodê ya UPCE biafirîne û bi çend rêzikên kodê bi Java li ser belgeya Dotx biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."

############################# Header ############################
title: "Di Java de ji bo belgeya UPCE îmzeya barkodê çêbike"
description: "Belgeyên karsaziya xwe yên Dotx bi UPCE Barkodê îmze bikin. Bi çend rêzikên kodê re zû û bi hêsanî îmzeya Barkodê biafirînin da ku vebijarkên îmzekirinê saz bikin."
