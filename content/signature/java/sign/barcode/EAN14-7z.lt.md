...
############################# Head ############################
head_title: "eSign 7z dokumentas su E A N14 brūkšniniu kodu Java"
head_description: "Sukurkite E A N14 brūkšninio kodo parašą ir įdėkite jį į 7z dokumentą su Java naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite E A N14 brūkšninio kodo parašą 7z dokumentui Java"
description: "e. Pasirašykite 7z verslo dokumentus naudodami E A N14 brūkšninį kodą. Greitai ir lengvai sugeneruokite brūkšninio kodo parašą naudodami kelias kodo eilutes, kad nustatytumėte pasirašymo parinktis."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti 7z naudojant Barcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti 7z dokumentus su Barcode parašais.
...
demos:
    enable: true
    title: "Dokumentų 7z pasirašymas naudojant Barcode tiesioginę demonstraciją"
    content: |
