...
############################# Head ############################
head_title: "Java içinde E A N14 Barkodlu eSign Odp belgesi"
head_description: "E A N14 Barkod İmzası oluşturun ve birkaç satır kod kullanarak Java ile Odp belgesine koyun. Çeşitli dosya biçimlerini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Odp belgesi için E A N14 Barkod imzası oluşturun"
description: "Odp iş belgelerinizi E A N14 Barkod ile e-imzalayın. İmzalama seçeneklerini ayarlamak için birkaç satır kodla hızlı ve kolay bir şekilde Barkod imzası oluşturun."
...
steps:
    enable: true
    title_left: "Java içinde Barcode ile Odp imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Odp belgelerini Barcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Odp dokümanı Barcode Canlı Demo ile imzalama"
    content: |
