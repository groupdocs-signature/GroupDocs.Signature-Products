...
############################# Head ############################
head_title: "Dokument eSign Ppsm s čárovým kódem E A N14 v Java"
head_description: "Vytvořte podpis čárového kódu E A N14 a vložte jej do dokumentu Ppsm s Java pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu E A N14 pro dokument Ppsm v Java"
description: "ePodepište své obchodní dokumenty ve formátu Ppsm pomocí čárového kódu E A N14. Vygenerujte podpis čárového kódu rychle a snadno pomocí několika řádků kódu pro nastavení možností podepisování."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Ppsm pomocí Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Ppsm pomocí podpisů Barcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Ppsm pomocí živé ukázky Barcode"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            European Article Number neboli EAN je standard popisující symboliku čárového kódu a systém číslování používaný v celosvětovém obchodu k identifikaci konkrétního typu maloobchodního produktu ve specifické konfiguraci balení od konkrétního výrobce.
          characterset: |
             Číslice (0-9) a speciální znaky.
          textcapacity: |
             Přesně 14 číslic.
          image: |
