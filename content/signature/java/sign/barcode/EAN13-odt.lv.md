...
############################# Head ############################
head_title: "eSign Odt dokuments ar E A N13 svītrkodu programmā Java"
head_description: "Izveidojiet E A N13 svītrkoda parakstu un ievietojiet to Odt dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt E A N13 svītrkoda parakstu dokumentam Odt programmā Java"
description: "eParakstiet savus Odt biznesa dokumentus, izmantojot E A N13 svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Odt ar Barcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Odt dokumentus ar Barcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Odt parakstīšana, izmantojot Barcode tiešraides demonstrāciju"
    content: |
