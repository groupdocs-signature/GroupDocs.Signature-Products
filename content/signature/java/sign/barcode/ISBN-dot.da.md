...
############################# Head ############################
head_title: "eSign Dot dokument med ISBN stregkode i Java"
head_description: "Opret ISBN stregkodesignatur og læg den på Dot dokument med Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer ISBN Stregkodesignatur for Dot dokument i Java"
description: "eSignér dine Dot forretningsdokumenter med ISBN stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
steps:
    enable: true
    title_left: "Trin til at signere Dot med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Dot dokumenter med Barcode signaturer hurtigt og nemt.
