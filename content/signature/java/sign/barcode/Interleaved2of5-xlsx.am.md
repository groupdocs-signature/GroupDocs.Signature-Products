...
############################# Head ############################
head_title: "eSign Xlsx ሰነድ በInterleaved2of5 ባርኮድ በJava"
head_description: "የInterleaved2of5 ባርኮድ ፊርማ ይፍጠሩ እና በXlsx ሰነድ ላይ በJava ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለXlsx ሰነድ የInterleaved2of5 ባርኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Xlsx የንግድ ሰነዶች በInterleaved2of5 ባርኮድ ይመዝገቡ። የመመዝገቢያ አማራጮችን ለማዘጋጀት የባርኮድ ፊርማ በፍጥነት እና በቀላሉ በጥቂት የኮድ መስመሮች ይፍጠሩ።"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የXlsx ሰነዶችን በBarcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
...
demos:
    enable: true
    title: "Xlsx ሰነዶችን በBarcode ቀጥታ ማሳያ በመፈረም ላይ"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            የተጠላለፉ 2 ከ 5 (አይቲኤፍ) ቀጣይነት ያለው ባለ ሁለት ስፋት የአሞሌ ኮድ ምልክት አሃዞችን መመሳጠር ነው። በ135 ፊልም፣ ለአይቲኤፍ-14 ባርኮድ እና በአንዳንድ ምርቶች ካርቶን ላይ ለገበያ የሚውል ሲሆን በውስጡ ያሉት ምርቶች በ UPC ወይም EAN ተለጥፈዋል።
          characterset: |
             የቁጥር አሃዞች (0-9)።
          textcapacity: |
             ተለዋዋጭ ርዝመት.
