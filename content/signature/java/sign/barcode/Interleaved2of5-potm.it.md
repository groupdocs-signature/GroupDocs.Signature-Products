...
############################# Head ############################
head_title: "eSign Potm documento con codice a barre Interleaved2of5 in Java"
head_description: "Crea Interleaved2of5 Firma codice a barre e inseriscilo nel documento Potm con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Interleaved2of5 firma del codice a barre per il documento Potm in Java"
description: "Firma elettronicamente i tuoi documenti aziendali Potm con il codice a barre Interleaved2of5. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Potm con Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Potm con firme Barcode in modo rapido e semplice.
...
demos:
    enable: true
    title: "Firma di documenti Potm con Barcode Demo live"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Interleaved 2 of 5 (ITF) è una simbologia di codici a barre a doppia larghezza continua che codifica le cifre. Viene utilizzato commercialmente su film 135, per codici a barre ITF-14 e su cartoni di alcuni prodotti, mentre i prodotti all'interno sono etichettati con UPC o EAN.
          characterset: |
             Cifre numeriche (0-9).
          textcapacity: |
             Lunghezza variabile.
