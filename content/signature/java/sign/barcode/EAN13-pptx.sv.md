...
############################# Head ############################
head_title: "eSign Pptx dokument med E A N13 streckkod i Java"
head_description: "Skapa E A N13 streckkodsignatur och lägg den på Pptx dokument med Java med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera E A N13 streckkodsignatur för Pptx dokument i Java"
description: "esignera dina Pptx affärsdokument med E A N13 streckkod. Skapa streckkodsignatur snabbt och enkelt med några rader kod för att ställa in signeringsalternativ."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Den vanligaste EAN-standarden är den trettonsiffriga EAN-13, en supplering av den ursprungliga 12-siffriga Universal Product Code-standarden.
          characterset: |
             Endast numeriska siffror (0-9).
          textcapacity: |
             Kodtextkapacitet: exakt 12 siffror + 1 kontrollsiffra.
          image: |
