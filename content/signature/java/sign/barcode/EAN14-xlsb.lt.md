...
############################# Head ############################
head_title: "eSign Xlsb dokumentas su E A N14 brūkšniniu kodu Java"
head_description: "Sukurkite E A N14 brūkšninio kodo parašą ir įdėkite jį į Xlsb dokumentą su Java naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite E A N14 brūkšninio kodo parašą Xlsb dokumentui Java"
description: "e. Pasirašykite Xlsb verslo dokumentus naudodami E A N14 brūkšninį kodą. Greitai ir lengvai sugeneruokite brūkšninio kodo parašą naudodami kelias kodo eilutes, kad nustatytumėte pasirašymo parinktis."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Xlsb naudojant Barcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Xlsb dokumentus su Barcode parašais.
...
demos:
    enable: true
    title: "Dokumentų Xlsb pasirašymas naudojant Barcode tiesioginę demonstraciją"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Europos gaminio numeris arba EAN yra standartas, apibūdinantis brūkšninio kodo simboliką ir numeravimo sistemą, naudojamą pasaulinėje prekyboje, siekiant identifikuoti konkretų mažmeninės prekybos produkto tipą, tam tikros pakuotės konfigūraciją, iš konkretaus gamintojo.
          characterset: |
             Skaitmeniniai skaitmenys (0–9) ir specialieji simboliai.
          textcapacity: |
             Tiksliai 14 skaitmeninių skaitmenų.
          image: |
