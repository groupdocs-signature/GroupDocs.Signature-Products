...
############################# Head ############################
head_title: "eSign Pps dokument s E A N14 čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu E A N14 a vložte ho do dokumentu Pps s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte E A N14 podpis čiarového kódu pre dokument Pps v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Pps pomocou čiarového kódu E A N14. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Pps pomocou Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Pps pomocou podpisov Barcode.
