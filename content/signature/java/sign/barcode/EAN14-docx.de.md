...
############################# Head ############################
head_title: "Docx-Dokument mit E A N14-Barcode in Java eSignieren"
head_description: "Erstellen Sie eine E A N14-Barcode-Signatur und fügen Sie sie mit ein paar Codezeilen in ein Docx-Dokument mit Java ein. Verwenden Sie die GroupDocs Document Signature API zum Signieren verschiedener Dateiformate."

############################# Header ############################
title: "E A N14-Barcode-Signatur für Docx-Dokument in Java generieren"
description: "Unterzeichnen Sie Ihre Docx-Geschäftsdokumente mit E A N14-Barcode. Generieren Sie Barcode-Signaturen schnell und einfach mit wenigen Codezeilen, um Signaturoptionen einzurichten."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Docx mit Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Docx-Dokumente mit Barcode-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Docx-Dokumenten mit Barcode Live-Demo"
    content: |
