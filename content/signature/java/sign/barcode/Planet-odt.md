...
more_formats:
    enable: true
    title: "Signing Other Document Formats with PLANET BARCODE using Java"
    content: |
        Java PLANET BARCODE signatures management API for documents and images. Add PLANET BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
