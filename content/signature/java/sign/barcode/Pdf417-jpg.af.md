...
############################# Head ############################
head_title: "eSign Jpg-dokument met Pdf417 Strepiekode in Java"
head_description: "Skep Pdf417 Strepiekode Handtekening en plaas dit op Jpg dokument met Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer Pdf417 strepieskode-handtekening vir Jpg-dokument in Java"
description: "eTeken jou Jpg besigheidsdokumente met Pdf417 Streepkode. Genereer strepieskode-handtekening vinnig en maklik met 'n paar reëls kode om ondertekenopsies op te stel."
...
steps:
    enable: true
    title_left: "Stappe om Jpg met Barcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Jpg dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Jpg dokumente met Barcode Regstreekse Demo"
    content: |
