...
############################# Head ############################
head_title: "eSign Odp-dokument med ISBN strekkode i Java"
head_description: "Opprett ISBN strekkodesignatur og legg den på Odp-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer ISBN strekkodesignatur for Odp dokument i Java"
description: "eSignér Odp-bedriftsdokumentene dine med ISBN strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
steps:
    enable: true
    title_left: "Trinn for å signere Odp med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Odp-dokumenter med Barcode-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Odp dokumenter med Barcode Live Demo"
    content: |
