...
############################# Head ############################
head_title: "eSign Doc doiciméad le UPCE Barcode in Java"
head_description: "Cruthaigh UPCE Síniú Barrachóid agus cuir ar Doc doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid UPCE don doiciméad Doc in Java"
description: "eSínigh do dhoiciméid ghnó Doc le Barrachóid UPCE. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
steps:
    enable: true
    title_left: "Céimeanna chun Doc a shíniú le Barcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Doc a shíniú le sínithe Barcode go tapa agus go héasca.
