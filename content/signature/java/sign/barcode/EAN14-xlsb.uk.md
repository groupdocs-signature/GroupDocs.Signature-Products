...
############################# Head ############################
head_title: "Документ eSign Xlsb зі штрих-кодом E A N14 у Java"
head_description: "Створіть підпис штрих-коду E A N14 і додайте його в документ Xlsb за допомогою Java за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs для підпису різних форматів файлів."

############################# Header ############################
title: "Згенеруйте підпис штрих-коду E A N14 для документа Xlsb у Java"
description: "Електронно підписуйте свої ділові документи Xlsb штрих-кодом E A N14. Згенеруйте підпис штрих-коду швидко та легко за допомогою кількох рядків коду, щоб налаштувати параметри підпису."
...
steps:
    enable: true
    title_left: "Кроки для підпису Xlsb за допомогою Barcode у Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) надає можливість швидко та легко підписувати документи Xlsb за допомогою підписів Barcode.
...
demos:
    enable: true
    title: "Підпис документів Xlsb за допомогою Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Європейський номер товару або EAN — це стандарт, що описує символіку штрих-коду та систему нумерації, яка використовується у світовій торгівлі для ідентифікації конкретного типу роздрібного продукту в певній конфігурації упаковки від конкретного виробника.
          characterset: |
