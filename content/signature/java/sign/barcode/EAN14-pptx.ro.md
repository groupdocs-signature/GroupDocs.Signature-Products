...
############################# Head ############################
head_title: "eSign Pptx document cu E A N14 cod de bare în Java"
head_description: "Creați semnătura codului de bare E A N14 și puneți-o pe documentul Pptx cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare E A N14 pentru documentul Pptx în Java"
description: "eSemnați documentele dvs. comerciale Pptx cu codul de bare E A N14. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Pptx cu Barcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Pptx cu semnături Barcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Pptx cu Barcode Live Demo"
    content: |
