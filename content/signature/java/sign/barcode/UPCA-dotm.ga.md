...
############################# Head ############################
head_title: "eSign Dotm doiciméad le UPCA Barcode in Java"
head_description: "Cruthaigh UPCA Síniú Barrachóid agus cuir ar Dotm doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid UPCA don doiciméad Dotm in Java"
description: "eSínigh do dhoiciméid ghnó Dotm le Barrachóid UPCA. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is siombaleolaíocht barrachóid é an Cód Táirge Uilíoch a úsáidtear go forleathan ar fud an domhain chun míreanna trádála i siopaí a rianú.
          characterset: |
             digití uimhriúla (0-9).
          textcapacity: |
             Go díreach 11 dhigit + 1 dhigit seiceála.
          image: |
