...
############################# Head ############################
head_title: "eSign Dotm-dokument met UPCA Strepiekode in Java"
head_description: "Skep UPCA Strepiekode Handtekening en plaas dit op Dotm dokument met Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer UPCA strepieskode-handtekening vir Dotm-dokument in Java"
description: "eTeken jou Dotm besigheidsdokumente met UPCA Streepkode. Genereer strepieskode-handtekening vinnig en maklik met 'n paar reëls kode om ondertekenopsies op te stel."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Die Universele Produkkode is 'n strepieskode-simbool wat wêreldwyd wyd gebruik word om handelsitems in winkels op te spoor.
          characterset: |
             Numeriese syfers (0-9).
          textcapacity: |
             Presies 11 syfers + 1 kontrolesyfer.
          image: |
