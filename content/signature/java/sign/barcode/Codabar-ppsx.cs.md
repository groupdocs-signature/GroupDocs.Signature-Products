...
############################# Head ############################
head_title: "Dokument eSign Ppsx s čárovým kódem Codabar v Java"
head_description: "Vytvořte podpis čárového kódu Codabar a vložte jej do dokumentu Ppsx s Java pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu Codabar pro dokument Ppsx v Java"
description: "ePodepište své obchodní dokumenty ve formátu Ppsx pomocí čárového kódu Codabar. Vygenerujte podpis čárového kódu rychle a snadno pomocí několika řádků kódu pro nastavení možností podepisování."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codabar je lineární symbolika čárového kódu, která byla navržena tak, aby byla přesně čitelná i při tisku na jehličkových tiskárnách pro vícedílné formuláře, jako jsou letecké poukázky FedEx a formulář krevní banky.
          characterset: |
