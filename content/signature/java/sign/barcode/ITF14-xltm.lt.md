...
############################# Head ############################
head_title: "eSign Xltm dokumentas su I T F14 brūkšniniu kodu Java"
head_description: "Sukurkite I T F14 brūkšninio kodo parašą ir įdėkite jį į Xltm dokumentą su Java naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite I T F14 brūkšninio kodo parašą Xltm dokumentui Java"
description: "e. Pasirašykite Xltm verslo dokumentus naudodami I T F14 brūkšninį kodą. Greitai ir lengvai sugeneruokite brūkšninio kodo parašą naudodami kelias kodo eilutes, kad nustatytumėte pasirašymo parinktis."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 yra GS1 interleaved 2 of 5 (ITF) brūkšninio kodo įgyvendinimas pasauliniam prekybos elemento numeriui koduoti.
          characterset: |
             Skaitmeniniai skaitmenys (0–9).
          textcapacity: |
             13 skaitmenų + 1 kontrolinis skaitmuo.
          image: |
