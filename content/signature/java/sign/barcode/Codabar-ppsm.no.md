...
############################# Head ############################
head_title: "eSign Ppsm-dokument med Codabar strekkode i Java"
head_description: "Opprett Codabar strekkodesignatur og legg den på Ppsm-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer Codabar strekkodesignatur for Ppsm dokument i Java"
description: "eSignér Ppsm-bedriftsdokumentene dine med Codabar strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codabar er en lineær strekkodesymbologi som ble designet for å leses nøyaktig selv når den skrives ut på matriseskrivere for flerdelte skjemaer som FedEx-luftsedler og blodbankskjema.
          characterset: |
