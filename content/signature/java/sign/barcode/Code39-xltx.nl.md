...
############################# Head ############################
head_title: "eSign Xltx document met Code39 Barcode in Java"
head_description: "Maak een Code39 Barcode Signature en plaats deze op het Xltx document met Java met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."

############################# Header ############################
title: "Genereer Code39 Barcode handtekening voor Xltx document in Java"
description: "Onderteken uw Xltx zakelijke documenten met Code39 Barcode. Genereer snel en eenvoudig een barcodehandtekening met een paar regels code om ondertekeningsopties in te stellen."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Code 39 (ook bekend als Alpha39, Code 3 of 9, Code 3/9, Type 39, USS Code 39 of USD-3) is een discrete barcodesymboliek met variabele lengte.
          characterset: |
             Numerieke cijfers (0-9) en hoofdletters (A-Z) en een aantal speciale tekens (-, ., $, /, +, % en spatie).
          textcapacity: |
