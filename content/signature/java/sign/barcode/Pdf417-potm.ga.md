...
############################# Head ############################
head_title: "eSign Potm doiciméad le Pdf417 Barcode in Java"
head_description: "Cruthaigh Pdf417 Síniú Barrachóid agus cuir ar Potm doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid Pdf417 don doiciméad Potm in Java"
description: "eSínigh do dhoiciméid ghnó Potm le Barrachóid Pdf417. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is formáid barrachóid líneach cruachta é PDF417 a úsáidtear in éagsúlacht feidhmeanna amhail iompar, cártaí aitheantais, agus bainistíocht fardail.
          characterset: |
             Gach 256 carachtar ASCII.
          textcapacity: |
             Suas le 800 carachtar.
          image: |
