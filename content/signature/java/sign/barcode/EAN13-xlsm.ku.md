...
############################# Head ############################
head_title: "eSign Xlsm belgeya bi E A N13 Barcode di Java"
head_description: "Îmzeya barkodê ya E A N13 biafirîne û bi çend rêzikên kodê bi Java li ser belgeya Xlsm biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."

############################# Header ############################
title: "Di Java de ji bo belgeya E A N13 îmzeya barkodê çêbike"
description: "Belgeyên karsaziya xwe yên Xlsm bi E A N13 Barkodê îmze bikin. Bi çend rêzikên kodê re zû û bi hêsanî îmzeya Barkodê biafirînin da ku vebijarkên îmzekirinê saz bikin."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Standarda EAN-ê ya ku herî zêde tê bikar anîn EAN-13-a sêzdeh-hejmar e, komek ji standarda 12-hejmarî ya orîjînal a Kodê Hilbera Gerdûnî ye.
          characterset: |
             Tenê hejmarên hejmarî (0-9).
          textcapacity: |
             Kapasîteya kodetextê: tam 12 jimar + 1 jimareya kontrolê.
          image: |
