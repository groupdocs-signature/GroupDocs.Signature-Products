...
############################# Head ############################
head_title: "eSign Zip dokument s E A N13 čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu E A N13 a vložte ho do dokumentu Zip s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte E A N13 podpis čiarového kódu pre dokument Zip v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Zip pomocou čiarového kódu E A N13. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Zip pomocou Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Zip pomocou podpisov Barcode.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Zip pomocou živej ukážky Barcode"
    content: |
