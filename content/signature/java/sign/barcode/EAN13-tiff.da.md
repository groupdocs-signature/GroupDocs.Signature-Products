...
############################# Head ############################
head_title: "eSign Tiff dokument med E A N13 stregkode i Java"
head_description: "Opret E A N13 stregkodesignatur og læg den på Tiff dokument med Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer E A N13 Stregkodesignatur for Tiff dokument i Java"
description: "eSignér dine Tiff forretningsdokumenter med E A N13 stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
steps:
    enable: true
    title_left: "Trin til at signere Tiff med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Tiff dokumenter med Barcode signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Tiff dokumenter med Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Den mest almindeligt anvendte EAN-standard er den trettencifrede EAN-13, et supersæt af den originale 12-cifrede Universal Product Code-standard.
          characterset: |
             Kun numeriske cifre (0-9).
          textcapacity: |
             Kodetekstkapacitet: nøjagtigt 12 cifre + 1 kontrolciffer.
          image: |
