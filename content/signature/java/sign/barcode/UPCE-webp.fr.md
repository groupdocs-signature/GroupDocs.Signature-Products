...
############################# Head ############################
head_title: "eSign Webp document avec UPCE Barcode in Java"
head_description: "Créez UPCE Barcode Signature et placez-le sur le document Webp avec Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres UPCE pour le document Webp dans Java"
description: "Signez électroniquement vos documents commerciaux Webp avec UPCE Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
...
steps:
    enable: true
    title_left: "Étapes pour signer Webp avec Barcode dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Webp avec des signatures Barcode.
...
demos:
    enable: true
    title: "Signature de documents Webp avec Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Le code produit universel est une symbologie de code-barres largement utilisée dans le monde entier pour suivre les articles commerciaux dans les magasins. UPCE est une variation à 8 chiffres si UPC.
          characterset: |
             Prend en charge uniquement les chiffres numériques (0-9).
          textcapacity: |
             Capacité du texte codé : exactement 7 chiffres + 1 chiffre de contrôle.
          image: |
