...
############################# Head ############################
head_title: "eSign Pptx dokuments ar Interleaved2of5 svītrkodu programmā Java"
head_description: "Izveidojiet Interleaved2of5 svītrkoda parakstu un ievietojiet to Pptx dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt Interleaved2of5 svītrkoda parakstu dokumentam Pptx programmā Java"
description: "eParakstiet savus Pptx biznesa dokumentus, izmantojot Interleaved2of5 svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Pptx ar Barcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Pptx dokumentus ar Barcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Pptx parakstīšana, izmantojot Barcode tiešraides demonstrāciju"
    content: |
