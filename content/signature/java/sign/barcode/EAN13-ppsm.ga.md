...
############################# Head ############################
head_title: "eSign Ppsm doiciméad le E A N13 Barcode in Java"
head_description: "Cruthaigh E A N13 Síniú Barrachóid agus cuir ar Ppsm doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid E A N13 don doiciméad Ppsm in Java"
description: "eSínigh do dhoiciméid ghnó Ppsm le Barrachóid E A N13. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is é an caighdeán EAN is coitianta a úsáidtear ná an trí dhigit déag EAN-13, superset den bhunchaighdeán 12-dhigit Cód Táirge Uilíoch bunaidh.
          characterset: |
             digití uimhriúla amháin (0-9).
          textcapacity: |
             Acmhainn an chóidthéacs: díreach 12 dhigit + 1 dhigit seiceála.
          image: |
