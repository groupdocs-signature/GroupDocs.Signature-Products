...
############################# Head ############################
head_title: "eSign Tar tài liệu với I T F14 Mã vạch trong Java"
head_description: "Tạo Chữ ký Mã vạch I T F14 và đưa nó vào tài liệu Tar với Java bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo I T F14 Chữ ký mã vạch cho tài liệu Tar trong Java"
