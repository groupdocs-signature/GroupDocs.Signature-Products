...
############################# Head ############################
head_title: "Документ eSign Ppsx зі штрих-кодом Code39 у Java"
head_description: "Створіть підпис штрих-коду Code39 і додайте його в документ Ppsx за допомогою Java за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs для підпису різних форматів файлів."

############################# Header ############################
title: "Згенеруйте підпис штрих-коду Code39 для документа Ppsx у Java"
description: "Електронно підписуйте свої ділові документи Ppsx штрих-кодом Code39. Згенеруйте підпис штрих-коду швидко та легко за допомогою кількох рядків коду, щоб налаштувати параметри підпису."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Код 39 (також відомий як Alpha39, Code 3 of 9, Code 3/9, Type 39, USS Code 39 або USD-3) — це дискретна символіка штрих-коду змінної довжини.
          characterset: |
             Цифри (0-9) і великі літери (A-Z) і ряд спеціальних символів (-, ., $, /, +, % і пробіл).
          textcapacity: |
