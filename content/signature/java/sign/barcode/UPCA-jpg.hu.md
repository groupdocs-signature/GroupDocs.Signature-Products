...
############################# Head ############################
head_title: "eSign Jpg dokumentum UPCA vonalkóddal a Java nyelven"
head_description: "Hozzon létre UPCA vonalkód-aláírást, és helyezze el a Jpg dokumentumra a Java termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "UPCA vonalkód aláírás létrehozása a Jpg dokumentumhoz a Java programban"
description: "eAláírja Jpg üzleti dokumentumait UPCA vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Az univerzális termékkód egy vonalkód-szimbólum, amelyet világszerte széles körben használnak az üzletekben található kereskedelmi cikkek nyomon követésére.
          characterset: |
             Numerikus számjegyek (0-9).
          textcapacity: |
             Pontosan 11 számjegy + 1 ellenőrző számjegy.
          image: |
