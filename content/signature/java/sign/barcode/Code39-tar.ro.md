...
############################# Head ############################
head_title: "eSign Tar document cu Code39 cod de bare în Java"
head_description: "Creați semnătura codului de bare Code39 și puneți-o pe documentul Tar cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare Code39 pentru documentul Tar în Java"
description: "eSemnați documentele dvs. comerciale Tar cu codul de bare Code39. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Tar cu Barcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Tar cu semnături Barcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Tar cu Barcode Live Demo"
    content: |
