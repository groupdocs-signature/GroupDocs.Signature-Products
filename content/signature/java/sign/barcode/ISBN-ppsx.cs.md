...
############################# Head ############################
head_title: "Dokument eSign Ppsx s čárovým kódem ISBN v Java"
head_description: "Vytvořte podpis čárového kódu ISBN a vložte jej do dokumentu Ppsx s Java pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu ISBN pro dokument Ppsx v Java"
description: "ePodepište své obchodní dokumenty ve formátu Ppsx pomocí čárového kódu ISBN. Vygenerujte podpis čárového kódu rychle a snadno pomocí několika řádků kódu pro nastavení možností podepisování."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Mezinárodní standardní číslo knihy (ISBN) je číselný komerční identifikátor knihy, který má být jedinečný.[a][b] Vydavatelé nakupují čísla ISBN od pobočky Mezinárodní agentury ISBN.
          characterset: |
             Číslice (0-9).
          textcapacity: |
             Přesně 9 číslic + 1 kontrolní číslice.
          image: |
