...
############################# Head ############################
head_title: "eSign Potm dokumen dengan ISBN Barcode di Java"
head_description: "Buat ISBN Tanda Tangan Barcode dan letakkan di dokumen Potm dengan Java menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat ISBN Tanda tangan kode batang untuk dokumen Potm di Java"
description: "eSign dokumen bisnis Potm Anda dengan ISBN Barcode. Hasilkan tanda tangan Barcode dengan cepat dan mudah dengan beberapa baris kode untuk menyiapkan opsi penandatanganan."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            International Standard Book Number (ISBN) adalah pengidentifikasi buku komersial numerik yang dimaksudkan untuk menjadi unik.[a][b] Penerbit membeli ISBN dari afiliasi Badan ISBN Internasional.
          characterset: |
             Digit numerik (0-9).
          textcapacity: |
             Tepat 9 digit + 1 digit cek.
          image: |
