...
############################# Head ############################
head_title: "eSign Docm dokument med ISBN stregkode i Java"
head_description: "Opret ISBN stregkodesignatur og læg den på Docm dokument med Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer ISBN Stregkodesignatur for Docm dokument i Java"
description: "eSignér dine Docm forretningsdokumenter med ISBN stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            International Standard Book Number (ISBN) er en numerisk kommerciel bogidentifikator, som er beregnet til at være unik.[a][b] Udgivere køber ISBN'er fra en affiliate af International ISBN Agency.
          characterset: |
             Numeriske cifre (0-9).
          textcapacity: |
             Præcis 9 cifre + 1 kontrolciffer.
          image: |
