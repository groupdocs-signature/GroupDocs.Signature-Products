...
############################# Head ############################
head_title: "وثيقة eSign Potx مع E A N14 رمز شريطي في Java"
head_description: "أنشئ E A N14 Barcode Signature وضعه في مستند Potx باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء E A N14 توقيع الرمز الشريطي للمستند Potx في Java"
description: "قم بتوقيع Potx على مستندات الأعمال باستخدام الرمز الشريطي E A N14. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
...
steps:
    enable: true
    title_left: "خطوات تسجيل Potx باستخدام Barcode في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Potx بتوقيعات Barcode بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Potx باستخدام العرض التوضيحي المباشر Barcode"
    content: |
