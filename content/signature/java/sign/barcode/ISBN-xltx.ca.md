...
############################# Head ############################
head_title: "Document electrònic Xltx amb codi de barres ISBN a Java"
head_description: "Creeu la signatura de codi de barres ISBN i poseu-la al document Xltx amb Java utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu ISBN signatura de codi de barres per al document Xltx a Java"
description: "eSigne els vostres documents comercials de Xltx amb el codi de barres ISBN. Genereu la signatura de codi de barres de manera ràpida i senzilla amb unes poques línies de codi per configurar les opcions de signatura."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            L'International Standard Book Number (ISBN) és un identificador numèric de llibres comercials que pretén ser únic.[a][b] Els editors compren ISBN a una filial de l'Agència Internacional de l'ISBN.
          characterset: |
             Dígits numèrics (0-9).
          textcapacity: |
             Exactament 9 dígits + 1 dígit de verificació.
          image: |
