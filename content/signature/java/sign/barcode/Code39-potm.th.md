...
############################# Head ############################
head_title: "eSign Potm เอกสารด้วยบาร์โค้ด Code39 ใน Java"
head_description: "สร้าง Code39 Barcode Signature และใส่ลงในเอกสาร Potm ด้วย Java โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API สำหรับการลงนามรูปแบบไฟล์ต่างๆ"

############################# Header ############################
title: "สร้าง Code39 ลายเซ็นบาร์โค้ดสำหรับเอกสาร Potm ใน Java"
description: "eSign เอกสารทางธุรกิจ Potm ของคุณด้วยบาร์โค้ด Code39 สร้างลายเซ็นบาร์โค้ดอย่างรวดเร็วและง่ายดายด้วยรหัสสองสามบรรทัดเพื่อตั้งค่าตัวเลือกการเซ็นชื่อ"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             ตัวเลข (0-9) และตัวอักษรพิมพ์ใหญ่ (A-Z) และอักขระพิเศษจำนวนหนึ่ง (-, ., $, /, +, % และช่องว่าง)
          textcapacity: |
             ไม่มีข้อจำกัดเฉพาะ
          image: |
