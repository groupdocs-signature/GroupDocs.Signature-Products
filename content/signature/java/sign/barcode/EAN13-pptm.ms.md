...
############################# Head ############################
head_title: "eSign Pptm dokumen dengan E A N13 Barcode dalam Java"
head_description: "Cipta E A N13 Tandatangan Kod Bar dan letakkan pada Pptm dokumen dengan Java menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani pelbagai format fail."

############################# Header ############################
title: "Hasilkan E A N13 Tandatangan Kod Bar untuk Pptm dokumen dalam Java"
description: "eTandatangani dokumen perniagaan Pptm anda dengan E A N13 Barcode. Hasilkan tandatangan Kod Bar dengan cepat dan mudah dengan beberapa baris kod untuk menyediakan pilihan tandatangan."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pptm dengan Barcode dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Pptm dengan tandatangan Barcode dengan cepat dan mudah.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Piawaian EAN yang paling biasa digunakan ialah EAN-13 tiga belas digit, superset piawaian Kod Produk Universal 12 digit asal.
          characterset: |
             Hanya digit berangka (0-9).
          textcapacity: |
             Kapasiti teks kod: tepat 12 digit + 1 digit semak.
          image: |
