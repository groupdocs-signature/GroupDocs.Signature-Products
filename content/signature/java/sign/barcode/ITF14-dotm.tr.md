...
############################# Head ############################
head_title: "Java içinde I T F14 Barkodlu eSign Dotm belgesi"
head_description: "I T F14 Barkod İmzası oluşturun ve birkaç satır kod kullanarak Java ile Dotm belgesine koyun. Çeşitli dosya biçimlerini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Dotm belgesi için I T F14 Barkod imzası oluşturun"
description: "Dotm iş belgelerinizi I T F14 Barkod ile e-imzalayın. İmzalama seçeneklerini ayarlamak için birkaç satır kodla hızlı ve kolay bir şekilde Barkod imzası oluşturun."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14, Global Ticari Ürün Numarasını kodlamak için Interleaved 2 of 5 (ITF) barkodunun GS1 uygulamasıdır.
          characterset: |
             Sayısal rakamlar (0-9).
          textcapacity: |
             13 basamak + 1 kontrol basamağı.
          image: |
