...
############################# Head ############################
head_title: "eSign Xlsm -asiakirja E A N13-viivakoodilla Java"
head_description: "Luo E A N13 Viivakoodiallekirjoitus ja laita se Xlsm-asiakirjaan, jossa on Java muutamalla rivillä koodia. Käytä GroupDocs Document Signature API:ta eri tiedostomuotojen allekirjoittamiseen."

############################# Header ############################
title: "Luo E A N13 viivakoodiallekirjoitus asiakirjalle Xlsm ohjelmassa Java"
description: "eAllekirjoita Xlsm yritysasiakirjasi E A N13-viivakoodilla. Luo viivakoodiallekirjoitus nopeasti ja helposti muutamalla koodirivillä allekirjoitusvaihtoehtojen määrittämiseksi."
...
steps:
    enable: true
    title_left: "Vaiheet Xlsm:n allekirjoittamiseen Barcode -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Xlsm-asiakirjoja Barcode-allekirjoituksella nopeasti ja helposti.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Yleisimmin käytetty EAN-standardi on 13-numeroinen EAN-13, joka on alkuperäisen 12-numeroisen Universal Product Code -standardin superjoukko.
          characterset: |
             Vain numeeriset numerot (0-9).
          textcapacity: |
             Kooditekstin kapasiteetti: täsmälleen 12 numeroa + 1 tarkistusnumero.
          image: |
