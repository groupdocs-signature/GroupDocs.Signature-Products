...
############################# Head ############################
head_title: "eSign Xltm dokumentum Pharmacode vonalkóddal a Java nyelven"
head_description: "Hozzon létre Pharmacode vonalkód-aláírást, és helyezze el a Xltm dokumentumra a Java termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "Pharmacode vonalkód aláírás létrehozása a Xltm dokumentumhoz a Java programban"
description: "eAláírja Xltm üzleti dokumentumait Pharmacode vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            A Pharmacode, más néven Pharmaceutical Binary Code, egy vonalkód-szabvány, amelyet a gyógyszeriparban csomagolásellenőrző rendszerként használnak.
          characterset: |
             Numerikus számjegyek (0-9).
          textcapacity: |
             Csak egyetlen egész számot jelöl 3 és 131070 között.
          image: |
