...
############################# Head ############################
head_title: "eSign Bmp dokument s Code39 čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu Code39 a vložte ho do dokumentu Bmp s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte Code39 podpis čiarového kódu pre dokument Bmp v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Bmp pomocou čiarového kódu Code39. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Bmp pomocou Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Bmp pomocou podpisov Barcode.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Bmp pomocou živej ukážky Barcode"
    content: |
