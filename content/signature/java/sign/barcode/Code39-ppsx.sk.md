...
############################# Head ############################
head_title: "eSign Ppsx dokument s Code39 čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu Code39 a vložte ho do dokumentu Ppsx s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte Code39 podpis čiarového kódu pre dokument Ppsx v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Ppsx pomocou čiarového kódu Code39. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Kód 39 (tiež známy ako Alpha39, Code 3 of 9, Code 3/9, Type 39, USS Code 39 alebo USD-3) je diskrétna symbolika čiarového kódu s variabilnou dĺžkou.
          characterset: |
             Číslice (0-9) a veľké písmená (A-Z) a množstvo špeciálnych znakov (-, ., $, /, +, %, a medzera).
          textcapacity: |
