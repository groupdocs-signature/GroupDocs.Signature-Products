...
############################# Head ############################
head_title: "eSign Ppsx dokumentum I T F14 vonalkóddal a Java nyelven"
head_description: "Hozzon létre I T F14 vonalkód-aláírást, és helyezze el a Ppsx dokumentumra a Java termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "I T F14 vonalkód aláírás létrehozása a Ppsx dokumentumhoz a Java programban"
description: "eAláírja Ppsx üzleti dokumentumait I T F14 vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
steps:
    enable: true
    title_left: "A Ppsx aláírásának lépései a Barcode segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Ppsx dokumentumok gyors és egyszerű aláírását Barcode aláírással.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Az ITF-14 az Interleaved 2 of 5 (ITF) vonalkód GS1 megvalósítása a globális kereskedelmi cikkszám kódolására.
          characterset: |
             Numerikus számjegyek (0-9).
          textcapacity: |
             13 számjegy + 1 ellenőrző számjegy.
          image: |
