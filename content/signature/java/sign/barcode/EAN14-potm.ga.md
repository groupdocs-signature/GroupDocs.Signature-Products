...
############################# Head ############################
head_title: "eSign Potm doiciméad le E A N14 Barcode in Java"
head_description: "Cruthaigh E A N14 Síniú Barrachóid agus cuir ar Potm doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid E A N14 don doiciméad Potm in Java"
description: "eSínigh do dhoiciméid ghnó Potm le Barrachóid E A N14. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
steps:
    enable: true
    title_left: "Céimeanna chun Potm a shíniú le Barcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Potm a shíniú le sínithe Barcode go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Potm doiciméad le Barcode Taispeántas Beo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is caighdeán é Uimhir Airteagal Eorpach nó EAN a dhéanann cur síos ar chóras siombaile agus uimhrithe barrachóid a úsáidtear i dtrádáil dhomhanda chun cineál sonrach táirge miondíola a shainaithint, i gcumraíocht shonrach pacáistithe, ó mhonaróir sonrach.
          characterset: |
             digití uimhriúla (0-9) agus carachtair speisialta.
          textcapacity: |
             Go díreach 14 dhigit uimhriúil.
          image: |
