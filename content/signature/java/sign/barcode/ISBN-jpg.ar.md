...
############################# Head ############################
head_title: "وثيقة eSign Jpg مع ISBN رمز شريطي في Java"
head_description: "أنشئ ISBN Barcode Signature وضعه في مستند Jpg باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء ISBN توقيع الرمز الشريطي للمستند Jpg في Java"
description: "قم بتوقيع Jpg على مستندات الأعمال باستخدام الرمز الشريطي ISBN. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
...
steps:
    enable: true
    title_left: "خطوات تسجيل Jpg باستخدام Barcode في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Jpg بتوقيعات Barcode بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Jpg باستخدام العرض التوضيحي المباشر Barcode"
    content: |
