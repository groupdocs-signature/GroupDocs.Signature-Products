...
############################# Head ############################
head_title: "eSign Xltx tài liệu với Codabar Mã vạch trong Java"
head_description: "Tạo Chữ ký Mã vạch Codabar và đưa nó vào tài liệu Xltx với Java bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo Codabar Chữ ký mã vạch cho tài liệu Xltx trong Java"
description: "eSign các tài liệu kinh doanh Xltx của bạn bằng Mã vạch Codabar. Tạo chữ ký mã vạch nhanh chóng và dễ dàng với một vài dòng mã để thiết lập các tùy chọn ký."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Xltx bằng Barcode trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Xltx bằng chữ ký Barcode một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Xltx bằng Barcode Live Demo"
    content: |
