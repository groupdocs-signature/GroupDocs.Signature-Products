...
############################# Head ############################
head_title: "eSign Pptm ሰነድ በE A N14 ባርኮድ በJava"
head_description: "የE A N14 ባርኮድ ፊርማ ይፍጠሩ እና በPptm ሰነድ ላይ በJava ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለPptm ሰነድ የE A N14 ባርኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Pptm የንግድ ሰነዶች በE A N14 ባርኮድ ይመዝገቡ። የመመዝገቢያ አማራጮችን ለማዘጋጀት የባርኮድ ፊርማ በፍጥነት እና በቀላሉ በጥቂት የኮድ መስመሮች ይፍጠሩ።"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            የአውሮፓ አንቀጽ ቁጥር ወይም EAN አንድን የተወሰነ የችርቻሮ ምርት ዓይነት፣ በአንድ የተወሰነ የማሸጊያ ውቅር ከአንድ የተወሰነ አምራች ለመለየት በዓለም አቀፍ ንግድ ውስጥ ጥቅም ላይ የሚውለውን የአሞሌ ምልክት እና የቁጥር ሥርዓት የሚገልጽ መደበኛ ነው።
          characterset: |
