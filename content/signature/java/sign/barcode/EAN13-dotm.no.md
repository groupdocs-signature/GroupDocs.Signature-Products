...
############################# Head ############################
head_title: "eSign Dotm-dokument med E A N13 strekkode i Java"
head_description: "Opprett E A N13 strekkodesignatur og legg den på Dotm-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer E A N13 strekkodesignatur for Dotm dokument i Java"
description: "eSignér Dotm-bedriftsdokumentene dine med E A N13 strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Den mest brukte EAN-standarden er den trettensifrede EAN-13, et supersett av den originale 12-sifrede Universal Product Code-standarden.
          characterset: |
             Kun numeriske sifre (0-9).
          textcapacity: |
             Kodetekstkapasitet: nøyaktig 12 siffer + 1 kontrollsiffer.
          image: |
