...
############################# Head ############################
head_title: "Java में E A N14 बारकोड के साथ eSign Xlsm दस्तावेज़"
head_description: "E A N14 बारकोड सिग्नेचर बनाएं और इसे Xlsm डॉक्यूमेंट पर Java के साथ कोड की दो पंक्तियों का उपयोग करके लगाएं। विभिन्न फ़ाइल स्वरूपों पर हस्ताक्षर करने के लिए GroupDocs दस्तावेज़ हस्ताक्षर API का उपयोग करें।"

############################# Header ############################
title: "Java में Xlsm दस्तावेज़ के लिए E A N14 बारकोड हस्ताक्षर जेनरेट करें"
description: "E A N14 बारकोड के साथ अपने Xlsm व्यावसायिक दस्तावेज़ों पर ई-हस्ताक्षर करें। हस्ताक्षर विकल्प सेट करने के लिए कोड की कुछ पंक्तियों के साथ जल्दी और आसानी से बारकोड हस्ताक्षर उत्पन्न करें।"
...
steps:
    enable: true
    title_left: "Java में Barcode के साथ Xlsm पर हस्ताक्षर करने के चरण"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) जल्दी और आसानी से Barcode हस्ताक्षर के साथ Xlsm दस्तावेज़ों पर हस्ताक्षर करने की क्षमता प्रदान करता है।
...
demos:
    enable: true
    title: "Barcode लाइव डेमो के साथ Xlsm दस्तावेज़ों पर हस्ताक्षर करना"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            यूरोपीय लेख संख्या या ईएएन एक विशिष्ट निर्माता से एक विशिष्ट पैकेजिंग कॉन्फ़िगरेशन में, एक विशिष्ट खुदरा उत्पाद प्रकार की पहचान करने के लिए वैश्विक व्यापार में उपयोग किए जाने वाले बारकोड सिम्बोलॉजी और नंबरिंग सिस्टम का वर्णन करने वाला एक मानक है।
          characterset: |
             संख्यात्मक अंक (0-9) और विशेष वर्ण।
          textcapacity: |
             बिल्कुल 14 अंकीय अंक।
          image: |
