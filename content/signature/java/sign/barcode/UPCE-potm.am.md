...
############################# Head ############################
head_title: "eSign Potm ሰነድ በUPCE ባርኮድ በJava"
head_description: "የUPCE ባርኮድ ፊርማ ይፍጠሩ እና በPotm ሰነድ ላይ በJava ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለPotm ሰነድ የUPCE ባርኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Potm የንግድ ሰነዶች በUPCE ባርኮድ ይመዝገቡ። የመመዝገቢያ አማራጮችን ለማዘጋጀት የባርኮድ ፊርማ በፍጥነት እና በቀላሉ በጥቂት የኮድ መስመሮች ይፍጠሩ።"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ሁለንተናዊ የምርት ኮድ በመደብሮች ውስጥ የንግድ ዕቃዎችን ለመከታተል በዓለም ዙሪያ በስፋት ጥቅም ላይ የሚውል የአሞሌ ኮድ ምልክት ነው። UPC ከሆነ UPCE ባለ 8-አሃዝ ልዩነት ነው።
          characterset: |
             የቁጥር አሃዞችን (0-9) ብቻ ይደግፋል።
          textcapacity: |
             የኮድቴክስት አቅም፡ በትክክል 7 አሃዞች + 1 ቼክ አሃዝ።
          image: |
