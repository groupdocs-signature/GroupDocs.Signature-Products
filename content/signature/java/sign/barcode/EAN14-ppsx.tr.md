...
############################# Head ############################
head_title: "Java içinde E A N14 Barkodlu eSign Ppsx belgesi"
head_description: "E A N14 Barkod İmzası oluşturun ve birkaç satır kod kullanarak Java ile Ppsx belgesine koyun. Çeşitli dosya biçimlerini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Ppsx belgesi için E A N14 Barkod imzası oluşturun"
description: "Ppsx iş belgelerinizi E A N14 Barkod ile e-imzalayın. İmzalama seçeneklerini ayarlamak için birkaç satır kodla hızlı ve kolay bir şekilde Barkod imzası oluşturun."
...
steps:
    enable: true
    title_left: "Java içinde Barcode ile Ppsx imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Ppsx belgelerini Barcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Ppsx dokümanı Barcode Canlı Demo ile imzalama"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Avrupa Ürün Numarası veya EAN, belirli bir üreticiden belirli bir ambalaj konfigürasyonunda belirli bir perakende ürün türünü tanımlamak için küresel ticarette kullanılan bir barkod sembolojisini ve numaralandırma sistemini tanımlayan bir standarttır.
          characterset: |
             Sayısal rakamlar (0-9) ve özel karakterler.
          textcapacity: |
             Tam olarak 14 sayısal basamak.
          image: |
