...
############################# Head ############################
head_title: "eSign Dotx belgeya bi E A N13 Barcode di Java"
head_description: "Îmzeya barkodê ya E A N13 biafirîne û bi çend rêzikên kodê bi Java li ser belgeya Dotx biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Dotx bi Barcode di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Dotx bi îmzeyên Barcode zû û bi hêsanî peyda dike.
