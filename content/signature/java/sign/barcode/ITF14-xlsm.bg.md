...
############################# Head ############################
head_title: "eSign Xlsm документ с I T F14 баркод в Java"
head_description: "Създайте I T F14 баркод подпис и го поставете в Xlsm документ с Java, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature за подписване на различни файлови формати."

############################# Header ############################
title: "Генерирайте I T F14 баркод подпис за документ Xlsm в Java"
description: "Електронно подпишете вашите Xlsm бизнес документи с I T F14 баркод. Генерирайте баркод подпис бързо и лесно с няколко реда код, за да зададете опции за подписване."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 е внедряването на GS1 на баркод Interleaved 2 of 5 (ITF) за кодиране на глобален номер на търговски артикул.
          characterset: |
             Цифри (0-9).
          textcapacity: |
             13 цифри + 1 контролна цифра.
          image: |
