...
############################# Head ############################
head_title: "eSign Potm dokuments ar E A N14 svītrkodu programmā Java"
head_description: "Izveidojiet E A N14 svītrkoda parakstu un ievietojiet to Potm dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt E A N14 svītrkoda parakstu dokumentam Potm programmā Java"
description: "eParakstiet savus Potm biznesa dokumentus, izmantojot E A N14 svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Potm ar Barcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Potm dokumentus ar Barcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Potm parakstīšana, izmantojot Barcode tiešraides demonstrāciju"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Eiropas izstrādājuma numurs jeb EAN ir standarts, kas apraksta svītrkoda simbolu un numerācijas sistēmu, ko izmanto globālajā tirdzniecībā, lai identificētu konkrētu mazumtirdzniecības produkta veidu noteiktā iepakojuma konfigurācijā no konkrēta ražotāja.
          characterset: |
             Ciparu cipari (0-9) un speciālās rakstzīmes.
          textcapacity: |
             Tieši 14 ciparu cipari.
          image: |
