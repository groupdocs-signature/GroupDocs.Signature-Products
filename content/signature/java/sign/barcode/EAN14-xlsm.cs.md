...
############################# Head ############################
head_title: "Dokument eSign Xlsm s čárovým kódem E A N14 v Java"
head_description: "Vytvořte podpis čárového kódu E A N14 a vložte jej do dokumentu Xlsm s Java pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu E A N14 pro dokument Xlsm v Java"
description: "ePodepište své obchodní dokumenty ve formátu Xlsm pomocí čárového kódu E A N14. Vygenerujte podpis čárového kódu rychle a snadno pomocí několika řádků kódu pro nastavení možností podepisování."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsm pomocí Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Xlsm pomocí podpisů Barcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Xlsm pomocí živé ukázky Barcode"
    content: |
