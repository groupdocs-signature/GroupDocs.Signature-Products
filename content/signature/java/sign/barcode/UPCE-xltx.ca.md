...
############################# Head ############################
head_title: "Document electrònic Xltx amb codi de barres UPCE a Java"
head_description: "Creeu la signatura de codi de barres UPCE i poseu-la al document Xltx amb Java utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu UPCE signatura de codi de barres per al document Xltx a Java"
description: "eSigne els vostres documents comercials de Xltx amb el codi de barres UPCE. Genereu la signatura de codi de barres de manera ràpida i senzilla amb unes poques línies de codi per configurar les opcions de signatura."
...
steps:
    enable: true
    title_left: "Passos per signar Xltx amb Barcode a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Xltx amb signatures Barcode de manera ràpida i senzilla.
...
demos:
    enable: true
    title: "Signant documents de Xltx amb Barcode Demostració en directe"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            El codi universal de producte és una simbologia de codi de barres que s'utilitza àmpliament a tot el món per fer el seguiment d'articles comercials a les botigues. UPCE és una variació de 8 dígits si UPC.
          characterset: |
             Només admet dígits numèrics (0-9).
          textcapacity: |
             Capacitat del text en codi: exactament 7 dígits + 1 dígit de verificació.
          image: |
