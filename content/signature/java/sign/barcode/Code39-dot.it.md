...
############################# Head ############################
head_title: "eSign Dot documento con codice a barre Code39 in Java"
head_description: "Crea Code39 Firma codice a barre e inseriscilo nel documento Dot con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Code39 firma del codice a barre per il documento Dot in Java"
description: "Firma elettronicamente i tuoi documenti aziendali Dot con il codice a barre Code39. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
