...
############################# Head ############################
head_title: "Document electrònic Xltm amb codi de barres Code39 a Java"
head_description: "Creeu la signatura de codi de barres Code39 i poseu-la al document Xltm amb Java utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu Code39 signatura de codi de barres per al document Xltm a Java"
description: "eSigne els vostres documents comercials de Xltm amb el codi de barres Code39. Genereu la signatura de codi de barres de manera ràpida i senzilla amb unes poques línies de codi per configurar les opcions de signatura."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            El codi 39 (també conegut com Alpha39, codi 3 de 9, codi 3/9, tipus 39, codi USS 39 o USD-3) és una simbologia de codi de barres discreta de longitud variable.
          characterset: |
             Dígits numèrics (0-9) i lletres majúscules (A-Z) i una sèrie de caràcters especials (-, ., $, /, +, % i espai).
          textcapacity: |
