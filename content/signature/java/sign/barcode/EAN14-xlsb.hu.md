...
############################# Head ############################
head_title: "eSign Xlsb dokumentum E A N14 vonalkóddal a Java nyelven"
head_description: "Hozzon létre E A N14 vonalkód-aláírást, és helyezze el a Xlsb dokumentumra a Java termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "E A N14 vonalkód aláírás létrehozása a Xlsb dokumentumhoz a Java programban"
description: "eAláírja Xlsb üzleti dokumentumait E A N14 vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
steps:
    enable: true
    title_left: "A Xlsb aláírásának lépései a Barcode segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Xlsb dokumentumok gyors és egyszerű aláírását Barcode aláírással.
...
demos:
    enable: true
    title: "Xlsb dokumentumok aláírása Barcode élő bemutatóval"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Az európai cikkszám vagy EAN egy szabvány, amely leírja a globális kereskedelemben használt vonalkód-szimbólumot és számozási rendszert egy adott gyártótól származó, meghatározott kiskereskedelmi terméktípus azonosítására, meghatározott csomagolási konfigurációban.
          characterset: |
             Számjegyek (0-9) és speciális karakterek.
          textcapacity: |
