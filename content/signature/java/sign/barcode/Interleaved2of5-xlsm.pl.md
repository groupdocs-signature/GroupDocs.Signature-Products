...
############################# Head ############################
head_title: "Podpisz dokument Xlsm z kodem kreskowym Interleaved2of5 w Java"
head_description: "Utwórz podpis z kodem kreskowym Interleaved2of5 i umieść go w dokumencie Xlsm za pomocą Java, używając kilku linijek kodu. Użyj interfejsu GroupDocs Document Signature API do podpisywania różnych formatów plików."

############################# Header ############################
title: "Wygeneruj Interleaved2of5 podpis z kodem kreskowym dla dokumentu Xlsm w Java"
description: "ePodpisz swoje dokumenty biznesowe w Xlsm za pomocą kodu kreskowego Interleaved2of5. Szybko i łatwo generuj podpis z kodem kreskowym za pomocą kilku linijek kodu, aby skonfigurować opcje podpisywania."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Xlsm za pomocą Barcode w Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Xlsm za pomocą podpisów Barcode.
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Xlsm za pomocą Barcode Demo na żywo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Interleaved 2 of 5 (ITF) to ciągła symbolika kodu kreskowego o dwóch szerokościach kodująca cyfry. Stosowany jest komercyjnie na folii 135, do kodów kreskowych ITF-14 oraz na kartonach niektórych produktów, podczas gdy produkty wewnątrz są oznaczone kodem UPC lub EAN.
          characterset: |
