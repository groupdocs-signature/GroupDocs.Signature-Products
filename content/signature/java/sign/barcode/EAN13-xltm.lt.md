...
############################# Head ############################
head_title: "eSign Xltm dokumentas su E A N13 brūkšniniu kodu Java"
head_description: "Sukurkite E A N13 brūkšninio kodo parašą ir įdėkite jį į Xltm dokumentą su Java naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite E A N13 brūkšninio kodo parašą Xltm dokumentui Java"
description: "e. Pasirašykite Xltm verslo dokumentus naudodami E A N13 brūkšninį kodą. Greitai ir lengvai sugeneruokite brūkšninio kodo parašą naudodami kelias kodo eilutes, kad nustatytumėte pasirašymo parinktis."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Dažniausiai naudojamas EAN standartas yra trylikos skaitmenų EAN-13, originalaus 12 skaitmenų universalaus gaminio kodo standarto superrinkinys.
          characterset: |
             Tik skaitiniai skaitmenys (0–9).
          textcapacity: |
             Kodo teksto talpa: tiksliai 12 skaitmenų + 1 kontrolinis skaitmuo.
          image: |
