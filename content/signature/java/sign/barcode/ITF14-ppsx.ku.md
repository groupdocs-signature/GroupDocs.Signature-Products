...
############################# Head ############################
head_title: "eSign Ppsx belgeya bi I T F14 Barcode di Java"
head_description: "Îmzeya barkodê ya I T F14 biafirîne û bi çend rêzikên kodê bi Java li ser belgeya Ppsx biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."

############################# Header ############################
title: "Di Java de ji bo belgeya I T F14 îmzeya barkodê çêbike"
description: "Belgeyên karsaziya xwe yên Ppsx bi I T F14 Barkodê îmze bikin. Bi çend rêzikên kodê re zû û bi hêsanî îmzeya Barkodê biafirînin da ku vebijarkên îmzekirinê saz bikin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Ppsx bi Barcode di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Ppsx bi îmzeyên Barcode zû û bi hêsanî peyda dike.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 pêkanîna GS1-ê ya barkodê ya Interleaved 2 ji 5 (ITF) ye ku jimara Tiştek Bazirganiya Gerdûnî şîfre dike.
          characterset: |
             Reqemên hejmarî (0-9).
          textcapacity: |
             13 jimar + 1 jimareya kontrolê.
          image: |
