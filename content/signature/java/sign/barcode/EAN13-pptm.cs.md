...
############################# Head ############################
head_title: "Dokument eSign Pptm s čárovým kódem E A N13 v Java"
head_description: "Vytvořte podpis čárového kódu E A N13 a vložte jej do dokumentu Pptm s Java pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu E A N13 pro dokument Pptm v Java"
description: "ePodepište své obchodní dokumenty ve formátu Pptm pomocí čárového kódu E A N13. Vygenerujte podpis čárového kódu rychle a snadno pomocí několika řádků kódu pro nastavení možností podepisování."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Nejčastěji používaným standardem EAN je třináctimístný EAN-13, nadmnožina původního 12místného standardu Universal Product Code.
          characterset: |
             Pouze číslice (0-9).
          textcapacity: |
             Kapacita kódového textu: přesně 12 číslic + 1 kontrolní číslice.
          image: |
