...
############################# Head ############################
head_title: "eSign Tiff ሰነድ በCode39 ባርኮድ በJava"
head_description: "የCode39 ባርኮድ ፊርማ ይፍጠሩ እና በTiff ሰነድ ላይ በJava ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለTiff ሰነድ የCode39 ባርኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Tiff የንግድ ሰነዶች በCode39 ባርኮድ ይመዝገቡ። የመመዝገቢያ አማራጮችን ለማዘጋጀት የባርኮድ ፊርማ በፍጥነት እና በቀላሉ በጥቂት የኮድ መስመሮች ይፍጠሩ።"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የTiff ሰነዶችን በBarcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
...
demos:
    enable: true
    title: "Tiff ሰነዶችን በBarcode ቀጥታ ማሳያ በመፈረም ላይ"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             አሃዛዊ አሃዞች (0-9) እና አቢይ ሆሄያት (A-Z) እና በርካታ ልዩ ቁምፊዎች (-፣ ., $, /, +, % እና ቦታ)።
          textcapacity: |
             ምንም ልዩ ገደቦች የሉም።
          image: |
