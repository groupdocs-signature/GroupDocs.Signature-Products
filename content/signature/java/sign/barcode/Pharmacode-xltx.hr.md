...
############################# Head ############################
head_title: "eSign Xltx dokument s Pharmacode crtičnim kodom u Java"
head_description: "Stvorite Pharmacode potpis crtičnog koda i stavite ga na Xltx dokument s Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje različitih formata datoteka."

############################# Header ############################
title: "Generirajte Pharmacode potpis crtičnog koda za Xltx dokument u Java"
description: "ePotpišite svoje Xltx poslovne dokumente pomoću Pharmacode crtičnog koda. Brzo i jednostavno generirajte potpis crtičnog koda s nekoliko redaka koda za postavljanje opcija potpisivanja."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Pharmacode, također poznat kao Pharmaceutical Binary Code, standard je crtičnog koda koji se koristi u farmaceutskoj industriji kao sustav kontrole pakiranja.
          characterset: |
             Brojčane znamenke (0-9).
          textcapacity: |
             Predstavlja samo jedan cijeli broj od 3 do 131070.
          image: |
