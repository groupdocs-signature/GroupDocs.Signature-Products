...
############################# Head ############################
head_title: "eSign Xlsx skjal með UPCE Strikamerki í Java"
head_description: "Búðu til UPCE Strikamerki undirskrift og settu hana á Xlsx skjal með Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita ýmis skráarsnið."

############################# Header ############################
title: "Búðu til UPCE Strikamerki undirskrift fyrir Xlsx skjal í Java"
description: "eSignaðu Xlsx viðskiptaskjölin þín með UPCE Strikamerki. Búðu til Strikamerki undirskrift fljótt og auðveldlega með nokkrum línum af kóða til að setja upp undirskriftarmöguleika."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Xlsx með Barcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Xlsx skjöl með Barcode undirskrift fljótt og auðveldlega.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Alhliða vörukóði er strikamerki sem er mikið notað um allan heim til að fylgjast með vöruvörum í verslunum. UPCE er 8 stafa afbrigði ef UPC.
          characterset: |
             Styður aðeins tölustafi (0-9).
          textcapacity: |
             Getu kóðatexta: nákvæmlega 7 tölustafir + 1 eftirlitsstafur.
          image: |
