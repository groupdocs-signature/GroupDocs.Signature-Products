...
############################# Head ############################
head_title: "eSign Xls doiciméad le E A N14 Barcode in Java"
head_description: "Cruthaigh E A N14 Síniú Barrachóid agus cuir ar Xls doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid E A N14 don doiciméad Xls in Java"
description: "eSínigh do dhoiciméid ghnó Xls le Barrachóid E A N14. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
steps:
    enable: true
    title_left: "Céimeanna chun Xls a shíniú le Barcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Xls a shíniú le sínithe Barcode go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Xls doiciméad le Barcode Taispeántas Beo"
    content: |
