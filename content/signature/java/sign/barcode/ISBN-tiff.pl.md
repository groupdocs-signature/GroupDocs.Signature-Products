...
############################# Head ############################
head_title: "Podpisz dokument Tiff z kodem kreskowym ISBN w Java"
head_description: "Utwórz podpis z kodem kreskowym ISBN i umieść go w dokumencie Tiff za pomocą Java, używając kilku linijek kodu. Użyj interfejsu GroupDocs Document Signature API do podpisywania różnych formatów plików."

############################# Header ############################
title: "Wygeneruj ISBN podpis z kodem kreskowym dla dokumentu Tiff w Java"
description: "ePodpisz swoje dokumenty biznesowe w Tiff za pomocą kodu kreskowego ISBN. Szybko i łatwo generuj podpis z kodem kreskowym za pomocą kilku linijek kodu, aby skonfigurować opcje podpisywania."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Międzynarodowy Standardowy Numer Książki (ISBN) to numeryczny komercyjny identyfikator książki, który ma być niepowtarzalny.[a][b] Wydawcy kupują numery ISBN od podmiotu stowarzyszonego Międzynarodowej Agencji ISBN.
          characterset: |
             Cyfry numeryczne (0-9).
          textcapacity: |
             Dokładnie 9 cyfr + 1 cyfra kontrolna.
          image: |
