...
############################# Head ############################
head_title: "eSign Docx dokument s črtno kodo Pdf417 v Java"
head_description: "Ustvarite podpis črtne kode Pdf417 in ga postavite na dokument Docx z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari Pdf417 podpis črtne kode za Docx dokument v Java"
description: "e-Podpišite svoje Docx poslovne dokumente s črtno kodo Pdf417. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 je zloženi linearni format črtne kode, ki se uporablja v različnih aplikacijah, kot so transport, identifikacijske kartice in upravljanje inventarja.
          characterset: |
