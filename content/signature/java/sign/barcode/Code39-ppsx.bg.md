...
############################# Head ############################
head_title: "eSign Ppsx документ с Code39 баркод в Java"
head_description: "Създайте Code39 баркод подпис и го поставете в Ppsx документ с Java, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature за подписване на различни файлови формати."

############################# Header ############################
title: "Генерирайте Code39 баркод подпис за документ Ppsx в Java"
description: "Електронно подпишете вашите Ppsx бизнес документи с Code39 баркод. Генерирайте баркод подпис бързо и лесно с няколко реда код, за да зададете опции за подписване."
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Ppsx с Barcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на Ppsx документи с Barcode подписи.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Код 39 (известен също като Alpha39, код 3 от 9, код 3/9, тип 39, USS код 39 или USD-3) е дискретна символика на баркод с променлива дължина.
          characterset: |
             Цифри (0-9) и главни букви (A-Z) и няколко специални символа (-, ., $, /, +, % и интервал).
          textcapacity: |
