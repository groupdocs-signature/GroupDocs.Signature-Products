...
############################# Head ############################
head_title: "Java içinde UPCE Barkodlu eSign Dotm belgesi"
head_description: "UPCE Barkod İmzası oluşturun ve birkaç satır kod kullanarak Java ile Dotm belgesine koyun. Çeşitli dosya biçimlerini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Dotm belgesi için UPCE Barkod imzası oluşturun"
description: "Dotm iş belgelerinizi UPCE Barkod ile e-imzalayın. İmzalama seçeneklerini ayarlamak için birkaç satır kodla hızlı ve kolay bir şekilde Barkod imzası oluşturun."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Evrensel Ürün Kodu, mağazalardaki ticari ürünlerin takibi için dünya çapında yaygın olarak kullanılan bir barkod sembolüdür. UPCE, UPC ise 8 basamaklı bir varyasyondur.
          characterset: |
             Yalnızca sayısal basamakları (0-9) destekler.
          textcapacity: |
             Codetext kapasitesi: tam olarak 7 basamak + 1 kontrol basamağı.
          image: |
