...
############################# Head ############################
head_title: "وثيقة eSign Xlsm مع ISBN رمز شريطي في Java"
head_description: "أنشئ ISBN Barcode Signature وضعه في مستند Xlsm باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء ISBN توقيع الرمز الشريطي للمستند Xlsm في Java"
