...
############################# Head ############################
head_title: "eSign Xlsm document met UPCA Barcode in Java"
head_description: "Maak een UPCA Barcode Signature en plaats deze op het Xlsm document met Java met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."

############################# Header ############################
title: "Genereer UPCA Barcode handtekening voor Xlsm document in Java"
description: "Onderteken uw Xlsm zakelijke documenten met UPCA Barcode. Genereer snel en eenvoudig een barcodehandtekening met een paar regels code om ondertekeningsopties in te stellen."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            De Universal Product Code is een barcode-symboliek die wereldwijd veel wordt gebruikt voor het volgen van handelsartikelen in winkels.
          characterset: |
             Numerieke cijfers (0-9).
          textcapacity: |
             Precies 11 cijfers + 1 controlecijfer.
          image: |
