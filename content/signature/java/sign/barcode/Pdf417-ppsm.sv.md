...
############################# Head ############################
head_title: "eSign Ppsm dokument med Pdf417 streckkod i Java"
head_description: "Skapa Pdf417 streckkodsignatur och lägg den på Ppsm dokument med Java med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera Pdf417 streckkodsignatur för Ppsm dokument i Java"
description: "esignera dina Ppsm affärsdokument med Pdf417 streckkod. Skapa streckkodsignatur snabbt och enkelt med några rader kod för att ställa in signeringsalternativ."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 är ett staplat linjärt streckkodsformat som används i en mängd olika applikationer som transport, ID-kort och lagerhantering.
          characterset: |
