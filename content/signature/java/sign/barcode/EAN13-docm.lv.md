...
############################# Head ############################
head_title: "eSign Docm dokuments ar E A N13 svītrkodu programmā Java"
head_description: "Izveidojiet E A N13 svītrkoda parakstu un ievietojiet to Docm dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt E A N13 svītrkoda parakstu dokumentam Docm programmā Java"
description: "eParakstiet savus Docm biznesa dokumentus, izmantojot E A N13 svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Visbiežāk izmantotais EAN standarts ir trīspadsmit ciparu EAN-13, kas ir sākotnējā 12 ciparu universālā produkta koda standarta superkopa.
          characterset: |
             Tikai ciparu cipari (0-9).
          textcapacity: |
             Koda teksta ietilpība: tieši 12 cipari + 1 kontrolcipars.
          image: |
