...
############################# Head ############################
head_title: "eSign Docm dokument s Pdf417 crtičnim kodom u Java"
head_description: "Stvorite Pdf417 potpis crtičnog koda i stavite ga na Docm dokument s Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje različitih formata datoteka."

############################# Header ############################
title: "Generirajte Pdf417 potpis crtičnog koda za Docm dokument u Java"
description: "ePotpišite svoje Docm poslovne dokumente pomoću Pdf417 crtičnog koda. Brzo i jednostavno generirajte potpis crtičnog koda s nekoliko redaka koda za postavljanje opcija potpisivanja."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Docm s Barcode u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Docm dokumenata s Barcode potpisima.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 je naslagani linearni format crtičnog koda koji se koristi u različitim aplikacijama kao što su transport, identifikacijske kartice i upravljanje inventarom.
          characterset: |
