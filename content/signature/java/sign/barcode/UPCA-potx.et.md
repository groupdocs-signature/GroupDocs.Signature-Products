...
############################# Head ############################
head_title: "eSign Potx dokument UPCA vöötkoodiga keeles Java"
head_description: "Looge UPCA vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile Potx tootega Java. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge Java-s dokumendile Potx vöötkoodiallkiri UPCA"
description: "eAllkirjasta oma Potx äridokumendid UPCA vöötkoodiga. Looge vöötkoodisignatuur kiiresti ja lihtsalt mõne koodirea abil allkirjastamisvalikute seadistamiseks."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Universaalne tootekood on vöötkoodi sümboolika, mida kasutatakse laialdaselt kogu maailmas kaubaartiklite jälgimiseks kauplustes.
          characterset: |
             Numbrilised numbrid (0-9).
          textcapacity: |
             Täpselt 11 numbrit + 1 kontrollnumber.
          image: |
