...
head_description: "Opprett UPCE strekkodesignatur og legg den på Xlsb-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."
