...
############################# Head ############################
head_title: "eSign Tar document avec Pdf417 Barcode in Java"
head_description: "Créez Pdf417 Barcode Signature et placez-le sur le document Tar avec Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres Pdf417 pour le document Tar dans Java"
description: "Signez électroniquement vos documents commerciaux Tar avec Pdf417 Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 est un format de code-barres linéaire empilé utilisé dans une variété d'applications telles que le transport, les cartes d'identification et la gestion des stocks.
          characterset: |
             Tous les 256 caractères ASCII.
          textcapacity: |
             Jusqu'à 800 caractères.
          image: |
