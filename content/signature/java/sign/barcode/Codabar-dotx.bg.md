...
############################# Head ############################
head_title: "eSign Dotx документ с Codabar баркод в Java"
head_description: "Създайте Codabar баркод подпис и го поставете в Dotx документ с Java, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature за подписване на различни файлови формати."

############################# Header ############################
title: "Генерирайте Codabar баркод подпис за документ Dotx в Java"
description: "Електронно подпишете вашите Dotx бизнес документи с Codabar баркод. Генерирайте баркод подпис бързо и лесно с няколко реда код, за да зададете опции за подписване."
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Dotx с Barcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на Dotx документи с Barcode подписи.
...
demos:
    enable: true
    title: "Подписване на Dotx документи с Barcode Демо на живо"
    content: |
