...
head_description: "Maak E A N14 Barcode Signature en plaats deze op Wmf document met Java met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
