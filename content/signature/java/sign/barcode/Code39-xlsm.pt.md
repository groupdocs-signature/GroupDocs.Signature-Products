...
############################# Head ############################
head_title: "eSign Xlsm documento com Code39 Código de barras em Java"
head_description: "Crie uma assinatura de código de barras Code39 e coloque-a no documento Xlsm com Java usando algumas linhas de código. Use a API de assinatura de documento do GroupDocs para assinar vários formatos de arquivo."

############################# Header ############################
title: "Gere assinatura de código de barras Code39 para Xlsm documento em Java"
description: "Assine seus documentos comerciais Xlsm com o código de barras Code39. Gere assinatura de código de barras de forma rápida e fácil com algumas linhas de código para configurar as opções de assinatura."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             Dígitos numéricos (0-9) e letras maiúsculas (A-Z) e vários caracteres especiais (-, ., $, /, +, % e espaço).
          textcapacity: |
