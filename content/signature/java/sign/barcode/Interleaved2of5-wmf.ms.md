...
############################# Head ############################
head_title: "eSign Wmf dokumen dengan Interleaved2of5 Barcode dalam Java"
head_description: "Cipta Interleaved2of5 Tandatangan Kod Bar dan letakkan pada Wmf dokumen dengan Java menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani pelbagai format fail."

############################# Header ############################
title: "Hasilkan Interleaved2of5 Tandatangan Kod Bar untuk Wmf dokumen dalam Java"
description: "eTandatangani dokumen perniagaan Wmf anda dengan Interleaved2of5 Barcode. Hasilkan tandatangan Kod Bar dengan cepat dan mudah dengan beberapa baris kod untuk menyediakan pilihan tandatangan."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Wmf dengan Barcode dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Wmf dengan tandatangan Barcode dengan cepat dan mudah.
