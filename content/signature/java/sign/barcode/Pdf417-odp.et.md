...
############################# Head ############################
head_title: "eSign Odp dokument Pdf417 vöötkoodiga keeles Java"
head_description: "Looge Pdf417 vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile Odp tootega Java. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge Java-s dokumendile Odp vöötkoodiallkiri Pdf417"
description: "eAllkirjasta oma Odp äridokumendid Pdf417 vöötkoodiga. Looge vöötkoodisignatuur kiiresti ja lihtsalt mõne koodirea abil allkirjastamisvalikute seadistamiseks."
...
steps:
    enable: true
    title_left: "Toimingud Odp allkirjastamiseks rakendusega Barcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Odp dokumente Barcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Odp allkirjastamine Barcode reaalajas demoga"
    content: |
