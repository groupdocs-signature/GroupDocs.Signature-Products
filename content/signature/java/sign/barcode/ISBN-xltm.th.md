...
############################# Head ############################
head_title: "eSign Xltm เอกสารด้วยบาร์โค้ด ISBN ใน Java"
head_description: "สร้าง ISBN Barcode Signature และใส่ลงในเอกสาร Xltm ด้วย Java โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API สำหรับการลงนามรูปแบบไฟล์ต่างๆ"

############################# Header ############################
title: "สร้าง ISBN ลายเซ็นบาร์โค้ดสำหรับเอกสาร Xltm ใน Java"
description: "eSign เอกสารทางธุรกิจ Xltm ของคุณด้วยบาร์โค้ด ISBN สร้างลายเซ็นบาร์โค้ดอย่างรวดเร็วและง่ายดายด้วยรหัสสองสามบรรทัดเพื่อตั้งค่าตัวเลือกการเซ็นชื่อ"
...
steps:
    enable: true
    title_left: "ขั้นตอนในการลงนาม Xltm กับ Barcode ใน Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ให้ความสามารถในการลงนามในเอกสาร Xltm ด้วยลายเซ็น Barcode อย่างรวดเร็วและง่ายดาย
...
demos:
    enable: true
    title: "การลงนามเอกสาร Xltm ด้วย Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            International Standard Book Number (ISBN) เป็นตัวระบุหนังสือเชิงพาณิชย์ที่เป็นตัวเลขซึ่งมีจุดประสงค์เพื่อให้ไม่ซ้ำใคร[a][b] ผู้จัดพิมพ์ซื้อ ISBN จากบริษัทในเครือของ International ISBN Agency
          characterset: |
             ตัวเลข (0-9)
          textcapacity: |
             ตัวเลข 9 หลัก + เช็ค 1 หลัก
          image: |
