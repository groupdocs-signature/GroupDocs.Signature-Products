...
############################# Head ############################
head_title: "eSign Svg documento con codice a barre Pdf417 in Java"
head_description: "Crea Pdf417 Firma codice a barre e inseriscilo nel documento Svg con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Pdf417 firma del codice a barre per il documento Svg in Java"
description: "Firma elettronicamente i tuoi documenti aziendali Svg con il codice a barre Pdf417. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Svg con Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Svg con firme Barcode in modo rapido e semplice.
