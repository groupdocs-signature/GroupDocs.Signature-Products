...
############################# Head ############################
head_title: "eSign Docx dokument s črtno kodo I T F14 v Java"
head_description: "Ustvarite podpis črtne kode I T F14 in ga postavite na dokument Docx z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari I T F14 podpis črtne kode za Docx dokument v Java"
description: "e-Podpišite svoje Docx poslovne dokumente s črtno kodo I T F14. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 je implementacija GS1 črtne kode Interleaved 2 of 5 (ITF) za kodiranje globalne številke trgovinske enote.
          characterset: |
             Številske številke (0-9).
          textcapacity: |
             13 številk + 1 kontrolna številka.
          image: |
