...
############################# Head ############################
head_title: "وثيقة eSign Xlsb مع Codabar رمز شريطي في Java"
head_description: "أنشئ Codabar Barcode Signature وضعه في مستند Xlsb باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Codabar توقيع الرمز الشريطي للمستند Xlsb في Java"
description: "قم بتوقيع Xlsb على مستندات الأعمال باستخدام الرمز الشريطي Codabar. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
