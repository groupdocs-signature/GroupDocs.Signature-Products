...
############################# Head ############################
head_title: "eSign Pdf փաստաթուղթը Codabar շտրիխ կոդով Java-ում"
head_description: "Ստեղծեք Codabar շտրիխ կոդի ստորագրություն և դրեք այն Pdf փաստաթղթում Java-ով` օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տարբեր ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք Codabar շտրիխ կոդ ստորագրություն Pdf փաստաթղթի համար Java-ում"
description: "Ստորագրեք ձեր Pdf բիզնես փաստաթղթերը Codabar շտրիխ կոդով: Ստեղծեք շտրիխ կոդ ստորագրություն արագ և հեշտությամբ մի քանի տող կոդի միջոցով՝ ստորագրման տարբերակները կարգավորելու համար:"
...
steps:
    enable: true
    title_left: "Pdf-ը Barcode-ով Java-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Pdf փաստաթղթերը Barcode ստորագրություններով:
...
demos:
    enable: true
    title: "Pdf փաստաթղթերի ստորագրում Barcode Live Demo-ով"
    content: |
