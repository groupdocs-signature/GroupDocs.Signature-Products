...
############################# Head ############################
head_title: "eSign Ppsm tài liệu với UPCE Mã vạch trong Java"
head_description: "Tạo Chữ ký Mã vạch UPCE và đưa nó vào tài liệu Ppsm với Java bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo UPCE Chữ ký mã vạch cho tài liệu Ppsm trong Java"
description: "eSign các tài liệu kinh doanh Ppsm của bạn bằng Mã vạch UPCE. Tạo chữ ký mã vạch nhanh chóng và dễ dàng với một vài dòng mã để thiết lập các tùy chọn ký."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Ppsm bằng Barcode trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Ppsm bằng chữ ký Barcode một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Ppsm bằng Barcode Live Demo"
    content: |
