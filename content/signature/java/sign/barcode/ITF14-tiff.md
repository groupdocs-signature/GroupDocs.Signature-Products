...
steps:
    ...
    code: |
        ...
        options.setEncodeType(BarcodeTypes.ITF14);
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with ITF14 BARCODE using Java"
    content: |
        Java ITF14 BARCODE signatures management API for documents and images. Add ITF14 BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
