...
############################# Head ############################
head_title: "eSign Xltx dokuments ar UPCE svītrkodu programmā Java"
head_description: "Izveidojiet UPCE svītrkoda parakstu un ievietojiet to Xltx dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt UPCE svītrkoda parakstu dokumentam Xltx programmā Java"
description: "eParakstiet savus Xltx biznesa dokumentus, izmantojot UPCE svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Xltx ar Barcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Xltx dokumentus ar Barcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Xltx parakstīšana, izmantojot Barcode tiešraides demonstrāciju"
    content: |
