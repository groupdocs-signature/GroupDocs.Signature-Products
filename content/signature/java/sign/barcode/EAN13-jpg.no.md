...
############################# Head ############################
head_title: "eSign Jpg-dokument med E A N13 strekkode i Java"
head_description: "Opprett E A N13 strekkodesignatur og legg den på Jpg-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer E A N13 strekkodesignatur for Jpg dokument i Java"
description: "eSignér Jpg-bedriftsdokumentene dine med E A N13 strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
steps:
    enable: true
    title_left: "Trinn for å signere Jpg med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Jpg-dokumenter med Barcode-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Jpg dokumenter med Barcode Live Demo"
    content: |
