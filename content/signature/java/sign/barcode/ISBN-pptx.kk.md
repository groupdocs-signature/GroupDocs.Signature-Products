...
############################# Head ############################
head_title: "eSign Pptx құжаты Java ішіндегі ISBN штрих-коды бар"
head_description: "ISBN штрих-код қолтаңбасын жасаңыз және оны кодтың бірнеше жолын пайдаланып Java арқылы Pptx құжатына қойыңыз. Әртүрлі файл пішімдеріне қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "Java ішінде Pptx құжаты үшін ISBN штрих-код қолтаңбасын жасаңыз"
description: "Pptx бизнес құжаттарыңызға ISBN штрих-кодпен e-қолтаңба қойыңыз. Қол қою опцияларын орнату үшін кодтың бірнеше жолы арқылы штрих-код қолтаңбасын жылдам және оңай жасаңыз."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Халықаралық стандартты кітап нөмірі (ISBN) бірегей болуға арналған сандық коммерциялық кітап идентификаторы болып табылады.[a][b] Баспагерлер ISBN нөмірін Халықаралық ISBN агенттігінің филиалынан сатып алады.
          characterset: |
             Сандық сандар (0-9).
          textcapacity: |
             Дәл 9 сан + 1 тексеру саны.
          image: |
