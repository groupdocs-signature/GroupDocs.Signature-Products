...
############################# Head ############################
head_title: "eSign Pptm ሰነድ በUPCA ባርኮድ በJava"
head_description: "የUPCA ባርኮድ ፊርማ ይፍጠሩ እና በPptm ሰነድ ላይ በJava ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለPptm ሰነድ የUPCA ባርኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Pptm የንግድ ሰነዶች በUPCA ባርኮድ ይመዝገቡ። የመመዝገቢያ አማራጮችን ለማዘጋጀት የባርኮድ ፊርማ በፍጥነት እና በቀላሉ በጥቂት የኮድ መስመሮች ይፍጠሩ።"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ሁለንተናዊ የምርት ኮድ በመደብሮች ውስጥ የንግድ ዕቃዎችን ለመከታተል በዓለም ዙሪያ በስፋት ጥቅም ላይ የሚውል የአሞሌ ኮድ ምልክት ነው።
          characterset: |
             የቁጥር አሃዞች (0-9)።
          textcapacity: |
             በትክክል 11 አሃዞች + 1 ቼክ አሃዝ።
          image: |
