...
############################# Head ############################
head_title: "eSign Jpg dokument Codabar vöötkoodiga keeles Java"
head_description: "Looge Codabar vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile Jpg tootega Java. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge Java-s dokumendile Jpg vöötkoodiallkiri Codabar"
description: "eAllkirjasta oma Jpg äridokumendid Codabar vöötkoodiga. Looge vöötkoodisignatuur kiiresti ja lihtsalt mõne koodirea abil allkirjastamisvalikute seadistamiseks."
...
steps:
    enable: true
    title_left: "Toimingud Jpg allkirjastamiseks rakendusega Barcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Jpg dokumente Barcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Jpg allkirjastamine Barcode reaalajas demoga"
    content: |
