...
head_description: "Opprett Codabar strekkodesignatur og legg den på Doc-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."
