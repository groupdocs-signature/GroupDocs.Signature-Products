...
############################# Head ############################
head_title: "eSign Pptm documento con codice a barre Interleaved2of5 in Java"
head_description: "Crea Interleaved2of5 Firma codice a barre e inseriscilo nel documento Pptm con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Interleaved2of5 firma del codice a barre per il documento Pptm in Java"
description: "Firma elettronicamente i tuoi documenti aziendali Pptm con il codice a barre Interleaved2of5. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Pptm con Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Pptm con firme Barcode in modo rapido e semplice.
...
demos:
    enable: true
    title: "Firma di documenti Pptm con Barcode Demo live"
    content: |
