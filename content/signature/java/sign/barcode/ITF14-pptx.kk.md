...
############################# Head ############################
head_title: "eSign Pptx құжаты Java ішіндегі I T F14 штрих-коды бар"
head_description: "I T F14 штрих-код қолтаңбасын жасаңыз және оны кодтың бірнеше жолын пайдаланып Java арқылы Pptx құжатына қойыңыз. Әртүрлі файл пішімдеріне қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "Java ішінде Pptx құжаты үшін I T F14 штрих-код қолтаңбасын жасаңыз"
description: "Pptx бизнес құжаттарыңызға I T F14 штрих-кодпен e-қолтаңба қойыңыз. Қол қою опцияларын орнату үшін кодтың бірнеше жолы арқылы штрих-код қолтаңбасын жылдам және оңай жасаңыз."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 – Жаһандық сауда элементінің нөмірін кодтау үшін Interleaved 2/5 (ITF) штрих-кодының GS1 орындалуы.
          characterset: |
             Сандық сандар (0-9).
          textcapacity: |
             13 сан + 1 тексеру саны.
          image: |
