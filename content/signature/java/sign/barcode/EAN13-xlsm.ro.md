...
############################# Head ############################
head_title: "eSign Xlsm document cu E A N13 cod de bare în Java"
head_description: "Creați semnătura codului de bare E A N13 și puneți-o pe documentul Xlsm cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare E A N13 pentru documentul Xlsm în Java"
description: "eSemnați documentele dvs. comerciale Xlsm cu codul de bare E A N13. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Cel mai frecvent utilizat standard EAN este EAN-13 din treisprezece cifre, un superset al standardului original de 12 cifre al codului universal de produs.
          characterset: |
             Numai cifre numerice (0-9).
          textcapacity: |
             Capacitate cod text: exact 12 cifre + 1 cifră de verificare.
          image: |
