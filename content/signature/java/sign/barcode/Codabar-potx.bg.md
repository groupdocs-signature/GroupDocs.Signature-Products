...
############################# Head ############################
head_title: "eSign Potx документ с Codabar баркод в Java"
head_description: "Създайте Codabar баркод подпис и го поставете в Potx документ с Java, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature за подписване на различни файлови формати."

############################# Header ############################
title: "Генерирайте Codabar баркод подпис за документ Potx в Java"
description: "Електронно подпишете вашите Potx бизнес документи с Codabar баркод. Генерирайте баркод подпис бързо и лесно с няколко реда код, за да зададете опции за подписване."
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Potx с Barcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на Potx документи с Barcode подписи.
...
demos:
    enable: true
    title: "Подписване на Potx документи с Barcode Демо на живо"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codabar е линеен символ на баркод, който е проектиран да се чете точно дори когато се отпечатва на матрични принтери за формуляри от много части, като самолетни фактури на FedEx и формуляр за кръвна банка.
          characterset: |
             Цифри (0-9) и специални знаци $/-:+.
          textcapacity: |
             Няма специфични ограничения.
          image: |
