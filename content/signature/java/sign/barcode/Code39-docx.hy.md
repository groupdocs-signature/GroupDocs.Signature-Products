...
############################# Head ############################
head_title: "eSign Docx փաստաթուղթը Code39 շտրիխ կոդով Java-ում"
head_description: "Ստեղծեք Code39 շտրիխ կոդի ստորագրություն և դրեք այն Docx փաստաթղթում Java-ով` օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տարբեր ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք Code39 շտրիխ կոդ ստորագրություն Docx փաստաթղթի համար Java-ում"
description: "Ստորագրեք ձեր Docx բիզնես փաստաթղթերը Code39 շտրիխ կոդով: Ստեղծեք շտրիխ կոդ ստորագրություն արագ և հեշտությամբ մի քանի տող կոդի միջոցով՝ ստորագրման տարբերակները կարգավորելու համար:"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Կոդ 39-ը (նաև հայտնի է որպես Alpha39, Code 3 of 9, Code 3/9, Type 39, USS Code 39 կամ USD-3) փոփոխական երկարությամբ, դիսկրետ շտրիխ կոդի խորհրդանիշ է:
          characterset: |
             Թվային թվեր (0-9) և մեծատառեր (A-Z) և մի շարք հատուկ նիշեր (-, ., $, /, +, %, և բացատ):
          textcapacity: |
