...
############################# Head ############################
head_title: "eSign Xlsm belgeya bi ISBN Barcode di Java"
head_description: "Îmzeya barkodê ya ISBN biafirîne û bi çend rêzikên kodê bi Java li ser belgeya Xlsm biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."

############################# Header ############################
title: "Di Java de ji bo belgeya ISBN îmzeya barkodê çêbike"
description: "Belgeyên karsaziya xwe yên Xlsm bi ISBN Barkodê îmze bikin. Bi çend rêzikên kodê re zû û bi hêsanî îmzeya Barkodê biafirînin da ku vebijarkên îmzekirinê saz bikin."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Nimreya Pirtûka Standard a Navneteweyî (ISBN) nasnameyek pirtûkê ya bazirganî ya jimareyî ye ku tê armanc kirin ku yekta be.[a][b] Weşanxane ISBN-an ji girêdayek Ajansa ISBN ya Navneteweyî dikirin.
          characterset: |
             Reqemên hejmarî (0-9).
          textcapacity: |
             Tam 9 jimar + 1 jimareya kontrolê.
          image: |
