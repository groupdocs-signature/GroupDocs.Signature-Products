...
head_description: "Maak E A N13 Barcode Signature en plaats deze op Odt document met Java met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
