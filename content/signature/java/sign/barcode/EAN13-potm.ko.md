...
############################# Head ############################
head_title: "Java의 E A N13 바코드로 Potm 문서에 전자 서명"
head_description: "E A N13 Barcode Signature를 생성하고 몇 줄의 코드를 사용하여 Java를 사용하여 Potm 문서에 넣습니다. 다양한 파일 형식에 서명하려면 GroupDocs 문서 서명 API를 사용하십시오."

############################# Header ############################
title: "Java에서 Potm 문서에 대한 E A N13 바코드 서명 생성"
description: "E A N13 바코드로 Potm 비즈니스 문서에 전자 서명하세요. 서명 옵션을 설정하는 몇 줄의 코드로 빠르고 쉽게 바코드 서명을 생성합니다."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            가장 일반적으로 사용되는 EAN 표준은 원래 12자리 범용 제품 코드 표준의 상위 집합인 13자리 EAN-13입니다.
          characterset: |
             숫자(0-9)만 가능합니다.
          textcapacity: |
             코드 텍스트 용량: 정확히 12자리 + 확인 1자리.
          image: |
