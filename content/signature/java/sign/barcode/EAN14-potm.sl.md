...
############################# Head ############################
head_title: "eSign Potm dokument s črtno kodo E A N14 v Java"
head_description: "Ustvarite podpis črtne kode E A N14 in ga postavite na dokument Potm z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari E A N14 podpis črtne kode za Potm dokument v Java"
description: "e-Podpišite svoje Potm poslovne dokumente s črtno kodo E A N14. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Potm z Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Potm s podpisi Barcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Potm z Barcode Live Demo"
    content: |
