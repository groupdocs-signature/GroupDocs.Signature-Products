...
############################# Head ############################
head_title: "Dokument eSign Pptm s čárovým kódem I T F14 v Java"
head_description: "Vytvořte podpis čárového kódu I T F14 a vložte jej do dokumentu Pptm s Java pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu I T F14 pro dokument Pptm v Java"
description: "ePodepište své obchodní dokumenty ve formátu Pptm pomocí čárového kódu I T F14. Vygenerujte podpis čárového kódu rychle a snadno pomocí několika řádků kódu pro nastavení možností podepisování."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 je implementace GS1 čárového kódu Interleaved 2 of 5 (ITF) pro zakódování čísla globální obchodní položky.
          characterset: |
             Číslice (0-9).
          textcapacity: |
             13 číslic + 1 kontrolní číslice.
          image: |
