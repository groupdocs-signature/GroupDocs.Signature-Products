...
############################# Head ############################
head_title: "eSign Dotm doiciméad le Code39 Barcode in Java"
head_description: "Cruthaigh Code39 Síniú Barrachóid agus cuir ar Dotm doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid Code39 don doiciméad Dotm in Java"
description: "eSínigh do dhoiciméid ghnó Dotm le Barrachóid Code39. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             digití uimhriúla (0-9) agus litreacha móra (A-Z) agus roinnt carachtair speisialta (-, ., $, /, +, %, agus spás).
          textcapacity: |
