...
############################# Head ############################
head_title: "Document electrònic Ods amb codi de barres E A N14 a Java"
head_description: "Creeu la signatura de codi de barres E A N14 i poseu-la al document Ods amb Java utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu E A N14 signatura de codi de barres per al document Ods a Java"
