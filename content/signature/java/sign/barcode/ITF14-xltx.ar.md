...
############################# Head ############################
head_title: "وثيقة eSign Xltx مع I T F14 رمز شريطي في Java"
head_description: "أنشئ I T F14 Barcode Signature وضعه في مستند Xltx باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء I T F14 توقيع الرمز الشريطي للمستند Xltx في Java"
description: "قم بتوقيع Xltx على مستندات الأعمال باستخدام الرمز الشريطي I T F14. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
