...
############################# Head ############################
head_title: "eSign Docx document cu UPCE cod de bare în Java"
head_description: "Creați semnătura codului de bare UPCE și puneți-o pe documentul Docx cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare UPCE pentru documentul Docx în Java"
description: "eSemnați documentele dvs. comerciale Docx cu codul de bare UPCE. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codul universal de produs este o simbolică a codurilor de bare care este utilizată pe scară largă în întreaga lume pentru urmărirea articolelor comerciale din magazine. UPCE este o variație de 8 cifre dacă UPC.
          characterset: |
             Acceptă numai cifre numerice (0-9).
          textcapacity: |
             Capacitate text cod: exact 7 cifre + 1 cifră de verificare.
          image: |
