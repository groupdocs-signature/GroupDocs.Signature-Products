...
############################# Head ############################
head_title: "eSign Tiff dokument med Code39 stregkode i Java"
head_description: "Opret Code39 stregkodesignatur og læg den på Tiff dokument med Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer Code39 Stregkodesignatur for Tiff dokument i Java"
description: "eSignér dine Tiff forretningsdokumenter med Code39 stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Kode 39 (også kendt som Alpha39, Kode 3 af 9, Kode 3/9, Type 39, USS Kode 39 eller USD-3) er en diskret stregkodesymbolologi med variabel længde.
          characterset: |
             Numeriske cifre (0-9) og store bogstaver (A-Z) og et antal specialtegn (-, ., $, /, +, % og mellemrum).
          textcapacity: |
