...
############################# Head ############################
head_title: "eSign Tar เอกสารด้วยบาร์โค้ด UPCE ใน Java"
head_description: "สร้าง UPCE Barcode Signature และใส่ลงในเอกสาร Tar ด้วย Java โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API สำหรับการลงนามรูปแบบไฟล์ต่างๆ"

############################# Header ############################
title: "สร้าง UPCE ลายเซ็นบาร์โค้ดสำหรับเอกสาร Tar ใน Java"
