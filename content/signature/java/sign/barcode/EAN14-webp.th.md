...
############################# Head ############################
head_title: "eSign Webp เอกสารด้วยบาร์โค้ด E A N14 ใน Java"
head_description: "สร้าง E A N14 Barcode Signature และใส่ลงในเอกสาร Webp ด้วย Java โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API สำหรับการลงนามรูปแบบไฟล์ต่างๆ"

############################# Header ############################
title: "สร้าง E A N14 ลายเซ็นบาร์โค้ดสำหรับเอกสาร Webp ใน Java"
description: "eSign เอกสารทางธุรกิจ Webp ของคุณด้วยบาร์โค้ด E A N14 สร้างลายเซ็นบาร์โค้ดอย่างรวดเร็วและง่ายดายด้วยรหัสสองสามบรรทัดเพื่อตั้งค่าตัวเลือกการเซ็นชื่อ"
...
steps:
    enable: true
    title_left: "ขั้นตอนในการลงนาม Webp กับ Barcode ใน Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ให้ความสามารถในการลงนามในเอกสาร Webp ด้วยลายเซ็น Barcode อย่างรวดเร็วและง่ายดาย
...
demos:
    enable: true
    title: "การลงนามเอกสาร Webp ด้วย Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            European Article Number หรือ EAN เป็นมาตรฐานที่อธิบายสัญลักษณ์บาร์โค้ดและระบบการนับที่ใช้ในการค้าโลกเพื่อระบุประเภทผลิตภัณฑ์ขายปลีกเฉพาะในการกำหนดค่าบรรจุภัณฑ์เฉพาะจากผู้ผลิตเฉพาะ
          characterset: |
             ตัวเลข (0-9) และอักขระพิเศษ
          textcapacity: |
             ตัวเลข 14 หลักเท่านั้น
          image: |
