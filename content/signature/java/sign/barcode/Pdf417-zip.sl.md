...
############################# Head ############################
head_title: "eSign Zip dokument s črtno kodo Pdf417 v Java"
head_description: "Ustvarite podpis črtne kode Pdf417 in ga postavite na dokument Zip z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari Pdf417 podpis črtne kode za Zip dokument v Java"
description: "e-Podpišite svoje Zip poslovne dokumente s črtno kodo Pdf417. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Zip z Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Zip s podpisi Barcode.
