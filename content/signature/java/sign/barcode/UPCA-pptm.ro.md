...
############################# Head ############################
head_title: "eSign Pptm document cu UPCA cod de bare în Java"
head_description: "Creați semnătura codului de bare UPCA și puneți-o pe documentul Pptm cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare UPCA pentru documentul Pptm în Java"
description: "eSemnați documentele dvs. comerciale Pptm cu codul de bare UPCA. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codul universal de produs este o simbolică a codurilor de bare care este utilizată pe scară largă în întreaga lume pentru urmărirea articolelor comerciale din magazine.
          characterset: |
             Cifre numerice (0-9).
          textcapacity: |
             Exact 11 cifre + 1 cifră de verificare.
          image: |
