...
############################# Head ############################
head_title: "eSign Ott-dokument met Code39 Strepiekode in Java"
head_description: "Skep Code39 Strepiekode Handtekening en plaas dit op Ott dokument met Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer Code39 strepieskode-handtekening vir Ott-dokument in Java"
description: "eTeken jou Ott besigheidsdokumente met Code39 Streepkode. Genereer strepieskode-handtekening vinnig en maklik met 'n paar reëls kode om ondertekenopsies op te stel."
...
steps:
    enable: true
    title_left: "Stappe om Ott met Barcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Ott dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
