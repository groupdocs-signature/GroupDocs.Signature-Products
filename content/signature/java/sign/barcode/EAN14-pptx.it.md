...
############################# Head ############################
head_title: "eSign Pptx documento con codice a barre E A N14 in Java"
head_description: "Crea E A N14 Firma codice a barre e inseriscilo nel documento Pptx con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera E A N14 firma del codice a barre per il documento Pptx in Java"
description: "Firma elettronicamente i tuoi documenti aziendali Pptx con il codice a barre E A N14. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Pptx con Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Pptx con firme Barcode in modo rapido e semplice.
...
demos:
    enable: true
    title: "Firma di documenti Pptx con Barcode Demo live"
    content: |
