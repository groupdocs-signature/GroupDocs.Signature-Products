...
############################# Head ############################
head_title: "eSign Dot dokumen dengan Interleaved2of5 Barcode di Java"
head_description: "Buat Interleaved2of5 Tanda Tangan Barcode dan letakkan di dokumen Dot dengan Java menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat Interleaved2of5 Tanda tangan kode batang untuk dokumen Dot di Java"
description: "eSign dokumen bisnis Dot Anda dengan Interleaved2of5 Barcode. Hasilkan tanda tangan Barcode dengan cepat dan mudah dengan beberapa baris kode untuk menyiapkan opsi penandatanganan."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Dot dengan Barcode di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Dot dengan Barcode tanda tangan dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Dot dengan Barcode Demo Langsung"
    content: |
