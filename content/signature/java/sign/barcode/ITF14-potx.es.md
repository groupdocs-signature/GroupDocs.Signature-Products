...
############################# Head ############################
head_title: "Firmar electrónicamente Potx documento con I T F14 código de barras en Java"
head_description: "Cree la firma de código de barras I T F14 y colóquela en el documento Potx con Java usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras I T F14 para el documento Potx en Java"
description: "Firme electrónicamente sus documentos comerciales de Potx con I T F14 Barcode. Genere una firma de código de barras rápida y fácilmente con unas pocas líneas de código para configurar las opciones de firma."
...
steps:
    enable: true
    title_left: "Pasos para firmar Potx con Barcode en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Potx con Barcode firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Potx documentos con Barcode Live Demo"
    content: |
