...
############################# Head ############################
head_title: "eSign Tiff dokument s črtno kodo Pharmacode v Java"
head_description: "Ustvarite podpis črtne kode Pharmacode in ga postavite na dokument Tiff z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari Pharmacode podpis črtne kode za Tiff dokument v Java"
description: "e-Podpišite svoje Tiff poslovne dokumente s črtno kodo Pharmacode. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Tiff z Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Tiff s podpisi Barcode.
