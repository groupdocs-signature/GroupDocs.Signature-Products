...
############################# Head ############################
head_title: "eSign Docm skjal með E A N14 Strikamerki í Java"
head_description: "Búðu til E A N14 Strikamerki undirskrift og settu hana á Docm skjal með Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita ýmis skráarsnið."

############################# Header ############################
title: "Búðu til E A N14 Strikamerki undirskrift fyrir Docm skjal í Java"
description: "eSignaðu Docm viðskiptaskjölin þín með E A N14 Strikamerki. Búðu til Strikamerki undirskrift fljótt og auðveldlega með nokkrum línum af kóða til að setja upp undirskriftarmöguleika."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Docm með Barcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Docm skjöl með Barcode undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Docm skjöl með Barcode lifandi kynningu"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Evrópsk vörunúmer eða EAN er staðall sem lýsir strikamerki og númerakerfi sem notað er í alþjóðlegum viðskiptum til að auðkenna tiltekna smásöluvörutegund, í tiltekinni umbúðastillingu, frá tilteknum framleiðanda.
          characterset: |
             Tölustafir (0-9) og sérstafir.
          textcapacity: |
             Nákvæmlega 14 tölustafir.
          image: |
