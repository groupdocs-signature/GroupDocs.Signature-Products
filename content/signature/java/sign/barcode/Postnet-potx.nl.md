...
head_description: "Maak Postnet Barcode Signature en plaats deze op Potx document met Java met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
