...
############################# Head ############################
head_title: "Document electrònic Odp amb codi de barres UPCE a Java"
head_description: "Creeu la signatura de codi de barres UPCE i poseu-la al document Odp amb Java utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu UPCE signatura de codi de barres per al document Odp a Java"
description: "eSigne els vostres documents comercials de Odp amb el codi de barres UPCE. Genereu la signatura de codi de barres de manera ràpida i senzilla amb unes poques línies de codi per configurar les opcions de signatura."
...
steps:
    enable: true
    title_left: "Passos per signar Odp amb Barcode a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Odp amb signatures Barcode de manera ràpida i senzilla.
...
demos:
    enable: true
    title: "Signant documents de Odp amb Barcode Demostració en directe"
    content: |
