...
############################# Head ############################
head_title: "eSign Otp เอกสารด้วยบาร์โค้ด ISBN ใน Java"
head_description: "สร้าง ISBN Barcode Signature และใส่ลงในเอกสาร Otp ด้วย Java โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API สำหรับการลงนามรูปแบบไฟล์ต่างๆ"

############################# Header ############################
title: "สร้าง ISBN ลายเซ็นบาร์โค้ดสำหรับเอกสาร Otp ใน Java"
description: "eSign เอกสารทางธุรกิจ Otp ของคุณด้วยบาร์โค้ด ISBN สร้างลายเซ็นบาร์โค้ดอย่างรวดเร็วและง่ายดายด้วยรหัสสองสามบรรทัดเพื่อตั้งค่าตัวเลือกการเซ็นชื่อ"
...
steps:
    enable: true
    title_left: "ขั้นตอนในการลงนาม Otp กับ Barcode ใน Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ให้ความสามารถในการลงนามในเอกสาร Otp ด้วยลายเซ็น Barcode อย่างรวดเร็วและง่ายดาย
...
demos:
    enable: true
    title: "การลงนามเอกสาร Otp ด้วย Barcode Live Demo"
    content: |
