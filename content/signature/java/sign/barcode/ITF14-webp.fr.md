...
############################# Head ############################
head_title: "eSign Webp document avec I T F14 Barcode in Java"
head_description: "Créez I T F14 Barcode Signature et placez-le sur le document Webp avec Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres I T F14 pour le document Webp dans Java"
description: "Signez électroniquement vos documents commerciaux Webp avec I T F14 Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 est l'implémentation GS1 d'un code à barres entrelacé 2 sur 5 (ITF) pour coder un numéro d'article commercial mondial.
          characterset: |
             Chiffres numériques (0-9).
          textcapacity: |
             13 chiffres + 1 chiffre de contrôle.
          image: |
