...
############################# Head ############################
head_title: "Dokument eSign Xltm s čárovým kódem Code39 v Java"
head_description: "Vytvořte podpis čárového kódu Code39 a vložte jej do dokumentu Xltm s Java pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu Code39 pro dokument Xltm v Java"
description: "ePodepište své obchodní dokumenty ve formátu Xltm pomocí čárového kódu Code39. Vygenerujte podpis čárového kódu rychle a snadno pomocí několika řádků kódu pro nastavení možností podepisování."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Kód 39 (také známý jako Alpha39, Code 3 of 9, Code 3/9, Type 39, USS Code 39 nebo USD-3) je diskrétní čárový kód proměnné délky.
          characterset: |
             Číslice (0-9) a velká písmena (A-Z) a řada speciálních znaků (-, ., $, /, +, %, a mezera).
          textcapacity: |
