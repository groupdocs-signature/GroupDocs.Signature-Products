...
############################# Head ############################
head_title: "Document electrònic Tar amb codi de barres Code39 a Java"
head_description: "Creeu la signatura de codi de barres Code39 i poseu-la al document Tar amb Java utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu Code39 signatura de codi de barres per al document Tar a Java"
