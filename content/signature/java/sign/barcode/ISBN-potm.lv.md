...
############################# Head ############################
head_title: "eSign Potm dokuments ar ISBN svītrkodu programmā Java"
head_description: "Izveidojiet ISBN svītrkoda parakstu un ievietojiet to Potm dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt ISBN svītrkoda parakstu dokumentam Potm programmā Java"
description: "eParakstiet savus Potm biznesa dokumentus, izmantojot ISBN svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Starptautiskais standarta grāmatas numurs (ISBN) ir komerciālas grāmatas ciparu identifikators, kas ir paredzēts unikāls.[a][b] Izdevēji iegādājas ISBN no Starptautiskās ISBN aģentūras filiāles.
          characterset: |
             Ciparu cipari (0-9).
          textcapacity: |
             Tieši 9 cipari + 1 kontrolcipars.
          image: |
