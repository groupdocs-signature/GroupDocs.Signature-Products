...
############################# Head ############################
head_title: "在 Java 中带有 ISBN 条码的 eSign Dotm 文档"
head_description: "创建 ISBN 条码签名并使用几行代码将其放在带有 Java 的 Dotm 文档中。使用 GroupDocs 文档签名 API 对各种文件格式进行签名。"

############################# Header ############################
title: "在 Java 中为 Dotm 文档生成 ISBN 条码签名"
description: "使用 ISBN 条码对您的 Dotm 业务文档进行电子签名。只需几行代码即可快速轻松地生成条形码签名以设置签名选项。"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            国际标准书号 (ISBN) 是一个数字商业图书标识符，旨在具有唯一性。[a][b] 出版商从国际 ISBN 机构的附属机构购买 ISBN。
          characterset: |
             数字 (0-9)。
          textcapacity: |
             正好 9 位数字 + 1 个校验位。
