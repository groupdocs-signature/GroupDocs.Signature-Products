...
############################# Head ############################
head_title: "eSign Otp -asiakirja ISBN-viivakoodilla Java"
head_description: "Luo ISBN Viivakoodiallekirjoitus ja laita se Otp-asiakirjaan, jossa on Java muutamalla rivillä koodia. Käytä GroupDocs Document Signature API:ta eri tiedostomuotojen allekirjoittamiseen."

############################# Header ############################
title: "Luo ISBN viivakoodiallekirjoitus asiakirjalle Otp ohjelmassa Java"
description: "eAllekirjoita Otp yritysasiakirjasi ISBN-viivakoodilla. Luo viivakoodiallekirjoitus nopeasti ja helposti muutamalla koodirivillä allekirjoitusvaihtoehtojen määrittämiseksi."
...
steps:
    enable: true
    title_left: "Vaiheet Otp:n allekirjoittamiseen Barcode -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Otp-asiakirjoja Barcode-allekirjoituksella nopeasti ja helposti.
