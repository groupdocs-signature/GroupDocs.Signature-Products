...
############################# Head ############################
head_title: "eSign Odt document avec Codabar Barcode in Java"
head_description: "Créez Codabar Barcode Signature et placez-le sur le document Odt avec Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres Codabar pour le document Odt dans Java"
description: "Signez électroniquement vos documents commerciaux Odt avec Codabar Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
