...
############################# Head ############################
head_title: "وثيقة eSign Odt مع Pdf417 رمز شريطي في Java"
head_description: "أنشئ Pdf417 Barcode Signature وضعه في مستند Odt باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Pdf417 توقيع الرمز الشريطي للمستند Odt في Java"
