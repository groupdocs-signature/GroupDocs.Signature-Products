...
############################# Head ############################
head_title: "eSign Ppsm έγγραφο με Pharmacode Barcode σε Java"
head_description: "Δημιουργήστε την υπογραφή γραμμικού κώδικα Pharmacode και τοποθετήστε την στο έγγραφο Ppsm με το Java χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για την υπογραφή διαφόρων μορφών αρχείων."

############################# Header ############################
title: "Δημιουργήστε Pharmacode υπογραφή γραμμικού κώδικα για το έγγραφο Ppsm στο Java"
description: "Ηλεκτρονικά υπογράψτε τα επαγγελματικά σας έγγραφα Ppsm με Pharmacode Barcode. Δημιουργήστε υπογραφή Barcode γρήγορα και εύκολα με μερικές γραμμές κώδικα για να ρυθμίσετε τις επιλογές υπογραφής."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Το Pharmacode, γνωστό και ως Pharmaceutical Binary Code, είναι ένα πρότυπο γραμμωτού κώδικα, που χρησιμοποιείται στη φαρμακοβιομηχανία ως σύστημα ελέγχου συσκευασίας.
          characterset: |
             Αριθμητικά ψηφία (0-9).
          textcapacity: |
             Αντιπροσωπεύει μόνο έναν ακέραιο από 3 έως 131070.
          image: |
