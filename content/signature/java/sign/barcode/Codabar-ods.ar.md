...
############################# Head ############################
head_title: "وثيقة eSign Ods مع Codabar رمز شريطي في Java"
head_description: "أنشئ Codabar Barcode Signature وضعه في مستند Ods باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Codabar توقيع الرمز الشريطي للمستند Ods في Java"
