...
############################# Head ############################
head_title: "eSign Ppsm dokument s E A N14 čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu E A N14 a vložte ho do dokumentu Ppsm s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte E A N14 podpis čiarového kódu pre dokument Ppsm v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Ppsm pomocou čiarového kódu E A N14. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Ppsm pomocou Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Ppsm pomocou podpisov Barcode.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Ppsm pomocou živej ukážky Barcode"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Európske číslo výrobku alebo EAN je štandard opisujúci symboliku čiarového kódu a systém číslovania používaný v globálnom obchode na identifikáciu konkrétneho typu maloobchodného produktu v špecifickej konfigurácii balenia od konkrétneho výrobcu.
          characterset: |
