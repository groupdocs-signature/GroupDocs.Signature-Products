...
############################# Head ############################
head_title: "eSign Dotm document cu E A N13 cod de bare în Java"
head_description: "Creați semnătura codului de bare E A N13 și puneți-o pe documentul Dotm cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare E A N13 pentru documentul Dotm în Java"
description: "eSemnați documentele dvs. comerciale Dotm cu codul de bare E A N13. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Dotm cu Barcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Dotm cu semnături Barcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Dotm cu Barcode Live Demo"
    content: |
