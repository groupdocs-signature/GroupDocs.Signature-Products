...
############################# Head ############################
head_title: "eSign Dotm dokuments ar Code39 svītrkodu programmā Java"
head_description: "Izveidojiet Code39 svītrkoda parakstu un ievietojiet to Dotm dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt Code39 svītrkoda parakstu dokumentam Dotm programmā Java"
description: "eParakstiet savus Dotm biznesa dokumentus, izmantojot Code39 svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             Ciparu cipari (0–9) un lielie burti (A–Z) un vairākas speciālās rakstzīmes (-, ., $, /, +, % un atstarpe).
          textcapacity: |
