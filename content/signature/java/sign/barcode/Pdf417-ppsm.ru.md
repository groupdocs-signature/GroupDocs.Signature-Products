...
############################# Head ############################
head_title: "eSign Ppsm документ со штрих-кодом Pdf417 в Java"
head_description: "Создайте подпись штрих-кода Pdf417 и поместите ее в документ Ppsm с Java, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода Pdf417 для документа Ppsm в Java"
description: "Подпишите свои бизнес-документы Ppsm с помощью штрих-кода Pdf417. Быстро и легко создавайте подпись штрих-кода с помощью нескольких строк кода для настройки параметров подписи."
...
steps:
    enable: true
    title_left: "Действия по подписанию Ppsm с помощью Barcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Ppsm с подписями Barcode.
...
demos:
    enable: true
    title: "Подписание Ppsm документов с помощью Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 — это формат линейных штрих-кодов с накоплением, используемый в различных приложениях, таких как транспорт, удостоверения личности и управление запасами.
          characterset: |
