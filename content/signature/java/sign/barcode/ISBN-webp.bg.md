...
############################# Head ############################
head_title: "eSign Webp документ с ISBN баркод в Java"
head_description: "Създайте ISBN баркод подпис и го поставете в Webp документ с Java, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature за подписване на различни файлови формати."

############################# Header ############################
title: "Генерирайте ISBN баркод подпис за документ Webp в Java"
description: "Електронно подпишете вашите Webp бизнес документи с ISBN баркод. Генерирайте баркод подпис бързо и лесно с няколко реда код, за да зададете опции за подписване."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Международният стандартен номер на книгата (ISBN) е цифров търговски идентификатор на книга, който е предназначен да бъде уникален.[a][b] Издателите купуват ISBN от филиал на Международната агенция за ISBN.
          characterset: |
             Цифри (0-9).
          textcapacity: |
             Точно 9 цифри + 1 контролна цифра.
          image: |
