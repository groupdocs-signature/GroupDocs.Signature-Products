...
############################# Head ############################
head_title: "eSign Dotm-dokument med Pdf417 strekkode i Java"
head_description: "Opprett Pdf417 strekkodesignatur og legg den på Dotm-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer Pdf417 strekkodesignatur for Dotm dokument i Java"
description: "eSignér Dotm-bedriftsdokumentene dine med Pdf417 strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 er et stablet lineært strekkodeformat som brukes i en rekke applikasjoner som transport, identifikasjonskort og lagerstyring.
          characterset: |
             Alle 256 ASCII-tegn.
          textcapacity: |
             Opptil 800 tegn.
