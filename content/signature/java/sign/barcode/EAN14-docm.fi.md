...
############################# Head ############################
head_title: "eSign Docm -asiakirja E A N14-viivakoodilla Java"
head_description: "Luo E A N14 Viivakoodiallekirjoitus ja laita se Docm-asiakirjaan, jossa on Java muutamalla rivillä koodia. Käytä GroupDocs Document Signature API:ta eri tiedostomuotojen allekirjoittamiseen."

############################# Header ############################
title: "Luo E A N14 viivakoodiallekirjoitus asiakirjalle Docm ohjelmassa Java"
description: "eAllekirjoita Docm yritysasiakirjasi E A N14-viivakoodilla. Luo viivakoodiallekirjoitus nopeasti ja helposti muutamalla koodirivillä allekirjoitusvaihtoehtojen määrittämiseksi."
...
steps:
    enable: true
    title_left: "Vaiheet Docm:n allekirjoittamiseen Barcode -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Docm-asiakirjoja Barcode-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Docm asiakirjoja Barcode Live-demolla"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Eurooppalainen artikkelinumero tai EAN on standardi, joka kuvaa viivakoodisymboliaa ja numerointijärjestelmää, jota käytetään maailmanlaajuisessa kaupassa tietyn valmistajan tietyn vähittäismyyntituotetyypin tunnistamiseen tietyssä pakkauskokoonpanossa.
          characterset: |
             Numerot (0-9) ja erikoismerkit.
          textcapacity: |
             Täsmälleen 14 numeroa.
          image: |
