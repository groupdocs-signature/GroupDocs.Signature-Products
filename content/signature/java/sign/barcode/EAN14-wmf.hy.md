...
############################# Head ############################
head_title: "eSign Wmf փաստաթուղթը E A N14 շտրիխ կոդով Java-ում"
head_description: "Ստեղծեք E A N14 շտրիխ կոդի ստորագրություն և դրեք այն Wmf փաստաթղթում Java-ով` օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տարբեր ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք E A N14 շտրիխ կոդ ստորագրություն Wmf փաստաթղթի համար Java-ում"
description: "Ստորագրեք ձեր Wmf բիզնես փաստաթղթերը E A N14 շտրիխ կոդով: Ստեղծեք շտրիխ կոդ ստորագրություն արագ և հեշտությամբ մի քանի տող կոդի միջոցով՝ ստորագրման տարբերակները կարգավորելու համար:"
...
steps:
    enable: true
    title_left: "Wmf-ը Barcode-ով Java-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Wmf փաստաթղթերը Barcode ստորագրություններով:
...
demos:
    enable: true
    title: "Wmf փաստաթղթերի ստորագրում Barcode Live Demo-ով"
    content: |
