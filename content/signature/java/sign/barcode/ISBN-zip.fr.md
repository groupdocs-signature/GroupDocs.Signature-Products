...
############################# Head ############################
head_title: "eSign Zip document avec ISBN Barcode in Java"
head_description: "Créez ISBN Barcode Signature et placez-le sur le document Zip avec Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres ISBN pour le document Zip dans Java"
description: "Signez électroniquement vos documents commerciaux Zip avec ISBN Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Le numéro international normalisé du livre (ISBN) est un identifiant numérique de livre commercial destiné à être unique.[a][b] Les éditeurs achètent des ISBN auprès d'une filiale de l'Agence internationale de l'ISBN.
          characterset: |
             Chiffres numériques (0-9).
          textcapacity: |
             Exactement 9 chiffres + 1 chiffre de contrôle.
          image: |
