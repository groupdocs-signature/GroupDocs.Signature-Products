...
############################# Head ############################
head_title: "Java içinde E A N13 Barkodlu eSign Xlsm belgesi"
head_description: "E A N13 Barkod İmzası oluşturun ve birkaç satır kod kullanarak Java ile Xlsm belgesine koyun. Çeşitli dosya biçimlerini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Xlsm belgesi için E A N13 Barkod imzası oluşturun"
description: "Xlsm iş belgelerinizi E A N13 Barkod ile e-imzalayın. İmzalama seçeneklerini ayarlamak için birkaç satır kodla hızlı ve kolay bir şekilde Barkod imzası oluşturun."
...
steps:
    enable: true
    title_left: "Java içinde Barcode ile Xlsm imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Xlsm belgelerini Barcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            En yaygın olarak kullanılan EAN standardı, orijinal 12 basamaklı Evrensel Ürün Kodu standardının bir üst kümesi olan on üç basamaklı EAN-13'tür.
          characterset: |
             Yalnızca sayısal rakamlar (0-9).
          textcapacity: |
             Kod metni kapasitesi: tam olarak 12 basamak + 1 kontrol basamağı.
          image: |
