...
############################# Head ############################
head_title: "Документ eSign Xltm зі штрих-кодом ISBN у Java"
head_description: "Створіть підпис штрих-коду ISBN і додайте його в документ Xltm за допомогою Java за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs для підпису різних форматів файлів."

############################# Header ############################
title: "Згенеруйте підпис штрих-коду ISBN для документа Xltm у Java"
description: "Електронно підписуйте свої ділові документи Xltm штрих-кодом ISBN. Згенеруйте підпис штрих-коду швидко та легко за допомогою кількох рядків коду, щоб налаштувати параметри підпису."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Міжнародний стандартний номер книги (ISBN) — це цифровий комерційний ідентифікатор книги, який має бути унікальним.[a][b] Видавці купують ISBN у філії Міжнародного агентства ISBN.
          characterset: |
             Числові цифри (0-9).
          textcapacity: |
             Рівно 9 цифр + 1 контрольна цифра.
          image: |
