...
head_description: "Create UPCE Barcode Signature and put it on Ppt document with Java using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."
