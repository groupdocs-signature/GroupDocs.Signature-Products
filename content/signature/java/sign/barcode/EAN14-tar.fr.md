...
############################# Head ############################
head_title: "eSign Tar document avec E A N14 Barcode in Java"
head_description: "Créez E A N14 Barcode Signature et placez-le sur le document Tar avec Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres E A N14 pour le document Tar dans Java"
description: "Signez électroniquement vos documents commerciaux Tar avec E A N14 Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
...
steps:
    enable: true
    title_left: "Étapes pour signer Tar avec Barcode dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Tar avec des signatures Barcode.
...
demos:
    enable: true
    title: "Signature de documents Tar avec Barcode Live Demo"
    content: |
