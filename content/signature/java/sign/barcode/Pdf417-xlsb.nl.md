...
head_description: "Maak Pdf417 Barcode Signature en plaats deze op Xlsb document met Java met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
