...
############################# Head ############################
head_title: "eSign Doc dokument s Code39 čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu Code39 a vložte ho do dokumentu Doc s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte Code39 podpis čiarového kódu pre dokument Doc v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Doc pomocou čiarového kódu Code39. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Doc pomocou Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Doc pomocou podpisov Barcode.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Doc pomocou živej ukážky Barcode"
    content: |
