...
############################# Head ############################
head_title: "Документ eSign Xlsm зі штрих-кодом E A N14 у Java"
head_description: "Створіть підпис штрих-коду E A N14 і додайте його в документ Xlsm за допомогою Java за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs для підпису різних форматів файлів."

############################# Header ############################
title: "Згенеруйте підпис штрих-коду E A N14 для документа Xlsm у Java"
description: "Електронно підписуйте свої ділові документи Xlsm штрих-кодом E A N14. Згенеруйте підпис штрих-коду швидко та легко за допомогою кількох рядків коду, щоб налаштувати параметри підпису."
...
steps:
    enable: true
    title_left: "Кроки для підпису Xlsm за допомогою Barcode у Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) надає можливість швидко та легко підписувати документи Xlsm за допомогою підписів Barcode.
...
demos:
    enable: true
    title: "Підпис документів Xlsm за допомогою Barcode Live Demo"
    content: |
