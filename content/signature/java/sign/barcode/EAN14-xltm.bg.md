...
############################# Head ############################
head_title: "eSign Xltm документ с E A N14 баркод в Java"
head_description: "Създайте E A N14 баркод подпис и го поставете в Xltm документ с Java, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature за подписване на различни файлови формати."

############################# Header ############################
title: "Генерирайте E A N14 баркод подпис за документ Xltm в Java"
description: "Електронно подпишете вашите Xltm бизнес документи с E A N14 баркод. Генерирайте баркод подпис бързо и лесно с няколко реда код, за да зададете опции за подписване."
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Xltm с Barcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на Xltm документи с Barcode подписи.
...
demos:
    enable: true
    title: "Подписване на Xltm документи с Barcode Демо на живо"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Европейски артикулен номер или EAN е стандарт, описващ баркод символика и система за номериране, използвани в световната търговия за идентифициране на конкретен тип продукт за продажба на дребно, в специфична конфигурация на опаковката, от конкретен производител.
          characterset: |
             Цифри (0-9) и специални знаци.
          textcapacity: |
             Точно 14 цифри.
          image: |
