...
############################# Head ############################
head_title: "eSign Xlsm dokumentas su Codabar brūkšniniu kodu Java"
head_description: "Sukurkite Codabar brūkšninio kodo parašą ir įdėkite jį į Xlsm dokumentą su Java naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite Codabar brūkšninio kodo parašą Xlsm dokumentui Java"
description: "e. Pasirašykite Xlsm verslo dokumentus naudodami Codabar brūkšninį kodą. Greitai ir lengvai sugeneruokite brūkšninio kodo parašą naudodami kelias kodo eilutes, kad nustatytumėte pasirašymo parinktis."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            „Codabar“ yra linijinio brūkšninio kodo simbolika, sukurta taip, kad ją būtų galima tiksliai perskaityti net spausdinant taškiniais spausdintuvais kelių dalių formoms, tokioms kaip „FedEx“ oro sąskaitos ir kraujo banko formos.
          characterset: |
