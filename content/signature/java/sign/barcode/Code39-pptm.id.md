...
############################# Head ############################
head_title: "eSign Pptm dokumen dengan Code39 Barcode di Java"
head_description: "Buat Code39 Tanda Tangan Barcode dan letakkan di dokumen Pptm dengan Java menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat Code39 Tanda tangan kode batang untuk dokumen Pptm di Java"
description: "eSign dokumen bisnis Pptm Anda dengan Code39 Barcode. Hasilkan tanda tangan Barcode dengan cepat dan mudah dengan beberapa baris kode untuk menyiapkan opsi penandatanganan."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             Digit numerik (0-9) dan huruf besar (A-Z) dan sejumlah karakter khusus (-, ., $, /, +, %, dan spasi).
          textcapacity: |
