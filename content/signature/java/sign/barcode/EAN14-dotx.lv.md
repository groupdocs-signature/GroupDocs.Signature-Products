...
############################# Head ############################
head_title: "eSign Dotx dokuments ar E A N14 svītrkodu programmā Java"
head_description: "Izveidojiet E A N14 svītrkoda parakstu un ievietojiet to Dotx dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt E A N14 svītrkoda parakstu dokumentam Dotx programmā Java"
description: "eParakstiet savus Dotx biznesa dokumentus, izmantojot E A N14 svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Dotx ar Barcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Dotx dokumentus ar Barcode parakstiem.
        
        * Izveidojiet paraksta klases gadījumu, kas nodrošina Dotx failu, kas paredzēts parakstīšanai kā ceļš vai atmiņas straume
        * Izveidojiet SignOptions klasi un iestatiet visus pieprasītos datus.
        * Izsauciet metodi Signature.Sign(), kas nodod izvades Dotx failu vai atmiņas straumi
...
demos:
    enable: true
    title: "Dokumentu Dotx parakstīšana, izmantojot Barcode tiešraides demonstrāciju"
    content: |
       Parakstiet Dotx failu ar dažādiem parakstiem tūlīt, apmeklējot vietni [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Jūs gaida bezmaksas tiešsaistes demonstrācija.
...
more_formats:
    ...
    content: |
        "Varat arī parakstīt Dotx ar citiem paraksta veidiem. Lūdzu, skatiet sarakstu zemāk."
    format: 
