...
############################# Head ############################
head_title: "eSign Ppsx dokument ISBN vöötkoodiga keeles Java"
head_description: "Looge ISBN vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile Ppsx tootega Java. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge Java-s dokumendile Ppsx vöötkoodiallkiri ISBN"
description: "eAllkirjasta oma Ppsx äridokumendid ISBN vöötkoodiga. Looge vöötkoodisignatuur kiiresti ja lihtsalt mõne koodirea abil allkirjastamisvalikute seadistamiseks."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Rahvusvaheline raamatu standardnumber (ISBN) on kommertsraamatu numbriline identifikaator, mis peab olema kordumatu.[a][b] Väljaandjad ostavad ISBN-e Rahvusvahelise ISBN-agentuuri sidusettevõttelt.
          characterset: |
             Numbrilised numbrid (0-9).
          textcapacity: |
             Täpselt 9 numbrit + 1 kontrollnumber.
          image: |
