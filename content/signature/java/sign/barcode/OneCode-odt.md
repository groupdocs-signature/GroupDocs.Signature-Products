...
steps:
    ...
    code: |
        ...
        options.setEncodeType(BarcodeTypes.ONECODE);
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with ONECODE BARCODE using Java"
    content: |
        Java ONECODE BARCODE signatures management API for documents and images. Add ONECODE BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
