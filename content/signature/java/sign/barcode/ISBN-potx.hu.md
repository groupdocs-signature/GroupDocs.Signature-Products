...
############################# Head ############################
head_title: "eSign Potx dokumentum ISBN vonalkóddal a Java nyelven"
head_description: "Hozzon létre ISBN vonalkód-aláírást, és helyezze el a Potx dokumentumra a Java termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "ISBN vonalkód aláírás létrehozása a Potx dokumentumhoz a Java programban"
description: "eAláírja Potx üzleti dokumentumait ISBN vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
steps:
    enable: true
    title_left: "A Potx aláírásának lépései a Barcode segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Potx dokumentumok gyors és egyszerű aláírását Barcode aláírással.
...
demos:
    enable: true
    title: "Potx dokumentumok aláírása Barcode élő bemutatóval"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            A nemzetközi szabványos könyvszám (ISBN) egy numerikus kereskedelmi könyvazonosító, amelyet egyedinek szántak.[a][b] A kiadók az ISBN-eket a Nemzetközi ISBN Ügynökség leányvállalatától vásárolják meg.
          characterset: |
             Numerikus számjegyek (0-9).
          textcapacity: |
             Pontosan 9 számjegy + 1 ellenőrző számjegy.
          image: |
