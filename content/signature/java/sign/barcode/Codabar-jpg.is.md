...
############################# Head ############################
head_title: "eSign Jpg skjal með Codabar Strikamerki í Java"
head_description: "Búðu til Codabar Strikamerki undirskrift og settu hana á Jpg skjal með Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita ýmis skráarsnið."

############################# Header ############################
title: "Búðu til Codabar Strikamerki undirskrift fyrir Jpg skjal í Java"
description: "eSignaðu Jpg viðskiptaskjölin þín með Codabar Strikamerki. Búðu til Strikamerki undirskrift fljótt og auðveldlega með nokkrum línum af kóða til að setja upp undirskriftarmöguleika."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Jpg með Barcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Jpg skjöl með Barcode undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Jpg skjöl með Barcode lifandi kynningu"
    content: |
