...
############################# Head ############################
head_title: "eSign Pptm-dokument med UPCE strekkode i Java"
head_description: "Opprett UPCE strekkodesignatur og legg den på Pptm-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer UPCE strekkodesignatur for Pptm dokument i Java"
description: "eSignér Pptm-bedriftsdokumentene dine med UPCE strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
steps:
    enable: true
    title_left: "Trinn for å signere Pptm med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Pptm-dokumenter med Barcode-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Pptm dokumenter med Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Universal Product Code er en strekkodesymbologi som er mye brukt over hele verden for å spore handelsvarer i butikker. UPCE er en 8-sifret variant hvis UPC.
          characterset: |
             Støtter kun numeriske sifre (0-9).
          textcapacity: |
             Kodetekstkapasitet: nøyaktig 7 siffer + 1 kontrollsiffer.
          image: |
