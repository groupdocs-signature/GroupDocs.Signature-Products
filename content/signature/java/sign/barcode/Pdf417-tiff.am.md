...
############################# Head ############################
head_title: "eSign Tiff ሰነድ በPdf417 ባርኮድ በJava"
head_description: "የPdf417 ባርኮድ ፊርማ ይፍጠሩ እና በTiff ሰነድ ላይ በJava ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለTiff ሰነድ የPdf417 ባርኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Tiff የንግድ ሰነዶች በPdf417 ባርኮድ ይመዝገቡ። የመመዝገቢያ አማራጮችን ለማዘጋጀት የባርኮድ ፊርማ በፍጥነት እና በቀላሉ በጥቂት የኮድ መስመሮች ይፍጠሩ።"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 እንደ ትራንስፖርት፣ መታወቂያ ካርዶች እና የእቃ ዝርዝር አስተዳደር ባሉ የተለያዩ አፕሊኬሽኖች ውስጥ የሚያገለግል የተቆለለ የመስመር ባርኮድ ቅርጸት ነው።
          characterset: |
             ሁሉም 256 ASCII ቁምፊዎች.
          textcapacity: |
             እስከ 800 ቁምፊዎች.
