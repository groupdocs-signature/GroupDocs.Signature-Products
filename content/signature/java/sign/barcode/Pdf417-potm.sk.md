...
############################# Head ############################
head_title: "eSign Potm dokument s Pdf417 čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu Pdf417 a vložte ho do dokumentu Potm s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte Pdf417 podpis čiarového kódu pre dokument Potm v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Potm pomocou čiarového kódu Pdf417. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 je skladaný formát lineárneho čiarového kódu používaný v rôznych aplikáciách, ako je doprava, identifikačné karty a správa zásob.
          characterset: |
