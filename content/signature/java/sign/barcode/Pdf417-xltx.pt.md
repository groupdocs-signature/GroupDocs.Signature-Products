...
############################# Head ############################
head_title: "eSign Xltx documento com Pdf417 Código de barras em Java"
head_description: "Crie uma assinatura de código de barras Pdf417 e coloque-a no documento Xltx com Java usando algumas linhas de código. Use a API de assinatura de documento do GroupDocs para assinar vários formatos de arquivo."

############################# Header ############################
title: "Gere assinatura de código de barras Pdf417 para Xltx documento em Java"
description: "Assine seus documentos comerciais Xltx com o código de barras Pdf417. Gere assinatura de código de barras de forma rápida e fácil com algumas linhas de código para configurar as opções de assinatura."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 é um formato de código de barras linear empilhado usado em uma variedade de aplicações, como transporte, cartões de identificação e gerenciamento de estoque.
          characterset: |
