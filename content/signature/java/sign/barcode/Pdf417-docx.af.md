...
############################# Head ############################
head_title: "eSign Docx-dokument met Pdf417 Strepiekode in Java"
head_description: "Skep Pdf417 Strepiekode Handtekening en plaas dit op Docx dokument met Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer Pdf417 strepieskode-handtekening vir Docx-dokument in Java"
description: "eTeken jou Docx besigheidsdokumente met Pdf417 Streepkode. Genereer strepieskode-handtekening vinnig en maklik met 'n paar reëls kode om ondertekenopsies op te stel."
...
steps:
    enable: true
    title_left: "Stappe om Docx met Barcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Docx dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Docx dokumente met Barcode Regstreekse Demo"
    content: |
