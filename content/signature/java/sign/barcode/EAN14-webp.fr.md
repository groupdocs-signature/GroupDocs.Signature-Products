...
############################# Head ############################
head_title: "eSign Webp document avec E A N14 Barcode in Java"
head_description: "Créez E A N14 Barcode Signature et placez-le sur le document Webp avec Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres E A N14 pour le document Webp dans Java"
description: "Signez électroniquement vos documents commerciaux Webp avec E A N14 Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Le numéro d'article européen ou EAN est une norme décrivant une symbologie de code-barres et un système de numérotation utilisé dans le commerce mondial pour identifier un type de produit de détail spécifique, dans une configuration d'emballage spécifique, d'un fabricant spécifique.
          characterset: |
