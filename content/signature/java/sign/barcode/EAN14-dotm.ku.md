...
############################# Head ############################
head_title: "eSign Dotm belgeya bi E A N14 Barcode di Java"
head_description: "Îmzeya barkodê ya E A N14 biafirîne û bi çend rêzikên kodê bi Java li ser belgeya Dotm biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."

############################# Header ############################
title: "Di Java de ji bo belgeya E A N14 îmzeya barkodê çêbike"
description: "Belgeyên karsaziya xwe yên Dotm bi E A N14 Barkodê îmze bikin. Bi çend rêzikên kodê re zû û bi hêsanî îmzeya Barkodê biafirînin da ku vebijarkên îmzekirinê saz bikin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Dotm bi Barcode di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Dotm bi îmzeyên Barcode zû û bi hêsanî peyda dike.
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Dotm bi Barcode Demoya Zindî"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Jimareya Gotara Ewropî an EAN standardek e ku sembolek barkodê û pergala hejmarkirinê diyar dike ku di bazirganiya gerdûnî de tê bikar anîn da ku celebek hilberek firotanê ya taybetî, di veavakirinek pakkirinê ya taybetî de, ji hilberînerek taybetî nas bike.
          characterset: |
             Hêjmarên hejmarî (0-9) û tîpên taybetî.
          textcapacity: |
             Tam 14 reqemên hejmarî.
          image: |
