...
############################# Head ############################
head_title: "eSign Dotx tài liệu với E A N13 Mã vạch trong Java"
head_description: "Tạo Chữ ký Mã vạch E A N13 và đưa nó vào tài liệu Dotx với Java bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo E A N13 Chữ ký mã vạch cho tài liệu Dotx trong Java"
description: "eSign các tài liệu kinh doanh Dotx của bạn bằng Mã vạch E A N13. Tạo chữ ký mã vạch nhanh chóng và dễ dàng với một vài dòng mã để thiết lập các tùy chọn ký."
