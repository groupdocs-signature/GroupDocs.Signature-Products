...
############################# Head ############################
head_title: "eSign Xltm dokument med E A N13 streckkod i Java"
head_description: "Skapa E A N13 streckkodsignatur och lägg den på Xltm dokument med Java med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera E A N13 streckkodsignatur för Xltm dokument i Java"
description: "esignera dina Xltm affärsdokument med E A N13 streckkod. Skapa streckkodsignatur snabbt och enkelt med några rader kod för att ställa in signeringsalternativ."
...
steps:
    enable: true
    title_left: "Steg för att signera Xltm med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Xltm-dokument med Barcode-signaturer snabbt och enkelt.
