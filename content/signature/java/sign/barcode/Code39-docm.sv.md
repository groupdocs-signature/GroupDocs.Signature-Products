...
############################# Head ############################
head_title: "eSign Docm dokument med Code39 streckkod i Java"
head_description: "Skapa Code39 streckkodsignatur och lägg den på Docm dokument med Java med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera Code39 streckkodsignatur för Docm dokument i Java"
description: "esignera dina Docm affärsdokument med Code39 streckkod. Skapa streckkodsignatur snabbt och enkelt med några rader kod för att ställa in signeringsalternativ."
...
steps:
    enable: true
    title_left: "Steg för att signera Docm med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Docm-dokument med Barcode-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Docm dokument med Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Kod 39 (även känd som Alpha39, Code 3 of 9, Code 3/9, Type 39, USS Code 39 eller USD-3) är en diskret streckkodssymbologi med variabel längd.
          characterset: |
             Numeriska siffror (0-9) och versaler (A-Z) och ett antal specialtecken (-, ., $, /, +, % och mellanslag).
          textcapacity: |
