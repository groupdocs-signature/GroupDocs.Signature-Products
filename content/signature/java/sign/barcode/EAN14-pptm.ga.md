...
############################# Head ############################
head_title: "eSign Pptm doiciméad le E A N14 Barcode in Java"
head_description: "Cruthaigh E A N14 Síniú Barrachóid agus cuir ar Pptm doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid E A N14 don doiciméad Pptm in Java"
description: "eSínigh do dhoiciméid ghnó Pptm le Barrachóid E A N14. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
steps:
    enable: true
    title_left: "Céimeanna chun Pptm a shíniú le Barcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Pptm a shíniú le sínithe Barcode go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Pptm doiciméad le Barcode Taispeántas Beo"
    content: |
