...
############################# Head ############################
head_title: "eSign Dotm doiciméad le ISBN Barcode in Java"
head_description: "Cruthaigh ISBN Síniú Barrachóid agus cuir ar Dotm doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid ISBN don doiciméad Dotm in Java"
description: "eSínigh do dhoiciméid ghnó Dotm le Barrachóid ISBN. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
steps:
    enable: true
    title_left: "Céimeanna chun Dotm a shíniú le Barcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Dotm a shíniú le sínithe Barcode go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Dotm doiciméad le Barcode Taispeántas Beo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is aitheantóir leabhar tráchtála uimhriúil í an Uimhir Chaighdeánach Idirnáisiúnta Leabhar (ISBN) a bheartaítear a bheith uathúil.[a][b] Ceannaíonn foilsitheoirí ISBN ó chleamhnaithe den Ghníomhaireacht Idirnáisiúnta ISBN.
          characterset: |
             digití uimhriúla (0-9).
          textcapacity: |
             Go díreach 9 ndigit + 1 dhigit seic.
          image: |
