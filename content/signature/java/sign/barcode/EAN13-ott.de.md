...
############################# Head ############################
head_title: "Ott-Dokument mit E A N13-Barcode in Java eSignieren"
head_description: "Erstellen Sie eine E A N13-Barcode-Signatur und fügen Sie sie mit ein paar Codezeilen in ein Ott-Dokument mit Java ein. Verwenden Sie die GroupDocs Document Signature API zum Signieren verschiedener Dateiformate."

############################# Header ############################
title: "E A N13-Barcode-Signatur für Ott-Dokument in Java generieren"
description: "Unterzeichnen Sie Ihre Ott-Geschäftsdokumente mit E A N13-Barcode. Generieren Sie Barcode-Signaturen schnell und einfach mit wenigen Codezeilen, um Signaturoptionen einzurichten."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Ott mit Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Ott-Dokumente mit Barcode-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Ott-Dokumenten mit Barcode Live-Demo"
    content: |
