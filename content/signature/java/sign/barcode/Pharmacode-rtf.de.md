...
############################# Head ############################
head_title: "Rtf-Dokument mit Pharmacode-Barcode in Java eSignieren"
head_description: "Erstellen Sie eine Pharmacode-Barcode-Signatur und fügen Sie sie mit ein paar Codezeilen in ein Rtf-Dokument mit Java ein. Verwenden Sie die GroupDocs Document Signature API zum Signieren verschiedener Dateiformate."

############################# Header ############################
title: "Pharmacode-Barcode-Signatur für Rtf-Dokument in Java generieren"
description: "Unterzeichnen Sie Ihre Rtf-Geschäftsdokumente mit Pharmacode-Barcode. Generieren Sie Barcode-Signaturen schnell und einfach mit wenigen Codezeilen, um Signaturoptionen einzurichten."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Rtf mit Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Rtf-Dokumente mit Barcode-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Rtf-Dokumenten mit Barcode Live-Demo"
    content: |
