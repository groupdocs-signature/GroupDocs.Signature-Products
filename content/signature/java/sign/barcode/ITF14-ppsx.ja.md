...
############################# Head ############################
head_title: "Java で I T F14 バーコードを使用して Ppsx 文書に eSign"
head_description: "I T F14 バーコード署名を作成し、数行のコードを使用して Java で Ppsx ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "Java の Ppsx ドキュメントの I T F14 バーコード署名を生成します"
description: "Ppsx ビジネス文書に I T F14 バーコードで電子署名します。署名オプションを設定するための数行のコードで、バーコード署名をすばやく簡単に生成します。"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 は、Global Trade Item Number をエンコードするための Interleaved 2 of 5 (ITF) バーコードの GS1 実装です。
          characterset: |
             数字 (0 から 9)。
          textcapacity: |
             13桁＋チェックデジット1桁。
