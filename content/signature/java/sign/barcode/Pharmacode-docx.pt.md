...
############################# Head ############################
head_title: "eSign Docx documento com Pharmacode Código de barras em Java"
head_description: "Crie uma assinatura de código de barras Pharmacode e coloque-a no documento Docx com Java usando algumas linhas de código. Use a API de assinatura de documento do GroupDocs para assinar vários formatos de arquivo."

############################# Header ############################
title: "Gere assinatura de código de barras Pharmacode para Docx documento em Java"
description: "Assine seus documentos comerciais Docx com o código de barras Pharmacode. Gere assinatura de código de barras de forma rápida e fácil com algumas linhas de código para configurar as opções de assinatura."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Pharmacode, também conhecido como Código Binário Farmacêutico, é um padrão de código de barras, usado na indústria farmacêutica como sistema de controle de embalagens.
          characterset: |
             Dígitos numéricos (0-9).
          textcapacity: |
             Representa apenas um único inteiro de 3 a 131070.
          image: |
