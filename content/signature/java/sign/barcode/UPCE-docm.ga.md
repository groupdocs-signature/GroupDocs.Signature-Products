...
############################# Head ############################
head_title: "eSign Docm doiciméad le UPCE Barcode in Java"
head_description: "Cruthaigh UPCE Síniú Barrachóid agus cuir ar Docm doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid UPCE don doiciméad Docm in Java"
description: "eSínigh do dhoiciméid ghnó Docm le Barrachóid UPCE. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
steps:
    enable: true
    title_left: "Céimeanna chun Docm a shíniú le Barcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Docm a shíniú le sínithe Barcode go tapa agus go héasca.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is siombaleolaíocht barrachóid é an Cód Táirge Uilíoch a úsáidtear go forleathan ar fud an domhain chun míreanna trádála i siopaí a rianú. Is athrú 8 ndigit é UPCE más UPC.
          characterset: |
             Ní thacaíonn ach le digití uimhriúla (0-9).
          textcapacity: |
             Acmhainn an chóidthéacs: 7 ndigit go díreach + 1 dhigit seiceála.
          image: |
