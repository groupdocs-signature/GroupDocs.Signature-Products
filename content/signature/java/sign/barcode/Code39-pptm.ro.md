...
############################# Head ############################
head_title: "eSign Pptm document cu Code39 cod de bare în Java"
head_description: "Creați semnătura codului de bare Code39 și puneți-o pe documentul Pptm cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare Code39 pentru documentul Pptm în Java"
description: "eSemnați documentele dvs. comerciale Pptm cu codul de bare Code39. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codul 39 (cunoscut și sub numele de Alpha39, Cod 3 din 9, Cod 3/9, Tip 39, Cod USS 39 sau USD-3) este o lungime variabilă, simboluri de cod de bare discrete.
          characterset: |
             Cifre numerice (0-9) și litere mari (A-Z) și un număr de caractere speciale (-, ., $, /, +, % și spațiu).
          textcapacity: |
