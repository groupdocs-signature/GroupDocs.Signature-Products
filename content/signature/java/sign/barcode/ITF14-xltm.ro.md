...
############################# Head ############################
head_title: "eSign Xltm document cu I T F14 cod de bare în Java"
head_description: "Creați semnătura codului de bare I T F14 și puneți-o pe documentul Xltm cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare I T F14 pentru documentul Xltm în Java"
description: "eSemnați documentele dvs. comerciale Xltm cu codul de bare I T F14. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 este implementarea GS1 a unui cod de bare Interleaved 2 of 5 (ITF) pentru a codifica un număr global de articol comercial.
          characterset: |
             Cifre numerice (0-9).
          textcapacity: |
             13 cifre + 1 cifră de verificare.
          image: |
