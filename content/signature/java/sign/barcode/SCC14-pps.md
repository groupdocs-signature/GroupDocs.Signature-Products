...
steps:
    ...
    code: |
        ...
        options.setEncodeType(BarcodeTypes.SCC14);
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with SCC14 BARCODE using Java"
    content: |
        Java SCC14 BARCODE signatures management API for documents and images. Add SCC14 BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
