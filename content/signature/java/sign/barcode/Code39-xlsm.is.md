...
############################# Head ############################
head_title: "eSign Xlsm skjal með Code39 Strikamerki í Java"
head_description: "Búðu til Code39 Strikamerki undirskrift og settu hana á Xlsm skjal með Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita ýmis skráarsnið."

############################# Header ############################
title: "Búðu til Code39 Strikamerki undirskrift fyrir Xlsm skjal í Java"
description: "eSignaðu Xlsm viðskiptaskjölin þín með Code39 Strikamerki. Búðu til Strikamerki undirskrift fljótt og auðveldlega með nokkrum línum af kóða til að setja upp undirskriftarmöguleika."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             Tölustafir (0-9) og hástafir (A-Z) og fjöldi sérstafa (-, ., $, /, +, % og bil).
          textcapacity: |
