...
############################# Head ############################
head_title: "eSign Webp tài liệu với I T F14 Mã vạch trong Java"
head_description: "Tạo Chữ ký Mã vạch I T F14 và đưa nó vào tài liệu Webp với Java bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo I T F14 Chữ ký mã vạch cho tài liệu Webp trong Java"
description: "eSign các tài liệu kinh doanh Webp của bạn bằng Mã vạch I T F14. Tạo chữ ký mã vạch nhanh chóng và dễ dàng với một vài dòng mã để thiết lập các tùy chọn ký."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 là việc GS1 triển khai mã vạch xen kẽ 2 trong 5 (ITF) để mã hóa Mã số thương phẩm toàn cầu.
          characterset: |
             Chữ số (0-9).
          textcapacity: |
             13 chữ số + 1 chữ số kiểm tra.
          image: |
