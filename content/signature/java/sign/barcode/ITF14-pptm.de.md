...
############################# Head ############################
head_title: "Pptm-Dokument mit I T F14-Barcode in Java eSignieren"
head_description: "Erstellen Sie eine I T F14-Barcode-Signatur und fügen Sie sie mit ein paar Codezeilen in ein Pptm-Dokument mit Java ein. Verwenden Sie die GroupDocs Document Signature API zum Signieren verschiedener Dateiformate."

############################# Header ############################
title: "I T F14-Barcode-Signatur für Pptm-Dokument in Java generieren"
description: "Unterzeichnen Sie Ihre Pptm-Geschäftsdokumente mit I T F14-Barcode. Generieren Sie Barcode-Signaturen schnell und einfach mit wenigen Codezeilen, um Signaturoptionen einzurichten."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 ist die GS1-Implementierung eines Interleaved 2 of 5 (ITF)-Barcodes zur Codierung einer Global Trade Item Number.
          characterset: |
             Numerische Ziffern (0-9).
          textcapacity: |
             13 Ziffern + 1 Prüfziffer.
          image: |
