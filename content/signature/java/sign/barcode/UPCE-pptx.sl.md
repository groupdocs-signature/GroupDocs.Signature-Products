...
############################# Head ############################
head_title: "eSign Pptx dokument s črtno kodo UPCE v Java"
head_description: "Ustvarite podpis črtne kode UPCE in ga postavite na dokument Pptx z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari UPCE podpis črtne kode za Pptx dokument v Java"
description: "e-Podpišite svoje Pptx poslovne dokumente s črtno kodo UPCE. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Univerzalna koda izdelka je simbologija črtne kode, ki se široko uporablja po vsem svetu za sledenje trgovinskih predmetov v trgovinah. UPCE je 8-mestna različica UPC.
          characterset: |
             Podpira samo številske številke (0-9).
          textcapacity: |
             Zmogljivost kodnega besedila: točno 7 števk + 1 kontrolna številka.
          image: |
