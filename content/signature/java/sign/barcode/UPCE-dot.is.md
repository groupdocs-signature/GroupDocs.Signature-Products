...
############################# Head ############################
head_title: "eSign Dot skjal með UPCE Strikamerki í Java"
head_description: "Búðu til UPCE Strikamerki undirskrift og settu hana á Dot skjal með Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita ýmis skráarsnið."

############################# Header ############################
title: "Búðu til UPCE Strikamerki undirskrift fyrir Dot skjal í Java"
description: "eSignaðu Dot viðskiptaskjölin þín með UPCE Strikamerki. Búðu til Strikamerki undirskrift fljótt og auðveldlega með nokkrum línum af kóða til að setja upp undirskriftarmöguleika."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Dot með Barcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Dot skjöl með Barcode undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Dot skjöl með Barcode lifandi kynningu"
    content: |
