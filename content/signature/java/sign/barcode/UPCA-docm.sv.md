...
############################# Head ############################
head_title: "eSign Docm dokument med UPCA streckkod i Java"
head_description: "Skapa UPCA streckkodsignatur och lägg den på Docm dokument med Java med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera UPCA streckkodsignatur för Docm dokument i Java"
description: "esignera dina Docm affärsdokument med UPCA streckkod. Skapa streckkodsignatur snabbt och enkelt med några rader kod för att ställa in signeringsalternativ."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Universal Product Code är en streckkodssymbologi som används flitigt över hela världen för att spåra handelsvaror i butiker.
          characterset: |
             Numeriska siffror (0-9).
          textcapacity: |
             Exakt 11 siffror + 1 kontrollsiffra.
          image: |
