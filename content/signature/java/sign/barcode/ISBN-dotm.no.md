...
############################# Head ############################
head_title: "eSign Dotm-dokument med ISBN strekkode i Java"
head_description: "Opprett ISBN strekkodesignatur og legg den på Dotm-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer ISBN strekkodesignatur for Dotm dokument i Java"
description: "eSignér Dotm-bedriftsdokumentene dine med ISBN strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            International Standard Book Number (ISBN) er en numerisk kommersiell bokidentifikator som er ment å være unik.[a][b] Utgivere kjøper ISBN-numre fra en tilknyttet organisasjon til International ISBN Agency.
          characterset: |
             Numeriske sifre (0-9).
          textcapacity: |
             Nøyaktig 9 siffer + 1 kontrollsiffer.
          image: |
