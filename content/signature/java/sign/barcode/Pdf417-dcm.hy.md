...
############################# Head ############################
head_title: "eSign Dcm փաստաթուղթը Pdf417 շտրիխ կոդով Java-ում"
head_description: "Ստեղծեք Pdf417 շտրիխ կոդի ստորագրություն և դրեք այն Dcm փաստաթղթում Java-ով` օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տարբեր ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք Pdf417 շտրիխ կոդ ստորագրություն Dcm փաստաթղթի համար Java-ում"
description: "Ստորագրեք ձեր Dcm բիզնես փաստաթղթերը Pdf417 շտրիխ կոդով: Ստեղծեք շտրիխ կոդ ստորագրություն արագ և հեշտությամբ մի քանի տող կոդի միջոցով՝ ստորագրման տարբերակները կարգավորելու համար:"
...
steps:
    enable: true
    title_left: "Dcm-ը Barcode-ով Java-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Dcm փաստաթղթերը Barcode ստորագրություններով:
