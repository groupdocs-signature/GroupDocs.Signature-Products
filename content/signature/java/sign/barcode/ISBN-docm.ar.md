...
############################# Head ############################
head_title: "وثيقة eSign Docm مع ISBN رمز شريطي في Java"
head_description: "أنشئ ISBN Barcode Signature وضعه في مستند Docm باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء ISBN توقيع الرمز الشريطي للمستند Docm في Java"
description: "قم بتوقيع Docm على مستندات الأعمال باستخدام الرمز الشريطي ISBN. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            رقم الكتاب القياسي الدولي (ISBN) هو معرّف رقمي للكتب التجارية يُقصد به أن يكون فريدًا. [أ] [ب] يشتري الناشرون أرقام ISBN من إحدى الشركات التابعة لوكالة ISBN الدولية.
          characterset: |
             أرقام رقمية (0-9).
          textcapacity: |
             9 أرقام بالضبط + 1 خانة تحقق.
          image: |
