...
############################# Head ############################
head_title: "eSign Dotx tài liệu với UPCA Mã vạch trong Java"
head_description: "Tạo Chữ ký Mã vạch UPCA và đưa nó vào tài liệu Dotx với Java bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo UPCA Chữ ký mã vạch cho tài liệu Dotx trong Java"
description: "eSign các tài liệu kinh doanh Dotx của bạn bằng Mã vạch UPCA. Tạo chữ ký mã vạch nhanh chóng và dễ dàng với một vài dòng mã để thiết lập các tùy chọn ký."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Dotx bằng Barcode trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Dotx bằng chữ ký Barcode một cách nhanh chóng và dễ dàng.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Mã sản phẩm chung là một ký hiệu mã vạch được sử dụng rộng rãi trên toàn thế giới để theo dõi các thương phẩm trong các cửa hàng.
          characterset: |
             Chữ số (0-9).
          textcapacity: |
             Chính xác 11 chữ số + 1 chữ số kiểm tra.
          image: |
