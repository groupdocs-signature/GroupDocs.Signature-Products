...
############################# Head ############################
head_title: "eSign Xls dokument med UPCA stregkode i Java"
head_description: "Opret UPCA stregkodesignatur og læg den på Xls dokument med Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer UPCA Stregkodesignatur for Xls dokument i Java"
description: "eSignér dine Xls forretningsdokumenter med UPCA stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
steps:
    enable: true
    title_left: "Trin til at signere Xls med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Xls dokumenter med Barcode signaturer hurtigt og nemt.
