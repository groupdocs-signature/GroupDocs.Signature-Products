...
############################# Head ############################
head_title: "وثيقة eSign Ppsm مع ISBN رمز شريطي في Java"
head_description: "أنشئ ISBN Barcode Signature وضعه في مستند Ppsm باستخدام Java باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء ISBN توقيع الرمز الشريطي للمستند Ppsm في Java"
