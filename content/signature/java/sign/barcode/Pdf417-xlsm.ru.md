...
############################# Head ############################
head_title: "eSign Xlsm документ со штрих-кодом Pdf417 в Java"
head_description: "Создайте подпись штрих-кода Pdf417 и поместите ее в документ Xlsm с Java, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода Pdf417 для документа Xlsm в Java"
