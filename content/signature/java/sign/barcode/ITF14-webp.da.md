...
############################# Head ############################
head_title: "eSign Webp dokument med I T F14 stregkode i Java"
head_description: "Opret I T F14 stregkodesignatur og læg den på Webp dokument med Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer I T F14 Stregkodesignatur for Webp dokument i Java"
description: "eSignér dine Webp forretningsdokumenter med I T F14 stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 er GS1-implementeringen af ​​en Interleaved 2 of 5 (ITF) stregkode til at kode et Global Trade Item Number.
          characterset: |
             Numeriske cifre (0-9).
          textcapacity: |
             13 cifre + 1 kontrolciffer.
          image: |
