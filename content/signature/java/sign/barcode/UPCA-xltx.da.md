...
############################# Head ############################
head_title: "eSign Xltx dokument med UPCA stregkode i Java"
head_description: "Opret UPCA stregkodesignatur og læg den på Xltx dokument med Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer UPCA Stregkodesignatur for Xltx dokument i Java"
description: "eSignér dine Xltx forretningsdokumenter med UPCA stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Den universelle produktkode er en stregkodesymbolik, der er meget brugt over hele verden til sporing af handelsvarer i butikker.
          characterset: |
             Numeriske cifre (0-9).
          textcapacity: |
             Præcis 11 cifre + 1 kontrolciffer.
          image: |
