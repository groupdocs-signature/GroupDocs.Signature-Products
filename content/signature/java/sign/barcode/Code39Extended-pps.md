...
steps:
    ...
    code: |
        ...
        options.setEncodeType(BarcodeTypes.CODE39EXTENDED);
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with CODE39EXTENDED BARCODE using Java"
    content: |
        Java CODE39EXTENDED BARCODE signatures management API for documents and images. Add CODE39EXTENDED BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
