...
############################# Head ############################
head_title: "Dokument eSign Potm s čárovým kódem UPCE v Java"
head_description: "Vytvořte podpis čárového kódu UPCE a vložte jej do dokumentu Potm s Java pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu UPCE pro dokument Potm v Java"
description: "ePodepište své obchodní dokumenty ve formátu Potm pomocí čárového kódu UPCE. Vygenerujte podpis čárového kódu rychle a snadno pomocí několika řádků kódu pro nastavení možností podepisování."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Potm pomocí Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Potm pomocí podpisů Barcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Potm pomocí živé ukázky Barcode"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Univerzální kód produktu je symbol čárového kódu, který je široce používán po celém světě pro sledování obchodních položek v obchodech. UPCE je 8místná varianta UPC.
          characterset: |
             Podporuje pouze číselné číslice (0-9).
          textcapacity: |
             Kapacita kódového textu: přesně 7 číslic + 1 kontrolní číslice.
          image: |
