...
############################# Head ############################
head_title: "eSign Pptx dokumentum UPCE vonalkóddal a Java nyelven"
head_description: "Hozzon létre UPCE vonalkód-aláírást, és helyezze el a Pptx dokumentumra a Java termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "UPCE vonalkód aláírás létrehozása a Pptx dokumentumhoz a Java programban"
description: "eAláírja Pptx üzleti dokumentumait UPCE vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
steps:
    enable: true
    title_left: "A Pptx aláírásának lépései a Barcode segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Pptx dokumentumok gyors és egyszerű aláírását Barcode aláírással.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Az univerzális termékkód egy vonalkód-szimbólum, amelyet világszerte széles körben használnak az üzletekben található kereskedelmi cikkek nyomon követésére. Az UPCE a UPC 8 számjegyű változata.
          characterset: |
             Csak numerikus számjegyeket (0-9) támogat.
          textcapacity: |
             Kódszöveg kapacitása: pontosan 7 számjegy + 1 ellenőrző számjegy.
          image: |
