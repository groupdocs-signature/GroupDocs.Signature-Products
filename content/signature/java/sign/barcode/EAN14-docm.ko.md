...
############################# Head ############################
head_title: "Java의 E A N14 바코드로 Docm 문서에 전자 서명"
head_description: "E A N14 Barcode Signature를 생성하고 몇 줄의 코드를 사용하여 Java를 사용하여 Docm 문서에 넣습니다. 다양한 파일 형식에 서명하려면 GroupDocs 문서 서명 API를 사용하십시오."

############################# Header ############################
title: "Java에서 Docm 문서에 대한 E A N14 바코드 서명 생성"
description: "E A N14 바코드로 Docm 비즈니스 문서에 전자 서명하세요. 서명 옵션을 설정하는 몇 줄의 코드로 빠르고 쉽게 바코드 서명을 생성합니다."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            유럽 ​​품목 번호 또는 EAN은 특정 제조업체의 특정 포장 구성에서 특정 소매 제품 유형을 식별하기 위해 글로벌 무역에서 사용되는 바코드 기호 및 번호 지정 시스템을 설명하는 표준입니다.
          characterset: |
             숫자(0-9) 및 특수 문자.
          textcapacity: |
             정확히 14자리 숫자입니다.
