...
############################# Head ############################
head_title: "eSign Xlsb dokument s črtno kodo Pharmacode v Java"
head_description: "Ustvarite podpis črtne kode Pharmacode in ga postavite na dokument Xlsb z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari Pharmacode podpis črtne kode za Xlsb dokument v Java"
description: "e-Podpišite svoje Xlsb poslovne dokumente s črtno kodo Pharmacode. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Pharmacode, znan tudi kot Pharmaceutical Binary Code, je standard črtne kode, ki se uporablja v farmacevtski industriji kot sistem za nadzor pakiranja.
          characterset: |
             Številske številke (0-9).
          textcapacity: |
             Predstavlja samo eno celo število od 3 do 131070.
          image: |
