...
############################# Head ############################
head_title: "eSign Xltx dokument s črtno kodo E A N14 v Java"
head_description: "Ustvarite podpis črtne kode E A N14 in ga postavite na dokument Xltx z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari E A N14 podpis črtne kode za Xltx dokument v Java"
description: "e-Podpišite svoje Xltx poslovne dokumente s črtno kodo E A N14. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Xltx z Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Xltx s podpisi Barcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Xltx z Barcode Live Demo"
    content: |
