...
############################# Head ############################
head_title: "eSign Ods-dokument med UPCE strekkode i Java"
head_description: "Opprett UPCE strekkodesignatur og legg den på Ods-dokumentet med Java ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer UPCE strekkodesignatur for Ods dokument i Java"
description: "eSignér Ods-bedriftsdokumentene dine med UPCE strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
steps:
    enable: true
    title_left: "Trinn for å signere Ods med Barcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Ods-dokumenter med Barcode-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Ods dokumenter med Barcode Live Demo"
    content: |
