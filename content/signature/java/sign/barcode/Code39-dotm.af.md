...
############################# Head ############################
head_title: "eSign Dotm-dokument met Code39 Strepiekode in Java"
head_description: "Skep Code39 Strepiekode Handtekening en plaas dit op Dotm dokument met Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer Code39 strepieskode-handtekening vir Dotm-dokument in Java"
description: "eTeken jou Dotm besigheidsdokumente met Code39 Streepkode. Genereer strepieskode-handtekening vinnig en maklik met 'n paar reëls kode om ondertekenopsies op te stel."
...
steps:
    enable: true
    title_left: "Stappe om Dotm met Barcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Dotm dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Dotm dokumente met Barcode Regstreekse Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Kode 39 (ook bekend as Alpha39, Kode 3 van 9, Kode 3/9, Tipe 39, USS Kode 39 of USD-3) is 'n diskrete strepieskode-simbool van veranderlike lengte.
          characterset: |
             Numeriese syfers (0-9) en hoofletters (A-Z) en 'n aantal spesiale karakters (-, ., $, /, +, % en spasie).
          textcapacity: |
