...
############################# Head ############################
head_title: "eSign Dotx dokumentas su ISBN brūkšniniu kodu Java"
head_description: "Sukurkite ISBN brūkšninio kodo parašą ir įdėkite jį į Dotx dokumentą su Java naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite ISBN brūkšninio kodo parašą Dotx dokumentui Java"
description: "e. Pasirašykite Dotx verslo dokumentus naudodami ISBN brūkšninį kodą. Greitai ir lengvai sugeneruokite brūkšninio kodo parašą naudodami kelias kodo eilutes, kad nustatytumėte pasirašymo parinktis."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Dotx naudojant Barcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Dotx dokumentus su Barcode parašais.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Tarptautinis standartinis knygos numeris (ISBN) yra skaitmeninis komercinės knygos identifikatorius, kuris turi būti unikalus.[a][b] Leidėjai perka ISBN iš Tarptautinės ISBN agentūros filialo.
          characterset: |
             Skaitmeniniai skaitmenys (0–9).
          textcapacity: |
             Tiksliai 9 skaitmenys + 1 kontrolinis skaitmuo.
          image: |
