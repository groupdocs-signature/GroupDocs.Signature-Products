...
############################# Head ############################
head_title: "eSign Ppsx dokument s I T F14 crtičnim kodom u Java"
head_description: "Stvorite I T F14 potpis crtičnog koda i stavite ga na Ppsx dokument s Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje različitih formata datoteka."

############################# Header ############################
title: "Generirajte I T F14 potpis crtičnog koda za Ppsx dokument u Java"
description: "ePotpišite svoje Ppsx poslovne dokumente pomoću I T F14 crtičnog koda. Brzo i jednostavno generirajte potpis crtičnog koda s nekoliko redaka koda za postavljanje opcija potpisivanja."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 je GS1 implementacija interleaved 2 of 5 (ITF) bar koda za kodiranje globalnog broja trgovačke jedinice.
          characterset: |
             Brojčane znamenke (0-9).
          textcapacity: |
             13 znamenki + 1 kontrolna znamenka.
          image: |
