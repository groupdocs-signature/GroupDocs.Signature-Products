...
############################# Head ############################
head_title: "eSign Xlsx dokument s UPCA crtičnim kodom u Java"
head_description: "Stvorite UPCA potpis crtičnog koda i stavite ga na Xlsx dokument s Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje različitih formata datoteka."

############################# Header ############################
title: "Generirajte UPCA potpis crtičnog koda za Xlsx dokument u Java"
description: "ePotpišite svoje Xlsx poslovne dokumente pomoću UPCA crtičnog koda. Brzo i jednostavno generirajte potpis crtičnog koda s nekoliko redaka koda za postavljanje opcija potpisivanja."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Univerzalni kod proizvoda simbol je crtičnog koda koji se širom svijeta široko koristi za praćenje trgovačkih jedinica u trgovinama.
          characterset: |
             Brojčane znamenke (0-9).
          textcapacity: |
             Točno 11 znamenki + 1 kontrolna znamenka.
          image: |
