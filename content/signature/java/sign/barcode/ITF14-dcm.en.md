...
############################# Head ############################
head_title: "eSign Dcm document with I T F14 Barcode in Java"
head_description: "Create I T F14 Barcode Signature and put it on Dcm document with Java using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."

############################# Header ############################
title: "Generate I T F14 Barcode signature for Dcm document in Java"
description: "eSign your Dcm business documents with I T F14 Barcode. Generate Barcode signature quickly and easily with a few lines of code to set up signing options."
...
steps:
    enable: true
    title_left: "Steps to sign Dcm with Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Dcm documents with Barcode signatures quickly and easily.
        
        * Create an instance of Signature class providing Dcm file supposed to signing as path or memory stream
        * Instantiate SignOptions class and set all demanded data.
        * Invoke the Signature.Sign() method passing output Dcm file or memory stream
...
demos:
    enable: true
    title: "Signing Dcm documents with Barcode Live Demo"
    content: |
       Sign Dcm file with various signatures right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website. Free online demo waiting for you.
...
more_formats:
    ...
    content: |
        "You can also sign Dcm with other signature types. Please see the list below."
    format: 
