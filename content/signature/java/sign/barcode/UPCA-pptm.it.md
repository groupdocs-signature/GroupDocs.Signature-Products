...
############################# Head ############################
head_title: "eSign Pptm documento con codice a barre UPCA in Java"
head_description: "Crea UPCA Firma codice a barre e inseriscilo nel documento Pptm con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera UPCA firma del codice a barre per il documento Pptm in Java"
description: "Firma elettronicamente i tuoi documenti aziendali Pptm con il codice a barre UPCA. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Il codice prodotto universale è una simbologia di codici a barre ampiamente utilizzata in tutto il mondo per tracciare gli articoli commerciali nei negozi.
          characterset: |
             Cifre numeriche (0-9).
          textcapacity: |
             Esattamente 11 cifre + 1 cifra di controllo.
          image: |
