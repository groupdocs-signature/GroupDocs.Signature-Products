...
head_description: "Create UPCA Barcode Signature and put it on Xltx document with Java using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."
