...
############################# Head ############################
head_title: "eSign Dotm dokuments ar I T F14 svītrkodu programmā Java"
head_description: "Izveidojiet I T F14 svītrkoda parakstu un ievietojiet to Dotm dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt I T F14 svītrkoda parakstu dokumentam Dotm programmā Java"
description: "eParakstiet savus Dotm biznesa dokumentus, izmantojot I T F14 svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 ir Interleaved 2 of 5 (ITF) svītrkoda GS1 ieviešana globālā tirdzniecības vienības numura kodēšanai.
          characterset: |
             Ciparu cipari (0-9).
          textcapacity: |
             13 cipari + 1 kontrolcipars.
          image: |
