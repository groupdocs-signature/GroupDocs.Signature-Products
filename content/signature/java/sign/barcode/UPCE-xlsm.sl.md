...
############################# Head ############################
head_title: "eSign Xlsm dokument s črtno kodo UPCE v Java"
head_description: "Ustvarite podpis črtne kode UPCE in ga postavite na dokument Xlsm z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari UPCE podpis črtne kode za Xlsm dokument v Java"
description: "e-Podpišite svoje Xlsm poslovne dokumente s črtno kodo UPCE. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Xlsm z Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Xlsm s podpisi Barcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Xlsm z Barcode Live Demo"
    content: |
