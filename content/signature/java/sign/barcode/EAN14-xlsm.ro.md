...
############################# Head ############################
head_title: "eSign Xlsm document cu E A N14 cod de bare în Java"
head_description: "Creați semnătura codului de bare E A N14 și puneți-o pe documentul Xlsm cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare E A N14 pentru documentul Xlsm în Java"
description: "eSemnați documentele dvs. comerciale Xlsm cu codul de bare E A N14. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xlsm cu Barcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Xlsm cu semnături Barcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Xlsm cu Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Numărul articolului european sau EAN este un standard care descrie o simbolică și un sistem de numerotare a codurilor de bare utilizate în comerțul global pentru a identifica un anumit tip de produs de vânzare cu amănuntul, într-o configurație specifică de ambalare, de la un anumit producător.
          characterset: |
             Cifre numerice (0-9) și caractere speciale.
          textcapacity: |
             Exact 14 cifre numerice.
          image: |
