...
############################# Head ############################
head_title: "eSign Ppsm dokument s črtno kodo Code39 v Java"
head_description: "Ustvarite podpis črtne kode Code39 in ga postavite na dokument Ppsm z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari Code39 podpis črtne kode za Ppsm dokument v Java"
description: "e-Podpišite svoje Ppsm poslovne dokumente s črtno kodo Code39. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             Številke (0-9) in velike črke (A-Z) ter številni posebni znaki (-, ., $, /, +, % in presledek).
          textcapacity: |
