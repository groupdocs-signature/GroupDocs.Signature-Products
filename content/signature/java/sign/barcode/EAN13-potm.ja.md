...
############################# Head ############################
head_title: "Java で E A N13 バーコードを使用して Potm 文書に eSign"
head_description: "E A N13 バーコード署名を作成し、数行のコードを使用して Java で Potm ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "Java の Potm ドキュメントの E A N13 バーコード署名を生成します"
description: "Potm ビジネス文書に E A N13 バーコードで電子署名します。署名オプションを設定するための数行のコードで、バーコード署名をすばやく簡単に生成します。"
...
steps:
    enable: true
    title_left: "Java で Barcode を使用して Potm に署名する手順"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) は、Potm ドキュメントに Barcode 署名ですばやく簡単に署名する機能を提供します。
...
demos:
    enable: true
    title: "Barcode ライブ デモで Potm ドキュメントに署名"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            最も一般的に使用されている EAN 標準は、元の 12 桁の Universal Product Code 標準のスーパーセットである 13 桁の EAN-13 です。
          characterset: |
             数字のみ (0 ～ 9)。
          textcapacity: |
             コードテキストの容量: 正確に 12 桁 + 1 桁のチェック ディジット。
          image: |
