...
############################# Head ############################
head_title: "eSign Doc document cu E A N13 cod de bare în Java"
head_description: "Creați semnătura codului de bare E A N13 și puneți-o pe documentul Doc cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare E A N13 pentru documentul Doc în Java"
description: "eSemnați documentele dvs. comerciale Doc cu codul de bare E A N13. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Doc cu Barcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Doc cu semnături Barcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Doc cu Barcode Live Demo"
    content: |
