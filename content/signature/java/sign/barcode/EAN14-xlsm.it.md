...
############################# Head ############################
head_title: "eSign Xlsm documento con codice a barre E A N14 in Java"
head_description: "Crea E A N14 Firma codice a barre e inseriscilo nel documento Xlsm con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera E A N14 firma del codice a barre per il documento Xlsm in Java"
description: "Firma elettronicamente i tuoi documenti aziendali Xlsm con il codice a barre E A N14. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Xlsm con Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Xlsm con firme Barcode in modo rapido e semplice.
...
demos:
    enable: true
    title: "Firma di documenti Xlsm con Barcode Demo live"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Il numero di articolo europeo o EAN è uno standard che descrive una simbologia di codici a barre e un sistema di numerazione utilizzato nel commercio globale per identificare un tipo specifico di prodotto al dettaglio, in una specifica configurazione di imballaggio, da un produttore specifico.
          characterset: |
             Cifre numeriche (0-9) e caratteri speciali.
          textcapacity: |
             Esattamente 14 cifre numeriche.
          image: |
