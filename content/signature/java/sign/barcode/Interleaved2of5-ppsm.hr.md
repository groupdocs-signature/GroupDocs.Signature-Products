...
############################# Head ############################
head_title: "eSign Ppsm dokument s Interleaved2of5 crtičnim kodom u Java"
head_description: "Stvorite Interleaved2of5 potpis crtičnog koda i stavite ga na Ppsm dokument s Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje različitih formata datoteka."

############################# Header ############################
title: "Generirajte Interleaved2of5 potpis crtičnog koda za Ppsm dokument u Java"
description: "ePotpišite svoje Ppsm poslovne dokumente pomoću Interleaved2of5 crtičnog koda. Brzo i jednostavno generirajte potpis crtičnog koda s nekoliko redaka koda za postavljanje opcija potpisivanja."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Ppsm s Barcode u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Ppsm dokumenata s Barcode potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Ppsm dokumenata s Barcode Live Demo"
    content: |
