...
############################# Head ############################
head_title: "eSign Ppsx dokument s E A N13 crtičnim kodom u Java"
head_description: "Stvorite E A N13 potpis crtičnog koda i stavite ga na Ppsx dokument s Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje različitih formata datoteka."

############################# Header ############################
title: "Generirajte E A N13 potpis crtičnog koda za Ppsx dokument u Java"
description: "ePotpišite svoje Ppsx poslovne dokumente pomoću E A N13 crtičnog koda. Brzo i jednostavno generirajte potpis crtičnog koda s nekoliko redaka koda za postavljanje opcija potpisivanja."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Ppsx s Barcode u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Ppsx dokumenata s Barcode potpisima.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Najčešće korišteni EAN standard je trinaesteroznamenkasti EAN-13, nadskup originalnog 12-znamenkasti standard univerzalnog koda proizvoda.
          characterset: |
             Samo numeričke znamenke (0-9).
          textcapacity: |
             Kapacitet kodnog teksta: točno 12 znamenki + 1 kontrolna znamenka.
          image: |
