...
############################# Head ############################
head_title: "eSign Pps documento con codice a barre Codabar in Java"
head_description: "Crea Codabar Firma codice a barre e inseriscilo nel documento Pps con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Codabar firma del codice a barre per il documento Pps in Java"
