...
############################# Head ############################
head_title: "eSign Zip dokumentas su Codabar brūkšniniu kodu Java"
head_description: "Sukurkite Codabar brūkšninio kodo parašą ir įdėkite jį į Zip dokumentą su Java naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite Codabar brūkšninio kodo parašą Zip dokumentui Java"
description: "e. Pasirašykite Zip verslo dokumentus naudodami Codabar brūkšninį kodą. Greitai ir lengvai sugeneruokite brūkšninio kodo parašą naudodami kelias kodo eilutes, kad nustatytumėte pasirašymo parinktis."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Zip naudojant Barcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Zip dokumentus su Barcode parašais.
...
demos:
    enable: true
    title: "Dokumentų Zip pasirašymas naudojant Barcode tiesioginę demonstraciją"
    content: |
