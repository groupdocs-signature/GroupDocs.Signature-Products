...
############################# Head ############################
head_title: "eSign Potm dokument s E A N13 čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu E A N13 a vložte ho do dokumentu Potm s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte E A N13 podpis čiarového kódu pre dokument Potm v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Potm pomocou čiarového kódu E A N13. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Potm pomocou Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Potm pomocou podpisov Barcode.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Potm pomocou živej ukážky Barcode"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Najbežnejšie používaným štandardom EAN je trinásťmiestny EAN-13, nadmnožina pôvodného 12-miestneho štandardu Universal Product Code.
          characterset: |
             Iba číselné číslice (0-9).
          textcapacity: |
             Kapacita kódového textu: presne 12 číslic + 1 kontrolná číslica.
          image: |
