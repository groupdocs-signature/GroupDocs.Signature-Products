...
############################# Head ############################
head_title: "Java içinde UPCA Barkodlu eSign Xlsm belgesi"
head_description: "UPCA Barkod İmzası oluşturun ve birkaç satır kod kullanarak Java ile Xlsm belgesine koyun. Çeşitli dosya biçimlerini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Xlsm belgesi için UPCA Barkod imzası oluşturun"
description: "Xlsm iş belgelerinizi UPCA Barkod ile e-imzalayın. İmzalama seçeneklerini ayarlamak için birkaç satır kodla hızlı ve kolay bir şekilde Barkod imzası oluşturun."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Evrensel Ürün Kodu, mağazalardaki ticari ürünlerin takibi için dünya çapında yaygın olarak kullanılan bir barkod sembolüdür.
          characterset: |
             Sayısal rakamlar (0-9).
          textcapacity: |
             Tam olarak 11 basamak + 1 kontrol basamağı.
          image: |
