...
############################# Head ############################
head_title: "eSign Potx -asiakirja UPCA-viivakoodilla Java"
head_description: "Luo UPCA Viivakoodiallekirjoitus ja laita se Potx-asiakirjaan, jossa on Java muutamalla rivillä koodia. Käytä GroupDocs Document Signature API:ta eri tiedostomuotojen allekirjoittamiseen."

############################# Header ############################
title: "Luo UPCA viivakoodiallekirjoitus asiakirjalle Potx ohjelmassa Java"
description: "eAllekirjoita Potx yritysasiakirjasi UPCA-viivakoodilla. Luo viivakoodiallekirjoitus nopeasti ja helposti muutamalla koodirivillä allekirjoitusvaihtoehtojen määrittämiseksi."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Universaali tuotekoodi on viivakoodisymboliikka, jota käytetään laajasti maailmanlaajuisesti myymälöissä olevien tuotteiden seuraamiseen.
          characterset: |
             Numeeriset numerot (0-9).
          textcapacity: |
             Täsmälleen 11 numeroa + 1 tarkistusnumero.
          image: |
