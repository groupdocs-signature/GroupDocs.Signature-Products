...
############################# Head ############################
head_title: "eSign Tiff doiciméad le Pharmacode Barcode in Java"
head_description: "Cruthaigh Pharmacode Síniú Barrachóid agus cuir ar Tiff doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid Pharmacode don doiciméad Tiff in Java"
description: "eSínigh do dhoiciméid ghnó Tiff le Barrachóid Pharmacode. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
steps:
    enable: true
    title_left: "Céimeanna chun Tiff a shíniú le Barcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Tiff a shíniú le sínithe Barcode go tapa agus go héasca.
