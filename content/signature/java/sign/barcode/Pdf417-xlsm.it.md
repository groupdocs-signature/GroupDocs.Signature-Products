...
############################# Head ############################
head_title: "eSign Xlsm documento con codice a barre Pdf417 in Java"
head_description: "Crea Pdf417 Firma codice a barre e inseriscilo nel documento Xlsm con Java utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Pdf417 firma del codice a barre per il documento Xlsm in Java"
description: "Firma elettronicamente i tuoi documenti aziendali Xlsm con il codice a barre Pdf417. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 è un formato di codice a barre lineare impilato utilizzato in una varietà di applicazioni come il trasporto, le carte d'identità e la gestione dell'inventario.
          characterset: |
             Tutti i 256 caratteri ASCII.
          textcapacity: |
             Fino a 800 caratteri.
          image: |
