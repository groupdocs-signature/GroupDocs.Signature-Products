...
############################# Head ############################
head_title: "eSign Tiff dokument Codabar vöötkoodiga keeles Java"
head_description: "Looge Codabar vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile Tiff tootega Java. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge Java-s dokumendile Tiff vöötkoodiallkiri Codabar"
description: "eAllkirjasta oma Tiff äridokumendid Codabar vöötkoodiga. Looge vöötkoodisignatuur kiiresti ja lihtsalt mõne koodirea abil allkirjastamisvalikute seadistamiseks."
...
steps:
    enable: true
    title_left: "Toimingud Tiff allkirjastamiseks rakendusega Barcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Tiff dokumente Barcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Tiff allkirjastamine Barcode reaalajas demoga"
    content: |
