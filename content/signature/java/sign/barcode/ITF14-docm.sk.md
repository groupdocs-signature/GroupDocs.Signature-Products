...
############################# Head ############################
head_title: "eSign Docm dokument s I T F14 čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu I T F14 a vložte ho do dokumentu Docm s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte I T F14 podpis čiarového kódu pre dokument Docm v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Docm pomocou čiarového kódu I T F14. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Docm pomocou Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Docm pomocou podpisov Barcode.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 je implementácia GS1 čiarového kódu Interleaved 2 of 5 (ITF) na kódovanie globálneho čísla obchodnej položky.
          characterset: |
             Číslice (0-9).
          textcapacity: |
             13 číslic + 1 kontrolná číslica.
          image: |
