...
############################# Head ############################
head_title: "Java で I T F14 バーコードを使用して Docm 文書に eSign"
head_description: "I T F14 バーコード署名を作成し、数行のコードを使用して Java で Docm ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "Java の Docm ドキュメントの I T F14 バーコード署名を生成します"
description: "Docm ビジネス文書に I T F14 バーコードで電子署名します。署名オプションを設定するための数行のコードで、バーコード署名をすばやく簡単に生成します。"
...
steps:
    enable: true
    title_left: "Java で Barcode を使用して Docm に署名する手順"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) は、Docm ドキュメントに Barcode 署名ですばやく簡単に署名する機能を提供します。
