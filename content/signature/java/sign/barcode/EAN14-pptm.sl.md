...
############################# Head ############################
head_title: "eSign Pptm dokument s črtno kodo E A N14 v Java"
head_description: "Ustvarite podpis črtne kode E A N14 in ga postavite na dokument Pptm z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari E A N14 podpis črtne kode za Pptm dokument v Java"
description: "e-Podpišite svoje Pptm poslovne dokumente s črtno kodo E A N14. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Pptm z Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Pptm s podpisi Barcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Pptm z Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Evropska številka artikla ali EAN je standard, ki opisuje simbologijo črtne kode in sistem številčenja, ki se uporablja v svetovni trgovini za identifikacijo določenega maloprodajnega tipa izdelka v določeni konfiguraciji embalaže določenega proizvajalca.
          characterset: |
