...
############################# Head ############################
head_title: "eSign Pptx dokument med I T F14 streckkod i Java"
head_description: "Skapa I T F14 streckkodsignatur och lägg den på Pptx dokument med Java med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera I T F14 streckkodsignatur för Pptx dokument i Java"
description: "esignera dina Pptx affärsdokument med I T F14 streckkod. Skapa streckkodsignatur snabbt och enkelt med några rader kod för att ställa in signeringsalternativ."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14 är GS1-implementeringen av en Interleaved 2 of 5 (ITF) streckkod för att koda ett Global Trade Item Number.
          characterset: |
             Numeriska siffror (0-9).
          textcapacity: |
             13 siffror + 1 kontrollsiffra.
          image: |
