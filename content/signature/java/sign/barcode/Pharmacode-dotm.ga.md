...
############################# Head ############################
head_title: "eSign Dotm doiciméad le Pharmacode Barcode in Java"
head_description: "Cruthaigh Pharmacode Síniú Barrachóid agus cuir ar Dotm doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid Pharmacode don doiciméad Dotm in Java"
description: "eSínigh do dhoiciméid ghnó Dotm le Barrachóid Pharmacode. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is caighdeán barrachód é Pharmacode, ar a dtugtar Cód Dénártha Cógaisíochta freisin, a úsáidtear sa tionscal cógaisíochta mar chóras rialaithe pacála.
          characterset: |
             digití uimhriúla (0-9).
          textcapacity: |
             Níl ann ach slánuimhir amháin ó 3 go 131070.
          image: |
