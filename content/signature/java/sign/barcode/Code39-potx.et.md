...
############################# Head ############################
head_title: "eSign Potx dokument Code39 vöötkoodiga keeles Java"
head_description: "Looge Code39 vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile Potx tootega Java. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge Java-s dokumendile Potx vöötkoodiallkiri Code39"
description: "eAllkirjasta oma Potx äridokumendid Code39 vöötkoodiga. Looge vöötkoodisignatuur kiiresti ja lihtsalt mõne koodirea abil allkirjastamisvalikute seadistamiseks."
...
steps:
    enable: true
    title_left: "Toimingud Potx allkirjastamiseks rakendusega Barcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Potx dokumente Barcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Potx allkirjastamine Barcode reaalajas demoga"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             Numbrilised numbrid (0–9) ja suurtähed (A–Z) ja hulk erimärke (-, ., $, /, +, % ja tühik).
          textcapacity: |
