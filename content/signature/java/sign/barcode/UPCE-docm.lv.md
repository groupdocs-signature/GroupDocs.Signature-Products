...
############################# Head ############################
head_title: "eSign Docm dokuments ar UPCE svītrkodu programmā Java"
head_description: "Izveidojiet UPCE svītrkoda parakstu un ievietojiet to Docm dokumentā ar Java, izmantojot pāris koda rindiņas. Izmantojiet GroupDocs Document Signature API dažādu failu formātu parakstīšanai."

############################# Header ############################
title: "Ģenerēt UPCE svītrkoda parakstu dokumentam Docm programmā Java"
description: "eParakstiet savus Docm biznesa dokumentus, izmantojot UPCE svītrkodu. Ātri un vienkārši ģenerējiet svītrkoda parakstu, izmantojot dažas koda rindiņas, lai iestatītu parakstīšanas opcijas."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Docm ar Barcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Docm dokumentus ar Barcode parakstiem.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Universālais produkta kods ir svītrkoda simbolika, ko visā pasaulē plaši izmanto tirdzniecības preču izsekošanai veikalos. UPCE ir 8 ciparu variācija, ja UPC.
          characterset: |
             Atbalsta tikai ciparu ciparus (0-9).
          textcapacity: |
             Koda teksta ietilpība: tieši 7 cipari + 1 pārbaudes cipars.
          image: |
