...
############################# Head ############################
head_title: "eSign Xlsx belgeya bi Pharmacode Barcode di Java"
head_description: "Îmzeya barkodê ya Pharmacode biafirîne û bi çend rêzikên kodê bi Java li ser belgeya Xlsx biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."

############################# Header ############################
title: "Di Java de ji bo belgeya Pharmacode îmzeya barkodê çêbike"
description: "Belgeyên karsaziya xwe yên Xlsx bi Pharmacode Barkodê îmze bikin. Bi çend rêzikên kodê re zû û bi hêsanî îmzeya Barkodê biafirînin da ku vebijarkên îmzekirinê saz bikin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Xlsx bi Barcode di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Xlsx bi îmzeyên Barcode zû û bi hêsanî peyda dike.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Pharmacode, ku wekî koda Binary a Derman jî tê zanîn, standardek barkodê ye, ku di pîşesaziya dermanan de wekî pergala kontrolkirina pakkirinê tê bikar anîn.
          characterset: |
             Reqemên hejmarî (0-9).
          textcapacity: |
             Ji 3 heta 131070 tenê yekjimarek yekjimar temsîl dike.
          image: |
