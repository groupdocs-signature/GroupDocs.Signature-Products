...
############################# Head ############################
head_title: "eSign Xlsx ሰነድ በE A N13 ባርኮድ በJava"
head_description: "የE A N13 ባርኮድ ፊርማ ይፍጠሩ እና በXlsx ሰነድ ላይ በJava ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለXlsx ሰነድ የE A N13 ባርኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Xlsx የንግድ ሰነዶች በE A N13 ባርኮድ ይመዝገቡ። የመመዝገቢያ አማራጮችን ለማዘጋጀት የባርኮድ ፊርማ በፍጥነት እና በቀላሉ በጥቂት የኮድ መስመሮች ይፍጠሩ።"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            በብዛት ጥቅም ላይ የዋለው የEAN መስፈርት አስራ ሶስት አሃዝ EAN-13 ነው፣የመጀመሪያው ባለ 12-አሃዝ ሁለንተናዊ የምርት ኮድ ስታንዳርድ ልዕለ ስብስብ።
          characterset: |
             የቁጥር አሃዞች (0-9) ብቻ።
          textcapacity: |
             የኮድቴክስት አቅም፡ በትክክል 12 አሃዞች + 1 ቼክ አሃዝ።
          image: |
