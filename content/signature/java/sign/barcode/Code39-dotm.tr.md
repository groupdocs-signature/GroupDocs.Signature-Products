...
############################# Head ############################
head_title: "Java içinde Code39 Barkodlu eSign Dotm belgesi"
head_description: "Code39 Barkod İmzası oluşturun ve birkaç satır kod kullanarak Java ile Dotm belgesine koyun. Çeşitli dosya biçimlerini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Dotm belgesi için Code39 Barkod imzası oluşturun"
description: "Dotm iş belgelerinizi Code39 Barkod ile e-imzalayın. İmzalama seçeneklerini ayarlamak için birkaç satır kodla hızlı ve kolay bir şekilde Barkod imzası oluşturun."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             Sayısal rakamlar (0-9) ve büyük harfler (A-Z) ve bir dizi özel karakter (-, ., $, /, +, % ve boşluk).
          textcapacity: |
