...
############################# Head ############################
head_title: "eSign Pptm -asiakirja Code39-viivakoodilla Java"
head_description: "Luo Code39 Viivakoodiallekirjoitus ja laita se Pptm-asiakirjaan, jossa on Java muutamalla rivillä koodia. Käytä GroupDocs Document Signature API:ta eri tiedostomuotojen allekirjoittamiseen."

############################# Header ############################
title: "Luo Code39 viivakoodiallekirjoitus asiakirjalle Pptm ohjelmassa Java"
description: "eAllekirjoita Pptm yritysasiakirjasi Code39-viivakoodilla. Luo viivakoodiallekirjoitus nopeasti ja helposti muutamalla koodirivillä allekirjoitusvaihtoehtojen määrittämiseksi."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             Numerot (0-9) ja isot kirjaimet (A-Z) ja joukko erikoismerkkejä (-, ., $, /, +, % ja välilyönti).
          textcapacity: |
