...
############################# Head ############################
head_title: "eSign Odp փաստաթուղթը ISBN շտրիխ կոդով Java-ում"
head_description: "Ստեղծեք ISBN շտրիխ կոդի ստորագրություն և դրեք այն Odp փաստաթղթում Java-ով` օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տարբեր ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք ISBN շտրիխ կոդ ստորագրություն Odp փաստաթղթի համար Java-ում"
description: "Ստորագրեք ձեր Odp բիզնես փաստաթղթերը ISBN շտրիխ կոդով: Ստեղծեք շտրիխ կոդ ստորագրություն արագ և հեշտությամբ մի քանի տող կոդի միջոցով՝ ստորագրման տարբերակները կարգավորելու համար:"
...
steps:
    enable: true
    title_left: "Odp-ը Barcode-ով Java-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Odp փաստաթղթերը Barcode ստորագրություններով:
