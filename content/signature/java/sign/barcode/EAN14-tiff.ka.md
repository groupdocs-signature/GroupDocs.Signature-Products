...
############################# Head ############################
head_title: "eSign Tiff დოკუმენტი E A N14 შტრიხკოდით Java-ში"
head_description: "შექმენით E A N14 შტრიხკოდის ხელმოწერა და განათავსეთ იგი Tiff დოკუმენტზე Java კოდის რამდენიმე ხაზის გამოყენებით. გამოიყენეთ GroupDocs Document Signature API სხვადასხვა ფაილის ფორმატების ხელმოწერისთვის."

############################# Header ############################
title: "შექმენით E A N14 შტრიხკოდის ხელმოწერა Tiff დოკუმენტისთვის Java-ში"
description: "მოაწერეთ თქვენი Tiff ბიზნეს დოკუმენტები E A N14 შტრიხკოდით. შექმენით შტრიხკოდის ხელმოწერა სწრაფად და მარტივად რამდენიმე ხაზის კოდით ხელმოწერის ვარიანტების დასაყენებლად."
...
steps:
    enable: true
    title_left: "Tiff-ით ხელმოწერის ნაბიჯები Barcode-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Tiff დოკუმენტები Barcode ხელმოწერებით სწრაფად და მარტივად.
...
demos:
    enable: true
    title: "დოკუმენტების Tiff ხელმოწერა Barcode Live Demo-ით"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ევროპული სტატიის ნომერი ან EAN არის სტანდარტი, რომელიც აღწერს შტრიხკოდების სიმბოლიკას და ნუმერაციის სისტემას, რომელიც გამოიყენება გლობალურ ვაჭრობაში კონკრეტული საცალო პროდუქტის ტიპის განსაზღვრისთვის, კონკრეტულ შეფუთვაში, კონკრეტული მწარმოებლისგან.
          characterset: |
             რიცხვითი ციფრები (0-9) და სპეციალური სიმბოლოები.
          textcapacity: |
             ზუსტად 14 ციფრული ციფრი.
          image: |
