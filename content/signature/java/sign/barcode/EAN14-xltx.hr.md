...
############################# Head ############################
head_title: "eSign Xltx dokument s E A N14 crtičnim kodom u Java"
head_description: "Stvorite E A N14 potpis crtičnog koda i stavite ga na Xltx dokument s Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje različitih formata datoteka."

############################# Header ############################
title: "Generirajte E A N14 potpis crtičnog koda za Xltx dokument u Java"
description: "ePotpišite svoje Xltx poslovne dokumente pomoću E A N14 crtičnog koda. Brzo i jednostavno generirajte potpis crtičnog koda s nekoliko redaka koda za postavljanje opcija potpisivanja."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xltx s Barcode u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Xltx dokumenata s Barcode potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Xltx dokumenata s Barcode Live Demo"
    content: |
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Europski broj artikla ili EAN standard je koji opisuje simbologiju crtičnog koda i sustav numeriranja koji se koristi u globalnoj trgovini za identifikaciju određene vrste maloprodajnog proizvoda, u specifičnoj konfiguraciji pakiranja, od određenog proizvođača.
          characterset: |
             Brojčane znamenke (0-9) i posebni znakovi.
          textcapacity: |
             Točno 14 brojčanih znamenki.
          image: |
