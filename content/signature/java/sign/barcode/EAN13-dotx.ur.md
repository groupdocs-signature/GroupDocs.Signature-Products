...
############################# Head ############################
head_title: "Java میں E A N13 بارکوڈ کے ساتھ eSign Dotx دستاویز"
head_description: "E A N13 بارکوڈ دستخط بنائیں اور کوڈ کی دو سطروں کا استعمال کرتے ہوئے Java کے ساتھ Dotx دستاویز پر رکھیں۔ مختلف فائل فارمیٹس پر دستخط کرنے کے لیے GroupDocs Document Signature API استعمال کریں۔"

############################# Header ############################
title: "Java میں Dotx دستاویز کے لیے E A N13 بارکوڈ دستخط بنائیں"
description: "اپنے Dotx کاروباری دستاویزات پر E A N13 بارکوڈ کے ساتھ دستخط کریں۔ دستخط کے اختیارات ترتیب دینے کے لیے کوڈ کی چند سطروں کے ساتھ بار کوڈ دستخط جلدی اور آسانی سے بنائیں۔"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            سب سے زیادہ استعمال ہونے والا EAN معیار تیرہ ہندسوں کا EAN-13 ہے، جو اصل 12 ہندسوں کے یونیورسل پروڈکٹ کوڈ کے معیار کا ایک سپر سیٹ ہے۔
          characterset: |
             صرف عددی ہندسے (0-9)۔
          textcapacity: |
             کوڈ ٹیکسٹ کی گنجائش: بالکل 12 ہندسے + 1 چیک ہندسہ۔
          image: |
