...
############################# Head ############################
head_title: "Документ eSign Potx зі штрих-кодом E A N13 у Java"
head_description: "Створіть підпис штрих-коду E A N13 і додайте його в документ Potx за допомогою Java за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs для підпису різних форматів файлів."

############################# Header ############################
title: "Згенеруйте підпис штрих-коду E A N13 для документа Potx у Java"
description: "Електронно підписуйте свої ділові документи Potx штрих-кодом E A N13. Згенеруйте підпис штрих-коду швидко та легко за допомогою кількох рядків коду, щоб налаштувати параметри підпису."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Найпоширенішим стандартом EAN є тринадцятизначний EAN-13, надмножина оригінального 12-значного стандарту універсального коду продукту.
          characterset: |
             Тільки цифри (0-9).
          textcapacity: |
             Місткість кодового тексту: рівно 12 цифр + 1 контрольна цифра.
          image: |
