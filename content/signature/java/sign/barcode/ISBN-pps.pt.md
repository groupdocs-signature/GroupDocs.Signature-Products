...
############################# Head ############################
head_title: "eSign Pps documento com ISBN Código de barras em Java"
head_description: "Crie uma assinatura de código de barras ISBN e coloque-a no documento Pps com Java usando algumas linhas de código. Use a API de assinatura de documento do GroupDocs para assinar vários formatos de arquivo."

############################# Header ############################
title: "Gere assinatura de código de barras ISBN para Pps documento em Java"
description: "Assine seus documentos comerciais Pps com o código de barras ISBN. Gere assinatura de código de barras de forma rápida e fácil com algumas linhas de código para configurar as opções de assinatura."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            O International Standard Book Number (ISBN) é um identificador numérico de livro comercial que deve ser exclusivo.[a][b] Os editores compram ISBNs de uma afiliada da International ISBN Agency.
          characterset: |
             Dígitos numéricos (0-9).
          textcapacity: |
             Exatamente 9 dígitos + 1 dígito verificador.
          image: |
