...
############################# Head ############################
head_title: "eSign Tar dokument s črtno kodo Code39 v Java"
head_description: "Ustvarite podpis črtne kode Code39 in ga postavite na dokument Tar z Java z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari Code39 podpis črtne kode za Tar dokument v Java"
description: "e-Podpišite svoje Tar poslovne dokumente s črtno kodo Code39. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Tar z Barcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Tar s podpisi Barcode.
