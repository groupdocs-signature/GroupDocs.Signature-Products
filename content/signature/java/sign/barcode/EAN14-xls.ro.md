...
############################# Head ############################
head_title: "eSign Xls document cu E A N14 cod de bare în Java"
head_description: "Creați semnătura codului de bare E A N14 și puneți-o pe documentul Xls cu Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna diferite formate de fișiere."

############################# Header ############################
title: "Generați semnătura de cod de bare E A N14 pentru documentul Xls în Java"
description: "eSemnați documentele dvs. comerciale Xls cu codul de bare E A N14. Generați semnătura cod de bare rapid și ușor cu câteva linii de cod pentru a configura opțiunile de semnare."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xls cu Barcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Xls cu semnături Barcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Xls cu Barcode Live Demo"
    content: |
