...
############################# Head ############################
head_title: "eSign Tiff dokument med Pdf417 stregkode i Java"
head_description: "Opret Pdf417 stregkodesignatur og læg den på Tiff dokument med Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer Pdf417 Stregkodesignatur for Tiff dokument i Java"
description: "eSignér dine Tiff forretningsdokumenter med Pdf417 stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            PDF417 er et stablet lineært stregkodeformat, der bruges i en række forskellige applikationer såsom transport, id-kort og lagerstyring.
          characterset: |
             Alle 256 ASCII-tegn.
          textcapacity: |
             Op til 800 tegn.
