...
############################# Head ############################
head_title: "Dot-Dokument mit Interleaved2of5-Barcode in Java eSignieren"
head_description: "Erstellen Sie eine Interleaved2of5-Barcode-Signatur und fügen Sie sie mit ein paar Codezeilen in ein Dot-Dokument mit Java ein. Verwenden Sie die GroupDocs Document Signature API zum Signieren verschiedener Dateiformate."

############################# Header ############################
title: "Interleaved2of5-Barcode-Signatur für Dot-Dokument in Java generieren"
description: "Unterzeichnen Sie Ihre Dot-Geschäftsdokumente mit Interleaved2of5-Barcode. Generieren Sie Barcode-Signaturen schnell und einfach mit wenigen Codezeilen, um Signaturoptionen einzurichten."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Dot mit Barcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Dot-Dokumente mit Barcode-Signaturen schnell und einfach zu signieren.
