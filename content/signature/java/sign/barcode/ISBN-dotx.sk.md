...
############################# Head ############################
head_title: "eSign Dotx dokument s ISBN čiarovým kódom v Java"
head_description: "Vytvorte podpis čiarového kódu ISBN a vložte ho do dokumentu Dotx s Java pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte ISBN podpis čiarového kódu pre dokument Dotx v Java"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Dotx pomocou čiarového kódu ISBN. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Medzinárodné štandardné číslo knihy (ISBN) je číselný komerčný identifikátor knihy, ktorý má byť jedinečný.[a][b] Vydavatelia kupujú čísla ISBN od pobočky Medzinárodnej agentúry ISBN.
          characterset: |
             Číslice (0-9).
          textcapacity: |
             Presne 9 číslic + 1 kontrolná číslica.
          image: |
