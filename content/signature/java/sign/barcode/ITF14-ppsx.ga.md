...
############################# Head ############################
head_title: "eSign Ppsx doiciméad le I T F14 Barcode in Java"
head_description: "Cruthaigh I T F14 Síniú Barrachóid agus cuir ar Ppsx doiciméad le Java ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid I T F14 don doiciméad Ppsx in Java"
description: "eSínigh do dhoiciméid ghnó Ppsx le Barrachóid I T F14. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is éard atá i ITF-14 ná cur chun feidhme GS1 de bharrachód Interleaved 2 de 5 (ITF) chun Uimhir Mhíre Trádála Dhomhanda a ionchódú.
          characterset: |
             digití uimhriúla (0-9).
          textcapacity: |
             13 dhigit + 1 dhigit seiceála.
          image: |
