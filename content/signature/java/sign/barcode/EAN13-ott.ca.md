...
############################# Head ############################
head_title: "Document electrònic Ott amb codi de barres E A N13 a Java"
head_description: "Creeu la signatura de codi de barres E A N13 i poseu-la al document Ott amb Java utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu E A N13 signatura de codi de barres per al document Ott a Java"
description: "eSigne els vostres documents comercials de Ott amb el codi de barres E A N13. Genereu la signatura de codi de barres de manera ràpida i senzilla amb unes poques línies de codi per configurar les opcions de signatura."
...
steps:
    enable: true
    title_left: "Passos per signar Ott amb Barcode a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Ott amb signatures Barcode de manera ràpida i senzilla.
