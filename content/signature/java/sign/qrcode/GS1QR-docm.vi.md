...
############################# Head ############################
head_title: "eSign Docm tài liệu với G S1 Q R Mã QR trong Java"
head_description: "Tạo Mã QR G S1 Q R và đặt nó vào tệp Docm bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Q R cho tài liệu Docm trong Java"
description: "eSign các tài liệu và hợp đồng Docm của bạn bằng Mã QR G S1 Q R. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Mã QR GS1 là một biến thể của Mã QR phù hợp với các thông số kỹ thuật của GS1. Nó được thiết kế đặc biệt để chia sẻ thông tin bao bì mở rộng, chẳng hạn như số lô, ID sản phẩm và số lượng.
          characterset: |
             Các chữ cái viết hoa và viết thường và các ký tự đặc biệt $% * + -. /: Tất cả đều có Số phân định ứng dụng chính xác
          textcapacity: |
             Lên đến 7089 ký tự số, 4296 ký tự chữ và số
          image: |
