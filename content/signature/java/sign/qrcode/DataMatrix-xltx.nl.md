...
############################# Head ############################
head_title: "eSign Xltx document met Data Matrix QR-code in Java"
head_description: "Maak een Data Matrix QR-code en plaats deze in het Xltx-bestand met behulp van Java met een kort stukje Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Data Matrix QR Code handtekening voor Xltx document in Java"
description: "Onderteken uw Xltx documenten en contracten met Data Matrix QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Xltx te ondertekenen met Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Xltx documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix is ​​een tweedimensionale code die bestaat uit zwarte en witte 'cellen' of stippen die zijn gerangschikt in een vierkant of rechthoekig patroon, ook wel matrix genoemd. De te coderen informatie kan tekst of numerieke gegevens zijn.
          characterset: |
             Ondersteunt alle 256 ASCII-tekens, alle ISO-tekens en alle Extended Binary Coded Decimal Interchange Code (EBCDIC)-tekens.
          textcapacity: |
             Maximaal 3116 numerieke cijfers of 2335 alfanumerieke tekens of 1556 binaire tekens.
          image: |
