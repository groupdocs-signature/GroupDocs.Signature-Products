...
############################# Head ############################
head_title: "eSign Docm dokuments ar QR QR kodu programmā Java"
head_description: "Izveidojiet QR QR kodu un ievietojiet to failā Docm, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt QR QR koda parakstu dokumentam Docm programmā Java"
description: "eParakstiet savus Docm dokumentus un līgumus ar QR QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
demos:
    enable: true
    title: "Dokumentu Docm parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
       Parakstiet Docm failu ar dažādiem parakstiem tūlīt, apmeklējot vietni [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Jūs gaida bezmaksas tiešsaistes demonstrācija.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR kods (saīsināts no Quick Response Code) ir matricas svītrkoda (vai divdimensiju svītrkoda) veida preču zīme. Tas ir vispopulārākais un plaši izmantotais divdimensiju koda veids. Praksē QR kodi bieži satur datus par vietrādi, identifikatoru vai izsekotāju, kas norāda uz vietni vai lietojumprogrammu.
          characterset: |
             Visas 256 ASCII rakstzīmes + Kanji
          textcapacity: |
             Līdz 7089 ciparu rakstzīmēm, 4296 burtciparu rakstzīmēm, 2953 baitiem (binārie dati) vai 1817 Kanji rakstzīmēm.
          image: |
...
more_formats:
    enable: true
    title: "Citi atbalstītie Qrcode paraksti priekš Java"
    content: |
        "Varat arī parakstīt Docm ar citiem paraksta veidiem. Lūdzu, skatiet sarakstu zemāk."
    format: 
