...
############################# Head ############################
head_title: "Java で G S1 Q R QR コードを使用して Pptm 文書に eSign"
head_description: "G S1 Q R QR コードを作成し、短い Java コードを含む Java を使用して Pptm ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "Java の Pptm ドキュメントの G S1 Q R QR コード署名を生成します"
description: "Pptm ドキュメントと契約書に G S1 Q R QR コードで電子署名します。 QR コード署名をすばやく簡単に生成します。"
