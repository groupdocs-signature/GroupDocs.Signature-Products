...
############################# Head ############################
head_title: "eSign Odp-dokument med Aztec QR-kod i Java"
head_description: "Skapa Aztec QR-kod och lägg den i filen Odp med Java med en kort bit av Java-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera Aztec QR-kodsignatur för Odp dokument i Java"
