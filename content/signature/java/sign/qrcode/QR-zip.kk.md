...
############################# Head ############################
head_title: "Java ішінде QR QR коды бар eSign Zip құжаты"
head_description: "QR QR кодын жасаңыз және оны Java арқылы Java кодының қысқа бөлігімен Zip файлына салыңыз. QR коды арқылы іскери құжаттар мен файлдарға электрондық қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "Java ішінде Zip құжаты үшін QR QR код қолтаңбасын жасаңыз"
description: "Zip құжаттарыңыз бен келісім-шарттарыңызға QR QR Code арқылы қол қойыңыз. QR Code қолтаңбасын тез және оңай жасаңыз."
