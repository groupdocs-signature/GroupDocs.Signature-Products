...
############################# Head ############################
head_title: "Belgeya eSign Svg bi G S1 Data Matrix Koda QR di Java"
head_description: "Koda QR-a G S1 Data Matrix biafirînin û bi koda Java bi koda Java li pelê Svg bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di Java de ji bo belgeya G S1 Data Matrix îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên Svg bi koda QR-a G S1 Data Matrix îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Svg bi Qrcode di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Svg bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Svg bi Qrcode Demoya Zindî"
    content: |
