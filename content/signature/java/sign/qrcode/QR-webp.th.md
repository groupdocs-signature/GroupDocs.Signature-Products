...
############################# Head ############################
head_title: "eSign Webp เอกสารด้วย QR QR Code ใน Java"
head_description: "สร้าง QR QR Code และใส่ลงในไฟล์ Webp โดยใช้ Java ด้วยโค้ดสั้นๆ Java ใช้ GroupDocs Document Signature API เพื่อลงนามในเอกสารทางธุรกิจและไฟล์ทางอิเล็กทรอนิกส์ด้วย QR Code"

############################# Header ############################
title: "สร้าง QR ลายเซ็นรหัส QR สำหรับเอกสาร Webp ใน Java"
description: "eSign Webp เอกสารและสัญญาของคุณด้วยรหัส QR QR สร้างลายเซ็น QR Code อย่างรวดเร็วและง่ายดาย"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR Code (ย่อมาจาก Quick Response Code) เป็นเครื่องหมายการค้าของบาร์โค้ดประเภทเมตริกซ์ (หรือบาร์โค้ดสองมิติ) เป็นรหัสสองมิติที่ได้รับความนิยมและใช้กันอย่างแพร่หลาย ในทางปฏิบัติ รหัส QR มักจะมีข้อมูลสำหรับตัวระบุตำแหน่ง ตัวระบุ หรือตัวติดตามที่ชี้ไปยังเว็บไซต์หรือแอปพลิเคชัน
          characterset: |
             อักขระ ASCII ทั้งหมด 256 ตัว + คันจิ
          textcapacity: |
             อักขระตัวเลขสูงสุด 7089 อักขระและตัวเลขและตัวอักษร 4296 อักขระ 2953 ไบต์ (ข้อมูลไบนารี) หรืออักขระคันจิ 1817 ตัว
          image: |
