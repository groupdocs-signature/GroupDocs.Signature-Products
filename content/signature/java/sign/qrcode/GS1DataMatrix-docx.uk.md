...
############################# Head ############################
head_title: "eSign Docx документ із G S1 Data Matrix QR-кодом у Java"
head_description: "Створіть QR-код G S1 Data Matrix і помістіть його у файл Docx за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду G S1 Data Matrix для документа Docx у Java"
description: "Електронно підписуйте свої Docx документи та контракти за допомогою G S1 Data Matrix QR-коду. Згенеруйте підпис QR-коду швидко та легко."
