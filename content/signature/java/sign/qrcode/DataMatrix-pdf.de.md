...
############################# Head ############################
head_title: "eSigniere Pdf-Dokument mit Data Matrix-QR-Code in Java"
head_description: "Erstellen Sie einen Data Matrix-QR-Code und fügen Sie ihn mit Java und einem kurzen Stück Java-Code in eine Pdf-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Data Matrix-QR-Code-Signatur für Pdf-Dokument in Java"
description: "Unterzeichnen Sie Ihre Pdf-Dokumente und -Verträge mit dem Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Pdf mit Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Pdf-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
        ...
        * Rufen Sie die Signature.Sign()-Methode auf und übergeben Sie die Pdf-Ausgabedatei oder den Speicherstrom
