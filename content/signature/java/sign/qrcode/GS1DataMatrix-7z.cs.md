...
############################# Head ############################
head_title: "Dokument eSign 7z s G S1 Data Matrix QR kódem v Java"
head_description: "Vytvořte QR kód G S1 Data Matrix a vložte jej do souboru 7z pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis G S1 Data Matrix QR kódu pro dokument 7z v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu 7z pomocí QR kódu G S1 Data Matrix. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání 7z pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty 7z pomocí podpisů Qrcode.
        
        * Vytvořte instanci třídy Signature poskytující soubor 7z, který se má podepisovat jako cesta nebo proud paměti
        * Instantujte třídu SignOptions a nastavte všechna požadovaná data.
        * Vyvolejte metodu Signature.Sign() předáním výstupního souboru 7z nebo proudu paměti
...
demos:
    enable: true
    title: "Podepisování dokumentů 7z pomocí živé ukázky Qrcode"
    content: |
       Podepište soubor 7z pomocí různých podpisů právě teď na webu [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čeká.
...
more_formats:
    ...
    content: |
        "Můžete také podepsat 7z pomocí jiných typů podpisů. Podívejte se prosím na níže uvedený seznam."
    format: 
