...
############################# Head ############################
head_title: "eSign Gif dokument s Aztec QR kodom u Java"
head_description: "Napravite Aztec QR kod i stavite ga u datoteku Gif koristeći Java s kratkim dijelom Java koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj Aztec potpis QR koda za Gif dokument u Java"
description: "ePotpišite svoje Gif dokumente i ugovore s Aztec QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code je dvodimenzionalna (2-D) matrična simbologija opće namjene koja je dizajnirana da ima veću točnost od ostalih 2-D simbologija. Aztec Code simbol može kodirati do 3832 numeričke znamenke; 3.067 abecednih znakova; ili 1914 bajtova podataka.
          characterset: |
             Svih 256 ASCII znakova.
          textcapacity: |
             Do 3832 numeričke znamenke ili 3067 abecednih znakova ili 1914 bajtova podataka.
          image: |
