...
############################# Head ############################
head_title: "eSigniere Tar-Dokument mit Aztec-QR-Code in Java"
head_description: "Erstellen Sie einen Aztec-QR-Code und fügen Sie ihn mit Java und einem kurzen Stück Java-Code in eine Tar-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Aztec-QR-Code-Signatur für Tar-Dokument in Java"
description: "Unterzeichnen Sie Ihre Tar-Dokumente und -Verträge mit dem Aztec-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
