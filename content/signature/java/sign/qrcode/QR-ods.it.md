...
############################# Head ############################
head_title: "eSign Ods documento con QR codice QR in Java"
head_description: "Crea il codice QR QR e inseriscilo nel file Ods utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera QR firma del codice QR per il documento Ods in Java"
description: "Firma i tuoi documenti e contratti Ods con il codice QR QR. Genera la firma del codice QR in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Ods con Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Ods con firme Qrcode in modo rapido e semplice.
