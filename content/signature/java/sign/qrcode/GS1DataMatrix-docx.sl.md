...
############################# Head ############################
head_title: "eSign Docx dokument s G S1 Data Matrix QR kodo v Java"
head_description: "Ustvarite QR kodo G S1 Data Matrix in jo postavite v datoteko Docx z uporabo Java s kratkim delom kode Java. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari G S1 Data Matrix podpis kode QR za dokument Docx v Java"
description: "e-Podpišite svoje Docx dokumente in pogodbe s G S1 Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Docx z Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Docx s podpisi Qrcode.
