...
############################# Head ############################
head_title: "eSign Xls dokument s QR QR kodom u Java"
head_description: "Napravite QR QR kod i stavite ga u datoteku Xls koristeći Java s kratkim dijelom Java koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj QR potpis QR koda za Xls dokument u Java"
description: "ePotpišite svoje Xls dokumente i ugovore s QR QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xls s Qrcode u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Xls dokumenata s Qrcode potpisima.
        
        * Stvorite instancu klase potpisa koja daje Xls datoteku koja bi se trebala potpisati kao put ili memorijski tok
        * Instancirajte klasu SignOptions i postavite sve tražene podatke.
        * Pozovite metodu Signature.Sign() prosljeđujući izlaznu datoteku Xls ili memorijski tok
...
demos:
    enable: true
    title: "Potpisivanje Xls dokumenata s Qrcode Live Demo"
    content: |
       Potpišite datoteku Xls raznim potpisima upravo sada tako da posjetite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web mjesto. Besplatan online demo čeka na vas.
...
more_formats:
    ...
    content: |
        "Također možete potpisati Xls drugim vrstama potpisa. Pogledajte popis u nastavku."
    format: 
