...
############################# Head ############################
head_title: "eSign Dcm документ із Aztec QR-кодом у Java"
head_description: "Створіть QR-код Aztec і помістіть його у файл Dcm за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду Aztec для документа Dcm у Java"
description: "Електронно підписуйте свої Dcm документи та контракти за допомогою Aztec QR-коду. Згенеруйте підпис QR-коду швидко та легко."
