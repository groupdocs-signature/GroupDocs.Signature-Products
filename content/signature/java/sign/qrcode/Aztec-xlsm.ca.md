...
############################# Head ############################
head_title: "Document electrònic Xlsm amb codi QR Aztec a Java"
head_description: "Creeu Aztec codi QR i col·loqueu-lo al fitxer Xlsm amb Java amb un tros curt de codi Java. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de Aztec per al document Xlsm a Java"
description: "eSigneu els vostres documents i contractes de Xlsm amb el codi QR de Aztec. Genereu la signatura del codi QR de manera ràpida i senzilla."
