...
############################# Head ############################
head_title: "eSign Dotx skjal með Aztec QR kóða í Java"
head_description: "Búðu til Aztec QR kóða og settu hann á Dotx skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til Aztec QR kóða undirskrift fyrir Dotx skjal í Java"
description: "eSignaðu Dotx skjölin þín og samninga með Aztec QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec kóði er tvívídd (2-D) alhliða fylki táknfræði sem er hönnuð til að hafa meiri nákvæmni en aðrar 2-D táknmyndir. Aztec kóða tákn getur umritað allt að 3.832 tölustafi; 3.067 stafrófsstafir; eða 1.914 bæti af gögnum.
          characterset: |
             Allir 256 ASCII stafir.
          textcapacity: |
             Allt að 3.832 tölustafir, eða 3.067 stafrófsstafir, eða 1.914 bæti af gögnum.
          image: |
