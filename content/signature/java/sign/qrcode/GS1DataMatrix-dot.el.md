...
############################# Head ############################
head_title: "eSign Dot έγγραφο με G S1 Data Matrix QR Code στο Java"
head_description: "Δημιουργήστε G S1 Data Matrix κώδικα QR και τοποθετήστε τον σε αρχείο Dot χρησιμοποιώντας το Java με ένα σύντομο κομμάτι κώδικα Java. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε ηλεκτρονικά τα έγγραφα και τα αρχεία της επιχείρησής σας με QR Code."

############################# Header ############################
title: "Δημιουργήστε G S1 Data Matrix υπογραφή κώδικα QR για το έγγραφο Dot στο Java"
description: "Ηλεκτρονικά υπογράψτε τα έγγραφα και τις συμβάσεις του Dot με τον κωδικό QR G S1 Data Matrix. Δημιουργήστε υπογραφή κωδικού QR γρήγορα και εύκολα."
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Dot με Qrcode στο Java"
    content_left: |
        Το [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) παρέχει τη δυνατότητα υπογραφής εγγράφων Dot με υπογραφές Qrcode γρήγορα και εύκολα.
...
demos:
    enable: true
    title: "Υπογραφή εγγράφων Dot με Qrcode Ζωντανή επίδειξη"
    content: |
