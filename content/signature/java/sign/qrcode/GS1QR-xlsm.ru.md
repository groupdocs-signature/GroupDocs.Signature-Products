...
############################# Head ############################
head_title: "eSign Xlsm документ с QR-кодом G S1 Q R в Java"
head_description: "Создайте QR-код G S1 Q R и поместите его в файл Xlsm, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода G S1 Q R для документа Xlsm в Java"
description: "Электронная подпись Xlsm документов и контрактов с G S1 Q R QR-кодом. Создавайте подпись QR-кода быстро и легко."
