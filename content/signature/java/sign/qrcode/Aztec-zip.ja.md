...
############################# Head ############################
head_title: "Java で Aztec QR コードを使用して Zip 文書に eSign"
head_description: "Aztec QR コードを作成し、短い Java コードを含む Java を使用して Zip ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "Java の Zip ドキュメントの Aztec QR コード署名を生成します"
description: "Zip ドキュメントと契約書に Aztec QR コードで電子署名します。 QR コード署名をすばやく簡単に生成します。"
