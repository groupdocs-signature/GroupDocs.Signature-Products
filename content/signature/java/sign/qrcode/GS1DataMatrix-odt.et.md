...
############################# Head ############################
head_title: "eSign Odt dokument G S1 Data Matrix QR-koodiga rakenduses Java"
head_description: "Looge QR-kood G S1 Data Matrix ja sisestage see faili Odt, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Odt QR-koodi allkiri G S1 Data Matrix"
description: "eAllkirjasta oma Odt dokumendid ja lepingud QR-koodiga G S1 Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Odt allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Odt dokumente Qrcode allkirjaga.
        
        * Looge allkirjaklassi eksemplar, mis sisaldab faili Odt, mis peaks allkirjastama tee või mäluvoona
        * Käivitage klass SignOptions ja määrake kõik nõutavad andmed.
        * Käivitage meetod Signature.Sign(), mis edastab väljundfaili Odt või mäluvoo
...
demos:
    enable: true
    title: "Dokumentide Odt allkirjastamine Qrcode reaalajas demoga"
    content: |
       Allkirjastage fail Odt erinevate allkirjadega kohe, külastades veebisaiti [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Tasuta online demo ootab teid.
...
more_formats:
    ...
    content: |
        "Saate allkirjastada faili Odt ka muude allkirjatüüpidega. Vaadake allolevat loendit."
    format: 
