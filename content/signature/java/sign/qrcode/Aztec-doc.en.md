...
############################# Head ############################
head_title: "eSign Doc document with Aztec QR Code in Java"
head_description: "Create Aztec QR Code and put it on Doc file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Doc document in Java"
