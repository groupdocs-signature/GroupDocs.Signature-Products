...
############################# Head ############################
head_title: "Java ішінде QR QR коды бар eSign Ots құжаты"
head_description: "QR QR кодын жасаңыз және оны Java арқылы Java кодының қысқа бөлігімен Ots файлына салыңыз. QR коды арқылы іскери құжаттар мен файлдарға электрондық қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "Java ішінде Ots құжаты үшін QR QR код қолтаңбасын жасаңыз"
description: "Ots құжаттарыңыз бен келісім-шарттарыңызға QR QR Code арқылы қол қойыңыз. QR Code қолтаңбасын тез және оңай жасаңыз."
...
steps:
    enable: true
    title_left: "Java жүйесінде Qrcode арқылы Ots файлына қол қою қадамдары"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) Ots құжаттарға Qrcode қолтаңбаларымен жылдам және оңай қол қою мүмкіндігін береді.
...
demos:
    enable: true
    title: "Ots құжаттарға Qrcode тікелей көрсетілімі арқылы қол қою"
    content: |
...
more_formats:
    ...
    content: |
        "Ots қолтаңбасының басқа түрлерімен де қол қоюға болады. Төмендегі тізімді қараңыз."
    format: 
