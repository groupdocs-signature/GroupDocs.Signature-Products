...
############################# Head ############################
head_title: "eSign Dot document with G S1 Data Matrix QR Code in Java"
head_description: "Create G S1 Data Matrix QR Code Signature on Dot file for Java using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Data Matrix QR Code signature for Dot document in Java"
description: "eSign your Dot documents and contracts with G S1 Data Matrix QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Dot files with Qrcode signatures using Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
        You can put Qrcode on Dot file in a very convenient way and for free. Besides that it is possible to sign Dot files using advanced Qrcode options. 
        ...
        * furthermore file can be encrypted with password or saved to memory stream.
        ...
        Signing Dot files with Qrcode provides vast amount opportunities for users. Moreover there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc.


############################# Steps ############################
steps:
    enable: true
    title_left: "Steps to sign Dot with Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Dot documents with Qrcode signatures quick and easily.
...
demos:
    enable: true
    title: "Signing Dot documents with Qrcode Live Demo"
    content: |
       Sign Dot file with Qrcode signature right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website. Free online demo waiting for you.
