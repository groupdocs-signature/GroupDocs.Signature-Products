...
############################# Head ############################
head_title: "eSign Dot dokumentas su G S1 Data Matrix QR kodu Java"
head_description: "Sukurkite QR kodą G S1 Data Matrix ir įdėkite jį į failą Dot naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Data Matrix QR kodo parašą Dot dokumentui Java"
description: "e. Pasirašykite Dot dokumentus ir sutartis naudodami G S1 Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Dot naudojant Qrcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Dot dokumentus su Qrcode parašais.
...
demos:
    enable: true
    title: "Dokumentų Dot pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
