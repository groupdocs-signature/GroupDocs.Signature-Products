...
############################# Head ############################
head_title: "Java میں G S1 Q R QR کوڈ کے ساتھ eSign Dotx دستاویز"
head_description: "G S1 Q R QR کوڈ بنائیں اور اسے Java کا استعمال کرتے ہوئے Java کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Dotx فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "Java میں Dotx دستاویز کے لیے G S1 Q R QR کوڈ دستخط بنائیں"
description: "اپنے Dotx دستاویزات اور معاہدوں پر G S1 Q R QR کوڈ کے ساتھ دستخط کریں۔ QR کوڈ دستخط جلدی اور آسانی سے بنائیں۔"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR کوڈ QR کوڈ کا ایک متغیر ہے جو GS1 وضاحتوں کے مطابق ہے۔ یہ خاص طور پر توسیع شدہ پیکیجنگ کی معلومات، جیسے لاٹ نمبر، پروڈکٹ ID، اور مقدار کے اشتراک کے لیے ڈیزائن کیا گیا تھا۔
          characterset: |
             اپر اور لوئر کیس کے حروف اور خصوصی حروف $%*+-./: سبھی درست ایپلیکیشن شناخت کنندگان کے ساتھ
          textcapacity: |
             7089 عددی حروف تک، 4296 حروف عددی حروف
          image: |
