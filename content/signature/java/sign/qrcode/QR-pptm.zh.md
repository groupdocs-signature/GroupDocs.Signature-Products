...
############################# Head ############################
head_title: "在 Java 中带有 QR QR 码的 eSign Pptm 文档"
head_description: "创建 QR 二维码并使用 Java 和一小段 Java 代码将其放在 Pptm 文件中。使用 GroupDocs 文档签名 API 使用 QR 码对您的业务文档和文件进行电子签名。"

############################# Header ############################
title: "在 Java 中为 Pptm 文档生成 QR 二维码签名"
