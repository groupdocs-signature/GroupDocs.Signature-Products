...
############################# Head ############################
head_title: "Document electrònic Bmp amb codi QR G S1 Q R a Java"
head_description: "Creeu G S1 Q R codi QR i col·loqueu-lo al fitxer Bmp amb Java amb un tros curt de codi Java. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de G S1 Q R per al document Bmp a Java"
description: "eSigneu els vostres documents i contractes de Bmp amb el codi QR de G S1 Q R. Genereu la signatura del codi QR de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Passos per signar Bmp amb Qrcode a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Bmp amb signatures Qrcode de manera ràpida i senzilla.
...
demos:
    enable: true
    title: "Signant documents de Bmp amb Qrcode Demostració en directe"
    content: |
