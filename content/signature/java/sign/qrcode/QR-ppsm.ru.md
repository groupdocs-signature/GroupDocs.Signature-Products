...
############################# Head ############################
head_title: "eSign Ppsm документ с QR-кодом QR в Java"
head_description: "Создайте QR-код QR и поместите его в файл Ppsm, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода QR для документа Ppsm в Java"
description: "Электронная подпись Ppsm документов и контрактов с QR QR-кодом. Создавайте подпись QR-кода быстро и легко."
...
demos:
    enable: true
    title: "Подписание Ppsm документов с помощью Qrcode Live Demo"
    content: |
       Подпишите файл Ppsm с различными подписями прямо сейчас, посетив веб-сайт [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Бесплатная онлайн-демонстрация ждет вас.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR-код (сокращенно от Quick Response Code) — это товарный знак матричного штрих-кода (или двумерного штрих-кода). Это самый популярный и широко используемый тип двумерного кода. На практике QR-коды часто содержат данные для локатора, идентификатора или трекера, которые указывают на веб-сайт или приложение.
          characterset: |
             Все 256 символов ASCII + кандзи
          textcapacity: |
             До 7089 цифровых символов, 4296 буквенно-цифровых символов, 2953 байта (двоичные данные) или 1817 символов кандзи.
          image: |
...
more_formats:
    ...
    content: |
        "Вы также можете подписать Ppsm другими типами подписи. См. список ниже."
    format: 
