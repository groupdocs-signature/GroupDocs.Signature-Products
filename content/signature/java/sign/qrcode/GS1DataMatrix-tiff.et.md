...
############################# Head ############################
head_title: "eSign Tiff dokument G S1 Data Matrix QR-koodiga rakenduses Java"
head_description: "Looge QR-kood G S1 Data Matrix ja sisestage see faili Tiff, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Tiff QR-koodi allkiri G S1 Data Matrix"
description: "eAllkirjasta oma Tiff dokumendid ja lepingud QR-koodiga G S1 Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Tiff allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Tiff dokumente Qrcode allkirjaga.
        
        * Looge allkirjaklassi eksemplar, mis sisaldab faili Tiff, mis peaks allkirjastama tee või mäluvoona
        * Käivitage klass SignOptions ja määrake kõik nõutavad andmed.
        * Käivitage meetod Signature.Sign(), mis edastab väljundfaili Tiff või mäluvoo
...
demos:
    enable: true
    title: "Dokumentide Tiff allkirjastamine Qrcode reaalajas demoga"
    content: |
       Allkirjastage fail Tiff erinevate allkirjadega kohe, külastades veebisaiti [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Tasuta online demo ootab teid.
...
more_formats:
    ...
    content: |
        "Saate allkirjastada faili Tiff ka muude allkirjatüüpidega. Vaadake allolevat loendit."
    format: 
