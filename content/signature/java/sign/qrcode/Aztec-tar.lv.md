...
############################# Head ############################
head_title: "eSign Tar dokuments ar Aztec QR kodu programmā Java"
head_description: "Izveidojiet Aztec QR kodu un ievietojiet to failā Tar, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt Aztec QR koda parakstu dokumentam Tar programmā Java"
description: "eParakstiet savus Tar dokumentus un līgumus ar Aztec QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Tar ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Tar dokumentus ar Qrcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Tar parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
