...
############################# Head ############################
head_title: "eSign Dot dokuments ar QR QR kodu programmā Java"
head_description: "Izveidojiet QR QR kodu un ievietojiet to failā Dot, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt QR QR koda parakstu dokumentam Dot programmā Java"
description: "eParakstiet savus Dot dokumentus un līgumus ar QR QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Dot ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Dot dokumentus ar Qrcode parakstiem.
        
        * Izveidojiet paraksta klases gadījumu, kas nodrošina Dot failu, kas paredzēts parakstīšanai kā ceļš vai atmiņas straume
        * Izveidojiet SignOptions klasi un iestatiet visus pieprasītos datus.
        * Izsauciet metodi Signature.Sign(), kas nodod izvades Dot failu vai atmiņas straumi
...
demos:
    enable: true
    title: "Dokumentu Dot parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
       Parakstiet Dot failu ar dažādiem parakstiem tūlīt, apmeklējot vietni [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Jūs gaida bezmaksas tiešsaistes demonstrācija.
...
more_formats:
    ...
    content: |
        "Varat arī parakstīt Dot ar citiem paraksta veidiem. Lūdzu, skatiet sarakstu zemāk."
    format: 
