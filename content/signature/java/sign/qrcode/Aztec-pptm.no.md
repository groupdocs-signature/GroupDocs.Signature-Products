...
############################# Head ############################
head_title: "eSign Pptm-dokument med Aztec QR-kode i Java"
head_description: "Lag Aztec QR-kode og legg den til Pptm-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer Aztec QR-kodesignatur for Pptm-dokument i Java"
description: "eSigner Pptm-dokumentene og kontraktene dine med QR-koden Aztec. Generer QR-kodesignatur raskt og enkelt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code er en todimensjonal (2D) generell matrisesymbologi som er designet for å ha høyere nøyaktighet enn andre 2D-symbologier. Et Aztec Code-symbol kan kode opptil 3 832 numeriske sifre; 3 067 alfabetiske tegn; eller 1 914 byte med data.
          characterset: |
             Alle 256 ASCII-tegn.
          textcapacity: |
             Opptil 3 832 numeriske sifre, eller 3 067 alfabetiske tegn, eller 1 914 byte med data.
          image: |
