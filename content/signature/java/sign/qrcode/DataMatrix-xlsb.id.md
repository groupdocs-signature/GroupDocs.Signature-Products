...
############################# Head ############################
head_title: "eSign Xlsb dokumen dengan Data Matrix QR Code di Java"
head_description: "Buat Kode QR Data Matrix dan letakkan di file Xlsb menggunakan Java dengan potongan pendek kode Java. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat Data Matrix tanda tangan Kode QR untuk dokumen Xlsb di Java"
description: "eTandatangani dokumen dan kontrak Xlsb Anda dengan Kode QR Data Matrix. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xlsb dengan Qrcode di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Xlsb dengan Qrcode tanda tangan dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Xlsb dengan Qrcode Demo Langsung"
    content: |
