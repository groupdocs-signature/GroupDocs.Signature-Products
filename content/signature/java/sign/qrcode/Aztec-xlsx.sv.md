...
############################# Head ############################
head_title: "eSign Xlsx-dokument med Aztec QR-kod i Java"
head_description: "Skapa Aztec QR-kod och lägg den i filen Xlsx med Java med en kort bit av Java-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera Aztec QR-kodsignatur för Xlsx dokument i Java"
description: "esignera dina Xlsx-dokument och kontrakt med Aztec QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code är en tvådimensionell (2D) generell matrissymbolik som är utformad för att ha högre noggrannhet än andra 2D-symboliker. En aztekisk kodsymbol kan koda upp till 3 832 numeriska siffror; 3 067 alfabetiska tecken; eller 1 914 byte data.
          characterset: |
             Alla 256 ASCII-tecken.
          textcapacity: |
             Upp till 3 832 numeriska siffror eller 3 067 alfabetiska tecken eller 1 914 byte data.
          image: |
