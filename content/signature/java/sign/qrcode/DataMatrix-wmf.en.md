...
head_description: "Create Data Matrix QR Code and put it on Wmf file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Data Matrix QR Code signature for Wmf document in Java"
description: "eSign your Wmf documents and contracts with Data Matrix QR Code. Generate QR Code signature quickly and easily."
