...
############################# Head ############################
head_title: "مستند eSign Dotx مع رمز الاستجابة السريعة G S1 Q R في Java"
head_description: "أنشئ رمز الاستجابة السريعة G S1 Q R وضعه في ملف Dotx باستخدام Java مع جزء قصير من كود Java. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء G S1 Q R توقيع رمز الاستجابة السريعة لمستند Dotx في Java"
description: "قم بتوقيع Dotx على المستندات والعقود باستخدام رمز الاستجابة السريعة G S1 Q R. قم بإنشاء توقيع QR Code بسرعة وسهولة."
...
steps:
    enable: true
    title_left: "خطوات تسجيل Dotx باستخدام Qrcode في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Dotx بتوقيعات Qrcode بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Dotx باستخدام العرض التوضيحي المباشر Qrcode"
    content: |
