...
############################# Head ############################
head_title: "eSign Jpg -asiakirja QR QR-koodilla Java"
head_description: "Luo QR-koodi QR ja laita se Jpg-tiedostoon käyttämällä Java lyhyttä Java-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo QR QR-koodiallekirjoitus asiakirjalle Jpg kohteessa Java"
description: "eAllekirjoita Jpg-asiakirjat ja sopimukset QR-koodilla QR. Luo QR-koodin allekirjoitus nopeasti ja helposti."
...
steps:
    enable: true
    title_left: "Vaiheet Jpg:n allekirjoittamiseen Qrcode -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Jpg-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
