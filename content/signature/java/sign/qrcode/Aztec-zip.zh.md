...
############################# Head ############################
head_title: "在 Java 中带有 Aztec QR 码的 eSign Zip 文档"
head_description: "创建 Aztec 二维码并使用 Java 和一小段 Java 代码将其放在 Zip 文件中。使用 GroupDocs 文档签名 API 使用 QR 码对您的业务文档和文件进行电子签名。"

############################# Header ############################
title: "在 Java 中为 Zip 文档生成 Aztec 二维码签名"
description: "使用 Aztec 二维码对您的 Zip 文档和合同进行电子签名。快速轻松地生成二维码签名。"
...
steps:
    enable: true
    title_left: "在 Java 中使用 Qrcode 签署 Zip 的步骤"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) 提供使用 Qrcode 签名快速轻松地签署 Zip 文档的能力。
