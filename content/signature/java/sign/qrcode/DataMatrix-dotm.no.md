...
head_description: "Lag Data Matrix QR-kode og legg den til Dotm-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer Data Matrix QR-kodesignatur for Dotm-dokument i Java"
description: "eSigner Dotm-dokumentene og kontraktene dine med QR-koden Data Matrix. Generer QR-kodesignatur raskt og enkelt."
