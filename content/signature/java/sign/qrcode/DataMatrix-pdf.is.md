...
############################# Head ############################
head_title: "eSign Pdf skjal með Data Matrix QR kóða í Java"
head_description: "Búðu til Data Matrix QR kóða og settu hann á Pdf skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til Data Matrix QR kóða undirskrift fyrir Pdf skjal í Java"
description: "eSignaðu Pdf skjölin þín og samninga með Data Matrix QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Pdf með Qrcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Pdf skjöl með Qrcode undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Pdf skjöl með Qrcode lifandi kynningu"
    content: |
