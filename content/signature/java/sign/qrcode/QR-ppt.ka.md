...
############################# Head ############################
head_title: "eSign Ppt დოკუმენტი QR QR კოდით Java-ში"
head_description: "შექმენით QR QR კოდი და განათავსეთ ის Ppt ფაილზე Java-ის გამოყენებით Java კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით QR QR კოდის ხელმოწერა Ppt დოკუმენტისთვის Java-ში"
...
steps:
    enable: true
    title_left: "Ppt-ით ხელმოწერის ნაბიჯები Qrcode-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Ppt დოკუმენტები Qrcode ხელმოწერებით სწრაფად და მარტივად.
