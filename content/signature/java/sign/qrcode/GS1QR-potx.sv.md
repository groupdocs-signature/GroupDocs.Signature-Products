...
############################# Head ############################
head_title: "eSign Potx-dokument med G S1 Q R QR-kod i Java"
head_description: "Skapa G S1 Q R QR-kod och lägg den i filen Potx med Java med en kort bit av Java-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera G S1 Q R QR-kodsignatur för Potx dokument i Java"
description: "esignera dina Potx-dokument och kontrakt med G S1 Q R QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Potx med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Potx-dokument med Qrcode-signaturer snabbt och enkelt.
