...
############################# Head ############################
head_title: "eSign Xlsb dokumentas su G S1 Data Matrix QR kodu Java"
head_description: "Sukurkite QR kodą G S1 Data Matrix ir įdėkite jį į failą Xlsb naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Data Matrix QR kodo parašą Xlsb dokumentui Java"
description: "e. Pasirašykite Xlsb dokumentus ir sutartis naudodami G S1 Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
about:
    enable: true
    title: "Apie GroupDocs.Signature for Java QR kodo parašų API"
    content: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra suaugusiųjų API, skirta kurti ir generuoti dokumentų QR kodo parašus. Vartotojai gali sugeneruoti QR kodo parašus, pateikdami tekstą, norėdami jį atsisiųsti arba bendrinti socialinėje žiniasklaidoje kaip vaizdą. Pasirašytą dokumentą galima nuskaityti naudojant API arba tiesiog per mobiliąją kamerą! Pasirašykite elektroniniu būdu verslo sutartis ir oficialius dokumentus pridėdami QR kodo parašą ir juo manipuliuokite. Bet kuriame QR kodo paraše bus unikali tinkinta informacija, skirta identifikuoti pasirašantįjį arba įgalioti dokumentą. Be to, QR kodo turinį galima programiškai užšifruoti ir iššifruoti asmeniniais raktais. Tai atveria daug galimybių dalytis neskelbtinais duomenimis viešuosiuose dokumentuose. Pasirašęs vartotojas gali atnaujinti, patikrinti, ištrinti, peržiūrėti arba ieškoti QR kodų PDF, MS Word dokumentuose, MS Excel darbaknygėse, MS PowerPoint pristatymuose, Adobe Photoshop failuose ir įvairiuose vaizdo formatuose. QR kodai gali būti papildomai pritaikyti.
    

############################# Steps ############################
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Xlsb naudojant Qrcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Xlsb dokumentus su Qrcode parašais.
        
        * Sukurkite parašo klasės egzempliorių, pateikiantį Xlsb failą, kuris turėtų būti pasirašytas kaip kelias arba atminties srautas
        * Sukurkite SignOptions klasę ir nustatykite visus reikalingus duomenis.
        * Iškvieskite Signature.Sign() metodą, perduodantį išvesties Xlsb failą arba atminties srautą
...
demos:
    enable: true
    title: "Dokumentų Xlsb pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
       Pasirašykite Xlsb failą įvairiais parašais dabar apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje. Jūsų laukia nemokama internetinė demonstracinė versija.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix yra duomenų matricos variantas, atitinkantis GS1 specifikacijas. Naudokite GS1 DataMatrix, norėdami užkoduoti tokią informaciją, kaip, bet tuo neapsiribojant: AI(01) pasaulinis prekybos elemento numeris (GTIN), AI(17) galiojimo laikas, AI(10) partijos numeris, AI(21) serijos numeris. .
          characterset: |
             Simbolių rinkinys: didžiosios ir mažosios raidės bei specialieji simboliai $@%*+-./:=<>;&*_,'! visi su teisingais programos identifikatoriais.
          textcapacity: |
             Kodo teksto talpa: iki 3116 skaitmeninių skaitmenų arba 2335 raidinių skaitmeninių simbolių.
          image: |
...
more_formats:
    enable: true
    title: "Kiti palaikomi Qrcode parašai, skirti Java"
    content: |
        "Taip pat galite pasirašyti Xlsb naudodami kitų tipų parašus. Žiūrėkite žemiau esantį sąrašą."
    format: 
