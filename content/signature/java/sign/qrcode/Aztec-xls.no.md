...
head_description: "Lag Aztec QR-kode og legg den til Xls-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer Aztec QR-kodesignatur for {{Filformat}}-dokument i Java"
description: "eSigner Xls-dokumentene og kontraktene dine med QR-koden Aztec. Generer QR-kodesignatur raskt og enkelt."
