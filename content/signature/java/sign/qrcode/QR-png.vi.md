...
############################# Head ############################
head_title: "eSign Png tài liệu với QR Mã QR trong Java"
head_description: "Tạo Mã QR QR và đặt nó vào tệp Png bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR QR cho tài liệu Png trong Java"
description: "eSign các tài liệu và hợp đồng Png của bạn bằng Mã QR QR. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
