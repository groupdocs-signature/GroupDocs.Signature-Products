...
############################# Head ############################
head_title: "eSign Jpeg document with Aztec QR Code in Java"
head_description: "Create Aztec QR Code Signature on Jpeg file for Java using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Jpeg document in Java"
description: "eSign your Jpeg documents and contracts with Aztec QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with Aztec Qrcode using Java"
    content: |
        Java Aztec Qrcode signatures management API for documents and images. Add Aztec Qrcode signatures to some of the popular file formats as stated below.
    format: 
