...
############################# Head ############################
head_title: "Document electrònic Docx amb codi QR Data Matrix a Java"
head_description: "Creeu Data Matrix codi QR i col·loqueu-lo al fitxer Docx amb Java amb un tros curt de codi Java. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de Data Matrix per al document Docx a Java"
description: "eSigneu els vostres documents i contractes de Docx amb el codi QR de Data Matrix. Genereu la signatura del codi QR de manera ràpida i senzilla."
...
demos:
    enable: true
    title: "Signant documents de Docx amb Qrcode Demostració en directe"
    content: |
       Signa el fitxer Docx amb diverses signatures ara mateix visitant el lloc web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demostració gratuïta en línia esperant-te.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix és un codi bidimensional que consta de "cel·les" o punts en blanc i negre disposats en un patró quadrat o rectangular, també conegut com a matriu. La informació a codificar pot ser text o dades numèriques.
          characterset: |
             Admet els 256 caràcters ASCII, tots els caràcters ISO i tots els caràcters de codi d'intercanvi decimal codificat binari estès (EBCDIC).
          textcapacity: |
             Fins a 3116 dígits numèrics, o 2335 caràcters alfanumèrics o 1556 caràcters binaris.
          image: |
...
more_formats:
    enable: true
    title: "Altres signatures admeses de Qrcode per a Java"
    content: |
        "També podeu signar Docx amb altres tipus de signatura. Si us plau, consulteu la llista a continuació."
    format: 
