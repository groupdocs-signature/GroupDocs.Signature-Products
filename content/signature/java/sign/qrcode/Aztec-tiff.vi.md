...
############################# Head ############################
head_title: "eSign Tiff tài liệu với Aztec Mã QR trong Java"
head_description: "Tạo Mã QR Aztec và đặt nó vào tệp Tiff bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR Aztec cho tài liệu Tiff trong Java"
description: "eSign các tài liệu và hợp đồng Tiff của bạn bằng Mã QR Aztec. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
