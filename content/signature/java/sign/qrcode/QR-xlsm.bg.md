...
############################# Head ############################
head_title: "eSign Xlsm документ с QR QR код в Java"
head_description: "Създайте QR QR код и го поставете във файл Xlsm, като използвате Java с кратка част от Java код. Използвайте API за подписване на документи на GroupDocs, за да подпишете електронно вашите бизнес документи и файлове с QR код."

############################# Header ############################
title: "Генерирайте QR QR Code подпис за Xlsm документ в Java"
description: "Електронно подпишете вашите Xlsm документи и договори с QR QR код. Генерирайте QR код подпис бързо и лесно."
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Xlsm с Qrcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на Xlsm документи с Qrcode подписи.
        
        * Създайте екземпляр на клас подпис, предоставящ файл Xlsm, който трябва да се подписва като път или поток от памет
        * Създайте клас SignOptions и задайте всички изисквани данни.
        * Извикване на метода Signature.Sign(), предаващ изходен файл Xlsm или поток от памет
...
demos:
    enable: true
    title: "Подписване на Xlsm документи с Qrcode Демо на живо"
    content: |
       Подпишете файл Xlsm с различни подписи точно сега, като посетите уебсайта [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Безплатна онлайн демонстрация ви очаква.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR код (съкратено от Quick Response Code) е търговската марка за тип матричен баркод (или двуизмерен баркод). Това е най-популярният и широко използван тип двуизмерен код. На практика QR кодовете често съдържат данни за локатор, идентификатор или тракер, който сочи към уебсайт или приложение.
          characterset: |
             Всички 256 ASCII знака + канджи
          textcapacity: |
             До 7089 цифрови знака, 4296 буквено-цифрови знака, 2953 байта (двоични данни) или 1817 канджи знака.
          image: |
...
more_formats:
    ...
    content: |
        "Можете също да подпишете Xlsm с други типове подписи. Моля, вижте списъка по-долу."
    format: 
