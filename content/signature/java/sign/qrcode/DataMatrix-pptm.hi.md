...
############################# Head ############################
head_title: "Java में Data Matrix QR कोड के साथ eSign Pptm दस्तावेज़"
head_description: "Data Matrix QR कोड बनाएं और Java कोड के एक छोटे टुकड़े के साथ Java का उपयोग करके इसे Pptm फ़ाइल में डालें। QR कोड के साथ अपने व्यावसायिक दस्तावेज़ों और फ़ाइलों पर ई-हस्ताक्षर करने के लिए GroupDocs दस्तावेज़ हस्ताक्षर API का उपयोग करें।"

############################# Header ############################
title: "Java में Pptm दस्तावेज़ के लिए Data Matrix QR कोड हस्ताक्षर जेनरेट करें"
description: "अपने Pptm दस्तावेज़ों और अनुबंधों पर Data Matrix QR कोड के साथ ई-हस्ताक्षर करें। क्यूआर कोड हस्ताक्षर जल्दी और आसानी से उत्पन्न करें।"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            डेटा मैट्रिक्स एक द्वि-आयामी कोड है जिसमें एक वर्ग या आयताकार पैटर्न में व्यवस्थित काले और सफेद 'कोशिकाएं' या बिंदु होते हैं, जिन्हें मैट्रिक्स भी कहा जाता है। एन्कोड की जाने वाली जानकारी टेक्स्ट या संख्यात्मक डेटा हो सकती है।
          characterset: |
             सभी 256 ASCII वर्णों, सभी ISO वर्णों और सभी विस्तारित बाइनरी कोडेड दशमलव इंटरचेंज कोड (EBCDIC) वर्णों का समर्थन करता है।
          textcapacity: |
             अप करने के लिए 3116 अंकीय अंक, या 2335 अल्फ़ा न्यूमेरिक वर्ण, या 1556 बाइनरी वर्ण।
          image: |
