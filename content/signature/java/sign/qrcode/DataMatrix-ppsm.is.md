...
############################# Head ############################
head_title: "eSign Ppsm skjal með Data Matrix QR kóða í Java"
head_description: "Búðu til Data Matrix QR kóða og settu hann á Ppsm skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til Data Matrix QR kóða undirskrift fyrir Ppsm skjal í Java"
description: "eSignaðu Ppsm skjölin þín og samninga með Data Matrix QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Ppsm með Qrcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Ppsm skjöl með Qrcode undirskrift fljótt og auðveldlega.
        
        * Búðu til tilvik af Signature class sem gefur upp Ppsm skrá sem á að undirrita sem slóð eða minnisstraum
        * Upphafðu SignOptions flokkinn og stilltu öll umbeðin gögn.
        * Kallaðu á Signature.Sign() aðferðina sem sendir úttak Ppsm skrá eða minnisstraum
...
demos:
    enable: true
    title: "Undirritar Ppsm skjöl með Qrcode lifandi kynningu"
    content: |
       Skrifaðu undir Ppsm skrána með ýmsum undirskriftum núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna. Ókeypis kynning á netinu bíður þín.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Gagnafylki er tvívíður kóði sem samanstendur af svörtum og hvítum „frumum“ eða punktum raðað í annað hvort ferhyrnt eða rétthyrnt mynstur, einnig þekkt sem fylki. Upplýsingarnar sem á að kóða geta verið texti eða töluleg gögn.
          characterset: |
             Styður alla 256 ASCII stafi, alla ISO stafi og alla Extended Binary Coded Decimal Interchange Code (EBCDIC) stafi.
          textcapacity: |
             Allt að 3116 tölustafir, eða 2335 alfa tölustafir, eða 1556 tvíundir stafir.
          image: |
...
more_formats:
    ...
    content: |
        "Þú getur líka skrifað undir Ppsm með öðrum undirskriftartegundum. Vinsamlegast skoðaðu listann hér að neðan."
    format: 
