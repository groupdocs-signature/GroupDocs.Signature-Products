...
head_description: "Create Data Matrix QR Code and put it on Pptm file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Data Matrix QR Code signature for Pptm document in Java"
description: "eSign your Pptm documents and contracts with Data Matrix QR Code. Generate QR Code signature quickly and easily."
