...
############################# Head ############################
head_title: "eSign documentul Xlsx cu codul QR G S1 Data Matrix în Java"
head_description: "Creați codul QR G S1 Data Matrix și puneți-l în fișierul Xlsx folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura G S1 Data Matrix cod QR pentru documentul Xlsx în Java"
description: "eSemnați documentele și contractele Xlsx cu codul QR G S1 Data Matrix. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xlsx cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Xlsx cu semnături Qrcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Xlsx cu Qrcode Live Demo"
    content: |
