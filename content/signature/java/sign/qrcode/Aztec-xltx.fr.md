...
############################# Head ############################
head_title: "eSign Xltx document avec Aztec QR Code en Java"
head_description: "Créez le code QR Aztec et placez-le dans le fichier Xltx en utilisant Java avec un court morceau de code Java. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR Aztec pour le document Xltx en Java"
description: "Signez électroniquement vos documents et contrats Xltx avec Aztec QR Code. Générez une signature QR Code rapidement et facilement."
