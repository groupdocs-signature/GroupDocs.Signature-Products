...
breadcrumb: Create QRCODE signature on XLTM for Java

############################# Head ############################
head_title: "Adding QRCODE signatures in a XLTM file with Java"
head_description: "Put QRCODE Signature on XLTM file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .XLTM files with QRCODE signatures in Java"
...
steps:
    ...
    code: |
        ...
        options.setEncodeType(QrCodeTypes.GS1DATAMATRIX);
