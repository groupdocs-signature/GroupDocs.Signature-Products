...
############################# Head ############################
head_title: "eSign Dot document met G S1 Data Matrix QR-code in Java"
head_description: "Maak een G S1 Data Matrix QR-code en plaats deze in het Dot-bestand met behulp van Java met een kort stukje Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR Code handtekening voor Dot document in Java"
description: "Onderteken uw Dot documenten en contracten met G S1 Data Matrix QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Dot te ondertekenen met Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Dot documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
...
demos:
    enable: true
    title: "Dot documenten ondertekenen met Qrcode Live Demo"
    content: |
       Onderteken het Dot-bestand met verschillende handtekeningen op dit moment door naar de website [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) te gaan. Gratis online demo voor u klaar.
...
more_formats:
    ...
    content: |
        "U kunt Dot ook ondertekenen met andere soorten handtekeningen. Zie de lijst hieronder."
    format: 
