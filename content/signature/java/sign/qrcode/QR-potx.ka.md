...
############################# Head ############################
head_title: "eSign Potx დოკუმენტი QR QR კოდით Java-ში"
head_description: "შექმენით QR QR კოდი და განათავსეთ ის Potx ფაილზე Java-ის გამოყენებით Java კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით QR QR კოდის ხელმოწერა Potx დოკუმენტისთვის Java-ში"
description: "მოაწერეთ თქვენი Potx დოკუმენტები და კონტრაქტები QR QR კოდით. შექმენით QR კოდის ხელმოწერა სწრაფად და მარტივად."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR კოდი (შემოკლებით სწრაფი რეაგირების კოდიდან) არის სავაჭრო ნიშანი მატრიცული შტრიხკოდის (ან ორგანზომილებიანი შტრიხკოდის) ტიპისთვის. ეს არის ყველაზე პოპულარული და ფართოდ გამოყენებული ორგანზომილებიანი კოდის ტიპი. პრაქტიკაში, QR კოდები ხშირად შეიცავს მონაცემებს ლოკატორის, იდენტიფიკატორის ან ტრეკერისთვის, რომელიც მიუთითებს ვებსაიტზე ან აპლიკაციაზე.
          characterset: |
             ყველა 256 ASCII სიმბოლო + კანჯი
          textcapacity: |
             7089-მდე რიცხვითი სიმბოლო, 4296 ალფანუმერული სიმბოლო, 2953 ბაიტი (ორობითი მონაცემები) ან 1817 კანჯი სიმბოლო.
          image: |
