...
############################# Head ############################
head_title: "Java içinde Aztec QR Kodu ile Potm belgesini eSign"
head_description: "Aztec QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Potm dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Potm belgesi için Aztec QR Kodu imzası oluşturun"
description: "Potm belgelerinizi ve sözleşmelerinizi Aztec QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
steps:
    enable: true
    title_left: "Java içinde Qrcode ile Potm imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Potm belgelerini Qrcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztek Kodu, diğer 2 boyutlu sembolojilerden daha yüksek doğruluğa sahip olacak şekilde tasarlanmış iki boyutlu (2-D) genel amaçlı bir matris sembolojisidir. Bir Aztek Kodu sembolü, en fazla 3.832 sayısal basamağı kodlayabilir; 3.067 alfabetik karakter; veya 1.914 bayt veri.
          characterset: |
             256 ASCII karakterin tümü.
          textcapacity: |
             En fazla 3.832 sayısal basamak veya 3.067 alfabetik karakter veya 1.914 bayt veri.
          image: |
