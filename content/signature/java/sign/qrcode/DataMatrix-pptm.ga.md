...
############################# Head ############################
head_title: "eSign Pptm doiciméad le Data Matrix Cód QR in Java"
head_description: "Cruthaigh Data Matrix Cód QR agus cuir ar chomhad Pptm é ag úsáid Java le píosa gairid de chód Java. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Data Matrix don doiciméad Pptm in Java"
description: "eSínigh do dhoiciméid agus conarthaí Pptm le Data Matrix Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
