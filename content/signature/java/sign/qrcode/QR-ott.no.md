...
############################# Head ############################
head_title: "eSign Ott-dokument med QR QR-kode i Java"
head_description: "Lag QR QR-kode og legg den til Ott-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Ott-dokument i Java"
description: "eSigner Ott-dokumentene og kontraktene dine med QR-koden QR. Generer QR-kodesignatur raskt og enkelt."
...
steps:
    enable: true
    title_left: "Trinn for å signere Ott med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Ott-dokumenter med Qrcode-signaturer raskt og enkelt.
