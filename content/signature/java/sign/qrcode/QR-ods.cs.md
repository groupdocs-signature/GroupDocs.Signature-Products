...
############################# Head ############################
head_title: "Dokument eSign Ods s QR QR kódem v Java"
head_description: "Vytvořte QR kód QR a vložte jej do souboru Ods pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis QR QR kódu pro dokument Ods v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Ods pomocí QR kódu QR. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Ods pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Ods pomocí podpisů Qrcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Ods pomocí živé ukázky Qrcode"
    content: |
