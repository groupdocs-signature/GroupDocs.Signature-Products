...
############################# Head ############################
head_title: "Java içinde Data Matrix QR Kodu ile Xlsb belgesini eSign"
head_description: "Data Matrix QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Xlsb dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Xlsb belgesi için Data Matrix QR Kodu imzası oluşturun"
description: "Xlsb belgelerinizi ve sözleşmelerinizi Data Matrix QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
steps:
    enable: true
    title_left: "Java içinde Qrcode ile Xlsb imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Xlsb belgelerini Qrcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
        
        * Yol veya bellek akışı olarak imzalaması gereken Xlsb dosyasını sağlayan bir Signature sınıfı örneği oluşturun
        * SignOptions sınıfını örnekleyin ve istenen tüm verileri ayarlayın.
        * Çıkış Xlsb dosyasını veya bellek akışını geçen Signature.Sign() yöntemini çağırın
...
demos:
    enable: true
    title: "Xlsb dokümanı Qrcode Canlı Demo ile imzalama"
    content: |
       Hemen şimdi [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web sitesini ziyaret ederek çeşitli imzalarla Xlsb dosyasını imzalayın. Ücretsiz çevrimiçi demo sizi bekliyor.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Veri Matrisi, kare veya dikdörtgen şeklinde düzenlenmiş siyah ve beyaz 'hücrelerden' veya noktalardan oluşan iki boyutlu bir koddur ve matris olarak da bilinir. Kodlanacak bilgi metin veya sayısal veri olabilir.
          characterset: |
             Tüm 256 ASCII karakterini, tüm ISO karakterlerini ve tüm Genişletilmiş İkili Kodlu Ondalık Değişim Kodu (EBCDIC) karakterlerini destekler.
          textcapacity: |
             En fazla 3116 sayısal basamak veya 2335 alfa sayısal karakter veya 1556 ikili karakter.
          image: |
...
more_formats:
    ...
    content: |
        "Xlsb'ı diğer imza türleriyle de imzalayabilirsiniz. Lütfen aşağıdaki listeye bakın."
    format: 
