...
############################# Head ############################
head_title: "eSign Ott dokumen dengan QR QR Code dalam Java"
head_description: "Cipta QR Kod QR dan letakkan pada fail Ott menggunakan Java dengan sekeping pendek kod Java. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan QR tandatangan Kod QR untuk Ott dokumen dalam Java"
description: "eTandatangani dokumen dan kontrak Ott anda dengan Kod QR QR. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Ott dengan Qrcode dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Ott dengan tandatangan Qrcode dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Ott dengan Qrcode Demo Langsung"
    content: |
