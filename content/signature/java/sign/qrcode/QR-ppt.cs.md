...
############################# Head ############################
head_title: "Dokument eSign Ppt s QR QR kódem v Java"
head_description: "Vytvořte QR kód QR a vložte jej do souboru Ppt pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis QR QR kódu pro dokument Ppt v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Ppt pomocí QR kódu QR. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Ppt pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Ppt pomocí podpisů Qrcode.
        
        * Vytvořte instanci třídy Signature poskytující soubor Ppt, který se má podepisovat jako cesta nebo proud paměti
        * Instantujte třídu SignOptions a nastavte všechna požadovaná data.
        * Vyvolejte metodu Signature.Sign() předáním výstupního souboru Ppt nebo proudu paměti
...
demos:
    enable: true
    title: "Podepisování dokumentů Ppt pomocí živé ukázky Qrcode"
    content: |
       Podepište soubor Ppt pomocí různých podpisů právě teď na webu [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čeká.
...
more_formats:
    ...
    content: |
        "Můžete také podepsat Ppt pomocí jiných typů podpisů. Podívejte se prosím na níže uvedený seznam."
    format: 
