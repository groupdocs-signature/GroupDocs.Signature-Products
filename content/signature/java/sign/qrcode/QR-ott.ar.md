...
############################# Head ############################
head_title: "مستند eSign Ott مع رمز الاستجابة السريعة QR في Java"
head_description: "أنشئ رمز الاستجابة السريعة QR وضعه في ملف Ott باستخدام Java مع جزء قصير من كود Java. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء QR توقيع رمز الاستجابة السريعة لمستند Ott في Java"
