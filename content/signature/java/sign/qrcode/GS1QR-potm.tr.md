...
############################# Head ############################
head_title: "Java içinde G S1 Q R QR Kodu ile Potm belgesini eSign"
head_description: "G S1 Q R QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Potm dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Potm belgesi için G S1 Q R QR Kodu imzası oluşturun"
description: "Potm belgelerinizi ve sözleşmelerinizi G S1 Q R QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR Kodu, GS1 spesifikasyonlarına uyan bir QR Kodu çeşididir. Parti numarası, ürün kimliği ve miktar gibi genişletilmiş paketleme bilgilerini paylaşmak için özel olarak tasarlanmıştır.
          characterset: |
             Büyük ve küçük harfler ve özel karakterler $%*+-./: tümü doğru Uygulama Tanımlayıcıları ile
          textcapacity: |
             7089 sayısal karaktere kadar, 4296 alfasayısal karakter
          image: |
