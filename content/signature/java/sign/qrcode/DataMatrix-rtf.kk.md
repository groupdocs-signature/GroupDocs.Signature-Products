...
############################# Head ############################
head_title: "Java ішінде Data Matrix QR коды бар eSign Rtf құжаты"
head_description: "Data Matrix QR кодын жасаңыз және оны Java арқылы Java кодының қысқа бөлігімен Rtf файлына салыңыз. QR коды арқылы іскери құжаттар мен файлдарға электрондық қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "Java ішінде Rtf құжаты үшін Data Matrix QR код қолтаңбасын жасаңыз"
description: "Rtf құжаттарыңыз бен келісім-шарттарыңызға Data Matrix QR Code арқылы қол қойыңыз. QR Code қолтаңбасын тез және оңай жасаңыз."
