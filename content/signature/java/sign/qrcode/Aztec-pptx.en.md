...
head_description: "Create Aztec QR Code and put it on Pptx file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Pptx document in Java"
description: "eSign your Pptx documents and contracts with Aztec QR Code. Generate QR Code signature quickly and easily."
