...
############################# Head ############################
head_title: "Java में Aztec QR कोड के साथ eSign Webp दस्तावेज़"
head_description: "Aztec QR कोड बनाएं और Java कोड के एक छोटे टुकड़े के साथ Java का उपयोग करके इसे Webp फ़ाइल में डालें। QR कोड के साथ अपने व्यावसायिक दस्तावेज़ों और फ़ाइलों पर ई-हस्ताक्षर करने के लिए GroupDocs दस्तावेज़ हस्ताक्षर API का उपयोग करें।"

############################# Header ############################
title: "Java में Webp दस्तावेज़ के लिए Aztec QR कोड हस्ताक्षर जेनरेट करें"
description: "अपने Webp दस्तावेज़ों और अनुबंधों पर Aztec QR कोड के साथ ई-हस्ताक्षर करें। क्यूआर कोड हस्ताक्षर जल्दी और आसानी से उत्पन्न करें।"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            एज़्टेक कोड एक द्वि-आयामी (2-डी) सामान्य-उद्देश्य मैट्रिक्स सिम्बोलॉजी है जिसे अन्य 2-डी सिम्बोलॉजी की तुलना में उच्च सटीकता के लिए डिज़ाइन किया गया है। एक एज़्टेक कोड प्रतीक 3,832 अंकीय अंकों तक को एन्कोड कर सकता है; 3,067 वर्णमाला वर्ण; या 1,914 बाइट्स डेटा।
          characterset: |
             सभी 256 ASCII वर्ण।
          textcapacity: |
             अधिकतम 3,832 अंकीय अंक, या 3,067 वर्णमाला वर्ण, या 1,914 बाइट्स डेटा।
          image: |
