...
############################# Head ############################
head_title: "eSign Webp tài liệu với Data Matrix Mã QR trong Java"
head_description: "Tạo Mã QR Data Matrix và đặt nó vào tệp Webp bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR Data Matrix cho tài liệu Webp trong Java"
description: "eSign các tài liệu và hợp đồng Webp của bạn bằng Mã QR Data Matrix. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Webp bằng Qrcode trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Webp bằng chữ ký Qrcode một cách nhanh chóng và dễ dàng.
        
        * Tạo một phiên bản của lớp Chữ ký cung cấp tệp Webp phải ký dưới dạng đường dẫn hoặc luồng bộ nhớ
        * Khởi tạo lớp SignOptions và thiết lập tất cả dữ liệu được yêu cầu.
        * Gọi phương thức Signature.Sign () chuyển đầu ra tệp Webp hoặc luồng bộ nhớ
...
demos:
    enable: true
    title: "Ký tài liệu Webp bằng Qrcode Live Demo"
    content: |
       Ký tệp Webp bằng nhiều chữ ký ngay bây giờ bằng cách truy cập trang web [GroupDocs.Signature App] (https://products.groupdocs.app/signature/family). Bản demo trực tuyến miễn phí đang chờ bạn.
...
more_formats:
    ...
    content: |
        "Bạn cũng có thể ký Webp bằng các loại chữ ký khác. Vui lòng xem danh sách bên dưới."
    format: 
