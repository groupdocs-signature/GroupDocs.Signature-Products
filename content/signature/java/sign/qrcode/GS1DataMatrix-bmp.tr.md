...
############################# Head ############################
head_title: "Java içinde G S1 Data Matrix QR Kodu ile Bmp belgesini eSign"
head_description: "G S1 Data Matrix QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Bmp dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Bmp belgesi için G S1 Data Matrix QR Kodu imzası oluşturun"
description: "Bmp belgelerinizi ve sözleşmelerinizi G S1 Data Matrix QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
steps:
    enable: true
    title_left: "Java içinde Qrcode ile Bmp imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Bmp belgelerini Qrcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
        
        * Yol veya bellek akışı olarak imzalaması gereken Bmp dosyasını sağlayan bir Signature sınıfı örneği oluşturun
        * SignOptions sınıfını örnekleyin ve istenen tüm verileri ayarlayın.
        * Çıkış Bmp dosyasını veya bellek akışını geçen Signature.Sign() yöntemini çağırın
...
demos:
    enable: true
    title: "Bmp dokümanı Qrcode Canlı Demo ile imzalama"
    content: |
       Hemen şimdi [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web sitesini ziyaret ederek çeşitli imzalarla Bmp dosyasını imzalayın. Ücretsiz çevrimiçi demo sizi bekliyor.
...
more_formats:
    ...
    content: |
        "Bmp'ı diğer imza türleriyle de imzalayabilirsiniz. Lütfen aşağıdaki listeye bakın."
    format: 
