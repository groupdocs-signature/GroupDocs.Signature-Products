...
############################# Head ############################
head_title: "eSign documentul Ppsx cu codul QR Aztec în Java"
head_description: "Creați codul QR Aztec și puneți-l în fișierul Ppsx folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura Aztec cod QR pentru documentul Ppsx în Java"
description: "eSemnați documentele și contractele Ppsx cu codul QR Aztec. Generați semnătura codului QR rapid și ușor."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codul Aztec este o simbologie matricială bidimensională (2-D) de uz general, care este concepută pentru a avea o precizie mai mare decât alte simboluri 2-D. Un simbol de cod aztec poate codifica până la 3.832 de cifre numerice; 3.067 caractere alfabetice; sau 1.914 octeți de date.
          characterset: |
             Toate cele 256 de caractere ASCII.
          textcapacity: |
             Până la 3.832 de cifre numerice sau 3.067 de caractere alfabetice sau 1.914 octeți de date.
          image: |
