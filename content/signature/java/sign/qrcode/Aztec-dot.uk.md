...
############################# Head ############################
head_title: "eSign Dot документ із Aztec QR-кодом у Java"
head_description: "Створіть QR-код Aztec і помістіть його у файл Dot за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду Aztec для документа Dot у Java"
