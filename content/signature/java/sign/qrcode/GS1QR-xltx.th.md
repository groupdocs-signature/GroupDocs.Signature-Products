...
############################# Head ############################
head_title: "eSign Xltx เอกสารด้วย G S1 Q R QR Code ใน Java"
head_description: "สร้าง G S1 Q R QR Code และใส่ลงในไฟล์ Xltx โดยใช้ Java ด้วยโค้ดสั้นๆ Java ใช้ GroupDocs Document Signature API เพื่อลงนามในเอกสารทางธุรกิจและไฟล์ทางอิเล็กทรอนิกส์ด้วย QR Code"

############################# Header ############################
title: "สร้าง G S1 Q R ลายเซ็นรหัส QR สำหรับเอกสาร Xltx ใน Java"
description: "eSign Xltx เอกสารและสัญญาของคุณด้วยรหัส QR G S1 Q R สร้างลายเซ็น QR Code อย่างรวดเร็วและง่ายดาย"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR Code เป็นรหัส QR Code ที่สอดคล้องกับข้อกำหนดของ GS1 ได้รับการออกแบบมาโดยเฉพาะสำหรับการแชร์ข้อมูลบรรจุภัณฑ์เพิ่มเติม เช่น หมายเลขล็อต รหัสผลิตภัณฑ์ และปริมาณ
          characterset: |
             ตัวอักษรตัวพิมพ์ใหญ่และตัวพิมพ์เล็กและอักขระพิเศษ $%*+-./: ทั้งหมดมี Application Identifiers . ที่ถูกต้อง
          textcapacity: |
             อักขระที่เป็นตัวเลขสูงสุด 7089 ตัว อักขระที่เป็นตัวอักษรและตัวเลขคละกัน 4296 ตัว
          image: |
