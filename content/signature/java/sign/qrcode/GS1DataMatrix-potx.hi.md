...
############################# Head ############################
head_title: "Java में G S1 Data Matrix QR कोड के साथ eSign Potx दस्तावेज़"
head_description: "G S1 Data Matrix QR कोड बनाएं और Java कोड के एक छोटे टुकड़े के साथ Java का उपयोग करके इसे Potx फ़ाइल में डालें। QR कोड के साथ अपने व्यावसायिक दस्तावेज़ों और फ़ाइलों पर ई-हस्ताक्षर करने के लिए GroupDocs दस्तावेज़ हस्ताक्षर API का उपयोग करें।"

############################# Header ############################
title: "Java में Potx दस्तावेज़ के लिए G S1 Data Matrix QR कोड हस्ताक्षर जेनरेट करें"
description: "अपने Potx दस्तावेज़ों और अनुबंधों पर G S1 Data Matrix QR कोड के साथ ई-हस्ताक्षर करें। क्यूआर कोड हस्ताक्षर जल्दी और आसानी से उत्पन्न करें।"
...
about:
    enable: true
    title: "GroupDocs.Signature for Java QR कोड हस्ताक्षर API के बारे में"
    content: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) दस्तावेज़ों के लिए QR कोड हस्ताक्षर बनाने और उत्पन्न करने के लिए एक परिपक्व API है। उपयोगकर्ता इसे डाउनलोड करने या छवि के रूप में सोशल मीडिया पर साझा करने के लिए टेक्स्ट प्रदान करते हुए क्यूआर कोड हस्ताक्षर उत्पन्न कर सकते हैं। हस्ताक्षरित दस्तावेज़ को एपीआई या केवल मोबाइल कैमरे पर स्कैन किया जा सकता है! क्यूआर कोड हस्ताक्षर जोड़कर इलेक्ट्रॉनिक रूप से अपने व्यावसायिक अनुबंधों और आधिकारिक दस्तावेजों पर हस्ताक्षर करें और उसमें हेरफेर करें। किसी भी क्यूआर कोड हस्ताक्षर में हस्ताक्षरकर्ता की पहचान करने या दस्तावेज़ को अधिकृत करने के लिए अद्वितीय कस्टम जानकारी होगी। इसके अलावा, क्यूआर कोड सामग्री को प्रोग्रामेटिक रूप से व्यक्तिगत कुंजी के साथ एन्क्रिप्ट और डिक्रिप्ट किया जा सकता है। इससे सार्वजनिक दस्तावेज़ों के अंदर संवेदनशील डेटा साझा करने की कई क्षमताएँ खुलती हैं। हस्ताक्षर करने के बाद उपयोगकर्ता पीडीएफ, एमएस वर्ड दस्तावेजों, एमएस एक्सेल वर्कबुक, एमएस पावरपॉइंट प्रेजेंटेशन, एडोब फोटोशॉप फाइलों और विभिन्न छवि प्रारूपों के भीतर क्यूआर कोड को अपडेट, सत्यापित, हटा, पूर्वावलोकन या खोज सकता है। क्यूआर कोड को अतिरिक्त रूप से अनुकूलित किया जा सकता है।
    

############################# Steps ############################
steps:
    enable: true
    title_left: "Java में Qrcode के साथ Potx पर हस्ताक्षर करने के चरण"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) जल्दी और आसानी से Qrcode हस्ताक्षर के साथ Potx दस्तावेज़ों पर हस्ताक्षर करने की क्षमता प्रदान करता है।
        
        * सिग्नेचर क्लास का एक इंस्टेंस बनाएं जो Qrcode फाइल को पाथ या मेमोरी स्ट्रीम के रूप में साइन करने वाली फाइल प्रदान करता है
        * साइनऑप्शन क्लास को इंस्टेंट करें और सभी मांगे गए डेटा को सेट करें।
        * Signature.Sign() मेथड पासिंग आउटपुट Potx फाइल या मेमोरी स्ट्रीम को आमंत्रित करें
...
demos:
    enable: true
    title: "Qrcode लाइव डेमो के साथ Potx दस्तावेज़ों पर हस्ताक्षर करना"
    content: |
       [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) वेबसाइट पर जाकर अभी विभिन्न हस्ताक्षरों के साथ Potx फ़ाइल पर हस्ताक्षर करें। मुफ्त ऑनलाइन डेमो आपका इंतजार कर रहा है।
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 डेटा मैट्रिक्स डेटा मैट्रिक्स का एक प्रकार है जो GS1 विनिर्देशों के अनुरूप है। निम्नलिखित जानकारी को एन्कोड करने के लिए GS1 डेटामैट्रिक्स का उपयोग करें, लेकिन इन्हीं तक सीमित नहीं: AI(01) ग्लोबल ट्रेड आइटम नंबर (GTIN), AI(17) समाप्ति तिथि, AI(10) बैच नंबर, AI(21) सीरियल नंबर .
          characterset: |
             कैरेक्टर सेट: अपर और लोअर केस लेटर्स और स्पेशल कैरेक्टर $@%*+-./:=<>;&*_,'! सभी सही एप्लिकेशन पहचानकर्ताओं के साथ।
          textcapacity: |
             कोडटेक्स्ट क्षमता: अधिकतम 3116 अंकीय अंक, या 2335 अल्फ़ा न्यूमेरिक वर्ण।
          image: |
...
more_formats:
    enable: true
    title: "Java के लिए अन्य समर्थित Qrcode हस्ताक्षर"
    content: |
        "आप अन्य हस्ताक्षर प्रकारों के साथ Potx पर भी हस्ताक्षर कर सकते हैं। कृपया नीचे दी गई सूची देखें।"
    format: 
