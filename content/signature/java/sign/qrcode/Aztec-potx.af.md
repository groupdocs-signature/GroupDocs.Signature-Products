...
############################# Head ############################
head_title: "eSign Potx-dokument met Aztec QR-kode in Java"
head_description: "Skep Aztec QR-kode en plaas dit op Potx-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer Aztec QR-kode handtekening vir Potx dokument in Java"
description: "eTeken jou Potx dokumente en kontrakte met Aztec QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec-kode is 'n twee-dimensionele (2-D) algemene-doel matriks simboliek wat ontwerp is om hoër akkuraatheid te hê as ander 2-D simbolologieë. 'n Asteekse Kodesimbool kan tot 3 832 numeriese syfers enkodeer; 3 067 alfabetiese karakters; of 1 914 grepe data.
          characterset: |
             Al 256 ASCII karakters.
          textcapacity: |
             Tot 3 832 numeriese syfers, of 3 067 alfabetiese karakters, of 1 914 grepe data.
          image: |
