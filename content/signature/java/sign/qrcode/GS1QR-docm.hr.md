...
############################# Head ############################
head_title: "eSign Docm dokument s G S1 Q R QR kodom u Java"
head_description: "Napravite G S1 Q R QR kod i stavite ga u datoteku Docm koristeći Java s kratkim dijelom Java koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj G S1 Q R potpis QR koda za Docm dokument u Java"
description: "ePotpišite svoje Docm dokumente i ugovore s G S1 Q R QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR kod je varijanta QR koda koji je u skladu sa GS1 specifikacijama. Osmišljen je posebno za dijeljenje proširenih informacija o pakiranju, kao što su broj serije, ID proizvoda i količina.
          characterset: |
             Velika i mala slova i posebni znakovi $%*+-./: svi s ispravnim aplikacijskim identifikatorima
          textcapacity: |
             Do 7089 numeričkih znakova, 4296 alfanumeričkih znakova
          image: |
