...
############################# Head ############################
head_title: "eSign Pdf dokument Data Matrix QR-koodiga rakenduses Java"
head_description: "Looge QR-kood Data Matrix ja sisestage see faili Pdf, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Pdf QR-koodi allkiri Data Matrix"
description: "eAllkirjasta oma Pdf dokumendid ja lepingud QR-koodiga Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Pdf allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Pdf dokumente Qrcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Pdf allkirjastamine Qrcode reaalajas demoga"
    content: |
