...
############################# Head ############################
head_title: "eSign Ots документ із G S1 Data Matrix QR-кодом у Java"
head_description: "Створіть QR-код G S1 Data Matrix і помістіть його у файл Ots за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду G S1 Data Matrix для документа Ots у Java"
description: "Електронно підписуйте свої Ots документи та контракти за допомогою G S1 Data Matrix QR-коду. Згенеруйте підпис QR-коду швидко та легко."
...
steps:
    enable: true
    title_left: "Кроки для підпису Ots за допомогою Qrcode у Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) надає можливість швидко та легко підписувати документи Ots за допомогою підписів Qrcode.
        
        * Створіть екземпляр класу підпису, який надає файл Ots, який має бути підписаний як шлях або потік пам’яті
        * Створіть екземпляр класу SignOptions і встановіть усі потрібні дані.
        * Викликати метод Signature.Sign(), передаючи вихідний файл Ots або потік пам’яті
...
demos:
    enable: true
    title: "Підпис документів Ots за допомогою Qrcode Live Demo"
    content: |
       Підпишіть файл Ots різними підписами просто зараз, відвідавши веб-сайт [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Безкоштовна онлайн-демоверсія чекає на вас.
...
more_formats:
    ...
    content: |
        "Ви також можете підписати Ots іншими типами підписів. Перегляньте список нижче."
    format: 
