...
############################# Head ############################
head_title: "eSign Docx dokuments ar G S1 Q R QR kodu programmā Java"
head_description: "Izveidojiet G S1 Q R QR kodu un ievietojiet to failā Docx, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Q R QR koda parakstu dokumentam Docx programmā Java"
description: "eParakstiet savus Docx dokumentus un līgumus ar G S1 Q R QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Docx ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Docx dokumentus ar Qrcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Docx parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
