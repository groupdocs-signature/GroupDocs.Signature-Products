...
############################# Head ############################
head_title: "eSign Pdf документ із Data Matrix QR-кодом у Java"
head_description: "Створіть QR-код Data Matrix і помістіть його у файл Pdf за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду Data Matrix для документа Pdf у Java"
description: "Електронно підписуйте свої Pdf документи та контракти за допомогою Data Matrix QR-коду. Згенеруйте підпис QR-коду швидко та легко."
...
steps:
    enable: true
    title_left: "Кроки для підпису Pdf за допомогою Qrcode у Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) надає можливість швидко та легко підписувати документи Pdf за допомогою підписів Qrcode.
...
demos:
    enable: true
    title: "Підпис документів Pdf за допомогою Qrcode Live Demo"
    content: |
