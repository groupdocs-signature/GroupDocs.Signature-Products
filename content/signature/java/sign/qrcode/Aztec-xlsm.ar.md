...
############################# Head ############################
head_title: "مستند eSign Xlsm مع رمز الاستجابة السريعة Aztec في Java"
head_description: "أنشئ رمز الاستجابة السريعة Aztec وضعه في ملف Xlsm باستخدام Java مع جزء قصير من كود Java. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء Aztec توقيع رمز الاستجابة السريعة لمستند Xlsm في Java"
description: "قم بتوقيع Xlsm على المستندات والعقود باستخدام رمز الاستجابة السريعة Aztec. قم بإنشاء توقيع QR Code بسرعة وسهولة."
...
steps:
    enable: true
    title_left: "خطوات تسجيل Xlsm باستخدام Qrcode في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Xlsm بتوقيعات Qrcode بسرعة وسهولة.
        
        * قم بإنشاء مثيل لفئة التوقيع بتوفير ملف Xlsm من المفترض أن يتم توقيعه كمسار أو دفق ذاكرة
        * إنشاء فئة SignOptions وتعيين جميع البيانات المطلوبة.
        * استدعاء أسلوب Signature.Sign () تمرير ملف الإخراج Xlsm أو دفق الذاكرة
...
demos:
    enable: true
    title: "توقيع مستندات Xlsm باستخدام العرض التوضيحي المباشر Qrcode"
    content: |
       وقّع ملف Xlsm بتوقيعات مختلفة الآن من خلال زيارة موقع ويب [GroupDocs.Signature App] (https://products.groupdocs.app/signature/family). عرض تجريبي مجاني على الإنترنت في انتظارك.
...
more_formats:
    ...
    content: |
        "يمكنك أيضًا توقيع Xlsm بأنواع التوقيع الأخرى. يرجى الاطلاع على القائمة أدناه."
    format: 
