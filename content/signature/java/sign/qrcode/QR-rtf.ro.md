...
############################# Head ############################
head_title: "eSign documentul Rtf cu codul QR QR în Java"
head_description: "Creați codul QR QR și puneți-l în fișierul Rtf folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura QR cod QR pentru documentul Rtf în Java"
description: "eSemnați documentele și contractele Rtf cu codul QR QR. Generați semnătura codului QR rapid și ușor."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codul QR (abreviat de la Quick Response Code) este marca comercială pentru un tip de cod de bare matrice (sau cod de bare bidimensional). Este cel mai popular și utilizat tip de cod bidimensional. În practică, codurile QR conțin adesea date pentru un localizator, identificator sau tracker care indică un site web sau o aplicație.
          characterset: |
             Toate cele 256 de caractere ASCII + Kanji
          textcapacity: |
             Până la 7089 de caractere numerice, 4296 de caractere alfanumerice, 2953 de octeți (date binare) sau 1817 de caractere kanji.
          image: |
