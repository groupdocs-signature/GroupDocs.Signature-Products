...
head_description: "Create G S1 Data Matrix QR Code and put it on Ppt file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Data Matrix QR Code signature for Ppt document in Java"
description: "eSign your Ppt documents and contracts with G S1 Data Matrix QR Code. Generate QR Code signature quickly and easily."
