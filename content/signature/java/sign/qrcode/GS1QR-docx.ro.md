...
############################# Head ############################
head_title: "eSign documentul Docx cu codul QR G S1 Q R în Java"
head_description: "Creați codul QR G S1 Q R și puneți-l în fișierul Docx folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura G S1 Q R cod QR pentru documentul Docx în Java"
description: "eSemnați documentele și contractele Docx cu codul QR G S1 Q R. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Docx cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Docx cu semnături Qrcode rapid și ușor.
        
        * Creați o instanță a clasei Signature care furnizează fișierul Docx care ar trebui să se semneze ca cale sau flux de memorie
        * Instanțiați clasa SignOptions și setați toate datele solicitate.
        * Invocați metoda Signature.Sign() pasând fișierul de ieșire Docx sau fluxul de memorie
...
demos:
    enable: true
    title: "Semnează documente Docx cu Qrcode Live Demo"
    content: |
       Semnați fișierul Docx cu diferite semnături chiar acum, vizitând site-ul web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo online gratuită vă așteaptă.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Codul QR GS1 este o variantă a codului QR care respectă specificațiile GS1. A fost conceput special pentru a partaja informații extinse despre ambalare, cum ar fi numărul lotului, ID-ul produsului și cantitatea.
          characterset: |
             Litere mari și mici și caractere speciale $%*+-./: toate cu identificatorii de aplicație corecti
          textcapacity: |
             Până la 7089 de caractere numerice, 4296 de caractere alfanumerice
          image: |
...
more_formats:
    ...
    content: |
        "De asemenea, puteți semna Docx cu alte tipuri de semnături. Vă rugăm să vedeți lista de mai jos."
    format: 
