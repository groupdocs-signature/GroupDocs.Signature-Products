...
############################# Head ############################
head_title: "eSign Zip dokuments ar Aztec QR kodu programmā Java"
head_description: "Izveidojiet Aztec QR kodu un ievietojiet to failā Zip, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt Aztec QR koda parakstu dokumentam Zip programmā Java"
description: "eParakstiet savus Zip dokumentus un līgumus ar Aztec QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Zip ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Zip dokumentus ar Qrcode parakstiem.
        
        * Izveidojiet paraksta klases gadījumu, kas nodrošina Zip failu, kas paredzēts parakstīšanai kā ceļš vai atmiņas straume
        * Izveidojiet SignOptions klasi un iestatiet visus pieprasītos datus.
        * Izsauciet metodi Signature.Sign(), kas nodod izvades Zip failu vai atmiņas straumi
...
demos:
    enable: true
    title: "Dokumentu Zip parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
       Parakstiet Zip failu ar dažādiem parakstiem tūlīt, apmeklējot vietni [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Jūs gaida bezmaksas tiešsaistes demonstrācija.
...
more_formats:
    ...
    content: |
        "Varat arī parakstīt Zip ar citiem paraksta veidiem. Lūdzu, skatiet sarakstu zemāk."
    format: 
