...
############################# Head ############################
head_title: "eSign Webp დოკუმენტი Aztec QR კოდით Java-ში"
head_description: "შექმენით Aztec QR კოდი და განათავსეთ ის Webp ფაილზე Java-ის გამოყენებით Java კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით Aztec QR კოდის ხელმოწერა Webp დოკუმენტისთვის Java-ში"
description: "მოაწერეთ თქვენი Webp დოკუმენტები და კონტრაქტები Aztec QR კოდით. შექმენით QR კოდის ხელმოწერა სწრაფად და მარტივად."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            აცტეკების კოდი არის ორგანზომილებიანი (2-D) ზოგადი დანიშნულების მატრიცის სიმბოლიკა, რომელიც შექმნილია უფრო მაღალი სიზუსტით, ვიდრე სხვა 2-D სიმბოლიკა. აცტეკების კოდის სიმბოლოს შეუძლია დაშიფვროს 3832 რიცხვამდე; 3067 ანბანური სიმბოლო; ან 1914 ბაიტი მონაცემები.
          characterset: |
             ყველა 256 ASCII სიმბოლო.
          textcapacity: |
             3,832-მდე ციფრული ციფრი, ან 3,067 ანბანური სიმბოლო, ან 1,914 ბაიტი მონაცემები.
          image: |
