...
############################# Head ############################
head_title: "eSign Xls skjal með Aztec QR kóða í Java"
head_description: "Búðu til Aztec QR kóða og settu hann á Xls skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til Aztec QR kóða undirskrift fyrir Xls skjal í Java"
description: "eSignaðu Xls skjölin þín og samninga með Aztec QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Xls með Qrcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Xls skjöl með Qrcode undirskrift fljótt og auðveldlega.
        
        * Búðu til tilvik af Signature class sem gefur upp Xls skrá sem á að undirrita sem slóð eða minnisstraum
        * Upphafðu SignOptions flokkinn og stilltu öll umbeðin gögn.
        * Kallaðu á Signature.Sign() aðferðina sem sendir úttak Xls skrá eða minnisstraum
...
demos:
    enable: true
    title: "Undirritar Xls skjöl með Qrcode lifandi kynningu"
    content: |
       Skrifaðu undir Xls skrána með ýmsum undirskriftum núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna. Ókeypis kynning á netinu bíður þín.
...
more_formats:
    ...
    content: |
        "Þú getur líka skrifað undir Xls með öðrum undirskriftartegundum. Vinsamlegast skoðaðu listann hér að neðan."
    format: 
