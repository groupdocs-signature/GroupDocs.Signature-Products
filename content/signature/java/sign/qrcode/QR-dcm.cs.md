...
############################# Head ############################
head_title: "Dokument eSign Dcm s QR QR kódem v Java"
head_description: "Vytvořte QR kód QR a vložte jej do souboru Dcm pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis QR QR kódu pro dokument Dcm v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Dcm pomocí QR kódu QR. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Dcm pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Dcm pomocí podpisů Qrcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Dcm pomocí živé ukázky Qrcode"
    content: |
