...
############################# Head ############################
head_title: "eSign Tiff документ с QR-кодом Data Matrix в Java"
head_description: "Создайте QR-код Data Matrix и поместите его в файл Tiff, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода Data Matrix для документа Tiff в Java"
