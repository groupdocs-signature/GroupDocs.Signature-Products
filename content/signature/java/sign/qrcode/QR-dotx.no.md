...
############################# Head ############################
head_title: "eSign Dotx-dokument med QR QR-kode i Java"
head_description: "Lag QR QR-kode og legg den til Dotx-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Dotx-dokument i Java"
description: "eSigner Dotx-dokumentene og kontraktene dine med QR-koden QR. Generer QR-kodesignatur raskt og enkelt."
...
steps:
    enable: true
    title_left: "Trinn for å signere Dotx med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Dotx-dokumenter med Qrcode-signaturer raskt og enkelt.
        
        * Opprett en forekomst av signaturklassen som gir Dotx-fil som skal signere som bane eller minnestrøm
        * Instantiate SignOptions-klassen og angi alle etterspurte data.
        * Påkall Signature.Sign()-metoden ved å sende utdatafilen Dotx eller minnestrøm
...
demos:
    enable: true
    title: "Signering av Dotx dokumenter med Qrcode Live Demo"
    content: |
       Signer Dotx-filen med forskjellige signaturer akkurat nå ved å gå til nettstedet [GroupDocs.Signature-appen](https://products.groupdocs.app/signature/family). Gratis online demo venter på deg.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR Code (forkortet fra Quick Response Code) er varemerket for en type matrisestrekkode (eller todimensjonal strekkode). Det er den mest populære og mest brukte typen todimensjonal kode. I praksis inneholder QR-koder ofte data for en locator, identifikator eller tracker som peker til et nettsted eller en applikasjon.
          characterset: |
             Alle 256 ASCII-tegn + Kanji
          textcapacity: |
             Opptil 7089 numeriske tegn, 4296 alfanumeriske tegn, 2953 byte (binære data) eller 1817 Kanji-tegn.
          image: |
...
more_formats:
    ...
    content: |
        "Du kan også signere Dotx med andre signaturtyper. Vennligst se listen nedenfor."
    format: 
