...
############################# Head ############################
head_title: "eSign Png dokument s Data Matrix QR kodo v Java"
head_description: "Ustvarite QR kodo Data Matrix in jo postavite v datoteko Png z uporabo Java s kratkim delom kode Java. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari Data Matrix podpis kode QR za dokument Png v Java"
description: "e-Podpišite svoje Png dokumente in pogodbe s Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Png z Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Png s podpisi Qrcode.
