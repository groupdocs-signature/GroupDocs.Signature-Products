...
head_description: "Create QR QR Code and put it on Tiff file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."
