...
head_description: "Create G S1 Q R QR Code and put it on Ppsm file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Q R QR Code signature for Ppsm document in Java"
description: "eSign your Ppsm documents and contracts with G S1 Q R QR Code. Generate QR Code signature quickly and easily."
