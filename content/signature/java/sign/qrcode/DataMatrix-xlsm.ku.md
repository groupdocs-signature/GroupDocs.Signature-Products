...
############################# Head ############################
head_title: "Belgeya eSign Xlsm bi Data Matrix Koda QR di Java"
head_description: "Koda QR-a Data Matrix biafirînin û bi koda Java bi koda Java li pelê Xlsm bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di Java de ji bo belgeya Data Matrix îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên Xlsm bi koda QR-a Data Matrix îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Xlsm bi Qrcode di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Xlsm bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
