...
############################# Head ############################
head_title: "eSigniere Ppsm-Dokument mit Data Matrix-QR-Code in Java"
head_description: "Erstellen Sie einen Data Matrix-QR-Code und fügen Sie ihn mit Java und einem kurzen Stück Java-Code in eine Ppsm-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Data Matrix-QR-Code-Signatur für Ppsm-Dokument in Java"
description: "Unterzeichnen Sie Ihre Ppsm-Dokumente und -Verträge mit dem Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Ppsm mit Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Ppsm-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
        ...
        * Rufen Sie die Signature.Sign()-Methode auf und übergeben Sie die Ppsm-Ausgabedatei oder den Speicherstream
...
demos:
    enable: true
    title: "Signieren von Ppsm-Dokumenten mit Qrcode Live-Demo"
    content: |
