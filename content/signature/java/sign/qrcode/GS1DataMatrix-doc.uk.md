...
############################# Head ############################
head_title: "eSign Doc документ із G S1 Data Matrix QR-кодом у Java"
head_description: "Створіть QR-код G S1 Data Matrix і помістіть його у файл Doc за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду G S1 Data Matrix для документа Doc у Java"
description: "Електронно підписуйте свої Doc документи та контракти за допомогою G S1 Data Matrix QR-коду. Згенеруйте підпис QR-коду швидко та легко."
...
steps:
    enable: true
    title_left: "Кроки для підпису Doc за допомогою Qrcode у Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) надає можливість швидко та легко підписувати документи Doc за допомогою підписів Qrcode.
...
demos:
    enable: true
    title: "Підпис документів Doc за допомогою Qrcode Live Demo"
    content: |
