...
############################# Head ############################
head_title: "Java içinde QR QR Kodu ile Dotm belgesini eSign"
head_description: "QR QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Dotm dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Dotm belgesi için QR QR Kodu imzası oluşturun"
description: "Dotm belgelerinizi ve sözleşmelerinizi QR QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
