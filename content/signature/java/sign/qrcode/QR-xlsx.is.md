...
############################# Head ############################
head_title: "eSign Xlsx skjal með QR QR kóða í Java"
head_description: "Búðu til QR QR kóða og settu hann á Xlsx skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til QR QR kóða undirskrift fyrir Xlsx skjal í Java"
description: "eSignaðu Xlsx skjölin þín og samninga með QR QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR Code (skammstafað af Quick Response Code) er vörumerki fyrir tegund fylkisstrikamerkja (eða tvívídd strikamerki). Það er vinsælasta og mest notaða tegund tvívíddar kóða. Í reynd innihalda QR kóðar oft gögn fyrir staðsetningartæki, auðkenni eða rekja spor einhvers sem vísar á vefsíðu eða forrit.
          characterset: |
             Allir 256 ASCII stafir + Kanji
          textcapacity: |
             Allt að 7089 tölustafir, 4296 tölustafir, 2953 bæti (tvíundir gögn) eða 1817 Kanji stafir.
          image: |
