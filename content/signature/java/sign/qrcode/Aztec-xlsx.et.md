...
############################# Head ############################
head_title: "eSign Xlsx dokument Aztec QR-koodiga rakenduses Java"
head_description: "Looge QR-kood Aztec ja sisestage see faili Xlsx, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Xlsx QR-koodi allkiri Aztec"
description: "eAllkirjasta oma Xlsx dokumendid ja lepingud QR-koodiga Aztec. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Asteekide kood on kahemõõtmeline (2-D) üldotstarbeline maatrikssümbololoogia, mis on loodud suurema täpsusega kui teistel kahemõõtmelistel sümbolitel. Asteekide koodi sümbol võib kodeerida kuni 3832 numbrilist numbrit; 3067 tähemärki; või 1914 baiti andmeid.
          characterset: |
             Kõik 256 ASCII märki.
          textcapacity: |
             Kuni 3832 numbrilist numbrit või 3067 tähemärki või 1914 baiti andmeid.
          image: |
