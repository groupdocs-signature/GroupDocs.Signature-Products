...
############################# Head ############################
head_title: "Java ішінде G S1 Q R QR коды бар eSign Odt құжаты"
head_description: "G S1 Q R QR кодын жасаңыз және оны Java арқылы Java кодының қысқа бөлігімен Odt файлына салыңыз. QR коды арқылы іскери құжаттар мен файлдарға электрондық қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "Java ішінде Odt құжаты үшін G S1 Q R QR код қолтаңбасын жасаңыз"
description: "Odt құжаттарыңыз бен келісім-шарттарыңызға G S1 Q R QR Code арқылы қол қойыңыз. QR Code қолтаңбасын тез және оңай жасаңыз."
...
steps:
    enable: true
    title_left: "Java жүйесінде Qrcode арқылы Odt файлына қол қою қадамдары"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) Odt құжаттарға Qrcode қолтаңбаларымен жылдам және оңай қол қою мүмкіндігін береді.
...
demos:
    enable: true
    title: "Odt құжаттарға Qrcode тікелей көрсетілімі арқылы қол қою"
    content: |
