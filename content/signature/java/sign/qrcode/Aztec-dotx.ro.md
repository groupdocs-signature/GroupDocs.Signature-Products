...
############################# Head ############################
head_title: "eSign documentul Dotx cu codul QR Aztec în Java"
head_description: "Creați codul QR Aztec și puneți-l în fișierul Dotx folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura Aztec cod QR pentru documentul Dotx în Java"
description: "eSemnați documentele și contractele Dotx cu codul QR Aztec. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Dotx cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Dotx cu semnături Qrcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Dotx cu Qrcode Live Demo"
    content: |
