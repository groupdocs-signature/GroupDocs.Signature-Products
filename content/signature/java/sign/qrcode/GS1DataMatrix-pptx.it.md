...
############################# Head ############################
head_title: "eSign Pptx documento con G S1 Data Matrix codice QR in Java"
head_description: "Crea il codice QR G S1 Data Matrix e inseriscilo nel file Pptx utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera G S1 Data Matrix firma del codice QR per il documento Pptx in Java"
description: "Firma i tuoi documenti e contratti Pptx con il codice QR G S1 Data Matrix. Genera la firma del codice QR in modo rapido e semplice."
