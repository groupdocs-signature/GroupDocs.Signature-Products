...
############################# Head ############################
head_title: "eSign Xls ሰነድ በG S1 Data Matrix QR ኮድ በJava"
head_description: "G S1 Data Matrix QR ኮድ ይፍጠሩ እና በXls ፋይል ላይ Javaን በመጠቀም በአጭር የJava ኮድ ያስቀምጡት። የንግድ ሰነዶችዎን እና ፋይሎችዎን በQR ኮድ ኢ-ለመፈረም የGroupDocs ሰነድ ፊርማ ኤፒአይ ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለXls ሰነድ የG S1 Data Matrix QR ኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Xls ሰነዶች እና ኮንትራቶች በG S1 Data Matrix QR ኮድ ይፈርሙ። የQR ኮድ ፊርማ በፍጥነት እና በቀላሉ ይፍጠሩ።"
...
steps:
    enable: true
    title_left: "Xlsን በ{{Signturetype}} በJava ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የXls ሰነዶችን በQrcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
...
demos:
    enable: true
    title: "Xls ሰነዶችን በQrcode ቀጥታ ማሳያ በመፈረም ላይ"
    content: |
