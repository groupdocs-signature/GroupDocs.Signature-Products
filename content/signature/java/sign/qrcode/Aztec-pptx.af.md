...
############################# Head ############################
head_title: "eSign Pptx-dokument met Aztec QR-kode in Java"
head_description: "Skep Aztec QR-kode en plaas dit op Pptx-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer Aztec QR-kode handtekening vir Pptx dokument in Java"
description: "eTeken jou Pptx dokumente en kontrakte met Aztec QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Pptx met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Pptx dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
        
        * Skep 'n instansie van Signature-klas wat Pptx-lêer verskaf wat veronderstel is om te onderteken as pad of geheuestroom
        * Instansieer SignOptions-klas en stel alle verlangde data in.
        * Roep die Signature.Sign()-metode deur die uitvoer Pptx-lêer of geheuestroom deur te gee
...
demos:
    enable: true
    title: "Teken Pptx dokumente met Qrcode Regstreekse Demo"
    content: |
       Teken nou die Pptx-lêer met verskeie handtekeninge deur die [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webwerf te besoek. Gratis aanlyn demo wag vir jou.
...
more_formats:
    ...
    content: |
        "Jy kan ook Pptx met ander handtekeningtipes onderteken. Sien asseblief die lys hieronder."
    format: 
