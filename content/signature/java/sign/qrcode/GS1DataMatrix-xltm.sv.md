...
############################# Head ############################
head_title: "eSign Xltm-dokument med G S1 Data Matrix QR-kod i Java"
head_description: "Skapa G S1 Data Matrix QR-kod och lägg den i filen Xltm med Java med en kort bit av Java-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera G S1 Data Matrix QR-kodsignatur för Xltm dokument i Java"
description: "esignera dina Xltm-dokument och kontrakt med G S1 Data Matrix QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Xltm med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Xltm-dokument med Qrcode-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Xltm dokument med Qrcode Live Demo"
    content: |
