...
############################# Head ############################
head_title: "eSign Potx έγγραφο με Aztec QR Code στο Java"
head_description: "Δημιουργήστε Aztec κώδικα QR και τοποθετήστε τον σε αρχείο Potx χρησιμοποιώντας το Java με ένα σύντομο κομμάτι κώδικα Java. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε ηλεκτρονικά τα έγγραφα και τα αρχεία της επιχείρησής σας με QR Code."

############################# Header ############################
title: "Δημιουργήστε Aztec υπογραφή κώδικα QR για το έγγραφο Potx στο Java"
description: "Ηλεκτρονικά υπογράψτε τα έγγραφα και τις συμβάσεις του Potx με τον κωδικό QR Aztec. Δημιουργήστε υπογραφή κωδικού QR γρήγορα και εύκολα."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Ο Κώδικας των Αζτέκων είναι μια δισδιάστατη (2-Δ) συμβολολογία μήτρας γενικής χρήσης που έχει σχεδιαστεί για να έχει υψηλότερη ακρίβεια από άλλες δισδιάστατες συμβολολογίες. Ένα σύμβολο κώδικα των Αζτέκων μπορεί να κωδικοποιήσει έως και 3.832 αριθμητικά ψηφία. 3.067 αλφαβητικούς χαρακτήρες. ή 1.914 byte δεδομένων.
          characterset: |
             Και οι 256 χαρακτήρες ASCII.
          textcapacity: |
             Έως 3.832 αριθμητικά ψηφία ή 3.067 αλφαβητικούς χαρακτήρες ή 1.914 byte δεδομένων.
          image: |
