...
############################# Head ############################
head_title: "Documento de firma electrónica Ott con G S1 Data Matrix código QR en Java"
head_description: "Cree el código QR G S1 Data Matrix y colóquelo en el archivo Ott usando Java con un fragmento corto de código Java. Utilice la API de firma de documentos de GroupDocs para firmar electrónicamente sus documentos y archivos comerciales con código QR."

############################# Header ############################
title: "Genere la firma del código QR G S1 Data Matrix para el documento Ott en Java"
description: "Firme electrónicamente sus Ott documentos y contratos con G S1 Data Matrix QR Code. Genere la firma del código QR de forma rápida y sencilla."
