...
############################# Head ############################
head_title: "eSign Xlsb dokumentas su Aztec QR kodu Java"
head_description: "Sukurkite QR kodą Aztec ir įdėkite jį į failą Xlsb naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite Aztec QR kodo parašą Xlsb dokumentui Java"
description: "e. Pasirašykite Xlsb dokumentus ir sutartis naudodami Aztec QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Actekų kodas yra dvimatė (2-D) bendrosios paskirties matricos simbolika, sukurta taip, kad būtų tikslesnė nei kitos dvimatės simbolikos. Actekų kodo simbolis gali užkoduoti iki 3832 skaitmeninių skaitmenų; 3 067 abėcėlės simboliai; arba 1914 baitų duomenų.
          characterset: |
             Visi 256 ASCII simboliai.
          textcapacity: |
             Iki 3 832 skaitmeninių skaitmenų arba 3 067 abėcėlės simbolių arba 1 914 baitų duomenų.
          image: |
