...
############################# Head ############################
head_title: "eSign Wmf dokumen dengan QR QR Code dalam Java"
head_description: "Cipta QR Kod QR dan letakkan pada fail Wmf menggunakan Java dengan sekeping pendek kod Java. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan QR tandatangan Kod QR untuk Wmf dokumen dalam Java"
description: "eTandatangani dokumen dan kontrak Wmf anda dengan Kod QR QR. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Wmf dengan Qrcode dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Wmf dengan tandatangan Qrcode dengan cepat dan mudah.
        
        * Buat contoh kelas Tandatangan yang menyediakan fail Wmf yang sepatutnya ditandatangani sebagai laluan atau aliran memori
        * Segerakan kelas SignOptions dan tetapkan semua data yang diminta.
        * Guna kaedah Signature.Sign() yang menghantar fail keluaran Wmf atau aliran memori
...
demos:
    enable: true
    title: "Menandatangani dokumen Wmf dengan Qrcode Demo Langsung"
    content: |
       Tandatangani fail Wmf dengan pelbagai tandatangan sekarang dengan melawati tapak web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo dalam talian percuma menanti anda.
...
more_formats:
    ...
    content: |
        "Anda juga boleh menandatangani Wmf dengan jenis tandatangan lain. Sila lihat senarai di bawah."
    format: 
