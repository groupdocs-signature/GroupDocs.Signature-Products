...
############################# Head ############################
head_title: "eSign Xlsb დოკუმენტი Aztec QR კოდით Java-ში"
head_description: "შექმენით Aztec QR კოდი და განათავსეთ ის Xlsb ფაილზე Java-ის გამოყენებით Java კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით Aztec QR კოდის ხელმოწერა Xlsb დოკუმენტისთვის Java-ში"
...
steps:
    enable: true
    title_left: "Xlsb-ით ხელმოწერის ნაბიჯები Qrcode-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Xlsb დოკუმენტები Qrcode ხელმოწერებით სწრაფად და მარტივად.
