...
############################# Head ############################
head_title: "Belgeya eSign Ppsx bi G S1 Q R Koda QR di Java"
head_description: "Koda QR-a G S1 Q R biafirînin û bi koda Java bi koda Java li pelê Ppsx bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di Java de ji bo belgeya G S1 Q R îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên Ppsx bi koda QR-a G S1 Q R îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR Code guhertoyek QR Code ye ku li gorî taybetmendiyên GS1 tevdigere. Ew bi taybetî ji bo parvekirina agahdariya pakkirinê ya dirêjkirî, wekî jimareya pir, nasnameya hilberê, û hejmar hate çêkirin.
          characterset: |
             Tîpên mezin û piçûk û tîpên taybetî $%*+-./: hemî bi Nasnameyên Serlêdanê yên rast
          textcapacity: |
             Heya 7089 tîpên hejmarî, 4296 tîpên alfabetîk
          image: |
