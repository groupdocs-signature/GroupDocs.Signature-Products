...
############################# Head ############################
head_title: "eSign Pps tài liệu với G S1 Data Matrix Mã QR trong Java"
head_description: "Tạo Mã QR G S1 Data Matrix và đặt nó vào tệp Pps bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Data Matrix cho tài liệu Pps trong Java"
description: "eSign các tài liệu và hợp đồng Pps của bạn bằng Mã QR G S1 Data Matrix. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Pps bằng Qrcode trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Pps bằng chữ ký Qrcode một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Pps bằng Qrcode Live Demo"
    content: |
