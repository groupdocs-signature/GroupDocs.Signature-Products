...
############################# Head ############################
head_title: "eSign Doc документ із Aztec QR-кодом у Java"
head_description: "Створіть QR-код Aztec і помістіть його у файл Doc за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду Aztec для документа Doc у Java"
description: "Електронно підписуйте свої Doc документи та контракти за допомогою Aztec QR-коду. Згенеруйте підпис QR-коду швидко та легко."
