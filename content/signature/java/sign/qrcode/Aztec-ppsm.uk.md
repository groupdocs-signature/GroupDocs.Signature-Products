...
############################# Head ############################
head_title: "eSign Ppsm документ із Aztec QR-кодом у Java"
head_description: "Створіть QR-код Aztec і помістіть його у файл Ppsm за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду Aztec для документа Ppsm у Java"
description: "Електронно підписуйте свої Ppsm документи та контракти за допомогою Aztec QR-коду. Згенеруйте підпис QR-коду швидко та легко."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code — це двовимірна (2-D) матрична символіка загального призначення, розроблена для вищої точності, ніж інші двовимірні символіки. Символ ацтекського коду може кодувати до 3832 цифрових цифр; 3067 літер; або 1914 байт даних.
          characterset: |
             Усі 256 символів ASCII.
          textcapacity: |
             До 3832 цифрових цифр або 3067 буквених символів або 1914 байт даних.
          image: |
