...
############################# Head ############################
head_title: "Dokument eSign Odp s G S1 Q R QR kódem v Java"
head_description: "Vytvořte QR kód G S1 Q R a vložte jej do souboru Odp pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis G S1 Q R QR kódu pro dokument Odp v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Odp pomocí QR kódu G S1 Q R. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Odp pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Odp pomocí podpisů Qrcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Odp pomocí živé ukázky Qrcode"
    content: |
