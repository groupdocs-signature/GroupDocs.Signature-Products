...
############################# Head ############################
head_title: "eSign Ppsm dokument s Aztec QR kódom v Java"
head_description: "Vytvorte Aztec QR kód a vložte ho do súboru Ppsm pomocou Java s krátkym kódom Java. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte Aztec podpis QR kódu pre dokument Ppsm v Java"
description: "ePodpíšte svoje Ppsm dokumenty a zmluvy pomocou Aztec QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
