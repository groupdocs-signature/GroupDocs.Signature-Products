...
############################# Head ############################
head_title: "eSign Webp dokument Data Matrix QR-koodiga rakenduses Java"
head_description: "Looge QR-kood Data Matrix ja sisestage see faili Webp, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Webp QR-koodi allkiri Data Matrix"
description: "eAllkirjasta oma Webp dokumendid ja lepingud QR-koodiga Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Webp allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Webp dokumente Qrcode allkirjaga.
