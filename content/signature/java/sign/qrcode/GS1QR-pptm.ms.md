...
############################# Head ############################
head_title: "eSign Pptm dokumen dengan G S1 Q R QR Code dalam Java"
head_description: "Cipta G S1 Q R Kod QR dan letakkan pada fail Pptm menggunakan Java dengan sekeping pendek kod Java. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan G S1 Q R tandatangan Kod QR untuk Pptm dokumen dalam Java"
description: "eTandatangani dokumen dan kontrak Pptm anda dengan Kod QR G S1 Q R. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Kod QR GS1 ialah varian Kod QR yang mematuhi spesifikasi GS1. Ia direka khusus untuk berkongsi maklumat pembungkusan lanjutan, seperti nombor lot, ID produk dan kuantiti.
          characterset: |
             Huruf besar dan kecil serta aksara khas $%*+-./: semua dengan Pengecam Aplikasi yang betul
          textcapacity: |
             Sehingga 7089 aksara angka, 4296 aksara abjad angka
          image: |
