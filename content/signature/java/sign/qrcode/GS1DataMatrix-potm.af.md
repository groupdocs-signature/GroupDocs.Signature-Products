...
############################# Head ############################
head_title: "eSign Potm-dokument met G S1 Data Matrix QR-kode in Java"
head_description: "Skep G S1 Data Matrix QR-kode en plaas dit op Potm-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR-kode handtekening vir Potm dokument in Java"
description: "eTeken jou Potm dokumente en kontrakte met G S1 Data Matrix QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
demos:
    enable: true
    title: "Teken Potm dokumente met Qrcode Regstreekse Demo"
    content: |
       Teken nou die Potm-lêer met verskeie handtekeninge deur die [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webwerf te besoek. Gratis aanlyn demo wag vir jou.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix is ​​'n variant van Data Matrix wat aan GS1 spesifikasies voldoen. Gebruik GS1 DataMatrix om die inligting te enkodeer soos, maar nie beperk nie tot, die volgende: AI(01) Global Trade Item Number (GTIN), AI(17) Vervaldatum, AI(10) Batch Number, AI(21) Serienommer .
          characterset: |
             Karakterstel: hoof- en kleinletters en spesiale karakters $@%*+-./:=<>;&*_,'! almal met korrekte toepassingsidentifiseerders.
          textcapacity: |
             Kodtekskapasiteit: tot 3116 numeriese syfers, of 2335 alfanumeriese karakters.
          image: |
...
more_formats:
    ...
    content: |
        "Jy kan ook Potm met ander handtekeningtipes onderteken. Sien asseblief die lys hieronder."
    format: 
