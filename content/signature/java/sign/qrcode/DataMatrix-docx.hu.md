...
############################# Head ############################
head_title: "eSign Docx dokumentum Data Matrix QR-kóddal a Java nyelven"
head_description: "Hozzon létre Data Matrix QR-kódot, és helyezze el a Docx fájlba a Java használatával egy rövid Java kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon Data Matrix QR-kód aláírást a Docx dokumentumhoz a Java programban"
description: "eAláírja Docx dokumentumait és szerződéseit Data Matrix QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
...
steps:
    enable: true
    title_left: "A Docx aláírásának lépései a Qrcode segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Docx dokumentumok gyors és egyszerű aláírását Qrcode aláírással.
