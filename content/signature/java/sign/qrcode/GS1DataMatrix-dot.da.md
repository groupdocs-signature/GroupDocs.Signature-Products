...
head_description: "Opret G S1 Data Matrix QR-kode og læg den i Dot-filen ved hjælp af Java med et kort stykke Java-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."
...
steps:
    enable: true
    title_left: "Trin til at signere Dot med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Dot dokumenter med Qrcode signaturer hurtigt og nemt.
