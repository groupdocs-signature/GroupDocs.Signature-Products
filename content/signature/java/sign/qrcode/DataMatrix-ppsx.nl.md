...
############################# Head ############################
head_title: "eSign Ppsx document met Data Matrix QR-code in Java"
head_description: "Maak een Data Matrix QR-code en plaats deze in het Ppsx-bestand met behulp van Java met een kort stukje Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Data Matrix QR Code handtekening voor Ppsx document in Java"
description: "Onderteken uw Ppsx documenten en contracten met Data Matrix QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Ppsx te ondertekenen met Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Ppsx documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
        ...
        * Roep de methode Signature.Sign() op en geef uitvoer Ppsx-bestand of geheugenstroom
...
demos:
    enable: true
    title: "Ppsx documenten ondertekenen met Qrcode Live Demo"
    content: |
