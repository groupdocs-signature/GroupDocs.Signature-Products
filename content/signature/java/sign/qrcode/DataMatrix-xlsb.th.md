...
############################# Head ############################
head_title: "eSign Xlsb เอกสารด้วย Data Matrix QR Code ใน Java"
head_description: "สร้าง Data Matrix QR Code และใส่ลงในไฟล์ Xlsb โดยใช้ Java ด้วยโค้ดสั้นๆ Java ใช้ GroupDocs Document Signature API เพื่อลงนามในเอกสารทางธุรกิจและไฟล์ทางอิเล็กทรอนิกส์ด้วย QR Code"

############################# Header ############################
title: "สร้าง Data Matrix ลายเซ็นรหัส QR สำหรับเอกสาร Xlsb ใน Java"
description: "eSign Xlsb เอกสารและสัญญาของคุณด้วยรหัส QR Data Matrix สร้างลายเซ็น QR Code อย่างรวดเร็วและง่ายดาย"
...
demos:
    enable: true
    title: "การลงนามเอกสาร Xlsb ด้วย Qrcode Live Demo"
    content: |
       ลงชื่อไฟล์ Xlsb ด้วยลายเซ็นต่างๆ ทันทีโดยไปที่เว็บไซต์ [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) สาธิตออนไลน์ฟรีรอคุณอยู่
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix คือโค้ดสองมิติที่ประกอบด้วย 'เซลล์' สีดำและสีขาว หรือจุดต่างๆ ที่จัดเรียงในรูปแบบสี่เหลี่ยมจัตุรัสหรือสี่เหลี่ยม หรือที่เรียกว่าเมทริกซ์ ข้อมูลที่จะเข้ารหัสอาจเป็นข้อมูลข้อความหรือตัวเลข
          characterset: |
             รองรับอักขระ ASCII ทั้งหมด 256 ตัว, อักขระ ISO ทั้งหมด และอักขระ Extended Binary Coded Decimal Interchange Code (EBCDIC) ทั้งหมด
          textcapacity: |
             ตัวเลขสูงสุด 3116 หลัก หรืออักขระที่เป็นตัวอักษรและตัวเลขคละกัน 2335 ตัว หรืออักขระไบนารี 1556 ตัว
          image: |
...
more_formats:
    enable: true
    title: "ลายเซ็น Qrcode อื่นๆ ที่รองรับสำหรับ Java"
    content: |
        "คุณยังสามารถเซ็นชื่อ Xlsb ด้วยลายเซ็นประเภทอื่นๆ โปรดดูรายการด้านล่าง"
    format: 
