...
############################# Head ############################
head_title: "eSign Tar document with G S1 Data Matrix QR Code in Java"
head_description: "Create G S1 Data Matrix QR Code and put it on Tar file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Data Matrix QR Code signature for Tar document in Java"
description: "eSign your Tar documents and contracts with G S1 Data Matrix QR Code. Generate QR Code signature quickly and easily."
...
steps:
    enable: true
    title_left: "Steps to sign Tar with Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Tar documents with Qrcode signatures quickly and easily.
...
demos:
    enable: true
    title: "Signing Tar documents with Qrcode Live Demo"
    content: |
