...
############################# Head ############################
head_title: "eSign Doc έγγραφο με G S1 Data Matrix QR Code στο Java"
head_description: "Δημιουργήστε G S1 Data Matrix κώδικα QR και τοποθετήστε τον σε αρχείο Doc χρησιμοποιώντας το Java με ένα σύντομο κομμάτι κώδικα Java. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε ηλεκτρονικά τα έγγραφα και τα αρχεία της επιχείρησής σας με QR Code."

############################# Header ############################
title: "Δημιουργήστε G S1 Data Matrix υπογραφή κώδικα QR για το έγγραφο Doc στο Java"
description: "Ηλεκτρονικά υπογράψτε τα έγγραφα και τις συμβάσεις του Doc με τον κωδικό QR G S1 Data Matrix. Δημιουργήστε υπογραφή κωδικού QR γρήγορα και εύκολα."
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Doc με Qrcode στο Java"
    content_left: |
        Το [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) παρέχει τη δυνατότητα υπογραφής εγγράφων Doc με υπογραφές Qrcode γρήγορα και εύκολα.
        
        * Δημιουργήστε ένα στιγμιότυπο κλάσης υπογραφής που παρέχει αρχείο Doc που υποτίθεται ότι υπογράφεται ως διαδρομή ή ροή μνήμης
        * Δημιουργήστε την κλάση SignOptions και ορίστε όλα τα απαιτούμενα δεδομένα.
        * Επικαλέστε τη μέθοδο Signature.Sign() μεταβιβάζοντας την έξοδο Doc αρχείο ή ροή μνήμης
...
demos:
    enable: true
    title: "Υπογραφή εγγράφων Doc με Qrcode Ζωντανή επίδειξη"
    content: |
       Υπογράψτε το αρχείο Doc με διάφορες υπογραφές αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Δωρεάν online demo σας περιμένει.
...
more_formats:
    ...
    content: |
        "Μπορείτε επίσης να υπογράψετε το Doc με άλλους τύπους υπογραφής. Δείτε την παρακάτω λίστα."
    format: 
