...
############################# Head ############################
head_title: "Dokument eSign Ppsx s QR QR kódem v Java"
head_description: "Vytvořte QR kód QR a vložte jej do souboru Ppsx pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis QR QR kódu pro dokument Ppsx v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Ppsx pomocí QR kódu QR. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Ppsx pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Ppsx pomocí podpisů Qrcode.
        
        * Vytvořte instanci třídy Signature poskytující soubor Ppsx, který se má podepisovat jako cesta nebo proud paměti
        * Instantujte třídu SignOptions a nastavte všechna požadovaná data.
        * Vyvolejte metodu Signature.Sign() předáním výstupního souboru Ppsx nebo proudu paměti
...
demos:
    enable: true
    title: "Podepisování dokumentů Ppsx pomocí živé ukázky Qrcode"
    content: |
       Podepište soubor Ppsx pomocí různých podpisů právě teď na webu [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čeká.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR Code (zkráceně Quick Response Code) je ochranná známka pro typ maticového čárového kódu (nebo dvourozměrného čárového kódu). Jedná se o nejoblíbenější a nejrozšířenější typ dvourozměrného kódu. V praxi QR kódy často obsahují data pro lokátor, identifikátor nebo tracker, který ukazuje na webovou stránku nebo aplikaci.
          characterset: |
             Všech 256 znaků ASCII + Kanji
          textcapacity: |
             Až 7089 číselných znaků, 4296 alfanumerických znaků, 2953 bajtů (binární data) nebo 1817 znaků Kanji.
          image: |
...
more_formats:
    ...
    content: |
        "Můžete také podepsat Ppsx pomocí jiných typů podpisů. Podívejte se prosím na níže uvedený seznam."
    format: 
