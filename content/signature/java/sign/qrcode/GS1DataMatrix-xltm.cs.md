...
############################# Head ############################
head_title: "Dokument eSign Xltm s G S1 Data Matrix QR kódem v Java"
head_description: "Vytvořte QR kód G S1 Data Matrix a vložte jej do souboru Xltm pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis G S1 Data Matrix QR kódu pro dokument Xltm v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Xltm pomocí QR kódu G S1 Data Matrix. Vygenerujte podpis QR kódu rychle a snadno."
...
demos:
    enable: true
    title: "Podepisování dokumentů Xltm pomocí živé ukázky Qrcode"
    content: |
       Podepište soubor Xltm pomocí různých podpisů právě teď na webu [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čeká.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix je varianta Data Matrix, která odpovídá specifikacím GS1. Použijte GS1 DataMatrix ke kódování informací, jako jsou mimo jiné následující: AI(01) číslo globální obchodní položky (GTIN), AI(17) datum vypršení platnosti, AI(10) číslo šarže, AI(21) sériové číslo .
          characterset: |
             Znaková sada: velká a malá písmena a speciální znaky $@%*+-./:=<>;&*_,'! vše se správnými identifikátory aplikací.
          textcapacity: |
             Kapacita kódového textu: až 3116 číselných číslic nebo 2335 alfanumerických znaků.
          image: |
...
more_formats:
    enable: true
    title: "Další podporované podpisy Qrcode pro Java"
    content: |
        "Můžete také podepsat Xltm pomocí jiných typů podpisů. Podívejte se prosím na níže uvedený seznam."
    format: 
