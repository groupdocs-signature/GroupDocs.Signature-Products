...
############################# Head ############################
head_title: "eSign Tar-dokument met G S1 Q R QR-kode in Java"
head_description: "Skep G S1 Q R QR-kode en plaas dit op Tar-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer G S1 Q R QR-kode handtekening vir Tar dokument in Java"
description: "eTeken jou Tar dokumente en kontrakte met G S1 Q R QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Tar met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Tar dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
