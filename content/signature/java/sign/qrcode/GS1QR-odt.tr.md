...
############################# Head ############################
head_title: "Java içinde G S1 Q R QR Kodu ile Odt belgesini eSign"
head_description: "G S1 Q R QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Odt dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Odt belgesi için G S1 Q R QR Kodu imzası oluşturun"
description: "Odt belgelerinizi ve sözleşmelerinizi G S1 Q R QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
steps:
    enable: true
    title_left: "Java içinde Qrcode ile Odt imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Odt belgelerini Qrcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
