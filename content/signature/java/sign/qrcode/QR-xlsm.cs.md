...
############################# Head ############################
head_title: "Dokument eSign Xlsm s QR QR kódem v Java"
head_description: "Vytvořte QR kód QR a vložte jej do souboru Xlsm pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis QR QR kódu pro dokument Xlsm v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Xlsm pomocí QR kódu QR. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsm pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Xlsm pomocí podpisů Qrcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Xlsm pomocí živé ukázky Qrcode"
    content: |
