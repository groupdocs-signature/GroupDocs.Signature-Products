...
############################# Head ############################
head_title: "eSign Docm dokuments ar Aztec QR kodu programmā Java"
head_description: "Izveidojiet Aztec QR kodu un ievietojiet to failā Docm, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt Aztec QR koda parakstu dokumentam Docm programmā Java"
description: "eParakstiet savus Docm dokumentus un līgumus ar Aztec QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Acteku kods ir divdimensiju (2-D) vispārējas nozīmes matricas simbolika, kas ir izstrādāta tā, lai tai būtu augstāka precizitāte nekā citām 2-D simboliem. Acteku koda simbols var iekodēt līdz 3832 ciparu cipariem; 3067 alfabēta rakstzīmes; vai 1914 baiti datu.
          characterset: |
             Visas 256 ASCII rakstzīmes.
          textcapacity: |
             Līdz 3832 ciparu cipariem vai 3067 alfabēta rakstzīmēm vai 1914 datu baitiem.
          image: |
