...
############################# Head ############################
head_title: "eSign Docm документ із Data Matrix QR-кодом у Java"
head_description: "Створіть QR-код Data Matrix і помістіть його у файл Docm за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду Data Matrix для документа Docm у Java"
