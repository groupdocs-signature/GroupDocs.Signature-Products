...
############################# Head ############################
head_title: "eSign Xltx document met G S1 Q R QR-code in Java"
head_description: "Maak een G S1 Q R QR-code en plaats deze in het Xltx-bestand met behulp van Java met een kort stukje Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Q R QR Code handtekening voor Xltx document in Java"
description: "Onderteken uw Xltx documenten en contracten met G S1 Q R QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR-code is een variant van QR-code die voldoet aan de GS1-specificaties. Het is speciaal ontworpen voor het delen van uitgebreide verpakkingsinformatie, zoals lotnummer, product-ID en hoeveelheid.
          characterset: |
             Hoofdletters en kleine letters en speciale tekens $%*+-./: allemaal met de juiste applicatie-ID's
          textcapacity: |
             Tot 7089 numerieke tekens, 4296 alfanumerieke tekens
          image: |
