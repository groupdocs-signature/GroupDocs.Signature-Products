...
############################# Head ############################
head_title: "Documento de firma electrónica Png con QR código QR en Java"
head_description: "Cree el código QR QR y colóquelo en el archivo Png usando Java con un fragmento corto de código Java. Utilice la API de firma de documentos de GroupDocs para firmar electrónicamente sus documentos y archivos comerciales con código QR."

############################# Header ############################
title: "Genere la firma del código QR QR para el documento Png en Java"
description: "Firme electrónicamente sus Png documentos y contratos con QR QR Code. Genere la firma del código QR de forma rápida y sencilla."
...
steps:
    enable: true
    title_left: "Pasos para firmar Png con Qrcode en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Png con Qrcode firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Png documentos con Qrcode Live Demo"
    content: |
