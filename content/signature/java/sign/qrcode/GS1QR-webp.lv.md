...
############################# Head ############################
head_title: "eSign Webp dokuments ar G S1 Q R QR kodu programmā Java"
head_description: "Izveidojiet G S1 Q R QR kodu un ievietojiet to failā Webp, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Q R QR koda parakstu dokumentam Webp programmā Java"
description: "eParakstiet savus Webp dokumentus un līgumus ar G S1 Q R QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR kods ir QR koda variants, kas atbilst GS1 specifikācijām. Tas tika īpaši izstrādāts, lai kopīgotu paplašinātu informāciju par iepakojumu, piemēram, partijas numuru, produkta ID un daudzumu.
          characterset: |
             Lielie un mazie burti un īpašās rakstzīmes $%*+-./: viss ar pareiziem lietojumprogrammu identifikatoriem
          textcapacity: |
             Līdz 7089 ciparu rakstzīmēm, 4296 burtciparu rakstzīmēm
          image: |
