...
############################# Head ############################
head_title: "eSign Xlsm dokumentas su QR QR kodu Java"
head_description: "Sukurkite QR kodą QR ir įdėkite jį į failą Xlsm naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite QR QR kodo parašą Xlsm dokumentui Java"
description: "e. Pasirašykite Xlsm dokumentus ir sutartis naudodami QR QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Xlsm naudojant Qrcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Xlsm dokumentus su Qrcode parašais.
        
        * Sukurkite parašo klasės egzempliorių, pateikiantį Xlsm failą, kuris turėtų būti pasirašytas kaip kelias arba atminties srautas
        * Sukurkite SignOptions klasę ir nustatykite visus reikalingus duomenis.
        * Iškvieskite Signature.Sign() metodą, perduodantį išvesties Xlsm failą arba atminties srautą
...
demos:
    enable: true
    title: "Dokumentų Xlsm pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
       Pasirašykite Xlsm failą įvairiais parašais dabar apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje. Jūsų laukia nemokama internetinė demonstracinė versija.
...
more_formats:
    ...
    content: |
        "Taip pat galite pasirašyti Xlsm naudodami kitų tipų parašus. Žiūrėkite žemiau esantį sąrašą."
    format: 
