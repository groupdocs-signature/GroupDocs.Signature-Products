...
############################# Head ############################
head_title: "eSign Pptm-dokument med G S1 Q R QR-kode i Java"
head_description: "Lag G S1 Q R QR-kode og legg den til Pptm-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer G S1 Q R QR-kodesignatur for Pptm-dokument i Java"
description: "eSigner Pptm-dokumentene og kontraktene dine med QR-koden G S1 Q R. Generer QR-kodesignatur raskt og enkelt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR-kode er en variant av QR-kode som samsvarer med GS1-spesifikasjonene. Den ble designet spesielt for å dele utvidet emballasjeinformasjon, for eksempel partinummer, produkt-ID og mengde.
          characterset: |
             Store og små bokstaver og spesialtegn $%*+-./: alle med korrekte applikasjonsidentifikatorer
          textcapacity: |
             Opptil 7089 numeriske tegn, 4296 alfanumeriske tegn
          image: |
