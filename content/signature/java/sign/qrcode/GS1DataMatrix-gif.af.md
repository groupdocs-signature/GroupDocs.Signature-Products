...
############################# Head ############################
head_title: "eSign Gif-dokument met G S1 Data Matrix QR-kode in Java"
head_description: "Skep G S1 Data Matrix QR-kode en plaas dit op Gif-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR-kode handtekening vir Gif dokument in Java"
