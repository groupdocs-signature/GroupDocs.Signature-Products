...
############################# Head ############################
head_title: "eSign Odp tài liệu với G S1 Data Matrix Mã QR trong Java"
head_description: "Tạo Mã QR G S1 Data Matrix và đặt nó vào tệp Odp bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Data Matrix cho tài liệu Odp trong Java"
description: "eSign các tài liệu và hợp đồng Odp của bạn bằng Mã QR G S1 Data Matrix. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
