...
############################# Head ############################
head_title: "eSign Pptx dokument QR QR-koodiga rakenduses Java"
head_description: "Looge QR-kood QR ja sisestage see faili Pptx, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Pptx QR-koodi allkiri QR"
description: "eAllkirjasta oma Pptx dokumendid ja lepingud QR-koodiga QR. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Pptx allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Pptx dokumente Qrcode allkirjaga.
