...
############################# Head ############################
head_title: "eSign Potm documento com G S1 Q R QR Code em Java"
head_description: "Crie G S1 Q R QR Code e coloque-o no arquivo Potm usando Java com um pequeno pedaço de código Java. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere G S1 Q R assinatura de QR Code para Potm documento em Java"
description: "Assine seus documentos e contratos Potm com G S1 Q R QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Potm com Qrcode em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Potm com assinaturas Qrcode de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Potm documentos com Qrcode Demonstração ao vivo"
    content: |
