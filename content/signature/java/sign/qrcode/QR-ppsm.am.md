...
############################# Head ############################
head_title: "eSign Ppsm ሰነድ በQR QR ኮድ በJava"
head_description: "QR QR ኮድ ይፍጠሩ እና በPpsm ፋይል ላይ Javaን በመጠቀም በአጭር የJava ኮድ ያስቀምጡት። የንግድ ሰነዶችዎን እና ፋይሎችዎን በQR ኮድ ኢ-ለመፈረም የGroupDocs ሰነድ ፊርማ ኤፒአይ ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለPpsm ሰነድ የQR QR ኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Ppsm ሰነዶች እና ኮንትራቶች በQR QR ኮድ ይፈርሙ። የQR ኮድ ፊርማ በፍጥነት እና በቀላሉ ይፍጠሩ።"
...
steps:
    enable: true
    title_left: "Ppsmን በ{{Signturetype}} በJava ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የPpsm ሰነዶችን በQrcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
