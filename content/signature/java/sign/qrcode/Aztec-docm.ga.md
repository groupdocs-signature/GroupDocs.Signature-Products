...
############################# Head ############################
head_title: "eSign Docm doiciméad le Aztec Cód QR in Java"
head_description: "Cruthaigh Aztec Cód QR agus cuir ar chomhad Docm é ag úsáid Java le píosa gairid de chód Java. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Aztec don doiciméad Docm in Java"
description: "eSínigh do dhoiciméid agus conarthaí Docm le Aztec Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Céimeanna chun Docm a shíniú le Qrcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Docm a shíniú le sínithe Qrcode go tapa agus go héasca.
