...
############################# Head ############################
head_title: "eSign Tar dokument s G S1 Data Matrix QR kodo v Java"
head_description: "Ustvarite QR kodo G S1 Data Matrix in jo postavite v datoteko Tar z uporabo Java s kratkim delom kode Java. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari G S1 Data Matrix podpis kode QR za dokument Tar v Java"
description: "e-Podpišite svoje Tar dokumente in pogodbe s G S1 Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Tar z Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Tar s podpisi Qrcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Tar z Qrcode Live Demo"
    content: |
