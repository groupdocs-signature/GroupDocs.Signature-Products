...
############################# Head ############################
head_title: "eSign Docx dokument G S1 Data Matrix QR-koodiga rakenduses Java"
head_description: "Looge QR-kood G S1 Data Matrix ja sisestage see faili Docx, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Docx QR-koodi allkiri G S1 Data Matrix"
description: "eAllkirjasta oma Docx dokumendid ja lepingud QR-koodiga G S1 Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Docx allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Docx dokumente Qrcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Docx allkirjastamine Qrcode reaalajas demoga"
    content: |
