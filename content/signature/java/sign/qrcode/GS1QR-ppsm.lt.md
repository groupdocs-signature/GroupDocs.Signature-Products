...
############################# Head ############################
head_title: "eSign Ppsm dokumentas su G S1 Q R QR kodu Java"
head_description: "Sukurkite QR kodą G S1 Q R ir įdėkite jį į failą Ppsm naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Q R QR kodo parašą Ppsm dokumentui Java"
description: "e. Pasirašykite Ppsm dokumentus ir sutartis naudodami G S1 Q R QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR kodas yra QR kodo variantas, atitinkantis GS1 specifikacijas. Jis buvo specialiai sukurtas dalytis išplėstine pakuotės informacija, tokia kaip partijos numeris, produkto ID ir kiekis.
          characterset: |
             Didžiosios ir mažosios raidės ir specialieji simboliai $%*+-./: visi su teisingais programos identifikatoriais
          textcapacity: |
             Iki 7089 skaitmeninių simbolių, 4296 raidinių ir skaitinių simbolių
          image: |
