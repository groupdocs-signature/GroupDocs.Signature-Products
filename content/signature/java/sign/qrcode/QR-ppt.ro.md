...
############################# Head ############################
head_title: "eSign documentul Ppt cu codul QR QR în Java"
head_description: "Creați codul QR QR și puneți-l în fișierul Ppt folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura QR cod QR pentru documentul Ppt în Java"
description: "eSemnați documentele și contractele Ppt cu codul QR QR. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Ppt cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Ppt cu semnături Qrcode rapid și ușor.
        
        * Creați o instanță a clasei Signature care furnizează fișierul Ppt care ar trebui să se semneze ca cale sau flux de memorie
        * Instanțiați clasa SignOptions și setați toate datele solicitate.
        * Invocați metoda Signature.Sign() pasând fișierul de ieșire Ppt sau fluxul de memorie
...
demos:
    enable: true
    title: "Semnează documente Ppt cu Qrcode Live Demo"
    content: |
       Semnați fișierul Ppt cu diferite semnături chiar acum, vizitând site-ul web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo online gratuită vă așteaptă.
...
more_formats:
    ...
    content: |
        "De asemenea, puteți semna Ppt cu alte tipuri de semnături. Vă rugăm să vedeți lista de mai jos."
    format: 
