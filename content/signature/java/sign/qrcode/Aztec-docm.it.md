...
############################# Head ############################
head_title: "eSign Docm documento con Aztec codice QR in Java"
head_description: "Crea il codice QR Aztec e inseriscilo nel file Docm utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Aztec firma del codice QR per il documento Docm in Java"
description: "Firma i tuoi documenti e contratti Docm con il codice QR Aztec. Genera la firma del codice QR in modo rapido e semplice."
