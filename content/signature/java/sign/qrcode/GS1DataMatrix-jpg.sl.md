...
############################# Head ############################
head_title: "eSign Jpg dokument s G S1 Data Matrix QR kodo v Java"
head_description: "Ustvarite QR kodo G S1 Data Matrix in jo postavite v datoteko Jpg z uporabo Java s kratkim delom kode Java. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari G S1 Data Matrix podpis kode QR za dokument Jpg v Java"
description: "e-Podpišite svoje Jpg dokumente in pogodbe s G S1 Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Jpg z Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Jpg s podpisi Qrcode.
        
        * Ustvarite primerek razreda podpisa, ki zagotavlja datoteko Jpg, ki naj bi se podpisala kot pot ali pomnilniški tok
        * Instanciirajte razred SignOptions in nastavite vse zahtevane podatke.
        * Prikličite metodo Signature.Sign(), ki posreduje izhodno datoteko Jpg ali pomnilniški tok
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Jpg z Qrcode Live Demo"
    content: |
       Takoj zdaj podpišite datoteko Jpg z različnimi podpisi, tako da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Brezplačna spletna predstavitev čaka na vas.
...
more_formats:
    ...
    content: |
        "Jpg lahko podpišete tudi z drugimi vrstami podpisov. Oglejte si spodnji seznam."
    format: 
