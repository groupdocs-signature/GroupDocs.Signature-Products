...
############################# Head ############################
head_title: "eSign Xltx skjal með Data Matrix QR kóða í Java"
head_description: "Búðu til Data Matrix QR kóða og settu hann á Xltx skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til Data Matrix QR kóða undirskrift fyrir Xltx skjal í Java"
description: "eSignaðu Xltx skjölin þín og samninga með Data Matrix QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Xltx með Qrcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Xltx skjöl með Qrcode undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Xltx skjöl með Qrcode lifandi kynningu"
    content: |
