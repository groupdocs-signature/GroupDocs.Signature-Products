...
############################# Head ############################
head_title: "Java의 G S1 Q R QR 코드로 Dotm 문서에 전자 서명"
head_description: "짧은 Java 코드와 함께 Java을(를) 사용하여 G S1 Q R QR 코드를 생성하고 Dotm 파일에 넣습니다. GroupDocs 문서 서명 API를 사용하여 QR 코드로 비즈니스 문서 및 파일에 전자 서명하십시오."

############################# Header ############################
title: "Java에서 Dotm 문서에 대한 G S1 Q R QR 코드 서명 생성"
description: "G S1 Q R QR 코드로 Dotm 문서 및 계약에 전자 서명합니다. QR 코드 서명을 빠르고 쉽게 생성합니다."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR 코드는 GS1 사양을 준수하는 QR 코드의 변형입니다. 로트 번호, 제품 ID 및 수량과 같은 확장된 포장 정보를 공유하기 위해 특별히 설계되었습니다.
          characterset: |
             대문자 및 소문자 및 특수 문자 $%*+-./: 모두 올바른 애플리케이션 식별자 포함
          textcapacity: |
             최대 7089자의 숫자, 4296자의 영숫자
          image: |
