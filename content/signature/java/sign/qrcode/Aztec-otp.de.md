...
############################# Head ############################
head_title: "eSigniere Otp-Dokument mit Aztec-QR-Code in Java"
head_description: "Erstellen Sie einen Aztec-QR-Code und fügen Sie ihn mit Java und einem kurzen Stück Java-Code in eine Otp-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Aztec-QR-Code-Signatur für Otp-Dokument in Java"
description: "Unterzeichnen Sie Ihre Otp-Dokumente und -Verträge mit dem Aztec-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Otp mit Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Otp-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
