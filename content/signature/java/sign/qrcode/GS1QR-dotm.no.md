...
head_description: "Lag G S1 Q R QR-kode og legg den til Dotm-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."
