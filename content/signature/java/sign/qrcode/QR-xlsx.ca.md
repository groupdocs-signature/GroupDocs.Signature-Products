...
############################# Head ############################
head_title: "Document electrònic Xlsx amb codi QR QR a Java"
head_description: "Creeu QR codi QR i col·loqueu-lo al fitxer Xlsx amb Java amb un tros curt de codi Java. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de QR per al document Xlsx a Java"
description: "eSigneu els vostres documents i contractes de Xlsx amb el codi QR de QR. Genereu la signatura del codi QR de manera ràpida i senzilla."
