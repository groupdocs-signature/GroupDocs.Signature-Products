...
############################# Head ############################
head_title: "eSign Potm документ с QR-кодом QR в Java"
head_description: "Создайте QR-код QR и поместите его в файл Potm, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода QR для документа Potm в Java"
description: "Электронная подпись Potm документов и контрактов с QR QR-кодом. Создавайте подпись QR-кода быстро и легко."
...
steps:
    enable: true
    title_left: "Действия по подписанию Potm с помощью Qrcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Potm с подписями Qrcode.
...
demos:
    enable: true
    title: "Подписание Potm документов с помощью Qrcode Live Demo"
    content: |
