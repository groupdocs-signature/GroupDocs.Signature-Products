...
############################# Head ############################
head_title: "Dokument eSign Potx s QR QR kódem v Java"
head_description: "Vytvořte QR kód QR a vložte jej do souboru Potx pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis QR QR kódu pro dokument Potx v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Potx pomocí QR kódu QR. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Potx pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Potx pomocí podpisů Qrcode.
        
        * Vytvořte instanci třídy Signature poskytující soubor Potx, který se má podepisovat jako cesta nebo proud paměti
        * Instantujte třídu SignOptions a nastavte všechna požadovaná data.
        * Vyvolejte metodu Signature.Sign() předáním výstupního souboru Potx nebo proudu paměti
...
demos:
    enable: true
    title: "Podepisování dokumentů Potx pomocí živé ukázky Qrcode"
    content: |
       Podepište soubor Potx pomocí různých podpisů právě teď na webu [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čeká.
...
more_formats:
    ...
    content: |
        "Můžete také podepsat Potx pomocí jiných typů podpisů. Podívejte se prosím na níže uvedený seznam."
    format: 
