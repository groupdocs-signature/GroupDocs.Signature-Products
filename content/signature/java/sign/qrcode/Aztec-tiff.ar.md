...
############################# Head ############################
head_title: "مستند eSign Tiff مع رمز الاستجابة السريعة Aztec في Java"
head_description: "أنشئ رمز الاستجابة السريعة Aztec وضعه في ملف Tiff باستخدام Java مع جزء قصير من كود Java. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء Aztec توقيع رمز الاستجابة السريعة لمستند Tiff في Java"
