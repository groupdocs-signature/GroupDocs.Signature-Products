...
############################# Head ############################
head_title: "eSign Ppt document with G S1 Q R QR Code in Java"
head_description: "Create G S1 Q R QR Code Signature on Ppt file for Java using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Q R QR Code signature for Ppt document in Java"
description: "eSign your Ppt documents and contracts with G S1 Q R QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options."
