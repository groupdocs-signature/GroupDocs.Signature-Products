...
############################# Head ############################
head_title: "Java で G S1 Q R QR コードを使用して Dot 文書に eSign"
head_description: "G S1 Q R QR コードを作成し、短い Java コードを含む Java を使用して Dot ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "Java の Dot ドキュメントの G S1 Q R QR コード署名を生成します"
...
steps:
    enable: true
    title_left: "Java で Qrcode を使用して Dot に署名する手順"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) は、Dot ドキュメントに Qrcode 署名ですばやく簡単に署名する機能を提供します。
