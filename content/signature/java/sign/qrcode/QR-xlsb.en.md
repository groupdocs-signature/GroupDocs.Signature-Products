...
############################# Head ############################
head_title: "eSign Xlsb document with QR QR Code in Java"
head_description: "Create QR QR Code Signature on Xlsb file for Java using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate QR QR Code signature for Xlsb document in Java"
description: "eSign your Xlsb documents and contracts with QR QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
