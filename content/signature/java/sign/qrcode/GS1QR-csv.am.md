...
############################# Head ############################
head_title: "eSign Csv ሰነድ በG S1 Q R QR ኮድ በJava"
head_description: "G S1 Q R QR ኮድ ይፍጠሩ እና በCsv ፋይል ላይ Javaን በመጠቀም በአጭር የJava ኮድ ያስቀምጡት። የንግድ ሰነዶችዎን እና ፋይሎችዎን በQR ኮድ ኢ-ለመፈረም የGroupDocs ሰነድ ፊርማ ኤፒአይ ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለCsv ሰነድ የG S1 Q R QR ኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Csv ሰነዶች እና ኮንትራቶች በG S1 Q R QR ኮድ ይፈርሙ። የQR ኮድ ፊርማ በፍጥነት እና በቀላሉ ይፍጠሩ።"
...
steps:
    enable: true
    title_left: "Csvን በ{{Signturetype}} በJava ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የCsv ሰነዶችን በQrcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
