...
############################# Head ############################
head_title: "eSign Svg-dokument med G S1 Data Matrix QR-kode i Java"
head_description: "Lag G S1 Data Matrix QR-kode og legg den til Svg-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer G S1 Data Matrix QR-kodesignatur for Svg-dokument i Java"
description: "eSigner Svg-dokumentene og kontraktene dine med QR-koden G S1 Data Matrix. Generer QR-kodesignatur raskt og enkelt."
...
steps:
    enable: true
    title_left: "Trinn for å signere Svg med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Svg-dokumenter med Qrcode-signaturer raskt og enkelt.
        
        * Opprett en forekomst av signaturklassen som gir Svg-fil som skal signere som bane eller minnestrøm
        * Instantiate SignOptions-klassen og angi alle etterspurte data.
        * Påkall Signature.Sign()-metoden ved å sende utdatafilen Svg eller minnestrøm
...
demos:
    enable: true
    title: "Signering av Svg dokumenter med Qrcode Live Demo"
    content: |
       Signer Svg-filen med forskjellige signaturer akkurat nå ved å gå til nettstedet [GroupDocs.Signature-appen](https://products.groupdocs.app/signature/family). Gratis online demo venter på deg.
...
more_formats:
    ...
    content: |
        "Du kan også signere Svg med andre signaturtyper. Vennligst se listen nedenfor."
    format: 
