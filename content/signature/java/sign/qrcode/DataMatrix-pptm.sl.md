...
############################# Head ############################
head_title: "eSign Pptm dokument s Data Matrix QR kodo v Java"
head_description: "Ustvarite QR kodo Data Matrix in jo postavite v datoteko Pptm z uporabo Java s kratkim delom kode Java. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari Data Matrix podpis kode QR za dokument Pptm v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Pptm z Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Pptm s podpisi Qrcode.
