...
############################# Head ############################
head_title: "Belgeya eSign Doc bi Data Matrix Koda QR di Java"
head_description: "Koda QR-a Data Matrix biafirînin û bi koda Java bi koda Java li pelê Doc bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di Java de ji bo belgeya Data Matrix îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên Doc bi koda QR-a Data Matrix îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
