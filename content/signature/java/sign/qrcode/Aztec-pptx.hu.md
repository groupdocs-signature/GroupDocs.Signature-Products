...
############################# Head ############################
head_title: "eSign Pptx dokumentum Aztec QR-kóddal a Java nyelven"
head_description: "Hozzon létre Aztec QR-kódot, és helyezze el a Pptx fájlba a Java használatával egy rövid Java kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon Aztec QR-kód aláírást a Pptx dokumentumhoz a Java programban"
description: "eAláírja Pptx dokumentumait és szerződéseit Aztec QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
...
steps:
    enable: true
    title_left: "A Pptx aláírásának lépései a Qrcode segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Pptx dokumentumok gyors és egyszerű aláírását Qrcode aláírással.
