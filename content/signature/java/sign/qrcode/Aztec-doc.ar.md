...
############################# Head ############################
head_title: "مستند eSign Doc مع رمز الاستجابة السريعة Aztec في Java"
head_description: "أنشئ رمز الاستجابة السريعة Aztec وضعه في ملف Doc باستخدام Java مع جزء قصير من كود Java. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء Aztec توقيع رمز الاستجابة السريعة لمستند Doc في Java"
description: "قم بتوقيع Doc على المستندات والعقود باستخدام رمز الاستجابة السريعة Aztec. قم بإنشاء توقيع QR Code بسرعة وسهولة."
