...
############################# Head ############################
head_title: "Java içinde Data Matrix QR Kodu ile Ott belgesini eSign"
head_description: "Data Matrix QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Ott dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Ott belgesi için Data Matrix QR Kodu imzası oluşturun"
description: "Ott belgelerinizi ve sözleşmelerinizi Data Matrix QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
steps:
    enable: true
    title_left: "Java içinde Qrcode ile Ott imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Ott belgelerini Qrcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Ott dokümanı Qrcode Canlı Demo ile imzalama"
    content: |
