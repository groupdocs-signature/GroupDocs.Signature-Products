...
############################# Head ############################
head_title: "eSign Doc-dokument met QR QR-kode in Java"
head_description: "Skep QR QR-kode en plaas dit op Doc-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer QR QR-kode handtekening vir Doc dokument in Java"
description: "eTeken jou Doc dokumente en kontrakte met QR QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Doc met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Doc dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
        ...
        * Roep die Signature.Sign()-metode deur die uitvoer Doc-lêer of geheuestroom deur te gee
...
demos:
    enable: true
    title: "Teken Doc dokumente met Qrcode Regstreekse Demo"
    content: |
