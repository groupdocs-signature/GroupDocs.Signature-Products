...
############################# Head ############################
head_title: "Document electrònic Ppsx amb codi QR G S1 Q R a Java"
head_description: "Creeu G S1 Q R codi QR i col·loqueu-lo al fitxer Ppsx amb Java amb un tros curt de codi Java. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de G S1 Q R per al document Ppsx a Java"
