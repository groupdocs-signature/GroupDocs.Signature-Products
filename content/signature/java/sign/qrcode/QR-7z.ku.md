...
############################# Head ############################
head_title: "Belgeya eSign 7z bi QR Koda QR di Java"
head_description: "Koda QR-a QR biafirînin û bi koda Java bi koda Java li pelê 7z bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di Java de ji bo belgeya QR îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên 7z bi koda QR-a QR îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
