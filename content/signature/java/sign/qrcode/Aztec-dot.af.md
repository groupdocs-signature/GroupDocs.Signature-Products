...
############################# Head ############################
head_title: "eSign Dot-dokument met Aztec QR-kode in Java"
head_description: "Skep Aztec QR-kode en plaas dit op Dot-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer Aztec QR-kode handtekening vir Dot dokument in Java"
description: "eTeken jou Dot dokumente en kontrakte met Aztec QR-kode. Genereer QR-kode handtekening vinnig en maklik."
