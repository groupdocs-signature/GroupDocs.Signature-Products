...
############################# Head ############################
head_title: "eSign Pptm -asiakirja G S1 Data Matrix QR-koodilla Java"
head_description: "Luo QR-koodi G S1 Data Matrix ja laita se Pptm-tiedostoon käyttämällä Java lyhyttä Java-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo G S1 Data Matrix QR-koodiallekirjoitus asiakirjalle Pptm kohteessa Java"
description: "eAllekirjoita Pptm-asiakirjat ja sopimukset QR-koodilla G S1 Data Matrix. Luo QR-koodin allekirjoitus nopeasti ja helposti."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix on Data Matrixin muunnos, joka on GS1-spesifikaatioiden mukainen. Käytä GS1 DataMatrixia koodataksesi tiedot, kuten, mutta ei rajoittuen, seuraavat tiedot: AI(01) Global Trade Item Number (GTIN), AI(17) Viimeinen voimassaolopäivä, AI(10) Eränumero, AI(21) Sarjanumero .
          characterset: |
             Merkistö: isot ja pienet kirjaimet ja erikoismerkit $@%*+-./:=<>;&*_,'! kaikilla oikeilla sovellustunnisteilla.
          textcapacity: |
             Kooditekstin kapasiteetti: jopa 3116 numeerista numeroa tai 2335 aakkosnumeerista merkkiä.
          image: |
