...
############################# Head ############################
head_title: "eSign Odt documento con Aztec codice QR in Java"
head_description: "Crea il codice QR Aztec e inseriscilo nel file Odt utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Aztec firma del codice QR per il documento Odt in Java"
