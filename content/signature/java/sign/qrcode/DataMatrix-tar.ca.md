...
############################# Head ############################
head_title: "Document electrònic Tar amb codi QR Data Matrix a Java"
head_description: "Creeu Data Matrix codi QR i col·loqueu-lo al fitxer Tar amb Java amb un tros curt de codi Java. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de Data Matrix per al document Tar a Java"
description: "eSigneu els vostres documents i contractes de Tar amb el codi QR de Data Matrix. Genereu la signatura del codi QR de manera ràpida i senzilla."
