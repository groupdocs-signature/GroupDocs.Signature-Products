...
############################# Head ############################
head_title: "eSign Ods document avec G S1 Q R QR Code en Java"
head_description: "Créez le code QR G S1 Q R et placez-le dans le fichier Ods en utilisant Java avec un court morceau de code Java. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR G S1 Q R pour le document Ods en Java"
description: "Signez électroniquement vos documents et contrats Ods avec G S1 Q R QR Code. Générez une signature QR Code rapidement et facilement."
