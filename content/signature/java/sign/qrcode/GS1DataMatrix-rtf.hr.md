...
############################# Head ############################
head_title: "eSign Rtf dokument s G S1 Data Matrix QR kodom u Java"
head_description: "Napravite G S1 Data Matrix QR kod i stavite ga u datoteku Rtf koristeći Java s kratkim dijelom Java koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj G S1 Data Matrix potpis QR koda za Rtf dokument u Java"
description: "ePotpišite svoje Rtf dokumente i ugovore s G S1 Data Matrix QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Rtf s Qrcode u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Rtf dokumenata s Qrcode potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Rtf dokumenata s Qrcode Live Demo"
    content: |
