...
############################# Head ############################
head_title: "eSign Tiff dokument s G S1 Data Matrix QR kodom u Java"
head_description: "Napravite G S1 Data Matrix QR kod i stavite ga u datoteku Tiff koristeći Java s kratkim dijelom Java koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj G S1 Data Matrix potpis QR koda za Tiff dokument u Java"
description: "ePotpišite svoje Tiff dokumente i ugovore s G S1 Data Matrix QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Tiff s Qrcode u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Tiff dokumenata s Qrcode potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Tiff dokumenata s Qrcode Live Demo"
    content: |
