...
############################# Head ############################
head_title: "eSign Ott-dokument med G S1 Data Matrix QR-kod i Java"
head_description: "Skapa G S1 Data Matrix QR-kod och lägg den i filen Ott med Java med en kort bit av Java-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera G S1 Data Matrix QR-kodsignatur för Ott dokument i Java"
description: "esignera dina Ott-dokument och kontrakt med G S1 Data Matrix QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Ott med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Ott-dokument med Qrcode-signaturer snabbt och enkelt.
        
        * Skapa en instans av Signature class som tillhandahåller Ott fil som ska signera som sökväg eller minnesström
        * Instantera SignOptions-klassen och ställ in all efterfrågad data.
        * Anropa metoden Signature.Sign() och skicka utdatafilen Ott eller minnesström
...
demos:
    enable: true
    title: "Signerar Ott dokument med Qrcode Live Demo"
    content: |
       Signera filen Ott med olika signaturer just nu genom att besöka webbplatsen [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Gratis onlinedemo väntar på dig.
...
more_formats:
    ...
    content: |
        "Du kan också signera Ott med andra signaturtyper. Se listan nedan."
    format: 
