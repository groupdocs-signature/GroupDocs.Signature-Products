...
head_description: "Create Aztec QR Code and put it on Ott file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Ott document in Java"
description: "eSign your Ott documents and contracts with Aztec QR Code. Generate QR Code signature quickly and easily."
