...
############################# Head ############################
head_title: "eSign Odp documento con Aztec codice QR in Java"
head_description: "Crea il codice QR Aztec e inseriscilo nel file Odp utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Aztec firma del codice QR per il documento Odp in Java"
...
steps:
    enable: true
    title_left: "Passaggi per firmare Odp con Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Odp con firme Qrcode in modo rapido e semplice.
