...
############################# Head ############################
head_title: "eSign 7z dokument Data Matrix QR-koodiga rakenduses Java"
head_description: "Looge QR-kood Data Matrix ja sisestage see faili 7z, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile 7z QR-koodi allkiri Data Matrix"
description: "eAllkirjasta oma 7z dokumendid ja lepingud QR-koodiga Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud 7z allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada 7z dokumente Qrcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide 7z allkirjastamine Qrcode reaalajas demoga"
    content: |
