...
############################# Head ############################
head_title: "eSign Zip document with G S1 Q R QR Code in Java"
head_description: "Create G S1 Q R QR Code and put it on Zip file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Q R QR Code signature for Zip document in Java"
description: "eSign your Zip documents and contracts with G S1 Q R QR Code. Generate QR Code signature quickly and easily."
...
steps:
    enable: true
    title_left: "Steps to sign Zip with Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Zip documents with Qrcode signatures quickly and easily.
