...
############################# Head ############################
head_title: "eSign Dotm documento con G S1 Data Matrix codice QR in Java"
head_description: "Crea il codice QR G S1 Data Matrix e inseriscilo nel file Dotm utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera G S1 Data Matrix firma del codice QR per il documento Dotm in Java"
...
steps:
    enable: true
    title_left: "Passaggi per firmare Dotm con Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Dotm con firme Qrcode in modo rapido e semplice.
