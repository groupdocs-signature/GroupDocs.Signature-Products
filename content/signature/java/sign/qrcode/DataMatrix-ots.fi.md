...
############################# Head ############################
head_title: "eSign Ots -asiakirja Data Matrix QR-koodilla Java"
head_description: "Luo QR-koodi Data Matrix ja laita se Ots-tiedostoon käyttämällä Java lyhyttä Java-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo Data Matrix QR-koodiallekirjoitus asiakirjalle Ots kohteessa Java"
description: "eAllekirjoita Ots-asiakirjat ja sopimukset QR-koodilla Data Matrix. Luo QR-koodin allekirjoitus nopeasti ja helposti."
...
steps:
    enable: true
    title_left: "Vaiheet Ots:n allekirjoittamiseen Qrcode -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Ots-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Ots asiakirjoja Qrcode Live-demolla"
    content: |
