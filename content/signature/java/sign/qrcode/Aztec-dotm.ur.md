...
############################# Head ############################
head_title: "Java میں Aztec QR کوڈ کے ساتھ eSign Dotm دستاویز"
head_description: "Aztec QR کوڈ بنائیں اور اسے Java کا استعمال کرتے ہوئے Java کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Dotm فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "Java میں Dotm دستاویز کے لیے Aztec QR کوڈ دستخط بنائیں"
description: "اپنے Dotm دستاویزات اور معاہدوں پر Aztec QR کوڈ کے ساتھ دستخط کریں۔ QR کوڈ دستخط جلدی اور آسانی سے بنائیں۔"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code ایک دو جہتی (2-D) عام مقصدی میٹرکس علامت ہے جسے دیگر 2-D علامتوں کے مقابلے میں زیادہ درستگی کے لیے ڈیزائن کیا گیا ہے۔ Aztec کوڈ کی علامت 3,832 عددی ہندسوں تک انکوڈ کر سکتی ہے۔ 3,067 حروف تہجی کے حروف؛ یا 1,914 بائٹس ڈیٹا۔
          characterset: |
             تمام 256 ASCII حروف۔
          textcapacity: |
             3,832 عددی ہندسے، یا 3,067 حروف تہجی کے حروف، یا ڈیٹا کے 1,914 بائٹس تک۔
          image: |
