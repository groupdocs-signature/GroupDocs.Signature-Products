...
############################# Head ############################
head_title: "eSign Potx tài liệu với Aztec Mã QR trong Java"
head_description: "Tạo Mã QR Aztec và đặt nó vào tệp Potx bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR Aztec cho tài liệu Potx trong Java"
description: "eSign các tài liệu và hợp đồng Potx của bạn bằng Mã QR Aztec. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Mã Aztec là mã vạch ma trận đa năng hai chiều (2-D) được thiết kế để có độ chính xác cao hơn các mã vạch 2-D khác. Một biểu tượng Mã Aztec có thể mã hóa tới 3.832 chữ số; 3.067 ký tự chữ cái; hoặc 1,914 byte dữ liệu.
          characterset: |
             Tất cả 256 ký tự ASCII.
          textcapacity: |
             Lên đến 3.832 chữ số hoặc 3.067 ký tự chữ cái hoặc 1.914 byte dữ liệu.
          image: |
