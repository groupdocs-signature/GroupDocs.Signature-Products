...
############################# Head ############################
head_title: "eSign Rtf-dokument med G S1 Data Matrix QR-kode i Java"
head_description: "Lag G S1 Data Matrix QR-kode og legg den til Rtf-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer G S1 Data Matrix QR-kodesignatur for Rtf-dokument i Java"
description: "eSigner Rtf-dokumentene og kontraktene dine med QR-koden G S1 Data Matrix. Generer QR-kodesignatur raskt og enkelt."
...
steps:
    enable: true
    title_left: "Trinn for å signere Rtf med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Rtf-dokumenter med Qrcode-signaturer raskt og enkelt.
        
        * Opprett en forekomst av signaturklassen som gir Rtf-fil som skal signere som bane eller minnestrøm
        * Instantiate SignOptions-klassen og angi alle etterspurte data.
        * Påkall Signature.Sign()-metoden ved å sende utdatafilen Rtf eller minnestrøm
...
demos:
    enable: true
    title: "Signering av Rtf dokumenter med Qrcode Live Demo"
    content: |
       Signer Rtf-filen med forskjellige signaturer akkurat nå ved å gå til nettstedet [GroupDocs.Signature-appen](https://products.groupdocs.app/signature/family). Gratis online demo venter på deg.
...
more_formats:
    ...
    content: |
        "Du kan også signere Rtf med andre signaturtyper. Vennligst se listen nedenfor."
    format: 
