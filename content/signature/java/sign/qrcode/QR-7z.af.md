...
############################# Head ############################
head_title: "eSign 7z-dokument met QR QR-kode in Java"
head_description: "Skep QR QR-kode en plaas dit op 7z-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer QR QR-kode handtekening vir 7z dokument in Java"
description: "eTeken jou 7z dokumente en kontrakte met QR QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om 7z met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om 7z dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
        
        * Skep 'n instansie van Signature-klas wat 7z-lêer verskaf wat veronderstel is om te onderteken as pad of geheuestroom
        * Instansieer SignOptions-klas en stel alle verlangde data in.
        * Roep die Signature.Sign()-metode deur die uitvoer 7z-lêer of geheuestroom deur te gee
...
demos:
    enable: true
    title: "Teken 7z dokumente met Qrcode Regstreekse Demo"
    content: |
       Teken nou die 7z-lêer met verskeie handtekeninge deur die [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webwerf te besoek. Gratis aanlyn demo wag vir jou.
...
more_formats:
    ...
    content: |
        "Jy kan ook 7z met ander handtekeningtipes onderteken. Sien asseblief die lys hieronder."
    format: 
