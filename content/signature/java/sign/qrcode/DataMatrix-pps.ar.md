...
############################# Head ############################
head_title: "مستند eSign Pps مع رمز الاستجابة السريعة Data Matrix في Java"
head_description: "أنشئ رمز الاستجابة السريعة Data Matrix وضعه في ملف Pps باستخدام Java مع جزء قصير من كود Java. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء Data Matrix توقيع رمز الاستجابة السريعة لمستند Pps في Java"
description: "قم بتوقيع Pps على المستندات والعقود باستخدام رمز الاستجابة السريعة Data Matrix. قم بإنشاء توقيع QR Code بسرعة وسهولة."
