...
############################# Head ############################
head_title: "eSign Ods dokuments ar QR QR kodu programmā Java"
head_description: "Izveidojiet QR QR kodu un ievietojiet to failā Ods, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt QR QR koda parakstu dokumentam Ods programmā Java"
description: "eParakstiet savus Ods dokumentus un līgumus ar QR QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Ods ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Ods dokumentus ar Qrcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Ods parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
