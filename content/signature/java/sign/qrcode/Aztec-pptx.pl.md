...
############################# Head ############################
head_title: "Podpisz dokument Pptx z kodem QR Aztec w Java"
head_description: "Utwórz kod QR Aztec i umieść go w pliku Pptx za pomocą Java z krótkim fragmentem kodu Java. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis Aztec kodu QR dla dokumentu Pptx w Java"
description: "Podpisz elektronicznie dokumenty i umowy w Pptx za pomocą kodu QR Aztec. Szybko i łatwo generuj podpis QR Code."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code to dwuwymiarowa (2-D) symbolika matrycowa ogólnego przeznaczenia, która została zaprojektowana tak, aby zapewniała większą dokładność niż inne symbole 2-D. Symbol Aztec Code może zakodować do 3832 cyfr; 3067 znaków alfabetycznych; lub 1914 bajtów danych.
          characterset: |
             Wszystkie 256 znaków ASCII.
          textcapacity: |
             Do 3832 cyfr lub 3067 znaków alfabetycznych lub 1914 bajtów danych.
          image: |
