...
############################# Head ############################
head_title: "eSign Potx dokumentas su G S1 Data Matrix QR kodu Java"
head_description: "Sukurkite QR kodą G S1 Data Matrix ir įdėkite jį į failą Potx naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Data Matrix QR kodo parašą Potx dokumentui Java"
description: "e. Pasirašykite Potx dokumentus ir sutartis naudodami G S1 Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Potx naudojant Qrcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Potx dokumentus su Qrcode parašais.
...
demos:
    enable: true
    title: "Dokumentų Potx pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
