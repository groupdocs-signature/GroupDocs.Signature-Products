...
############################# Head ############################
head_title: "eSign Ppsm dokumen dengan Data Matrix QR Code di Java"
head_description: "Buat Kode QR Data Matrix dan letakkan di file Ppsm menggunakan Java dengan potongan pendek kode Java. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat Data Matrix tanda tangan Kode QR untuk dokumen Ppsm di Java"
description: "eTandatangani dokumen dan kontrak Ppsm Anda dengan Kode QR Data Matrix. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Matriks Data adalah kode dua dimensi yang terdiri dari 'sel' atau titik hitam putih yang disusun dalam pola persegi atau persegi panjang, juga dikenal sebagai matriks. Informasi yang akan dikodekan dapat berupa teks atau data numerik.
          characterset: |
             Mendukung semua 256 karakter ASCII, semua karakter ISO, dan semua karakter Extended Binary Coded Decimal Interchange Code (EBCDIC).
          textcapacity: |
             Hingga 3116 digit numerik, atau 2335 karakter alfanumerik, atau 1556 karakter biner.
          image: |
