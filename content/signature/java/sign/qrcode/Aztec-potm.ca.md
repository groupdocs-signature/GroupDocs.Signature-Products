...
############################# Head ############################
head_title: "Document electrònic Potm amb codi QR Aztec a Java"
head_description: "Creeu Aztec codi QR i col·loqueu-lo al fitxer Potm amb Java amb un tros curt de codi Java. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de Aztec per al document Potm a Java"
description: "eSigneu els vostres documents i contractes de Potm amb el codi QR de Aztec. Genereu la signatura del codi QR de manera ràpida i senzilla."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            El codi asteca és una simbologia matricial bidimensional (2-D) de propòsit general dissenyada per tenir una precisió més alta que altres simbologies 2-D. Un símbol de codi asteca pot codificar fins a 3.832 dígits numèrics; 3.067 caràcters alfabètics; o 1.914 bytes de dades.
          characterset: |
             Tots els 256 caràcters ASCII.
          textcapacity: |
             Fins a 3.832 dígits numèrics, o 3.067 caràcters alfabètics o 1.914 bytes de dades.
          image: |
