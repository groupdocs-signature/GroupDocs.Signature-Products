...
############################# Head ############################
head_title: "eSign Ppsm dokumentum QR QR-kóddal a Java nyelven"
head_description: "Hozzon létre QR QR-kódot, és helyezze el a Ppsm fájlba a Java használatával egy rövid Java kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon QR QR-kód aláírást a Ppsm dokumentumhoz a Java programban"
description: "eAláírja Ppsm dokumentumait és szerződéseit QR QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
...
steps:
    enable: true
    title_left: "A Ppsm aláírásának lépései a Qrcode segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Ppsm dokumentumok gyors és egyszerű aláírását Qrcode aláírással.
...
demos:
    enable: true
    title: "Ppsm dokumentumok aláírása Qrcode élő bemutatóval"
    content: |
