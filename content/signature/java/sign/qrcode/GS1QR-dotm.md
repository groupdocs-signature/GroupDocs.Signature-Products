...
breadcrumb: Create QRCODE signature on DOTM for Java

############################# Head ############################
head_title: "Adding QRCODE signatures in a DOTM file with Java"
head_description: "Put QRCODE Signature on DOTM file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .DOTM files with QRCODE signatures in Java"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your DOTM files with QRCODE signatures using Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to sign DOTM with QRCODE in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign DOTM documents with QRCODE signatures quick and easily.
