...
############################# Head ############################
head_title: "eSign Dotm документ с QR QR код в Java"
head_description: "Създайте QR QR код и го поставете във файл Dotm, като използвате Java с кратка част от Java код. Използвайте API за подписване на документи на GroupDocs, за да подпишете електронно вашите бизнес документи и файлове с QR код."

############################# Header ############################
title: "Генерирайте QR QR Code подпис за Dotm документ в Java"
