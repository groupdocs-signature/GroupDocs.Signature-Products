...
############################# Head ############################
head_title: "eSign Dot dokumentum QR QR-kóddal a Java nyelven"
head_description: "Hozzon létre QR QR-kódot, és helyezze el a Dot fájlba a Java használatával egy rövid Java kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon QR QR-kód aláírást a Dot dokumentumhoz a Java programban"
description: "eAláírja Dot dokumentumait és szerződéseit QR QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
