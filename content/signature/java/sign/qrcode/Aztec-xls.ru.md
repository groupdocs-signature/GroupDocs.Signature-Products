...
############################# Head ############################
head_title: "eSign Xls документ с QR-кодом Aztec в Java"
head_description: "Создайте QR-код Aztec и поместите его в файл Xls, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода Aztec для документа Xls в Java"
description: "Электронная подпись Xls документов и контрактов с Aztec QR-кодом. Создавайте подпись QR-кода быстро и легко."
...
steps:
    enable: true
    title_left: "Действия по подписанию Xls с помощью Qrcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Xls с подписями Qrcode.
...
demos:
    enable: true
    title: "Подписание Xls документов с помощью Qrcode Live Demo"
    content: |
