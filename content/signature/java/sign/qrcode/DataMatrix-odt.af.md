...
############################# Head ############################
head_title: "eSign Odt-dokument met Data Matrix QR-kode in Java"
head_description: "Skep Data Matrix QR-kode en plaas dit op Odt-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer Data Matrix QR-kode handtekening vir Odt dokument in Java"
description: "eTeken jou Odt dokumente en kontrakte met Data Matrix QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Odt met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Odt dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Odt dokumente met Qrcode Regstreekse Demo"
    content: |
