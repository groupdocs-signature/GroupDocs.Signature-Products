...
############################# Head ############################
head_title: "eSign Pps document avec Data Matrix QR Code en Java"
head_description: "Créez le code QR Data Matrix et placez-le dans le fichier Pps en utilisant Java avec un court morceau de code Java. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR Data Matrix pour le document Pps en Java"
description: "Signez électroniquement vos documents et contrats Pps avec Data Matrix QR Code. Générez une signature QR Code rapidement et facilement."
...
steps:
    enable: true
    title_left: "Étapes pour signer Pps avec Qrcode dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Pps avec des signatures Qrcode.
