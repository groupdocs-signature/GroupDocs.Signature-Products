...
############################# Head ############################
head_title: "eSigniere Odt-Dokument mit G S1 Data Matrix-QR-Code in Java"
head_description: "Erstellen Sie einen G S1 Data Matrix-QR-Code und fügen Sie ihn mit Java und einem kurzen Stück Java-Code in eine Odt-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere G S1 Data Matrix-QR-Code-Signatur für Odt-Dokument in Java"
description: "Unterzeichnen Sie Ihre Odt-Dokumente und -Verträge mit dem G S1 Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Odt mit Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Odt-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Odt-Dokumenten mit Qrcode Live-Demo"
    content: |
