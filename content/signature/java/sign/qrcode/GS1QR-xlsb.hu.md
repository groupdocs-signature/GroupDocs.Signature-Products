...
############################# Head ############################
head_title: "eSign Xlsb dokumentum G S1 Q R QR-kóddal a Java nyelven"
head_description: "Hozzon létre G S1 Q R QR-kódot, és helyezze el a Xlsb fájlba a Java használatával egy rövid Java kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon G S1 Q R QR-kód aláírást a Xlsb dokumentumhoz a Java programban"
description: "eAláírja Xlsb dokumentumait és szerződéseit G S1 Q R QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
