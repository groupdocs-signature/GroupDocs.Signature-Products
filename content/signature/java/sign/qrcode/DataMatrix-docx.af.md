...
############################# Head ############################
head_title: "eSign Docx-dokument met Data Matrix QR-kode in Java"
head_description: "Skep Data Matrix QR-kode en plaas dit op Docx-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer Data Matrix QR-kode handtekening vir Docx dokument in Java"
description: "eTeken jou Docx dokumente en kontrakte met Data Matrix QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Docx met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Docx dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
        
        * Skep 'n instansie van Signature-klas wat Docx-lêer verskaf wat veronderstel is om te onderteken as pad of geheuestroom
        * Instansieer SignOptions-klas en stel alle verlangde data in.
        * Roep die Signature.Sign()-metode deur die uitvoer Docx-lêer of geheuestroom deur te gee
...
demos:
    enable: true
    title: "Teken Docx dokumente met Qrcode Regstreekse Demo"
    content: |
       Teken nou die Docx-lêer met verskeie handtekeninge deur die [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webwerf te besoek. Gratis aanlyn demo wag vir jou.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Datamatriks is 'n tweedimensionele kode wat bestaan ​​uit swart en wit 'selle' of kolletjies wat in 'n vierkantige of reghoekige patroon gerangskik is, ook bekend as 'n matriks. Die inligting wat geënkodeer moet word, kan teks- of numeriese data wees.
          characterset: |
             Ondersteun al 256 ASCII-karakters, alle ISO-karakters en alle Extended Binary Coded Decimal Interchange Code (EBCDIC) karakters.
          textcapacity: |
             Tot 3116 numeriese syfers, of 2335 alfa-numeriese karakters, of 1556 binêre karakters.
          image: |
...
more_formats:
    ...
    content: |
        "Jy kan ook Docx met ander handtekeningtipes onderteken. Sien asseblief die lys hieronder."
    format: 
