...
############################# Head ############################
head_title: "Podpisz dokument Dotx z kodem QR QR w Java"
head_description: "Utwórz kod QR QR i umieść go w pliku Dotx za pomocą Java z krótkim fragmentem kodu Java. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis QR kodu QR dla dokumentu Dotx w Java"
description: "Podpisz elektronicznie dokumenty i umowy w Dotx za pomocą kodu QR QR. Szybko i łatwo generuj podpis QR Code."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Dotx za pomocą Qrcode w Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Dotx za pomocą podpisów Qrcode.
