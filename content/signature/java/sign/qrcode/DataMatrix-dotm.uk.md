...
############################# Head ############################
head_title: "eSign Dotm документ із Data Matrix QR-кодом у Java"
head_description: "Створіть QR-код Data Matrix і помістіть його у файл Dotm за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду Data Matrix для документа Dotm у Java"
description: "Електронно підписуйте свої Dotm документи та контракти за допомогою Data Matrix QR-коду. Згенеруйте підпис QR-коду швидко та легко."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Матриця даних — це двовимірний код, що складається з чорних і білих «клітин» або точок, розташованих у формі квадрата або прямокутника, також відомого як матриця. Інформація, що кодується, може бути текстовою або числовою інформацією.
          characterset: |
             Підтримує всі 256 символів ASCII, усі символи ISO та всі символи розширеного двійкового десяткового коду обміну (EBCDIC).
          textcapacity: |
             До 3116 чисел, або 2335 буквено-цифрових символів, або 1556 двійкових символів.
          image: |
