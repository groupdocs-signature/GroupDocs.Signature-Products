...
############################# Head ############################
head_title: "eSigniere Docm-Dokument mit G S1 Data Matrix-QR-Code in Java"
head_description: "Erstellen Sie einen G S1 Data Matrix-QR-Code und fügen Sie ihn mit Java und einem kurzen Stück Java-Code in eine Docm-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere G S1 Data Matrix-QR-Code-Signatur für Docm-Dokument in Java"
description: "Unterzeichnen Sie Ihre Docm-Dokumente und -Verträge mit dem G S1 Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Docm mit Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Docm-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
