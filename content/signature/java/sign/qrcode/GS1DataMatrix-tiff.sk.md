...
############################# Head ############################
head_title: "eSign Tiff dokument s G S1 Data Matrix QR kódom v Java"
head_description: "Vytvorte G S1 Data Matrix QR kód a vložte ho do súboru Tiff pomocou Java s krátkym kódom Java. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte G S1 Data Matrix podpis QR kódu pre dokument Tiff v Java"
description: "ePodpíšte svoje Tiff dokumenty a zmluvy pomocou G S1 Data Matrix QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
...
about:
    enable: true
    title: "O rozhraní API na podpisy QR kódu GroupDocs.Signature for Java"
    content: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) je vyspelé rozhranie API na vytváranie a generovanie podpisov QR kódu pre dokumenty. Používatelia môžu generovať podpisy QR kódu poskytujúce text na stiahnutie alebo zdieľanie cez sociálne médiá ako obrázok. Podpísaný dokument je možné naskenovať pomocou API alebo jednoducho cez mobilnú kameru! Elektronicky podpisujte svoje obchodné zmluvy a úradné dokumenty pridaním podpisu QR kódu a manipulujte s nimi. Každý podpis QR kódu bude obsahovať jedinečné vlastné informácie na identifikáciu podpisovateľa alebo autorizáciu dokumentu. Okrem toho je možné obsah QR kódu programovo šifrovať a dešifrovať pomocou osobných kľúčov. To otvára veľa možností na zdieľanie citlivých údajov vo verejných dokumentoch. Po podpísaní môže používateľ aktualizovať, overiť, odstrániť, zobraziť náhľad alebo vyhľadať QR kódy v súboroch PDF, dokumentoch MS Word, zošitoch MS Excel, prezentáciách MS PowerPoint, súboroch Adobe Photoshop a rôznych formátoch obrázkov. QR kódy je možné dodatočne prispôsobiť.
    

############################# Steps ############################
steps:
    enable: true
    title_left: "Kroky na podpísanie Tiff pomocou Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Tiff pomocou podpisov Qrcode.
        
        * Vytvorte inštanciu triedy Signature poskytujúcej súbor Tiff, ktorý sa má podpisovať ako cesta alebo prúd pamäte
        * Instanciujte triedu SignOptions a nastavte všetky požadované údaje.
        * Vyvolajte metódu Signature.Sign() odovzdajúc výstupný súbor Tiff alebo prúd pamäte
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Tiff pomocou živej ukážky Qrcode"
    content: |
       Podpíšte súbor Tiff pomocou rôznych podpisov práve teraz na webovej lokalite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čaká.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix je variant Data Matrix, ktorý vyhovuje špecifikáciám GS1. Použite GS1 DataMatrix na zakódovanie informácií, ako sú, ale nie výlučne, nasledujúce: AI(01) globálne číslo obchodnej položky (GTIN), AI(17) dátum vypršania platnosti, AI(10) číslo šarže, AI(21) sériové číslo .
          characterset: |
             Znaková sada: veľké a malé písmená a špeciálne znaky $@%*+-./:=<>;&*_,'! všetko so správnymi identifikátormi aplikácie.
          textcapacity: |
             Kapacita kódového textu: až 3116 numerických číslic alebo 2335 alfanumerických znakov.
          image: |
...
more_formats:
    enable: true
    title: "Ďalšie podporované podpisy Qrcode pre Java"
    content: |
        "Tiff môžete podpísať aj inými typmi podpisov. Pozrite si zoznam nižšie."
    format: 
