...
############################# Head ############################
head_title: "eSign Ppt dokumentas su Aztec QR kodu Java"
head_description: "Sukurkite QR kodą Aztec ir įdėkite jį į failą Ppt naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite Aztec QR kodo parašą Ppt dokumentui Java"
description: "e. Pasirašykite Ppt dokumentus ir sutartis naudodami Aztec QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Ppt naudojant Qrcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Ppt dokumentus su Qrcode parašais.
        
        * Sukurkite parašo klasės egzempliorių, pateikiantį Ppt failą, kuris turėtų būti pasirašytas kaip kelias arba atminties srautas
        * Sukurkite SignOptions klasę ir nustatykite visus reikalingus duomenis.
        * Iškvieskite Signature.Sign() metodą, perduodantį išvesties Ppt failą arba atminties srautą
...
demos:
    enable: true
    title: "Dokumentų Ppt pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
       Pasirašykite Ppt failą įvairiais parašais dabar apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje. Jūsų laukia nemokama internetinė demonstracinė versija.
...
more_formats:
    ...
    content: |
        "Taip pat galite pasirašyti Ppt naudodami kitų tipų parašus. Žiūrėkite žemiau esantį sąrašą."
    format: 
