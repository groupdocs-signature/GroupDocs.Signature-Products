...
############################# Head ############################
head_title: "eSign Ods-dokument med G S1 Data Matrix QR-kode i Java"
head_description: "Opret G S1 Data Matrix QR-kode og læg den i Ods-filen ved hjælp af Java med et kort stykke Java-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer G S1 Data Matrix QR-kodesignatur for Ods dokument i Java"
description: "eSignér dine Ods-dokumenter og kontrakter med G S1 Data Matrix QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Trin til at signere Ods med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Ods dokumenter med Qrcode signaturer hurtigt og nemt.
