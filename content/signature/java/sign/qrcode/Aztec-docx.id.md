...
############################# Head ############################
head_title: "eSign Docx dokumen dengan Aztec QR Code di Java"
head_description: "Buat Kode QR Aztec dan letakkan di file Docx menggunakan Java dengan potongan pendek kode Java. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat Aztec tanda tangan Kode QR untuk dokumen Docx di Java"
description: "eTandatangani dokumen dan kontrak Docx Anda dengan Kode QR Aztec. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Docx dengan Qrcode di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Docx dengan Qrcode tanda tangan dengan cepat dan mudah.
