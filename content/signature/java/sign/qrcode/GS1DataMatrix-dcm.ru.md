...
############################# Head ############################
head_title: "eSign Dcm документ с QR-кодом G S1 Data Matrix в Java"
head_description: "Создайте QR-код G S1 Data Matrix и поместите его в файл Dcm, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода G S1 Data Matrix для документа Dcm в Java"
