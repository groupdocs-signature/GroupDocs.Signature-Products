...
############################# Head ############################
head_title: "eSign Webp -asiakirja QR QR-koodilla Java"
head_description: "Luo QR-koodi QR ja laita se Webp-tiedostoon käyttämällä Java lyhyttä Java-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo QR QR-koodiallekirjoitus asiakirjalle Webp kohteessa Java"
description: "eAllekirjoita Webp-asiakirjat ja sopimukset QR-koodilla QR. Luo QR-koodin allekirjoitus nopeasti ja helposti."
...
steps:
    enable: true
    title_left: "Vaiheet Webp:n allekirjoittamiseen Qrcode -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Webp-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Webp asiakirjoja Qrcode Live-demolla"
    content: |
