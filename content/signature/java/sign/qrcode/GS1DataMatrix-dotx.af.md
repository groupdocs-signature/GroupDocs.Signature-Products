...
############################# Head ############################
head_title: "eSign Dotx-dokument met G S1 Data Matrix QR-kode in Java"
head_description: "Skep G S1 Data Matrix QR-kode en plaas dit op Dotx-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR-kode handtekening vir Dotx dokument in Java"
description: "eTeken jou Dotx dokumente en kontrakte met G S1 Data Matrix QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Dotx met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Dotx dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Dotx dokumente met Qrcode Regstreekse Demo"
    content: |
...
more_formats:
    ...
    content: |
        "Jy kan ook Dotx met ander handtekeningtipes onderteken. Sien asseblief die lys hieronder."
    format: 
