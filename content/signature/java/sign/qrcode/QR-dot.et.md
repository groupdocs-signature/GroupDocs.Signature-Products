...
############################# Head ############################
head_title: "eSign Dot dokument QR QR-koodiga rakenduses Java"
head_description: "Looge QR-kood QR ja sisestage see faili Dot, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Dot QR-koodi allkiri QR"
description: "eAllkirjasta oma Dot dokumendid ja lepingud QR-koodiga QR. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Dot allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Dot dokumente Qrcode allkirjaga.
