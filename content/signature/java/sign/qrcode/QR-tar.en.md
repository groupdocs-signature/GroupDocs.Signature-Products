...
############################# Head ############################
head_title: "eSign Tar document with QR QR Code in Java"
head_description: "Create QR QR Code and put it on Tar file using Java with a short piece of Java code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate QR QR Code signature for Tar document in Java"
description: "eSign your Tar documents and contracts with QR QR Code. Generate QR Code signature quickly and easily."
