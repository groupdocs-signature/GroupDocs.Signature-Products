...
############################# Head ############################
head_title: "eSign Xls документ с QR-кодом G S1 Data Matrix в Java"
head_description: "Создайте QR-код G S1 Data Matrix и поместите его в файл Xls, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода G S1 Data Matrix для документа Xls в Java"
description: "Электронная подпись Xls документов и контрактов с G S1 Data Matrix QR-кодом. Создавайте подпись QR-кода быстро и легко."
