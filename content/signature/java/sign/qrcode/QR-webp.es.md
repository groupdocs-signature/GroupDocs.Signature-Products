...
############################# Head ############################
head_title: "Documento de firma electrónica Webp con QR código QR en Java"
head_description: "Cree el código QR QR y colóquelo en el archivo Webp usando Java con un fragmento corto de código Java. Utilice la API de firma de documentos de GroupDocs para firmar electrónicamente sus documentos y archivos comerciales con código QR."

############################# Header ############################
title: "Genere la firma del código QR QR para el documento Webp en Java"
description: "Firme electrónicamente sus Webp documentos y contratos con QR QR Code. Genere la firma del código QR de forma rápida y sencilla."
...
steps:
    enable: true
    title_left: "Pasos para firmar Webp con Qrcode en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Webp con Qrcode firmas de forma rápida y sencilla.
        
        * Cree una instancia de la clase Signature que proporcione el archivo Webp que se supone que debe firmar como ruta o flujo de memoria
        * Cree una instancia de la clase SignOptions y configure todos los datos solicitados.
        * Invoque el método Signature.Sign() pasando la salida Webp archivo o flujo de memoria
...
demos:
    enable: true
    title: "Firma de Webp documentos con Qrcode Live Demo"
    content: |
       Firme el archivo Webp con varias firmas ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demostración en línea gratuita esperándote.
...
more_formats:
    ...
    content: |
        "También puede firmar Webp con otros tipos de firma. Consulte la lista a continuación."
    format: 
