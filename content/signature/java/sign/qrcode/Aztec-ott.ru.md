...
############################# Head ############################
head_title: "eSign Ott документ с QR-кодом Aztec в Java"
head_description: "Создайте QR-код Aztec и поместите его в файл Ott, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода Aztec для документа Ott в Java"
description: "Электронная подпись Ott документов и контрактов с Aztec QR-кодом. Создавайте подпись QR-кода быстро и легко."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code — это двумерная (2-D) матричная система символов общего назначения, разработанная для обеспечения более высокой точности, чем другие 2-D системы символов. Символ кода ацтеков может кодировать до 3832 цифровых цифр; 3067 буквенных символов; или 1914 байт данных.
          characterset: |
             Все 256 символов ASCII.
          textcapacity: |
             До 3832 цифровых цифр, или 3067 буквенных символов, или 1914 байтов данных.
          image: |
