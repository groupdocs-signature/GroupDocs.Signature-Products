...
breadcrumb: Put  Qrcode signature on Jpeg for Java

############################# Head ############################
head_title: "eSign Jpeg document with G S1 Q R QR Code in Java"
head_description: "Create G S1 Q R QR Code Signature on Jpeg file for Java using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Q R QR Code signature for Jpeg document in Java"
description: "eSign your Jpeg documents and contracts with G S1 Q R QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Jpeg files with Qrcode signatures using Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
        You can put Qrcode on Jpeg file in a very convenient way and for free. Besides that it is possible to sign Jpeg files using advanced Qrcode options. 
        ...
        * furthermore file can be encrypted with password or saved to memory stream.
        ...
        Signing Jpeg files with Qrcode provides vast amount opportunities for users. Moreover there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc.


############################# Steps ############################
steps:
    enable: true
    title_left: "Steps to sign Jpeg with Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Jpeg documents with Qrcode signatures quick and easily.
...
demos:
    enable: true
    title: "Signing Jpeg documents with Qrcode Live Demo"
    content: |
       Sign Jpeg file with Qrcode signature right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website. Free online demo waiting for you.
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with G S1 Q R Qrcode using Java"
    content: |
        Java G S1 Q R Qrcode signatures management API for documents and images. Add G S1 Q R Qrcode signatures to some of the popular file formats as stated below.
    format: 
