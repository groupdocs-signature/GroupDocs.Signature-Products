...
############################# Head ############################
head_title: "Java içinde QR QR Kodu ile Webp belgesini eSign"
head_description: "QR QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Webp dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Webp belgesi için QR QR Kodu imzası oluşturun"
description: "Webp belgelerinizi ve sözleşmelerinizi QR QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR Kodu (Hızlı Yanıt Kodundan kısaltılmıştır), bir tür matris barkodunun (veya iki boyutlu barkodun) ticari markasıdır. En popüler ve yaygın olarak kullanılan iki boyutlu kod türüdür. Pratikte, QR kodları genellikle bir web sitesine veya uygulamaya işaret eden bir konumlandırıcı, tanımlayıcı veya izleyici için veriler içerir.
          characterset: |
             256 ASCII karakterin tümü + Kanji
          textcapacity: |
             7089'a kadar sayısal karakter, 4296 alfasayısal karakter, 2953 bayt (ikili veri) veya 1817 Kanji karakteri.
          image: |
