...
############################# Head ############################
head_title: "eSign Docx ሰነድ በData Matrix QR ኮድ በJava"
head_description: "Data Matrix QR ኮድ ይፍጠሩ እና በDocx ፋይል ላይ Javaን በመጠቀም በአጭር የJava ኮድ ያስቀምጡት። የንግድ ሰነዶችዎን እና ፋይሎችዎን በQR ኮድ ኢ-ለመፈረም የGroupDocs ሰነድ ፊርማ ኤፒአይ ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለDocx ሰነድ የData Matrix QR ኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Docx ሰነዶች እና ኮንትራቶች በData Matrix QR ኮድ ይፈርሙ። የQR ኮድ ፊርማ በፍጥነት እና በቀላሉ ይፍጠሩ።"
...
steps:
    enable: true
    title_left: "Docxን በQrcode በJava ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የDocx ሰነዶችን በQrcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
