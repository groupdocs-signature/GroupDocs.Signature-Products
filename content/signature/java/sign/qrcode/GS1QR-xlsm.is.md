...
############################# Head ############################
head_title: "eSign Xlsm skjal með G S1 Q R QR kóða í Java"
head_description: "Búðu til G S1 Q R QR kóða og settu hann á Xlsm skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til G S1 Q R QR kóða undirskrift fyrir Xlsm skjal í Java"
description: "eSignaðu Xlsm skjölin þín og samninga með G S1 Q R QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Xlsm með Qrcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Xlsm skjöl með Qrcode undirskrift fljótt og auðveldlega.
