...
############################# Head ############################
head_title: "eSign Xls documento con QR codice QR in Java"
head_description: "Crea il codice QR QR e inseriscilo nel file Xls utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera QR firma del codice QR per il documento Xls in Java"
