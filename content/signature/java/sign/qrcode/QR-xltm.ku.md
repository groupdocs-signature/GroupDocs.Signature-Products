...
############################# Head ############################
head_title: "Belgeya eSign Xltm bi QR Koda QR di Java"
head_description: "Koda QR-a QR biafirînin û bi koda Java bi koda Java li pelê Xltm bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di Java de ji bo belgeya QR îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên Xltm bi koda QR-a QR îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Xltm bi Qrcode di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Xltm bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
