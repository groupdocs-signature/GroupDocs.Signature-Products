...
############################# Head ############################
head_title: "eSign Ppsm dokumen dengan Aztec QR Code dalam Java"
head_description: "Cipta Aztec Kod QR dan letakkan pada fail Ppsm menggunakan Java dengan sekeping pendek kod Java. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan Aztec tandatangan Kod QR untuk Ppsm dokumen dalam Java"
description: "eTandatangani dokumen dan kontrak Ppsm anda dengan Kod QR Aztec. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Ppsm dengan Qrcode dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Ppsm dengan tandatangan Qrcode dengan cepat dan mudah.
        
        * Buat contoh kelas Tandatangan yang menyediakan fail Ppsm yang sepatutnya ditandatangani sebagai laluan atau aliran memori
        * Segerakan kelas SignOptions dan tetapkan semua data yang diminta.
        * Guna kaedah Signature.Sign() yang menghantar fail keluaran Ppsm atau aliran memori
...
demos:
    ...
    content: |
       Tandatangani fail Ppsm dengan pelbagai tandatangan sekarang dengan melawati tapak web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo dalam talian percuma menanti anda.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Kod Aztec ialah simbol matriks tujuan am dua dimensi (2-D) yang direka bentuk untuk mempunyai ketepatan yang lebih tinggi daripada simbolologi 2-D yang lain. Simbol Kod Aztec boleh mengekod sehingga 3,832 digit berangka; 3,067 aksara abjad; atau 1,914 bait data.
          characterset: |
             Semua 256 aksara ASCII.
          textcapacity: |
             Sehingga 3,832 digit angka, atau 3,067 aksara abjad, atau 1,914 bait data.
          image: |
...
more_formats:
    ...
    content: |
        "Anda juga boleh menandatangani Ppsm dengan jenis tandatangan lain. Sila lihat senarai di bawah."
    format: 
