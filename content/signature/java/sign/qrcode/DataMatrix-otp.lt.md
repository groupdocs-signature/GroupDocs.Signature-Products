...
############################# Head ############################
head_title: "eSign Otp dokumentas su Data Matrix QR kodu Java"
head_description: "Sukurkite QR kodą Data Matrix ir įdėkite jį į failą Otp naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite Data Matrix QR kodo parašą Otp dokumentui Java"
description: "e. Pasirašykite Otp dokumentus ir sutartis naudodami Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Otp naudojant Qrcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Otp dokumentus su Qrcode parašais.
...
demos:
    enable: true
    title: "Dokumentų Otp pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
