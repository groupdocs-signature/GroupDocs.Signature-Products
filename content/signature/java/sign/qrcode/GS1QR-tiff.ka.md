...
############################# Head ############################
head_title: "eSign Tiff დოკუმენტი G S1 Q R QR კოდით Java-ში"
head_description: "შექმენით G S1 Q R QR კოდი და განათავსეთ ის Tiff ფაილზე Java-ის გამოყენებით Java კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით G S1 Q R QR კოდის ხელმოწერა Tiff დოკუმენტისთვის Java-ში"
description: "მოაწერეთ თქვენი Tiff დოკუმენტები და კონტრაქტები G S1 Q R QR კოდით. შექმენით QR კოდის ხელმოწერა სწრაფად და მარტივად."
...
steps:
    enable: true
    title_left: "Tiff-ით ხელმოწერის ნაბიჯები Qrcode-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Tiff დოკუმენტები Qrcode ხელმოწერებით სწრაფად და მარტივად.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR კოდი არის QR კოდის ვარიანტი, რომელიც შეესაბამება GS1 სპეციფიკაციებს. ის სპეციალურად შეიქმნა შეფუთვის გაფართოებული ინფორმაციის გასაზიარებლად, როგორიცაა ლოტის ნომერი, პროდუქტის ID და რაოდენობა.
          characterset: |
             დიდი და პატარა ასოები და სპეციალური სიმბოლოები $%*+-./: ყველა სწორი განაცხადის იდენტიფიკატორებით
          textcapacity: |
             7089-მდე რიცხვითი სიმბოლო, 4296 ალფანუმერული სიმბოლო
          image: |
