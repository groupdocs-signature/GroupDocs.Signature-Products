...
############################# Head ############################
head_title: "Dokument eSign Wmf s G S1 Q R QR kódem v Java"
head_description: "Vytvořte QR kód G S1 Q R a vložte jej do souboru Wmf pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis G S1 Q R QR kódu pro dokument Wmf v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Wmf pomocí QR kódu G S1 Q R. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Wmf pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Wmf pomocí podpisů Qrcode.
        
        * Vytvořte instanci třídy Signature poskytující soubor Wmf, který se má podepisovat jako cesta nebo proud paměti
        * Instantujte třídu SignOptions a nastavte všechna požadovaná data.
        * Vyvolejte metodu Signature.Sign() předáním výstupního souboru Wmf nebo proudu paměti
...
demos:
    enable: true
    title: "Podepisování dokumentů Wmf pomocí živé ukázky Qrcode"
    content: |
       Podepište soubor Wmf pomocí různých podpisů právě teď na webu [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čeká.
...
more_formats:
    ...
    content: |
        "Můžete také podepsat Wmf pomocí jiných typů podpisů. Podívejte se prosím na níže uvedený seznam."
    format: 
