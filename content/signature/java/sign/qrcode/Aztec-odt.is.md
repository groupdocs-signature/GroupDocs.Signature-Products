...
############################# Head ############################
head_title: "eSign Odt skjal með Aztec QR kóða í Java"
head_description: "Búðu til Aztec QR kóða og settu hann á Odt skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til Aztec QR kóða undirskrift fyrir Odt skjal í Java"
description: "eSignaðu Odt skjölin þín og samninga með Aztec QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Odt með Qrcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Odt skjöl með Qrcode undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Odt skjöl með Qrcode lifandi kynningu"
    content: |
