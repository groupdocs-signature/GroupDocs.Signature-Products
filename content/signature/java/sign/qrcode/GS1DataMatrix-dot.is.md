...
############################# Head ############################
head_title: "eSign Dot skjal með G S1 Data Matrix QR kóða í Java"
head_description: "Búðu til G S1 Data Matrix QR kóða og settu hann á Dot skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til G S1 Data Matrix QR kóða undirskrift fyrir Dot skjal í Java"
description: "eSignaðu Dot skjölin þín og samninga með G S1 Data Matrix QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Dot með Qrcode í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Dot skjöl með Qrcode undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Dot skjöl með Qrcode lifandi kynningu"
    content: |
