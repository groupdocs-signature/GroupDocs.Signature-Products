...
############################# Head ############################
head_title: "eSign Docm -asiakirja QR QR-koodilla Java"
head_description: "Luo QR-koodi QR ja laita se Docm-tiedostoon käyttämällä Java lyhyttä Java-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo QR QR-koodiallekirjoitus asiakirjalle Docm kohteessa Java"
description: "eAllekirjoita Docm-asiakirjat ja sopimukset QR-koodilla QR. Luo QR-koodin allekirjoitus nopeasti ja helposti."
...
steps:
    enable: true
    title_left: "Vaiheet Docm:n allekirjoittamiseen Qrcode -sovelluksella Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tarjoaa mahdollisuuden allekirjoittaa Docm-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR Code (lyhenne sanoista Quick Response Code) on tavaramerkki matriisiviivakoodille (tai kaksiulotteiselle viivakoodille). Se on suosituin ja laajimmin käytetty kaksiulotteisen koodin tyyppi. Käytännössä QR-koodit sisältävät usein tietoja paikantimelle, tunnisteelle tai seurantaohjelmalle, joka osoittaa verkkosivustolle tai sovellukseen.
          characterset: |
             Kaikki 256 ASCII-merkkiä + Kanji
          textcapacity: |
             Enintään 7089 numeerista merkkiä, 4296 aakkosnumeerista merkkiä, 2953 tavua (binääridata) tai 1817 kanji-merkkiä.
          image: |
