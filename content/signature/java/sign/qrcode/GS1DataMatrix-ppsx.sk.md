...
############################# Head ############################
head_title: "eSign Ppsx dokument s G S1 Data Matrix QR kódom v Java"
head_description: "Vytvorte G S1 Data Matrix QR kód a vložte ho do súboru Ppsx pomocou Java s krátkym kódom Java. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte G S1 Data Matrix podpis QR kódu pre dokument Ppsx v Java"
description: "ePodpíšte svoje Ppsx dokumenty a zmluvy pomocou G S1 Data Matrix QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Ppsx pomocou Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Ppsx pomocou podpisov Qrcode.
        
        * Vytvorte inštanciu triedy Signature poskytujúcej súbor Ppsx, ktorý sa má podpisovať ako cesta alebo prúd pamäte
        * Instanciujte triedu SignOptions a nastavte všetky požadované údaje.
        * Vyvolajte metódu Signature.Sign() odovzdajúc výstupný súbor Ppsx alebo prúd pamäte
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Ppsx pomocou živej ukážky Qrcode"
    content: |
       Podpíšte súbor Ppsx pomocou rôznych podpisov práve teraz na webovej lokalite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čaká.
...
more_formats:
    ...
    content: |
        "Ppsx môžete podpísať aj inými typmi podpisov. Pozrite si zoznam nižšie."
    format: 
