...
############################# Head ############################
head_title: "eSign Xlsx dokument s Data Matrix QR kodom u Java"
head_description: "Napravite Data Matrix QR kod i stavite ga u datoteku Xlsx koristeći Java s kratkim dijelom Java koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj Data Matrix potpis QR koda za Xlsx dokument u Java"
description: "ePotpišite svoje Xlsx dokumente i ugovore s Data Matrix QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xlsx s Qrcode u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Xlsx dokumenata s Qrcode potpisima.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix je dvodimenzionalni kod koji se sastoji od crnih i bijelih 'ćelija' ili točaka raspoređenih u kvadratni ili pravokutni uzorak, također poznat kao matrica. Informacije koje treba kodirati mogu biti tekstualni ili numerički podaci.
          characterset: |
             Podržava svih 256 ASCII znakova, sve ISO znakove i sve znakove Extended Binary Coded Decimal Interchange Code (EBCDIC).
          textcapacity: |
             Do 3116 numeričkih znamenki, ili 2335 alfanumeričkih znakova, ili 1556 binarnih znakova.
          image: |
