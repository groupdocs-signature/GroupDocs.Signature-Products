...
############################# Head ############################
head_title: "Java میں G S1 Data Matrix QR کوڈ کے ساتھ eSign Odt دستاویز"
head_description: "G S1 Data Matrix QR کوڈ بنائیں اور اسے Java کا استعمال کرتے ہوئے Java کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Odt فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "Java میں Odt دستاویز کے لیے G S1 Data Matrix QR کوڈ دستخط بنائیں"
description: "اپنے Odt دستاویزات اور معاہدوں پر G S1 Data Matrix QR کوڈ کے ساتھ دستخط کریں۔ QR کوڈ دستخط جلدی اور آسانی سے بنائیں۔"
...
steps:
    enable: true
    title_left: "Java میں Qrcode کے ساتھ Odt پر دستخط کرنے کے مراحل"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) جلد اور آسانی سے Qrcode دستخطوں کے ساتھ Odt دستاویزات پر دستخط کرنے کی صلاحیت فراہم کرتا ہے۔
...
demos:
    enable: true
    title: "Qrcode لائیو ڈیمو کے ساتھ Odt دستاویزات پر دستخط کرنا"
    content: |
