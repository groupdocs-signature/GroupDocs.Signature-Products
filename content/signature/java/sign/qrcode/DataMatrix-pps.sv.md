...
############################# Head ############################
head_title: "eSign Pps-dokument med Data Matrix QR-kod i Java"
head_description: "Skapa Data Matrix QR-kod och lägg den i filen Pps med Java med en kort bit av Java-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera Data Matrix QR-kodsignatur för Pps dokument i Java"
description: "esignera dina Pps-dokument och kontrakt med Data Matrix QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Pps med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Pps-dokument med Qrcode-signaturer snabbt och enkelt.
