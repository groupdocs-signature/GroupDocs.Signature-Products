...
############################# Head ############################
head_title: "eSign Docx dokument s QR QR kodom u Java"
head_description: "Napravite QR QR kod i stavite ga u datoteku Docx koristeći Java s kratkim dijelom Java koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj QR potpis QR koda za Docx dokument u Java"
description: "ePotpišite svoje Docx dokumente i ugovore s QR QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR kod (skraćeno od Quick Response Code) zaštitni je znak za vrstu matričnog barkoda (ili dvodimenzionalnog barkoda). To je najpopularnija i najraširenija vrsta dvodimenzionalnog koda. U praksi, QR kodovi često sadrže podatke za lokator, identifikator ili tragač koji upućuje na web mjesto ili aplikaciju.
          characterset: |
             Svih 256 ASCII znakova + Kanji
          textcapacity: |
             Do 7089 numeričkih znakova, 4296 alfanumeričkih znakova, 2953 bajta (binarni podaci) ili 1817 Kanji znakova.
          image: |
