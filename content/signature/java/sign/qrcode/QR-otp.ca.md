...
############################# Head ############################
head_title: "Document electrònic Otp amb codi QR QR a Java"
head_description: "Creeu QR codi QR i col·loqueu-lo al fitxer Otp amb Java amb un tros curt de codi Java. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de QR per al document Otp a Java"
description: "eSigneu els vostres documents i contractes de Otp amb el codi QR de QR. Genereu la signatura del codi QR de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Passos per signar Otp amb Qrcode a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Otp amb signatures Qrcode de manera ràpida i senzilla.
