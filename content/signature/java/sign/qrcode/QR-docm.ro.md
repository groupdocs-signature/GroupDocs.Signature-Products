...
############################# Head ############################
head_title: "eSign documentul Docm cu codul QR QR în Java"
head_description: "Creați codul QR QR și puneți-l în fișierul Docm folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura QR cod QR pentru documentul Docm în Java"
description: "eSemnați documentele și contractele Docm cu codul QR QR. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Docm cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Docm cu semnături Qrcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Docm cu Qrcode Live Demo"
    content: |
