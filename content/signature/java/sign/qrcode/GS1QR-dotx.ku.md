...
############################# Head ############################
head_title: "Belgeya eSign Dotx bi G S1 Q R Koda QR di Java"
head_description: "Koda QR-a G S1 Q R biafirînin û bi koda Java bi koda Java li pelê Dotx bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di Java de ji bo belgeya G S1 Q R îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên Dotx bi koda QR-a G S1 Q R îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Dotx bi Qrcode di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Dotx bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Dotx bi Qrcode Demoya Zindî"
    content: |
