...
############################# Head ############################
head_title: "eSign Potx έγγραφο με G S1 Q R QR Code στο Java"
head_description: "Δημιουργήστε G S1 Q R κώδικα QR και τοποθετήστε τον σε αρχείο Potx χρησιμοποιώντας το Java με ένα σύντομο κομμάτι κώδικα Java. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε ηλεκτρονικά τα έγγραφα και τα αρχεία της επιχείρησής σας με QR Code."

############################# Header ############################
title: "Δημιουργήστε G S1 Q R υπογραφή κώδικα QR για το έγγραφο Potx στο Java"
description: "Ηλεκτρονικά υπογράψτε τα έγγραφα και τις συμβάσεις του Potx με τον κωδικό QR G S1 Q R. Δημιουργήστε υπογραφή κωδικού QR γρήγορα και εύκολα."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Το GS1 QR Code είναι μια παραλλαγή του QR Code που συμμορφώνεται με τις προδιαγραφές GS1. Σχεδιάστηκε ειδικά για την κοινή χρήση εκτεταμένων πληροφοριών συσκευασίας, όπως αριθμός παρτίδας, αναγνωριστικό προϊόντος και ποσότητα.
          characterset: |
             Κεφάλαια και πεζά γράμματα και ειδικοί χαρακτήρες $%*+-./: όλα με σωστά αναγνωριστικά εφαρμογής
          textcapacity: |
             Έως 7089 αριθμητικοί χαρακτήρες, 4296 αλφαριθμητικοί χαρακτήρες
          image: |
