...
############################# Head ############################
head_title: "eSign Ppt documento com Aztec QR Code em Java"
head_description: "Crie Aztec QR Code e coloque-o no arquivo Ppt usando Java com um pequeno pedaço de código Java. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere Aztec assinatura de QR Code para Ppt documento em Java"
description: "Assine seus documentos e contratos Ppt com Aztec QR Code. Gere assinatura de QR Code de forma rápida e fácil."
