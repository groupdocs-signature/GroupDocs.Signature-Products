...
############################# Head ############################
head_title: "eSign Dotm tài liệu với G S1 Q R Mã QR trong Java"
head_description: "Tạo Mã QR G S1 Q R và đặt nó vào tệp Dotm bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Q R cho tài liệu Dotm trong Java"
description: "eSign các tài liệu và hợp đồng Dotm của bạn bằng Mã QR G S1 Q R. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
