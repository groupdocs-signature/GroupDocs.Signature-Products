...
############################# Head ############################
head_title: "在 Java 中带有 G S1 Data Matrix QR 码的 eSign Bmp 文档"
head_description: "创建 G S1 Data Matrix 二维码并使用 Java 和一小段 Java 代码将其放在 Bmp 文件中。使用 GroupDocs 文档签名 API 使用 QR 码对您的业务文档和文件进行电子签名。"

############################# Header ############################
title: "在 Java 中为 Bmp 文档生成 G S1 Data Matrix 二维码签名"
description: "使用 G S1 Data Matrix 二维码对您的 Bmp 文档和合同进行电子签名。快速轻松地生成二维码签名。"
