...
############################# Head ############################
head_title: "eSign Xlsm dokumentum Data Matrix QR-kóddal a Java nyelven"
head_description: "Hozzon létre Data Matrix QR-kódot, és helyezze el a Xlsm fájlba a Java használatával egy rövid Java kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon Data Matrix QR-kód aláírást a Xlsm dokumentumhoz a Java programban"
description: "eAláírja Xlsm dokumentumait és szerződéseit Data Matrix QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
...
steps:
    enable: true
    title_left: "A Xlsm aláírásának lépései a Qrcode segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Xlsm dokumentumok gyors és egyszerű aláírását Qrcode aláírással.
        
        * Hozzon létre egy példányt a Signature osztályból, amely Xlsm fájlt tartalmaz, amelyet elérési útként vagy memóriafolyamként kell aláírni
        * Példányosítsa a SignOptions osztályt, és állítsa be az összes kért adatot.
        * Hívja meg a Signature.Sign() metódust, amely átadja a kimeneti Xlsm fájlt vagy memóriafolyamot
...
demos:
    enable: true
    title: "Xlsm dokumentumok aláírása Qrcode élő bemutatóval"
    content: |
...
more_formats:
    ...
    content: |
        "A Xlsm más aláírástípusokkal is aláírható. Kérjük, tekintse meg az alábbi listát."
    format: 
