...
############################# Head ############################
head_title: "Java içinde Data Matrix QR Kodu ile Xlsm belgesini eSign"
head_description: "Data Matrix QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Xlsm dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Xlsm belgesi için Data Matrix QR Kodu imzası oluşturun"
description: "Xlsm belgelerinizi ve sözleşmelerinizi Data Matrix QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
steps:
    enable: true
    title_left: "Java içinde Qrcode ile Xlsm imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Xlsm belgelerini Qrcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Xlsm dokümanı Qrcode Canlı Demo ile imzalama"
    content: |
