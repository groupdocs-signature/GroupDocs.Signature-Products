...
############################# Head ############################
head_title: "eSign Odp dokuments ar G S1 Data Matrix QR kodu programmā Java"
head_description: "Izveidojiet G S1 Data Matrix QR kodu un ievietojiet to failā Odp, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Data Matrix QR koda parakstu dokumentam Odp programmā Java"
description: "eParakstiet savus Odp dokumentus un līgumus ar G S1 Data Matrix QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Odp ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Odp dokumentus ar Qrcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Odp parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
