...
############################# Head ############################
head_title: "eSign Png dokument Aztec QR-koodiga rakenduses Java"
head_description: "Looge QR-kood Aztec ja sisestage see faili Png, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Png QR-koodi allkiri Aztec"
description: "eAllkirjasta oma Png dokumendid ja lepingud QR-koodiga Aztec. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Png allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Png dokumente Qrcode allkirjaga.
