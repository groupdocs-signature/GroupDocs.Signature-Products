...
############################# Head ############################
head_title: "eSign Docm-dokument met QR QR-kode in Java"
head_description: "Skep QR QR-kode en plaas dit op Docm-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer QR QR-kode handtekening vir Docm dokument in Java"
description: "eTeken jou Docm dokumente en kontrakte met QR QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Docm met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Docm dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Docm dokumente met Qrcode Regstreekse Demo"
    content: |
...
more_formats:
    ...
    content: |
        "Jy kan ook Docm met ander handtekeningtipes onderteken. Sien asseblief die lys hieronder."
    format: 
