...
############################# Head ############################
head_title: "eSign Dotx dokumen dengan Aztec QR Code di Java"
head_description: "Buat Kode QR Aztec dan letakkan di file Dotx menggunakan Java dengan potongan pendek kode Java. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat Aztec tanda tangan Kode QR untuk dokumen Dotx di Java"
description: "eTandatangani dokumen dan kontrak Dotx Anda dengan Kode QR Aztec. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Kode Aztec adalah simbologi matriks tujuan umum dua dimensi (2-D) yang dirancang untuk memiliki akurasi lebih tinggi daripada simbologi 2-D lainnya. Simbol Kode Aztec dapat mengkodekan hingga 3.832 digit angka; 3.067 karakter alfabet; atau 1.914 byte data.
          characterset: |
             Semua 256 karakter ASCII.
          textcapacity: |
             Hingga 3.832 digit numerik, atau 3.067 karakter alfabet, atau 1.914 byte data.
          image: |
