...
description: "eSínigh do dhoiciméid agus conarthaí Ppt le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Ppt doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
