...
############################# Head ############################
head_title: "eSign Ots dokuments ar G S1 Q R QR kodu programmā Java"
head_description: "Izveidojiet G S1 Q R QR kodu un ievietojiet to failā Ots, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Q R QR koda parakstu dokumentam Ots programmā Java"
description: "eParakstiet savus Ots dokumentus un līgumus ar G S1 Q R QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Ots ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Ots dokumentus ar Qrcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Ots parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
