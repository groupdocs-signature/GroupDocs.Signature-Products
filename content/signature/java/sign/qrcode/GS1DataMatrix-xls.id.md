...
############################# Head ############################
head_title: "eSign Xls dokumen dengan G S1 Data Matrix QR Code di Java"
head_description: "Buat Kode QR G S1 Data Matrix dan letakkan di file Xls menggunakan Java dengan potongan pendek kode Java. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat G S1 Data Matrix tanda tangan Kode QR untuk dokumen Xls di Java"
description: "eTandatangani dokumen dan kontrak Xls Anda dengan Kode QR G S1 Data Matrix. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xls dengan Qrcode di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Xls dengan Qrcode tanda tangan dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Xls dengan Qrcode Demo Langsung"
    content: |
