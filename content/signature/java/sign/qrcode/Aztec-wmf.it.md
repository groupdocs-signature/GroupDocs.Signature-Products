...
############################# Head ############################
head_title: "eSign Wmf documento con Aztec codice QR in Java"
head_description: "Crea il codice QR Aztec e inseriscilo nel file Wmf utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Aztec firma del codice QR per il documento Wmf in Java"
description: "Firma i tuoi documenti e contratti Wmf con il codice QR Aztec. Genera la firma del codice QR in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Wmf con Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Wmf con firme Qrcode in modo rapido e semplice.
