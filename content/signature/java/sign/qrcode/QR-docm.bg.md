...
############################# Head ############################
head_title: "eSign Docm документ с QR QR код в Java"
head_description: "Създайте QR QR код и го поставете във файл Docm, като използвате Java с кратка част от Java код. Използвайте API за подписване на документи на GroupDocs, за да подпишете електронно вашите бизнес документи и файлове с QR код."

############################# Header ############################
title: "Генерирайте QR QR Code подпис за Docm документ в Java"
description: "Електронно подпишете вашите Docm документи и договори с QR QR код. Генерирайте QR код подпис бързо и лесно."
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Docm с Qrcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на Docm документи с Qrcode подписи.
...
demos:
    enable: true
    title: "Подписване на Docm документи с Qrcode Демо на живо"
    content: |
