...
############################# Head ############################
head_title: "eSign Xltx-dokument met G S1 Data Matrix QR-kode in Java"
head_description: "Skep G S1 Data Matrix QR-kode en plaas dit op Xltx-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR-kode handtekening vir Xltx dokument in Java"
description: "eTeken jou Xltx dokumente en kontrakte met G S1 Data Matrix QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Xltx met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Xltx dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
        ...
        * Roep die Signature.Sign()-metode deur die uitvoer Xltx-lêer of geheuestroom deur te gee
...
demos:
    enable: true
    title: "Teken Xltx dokumente met Qrcode Regstreekse Demo"
    content: |
