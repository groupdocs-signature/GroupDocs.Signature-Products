...
############################# Head ############################
head_title: "eSign Xlsb doiciméad le G S1 Data Matrix Cód QR in Java"
head_description: "Cruthaigh G S1 Data Matrix Cód QR agus cuir ar chomhad Xlsb é ag úsáid Java le píosa gairid de chód Java. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR G S1 Data Matrix don doiciméad Xlsb in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Xlsb a shíniú le Qrcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Xlsb a shíniú le sínithe Qrcode go tapa agus go héasca.
