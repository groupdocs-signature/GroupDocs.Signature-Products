...
############################# Head ############################
head_title: "eSign Odt დოკუმენტი G S1 Data Matrix QR კოდით Java-ში"
head_description: "შექმენით G S1 Data Matrix QR კოდი და განათავსეთ ის Odt ფაილზე Java-ის გამოყენებით Java კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით G S1 Data Matrix QR კოდის ხელმოწერა Odt დოკუმენტისთვის Java-ში"
...
steps:
    enable: true
    title_left: "Odt-ით ხელმოწერის ნაბიჯები Qrcode-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Odt დოკუმენტები Qrcode ხელმოწერებით სწრაფად და მარტივად.
