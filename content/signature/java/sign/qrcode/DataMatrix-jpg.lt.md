...
############################# Head ############################
head_title: "eSign Jpg dokumentas su Data Matrix QR kodu Java"
head_description: "Sukurkite QR kodą Data Matrix ir įdėkite jį į failą Jpg naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite Data Matrix QR kodo parašą Jpg dokumentui Java"
description: "e. Pasirašykite Jpg dokumentus ir sutartis naudodami Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Jpg naudojant Qrcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Jpg dokumentus su Qrcode parašais.
        
        * Sukurkite parašo klasės egzempliorių, pateikiantį Jpg failą, kuris turėtų būti pasirašytas kaip kelias arba atminties srautas
        * Sukurkite SignOptions klasę ir nustatykite visus reikalingus duomenis.
        * Iškvieskite Signature.Sign() metodą, perduodantį išvesties Jpg failą arba atminties srautą
...
demos:
    enable: true
    title: "Dokumentų Jpg pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
       Pasirašykite Jpg failą įvairiais parašais dabar apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje. Jūsų laukia nemokama internetinė demonstracinė versija.
...
more_formats:
    ...
    content: |
        "Taip pat galite pasirašyti Jpg naudodami kitų tipų parašus. Žiūrėkite žemiau esantį sąrašą."
    format: 
