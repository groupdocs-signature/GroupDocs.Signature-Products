...
############################# Head ############################
head_title: "eSign Ppsx tài liệu với Data Matrix Mã QR trong Java"
head_description: "Tạo Mã QR Data Matrix và đặt nó vào tệp Ppsx bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR Data Matrix cho tài liệu Ppsx trong Java"
description: "eSign các tài liệu và hợp đồng Ppsx của bạn bằng Mã QR Data Matrix. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Ma trận dữ liệu là một mã hai chiều bao gồm các 'ô' hoặc chấm màu đen và trắng được sắp xếp theo hình vuông hoặc hình chữ nhật, còn được gọi là ma trận. Thông tin được mã hóa có thể là dữ liệu văn bản hoặc số.
          characterset: |
             Hỗ trợ tất cả 256 ký tự ASCII, tất cả các ký tự ISO và tất cả các ký tự Mã trao đổi thập phân được mã hóa nhị phân mở rộng (EBCDIC).
          textcapacity: |
             Lên đến 3116 ký tự số hoặc 2335 ký tự số alpha hoặc 1556 ký tự nhị phân.
          image: |
