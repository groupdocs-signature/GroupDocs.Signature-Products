...
############################# Head ############################
head_title: "eSign Svg documento com Aztec QR Code em Java"
head_description: "Crie Aztec QR Code e coloque-o no arquivo Svg usando Java com um pequeno pedaço de código Java. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere Aztec assinatura de QR Code para Svg documento em Java"
description: "Assine seus documentos e contratos Svg com Aztec QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Svg com Qrcode em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Svg com assinaturas Qrcode de forma rápida e fácil.
