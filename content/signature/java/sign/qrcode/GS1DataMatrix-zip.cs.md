...
############################# Head ############################
head_title: "Dokument eSign Zip s G S1 Data Matrix QR kódem v Java"
head_description: "Vytvořte QR kód G S1 Data Matrix a vložte jej do souboru Zip pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis G S1 Data Matrix QR kódu pro dokument Zip v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Zip pomocí QR kódu G S1 Data Matrix. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Zip pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Zip pomocí podpisů Qrcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Zip pomocí živé ukázky Qrcode"
    content: |
