...
############################# Head ############################
head_title: "Dokument eSign Pdf s Aztec QR kódem v Java"
head_description: "Vytvořte QR kód Aztec a vložte jej do souboru Pdf pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis Aztec QR kódu pro dokument Pdf v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Pdf pomocí QR kódu Aztec. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Pdf pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Pdf pomocí podpisů Qrcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Pdf pomocí živé ukázky Qrcode"
    content: |
