...
############################# Head ############################
head_title: "Dokument eSign Pptm s Aztec QR kódem v Java"
head_description: "Vytvořte QR kód Aztec a vložte jej do souboru Pptm pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis Aztec QR kódu pro dokument Pptm v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Pptm pomocí QR kódu Aztec. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Pptm pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Pptm pomocí podpisů Qrcode.
        
        * Vytvořte instanci třídy Signature poskytující soubor Pptm, který se má podepisovat jako cesta nebo proud paměti
        * Instantujte třídu SignOptions a nastavte všechna požadovaná data.
        * Vyvolejte metodu Signature.Sign() předáním výstupního souboru Pptm nebo proudu paměti
...
demos:
    enable: true
    title: "Podepisování dokumentů Pptm pomocí živé ukázky Qrcode"
    content: |
       Podepište soubor Pptm pomocí různých podpisů právě teď na webu [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čeká.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztécký kód je dvourozměrná (2-D) maticová symbolika pro obecné účely, která je navržena tak, aby měla vyšší přesnost než jiné 2-D symboliky. Symbol aztéckého kódu může zakódovat až 3 832 číslic; 3 067 abecedních znaků; nebo 1 914 bajtů dat.
          characterset: |
             Všech 256 znaků ASCII.
          textcapacity: |
             Až 3 832 numerických číslic nebo 3 067 abecedních znaků nebo 1 914 bajtů dat.
          image: |
...
more_formats:
    ...
    content: |
        "Můžete také podepsat Pptm pomocí jiných typů podpisů. Podívejte se prosím na níže uvedený seznam."
    format: 
