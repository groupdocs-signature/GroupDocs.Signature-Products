...
############################# Head ############################
head_title: "Java में G S1 Q R QR कोड के साथ eSign Ppsx दस्तावेज़"
head_description: "G S1 Q R QR कोड बनाएं और Java कोड के एक छोटे टुकड़े के साथ Java का उपयोग करके इसे Ppsx फ़ाइल में डालें। QR कोड के साथ अपने व्यावसायिक दस्तावेज़ों और फ़ाइलों पर ई-हस्ताक्षर करने के लिए GroupDocs दस्तावेज़ हस्ताक्षर API का उपयोग करें।"

############################# Header ############################
title: "Java में Ppsx दस्तावेज़ के लिए G S1 Q R QR कोड हस्ताक्षर जेनरेट करें"
description: "अपने Ppsx दस्तावेज़ों और अनुबंधों पर G S1 Q R QR कोड के साथ ई-हस्ताक्षर करें। क्यूआर कोड हस्ताक्षर जल्दी और आसानी से उत्पन्न करें।"
...
steps:
    enable: true
    title_left: "Java में Qrcode के साथ Ppsx पर हस्ताक्षर करने के चरण"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) जल्दी और आसानी से Qrcode हस्ताक्षर के साथ Ppsx दस्तावेज़ों पर हस्ताक्षर करने की क्षमता प्रदान करता है।
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            जीएस1 क्यूआर कोड क्यूआर कोड का एक प्रकार है जो जीएस1 विनिर्देशों के अनुरूप है। इसे विशेष रूप से विस्तारित पैकेजिंग जानकारी, जैसे लॉट नंबर, उत्पाद आईडी और मात्रा साझा करने के लिए डिज़ाइन किया गया था।
          characterset: |
             अपर और लोअर केस लेटर्स और स्पेशल कैरेक्टर $%*+-./: सभी सही एप्लीकेशन आइडेंटिफायर के साथ
          textcapacity: |
             अधिकतम 7089 अंकीय वर्ण, 4296 अक्षरांकीय वर्ण
          image: |
