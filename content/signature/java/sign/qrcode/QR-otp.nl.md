...
############################# Head ############################
head_title: "eSign Otp document met QR QR-code in Java"
head_description: "Maak een QR QR-code en plaats deze in het Otp-bestand met behulp van Java met een kort stukje Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer QR QR Code handtekening voor Otp document in Java"
description: "Onderteken uw Otp documenten en contracten met QR QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
