...
############################# Head ############################
head_title: "eSign Dot dokumen dengan Data Matrix QR Code dalam Java"
head_description: "Cipta Data Matrix Kod QR dan letakkan pada fail Dot menggunakan Java dengan sekeping pendek kod Java. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan Data Matrix tandatangan Kod QR untuk Dot dokumen dalam Java"
description: "eTandatangani dokumen dan kontrak Dot anda dengan Kod QR Data Matrix. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Dot dengan Qrcode dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Dot dengan tandatangan Qrcode dengan cepat dan mudah.
