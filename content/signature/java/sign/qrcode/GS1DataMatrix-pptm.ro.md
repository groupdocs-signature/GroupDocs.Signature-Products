...
############################# Head ############################
head_title: "eSign documentul Pptm cu codul QR G S1 Data Matrix în Java"
head_description: "Creați codul QR G S1 Data Matrix și puneți-l în fișierul Pptm folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura G S1 Data Matrix cod QR pentru documentul Pptm în Java"
description: "eSemnați documentele și contractele Pptm cu codul QR G S1 Data Matrix. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Pptm cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Pptm cu semnături Qrcode rapid și ușor.
        
        * Creați o instanță a clasei Signature care furnizează fișierul Pptm care ar trebui să se semneze ca cale sau flux de memorie
        * Instanțiați clasa SignOptions și setați toate datele solicitate.
        * Invocați metoda Signature.Sign() pasând fișierul de ieșire Pptm sau fluxul de memorie
...
demos:
    enable: true
    title: "Semnează documente Pptm cu Qrcode Live Demo"
    content: |
       Semnați fișierul Pptm cu diferite semnături chiar acum, vizitând site-ul web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo online gratuită vă așteaptă.
...
more_formats:
    ...
    content: |
        "De asemenea, puteți semna Pptm cu alte tipuri de semnături. Vă rugăm să vedeți lista de mai jos."
    format: 
