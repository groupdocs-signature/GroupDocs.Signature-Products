...
############################# Head ############################
head_title: "eSign Docm skjal með G S1 Data Matrix QR kóða í Java"
head_description: "Búðu til G S1 Data Matrix QR kóða og settu hann á Docm skrá með því að nota Java með stuttu stykki af Java kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til G S1 Data Matrix QR kóða undirskrift fyrir Docm skjal í Java"
description: "eSignaðu Docm skjölin þín og samninga með G S1 Data Matrix QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
demos:
    enable: true
    title: "Undirritar Docm skjöl með Qrcode lifandi kynningu"
    content: |
       Skrifaðu undir Docm skrána með ýmsum undirskriftum núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna. Ókeypis kynning á netinu bíður þín.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix er afbrigði af Data Matrix sem er í samræmi við GS1 forskriftir. Notaðu GS1 DataMatrix til að kóða upplýsingarnar eins og, en takmarkast ekki við, eftirfarandi: AI(01) Global Trade Item Number (GTIN), AI(17) Fyrningardagsetning, AI(10) Lotunúmer, AI(21) Raðnúmer .
          characterset: |
             Stafasett: há- og lágstafir og sérstafir $@%*+-./:=<>;&*_,'! allt með réttum forritaauðkennum.
          textcapacity: |
             Getu kóðatexta: allt að 3116 tölustafir, eða 2335 alfa tölustafir.
          image: |
...
more_formats:
    enable: true
    title: "Aðrar studdar Qrcode undirskriftir fyrir Java"
    content: |
        "Þú getur líka skrifað undir Docm með öðrum undirskriftartegundum. Vinsamlegast skoðaðu listann hér að neðan."
    format: 
