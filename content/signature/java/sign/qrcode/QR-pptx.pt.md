...
############################# Head ############################
head_title: "eSign Pptx documento com QR QR Code em Java"
head_description: "Crie QR QR Code e coloque-o no arquivo Pptx usando Java com um pequeno pedaço de código Java. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere QR assinatura de QR Code para Pptx documento em Java"
...
steps:
    enable: true
    title_left: "Etapas para assinar Pptx com Qrcode em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Pptx com assinaturas Qrcode de forma rápida e fácil.
