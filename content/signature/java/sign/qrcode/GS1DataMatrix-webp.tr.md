...
############################# Head ############################
head_title: "Java içinde G S1 Data Matrix QR Kodu ile Webp belgesini eSign"
head_description: "G S1 Data Matrix QR Kodu oluşturun ve kısa bir Java kodu parçasıyla Java kullanarak Webp dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Java içinde Webp belgesi için G S1 Data Matrix QR Kodu imzası oluşturun"
description: "Webp belgelerinizi ve sözleşmelerinizi G S1 Data Matrix QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
about:
    enable: true
    title: "GroupDocs.Signature for Java QR Kodu imzaları API'sı hakkında"
    content: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), belgeler için QR Kodu imzaları oluşturmak ve oluşturmak için gelişmiş bir API'dir. Kullanıcılar, indirmek veya sosyal medyada resim olarak paylaşmak için metin sağlayan QR Kod imzaları oluşturabilir. İmzalı belge API ile veya sadece mobil kamera üzerinden taranabilir! İş sözleşmelerinizi ve resmi belgelerinizi QR Kod imzası ekleyerek elektronik olarak imzalayın ve değiştirin. Herhangi bir QR Kodu imzası, imzalayanı tanımlamak veya belgeyi yetkilendirmek için benzersiz özel bilgiler içerir. Ayrıca, QR Kod içeriği programlı olarak kişisel anahtarlarla şifrelenebilir ve şifresi çözülebilir. Bu, kamuya açık belgelerdeki hassas verileri paylaşmak için birçok yetenek açar. İmzalayan kullanıcı, PDF'ler, MS Word belgeleri, MS Excel çalışma kitapları, MS PowerPoint sunumları, Adobe Photoshop dosyaları ve çeşitli görüntü formatlarındaki QR Kodlarını güncelleyebilir, doğrulayabilir, silebilir, önizleyebilir veya arayabilir. QR Kodları ayrıca özelleştirilebilir.
    

############################# Steps ############################
steps:
    enable: true
    title_left: "Java içinde Qrcode ile Webp imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Webp belgelerini Qrcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
        
        * Yol veya bellek akışı olarak imzalaması gereken Webp dosyasını sağlayan bir Signature sınıfı örneği oluşturun
        * SignOptions sınıfını örnekleyin ve istenen tüm verileri ayarlayın.
        * Çıkış Webp dosyasını veya bellek akışını geçen Signature.Sign() yöntemini çağırın
...
demos:
    enable: true
    title: "Webp dokümanı Qrcode Canlı Demo ile imzalama"
    content: |
       Hemen şimdi [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web sitesini ziyaret ederek çeşitli imzalarla Webp dosyasını imzalayın. Ücretsiz çevrimiçi demo sizi bekliyor.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Veri Matrisi, GS1 özelliklerine uyan bir Veri Matrisi çeşididir. Aşağıdakiler gibi ancak bunlarla sınırlı olmayan bilgileri kodlamak için GS1 DataMatrix'i kullanın: AI(01) Global Ticari Ürün Numarası (GTIN), AI(17) Son Kullanma Tarihi, AI(10) Parti Numarası, AI(21) Seri Numarası .
          characterset: |
             Karakter seti: büyük ve küçük harfler ve özel karakterler $@%*+-./:=<>;&*_,'! hepsi doğru Uygulama Tanımlayıcıları ile.
          textcapacity: |
             Kod metni kapasitesi: en fazla 3116 sayısal basamak veya 2335 alfa sayısal karakter.
          image: |
...
more_formats:
    enable: true
    title: "Java için desteklenen diğer Qrcode imzaları"
    content: |
        "Webp'ı diğer imza türleriyle de imzalayabilirsiniz. Lütfen aşağıdaki listeye bakın."
    format: 
