...
############################# Head ############################
head_title: "Dokument eSign Odt s G S1 Q R QR kódem v Java"
head_description: "Vytvořte QR kód G S1 Q R a vložte jej do souboru Odt pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis G S1 Q R QR kódu pro dokument Odt v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Odt pomocí QR kódu G S1 Q R. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Odt pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Odt pomocí podpisů Qrcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Odt pomocí živé ukázky Qrcode"
    content: |
