...
############################# Head ############################
head_title: "eSign Bmp документ с QR-кодом Data Matrix в Java"
head_description: "Создайте QR-код Data Matrix и поместите его в файл Bmp, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода Data Matrix для документа Bmp в Java"
description: "Электронная подпись Bmp документов и контрактов с Data Matrix QR-кодом. Создавайте подпись QR-кода быстро и легко."
