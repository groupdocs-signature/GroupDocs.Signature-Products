...
############################# Head ############################
head_title: "eSign Ott document met Data Matrix QR-code in Java"
head_description: "Maak een Data Matrix QR-code en plaats deze in het Ott-bestand met behulp van Java met een kort stukje Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Data Matrix QR Code handtekening voor Ott document in Java"
description: "Onderteken uw Ott documenten en contracten met Data Matrix QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Ott te ondertekenen met Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Ott documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
