...
############################# Head ############################
head_title: "eSign Doc tài liệu với G S1 Q R Mã QR trong Java"
head_description: "Tạo Mã QR G S1 Q R và đặt nó vào tệp Doc bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Q R cho tài liệu Doc trong Java"
description: "eSign các tài liệu và hợp đồng Doc của bạn bằng Mã QR G S1 Q R. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Doc bằng Qrcode trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Doc bằng chữ ký Qrcode một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Doc bằng Qrcode Live Demo"
    content: |
