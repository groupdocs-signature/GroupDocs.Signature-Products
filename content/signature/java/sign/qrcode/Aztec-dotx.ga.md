...
############################# Head ############################
head_title: "eSign Dotx doiciméad le Aztec Cód QR in Java"
head_description: "Cruthaigh Aztec Cód QR agus cuir ar chomhad Dotx é ag úsáid Java le píosa gairid de chód Java. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Aztec don doiciméad Dotx in Java"
description: "eSínigh do dhoiciméid agus conarthaí Dotx le Aztec Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
