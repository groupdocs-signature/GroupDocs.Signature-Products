...
############################# Head ############################
head_title: "eSign Xltm dokumen dengan Data Matrix QR Code dalam Java"
head_description: "Cipta Data Matrix Kod QR dan letakkan pada fail Xltm menggunakan Java dengan sekeping pendek kod Java. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan Data Matrix tandatangan Kod QR untuk Xltm dokumen dalam Java"
description: "eTandatangani dokumen dan kontrak Xltm anda dengan Kod QR Data Matrix. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
demos:
    ...
    content: |
       Tandatangani fail Xltm dengan pelbagai tandatangan sekarang dengan melawati tapak web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo dalam talian percuma menanti anda.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Matriks Data ialah kod dua dimensi yang terdiri daripada 'sel' hitam dan putih atau titik yang disusun sama ada dalam corak segi empat sama atau segi empat tepat, juga dikenali sebagai matriks. Maklumat yang akan dikodkan boleh berupa data teks atau angka.
          characterset: |
             Menyokong semua 256 aksara ASCII, semua aksara ISO dan semua aksara Kod Pertukaran Perpuluhan Berkod Binari Lanjutan (EBCDIC).
          textcapacity: |
             Sehingga 3116 digit angka, atau 2335 aksara angka alfa, atau 1556 aksara perduaan.
          image: |
...
more_formats:
    enable: true
    title: "Tandatangan Qrcode lain yang disokong untuk Java"
    content: |
        "Anda juga boleh menandatangani Xltm dengan jenis tandatangan lain. Sila lihat senarai di bawah."
    format: 
