...
############################# Head ############################
head_title: "eSign Xltm dokumen dengan G S1 Data Matrix QR Code di Java"
head_description: "Buat Kode QR G S1 Data Matrix dan letakkan di file Xltm menggunakan Java dengan potongan pendek kode Java. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat G S1 Data Matrix tanda tangan Kode QR untuk dokumen Xltm di Java"
description: "eTandatangani dokumen dan kontrak Xltm Anda dengan Kode QR G S1 Data Matrix. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
demos:
    enable: true
    title: "Menandatangani dokumen Xltm dengan Qrcode Demo Langsung"
    content: |
       Tanda tangani file Xltm dengan berbagai tanda tangan sekarang juga dengan mengunjungi situs web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo online gratis menunggu Anda.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix GS1 adalah varian dari Data Matrix yang sesuai dengan spesifikasi GS1. Gunakan GS1 DataMatrix untuk mengkodekan informasi seperti, namun tidak terbatas pada, berikut ini: AI(01) Nomor Barang Perdagangan Global (GTIN), AI(17) Tanggal Kedaluwarsa, AI(10) Nomor Batch, AI(21) Nomor Seri .
          characterset: |
             Kumpulan karakter: huruf besar dan kecil serta karakter khusus $@%*+-./:=<>;&*_,'! semua dengan Pengidentifikasi Aplikasi yang benar.
          textcapacity: |
             Kapasitas codetext: hingga 3116 digit numerik, atau 2335 karakter alfanumerik.
          image: |
...
more_formats:
    enable: true
    title: "Tanda tangan Qrcode lain yang didukung untuk Java"
    content: |
        "Anda juga dapat menandatangani Xltm dengan jenis tanda tangan lainnya. Silakan lihat daftarnya di bawah ini."
    format: 
