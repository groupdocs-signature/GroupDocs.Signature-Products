...
############################# Head ############################
head_title: "eSign Png dokuments ar G S1 Data Matrix QR kodu programmā Java"
head_description: "Izveidojiet G S1 Data Matrix QR kodu un ievietojiet to failā Png, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Data Matrix QR koda parakstu dokumentam Png programmā Java"
description: "eParakstiet savus Png dokumentus un līgumus ar G S1 Data Matrix QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Png ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Png dokumentus ar Qrcode parakstiem.
        
        * Izveidojiet paraksta klases gadījumu, kas nodrošina Png failu, kas paredzēts parakstīšanai kā ceļš vai atmiņas straume
        * Izveidojiet SignOptions klasi un iestatiet visus pieprasītos datus.
        * Izsauciet metodi Signature.Sign(), kas nodod izvades Png failu vai atmiņas straumi
...
demos:
    enable: true
    title: "Dokumentu Png parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
       Parakstiet Png failu ar dažādiem parakstiem tūlīt, apmeklējot vietni [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Jūs gaida bezmaksas tiešsaistes demonstrācija.
...
more_formats:
    ...
    content: |
        "Varat arī parakstīt Png ar citiem paraksta veidiem. Lūdzu, skatiet sarakstu zemāk."
    format: 
