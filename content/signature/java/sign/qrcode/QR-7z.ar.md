...
############################# Head ############################
head_title: "مستند eSign 7z مع رمز الاستجابة السريعة QR في Java"
head_description: "أنشئ رمز الاستجابة السريعة QR وضعه في ملف 7z باستخدام Java مع جزء قصير من كود Java. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء QR توقيع رمز الاستجابة السريعة لمستند 7z في Java"
description: "قم بتوقيع 7z على المستندات والعقود باستخدام رمز الاستجابة السريعة QR. قم بإنشاء توقيع QR Code بسرعة وسهولة."
