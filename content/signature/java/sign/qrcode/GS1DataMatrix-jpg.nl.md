...
############################# Head ############################
head_title: "eSign Jpg document met G S1 Data Matrix QR-code in Java"
head_description: "Maak een G S1 Data Matrix QR-code en plaats deze in het Jpg-bestand met behulp van Java met een kort stukje Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR Code handtekening voor Jpg document in Java"
description: "Onderteken uw Jpg documenten en contracten met G S1 Data Matrix QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Jpg te ondertekenen met Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Jpg documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
        
        * Maak een instantie van de Signature-klasse die een Jpg-bestand levert dat moet worden ondertekend als pad of geheugenstroom
        * Instantieer SignOptions klasse en stel alle gevraagde gegevens in.
        * Roep de methode Signature.Sign() op en geef uitvoer Jpg-bestand of geheugenstroom
...
demos:
    enable: true
    title: "Jpg documenten ondertekenen met Qrcode Live Demo"
    content: |
       Onderteken het Jpg-bestand met verschillende handtekeningen op dit moment door naar de website [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) te gaan. Gratis online demo voor u klaar.
...
more_formats:
    ...
    content: |
        "U kunt Jpg ook ondertekenen met andere soorten handtekeningen. Zie de lijst hieronder."
    format: 
