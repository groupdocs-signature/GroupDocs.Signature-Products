...
############################# Head ############################
head_title: "eSign Tiff dokument G S1 Q R QR-koodiga rakenduses Java"
head_description: "Looge QR-kood G S1 Q R ja sisestage see faili Tiff, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Tiff QR-koodi allkiri G S1 Q R"
description: "eAllkirjasta oma Tiff dokumendid ja lepingud QR-koodiga G S1 Q R. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR-kood on QR-koodi variant, mis vastab GS1 spetsifikatsioonidele. See oli loodud spetsiaalselt laiendatud pakenditeabe (nt partii number, toote ID ja kogus) jagamiseks.
          characterset: |
             Suur- ja väiketähed ja erimärgid $%*+-./: kõik koos õigete rakenduse identifikaatoritega
          textcapacity: |
             Kuni 7089 numbrimärki, 4296 tähtnumbrilist märki
          image: |
