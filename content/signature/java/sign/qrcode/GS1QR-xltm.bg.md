...
############################# Head ############################
head_title: "eSign Xltm документ с G S1 Q R QR код в Java"
head_description: "Създайте G S1 Q R QR код и го поставете във файл Xltm, като използвате Java с кратка част от Java код. Използвайте API за подписване на документи на GroupDocs, за да подпишете електронно вашите бизнес документи и файлове с QR код."

############################# Header ############################
title: "Генерирайте G S1 Q R QR Code подпис за Xltm документ в Java"
description: "Електронно подпишете вашите Xltm документи и договори с G S1 Q R QR код. Генерирайте QR код подпис бързо и лесно."
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Xltm с Qrcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на Xltm документи с Qrcode подписи.
        
        * Създайте екземпляр на клас подпис, предоставящ файл Xltm, който трябва да се подписва като път или поток от памет
        * Създайте клас SignOptions и задайте всички изисквани данни.
        * Извикване на метода Signature.Sign(), предаващ изходен файл Xltm или поток от памет
...
demos:
    enable: true
    title: "Подписване на Xltm документи с Qrcode Демо на живо"
    content: |
       Подпишете файл Xltm с различни подписи точно сега, като посетите уебсайта [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Безплатна онлайн демонстрация ви очаква.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR Code е вариант на QR Code, който отговаря на спецификациите на GS1. Той е проектиран специално за споделяне на разширена информация за опаковката, като партиден номер, идентификатор на продукта и количество.
          characterset: |
             Главни и малки букви и специални знаци $%*+-./: всички с правилни идентификатори на приложения
          textcapacity: |
             До 7089 цифрови знака, 4296 буквено-цифрови знака
          image: |
...
more_formats:
    ...
    content: |
        "Можете също да подпишете Xltm с други типове подписи. Моля, вижте списъка по-долу."
    format: 
