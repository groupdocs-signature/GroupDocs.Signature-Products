...
############################# Head ############################
head_title: "eSign 7z документ із QR QR-кодом у Java"
head_description: "Створіть QR-код QR і помістіть його у файл 7z за допомогою Java із коротким фрагментом коду Java. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду QR для документа 7z у Java"
description: "Електронно підписуйте свої 7z документи та контракти за допомогою QR QR-коду. Згенеруйте підпис QR-коду швидко та легко."
...
steps:
    enable: true
    title_left: "Кроки для підпису 7z за допомогою Qrcode у Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) надає можливість швидко та легко підписувати документи 7z за допомогою підписів Qrcode.
