...
############################# Head ############################
head_title: "eSign Pptx document avec Data Matrix QR Code en Java"
head_description: "Créez le code QR Data Matrix et placez-le dans le fichier Pptx en utilisant Java avec un court morceau de code Java. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR Data Matrix pour le document Pptx en Java"
...
steps:
    enable: true
    title_left: "Étapes pour signer Pptx avec Qrcode dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Pptx avec des signatures Qrcode.
