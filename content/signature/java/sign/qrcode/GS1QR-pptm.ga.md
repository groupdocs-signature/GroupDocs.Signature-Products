...
############################# Head ############################
head_title: "eSign Pptm doiciméad le G S1 Q R Cód QR in Java"
head_description: "Cruthaigh G S1 Q R Cód QR agus cuir ar chomhad Pptm é ag úsáid Java le píosa gairid de chód Java. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR G S1 Q R don doiciméad Pptm in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Pptm a shíniú le Qrcode in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Pptm a shíniú le sínithe Qrcode go tapa agus go héasca.
