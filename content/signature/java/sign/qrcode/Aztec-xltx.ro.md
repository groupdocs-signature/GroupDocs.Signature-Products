...
############################# Head ############################
head_title: "eSign documentul Xltx cu codul QR Aztec în Java"
head_description: "Creați codul QR Aztec și puneți-l în fișierul Xltx folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura Aztec cod QR pentru documentul Xltx în Java"
description: "eSemnați documentele și contractele Xltx cu codul QR Aztec. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xltx cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Xltx cu semnături Qrcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Xltx cu Qrcode Live Demo"
    content: |
