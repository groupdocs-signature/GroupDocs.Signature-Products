...
############################# Head ############################
head_title: "eSign Doc documento con G S1 Q R codice QR in Java"
head_description: "Crea il codice QR G S1 Q R e inseriscilo nel file Doc utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera G S1 Q R firma del codice QR per il documento Doc in Java"
description: "Firma i tuoi documenti e contratti Doc con il codice QR G S1 Q R. Genera la firma del codice QR in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Doc con Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Doc con firme Qrcode in modo rapido e semplice.
