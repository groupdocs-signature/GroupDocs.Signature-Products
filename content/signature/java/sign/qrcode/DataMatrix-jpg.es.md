...
############################# Head ############################
head_title: "Documento de firma electrónica Jpg con Data Matrix código QR en Java"
head_description: "Cree el código QR Data Matrix y colóquelo en el archivo Jpg usando Java con un fragmento corto de código Java. Utilice la API de firma de documentos de GroupDocs para firmar electrónicamente sus documentos y archivos comerciales con código QR."

############################# Header ############################
title: "Genere la firma del código QR Data Matrix para el documento Jpg en Java"
description: "Firme electrónicamente sus Jpg documentos y contratos con Data Matrix QR Code. Genere la firma del código QR de forma rápida y sencilla."
...
steps:
    enable: true
    title_left: "Pasos para firmar Jpg con Qrcode en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Jpg con Qrcode firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Jpg documentos con Qrcode Live Demo"
    content: |
