...
############################# Head ############################
head_title: "eSign Docx dokumen dengan QR QR Code dalam Java"
head_description: "Cipta QR Kod QR dan letakkan pada fail Docx menggunakan Java dengan sekeping pendek kod Java. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan QR tandatangan Kod QR untuk Docx dokumen dalam Java"
description: "eTandatangani dokumen dan kontrak Docx anda dengan Kod QR QR. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Docx dengan Qrcode dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Docx dengan tandatangan Qrcode dengan cepat dan mudah.
        
        * Buat contoh kelas Tandatangan yang menyediakan fail Docx yang sepatutnya ditandatangani sebagai laluan atau aliran memori
        * Segerakan kelas SignOptions dan tetapkan semua data yang diminta.
        * Guna kaedah Signature.Sign() yang menghantar fail keluaran Docx atau aliran memori
...
demos:
    enable: true
    title: "Menandatangani dokumen Docx dengan Qrcode Demo Langsung"
    content: |
       Tandatangani fail Docx dengan pelbagai tandatangan sekarang dengan melawati tapak web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo dalam talian percuma menanti anda.
...
more_formats:
    ...
    content: |
        "Anda juga boleh menandatangani Docx dengan jenis tandatangan lain. Sila lihat senarai di bawah."
    format: 
