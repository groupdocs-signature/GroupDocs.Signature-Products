...
############################# Head ############################
head_title: "eSign Ppsx tài liệu với G S1 Data Matrix Mã QR trong Java"
head_description: "Tạo Mã QR G S1 Data Matrix và đặt nó vào tệp Ppsx bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Data Matrix cho tài liệu Ppsx trong Java"
description: "eSign các tài liệu và hợp đồng Ppsx của bạn bằng Mã QR G S1 Data Matrix. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
...
demos:
    enable: true
    title: "Ký tài liệu Ppsx bằng Qrcode Live Demo"
    content: |
       Ký tệp Ppsx bằng nhiều chữ ký ngay bây giờ bằng cách truy cập trang web [GroupDocs.Signature App] (https://products.groupdocs.app/signature/family). Bản demo trực tuyến miễn phí đang chờ bạn.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Ma trận dữ liệu GS1 là một biến thể của Ma trận dữ liệu phù hợp với các thông số kỹ thuật của GS1. Sử dụng GS1 DataMatrix để mã hóa các thông tin như, nhưng không giới hạn ở những thông tin sau: AI (01) Mã số thương phẩm toàn cầu (GTIN), AI (17) Ngày hết hạn, AI (10) Số lô, AI (21) Số sê-ri .
          characterset: |
             Bộ ký tự: chữ hoa, chữ thường và ký tự đặc biệt $@%*+-./: = <>; & * _, '! tất cả đều có Số phân định ứng dụng chính xác.
          textcapacity: |
             Dung lượng văn bản mã: lên đến 3116 chữ số hoặc 2335 ký tự số alpha.
          image: |
...
more_formats:
    enable: true
    title: "Các chữ ký Qrcode được hỗ trợ khác cho Java"
    content: |
        "Bạn cũng có thể ký Ppsx bằng các loại chữ ký khác. Vui lòng xem danh sách bên dưới."
    format: 
