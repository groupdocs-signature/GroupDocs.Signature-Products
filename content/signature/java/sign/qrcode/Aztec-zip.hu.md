...
############################# Head ############################
head_title: "eSign Zip dokumentum Aztec QR-kóddal a Java nyelven"
head_description: "Hozzon létre Aztec QR-kódot, és helyezze el a Zip fájlba a Java használatával egy rövid Java kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon Aztec QR-kód aláírást a Zip dokumentumhoz a Java programban"
description: "eAláírja Zip dokumentumait és szerződéseit Aztec QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
