...
############################# Head ############################
head_title: "eSign Ppsm dokument s Data Matrix QR kódom v Java"
head_description: "Vytvorte Data Matrix QR kód a vložte ho do súboru Ppsm pomocou Java s krátkym kódom Java. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte Data Matrix podpis QR kódu pre dokument Ppsm v Java"
description: "ePodpíšte svoje Ppsm dokumenty a zmluvy pomocou Data Matrix QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Ppsm pomocou Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Ppsm pomocou podpisov Qrcode.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix je dvojrozmerný kód pozostávajúci z čiernych a bielych „buniek“ alebo bodiek usporiadaných do štvorcového alebo obdĺžnikového vzoru, ktorý je známy aj ako matica. Informácie, ktoré sa majú zakódovať, môžu byť textové alebo číselné údaje.
          characterset: |
             Podporuje všetkých 256 znakov ASCII, všetky znaky ISO a všetky znaky EBCDIC (Extended Binary Coded Decimal Interchange Code).
          textcapacity: |
             Až 3116 numerických číslic alebo 2335 alfanumerických znakov alebo 1556 binárnych znakov.
          image: |
