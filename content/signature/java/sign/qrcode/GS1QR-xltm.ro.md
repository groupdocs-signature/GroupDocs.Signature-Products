...
############################# Head ############################
head_title: "eSign documentul Xltm cu codul QR G S1 Q R în Java"
head_description: "Creați codul QR G S1 Q R și puneți-l în fișierul Xltm folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura G S1 Q R cod QR pentru documentul Xltm în Java"
description: "eSemnați documentele și contractele Xltm cu codul QR G S1 Q R. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xltm cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Xltm cu semnături Qrcode rapid și ușor.
        
        * Creați o instanță a clasei Signature care furnizează fișierul Xltm care ar trebui să se semneze ca cale sau flux de memorie
        * Instanțiați clasa SignOptions și setați toate datele solicitate.
        * Invocați metoda Signature.Sign() pasând fișierul de ieșire Xltm sau fluxul de memorie
...
demos:
    enable: true
    title: "Semnează documente Xltm cu Qrcode Live Demo"
    content: |
       Semnați fișierul Xltm cu diferite semnături chiar acum, vizitând site-ul web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo online gratuită vă așteaptă.
...
more_formats:
    ...
    content: |
        "De asemenea, puteți semna Xltm cu alte tipuri de semnături. Vă rugăm să vedeți lista de mai jos."
    format: 
