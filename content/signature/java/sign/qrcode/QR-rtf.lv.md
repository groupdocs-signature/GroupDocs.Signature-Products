...
############################# Head ############################
head_title: "eSign Rtf dokuments ar QR QR kodu programmā Java"
head_description: "Izveidojiet QR QR kodu un ievietojiet to failā Rtf, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt QR QR koda parakstu dokumentam Rtf programmā Java"
description: "eParakstiet savus Rtf dokumentus un līgumus ar QR QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Rtf ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Rtf dokumentus ar Qrcode parakstiem.
        
        * Izveidojiet paraksta klases gadījumu, kas nodrošina Rtf failu, kas paredzēts parakstīšanai kā ceļš vai atmiņas straume
        * Izveidojiet SignOptions klasi un iestatiet visus pieprasītos datus.
        * Izsauciet metodi Signature.Sign(), kas nodod izvades Rtf failu vai atmiņas straumi
...
demos:
    enable: true
    title: "Dokumentu Rtf parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
       Parakstiet Rtf failu ar dažādiem parakstiem tūlīt, apmeklējot vietni [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Jūs gaida bezmaksas tiešsaistes demonstrācija.
...
more_formats:
    ...
    content: |
        "Varat arī parakstīt Rtf ar citiem paraksta veidiem. Lūdzu, skatiet sarakstu zemāk."
    format: 
