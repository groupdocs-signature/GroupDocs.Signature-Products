...
############################# Head ############################
head_title: "Documento de firma electrónica Ppsx con Data Matrix código QR en Java"
head_description: "Cree el código QR Data Matrix y colóquelo en el archivo Ppsx usando Java con un fragmento corto de código Java. Utilice la API de firma de documentos de GroupDocs para firmar electrónicamente sus documentos y archivos comerciales con código QR."

############################# Header ############################
title: "Genere la firma del código QR Data Matrix para el documento Ppsx en Java"
description: "Firme electrónicamente sus Ppsx documentos y contratos con Data Matrix QR Code. Genere la firma del código QR de forma rápida y sencilla."
...
demos:
    enable: true
    title: "Firma de Ppsx documentos con Qrcode Live Demo"
    content: |
       Firme el archivo Ppsx con varias firmas ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demostración en línea gratuita esperándote.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix es un código bidimensional que consta de "celdas" o puntos en blanco y negro dispuestos en un patrón cuadrado o rectangular, también conocido como matriz. La información a codificar puede ser texto o datos numéricos.
          characterset: |
             Admite los 256 caracteres ASCII, todos los caracteres ISO y todos los caracteres de código de intercambio decimal codificado en binario extendido (EBCDIC).
          textcapacity: |
             Hasta 3116 dígitos numéricos, 2335 caracteres alfanuméricos o 1556 caracteres binarios.
          image: |
...
more_formats:
    ...
    content: |
        "También puede firmar Ppsx con otros tipos de firma. Consulte la lista a continuación."
    format: 
