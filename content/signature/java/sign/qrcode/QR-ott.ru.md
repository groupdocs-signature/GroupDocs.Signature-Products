...
############################# Head ############################
head_title: "eSign Ott документ с QR-кодом QR в Java"
head_description: "Создайте QR-код QR и поместите его в файл Ott, используя Java с коротким фрагментом кода Java. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода QR для документа Ott в Java"
description: "Электронная подпись Ott документов и контрактов с QR QR-кодом. Создавайте подпись QR-кода быстро и легко."
...
steps:
    enable: true
    title_left: "Действия по подписанию Ott с помощью Qrcode в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Ott с подписями Qrcode.
        
        * Создайте экземпляр класса Signature, предоставляющий файл Ott, который должен быть подписан как путь или поток памяти.
        * Создайте экземпляр класса SignOptions и установите все требуемые данные.
        * Вызвать метод Signature.Sign(), передав выходной файл Ott или поток памяти
...
demos:
    enable: true
    title: "Подписание Ott документов с помощью Qrcode Live Demo"
    content: |
       Подпишите файл Ott с различными подписями прямо сейчас, посетив веб-сайт [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Бесплатная онлайн-демонстрация ждет вас.
...
more_formats:
    ...
    content: |
        "Вы также можете подписать Ott другими типами подписи. См. список ниже."
    format: 
