...
############################# Head ############################
head_title: "Dokument eSign Ppsx s G S1 Q R QR kódem v Java"
head_description: "Vytvořte QR kód G S1 Q R a vložte jej do souboru Ppsx pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis G S1 Q R QR kódu pro dokument Ppsx v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Ppsx pomocí QR kódu G S1 Q R. Vygenerujte podpis QR kódu rychle a snadno."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR Code je varianta QR kódu, která odpovídá specifikacím GS1. Byl navržen speciálně pro sdílení rozšířených informací o balení, jako je číslo šarže, ID produktu a množství.
          characterset: |
             Velká a malá písmena a speciální znaky $%*+-./: vše se správnými identifikátory aplikace
          textcapacity: |
             Až 7089 číselných znaků, 4296 alfanumerických znaků
          image: |
