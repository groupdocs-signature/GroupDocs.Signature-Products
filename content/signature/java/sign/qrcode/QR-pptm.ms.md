...
############################# Head ############################
head_title: "eSign Pptm dokumen dengan QR QR Code dalam Java"
head_description: "Cipta QR Kod QR dan letakkan pada fail Pptm menggunakan Java dengan sekeping pendek kod Java. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan QR tandatangan Kod QR untuk Pptm dokumen dalam Java"
description: "eTandatangani dokumen dan kontrak Pptm anda dengan Kod QR QR. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pptm dengan Qrcode dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Pptm dengan tandatangan Qrcode dengan cepat dan mudah.
        
        * Buat contoh kelas Tandatangan yang menyediakan fail Pptm yang sepatutnya ditandatangani sebagai laluan atau aliran memori
        * Segerakan kelas SignOptions dan tetapkan semua data yang diminta.
        * Guna kaedah Signature.Sign() yang menghantar fail keluaran Pptm atau aliran memori
...
demos:
    ...
    content: |
       Tandatangani fail Pptm dengan pelbagai tandatangan sekarang dengan melawati tapak web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo dalam talian percuma menanti anda.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Kod QR (disingkatkan daripada Kod Respons Pantas) ialah tanda dagangan untuk jenis kod bar matriks (atau kod bar dua dimensi). Ia adalah jenis kod dua dimensi yang paling popular dan digunakan secara meluas. Dalam amalan, kod QR selalunya mengandungi data untuk pencari, pengecam atau penjejak yang menghala ke tapak web atau aplikasi.
          characterset: |
             Semua 256 aksara ASCII + Kanji
          textcapacity: |
             Sehingga 7089 aksara angka, 4296 aksara abjad angka, 2953 bait (data binari) atau 1817 aksara Kanji.
          image: |
...
more_formats:
    ...
    content: |
        "Anda juga boleh menandatangani Pptm dengan jenis tandatangan lain. Sila lihat senarai di bawah."
    format: 
