...
############################# Head ############################
head_title: "在 Java 中带有 Aztec QR 码的 eSign Tiff 文档"
head_description: "创建 Aztec 二维码并使用 Java 和一小段 Java 代码将其放在 Tiff 文件中。使用 GroupDocs 文档签名 API 使用 QR 码对您的业务文档和文件进行电子签名。"

############################# Header ############################
title: "在 Java 中为 Tiff 文档生成 Aztec 二维码签名"
description: "使用 Aztec 二维码对您的 Tiff 文档和合同进行电子签名。快速轻松地生成二维码签名。"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code 是一种二维 (2-D) 通用矩阵符号系统，其设计精度高于其他二维符号系统。一个阿兹特克代码符号可以编码多达 3,832 个数字； 3,067 个字母字符；或 1,914 字节的数据。
          characterset: |
             所有 256 个 ASCII 字符。
          textcapacity: |
