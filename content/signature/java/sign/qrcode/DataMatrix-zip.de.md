...
############################# Head ############################
head_title: "eSigniere Zip-Dokument mit Data Matrix-QR-Code in Java"
head_description: "Erstellen Sie einen Data Matrix-QR-Code und fügen Sie ihn mit Java und einem kurzen Stück Java-Code in eine Zip-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Data Matrix-QR-Code-Signatur für Zip-Dokument in Java"
description: "Unterzeichnen Sie Ihre Zip-Dokumente und -Verträge mit dem Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Zip mit Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Zip-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Zip-Dokumenten mit Qrcode Live-Demo"
    content: |
