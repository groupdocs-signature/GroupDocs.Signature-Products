...
############################# Head ############################
head_title: "eSign Odt-dokument med QR QR-kode i Java"
head_description: "Lag QR QR-kode og legg den til Odt-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Odt-dokument i Java"
description: "eSigner Odt-dokumentene og kontraktene dine med QR-koden QR. Generer QR-kodesignatur raskt og enkelt."
