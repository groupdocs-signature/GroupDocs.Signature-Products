...
############################# Head ############################
head_title: "Java میں QR QR کوڈ کے ساتھ eSign Docm دستاویز"
head_description: "QR QR کوڈ بنائیں اور اسے Java کا استعمال کرتے ہوئے Java کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Docm فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "Java میں Docm دستاویز کے لیے QR QR کوڈ دستخط بنائیں"
description: "اپنے Docm دستاویزات اور معاہدوں پر QR QR کوڈ کے ساتھ دستخط کریں۔ QR کوڈ دستخط جلدی اور آسانی سے بنائیں۔"
