...
############################# Head ############################
head_title: "eSign Xlsx ሰነድ በAztec QR ኮድ በJava"
head_description: "Aztec QR ኮድ ይፍጠሩ እና በXlsx ፋይል ላይ Javaን በመጠቀም በአጭር የJava ኮድ ያስቀምጡት። የንግድ ሰነዶችዎን እና ፋይሎችዎን በQR ኮድ ኢ-ለመፈረም የGroupDocs ሰነድ ፊርማ ኤፒአይ ይጠቀሙ።"

############################# Header ############################
title: "በJava ውስጥ ለXlsx ሰነድ የAztec QR ኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Xlsx ሰነዶች እና ኮንትራቶች በAztec QR ኮድ ይፈርሙ። የQR ኮድ ፊርማ በፍጥነት እና በቀላሉ ይፍጠሩ።"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            አዝቴክ ኮድ ከሌሎቹ የ2-ዲ ምልክቶች የበለጠ ትክክለኝነት እንዲኖረው የተነደፈ ባለሁለት-ልኬት (2-ዲ) አጠቃላይ ዓላማ ማትሪክስ ምልክት ነው። የአዝቴክ ኮድ ምልክት እስከ 3,832 አሃዛዊ አሃዞችን መመስጠር ይችላል። 3,067 ፊደላት ቁምፊዎች; ወይም 1,914 ባይት ዳታ።
          characterset: |
             ሁሉም 256 ASCII ቁምፊዎች.
          textcapacity: |
             እስከ 3,832 አሃዛዊ አሃዞች፣ ወይም 3,067 የፊደል ቁምፊዎች፣ ወይም 1,914 ባይት ውሂብ።
          image: |
