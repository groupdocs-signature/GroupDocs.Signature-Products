...
############################# Head ############################
head_title: "eSigniere Xls-Dokument mit Data Matrix-QR-Code in Java"
head_description: "Erstellen Sie einen Data Matrix-QR-Code und fügen Sie ihn mit Java und einem kurzen Stück Java-Code in eine Xls-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Data Matrix-QR-Code-Signatur für Xls-Dokument in Java"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Xls mit Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Xls-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
