...
############################# Head ############################
head_title: "eSign Dot dokumentas su Data Matrix QR kodu Java"
head_description: "Sukurkite QR kodą Data Matrix ir įdėkite jį į failą Dot naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite Data Matrix QR kodo parašą Dot dokumentui Java"
description: "e. Pasirašykite Dot dokumentus ir sutartis naudodami Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
