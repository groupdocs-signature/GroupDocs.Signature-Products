...
############################# Head ############################
head_title: "eSign Docx dokument s G S1 Data Matrix QR kódom v Java"
head_description: "Vytvorte G S1 Data Matrix QR kód a vložte ho do súboru Docx pomocou Java s krátkym kódom Java. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte G S1 Data Matrix podpis QR kódu pre dokument Docx v Java"
description: "ePodpíšte svoje Docx dokumenty a zmluvy pomocou G S1 Data Matrix QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Docx pomocou Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Docx pomocou podpisov Qrcode.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Docx pomocou živej ukážky Qrcode"
    content: |
