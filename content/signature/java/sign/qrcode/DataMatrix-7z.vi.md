...
############################# Head ############################
head_title: "eSign 7z tài liệu với Data Matrix Mã QR trong Java"
head_description: "Tạo Mã QR Data Matrix và đặt nó vào tệp 7z bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR Data Matrix cho tài liệu 7z trong Java"
