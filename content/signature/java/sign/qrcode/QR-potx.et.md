...
############################# Head ############################
head_title: "eSign Potx dokument QR QR-koodiga rakenduses Java"
head_description: "Looge QR-kood QR ja sisestage see faili Potx, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Potx QR-koodi allkiri QR"
description: "eAllkirjasta oma Potx dokumendid ja lepingud QR-koodiga QR. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR-kood (lühendatult kiirresponsi koodist) on teatud tüüpi maatriksvöötkoodi (või kahemõõtmelise vöötkoodi) kaubamärk. See on kõige populaarsem ja laialdasemalt kasutatav kahemõõtmelise koodi tüüp. Praktikas sisaldavad QR-koodid sageli veebisaidile või rakendusele osutava asukoha, identifikaatori või jälgija andmeid.
          characterset: |
             Kõik 256 ASCII märki + Kanji
          textcapacity: |
             Kuni 7089 numbrimärki, 4296 tähtnumbrilist märki, 2953 baiti (binaarandmed) või 1817 Kanji märki.
          image: |
