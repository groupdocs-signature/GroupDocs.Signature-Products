...
############################# Head ############################
head_title: "eSign Doc-dokument med G S1 Q R QR-kode i Java"
head_description: "Lag G S1 Q R QR-kode og legg den til Doc-filen ved å bruke Java med en kort bit av Java-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer G S1 Q R QR-kodesignatur for Doc-dokument i Java"
description: "eSigner Doc-dokumentene og kontraktene dine med QR-koden G S1 Q R. Generer QR-kodesignatur raskt og enkelt."
...
steps:
    enable: true
    title_left: "Trinn for å signere Doc med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Doc-dokumenter med Qrcode-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Doc dokumenter med Qrcode Live Demo"
    content: |
