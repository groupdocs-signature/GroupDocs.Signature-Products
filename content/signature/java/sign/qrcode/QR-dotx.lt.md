...
############################# Head ############################
head_title: "eSign Dotx dokumentas su QR QR kodu Java"
head_description: "Sukurkite QR kodą QR ir įdėkite jį į failą Dotx naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite QR QR kodo parašą Dotx dokumentui Java"
description: "e. Pasirašykite Dotx dokumentus ir sutartis naudodami QR QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR kodas (sutrumpintas iš greitojo atsako kodas) yra matricinio brūkšninio kodo (arba dvimačio brūkšninio kodo) tipo prekės ženklas. Tai populiariausias ir plačiausiai naudojamas dvimačio kodo tipas. Praktikoje QR koduose dažnai yra duomenų, skirtų vietos nustatymui, identifikatoriui arba sekimui, kuris nurodo svetainę ar programą.
          characterset: |
             Visi 256 ASCII simboliai + Kanji
          textcapacity: |
             Iki 7089 skaitmeninių simbolių, 4296 raidinių ir skaitinių simbolių, 2953 baitų (dvejetainiai duomenys) arba 1817 Kanji simbolių.
          image: |
