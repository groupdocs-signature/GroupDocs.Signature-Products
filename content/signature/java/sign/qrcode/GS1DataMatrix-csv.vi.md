...
############################# Head ############################
head_title: "eSign Csv tài liệu với G S1 Data Matrix Mã QR trong Java"
head_description: "Tạo Mã QR G S1 Data Matrix và đặt nó vào tệp Csv bằng cách sử dụng Java với một đoạn mã Java ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Data Matrix cho tài liệu Csv trong Java"
description: "eSign các tài liệu và hợp đồng Csv của bạn bằng Mã QR G S1 Data Matrix. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Csv bằng Qrcode trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Csv bằng chữ ký Qrcode một cách nhanh chóng và dễ dàng.
        
        * Tạo một phiên bản của lớp Chữ ký cung cấp tệp Csv phải ký dưới dạng đường dẫn hoặc luồng bộ nhớ
        * Khởi tạo lớp SignOptions và thiết lập tất cả dữ liệu được yêu cầu.
        * Gọi phương thức Signature.Sign () chuyển đầu ra tệp Csv hoặc luồng bộ nhớ
...
demos:
    enable: true
    title: "Ký tài liệu Csv bằng Qrcode Live Demo"
    content: |
       Ký tệp Csv bằng nhiều chữ ký ngay bây giờ bằng cách truy cập trang web [GroupDocs.Signature App] (https://products.groupdocs.app/signature/family). Bản demo trực tuyến miễn phí đang chờ bạn.
...
more_formats:
    ...
    content: |
        "Bạn cũng có thể ký Csv bằng các loại chữ ký khác. Vui lòng xem danh sách bên dưới."
    format: 
