...
############################# Head ############################
head_title: "Podpisz dokument Xlsb z kodem QR G S1 Data Matrix w Java"
head_description: "Utwórz kod QR G S1 Data Matrix i umieść go w pliku Xlsb za pomocą Java z krótkim fragmentem kodu Java. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis G S1 Data Matrix kodu QR dla dokumentu Xlsb w Java"
description: "Podpisz elektronicznie dokumenty i umowy w Xlsb za pomocą kodu QR G S1 Data Matrix. Szybko i łatwo generuj podpis QR Code."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Xlsb za pomocą Qrcode w Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Xlsb za pomocą podpisów Qrcode.
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Xlsb za pomocą Qrcode Demo na żywo"
    content: |
