...
############################# Head ############################
head_title: "eSign documentul Xlsm cu codul QR G S1 Data Matrix în Java"
head_description: "Creați codul QR G S1 Data Matrix și puneți-l în fișierul Xlsm folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura G S1 Data Matrix cod QR pentru documentul Xlsm în Java"
description: "eSemnați documentele și contractele Xlsm cu codul QR G S1 Data Matrix. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xlsm cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Xlsm cu semnături Qrcode rapid și ușor.
        
        * Creați o instanță a clasei Signature care furnizează fișierul Xlsm care ar trebui să se semneze ca cale sau flux de memorie
        * Instanțiați clasa SignOptions și setați toate datele solicitate.
        * Invocați metoda Signature.Sign() pasând fișierul de ieșire Xlsm sau fluxul de memorie
...
demos:
    enable: true
    title: "Semnează documente Xlsm cu Qrcode Live Demo"
    content: |
       Semnați fișierul Xlsm cu diferite semnături chiar acum, vizitând site-ul web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo online gratuită vă așteaptă.
...
more_formats:
    ...
    content: |
        "De asemenea, puteți semna Xlsm cu alte tipuri de semnături. Vă rugăm să vedeți lista de mai jos."
    format: 
