...
############################# Head ############################
head_title: "Java의 Aztec QR 코드로 Ppsx 문서에 전자 서명"
head_description: "짧은 Java 코드와 함께 Java을(를) 사용하여 Aztec QR 코드를 생성하고 Ppsx 파일에 넣습니다. GroupDocs 문서 서명 API를 사용하여 QR 코드로 비즈니스 문서 및 파일에 전자 서명하십시오."

############################# Header ############################
title: "Java에서 Ppsx 문서에 대한 Aztec QR 코드 서명 생성"
description: "Aztec QR 코드로 Ppsx 문서 및 계약에 전자 서명합니다. QR 코드 서명을 빠르고 쉽게 생성합니다."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            아즈텍 코드는 다른 2차원 기호보다 더 높은 정확도를 갖도록 설계된 2차원(2차원) 범용 행렬 기호입니다. Aztec 코드 기호는 최대 3,832자리 숫자를 인코딩할 수 있습니다. 3,067개의 알파벳 문자; 또는 1,914바이트의 데이터.
          characterset: |
             모든 256 ASCII 문자.
          textcapacity: |
             최대 3,832개의 숫자 또는 3,067개의 알파벳 문자 또는 1,914바이트의 데이터.
          image: |
