...
############################# Head ############################
head_title: "eSign Dotx document met G S1 Data Matrix QR-code in Java"
head_description: "Maak een G S1 Data Matrix QR-code en plaats deze in het Dotx-bestand met behulp van Java met een kort stukje Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR Code handtekening voor Dotx document in Java"
description: "Onderteken uw Dotx documenten en contracten met G S1 Data Matrix QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Dotx te ondertekenen met Qrcode in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Dotx documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
...
demos:
    enable: true
    title: "Dotx documenten ondertekenen met Qrcode Live Demo"
    content: |
