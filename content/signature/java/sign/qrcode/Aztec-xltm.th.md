...
############################# Head ############################
head_title: "eSign Xltm เอกสารด้วย Aztec QR Code ใน Java"
head_description: "สร้าง Aztec QR Code และใส่ลงในไฟล์ Xltm โดยใช้ Java ด้วยโค้ดสั้นๆ Java ใช้ GroupDocs Document Signature API เพื่อลงนามในเอกสารทางธุรกิจและไฟล์ทางอิเล็กทรอนิกส์ด้วย QR Code"

############################# Header ############################
title: "สร้าง Aztec ลายเซ็นรหัส QR สำหรับเอกสาร Xltm ใน Java"
description: "eSign Xltm เอกสารและสัญญาของคุณด้วยรหัส QR Aztec สร้างลายเซ็น QR Code อย่างรวดเร็วและง่ายดาย"
