...
############################# Head ############################
head_title: "eSign Ppt dokument G S1 Data Matrix QR-koodiga rakenduses Java"
head_description: "Looge QR-kood G S1 Data Matrix ja sisestage see faili Ppt, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Ppt QR-koodi allkiri G S1 Data Matrix"
description: "eAllkirjasta oma Ppt dokumendid ja lepingud QR-koodiga G S1 Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Ppt allkirjastamiseks rakendusega Qrcode rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Ppt dokumente Qrcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Ppt allkirjastamine Qrcode reaalajas demoga"
    content: |
