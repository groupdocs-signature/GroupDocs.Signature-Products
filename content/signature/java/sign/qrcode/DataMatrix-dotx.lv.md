...
############################# Head ############################
head_title: "eSign Dotx dokuments ar Data Matrix QR kodu programmā Java"
head_description: "Izveidojiet Data Matrix QR kodu un ievietojiet to failā Dotx, izmantojot Java un īsu Java kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt Data Matrix QR koda parakstu dokumentam Dotx programmā Java"
description: "eParakstiet savus Dotx dokumentus un līgumus ar Data Matrix QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Dotx ar Qrcode programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Dotx dokumentus ar Qrcode parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Dotx parakstīšana, izmantojot Qrcode tiešraides demonstrāciju"
    content: |
