...
############################# Head ############################
head_title: "eSign Xltm document with Aztec QR Code in Java"
head_description: "Create Aztec QR Code Signature on Xltm file for Java using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Xltm document in Java"
description: "eSign your Xltm documents and contracts with Aztec QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
