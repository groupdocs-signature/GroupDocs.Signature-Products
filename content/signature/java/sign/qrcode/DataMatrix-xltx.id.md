...
############################# Head ############################
head_title: "eSign Xltx dokumen dengan Data Matrix QR Code di Java"
head_description: "Buat Kode QR Data Matrix dan letakkan di file Xltx menggunakan Java dengan potongan pendek kode Java. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat Data Matrix tanda tangan Kode QR untuk dokumen Xltx di Java"
description: "eTandatangani dokumen dan kontrak Xltx Anda dengan Kode QR Data Matrix. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xltx dengan Qrcode di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Xltx dengan Qrcode tanda tangan dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Xltx dengan Qrcode Demo Langsung"
    content: |
