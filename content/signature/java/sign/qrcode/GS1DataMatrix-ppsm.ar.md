...
############################# Head ############################
head_title: "مستند eSign Ppsm مع رمز الاستجابة السريعة G S1 Data Matrix في Java"
head_description: "أنشئ رمز الاستجابة السريعة G S1 Data Matrix وضعه في ملف Ppsm باستخدام Java مع جزء قصير من كود Java. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء G S1 Data Matrix توقيع رمز الاستجابة السريعة لمستند Ppsm في Java"
description: "قم بتوقيع Ppsm على المستندات والعقود باستخدام رمز الاستجابة السريعة G S1 Data Matrix. قم بإنشاء توقيع QR Code بسرعة وسهولة."
