...
############################# Head ############################
head_title: "eSign Bmp documento com G S1 Q R QR Code em Java"
head_description: "Crie G S1 Q R QR Code e coloque-o no arquivo Bmp usando Java com um pequeno pedaço de código Java. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere G S1 Q R assinatura de QR Code para Bmp documento em Java"
...
steps:
    enable: true
    title_left: "Etapas para assinar Bmp com Qrcode em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Bmp com assinaturas Qrcode de forma rápida e fácil.
