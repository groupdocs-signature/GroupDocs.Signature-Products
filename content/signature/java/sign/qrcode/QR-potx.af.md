...
############################# Head ############################
head_title: "eSign Potx-dokument met QR QR-kode in Java"
head_description: "Skep QR QR-kode en plaas dit op Potx-lêer deur Java met 'n kort stukkie Java-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer QR QR-kode handtekening vir Potx dokument in Java"
description: "eTeken jou Potx dokumente en kontrakte met QR QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Potx met Qrcode in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Potx dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
        
        * Skep 'n instansie van Signature-klas wat Potx-lêer verskaf wat veronderstel is om te onderteken as pad of geheuestroom
        * Instansieer SignOptions-klas en stel alle verlangde data in.
        * Roep die Signature.Sign()-metode deur die uitvoer Potx-lêer of geheuestroom deur te gee
...
demos:
    enable: true
    title: "Teken Potx dokumente met Qrcode Regstreekse Demo"
    content: |
       Teken nou die Potx-lêer met verskeie handtekeninge deur die [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webwerf te besoek. Gratis aanlyn demo wag vir jou.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR-kode (afgekort van Quick Response Code) is die handelsmerk vir 'n tipe matriksstrepieskode (of tweedimensionele strepieskode). Dit is die gewildste en algemeenste tipe tweedimensionele kode. In die praktyk bevat QR-kodes dikwels data vir 'n opspoorder, identifiseerder of spoorsnyer wat na 'n webwerf of toepassing wys.
          characterset: |
             Al 256 ASCII karakters + Kanji
          textcapacity: |
             Tot 7 089 numeriese karakters, 4 296 alfanumeriese karakters, 2 953 grepe (binêre data) of 1 817 Kanji-karakters.
          image: |
...
more_formats:
    ...
    content: |
        "Jy kan ook Potx met ander handtekeningtipes onderteken. Sien asseblief die lys hieronder."
    format: 
