...
############################# Head ############################
head_title: "Belgeya eSign Ppsx bi G S1 Data Matrix Koda QR di Java"
head_description: "Koda QR-a G S1 Data Matrix biafirînin û bi koda Java bi koda Java li pelê Ppsx bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di Java de ji bo belgeya G S1 Data Matrix îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên Ppsx bi koda QR-a G S1 Data Matrix îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Ppsx bi Qrcode di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Ppsx bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
        
        * Nimûneyek ji çîna îmzayê biafirîne ku pelê Ppsx pêşkêş dike ku divê wekî rêyek an herikîna bîranînê were îmzekirin
        * Dersa SignOptions destnîşan bikin û hemî daneyên daxwazkirî bicîh bikin.
        * Rêbaza Signature.Sign() vexwend ku derana pelê Ppsx an jî herikîna bîrê derbas dike
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Ppsx bi Qrcode Demoya Zindî"
    content: |
       Naha bi serdana malpera [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) pelê Ppsx bi îmzeyên cihêreng îmze bikin. Demoya serhêl a belaş li benda we ye.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix guhertoyek Data Matrixê ye ku li gorî taybetmendiyên GS1-ê tevdigere. GS1 DataMatrix bikar bînin da ku agahdariya wekî, lê ne bi sînorkirî, ya jêrîn şîfre bike: AI (01) Jimareya Bazirganiya Gerdûnî (GTIN), AI (17) Dîroka Dawîbûnê, AI (10) Hejmara Komê, AI (21) Jimareya Rêze .
          characterset: |
             Koma tîpan: tîpên mezin û biçûk û tîpên taybet $@%*+-./:=<>;&*_,'! hemî bi Nasnameyên Serlêdanê yên rast.
          textcapacity: |
             Kapasîteya kodetextê: heya 3116 reqemên hejmarî, an 2335 tîpên hejmarî yên alfa.
          image: |
...
more_formats:
    ...
    content: |
        "Her weha hûn dikarin Ppsx bi celebên din ên îmzayê re îmze bikin. Ji kerema xwe lîsteya jêrîn bibînin."
    format: 
