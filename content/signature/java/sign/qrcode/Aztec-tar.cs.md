...
############################# Head ############################
head_title: "Dokument eSign Tar s Aztec QR kódem v Java"
head_description: "Vytvořte QR kód Aztec a vložte jej do souboru Tar pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis Aztec QR kódu pro dokument Tar v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Tar pomocí QR kódu Aztec. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Tar pomocí Qrcode v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Tar pomocí podpisů Qrcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Tar pomocí živé ukázky Qrcode"
    content: |
