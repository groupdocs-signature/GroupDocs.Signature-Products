...
############################# Head ############################
head_title: "eSign Ppsx έγγραφο με Data Matrix QR Code στο Java"
head_description: "Δημιουργήστε Data Matrix κώδικα QR και τοποθετήστε τον σε αρχείο Ppsx χρησιμοποιώντας το Java με ένα σύντομο κομμάτι κώδικα Java. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε ηλεκτρονικά τα έγγραφα και τα αρχεία της επιχείρησής σας με QR Code."

############################# Header ############################
title: "Δημιουργήστε Data Matrix υπογραφή κώδικα QR για το έγγραφο Ppsx στο Java"
description: "Ηλεκτρονικά υπογράψτε τα έγγραφα και τις συμβάσεις του Ppsx με τον κωδικό QR Data Matrix. Δημιουργήστε υπογραφή κωδικού QR γρήγορα και εύκολα."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Το Data Matrix είναι ένας δισδιάστατος κώδικας που αποτελείται από ασπρόμαυρα «κελιά» ή κουκκίδες διατεταγμένες είτε σε τετράγωνο είτε σε ορθογώνιο μοτίβο, γνωστό και ως μήτρα. Οι πληροφορίες που θα κωδικοποιηθούν μπορεί να είναι κείμενο ή αριθμητικά δεδομένα.
          characterset: |
             Υποστηρίζει και τους 256 χαρακτήρες ASCII, όλους τους χαρακτήρες ISO και όλους τους χαρακτήρες Extended Binary Coded Decimal Interchange Code (EBCDIC).
          textcapacity: |
             Έως 3116 αριθμητικά ψηφία ή 2335 αλφαριθμητικούς χαρακτήρες ή 1556 δυαδικούς χαρακτήρες.
          image: |
