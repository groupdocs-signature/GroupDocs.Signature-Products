...
############################# Head ############################
head_title: "Java میں QR QR کوڈ کے ساتھ eSign Potx دستاویز"
head_description: "QR QR کوڈ بنائیں اور اسے Java کا استعمال کرتے ہوئے Java کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Potx فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "Java میں Potx دستاویز کے لیے QR QR کوڈ دستخط بنائیں"
description: "اپنے Potx دستاویزات اور معاہدوں پر QR QR کوڈ کے ساتھ دستخط کریں۔ QR کوڈ دستخط جلدی اور آسانی سے بنائیں۔"
...
steps:
    enable: true
    title_left: "Java میں Qrcode کے ساتھ Potx پر دستخط کرنے کے مراحل"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) جلد اور آسانی سے Qrcode دستخطوں کے ساتھ Potx دستاویزات پر دستخط کرنے کی صلاحیت فراہم کرتا ہے۔
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            کیو آر کوڈ (کوئیک ریسپانس کوڈ سے مخفف) میٹرکس بارکوڈ (یا دو جہتی بارکوڈ) کی ایک قسم کا ٹریڈ مارک ہے۔ یہ دو جہتی کوڈ کی سب سے زیادہ مقبول اور وسیع پیمانے پر استعمال شدہ قسم ہے۔ عملی طور پر، QR کوڈز میں اکثر لوکیٹر، شناخت کنندہ، یا ٹریکر کا ڈیٹا ہوتا ہے جو ویب سائٹ یا ایپلیکیشن کی طرف اشارہ کرتا ہے۔
          characterset: |
             تمام 256 ASCII حروف + کانجی
          textcapacity: |
             7089 عددی حروف، 4296 حروف عددی حروف، 2953 بائٹس (بائنری ڈیٹا) یا 1817 کانجی حروف تک۔
          image: |
