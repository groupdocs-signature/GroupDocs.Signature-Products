...
############################# Head ############################
head_title: "eSign Potx dokument Data Matrix QR-koodiga rakenduses Java"
head_description: "Looge QR-kood Data Matrix ja sisestage see faili Potx, kasutades Java koos lühikese Java koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge Java dokumendile Potx QR-koodi allkiri Data Matrix"
description: "eAllkirjasta oma Potx dokumendid ja lepingud QR-koodiga Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Andmemaatriks on kahemõõtmeline kood, mis koosneb mustvalgetest lahtritest või punktidest, mis on paigutatud kas ruudu- või ristkülikukujuliseks mustriks, mida nimetatakse ka maatriksiks. Kodeeritav teave võib olla tekst- või arvandmed.
          characterset: |
             Toetab kõiki 256 ASCII-märki, kõiki ISO-märke ja kõiki laiendatud kahendkoodiga kümnendvahetuskoodi (EBCDIC) märke.
          textcapacity: |
             Kuni 3116 numbrilist numbrit või 2335 tähtnumbrilist märki või 1556 kahendmärki.
          image: |
