...
############################# Head ############################
head_title: "eSign Xltx dokument s QR QR kódom v Java"
head_description: "Vytvorte QR QR kód a vložte ho do súboru Xltx pomocou Java s krátkym kódom Java. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte QR podpis QR kódu pre dokument Xltx v Java"
description: "ePodpíšte svoje Xltx dokumenty a zmluvy pomocou QR QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR Code (skrátene z Quick Response Code) je ochranná známka pre typ maticového čiarového kódu (alebo dvojrozmerného čiarového kódu). Je to najpopulárnejší a najrozšírenejší typ dvojrozmerného kódu. V praxi QR kódy často obsahujú údaje pre lokátor, identifikátor alebo sledovač, ktorý ukazuje na webovú stránku alebo aplikáciu.
          characterset: |
             Všetkých 256 znakov ASCII + Kanji
          textcapacity: |
             Až 7089 numerických znakov, 4296 alfanumerických znakov, 2953 bajtov (binárne dáta) alebo 1817 znakov Kanji.
          image: |
