...
############################# Head ############################
head_title: "Java で QR QR コードを使用して Jpg 文書に eSign"
head_description: "QR QR コードを作成し、短い Java コードを含む Java を使用して Jpg ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "Java の Jpg ドキュメントの QR QR コード署名を生成します"
description: "Jpg ドキュメントと契約書に QR QR コードで電子署名します。 QR コード署名をすばやく簡単に生成します。"
...
steps:
    enable: true
    title_left: "Java で Qrcode を使用して Jpg に署名する手順"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) は、Jpg ドキュメントに Qrcode 署名ですばやく簡単に署名する機能を提供します。
