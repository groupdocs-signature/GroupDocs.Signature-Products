...
############################# Head ############################
head_title: "Documento de firma electrónica Potx con G S1 Q R código QR en Java"
head_description: "Cree el código QR G S1 Q R y colóquelo en el archivo Potx usando Java con un fragmento corto de código Java. Utilice la API de firma de documentos de GroupDocs para firmar electrónicamente sus documentos y archivos comerciales con código QR."

############################# Header ############################
title: "Genere la firma del código QR G S1 Q R para el documento Potx en Java"
description: "Firme electrónicamente sus Potx documentos y contratos con G S1 Q R QR Code. Genere la firma del código QR de forma rápida y sencilla."
...
steps:
    enable: true
    title_left: "Pasos para firmar Potx con Qrcode en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Potx con Qrcode firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Potx documentos con Qrcode Live Demo"
    content: |
