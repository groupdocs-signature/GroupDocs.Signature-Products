...
############################# Head ############################
head_title: "eSign Pdf dokumen dengan QR QR Code dalam Java"
head_description: "Cipta QR Kod QR dan letakkan pada fail Pdf menggunakan Java dengan sekeping pendek kod Java. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan QR tandatangan Kod QR untuk Pdf dokumen dalam Java"
description: "eTandatangani dokumen dan kontrak Pdf anda dengan Kod QR QR. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pdf dengan Qrcode dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Pdf dengan tandatangan Qrcode dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Pdf dengan Qrcode Demo Langsung"
    content: |
