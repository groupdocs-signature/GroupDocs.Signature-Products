...
############################# Head ############################
head_title: "eSign Potm-dokument med QR QR-kod i Java"
head_description: "Skapa QR QR-kod och lägg den i filen Potm med Java med en kort bit av Java-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera QR QR-kodsignatur för Potm dokument i Java"
description: "esignera dina Potm-dokument och kontrakt med QR QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Potm med Qrcode i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Potm-dokument med Qrcode-signaturer snabbt och enkelt.
