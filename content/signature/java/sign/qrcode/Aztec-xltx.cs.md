...
############################# Head ############################
head_title: "Dokument eSign Xltx s Aztec QR kódem v Java"
head_description: "Vytvořte QR kód Aztec a vložte jej do souboru Xltx pomocí Java s krátkým kódem Java. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis Aztec QR kódu pro dokument Xltx v Java"
description: "ePodepište své dokumenty a smlouvy ve formátu Xltx pomocí QR kódu Aztec. Vygenerujte podpis QR kódu rychle a snadno."
