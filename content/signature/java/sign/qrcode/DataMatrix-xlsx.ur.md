...
############################# Head ############################
head_title: "Java میں Data Matrix QR کوڈ کے ساتھ eSign Xlsx دستاویز"
head_description: "Data Matrix QR کوڈ بنائیں اور اسے Java کا استعمال کرتے ہوئے Java کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Xlsx فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "Java میں Xlsx دستاویز کے لیے Data Matrix QR کوڈ دستخط بنائیں"
description: "اپنے Xlsx دستاویزات اور معاہدوں پر Data Matrix QR کوڈ کے ساتھ دستخط کریں۔ QR کوڈ دستخط جلدی اور آسانی سے بنائیں۔"
...
steps:
    enable: true
    title_left: "Java میں Qrcode کے ساتھ Xlsx پر دستخط کرنے کے مراحل"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) جلد اور آسانی سے Qrcode دستخطوں کے ساتھ Xlsx دستاویزات پر دستخط کرنے کی صلاحیت فراہم کرتا ہے۔
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ڈیٹا میٹرکس ایک دو جہتی کوڈ ہے جو سیاہ اور سفید 'خلیات' یا نقطوں پر مشتمل ہوتا ہے جو ایک مربع یا مستطیل پیٹرن میں ترتیب دیا جاتا ہے، جسے میٹرکس بھی کہا جاتا ہے۔ انکوڈ کی جانی والی معلومات متن یا عددی ڈیٹا ہو سکتی ہے۔
          characterset: |
             تمام 256 ASCII حروف، تمام ISO حروف، اور تمام Extended Binary Coded Decimal Interchange Code (EBCDIC) حروف کو سپورٹ کرتا ہے۔
          textcapacity: |
             3116 عددی ہندسے، یا 2335 الفا عددی حروف، یا 1556 بائنری حروف تک۔
          image: |
