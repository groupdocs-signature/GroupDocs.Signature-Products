...
############################# Head ############################
head_title: "eSign Webp დოკუმენტი Data Matrix QR კოდით Java-ში"
head_description: "შექმენით Data Matrix QR კოდი და განათავსეთ ის Webp ფაილზე Java-ის გამოყენებით Java კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით Data Matrix QR კოდის ხელმოწერა Webp დოკუმენტისთვის Java-ში"
description: "მოაწერეთ თქვენი Webp დოკუმენტები და კონტრაქტები Data Matrix QR კოდით. შექმენით QR კოდის ხელმოწერა სწრაფად და მარტივად."
...
steps:
    enable: true
    title_left: "Webp-ით ხელმოწერის ნაბიჯები Qrcode-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Webp დოკუმენტები Qrcode ხელმოწერებით სწრაფად და მარტივად.
        
        * შექმენით ხელმოწერის კლასის მაგალითი, რომელიც უზრუნველყოფს Webp ფაილს, რომელიც უნდა მოაწეროს ხელი, როგორც გზა ან მეხსიერების ნაკადი
        * Instantate SignOptions კლასი და დააყენეთ ყველა მოთხოვნილი მონაცემი.
        * გამოიძახეთ Signature.Sign() მეთოდი, რომელიც გადასცემს გამომავალ Webp ფაილს ან მეხსიერების ნაკადს
...
demos:
    enable: true
    title: "დოკუმენტების Webp ხელმოწერა Qrcode Live Demo-ით"
    content: |
       მოაწერეთ Webp ფაილი სხვადასხვა ხელმოწერებით ახლავე, ეწვიეთ [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) ვებსაიტს. უფასო ონლაინ დემო გელოდებათ.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            მონაცემთა მატრიცა არის ორგანზომილებიანი კოდი, რომელიც შედგება შავი და თეთრი „უჯრედებისგან“ ან წერტილებისგან, რომლებიც განლაგებულია კვადრატულ ან მართკუთხა შაბლონში, რომელიც ასევე ცნობილია როგორც მატრიცა. დაშიფრული ინფორმაცია შეიძლება იყოს ტექსტური ან რიცხვითი მონაცემები.
          characterset: |
             მხარს უჭერს ყველა 256 ASCII სიმბოლოს, ყველა ISO სიმბოლოს და ყველა გაფართოებული ორობითი კოდირებული ათწილადის ურთიერთგაცვლის კოდის (EBCDIC) სიმბოლოს.
          textcapacity: |
             3116-მდე რიცხვითი ციფრი, ან 2335 ალფა რიცხვითი სიმბოლო, ან 1556 ორობითი სიმბოლო.
          image: |
...
more_formats:
    ...
    content: |
        "თქვენ ასევე შეგიძლიათ მოაწეროთ Webp ხელმოწერის სხვა ტიპებით. გთხოვთ იხილოთ სია ქვემოთ."
    format: 
