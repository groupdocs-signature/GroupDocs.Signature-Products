...
############################# Head ############################
head_title: "eSign Pdf dokumentas su G S1 Data Matrix QR kodu Java"
head_description: "Sukurkite QR kodą G S1 Data Matrix ir įdėkite jį į failą Pdf naudodami Java su trumpu Java kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Data Matrix QR kodo parašą Pdf dokumentui Java"
description: "e. Pasirašykite Pdf dokumentus ir sutartis naudodami G S1 Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Pdf naudojant Qrcode programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Pdf dokumentus su Qrcode parašais.
...
demos:
    enable: true
    title: "Dokumentų Pdf pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
