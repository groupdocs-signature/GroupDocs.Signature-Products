...
############################# Head ############################
head_title: "Document electrònic Ott amb codi QR Data Matrix a Java"
head_description: "Creeu Data Matrix codi QR i col·loqueu-lo al fitxer Ott amb Java amb un tros curt de codi Java. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de Data Matrix per al document Ott a Java"
description: "eSigneu els vostres documents i contractes de Ott amb el codi QR de Data Matrix. Genereu la signatura del codi QR de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Passos per signar Ott amb Qrcode a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Ott amb signatures Qrcode de manera ràpida i senzilla.
