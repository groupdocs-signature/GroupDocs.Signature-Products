...
############################# Head ############################
head_title: "Documento de firma electrónica Ppsx con G S1 Q R código QR en Java"
head_description: "Cree el código QR G S1 Q R y colóquelo en el archivo Ppsx usando Java con un fragmento corto de código Java. Utilice la API de firma de documentos de GroupDocs para firmar electrónicamente sus documentos y archivos comerciales con código QR."

############################# Header ############################
title: "Genere la firma del código QR G S1 Q R para el documento Ppsx en Java"
description: "Firme electrónicamente sus Ppsx documentos y contratos con G S1 Q R QR Code. Genere la firma del código QR de forma rápida y sencilla."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            El Código QR GS1 es una variante del Código QR que cumple con las especificaciones GS1. Fue diseñado específicamente para compartir información de empaque ampliada, como el número de lote, la identificación del producto y la cantidad.
          characterset: |
             Mayúsculas, minúsculas y caracteres especiales $%*+-./: todos con los identificadores de aplicación correctos
          textcapacity: |
             Hasta 7089 caracteres numéricos, 4296 caracteres alfanuméricos
          image: |
