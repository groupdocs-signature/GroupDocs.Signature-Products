...
############################# Head ############################
head_title: "eSign Potx dokumentum Data Matrix QR-kóddal a Java nyelven"
head_description: "Hozzon létre Data Matrix QR-kódot, és helyezze el a Potx fájlba a Java használatával egy rövid Java kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon Data Matrix QR-kód aláírást a Potx dokumentumhoz a Java programban"
description: "eAláírja Potx dokumentumait és szerződéseit Data Matrix QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
...
demos:
    enable: true
    title: "Potx dokumentumok aláírása Qrcode élő bemutatóval"
    content: |
       A [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webhelyen azonnal írjon alá Potx fájlt különféle aláírásokkal. Ingyenes online demo vár rád.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Az adatmátrix egy kétdimenziós kód, amely fekete-fehér „cellákból” vagy pontokból áll, amelyek négyzet vagy téglalap alakú mintában vannak elrendezve, vagy más néven mátrix. A kódolandó információ lehet szöveges vagy numerikus adat.
          characterset: |
             Támogatja az összes 256 ASCII karaktert, az összes ISO karaktert és az összes kiterjesztett bináris kódolású decimális cserekód (EBCDIC) karaktert.
          textcapacity: |
             Legfeljebb 3116 numerikus számjegy, 2335 alfanumerikus karakter vagy 1556 bináris karakter.
          image: |
...
more_formats:
    ...
    content: |
        "A Potx más aláírástípusokkal is aláírható. Kérjük, tekintse meg az alábbi listát."
    format: 
