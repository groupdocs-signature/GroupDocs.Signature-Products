...
############################# Head ############################
head_title: "eSign documentul Svg cu codul QR Aztec în Java"
head_description: "Creați codul QR Aztec și puneți-l în fișierul Svg folosind Java cu o scurtă bucată de cod Java. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura Aztec cod QR pentru documentul Svg în Java"
description: "eSemnați documentele și contractele Svg cu codul QR Aztec. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Svg cu Qrcode în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Svg cu semnături Qrcode rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Svg cu Qrcode Live Demo"
    content: |
