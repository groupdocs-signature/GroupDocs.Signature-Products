...
############################# Head ############################
head_title: "eSign Xltm dokumen dengan QR QR Code di Java"
head_description: "Buat Kode QR QR dan letakkan di file Xltm menggunakan Java dengan potongan pendek kode Java. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat QR tanda tangan Kode QR untuk dokumen Xltm di Java"
description: "eTandatangani dokumen dan kontrak Xltm Anda dengan Kode QR QR. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          characterset: |
             Semua 256 karakter ASCII + Kanji
          textcapacity: |
             Hingga 7089 karakter numerik, 4296 karakter alfanumerik, 2953 byte (data biner) atau 1817 karakter Kanji.
          image: |
