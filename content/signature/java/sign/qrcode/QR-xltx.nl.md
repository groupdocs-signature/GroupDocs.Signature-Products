...
############################# Head ############################
head_title: "eSign Xltx document met QR QR-code in Java"
head_description: "Maak een QR QR-code en plaats deze in het Xltx-bestand met behulp van Java met een kort stukje Java-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer QR QR Code handtekening voor Xltx document in Java"
description: "Onderteken uw Xltx documenten en contracten met QR QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR-code (afgekort van Quick Response Code) is het handelsmerk voor een type matrixbarcode (of tweedimensionale streepjescode). Het is het meest populaire en meest gebruikte type tweedimensionale code. In de praktijk bevatten QR-codes vaak gegevens voor een locator, identifier of tracker die naar een website of applicatie verwijst.
          characterset: |
             Alle 256 ASCII-tekens + Kanji
          textcapacity: |
             Maximaal 7089 numerieke tekens, 4296 alfanumerieke tekens, 2953 bytes (binaire gegevens) of 1817 Kanji-tekens.
          image: |
