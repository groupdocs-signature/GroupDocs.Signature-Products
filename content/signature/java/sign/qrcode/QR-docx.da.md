...
head_description: "Opret QR QR-kode og læg den i Docx-filen ved hjælp af Java med et kort stykke Java-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Docx dokument i Java"
description: "eSignér dine Docx-dokumenter og kontrakter med QR QR-kode. Generer QR-kodesignatur hurtigt og nemt."
