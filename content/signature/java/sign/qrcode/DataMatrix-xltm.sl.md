...
############################# Head ############################
head_title: "eSign Xltm dokument s Data Matrix QR kodo v Java"
head_description: "Ustvarite QR kodo Data Matrix in jo postavite v datoteko Xltm z uporabo Java s kratkim delom kode Java. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari Data Matrix podpis kode QR za dokument Xltm v Java"
description: "e-Podpišite svoje Xltm dokumente in pogodbe s Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
