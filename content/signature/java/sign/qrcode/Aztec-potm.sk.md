...
############################# Head ############################
head_title: "eSign Potm dokument s Aztec QR kódom v Java"
head_description: "Vytvorte Aztec QR kód a vložte ho do súboru Potm pomocou Java s krátkym kódom Java. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte Aztec podpis QR kódu pre dokument Potm v Java"
description: "ePodpíšte svoje Potm dokumenty a zmluvy pomocou Aztec QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztécky kód je dvojrozmerná (2-D) maticová symbolika na všeobecné účely, ktorá je navrhnutá tak, aby mala vyššiu presnosť ako iné 2-D symboliky. Symbol aztéckeho kódu môže zakódovať až 3 832 číslic; 3 067 abecedných znakov; alebo 1 914 bajtov dát.
          characterset: |
             Všetkých 256 znakov ASCII.
          textcapacity: |
             Až 3 832 numerických číslic alebo 3 067 abecedných znakov alebo 1 914 bajtov údajov.
          image: |
