...
############################# Head ############################
head_title: "eSign Pps documento con Data Matrix codice QR in Java"
head_description: "Crea il codice QR Data Matrix e inseriscilo nel file Pps utilizzando Java con un breve pezzo di codice Java. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Data Matrix firma del codice QR per il documento Pps in Java"
description: "Firma i tuoi documenti e contratti Pps con il codice QR Data Matrix. Genera la firma del codice QR in modo rapido e semplice."
