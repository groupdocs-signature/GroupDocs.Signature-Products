...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko Odp z Java"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko Odp za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Odp datoteke s podpisi Image v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Odp z Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Odp s podpisi Image.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Odp z Image Live Demo"
    content: |
