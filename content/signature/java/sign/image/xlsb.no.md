...
############################# Head ############################
head_title: "Legger til Image-signaturer til Xlsb-filen med Java"
head_description: "Sett Image-signatur på Xlsb-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Xlsb-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Xlsb med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Xlsb-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Xlsb dokumenter med Image Live Demo"
    content: |
