...
############################# Head ############################
head_title: "Dodavanje potpisa Image u datoteku Potm s Java"
head_description: "Stavite potpis Image na datoteku Potm za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Potm datoteke s Image potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Potm s Image u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Potm dokumenata s Image potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Potm dokumenata s Image Live Demo"
    content: |
