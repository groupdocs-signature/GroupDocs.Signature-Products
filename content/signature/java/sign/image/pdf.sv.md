...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Pdf med Java"
head_description: "Sätt Image Signatur på Pdf-filen för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Pdf-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Pdf med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Pdf-dokument med Image-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Pdf dokument med Image Live Demo"
    content: |
