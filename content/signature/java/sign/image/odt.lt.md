...
############################# Head ############################
head_title: "Image parašų pridėjimas prie Odt failo naudojant Java"
head_description: "Įdėkite Image parašą į Odt failą, skirtą Java, naudodami kelias kodo eilutes. Norėdami pasirašyti daugybę failų formatų, naudokite GroupDocs Document Signature API."

############################# Header ############################
title: "Pasirašykite Odt failus naudodami Image parašus Java"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Odt naudojant Image programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Odt dokumentus su Image parašais.
...
demos:
    enable: true
    title: "Dokumentų Odt pasirašymas naudojant Image tiesioginę demonstraciją"
    content: |
