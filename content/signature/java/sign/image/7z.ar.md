...
############################# Head ############################
head_title: "إضافة Image توقيعات إلى ملف 7z باستخدام Java"
head_description: "ضع Image التوقيع على ملف 7z لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات 7z بتوقيعات Image في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل 7z باستخدام Image في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات 7z بتوقيعات Image بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات 7z باستخدام العرض التوضيحي المباشر Image"
    content: |
