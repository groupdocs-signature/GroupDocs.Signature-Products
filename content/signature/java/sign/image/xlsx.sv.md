...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Xlsx med Java"
head_description: "Sätt Image Signatur på Xlsx-filen för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Xlsx-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Xlsx med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Xlsx-dokument med Image-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Xlsx dokument med Image Live Demo"
    content: |
