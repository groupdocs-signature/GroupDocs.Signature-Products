...
############################# Head ############################
head_title: "Menambahkan tanda tangan Image ke file Xls dengan Java"
head_description: "Letakkan Image Signature pada file Xls untuk Java menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "Tanda tangani file Xls dengan tanda tangan Image di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xls dengan Image di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Xls dengan Image tanda tangan dengan cepat dan mudah.
