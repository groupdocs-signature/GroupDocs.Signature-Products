...
############################# Head ############################
head_title: "Ag cur Image sínithe le comhad Ppsx le Java"
head_description: "Cuir Image Síniú ar Ppsx comhad le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Ppsx comhad le sínithe Image in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Ppsx a shíniú le Image in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Ppsx a shíniú le sínithe Image go tapa agus go héasca.
