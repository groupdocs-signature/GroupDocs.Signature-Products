...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Xltx lêer met Java"
head_description: "Plaas Image Handtekening op Xltx lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Xltx lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Xltx met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Xltx dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Xltx dokumente met Image Regstreekse Demo"
    content: |
