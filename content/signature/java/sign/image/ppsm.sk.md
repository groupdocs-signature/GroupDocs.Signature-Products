...
############################# Head ############################
head_title: "Pridanie podpisov Image do súboru Ppsm pomocou Java"
head_description: "Vložte podpis Image do súboru Ppsm pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Ppsm pomocou podpisov Image v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Ppsm pomocou Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Ppsm pomocou podpisov Image.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Ppsm pomocou živej ukážky Image"
    content: |
