...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Bmp pomocí Java"
head_description: "Vložte podpis Image do souboru Bmp pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Bmp pomocí podpisů Image v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Bmp pomocí Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Bmp pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Bmp pomocí živé ukázky Image"
    content: |
