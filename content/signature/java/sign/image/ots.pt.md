...
############################# Head ############################
head_title: "Adicionando assinaturas Image ao arquivo Ots com Java"
head_description: "Coloque a assinatura Image no arquivo Ots para Java usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Ots arquivos com assinaturas Image em Java"
...
steps:
    enable: true
    title_left: "Etapas para assinar Ots com Image em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Ots com assinaturas Image de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Ots documentos com Image Demonstração ao vivo"
    content: |
