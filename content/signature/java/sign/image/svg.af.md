...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Svg lêer met Java"
head_description: "Plaas Image Handtekening op Svg lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Svg lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Svg met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Svg dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Svg dokumente met Image Regstreekse Demo"
    content: |
