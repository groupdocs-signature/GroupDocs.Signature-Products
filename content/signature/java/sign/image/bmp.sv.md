...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Bmp med Java"
head_description: "Sätt Image Signatur på Bmp-filen för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Bmp-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Bmp med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Bmp-dokument med Image-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Bmp dokument med Image Live Demo"
    content: |
