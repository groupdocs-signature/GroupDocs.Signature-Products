...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Potx rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Potx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Potx allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Potx allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Potx dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Potx allkirjastamine Image reaalajas demoga"
    content: |
