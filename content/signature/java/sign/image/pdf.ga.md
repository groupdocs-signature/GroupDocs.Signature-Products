...
############################# Head ############################
head_title: "Ag cur Image sínithe le comhad Pdf le Java"
head_description: "Cuir Image Síniú ar Pdf comhad le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Pdf comhad le sínithe Image in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Pdf a shíniú le Image in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Pdf a shíniú le sínithe Image go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Pdf doiciméad le Image Taispeántas Beo"
    content: |
