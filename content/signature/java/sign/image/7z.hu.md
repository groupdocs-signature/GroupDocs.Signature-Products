...
############################# Head ############################
head_title: "Image aláírás hozzáadása a 7z fájlhoz a Java segítségével"
head_description: "Helyezzen Image aláírást a Java 7z fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "7z fájl aláírása Image aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A 7z aláírásának lépései a Image segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a 7z dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "7z dokumentumok aláírása Image élő bemutatóval"
    content: |
