...
############################# Head ############################
head_title: "Afegint Image signatures al fitxer Otp amb Java"
head_description: "Poseu la signatura Image al fitxer Otp per a Java utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "Signa fitxers Otp amb signatures Image a Java"
...
steps:
    enable: true
    title_left: "Passos per signar Otp amb Image a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Otp amb signatures Image de manera ràpida i senzilla.
...
demos:
    enable: true
    title: "Signant documents de Otp amb Image Demostració en directe"
    content: |
