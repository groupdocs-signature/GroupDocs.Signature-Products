...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Tar lêer met Java"
head_description: "Plaas Image Handtekening op Tar lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Tar lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Tar met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Tar dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Tar dokumente met Image Regstreekse Demo"
    content: |
