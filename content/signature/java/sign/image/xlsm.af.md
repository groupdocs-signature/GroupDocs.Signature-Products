...
############################# Header ############################
title: "Teken Xlsm lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Xlsm met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Xlsm dokumente met Image handtekeninge vinnig en maklik te onderteken.
