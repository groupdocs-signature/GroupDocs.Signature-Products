...
############################# Head ############################
head_title: "Menambahkan tandatangan Image pada fail Tar dengan Java"
head_description: "Letakkan Image Tandatangan pada fail Tar untuk Java menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Tar dengan tandatangan Image dalam Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Tar dengan Image dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Tar dengan tandatangan Image dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Tar dengan Image Demo Langsung"
    content: |
