...
############################# Head ############################
head_title: "Добавяне на подписи Image към файл Pptx с Java"
head_description: "Поставете подпис Image върху файл Pptx за Java, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature, за да подписвате десетки файлови формати."

############################# Header ############################
title: "Подпишете Pptx файлове с Image подписи в Java"
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Pptx с Image в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на Pptx документи с Image подписи.
...
demos:
    enable: true
    title: "Подписване на Pptx документи с Image Демо на живо"
    content: |
