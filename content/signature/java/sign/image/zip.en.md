...
############################# Head ############################
head_title: "Adding Image signatures to Zip file with Java"
head_description: "Put Image Signature on Zip file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "Sign Zip files with Image signatures in Java"
...
steps:
    enable: true
    title_left: "Steps to sign Zip with Image in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Zip documents with Image signatures quickly and easily.
...
demos:
    enable: true
    title: "Signing Zip documents with Image Live Demo"
    content: |
