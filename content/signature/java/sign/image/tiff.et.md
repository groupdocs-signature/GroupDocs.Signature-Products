...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Tiff rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Tiff, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Tiff allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Tiff allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Tiff dokumente Image allkirjaga.
