...
############################# Head ############################
head_title: "Java ile Ppsx dosyasına Image imza ekleme"
head_description: "Birkaç satır kod kullanarak Java için Ppsx dosyasına Image İmza koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Ppsx dosyalarını Image imzasıyla Java içinde imzalayın"
...
steps:
    enable: true
    title_left: "Java içinde Image ile Ppsx imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Ppsx belgelerini Image imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Ppsx dokümanı Image Canlı Demo ile imzalama"
    content: |
