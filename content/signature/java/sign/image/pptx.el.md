...
############################# Head ############################
head_title: "Προσθήκη υπογραφών Image στο αρχείο Pptx με Java"
head_description: "Τοποθετήστε το Image Signature στο αρχείο Pptx για το Java χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε δεκάδες μορφές αρχείων."

############################# Header ############################
title: "Υπογράψτε αρχεία Pptx με υπογραφές Image στο Java"
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Pptx με Image στο Java"
    content_left: |
        Το [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) παρέχει τη δυνατότητα υπογραφής εγγράφων Pptx με υπογραφές Image γρήγορα και εύκολα.
...
demos:
    enable: true
    title: "Υπογραφή εγγράφων Pptx με Image Ζωντανή επίδειξη"
    content: |
