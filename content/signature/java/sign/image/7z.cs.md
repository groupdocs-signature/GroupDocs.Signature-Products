...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru 7z pomocí Java"
head_description: "Vložte podpis Image do souboru 7z pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory 7z pomocí podpisů Image v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání 7z pomocí Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty 7z pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů 7z pomocí živé ukázky Image"
    content: |
