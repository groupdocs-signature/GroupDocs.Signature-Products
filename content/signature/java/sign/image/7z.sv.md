...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen 7z med Java"
head_description: "Sätt Image Signatur på 7z-filen för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera 7z-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera 7z med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera 7z-dokument med Image-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar 7z dokument med Image Live Demo"
    content: |
