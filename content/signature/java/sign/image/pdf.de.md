...
############################# Head ############################
head_title: "Hinzufügen von Image-Signaturen zur Pdf-Datei mit Java"
head_description: "Fügen Sie die Image-Signatur in die Pdf-Datei für Java ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Pdf-Dateien mit Image-Signaturen in Java"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Pdf mit Image in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Pdf-Dokumente mit Image-Signaturen schnell und einfach zu signieren.
