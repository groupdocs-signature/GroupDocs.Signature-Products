...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Svg fájlhoz a Java segítségével"
head_description: "Helyezzen Image aláírást a Java Svg fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Svg fájl aláírása Image aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Svg aláírásának lépései a Image segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Svg dokumentumok gyors és egyszerű aláírását Image aláírással.
