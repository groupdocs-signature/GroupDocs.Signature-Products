...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Doc lêer met Java"
head_description: "Plaas Image Handtekening op Doc lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Doc lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Doc met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Doc dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Doc dokumente met Image Regstreekse Demo"
    content: |
