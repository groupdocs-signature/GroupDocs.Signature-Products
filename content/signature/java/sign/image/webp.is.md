...
############################# Head ############################
head_title: "Bætir Image undirskriftum við Webp skrá með Java"
head_description: "Settu Image undirskrift á Webp skrá fyrir Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "Undirritaðu Webp skrár með Image undirskriftum í Java"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Webp með Image í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Webp skjöl með Image undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Webp skjöl með Image lifandi kynningu"
    content: |
