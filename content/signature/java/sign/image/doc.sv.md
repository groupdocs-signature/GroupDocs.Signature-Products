...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Doc med Java"
head_description: "Sätt Image Signatur på Doc-filen för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Doc-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Doc med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Doc-dokument med Image-signaturer snabbt och enkelt.
