...
############################# Head ############################
head_title: "Image қолтаңбаларын Pps файлына Java арқылы қосу"
head_description: "Кодтың бірнеше жолын пайдаланып, Java үшін Pps файлына Image Қолтаңбасын қойыңыз. Ондаған файл пішіміне қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "Pps файлдарға Java жүйесінде Image қолтаңбаларымен қол қойыңыз"
...
steps:
    enable: true
    title_left: "Java жүйесінде Image арқылы Pps файлына қол қою қадамдары"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) Pps құжаттарға Image қолтаңбаларымен жылдам және оңай қол қою мүмкіндігін береді.
...
demos:
    enable: true
    title: "Pps құжаттарға Image тікелей көрсетілімі арқылы қол қою"
    content: |
