...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam Rtf, izmantojot Java"
head_description: "Ievietojiet Image parakstu Rtf failā Java, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Rtf failus ar Image parakstiem programmā Java"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Rtf ar Image programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Rtf dokumentus ar Image parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Rtf parakstīšana, izmantojot Image tiešraides demonstrāciju"
    content: |
