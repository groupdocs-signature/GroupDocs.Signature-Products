...
############################# Head ############################
head_title: "Menambahkan tanda tangan Image ke file Xlsb dengan Java"
head_description: "Letakkan Image Signature pada file Xlsb untuk Java menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "Tanda tangani file Xlsb dengan tanda tangan Image di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xlsb dengan Image di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Xlsb dengan Image tanda tangan dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Xlsb dengan Image Demo Langsung"
    content: |
