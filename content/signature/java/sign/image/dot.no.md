...
############################# Head ############################
head_title: "Legger til Image-signaturer til Dot-filen med Java"
head_description: "Sett Image-signatur på Dot-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Dot-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Dot med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Dot-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Dot dokumenter med Image Live Demo"
    content: |
