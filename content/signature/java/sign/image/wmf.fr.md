...
############################# Head ############################
head_title: "Ajout de signatures Image au fichier Wmf avec Java"
head_description: "Mettez Image Signature sur le fichier Wmf pour Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "Signez des fichiers Wmf avec des signatures Image en Java"
...
about:
    enable: true
    title: "À propos de l'API de signatures d'image GroupDocs.Signature for Java"
    content: |
...
steps:
    enable: true
    title_left: "Étapes pour signer Wmf avec Image dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Wmf avec des signatures Image.
...
demos:
    enable: true
    title: "Signature de documents Wmf avec Image Live Demo"
    content: |
