...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam 7z, izmantojot Java"
head_description: "Ievietojiet Image parakstu 7z failā Java, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt 7z failus ar Image parakstiem programmā Java"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu 7z ar Image programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt 7z dokumentus ar Image parakstiem.
...
demos:
    enable: true
    title: "Dokumentu 7z parakstīšana, izmantojot Image tiešraides demonstrāciju"
    content: |
