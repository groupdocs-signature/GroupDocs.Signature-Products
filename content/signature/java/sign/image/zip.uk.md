...
############################# Head ############################
head_title: "Додавання підписів Image до файлу Zip за допомогою Java"
head_description: "Додайте підпис Image до файлу Zip для Java за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs, щоб підписувати десятки форматів файлів."

############################# Header ############################
title: "Підпишіть файли Zip підписами Image у Java"
...
steps:
    enable: true
    title_left: "Кроки для підпису Zip за допомогою Image у Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) надає можливість швидко та легко підписувати документи Zip за допомогою підписів Image.
...
demos:
    enable: true
    title: "Підпис документів Zip за допомогою Image Live Demo"
    content: |
