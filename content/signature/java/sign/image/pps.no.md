...
############################# Head ############################
head_title: "Legger til Image-signaturer til Pps-filen med Java"
head_description: "Sett Image-signatur på Pps-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Pps-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Pps med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Pps-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Pps dokumenter med Image Live Demo"
    content: |
