...
############################# Head ############################
head_title: "Ag cur Image sínithe le comhad Xltm le Java"
head_description: "Cuir Image Síniú ar Xltm comhad le haghaidh Java ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Xltm comhad le sínithe Image in Java"
...
steps:
    enable: true
    title_left: "Céimeanna chun Xltm a shíniú le Image in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) cumas chun doiciméid Xltm a shíniú le sínithe Image go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Xltm doiciméad le Image Taispeántas Beo"
    content: |
