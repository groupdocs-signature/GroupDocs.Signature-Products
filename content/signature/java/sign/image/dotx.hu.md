...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Dotx fájlhoz a Java segítségével"
head_description: "Helyezzen Image aláírást a Java Dotx fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Dotx fájl aláírása Image aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Dotx aláírásának lépései a Image segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Dotx dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Dotx dokumentumok aláírása Image élő bemutatóval"
    content: |
