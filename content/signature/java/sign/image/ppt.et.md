...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Ppt rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Ppt, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Ppt allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Ppt allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Ppt dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Ppt allkirjastamine Image reaalajas demoga"
    content: |
