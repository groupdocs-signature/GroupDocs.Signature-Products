...
############################# Header ############################
title: "Signera Xlsm-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Xlsm med Image i Java"
    content_left: |
...
demos:
    enable: true
    title: "Signerar Xlsm dokument med Image Live Demo"
    content: |
