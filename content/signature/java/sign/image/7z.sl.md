...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko 7z z Java"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko 7z za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite 7z datoteke s podpisi Image v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis 7z z Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov 7z s podpisi Image.
