...
############################# Head ############################
head_title: "Java ile Xlsb dosyasına Image imza ekleme"
head_description: "Birkaç satır kod kullanarak Java için Xlsb dosyasına Image İmza koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Xlsb dosyalarını Image imzasıyla Java içinde imzalayın"
...
steps:
    enable: true
    title_left: "Java içinde Image ile Xlsb imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Xlsb belgelerini Image imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
