...
############################# Head ############################
head_title: "Java کے ساتھ Docx فائل میں Image دستخط شامل کرنا"
head_description: "کوڈ کی چند سطروں کا استعمال کرتے ہوئے Java کے لیے Docx فائل پر Image دستخط لگائیں۔ درجنوں فائل فارمیٹس پر دستخط کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "Java میں Docx فائلوں پر Image دستخطوں کے ساتھ دستخط کریں"
...
steps:
    enable: true
    title_left: "Java میں Image کے ساتھ Docx پر دستخط کرنے کے مراحل"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) جلد اور آسانی سے Image دستخطوں کے ساتھ Docx دستاویزات پر دستخط کرنے کی صلاحیت فراہم کرتا ہے۔
...
demos:
    enable: true
    title: "Image لائیو ڈیمو کے ساتھ Docx دستاویزات پر دستخط کرنا"
    content: |
