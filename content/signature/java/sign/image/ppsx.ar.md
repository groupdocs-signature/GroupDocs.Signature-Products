...
############################# Head ############################
head_title: "إضافة Image توقيعات إلى ملف Ppsx باستخدام Java"
head_description: "ضع Image التوقيع على ملف Ppsx لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات Ppsx بتوقيعات Image في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Ppsx باستخدام Image في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Ppsx بتوقيعات Image بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Ppsx باستخدام العرض التوضيحي المباشر Image"
    content: |
