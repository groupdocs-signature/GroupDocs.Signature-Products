...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Bmp fájlhoz a Java segítségével"
head_description: "Helyezzen Image aláírást a Java Bmp fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Bmp fájl aláírása Image aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Bmp aláírásának lépései a Image segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Bmp dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Bmp dokumentumok aláírása Image élő bemutatóval"
    content: |
