...
############################# Head ############################
head_title: "Agregando Image firmas al archivo Docm con Java"
head_description: "Coloque la firma Image en el archivo Docm para Java usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "Firme Docm archivos con Image firmas en Java"
...
about:
    enable: true
    title: "Acerca de GroupDocs.Signature for Java API de firmas de imágenes"
    content: |
...
steps:
    enable: true
    title_left: "Pasos para firmar Docm con Image en Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona la capacidad de firmar documentos Docm con Image firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Docm documentos con Image Live Demo"
    content: |
