...
############################# Head ############################
head_title: "Legger til Image-signaturer til Otp-filen med Java"
head_description: "Sett Image-signatur på Otp-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Otp-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Otp med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Otp-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Otp dokumenter med Image Live Demo"
    content: |
