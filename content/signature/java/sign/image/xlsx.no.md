...
############################# Head ############################
head_title: "Legger til Image-signaturer til Xlsx-filen med Java"
head_description: "Sett Image-signatur på Xlsx-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Xlsx-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Xlsx med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Xlsx-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Xlsx dokumenter med Image Live Demo"
    content: |
