...
############################# Head ############################
head_title: "Adding Image signatures to Potm file with Java"
head_description: "Put Image Signature on Potm file for Java using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "Sign Potm files with Image signatures in Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides ability to sign Potm documents with Image signatures quickly and easily.
