...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Ods pomocí Java"
head_description: "Vložte podpis Image do souboru Ods pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Ods pomocí podpisů Image v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Ods pomocí Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Ods pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Ods pomocí živé ukázky Image"
    content: |
