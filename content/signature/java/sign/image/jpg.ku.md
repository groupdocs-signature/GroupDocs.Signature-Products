...
############################# Head ############################
head_title: "Zêdekirina Image îmzeyan li pelê Jpg bi Java"
head_description: "Ji bo Java Image îmza li ser pela Jpg bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Jpg bi îmzeyên Image di Java de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Jpg bi Image di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Jpg bi îmzeyên Image zû û bi hêsanî peyda dike.
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Jpg bi Image Demoya Zindî"
    content: |
