...
############################# Head ############################
head_title: "Aggiunta di firme Image al file Ppt con Java"
head_description: "Inserisci Image Firma sul file Ppt per Java utilizzando poche righe di codice. Usa l'API per la firma dei documenti di GroupDocs per firmare decine di formati di file."

############################# Header ############################
title: "Firma file Ppt con firme Image in Java"
...
steps:
    enable: true
    title_left: "Passaggi per firmare Ppt con Image in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) offre la possibilità di firmare documenti Ppt con firme Image in modo rapido e semplice.
...
demos:
    enable: true
    title: "Firma di documenti Ppt con Image Demo live"
    content: |
