...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam Dotx, izmantojot Java"
head_description: "Ievietojiet Image parakstu Dotx failā Java, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Dotx failus ar Image parakstiem programmā Java"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Dotx ar Image programmā Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina iespēju ātri un vienkārši parakstīt Dotx dokumentus ar Image parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Dotx parakstīšana, izmantojot Image tiešraides demonstrāciju"
    content: |
