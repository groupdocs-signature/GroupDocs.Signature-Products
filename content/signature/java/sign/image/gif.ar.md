...
############################# Head ############################
head_title: "إضافة Image توقيعات إلى ملف Gif باستخدام Java"
head_description: "ضع Image التوقيع على ملف Gif لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات Gif بتوقيعات Image في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Gif باستخدام Image في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Gif بتوقيعات Image بسرعة وسهولة.
