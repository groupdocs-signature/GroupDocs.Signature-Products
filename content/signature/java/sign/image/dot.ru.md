...
############################# Head ############################
head_title: "Добавление подписей Image в файл Dot с Java"
head_description: "Поместите подпись Image в файл Dot для Java, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "Подпишите файлы Dot с подписями Image в Java"
...
steps:
    enable: true
    title_left: "Действия по подписанию Dot с помощью Image в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Dot с подписями Image.
...
demos:
    enable: true
    title: "Подписание Dot документов с помощью Image Live Demo"
    content: |
