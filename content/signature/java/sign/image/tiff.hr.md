...
############################# Head ############################
head_title: "Dodavanje potpisa Image u datoteku Tiff s Java"
head_description: "Stavite potpis Image na datoteku Tiff za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Tiff datoteke s Image potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Tiff s Image u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Tiff dokumenata s Image potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Tiff dokumenata s Image Live Demo"
    content: |
