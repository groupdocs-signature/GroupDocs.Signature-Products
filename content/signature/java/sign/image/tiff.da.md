...
############################# Head ############################
head_title: "Tilføjelse af Image-signaturer til Tiff-fil med Java"
head_description: "Sæt Image Signatur på Tiff fil for Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Tiff-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trin til at signere Tiff med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Tiff dokumenter med Image signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Tiff dokumenter med Image Live Demo"
    content: |
