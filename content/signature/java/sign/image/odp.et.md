...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Odp rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Odp, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Odp allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Odp allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Odp dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Odp allkirjastamine Image reaalajas demoga"
    content: |
