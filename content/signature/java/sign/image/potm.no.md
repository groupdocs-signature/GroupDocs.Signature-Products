...
############################# Head ############################
head_title: "Legger til Image-signaturer til Potm-filen med Java"
head_description: "Sett Image-signatur på Potm-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."
...
steps:
    enable: true
    title_left: "Trinn for å signere Potm med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Potm-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Potm dokumenter med Image Live Demo"
    content: |
