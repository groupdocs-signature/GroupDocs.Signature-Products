...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Ots rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Ots, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Ots allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Ots allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Ots dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Ots allkirjastamine Image reaalajas demoga"
    content: |
