...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Ppsx lêer met Java"
head_description: "Plaas Image Handtekening op Ppsx lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Ppsx lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Ppsx met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Ppsx dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Ppsx dokumente met Image Regstreekse Demo"
    content: |
