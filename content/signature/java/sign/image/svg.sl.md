...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko Svg z Java"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko Svg za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Svg datoteke s podpisi Image v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Svg z Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Svg s podpisi Image.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Svg z Image Live Demo"
    content: |
