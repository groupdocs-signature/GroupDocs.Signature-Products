...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Odt lêer met Java"
head_description: "Plaas Image Handtekening op Odt lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Odt lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Odt met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Odt dokumente met Image handtekeninge vinnig en maklik te onderteken.
