...
############################# Head ############################
head_title: "Hinzufügen von Image-Signaturen zur Jpg-Datei mit Java"
head_description: "Fügen Sie die Image-Signatur in die Jpg-Datei für Java ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Jpg-Dateien mit Image-Signaturen in Java"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Jpg mit Image in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet die Möglichkeit, Jpg-Dokumente mit Image-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Jpg-Dokumenten mit Image Live-Demo"
    content: |
