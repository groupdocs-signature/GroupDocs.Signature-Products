...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Png med Java"
head_description: "Sätt Image Signatur på Png-filen för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Png-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Png med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Png-dokument med Image-signaturer snabbt och enkelt.
