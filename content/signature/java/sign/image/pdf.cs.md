...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Pdf pomocí Java"
head_description: "Vložte podpis Image do souboru Pdf pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Pdf pomocí podpisů Image v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Pdf pomocí Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Pdf pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Pdf pomocí živé ukázky Image"
    content: |
