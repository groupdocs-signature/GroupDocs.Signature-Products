...
############################# Head ############################
head_title: "Добавяне на подписи Image към файл Odp с Java"
head_description: "Поставете подпис Image върху файл Odp за Java, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature, за да подписвате десетки файлови формати."

############################# Header ############################
title: "Подпишете Odp файлове с Image подписи в Java"
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Odp с Image в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя възможност за бързо и лесно подписване на Odp документи с Image подписи.
...
demos:
    enable: true
    title: "Подписване на Odp документи с Image Демо на живо"
    content: |
