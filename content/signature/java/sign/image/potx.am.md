...
############################# Head ############################
head_title: "የImage ፊርማዎችን ወደ Potx ፋይል በJava ማከል"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም የImage ፊርማ በPotx ፋይል ላይ ለJava ያድርጉ። በደርዘን የሚቆጠሩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "Potx ፋይሎችን በImage ፊርማዎች በJava ይፈርሙ"
...
steps:
    enable: true
    title_left: "Potxን በImage በJava ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የPotx ሰነዶችን በImage ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
...
demos:
    enable: true
    title: "Potx ሰነዶችን በImage ቀጥታ ማሳያ በመፈረም ላይ"
    content: |
