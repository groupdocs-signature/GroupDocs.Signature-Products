...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Jpg fájlhoz a Java segítségével"
head_description: "Helyezzen Image aláírást a Java Jpg fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Jpg fájl aláírása Image aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Jpg aláírásának lépései a Image segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Jpg dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Jpg dokumentumok aláírása Image élő bemutatóval"
    content: |
