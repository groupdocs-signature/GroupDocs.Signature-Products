...
############################# Head ############################
head_title: "Tilføjelse af Image-signaturer til 7z-fil med Java"
head_description: "Sæt Image Signatur på 7z fil for Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."
...
steps:
    enable: true
    title_left: "Trin til at signere 7z med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere 7z dokumenter med Image signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af 7z dokumenter med Image Live Demo"
    content: |
