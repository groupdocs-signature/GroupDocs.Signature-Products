...
############################# Head ############################
head_title: "إضافة Image توقيعات إلى ملف Docx باستخدام Java"
head_description: "ضع Image التوقيع على ملف Docx لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات Docx بتوقيعات Image في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Docx باستخدام Image في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Docx بتوقيعات Image بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Docx باستخدام العرض التوضيحي المباشر Image"
    content: |
