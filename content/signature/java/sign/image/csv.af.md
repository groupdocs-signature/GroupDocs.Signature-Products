...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Csv lêer met Java"
head_description: "Plaas Image Handtekening op Csv lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Csv lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Csv met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Csv dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Csv dokumente met Image Regstreekse Demo"
    content: |
