...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Ots pomocí Java"
head_description: "Vložte podpis Image do souboru Ots pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Ots pomocí podpisů Image v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Ots pomocí Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Ots pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Ots pomocí živé ukázky Image"
    content: |
