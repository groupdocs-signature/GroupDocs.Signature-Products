...
############################# Head ############################
head_title: "Dodavanje potpisa Image u datoteku Xltm s Java"
head_description: "Stavite potpis Image na datoteku Xltm za Java pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Xltm datoteke s Image potpisima u Java"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xltm s Image u Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža mogućnost brzog i jednostavnog potpisivanja Xltm dokumenata s Image potpisima.
