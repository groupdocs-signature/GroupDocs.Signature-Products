...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Docm lêer met Java"
head_description: "Plaas Image Handtekening op Docm lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Docm lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Docm met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Docm dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Docm dokumente met Image Regstreekse Demo"
    content: |
