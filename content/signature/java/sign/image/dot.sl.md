...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko Dot z Java"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko Dot za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Dot datoteke s podpisi Image v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Dot z Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Dot s podpisi Image.
