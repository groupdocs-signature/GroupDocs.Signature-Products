...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Dotx rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Dotx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Dotx allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Dotx allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Dotx dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Dotx allkirjastamine Image reaalajas demoga"
    content: |
