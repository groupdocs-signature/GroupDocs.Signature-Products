...
############################# Head ############################
head_title: "Добавление подписей Image в файл Gif с Java"
head_description: "Поместите подпись Image в файл Gif для Java, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "Подпишите файлы Gif с подписями Image в Java"
...
steps:
    enable: true
    title_left: "Действия по подписанию Gif с помощью Image в Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) позволяет быстро и легко подписывать документы Gif с подписями Image.
