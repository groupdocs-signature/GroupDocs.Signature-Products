...
############################# Head ############################
head_title: "Image handtekeningen toevoegen aan Rtf bestand met Java"
head_description: "Zet Image Signature op Rtf bestand voor Java met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Rtf bestanden met Image handtekeningen in Java"
...
steps:
    enable: true
    title_left: "Stappen om Rtf te ondertekenen met Image in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Rtf documenten snel en gemakkelijk te ondertekenen met Image handtekeningen.
