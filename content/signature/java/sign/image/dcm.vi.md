...
############################# Head ############################
head_title: "Thêm chữ ký Image vào tệp Dcm bằng Java"
head_description: "Đặt Image Chữ ký trên tệp Dcm cho Java bằng cách sử dụng một vài dòng mã. Sử dụng API chữ ký tài liệu GroupDocs để ký hàng chục định dạng tệp."

############################# Header ############################
title: "Ký các tệp Dcm bằng chữ ký Image trong Java"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Dcm bằng Image trong Java"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp khả năng ký các tài liệu Dcm bằng chữ ký Image một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Dcm bằng Image Live Demo"
    content: |
