...
############################# Head ############################
head_title: "Adăugarea de semnături Image la fișierul Potx cu Java"
head_description: "Puneți Image Semnătura pe fișierul Potx pentru Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "Semnează fișiere Potx cu semnături Image în Java"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Potx cu Image în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Potx cu semnături Image rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Potx cu Image Live Demo"
    content: |
