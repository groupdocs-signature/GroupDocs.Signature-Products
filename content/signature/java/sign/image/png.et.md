...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Png rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Png, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Png allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Png allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Png dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Png allkirjastamine Image reaalajas demoga"
    content: |
