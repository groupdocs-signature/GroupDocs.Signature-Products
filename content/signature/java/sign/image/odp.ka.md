...
############################# Head ############################
head_title: "Image ხელმოწერების დამატება Odp ფაილში Java-ით"
head_description: "განათავსეთ Image ხელმოწერა Odp ფაილზე Java კოდის რამდენიმე ხაზის გამოყენებით. გამოიყენეთ GroupDocs Document Signature API ათობით ფაილის ფორმატის ხელმოწერისთვის."

############################# Header ############################
title: "შედით Odp ფაილებში Image ხელმოწერებით Java-ში"
...
steps:
    enable: true
    title_left: "Odp-ით ხელმოწერის ნაბიჯები Image-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Odp დოკუმენტები Image ხელმოწერებით სწრაფად და მარტივად.
