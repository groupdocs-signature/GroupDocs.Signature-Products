...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Pptx rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Pptx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Pptx allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Pptx allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Pptx dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Pptx allkirjastamine Image reaalajas demoga"
    content: |
