...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Xltx rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Xltx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Xltx allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Xltx allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Xltx dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Xltx allkirjastamine Image reaalajas demoga"
    content: |
