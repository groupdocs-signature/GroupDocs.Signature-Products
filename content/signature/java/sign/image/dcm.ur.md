...
############################# Head ############################
head_title: "Java کے ساتھ Dcm فائل میں Image دستخط شامل کرنا"
head_description: "کوڈ کی چند سطروں کا استعمال کرتے ہوئے Java کے لیے Dcm فائل پر Image دستخط لگائیں۔ درجنوں فائل فارمیٹس پر دستخط کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "Java میں Dcm فائلوں پر Image دستخطوں کے ساتھ دستخط کریں"
...
steps:
    enable: true
    title_left: "Java میں Image کے ساتھ Dcm پر دستخط کرنے کے مراحل"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) جلد اور آسانی سے Image دستخطوں کے ساتھ Dcm دستاویزات پر دستخط کرنے کی صلاحیت فراہم کرتا ہے۔
...
demos:
    enable: true
    title: "Image لائیو ڈیمو کے ساتھ Dcm دستاویزات پر دستخط کرنا"
    content: |
