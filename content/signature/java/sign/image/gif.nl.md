...
############################# Head ############################
head_title: "Image handtekeningen toevoegen aan Gif bestand met Java"
head_description: "Zet Image Signature op Gif bestand voor Java met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Gif bestanden met Image handtekeningen in Java"
...
steps:
    enable: true
    title_left: "Stappen om Gif te ondertekenen met Image in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Gif documenten snel en gemakkelijk te ondertekenen met Image handtekeningen.
...
demos:
    enable: true
    title: "Gif documenten ondertekenen met Image Live Demo"
    content: |
