...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Dotx med Java"
head_description: "Sätt Image Signatur på Dotx-filen för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Dotx-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Dotx med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Dotx-dokument med Image-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Dotx dokument med Image Live Demo"
    content: |
