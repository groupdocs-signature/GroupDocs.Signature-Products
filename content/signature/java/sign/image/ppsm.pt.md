...
############################# Head ############################
head_title: "Adicionando assinaturas Image ao arquivo Ppsm com Java"
head_description: "Coloque a assinatura Image no arquivo Ppsm para Java usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Ppsm arquivos com assinaturas Image em Java"
...
steps:
    enable: true
    title_left: "Etapas para assinar Ppsm com Image em Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permite assinar documentos Ppsm com assinaturas Image de forma rápida e fácil.
