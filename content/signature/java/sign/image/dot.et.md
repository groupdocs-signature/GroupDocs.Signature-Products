...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Dot rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Dot, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Dot allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Dot allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Dot dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Dot allkirjastamine Image reaalajas demoga"
    content: |
