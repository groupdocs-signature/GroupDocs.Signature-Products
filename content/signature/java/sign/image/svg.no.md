...
############################# Head ############################
head_title: "Legger til Image-signaturer til Svg-filen med Java"
head_description: "Sett Image-signatur på Svg-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."
...
steps:
    enable: true
    title_left: "Trinn for å signere Svg med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Svg-dokumenter med Image-signaturer raskt og enkelt.
