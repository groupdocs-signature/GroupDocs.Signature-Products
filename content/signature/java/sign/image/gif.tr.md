...
############################# Head ############################
head_title: "Java ile Gif dosyasına Image imza ekleme"
head_description: "Birkaç satır kod kullanarak Java için Gif dosyasına Image İmza koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Gif dosyalarını Image imzasıyla Java içinde imzalayın"
...
steps:
    enable: true
    title_left: "Java içinde Image ile Gif imzalama adımları"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Gif belgelerini Image imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Gif dokümanı Image Canlı Demo ile imzalama"
    content: |
