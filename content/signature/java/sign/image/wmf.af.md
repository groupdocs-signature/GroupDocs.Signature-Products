...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Wmf lêer met Java"
head_description: "Plaas Image Handtekening op Wmf lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Wmf lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Wmf met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Wmf dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Wmf dokumente met Image Regstreekse Demo"
    content: |
