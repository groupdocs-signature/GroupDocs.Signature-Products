...
############################# Head ############################
head_title: "Menambahkan tandatangan Image pada fail Xlsx dengan Java"
head_description: "Letakkan Image Tandatangan pada fail Xlsx untuk Java menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Xlsx dengan tandatangan Image dalam Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xlsx dengan Image dalam Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan keupayaan untuk menandatangani dokumen Xlsx dengan tandatangan Image dengan cepat dan mudah.
