...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Odt rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Odt, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Odt allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Odt allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Odt dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Odt allkirjastamine Image reaalajas demoga"
    content: |
