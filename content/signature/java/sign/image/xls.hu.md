...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Xls fájlhoz a Java segítségével"
head_description: "Helyezzen Image aláírást a Java Xls fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Xls fájl aláírása Image aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Xls aláírásának lépései a Image segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Xls dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Xls dokumentumok aláírása Image élő bemutatóval"
    content: |
