...
############################# Head ############################
head_title: "Voeg Image handtekeninge by 7z lêer met Java"
head_description: "Plaas Image Handtekening op 7z lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken 7z lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om 7z met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om 7z dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken 7z dokumente met Image Regstreekse Demo"
    content: |
