...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Xlsb pomocí Java"
head_description: "Vložte podpis Image do souboru Xlsb pro Java pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Xlsb pomocí podpisů Image v Java"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsb pomocí Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) umožňuje rychle a snadno podepisovat dokumenty Xlsb pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Xlsb pomocí živé ukázky Image"
    content: |
