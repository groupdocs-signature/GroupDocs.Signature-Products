...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Dcm fájlhoz a Java segítségével"
head_description: "Helyezzen Image aláírást a Java Dcm fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Dcm fájl aláírása Image aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Dcm aláírásának lépései a Image segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Dcm dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Dcm dokumentumok aláírása Image élő bemutatóval"
    content: |
