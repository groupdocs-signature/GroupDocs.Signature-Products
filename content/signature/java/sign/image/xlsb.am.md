...
############################# Head ############################
head_title: "የImage ፊርማዎችን ወደ Xlsb ፋይል በJava ማከል"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም የImage ፊርማ በXlsb ፋይል ላይ ለJava ያድርጉ። በደርዘን የሚቆጠሩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "Xlsb ፋይሎችን በImage ፊርማዎች በJava ይፈርሙ"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የXlsb ሰነዶችን በImage ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
...
demos:
    enable: true
    title: "Xlsb ሰነዶችን በImage ቀጥታ ማሳያ በመፈረም ላይ"
    content: |
