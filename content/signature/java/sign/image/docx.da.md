...
############################# Head ############################
head_title: "Tilføjelse af Image-signaturer til Docx-fil med Java"
head_description: "Sæt Image Signatur på Docx fil for Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."
...
steps:
    enable: true
    title_left: "Trin til at signere Docx med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Docx dokumenter med Image signaturer hurtigt og nemt.
