...
############################# Head ############################
head_title: "Ajout de signatures Image au fichier Xltx avec Java"
head_description: "Mettez Image Signature sur le fichier Xltx pour Java en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "Signez des fichiers Xltx avec des signatures Image en Java"
...
steps:
    enable: true
    title_left: "Étapes pour signer Xltx avec Image dans Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet de signer rapidement et facilement des documents Xltx avec des signatures Image.
...
demos:
    enable: true
    title: "Signature de documents Xltx avec Image Live Demo"
    content: |
