...
############################# Head ############################
head_title: "Tilføjelse af Image-signaturer til Pdf-fil med Java"
head_description: "Sæt Image Signatur på Pdf fil for Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Pdf-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trin til at signere Pdf med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Pdf dokumenter med Image signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Pdf dokumenter med Image Live Demo"
    content: |
