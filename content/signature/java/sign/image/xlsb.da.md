...
############################# Head ############################
head_title: "Tilføjelse af Image-signaturer til Xlsb-fil med Java"
head_description: "Sæt Image Signatur på Xlsb fil for Java ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."
...
steps:
    enable: true
    title_left: "Trin til at signere Xlsb med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver mulighed for at signere Xlsb dokumenter med Image signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Xlsb dokumenter med Image Live Demo"
    content: |
