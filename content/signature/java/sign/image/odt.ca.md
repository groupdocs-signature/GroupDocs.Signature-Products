...
############################# Head ############################
head_title: "Afegint Image signatures al fitxer Odt amb Java"
head_description: "Poseu la signatura Image al fitxer Odt per a Java utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "Signa fitxers Odt amb signatures Image a Java"
...
steps:
    enable: true
    title_left: "Passos per signar Odt amb Image a Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix la possibilitat de signar documents Odt amb signatures Image de manera ràpida i senzilla.
