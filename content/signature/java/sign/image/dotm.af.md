...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Dotm lêer met Java"
head_description: "Plaas Image Handtekening op Dotm lêer vir Java deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Dotm lêers met Image handtekeninge in Java"
...
steps:
    enable: true
    title_left: "Stappe om Dotm met Image in Java te onderteken"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied die vermoë om Dotm dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Dotm dokumente met Image Regstreekse Demo"
    content: |
