...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Tar rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Tar, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Tar allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Tar allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Tar dokumente Image allkirjaga.
