...
############################# Head ############################
head_title: "Image handtekeningen toevoegen aan Docm bestand met Java"
head_description: "Zet Image Signature op Docm bestand voor Java met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Docm bestanden met Image handtekeningen in Java"
...
steps:
    enable: true
    title_left: "Stappen om Docm te ondertekenen met Image in Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt de mogelijkheid om Docm documenten snel en gemakkelijk te ondertekenen met Image handtekeningen.
