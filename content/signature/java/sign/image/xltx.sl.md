...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko Xltx z Java"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko Xltx za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Xltx datoteke s podpisi Image v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Xltx z Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Xltx s podpisi Image.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Xltx z Image Live Demo"
    content: |
