...
############################# Head ############################
head_title: "Bætir Image undirskriftum við Pdf skrá með Java"
head_description: "Settu Image undirskrift á Pdf skrá fyrir Java með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "Undirritaðu Pdf skrár með Image undirskriftum í Java"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Pdf með Image í Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) veitir möguleika á að undirrita Pdf skjöl með Image undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Pdf skjöl með Image lifandi kynningu"
    content: |
