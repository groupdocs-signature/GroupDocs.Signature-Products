...
############################# Head ############################
head_title: "Legger til Image-signaturer til Pdf-filen med Java"
head_description: "Sett Image-signatur på Pdf-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."
...
steps:
    enable: true
    title_left: "Trinn for å signere Pdf med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Pdf-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Pdf dokumenter med Image Live Demo"
    content: |
