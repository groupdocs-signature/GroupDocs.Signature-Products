...
############################# Head ############################
head_title: "Zêdekirina Image îmzeyan li pelê Pptm bi Java"
head_description: "Ji bo Java Image îmza li ser pela Pptm bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Pptm bi îmzeyên Image di Java de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Pptm bi Image di Java de"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) îmzakirina belgeyên Pptm bi îmzeyên Image zû û bi hêsanî peyda dike.
