...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Dot med Java"
head_description: "Sätt Image Signatur på Dot-filen för Java med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Dot-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Steg för att signera Dot med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ger möjlighet att signera Dot-dokument med Image-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Dot dokument med Image Live Demo"
    content: |
