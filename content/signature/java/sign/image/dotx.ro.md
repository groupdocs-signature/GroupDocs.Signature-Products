...
############################# Head ############################
head_title: "Adăugarea de semnături Image la fișierul Dotx cu Java"
head_description: "Puneți Image Semnătura pe fișierul Dotx pentru Java folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "Semnează fișiere Dotx cu semnături Image în Java"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Dotx cu Image în Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) oferă posibilitatea de a semna documente Dotx cu semnături Image rapid și ușor.
...
demos:
    enable: true
    title: "Semnează documente Dotx cu Image Live Demo"
    content: |
