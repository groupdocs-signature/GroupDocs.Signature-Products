...
############################# Head ############################
head_title: "Menambahkan tanda tangan Image ke file Odt dengan Java"
head_description: "Letakkan Image Signature pada file Odt untuk Java menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "Tanda tangani file Odt dengan tanda tangan Image di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Odt dengan Image di Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memberikan kemampuan untuk menandatangani dokumen Odt dengan Image tanda tangan dengan cepat dan mudah.
