...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Pps fájlhoz a Java segítségével"
head_description: "Helyezzen Image aláírást a Java Pps fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Pps fájl aláírása Image aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Pps aláírásának lépései a Image segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Pps dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Pps dokumentumok aláírása Image élő bemutatóval"
    content: |
