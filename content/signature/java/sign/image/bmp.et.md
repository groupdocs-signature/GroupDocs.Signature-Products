...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Bmp rakendusega Java"
head_description: "Pane allkiri Image allkiri Java failile Bmp, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Bmp allkirjadega Image rakenduses Java"
...
steps:
    enable: true
    title_left: "Toimingud Bmp allkirjastamiseks rakendusega Image rakenduses Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) võimaldab kiiresti ja lihtsalt allkirjastada Bmp dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Bmp allkirjastamine Image reaalajas demoga"
    content: |
