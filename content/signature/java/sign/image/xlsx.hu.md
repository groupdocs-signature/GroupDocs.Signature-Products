...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Xlsx fájlhoz a Java segítségével"
head_description: "Helyezzen Image aláírást a Java Xlsx fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Xlsx fájl aláírása Image aláírással a Java alkalmazásban"
...
steps:
    enable: true
    title_left: "A Xlsx aláírásának lépései a Image segítségével a Java programban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) lehetővé teszi a Xlsx dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Xlsx dokumentumok aláírása Image élő bemutatóval"
    content: |
