...
############################# Head ############################
head_title: "Image parašų pridėjimas prie Gif failo naudojant Java"
head_description: "Įdėkite Image parašą į Gif failą, skirtą Java, naudodami kelias kodo eilutes. Norėdami pasirašyti daugybę failų formatų, naudokite GroupDocs Document Signature API."

############################# Header ############################
title: "Pasirašykite Gif failus naudodami Image parašus Java"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Gif naudojant Image programoje Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) suteikia galimybę greitai ir lengvai pasirašyti Gif dokumentus su Image parašais.
...
demos:
    enable: true
    title: "Dokumentų Gif pasirašymas naudojant Image tiesioginę demonstraciją"
    content: |
