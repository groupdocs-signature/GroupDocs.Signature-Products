...
############################# Head ############################
head_title: "إضافة Image توقيعات إلى ملف Xltx باستخدام Java"
head_description: "ضع Image التوقيع على ملف Xltx لـ Java باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات Xltx بتوقيعات Image في Java"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Xltx باستخدام Image في Java"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) إمكانية توقيع مستندات Xltx بتوقيعات Image بسرعة وسهولة.
