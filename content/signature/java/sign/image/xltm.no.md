...
############################# Head ############################
head_title: "Legger til Image-signaturer til Xltm-filen med Java"
head_description: "Sett Image-signatur på Xltm-filen for Java ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Xltm-filer med Image-signaturer i Java"
...
steps:
    enable: true
    title_left: "Trinn for å signere Xltm med Image i Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir mulighet til å signere Xltm-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Xltm dokumenter med Image Live Demo"
    content: |
