...
############################# Head ############################
head_title: "Image ხელმოწერების დამატება Csv ფაილში Java-ით"
head_description: "განათავსეთ Image ხელმოწერა Csv ფაილზე Java კოდის რამდენიმე ხაზის გამოყენებით. გამოიყენეთ GroupDocs Document Signature API ათობით ფაილის ფორმატის ხელმოწერისთვის."

############################# Header ############################
title: "შედით Csv ფაილებში Image ხელმოწერებით Java-ში"
...
steps:
    enable: true
    title_left: "Csv-ით ხელმოწერის ნაბიჯები Image-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Csv დოკუმენტები Image ხელმოწერებით სწრაფად და მარტივად.
...
demos:
    enable: true
    title: "დოკუმენტების Csv ხელმოწერა Image Live Demo-ით"
    content: |
