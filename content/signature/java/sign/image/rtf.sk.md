...
############################# Head ############################
head_title: "Pridanie podpisov Image do súboru Rtf pomocou Java"
head_description: "Vložte podpis Image do súboru Rtf pre Java pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Rtf pomocou podpisov Image v Java"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Rtf pomocou Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Rtf pomocou podpisov Image.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Rtf pomocou živej ukážky Image"
    content: |
