...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko Doc z Java"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko Doc za Java. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Doc datoteke s podpisi Image v Java"
...
steps:
    enable: true
    title_left: "Koraki za podpis Doc z Image v Java"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) omogoča hitro in enostavno podpisovanje dokumentov Doc s podpisi Image.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Doc z Image Live Demo"
    content: |
