...
############################# Head ############################
head_title: "Image ხელმოწერების დამატება Pptx ფაილში Java-ით"
head_description: "განათავსეთ Image ხელმოწერა Pptx ფაილზე Java კოდის რამდენიმე ხაზის გამოყენებით. გამოიყენეთ GroupDocs Document Signature API ათობით ფაილის ფორმატის ხელმოწერისთვის."

############################# Header ############################
title: "შედით Pptx ფაილებში Image ხელმოწერებით Java-ში"
...
steps:
    enable: true
    title_left: "Pptx-ით ხელმოწერის ნაბიჯები Image-ით Java-ში"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) იძლევა შესაძლებლობას მოაწეროთ Pptx დოკუმენტები Image ხელმოწერებით სწრაფად და მარტივად.
...
demos:
    enable: true
    title: "დოკუმენტების Pptx ხელმოწერა Image Live Demo-ით"
    content: |
