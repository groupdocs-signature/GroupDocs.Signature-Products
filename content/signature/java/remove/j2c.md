...
############################# Head ############################
head_title: "Remove Digital Signatures from J2C in Java"
head_description: "Java library to clear &amp; remove digital signatures from J2C file using GroupDocs.Signature API - manipulate Image, Barcode, QR-Code, Stamp, Text, Optical &amp; Metadata signatures from digitally signed documents."

############################# Header ############################
title: "Remove Digital Signature from J2C via Java"
description: "Java eSignature library to remove digital signatures from J2C file. Easily manipulate Image, Barcode, QR-Code, Stamp, Text, Optical and Metadata signatures from digitally signed documents."
...
steps:
    enable: true
    title_left: "How to Remove Digital Signatures from J2C"
    content_left: |
        Below Java code example clearly demonstrates the steps to **delete text signatures from J2C file in Java** by adding just a few lines of code.
    ...
    code: |
        ...
        // delete signatures
        DeleteResult deleteResult = signature.delete("signed.j2c", signaturesToDelete);
...
demos:
    enable: true
    title: "Remove J2C Signature Live Demos"
    content: |
