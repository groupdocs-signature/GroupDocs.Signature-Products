...
############################# Head ############################
head_title: "Remove Digital Signatures from JPF in Java"
head_description: "Java library to clear &amp; remove digital signatures from JPF file using GroupDocs.Signature API - manipulate Image, Barcode, QR-Code, Stamp, Text, Optical &amp; Metadata signatures from digitally signed documents."

############################# Header ############################
title: "Remove Digital Signature from JPF via Java"
description: "Java eSignature library to remove digital signatures from JPF file. Easily manipulate Image, Barcode, QR-Code, Stamp, Text, Optical and Metadata signatures from digitally signed documents."
...
steps:
    enable: true
    title_left: "How to Remove Digital Signatures from JPF"
    content_left: |
        Below Java code example clearly demonstrates the steps to **delete text signatures from JPF file in Java** by adding just a few lines of code.
    ...
    code: |
        ...
        // delete signatures
        DeleteResult deleteResult = signature.delete("signed.jpf", signaturesToDelete);
...
demos:
    enable: true
    title: "Remove JPF Signature Live Demos"
    content: |
