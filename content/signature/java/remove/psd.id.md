...
head_title: "Hapus Tanda Tangan Digital dari PSD di Java"
head_description: "Pustaka Java untuk menghapus &amp; hapus tanda tangan digital dari file PSD menggunakan GroupDocs.Signature API - memanipulasi Gambar, Kode Batang, Kode QR, Stempel, Teks, Optik &amp; Tanda tangan metadata dari dokumen yang ditandatangani secara digital."

title: "Hapus Tanda Tangan Digital dari PSD melalui Java"
description: "Pustaka Java eSignature untuk menghapus tanda tangan digital dari file PSD. Mudah memanipulasi tanda tangan Gambar, Barcode, QR-Code, Cap, Teks, Optik dan Metadata dari dokumen yang ditandatangani secara digital."
...
steps:
    enable: true
    title_left: "Cara Menghapus Tanda Tangan Digital dari PSD"
    content_left: |
        Contoh kode Java di bawah ini dengan jelas menunjukkan langkah-langkah untuk **menghapus tanda tangan teks dari file PSD di Java** dengan menambahkan beberapa baris kode saja.
    ...
    code: |
        ...
        // hapus tanda tangan
        DeleteResult deleteResult = signature.delete("signed.psd", signaturesToDelete);
...
demos:
    enable: true
    title: "Hapus PSD Signature Live Demo"
    content: |
