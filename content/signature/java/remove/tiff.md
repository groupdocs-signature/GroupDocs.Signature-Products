...
############################# Head ############################
head_title: "Remove Digital Signatures from TIFF in Java"
head_description: "Java library to clear &amp; remove digital signatures from TIFF file using GroupDocs.Signature API - manipulate Image, Barcode, QR-Code, Stamp, Text, Optical &amp; Metadata signatures from digitally signed documents."

############################# Header ############################
title: "Remove Digital Signature from TIFF via Java"
description: "Java eSignature library to remove digital signatures from TIFF file. Easily manipulate Image, Barcode, QR-Code, Stamp, Text, Optical and Metadata signatures from digitally signed documents."
...
steps:
    enable: true
    title_left: "How to Remove Digital Signatures from TIFF"
    content_left: |
        Below Java code example clearly demonstrates the steps to **delete text signatures from TIFF file in Java** by adding just a few lines of code.
    ...
    code: |
        ...
        // delete signatures
        DeleteResult deleteResult = signature.delete("signed.tiff", signaturesToDelete);
...
demos:
    enable: true
    title: "Remove TIFF Signature Live Demos"
    content: |
