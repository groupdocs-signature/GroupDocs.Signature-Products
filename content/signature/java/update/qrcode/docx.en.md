...
############################# Head ############################
head_title: "Update Qrcode signatures placed at Docx files with Java"
head_description: "Use simple and easy for understanding Java code for Qrcode signatures updation in signed Docx documents."

############################# Header ############################
title: "Edit and update Qrcode signatures placed at Docx files"
description: "API for Java provides functionality for Qrcode signatures updating at Docx documents. Update e-signatures inside your Docx documents with a couple lines of Java code quickly and easily."
...
steps:
    enable: true
    title_left: "How to change Qrcode signatures in your Docx document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like updation of Qrcode signatures placed at Docx documents. It makes possible to change signatures features without extra code.
...
demos:
    ...
    content: |
       Edit various electronic signatures of the Docx document right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.          
