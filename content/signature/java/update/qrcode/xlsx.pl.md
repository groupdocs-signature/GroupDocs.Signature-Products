...
############################# Head ############################
head_title: "Zaktualizuj podpisy Qrcode umieszczone w plikach Xlsx za pomocą Java"
head_description: "Użyj prostego i łatwego do zrozumienia kodu Java do aktualizacji podpisów Qrcode w podpisanych dokumentach Xlsx."

############################# Header ############################
title: "Edytuj i aktualizuj podpisy Qrcode umieszczone w plikach Xlsx"
description: "Interfejs API dla Java zapewnia funkcjonalność aktualizacji podpisów Qrcode w dokumentach Xlsx. Zaktualizuj podpisy elektroniczne w swoich dokumentach Xlsx za pomocą kilku linijek kodu Java szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zmienić podpisy Qrcode w dokumencie Xlsx?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak aktualizacja podpisów Qrcode umieszczonych w dokumentach Xlsx. Umożliwia zmianę funkcji podpisów bez dodatkowego kodu.
