...
############################# Head ############################
head_title: "Aktualizujte podpisy Qrcode umiestnené v súboroch Rtf pomocou Java"
head_description: "Použite jednoduchý a zrozumiteľný kód Java na aktualizáciu podpisov Qrcode v podpísaných dokumentoch Rtf."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Qrcode umiestnené v súboroch Rtf"
description: "API pre Java poskytuje funkcie pre aktualizácie podpisov Qrcode v dokumentoch Rtf. Rýchlo a jednoducho aktualizujte elektronické podpisy vo svojich dokumentoch Rtf pomocou niekoľkých riadkov kódu Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je aktualizácia podpisov Qrcode umiestnených v dokumentoch Rtf. Umožňuje meniť funkcie podpisov bez dodatočného kódu.
