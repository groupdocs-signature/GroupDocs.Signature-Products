...
############################# Head ############################
head_title: "Uppfærðu Qrcode undirskriftir settar á Docm skrár með Java"
head_description: "Notaðu einfaldan og auðskilinn Java kóða fyrir uppfærslu á Qrcode undirskriftum í undirrituðum Docm skjölum."

############################# Header ############################
title: "Breyttu og uppfærðu Qrcode undirskriftir sem settar eru á Docm skrár"
description: "API fyrir Java veitir virkni fyrir Qrcode undirskriftir sem uppfæra á Docm skjölum. Uppfærðu rafrænar undirskriftir í Docm skjölunum þínum með nokkrum línum af Java kóða fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Hvernig á að breyta Qrcode undirskriftum í Docm skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inniheldur gagnlega eiginleika eins og uppfærslu á Qrcode undirskriftum sem settar eru á Docm skjöl. Það gerir mögulegt að breyta eiginleikum undirskrifta án aukakóða.
...
demos:
    ...
    content: |
       Breyttu ýmsum rafrænum undirskriftum Docm skjalsins núna með því að fara á vefsíðuna [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
