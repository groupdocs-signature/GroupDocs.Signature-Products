...
############################# Head ############################
head_title: "Aggiorna le firme Qrcode inserite nei file Docm con Java"
head_description: "Utilizza il codice Java semplice e facile per l'aggiornamento delle firme Qrcode nei documenti Docm firmati."

############################# Header ############################
title: "Modifica e aggiorna le firme Qrcode inserite nei file Docm"
description: "L'API per Java fornisce funzionalità per l'aggiornamento delle firme Qrcode nei documenti Docm. Aggiorna le firme elettroniche all'interno dei tuoi documenti Docm con un paio di righe di codice Java in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Come modificare le firme Qrcode nel tuo documento Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) include funzioni utili come l'aggiornamento di firme Qrcode apposte in documenti Docm. Consente di modificare le caratteristiche delle firme senza codice aggiuntivo.
