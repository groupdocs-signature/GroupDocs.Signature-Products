...
############################# Head ############################
head_title: "Atualize assinaturas Qrcode colocadas em arquivos Odp com Java"
head_description: "Use o código Java simples e fácil para atualização de assinaturas Qrcode em documentos Odp assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Qrcode colocadas em arquivos Odp"
description: "A API para Java fornece funcionalidade para atualização de assinaturas Qrcode em documentos Odp. Atualize assinaturas eletrônicas dentro de seus documentos Odp com algumas linhas de código Java de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como alterar assinaturas Qrcode em seu documento Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis como atualização de Qrcode assinaturas colocadas em documentos Odp. Possibilita alterar recursos de assinaturas sem código extra.
