...
############################# Head ############################
head_title: "Update Qrcode signatures placed at Dotx files with Java"
head_description: "Use simple and easy for understanding Java code for Qrcode signatures updation in signed Dotx documents."

############################# Header ############################
title: "Edit and update Qrcode signatures placed at Dotx files"
description: "API for Java provides functionality for Qrcode signatures updating at Dotx documents. Update e-signatures inside your Dotx documents with a couple lines of Java code quickly and easily."
...
steps:
    enable: true
    title_left: "How to change Qrcode signatures in your Dotx document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like updation of Qrcode signatures placed at Dotx documents. It makes possible to change signatures features without extra code.
...
demos:
    enable: true
    title: "Updating the Qrcode signatures on the document pages - Live Demo"
    content: |
       Edit various electronic signatures of the Dotx document right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.          
