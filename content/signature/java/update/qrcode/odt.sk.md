...
############################# Head ############################
head_title: "Aktualizujte podpisy Qrcode umiestnené v súboroch Odt pomocou Java"
head_description: "Použite jednoduchý a zrozumiteľný kód Java na aktualizáciu podpisov Qrcode v podpísaných dokumentoch Odt."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Qrcode umiestnené v súboroch Odt"
description: "API pre Java poskytuje funkcie pre aktualizácie podpisov Qrcode v dokumentoch Odt. Rýchlo a jednoducho aktualizujte elektronické podpisy vo svojich dokumentoch Odt pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Ako zmeniť Qrcode podpisy vo vašom dokumente Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je aktualizácia podpisov Qrcode umiestnených v dokumentoch Odt. Umožňuje meniť funkcie podpisov bez dodatočného kódu.
