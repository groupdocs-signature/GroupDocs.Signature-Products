...
############################# Head ############################
head_title: "Oppdater Qrcode-signaturer plassert på Ods-filer med Java"
head_description: "Bruk enkel og enkel for å forstå Java-koden for Qrcode-signaturoppdatering i signerte Ods-dokumenter."

############################# Header ############################
title: "Rediger og oppdater Qrcode-signaturer plassert i Ods-filer"
description: "API for Java gir funksjonalitet for Qrcode-signaturer som oppdateres i Ods-dokumenter. Oppdater e-signaturer i Ods-dokumentene dine med et par linjer med Java-kode raskt og enkelt."
...
steps:
    enable: true
    title_left: "Hvordan endre Qrcode-signaturer i Ods-dokumentet ditt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funksjoner som oppdatering av Qrcode-signaturer plassert i Ods-dokumenter. Det gjør det mulig å endre signaturfunksjoner uten ekstra kode.
