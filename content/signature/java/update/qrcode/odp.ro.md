...
############################# Head ############################
head_title: "Actualizați Qrcode semnături plasate în fișiere Odp cu Java"
head_description: "Utilizați codul Java simplu și ușor de înțeles pentru actualizarea semnăturilor Qrcode în documentele Odp semnate."

############################# Header ############################
title: "Editați și actualizați semnăturile Qrcode plasate în fișierele Odp"
description: "API-ul pentru Java oferă funcționalități pentru actualizarea semnăturilor Qrcode la documentele Odp. Actualizați rapid și ușor semnăturile electronice din documentele dvs. Odp cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Cum să schimbați semnăturile Qrcode în documentul dvs. Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) include funcții utile, cum ar fi actualizarea semnăturilor Qrcode plasate în documentele Odp. Face posibilă schimbarea caracteristicilor semnăturilor fără cod suplimentar.
