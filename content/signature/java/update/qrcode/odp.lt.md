...
############################# Head ############################
head_title: "Atnaujinkite Qrcode parašus, pateiktus Odp failuose naudodami Java"
head_description: "Naudokite paprastą ir lengvai suprantamą Java kodą Qrcode parašų atnaujinimui pasirašytuose Odp dokumentuose."

############################# Header ############################
title: "Redaguoti ir atnaujinti Qrcode parašus, esančius Odp failuose"
description: "API, skirta Java, teikia Qrcode parašų atnaujinimo funkciją Odp dokumentuose. Greitai ir lengvai atnaujinkite el. parašus savo Odp dokumentuose naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip pakeisti Qrcode parašus Odp dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingų funkcijų, pvz., Qrcode parašų, esančių Odp dokumentuose, atnaujinimas. Tai leidžia pakeisti parašo funkcijas be papildomo kodo.
