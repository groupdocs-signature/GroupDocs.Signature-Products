...
############################# Head ############################
head_title: "Atualize assinaturas Qrcode colocadas em arquivos Docx com Java"
head_description: "Use o código Java simples e fácil para atualização de assinaturas Qrcode em documentos Docx assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Qrcode colocadas em arquivos Docx"
description: "A API para Java fornece funcionalidade para atualização de assinaturas Qrcode em documentos Docx. Atualize assinaturas eletrônicas dentro de seus documentos Docx com algumas linhas de código Java de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como alterar assinaturas Qrcode em seu documento Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis como atualização de Qrcode assinaturas colocadas em documentos Docx. Possibilita alterar recursos de assinaturas sem código extra.
