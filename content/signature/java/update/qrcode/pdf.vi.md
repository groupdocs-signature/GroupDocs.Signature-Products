...
############################# Head ############################
head_title: "Cập nhật chữ ký Qrcode được đặt trong tệp Pdf bằng Java"
head_description: "Sử dụng mã Java đơn giản và dễ hiểu để cập nhật chữ ký Qrcode trong tài liệu Pdf đã ký."

############################# Header ############################
title: "Chỉnh sửa và cập nhật chữ ký Qrcode được đặt trong tệp Pdf"
description: "API cho Java cung cấp chức năng cập nhật chữ ký Qrcode tại tài liệu Pdf. Cập nhật chữ ký điện tử bên trong tài liệu Pdf của bạn bằng một vài dòng mã Java một cách nhanh chóng và dễ dàng."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) bao gồm các tính năng hữu ích như cập nhật chữ ký Qrcode được đặt trong tài liệu Pdf. Có thể thay đổi các tính năng của chữ ký mà không cần thêm mã.
