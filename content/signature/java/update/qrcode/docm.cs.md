...
############################# Head ############################
head_title: "Aktualizujte podpisy Qrcode umístěné v souborech Docm pomocí Java"
head_description: "Použijte jednoduchý a snadno pochopitelný kód Java pro aktualizaci podpisů Qrcode v podepsaných dokumentech Docm."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Qrcode umístěné v souborech Docm"
description: "API pro Java poskytuje funkce pro aktualizaci podpisů Qrcode v dokumentech Docm. Aktualizujte elektronické podpisy ve svých dokumentech Docm pomocí několika řádků kódu Java rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je aktualizace podpisů Qrcode umístěných v dokumentech Docm. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
