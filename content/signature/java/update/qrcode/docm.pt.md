...
############################# Head ############################
head_title: "Atualize assinaturas Qrcode colocadas em arquivos Docm com Java"
head_description: "Use o código Java simples e fácil para atualização de assinaturas Qrcode em documentos Docm assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Qrcode colocadas em arquivos Docm"
description: "A API para Java fornece funcionalidade para atualização de assinaturas Qrcode em documentos Docm. Atualize assinaturas eletrônicas dentro de seus documentos Docm com algumas linhas de código Java de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como alterar assinaturas Qrcode em seu documento Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis como atualização de Qrcode assinaturas colocadas em documentos Docm. Possibilita alterar recursos de assinaturas sem código extra.
