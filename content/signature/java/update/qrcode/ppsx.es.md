...
############################# Head ############################
head_title: "Actualice Qrcode firmas colocadas en Ppsx archivos con Java"
head_description: "Use código simple y fácil de entender Java para la actualización de firmas Qrcode en documentos Ppsx firmados."

############################# Header ############################
title: "Edite y actualice Qrcode firmas colocadas en Ppsx archivos"
description: "La API para Java proporciona funcionalidad para la actualización de firmas Qrcode en documentos Ppsx. Actualice las firmas electrónicas dentro de sus documentos Ppsx con un par de líneas de código Java rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la actualización de Qrcode firmas colocadas en Ppsx documentos. Hace posible cambiar las características de las firmas sin código adicional.
