...
############################# Head ############################
head_title: "Posodobite podpise Qrcode v datotekah Xls z Java"
head_description: "Uporabite preprosto in razumljivo kodo Java za posodobitev podpisov Qrcode v podpisanih dokumentih Xls."

############################# Header ############################
title: "Uredite in posodobite podpise Qrcode v datotekah Xls"
description: "API za Java zagotavlja funkcionalnost za posodabljanje podpisov Qrcode v dokumentih Xls. Hitro in enostavno posodobite e-podpise v svojih dokumentih Xls z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Kako spremeniti podpise Qrcode v dokumentu Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je posodobitev podpisov Qrcode v dokumentih Xls. Omogoča spreminjanje funkcij podpisov brez dodatne kode.
