...
############################# Head ############################
head_title: "Aktualizujte podpisy Qrcode umiestnené v súboroch Dotx pomocou Java"
head_description: "Použite jednoduchý a zrozumiteľný kód Java na aktualizáciu podpisov Qrcode v podpísaných dokumentoch Dotx."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Qrcode umiestnené v súboroch Dotx"
description: "API pre Java poskytuje funkcie pre aktualizácie podpisov Qrcode v dokumentoch Dotx. Rýchlo a jednoducho aktualizujte elektronické podpisy vo svojich dokumentoch Dotx pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Ako zmeniť Qrcode podpisy vo vašom dokumente Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je aktualizácia podpisov Qrcode umiestnených v dokumentoch Dotx. Umožňuje meniť funkcie podpisov bez dodatočného kódu.
