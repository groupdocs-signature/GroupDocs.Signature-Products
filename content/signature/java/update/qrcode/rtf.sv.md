...
############################# Head ############################
head_title: "Uppdatera Qrcode-signaturer placerade i Rtf-filer med Java"
head_description: "Använd enkel och lätt att förstå Java-koden för uppdatering av Qrcode-signaturer i signerade Rtf-dokument."

############################# Header ############################
title: "Redigera och uppdatera Qrcode-signaturer placerade i Rtf-filer"
description: "API för Java tillhandahåller funktionalitet för Qrcode-signaturer som uppdateras i Rtf-dokument. Uppdatera e-signaturer i dina Rtf-dokument med ett par rader Java-kod snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här ändrar du Qrcode-signaturer i ditt Rtf-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som uppdatering av Qrcode-signaturer placerade i Rtf-dokument. Det gör det möjligt att ändra signaturfunktioner utan extra kod.
