...
############################# Head ############################
head_title: "Värskendage Qrcode allkirja, mis on pandud failidesse Doc rakendusega Java"
head_description: "Kasutage allkirjastatud Doc dokumentides allkirjade Qrcode värskendamiseks lihtsat ja hõlpsasti mõistetavat Java koodi."

############################# Header ############################
title: "Muutke ja värskendage failidesse Doc pandud allkirju Qrcode"
description: "API for Java pakub funktsiooni Qrcode allkirjade värskendamiseks dokumentides Doc. Värskendage oma Doc dokumentides olevaid e-allkirju paari rea koodiga Java kiiresti ja lihtsalt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Qrcode allkirjade värskendamine, mis on paigutatud dokumentidele Doc. See võimaldab muuta allkirjafunktsioone ilma lisakoodita.
