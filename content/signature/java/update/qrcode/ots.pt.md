...
############################# Head ############################
head_title: "Atualize assinaturas Qrcode colocadas em arquivos Ots com Java"
head_description: "Use o código Java simples e fácil para atualização de assinaturas Qrcode em documentos Ots assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Qrcode colocadas em arquivos Ots"
description: "A API para Java fornece funcionalidade para atualização de assinaturas Qrcode em documentos Ots. Atualize assinaturas eletrônicas dentro de seus documentos Ots com algumas linhas de código Java de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como alterar assinaturas Qrcode em seu documento Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis como atualização de Qrcode assinaturas colocadas em documentos Ots. Possibilita alterar recursos de assinaturas sem código extra.
...
demos:
    ...
    content: |
       Edite várias assinaturas eletrônicas do documento Ots agora mesmo visitando o site do [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
