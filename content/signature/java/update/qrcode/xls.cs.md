...
############################# Head ############################
head_title: "Aktualizujte podpisy Qrcode umístěné v souborech Xls pomocí Java"
head_description: "Použijte jednoduchý a snadno pochopitelný kód Java pro aktualizaci podpisů Qrcode v podepsaných dokumentech Xls."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Qrcode umístěné v souborech Xls"
description: "API pro Java poskytuje funkce pro aktualizaci podpisů Qrcode v dokumentech Xls. Aktualizujte elektronické podpisy ve svých dokumentech Xls pomocí několika řádků kódu Java rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak změnit podpisy Qrcode ve vašem dokumentu Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je aktualizace podpisů Qrcode umístěných v dokumentech Xls. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
...
demos:
    ...
    content: |
       Upravte různé elektronické podpisy dokumentu Xls právě teď na webu [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
