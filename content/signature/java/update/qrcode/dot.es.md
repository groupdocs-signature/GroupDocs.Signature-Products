...
############################# Head ############################
head_title: "Actualice Qrcode firmas colocadas en Dot archivos con Java"
head_description: "Use código simple y fácil de entender Java para la actualización de firmas Qrcode en documentos Dot firmados."

############################# Header ############################
title: "Edite y actualice Qrcode firmas colocadas en Dot archivos"
description: "La API para Java proporciona funcionalidad para la actualización de firmas Qrcode en documentos Dot. Actualice las firmas electrónicas dentro de sus documentos Dot con un par de líneas de código Java rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la actualización de Qrcode firmas colocadas en Dot documentos. Hace posible cambiar las características de las firmas sin código adicional.
