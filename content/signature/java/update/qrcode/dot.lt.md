...
############################# Head ############################
head_title: "Atnaujinkite Qrcode parašus, pateiktus Dot failuose naudodami Java"
head_description: "Naudokite paprastą ir lengvai suprantamą Java kodą Qrcode parašų atnaujinimui pasirašytuose Dot dokumentuose."

############################# Header ############################
title: "Redaguoti ir atnaujinti Qrcode parašus, esančius Dot failuose"
description: "API, skirta Java, teikia Qrcode parašų atnaujinimo funkciją Dot dokumentuose. Greitai ir lengvai atnaujinkite el. parašus savo Dot dokumentuose naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip pakeisti Qrcode parašus Dot dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingų funkcijų, pvz., Qrcode parašų, esančių Dot dokumentuose, atnaujinimas. Tai leidžia pakeisti parašo funkcijas be papildomo kodo.
