...
############################# Head ############################
head_title: "Actualice Qrcode firmas colocadas en Potm archivos con Java"
head_description: "Use código simple y fácil de entender Java para la actualización de firmas Qrcode en documentos Potm firmados."

############################# Header ############################
title: "Edite y actualice Qrcode firmas colocadas en Potm archivos"
description: "La API para Java proporciona funcionalidad para la actualización de firmas Qrcode en documentos Potm. Actualice las firmas electrónicas dentro de sus documentos Potm con un par de líneas de código Java rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo cambiar las firmas Qrcode en su documento Potm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la actualización de Qrcode firmas colocadas en Potm documentos. Hace posible cambiar las características de las firmas sin código adicional.
