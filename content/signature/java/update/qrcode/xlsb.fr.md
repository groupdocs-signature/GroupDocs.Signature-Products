...
############################# Head ############################
head_title: "Mettre à jour les signatures Qrcode placées dans les fichiers Xlsb avec Java"
head_description: "Utilisez le code Java simple et facile à comprendre pour la mise à jour des signatures Qrcode dans les documents signés Xlsb."

############################# Header ############################
title: "Modifier et mettre à jour les signatures Qrcode placées dans les fichiers Xlsb"
description: "L'API pour Java fournit des fonctionnalités pour la mise à jour des signatures Qrcode dans les documents Xlsb. Mettez à jour les signatures électroniques dans vos documents Xlsb avec quelques lignes de code Java rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment changer les signatures Qrcode dans votre document Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la mise à jour des signatures Qrcode placées dans les documents Xlsb. Il permet de modifier les fonctionnalités des signatures sans code supplémentaire.
