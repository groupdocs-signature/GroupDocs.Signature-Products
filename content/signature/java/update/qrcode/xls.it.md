...
############################# Head ############################
head_title: "Aggiorna le firme Qrcode inserite nei file Xls con Java"
head_description: "Utilizza il codice Java semplice e facile per l'aggiornamento delle firme Qrcode nei documenti Xls firmati."

############################# Header ############################
title: "Modifica e aggiorna le firme Qrcode inserite nei file Xls"
description: "L'API per Java fornisce funzionalità per l'aggiornamento delle firme Qrcode nei documenti Xls. Aggiorna le firme elettroniche all'interno dei tuoi documenti Xls con un paio di righe di codice Java in modo rapido e semplice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) include funzioni utili come l'aggiornamento di firme Qrcode apposte in documenti Xls. Consente di modificare le caratteristiche delle firme senza codice aggiuntivo.
