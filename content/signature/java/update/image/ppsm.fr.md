...
############################# Head ############################
head_title: "Mettre à jour les signatures Image placées dans les fichiers Ppsm avec Java"
head_description: "Utilisez le code Java simple et facile à comprendre pour la mise à jour des signatures Image dans les documents signés Ppsm."

############################# Header ############################
title: "Modifier et mettre à jour les signatures Image placées dans les fichiers Ppsm"
description: "L'API pour Java fournit des fonctionnalités pour la mise à jour des signatures Image dans les documents Ppsm. Mettez à jour les signatures électroniques dans vos documents Ppsm avec quelques lignes de code Java rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment changer les signatures Image dans votre document Ppsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la mise à jour des signatures Image placées dans les documents Ppsm. Il permet de modifier les fonctionnalités des signatures sans code supplémentaire.
