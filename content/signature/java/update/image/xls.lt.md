...
############################# Head ############################
head_title: "Atnaujinkite Image parašus, pateiktus Xls failuose naudodami Java"
head_description: "Naudokite paprastą ir lengvai suprantamą Java kodą Image parašų atnaujinimui pasirašytuose Xls dokumentuose."

############################# Header ############################
title: "Redaguoti ir atnaujinti Image parašus, esančius Xls failuose"
description: "API, skirta Java, teikia Image parašų atnaujinimo funkciją Xls dokumentuose. Greitai ir lengvai atnaujinkite el. parašus savo Xls dokumentuose naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip pakeisti Image parašus Xls dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingų funkcijų, pvz., Image parašų, esančių Xls dokumentuose, atnaujinimas. Tai leidžia pakeisti parašo funkcijas be papildomo kodo.
