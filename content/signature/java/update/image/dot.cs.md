...
############################# Head ############################
head_title: "Aktualizujte podpisy Image umístěné v souborech Dot pomocí Java"
head_description: "Použijte jednoduchý a snadno pochopitelný kód Java pro aktualizaci podpisů Image v podepsaných dokumentech Dot."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Image umístěné v souborech Dot"
description: "API pro Java poskytuje funkce pro aktualizaci podpisů Image v dokumentech Dot. Aktualizujte elektronické podpisy ve svých dokumentech Dot pomocí několika řádků kódu Java rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je aktualizace podpisů Image umístěných v dokumentech Dot. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
