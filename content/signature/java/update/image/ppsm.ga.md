...
############################# Head ############################
head_title: "Nuashonraigh Image sínithe atá curtha i gcomhad Ppsm le Java"
head_description: "Úsáid cód Java atá simplí agus éasca le tuiscint le haghaidh nuashonruithe sínithe Image i ndoiciméid sínithe Ppsm."

############################# Header ############################
title: "Cuir in eagar agus nuashonraigh Image sínithe atá curtha ag comhaid Ppsm"
description: "Soláthraíonn API le haghaidh Java feidhmiúlacht le haghaidh sínithe Image nuashonraithe ag Ppsm doiciméad. Nuashonraigh ríomhshínithe taobh istigh de do dhoiciméid Ppsm le cúpla líne de chód Java go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Image sínithe a athrú i do dhoiciméad Ppsm"
    content_left: |
        Cuimsíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gnéithe úsáideacha amhail nuashonrú ar Image sínithe a cuireadh i ndoiciméid Ppsm. Is féidir gnéithe sínithe a athrú gan cód breise.
...
demos:
    ...
    content: |
       Cuir sínithe leictreonacha éagsúla den doiciméad Ppsm in eagar faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
