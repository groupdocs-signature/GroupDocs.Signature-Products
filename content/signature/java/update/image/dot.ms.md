...
############################# Head ############################
head_title: "Kemas kini tandatangan Image yang diletakkan pada fail Dot dengan Java"
head_description: "Gunakan kod Java yang ringkas dan mudah untuk kemas kini tandatangan Image dalam dokumen Dot yang ditandatangani."

############################# Header ############################
title: "Edit dan kemas kini tandatangan Image yang diletakkan pada fail Dot."
description: "API untuk Java menyediakan kefungsian untuk tandatangan Image mengemas kini pada dokumen Dot. Kemas kini e-tandatangan di dalam dokumen Dot anda dengan beberapa baris kod Java dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Cara menukar tandatangan Image dalam dokumen Dot anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) termasuk ciri berguna seperti pengemaskinian tandatangan Image yang diletakkan pada dokumen Dot. Ia memungkinkan untuk menukar ciri tandatangan tanpa kod tambahan.
