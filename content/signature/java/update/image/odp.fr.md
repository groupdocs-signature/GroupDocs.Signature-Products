...
############################# Head ############################
head_title: "Mettre à jour les signatures Image placées dans les fichiers Odp avec Java"
head_description: "Utilisez le code Java simple et facile à comprendre pour la mise à jour des signatures Image dans les documents signés Odp."

############################# Header ############################
title: "Modifier et mettre à jour les signatures Image placées dans les fichiers Odp"
description: "L'API pour Java fournit des fonctionnalités pour la mise à jour des signatures Image dans les documents Odp. Mettez à jour les signatures électroniques dans vos documents Odp avec quelques lignes de code Java rapidement et facilement."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la mise à jour des signatures Image placées dans les documents Odp. Il permet de modifier les fonctionnalités des signatures sans code supplémentaire.
