...
############################# Head ############################
head_title: "Îmzeyên Image li pelên Rtf bi Java hatine danîn nûve bikin"
head_description: "Ji bo têgihîştina koda Java ji bo nûvekirina îmzeyan a Image di belgeyên Rtf yên îmzekirî de hêsan û hêsan bikar bînin."

############################# Header ############################
title: "Îmzeyên ku li pelên Rtf hatine danîn biguherînin û nûve bikin"
description: "API ji bo Java fonksîyonê ji bo îmzeyên Image di belgeyên Rtf de nûve dike. E-îmzeyan di hundirê belgeyên xwe yên Rtf de bi çend rêzikên koda Java zû û bi hêsanî nûve bikin."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzeyên Image di belgeya xweya Rtf de biguherîne"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) taybetmendiyên bikêrhatî yên mîna nûvekirina îmzeyên Image yên ku li belgeyên Rtf hatine danîn, vedihewîne. Ew gengaz dike ku taybetmendiyên îmzeyan bêyî kodek zêde biguhezîne.
