...
############################# Head ############################
head_title: "Actualice Image firmas colocadas en Pps archivos con Java"
head_description: "Use código simple y fácil de entender Java para la actualización de firmas Image en documentos Pps firmados."

############################# Header ############################
title: "Edite y actualice Image firmas colocadas en Pps archivos"
description: "La API para Java proporciona funcionalidad para la actualización de firmas Image en documentos Pps. Actualice las firmas electrónicas dentro de sus documentos Pps con un par de líneas de código Java rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo cambiar las firmas Image en su documento Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la actualización de Image firmas colocadas en Pps documentos. Hace posible cambiar las características de las firmas sin código adicional.
