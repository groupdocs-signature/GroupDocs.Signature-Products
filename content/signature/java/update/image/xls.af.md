...
############################# Head ############################
head_title: "Dateer Image-handtekeninge wat by Xls-lêers geplaas is op met Java"
head_description: "Gebruik eenvoudig en maklik om Java-kode te verstaan ​​vir opdatering van Image-handtekeninge in ondertekende Xls-dokumente."

############################# Header ############################
title: "Wysig en werk Image-handtekeninge op wat by Xls-lêers geplaas is"
description: "API vir Java verskaf funksionaliteit vir Image handtekeninge wat by Xls dokumente opdateer. Dateer e-handtekeninge binne jou Xls dokumente op met 'n paar reëls van Java kode vinnig en maklik."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos opdatering van Image-handtekeninge wat by Xls-dokumente geplaas is. Dit maak dit moontlik om handtekeningkenmerke te verander sonder ekstra kode.
