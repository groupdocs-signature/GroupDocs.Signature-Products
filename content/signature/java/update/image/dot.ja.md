...
############################# Head ############################
head_title: "Dot ファイルに配置された Image 署名を Java で更新します"
head_description: "署名済みの Dot ドキュメントの Image 署名の更新には、シンプルでわかりやすい Java コードを使用してください。"

############################# Header ############################
title: "Dot ファイルに配置された Image 署名の編集と更新"
description: "Java の API は、Dot ドキュメントで更新する Image 署名の機能を提供します。 Dot ドキュメント内の電子署名を数行の Java コードですばやく簡単に更新します。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) には、Dot ドキュメントに配置された Image 署名の更新などの便利な機能が含まれています。追加のコードなしで署名機能を変更できます。
