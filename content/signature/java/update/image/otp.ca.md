...
############################# Head ############################
head_title: "Actualitza les signatures de Image col·locades als fitxers Otp amb Java"
head_description: "Utilitzeu el codi Java senzill i fàcil d'entendre per a l'actualització de signatures de Image en documents de Otp signats."

############################# Header ############################
title: "Editeu i actualitzeu les signatures Image col·locades als fitxers Otp"
description: "L'API per a Java proporciona funcionalitat per a les signatures de Image que s'actualitzen als documents Otp. Actualitzeu les signatures electròniques dins dels vostres documents Otp amb un parell de línies de codi Java de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com canviar les signatures de Image al vostre document Otp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclou funcions útils com ara l'actualització de signatures de Image col·locades als documents Otp. Permet canviar les funcions de signatures sense codi addicional.
