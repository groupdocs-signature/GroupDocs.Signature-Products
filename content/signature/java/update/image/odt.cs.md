...
############################# Head ############################
head_title: "Aktualizujte podpisy Image umístěné v souborech Odt pomocí Java"
head_description: "Použijte jednoduchý a snadno pochopitelný kód Java pro aktualizaci podpisů Image v podepsaných dokumentech Odt."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Image umístěné v souborech Odt"
description: "API pro Java poskytuje funkce pro aktualizaci podpisů Image v dokumentech Odt. Aktualizujte elektronické podpisy ve svých dokumentech Odt pomocí několika řádků kódu Java rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je aktualizace podpisů Image umístěných v dokumentech Odt. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
