...
############################# Head ############################
head_title: "በPps ፋይሎች ላይ የተቀመጡ የImage ፊርማዎችን በJava ያዘምኑ"
head_description: "በተፈረሙ የPps ሰነዶች ውስጥ ለImage የፊርማ ማሻሻያ የJava ኮድ ለመረዳት ቀላል እና ቀላል ይጠቀሙ።"

############################# Header ############################
title: "በPps ፋይሎች ላይ የተቀመጡ የImage ፊርማዎችን ያርትዑ እና ያዘምኑ"
description: "ኤፒአይ ለJava ለImage ፊርማዎች በPps ሰነዶች ላይ ማዘመንን ያቀርባል። በPps ሰነዶችዎ ውስጥ ያሉ ኢ-ፊርማዎችን በሁለት መስመር Java ኮድ በፍጥነት እና በቀላሉ ያዘምኑ።"
...
steps:
    enable: true
    title_left: "በእርስዎ Pps ሰነድ ውስጥ የImage ፊርማዎችን እንዴት መቀየር እንደሚቻል"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) በPps ሰነዶች ላይ የተቀመጡ የImage ፊርማዎችን ማዘመንን የመሳሰሉ ጠቃሚ ባህሪያትን ያካትታል። ያለ ተጨማሪ ኮድ የፊርማ ባህሪያትን ለመለወጥ ያስችላል።
