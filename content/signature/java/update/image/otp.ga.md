...
############################# Head ############################
head_title: "Nuashonraigh Image sínithe atá curtha i gcomhad Otp le Java"
head_description: "Úsáid cód Java atá simplí agus éasca le tuiscint le haghaidh nuashonruithe sínithe Image i ndoiciméid sínithe Otp."

############################# Header ############################
title: "Cuir in eagar agus nuashonraigh Image sínithe atá curtha ag comhaid Otp"
description: "Soláthraíonn API le haghaidh Java feidhmiúlacht le haghaidh sínithe Image nuashonraithe ag Otp doiciméad. Nuashonraigh ríomhshínithe taobh istigh de do dhoiciméid Otp le cúpla líne de chód Java go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Image sínithe a athrú i do dhoiciméad Otp"
    content_left: |
        Cuimsíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gnéithe úsáideacha amhail nuashonrú ar Image sínithe a cuireadh i ndoiciméid Otp. Is féidir gnéithe sínithe a athrú gan cód breise.
