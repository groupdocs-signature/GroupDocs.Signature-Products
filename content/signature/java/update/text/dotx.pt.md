...
############################# Head ############################
head_title: "Atualize assinaturas Text colocadas em arquivos Dotx com Java"
head_description: "Use o código Java simples e fácil para atualização de assinaturas Text em documentos Dotx assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Text colocadas em arquivos Dotx"
description: "A API para Java fornece funcionalidade para atualização de assinaturas Text em documentos Dotx. Atualize assinaturas eletrônicas dentro de seus documentos Dotx com algumas linhas de código Java de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis como atualização de Text assinaturas colocadas em documentos Dotx. Possibilita alterar recursos de assinaturas sem código extra.
