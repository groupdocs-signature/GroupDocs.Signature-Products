...
demos:
    ...
    content: |
       Agregue varias firmas electrónicas al archivo Pptx ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
