...
############################# Head ############################
head_title: "Mettre à jour les signatures Text placées dans les fichiers Ods avec Java"
head_description: "Utilisez le code Java simple et facile à comprendre pour la mise à jour des signatures Text dans les documents signés Ods."

############################# Header ############################
title: "Modifier et mettre à jour les signatures Text placées dans les fichiers Ods"
description: "L'API pour Java fournit des fonctionnalités pour la mise à jour des signatures Text dans les documents Ods. Mettez à jour les signatures électroniques dans vos documents Ods avec quelques lignes de code Java rapidement et facilement."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la mise à jour des signatures Text placées dans les documents Ods. Il permet de modifier les fonctionnalités des signatures sans code supplémentaire.
