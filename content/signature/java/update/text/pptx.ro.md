...
############################# Head ############################
head_title: "Actualizați Text semnături plasate în fișiere Pptx cu Java"
head_description: "Utilizați codul Java simplu și ușor de înțeles pentru actualizarea semnăturilor Text în documentele Pptx semnate."

############################# Header ############################
title: "Editați și actualizați semnăturile Text plasate în fișierele Pptx"
description: "API-ul pentru Java oferă funcționalități pentru actualizarea semnăturilor Text la documentele Pptx. Actualizați rapid și ușor semnăturile electronice din documentele dvs. Pptx cu câteva rânduri de cod Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) include funcții utile, cum ar fi actualizarea semnăturilor Text plasate în documentele Pptx. Face posibilă schimbarea caracteristicilor semnăturilor fără cod suplimentar.
