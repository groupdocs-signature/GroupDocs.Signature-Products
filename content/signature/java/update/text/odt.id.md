...
############################# Head ############################
head_title: "Perbarui tanda tangan Text yang ditempatkan di file Odt dengan Java"
head_description: "Gunakan kode Java yang sederhana dan mudah dipahami untuk pembaruan tanda tangan Text dalam dokumen Odt yang ditandatangani."

############################# Header ############################
title: "Edit dan perbarui tanda tangan Text yang ditempatkan di file Odt"
description: "API untuk Java menyediakan fungsionalitas untuk pembaruan tanda tangan Text pada dokumen Odt. Perbarui tanda tangan elektronik di dalam dokumen Odt Anda dengan beberapa baris kode Java dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Cara mengubah tanda tangan Text di dokumen Odt Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyertakan fitur berguna seperti pembaruan tanda tangan Text yang ditempatkan di dokumen Odt. Itu memungkinkan untuk mengubah fitur tanda tangan tanpa kode tambahan.
