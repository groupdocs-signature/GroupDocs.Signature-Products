...
############################# Head ############################
head_title: "Atnaujinkite Text parašus, pateiktus Xlsx failuose naudodami Java"
head_description: "Naudokite paprastą ir lengvai suprantamą Java kodą Text parašų atnaujinimui pasirašytuose Xlsx dokumentuose."

############################# Header ############################
title: "Redaguoti ir atnaujinti Text parašus, esančius Xlsx failuose"
description: "API, skirta Java, teikia Text parašų atnaujinimo funkciją Xlsx dokumentuose. Greitai ir lengvai atnaujinkite el. parašus savo Xlsx dokumentuose naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip pakeisti Text parašus Xlsx dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingų funkcijų, pvz., Text parašų, esančių Xlsx dokumentuose, atnaujinimas. Tai leidžia pakeisti parašo funkcijas be papildomo kodo.
