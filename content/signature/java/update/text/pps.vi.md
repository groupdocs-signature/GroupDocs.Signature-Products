...
############################# Head ############################
head_title: "Cập nhật chữ ký Text được đặt trong tệp Pps bằng Java"
head_description: "Sử dụng mã Java đơn giản và dễ hiểu để cập nhật chữ ký Text trong tài liệu Pps đã ký."

############################# Header ############################
title: "Chỉnh sửa và cập nhật chữ ký Text được đặt trong tệp Pps"
description: "API cho Java cung cấp chức năng cập nhật chữ ký Text tại tài liệu Pps. Cập nhật chữ ký điện tử bên trong tài liệu Pps của bạn bằng một vài dòng mã Java một cách nhanh chóng và dễ dàng."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) bao gồm các tính năng hữu ích như cập nhật chữ ký Text được đặt trong tài liệu Pps. Có thể thay đổi các tính năng của chữ ký mà không cần thêm mã.
