...
############################# Head ############################
head_title: "Posodobite podpise Text v datotekah Xls z Java"
head_description: "Uporabite preprosto in razumljivo kodo Java za posodobitev podpisov Text v podpisanih dokumentih Xls."

############################# Header ############################
title: "Uredite in posodobite podpise Text v datotekah Xls"
description: "API za Java zagotavlja funkcionalnost za posodabljanje podpisov Text v dokumentih Xls. Hitro in enostavno posodobite e-podpise v svojih dokumentih Xls z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Kako spremeniti podpise Text v dokumentu Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je posodobitev podpisov Text v dokumentih Xls. Omogoča spreminjanje funkcij podpisov brez dodatne kode.
