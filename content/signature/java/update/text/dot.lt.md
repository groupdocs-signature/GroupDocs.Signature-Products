...
############################# Head ############################
head_title: "Atnaujinkite Text parašus, pateiktus Dot failuose naudodami Java"
head_description: "Naudokite paprastą ir lengvai suprantamą Java kodą Text parašų atnaujinimui pasirašytuose Dot dokumentuose."

############################# Header ############################
title: "Redaguoti ir atnaujinti Text parašus, esančius Dot failuose"
description: "API, skirta Java, teikia Text parašų atnaujinimo funkciją Dot dokumentuose. Greitai ir lengvai atnaujinkite el. parašus savo Dot dokumentuose naudodami kelias Java kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingų funkcijų, pvz., Text parašų, esančių Dot dokumentuose, atnaujinimas. Tai leidžia pakeisti parašo funkcijas be papildomo kodo.
