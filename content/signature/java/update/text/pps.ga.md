...
############################# Head ############################
head_title: "Nuashonraigh Text sínithe atá curtha i gcomhad Pps le Java"
head_description: "Úsáid cód Java atá simplí agus éasca le tuiscint le haghaidh nuashonruithe sínithe Text i ndoiciméid sínithe Pps."

############################# Header ############################
title: "Cuir in eagar agus nuashonraigh Text sínithe atá curtha ag comhaid Pps"
description: "Soláthraíonn API le haghaidh Java feidhmiúlacht le haghaidh sínithe Text nuashonraithe ag Pps doiciméad. Nuashonraigh ríomhshínithe taobh istigh de do dhoiciméid Pps le cúpla líne de chód Java go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Text sínithe a athrú i do dhoiciméad Pps"
    content_left: |
        Cuimsíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gnéithe úsáideacha amhail nuashonrú ar Text sínithe a cuireadh i ndoiciméid Pps. Is féidir gnéithe sínithe a athrú gan cód breise.
