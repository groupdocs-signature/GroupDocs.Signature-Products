...
############################# Head ############################
head_title: "Uppfærðu Text undirskriftir settar á Ott skrár með Java"
head_description: "Notaðu einfaldan og auðskilinn Java kóða fyrir uppfærslu á Text undirskriftum í undirrituðum Ott skjölum."

############################# Header ############################
title: "Breyttu og uppfærðu Text undirskriftir sem settar eru á Ott skrár"
description: "API fyrir Java veitir virkni fyrir Text undirskriftir sem uppfæra á Ott skjölum. Uppfærðu rafrænar undirskriftir í Ott skjölunum þínum með nokkrum línum af Java kóða fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Hvernig á að breyta Text undirskriftum í Ott skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inniheldur gagnlega eiginleika eins og uppfærslu á Text undirskriftum sem settar eru á Ott skjöl. Það gerir mögulegt að breyta eiginleikum undirskrifta án aukakóða.
