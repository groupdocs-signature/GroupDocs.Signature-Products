...
############################# Head ############################
head_title: "Îmzeyên Text li pelên Otp bi Java hatine danîn nûve bikin"
head_description: "Ji bo têgihîştina koda Java ji bo nûvekirina îmzeyan a Text di belgeyên Otp yên îmzekirî de hêsan û hêsan bikar bînin."

############################# Header ############################
title: "Îmzeyên ku li pelên Otp hatine danîn biguherînin û nûve bikin"
description: "API ji bo Java fonksîyonê ji bo îmzeyên Text di belgeyên Otp de nûve dike. E-îmzeyan di hundirê belgeyên xwe yên Otp de bi çend rêzikên koda Java zû û bi hêsanî nûve bikin."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzeyên Text di belgeya xweya Otp de biguherîne"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) taybetmendiyên bikêrhatî yên mîna nûvekirina îmzeyên Text yên ku li belgeyên Otp hatine danîn, vedihewîne. Ew gengaz dike ku taybetmendiyên îmzeyan bêyî kodek zêde biguhezîne.
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) aniha gelek îmzeyên elektronîkî yên belgeya Otp biguherînin.          
