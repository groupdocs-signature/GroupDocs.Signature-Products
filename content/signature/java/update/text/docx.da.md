...
head_description: "Brug enkel og nem at forstå Java-koden til opdatering af Text-signaturer i signerede Docx-dokumenter."

############################# Header ############################
title: "Rediger og opdater Text signaturer placeret på Docx filer"
description: "API for Java giver funktionalitet til Text signaturer, der opdateres i Docx dokumenter. Opdater e-signaturer i dine Docx dokumenter med et par linjer med Java kode hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan ændrer du Text-signaturer i dit Docx-dokument"
    content_left: |
