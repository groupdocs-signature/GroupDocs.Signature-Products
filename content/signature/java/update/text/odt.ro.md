...
############################# Head ############################
head_title: "Actualizați Text semnături plasate în fișiere Odt cu Java"
head_description: "Utilizați codul Java simplu și ușor de înțeles pentru actualizarea semnăturilor Text în documentele Odt semnate."

############################# Header ############################
title: "Editați și actualizați semnăturile Text plasate în fișierele Odt"
description: "API-ul pentru Java oferă funcționalități pentru actualizarea semnăturilor Text la documentele Odt. Actualizați rapid și ușor semnăturile electronice din documentele dvs. Odt cu câteva rânduri de cod Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) include funcții utile, cum ar fi actualizarea semnăturilor Text plasate în documentele Odt. Face posibilă schimbarea caracteristicilor semnăturilor fără cod suplimentar.
