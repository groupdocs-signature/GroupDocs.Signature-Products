...
############################# Head ############################
head_title: "Aktualizujte podpisy Text umístěné v souborech Xlsm pomocí Java"
head_description: "Použijte jednoduchý a snadno pochopitelný kód Java pro aktualizaci podpisů Text v podepsaných dokumentech Xlsm."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Text umístěné v souborech Xlsm"
description: "API pro Java poskytuje funkce pro aktualizaci podpisů Text v dokumentech Xlsm. Aktualizujte elektronické podpisy ve svých dokumentech Xlsm pomocí několika řádků kódu Java rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je aktualizace podpisů Text umístěných v dokumentech Xlsm. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
