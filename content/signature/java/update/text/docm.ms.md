...
############################# Head ############################
head_title: "Kemas kini tandatangan Text yang diletakkan pada fail Docm dengan Java"
head_description: "Gunakan kod Java yang ringkas dan mudah untuk kemas kini tandatangan Text dalam dokumen Docm yang ditandatangani."

############################# Header ############################
title: "Edit dan kemas kini tandatangan Text yang diletakkan pada fail Docm."
description: "API untuk Java menyediakan kefungsian untuk tandatangan Text mengemas kini pada dokumen Docm. Kemas kini e-tandatangan di dalam dokumen Docm anda dengan beberapa baris kod Java dengan cepat dan mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) termasuk ciri berguna seperti pengemaskinian tandatangan Text yang diletakkan pada dokumen Docm. Ia memungkinkan untuk menukar ciri tandatangan tanpa kod tambahan.
