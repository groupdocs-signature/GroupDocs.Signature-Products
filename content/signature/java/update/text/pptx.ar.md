...
############################# Head ############################
head_title: "تحديث Text التوقيعات الموضوعة في ملفات Pptx باستخدام Java"
head_description: "استخدم رمز Java البسيط والسهل الفهم لتحديث التوقيعات Text في المستندات الموقعة Pptx."

############################# Header ############################
title: "قم بتحرير وتحديث توقيعات Text الموضوعة في ملفات Pptx"
description: "توفر واجهة برمجة التطبيقات لـ Java وظيفة لتحديث توقيعات Text في مستندات Pptx. قم بتحديث التوقيعات الإلكترونية داخل مستندات Pptx باستخدام سطرين من كود Java بسرعة وسهولة."
...
steps:
    enable: true
    title_left: "كيفية تغيير توقيعات Text في مستندك Pptx"
    content_left: |
        يتضمن [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) ميزات مفيدة مثل تحديث توقيعات Text الموضوعة في مستندات Pptx. يجعل من الممكن تغيير ميزات التوقيعات بدون رمز إضافي.
