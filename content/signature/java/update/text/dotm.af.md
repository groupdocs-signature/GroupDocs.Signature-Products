...
############################# Head ############################
head_title: "Dateer Text-handtekeninge wat by Dotm-lêers geplaas is op met Java"
head_description: "Gebruik eenvoudig en maklik om Java-kode te verstaan ​​vir opdatering van Text-handtekeninge in ondertekende Dotm-dokumente."

############################# Header ############################
title: "Wysig en werk Text-handtekeninge op wat by Dotm-lêers geplaas is"
description: "API vir Java verskaf funksionaliteit vir Text handtekeninge wat by Dotm dokumente opdateer. Dateer e-handtekeninge binne jou Dotm dokumente op met 'n paar reëls van Java kode vinnig en maklik."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos opdatering van Text-handtekeninge wat by Dotm-dokumente geplaas is. Dit maak dit moontlik om handtekeningkenmerke te verander sonder ekstra kode.
