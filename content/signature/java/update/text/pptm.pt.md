...
############################# Head ############################
head_title: "Atualize assinaturas Text colocadas em arquivos Pptm com Java"
head_description: "Use o código Java simples e fácil para atualização de assinaturas Text em documentos Pptm assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Text colocadas em arquivos Pptm"
description: "A API para Java fornece funcionalidade para atualização de assinaturas Text em documentos Pptm. Atualize assinaturas eletrônicas dentro de seus documentos Pptm com algumas linhas de código Java de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como alterar assinaturas Text em seu documento Pptm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis como atualização de Text assinaturas colocadas em documentos Pptm. Possibilita alterar recursos de assinaturas sem código extra.
...
demos:
    ...
    content: |
       Edite várias assinaturas eletrônicas do documento Pptm agora mesmo visitando o site do [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
