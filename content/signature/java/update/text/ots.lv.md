...
############################# Head ############################
head_title: "Atjauniniet Text parakstus, kas ievietoti failos Ots ar Java"
head_description: "Izmantojiet vienkāršu un viegli saprotamu Java kodu Text parakstu atjaunināšanai parakstītos Ots dokumentos."

############################# Header ############################
title: "Rediģējiet un atjauniniet Text parakstus, kas ievietoti Ots failos"
description: "Java API nodrošina funkcionalitāti Text parakstu atjaunināšanai Ots dokumentos. Ātri un vienkārši atjauniniet e-parakstus savos Ots dokumentos, izmantojot pāris Java koda rindiņas."
...
steps:
    enable: true
    title_left: "Kā mainīt Text parakstus savā Ots dokumentā"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ietver noderīgas funkcijas, piemēram, Text parakstu atjaunināšanu, kas ievietoti Ots dokumentos. Tas ļauj mainīt parakstu funkcijas bez papildu koda.
