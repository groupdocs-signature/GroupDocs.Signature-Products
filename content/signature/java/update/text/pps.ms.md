...
############################# Head ############################
head_title: "Kemas kini tandatangan Text yang diletakkan pada fail Pps dengan Java"
head_description: "Gunakan kod Java yang ringkas dan mudah untuk kemas kini tandatangan Text dalam dokumen Pps yang ditandatangani."

############################# Header ############################
title: "Edit dan kemas kini tandatangan Text yang diletakkan pada fail Pps."
description: "API untuk Java menyediakan kefungsian untuk tandatangan Text mengemas kini pada dokumen Pps. Kemas kini e-tandatangan di dalam dokumen Pps anda dengan beberapa baris kod Java dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Cara menukar tandatangan Text dalam dokumen Pps anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) termasuk ciri berguna seperti pengemaskinian tandatangan Text yang diletakkan pada dokumen Pps. Ia memungkinkan untuk menukar ciri tandatangan tanpa kod tambahan.
