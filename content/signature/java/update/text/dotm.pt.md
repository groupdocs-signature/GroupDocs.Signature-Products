...
############################# Head ############################
head_title: "Atualize assinaturas Text colocadas em arquivos Dotm com Java"
head_description: "Use o código Java simples e fácil para atualização de assinaturas Text em documentos Dotm assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Text colocadas em arquivos Dotm"
description: "A API para Java fornece funcionalidade para atualização de assinaturas Text em documentos Dotm. Atualize assinaturas eletrônicas dentro de seus documentos Dotm com algumas linhas de código Java de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como alterar assinaturas Text em seu documento Dotm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis como atualização de Text assinaturas colocadas em documentos Dotm. Possibilita alterar recursos de assinaturas sem código extra.
