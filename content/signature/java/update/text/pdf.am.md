...
############################# Head ############################
head_title: "በPdf ፋይሎች ላይ የተቀመጡ የText ፊርማዎችን በJava ያዘምኑ"
head_description: "በተፈረሙ የPdf ሰነዶች ውስጥ ለText የፊርማ ማሻሻያ የJava ኮድ ለመረዳት ቀላል እና ቀላል ይጠቀሙ።"

############################# Header ############################
title: "በPdf ፋይሎች ላይ የተቀመጡ የText ፊርማዎችን ያርትዑ እና ያዘምኑ"
description: "ኤፒአይ ለJava ለText ፊርማዎች በPdf ሰነዶች ላይ ማዘመንን ያቀርባል። በPdf ሰነዶችዎ ውስጥ ያሉ ኢ-ፊርማዎችን በሁለት መስመር Java ኮድ በፍጥነት እና በቀላሉ ያዘምኑ።"
...
steps:
    enable: true
    title_left: "በእርስዎ Pdf ሰነድ ውስጥ የText ፊርማዎችን እንዴት መቀየር እንደሚቻል"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) በPdf ሰነዶች ላይ የተቀመጡ የText ፊርማዎችን ማዘመንን የመሳሰሉ ጠቃሚ ባህሪያትን ያካትታል። ያለ ተጨማሪ ኮድ የፊርማ ባህሪያትን ለመለወጥ ያስችላል።
