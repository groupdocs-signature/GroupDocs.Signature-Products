...
############################# Head ############################
head_title: "Värskendage Text allkirja, mis on pandud failidesse Odp rakendusega Java"
head_description: "Kasutage allkirjastatud Odp dokumentides allkirjade Text värskendamiseks lihtsat ja hõlpsasti mõistetavat Java koodi."

############################# Header ############################
title: "Muutke ja värskendage failidesse Odp pandud allkirju Text"
description: "API for Java pakub funktsiooni Text allkirjade värskendamiseks dokumentides Odp. Värskendage oma Odp dokumentides olevaid e-allkirju paari rea koodiga Java kiiresti ja lihtsalt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Text allkirjade värskendamine, mis on paigutatud dokumentidele Odp. See võimaldab muuta allkirjafunktsioone ilma lisakoodita.
