...
############################# Head ############################
head_title: "Actualitza les signatures de Text col·locades als fitxers Odt amb Java"
head_description: "Utilitzeu el codi Java senzill i fàcil d'entendre per a l'actualització de signatures de Text en documents de Odt signats."

############################# Header ############################
title: "Editeu i actualitzeu les signatures Text col·locades als fitxers Odt"
description: "L'API per a Java proporciona funcionalitat per a les signatures de Text que s'actualitzen als documents Odt. Actualitzeu les signatures electròniques dins dels vostres documents Odt amb un parell de línies de codi Java de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com canviar les signatures de Text al vostre document Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclou funcions útils com ara l'actualització de signatures de Text col·locades als documents Odt. Permet canviar les funcions de signatures sense codi addicional.
...
demos:
    ...
    content: |
       Editeu diverses signatures electròniques del document Odt ara mateix visitant el lloc web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
