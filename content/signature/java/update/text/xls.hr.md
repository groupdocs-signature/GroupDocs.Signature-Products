...
############################# Head ############################
head_title: "Ažurirajte Text potpise postavljene u datoteke Xls s Java"
head_description: "Koristite jednostavan i razumljiv Java kod za ažuriranje potpisa Text u potpisanim Xls dokumentima."

############################# Header ############################
title: "Uredite i ažurirajte Text potpise postavljene u Xls datoteke"
description: "API za Java pruža funkcionalnost za ažuriranje potpisa Text u dokumentima Xls. Ažurirajte e-potpise unutar svojih Xls dokumenata s nekoliko redaka Java koda brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je ažuriranje Text potpisa postavljenih u dokumente Xls. Omogućuje promjenu značajki potpisa bez dodatnog koda.
