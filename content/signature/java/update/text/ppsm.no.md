...
############################# Head ############################
head_title: "Oppdater Text-signaturer plassert på Ppsm-filer med Java"
head_description: "Bruk enkel og enkel for å forstå Java-koden for Text-signaturoppdatering i signerte Ppsm-dokumenter."

############################# Header ############################
title: "Rediger og oppdater Text-signaturer plassert i Ppsm-filer"
description: "API for Java gir funksjonalitet for Text-signaturer som oppdateres i Ppsm-dokumenter. Oppdater e-signaturer i Ppsm-dokumentene dine med et par linjer med Java-kode raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funksjoner som oppdatering av Text-signaturer plassert i Ppsm-dokumenter. Det gjør det mulig å endre signaturfunksjoner uten ekstra kode.
