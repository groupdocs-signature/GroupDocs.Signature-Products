...
############################# Head ############################
head_title: "تحديث Text التوقيعات الموضوعة في ملفات Dotm باستخدام Java"
head_description: "استخدم رمز Java البسيط والسهل الفهم لتحديث التوقيعات Text في المستندات الموقعة Dotm."

############################# Header ############################
title: "قم بتحرير وتحديث توقيعات Text الموضوعة في ملفات Dotm"
description: "توفر واجهة برمجة التطبيقات لـ Java وظيفة لتحديث توقيعات Text في مستندات Dotm. قم بتحديث التوقيعات الإلكترونية داخل مستندات Dotm باستخدام سطرين من كود Java بسرعة وسهولة."
...
steps:
    enable: true
    title_left: "كيفية تغيير توقيعات Text في مستندك Dotm"
    content_left: |
        يتضمن [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) ميزات مفيدة مثل تحديث توقيعات Text الموضوعة في مستندات Dotm. يجعل من الممكن تغيير ميزات التوقيعات بدون رمز إضافي.
