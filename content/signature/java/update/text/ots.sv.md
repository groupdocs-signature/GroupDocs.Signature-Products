...
############################# Head ############################
head_title: "Uppdatera Text-signaturer placerade i Ots-filer med Java"
head_description: "Använd enkel och lätt att förstå Java-koden för uppdatering av Text-signaturer i signerade Ots-dokument."

############################# Header ############################
title: "Redigera och uppdatera Text-signaturer placerade i Ots-filer"
description: "API för Java tillhandahåller funktionalitet för Text-signaturer som uppdateras i Ots-dokument. Uppdatera e-signaturer i dina Ots-dokument med ett par rader Java-kod snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här ändrar du Text-signaturer i ditt Ots-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som uppdatering av Text-signaturer placerade i Ots-dokument. Det gör det möjligt att ändra signaturfunktioner utan extra kod.
