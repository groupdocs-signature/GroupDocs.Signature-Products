...
############################# Head ############################
head_title: "Java کے ساتھ Odt فائلوں پر رکھے گئے Text دستخطوں کو اپ ڈیٹ کریں"
head_description: "دستخط شدہ Odt دستاویزات میں Text دستخطوں کی تازہ کاری کے لیے Java کوڈ کو سمجھنے کے لیے آسان اور آسان استعمال کریں۔"

############################# Header ############################
title: "Odt فائلوں پر رکھے گئے Text دستخطوں میں ترمیم اور اپ ڈیٹ کریں"
description: "API برائے Java Text دستخطوں کو Odt دستاویزات پر اپ ڈیٹ کرنے کے لیے فعالیت فراہم کرتا ہے۔ اپنے Odt دستاویزات کے اندر ای دستخطوں کو Java کوڈ کی دو لائنوں کے ساتھ جلدی اور آسانی سے اپ ڈیٹ کریں۔"
...
steps:
    enable: true
    title_left: "اپنے Odt دستاویز میں Text دستخطوں کو کیسے تبدیل کریں۔"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) میں مفید خصوصیات شامل ہیں جیسے Odt دستاویزات پر رکھے گئے Text دستخطوں کی تازہ کاری۔ اضافی کوڈ کے بغیر دستخط کی خصوصیات کو تبدیل کرنا ممکن بناتا ہے۔
