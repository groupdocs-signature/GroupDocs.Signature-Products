...
############################# Head ############################
head_title: "Update Text signatures placed at Doc files in Java"
head_description: "Use simple and easy to understand Java code for Text signatures updation in signed Doc documents."

############################# Header ############################
title: "Edit and update Text signatures placed at Doc files"
description: "API for Java provides functionality to edit and update Text signatures at Doc documents. Update e-signatures inside your Doc documents with a couple lines of code quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like updation of Text signatures placed at Doc documents. It is makes possible to change signatures features without excess code.
