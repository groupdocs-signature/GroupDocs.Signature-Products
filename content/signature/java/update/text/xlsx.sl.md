...
############################# Head ############################
head_title: "Posodobite podpise Text v datotekah Xlsx z Java"
head_description: "Uporabite preprosto in razumljivo kodo Java za posodobitev podpisov Text v podpisanih dokumentih Xlsx."

############################# Header ############################
title: "Uredite in posodobite podpise Text v datotekah Xlsx"
description: "API za Java zagotavlja funkcionalnost za posodabljanje podpisov Text v dokumentih Xlsx. Hitro in enostavno posodobite e-podpise v svojih dokumentih Xlsx z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Kako spremeniti podpise Text v dokumentu Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je posodobitev podpisov Text v dokumentih Xlsx. Omogoča spreminjanje funkcij podpisov brez dodatne kode.
