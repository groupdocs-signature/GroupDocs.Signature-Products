...
############################# Head ############################
head_title: "Nuashonraigh Barcode sínithe atá curtha i gcomhad Pptm le Java"
head_description: "Úsáid cód Java atá simplí agus éasca le tuiscint le haghaidh nuashonruithe sínithe Barcode i ndoiciméid sínithe Pptm."

############################# Header ############################
title: "Cuir in eagar agus nuashonraigh Barcode sínithe atá curtha ag comhaid Pptm"
description: "Soláthraíonn API le haghaidh Java feidhmiúlacht le haghaidh sínithe Barcode nuashonraithe ag Pptm doiciméad. Nuashonraigh ríomhshínithe taobh istigh de do dhoiciméid Pptm le cúpla líne de chód Java go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Barcode sínithe a athrú i do dhoiciméad Pptm"
    content_left: |
        Cuimsíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gnéithe úsáideacha amhail nuashonrú ar Barcode sínithe a cuireadh i ndoiciméid Pptm. Is féidir gnéithe sínithe a athrú gan cód breise.
