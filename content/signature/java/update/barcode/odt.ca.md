...
############################# Head ############################
head_title: "Actualitza les signatures de Barcode col·locades als fitxers Odt amb Java"
head_description: "Utilitzeu el codi Java senzill i fàcil d'entendre per a l'actualització de signatures de Barcode en documents de Odt signats."

############################# Header ############################
title: "Editeu i actualitzeu les signatures Barcode col·locades als fitxers Odt"
description: "L'API per a Java proporciona funcionalitat per a les signatures de Barcode que s'actualitzen als documents Odt. Actualitzeu les signatures electròniques dins dels vostres documents Odt amb un parell de línies de codi Java de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com canviar les signatures de Barcode al vostre document Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclou funcions útils com ara l'actualització de signatures de Barcode col·locades als documents Odt. Permet canviar les funcions de signatures sense codi addicional.
