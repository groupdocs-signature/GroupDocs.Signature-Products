...
############################# Head ############################
head_title: "Aggiorna le firme Barcode inserite nei file Ods con Java"
head_description: "Utilizza il codice Java semplice e facile per l'aggiornamento delle firme Barcode nei documenti Ods firmati."

############################# Header ############################
title: "Modifica e aggiorna le firme Barcode inserite nei file Ods"
description: "L'API per Java fornisce funzionalità per l'aggiornamento delle firme Barcode nei documenti Ods. Aggiorna le firme elettroniche all'interno dei tuoi documenti Ods con un paio di righe di codice Java in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Come modificare le firme Barcode nel tuo documento Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) include funzioni utili come l'aggiornamento di firme Barcode apposte in documenti Ods. Consente di modificare le caratteristiche delle firme senza codice aggiuntivo.
