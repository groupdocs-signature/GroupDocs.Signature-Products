...
############################# Head ############################
head_title: "Atualize assinaturas Barcode colocadas em arquivos Xlsb com Java"
head_description: "Use o código Java simples e fácil para atualização de assinaturas Barcode em documentos Xlsb assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Barcode colocadas em arquivos Xlsb"
description: "A API para Java fornece funcionalidade para atualização de assinaturas Barcode em documentos Xlsb. Atualize assinaturas eletrônicas dentro de seus documentos Xlsb com algumas linhas de código Java de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como alterar assinaturas Barcode em seu documento Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis como atualização de Barcode assinaturas colocadas em documentos Xlsb. Possibilita alterar recursos de assinaturas sem código extra.
...
demos:
    ...
    content: |
       Edite várias assinaturas eletrônicas do documento Xlsb agora mesmo visitando o site do [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
