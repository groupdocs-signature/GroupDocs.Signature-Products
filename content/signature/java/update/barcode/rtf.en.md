...
############################# Head ############################
head_title: "Update Barcode signatures placed at Rtf files with Java"
head_description: "Use simple and easy for understanding Java code for Barcode signatures updation in signed Rtf documents."

############################# Header ############################
title: "Edit and update Barcode signatures placed at Rtf files"
description: "API for Java provides functionality for Barcode signatures updating at Rtf documents. Update e-signatures inside your Rtf documents with a couple lines of Java code quickly and easily."
...
steps:
    enable: true
    title_left: "How to change Barcode signatures in your Rtf document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like updation of Barcode signatures placed at Rtf documents. It makes possible to change signatures features without extra code.
...
demos:
    ...
    content: |
       Edit various electronic signatures of the Rtf document right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.          
