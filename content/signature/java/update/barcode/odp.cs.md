...
############################# Head ############################
head_title: "Aktualizujte podpisy Barcode umístěné v souborech Odp pomocí Java"
head_description: "Použijte jednoduchý a snadno pochopitelný kód Java pro aktualizaci podpisů Barcode v podepsaných dokumentech Odp."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Barcode umístěné v souborech Odp"
description: "API pro Java poskytuje funkce pro aktualizaci podpisů Barcode v dokumentech Odp. Aktualizujte elektronické podpisy ve svých dokumentech Odp pomocí několika řádků kódu Java rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak změnit podpisy Barcode ve vašem dokumentu Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je aktualizace podpisů Barcode umístěných v dokumentech Odp. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
