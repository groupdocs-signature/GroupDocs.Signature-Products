...
############################# Head ############################
head_title: "Atualize assinaturas Barcode colocadas em arquivos Ods com Java"
head_description: "Use o código Java simples e fácil para atualização de assinaturas Barcode em documentos Ods assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Barcode colocadas em arquivos Ods"
description: "A API para Java fornece funcionalidade para atualização de assinaturas Barcode em documentos Ods. Atualize assinaturas eletrônicas dentro de seus documentos Ods com algumas linhas de código Java de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis como atualização de Barcode assinaturas colocadas em documentos Ods. Possibilita alterar recursos de assinaturas sem código extra.
