...
############################# Head ############################
head_title: "Ots ファイルに配置された Barcode 署名を Java で更新します"
head_description: "署名済みの Ots ドキュメントの Barcode 署名の更新には、シンプルでわかりやすい Java コードを使用してください。"

############################# Header ############################
title: "Ots ファイルに配置された Barcode 署名の編集と更新"
description: "Java の API は、Ots ドキュメントで更新する Barcode 署名の機能を提供します。 Ots ドキュメント内の電子署名を数行の Java コードですばやく簡単に更新します。"
...
steps:
    enable: true
    title_left: "Ots ドキュメントの Barcode 署名を変更する方法"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) には、Ots ドキュメントに配置された Barcode 署名の更新などの便利な機能が含まれています。追加のコードなしで署名機能を変更できます。
