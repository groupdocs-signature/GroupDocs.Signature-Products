...
############################# Head ############################
head_title: "Qrcode parakstu pārbaude failiem 7z, izmantojot Java"
head_description: "Izmantojiet tikai dažas Java koda rindiņas, lai pārbaudītu 7z dokumentus un to Qrcode parakstus."

############################# Header ############################
title: "Qrcode parakstu pārbaude failiem 7z"
description: "Java API nodrošina iespēju pārbaudīt Qrcode parakstus 7z dokumentos. E-parakstu pārbaude jūsu 7z dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    enable: true
    title_left: "Kā pārbaudīt Qrcode parakstus savā 7z dokumentā"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ietver tādas noderīgas funkcijas kā Qrcode parakstu pārbaude, kas ievietoti 7z dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
...
demos:
    ...
    content: |
       Pievienojiet dažādus elektroniskos parakstus failam 7z tūlīt, apmeklējot vietni [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
