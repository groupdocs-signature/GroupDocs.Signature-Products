...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Xltx datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Xltx dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Xltx datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Xltx. Provjera e-potpisa unutar vaših Xltx dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Xltx dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Xltx. Iskoristite ovu priliku bez implementacije dodatnog koda.
