...
############################# Head ############################
head_title: "Qrcode allkirjade kontrollimine failide Xls jaoks läbi Java"
head_description: "Kasutage Xls dokumentide ja nende allkirjade Qrcode kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Qrcode allkirjade kontrollimine faili Xls jaoks"
description: "API for Java annab võimaluse kontrollida Qrcode allkirju Xls dokumentides. Teie Xls dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Kuidas kontrollida allkirja Qrcode oma dokumendis Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Qrcode allkirjade kontrollimine, mis on pandud dokumentidele Xls. Kasutage seda võimalust lisakoodi rakendamata.
