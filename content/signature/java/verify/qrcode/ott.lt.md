...
############################# Head ############################
head_title: "Qrcode failų Ott parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Ott dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas Ott failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Qrcode parašus Ott dokumentuose. El. parašų patvirtinimas jūsų Ott dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų Ott dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
