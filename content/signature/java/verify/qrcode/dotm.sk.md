...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Dotm cez Java"
head_description: "Na overenie dokumentov Dotm a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Dotm"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Dotm. Overenie elektronických podpisov vo vašich dokumentoch Dotm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Dotm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Dotm. Využite túto príležitosť bez implementácie dodatočného kódu.
