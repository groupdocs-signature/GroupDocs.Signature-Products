...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Ott filer via Java"
head_description: "Brug kun et par linjer med Java-kode til at bekræfte Ott-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Ott filer"
description: "API for Java giver mulighed for at bekræfte Qrcode-signaturer på Ott-dokumenter. Bekræftelse af e-signaturer i dine Ott-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Qrcode-signaturer i dit Ott-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Ott dokumenter. Brug denne mulighed uden at implementere ekstra kode.
