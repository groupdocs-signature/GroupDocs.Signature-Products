...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Pptm cez Java"
head_description: "Na overenie dokumentov Pptm a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Pptm"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Pptm. Overenie elektronických podpisov vo vašich dokumentoch Pptm môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Pptm. Využite túto príležitosť bez implementácie dodatočného kódu.
