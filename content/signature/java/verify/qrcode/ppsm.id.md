...
############################# Head ############################
head_title: "Verifikasi tanda tangan Qrcode untuk file Ppsm melalui Java"
head_description: "Gunakan hanya beberapa baris kode Java untuk memverifikasi dokumen Ppsm dan tanda tangan Qrcode mereka."

############################# Header ############################
title: "Qrcode verifikasi tanda tangan untuk file Ppsm"
description: "API untuk Java memberikan kesempatan untuk memverifikasi tanda tangan Qrcode pada dokumen Ppsm. Verifikasi tanda tangan elektronik di dalam dokumen Ppsm Anda dapat dilakukan dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Cara memvalidasi tanda tangan Qrcode di dokumen Ppsm Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyertakan fitur berguna seperti verifikasi tanda tangan Qrcode yang ditempatkan di dokumen Ppsm. Gunakan kesempatan ini tanpa menerapkan kode tambahan.
