...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Pdf datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Pdf dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Pdf datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Pdf. Provjera e-potpisa unutar vaših Pdf dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Pdf dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Pdf. Iskoristite ovu priliku bez implementacije dodatnog koda.
