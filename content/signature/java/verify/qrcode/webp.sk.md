...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Webp cez Java"
head_description: "Na overenie dokumentov Webp a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Webp"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Webp. Overenie elektronických podpisov vo vašich dokumentoch Webp môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Webp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Webp. Využite túto príležitosť bez implementácie dodatočného kódu.
