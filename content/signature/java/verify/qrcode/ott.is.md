...
############################# Head ############################
head_title: "Staðfesting á Qrcode undirskriftum fyrir Ott skrár í gegnum Java"
head_description: "Notaðu aðeins nokkrar línur af Java kóða til að staðfesta Ott skjöl og Qrcode undirskrift þeirra."

############################# Header ############################
title: "Qrcode staðfesting á undirskriftum fyrir Ott skrár"
description: "API fyrir Java veitir tækifæri til að staðfesta Qrcode undirskriftir á Ott skjölum. Staðfesting á rafrænum undirskriftum inni í Ott skjölunum þínum gæti verið framkvæmd fljótt og auðveldlega."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inniheldur gagnlega eiginleika eins og staðfestingu á Qrcode undirskriftum sem settar eru á Ott skjöl. Notaðu þetta tækifæri án þess að innleiða aukakóða.
