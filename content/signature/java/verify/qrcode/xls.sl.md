...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke Xls prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Xls in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke Xls"
description: "API za Java ponuja možnost preverjanja podpisov Qrcode v dokumentih Xls. Preverjanje e-podpisov v vaših Xls dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Qrcode v dokumentu Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih Xls. Izkoristite to priložnost brez implementacije dodatne kode.
