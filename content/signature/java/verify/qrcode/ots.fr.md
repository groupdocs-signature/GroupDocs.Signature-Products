...
############################# Head ############################
head_title: "Vérification des signatures Qrcode pour les fichiers Ots via Java"
head_description: "Utilisez seulement quelques lignes de code Java pour vérifier les documents Ots et leurs signatures Qrcode."

############################# Header ############################
title: "Vérification des signatures Qrcode pour les fichiers Ots"
description: "L'API pour Java offre la possibilité de vérifier les signatures Qrcode sur les documents Ots. La vérification des signatures électroniques dans vos documents Ots peut être effectuée rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment valider les signatures Qrcode dans votre document Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la vérification des signatures Qrcode placées sur les documents Ots. Utilisez cette opportunité sans implémenter de code supplémentaire.
