...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Odp cez Java"
head_description: "Na overenie dokumentov Odp a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Odp"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Odp. Overenie elektronických podpisov vo vašich dokumentoch Odp môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Odp. Využite túto príležitosť bez implementácie dodatočného kódu.
