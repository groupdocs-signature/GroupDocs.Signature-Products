...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Dotx datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Dotx dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Dotx datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Dotx. Provjera e-potpisa unutar vaših Dotx dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Dotx dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Dotx. Iskoristite ovu priliku bez implementacije dodatnog koda.
...
demos:
    ...
    content: |
       Odmah dodajte različite elektroničke potpise u datoteku Dotx tako da posjetite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web mjesto.          
