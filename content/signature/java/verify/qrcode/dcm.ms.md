...
############################# Head ############################
head_title: "Pengesahan tandatangan Qrcode untuk fail Dcm melalui Java"
head_description: "Gunakan hanya beberapa baris kod Java untuk mengesahkan dokumen Dcm dan tandatangan Qrcode mereka."

############################# Header ############################
title: "Qrcode pengesahan tandatangan untuk fail Dcm."
description: "API untuk Java memberi peluang untuk mengesahkan tandatangan Qrcode pada dokumen Dcm. Pengesahan e-tandatangan di dalam dokumen Dcm anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengesahkan tandatangan Qrcode dalam dokumen Dcm anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) termasuk ciri berguna seperti pengesahan tandatangan Qrcode yang diletakkan pada dokumen Dcm. Gunakan peluang ini tanpa melaksanakan kod tambahan.
...
demos:
    ...
    content: |
       Tambahkan pelbagai tandatangan elektronik pada fail Dcm sekarang dengan melawati tapak web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
