...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Ots datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Ots dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Ots datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Ots. Provjera e-potpisa unutar vaših Ots dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Ots dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Ots. Iskoristite ovu priliku bez implementacije dodatnog koda.
