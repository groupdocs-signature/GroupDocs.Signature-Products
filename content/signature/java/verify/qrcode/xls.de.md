...
############################# Head ############################
head_title: "Überprüfung von Qrcode-Signaturen für Xls-Dateien über Java"
head_description: "Verwenden Sie nur wenige Zeilen Java-Code, um Xls-Dokumente und ihre Qrcode-Signaturen zu überprüfen."

############################# Header ############################
title: "Qrcode-Signaturüberprüfung für Xls-Dateien"
description: "Die API für Java bietet die Möglichkeit, Qrcode-Signaturen bei Xls-Dokumenten zu überprüfen. Die Überprüfung elektronischer Signaturen in Ihren Xls-Dokumenten kann schnell und einfach durchgeführt werden."
...
steps:
    enable: true
    title_left: "So validieren Sie Qrcode-Signaturen in Ihrem Xls-Dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) enthält nützliche Funktionen wie die Überprüfung von Qrcode-Signaturen, die in Xls-Dokumenten platziert wurden. Nutzen Sie diese Gelegenheit, ohne zusätzlichen Code zu implementieren.
