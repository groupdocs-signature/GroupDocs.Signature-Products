...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Ppsm cez Java"
head_description: "Na overenie dokumentov Ppsm a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Ppsm"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Ppsm. Overenie elektronických podpisov vo vašich dokumentoch Ppsm môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Ppsm. Využite túto príležitosť bez implementácie dodatočného kódu.
