...
############################# Head ############################
head_title: "Qrcode failų Tar parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Tar dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas Tar failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Qrcode parašus Tar dokumentuose. El. parašų patvirtinimas jūsų Tar dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Qrcode parašus Tar dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų Tar dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
