...
############################# Head ############################
head_title: "Qrcode parakstu pārbaude failiem Ods, izmantojot Java"
head_description: "Izmantojiet tikai dažas Java koda rindiņas, lai pārbaudītu Ods dokumentus un to Qrcode parakstus."

############################# Header ############################
title: "Qrcode parakstu pārbaude failiem Ods"
description: "Java API nodrošina iespēju pārbaudīt Qrcode parakstus Ods dokumentos. E-parakstu pārbaude jūsu Ods dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    enable: true
    title_left: "Kā pārbaudīt Qrcode parakstus savā Ods dokumentā"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ietver tādas noderīgas funkcijas kā Qrcode parakstu pārbaude, kas ievietoti Ods dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
