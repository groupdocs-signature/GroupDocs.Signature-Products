...
############################# Head ############################
head_title: "Qrcode failų Odp parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Odp dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas Odp failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Qrcode parašus Odp dokumentuose. El. parašų patvirtinimas jūsų Odp dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Qrcode parašus Odp dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų Odp dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
...
demos:
    ...
    content: |
       Pridėkite įvairių elektroninių parašų prie Odp failo dabar, apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje.          
