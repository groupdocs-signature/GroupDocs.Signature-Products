...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Pptm przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Pptm i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Pptm"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Qrcode w dokumentach Pptm. Weryfikacja podpisów elektronicznych w dokumentach Pptm może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Pptm. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
