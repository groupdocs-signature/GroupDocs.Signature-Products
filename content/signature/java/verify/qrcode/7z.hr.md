...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za 7z datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru 7z dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za 7z datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima 7z. Provjera e-potpisa unutar vaših 7z dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem 7z dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente 7z. Iskoristite ovu priliku bez implementacije dodatnog koda.
