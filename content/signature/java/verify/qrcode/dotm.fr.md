...
############################# Head ############################
head_title: "Vérification des signatures Qrcode pour les fichiers Dotm via Java"
head_description: "Utilisez seulement quelques lignes de code Java pour vérifier les documents Dotm et leurs signatures Qrcode."

############################# Header ############################
title: "Vérification des signatures Qrcode pour les fichiers Dotm"
description: "L'API pour Java offre la possibilité de vérifier les signatures Qrcode sur les documents Dotm. La vérification des signatures électroniques dans vos documents Dotm peut être effectuée rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment valider les signatures Qrcode dans votre document Dotm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la vérification des signatures Qrcode placées sur les documents Dotm. Utilisez cette opportunité sans implémenter de code supplémentaire.
...
more_formats:
    enable: true
    title: "Vérifiez les autres signatures Qrcode à l'aide de Java"
    content: |
