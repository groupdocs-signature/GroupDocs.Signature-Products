...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Xlsm filer via Java"
head_description: "Brug kun et par linjer med Java-kode til at bekræfte Xlsm-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Xlsm filer"
description: "API for Java giver mulighed for at bekræfte Qrcode-signaturer på Xlsm-dokumenter. Bekræftelse af e-signaturer i dine Xlsm-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Qrcode-signaturer i dit Xlsm-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Xlsm dokumenter. Brug denne mulighed uden at implementere ekstra kode.
