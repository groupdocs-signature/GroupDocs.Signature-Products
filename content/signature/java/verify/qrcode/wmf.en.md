...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Wmf files in Java"
head_description: "Use only a few lines of Java code to verify Wmf documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Wmf files"
description: "API for Java provides opportunity to verify Qrcode signatures at Wmf documents. Verification of e-signatures inside your Wmf documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Qrcode signatures in your Wmf document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Qrcode signatures placed at Wmf documents. Use this opportunity without implementing extra code.
...
demos:
    ...
    content: |
       Add various electronic signatures to Wmf file right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.          
