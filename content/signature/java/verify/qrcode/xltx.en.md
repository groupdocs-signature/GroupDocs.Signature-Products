...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Xltx files in Java"
head_description: "Use only a few lines of Java code to verify Xltx documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Xltx files"
description: "API for Java provides opportunity to verify Qrcode signatures at Xltx documents. Verification of e-signatures inside your Xltx documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Qrcode signatures in your Xltx document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Qrcode signatures placed at Xltx documents. Use this opportunity without implementing extra code.
