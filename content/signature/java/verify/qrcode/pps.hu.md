...
############################# Head ############################
head_title: "A Qrcode aláírások ellenőrzése a Pps fájlokhoz a Java segítségével"
head_description: "Csak néhány sornyi Java kódot használjon a Pps dokumentumok és a hozzájuk tartozó Qrcode aláírások ellenőrzéséhez."

############################# Header ############################
title: "Qrcode aláírás ellenőrzése a Pps fájlokhoz"
description: "A(z) Java API lehetőséget biztosít a(z) Qrcode aláírások ellenőrzésére a(z) Pps dokumentumoknál. A Pps dokumentumaiban lévő e-aláírások ellenőrzése gyorsan és egyszerűen elvégezhető."
...
steps:
    enable: true
    title_left: "A Qrcode aláírások érvényesítése a Pps dokumentumban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) olyan hasznos funkciókat tartalmaz, mint a Qrcode aláírások ellenőrzése a Pps dokumentumokban. Használja ki ezt a lehetőséget extra kód alkalmazása nélkül.
