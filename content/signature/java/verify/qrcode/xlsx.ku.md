...
############################# Head ############################
head_title: "Verastkirina îmzeyên Qrcode ji bo pelên Xlsx bi rêya Java"
head_description: "Tenê çend rêzên koda Java bikar bînin da ku belgeyên Xlsx û îmzeyên wan ên Qrcode rast bikin."

############################# Header ############################
title: "Verastkirina îmzeyan ji bo pelên Qrcode"
description: "API ji bo Java firsendê dide ku hûn îmzeyên Qrcode li ser belgeyên Xlsx verast bikin. Verastkirina e-îmzeyan di hundirê belgeyên we yên {{Pelformat}} de dibe ku zû û bi hêsanî were kirin."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzeyên Qrcode di belgeya xweya Xlsx de rast bike"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) taybetmendîyên bikêrhatî yên wekî verastkirina îmzayên Qrcode yên ku li belgeyên Xlsx hatine danîn dihewîne. Vê derfetê bêyî pêkanîna kodek zêde bikar bînin.
...
demos:
    ...
    content: |
       Bi serdana malpera [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) aniha gelek îmzeyên elektronîkî li pelê Xlsx zêde bikin.          
