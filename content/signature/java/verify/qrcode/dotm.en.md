...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Dotm files in Java"
head_description: "Use only a few lines of Java code to verify Dotm documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Dotm files"
description: "API for Java provides opportunity to verify Qrcode signatures at Dotm documents. Verification of e-signatures inside your Dotm documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Qrcode signatures in your Dotm document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Qrcode signatures placed at Dotm documents. Use this opportunity without implementing extra code.
