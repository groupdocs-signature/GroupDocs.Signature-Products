...
############################# Head ############################
head_title: "通过 Java 验证 Xltm 文件的 Qrcode 签名"
...
steps:
    enable: true
    title_left: "如何验证 Xltm 文档中的 Qrcode 签名"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) 包括有用的功能，例如验证放置在 Xltm 文档中的 Qrcode 签名。利用这个机会，无需实现额外的代码。
