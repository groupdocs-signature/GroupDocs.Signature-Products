...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Docm datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Docm dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Docm datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Docm. Provjera e-potpisa unutar vaših Docm dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Docm. Iskoristite ovu priliku bez implementacije dodatnog koda.
