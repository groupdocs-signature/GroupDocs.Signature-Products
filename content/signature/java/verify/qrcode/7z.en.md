...
############################# Head ############################
head_title: "Verification of Qrcode signatures for 7z files via Java"
head_description: "Use only a few lines of Java code to verify 7z documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for 7z files"
description: "API for Java provides opportunity to verify Qrcode signatures at 7z documents. Verification of e-signatures inside your 7z documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like verification of Qrcode signatures placed at 7z documents. Use this opportunity without implementing extra code.
