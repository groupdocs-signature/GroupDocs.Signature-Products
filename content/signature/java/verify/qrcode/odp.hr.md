...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Odp datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Odp dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Odp datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Odp. Provjera e-potpisa unutar vaših Odp dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Odp dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Odp. Iskoristite ovu priliku bez implementacije dodatnog koda.
...
demos:
    ...
    content: |
       Odmah dodajte različite elektroničke potpise u datoteku Odp tako da posjetite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web mjesto.          
