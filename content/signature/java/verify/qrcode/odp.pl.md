...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Odp przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Odp i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Odp"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Qrcode w dokumentach Odp. Weryfikacja podpisów elektronicznych w dokumentach Odp może być przeprowadzona szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zweryfikować podpisy Qrcode w dokumencie Odp?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Odp. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
