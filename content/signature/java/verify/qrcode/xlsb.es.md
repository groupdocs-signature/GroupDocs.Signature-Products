...
############################# Head ############################
head_title: "Verificación de Qrcode firmas para Xlsb archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Xlsb y sus firmas Qrcode."

############################# Header ############################
title: "Qrcode verificación de firmas para Xlsb archivos"
description: "La API para Java brinda la oportunidad de verificar Qrcode firmas en Xlsb documentos. La verificación de las firmas electrónicas dentro de sus documentos Xlsb se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Qrcode firmas colocadas en Xlsb documentos. Aproveche esta oportunidad sin implementar código adicional.
