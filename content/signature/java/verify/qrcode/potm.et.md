...
############################# Head ############################
head_title: "Qrcode allkirjade kontrollimine failide Potm jaoks läbi Java"
head_description: "Kasutage Potm dokumentide ja nende allkirjade Qrcode kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Qrcode allkirjade kontrollimine faili Potm jaoks"
description: "API for Java annab võimaluse kontrollida Qrcode allkirju Potm dokumentides. Teie Potm dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Kuidas kontrollida allkirja Qrcode oma dokumendis Potm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Qrcode allkirjade kontrollimine, mis on pandud dokumentidele Potm. Kasutage seda võimalust lisakoodi rakendamata.
