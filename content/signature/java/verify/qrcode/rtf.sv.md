...
############################# Head ############################
head_title: "Verifiering av Qrcode-signaturer för Rtf-filer via Java"
head_description: "Använd bara några rader med Java-kod för att verifiera Rtf-dokument och deras Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturverifiering för Rtf-filer"
description: "API för Java ger möjlighet att verifiera Qrcode-signaturer i Rtf-dokument. Verifiering av e-signaturer i dina Rtf-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Qrcode-signaturer i ditt Rtf-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som verifiering av Qrcode-signaturer placerade i Rtf-dokument. Använd denna möjlighet utan att implementera extra kod.
