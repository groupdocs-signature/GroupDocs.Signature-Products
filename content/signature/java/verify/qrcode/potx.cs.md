...
############################# Head ############################
head_title: "Ověření podpisů Qrcode pro soubory Potx prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Potx a jejich podpisů Qrcode."

############################# Header ############################
title: "Ověření podpisů Qrcode pro soubory Potx"
description: "API pro Java poskytuje příležitost ověřit podpisy Qrcode v dokumentech Potx. Ověření elektronických podpisů ve vašich dokumentech Potx může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Qrcode ve vašem dokumentu Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Qrcode umístěných v dokumentech Potx. Využijte tuto příležitost bez implementace dalšího kódu.
