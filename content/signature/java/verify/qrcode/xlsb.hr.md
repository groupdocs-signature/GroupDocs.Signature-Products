...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Xlsb datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Xlsb dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Xlsb datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Xlsb. Provjera e-potpisa unutar vaših Xlsb dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Xlsb dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Xlsb. Iskoristite ovu priliku bez implementacije dodatnog koda.
