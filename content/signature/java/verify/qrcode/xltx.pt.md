...
############################# Head ############################
head_title: "Verificação de assinaturas Qrcode para arquivos Xltx via Java"
head_description: "Use apenas algumas linhas de código Java para verificar documentos Xltx e suas assinaturas Qrcode."

############################# Header ############################
title: "Qrcode verificação de assinaturas para Xltx arquivos"
description: "A API para Java oferece a oportunidade de verificar assinaturas Qrcode em documentos Xltx. A verificação de assinaturas eletrônicas dentro de seus documentos Xltx pode ser realizada de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como validar assinaturas Qrcode em seu documento Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis, como verificação de Qrcode assinaturas colocadas em documentos Xltx. Use esta oportunidade sem implementar código extra.
