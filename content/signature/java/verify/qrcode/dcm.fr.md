...
############################# Head ############################
head_title: "Vérification des signatures Qrcode pour les fichiers Dcm via Java"
head_description: "Utilisez seulement quelques lignes de code Java pour vérifier les documents Dcm et leurs signatures Qrcode."

############################# Header ############################
title: "Vérification des signatures Qrcode pour les fichiers Dcm"
description: "L'API pour Java offre la possibilité de vérifier les signatures Qrcode sur les documents Dcm. La vérification des signatures électroniques dans vos documents Dcm peut être effectuée rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment valider les signatures Qrcode dans votre document Dcm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la vérification des signatures Qrcode placées sur les documents Dcm. Utilisez cette opportunité sans implémenter de code supplémentaire.
...
demos:
    ...
    content: |
       Ajoutez dès maintenant diverses signatures électroniques au fichier Dcm en visitant le site Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
