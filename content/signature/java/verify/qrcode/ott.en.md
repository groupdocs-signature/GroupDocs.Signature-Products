...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Ott files in Java"
head_description: "Use only a few lines of Java code to verify Ott documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Ott files"
description: "API for Java provides opportunity to verify Qrcode signatures at Ott documents. Verification of e-signatures inside your Ott documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Qrcode signatures placed at Ott documents. Use this opportunity without implementing extra code.
