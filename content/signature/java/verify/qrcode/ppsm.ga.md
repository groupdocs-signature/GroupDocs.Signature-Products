...
############################# Head ############################
head_title: "Fíorú Qrcode sínithe do chomhaid Ppsm trí Java"
head_description: "Ná húsáid ach cúpla líne de chód Java chun doiciméid Ppsm agus a gcuid sínithe Qrcode a fhíorú."

############################# Header ############################
title: "Qrcode fíorú sínithe le haghaidh comhad Ppsm"
description: "Soláthraíonn API do Java deis chun Qrcode sínithe ag Ppsm doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Ppsm a fhíorú go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Qrcode sínithe i do dhoiciméad Ppsm a bhailíochtú"
    content_left: |
        Áiríonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gnéithe úsáideacha amhail fíorú Qrcode sínithe atá curtha ag Ppsm doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
