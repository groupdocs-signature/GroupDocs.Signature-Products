...
############################# Head ############################
head_title: "Verifikasie van Qrcode handtekeninge vir Dcm lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Dcm-dokumente en hul Qrcode-handtekeninge te verifieer."

############################# Header ############################
title: "Qrcode handtekeningverifikasie vir Dcm lêers"
description: "API vir Java bied geleentheid om Qrcode handtekeninge by Dcm dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Dcm dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Qrcode-handtekeninge wat by Dcm-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
