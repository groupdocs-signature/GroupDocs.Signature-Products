...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke Pps prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Pps in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke Pps"
description: "API za Java ponuja možnost preverjanja podpisov Qrcode v dokumentih Pps. Preverjanje e-podpisov v vaših Pps dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Qrcode v dokumentu Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih Pps. Izkoristite to priložnost brez implementacije dodatne kode.
