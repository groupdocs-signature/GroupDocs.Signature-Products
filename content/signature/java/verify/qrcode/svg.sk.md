...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Svg cez Java"
head_description: "Na overenie dokumentov Svg a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Svg"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Svg. Overenie elektronických podpisov vo vašich dokumentoch Svg môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Svg. Využite túto príležitosť bez implementácie dodatočného kódu.
