...
############################# Header ############################
title: "Qrcode signaturbekræftelse for Doc filer"
description: "API for Java giver mulighed for at bekræfte Qrcode-signaturer på Doc-dokumenter. Bekræftelse af e-signaturer i dine Doc-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Qrcode-signaturer i dit Doc-dokument"
    content_left: |
