...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Ppsm files in Java"
head_description: "Use only a few lines of Java code to verify Ppsm documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Ppsm files"
description: "API for Java provides opportunity to verify Qrcode signatures at Ppsm documents. Verification of e-signatures inside your Ppsm documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Qrcode signatures in your Ppsm document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Qrcode signatures placed at Ppsm documents. Use this opportunity without implementing extra code.
