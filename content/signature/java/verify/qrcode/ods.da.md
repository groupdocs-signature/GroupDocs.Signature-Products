...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Ods filer via Java"
head_description: "Brug kun et par linjer med Java-kode til at bekræfte Ods-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Ods filer"
description: "API for Java giver mulighed for at bekræfte Qrcode-signaturer på Ods-dokumenter. Bekræftelse af e-signaturer i dine Ods-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Qrcode-signaturer i dit Ods-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Ods dokumenter. Brug denne mulighed uden at implementere ekstra kode.
