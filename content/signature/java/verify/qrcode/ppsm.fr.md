...
############################# Head ############################
head_title: "Vérification des signatures Qrcode pour les fichiers Ppsm via Java"
head_description: "Utilisez seulement quelques lignes de code Java pour vérifier les documents Ppsm et leurs signatures Qrcode."

############################# Header ############################
title: "Vérification des signatures Qrcode pour les fichiers Ppsm"
description: "L'API pour Java offre la possibilité de vérifier les signatures Qrcode sur les documents Ppsm. La vérification des signatures électroniques dans vos documents Ppsm peut être effectuée rapidement et facilement."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la vérification des signatures Qrcode placées sur les documents Ppsm. Utilisez cette opportunité sans implémenter de code supplémentaire.
