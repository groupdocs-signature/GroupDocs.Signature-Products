...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Ots files in Java"
head_description: "Use only a few lines of Java code to verify Ots documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Ots files"
description: "API for Java provides opportunity to verify Qrcode signatures at Ots documents. Verification of e-signatures inside your Ots documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Qrcode signatures in your Ots document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Qrcode signatures placed at Ots documents. Use this opportunity without implementing extra code.
