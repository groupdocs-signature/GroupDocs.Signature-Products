...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Tiff datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Tiff dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Tiff datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Tiff. Provjera e-potpisa unutar vaših Tiff dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Tiff dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Tiff. Iskoristite ovu priliku bez implementacije dodatnog koda.
