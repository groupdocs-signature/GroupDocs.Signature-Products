...
############################# Head ############################
head_title: "Verastkirina îmzeyên Qrcode ji bo pelên Otp bi rêya Java"
head_description: "Tenê çend rêzên koda Java bikar bînin da ku belgeyên Otp û îmzeyên wan ên Qrcode rast bikin."

############################# Header ############################
title: "Verastkirina îmzeyan ji bo pelên Qrcode"
description: "API ji bo Java firsendê dide ku hûn îmzeyên Qrcode li ser belgeyên Otp verast bikin. Verastkirina e-îmzeyan di hundirê belgeyên we yên {{Pelformat}} de dibe ku zû û bi hêsanî were kirin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) taybetmendîyên bikêrhatî yên wekî verastkirina îmzayên Qrcode yên ku li belgeyên Otp hatine danîn dihewîne. Vê derfetê bêyî pêkanîna kodek zêde bikar bînin.
