...
############################# Head ############################
head_title: "Qrcode failų Ppsm parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Ppsm dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas Ppsm failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Qrcode parašus Ppsm dokumentuose. El. parašų patvirtinimas jūsų Ppsm dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų Ppsm dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
