...
############################# Head ############################
head_title: "Verificação de assinaturas Qrcode para arquivos 7z via Java"
head_description: "Use apenas algumas linhas de código Java para verificar documentos 7z e suas assinaturas Qrcode."

############################# Header ############################
title: "Qrcode verificação de assinaturas para 7z arquivos"
description: "A API para Java oferece a oportunidade de verificar assinaturas Qrcode em documentos 7z. A verificação de assinaturas eletrônicas dentro de seus documentos 7z pode ser realizada de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como validar assinaturas Qrcode em seu documento 7z"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis, como verificação de Qrcode assinaturas colocadas em documentos 7z. Use esta oportunidade sem implementar código extra.
