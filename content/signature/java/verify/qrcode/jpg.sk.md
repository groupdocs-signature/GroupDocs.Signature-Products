...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Jpg cez Java"
head_description: "Na overenie dokumentov Jpg a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Jpg"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Jpg. Overenie elektronických podpisov vo vašich dokumentoch Jpg môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Jpg"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Jpg. Využite túto príležitosť bez implementácie dodatočného kódu.
