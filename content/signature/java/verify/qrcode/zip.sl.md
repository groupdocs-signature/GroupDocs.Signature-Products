...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke Zip prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Zip in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke Zip"
description: "API za Java ponuja možnost preverjanja podpisov Qrcode v dokumentih Zip. Preverjanje e-podpisov v vaših Zip dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Qrcode v dokumentu Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih Zip. Izkoristite to priložnost brez implementacije dodatne kode.
