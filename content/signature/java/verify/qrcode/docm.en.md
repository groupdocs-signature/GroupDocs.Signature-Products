...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Docm files in Java"
head_description: "Use only a few lines of Java code to verify Docm documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Docm files"
description: "API for Java provides opportunity to verify Qrcode signatures at Docm documents. Verification of e-signatures inside your Docm documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Qrcode signatures in your Docm document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Qrcode signatures placed at Docm documents. Use this opportunity without implementing extra code.
