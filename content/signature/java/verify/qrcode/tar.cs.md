...
############################# Head ############################
head_title: "Ověření podpisů Qrcode pro soubory Tar prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Tar a jejich podpisů Qrcode."

############################# Header ############################
title: "Ověření podpisů Qrcode pro soubory Tar"
description: "API pro Java poskytuje příležitost ověřit podpisy Qrcode v dokumentech Tar. Ověření elektronických podpisů ve vašich dokumentech Tar může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Qrcode ve vašem dokumentu Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Qrcode umístěných v dokumentech Tar. Využijte tuto příležitost bez implementace dalšího kódu.
