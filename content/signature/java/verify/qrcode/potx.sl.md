...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke Potx prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Potx in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke Potx"
description: "API za Java ponuja možnost preverjanja podpisov Qrcode v dokumentih Potx. Preverjanje e-podpisov v vaših Potx dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Qrcode v dokumentu Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih Potx. Izkoristite to priložnost brez implementacije dodatne kode.
