...
############################# Head ############################
head_title: "Ott dosyaları için Qrcode imzalarının Java aracılığıyla doğrulanması"
head_description: "Ott belgelerini ve bunların Qrcode imzalarını doğrulamak için yalnızca birkaç satır Java kodu kullanın."

############################# Header ############################
title: "Ott dosyaları için Qrcode imza doğrulaması"
description: "Java için API, Ott belgelerinde Qrcode imzalarını doğrulama fırsatı sunar. Ott belgelerinizdeki e-imzaların doğrulanması hızlı ve kolay bir şekilde gerçekleştirilebilir."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Ott belgelerine yerleştirilen Qrcode imzalarının doğrulanması gibi faydalı özellikler içerir. Ekstra kod uygulamadan bu fırsatı kullanın.
