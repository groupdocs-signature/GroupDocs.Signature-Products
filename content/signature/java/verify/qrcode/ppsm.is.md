...
############################# Head ############################
head_title: "Staðfesting á Qrcode undirskriftum fyrir Ppsm skrár í gegnum Java"
head_description: "Notaðu aðeins nokkrar línur af Java kóða til að staðfesta Ppsm skjöl og Qrcode undirskrift þeirra."

############################# Header ############################
title: "Qrcode staðfesting á undirskriftum fyrir Ppsm skrár"
description: "API fyrir Java veitir tækifæri til að staðfesta Qrcode undirskriftir á Ppsm skjölum. Staðfesting á rafrænum undirskriftum inni í Ppsm skjölunum þínum gæti verið framkvæmd fljótt og auðveldlega."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inniheldur gagnlega eiginleika eins og staðfestingu á Qrcode undirskriftum sem settar eru á Ppsm skjöl. Notaðu þetta tækifæri án þess að innleiða aukakóða.
