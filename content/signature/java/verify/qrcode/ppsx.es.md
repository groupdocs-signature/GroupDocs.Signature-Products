...
############################# Head ############################
head_title: "Verificación de Qrcode firmas para Ppsx archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Ppsx y sus firmas Qrcode."

############################# Header ############################
title: "Qrcode verificación de firmas para Ppsx archivos"
description: "La API para Java brinda la oportunidad de verificar Qrcode firmas en Ppsx documentos. La verificación de las firmas electrónicas dentro de sus documentos Ppsx se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Qrcode firmas en su documento Ppsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Qrcode firmas colocadas en Ppsx documentos. Aproveche esta oportunidad sin implementar código adicional.
