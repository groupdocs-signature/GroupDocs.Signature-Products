...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke Tiff prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Tiff in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke Tiff"
description: "API za Java ponuja možnost preverjanja podpisov Qrcode v dokumentih Tiff. Preverjanje e-podpisov v vaših Tiff dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Qrcode v dokumentu Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih Tiff. Izkoristite to priložnost brez implementacije dodatne kode.
