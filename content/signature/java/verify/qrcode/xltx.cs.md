...
############################# Head ############################
head_title: "Ověření podpisů Qrcode pro soubory Xltx prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Xltx a jejich podpisů Qrcode."

############################# Header ############################
title: "Ověření podpisů Qrcode pro soubory Xltx"
description: "API pro Java poskytuje příležitost ověřit podpisy Qrcode v dokumentech Xltx. Ověření elektronických podpisů ve vašich dokumentech Xltx může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Qrcode ve vašem dokumentu Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Qrcode umístěných v dokumentech Xltx. Využijte tuto příležitost bez implementace dalšího kódu.
