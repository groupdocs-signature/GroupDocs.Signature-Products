...
############################# Head ############################
head_title: "Ověření podpisů Qrcode pro soubory Dotx prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Dotx a jejich podpisů Qrcode."

############################# Header ############################
title: "Ověření podpisů Qrcode pro soubory Dotx"
description: "API pro Java poskytuje příležitost ověřit podpisy Qrcode v dokumentech Dotx. Ověření elektronických podpisů ve vašich dokumentech Dotx může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Qrcode ve vašem dokumentu Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Qrcode umístěných v dokumentech Dotx. Využijte tuto příležitost bez implementace dalšího kódu.
