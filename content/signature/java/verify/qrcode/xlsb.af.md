...
############################# Head ############################
head_title: "Verifikasie van Qrcode handtekeninge vir Xlsb lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Xlsb-dokumente en hul Qrcode-handtekeninge te verifieer."

############################# Header ############################
title: "Qrcode handtekeningverifikasie vir Xlsb lêers"
description: "API vir Java bied geleentheid om Qrcode handtekeninge by Xlsb dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Xlsb dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    enable: true
    title_left: "Hoe om Qrcode handtekeninge in jou Xlsb dokument te bekragtig"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Qrcode-handtekeninge wat by Xlsb-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
