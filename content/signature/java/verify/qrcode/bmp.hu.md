...
############################# Head ############################
head_title: "A Qrcode aláírások ellenőrzése a Bmp fájlokhoz a Java segítségével"
head_description: "Csak néhány sornyi Java kódot használjon a Bmp dokumentumok és a hozzájuk tartozó Qrcode aláírások ellenőrzéséhez."

############################# Header ############################
title: "Qrcode aláírás ellenőrzése a Bmp fájlokhoz"
description: "A(z) Java API lehetőséget biztosít a(z) Qrcode aláírások ellenőrzésére a(z) Bmp dokumentumoknál. A Bmp dokumentumaiban lévő e-aláírások ellenőrzése gyorsan és egyszerűen elvégezhető."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) olyan hasznos funkciókat tartalmaz, mint a Qrcode aláírások ellenőrzése a Bmp dokumentumokban. Használja ki ezt a lehetőséget extra kód alkalmazása nélkül.
