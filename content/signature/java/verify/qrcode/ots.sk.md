...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Ots cez Java"
head_description: "Na overenie dokumentov Ots a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Ots"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Ots. Overenie elektronických podpisov vo vašich dokumentoch Ots môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Ots. Využite túto príležitosť bez implementácie dodatočného kódu.
