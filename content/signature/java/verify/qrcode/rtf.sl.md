...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke Rtf prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Rtf in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke Rtf"
description: "API za Java ponuja možnost preverjanja podpisov Qrcode v dokumentih Rtf. Preverjanje e-podpisov v vaših Rtf dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Qrcode v dokumentu Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih Rtf. Izkoristite to priložnost brez implementacije dodatne kode.
...
demos:
    ...
    content: |
       Takoj dodajte različne elektronske podpise v datoteko Rtf tako, da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
