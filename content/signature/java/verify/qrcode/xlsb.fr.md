...
############################# Head ############################
head_title: "Vérification des signatures Qrcode pour les fichiers Xlsb via Java"
head_description: "Utilisez seulement quelques lignes de code Java pour vérifier les documents Xlsb et leurs signatures Qrcode."

############################# Header ############################
title: "Vérification des signatures Qrcode pour les fichiers Xlsb"
description: "L'API pour Java offre la possibilité de vérifier les signatures Qrcode sur les documents Xlsb. La vérification des signatures électroniques dans vos documents Xlsb peut être effectuée rapidement et facilement."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la vérification des signatures Qrcode placées sur les documents Xlsb. Utilisez cette opportunité sans implémenter de code supplémentaire.
