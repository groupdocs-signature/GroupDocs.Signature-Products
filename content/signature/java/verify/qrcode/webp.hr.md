...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Webp datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Webp dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Webp datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Webp. Provjera e-potpisa unutar vaših Webp dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Webp. Iskoristite ovu priliku bez implementacije dodatnog koda.
