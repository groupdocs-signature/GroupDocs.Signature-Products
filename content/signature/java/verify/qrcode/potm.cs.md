...
############################# Head ############################
head_title: "Ověření podpisů Qrcode pro soubory Potm prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Potm a jejich podpisů Qrcode."

############################# Header ############################
title: "Ověření podpisů Qrcode pro soubory Potm"
description: "API pro Java poskytuje příležitost ověřit podpisy Qrcode v dokumentech Potm. Ověření elektronických podpisů ve vašich dokumentech Potm může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Qrcode ve vašem dokumentu Potm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Qrcode umístěných v dokumentech Potm. Využijte tuto příležitost bez implementace dalšího kódu.
