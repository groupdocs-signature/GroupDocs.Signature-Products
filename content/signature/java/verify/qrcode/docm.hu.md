...
############################# Head ############################
head_title: "A Qrcode aláírások ellenőrzése a Docm fájlokhoz a Java segítségével"
head_description: "Csak néhány sornyi Java kódot használjon a Docm dokumentumok és a hozzájuk tartozó Qrcode aláírások ellenőrzéséhez."

############################# Header ############################
title: "Qrcode aláírás ellenőrzése a Docm fájlokhoz"
description: "A(z) Java API lehetőséget biztosít a(z) Qrcode aláírások ellenőrzésére a(z) Docm dokumentumoknál. A Docm dokumentumaiban lévő e-aláírások ellenőrzése gyorsan és egyszerűen elvégezhető."
...
steps:
    enable: true
    title_left: "A Qrcode aláírások érvényesítése a Docm dokumentumban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) olyan hasznos funkciókat tartalmaz, mint a Qrcode aláírások ellenőrzése a Docm dokumentumokban. Használja ki ezt a lehetőséget extra kód alkalmazása nélkül.
...
demos:
    ...
    content: |
       A [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webhely meglátogatásával azonnal adjon hozzá különféle elektronikus aláírásokat a Docm fájlhoz.          
