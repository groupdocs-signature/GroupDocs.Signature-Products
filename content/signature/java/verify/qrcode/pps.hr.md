...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Pps datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Pps dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Pps datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Pps. Provjera e-potpisa unutar vaših Pps dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Pps. Iskoristite ovu priliku bez implementacije dodatnog koda.
