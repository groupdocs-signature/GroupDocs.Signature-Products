...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Doc datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Doc dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Doc datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Doc. Provjera e-potpisa unutar vaših Doc dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Doc dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Doc. Iskoristite ovu priliku bez implementacije dodatnog koda.
