...
############################# Head ############################
head_title: "Qrcode allkirjade kontrollimine failide Doc jaoks läbi Java"
head_description: "Kasutage Doc dokumentide ja nende allkirjade Qrcode kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Qrcode allkirjade kontrollimine faili Doc jaoks"
description: "API for Java annab võimaluse kontrollida Qrcode allkirju Doc dokumentides. Teie Doc dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Kuidas kontrollida allkirja Qrcode oma dokumendis Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Qrcode allkirjade kontrollimine, mis on pandud dokumentidele Doc. Kasutage seda võimalust lisakoodi rakendamata.
