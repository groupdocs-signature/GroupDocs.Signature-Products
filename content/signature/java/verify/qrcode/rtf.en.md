...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Rtf files in Java"
head_description: "Use only a few lines of Java code to verify Rtf documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Rtf files"
description: "API for Java provides opportunity to verify Qrcode signatures at Rtf documents. Verification of e-signatures inside your Rtf documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Qrcode signatures placed at Rtf documents. Use this opportunity without implementing extra code.
