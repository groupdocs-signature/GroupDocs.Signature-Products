...
############################# Head ############################
head_title: "Xác minh chữ ký Qrcode cho tệp Ppsx qua Java"
head_description: "Chỉ sử dụng một vài dòng mã Java để xác minh tài liệu Ppsx và chữ ký Qrcode của chúng."

############################# Header ############################
title: "Xác minh chữ ký Qrcode cho các tệp Ppsx"
description: "API cho Java cung cấp cơ hội xác minh chữ ký Qrcode tại tài liệu Ppsx. Việc xác minh chữ ký điện tử bên trong tài liệu Ppsx của bạn có thể được thực hiện nhanh chóng và dễ dàng."
...
steps:
    enable: true
    title_left: "Cách xác thực chữ ký Qrcode trong tài liệu Ppsx của bạn"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) bao gồm các tính năng hữu ích như xác minh chữ ký Qrcode được đặt trong tài liệu Ppsx. Sử dụng cơ hội này mà không cần triển khai thêm mã.
