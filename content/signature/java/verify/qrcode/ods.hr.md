...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Ods datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Ods dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Ods datoteke"
description: "API za Java pruža priliku za provjeru potpisa Qrcode u dokumentima Ods. Provjera e-potpisa unutar vaših Ods dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Ods. Iskoristite ovu priliku bez implementacije dodatnog koda.
