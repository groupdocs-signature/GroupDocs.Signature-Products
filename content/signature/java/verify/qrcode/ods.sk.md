...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Ods cez Java"
head_description: "Na overenie dokumentov Ods a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Ods"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Ods. Overenie elektronických podpisov vo vašich dokumentoch Ods môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Ods. Využite túto príležitosť bez implementácie dodatočného kódu.
