...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Tiff cez Java"
head_description: "Na overenie dokumentov Tiff a ich podpisov Qrcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Tiff"
description: "API pre Java poskytuje možnosť overiť podpisy Qrcode v dokumentoch Tiff. Overenie elektronických podpisov vo vašich dokumentoch Tiff môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Tiff. Využite túto príležitosť bez implementácie dodatočného kódu.
