...
############################# Head ############################
head_title: "Text failų Xlsb parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Xlsb dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Xlsb failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Text parašus Xlsb dokumentuose. El. parašų patvirtinimas jūsų Xlsb dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Text parašus Xlsb dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Xlsb dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
