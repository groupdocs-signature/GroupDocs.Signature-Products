...
############################# Head ############################
head_title: "Verificación de Text firmas para Doc archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Doc y sus firmas Text."

############################# Header ############################
title: "Text verificación de firmas para Doc archivos"
description: "La API para Java brinda la oportunidad de verificar Text firmas en Doc documentos. La verificación de las firmas electrónicas dentro de sus documentos Doc se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Text firmas en su documento Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Text firmas colocadas en Doc documentos. Aproveche esta oportunidad sin implementar código adicional.
