...
############################# Head ############################
head_title: "Verifikasi tanda tangan Text untuk file Odp melalui Java"
head_description: "Gunakan hanya beberapa baris kode Java untuk memverifikasi dokumen Odp dan tanda tangan Text mereka."

############################# Header ############################
title: "Text verifikasi tanda tangan untuk file Odp"
description: "API untuk Java memberikan kesempatan untuk memverifikasi tanda tangan Text pada dokumen Odp. Verifikasi tanda tangan elektronik di dalam dokumen Odp Anda dapat dilakukan dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Cara memvalidasi tanda tangan Text di dokumen Odp Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyertakan fitur berguna seperti verifikasi tanda tangan Text yang ditempatkan di dokumen Odp. Gunakan kesempatan ini tanpa menerapkan kode tambahan.
