...
############################# Head ############################
head_title: "Text failų Csv parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Csv dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Csv failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Text parašus Csv dokumentuose. El. parašų patvirtinimas jūsų Csv dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Text parašus Csv dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Csv dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
