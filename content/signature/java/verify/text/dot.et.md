...
############################# Head ############################
head_title: "Text allkirjade kontrollimine failide Dot jaoks läbi Java"
head_description: "Kasutage Dot dokumentide ja nende allkirjade Text kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Text allkirjade kontrollimine faili Dot jaoks"
description: "API for Java annab võimaluse kontrollida Text allkirju Dot dokumentides. Teie Dot dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Kuidas kontrollida allkirja Text oma dokumendis Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Text allkirjade kontrollimine, mis on pandud dokumentidele Dot. Kasutage seda võimalust lisakoodi rakendamata.
