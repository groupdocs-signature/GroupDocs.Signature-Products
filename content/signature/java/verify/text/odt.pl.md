...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Odt przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Odt i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Odt"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Text w dokumentach Odt. Weryfikacja podpisów elektronicznych w dokumentach Odt może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Odt. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
