...
############################# Head ############################
head_title: "Bekreftelse av Text signaturer for 7z filer via Java"
head_description: "Bruk bare noen få linjer med Java-kode for å bekrefte 7z-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekreftelse for 7z-filer"
description: "API for Java gir mulighet til å bekrefte Text-signaturer i 7z-dokumenter. Verifisering av e-signaturer i 7z-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funksjoner som bekreftelse av Text-signaturer plassert på 7z-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
