...
############################# Head ############################
head_title: "Verifikasie van Text handtekeninge vir Ppsm lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Ppsm-dokumente en hul Text-handtekeninge te verifieer."

############################# Header ############################
title: "Text handtekeningverifikasie vir Ppsm lêers"
description: "API vir Java bied geleentheid om Text handtekeninge by Ppsm dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Ppsm dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Text-handtekeninge wat by Ppsm-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
