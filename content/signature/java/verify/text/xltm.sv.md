...
############################# Head ############################
head_title: "Verifiering av Text-signaturer för Xltm-filer via Java"
head_description: "Använd bara några rader med Java-kod för att verifiera Xltm-dokument och deras Text-signaturer."

############################# Header ############################
title: "Text signaturverifiering för {{Filformat}}-filer"
description: "API för Java ger möjlighet att verifiera Text-signaturer i Xltm-dokument. Verifiering av e-signaturer i dina {{Filformat}}-dokument kan utföras snabbt och enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som verifiering av Text-signaturer placerade i Xltm-dokument. Använd denna möjlighet utan att implementera extra kod.
