...
description: "API vir Java bied geleentheid om Text handtekeninge by Ott dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Ott dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Text-handtekeninge wat by Ott-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
