...
############################# Head ############################
head_title: "Verifikasie van Text handtekeninge vir Ott lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Ott-dokumente en hul Text-handtekeninge te verifieer."

############################# Header ############################
title: "Text handtekeningverifikasie vir {{Lêerformaat}} lêers"
description: "API vir Java bied geleentheid om Text handtekeninge by Ott dokumente te verifieer. Verifikasie van e-handtekeninge binne jou {{Lêerformaat}} dokumente kan vinnig en maklik uitgevoer word."
