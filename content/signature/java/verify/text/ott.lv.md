...
############################# Head ############################
head_title: "Text parakstu pārbaude failiem Ott, izmantojot Java"
head_description: "Izmantojiet tikai dažas Java koda rindiņas, lai pārbaudītu Ott dokumentus un to Text parakstus."

############################# Header ############################
title: "Text parakstu pārbaude failiem Ott"
description: "Java API nodrošina iespēju pārbaudīt Text parakstus Ott dokumentos. E-parakstu pārbaude jūsu Ott dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ietver tādas noderīgas funkcijas kā Text parakstu pārbaude, kas ievietoti Ott dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
