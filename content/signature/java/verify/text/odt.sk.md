...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Odt cez Java"
head_description: "Na overenie dokumentov Odt a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Odt"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Odt. Overenie elektronických podpisov vo vašich dokumentoch Odt môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Odt. Využite túto príležitosť bez implementácie dodatočného kódu.
