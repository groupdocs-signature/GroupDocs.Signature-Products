...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Otp cez Java"
head_description: "Na overenie dokumentov Otp a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Otp"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Otp. Overenie elektronických podpisov vo vašich dokumentoch Otp môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Text vo vašom dokumente Otp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Otp. Využite túto príležitosť bez implementácie dodatočného kódu.
