...
############################# Head ############################
head_title: "Text failų Pptx parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Pptx dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Pptx failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Text parašus Pptx dokumentuose. El. parašų patvirtinimas jūsų Pptx dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Text parašus Pptx dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Pptx dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
