...
############################# Head ############################
head_title: "Pengesahan tandatangan Text untuk fail Ods melalui Java"
head_description: "Gunakan hanya beberapa baris kod Java untuk mengesahkan dokumen Ods dan tandatangan Text mereka."

############################# Header ############################
title: "Text pengesahan tandatangan untuk fail Ods."
description: "API untuk Java memberi peluang untuk mengesahkan tandatangan Text pada dokumen Ods. Pengesahan e-tandatangan di dalam dokumen Ods anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) termasuk ciri berguna seperti pengesahan tandatangan Text yang diletakkan pada dokumen Ods. Gunakan peluang ini tanpa melaksanakan kod tambahan.
