...
############################# Head ############################
head_title: "Verificació de signatures de Text per a fitxers Doc mitjançant Java"
head_description: "Utilitzeu només unes poques línies de codi Java per verificar els documents Doc i les seves signatures Text."

############################# Header ############################
title: "Text verificació de signatures per a fitxers Doc"
description: "L'API per a Java ofereix l'oportunitat de verificar les signatures de Text als documents Doc. La verificació de les signatures electròniques dins dels vostres documents Doc es pot fer de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com validar les signatures de Text al vostre document Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclou funcions útils com la verificació de les signatures de Text col·locades als documents de Doc. Aprofiteu aquesta oportunitat sense implementar codi addicional.
