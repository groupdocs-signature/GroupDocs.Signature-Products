...
############################# Head ############################
head_title: "Verification of Text signatures for Tar files via Java"
head_description: "Use only a few lines of Java code to verify Tar documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Tar files"
description: "API for Java provides opportunity to verify Text signatures at Tar documents. Verification of e-signatures inside your Tar documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like verification of Text signatures placed at Tar documents. Use this opportunity without implementing extra code.
