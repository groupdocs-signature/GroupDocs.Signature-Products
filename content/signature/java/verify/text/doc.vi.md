...
############################# Head ############################
head_title: "Xác minh chữ ký Text cho tệp Doc qua Java"
head_description: "Chỉ sử dụng một vài dòng mã Java để xác minh tài liệu Doc và chữ ký Text của chúng."

############################# Header ############################
title: "Xác minh chữ ký Text cho các tệp Doc"
description: "API cho Java cung cấp cơ hội xác minh chữ ký Text tại tài liệu Doc. Việc xác minh chữ ký điện tử bên trong tài liệu Doc của bạn có thể được thực hiện nhanh chóng và dễ dàng."
...
steps:
    enable: true
    title_left: "Cách xác thực chữ ký Text trong tài liệu Doc của bạn"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) bao gồm các tính năng hữu ích như xác minh chữ ký Text được đặt trong tài liệu Doc. Sử dụng cơ hội này mà không cần triển khai thêm mã.
