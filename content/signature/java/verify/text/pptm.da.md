...
############################# Header ############################
title: "Text signaturbekræftelse for Pptm filer"
description: "API for Java giver mulighed for at bekræfte Text-signaturer på Pptm-dokumenter. Bekræftelse af e-signaturer i dine Pptm-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Text-signaturer i dit Pptm-dokument"
    content_left: |
