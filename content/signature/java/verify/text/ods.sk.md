...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Ods cez Java"
head_description: "Na overenie dokumentov Ods a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Ods"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Ods. Overenie elektronických podpisov vo vašich dokumentoch Ods môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Text vo vašom dokumente Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Ods. Využite túto príležitosť bez implementácie dodatočného kódu.
