...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Xltx przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Xltx i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Xltx"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Text w dokumentach Xltx. Weryfikacja podpisów elektronicznych w dokumentach Xltx może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Xltx. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
