...
############################# Head ############################
head_title: "Bekræftelse af Text signaturer for Rtf filer via Java"
head_description: "Brug kun et par linjer med Java-kode til at bekræfte Rtf-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekræftelse for Rtf filer"
description: "API for Java giver mulighed for at bekræfte Text-signaturer på Rtf-dokumenter. Bekræftelse af e-signaturer i dine Rtf-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Text-signaturer i dit Rtf-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funktioner såsom bekræftelse af Text signaturer placeret på Rtf dokumenter. Brug denne mulighed uden at implementere ekstra kode.
