...
############################# Head ############################
head_title: "Ověření podpisů Text pro soubory Doc prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Doc a jejich podpisů Text."

############################# Header ############################
title: "Ověření podpisů Text pro soubory Doc"
description: "API pro Java poskytuje příležitost ověřit podpisy Text v dokumentech Doc. Ověření elektronických podpisů ve vašich dokumentech Doc může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Text ve vašem dokumentu Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Text umístěných v dokumentech Doc. Využijte tuto příležitost bez implementace dalšího kódu.
