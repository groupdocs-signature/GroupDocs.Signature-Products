...
############################# Head ############################
head_title: "Verification of Text signatures for Potx files in Java"
head_description: "Use only a few lines of Java code to verify Potx documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Potx files"
description: "API for Java provides opportunity to verify Text signatures at Potx documents. Verification of e-signatures inside your Potx documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Text signatures in your Potx document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Text signatures placed at Potx documents. Use this opportunity without implementing extra code.
