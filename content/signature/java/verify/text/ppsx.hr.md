...
############################# Head ############################
head_title: "Provjera Text potpisa za Ppsx datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Ppsx dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za Ppsx datoteke"
description: "API za Java pruža priliku za provjeru potpisa Text u dokumentima Ppsx. Provjera e-potpisa unutar vaših Ppsx dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Text u vašem Ppsx dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente Ppsx. Iskoristite ovu priliku bez implementacije dodatnog koda.
