...
############################# Head ############################
head_title: "Verification of Text signatures for 7z files via Java"
head_description: "Use only a few lines of Java code to verify 7z documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for 7z files"
description: "API for Java provides opportunity to verify Text signatures at 7z documents. Verification of e-signatures inside your 7z documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Text signatures in your 7z document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like verification of Text signatures placed at 7z documents. Use this opportunity without implementing extra code.
