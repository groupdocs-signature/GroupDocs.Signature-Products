...
############################# Head ############################
head_title: "Pengesahan tandatangan Text untuk fail Docx melalui Java"
head_description: "Gunakan hanya beberapa baris kod Java untuk mengesahkan dokumen Docx dan tandatangan Text mereka."

############################# Header ############################
title: "Text pengesahan tandatangan untuk fail Docx."
description: "API untuk Java memberi peluang untuk mengesahkan tandatangan Text pada dokumen Docx. Pengesahan e-tandatangan di dalam dokumen Docx anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengesahkan tandatangan Text dalam dokumen Docx anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) termasuk ciri berguna seperti pengesahan tandatangan Text yang diletakkan pada dokumen Docx. Gunakan peluang ini tanpa melaksanakan kod tambahan.
