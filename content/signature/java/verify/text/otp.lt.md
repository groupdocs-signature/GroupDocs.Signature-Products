...
############################# Head ############################
head_title: "Text failų Otp parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Otp dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Otp failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Text parašus Otp dokumentuose. El. parašų patvirtinimas jūsų Otp dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Text parašus Otp dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Otp dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
