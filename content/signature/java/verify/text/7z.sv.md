...
############################# Head ############################
head_title: "Verifiering av Text-signaturer för 7z-filer via Java"
head_description: "Använd bara några rader med Java-kod för att verifiera 7z-dokument och deras Text-signaturer."

############################# Header ############################
title: "Text signaturverifiering för 7z-filer"
description: "API för Java ger möjlighet att verifiera Text-signaturer i 7z-dokument. Verifiering av e-signaturer i dina 7z-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Text-signaturer i ditt 7z-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som verifiering av Text-signaturer placerade i 7z-dokument. Använd denna möjlighet utan att implementera extra kod.
...
demos:
    ...
    content: |
       Lägg till olika elektroniska signaturer i filen 7z just nu genom att besöka webbplatsen [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
