...
############################# Head ############################
head_title: "Preverjanje podpisov Text za datoteke Ots prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Ots in njihovih podpisov Text."

############################# Header ############################
title: "Preverjanje podpisov Text za datoteke Ots"
description: "API za Java ponuja možnost preverjanja podpisov Text v dokumentih Ots. Preverjanje e-podpisov v vaših Ots dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Text v dokumentu Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Text v dokumentih Ots. Izkoristite to priložnost brez implementacije dodatne kode.
