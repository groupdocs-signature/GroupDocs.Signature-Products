...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Ppsm cez Java"
head_description: "Na overenie dokumentov Ppsm a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Ppsm"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Ppsm. Overenie elektronických podpisov vo vašich dokumentoch Ppsm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Text vo vašom dokumente Ppsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Ppsm. Využite túto príležitosť bez implementácie dodatočného kódu.
