...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Zip przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Zip i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Zip"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Text w dokumentach Zip. Weryfikacja podpisów elektronicznych w dokumentach Zip może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Zip. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
