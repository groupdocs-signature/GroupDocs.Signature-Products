...
############################# Head ############################
head_title: "Text failų Xlsx parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Xlsx dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Xlsx failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Text parašus Xlsx dokumentuose. El. parašų patvirtinimas jūsų Xlsx dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Xlsx dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
