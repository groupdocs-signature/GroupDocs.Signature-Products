...
############################# Head ############################
head_title: "Text parakstu pārbaude failiem Tar, izmantojot Java"
head_description: "Izmantojiet tikai dažas Java koda rindiņas, lai pārbaudītu Tar dokumentus un to Text parakstus."

############################# Header ############################
title: "Text parakstu pārbaude failiem Tar"
description: "Java API nodrošina iespēju pārbaudīt Text parakstus Tar dokumentos. E-parakstu pārbaude jūsu Tar dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    enable: true
    title_left: "Kā pārbaudīt Text parakstus savā Tar dokumentā"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ietver tādas noderīgas funkcijas kā Text parakstu pārbaude, kas ievietoti Tar dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
