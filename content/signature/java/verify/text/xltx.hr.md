...
############################# Head ############################
head_title: "Provjera Text potpisa za Xltx datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Xltx dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za Xltx datoteke"
description: "API za Java pruža priliku za provjeru potpisa Text u dokumentima Xltx. Provjera e-potpisa unutar vaših Xltx dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente Xltx. Iskoristite ovu priliku bez implementacije dodatnog koda.
