...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Potx cez Java"
head_description: "Na overenie dokumentov Potx a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Potx"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Potx. Overenie elektronických podpisov vo vašich dokumentoch Potx môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Text vo vašom dokumente Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Potx. Využite túto príležitosť bez implementácie dodatočného kódu.
