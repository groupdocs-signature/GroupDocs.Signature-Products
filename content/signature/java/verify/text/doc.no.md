...
############################# Head ############################
head_title: "Bekreftelse av Text signaturer for Doc filer via Java"
head_description: "Bruk bare noen få linjer med Java-kode for å bekrefte Doc-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekreftelse for Doc-filer"
description: "API for Java gir mulighet til å bekrefte Text-signaturer i Doc-dokumenter. Verifisering av e-signaturer i Doc-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funksjoner som bekreftelse av Text-signaturer plassert på Doc-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
