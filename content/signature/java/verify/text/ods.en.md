...
############################# Head ############################
head_title: "Verification of Text signatures for Ods files in Java"
head_description: "Use only a few lines of Java code to verify Ods documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Ods files"
description: "API for Java provides opportunity to verify Text signatures at Ods documents. Verification of e-signatures inside your Ods documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Text signatures in your Ods document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Text signatures placed at Ods documents. Use this opportunity without implementing extra code.
