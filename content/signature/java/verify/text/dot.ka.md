...
############################# Head ############################
head_title: "Text ხელმოწერების დადასტურება Dot ფაილებისთვის Java-ით"
head_description: "გამოიყენეთ Java კოდის მხოლოდ რამდენიმე ხაზი Dot დოკუმენტებისა და მათი Text ხელმოწერების დასადასტურებლად."

############################# Header ############################
title: "Text ხელმოწერების დადასტურება Dot ფაილებისთვის"
description: "API Java-ისთვის იძლევა შესაძლებლობას გადაამოწმოთ Text ხელმოწერები Dot დოკუმენტებში. თქვენი {{ფაილის ფორმატი}} დოკუმენტებში ელექტრონული ხელმოწერების დადასტურება შეიძლება სწრაფად და მარტივად განხორციელდეს."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) შეიცავს სასარგებლო ფუნქციებს, როგორიცაა Text ხელმოწერების დადასტურება, რომლებიც განთავსებულია Dot დოკუმენტებზე. გამოიყენეთ ეს შესაძლებლობა დამატებითი კოდის განხორციელების გარეშე.
