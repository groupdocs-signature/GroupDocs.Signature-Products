...
############################# Head ############################
head_title: "Text allkirjade kontrollimine failide Pdf jaoks läbi Java"
head_description: "Kasutage Pdf dokumentide ja nende allkirjade Text kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Text allkirjade kontrollimine faili Pdf jaoks"
description: "API for Java annab võimaluse kontrollida Text allkirju Pdf dokumentides. Teie Pdf dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Kuidas kontrollida allkirja Text oma dokumendis Pdf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Text allkirjade kontrollimine, mis on pandud dokumentidele Pdf. Kasutage seda võimalust lisakoodi rakendamata.
