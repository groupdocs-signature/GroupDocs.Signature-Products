...
############################# Head ############################
head_title: "Verifikasie van Text handtekeninge vir Doc lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Doc-dokumente en hul Text-handtekeninge te verifieer."

############################# Header ############################
title: "Text handtekeningverifikasie vir Doc lêers"
description: "API vir Java bied geleentheid om Text handtekeninge by Doc dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Doc dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    enable: true
    title_left: "Hoe om Text handtekeninge in jou Doc dokument te bekragtig"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Text-handtekeninge wat by Doc-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
