...
############################# Head ############################
head_title: "Bekræftelse af Text signaturer for Xlsm filer via Java"
head_description: "Brug kun et par linjer med Java-kode til at bekræfte Xlsm-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekræftelse for Xlsm filer"
description: "API for Java giver mulighed for at bekræfte Text-signaturer på Xlsm-dokumenter. Bekræftelse af e-signaturer i dine Xlsm-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Text-signaturer i dit Xlsm-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funktioner såsom bekræftelse af Text signaturer placeret på Xlsm dokumenter. Brug denne mulighed uden at implementere ekstra kode.
