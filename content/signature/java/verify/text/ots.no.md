...
############################# Head ############################
head_title: "Bekreftelse av Text signaturer for Ots filer via Java"
head_description: "Bruk bare noen få linjer med Java-kode for å bekrefte Ots-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekreftelse for Ots-filer"
description: "API for Java gir mulighet til å bekrefte Text-signaturer i Ots-dokumenter. Verifisering av e-signaturer i Ots-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    enable: true
    title_left: "Slik validerer du Text-signaturer i Ots-dokumentet ditt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funksjoner som bekreftelse av Text-signaturer plassert på Ots-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
