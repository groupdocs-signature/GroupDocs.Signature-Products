...
############################# Head ############################
head_title: "Pengesahan tandatangan Text untuk fail Ots melalui Java"
head_description: "Gunakan hanya beberapa baris kod Java untuk mengesahkan dokumen Ots dan tandatangan Text mereka."

############################# Header ############################
title: "Text pengesahan tandatangan untuk fail Ots."
description: "API untuk Java memberi peluang untuk mengesahkan tandatangan Text pada dokumen Ots. Pengesahan e-tandatangan di dalam dokumen Ots anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengesahkan tandatangan Text dalam dokumen Ots anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) termasuk ciri berguna seperti pengesahan tandatangan Text yang diletakkan pada dokumen Ots. Gunakan peluang ini tanpa melaksanakan kod tambahan.
