...
############################# Head ############################
head_title: "Verificação de assinaturas Text para arquivos Ppsm via Java"
head_description: "Use apenas algumas linhas de código Java para verificar documentos Ppsm e suas assinaturas Text."

############################# Header ############################
title: "Text verificação de assinaturas para Ppsm arquivos"
description: "A API para Java oferece a oportunidade de verificar assinaturas Text em documentos Ppsm. A verificação de assinaturas eletrônicas dentro de seus documentos Ppsm pode ser realizada de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como validar assinaturas Text em seu documento Ppsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis, como verificação de Text assinaturas colocadas em documentos Ppsm. Use esta oportunidade sem implementar código extra.
