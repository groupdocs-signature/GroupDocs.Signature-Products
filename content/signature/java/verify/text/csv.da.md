...
description: "API for Java giver mulighed for at bekræfte Text-signaturer på Csv-dokumenter. Bekræftelse af e-signaturer i dine {{Filformat}}-dokumenter kan udføres hurtigt og nemt."
