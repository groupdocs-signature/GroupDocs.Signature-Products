...
############################# Head ############################
head_title: "Text failų Pps parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Pps dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Pps failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Text parašus Pps dokumentuose. El. parašų patvirtinimas jūsų Pps dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Text parašus Pps dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Pps dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
