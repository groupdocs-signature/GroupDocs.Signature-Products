...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Odp przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Odp i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Odp"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Text w dokumentach Odp. Weryfikacja podpisów elektronicznych w dokumentach Odp może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Odp. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
