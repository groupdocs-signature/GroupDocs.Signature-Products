...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Docx cez Java"
head_description: "Na overenie dokumentov Docx a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Docx"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Docx. Overenie elektronických podpisov vo vašich dokumentoch Docx môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Text vo vašom dokumente Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Docx. Využite túto príležitosť bez implementácie dodatočného kódu.
