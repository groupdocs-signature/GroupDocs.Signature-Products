...
############################# Head ############################
head_title: "Verificación de Text firmas para Odp archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Odp y sus firmas Text."

############################# Header ############################
title: "Text verificación de firmas para Odp archivos"
description: "La API para Java brinda la oportunidad de verificar Text firmas en Odp documentos. La verificación de las firmas electrónicas dentro de sus documentos Odp se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Text firmas colocadas en Odp documentos. Aproveche esta oportunidad sin implementar código adicional.
