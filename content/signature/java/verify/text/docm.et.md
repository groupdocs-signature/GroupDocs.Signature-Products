...
############################# Head ############################
head_title: "Text allkirjade kontrollimine failide Docm jaoks läbi Java"
head_description: "Kasutage Docm dokumentide ja nende allkirjade Text kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Text allkirjade kontrollimine faili Docm jaoks"
description: "API for Java annab võimaluse kontrollida Text allkirju Docm dokumentides. Teie Docm dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Text allkirjade kontrollimine, mis on pandud dokumentidele Docm. Kasutage seda võimalust lisakoodi rakendamata.
