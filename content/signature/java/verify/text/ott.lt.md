...
############################# Head ############################
head_title: "Text failų Ott parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Ott dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Ott failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Text parašus Ott dokumentuose. El. parašų patvirtinimas jūsų Ott dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Ott dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
