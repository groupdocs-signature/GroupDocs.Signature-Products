...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Pptm przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Pptm i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Pptm"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Text w dokumentach Pptm. Weryfikacja podpisów elektronicznych w dokumentach Pptm może być przeprowadzona szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zweryfikować podpisy Text w dokumencie Pptm?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Pptm. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
