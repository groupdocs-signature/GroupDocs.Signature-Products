...
############################# Head ############################
head_title: "Provjera Text potpisa za Otp datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Otp dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za Otp datoteke"
description: "API za Java pruža priliku za provjeru potpisa Text u dokumentima Otp. Provjera e-potpisa unutar vaših Otp dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente Otp. Iskoristite ovu priliku bez implementacije dodatnog koda.
