...
############################# Head ############################
head_title: "Xác minh chữ ký Text cho tệp Xlsx qua Java"
head_description: "Chỉ sử dụng một vài dòng mã Java để xác minh tài liệu Xlsx và chữ ký Text của chúng."

############################# Header ############################
title: "Xác minh chữ ký Text cho các tệp Xlsx"
description: "API cho Java cung cấp cơ hội xác minh chữ ký Text tại tài liệu Xlsx. Việc xác minh chữ ký điện tử bên trong tài liệu Xlsx của bạn có thể được thực hiện nhanh chóng và dễ dàng."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) bao gồm các tính năng hữu ích như xác minh chữ ký Text được đặt trong tài liệu Xlsx. Sử dụng cơ hội này mà không cần triển khai thêm mã.
