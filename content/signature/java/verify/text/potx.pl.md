...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Potx przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Potx i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Potx"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Text w dokumentach Potx. Weryfikacja podpisów elektronicznych w dokumentach Potx może być przeprowadzona szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zweryfikować podpisy Text w dokumencie Potx?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Potx. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
