...
############################# Head ############################
head_title: "Verificarea semnăturilor Text pentru fișierele Docm prin Java"
head_description: "Utilizați doar câteva rânduri de cod Java pentru a verifica documentele Docm și semnăturile acestora Text."

############################# Header ############################
title: "Text verificarea semnăturilor pentru fișiere Docm"
description: "API-ul pentru Java oferă posibilitatea de a verifica semnăturile Text în documentele Docm. Verificarea semnăturilor electronice din documentele dvs. Docm poate fi efectuată rapid și ușor."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) include funcții utile, cum ar fi verificarea semnăturilor Text plasate în documentele Docm. Folosiți această oportunitate fără a implementa cod suplimentar.
