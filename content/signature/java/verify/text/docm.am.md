...
############################# Head ############################
head_title: "የText ፊርማዎች ለDocm ፋይሎች በJava በኩል ማረጋገጫ"
head_description: "Docm ሰነዶችን እና Text ፊርማቸውን ለማረጋገጥ ጥቂት የJava ኮድ መስመሮችን ብቻ ይጠቀሙ።"

############################# Header ############################
title: "ለDocm ፋይሎች የText ፊርማ ማረጋገጫ"
description: "ኤፒአይ ለJava የText ፊርማዎችን በDocm ሰነዶች ለማረጋገጥ እድል ይሰጣል። በእርስዎ Docm ሰነዶች ውስጥ ያሉ የኢ-ፊርማዎች ማረጋገጫ በፍጥነት እና በቀላሉ ሊከናወን ይችላል።"
...
steps:
    enable: true
    title_left: "በእርስዎ Docm ሰነድ ውስጥ የText ፊርማዎችን እንዴት ማረጋገጥ እንደሚቻል"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) በDocm ሰነዶች ላይ የተቀመጡ የText ፊርማዎችን ማረጋገጥ ያሉ ጠቃሚ ባህሪያትን ያካትታል። ተጨማሪ ኮድ ሳይተገብሩ ይህንን እድል ይጠቀሙ።
