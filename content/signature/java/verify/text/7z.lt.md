...
############################# Head ############################
head_title: "Text failų 7z parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte 7z dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas 7z failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Text parašus 7z dokumentuose. El. parašų patvirtinimas jūsų 7z dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Text parašų, pateiktų 7z dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
