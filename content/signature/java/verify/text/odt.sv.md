...
############################# Head ############################
head_title: "Verifiering av Text-signaturer för Odt-filer via Java"
head_description: "Använd bara några rader med Java-kod för att verifiera Odt-dokument och deras Text-signaturer."

############################# Header ############################
title: "Text signaturverifiering för Odt-filer"
description: "API för Java ger möjlighet att verifiera Text-signaturer i Odt-dokument. Verifiering av e-signaturer i dina Odt-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Text-signaturer i ditt Odt-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som verifiering av Text-signaturer placerade i Odt-dokument. Använd denna möjlighet utan att implementera extra kod.
