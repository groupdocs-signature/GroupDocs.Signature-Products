...
############################# Head ############################
head_title: "A Text aláírások ellenőrzése a Potx fájlokhoz a Java segítségével"
head_description: "Csak néhány sornyi Java kódot használjon a Potx dokumentumok és a hozzájuk tartozó Text aláírások ellenőrzéséhez."

############################# Header ############################
title: "Text aláírás ellenőrzése a Potx fájlokhoz"
description: "A(z) Java API lehetőséget biztosít a(z) Text aláírások ellenőrzésére a(z) Potx dokumentumoknál. A Potx dokumentumaiban lévő e-aláírások ellenőrzése gyorsan és egyszerűen elvégezhető."
...
steps:
    enable: true
    title_left: "A Text aláírások érvényesítése a Potx dokumentumban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) olyan hasznos funkciókat tartalmaz, mint a Text aláírások ellenőrzése a Potx dokumentumokban. Használja ki ezt a lehetőséget extra kód alkalmazása nélkül.
