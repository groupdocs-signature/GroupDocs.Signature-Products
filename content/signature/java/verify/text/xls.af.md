...
############################# Head ############################
head_title: "Verifikasie van Text handtekeninge vir Xls lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Xls-dokumente en hul Text-handtekeninge te verifieer."

############################# Header ############################
title: "Text handtekeningverifikasie vir Xls lêers"
description: "API vir Java bied geleentheid om Text handtekeninge by Xls dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Xls dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    enable: true
    title_left: "Hoe om Text handtekeninge in jou Xls dokument te bekragtig"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Text-handtekeninge wat by Xls-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
