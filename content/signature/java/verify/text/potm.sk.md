...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Potm cez Java"
head_description: "Na overenie dokumentov Potm a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Potm"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Potm. Overenie elektronických podpisov vo vašich dokumentoch Potm môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Potm. Využite túto príležitosť bez implementácie dodatočného kódu.
