...
############################# Head ############################
head_title: "Java による Xltx ファイルの Text 署名の検証"
head_description: "数行の Java コードを使用して、Xltx ドキュメントとその Text 署名を検証します。"

############################# Header ############################
title: "Xltx ファイルの Text 署名検証"
description: "Java の API は、Xltx ドキュメントで Text 署名を検証する機会を提供します。 Xltx ドキュメント内の電子署名の検証は、迅速かつ簡単に実行できます。"
...
steps:
    enable: true
    title_left: "Xltx ドキュメントで Text 署名を検証する方法"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) には、Xltx ドキュメントに配置された Text 署名の検証などの便利な機能が含まれています。余分なコードを実装せずに、この機会を利用してください。
