...
############################# Head ############################
head_title: "Java کے ذریعے Dot فائلوں کے لیے Text دستخطوں کی تصدیق"
head_description: "Dot دستاویزات اور ان کے Text دستخطوں کی تصدیق کے لیے Java کوڈ کی صرف چند سطریں استعمال کریں۔"

############################# Header ############################
title: "Text Dot فائلوں کے لیے دستخطوں کی تصدیق"
description: "API برائے Java Dot دستاویزات پر Text دستخطوں کی تصدیق کرنے کا موقع فراہم کرتا ہے۔ آپ کے Dot دستاویزات کے اندر ای دستخطوں کی تصدیق جلد اور آسانی سے کی جا سکتی ہے۔"
...
steps:
    enable: true
    title_left: "اپنے Dot دستاویز میں Text دستخطوں کی تصدیق کیسے کریں"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) میں مفید خصوصیات شامل ہیں جیسے Dot دستاویزات پر رکھے گئے Text دستخطوں کی تصدیق۔ اضافی کوڈ کو لاگو کیے بغیر اس موقع کا استعمال کریں۔
