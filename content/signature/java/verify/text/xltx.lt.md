...
############################# Head ############################
head_title: "Text failų Xltx parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Xltx dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Xltx failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Text parašus Xltx dokumentuose. El. parašų patvirtinimas jūsų Xltx dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Text parašus Xltx dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Xltx dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
