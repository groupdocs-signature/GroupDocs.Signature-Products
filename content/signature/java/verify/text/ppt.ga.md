...
############################# Head ############################
head_title: "Fíorú Text sínithe do chomhaid Ppt trí Java"
head_description: "Ná húsáid ach cúpla líne de chód Java chun doiciméid Ppt agus a gcuid sínithe Text a fhíorú."

############################# Header ############################
title: "Text fíorú sínithe le haghaidh comhad Ppt"
description: "Soláthraíonn API do Java deis chun Text sínithe ag Ppt doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Ppt a fhíorú go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Text sínithe i do dhoiciméad Ppt a bhailíochtú"
    content_left: |
        Áiríonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gnéithe úsáideacha amhail fíorú Text sínithe atá curtha ag Ppt doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
...
demos:
    ...
    content: |
       Cuir sínithe leictreonacha éagsúla le comhad Ppt faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
