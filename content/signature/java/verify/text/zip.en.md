...
############################# Head ############################
head_title: "Verification of Text signatures for Zip files via Java"
head_description: "Use only a few lines of Java code to verify Zip documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Zip files"
description: "API for Java provides opportunity to verify Text signatures at Zip documents. Verification of e-signatures inside your Zip documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like verification of Text signatures placed at Zip documents. Use this opportunity without implementing extra code.
