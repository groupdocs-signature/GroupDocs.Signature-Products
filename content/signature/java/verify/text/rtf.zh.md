...
############################# Head ############################
head_title: "通过 Java 验证 Rtf 文件的 Text 签名"
head_description: "仅使用几行 Java 代码来验证 Rtf 文档及其 Text 签名。"

############################# Header ############################
title: "Text 对 Rtf 文件的签名验证"
description: "Java 的 API 提供了验证 Rtf 文档中的 Text 签名的机会。您的 Rtf 文档中的电子签名验证可以快速轻松地执行。"
...
steps:
    enable: true
    title_left: "如何验证 Rtf 文档中的 Text 签名"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) 包括有用的功能，例如验证放置在 Rtf 文档中的 Text 签名。利用这个机会，无需实现额外的代码。
