...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Ott cez Java"
head_description: "Na overenie dokumentov Ott a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Ott"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Ott. Overenie elektronických podpisov vo vašich dokumentoch Ott môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Text vo vašom dokumente Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Ott. Využite túto príležitosť bez implementácie dodatočného kódu.
