...
############################# Head ############################
head_title: "Provjera Text potpisa za 7z datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru 7z dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za 7z datoteke"
description: "API za Java pruža priliku za provjeru potpisa Text u dokumentima 7z. Provjera e-potpisa unutar vaših 7z dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente 7z. Iskoristite ovu priliku bez implementacije dodatnog koda.
