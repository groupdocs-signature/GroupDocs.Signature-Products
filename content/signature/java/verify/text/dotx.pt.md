...
############################# Head ############################
head_title: "Verificação de assinaturas Text para arquivos Dotx via Java"
head_description: "Use apenas algumas linhas de código Java para verificar documentos Dotx e suas assinaturas Text."

############################# Header ############################
title: "Text verificação de assinaturas para Dotx arquivos"
description: "A API para Java oferece a oportunidade de verificar assinaturas Text em documentos Dotx. A verificação de assinaturas eletrônicas dentro de seus documentos Dotx pode ser realizada de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis, como verificação de Text assinaturas colocadas em documentos Dotx. Use esta oportunidade sem implementar código extra.
