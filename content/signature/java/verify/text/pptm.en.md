...
############################# Head ############################
head_title: "Verification of Text signatures for Pptm files in Java"
head_description: "Use only a few lines of Java code to verify Pptm documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Pptm files"
description: "API for Java provides opportunity to verify Text signatures at Pptm documents. Verification of e-signatures inside your Pptm documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Text signatures in your Pptm document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Text signatures placed at Pptm documents. Use this opportunity without implementing extra code.
