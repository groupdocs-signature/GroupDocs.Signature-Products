...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Tar cez Java"
head_description: "Na overenie dokumentov Tar a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Tar"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Tar. Overenie elektronických podpisov vo vašich dokumentoch Tar môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Tar. Využite túto príležitosť bez implementácie dodatočného kódu.
