...
############################# Head ############################
head_title: "Preverjanje podpisov Text za datoteke Pptm prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Pptm in njihovih podpisov Text."

############################# Header ############################
title: "Preverjanje podpisov Text za datoteke Pptm"
description: "API za Java ponuja možnost preverjanja podpisov Text v dokumentih Pptm. Preverjanje e-podpisov v vaših Pptm dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Text v dokumentu Pptm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Text v dokumentih Pptm. Izkoristite to priložnost brez implementacije dodatne kode.
