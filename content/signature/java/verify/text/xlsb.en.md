...
############################# Head ############################
head_title: "Verification of Text signatures for Xlsb files in Java"
head_description: "Use only a few lines of Java code to verify Xlsb documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Xlsb files"
description: "API for Java provides opportunity to verify Text signatures at Xlsb documents. Verification of e-signatures inside your Xlsb documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Text signatures placed at Xlsb documents. Use this opportunity without implementing extra code.
