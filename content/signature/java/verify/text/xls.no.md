...
############################# Head ############################
head_title: "Bekreftelse av Text signaturer for Xls filer via Java"
head_description: "Bruk bare noen få linjer med Java-kode for å bekrefte Xls-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekreftelse for Xls-filer"
description: "API for Java gir mulighet til å bekrefte Text-signaturer i Xls-dokumenter. Verifisering av e-signaturer i Xls-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    enable: true
    title_left: "Slik validerer du Text-signaturer i Xls-dokumentet ditt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funksjoner som bekreftelse av Text-signaturer plassert på Xls-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
