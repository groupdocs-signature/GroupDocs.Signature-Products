...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Dot cez Java"
head_description: "Na overenie dokumentov Dot a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Dot"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Dot. Overenie elektronických podpisov vo vašich dokumentoch Dot môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Text vo vašom dokumente Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Dot. Využite túto príležitosť bez implementácie dodatočného kódu.
