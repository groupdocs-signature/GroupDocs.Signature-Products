...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Ppsx cez Java"
head_description: "Na overenie dokumentov Ppsx a ich podpisov Text použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Ppsx"
description: "API pre Java poskytuje možnosť overiť podpisy Text v dokumentoch Ppsx. Overenie elektronických podpisov vo vašich dokumentoch Ppsx môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Text vo vašom dokumente Ppsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Ppsx. Využite túto príležitosť bez implementácie dodatočného kódu.
