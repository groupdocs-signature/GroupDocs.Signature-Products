...
############################# Head ############################
head_title: "Verifikasie van Text handtekeninge vir 7z lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om 7z-dokumente en hul Text-handtekeninge te verifieer."

############################# Header ############################
title: "Text handtekeningverifikasie vir 7z lêers"
description: "API vir Java bied geleentheid om Text handtekeninge by 7z dokumente te verifieer. Verifikasie van e-handtekeninge binne jou 7z dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    enable: true
    title_left: "Hoe om Text handtekeninge in jou 7z dokument te bekragtig"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Text-handtekeninge wat by 7z-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
...
demos:
    ...
    content: |
       Voeg nou verskeie elektroniese handtekeninge by die 7z-lêer deur die [GroupDocs.Signature-toepassing](https://products.groupdocs.app/signature/family) webwerf te besoek.          
