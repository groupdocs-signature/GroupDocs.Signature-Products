...
############################# Head ############################
head_title: "Preverjanje podpisov Text za datoteke Otp prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Otp in njihovih podpisov Text."

############################# Header ############################
title: "Preverjanje podpisov Text za datoteke Otp"
description: "API za Java ponuja možnost preverjanja podpisov Text v dokumentih Otp. Preverjanje e-podpisov v vaših Otp dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Text v dokumentu Otp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Text v dokumentih Otp. Izkoristite to priložnost brez implementacije dodatne kode.
