...
############################# Head ############################
head_title: "Verificación de Text firmas para Xls archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Xls y sus firmas Text."

############################# Header ############################
title: "Text verificación de firmas para Xls archivos"
description: "La API para Java brinda la oportunidad de verificar Text firmas en Xls documentos. La verificación de las firmas electrónicas dentro de sus documentos Xls se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Text firmas en su documento Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Text firmas colocadas en Xls documentos. Aproveche esta oportunidad sin implementar código adicional.
