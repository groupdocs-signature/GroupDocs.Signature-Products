...
############################# Head ############################
head_title: "Verificación de Text firmas para Otp archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Otp y sus firmas Text."

############################# Header ############################
title: "Text verificación de firmas para Otp archivos"
description: "La API para Java brinda la oportunidad de verificar Text firmas en Otp documentos. La verificación de las firmas electrónicas dentro de sus documentos Otp se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Text firmas colocadas en Otp documentos. Aproveche esta oportunidad sin implementar código adicional.
