...
############################# Head ############################
head_title: "Digital failų Zip parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Zip dokumentus ir jų Digital parašus."

############################# Header ############################
title: "Digital parašų patvirtinimas Zip failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Digital parašus Zip dokumentuose. El. parašų patvirtinimas jūsų Zip dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Digital parašų, pateiktų Zip dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
