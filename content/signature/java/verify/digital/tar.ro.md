...
############################# Head ############################
head_title: "Verificarea semnăturilor Digital pentru fișierele Tar prin Java"
head_description: "Utilizați doar câteva rânduri de cod Java pentru a verifica documentele Tar și semnăturile acestora Digital."

############################# Header ############################
title: "Digital verificarea semnăturilor pentru fișiere Tar"
description: "API-ul pentru Java oferă posibilitatea de a verifica semnăturile Digital în documentele Tar. Verificarea semnăturilor electronice din documentele dvs. Tar poate fi efectuată rapid și ușor."
...
steps:
    enable: true
    title_left: "Cum să validați semnăturile Digital în documentul dvs. Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) include funcții utile, cum ar fi verificarea semnăturilor Digital plasate în documentele Tar. Folosiți această oportunitate fără a implementa cod suplimentar.
