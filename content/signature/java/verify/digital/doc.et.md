...
############################# Head ############################
head_title: "Digital allkirjade kontrollimine failide Doc jaoks läbi Java"
head_description: "Kasutage Doc dokumentide ja nende allkirjade Digital kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Digital allkirjade kontrollimine faili Doc jaoks"
description: "API for Java annab võimaluse kontrollida Digital allkirju Doc dokumentides. Teie Doc dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Digital allkirjade kontrollimine, mis on pandud dokumentidele Doc. Kasutage seda võimalust lisakoodi rakendamata.
