...
############################# Head ############################
head_title: "Verificació de signatures de Digital per a fitxers Xlsb mitjançant Java"
head_description: "Utilitzeu només unes poques línies de codi Java per verificar els documents Xlsb i les seves signatures Digital."

############################# Header ############################
title: "Digital verificació de signatures per a fitxers Xlsb"
description: "L'API per a Java ofereix l'oportunitat de verificar les signatures de Digital als documents Xlsb. La verificació de les signatures electròniques dins dels vostres documents Xlsb es pot fer de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com validar les signatures de Digital al vostre document Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclou funcions útils com la verificació de les signatures de Digital col·locades als documents de Xlsb. Aprofiteu aquesta oportunitat sense implementar codi addicional.
