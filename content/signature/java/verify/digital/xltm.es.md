...
############################# Head ############################
head_title: "Verificación de Digital firmas para Xltm archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Xltm y sus firmas Digital."

############################# Header ############################
title: "Digital verificación de firmas para Xltm archivos"
description: "La API para Java brinda la oportunidad de verificar Digital firmas en Xltm documentos. La verificación de las firmas electrónicas dentro de sus documentos Xltm se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Digital firmas colocadas en Xltm documentos. Aproveche esta oportunidad sin implementar código adicional.
