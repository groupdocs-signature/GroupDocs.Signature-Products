...
description: "API för Java ger möjlighet att verifiera Digital-signaturer i Docm-dokument. Verifiering av e-signaturer i dina Docm-dokument kan utföras snabbt och enkelt."
