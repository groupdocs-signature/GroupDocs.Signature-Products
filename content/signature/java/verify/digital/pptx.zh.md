...
############################# Head ############################
head_title: "通过 Java 验证 Pptx 文件的 Digital 签名"
head_description: "仅使用几行 Java 代码来验证 Pptx 文档及其 Digital 签名。"

############################# Header ############################
title: "Digital 对 Pptx 文件的签名验证"
description: "Java 的 API 提供了验证 Pptx 文档中的 Digital 签名的机会。您的 Pptx 文档中的电子签名验证可以快速轻松地执行。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) 包括有用的功能，例如验证放置在 Pptx 文档中的 Digital 签名。利用这个机会，无需实现额外的代码。
