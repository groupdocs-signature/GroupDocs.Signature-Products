...
############################# Head ############################
head_title: "Verification of Digital signatures for Tar files via Java"
head_description: "Use only a few lines of Java code to verify Tar documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Tar files"
description: "API for Java provides opportunity to verify Digital signatures at Tar documents. Verification of e-signatures inside your Tar documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Digital signatures in your Tar document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like verification of Digital signatures placed at Tar documents. Use this opportunity without implementing extra code.
...
demos:
    ...
    content: |
       Add various electronic signatures to Tar file right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.          
