...
############################# Head ############################
head_title: "Verificação de assinaturas Digital para arquivos Ott via Java"
head_description: "Use apenas algumas linhas de código Java para verificar documentos Ott e suas assinaturas Digital."

############################# Header ############################
title: "Digital verificação de assinaturas para Ott arquivos"
description: "A API para Java oferece a oportunidade de verificar assinaturas Digital em documentos Ott. A verificação de assinaturas eletrônicas dentro de seus documentos Ott pode ser realizada de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis, como verificação de Digital assinaturas colocadas em documentos Ott. Use esta oportunidade sem implementar código extra.
