...
############################# Head ############################
head_title: "Verifikasie van Digital handtekeninge vir Ots lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Ots-dokumente en hul Digital-handtekeninge te verifieer."

############################# Header ############################
title: "Digital handtekeningverifikasie vir Ots lêers"
description: "API vir Java bied geleentheid om Digital handtekeninge by Ots dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Ots dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    enable: true
    title_left: "Hoe om Digital handtekeninge in jou Ots dokument te bekragtig"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Digital-handtekeninge wat by Ots-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
