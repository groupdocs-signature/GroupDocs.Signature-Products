...
############################# Head ############################
head_title: "Verifikasie van Digital handtekeninge vir Pdf lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Pdf-dokumente en hul Digital-handtekeninge te verifieer."

############################# Header ############################
title: "Digital handtekeningverifikasie vir Pdf lêers"
description: "API vir Java bied geleentheid om Digital handtekeninge by Pdf dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Pdf dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Digital-handtekeninge wat by Pdf-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
