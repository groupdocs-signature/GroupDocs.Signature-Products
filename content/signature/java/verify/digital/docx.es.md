...
############################# Head ############################
head_title: "Verificación de Digital firmas para Docx archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Docx y sus firmas Digital."

############################# Header ############################
title: "Digital verificación de firmas para Docx archivos"
description: "La API para Java brinda la oportunidad de verificar Digital firmas en Docx documentos. La verificación de las firmas electrónicas dentro de sus documentos Docx se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Digital firmas en su documento Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Digital firmas colocadas en Docx documentos. Aproveche esta oportunidad sin implementar código adicional.
