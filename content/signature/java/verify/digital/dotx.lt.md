...
############################# Head ############################
head_title: "Digital failų Dotx parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Dotx dokumentus ir jų Digital parašus."

############################# Header ############################
title: "Digital parašų patvirtinimas Dotx failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Digital parašus Dotx dokumentuose. El. parašų patvirtinimas jūsų Dotx dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Digital parašus Dotx dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Digital parašų, pateiktų Dotx dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
