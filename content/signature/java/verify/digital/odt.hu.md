...
############################# Head ############################
head_title: "A Digital aláírások ellenőrzése a Odt fájlokhoz a Java segítségével"
head_description: "Csak néhány sornyi Java kódot használjon a Odt dokumentumok és a hozzájuk tartozó Digital aláírások ellenőrzéséhez."

############################# Header ############################
title: "Digital aláírás ellenőrzése a Odt fájlokhoz"
description: "A(z) Java API lehetőséget biztosít a(z) Digital aláírások ellenőrzésére a(z) Odt dokumentumoknál. A Odt dokumentumaiban lévő e-aláírások ellenőrzése gyorsan és egyszerűen elvégezhető."
...
steps:
    enable: true
    title_left: "A Digital aláírások érvényesítése a Odt dokumentumban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) olyan hasznos funkciókat tartalmaz, mint a Digital aláírások ellenőrzése a Odt dokumentumokban. Használja ki ezt a lehetőséget extra kód alkalmazása nélkül.
