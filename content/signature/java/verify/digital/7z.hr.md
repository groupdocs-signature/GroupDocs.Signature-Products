...
############################# Head ############################
head_title: "Provjera Digital potpisa za 7z datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru 7z dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za 7z datoteke"
description: "API za Java pruža priliku za provjeru potpisa Digital u dokumentima 7z. Provjera e-potpisa unutar vaših 7z dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente 7z. Iskoristite ovu priliku bez implementacije dodatnog koda.
