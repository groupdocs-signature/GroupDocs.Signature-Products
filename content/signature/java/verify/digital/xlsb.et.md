...
############################# Head ############################
head_title: "Digital allkirjade kontrollimine failide Xlsb jaoks läbi Java"
head_description: "Kasutage Xlsb dokumentide ja nende allkirjade Digital kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Digital allkirjade kontrollimine faili Xlsb jaoks"
description: "API for Java annab võimaluse kontrollida Digital allkirju Xlsb dokumentides. Teie Xlsb dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Kuidas kontrollida allkirja Digital oma dokumendis Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Digital allkirjade kontrollimine, mis on pandud dokumentidele Xlsb. Kasutage seda võimalust lisakoodi rakendamata.
