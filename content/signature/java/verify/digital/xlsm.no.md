...
############################# Head ############################
head_title: "Bekreftelse av Digital signaturer for Xlsm filer via Java"
head_description: "Bruk bare noen få linjer med Java-kode for å bekrefte Xlsm-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekreftelse for Xlsm-filer"
description: "API for Java gir mulighet til å bekrefte Digital-signaturer i Xlsm-dokumenter. Verifisering av e-signaturer i Xlsm-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funksjoner som bekreftelse av Digital-signaturer plassert på Xlsm-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
