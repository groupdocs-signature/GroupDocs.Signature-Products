...
############################# Head ############################
head_title: "Provjera Digital potpisa za Pptx datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Pptx dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za Pptx datoteke"
description: "API za Java pruža priliku za provjeru potpisa Digital u dokumentima Pptx. Provjera e-potpisa unutar vaših Pptx dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Digital u vašem Pptx dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente Pptx. Iskoristite ovu priliku bez implementacije dodatnog koda.
