...
############################# Head ############################
head_title: "Ověření podpisů Digital pro soubory Xlsb prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Xlsb a jejich podpisů Digital."

############################# Header ############################
title: "Ověření podpisů Digital pro soubory Xlsb"
description: "API pro Java poskytuje příležitost ověřit podpisy Digital v dokumentech Xlsb. Ověření elektronických podpisů ve vašich dokumentech Xlsb může být provedeno rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Digital umístěných v dokumentech Xlsb. Využijte tuto příležitost bez implementace dalšího kódu.
