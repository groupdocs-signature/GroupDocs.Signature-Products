...
############################# Head ############################
head_title: "Verificarea semnăturilor Digital pentru fișierele Odt prin Java"
head_description: "Utilizați doar câteva rânduri de cod Java pentru a verifica documentele Odt și semnăturile acestora Digital."

############################# Header ############################
title: "Digital verificarea semnăturilor pentru fișiere Odt"
description: "API-ul pentru Java oferă posibilitatea de a verifica semnăturile Digital în documentele Odt. Verificarea semnăturilor electronice din documentele dvs. Odt poate fi efectuată rapid și ușor."
...
steps:
    enable: true
    title_left: "Cum să validați semnăturile Digital în documentul dvs. Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) include funcții utile, cum ar fi verificarea semnăturilor Digital plasate în documentele Odt. Folosiți această oportunitate fără a implementa cod suplimentar.
