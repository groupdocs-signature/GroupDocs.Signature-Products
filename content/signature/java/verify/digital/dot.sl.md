...
############################# Head ############################
head_title: "Preverjanje podpisov Digital za datoteke Dot prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Dot in njihovih podpisov Digital."

############################# Header ############################
title: "Preverjanje podpisov Digital za datoteke Dot"
description: "API za Java ponuja možnost preverjanja podpisov Digital v dokumentih Dot. Preverjanje e-podpisov v vaših Dot dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Digital v dokumentu Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Digital v dokumentih Dot. Izkoristite to priložnost brez implementacije dodatne kode.
