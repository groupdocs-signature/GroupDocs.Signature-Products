...
############################# Head ############################
head_title: "A Digital aláírások ellenőrzése a Xlsx fájlokhoz a Java segítségével"
head_description: "Csak néhány sornyi Java kódot használjon a Xlsx dokumentumok és a hozzájuk tartozó Digital aláírások ellenőrzéséhez."

############################# Header ############################
title: "Digital aláírás ellenőrzése a Xlsx fájlokhoz"
description: "A(z) Java API lehetőséget biztosít a(z) Digital aláírások ellenőrzésére a(z) Xlsx dokumentumoknál. A Xlsx dokumentumaiban lévő e-aláírások ellenőrzése gyorsan és egyszerűen elvégezhető."
...
steps:
    enable: true
    title_left: "A Digital aláírások érvényesítése a Xlsx dokumentumban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) olyan hasznos funkciókat tartalmaz, mint a Digital aláírások ellenőrzése a Xlsx dokumentumokban. Használja ki ezt a lehetőséget extra kód alkalmazása nélkül.
