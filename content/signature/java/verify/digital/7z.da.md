...
############################# Head ############################
head_title: "Bekræftelse af Digital signaturer for 7z filer via Java"
head_description: "Brug kun et par linjer med Java-kode til at bekræfte 7z-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekræftelse for 7z filer"
description: "API for Java giver mulighed for at bekræfte Digital-signaturer på 7z-dokumenter. Bekræftelse af e-signaturer i dine 7z-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funktioner såsom bekræftelse af Digital signaturer placeret på 7z dokumenter. Brug denne mulighed uden at implementere ekstra kode.
