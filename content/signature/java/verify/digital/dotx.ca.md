...
############################# Head ############################
head_title: "Verificació de signatures de Digital per a fitxers Dotx mitjançant Java"
head_description: "Utilitzeu només unes poques línies de codi Java per verificar els documents Dotx i les seves signatures Digital."

############################# Header ############################
title: "Digital verificació de signatures per a fitxers Dotx"
description: "L'API per a Java ofereix l'oportunitat de verificar les signatures de Digital als documents Dotx. La verificació de les signatures electròniques dins dels vostres documents Dotx es pot fer de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com validar les signatures de Digital al vostre document Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclou funcions útils com la verificació de les signatures de Digital col·locades als documents de Dotx. Aprofiteu aquesta oportunitat sense implementar codi addicional.
...
demos:
    ...
    content: |
       Afegiu diverses signatures electròniques al fitxer Dotx ara mateix visitant el lloc web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
