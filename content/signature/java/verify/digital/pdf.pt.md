...
############################# Head ############################
head_title: "Verificação de assinaturas Digital para arquivos Pdf via Java"
head_description: "Use apenas algumas linhas de código Java para verificar documentos Pdf e suas assinaturas Digital."

############################# Header ############################
title: "Digital verificação de assinaturas para Pdf arquivos"
description: "A API para Java oferece a oportunidade de verificar assinaturas Digital em documentos Pdf. A verificação de assinaturas eletrônicas dentro de seus documentos Pdf pode ser realizada de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como validar assinaturas Digital em seu documento Pdf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis, como verificação de Digital assinaturas colocadas em documentos Pdf. Use esta oportunidade sem implementar código extra.
