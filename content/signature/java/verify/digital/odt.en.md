...
############################# Head ############################
head_title: "Verification of Digital signatures for Odt files in Java"
head_description: "Use only a few lines of Java code to verify Odt documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Odt files"
description: "API for Java provides opportunity to verify Digital signatures at Odt documents. Verification of e-signatures inside your Odt documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Digital signatures placed at Odt documents. Use this opportunity without implementing extra code.
