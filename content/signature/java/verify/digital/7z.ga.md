...
############################# Head ############################
head_title: "Fíorú Digital sínithe do chomhaid 7z trí Java"
head_description: "Ná húsáid ach cúpla líne de chód Java chun doiciméid 7z agus a gcuid sínithe Digital a fhíorú."

############################# Header ############################
title: "Digital fíorú sínithe le haghaidh comhad 7z"
description: "Soláthraíonn API do Java deis chun Digital sínithe ag 7z doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid 7z a fhíorú go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Digital sínithe i do dhoiciméad 7z a bhailíochtú"
    content_left: |
        Áiríonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gnéithe úsáideacha amhail fíorú Digital sínithe atá curtha ag 7z doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
...
demos:
    ...
    content: |
       Cuir sínithe leictreonacha éagsúla le comhad 7z faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
