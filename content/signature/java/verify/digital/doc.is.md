...
############################# Head ############################
head_title: "Staðfesting á Digital undirskriftum fyrir Doc skrár í gegnum Java"
head_description: "Notaðu aðeins nokkrar línur af Java kóða til að staðfesta Doc skjöl og Digital undirskrift þeirra."

############################# Header ############################
title: "Digital staðfesting á undirskriftum fyrir Doc skrár"
description: "API fyrir Java veitir tækifæri til að staðfesta Digital undirskriftir á Doc skjölum. Staðfesting á rafrænum undirskriftum inni í Doc skjölunum þínum gæti verið framkvæmd fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Hvernig á að staðfesta Digital undirskriftir í Doc skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inniheldur gagnlega eiginleika eins og staðfestingu á Digital undirskriftum sem settar eru á Doc skjöl. Notaðu þetta tækifæri án þess að innleiða aukakóða.
...
demos:
    ...
    content: |
       Bættu ýmsum rafrænum undirskriftum við Doc skrá núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna.          
