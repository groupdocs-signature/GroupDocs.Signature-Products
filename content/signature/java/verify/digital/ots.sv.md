...
############################# Head ############################
head_title: "Verifiering av Digital-signaturer för Ots-filer via Java"
head_description: "Använd bara några rader med Java-kod för att verifiera Ots-dokument och deras Digital-signaturer."

############################# Header ############################
title: "Digital signaturverifiering för Ots-filer"
description: "API för Java ger möjlighet att verifiera Digital-signaturer i Ots-dokument. Verifiering av e-signaturer i dina Ots-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Digital-signaturer i ditt Ots-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som verifiering av Digital-signaturer placerade i Ots-dokument. Använd denna möjlighet utan att implementera extra kod.
...
demos:
    ...
    content: |
       Lägg till olika elektroniska signaturer i filen Ots just nu genom att besöka webbplatsen [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
