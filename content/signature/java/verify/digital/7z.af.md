...
############################# Head ############################
head_title: "Verifikasie van Digital handtekeninge vir 7z lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om 7z-dokumente en hul Digital-handtekeninge te verifieer."

############################# Header ############################
title: "Digital handtekeningverifikasie vir 7z lêers"
description: "API vir Java bied geleentheid om Digital handtekeninge by 7z dokumente te verifieer. Verifikasie van e-handtekeninge binne jou 7z dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    enable: true
    title_left: "Hoe om Digital handtekeninge in jou 7z dokument te bekragtig"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Digital-handtekeninge wat by 7z-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
