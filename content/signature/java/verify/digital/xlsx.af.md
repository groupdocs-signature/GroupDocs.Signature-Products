...
############################# Head ############################
head_title: "Verifikasie van Digital handtekeninge vir Xlsx lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Xlsx-dokumente en hul Digital-handtekeninge te verifieer."

############################# Header ############################
title: "Digital handtekeningverifikasie vir Xlsx lêers"
description: "API vir Java bied geleentheid om Digital handtekeninge by Xlsx dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Xlsx dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Digital-handtekeninge wat by Xlsx-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
