...
############################# Head ############################
head_title: "Digital allkirjade kontrollimine failide Ots jaoks läbi Java"
head_description: "Kasutage Ots dokumentide ja nende allkirjade Digital kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Digital allkirjade kontrollimine faili Ots jaoks"
description: "API for Java annab võimaluse kontrollida Digital allkirju Ots dokumentides. Teie Ots dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Kuidas kontrollida allkirja Digital oma dokumendis Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Digital allkirjade kontrollimine, mis on pandud dokumentidele Ots. Kasutage seda võimalust lisakoodi rakendamata.
