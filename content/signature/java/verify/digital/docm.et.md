...
############################# Head ############################
head_title: "Digital allkirjade kontrollimine failide Docm jaoks läbi Java"
head_description: "Kasutage Docm dokumentide ja nende allkirjade Digital kontrollimiseks ainult mõnda rida Java koodi."

############################# Header ############################
title: "Digital allkirjade kontrollimine faili Docm jaoks"
description: "API for Java annab võimaluse kontrollida Digital allkirju Docm dokumentides. Teie Docm dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Kuidas kontrollida allkirja Digital oma dokumendis Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sisaldab kasulikke funktsioone, nagu Digital allkirjade kontrollimine, mis on pandud dokumentidele Docm. Kasutage seda võimalust lisakoodi rakendamata.
