...
############################# Head ############################
head_title: "Verification of Digital signatures for Doc files in Java"
head_description: "Use only a few lines of Java code to verify Doc documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Doc files"
description: "API for Java provides opportunity to verify Digital signatures at Doc documents. Verification of e-signatures inside your Doc documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Digital signatures placed at Doc documents. Use this opportunity without implementing extra code.
