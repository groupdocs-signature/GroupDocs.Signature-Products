...
############################# Head ############################
head_title: "Vérification des signatures Digital pour les fichiers Xltm via Java"
head_description: "Utilisez seulement quelques lignes de code Java pour vérifier les documents Xltm et leurs signatures Digital."

############################# Header ############################
title: "Vérification des signatures Digital pour les fichiers Xltm"
description: "L'API pour Java offre la possibilité de vérifier les signatures Digital sur les documents Xltm. La vérification des signatures électroniques dans vos documents Xltm peut être effectuée rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment valider les signatures Digital dans votre document Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclut des fonctionnalités utiles telles que la vérification des signatures Digital placées sur les documents Xltm. Utilisez cette opportunité sans implémenter de code supplémentaire.
