...
############################# Head ############################
head_title: "Bekreftelse av Digital signaturer for Odt filer via Java"
head_description: "Bruk bare noen få linjer med Java-kode for å bekrefte Odt-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekreftelse for {{Filformat}}-filer"
description: "API for Java gir mulighet til å bekrefte Digital-signaturer i Odt-dokumenter. Verifisering av e-signaturer i Odt-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funksjoner som bekreftelse av Digital-signaturer plassert på Odt-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
...
demos:
    ...
    content: |
       Legg til ulike elektroniske signaturer i Odt-filen akkurat nå ved å gå til nettstedet [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
