...
############################# Head ############################
head_title: "Digital parakstu pārbaude failiem Xlsm, izmantojot Java"
head_description: "Izmantojiet tikai dažas Java koda rindiņas, lai pārbaudītu Xlsm dokumentus un to Digital parakstus."

############################# Header ############################
title: "Digital parakstu pārbaude failiem Xlsm"
description: "Java API nodrošina iespēju pārbaudīt Digital parakstus Xlsm dokumentos. E-parakstu pārbaude jūsu Xlsm dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    enable: true
    title_left: "Kā pārbaudīt Digital parakstus savā Xlsm dokumentā"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ietver tādas noderīgas funkcijas kā Digital parakstu pārbaude, kas ievietoti Xlsm dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
