...
############################# Head ############################
head_title: "Verastkirina îmzeyên Digital ji bo pelên Xlsx bi rêya Java"
head_description: "Tenê çend rêzên koda Java bikar bînin da ku belgeyên Xlsx û îmzeyên wan ên Digital rast bikin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) taybetmendîyên bikêrhatî yên wekî verastkirina îmzayên Digital yên ku li belgeyên Xlsx hatine danîn dihewîne. Vê derfetê bêyî pêkanîna kodek zêde bikar bînin.
