...
############################# Head ############################
head_title: "Provjera Digital potpisa za Xlsx datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Xlsx dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za Xlsx datoteke"
description: "API za Java pruža priliku za provjeru potpisa Digital u dokumentima Xlsx. Provjera e-potpisa unutar vaših Xlsx dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Digital u vašem Xlsx dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente Xlsx. Iskoristite ovu priliku bez implementacije dodatnog koda.
