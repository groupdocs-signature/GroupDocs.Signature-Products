...
############################# Head ############################
head_title: "Ověření podpisů Digital pro soubory Pptm prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Pptm a jejich podpisů Digital."

############################# Header ############################
title: "Ověření podpisů Digital pro soubory Pptm"
description: "API pro Java poskytuje příležitost ověřit podpisy Digital v dokumentech Pptm. Ověření elektronických podpisů ve vašich dokumentech Pptm může být provedeno rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Digital umístěných v dokumentech Pptm. Využijte tuto příležitost bez implementace dalšího kódu.
