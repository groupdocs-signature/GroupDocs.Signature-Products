...
############################# Head ############################
head_title: "Verifiering av Digital-signaturer för Tar-filer via Java"
head_description: "Använd bara några rader med Java-kod för att verifiera Tar-dokument och deras Digital-signaturer."

############################# Header ############################
title: "Digital signaturverifiering för Tar-filer"
description: "API för Java ger möjlighet att verifiera Digital-signaturer i Tar-dokument. Verifiering av e-signaturer i dina Tar-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Digital-signaturer i ditt Tar-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som verifiering av Digital-signaturer placerade i Tar-dokument. Använd denna möjlighet utan att implementera extra kod.
