...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory Dotx cez Java"
head_description: "Na overenie dokumentov Dotx a ich podpisov Digital použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory Dotx"
description: "API pre Java poskytuje možnosť overiť podpisy Digital v dokumentoch Dotx. Overenie elektronických podpisov vo vašich dokumentoch Dotx môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Digital vo vašom dokumente Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch Dotx. Využite túto príležitosť bez implementácie dodatočného kódu.
