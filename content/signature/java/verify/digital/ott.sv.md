...
############################# Head ############################
head_title: "Verifiering av Digital-signaturer för Ott-filer via Java"
head_description: "Använd bara några rader med Java-kod för att verifiera Ott-dokument och deras Digital-signaturer."

############################# Header ############################
title: "Digital signaturverifiering för Ott-filer"
description: "API för Java ger möjlighet att verifiera Digital-signaturer i Ott-dokument. Verifiering av e-signaturer i dina Ott-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Digital-signaturer i ditt Ott-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som verifiering av Digital-signaturer placerade i Ott-dokument. Använd denna möjlighet utan att implementera extra kod.
