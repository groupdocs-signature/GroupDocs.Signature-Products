...
############################# Head ############################
head_title: "Preverjanje podpisov Digital za datoteke Tar prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Tar in njihovih podpisov Digital."

############################# Header ############################
title: "Preverjanje podpisov Digital za datoteke Tar"
description: "API za Java ponuja možnost preverjanja podpisov Digital v dokumentih Tar. Preverjanje e-podpisov v vaših Tar dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Digital v dokumentu Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Digital v dokumentih Tar. Izkoristite to priložnost brez implementacije dodatne kode.
...
demos:
    ...
    content: |
       Takoj dodajte različne elektronske podpise v datoteko Tar tako, da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
