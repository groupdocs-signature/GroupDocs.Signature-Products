...
############################# Head ############################
head_title: "Provjera Digital potpisa za Docm datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Docm dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za Docm datoteke"
description: "API za Java pruža priliku za provjeru potpisa Digital u dokumentima Docm. Provjera e-potpisa unutar vaših Docm dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Digital u vašem Docm dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente Docm. Iskoristite ovu priliku bez implementacije dodatnog koda.
