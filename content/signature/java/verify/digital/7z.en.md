...
############################# Head ############################
head_title: "Verification of Digital signatures for 7z files via Java"
head_description: "Use only a few lines of Java code to verify 7z documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for 7z files"
description: "API for Java provides opportunity to verify Digital signatures at 7z documents. Verification of e-signatures inside your 7z documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Digital signatures in your 7z document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like verification of Digital signatures placed at 7z documents. Use this opportunity without implementing extra code.
...
demos:
    ...
    content: |
       Add various electronic signatures to 7z file right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.          
