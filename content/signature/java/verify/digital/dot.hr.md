...
############################# Head ############################
head_title: "Provjera Digital potpisa za Dot datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Dot dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za Dot datoteke"
description: "API za Java pruža priliku za provjeru potpisa Digital u dokumentima Dot. Provjera e-potpisa unutar vaših Dot dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente Dot. Iskoristite ovu priliku bez implementacije dodatnog koda.
