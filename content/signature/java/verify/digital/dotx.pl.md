...
############################# Head ############################
head_title: "Weryfikacja podpisów Digital dla plików Dotx przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Dotx i ich podpisy Digital."

############################# Header ############################
title: "Weryfikacja podpisów Digital dla plików Dotx"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Digital w dokumentach Dotx. Weryfikacja podpisów elektronicznych w dokumentach Dotx może być przeprowadzona szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zweryfikować podpisy Digital w dokumencie Dotx?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Digital umieszczonych w dokumentach Dotx. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
