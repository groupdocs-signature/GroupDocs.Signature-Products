...
############################# Head ############################
head_title: "Digital failų Docm parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Docm dokumentus ir jų Digital parašus."

############################# Header ############################
title: "Digital parašų patvirtinimas Docm failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Digital parašus Docm dokumentuose. El. parašų patvirtinimas jūsų Docm dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Digital parašus Docm dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Digital parašų, pateiktų Docm dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
