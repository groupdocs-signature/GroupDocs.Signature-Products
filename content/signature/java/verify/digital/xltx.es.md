...
############################# Head ############################
head_title: "Verificación de Digital firmas para Xltx archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Xltx y sus firmas Digital."

############################# Header ############################
title: "Digital verificación de firmas para Xltx archivos"
description: "La API para Java brinda la oportunidad de verificar Digital firmas en Xltx documentos. La verificación de las firmas electrónicas dentro de sus documentos Xltx se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Digital firmas colocadas en Xltx documentos. Aproveche esta oportunidad sin implementar código adicional.
