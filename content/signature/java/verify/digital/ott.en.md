...
############################# Head ############################
head_title: "Verification of Digital signatures for Ott files in Java"
head_description: "Use only a few lines of Java code to verify Ott documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Ott files"
description: "API for Java provides opportunity to verify Digital signatures at Ott documents. Verification of e-signatures inside your Ott documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Digital signatures in your Ott document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Digital signatures placed at Ott documents. Use this opportunity without implementing extra code.
