...
############################# Head ############################
head_title: "የDigital ፊርማዎች ለXlsm ፋይሎች በJava በኩል ማረጋገጫ"
head_description: "Xlsm ሰነዶችን እና Digital ፊርማቸውን ለማረጋገጥ ጥቂት የJava ኮድ መስመሮችን ብቻ ይጠቀሙ።"

############################# Header ############################
title: "ለXlsm ፋይሎች የDigital ፊርማ ማረጋገጫ"
description: "ኤፒአይ ለJava የDigital ፊርማዎችን በXlsm ሰነዶች ለማረጋገጥ እድል ይሰጣል። በእርስዎ Xlsm ሰነዶች ውስጥ ያሉ የኢ-ፊርማዎች ማረጋገጫ በፍጥነት እና በቀላሉ ሊከናወን ይችላል።"
...
steps:
    enable: true
    title_left: "በእርስዎ Xlsm ሰነድ ውስጥ የ{{Signturetype}} ፊርማዎችን እንዴት ማረጋገጥ እንደሚቻል"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) በXlsm ሰነዶች ላይ የተቀመጡ የDigital ፊርማዎችን ማረጋገጥ ያሉ ጠቃሚ ባህሪያትን ያካትታል። ተጨማሪ ኮድ ሳይተገብሩ ይህንን እድል ይጠቀሙ።
