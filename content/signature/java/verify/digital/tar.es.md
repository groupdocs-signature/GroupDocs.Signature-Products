...
############################# Head ############################
head_title: "Verificación de Digital firmas para Tar archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Tar y sus firmas Digital."

############################# Header ############################
title: "Digital verificación de firmas para Tar archivos"
description: "La API para Java brinda la oportunidad de verificar Digital firmas en Tar documentos. La verificación de las firmas electrónicas dentro de sus documentos Tar se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Digital firmas colocadas en Tar documentos. Aproveche esta oportunidad sin implementar código adicional.
