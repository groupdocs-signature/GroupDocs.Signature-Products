...
############################# Head ############################
head_title: "Preverjanje podpisov Digital za datoteke Odt prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Odt in njihovih podpisov Digital."

############################# Header ############################
title: "Preverjanje podpisov Digital za datoteke Odt"
description: "API za Java ponuja možnost preverjanja podpisov Digital v dokumentih Odt. Preverjanje e-podpisov v vaših Odt dokumentih lahko izvedete hitro in enostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Digital v dokumentih Odt. Izkoristite to priložnost brez implementacije dodatne kode.
