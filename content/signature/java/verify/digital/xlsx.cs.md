...
############################# Head ############################
head_title: "Ověření podpisů Digital pro soubory Xlsx prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Xlsx a jejich podpisů Digital."

############################# Header ############################
title: "Ověření podpisů Digital pro soubory Xlsx"
description: "API pro Java poskytuje příležitost ověřit podpisy Digital v dokumentech Xlsx. Ověření elektronických podpisů ve vašich dokumentech Xlsx může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Digital ve vašem dokumentu Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Digital umístěných v dokumentech Xlsx. Využijte tuto příležitost bez implementace dalšího kódu.
