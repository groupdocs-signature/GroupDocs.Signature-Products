...
############################# Head ############################
head_title: "Provjera Digital potpisa za Pdf datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Pdf dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za Pdf datoteke"
description: "API za Java pruža priliku za provjeru potpisa Digital u dokumentima Pdf. Provjera e-potpisa unutar vaših Pdf dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente Pdf. Iskoristite ovu priliku bez implementacije dodatnog koda.
