...
############################# Head ############################
head_title: "Digital failų Xls parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Xls dokumentus ir jų Digital parašus."

############################# Header ############################
title: "Digital parašų patvirtinimas Xls failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Digital parašus Xls dokumentuose. El. parašų patvirtinimas jūsų Xls dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Digital parašus Xls dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Digital parašų, pateiktų Xls dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
