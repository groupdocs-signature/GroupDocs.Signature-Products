...
############################# Head ############################
head_title: "Ověření podpisů Digital pro soubory Odt prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Odt a jejich podpisů Digital."

############################# Header ############################
title: "Ověření podpisů Digital pro soubory Odt"
description: "API pro Java poskytuje příležitost ověřit podpisy Digital v dokumentech Odt. Ověření elektronických podpisů ve vašich dokumentech Odt může být provedeno rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Digital umístěných v dokumentech Odt. Využijte tuto příležitost bez implementace dalšího kódu.
