...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory Docm cez Java"
head_description: "Na overenie dokumentov Docm a ich podpisov Digital použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory Docm"
description: "API pre Java poskytuje možnosť overiť podpisy Digital v dokumentoch Docm. Overenie elektronických podpisov vo vašich dokumentoch Docm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Digital vo vašom dokumente Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch Docm. Využite túto príležitosť bez implementácie dodatočného kódu.
