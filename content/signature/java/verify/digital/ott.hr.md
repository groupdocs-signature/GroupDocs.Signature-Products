...
############################# Head ############################
head_title: "Provjera Digital potpisa za Ott datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Ott dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za Ott datoteke"
description: "API za Java pruža priliku za provjeru potpisa Digital u dokumentima Ott. Provjera e-potpisa unutar vaših Ott dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente Ott. Iskoristite ovu priliku bez implementacije dodatnog koda.
