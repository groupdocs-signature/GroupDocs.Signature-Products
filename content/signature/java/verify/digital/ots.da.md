...
############################# Head ############################
head_title: "Bekræftelse af Digital signaturer for Ots filer via Java"
head_description: "Brug kun et par linjer med Java-kode til at bekræfte Ots-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekræftelse for Ots filer"
description: "API for Java giver mulighed for at bekræfte Digital-signaturer på Ots-dokumenter. Bekræftelse af e-signaturer i dine Ots-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Digital-signaturer i dit Ots-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inkluderer nyttige funktioner såsom bekræftelse af Digital signaturer placeret på Ots dokumenter. Brug denne mulighed uden at implementere ekstra kode.
...
demos:
    ...
    content: |
       Føj forskellige elektroniske signaturer til filen Ots lige nu ved at besøge webstedet [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
