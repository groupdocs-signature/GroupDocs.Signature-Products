...
############################# Head ############################
head_title: "Preverjanje podpisov Digital za datoteke Ott prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Ott in njihovih podpisov Digital."

############################# Header ############################
title: "Preverjanje podpisov Digital za datoteke Ott"
description: "API za Java ponuja možnost preverjanja podpisov Digital v dokumentih Ott. Preverjanje e-podpisov v vaših Ott dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Digital v dokumentu Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Digital v dokumentih Ott. Izkoristite to priložnost brez implementacije dodatne kode.
