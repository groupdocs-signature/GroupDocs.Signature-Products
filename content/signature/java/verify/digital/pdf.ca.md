...
############################# Head ############################
head_title: "Verificació de signatures de Digital per a fitxers Pdf mitjançant Java"
head_description: "Utilitzeu només unes poques línies de codi Java per verificar els documents Pdf i les seves signatures Digital."

############################# Header ############################
title: "Digital verificació de signatures per a fitxers Pdf"
description: "L'API per a Java ofereix l'oportunitat de verificar les signatures de Digital als documents Pdf. La verificació de les signatures electròniques dins dels vostres documents Pdf es pot fer de manera ràpida i senzilla."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclou funcions útils com la verificació de les signatures de Digital col·locades als documents de Pdf. Aprofiteu aquesta oportunitat sense implementar codi addicional.
