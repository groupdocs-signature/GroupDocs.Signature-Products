...
############################# Head ############################
head_title: "Verification of Digital signatures for Zip files via Java"
head_description: "Use only a few lines of Java code to verify Zip documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Zip files"
description: "API for Java provides opportunity to verify Digital signatures at Zip documents. Verification of e-signatures inside your Zip documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Digital signatures in your Zip document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like verification of Digital signatures placed at Zip documents. Use this opportunity without implementing extra code.
