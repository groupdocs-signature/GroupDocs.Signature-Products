...
############################# Head ############################
head_title: "Verifikasie van Digital handtekeninge vir Xlsm lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Xlsm-dokumente en hul Digital-handtekeninge te verifieer."

############################# Header ############################
title: "Digital handtekeningverifikasie vir Xlsm lêers"
description: "API vir Java bied geleentheid om Digital handtekeninge by Xlsm dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Xlsm dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    enable: true
    title_left: "Hoe om Digital handtekeninge in jou Xlsm dokument te bekragtig"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Digital-handtekeninge wat by Xlsm-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
