...
############################# Head ############################
head_title: "Pengesahan tandatangan Digital untuk fail Xlsm melalui Java"
head_description: "Gunakan hanya beberapa baris kod Java untuk mengesahkan dokumen Xlsm dan tandatangan Digital mereka."

############################# Header ############################
title: "Digital pengesahan tandatangan untuk fail Xlsm."
description: "API untuk Java memberi peluang untuk mengesahkan tandatangan Digital pada dokumen Xlsm. Pengesahan e-tandatangan di dalam dokumen Xlsm anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengesahkan tandatangan Digital dalam dokumen Xlsm anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) termasuk ciri berguna seperti pengesahan tandatangan Digital yang diletakkan pada dokumen Xlsm. Gunakan peluang ini tanpa melaksanakan kod tambahan.
