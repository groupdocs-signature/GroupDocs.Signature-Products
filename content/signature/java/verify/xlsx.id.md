...
############################# Head ############################
head_title: "Verifikasi tanda tangan elektronik XLSX menggunakan Java"
head_description: "GroupDocs.Signature for Java memungkinkan verifikasi tanda tangan yang diletakkan dalam file XLSX. Validasi tanda tangan dalam PDF, dokumen Word, lembar Excel, Presentasi, Gambar, atau arsip ZIP."

############################# Header ############################
title: "Verifikasi e-Signature untuk XLSX" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk memverifikasi tanda tangan dalam XLSX menggunakan Java"
    content: |
      [GroupDocs.Signature](/signature/java/) dapat memverifikasi keberadaan tanda tangan tertentu dalam dokumen XLSX. Pengembang Java dapat meningkatkan aplikasi mereka dengan menambahkan fitur yang disediakan oleh solusi kami.
      
      1. Muat file XLSX ke dalam instansi Signature.
