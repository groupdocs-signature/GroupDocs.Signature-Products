...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Odt cez Java"
head_description: "Na overenie dokumentov Odt a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Odt"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Odt. Overenie elektronických podpisov vo vašich dokumentoch Odt môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Odt. Využite túto príležitosť bez implementácie dodatočného kódu.
