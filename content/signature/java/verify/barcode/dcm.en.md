...
############################# Head ############################
head_title: "Verification of Barcode signatures for Dcm files via Java"
head_description: "Use only a few lines of Java code to verify Dcm documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Dcm files"
description: "API for Java provides opportunity to verify Barcode signatures at Dcm documents. Verification of e-signatures inside your Dcm documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Barcode signatures in your Dcm document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like verification of Barcode signatures placed at Dcm documents. Use this opportunity without implementing extra code.
