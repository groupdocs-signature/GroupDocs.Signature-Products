...
############################# Head ############################
head_title: "Weryfikacja podpisów Barcode dla plików Ods przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Ods i ich podpisy Barcode."

############################# Header ############################
title: "Weryfikacja podpisów Barcode dla plików Ods"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Barcode w dokumentach Ods. Weryfikacja podpisów elektronicznych w dokumentach Ods może być przeprowadzona szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zweryfikować podpisy Barcode w dokumencie Ods?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Barcode umieszczonych w dokumentach Ods. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
