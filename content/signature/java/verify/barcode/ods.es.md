...
############################# Head ############################
head_title: "Verificación de Barcode firmas para Ods archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Ods y sus firmas Barcode."

############################# Header ############################
title: "Barcode verificación de firmas para Ods archivos"
description: "La API para Java brinda la oportunidad de verificar Barcode firmas en Ods documentos. La verificación de las firmas electrónicas dentro de sus documentos Ods se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Barcode firmas en su documento Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Barcode firmas colocadas en Ods documentos. Aproveche esta oportunidad sin implementar código adicional.
