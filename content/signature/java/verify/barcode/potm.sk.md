...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Potm cez Java"
head_description: "Na overenie dokumentov Potm a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Potm"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Potm. Overenie elektronických podpisov vo vašich dokumentoch Potm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Potm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Potm. Využite túto príležitosť bez implementácie dodatočného kódu.
