...
############################# Head ############################
head_title: "Verification of Barcode signatures for Ods files in Java"
head_description: "Use only a few lines of Java code to verify Ods documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Ods files"
description: "API for Java provides opportunity to verify Barcode signatures at Ods documents. Verification of e-signatures inside your Ods documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Barcode signatures in your Ods document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Barcode signatures placed at Ods documents. Use this opportunity without implementing extra code.
