...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Dot cez Java"
head_description: "Na overenie dokumentov Dot a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Dot"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Dot. Overenie elektronických podpisov vo vašich dokumentoch Dot môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Dot. Využite túto príležitosť bez implementácie dodatočného kódu.
