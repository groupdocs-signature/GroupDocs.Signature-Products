...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Doc cez Java"
head_description: "Na overenie dokumentov Doc a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Doc"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Doc. Overenie elektronických podpisov vo vašich dokumentoch Doc môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Doc. Využite túto príležitosť bez implementácie dodatočného kódu.
