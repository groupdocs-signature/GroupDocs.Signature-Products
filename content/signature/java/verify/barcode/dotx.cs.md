...
############################# Head ############################
head_title: "Ověření podpisů Barcode pro soubory Dotx prostřednictvím Java"
head_description: "Použijte pouze několik řádků kódu Java k ověření dokumentů Dotx a jejich podpisů Barcode."

############################# Header ############################
title: "Ověření podpisů Barcode pro soubory Dotx"
description: "API pro Java poskytuje příležitost ověřit podpisy Barcode v dokumentech Dotx. Ověření elektronických podpisů ve vašich dokumentech Dotx může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Barcode ve vašem dokumentu Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitečné funkce, jako je ověřování podpisů Barcode umístěných v dokumentech Dotx. Využijte tuto příležitost bez implementace dalšího kódu.
