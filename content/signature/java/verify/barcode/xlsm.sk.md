...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Xlsm cez Java"
head_description: "Na overenie dokumentov Xlsm a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Xlsm"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Xlsm. Overenie elektronických podpisov vo vašich dokumentoch Xlsm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Xlsm. Využite túto príležitosť bez implementácie dodatočného kódu.
