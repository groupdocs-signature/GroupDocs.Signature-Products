...
############################# Head ############################
head_title: "Verificação de assinaturas Barcode para arquivos Rtf via Java"
head_description: "Use apenas algumas linhas de código Java para verificar documentos Rtf e suas assinaturas Barcode."

############################# Header ############################
title: "Barcode verificação de assinaturas para Rtf arquivos"
description: "A API para Java oferece a oportunidade de verificar assinaturas Barcode em documentos Rtf. A verificação de assinaturas eletrônicas dentro de seus documentos Rtf pode ser realizada de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como validar assinaturas Barcode em seu documento Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis, como verificação de Barcode assinaturas colocadas em documentos Rtf. Use esta oportunidade sem implementar código extra.
