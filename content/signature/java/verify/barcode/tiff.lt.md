...
############################# Head ############################
head_title: "Barcode failų Tiff parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Tiff dokumentus ir jų Barcode parašus."

############################# Header ############################
title: "Barcode parašų patvirtinimas Tiff failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Barcode parašus Tiff dokumentuose. El. parašų patvirtinimas jūsų Tiff dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Barcode parašų, pateiktų Tiff dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
