...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Xlsb datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Xlsb dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Xlsb datoteke"
description: "API za Java pruža priliku za provjeru potpisa Barcode u dokumentima Xlsb. Provjera e-potpisa unutar vaših Xlsb dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Barcode u vašem Xlsb dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Xlsb. Iskoristite ovu priliku bez implementacije dodatnog koda.
