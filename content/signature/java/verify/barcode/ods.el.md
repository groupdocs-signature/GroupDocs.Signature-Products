...
description: "Το API για το Java παρέχει την ευκαιρία να επαληθεύσετε τις υπογραφές Barcode σε έγγραφα Ods. Η επαλήθευση των ηλεκτρονικών υπογραφών στα έγγραφά σας Ods μπορεί να πραγματοποιηθεί γρήγορα και εύκολα."
