...
############################# Head ############################
head_title: "Verification of Barcode signatures for Tar files via Java"
head_description: "Use only a few lines of Java code to verify Tar documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Tar files"
description: "API for Java provides opportunity to verify Barcode signatures at Tar documents. Verification of e-signatures inside your Tar documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Barcode signatures in your Tar document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) includes useful features like verification of Barcode signatures placed at Tar documents. Use this opportunity without implementing extra code.
