...
############################# Head ############################
head_title: "Preverjanje podpisov Barcode za datoteke Tar prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Tar in njihovih podpisov Barcode."

############################# Header ############################
title: "Preverjanje podpisov Barcode za datoteke Tar"
description: "API za Java ponuja možnost preverjanja podpisov Barcode v dokumentih Tar. Preverjanje e-podpisov v vaših Tar dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Barcode v dokumentu Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Barcode v dokumentih Tar. Izkoristite to priložnost brez implementacije dodatne kode.
