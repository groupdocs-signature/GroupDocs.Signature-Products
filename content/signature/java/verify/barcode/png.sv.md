...
description: "API för Java ger möjlighet att verifiera Barcode-signaturer i Png-dokument. Verifiering av e-signaturer i dina Png-dokument kan utföras snabbt och enkelt."
