...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Tiff cez Java"
head_description: "Na overenie dokumentov Tiff a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Tiff"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Tiff. Overenie elektronických podpisov vo vašich dokumentoch Tiff môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Tiff. Využite túto príležitosť bez implementácie dodatočného kódu.
