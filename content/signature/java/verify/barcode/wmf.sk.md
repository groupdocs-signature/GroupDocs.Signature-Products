...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Wmf cez Java"
head_description: "Na overenie dokumentov Wmf a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Wmf"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Wmf. Overenie elektronických podpisov vo vašich dokumentoch Wmf môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Wmf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Wmf. Využite túto príležitosť bez implementácie dodatočného kódu.
