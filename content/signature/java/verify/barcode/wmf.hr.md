...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Wmf datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Wmf dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Wmf datoteke"
description: "API za Java pruža priliku za provjeru potpisa Barcode u dokumentima Wmf. Provjera e-potpisa unutar vaših Wmf dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Barcode u vašem Wmf dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Wmf. Iskoristite ovu priliku bez implementacije dodatnog koda.
