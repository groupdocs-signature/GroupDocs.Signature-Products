...
############################# Head ############################
head_title: "Verifiering av Barcode-signaturer för Xls-filer via Java"
head_description: "Använd bara några rader med Java-kod för att verifiera Xls-dokument och deras Barcode-signaturer."

############################# Header ############################
title: "Barcode signaturverifiering för Xls-filer"
description: "API för Java ger möjlighet att verifiera Barcode-signaturer i Xls-dokument. Verifiering av e-signaturer i dina Xls-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Barcode-signaturer i ditt Xls-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) innehåller användbara funktioner som verifiering av Barcode-signaturer placerade i Xls-dokument. Använd denna möjlighet utan att implementera extra kod.
