...
############################# Head ############################
head_title: "Verificación de Barcode firmas para Rtf archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Rtf y sus firmas Barcode."

############################# Header ############################
title: "Barcode verificación de firmas para Rtf archivos"
description: "La API para Java brinda la oportunidad de verificar Barcode firmas en Rtf documentos. La verificación de las firmas electrónicas dentro de sus documentos Rtf se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Barcode firmas colocadas en Rtf documentos. Aproveche esta oportunidad sin implementar código adicional.
