...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Xlsb cez Java"
head_description: "Na overenie dokumentov Xlsb a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Xlsb"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Xlsb. Overenie elektronických podpisov vo vašich dokumentoch Xlsb môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Xlsb. Využite túto príležitosť bez implementácie dodatočného kódu.
