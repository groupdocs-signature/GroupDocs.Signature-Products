...
############################# Head ############################
head_title: "Verification of Barcode signatures for Pdf files in Java"
head_description: "Use only a few lines of Java code to verify Pdf documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Pdf files"
description: "API for Java provides opportunity to verify Barcode signatures at Pdf documents. Verification of e-signatures inside your Pdf documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Barcode signatures placed at Pdf documents. Use this opportunity without implementing extra code.
