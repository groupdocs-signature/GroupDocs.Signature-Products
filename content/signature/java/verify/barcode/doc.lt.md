...
############################# Head ############################
head_title: "Barcode failų Doc parašų patvirtinimas naudojant Java"
head_description: "Naudokite tik kelias Java kodo eilutes, kad patikrintumėte Doc dokumentus ir jų Barcode parašus."

############################# Header ############################
title: "Barcode parašų patvirtinimas Doc failams"
description: "API, skirta Java, suteikia galimybę patvirtinti Barcode parašus Doc dokumentuose. El. parašų patvirtinimas jūsų Doc dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Barcode parašus Doc dokumente"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) apima naudingas funkcijas, pvz., Barcode parašų, pateiktų Doc dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
