...
############################# Head ############################
head_title: "Verificación de Barcode firmas para Odt archivos a través de Java"
head_description: "Use solo unas pocas líneas de código Java para verificar los documentos Odt y sus firmas Barcode."

############################# Header ############################
title: "Barcode verificación de firmas para Odt archivos"
description: "La API para Java brinda la oportunidad de verificar Barcode firmas en Odt documentos. La verificación de las firmas electrónicas dentro de sus documentos Odt se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) incluye funciones útiles como la verificación de Barcode firmas colocadas en Odt documentos. Aproveche esta oportunidad sin implementar código adicional.
