...
############################# Head ############################
head_title: "Verifikasie van Barcode handtekeninge vir Png lêers via Java"
head_description: "Gebruik slegs 'n paar reëls van Java-kode om Png-dokumente en hul Barcode-handtekeninge te verifieer."

############################# Header ############################
title: "Barcode handtekeningverifikasie vir Png lêers"
description: "API vir Java bied geleentheid om Barcode handtekeninge by Png dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Png dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) sluit nuttige kenmerke in soos verifikasie van Barcode-handtekeninge wat by Png-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
