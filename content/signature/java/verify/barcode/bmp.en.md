...
############################# Head ############################
head_title: "Verification of Barcode signatures for Bmp files in Java"
head_description: "Use only a few lines of Java code to verify Bmp documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Bmp files"
description: "API for Java provides opportunity to verify Barcode signatures at Bmp documents. Verification of e-signatures inside your Bmp documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Barcode signatures in your Bmp document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Barcode signatures placed at Bmp documents. Use this opportunity without implementing extra code.
...
demos:
    ...
    content: |
       Add various electronic signatures to Bmp file right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.          
