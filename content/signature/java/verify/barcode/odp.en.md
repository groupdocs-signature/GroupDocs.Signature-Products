...
############################# Head ############################
head_title: "Verification of Barcode signatures for Odp files in Java"
head_description: "Use only a few lines of Java code to verify Odp documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Odp files"
description: "API for Java provides opportunity to verify Barcode signatures at Odp documents. Verification of e-signatures inside your Odp documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Barcode signatures placed at Odp documents. Use this opportunity without implementing extra code.
