...
############################# Head ############################
head_title: "Verification of Barcode signatures for Dot files in Java"
head_description: "Use only a few lines of Java code to verify Dot documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Dot files"
description: "API for Java provides opportunity to verify Barcode signatures at Dot documents. Verification of e-signatures inside your Dot documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Barcode signatures in your Dot document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Barcode signatures placed at Dot documents. Use this opportunity without implementing extra code.
