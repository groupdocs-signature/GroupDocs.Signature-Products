...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Odp cez Java"
head_description: "Na overenie dokumentov Odp a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Odp"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Odp. Overenie elektronických podpisov vo vašich dokumentoch Odp môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Odp. Využite túto príležitosť bez implementácie dodatočného kódu.
