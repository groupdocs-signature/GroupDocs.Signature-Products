...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Ods datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Ods dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Ods datoteke"
description: "API za Java pruža priliku za provjeru potpisa Barcode u dokumentima Ods. Provjera e-potpisa unutar vaših Ods dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Barcode u vašem Ods dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Ods. Iskoristite ovu priliku bez implementacije dodatnog koda.
