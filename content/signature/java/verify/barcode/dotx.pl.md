...
############################# Head ############################
head_title: "Weryfikacja podpisów Barcode dla plików Dotx przez Java"
head_description: "Użyj tylko kilku wierszy kodu Java, aby zweryfikować dokumenty Dotx i ich podpisy Barcode."

############################# Header ############################
title: "Weryfikacja podpisów Barcode dla plików Dotx"
description: "Interfejs API dla Java umożliwia weryfikację podpisów Barcode w dokumentach Dotx. Weryfikacja podpisów elektronicznych w dokumentach Dotx może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Barcode umieszczonych w dokumentach Dotx. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
