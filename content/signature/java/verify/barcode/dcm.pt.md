...
############################# Head ############################
head_title: "Verificação de assinaturas Barcode para arquivos Dcm via Java"
head_description: "Use apenas algumas linhas de código Java para verificar documentos Dcm e suas assinaturas Barcode."

############################# Header ############################
title: "Barcode verificação de assinaturas para Dcm arquivos"
description: "A API para Java oferece a oportunidade de verificar assinaturas Barcode em documentos Dcm. A verificação de assinaturas eletrônicas dentro de seus documentos Dcm pode ser realizada de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como validar assinaturas Barcode em seu documento Dcm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) inclui recursos úteis, como verificação de Barcode assinaturas colocadas em documentos Dcm. Use esta oportunidade sem implementar código extra.
