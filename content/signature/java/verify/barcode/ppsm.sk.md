...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Ppsm cez Java"
head_description: "Na overenie dokumentov Ppsm a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Ppsm"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Ppsm. Overenie elektronických podpisov vo vašich dokumentoch Ppsm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Ppsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Ppsm. Využite túto príležitosť bez implementácie dodatočného kódu.
