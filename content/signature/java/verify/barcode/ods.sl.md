...
############################# Head ############################
head_title: "Preverjanje podpisov Barcode za datoteke Ods prek Java"
head_description: "Uporabite samo nekaj vrstic kode Java za preverjanje dokumentov Ods in njihovih podpisov Barcode."

############################# Header ############################
title: "Preverjanje podpisov Barcode za datoteke Ods"
description: "API za Java ponuja možnost preverjanja podpisov Barcode v dokumentih Ods. Preverjanje e-podpisov v vaših Ods dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Barcode v dokumentu Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) vključuje uporabne funkcije, kot je preverjanje podpisov Barcode v dokumentih Ods. Izkoristite to priložnost brez implementacije dodatne kode.
