...
############################# Head ############################
head_title: "Verification of Barcode signatures for Tiff files in Java"
head_description: "Use only a few lines of Java code to verify Tiff documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Tiff files"
description: "API for Java provides opportunity to verify Barcode signatures at Tiff documents. Verification of e-signatures inside your Tiff documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) for Java includes useful features like verification of Barcode signatures placed at Tiff documents. Use this opportunity without implementing extra code.
