...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Dot datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Dot dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Dot datoteke"
description: "API za Java pruža priliku za provjeru potpisa Barcode u dokumentima Dot. Provjera e-potpisa unutar vaših Dot dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Barcode u vašem Dot dokumentu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Dot. Iskoristite ovu priliku bez implementacije dodatnog koda.
