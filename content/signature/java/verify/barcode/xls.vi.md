...
############################# Head ############################
head_title: "Xác minh chữ ký Barcode cho tệp Xls qua Java"
head_description: "Chỉ sử dụng một vài dòng mã Java để xác minh tài liệu Xls và chữ ký Barcode của chúng."

############################# Header ############################
title: "Xác minh chữ ký Barcode cho các tệp Xls"
description: "API cho Java cung cấp cơ hội xác minh chữ ký Barcode tại tài liệu Xls. Việc xác minh chữ ký điện tử bên trong tài liệu Xls của bạn có thể được thực hiện nhanh chóng và dễ dàng."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) bao gồm các tính năng hữu ích như xác minh chữ ký Barcode được đặt trong tài liệu Xls. Sử dụng cơ hội này mà không cần triển khai thêm mã.
