...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Odt datoteke putem Java"
head_description: "Upotrijebite samo nekoliko redaka Java koda za provjeru Odt dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Odt datoteke"
description: "API za Java pruža priliku za provjeru potpisa Barcode u dokumentima Odt. Provjera e-potpisa unutar vaših Odt dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Odt. Iskoristite ovu priliku bez implementacije dodatnog koda.
