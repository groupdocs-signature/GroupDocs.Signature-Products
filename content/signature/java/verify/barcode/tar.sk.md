...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Tar cez Java"
head_description: "Na overenie dokumentov Tar a ich podpisov Barcode použite iba niekoľko riadkov kódu Java."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Tar"
description: "API pre Java poskytuje možnosť overiť podpisy Barcode v dokumentoch Tar. Overenie elektronických podpisov vo vašich dokumentoch Tar môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Tar. Využite túto príležitosť bez implementácie dodatočného kódu.
