...
############################# Head ############################
head_title: "通过 Java 验证 Docm 文件的 Barcode 签名"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) 包括有用的功能，例如验证放置在 Docm 文档中的 Barcode 签名。利用这个机会，无需实现额外的代码。
