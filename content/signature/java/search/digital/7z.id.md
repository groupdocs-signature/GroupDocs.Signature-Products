...
############################# Head ############################
head_title: "Cari tanda tangan Digital dalam file 7z di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Digital di file 7z menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Digital di file 7z"
description: "Java API asli memungkinkan untuk mencari Digital tanda tangan di file 7z yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen 7z Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Digital di 7z"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Digital dalam file 7z dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
