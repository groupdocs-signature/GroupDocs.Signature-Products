...
############################# Head ############################
head_title: "Cerqueu signatures de Digital al fitxer Dot a Java"
head_description: "Utilitzeu Java per cercar signatures Digital als fitxers Dot mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Digital al fitxer Dot"
description: "L'API nativa de Java permet cercar signatures Digital als fitxers Dot ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Dot amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Digital a Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Digital als fitxers Dot des de les seves aplicacions implementant uns quants passos senzills.
