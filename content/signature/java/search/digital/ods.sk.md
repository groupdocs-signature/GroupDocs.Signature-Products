...
############################# Head ############################
head_title: "Vyhľadajte podpisy Digital v súbore Ods v Java"
head_description: "Použite Java na vyhľadávanie Digital podpisov v súboroch Ods pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Digital v súbore Ods"
description: "Natívne API Java umožňuje vyhľadávať podpisy Digital v už podpísaných súboroch Ods. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Ods pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Digital v Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Digital v súboroch Ods z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
