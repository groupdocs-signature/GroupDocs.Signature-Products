...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Xls u Java"
head_description: "Upotrijebite Java za traženje potpisa Digital u datotekama Xls pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Xls datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Digital u već potpisanim Xls datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xls dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Digital potpise u Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Digital u datotekama Xls iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
