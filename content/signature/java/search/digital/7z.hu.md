...
############################# Head ############################
head_title: "Keressen Digital aláírásokat a 7z fájlban a Java programban"
head_description: "A Java használatával kereshet Digital aláírásokat a 7z fájlokban néhány sornyi kód használatával."

############################# Header ############################
title: "Keressen Digital aláírásokat a 7z fájlban"
description: "A Java natív API lehetővé teszi a Digital aláírások keresését a már aláírt 7z fájlokban. Végezzen speciális e-aláírás-keresést a 7z dokumentumaiban néhány sornyi kód használatával."
...
steps:
    enable: true
    title_left: "Digital aláírások keresése a 7z fájlban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy Digital aláírásokat keressenek alkalmazásaik 7z fájljaiban.
