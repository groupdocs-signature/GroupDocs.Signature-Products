...
############################# Head ############################
head_title: "Rechercher les signatures Digital dans le fichier Xltx dans Java"
head_description: "Utilisez Java pour rechercher des signatures Digital dans des fichiers Xltx en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Digital dans le fichier Xltx"
description: "L'API native Java permet de rechercher des signatures Digital dans des fichiers Xltx déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Xltx en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Digital dans Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Digital dans des fichiers Xltx à partir de leurs applications en mettant en œuvre quelques étapes simples.
