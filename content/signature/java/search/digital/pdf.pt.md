...
############################# Head ############################
head_title: "Procure por assinaturas Digital no arquivo Pdf em Java"
head_description: "Use Java para pesquisar assinaturas Digital em arquivos Pdf usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Digital no arquivo Pdf"
description: "A API nativa do Java permite pesquisar assinaturas Digital em arquivos Pdf já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Pdf usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Digital em Pdf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Digital em arquivos Pdf de seus aplicativos implementando algumas etapas fáceis.
