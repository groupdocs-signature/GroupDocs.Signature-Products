...
############################# Head ############################
head_title: "Vyhľadajte podpisy Digital v súbore Xls v Java"
head_description: "Použite Java na vyhľadávanie Digital podpisov v súboroch Xls pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Digital v súbore Xls"
description: "Natívne API Java umožňuje vyhľadávať podpisy Digital v už podpísaných súboroch Xls. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Xls pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Digital v súboroch Xls z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
