...
############################# Head ############################
head_title: "Procure por assinaturas Digital no arquivo Docx em Java"
head_description: "Use Java para pesquisar assinaturas Digital em arquivos Docx usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Digital no arquivo Docx"
description: "A API nativa do Java permite pesquisar assinaturas Digital em arquivos Docx já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Docx usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Digital em Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Digital em arquivos Docx de seus aplicativos implementando algumas etapas fáceis.
