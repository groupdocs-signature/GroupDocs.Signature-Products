...
############################# Head ############################
head_title: "Шукайте підписи Digital у файлі Xlsx у Java"
head_description: "Використовуйте Java для пошуку підписів Digital у файлах Xlsx за допомогою кількох рядків коду."

############################# Header ############################
title: "Шукайте підписи Digital у файлі Xlsx"
description: "Власний API Java дозволяє шукати підписи Digital у вже підписаних файлах Xlsx. Виконайте розширений пошук електронного підпису в документах Xlsx за допомогою кількох рядків коду."
...
steps:
    enable: true
    title_left: "Як шукати підписи Digital у Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) полегшує розробникам Java пошук підписів Digital у файлах Xlsx у їхніх програмах, виконавши кілька простих кроків.
