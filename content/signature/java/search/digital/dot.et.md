...
############################# Head ############################
head_title: "Otsige allkirju Digital failist Dot rakenduses Java"
head_description: "Kasutage Java allkirjade Digital otsimiseks failides Dot, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Digital allkirju Dot"
description: "Native API Java võimaldab otsida allkirju Digital juba allkirjastatud Dot failides. Tehke oma Dot dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Digital otsimist oma rakendustest failides Dot, rakendades mõnda lihtsat sammu.
