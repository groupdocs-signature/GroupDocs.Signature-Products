...
############################# Head ############################
head_title: "Cuardaigh Digital síniú i gcomhad Ots i Java"
head_description: "Úsáid Java chun sínithe Digital a chuardach i gcomhaid Ots ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Digital sínithe i gcomhad Ots"
...
steps:
    enable: true
    title_left: "Conas síniú Digital a chuardach i Ots"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Digital i gcomhaid Ots óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
