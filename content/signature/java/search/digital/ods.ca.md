...
############################# Head ############################
head_title: "Cerqueu signatures de Digital al fitxer Ods a Java"
head_description: "Utilitzeu Java per cercar signatures Digital als fitxers Ods mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Digital al fitxer Ods"
description: "L'API nativa de Java permet cercar signatures Digital als fitxers Ods ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Ods amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Digital a Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Digital als fitxers Ods des de les seves aplicacions implementant uns quants passos senzills.
