...
############################# Head ############################
head_title: "Rechercher les signatures Digital dans le fichier Dot dans Java"
head_description: "Utilisez Java pour rechercher des signatures Digital dans des fichiers Dot en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Digital dans le fichier Dot"
description: "L'API native Java permet de rechercher des signatures Digital dans des fichiers Dot déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Dot en utilisant quelques lignes de code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Digital dans des fichiers Dot à partir de leurs applications en mettant en œuvre quelques étapes simples.
