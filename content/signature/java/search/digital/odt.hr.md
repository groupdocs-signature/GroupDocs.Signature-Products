...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Odt u Java"
head_description: "Upotrijebite Java za traženje potpisa Digital u datotekama Odt pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Odt datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Digital u već potpisanim Odt datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Odt dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Digital potpise u Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Digital u datotekama Odt iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
