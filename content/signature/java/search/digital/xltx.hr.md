...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Xltx u Java"
head_description: "Upotrijebite Java za traženje potpisa Digital u datotekama Xltx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Xltx datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Digital u već potpisanim Xltx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xltx dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Digital u datotekama Xltx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
