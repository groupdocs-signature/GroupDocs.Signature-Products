...
############################# Head ############################
head_title: "Wyszukaj podpisy Digital w pliku Pptm w Java"
head_description: "Użyj Java do wyszukiwania podpisów Digital w plikach Pptm przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Digital w pliku Pptm"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Digital w już podpisanych plikach Pptm. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Pptm, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Digital w plikach Pptm z ich aplikacji, wykonując kilka prostych kroków.
