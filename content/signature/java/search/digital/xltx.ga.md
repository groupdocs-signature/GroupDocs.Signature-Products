...
############################# Head ############################
head_title: "Cuardaigh Digital síniú i gcomhad Xltx i Java"
head_description: "Úsáid Java chun sínithe Digital a chuardach i gcomhaid Xltx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Digital sínithe i gcomhad Xltx"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Digital sínithe i gcomhaid Xltx atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Xltx ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Digital a chuardach i Xltx"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Digital i gcomhaid Xltx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
