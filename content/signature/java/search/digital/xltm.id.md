...
############################# Head ############################
head_title: "Cari tanda tangan Digital dalam file Xltm di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Digital di file Xltm menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Digital di file Xltm"
description: "Java API asli memungkinkan untuk mencari Digital tanda tangan di file Xltm yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xltm Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Digital dalam file Xltm dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
