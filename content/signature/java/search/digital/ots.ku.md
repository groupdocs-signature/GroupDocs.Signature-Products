...
############################# Head ############################
head_title: "Li Digital îmzeyan di pela Ots de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Digital di pelên Ots de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Ots de li îmzeyên Digital bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Ots yên jixwe îmzekirî de li îmzeyên Digital bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Ots de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Digital di Ots de digere"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Digital di pelên Ots îmzeyan de ji sepanên xwe bigerin.
