...
############################# Head ############################
head_title: "Search for Digital signatures in Xltx file in Java"
head_description: "Use Java for searching for Digital signatures in Xltx files using a few lines of code."

############################# Header ############################
title: "Search for Digital signatures in Xltx file"
description: "Java native API allows to search for Digital signatures in already signed Xltx files. Perform advanced e-signature search within your Xltx documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Digital signatures in Xltx files from their applications by implementing a few easy steps.
