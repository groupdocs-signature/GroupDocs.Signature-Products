...
############################# Head ############################
head_title: "Cuardaigh Digital síniú i gcomhad Ods i Java"
head_description: "Úsáid Java chun sínithe Digital a chuardach i gcomhaid Ods ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Digital sínithe i gcomhad Ods"
...
steps:
    enable: true
    title_left: "Conas síniú Digital a chuardach i Ods"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Digital i gcomhaid Ods óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
