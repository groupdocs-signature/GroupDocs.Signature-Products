...
############################# Head ############################
head_title: "Ieškokite Digital parašų Xltm faile Java"
head_description: "Naudokite Java, norėdami ieškoti Digital parašų Xltm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Xltm faile"
description: "Java savoji API leidžia ieškoti Digital parašų jau pasirašytuose Xltm failuose. Atlikite išplėstinę el. parašo paiešką savo Xltm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Digital parašų Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Digital parašų Xltm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
