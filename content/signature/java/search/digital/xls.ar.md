...
############################# Head ############################
head_title: "ابحث عن توقيعات Digital في ملف Xls في Java"
head_description: "استخدم Java للبحث عن توقيعات Digital في ملفات Xls باستخدام بضعة أسطر من التعليمات البرمجية."

############################# Header ############################
title: "ابحث عن توقيعات Digital في ملف Xls"
description: "تسمح واجهة برمجة التطبيقات الأصلية لـ Java بالبحث عن توقيعات Digital في ملفات Xls الموقعة بالفعل. قم بإجراء بحث متقدم عن التوقيع الإلكتروني داخل مستندات Xls باستخدام بضعة أسطر من التعليمات البرمجية."
...
steps:
    enable: true
    title_left: "كيفية البحث عن توقيعات Digital في Xls"
    content_left: |
        يسهّل [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) على مطوري Java البحث عن توقيعات Digital في ملفات Xls من تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
