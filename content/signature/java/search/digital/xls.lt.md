...
############################# Head ############################
head_title: "Ieškokite Digital parašų Xls faile Java"
head_description: "Naudokite Java, norėdami ieškoti Digital parašų Xls failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Xls faile"
description: "Java savoji API leidžia ieškoti Digital parašų jau pasirašytuose Xls failuose. Atlikite išplėstinę el. parašo paiešką savo Xls dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Digital parašų Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Digital parašų Xls failuose iš savo programų, atlikdami kelis paprastus veiksmus.
