...
############################# Head ############################
head_title: "Otsige allkirju Digital failist Xltm rakenduses Java"
head_description: "Kasutage Java allkirjade Digital otsimiseks failides Xltm, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Digital allkirju Xltm"
description: "Native API Java võimaldab otsida allkirju Digital juba allkirjastatud Xltm failides. Tehke oma Xltm dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Digital otsimine failivormingus Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Digital otsimist oma rakendustest failides Xltm, rakendades mõnda lihtsat sammu.
