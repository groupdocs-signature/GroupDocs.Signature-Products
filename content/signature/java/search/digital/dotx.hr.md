...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Dotx u Java"
head_description: "Upotrijebite Java za traženje potpisa Digital u datotekama Dotx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Dotx datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Digital u već potpisanim Dotx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Dotx dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Digital u datotekama Dotx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
