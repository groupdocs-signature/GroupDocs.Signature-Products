...
description: "Java se inheemse API laat toe om vir Digital handtekeninge te soek in reeds ondertekende Xlsx lêers. Voer gevorderde e-handtekeningsoektog binne jou Xlsx dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    enable: true
    title_left: "Hoe om te soek vir Digital handtekeninge in Xlsx"
    content_left: |
