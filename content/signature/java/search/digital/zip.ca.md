...
############################# Head ############################
head_title: "Cerqueu signatures de Digital al fitxer Zip a Java"
head_description: "Utilitzeu Java per cercar signatures Digital als fitxers Zip mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Digital al fitxer Zip"
description: "L'API nativa de Java permet cercar signatures Digital als fitxers Zip ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Zip amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Digital a Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Digital als fitxers Zip des de les seves aplicacions implementant uns quants passos senzills.
