...
############################# Head ############################
head_title: "Vyhľadajte podpisy Digital v súbore Xlsb v Java"
head_description: "Použite Java na vyhľadávanie Digital podpisov v súboroch Xlsb pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Digital v súbore Xlsb"
description: "Natívne API Java umožňuje vyhľadávať podpisy Digital v už podpísaných súboroch Xlsb. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Xlsb pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Digital v Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Digital v súboroch Xlsb z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
