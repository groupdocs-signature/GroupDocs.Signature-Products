...
############################# Head ############################
head_title: "Cuardaigh Digital síniú i gcomhad Dotx i Java"
head_description: "Úsáid Java chun sínithe Digital a chuardach i gcomhaid Dotx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Digital sínithe i gcomhad Dotx"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Digital sínithe i gcomhaid Dotx atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Dotx ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Digital a chuardach i Dotx"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Digital i gcomhaid Dotx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
