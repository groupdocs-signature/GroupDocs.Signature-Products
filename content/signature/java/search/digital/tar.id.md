...
############################# Head ############################
head_title: "Cari tanda tangan Digital dalam file Tar di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Digital di file Tar menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Digital di file Tar"
description: "Java API asli memungkinkan untuk mencari Digital tanda tangan di file Tar yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Tar Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Digital di Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Digital dalam file Tar dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
