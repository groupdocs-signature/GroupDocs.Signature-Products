...
############################# Head ############################
head_title: "Cari tanda tangan Digital dalam file Doc di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Digital di file Doc menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Digital di file Doc"
description: "Java API asli memungkinkan untuk mencari Digital tanda tangan di file Doc yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Doc Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Digital di Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Digital dalam file Doc dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
