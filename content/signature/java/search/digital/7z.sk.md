...
############################# Head ############################
head_title: "Vyhľadajte podpisy Digital v súbore 7z v Java"
head_description: "Použite Java na vyhľadávanie Digital podpisov v súboroch 7z pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Digital v súbore 7z"
description: "Natívne API Java umožňuje vyhľadávať podpisy Digital v už podpísaných súboroch 7z. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch 7z pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Digital v 7z"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Digital v súboroch 7z z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
