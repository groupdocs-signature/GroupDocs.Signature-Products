...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Ods u Java"
head_description: "Upotrijebite Java za traženje potpisa Digital u datotekama Ods pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Ods datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Digital u već potpisanim Ods datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ods dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Digital potpise u Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Digital u datotekama Ods iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
