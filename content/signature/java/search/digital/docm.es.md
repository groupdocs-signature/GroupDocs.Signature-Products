...
############################# Head ############################
head_title: "Busque Digital firmas en Docm archivo en Java"
head_description: "Use Java para buscar firmas Digital en archivos Docm usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Digital en el archivo Docm"
description: "Java API nativa permite buscar Digital firmas en archivos Docm ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Docm utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Digital en Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Digital en archivos Docm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
...
demos:
    enable: true
    title: "Buscar Digital firmas electrónicas Demostración en vivo"
    content: |
       Busque en el documento varias firmas electrónicas para archivos Docm ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).

        
############################# More Formats ############################
more_formats:
    enable: true
    title: "Busque otras firmas Digital usando Java"
    content: |
