...
############################# Head ############################
head_title: "Ieškokite Digital parašų 7z faile Java"
head_description: "Naudokite Java, norėdami ieškoti Digital parašų 7z failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų 7z faile"
description: "Java savoji API leidžia ieškoti Digital parašų jau pasirašytuose 7z failuose. Atlikite išplėstinę el. parašo paiešką savo 7z dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Digital parašų 7z"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Digital parašų 7z failuose iš savo programų, atlikdami kelis paprastus veiksmus.
