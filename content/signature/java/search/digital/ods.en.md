...
############################# Head ############################
head_title: "Search Digital signatures in Ods file in Java"
head_description: "Use Java for searching Digital signatures in Ods files using a few lines of code."

############################# Header ############################
title: "Search Digital signatures in Ods file"
description: "Java native API to search Digital signatures in already signed Ods file. Perform advanced e-signature operations within your Ods documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Digital signatures in Ods files from within their applications by implementing a few easy steps.
