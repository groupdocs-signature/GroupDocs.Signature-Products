...
############################# Head ############################
head_title: "Ieškokite Digital parašų Ods faile Java"
head_description: "Naudokite Java, norėdami ieškoti Digital parašų Ods failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Ods faile"
description: "Java savoji API leidžia ieškoti Digital parašų jau pasirašytuose Ods failuose. Atlikite išplėstinę el. parašo paiešką savo Ods dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Digital parašų Ods failuose iš savo programų, atlikdami kelis paprastus veiksmus.
