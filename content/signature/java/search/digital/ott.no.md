...
############################# Head ############################
head_title: "Søk etter Digital-signaturer i filen Ott i Java"
head_description: "Bruk Java for å søke etter Digital-signaturer i Ott-filer ved å bruke noen få linjer med kode."

############################# Header ############################
title: "Søk etter Digital-signaturer i filen Ott"
description: "Java native API gjør det mulig å søke etter Digital-signaturer i allerede signerte Ott-filer. Utfør avansert e-signatursøk i Ott-dokumentene dine ved å bruke noen få linjer med kode."
...
steps:
    enable: true
    title_left: "Slik søker du etter Digital-signaturer i Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gjør det enklere for Java-utviklere å søke etter Digital-signaturer i Ott-filer fra applikasjonene deres ved å implementere noen få enkle trinn.
