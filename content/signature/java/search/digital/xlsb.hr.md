...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Xlsb u Java"
head_description: "Upotrijebite Java za traženje potpisa Digital u datotekama Xlsb pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Xlsb datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Digital u već potpisanim Xlsb datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xlsb dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Digital u datotekama Xlsb iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
