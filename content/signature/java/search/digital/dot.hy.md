...
############################# Head ############################
head_title: "Որոնեք Digital ստորագրությունները Dot ֆայլում Java-ում"
head_description: "Օգտագործեք Java՝ Digital ստորագրությունները Dot ֆայլերում մի քանի տող կոդով որոնելու համար:"

############################# Header ############################
title: "Փնտրեք Digital ստորագրությունները Dot ֆայլում"
description: "Java բնօրինակ API-ն թույլ է տալիս որոնել Digital ստորագրություններ արդեն ստորագրված Dot ֆայլերում: Կատարեք էլեկտրոնային ստորագրության առաջադեմ որոնում ձեր Dot փաստաթղթերում՝ օգտագործելով մի քանի տող կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես որոնել Digital ստորագրությունները Dot-ում"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հեշտացնում է Java ծրագրավորողների համար որոնել Digital ստորագրությունները Dot ֆայլերում իրենց հավելվածներից` իրականացնելով մի քանի հեշտ քայլեր:
