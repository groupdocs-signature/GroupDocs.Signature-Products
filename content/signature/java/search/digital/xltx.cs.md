...
############################# Head ############################
head_title: "Vyhledejte podpisy Digital v souboru Xltx v Java"
head_description: "Použijte Java k vyhledávání podpisů Digital v souborech Xltx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Digital v souboru Xltx"
description: "Nativní API Java umožňuje vyhledávat podpisy Digital v již podepsaných souborech Xltx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Xltx pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Digital v souborech Xltx z jejich aplikací implementací několika snadných kroků.
