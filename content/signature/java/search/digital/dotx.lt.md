...
############################# Head ############################
head_title: "Ieškokite Digital parašų Dotx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Digital parašų Dotx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Dotx faile"
description: "Java savoji API leidžia ieškoti Digital parašų jau pasirašytuose Dotx failuose. Atlikite išplėstinę el. parašo paiešką savo Dotx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Digital parašų Dotx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
