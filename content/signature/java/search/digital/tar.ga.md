...
############################# Head ############################
head_title: "Cuardaigh Digital síniú i gcomhad Tar i Java"
head_description: "Úsáid Java chun sínithe Digital a chuardach i gcomhaid Tar ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Digital sínithe i gcomhad Tar"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Digital sínithe i gcomhaid Tar atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Tar ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Digital i gcomhaid Tar óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
