...
############################# Head ############################
head_title: "Otsige allkirju Digital failist Xlsb rakenduses Java"
head_description: "Kasutage Java allkirjade Digital otsimiseks failides Xlsb, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Digital allkirju Xlsb"
description: "Native API Java võimaldab otsida allkirju Digital juba allkirjastatud Xlsb failides. Tehke oma Xlsb dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Digital otsimine failivormingus Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Digital otsimist oma rakendustest failides Xlsb, rakendades mõnda lihtsat sammu.
