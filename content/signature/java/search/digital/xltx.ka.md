...
############################# Head ############################
head_title: "მოძებნეთ Digital ხელმოწერები Xltx ფაილში Java"
head_description: "გამოიყენეთ Java Digital ხელმოწერების მოსაძიებლად Xltx ფაილებში კოდის რამდენიმე ხაზის გამოყენებით."

############################# Header ############################
title: "მოძებნეთ Digital ხელმოწერები Xltx ფაილში"
description: "Java მშობლიური API საშუალებას გაძლევთ მოძებნოთ Digital ხელმოწერები უკვე ხელმოწერილ Xltx ფაილებში. განახორციელეთ ელექტრონული ხელმოწერის გაფართოებული ძიება თქვენს {{ფაილის ფორმატში}} დოკუმენტებში კოდის რამდენიმე ხაზის გამოყენებით."
...
steps:
    enable: true
    title_left: "როგორ მოძებნოთ Digital ხელმოწერები Xltx-ში"
    content_left: |
