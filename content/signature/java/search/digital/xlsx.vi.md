...
############################# Head ############################
head_title: "Tìm kiếm chữ ký Digital trong tệp Xlsx trong Java"
head_description: "Sử dụng Java để tìm kiếm chữ ký Digital trong tệp Xlsx bằng một vài dòng mã."

############################# Header ############################
title: "Tìm kiếm chữ ký Digital trong tệp Xlsx"
description: "API gốc Java cho phép tìm kiếm chữ ký Digital trong các tệp Xlsx đã được ký. Thực hiện tìm kiếm chữ ký điện tử nâng cao trong tài liệu Xlsx của bạn bằng cách sử dụng một vài dòng mã."
...
steps:
    enable: true
    title_left: "Cách tìm kiếm chữ ký Digital trong Xlsx"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) giúp các nhà phát triển Java tìm kiếm chữ ký Digital trong tệp Xlsx từ ứng dụng của họ dễ dàng hơn bằng cách thực hiện một vài bước đơn giản.
...
demos:
    ...
    content: |
       Tìm kiếm tài liệu để tìm các chữ ký điện tử khác nhau cho các tệp Xlsx ngay bây giờ bằng cách truy cập trang web [GroupDocs.Signature App] (https://products.groupdocs.app/signature/family).
