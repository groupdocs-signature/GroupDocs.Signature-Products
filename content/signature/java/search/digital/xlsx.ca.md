...
############################# Head ############################
head_title: "Cerqueu signatures de Digital al fitxer Xlsx a Java"
head_description: "Utilitzeu Java per cercar signatures Digital als fitxers Xlsx mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Digital al fitxer Xlsx"
description: "L'API nativa de Java permet cercar signatures Digital als fitxers Xlsx ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Xlsx amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Digital als fitxers Xlsx des de les seves aplicacions implementant uns quants passos senzills.
