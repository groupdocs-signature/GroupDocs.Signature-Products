...
############################# Head ############################
head_title: "Cuardaigh Digital síniú i gcomhad Xlsb i Java"
head_description: "Úsáid Java chun sínithe Digital a chuardach i gcomhaid Xlsb ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Digital sínithe i gcomhad Xlsb"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Xlsb ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Digital a chuardach i Xlsb"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Digital i gcomhaid Xlsb óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
