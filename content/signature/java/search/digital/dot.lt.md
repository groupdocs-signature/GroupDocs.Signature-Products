...
############################# Head ############################
head_title: "Ieškokite Digital parašų Dot faile Java"
head_description: "Naudokite Java, norėdami ieškoti Digital parašų Dot failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Dot faile"
description: "Java savoji API leidžia ieškoti Digital parašų jau pasirašytuose Dot failuose. Atlikite išplėstinę el. parašo paiešką savo Dot dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Digital parašų Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Digital parašų Dot failuose iš savo programų, atlikdami kelis paprastus veiksmus.
