...
############################# Head ############################
head_title: "Li Digital îmzeyan di pela Zip de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Digital di pelên Zip de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Zip de li îmzeyên Digital bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Zip yên jixwe îmzekirî de li îmzeyên Digital bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Zip de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Digital di pelên Zip îmzeyan de ji sepanên xwe bigerin.
