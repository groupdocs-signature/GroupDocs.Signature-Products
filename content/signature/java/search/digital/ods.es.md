...
############################# Head ############################
head_title: "Busque Digital firmas en Ods archivo en Java"
head_description: "Use Java para buscar firmas Digital en archivos Ods usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Digital en el archivo Ods"
description: "Java API nativa permite buscar Digital firmas en archivos Ods ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Ods utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Digital en archivos Ods desde sus aplicaciones mediante la implementación de unos sencillos pasos.
