...
############################# Head ############################
head_title: "Search for Digital signatures in Dot file in Java"
head_description: "Use Java for searching for Digital signatures in Dot files using a few lines of code."

############################# Header ############################
title: "Search for Digital signatures in Dot file"
description: "Java native API allows to search for Digital signatures in already signed Dot files. Perform advanced e-signature search within your Dot documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Digital signatures in Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Digital signatures in Dot files from their applications by implementing a few easy steps.
