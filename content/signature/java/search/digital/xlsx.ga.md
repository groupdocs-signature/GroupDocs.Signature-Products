...
############################# Head ############################
head_title: "Cuardaigh Digital síniú i gcomhad Xlsx i Java"
head_description: "Úsáid Java chun sínithe Digital a chuardach i gcomhaid Xlsx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Digital sínithe i gcomhad Xlsx"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Xlsx ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Digital a chuardach i Xlsx"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Digital i gcomhaid Xlsx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
...
demos:
    ...
    content: |
       Cuardaigh an doiciméad le haghaidh sínithe leictreonacha éagsúla ar chomhaid Xlsx faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
