...
############################# Head ############################
head_title: "Căutați semnături Digital în fișierul Ods în Java"
head_description: "Utilizați Java pentru a căuta semnături Digital în fișiere Ods folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Digital în fișierul Ods"
description: "API-ul nativ Java permite căutarea semnăturilor Digital în fișierele Ods deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Ods folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Digital în fișierele Ods din aplicațiile lor prin implementarea câțiva pași simpli.
