...
############################# Head ############################
head_title: "Vyhledejte podpisy Digital v souboru Zip v Java"
head_description: "Použijte Java k vyhledávání podpisů Digital v souborech Zip pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Digital v souboru Zip"
description: "Nativní API Java umožňuje vyhledávat podpisy Digital v již podepsaných souborech Zip. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Zip pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Digital v Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Digital v souborech Zip z jejich aplikací implementací několika snadných kroků.
