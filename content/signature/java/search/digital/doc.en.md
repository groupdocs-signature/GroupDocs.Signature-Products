...
############################# Head ############################
head_title: "Search Digital signatures in Doc file in Java"
head_description: "Use Java for searching Digital signatures in Doc files using a few lines of code."

############################# Header ############################
title: "Search Digital signatures in Doc file"
description: "Java native API to search Digital signatures in already signed Doc file. Perform advanced e-signature operations within your Doc documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search Digital signatures in Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Digital signatures in Doc files from within their applications by implementing a few easy steps.
