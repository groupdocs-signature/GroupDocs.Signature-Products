...
############################# Head ############################
head_title: "Procure por assinaturas Digital no arquivo Dot em Java"
head_description: "Use Java para pesquisar assinaturas Digital em arquivos Dot usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Digital no arquivo Dot"
description: "A API nativa do Java permite pesquisar assinaturas Digital em arquivos Dot já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Dot usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Digital em Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Digital em arquivos Dot de seus aplicativos implementando algumas etapas fáceis.
