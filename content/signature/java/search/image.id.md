...
head_title: "Cari Tanda Tangan Digital di IMAGE melalui Java Library"
head_description: "Pustaka Java untuk mencari &amp; memvalidasi tanda tangan digital dalam file IMAGE menggunakan GroupDocs.Siganture API - memanipulasi IMAGE, Barcode, QR-Code, Cap, Teks, Optik &amp; Tanda tangan metadata dari dokumen yang ditandatangani secara digital."

title: "Cari Tanda Tangan Digital di IMAGE melalui Java"
description: "Java eSignature API untuk mencari &amp; memvalidasi tanda tangan digital dalam file IMAGE. Memanipulasi IMAGE, Barcode, QR-Code, Cap, Teks, Optik &amp; Tanda tangan metadata dari dokumen yang ditandatangani secara digital."
...
steps:
    enable: true
    title_left: "Cara Mencari Tanda Tangan Digital dari IMAGE"
    content_left: |
        Contoh kode Java di bawah ini dengan jelas menunjukkan langkah-langkah untuk **mencari tanda tangan digital dalam file IMAGE di Java** dengan menambahkan beberapa baris kode saja.
...
demos:
    enable: true
    title: "Cari IMAGE Signature Live Demo"
    content: |
