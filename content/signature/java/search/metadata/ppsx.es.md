...
############################# Head ############################
head_title: "Busque Metadata firmas en Ppsx archivo en Java"
head_description: "Use Java para buscar firmas Metadata en archivos Ppsx usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Metadata en el archivo Ppsx"
description: "Java API nativa permite buscar Metadata firmas en archivos Ppsx ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Ppsx utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas Metadata en Ppsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Metadata en archivos Ppsx desde sus aplicaciones mediante la implementación de unos sencillos pasos.
...
demos:
    ...
    content: |
       Agregue varias firmas electrónicas a los archivos Ppsx ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
