...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Metadata en Ppsx"
    content_left: |
...
demos:
    ...
    content: |
       Busque en el documento varias firmas electrónicas para archivos Ppsx ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
