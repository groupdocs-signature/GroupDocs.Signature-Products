...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Odt rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Odt, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Odt"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Odt failides. Tehke oma Odt dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Odt, rakendades mõnda lihtsat sammu.
