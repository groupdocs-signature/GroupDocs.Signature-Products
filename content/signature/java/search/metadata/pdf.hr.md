...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Pdf u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Pdf pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Pdf datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Pdf datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Pdf dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Pdf iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
