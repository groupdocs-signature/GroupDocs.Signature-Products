...
############################# Head ############################
head_title: "Meklēt Metadata parakstus Ods failā programmā Java"
head_description: "Izmantojiet Java, lai meklētu Metadata parakstus Ods failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Metadata parakstus failā Ods"
description: "Java vietējais API ļauj meklēt Metadata parakstus jau parakstītos Ods failos. Veiciet izvērsto e-paraksta meklēšanu savos Ods dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    enable: true
    title_left: "Kā meklēt Metadata parakstus Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ļauj Java izstrādātājiem vieglāk meklēt Metadata parakstus Ods failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
...
demos:
    ...
    content: |
       Meklējiet dokumentā dažādus Ods failu elektroniskos parakstus tūlīt, apmeklējot vietni [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).

        
############################# More Formats ############################
more_formats:
    enable: true
    title: "Meklēt citus Metadata parakstus, izmantojot Java"
    content: |
