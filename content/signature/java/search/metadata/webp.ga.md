...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Webp i Java"
head_description: "Úsáid Java chun sínithe Metadata a chuardach i gcomhaid Webp ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Metadata i gcomhaid Webp óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
