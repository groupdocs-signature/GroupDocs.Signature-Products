...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Wmf v Java"
head_description: "Uporabite Java za iskanje podpisov Metadata v datotekah Wmf z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Wmf"
description: "Izvorni API za Java omogoča iskanje podpisov Metadata v že podpisanih datotekah Wmf. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Wmf z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Metadata v datotekah Wmf iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
