...
############################# Head ############################
head_title: "Java içinde Xlsm dosyasında Metadata imzasını arayın"
head_description: "Birkaç satır kod kullanarak Xlsm dosyalarında Metadata imzasını aramak için Java kullanın."

############################# Header ############################
title: "Xlsm dosyasında Metadata imzasını arayın"
description: "Java yerel API'si, önceden imzalanmış Xlsm dosyalarında Metadata imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Xlsm belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Xlsm içinde Metadata imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak Xlsm dosyalarında Metadata imzalarını aramasını kolaylaştırır.
