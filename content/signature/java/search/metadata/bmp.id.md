...
############################# Head ############################
head_title: "Cari tanda tangan Metadata dalam file Bmp di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Metadata di file Bmp menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Metadata di file Bmp"
description: "Java API asli memungkinkan untuk mencari Metadata tanda tangan di file Bmp yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Bmp Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Metadata di Bmp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Metadata dalam file Bmp dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
