...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Png faile Java"
head_description: "Naudokite Java, norėdami ieškoti Metadata parašų Png failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Png faile"
description: "Java savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Png failuose. Atlikite išplėstinę el. parašo paiešką savo Png dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Metadata parašų Png failuose iš savo programų, atlikdami kelis paprastus veiksmus.
