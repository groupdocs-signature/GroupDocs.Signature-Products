...
############################# Head ############################
head_title: "በJava ውስጥ በXltm ፋይል ውስጥ የMetadata ፊርማዎችን ይፈልጉ"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም በXltm ፋይሎች ውስጥ የMetadata ፊርማዎችን ለመፈለግ Javaን ይጠቀሙ።"

############################# Header ############################
title: "በXltm ፋይል ውስጥ የMetadata ፊርማዎችን ይፈልጉ"
description: "Java ቤተኛ ኤፒአይ አስቀድሞ በተፈረሙ Xltm ፋይሎች ውስጥ የMetadata ፊርማዎችን ለመፈለግ ይፈቅዳል። ጥቂት የኮድ መስመሮችን በመጠቀም በXltm ሰነዶችዎ ውስጥ የላቀ የኢ-ፊርማ ፍለጋን ያድርጉ።"
...
steps:
    enable: true
    title_left: "በXltm ውስጥ የMetadata ፊርማዎችን እንዴት መፈለግ እንደሚቻል"
    content_left: |
