...
############################# Head ############################
head_title: "Procure por assinaturas Metadata no arquivo Otp em Java"
head_description: "Use Java para pesquisar assinaturas Metadata em arquivos Otp usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Metadata no arquivo Otp"
description: "A API nativa do Java permite pesquisar assinaturas Metadata em arquivos Otp já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Otp usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Metadata em Otp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Metadata em arquivos Otp de seus aplicativos implementando algumas etapas fáceis.
