...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Docm rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Docm, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Docm"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Docm failides. Tehke oma Docm dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Docm, rakendades mõnda lihtsat sammu.
