...
############################# Head ############################
head_title: "Busque Metadata firmas en Odt archivo en Java"
head_description: "Use Java para buscar firmas Metadata en archivos Odt usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Metadata en el archivo Odt"
description: "Java API nativa permite buscar Metadata firmas en archivos Odt ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Odt utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Metadata en Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Metadata en archivos Odt desde sus aplicaciones mediante la implementación de unos sencillos pasos.
