...
############################# Head ############################
head_title: "Search Metadata signatures in Docm file in Java"
head_description: "Use Java for searching Metadata signatures in Docm files using a few lines of code."

############################# Header ############################
title: "Search Metadata signatures in Docm file"
description: "Java native API to search Metadata signatures in already signed Docm file. Perform advanced e-signature operations within your Docm documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Metadata signatures in Docm files from within their applications by implementing a few easy steps.
