...
############################# Head ############################
head_title: "Vyhľadajte podpisy Metadata v súbore Docm v Java"
head_description: "Použite Java na vyhľadávanie Metadata podpisov v súboroch Docm pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Metadata v súbore Docm"
description: "Natívne API Java umožňuje vyhľadávať podpisy Metadata v už podpísaných súboroch Docm. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Docm pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Metadata v Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Metadata v súboroch Docm z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
