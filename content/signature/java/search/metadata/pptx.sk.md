...
############################# Head ############################
head_title: "Vyhľadajte podpisy Metadata v súbore Pptx v Java"
head_description: "Použite Java na vyhľadávanie Metadata podpisov v súboroch Pptx pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Metadata v súbore Pptx"
description: "Natívne API Java umožňuje vyhľadávať podpisy Metadata v už podpísaných súboroch Pptx. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Pptx pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Metadata v Pptx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Metadata v súboroch Pptx z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
