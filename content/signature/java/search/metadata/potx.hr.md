...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Potx u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Potx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Potx datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Potx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Potx dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Potx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
