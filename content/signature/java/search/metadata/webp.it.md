...
############################# Head ############################
head_title: "Cerca le firme Metadata nel file Webp in Java"
head_description: "Usa Java per cercare le firme Metadata nei file Webp utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Metadata nel file Webp"
description: "L'API nativa Java consente di cercare firme Metadata in file Webp già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Webp utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Metadata in Webp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Metadata nei file Webp dalle loro applicazioni implementando alcuni semplici passaggi.
