...
############################# Head ############################
head_title: "მოძებნეთ Metadata ხელმოწერები Odp ფაილში Java"
head_description: "გამოიყენეთ Java Metadata ხელმოწერების მოსაძიებლად Odp ფაილებში კოდის რამდენიმე ხაზის გამოყენებით."

############################# Header ############################
title: "მოძებნეთ Metadata ხელმოწერები Odp ფაილში"
description: "Java მშობლიური API საშუალებას გაძლევთ მოძებნოთ Metadata ხელმოწერები უკვე ხელმოწერილ Odp ფაილებში. განახორციელეთ ელექტრონული ხელმოწერის გაფართოებული ძიება თქვენს {{ფაილის ფორმატში}} დოკუმენტებში კოდის რამდენიმე ხაზის გამოყენებით."
...
steps:
    enable: true
    title_left: "როგორ მოძებნოთ Metadata ხელმოწერები Odp-ში"
    content_left: |
