...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Ppsm v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Ppsm pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Ppsm"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Ppsm. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ppsm pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Ppsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Ppsm z jejich aplikací implementací několika snadných kroků.
