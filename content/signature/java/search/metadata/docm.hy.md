...
############################# Head ############################
head_title: "Որոնեք Metadata ստորագրությունները Docm ֆայլում Java-ում"
head_description: "Օգտագործեք Java՝ Metadata ստորագրությունները Docm ֆայլերում մի քանի տող կոդով որոնելու համար:"

############################# Header ############################
title: "Փնտրեք Metadata ստորագրությունները Docm ֆայլում"
description: "Java բնօրինակ API-ն թույլ է տալիս որոնել Metadata ստորագրություններ արդեն ստորագրված Docm ֆայլերում: Կատարեք էլեկտրոնային ստորագրության առաջադեմ որոնում ձեր Docm փաստաթղթերում՝ օգտագործելով մի քանի տող կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես որոնել Metadata ստորագրությունները Docm-ում"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հեշտացնում է Java ծրագրավորողների համար որոնել Metadata ստորագրությունները Docm ֆայլերում իրենց հավելվածներից` իրականացնելով մի քանի հեշտ քայլեր:
