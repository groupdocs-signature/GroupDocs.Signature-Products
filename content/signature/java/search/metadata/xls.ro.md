...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Xls în Java"
head_description: "Utilizați Java pentru a căuta semnături Metadata în fișiere Xls folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Xls"
description: "API-ul nativ Java permite căutarea semnăturilor Metadata în fișierele Xls deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Xls folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Metadata în fișierele Xls din aplicațiile lor prin implementarea câțiva pași simpli.
