...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Ots în Java"
head_description: "Utilizați Java pentru a căuta semnături Metadata în fișiere Ots folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Ots"
description: "API-ul nativ Java permite căutarea semnăturilor Metadata în fișierele Ots deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Ots folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Metadata în Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Metadata în fișierele Ots din aplicațiile lor prin implementarea câțiva pași simpli.
