...
############################# Head ############################
head_title: "Procure por assinaturas Metadata no arquivo Ots em Java"
head_description: "Use Java para pesquisar assinaturas Metadata em arquivos Ots usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Metadata no arquivo Ots"
description: "A API nativa do Java permite pesquisar assinaturas Metadata em arquivos Ots já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Ots usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Metadata em Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Metadata em arquivos Ots de seus aplicativos implementando algumas etapas fáceis.
