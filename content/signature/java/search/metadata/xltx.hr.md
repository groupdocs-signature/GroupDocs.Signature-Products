...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Xltx u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Xltx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Xltx datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Xltx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xltx dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Xltx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
