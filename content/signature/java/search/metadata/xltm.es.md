...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Metadata en Xltm"
    content_left: |
...
demos:
    ...
    content: |
       Busque en el documento varias firmas electrónicas para archivos Xltm ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
