...
############################# Head ############################
head_title: "Li Metadata îmzeyan di pela Dotm de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Metadata di pelên Dotm de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Dotm de li îmzeyên Metadata bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Dotm yên jixwe îmzekirî de li îmzeyên Metadata bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Dotm de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Metadata di pelên Dotm îmzeyan de ji sepanên xwe bigerin.
