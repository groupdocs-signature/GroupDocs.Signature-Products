...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Xltm u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Xltm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Xltm datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Xltm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xltm dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Xltm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
