...
############################# Head ############################
head_title: "Procure por assinaturas Metadata no arquivo Doc em Java"
head_description: "Use Java para pesquisar assinaturas Metadata em arquivos Doc usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Metadata no arquivo Doc"
description: "A API nativa do Java permite pesquisar assinaturas Metadata em arquivos Doc já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Doc usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Metadata em arquivos Doc de seus aplicativos implementando algumas etapas fáceis.
