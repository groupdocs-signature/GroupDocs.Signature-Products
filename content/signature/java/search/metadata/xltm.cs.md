...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Xltm v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Xltm pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Xltm"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Xltm. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Xltm pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Xltm z jejich aplikací implementací několika snadných kroků.
