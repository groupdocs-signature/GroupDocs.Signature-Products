...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Xlsb u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Xlsb pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Xlsb datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Xlsb datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xlsb dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Xlsb iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
