...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Xltx i Java"
head_description: "Úsáid Java chun sínithe Metadata a chuardach i gcomhaid Xltx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Xltx"
...
steps:
    enable: true
    title_left: "Conas síniú Metadata a chuardach i Xltx"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Metadata i gcomhaid Xltx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
