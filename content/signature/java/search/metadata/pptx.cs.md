...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Pptx v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Pptx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Pptx"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Pptx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Pptx pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Pptx z jejich aplikací implementací několika snadných kroků.
