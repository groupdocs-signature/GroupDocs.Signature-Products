...
############################# Head ############################
head_title: "Cari tandatangan Metadata dalam fail Ott dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Metadata dalam fail Ott menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Metadata dalam fail Ott."
description: "API asli Java membenarkan untuk mencari tandatangan Metadata dalam fail Ott yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Ott anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Metadata dalam Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Metadata dalam fail Ott daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
