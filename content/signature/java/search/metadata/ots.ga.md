...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Ots i Java"
head_description: "Úsáid Java chun sínithe Metadata a chuardach i gcomhaid Ots ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Ots"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Metadata sínithe i gcomhaid Ots atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Ots ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Metadata i gcomhaid Ots óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
