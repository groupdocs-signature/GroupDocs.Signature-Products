...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Pps în Java"
head_description: "Utilizați Java pentru a căuta semnături Metadata în fișiere Pps folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Pps"
description: "API-ul nativ Java permite căutarea semnăturilor Metadata în fișierele Pps deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Pps folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Metadata în Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Metadata în fișierele Pps din aplicațiile lor prin implementarea câțiva pași simpli.
