...
############################# Head ############################
head_title: "Busque Metadata firmas en Ppt archivo en Java"
head_description: "Use Java para buscar firmas Metadata en archivos Ppt usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Metadata en el archivo Ppt"
description: "Java API nativa permite buscar Metadata firmas en archivos Ppt ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Ppt utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Metadata en archivos Ppt desde sus aplicaciones mediante la implementación de unos sencillos pasos.
