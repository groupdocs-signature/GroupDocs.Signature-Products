...
############################# Head ############################
head_title: "Cari tanda tangan Metadata dalam file Ods di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Metadata di file Ods menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Metadata di file Ods"
description: "Java API asli memungkinkan untuk mencari Metadata tanda tangan di file Ods yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ods Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Metadata dalam file Ods dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
