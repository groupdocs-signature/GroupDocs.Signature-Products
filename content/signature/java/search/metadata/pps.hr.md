...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Pps u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Pps pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Pps datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Pps datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Pps dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Pps iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
