...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Pptm a Java"
head_description: "Utilitzeu Java per cercar signatures Metadata als fitxers Pptm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Pptm"
description: "L'API nativa de Java permet cercar signatures Metadata als fitxers Pptm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Pptm amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Metadata a Pptm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Metadata als fitxers Pptm des de les seves aplicacions implementant uns quants passos senzills.
...
demos:
    ...
    content: |
       Cerqueu al document diverses signatures electròniques als fitxers Pptm ara mateix visitant el lloc web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
