...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Ott u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Ott pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Ott datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Ott datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ott dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Ott iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
