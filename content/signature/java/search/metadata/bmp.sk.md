...
############################# Head ############################
head_title: "Vyhľadajte podpisy Metadata v súbore Bmp v Java"
head_description: "Použite Java na vyhľadávanie Metadata podpisov v súboroch Bmp pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Metadata v súbore Bmp"
description: "Natívne API Java umožňuje vyhľadávať podpisy Metadata v už podpísaných súboroch Bmp. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Bmp pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Metadata v súboroch Bmp z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
