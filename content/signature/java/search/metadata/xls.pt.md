...
############################# Head ############################
head_title: "Procure por assinaturas Metadata no arquivo Xls em Java"
head_description: "Use Java para pesquisar assinaturas Metadata em arquivos Xls usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Metadata no arquivo Xls"
description: "A API nativa do Java permite pesquisar assinaturas Metadata em arquivos Xls já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Xls usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Metadata em Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Metadata em arquivos Xls de seus aplicativos implementando algumas etapas fáceis.
