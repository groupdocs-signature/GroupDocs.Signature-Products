...
############################# Head ############################
head_title: "Cari tandatangan Metadata dalam fail Xlsm dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Metadata dalam fail Xlsm menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Metadata dalam fail Xlsm."
description: "API asli Java membenarkan untuk mencari tandatangan Metadata dalam fail Xlsm yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Xlsm anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Metadata dalam Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Metadata dalam fail Xlsm daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
...
demos:
    ...
    content: |
       Cari dokumen untuk pelbagai tandatangan elektronik pada fail Xlsm sekarang dengan melawati tapak web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).

        
############################# More Formats ############################
more_formats:
    enable: true
    title: "Cari tandatangan Metadata lain menggunakan Java"
    content: |
