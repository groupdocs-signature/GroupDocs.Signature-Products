...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Xlsb a Java"
head_description: "Utilitzeu Java per cercar signatures Metadata als fitxers Xlsb mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Xlsb"
description: "L'API nativa de Java permet cercar signatures Metadata als fitxers Xlsb ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Xlsb amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Metadata a Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Metadata als fitxers Xlsb des de les seves aplicacions implementant uns quants passos senzills.
