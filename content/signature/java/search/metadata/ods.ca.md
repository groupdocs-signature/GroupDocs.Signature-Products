...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Ods a Java"
head_description: "Utilitzeu Java per cercar signatures Metadata als fitxers Ods mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Ods"
description: "L'API nativa de Java permet cercar signatures Metadata als fitxers Ods ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Ods amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Metadata als fitxers Ods des de les seves aplicacions implementant uns quants passos senzills.
