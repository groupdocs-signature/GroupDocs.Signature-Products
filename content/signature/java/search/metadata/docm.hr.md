...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Docm u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Docm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Docm datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Docm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Docm dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Docm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
