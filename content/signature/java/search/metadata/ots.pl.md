...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Ots w Java"
head_description: "Użyj Java do wyszukiwania podpisów Metadata w plikach Ots przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Ots"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Ots. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Ots, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Metadata w Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Metadata w plikach Ots z ich aplikacji, wykonując kilka prostych kroków.
...
demos:
    ...
    content: |
       Wyszukaj w dokumencie różne podpisy elektroniczne w plikach Ots, odwiedzając witrynę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
