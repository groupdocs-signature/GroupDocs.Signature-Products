...
############################# Head ############################
head_title: "Busque Metadata firmas en Ods archivo en Java"
head_description: "Use Java para buscar firmas Metadata en archivos Ods usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Metadata en el archivo Ods"
description: "Java API nativa permite buscar Metadata firmas en archivos Ods ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Ods utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas Metadata en Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Metadata en archivos Ods desde sus aplicaciones mediante la implementación de unos sencillos pasos.
...
demos:
    ...
    content: |
       Agregue varias firmas electrónicas a los archivos Ods ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
