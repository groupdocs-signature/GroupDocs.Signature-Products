...
############################# Head ############################
head_title: "Keressen Metadata aláírásokat a Webp fájlban a Java programban"
head_description: "A Java használatával kereshet Metadata aláírásokat a Webp fájlokban néhány sornyi kód használatával."

############################# Header ############################
title: "Keressen Metadata aláírásokat a Webp fájlban"
description: "A Java natív API lehetővé teszi a Metadata aláírások keresését a már aláírt Webp fájlokban. Végezzen speciális e-aláírás-keresést a Webp dokumentumaiban néhány sornyi kód használatával."
...
steps:
    enable: true
    title_left: "Metadata aláírások keresése a Webp fájlban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy Metadata aláírásokat keressenek alkalmazásaik Webp fájljaiban.
