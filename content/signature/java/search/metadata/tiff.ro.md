...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Tiff în Java"
head_description: "Utilizați Java pentru a căuta semnături Metadata în fișiere Tiff folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Tiff"
description: "API-ul nativ Java permite căutarea semnăturilor Metadata în fișierele Tiff deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Tiff folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Metadata în Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Metadata în fișierele Tiff din aplicațiile lor prin implementarea câțiva pași simpli.
