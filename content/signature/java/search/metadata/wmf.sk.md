...
############################# Head ############################
head_title: "Vyhľadajte podpisy Metadata v súbore Wmf v Java"
head_description: "Použite Java na vyhľadávanie Metadata podpisov v súboroch Wmf pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Metadata v súbore Wmf"
description: "Natívne API Java umožňuje vyhľadávať podpisy Metadata v už podpísaných súboroch Wmf. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Wmf pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Metadata v súboroch Wmf z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
