...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Ppsx u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Ppsx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Ppsx datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Ppsx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ppsx dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Ppsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Ppsx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
