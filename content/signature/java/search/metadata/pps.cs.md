...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Pps v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Pps pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Pps"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Pps. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Pps pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Pps z jejich aplikací implementací několika snadných kroků.
