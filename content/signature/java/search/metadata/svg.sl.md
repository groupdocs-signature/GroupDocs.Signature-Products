...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Svg v Java"
head_description: "Uporabite Java za iskanje podpisov Metadata v datotekah Svg z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Svg"
description: "Izvorni API za Java omogoča iskanje podpisov Metadata v že podpisanih datotekah Svg. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Svg z uporabo nekaj vrstic kode."
...
steps:
    enable: true
    title_left: "Kako poiskati podpise Metadata v Svg"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Metadata v datotekah Svg iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
