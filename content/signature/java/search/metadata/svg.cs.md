...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Svg v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Svg pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Svg"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Svg. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Svg pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Svg"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Svg z jejich aplikací implementací několika snadných kroků.
