...
############################# Head ############################
head_title: "Rechercher les signatures Metadata dans le fichier Docm dans Java"
head_description: "Utilisez Java pour rechercher des signatures Metadata dans des fichiers Docm en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Metadata dans le fichier Docm"
description: "L'API native Java permet de rechercher des signatures Metadata dans des fichiers Docm déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Docm en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Metadata dans Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Metadata dans des fichiers Docm à partir de leurs applications en mettant en œuvre quelques étapes simples.
...
demos:
    ...
    content: |
       Ajoutez dès maintenant diverses signatures électroniques aux fichiers Docm en visitant le site Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
