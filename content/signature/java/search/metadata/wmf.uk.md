...
############################# Head ############################
head_title: "Шукайте підписи Metadata у файлі Wmf у Java"
head_description: "Використовуйте Java для пошуку підписів Metadata у файлах Wmf за допомогою кількох рядків коду."

############################# Header ############################
title: "Шукайте підписи Metadata у файлі Wmf"
description: "Власний API Java дозволяє шукати підписи Metadata у вже підписаних файлах Wmf. Виконайте розширений пошук електронного підпису в документах Wmf за допомогою кількох рядків коду."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) полегшує розробникам Java пошук підписів Metadata у файлах Wmf у їхніх програмах, виконавши кілька простих кроків.
