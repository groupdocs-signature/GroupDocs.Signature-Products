...
############################# Head ############################
head_title: "Søg efter Metadata signaturer i filen Odp i Java"
head_description: "Brug Java til at søge efter Metadata-signaturer i Odp-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Metadata-signaturer i filen Odp"
description: "Java native API gør det muligt at søge efter Metadata-signaturer i allerede signerede Odp-filer. Udfør avanceret e-signatursøgning i dine Odp dokumenter ved hjælp af et par linjer kode."
...
steps:
    enable: true
    title_left: "Sådan søger du efter Metadata-signaturer i Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gør det nemmere for Java-udviklere at søge efter Metadata-signaturer i Odp-filer fra deres applikationer ved at implementere nogle få nemme trin.
