...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Svg u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Svg pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Svg datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Svg datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Svg dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Svg"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Svg iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
