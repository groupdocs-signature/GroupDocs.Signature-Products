...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Ots u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Ots pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Ots datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Ots datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ots dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Ots iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
