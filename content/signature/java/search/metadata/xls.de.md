...
############################# Head ############################
head_title: "Suche nach Metadata-Signaturen in der Datei Xls in Java"
head_description: "Verwenden Sie Java für die Suche nach Metadata-Signaturen in Xls-Dateien mit ein paar Zeilen Code."

############################# Header ############################
title: "Suchen Sie nach Metadata-Signaturen in der Datei Xls"
description: "Die native API von Java ermöglicht die Suche nach Metadata-Signaturen in bereits signierten Xls-Dateien. Führen Sie mit wenigen Codezeilen eine erweiterte E-Signatur-Suche in Ihren Xls-Dokumenten durch."
...
steps:
    enable: true
    title_left: "So suchen Sie nach Metadata-Signaturen in Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) erleichtert Entwicklern von Java die Suche nach Metadata-Signaturen in Xls-Dateien aus ihren Anwendungen, indem einige einfache Schritte implementiert werden.
...
demos:
    ...
    content: |
       Durchsuchen Sie das Dokument jetzt nach verschiedenen elektronischen Signaturen für Xls-Dateien, indem Sie die Website [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) besuchen.
