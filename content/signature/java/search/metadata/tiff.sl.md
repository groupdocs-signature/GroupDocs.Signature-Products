...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Tiff v Java"
head_description: "Uporabite Java za iskanje podpisov Metadata v datotekah Tiff z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Tiff"
description: "Izvorni API za Java omogoča iskanje podpisov Metadata v že podpisanih datotekah Tiff. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Tiff z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Metadata v datotekah Tiff iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
