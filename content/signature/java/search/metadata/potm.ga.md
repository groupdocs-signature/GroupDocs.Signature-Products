...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Potm i Java"
head_description: "Úsáid Java chun sínithe Metadata a chuardach i gcomhaid Potm ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Potm"
...
steps:
    enable: true
    title_left: "Conas síniú Metadata a chuardach i Potm"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Metadata i gcomhaid Potm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
