...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Jpg rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Jpg, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Jpg"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Jpg failides. Tehke oma Jpg dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Jpg, rakendades mõnda lihtsat sammu.
