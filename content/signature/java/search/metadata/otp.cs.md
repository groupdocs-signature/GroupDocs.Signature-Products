...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Otp v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Otp pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Otp"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Otp. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Otp pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Otp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Otp z jejich aplikací implementací několika snadných kroků.
