...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Dotx v Java"
head_description: "Uporabite Java za iskanje podpisov Metadata v datotekah Dotx z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Dotx"
description: "Izvorni API za Java omogoča iskanje podpisov Metadata v že podpisanih datotekah Dotx. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Dotx z uporabo nekaj vrstic kode."
...
steps:
    enable: true
    title_left: "Kako poiskati podpise Metadata v Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Metadata v datotekah Dotx iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
