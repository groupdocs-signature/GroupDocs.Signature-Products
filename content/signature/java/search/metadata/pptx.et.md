...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Pptx rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Pptx, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Pptx"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Pptx failides. Tehke oma Pptx dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Pptx, rakendades mõnda lihtsat sammu.
