...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Docx w Java"
head_description: "Użyj Java do wyszukiwania podpisów Metadata w plikach Docx przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Docx"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Docx. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Docx, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Metadata w Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Metadata w plikach Docx z ich aplikacji, wykonując kilka prostych kroków.
