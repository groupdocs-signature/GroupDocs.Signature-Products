...
############################# Head ############################
head_title: "Meklēt Metadata parakstus Tiff failā programmā Java"
head_description: "Izmantojiet Java, lai meklētu Metadata parakstus Tiff failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Metadata parakstus failā Tiff"
description: "Java vietējais API ļauj meklēt Metadata parakstus jau parakstītos Tiff failos. Veiciet izvērsto e-paraksta meklēšanu savos Tiff dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    enable: true
    title_left: "Kā meklēt Metadata parakstus Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ļauj Java izstrādātājiem vieglāk meklēt Metadata parakstus Tiff failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
