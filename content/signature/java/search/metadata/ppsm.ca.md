...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Ppsm a Java"
head_description: "Utilitzeu Java per cercar signatures Metadata als fitxers Ppsm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Ppsm"
description: "L'API nativa de Java permet cercar signatures Metadata als fitxers Ppsm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Ppsm amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Metadata als fitxers Ppsm des de les seves aplicacions implementant uns quants passos senzills.
