...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Bmp u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Bmp pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Bmp datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Bmp datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Bmp dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Bmp iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
