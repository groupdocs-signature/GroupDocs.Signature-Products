...
############################# Head ############################
head_title: "Search for Metadata signatures in Pps file in Java"
head_description: "Use Java for searching for Metadata signatures in Pps files using a few lines of code."

############################# Header ############################
title: "Search for Metadata signatures in Pps file"
description: "Java native API allows to search for Metadata signatures in already signed Pps files. Perform advanced e-signature search within your Pps documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Metadata signatures in Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Metadata signatures in Pps files from their applications by implementing a few easy steps.
