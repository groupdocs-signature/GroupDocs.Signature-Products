...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Webp v Java"
head_description: "Uporabite Java za iskanje podpisov Metadata v datotekah Webp z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Webp"
description: "Izvorni API za Java omogoča iskanje podpisov Metadata v že podpisanih datotekah Webp. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Webp z uporabo nekaj vrstic kode."
...
steps:
    enable: true
    title_left: "Kako poiskati podpise Metadata v Webp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Metadata v datotekah Webp iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
...
demos:
    ...
    content: |
       Takoj zdaj poiščite v dokumentu različne elektronske podpise za datoteke Webp tako, da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
