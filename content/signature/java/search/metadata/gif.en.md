...
############################# Head ############################
head_title: "Search for Metadata signatures in Gif file in Java"
head_description: "Use Java for searching for Metadata signatures in Gif files using a few lines of code."

############################# Header ############################
title: "Search for Metadata signatures in Gif file"
description: "Java native API allows to search for Metadata signatures in already signed Gif files. Perform advanced e-signature search within your Gif documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Metadata signatures in Gif"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Metadata signatures in Gif files from their applications by implementing a few easy steps.
