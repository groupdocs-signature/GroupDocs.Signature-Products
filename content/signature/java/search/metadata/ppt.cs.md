...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Ppt v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Ppt pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Ppt"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Ppt. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ppt pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Ppt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Ppt z jejich aplikací implementací několika snadných kroků.
