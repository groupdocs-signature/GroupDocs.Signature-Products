...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Ppsx v Java"
head_description: "Uporabite Java za iskanje podpisov Metadata v datotekah Ppsx z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Ppsx"
description: "Izvorni API za Java omogoča iskanje podpisov Metadata v že podpisanih datotekah Ppsx. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Ppsx z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Metadata v datotekah Ppsx iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
