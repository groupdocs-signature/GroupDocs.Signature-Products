...
############################# Head ############################
head_title: "Busque Metadata firmas en Wmf archivo en Java"
head_description: "Use Java para buscar firmas Metadata en archivos Wmf usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Metadata en el archivo Wmf"
description: "Java API nativa permite buscar Metadata firmas en archivos Wmf ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Wmf utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Metadata en Wmf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Metadata en archivos Wmf desde sus aplicaciones mediante la implementación de unos sencillos pasos.
