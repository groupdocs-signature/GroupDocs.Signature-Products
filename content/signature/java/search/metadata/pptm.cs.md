...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Pptm v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Pptm pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Pptm"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Pptm. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Pptm pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Pptm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Pptm z jejich aplikací implementací několika snadných kroků.
