...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Docx u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Docx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Docx datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Docx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Docx dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Docx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
