...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Odt în Java"
head_description: "Utilizați Java pentru a căuta semnături Metadata în fișiere Odt folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Odt"
description: "API-ul nativ Java permite căutarea semnăturilor Metadata în fișierele Odt deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Odt folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Metadata în fișierele Odt din aplicațiile lor prin implementarea câțiva pași simpli.
