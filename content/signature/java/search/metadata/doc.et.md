...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Doc rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Doc, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Doc"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Doc failides. Tehke oma Doc dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Doc, rakendades mõnda lihtsat sammu.
