...
############################# Head ############################
head_title: "Procure por assinaturas Metadata no arquivo Webp em Java"
head_description: "Use Java para pesquisar assinaturas Metadata em arquivos Webp usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Metadata no arquivo Webp"
description: "A API nativa do Java permite pesquisar assinaturas Metadata em arquivos Webp já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Webp usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Metadata em Webp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Metadata em arquivos Webp de seus aplicativos implementando algumas etapas fáceis.
...
demos:
    ...
    content: |
       Pesquise no documento várias assinaturas eletrônicas para arquivos Webp agora mesmo visitando o site do [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
