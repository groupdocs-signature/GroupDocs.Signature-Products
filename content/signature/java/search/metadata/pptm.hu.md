...
############################# Head ############################
head_title: "Keressen Metadata aláírásokat a Pptm fájlban a Java programban"
head_description: "A Java használatával kereshet Metadata aláírásokat a Pptm fájlokban néhány sornyi kód használatával."

############################# Header ############################
title: "Keressen Metadata aláírásokat a Pptm fájlban"
description: "A Java natív API lehetővé teszi a Metadata aláírások keresését a már aláírt Pptm fájlokban. Végezzen speciális e-aláírás-keresést a Pptm dokumentumaiban néhány sornyi kód használatával."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy Metadata aláírásokat keressenek alkalmazásaik Pptm fájljaiban.
