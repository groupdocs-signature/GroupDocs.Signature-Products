...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Pptx w Java"
head_description: "Użyj Java do wyszukiwania podpisów Metadata w plikach Pptx przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Pptx"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Pptx. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Pptx, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Metadata w Pptx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Metadata w plikach Pptx z ich aplikacji, wykonując kilka prostych kroków.
