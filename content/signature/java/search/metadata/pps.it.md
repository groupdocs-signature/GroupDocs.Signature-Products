...
############################# Head ############################
head_title: "Cerca le firme Metadata nel file Pps in Java"
head_description: "Usa Java per cercare le firme Metadata nei file Pps utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Metadata nel file Pps"
description: "L'API nativa Java consente di cercare firme Metadata in file Pps già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Pps utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Metadata in Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Metadata nei file Pps dalle loro applicazioni implementando alcuni semplici passaggi.
...
demos:
    ...
    content: |
       Cerca subito nel documento varie firme elettroniche nei file Pps visitando il sito Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
