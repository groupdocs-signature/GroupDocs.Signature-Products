...
############################# Head ############################
head_title: "Cerca le firme Metadata nel file Potx in Java"
head_description: "Usa Java per cercare le firme Metadata nei file Potx utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Metadata nel file Potx"
description: "L'API nativa Java consente di cercare firme Metadata in file Potx già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Potx utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Metadata in Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Metadata nei file Potx dalle loro applicazioni implementando alcuni semplici passaggi.
