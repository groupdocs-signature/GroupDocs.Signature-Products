...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Svg faile Java"
head_description: "Naudokite Java, norėdami ieškoti Metadata parašų Svg failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Svg faile"
description: "Java savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Svg failuose. Atlikite išplėstinę el. parašo paiešką savo Svg dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Metadata parašų Svg failuose iš savo programų, atlikdami kelis paprastus veiksmus.
