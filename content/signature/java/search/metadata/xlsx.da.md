...
############################# Head ############################
head_title: "Søg efter Metadata signaturer i filen Xlsx i Java"
head_description: "Brug Java til at søge efter Metadata-signaturer i Xlsx-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Metadata-signaturer i filen Xlsx"
description: "Java native API gør det muligt at søge efter Metadata-signaturer i allerede signerede Xlsx-filer. Udfør avanceret e-signatursøgning i dine Xlsx dokumenter ved hjælp af et par linjer kode."
...
steps:
    enable: true
    title_left: "Sådan søger du efter Metadata-signaturer i Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gør det nemmere for Java-udviklere at søge efter Metadata-signaturer i Xlsx-filer fra deres applikationer ved at implementere nogle få nemme trin.
