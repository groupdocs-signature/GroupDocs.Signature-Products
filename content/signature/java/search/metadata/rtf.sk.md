...
############################# Head ############################
head_title: "Vyhľadajte podpisy Metadata v súbore Rtf v Java"
head_description: "Použite Java na vyhľadávanie Metadata podpisov v súboroch Rtf pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Metadata v súbore Rtf"
description: "Natívne API Java umožňuje vyhľadávať podpisy Metadata v už podpísaných súboroch Rtf. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Rtf pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Metadata v súboroch Rtf z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
