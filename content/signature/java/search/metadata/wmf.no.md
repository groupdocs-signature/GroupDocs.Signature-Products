...
############################# Head ############################
head_title: "Søk etter Metadata-signaturer i filen Wmf i Java"
head_description: "Bruk Java for å søke etter Metadata-signaturer i Wmf-filer ved å bruke noen få linjer med kode."

############################# Header ############################
title: "Søk etter Metadata-signaturer i filen Wmf"
description: "Java native API gjør det mulig å søke etter Metadata-signaturer i allerede signerte Wmf-filer. Utfør avansert e-signatursøk i Wmf-dokumentene dine ved å bruke noen få linjer med kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gjør det enklere for Java-utviklere å søke etter Metadata-signaturer i Wmf-filer fra applikasjonene deres ved å implementere noen få enkle trinn.
