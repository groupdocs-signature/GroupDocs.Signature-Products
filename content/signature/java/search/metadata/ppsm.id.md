...
############################# Head ############################
head_title: "Cari tanda tangan Metadata dalam file Ppsm di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Metadata di file Ppsm menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Metadata di file Ppsm"
description: "Java API asli memungkinkan untuk mencari Metadata tanda tangan di file Ppsm yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ppsm Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Metadata dalam file Ppsm dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
