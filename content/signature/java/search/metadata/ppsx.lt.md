...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Ppsx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Metadata parašų Ppsx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Ppsx faile"
description: "Java savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Ppsx failuose. Atlikite išplėstinę el. parašo paiešką savo Ppsx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Metadata parašų Ppsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Metadata parašų Ppsx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
