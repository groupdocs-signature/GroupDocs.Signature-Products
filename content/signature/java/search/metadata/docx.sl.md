...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Docx v Java"
head_description: "Uporabite Java za iskanje podpisov Metadata v datotekah Docx z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Docx"
description: "Izvorni API za Java omogoča iskanje podpisov Metadata v že podpisanih datotekah Docx. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Docx z uporabo nekaj vrstic kode."
...
steps:
    enable: true
    title_left: "Kako poiskati podpise Metadata v Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Metadata v datotekah Docx iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
