...
############################# Head ############################
head_title: "Vyhľadajte podpisy Metadata v súbore Svg v Java"
head_description: "Použite Java na vyhľadávanie Metadata podpisov v súboroch Svg pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Metadata v súbore Svg"
description: "Natívne API Java umožňuje vyhľadávať podpisy Metadata v už podpísaných súboroch Svg. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Svg pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Metadata v Svg"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Metadata v súboroch Svg z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
