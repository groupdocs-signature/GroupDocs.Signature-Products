...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Otp u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Otp pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Otp datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Otp datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Otp dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Otp iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
