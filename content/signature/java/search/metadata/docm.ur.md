...
############################# Head ############################
head_title: "Java میں Docm فائل میں Metadata دستخط تلاش کریں۔"
head_description: "کوڈ کی چند سطروں کا استعمال کرتے ہوئے Docm فائلوں میں Metadata دستخط تلاش کرنے کے لیے Java استعمال کریں۔"

############################# Header ############################
title: "Docm فائل میں Metadata دستخط تلاش کریں۔"
description: "Java مقامی API پہلے سے دستخط شدہ Docm فائلوں میں Metadata دستخطوں کو تلاش کرنے کی اجازت دیتا ہے۔ کوڈ کی چند سطروں کا استعمال کرتے ہوئے اپنے Docm دستاویزات کے اندر اعلی درجے کی ای دستخط تلاش کریں۔"
...
steps:
    enable: true
    title_left: "Docm میں Metadata دستخط کیسے تلاش کریں"
    content_left: |
...
demos:
    ...
    content: |
       ابھی [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) ویب سائٹ پر جا کر Docm فائلوں پر مختلف الیکٹرانک دستخطوں کے لیے دستاویز تلاش کریں۔
