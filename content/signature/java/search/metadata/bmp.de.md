...
demos:
    ...
    content: |
       Fügen Sie jetzt verschiedene elektronische Signaturen zu Bmp-Dateien hinzu, indem Sie die Website [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) besuchen.
