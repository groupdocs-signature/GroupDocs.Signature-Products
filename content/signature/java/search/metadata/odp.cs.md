...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Odp v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Odp pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Odp"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Odp. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Odp pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Odp z jejich aplikací implementací několika snadných kroků.
