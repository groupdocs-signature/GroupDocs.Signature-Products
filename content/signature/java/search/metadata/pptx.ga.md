...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Pptx i Java"
head_description: "Úsáid Java chun sínithe Metadata a chuardach i gcomhaid Pptx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Pptx"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Pptx ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Metadata a chuardach i Pptx"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Metadata i gcomhaid Pptx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
