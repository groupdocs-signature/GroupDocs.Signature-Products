...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Xlsx u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Xlsx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Xlsx datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Xlsx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xlsx dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Xlsx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
