...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Ods v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Ods pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Ods"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Ods. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ods pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Ods z jejich aplikací implementací několika snadných kroků.
...
demos:
    ...
    content: |
       Navštivte web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) a vyhledejte v dokumentu různé elektronické podpisy do souborů Ods právě teď.
