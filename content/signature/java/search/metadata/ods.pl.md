...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Ods w Java"
head_description: "Użyj Java do wyszukiwania podpisów Metadata w plikach Ods przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Ods"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Ods. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Ods, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Metadata w Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Metadata w plikach Ods z ich aplikacji, wykonując kilka prostych kroków.
