...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Doc a Java"
head_description: "Utilitzeu Java per cercar signatures Metadata als fitxers Doc mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Doc"
description: "L'API nativa de Java permet cercar signatures Metadata als fitxers Doc ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Doc amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Metadata als fitxers Doc des de les seves aplicacions implementant uns quants passos senzills.
