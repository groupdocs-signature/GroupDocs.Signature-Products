...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Csv rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Csv, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Csv"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Csv failides. Tehke oma Csv dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Csv"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Csv, rakendades mõnda lihtsat sammu.
