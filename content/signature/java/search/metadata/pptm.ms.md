...
############################# Head ############################
head_title: "Cari tandatangan Metadata dalam fail Pptm dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Metadata dalam fail Pptm menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Metadata dalam fail Pptm."
description: "API asli Java membenarkan untuk mencari tandatangan Metadata dalam fail Pptm yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Pptm anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Metadata dalam Pptm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Metadata dalam fail Pptm daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
