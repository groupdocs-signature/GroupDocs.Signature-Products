...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Xlsm a Java"
head_description: "Utilitzeu Java per cercar signatures Metadata als fitxers Xlsm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Xlsm"
description: "L'API nativa de Java permet cercar signatures Metadata als fitxers Xlsm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Xlsm amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Metadata a Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Metadata als fitxers Xlsm des de les seves aplicacions implementant uns quants passos senzills.
