...
############################# Head ############################
head_title: "Шукайте підписи Metadata у файлі Ots у Java"
head_description: "Використовуйте Java для пошуку підписів Metadata у файлах Ots за допомогою кількох рядків коду."

############################# Header ############################
title: "Шукайте підписи Metadata у файлі Ots"
description: "Власний API Java дозволяє шукати підписи Metadata у вже підписаних файлах Ots. Виконайте розширений пошук електронного підпису в документах Ots за допомогою кількох рядків коду."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) полегшує розробникам Java пошук підписів Metadata у файлах Ots у їхніх програмах, виконавши кілька простих кроків.
