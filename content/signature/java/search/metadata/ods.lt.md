...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Ods faile Java"
head_description: "Naudokite Java, norėdami ieškoti Metadata parašų Ods failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Ods faile"
description: "Java savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Ods failuose. Atlikite išplėstinę el. parašo paiešką savo Ods dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Metadata parašų Ods failuose iš savo programų, atlikdami kelis paprastus veiksmus.
