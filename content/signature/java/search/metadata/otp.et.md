...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Otp rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Otp, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Otp"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Otp failides. Tehke oma Otp dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Otp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Otp, rakendades mõnda lihtsat sammu.
...
demos:
    ...
    content: |
       Otsige kohe dokumendist erinevaid elektroonilisi allkirju Otp-failidele, külastades veebisaiti [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
