...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Xlsm v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Xlsm pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Xlsm"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Xlsm. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Xlsm pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Xlsm z jejich aplikací implementací několika snadných kroků.
