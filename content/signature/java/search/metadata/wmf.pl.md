...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Wmf w Java"
head_description: "Użyj Java do wyszukiwania podpisów Metadata w plikach Wmf przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Wmf"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Wmf. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Wmf, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Metadata w Wmf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Metadata w plikach Wmf z ich aplikacji, wykonując kilka prostych kroków.
