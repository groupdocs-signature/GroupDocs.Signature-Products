...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Csv i Java"
head_description: "Úsáid Java chun sínithe Metadata a chuardach i gcomhaid Csv ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Csv"
...
steps:
    enable: true
    title_left: "Conas síniú Metadata a chuardach i Csv"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Metadata i gcomhaid Csv óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
