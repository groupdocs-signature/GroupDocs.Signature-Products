...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Pps i Java"
head_description: "Úsáid Java chun sínithe Metadata a chuardach i gcomhaid Pps ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Pps"
...
steps:
    enable: true
    title_left: "Conas síniú Metadata a chuardach i Pps"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Metadata i gcomhaid Pps óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
