...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Pps faile Java"
head_description: "Naudokite Java, norėdami ieškoti Metadata parašų Pps failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Pps faile"
description: "Java savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Pps failuose. Atlikite išplėstinę el. parašo paiešką savo Pps dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Metadata parašų Pps failuose iš savo programų, atlikdami kelis paprastus veiksmus.
