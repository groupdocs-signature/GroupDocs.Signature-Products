...
############################# Head ############################
head_title: "Cari tandatangan Metadata dalam fail Dotx dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Metadata dalam fail Dotx menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Metadata dalam fail Dotx."
description: "API asli Java membenarkan untuk mencari tandatangan Metadata dalam fail Dotx yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Dotx anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Metadata dalam Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Metadata dalam fail Dotx daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
