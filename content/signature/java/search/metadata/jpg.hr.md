...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Jpg u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Jpg pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Jpg datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Jpg datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Jpg dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Jpg iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
