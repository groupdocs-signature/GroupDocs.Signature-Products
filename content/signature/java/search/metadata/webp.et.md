...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Webp rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Webp, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Webp"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Webp failides. Tehke oma Webp dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Webp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Webp, rakendades mõnda lihtsat sammu.
