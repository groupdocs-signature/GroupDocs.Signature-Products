...
############################# Head ############################
head_title: "Cari tandatangan Metadata dalam fail Potx dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Metadata dalam fail Potx menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Metadata dalam fail Potx."
description: "API asli Java membenarkan untuk mencari tandatangan Metadata dalam fail Potx yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Potx anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Metadata dalam Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Metadata dalam fail Potx daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
