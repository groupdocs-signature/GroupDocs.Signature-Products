...
############################# Head ############################
head_title: "Vyhľadajte podpisy Metadata v súbore Odp v Java"
head_description: "Použite Java na vyhľadávanie Metadata podpisov v súboroch Odp pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Metadata v súbore Odp"
description: "Natívne API Java umožňuje vyhľadávať podpisy Metadata v už podpísaných súboroch Odp. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Odp pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Metadata v súboroch Odp z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
