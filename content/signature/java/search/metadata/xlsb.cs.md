...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Xlsb v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Xlsb pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Xlsb"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Xlsb. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Xlsb pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Xlsb z jejich aplikací implementací několika snadných kroků.
