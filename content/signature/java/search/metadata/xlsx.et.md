...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Xlsx rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Xlsx, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Xlsx"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Xlsx failides. Tehke oma Xlsx dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Xlsx, rakendades mõnda lihtsat sammu.
