...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Svg rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Svg, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Svg"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Svg failides. Tehke oma Svg dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Svg, rakendades mõnda lihtsat sammu.
