...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Bmp i Java"
head_description: "Úsáid Java chun sínithe Metadata a chuardach i gcomhaid Bmp ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Bmp"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Metadata sínithe i gcomhaid Bmp atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Bmp ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Metadata i gcomhaid Bmp óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
