...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Xlsm faile Java"
head_description: "Naudokite Java, norėdami ieškoti Metadata parašų Xlsm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Xlsm faile"
description: "Java savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Xlsm failuose. Atlikite išplėstinę el. parašo paiešką savo Xlsm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Metadata parašų Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Metadata parašų Xlsm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
