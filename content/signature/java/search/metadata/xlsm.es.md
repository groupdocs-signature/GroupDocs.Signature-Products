...
breadcrumb: Search Metadata signatures at Xlsm with Java

############################# Head ############################
head_title: "Busque Metadata firmas en Xlsm archivo en Java"
head_description: "Use Java para buscar firmas Metadata en archivos Xlsm usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Metadata en el archivo Xlsm"
description: "Java API nativa permite buscar Metadata firmas en archivos Xlsm ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Xlsm utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas Metadata en Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Metadata en archivos Xlsm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
    ...
    code: |
        ...
        // search for Metadata signatures in Xlsm document
...
demos:
    enable: true
    title: "Firmar con Metadata firmas Demostración en vivo"
    content: |
       Agregue varias firmas electrónicas a los archivos Xlsm ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).

        
############################# More Formats ############################
more_formats:
    enable: true
    title: "Busque otras firmas Metadata usando Java"
    content: |
