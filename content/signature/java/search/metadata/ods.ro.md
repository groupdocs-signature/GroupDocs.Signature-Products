...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Ods în Java"
head_description: "Utilizați Java pentru a căuta semnături Metadata în fișiere Ods folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Ods"
description: "API-ul nativ Java permite căutarea semnăturilor Metadata în fișierele Ods deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Ods folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Metadata în Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Metadata în fișierele Ods din aplicațiile lor prin implementarea câțiva pași simpli.
...
demos:
    ...
    content: |
       Căutați în document diferite semnături electronice în fișiere Ods chiar acum, vizitând site-ul web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
