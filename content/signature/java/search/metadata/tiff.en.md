...
############################# Head ############################
head_title: "Search Metadata signatures in Tiff file in Java"
head_description: "Use Java for searching Metadata signatures in Tiff files using a few lines of code."

############################# Header ############################
title: "Search Metadata signatures in Tiff file"
description: "Java native API to search Metadata signatures in already signed Tiff file. Perform advanced e-signature operations within your Tiff documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Metadata signatures in Tiff files from within their applications by implementing a few easy steps.
