...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Xlsm rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Xlsm, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Xlsm"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Xlsm failides. Tehke oma Xlsm dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Xlsm, rakendades mõnda lihtsat sammu.
