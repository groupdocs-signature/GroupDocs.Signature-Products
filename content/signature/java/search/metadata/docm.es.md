...
############################# Head ############################
head_title: "Busque Metadata firmas en Docm archivo en Java"
head_description: "Use Java para buscar firmas Metadata en archivos Docm usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Metadata en el archivo Docm"
description: "Java API nativa permite buscar Metadata firmas en archivos Docm ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Docm utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Metadata en Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Metadata en archivos Docm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
