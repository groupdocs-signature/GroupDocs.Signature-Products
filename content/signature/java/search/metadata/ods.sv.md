...
description: "Inbyggt API för Java gör det möjligt att söka efter Metadata-signaturer i redan signerade Ods-filer. Utför avancerad e-signatursökning i dina {{Filformat}}-dokument med några rader kod."
