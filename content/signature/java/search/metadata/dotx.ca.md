...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Dotx a Java"
head_description: "Utilitzeu Java per cercar signatures Metadata als fitxers Dotx mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Dotx"
description: "L'API nativa de Java permet cercar signatures Metadata als fitxers Dotx ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Dotx amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Metadata a Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Metadata als fitxers Dotx des de les seves aplicacions implementant uns quants passos senzills.
