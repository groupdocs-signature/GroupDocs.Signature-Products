...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Xlsm u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Xlsm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Xlsm datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Xlsm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xlsm dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Xlsm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
