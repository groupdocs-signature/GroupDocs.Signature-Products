...
description: "Java жергілікті API бұрыннан қол қойылған Xltx файлдарындағы Metadata қолтаңбаларын іздеуге мүмкіндік береді. Кодтың бірнеше жолын пайдаланып Xltx құжаттарыңызда кеңейтілген электрондық қолтаңбаны іздеуді орындаңыз."
