...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Xls w Java"
head_description: "Użyj Java do wyszukiwania podpisów Metadata w plikach Xls przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Xls"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Xls. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Xls, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Metadata w Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Metadata w plikach Xls z ich aplikacji, wykonując kilka prostych kroków.
...
demos:
    ...
    content: |
       Wyszukaj w dokumencie różne podpisy elektroniczne w plikach Xls, odwiedzając witrynę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
