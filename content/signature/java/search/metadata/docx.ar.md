...
############################# Head ############################
head_title: "ابحث عن توقيعات Metadata في ملف Docx في Java"
head_description: "استخدم Java للبحث عن توقيعات Metadata في ملفات Docx باستخدام بضعة أسطر من التعليمات البرمجية."

############################# Header ############################
title: "ابحث عن توقيعات Metadata في ملف Docx"
description: "تسمح واجهة برمجة التطبيقات الأصلية لـ Java بالبحث عن توقيعات Metadata في ملفات Docx الموقعة بالفعل. قم بإجراء بحث متقدم عن التوقيع الإلكتروني داخل مستندات Docx باستخدام بضعة أسطر من التعليمات البرمجية."
...
steps:
    enable: true
    title_left: "كيفية البحث عن توقيعات Metadata في Docx"
    content_left: |
        يسهّل [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) على مطوري Java البحث عن توقيعات Metadata في ملفات Docx من تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
