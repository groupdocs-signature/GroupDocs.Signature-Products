...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Webp a Java"
head_description: "Utilitzeu Java per cercar signatures Metadata als fitxers Webp mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Webp"
description: "L'API nativa de Java permet cercar signatures Metadata als fitxers Webp ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Webp amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Metadata a Webp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Metadata als fitxers Webp des de les seves aplicacions implementant uns quants passos senzills.
