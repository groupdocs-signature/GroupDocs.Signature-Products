...
############################# Head ############################
head_title: "Rechercher les signatures Metadata dans le fichier Ott dans Java"
head_description: "Utilisez Java pour rechercher des signatures Metadata dans des fichiers Ott en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Metadata dans le fichier Ott"
description: "L'API native Java permet de rechercher des signatures Metadata dans des fichiers Ott déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Ott en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Metadata dans Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Metadata dans des fichiers Ott à partir de leurs applications en mettant en œuvre quelques étapes simples.
