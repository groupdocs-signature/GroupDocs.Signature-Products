...
############################# Head ############################
head_title: "Keressen Metadata aláírásokat a Xlsb fájlban a Java programban"
head_description: "A Java használatával kereshet Metadata aláírásokat a Xlsb fájlokban néhány sornyi kód használatával."

############################# Header ############################
title: "Keressen Metadata aláírásokat a Xlsb fájlban"
description: "A Java natív API lehetővé teszi a Metadata aláírások keresését a már aláírt Xlsb fájlokban. Végezzen speciális e-aláírás-keresést a Xlsb dokumentumaiban néhány sornyi kód használatával."
...
steps:
    enable: true
    title_left: "Metadata aláírások keresése a Xlsb fájlban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy Metadata aláírásokat keressenek alkalmazásaik Xlsb fájljaiban.
