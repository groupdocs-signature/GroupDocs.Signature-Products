...
############################# Head ############################
head_title: "Li Metadata îmzeyan di pela Pptx de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Metadata di pelên Pptx de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Pptx de li îmzeyên Metadata bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Pptx yên jixwe îmzekirî de li îmzeyên Metadata bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Pptx de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Metadata di Pptx de digere"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Metadata di pelên Pptx îmzeyan de ji sepanên xwe bigerin.
