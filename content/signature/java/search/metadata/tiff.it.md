...
############################# Head ############################
head_title: "Cerca le firme Metadata nel file Tiff in Java"
head_description: "Usa Java per cercare le firme Metadata nei file Tiff utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Metadata nel file Tiff"
description: "L'API nativa Java consente di cercare firme Metadata in file Tiff già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Tiff utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Metadata nei file Tiff dalle loro applicazioni implementando alcuni semplici passaggi.
