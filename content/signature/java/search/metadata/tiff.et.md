...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Tiff rakenduses Java"
head_description: "Kasutage Java allkirjade Metadata otsimiseks failides Tiff, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Tiff"
description: "Native API Java võimaldab otsida allkirju Metadata juba allkirjastatud Tiff failides. Tehke oma Tiff dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Metadata otsimist oma rakendustest failides Tiff, rakendades mõnda lihtsat sammu.
