...
############################# Head ############################
head_title: "Zoek naar Metadata handtekeningen in Docm bestand in Java"
head_description: "Gebruik Java om te zoeken naar Metadata handtekeningen in Docm bestanden met een paar regels code."

############################# Header ############################
title: "Zoek naar Metadata handtekeningen in Docm bestand"
description: "Java native API maakt het mogelijk om te zoeken naar Metadata handtekeningen in reeds ondertekende Docm bestanden. Voer geavanceerd zoeken naar elektronische handtekeningen uit in uw Docm-documenten met een paar regels code."
...
steps:
    enable: true
    title_left: "Zoeken naar handtekeningen van Metadata in Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) maakt het voor Java-ontwikkelaars gemakkelijker om te zoeken naar Metadata-handtekeningen in Docm-bestanden vanuit hun applicaties door een paar eenvoudige stappen te implementeren.
