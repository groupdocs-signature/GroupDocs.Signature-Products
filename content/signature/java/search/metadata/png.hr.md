...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Png u Java"
head_description: "Upotrijebite Java za traženje potpisa Metadata u datotekama Png pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Png datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Metadata u već potpisanim Png datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Png dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Metadata u datotekama Png iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
