...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Wmf v Java"
head_description: "Použijte Java k vyhledávání podpisů Metadata v souborech Wmf pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Wmf"
description: "Nativní API Java umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Wmf. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Wmf pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Metadata v souborech Wmf z jejich aplikací implementací několika snadných kroků.
