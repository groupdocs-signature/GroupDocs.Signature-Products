...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Doc v Java"
head_description: "Uporabite Java za iskanje podpisov Metadata v datotekah Doc z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Doc"
description: "Izvorni API za Java omogoča iskanje podpisov Metadata v že podpisanih datotekah Doc. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Doc z uporabo nekaj vrstic kode."
...
steps:
    enable: true
    title_left: "Kako poiskati podpise Metadata v Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Metadata v datotekah Doc iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
