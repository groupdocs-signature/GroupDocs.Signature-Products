...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Otp i Java"
head_description: "Úsáid Java chun sínithe Metadata a chuardach i gcomhaid Otp ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Otp"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Metadata sínithe i gcomhaid Otp atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Otp ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Metadata i gcomhaid Otp óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
