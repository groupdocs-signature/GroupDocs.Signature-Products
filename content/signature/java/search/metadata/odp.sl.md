...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Odp v Java"
head_description: "Uporabite Java za iskanje podpisov Metadata v datotekah Odp z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Odp"
description: "Izvorni API za Java omogoča iskanje podpisov Metadata v že podpisanih datotekah Odp. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Odp z uporabo nekaj vrstic kode."
...
steps:
    enable: true
    title_left: "Kako poiskati podpise Metadata v Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Metadata v datotekah Odp iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
