...
############################# Head ############################
head_title: "Vyhledejte podpisy Text v souboru Odt v Java"
head_description: "Použijte Java k vyhledávání podpisů Text v souborech Odt pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Text v souboru Odt"
description: "Nativní API Java umožňuje vyhledávat podpisy Text v již podepsaných souborech Odt. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Odt pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Text v Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Text v souborech Odt z jejich aplikací implementací několika snadných kroků.
