...
############################# Head ############################
head_title: "Vyhľadajte podpisy Text v súbore Rtf v Java"
head_description: "Použite Java na vyhľadávanie Text podpisov v súboroch Rtf pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Text v súbore Rtf"
description: "Natívne API Java umožňuje vyhľadávať podpisy Text v už podpísaných súboroch Rtf. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Rtf pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Text v Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Text v súboroch Rtf z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
