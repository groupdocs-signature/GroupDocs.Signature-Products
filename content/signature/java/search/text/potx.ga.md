...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Potx i Java"
head_description: "Úsáid Java chun sínithe Text a chuardach i gcomhaid Potx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Text sínithe i gcomhad Potx"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Text sínithe i gcomhaid Potx atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Potx ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Text a chuardach i Potx"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Text i gcomhaid Potx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
