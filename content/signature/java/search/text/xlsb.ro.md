...
############################# Head ############################
head_title: "Căutați semnături Text în fișierul Xlsb în Java"
head_description: "Utilizați Java pentru a căuta semnături Text în fișiere Xlsb folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Text în fișierul Xlsb"
description: "API-ul nativ Java permite căutarea semnăturilor Text în fișierele Xlsb deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Xlsb folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Text în fișierele Xlsb din aplicațiile lor prin implementarea câțiva pași simpli.
