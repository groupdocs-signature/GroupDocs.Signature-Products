...
############################# Head ############################
head_title: "Ieškokite Text parašų Xltm faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Xltm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Xltm faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Xltm failuose. Atlikite išplėstinę el. parašo paiešką savo Xltm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Xltm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
...
demos:
    ...
    content: |
       Dabar ieškokite dokumente įvairių elektroninių parašų prie Xltm failų, apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje.
