...
############################# Head ############################
head_title: "Vyhľadajte podpisy Text v súbore Potx v Java"
head_description: "Použite Java na vyhľadávanie Text podpisov v súboroch Potx pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Text v súbore Potx"
description: "Natívne API Java umožňuje vyhľadávať podpisy Text v už podpísaných súboroch Potx. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Potx pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Text v Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Text v súboroch Potx z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
