...
############################# Head ############################
head_title: "Ieškokite Text parašų Ots faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Ots failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Ots faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Ots failuose. Atlikite išplėstinę el. parašo paiešką savo Ots dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Ots failuose iš savo programų, atlikdami kelis paprastus veiksmus.
