...
description: "Inbyggt API för Java gör det möjligt att söka efter Text-signaturer i redan signerade Odt-filer. Utför avancerad e-signatursökning i dina {{Filformat}}-dokument med några rader kod."
