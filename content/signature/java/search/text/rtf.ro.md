...
############################# Head ############################
head_title: "Căutați semnături Text în fișierul Rtf în Java"
head_description: "Utilizați Java pentru a căuta semnături Text în fișiere Rtf folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Text în fișierul Rtf"
description: "API-ul nativ Java permite căutarea semnăturilor Text în fișierele Rtf deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Rtf folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Text în fișierele Rtf din aplicațiile lor prin implementarea câțiva pași simpli.
