...
############################# Head ############################
head_title: "Poiščite podpise Text v datoteki Odp v Java"
head_description: "Uporabite Java za iskanje podpisov Text v datotekah Odp z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Text v datoteki Odp"
description: "Izvorni API za Java omogoča iskanje podpisov Text v že podpisanih datotekah Odp. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Odp z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Text v datotekah Odp iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
