...
############################# Head ############################
head_title: "Ieškokite Text parašų Odt faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Odt failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Odt faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Odt failuose. Atlikite išplėstinę el. parašo paiešką savo Odt dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Odt failuose iš savo programų, atlikdami kelis paprastus veiksmus.
