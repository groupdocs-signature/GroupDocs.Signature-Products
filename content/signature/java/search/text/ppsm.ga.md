...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Ppsm i Java"
head_description: "Úsáid Java chun sínithe Text a chuardach i gcomhaid Ppsm ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Text sínithe i gcomhad Ppsm"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Text sínithe i gcomhaid Ppsm atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Ppsm ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Text a chuardach i Ppsm"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Text i gcomhaid Ppsm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
