...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Odt dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Odt menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Odt."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Odt yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Odt anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Text dalam Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Odt daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
