...
############################# Head ############################
head_title: "Cari tanda tangan Text dalam file Ots di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Text di file Ots menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Text di file Ots"
description: "Java API asli memungkinkan untuk mencari Text tanda tangan di file Ots yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ots Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Text di Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Text dalam file Ots dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
