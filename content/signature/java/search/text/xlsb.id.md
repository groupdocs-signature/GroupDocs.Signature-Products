...
############################# Head ############################
head_title: "Cari tanda tangan Text dalam file Xlsb di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Text di file Xlsb menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Text di file Xlsb"
description: "Java API asli memungkinkan untuk mencari Text tanda tangan di file Xlsb yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xlsb Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Text di Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Text dalam file Xlsb dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
