...
############################# Head ############################
head_title: "Ieškokite Text parašų Xltx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Xltx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Xltx faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Xltx failuose. Atlikite išplėstinę el. parašo paiešką savo Xltx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Xltx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
