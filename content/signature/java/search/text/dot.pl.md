...
############################# Head ############################
head_title: "Wyszukaj podpisy Text w pliku Dot w Java"
head_description: "Użyj Java do wyszukiwania podpisów Text w plikach Dot przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Text w pliku Dot"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Text w już podpisanych plikach Dot. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Dot, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Text w Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Text w plikach Dot z ich aplikacji, wykonując kilka prostych kroków.
