...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Potm u Java"
head_description: "Upotrijebite Java za traženje potpisa Text u datotekama Potm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Potm datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Text u već potpisanim Potm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Potm dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Text u datotekama Potm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
