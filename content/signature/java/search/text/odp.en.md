...
############################# Head ############################
head_title: "Search Text signatures in Odp file in Java"
head_description: "Use Java for searching Text signatures in Odp files using a few lines of code."

############################# Header ############################
title: "Search Text signatures in Odp file"
description: "Java native API to search Text signatures in already signed Odp file. Perform advanced e-signature operations within your Odp documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Text signatures in Odp files from within their applications by implementing a few easy steps.
