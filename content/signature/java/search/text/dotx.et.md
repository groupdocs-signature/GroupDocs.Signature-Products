...
############################# Head ############################
head_title: "Otsige allkirju Text failist Dotx rakenduses Java"
head_description: "Kasutage Java allkirjade Text otsimiseks failides Dotx, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Dotx"
description: "Native API Java võimaldab otsida allkirju Text juba allkirjastatud Dotx failides. Tehke oma Dotx dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Text otsimine failivormingus Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Text otsimist oma rakendustest failides Dotx, rakendades mõnda lihtsat sammu.
