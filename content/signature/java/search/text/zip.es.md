...
############################# Head ############################
head_title: "Busque Text firmas en Zip archivo en Java"
head_description: "Use Java para buscar firmas Text en archivos Zip usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Text en el archivo Zip"
description: "Java API nativa permite buscar Text firmas en archivos Zip ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Zip utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Text en Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Text en archivos Zip desde sus aplicaciones mediante la implementación de unos sencillos pasos.
