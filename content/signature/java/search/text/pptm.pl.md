...
############################# Head ############################
head_title: "Wyszukaj podpisy Text w pliku Pptm w Java"
head_description: "Użyj Java do wyszukiwania podpisów Text w plikach Pptm przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Text w pliku Pptm"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Text w już podpisanych plikach Pptm. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Pptm, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Text w Pptm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Text w plikach Pptm z ich aplikacji, wykonując kilka prostych kroków.
