...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Ppt i Java"
head_description: "Úsáid Java chun sínithe Text a chuardach i gcomhaid Ppt ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Text sínithe i gcomhad Ppt"
...
steps:
    enable: true
    title_left: "Conas síniú Text a chuardach i Ppt"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Text i gcomhaid Ppt óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
