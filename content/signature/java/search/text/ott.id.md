...
############################# Head ############################
head_title: "Cari tanda tangan Text dalam file Ott di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Text di file Ott menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Text di file Ott"
description: "Java API asli memungkinkan untuk mencari Text tanda tangan di file Ott yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ott Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Text di Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Text dalam file Ott dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
