...
############################# Head ############################
head_title: "Търсене на подписи Text във файл Zip в Java"
head_description: "Използвайте Java за търсене на подписи Text във файлове Zip, като използвате няколко реда код."

############################# Header ############################
title: "Търсене на подписи Text във файл Zip"
description: "Нативният API на Java позволява търсене на подписи на Text във вече подписани файлове на Zip. Извършете разширено търсене с електронен подпис във вашите Zip документи, като използвате няколко реда код."
...
steps:
    enable: true
    title_left: "Как да търсите Text подписи във Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) улеснява разработчиците на Java да търсят подписи на Text във файловете на Zip от техните приложения чрез прилагане на няколко лесни стъпки.
