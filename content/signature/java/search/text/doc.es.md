...
############################# Head ############################
head_title: "Busque Text firmas en Doc archivo en Java"
head_description: "Use Java para buscar firmas Text en archivos Doc usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Text en el archivo Doc"
description: "Java API nativa permite buscar Text firmas en archivos Doc ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Doc utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Text en archivos Doc desde sus aplicaciones mediante la implementación de unos sencillos pasos.
