...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Dotx u Java"
head_description: "Upotrijebite Java za traženje potpisa Text u datotekama Dotx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Dotx datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Text u već potpisanim Dotx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Dotx dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Text potpise u Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Text u datotekama Dotx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
