...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Xlsb dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Xlsb menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Xlsb."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Xlsb yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Xlsb anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Xlsb daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
