...
############################# Head ############################
head_title: "Java içinde Ott dosyasında Text imzasını arayın"
head_description: "Birkaç satır kod kullanarak Ott dosyalarında Text imzasını aramak için Java kullanın."

############################# Header ############################
title: "Ott dosyasında Text imzasını arayın"
description: "Java yerel API'si, önceden imzalanmış Ott dosyalarında Text imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Ott belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Ott içinde Text imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak Ott dosyalarında Text imzalarını aramasını kolaylaştırır.
