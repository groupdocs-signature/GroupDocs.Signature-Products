...
############################# Head ############################
head_title: "Procure por assinaturas Text no arquivo 7z em Java"
head_description: "Use Java para pesquisar assinaturas Text em arquivos 7z usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Text no arquivo 7z"
description: "A API nativa do Java permite pesquisar assinaturas Text em arquivos 7z já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos 7z usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Text em 7z"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Text em arquivos 7z de seus aplicativos implementando algumas etapas fáceis.
