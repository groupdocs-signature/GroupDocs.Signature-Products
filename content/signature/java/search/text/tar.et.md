...
############################# Head ############################
head_title: "Otsige allkirju Text failist Tar rakenduses Java"
head_description: "Kasutage Java allkirjade Text otsimiseks failides Tar, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Tar"
description: "Native API Java võimaldab otsida allkirju Text juba allkirjastatud Tar failides. Tehke oma Tar dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Text otsimine failivormingus Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Text otsimist oma rakendustest failides Tar, rakendades mõnda lihtsat sammu.
