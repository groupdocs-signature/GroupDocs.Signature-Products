...
############################# Head ############################
head_title: "Otsige allkirju Text failist Ots rakenduses Java"
head_description: "Kasutage Java allkirjade Text otsimiseks failides Ots, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Ots"
description: "Native API Java võimaldab otsida allkirju Text juba allkirjastatud Ots failides. Tehke oma Ots dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Text otsimine failivormingus Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Text otsimist oma rakendustest failides Ots, rakendades mõnda lihtsat sammu.
