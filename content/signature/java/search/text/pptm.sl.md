...
############################# Head ############################
head_title: "Poiščite podpise Text v datoteki Pptm v Java"
head_description: "Uporabite Java za iskanje podpisov Text v datotekah Pptm z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Text v datoteki Pptm"
description: "Izvorni API za Java omogoča iskanje podpisov Text v že podpisanih datotekah Pptm. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Pptm z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Text v datotekah Pptm iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
