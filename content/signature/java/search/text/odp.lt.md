...
############################# Head ############################
head_title: "Ieškokite Text parašų Odp faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Odp failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Odp faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Odp failuose. Atlikite išplėstinę el. parašo paiešką savo Odp dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Odp failuose iš savo programų, atlikdami kelis paprastus veiksmus.
