...
############################# Head ############################
head_title: "Ieškokite Text parašų Ppsx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Ppsx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Ppsx faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Ppsx failuose. Atlikite išplėstinę el. parašo paiešką savo Ppsx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Ppsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Ppsx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
