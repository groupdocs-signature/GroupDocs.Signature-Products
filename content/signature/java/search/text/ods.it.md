...
############################# Head ############################
head_title: "Cerca le firme Text nel file Ods in Java"
head_description: "Usa Java per cercare le firme Text nei file Ods utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Text nel file Ods"
description: "L'API nativa Java consente di cercare firme Text in file Ods già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Ods utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Text nei file Ods dalle loro applicazioni implementando alcuni semplici passaggi.
