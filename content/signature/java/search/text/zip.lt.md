...
############################# Head ############################
head_title: "Ieškokite Text parašų Zip faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Zip failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Zip faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Zip failuose. Atlikite išplėstinę el. parašo paiešką savo Zip dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Zip failuose iš savo programų, atlikdami kelis paprastus veiksmus.
...
demos:
    ...
    content: |
       Dabar ieškokite dokumente įvairių elektroninių parašų prie Zip failų, apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje.
