...
############################# Head ############################
head_title: "Search for Text signatures in Ppsx file in Java"
head_description: "Use Java for searching for Text signatures in Ppsx files using a few lines of code."

############################# Header ############################
title: "Search for Text signatures in Ppsx file"
description: "Java native API allows to search for Text signatures in already signed Ppsx files. Perform advanced e-signature search within your Ppsx documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Text signatures in Ppsx files from their applications by implementing a few easy steps.
