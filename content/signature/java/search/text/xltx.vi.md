...
############################# Head ############################
head_title: "Tìm kiếm chữ ký Text trong tệp Xltx trong Java"
head_description: "Sử dụng Java để tìm kiếm chữ ký Text trong tệp Xltx bằng một vài dòng mã."

############################# Header ############################
title: "Tìm kiếm chữ ký Text trong tệp Xltx"
description: "API gốc Java cho phép tìm kiếm chữ ký Text trong các tệp Xltx đã được ký. Thực hiện tìm kiếm chữ ký điện tử nâng cao trong tài liệu Xltx của bạn bằng cách sử dụng một vài dòng mã."
...
steps:
    enable: true
    title_left: "Cách tìm kiếm chữ ký Text trong Xltx"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) giúp các nhà phát triển Java tìm kiếm chữ ký Text trong tệp Xltx từ ứng dụng của họ dễ dàng hơn bằng cách thực hiện một vài bước đơn giản.
