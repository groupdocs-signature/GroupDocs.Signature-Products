...
############################# Head ############################
head_title: "Procure por assinaturas Text no arquivo Potx em Java"
head_description: "Use Java para pesquisar assinaturas Text em arquivos Potx usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Text no arquivo Potx"
description: "A API nativa do Java permite pesquisar assinaturas Text em arquivos Potx já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Potx usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Text em Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Text em arquivos Potx de seus aplicativos implementando algumas etapas fáceis.
