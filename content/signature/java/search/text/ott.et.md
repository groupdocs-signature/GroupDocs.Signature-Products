...
############################# Head ############################
head_title: "Otsige allkirju Text failist Ott rakenduses Java"
head_description: "Kasutage Java allkirjade Text otsimiseks failides Ott, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Ott"
description: "Native API Java võimaldab otsida allkirju Text juba allkirjastatud Ott failides. Tehke oma Ott dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Text otsimine failivormingus Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Text otsimist oma rakendustest failides Ott, rakendades mõnda lihtsat sammu.
