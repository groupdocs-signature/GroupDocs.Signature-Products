...
############################# Head ############################
head_title: "Cerqueu signatures de Text al fitxer Dotm a Java"
head_description: "Utilitzeu Java per cercar signatures Text als fitxers Dotm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Text al fitxer Dotm"
description: "L'API nativa de Java permet cercar signatures Text als fitxers Dotm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Dotm amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Text a Dotm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Text als fitxers Dotm des de les seves aplicacions implementant uns quants passos senzills.
