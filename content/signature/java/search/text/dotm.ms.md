...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Dotm dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Dotm menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Dotm."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Dotm yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Dotm anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Text dalam Dotm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Dotm daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
