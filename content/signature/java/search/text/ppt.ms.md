...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Ppt dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Ppt menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Ppt."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Ppt yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Ppt anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Ppt daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
