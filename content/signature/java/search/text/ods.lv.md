...
############################# Head ############################
head_title: "Meklēt Text parakstus Ods failā programmā Java"
head_description: "Izmantojiet Java, lai meklētu Text parakstus Ods failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Text parakstus failā Ods"
description: "Java vietējais API ļauj meklēt Text parakstus jau parakstītos Ods failos. Veiciet izvērsto e-paraksta meklēšanu savos Ods dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    enable: true
    title_left: "Kā meklēt Text parakstus Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ļauj Java izstrādātājiem vieglāk meklēt Text parakstus Ods failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
