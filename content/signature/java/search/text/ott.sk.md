...
############################# Head ############################
head_title: "Vyhľadajte podpisy Text v súbore Ott v Java"
head_description: "Použite Java na vyhľadávanie Text podpisov v súboroch Ott pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Text v súbore Ott"
description: "Natívne API Java umožňuje vyhľadávať podpisy Text v už podpísaných súboroch Ott. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Ott pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Text v súboroch Ott z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
