...
############################# Head ############################
head_title: "Wyszukaj podpisy Text w pliku Odp w Java"
head_description: "Użyj Java do wyszukiwania podpisów Text w plikach Odp przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Text w pliku Odp"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Text w już podpisanych plikach Odp. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Odp, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Text w plikach Odp z ich aplikacji, wykonując kilka prostych kroków.
