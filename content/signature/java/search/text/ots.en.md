...
############################# Head ############################
head_title: "Search for Text signatures in Ots file in Java"
head_description: "Use Java for searching for Text signatures in Ots files using a few lines of code."

############################# Header ############################
title: "Search for Text signatures in Ots file"
description: "Java native API allows to search for Text signatures in already signed Ots files. Perform advanced e-signature search within your Ots documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Text signatures in Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Text signatures in Ots files from their applications by implementing a few easy steps.
