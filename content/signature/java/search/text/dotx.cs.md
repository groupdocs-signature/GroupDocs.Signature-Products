...
############################# Head ############################
head_title: "Vyhledejte podpisy Text v souboru Dotx v Java"
head_description: "Použijte Java k vyhledávání podpisů Text v souborech Dotx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Text v souboru Dotx"
description: "Nativní API Java umožňuje vyhledávat podpisy Text v již podepsaných souborech Dotx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Dotx pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Text v Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Text v souborech Dotx z jejich aplikací implementací několika snadných kroků.
