...
############################# Head ############################
head_title: "Tìm kiếm chữ ký Text trong tệp Rtf trong Java"
head_description: "Sử dụng Java để tìm kiếm chữ ký Text trong tệp Rtf bằng một vài dòng mã."

############################# Header ############################
title: "Tìm kiếm chữ ký Text trong tệp Rtf"
description: "API gốc Java cho phép tìm kiếm chữ ký Text trong các tệp Rtf đã được ký. Thực hiện tìm kiếm chữ ký điện tử nâng cao trong tài liệu Rtf của bạn bằng cách sử dụng một vài dòng mã."
...
steps:
    enable: true
    title_left: "Cách tìm kiếm chữ ký Text trong Rtf"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) giúp các nhà phát triển Java tìm kiếm chữ ký Text trong tệp Rtf từ ứng dụng của họ dễ dàng hơn bằng cách thực hiện một vài bước đơn giản.
...
demos:
    ...
    content: |
       Tìm kiếm tài liệu để tìm các chữ ký điện tử khác nhau cho các tệp Rtf ngay bây giờ bằng cách truy cập trang web [GroupDocs.Signature App] (https://products.groupdocs.app/signature/family).
