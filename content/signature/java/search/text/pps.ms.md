...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Pps dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Pps menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Pps."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Pps yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Pps anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Text dalam Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Pps daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
