...
############################# Head ############################
head_title: "Cerca le firme Text nel file Tar in Java"
head_description: "Usa Java per cercare le firme Text nei file Tar utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Text nel file Tar"
description: "L'API nativa Java consente di cercare firme Text in file Tar già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Tar utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Text in Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Text nei file Tar dalle loro applicazioni implementando alcuni semplici passaggi.
