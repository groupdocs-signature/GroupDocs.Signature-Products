...
############################# Head ############################
head_title: "Procure por assinaturas Text no arquivo Xltm em Java"
head_description: "Use Java para pesquisar assinaturas Text em arquivos Xltm usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Text no arquivo Xltm"
description: "A API nativa do Java permite pesquisar assinaturas Text em arquivos Xltm já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Xltm usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Text em Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Text em arquivos Xltm de seus aplicativos implementando algumas etapas fáceis.
