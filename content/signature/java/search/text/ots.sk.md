...
############################# Head ############################
head_title: "Vyhľadajte podpisy Text v súbore Ots v Java"
head_description: "Použite Java na vyhľadávanie Text podpisov v súboroch Ots pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Text v súbore Ots"
description: "Natívne API Java umožňuje vyhľadávať podpisy Text v už podpísaných súboroch Ots. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Ots pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Text v súboroch Ots z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
