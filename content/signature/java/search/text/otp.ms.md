...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Otp dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Otp menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Otp."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Otp yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Otp anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Otp daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
