...
############################# Head ############################
head_title: "Otsige allkirju Text failist Odt rakenduses Java"
head_description: "Kasutage Java allkirjade Text otsimiseks failides Odt, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Odt"
description: "Native API Java võimaldab otsida allkirju Text juba allkirjastatud Odt failides. Tehke oma Odt dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Text otsimine failivormingus Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Text otsimist oma rakendustest failides Odt, rakendades mõnda lihtsat sammu.
