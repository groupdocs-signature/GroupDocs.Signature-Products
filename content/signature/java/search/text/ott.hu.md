...
############################# Head ############################
head_title: "Keressen Text aláírásokat a Ott fájlban a Java programban"
head_description: "A Java használatával kereshet Text aláírásokat a Ott fájlokban néhány sornyi kód használatával."

############################# Header ############################
title: "Keressen Text aláírásokat a Ott fájlban"
description: "A Java natív API lehetővé teszi a Text aláírások keresését a már aláírt Ott fájlokban. Végezzen speciális e-aláírás-keresést a Ott dokumentumaiban néhány sornyi kód használatával."
...
steps:
    enable: true
    title_left: "Text aláírások keresése a Ott fájlban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy Text aláírásokat keressenek alkalmazásaik Ott fájljaiban.
