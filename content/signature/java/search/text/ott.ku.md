...
############################# Head ############################
head_title: "Li Text îmzeyan di pela Ott de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Text di pelên Ott de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Ott de li îmzeyên Text bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Ott yên jixwe îmzekirî de li îmzeyên Text bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Ott de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Text di Ott de digere"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Text di pelên Ott îmzeyan de ji sepanên xwe bigerin.
