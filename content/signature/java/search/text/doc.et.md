...
############################# Head ############################
head_title: "Otsige allkirju Text failist Doc rakenduses Java"
head_description: "Kasutage Java allkirjade Text otsimiseks failides Doc, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Doc"
description: "Native API Java võimaldab otsida allkirju Text juba allkirjastatud Doc failides. Tehke oma Doc dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Text otsimine failivormingus Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Text otsimist oma rakendustest failides Doc, rakendades mõnda lihtsat sammu.
