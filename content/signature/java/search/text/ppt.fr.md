...
############################# Head ############################
head_title: "Rechercher les signatures Text dans le fichier Ppt dans Java"
head_description: "Utilisez Java pour rechercher des signatures Text dans des fichiers Ppt en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Text dans le fichier Ppt"
description: "L'API native Java permet de rechercher des signatures Text dans des fichiers Ppt déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Ppt en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Text dans Ppt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Text dans des fichiers Ppt à partir de leurs applications en mettant en œuvre quelques étapes simples.
