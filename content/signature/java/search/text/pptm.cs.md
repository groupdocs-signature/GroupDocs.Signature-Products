...
############################# Head ############################
head_title: "Vyhledejte podpisy Text v souboru Pptm v Java"
head_description: "Použijte Java k vyhledávání podpisů Text v souborech Pptm pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Text v souboru Pptm"
description: "Nativní API Java umožňuje vyhledávat podpisy Text v již podepsaných souborech Pptm. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Pptm pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Text v Pptm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Text v souborech Pptm z jejich aplikací implementací několika snadných kroků.
