...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Pptx dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Pptx menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Pptx."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Pptx yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Pptx anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Text dalam Pptx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Pptx daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
