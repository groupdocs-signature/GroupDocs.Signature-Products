...
############################# Head ############################
head_title: "Cerqueu signatures de Text al fitxer Docm a Java"
head_description: "Utilitzeu Java per cercar signatures Text als fitxers Docm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Text al fitxer Docm"
description: "L'API nativa de Java permet cercar signatures Text als fitxers Docm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Docm amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Text a Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Text als fitxers Docm des de les seves aplicacions implementant uns quants passos senzills.
