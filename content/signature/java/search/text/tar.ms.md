...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Tar dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Tar menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Tar."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Tar yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Tar anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Text dalam Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Tar daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
