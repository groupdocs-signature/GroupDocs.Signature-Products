...
############################# Head ############################
head_title: "Keressen Text aláírásokat a Pptm fájlban a Java programban"
head_description: "A Java használatával kereshet Text aláírásokat a Pptm fájlokban néhány sornyi kód használatával."

############################# Header ############################
title: "Keressen Text aláírásokat a Pptm fájlban"
description: "A Java natív API lehetővé teszi a Text aláírások keresését a már aláírt Pptm fájlokban. Végezzen speciális e-aláírás-keresést a Pptm dokumentumaiban néhány sornyi kód használatával."
...
steps:
    enable: true
    title_left: "Text aláírások keresése a Pptm fájlban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy Text aláírásokat keressenek alkalmazásaik Pptm fájljaiban.
