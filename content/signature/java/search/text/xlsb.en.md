...
############################# Head ############################
head_title: "Search Text signatures in Xlsb file in Java"
head_description: "Use Java for searching Text signatures in Xlsb files using a few lines of code."

############################# Header ############################
title: "Search Text signatures in Xlsb file"
description: "Java native API to search Text signatures in already signed Xlsb file. Perform advanced e-signature operations within your Xlsb documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Text signatures in Xlsb files from within their applications by implementing a few easy steps.
