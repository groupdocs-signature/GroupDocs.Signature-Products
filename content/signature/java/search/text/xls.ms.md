...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Xls dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Xls menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Xls."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Xls yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Xls anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Text dalam Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Xls daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
