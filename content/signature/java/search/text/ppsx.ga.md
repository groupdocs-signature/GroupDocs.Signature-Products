...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Ppsx i Java"
head_description: "Úsáid Java chun sínithe Text a chuardach i gcomhaid Ppsx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Text sínithe i gcomhad Ppsx"
...
steps:
    enable: true
    title_left: "Conas síniú Text a chuardach i Ppsx"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Text i gcomhaid Ppsx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
