...
breadcrumb: Search Text signatures at Rtf with Java

############################# Head ############################
head_title: "Cari tanda tangan Text dalam file Rtf di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Text di file Rtf menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Text di file Rtf"
description: "Java API asli memungkinkan untuk mencari Text tanda tangan di file Rtf yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Rtf Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Text di Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Text dalam file Rtf dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ...
        // search for Text signatures in Rtf document
...
demos:
    ...
    content: |
       Cari dokumen untuk berbagai tanda tangan elektronik ke file Rtf sekarang juga dengan mengunjungi situs web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
