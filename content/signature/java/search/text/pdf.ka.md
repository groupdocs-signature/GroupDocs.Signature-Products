...
############################# Head ############################
head_title: "მოძებნეთ Text ხელმოწერები Pdf ფაილში Java"
head_description: "გამოიყენეთ Java Text ხელმოწერების მოსაძიებლად Pdf ფაილებში კოდის რამდენიმე ხაზის გამოყენებით."

############################# Header ############################
title: "მოძებნეთ Text ხელმოწერები Pdf ფაილში"
description: "Java მშობლიური API საშუალებას გაძლევთ მოძებნოთ Text ხელმოწერები უკვე ხელმოწერილ Pdf ფაილებში. განახორციელეთ ელექტრონული ხელმოწერის გაფართოებული ძიება თქვენს {{ფაილის ფორმატში}} დოკუმენტებში კოდის რამდენიმე ხაზის გამოყენებით."
...
steps:
    enable: true
    title_left: "როგორ მოძებნოთ Text ხელმოწერები Pdf-ში"
    content_left: |
