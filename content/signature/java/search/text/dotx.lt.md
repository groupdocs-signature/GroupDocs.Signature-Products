...
############################# Head ############################
head_title: "Ieškokite Text parašų Dotx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Dotx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Dotx faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Dotx failuose. Atlikite išplėstinę el. parašo paiešką savo Dotx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Dotx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
