...
############################# Head ############################
head_title: "Cerqueu signatures de Text al fitxer Ots a Java"
head_description: "Utilitzeu Java per cercar signatures Text als fitxers Ots mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Text al fitxer Ots"
description: "L'API nativa de Java permet cercar signatures Text als fitxers Ots ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Ots amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Text a Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Text als fitxers Ots des de les seves aplicacions implementant uns quants passos senzills.
