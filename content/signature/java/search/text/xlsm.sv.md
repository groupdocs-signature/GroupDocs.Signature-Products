...
############################# Head ############################
head_title: "Sök efter Text-signaturer i filen Xlsm i Java"
head_description: "Använd Java för att söka efter Text-signaturer i Xlsm-filer med några rader kod."

############################# Header ############################
title: "Sök efter Text-signaturer i filen Xlsm"
description: "Inbyggt API för Java gör det möjligt att söka efter Text-signaturer i redan signerade Xlsm-filer. Utför avancerad e-signatursökning i dina Xlsm-dokument med några rader kod."
...
steps:
    enable: true
    title_left: "Hur man söker efter Text-signaturer i Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gör det enklare för Java-utvecklare att söka efter Text-signaturer i Xlsm-filer från sina applikationer genom att implementera några enkla steg.
