...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Odt i Java"
head_description: "Úsáid Java chun sínithe Text a chuardach i gcomhaid Odt ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Text sínithe i gcomhad Odt"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Text sínithe i gcomhaid Odt atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Odt ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Text a chuardach i Odt"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Text i gcomhaid Odt óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
