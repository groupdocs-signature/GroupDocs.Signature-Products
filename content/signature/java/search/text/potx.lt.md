...
############################# Head ############################
head_title: "Ieškokite Text parašų Potx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Potx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Potx faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Potx failuose. Atlikite išplėstinę el. parašo paiešką savo Potx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Potx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
