...
############################# Head ############################
head_title: "Rechercher les signatures Text dans le fichier Xlsx dans Java"
head_description: "Utilisez Java pour rechercher des signatures Text dans des fichiers Xlsx en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Text dans le fichier Xlsx"
description: "L'API native Java permet de rechercher des signatures Text dans des fichiers Xlsx déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Xlsx en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Text dans Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Text dans des fichiers Xlsx à partir de leurs applications en mettant en œuvre quelques étapes simples.
