...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Dot i Java"
head_description: "Úsáid Java chun sínithe Text a chuardach i gcomhaid Dot ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Text sínithe i gcomhad Dot"
...
steps:
    enable: true
    title_left: "Conas síniú Text a chuardach i Dot"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Text i gcomhaid Dot óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
