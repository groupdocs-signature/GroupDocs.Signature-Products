...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Zip dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Zip menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Zip."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Zip yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Zip anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Zip daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
