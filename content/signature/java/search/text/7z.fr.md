...
############################# Head ############################
head_title: "Rechercher les signatures Text dans le fichier 7z dans Java"
head_description: "Utilisez Java pour rechercher des signatures Text dans des fichiers 7z en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Text dans le fichier 7z"
description: "L'API native Java permet de rechercher des signatures Text dans des fichiers 7z déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents 7z en utilisant quelques lignes de code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Text dans des fichiers 7z à partir de leurs applications en mettant en œuvre quelques étapes simples.
