...
############################# Head ############################
head_title: "Otsige allkirju Text failist 7z rakenduses Java"
head_description: "Kasutage Java allkirjade Text otsimiseks failides 7z, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju 7z"
description: "Native API Java võimaldab otsida allkirju Text juba allkirjastatud 7z failides. Tehke oma 7z dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Text otsimine failivormingus 7z"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Text otsimist oma rakendustest failides 7z, rakendades mõnda lihtsat sammu.
