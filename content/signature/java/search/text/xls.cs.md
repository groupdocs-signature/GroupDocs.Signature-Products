...
############################# Head ############################
head_title: "Vyhledejte podpisy Text v souboru Xls v Java"
head_description: "Použijte Java k vyhledávání podpisů Text v souborech Xls pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Text v souboru Xls"
description: "Nativní API Java umožňuje vyhledávat podpisy Text v již podepsaných souborech Xls. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Xls pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Text v souborech Xls z jejich aplikací implementací několika snadných kroků.
