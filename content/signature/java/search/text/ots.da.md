...
head_description: "Brug Java til at søge efter Text-signaturer i Ots-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Text-signaturer i filen {{Filformat}}"
description: "Java native API gør det muligt at søge efter Text-signaturer i allerede signerede Ots-filer. Udfør avanceret e-signatursøgning i dine {{Filformat}} dokumenter ved hjælp af et par linjer kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gør det nemmere for Java-udviklere at søge efter Text-signaturer i Ots-filer fra deres applikationer ved at implementere nogle få nemme trin.
