...
############################# Head ############################
head_title: "Busque Text firmas en Xltx archivo en Java"
head_description: "Use Java para buscar firmas Text en archivos Xltx usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Text en el archivo Xltx"
description: "Java API nativa permite buscar Text firmas en archivos Xltx ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Xltx utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Text en Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Text en archivos Xltx desde sus aplicaciones mediante la implementación de unos sencillos pasos.
