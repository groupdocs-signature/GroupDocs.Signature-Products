...
############################# Head ############################
head_title: "Vyhledejte podpisy Text v souboru Zip v Java"
head_description: "Použijte Java k vyhledávání podpisů Text v souborech Zip pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Text v souboru Zip"
description: "Nativní API Java umožňuje vyhledávat podpisy Text v již podepsaných souborech Zip. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Zip pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Text v Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Text v souborech Zip z jejich aplikací implementací několika snadných kroků.
