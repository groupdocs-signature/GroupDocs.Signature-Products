...
############################# Head ############################
head_title: "Ieškokite Text parašų Csv faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Csv failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Csv faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Csv failuose. Atlikite išplėstinę el. parašo paiešką savo Csv dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Csv"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Csv failuose iš savo programų, atlikdami kelis paprastus veiksmus.
