...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Xltx dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Text dalam fail Xltx menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Xltx."
description: "API asli Java membenarkan untuk mencari tandatangan Text dalam fail Xltx yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Xltx anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Text dalam Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Text dalam fail Xltx daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
