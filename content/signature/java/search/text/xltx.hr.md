...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Xltx u Java"
head_description: "Upotrijebite Java za traženje potpisa Text u datotekama Xltx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Xltx datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Text u već potpisanim Xltx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xltx dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Text potpise u Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Text u datotekama Xltx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
