...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Tar u Java"
head_description: "Upotrijebite Java za traženje potpisa Text u datotekama Tar pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Tar datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Text u već potpisanim Tar datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Tar dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Text potpise u Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Text u datotekama Tar iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
