...
############################# Head ############################
head_title: "Căutați semnături Text în fișierul Ott în Java"
head_description: "Utilizați Java pentru a căuta semnături Text în fișiere Ott folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Text în fișierul Ott"
description: "API-ul nativ Java permite căutarea semnăturilor Text în fișierele Ott deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Ott folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Text în Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Text în fișierele Ott din aplicațiile lor prin implementarea câțiva pași simpli.
