...
############################# Head ############################
head_title: "Wyszukaj podpisy Text w pliku Pptx w Java"
head_description: "Użyj Java do wyszukiwania podpisów Text w plikach Pptx przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Text w pliku Pptx"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Text w już podpisanych plikach Pptx. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Pptx, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Text w Pptx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Text w plikach Pptx z ich aplikacji, wykonując kilka prostych kroków.
