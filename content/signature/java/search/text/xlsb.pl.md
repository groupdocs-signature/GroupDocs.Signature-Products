...
############################# Head ############################
head_title: "Wyszukaj podpisy Text w pliku Xlsb w Java"
head_description: "Użyj Java do wyszukiwania podpisów Text w plikach Xlsb przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Text w pliku Xlsb"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Text w już podpisanych plikach Xlsb. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Xlsb, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Text w Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Text w plikach Xlsb z ich aplikacji, wykonując kilka prostych kroków.
