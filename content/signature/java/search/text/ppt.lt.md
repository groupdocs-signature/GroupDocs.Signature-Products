...
############################# Head ############################
head_title: "Ieškokite Text parašų Ppt faile Java"
head_description: "Naudokite Java, norėdami ieškoti Text parašų Ppt failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Ppt faile"
description: "Java savoji API leidžia ieškoti Text parašų jau pasirašytuose Ppt failuose. Atlikite išplėstinę el. parašo paiešką savo Ppt dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Ppt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Text parašų Ppt failuose iš savo programų, atlikdami kelis paprastus veiksmus.
