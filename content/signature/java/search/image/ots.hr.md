...
############################# Head ############################
head_title: "Potražite Image potpise u datoteci Ots u Java"
head_description: "Upotrijebite Java za traženje potpisa Image u datotekama Ots pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Image potpise u Ots datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Image u već potpisanim Ots datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ots dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Image u datotekama Ots iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
