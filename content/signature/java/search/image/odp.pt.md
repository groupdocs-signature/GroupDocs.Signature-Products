...
############################# Head ############################
head_title: "Procure por assinaturas Image no arquivo Odp em Java"
head_description: "Use Java para pesquisar assinaturas Image em arquivos Odp usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Image no arquivo Odp"
description: "A API nativa do Java permite pesquisar assinaturas Image em arquivos Odp já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Odp usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Image em Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Image em arquivos Odp de seus aplicativos implementando algumas etapas fáceis.
