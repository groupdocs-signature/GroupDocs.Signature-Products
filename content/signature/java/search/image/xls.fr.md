...
############################# Head ############################
head_title: "Rechercher les signatures Image dans le fichier Xls dans Java"
head_description: "Utilisez Java pour rechercher des signatures Image dans des fichiers Xls en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Image dans le fichier Xls"
description: "L'API native Java permet de rechercher des signatures Image dans des fichiers Xls déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Xls en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Image dans Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Image dans des fichiers Xls à partir de leurs applications en mettant en œuvre quelques étapes simples.
