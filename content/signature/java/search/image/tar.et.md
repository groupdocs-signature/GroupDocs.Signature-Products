...
############################# Head ############################
head_title: "Otsige allkirju Image failist Tar rakenduses Java"
head_description: "Kasutage Java allkirjade Image otsimiseks failides Tar, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Image allkirju Tar"
description: "Native API Java võimaldab otsida allkirju Image juba allkirjastatud Tar failides. Tehke oma Tar dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Image otsimine failivormingus Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Image otsimist oma rakendustest failides Tar, rakendades mõnda lihtsat sammu.
