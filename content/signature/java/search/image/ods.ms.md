...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Ods dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Ods menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Ods."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Ods yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Ods anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Image dalam Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Ods daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
