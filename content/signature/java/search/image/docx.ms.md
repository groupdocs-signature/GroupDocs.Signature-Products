...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Docx dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Docx menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Docx."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Docx yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Docx anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Image dalam Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Docx daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
