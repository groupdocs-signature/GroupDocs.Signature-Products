...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Xlsx dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Xlsx menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Xlsx."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Xlsx yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Xlsx anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Image dalam Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Xlsx daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
