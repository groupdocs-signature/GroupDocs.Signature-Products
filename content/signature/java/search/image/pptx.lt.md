...
############################# Head ############################
head_title: "Ieškokite Image parašų Pptx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Image parašų Pptx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Pptx faile"
description: "Java savoji API leidžia ieškoti Image parašų jau pasirašytuose Pptx failuose. Atlikite išplėstinę el. parašo paiešką savo Pptx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Image parašų Pptx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Image parašų Pptx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
