...
############################# Head ############################
head_title: "Procure por assinaturas Image no arquivo Rtf em Java"
head_description: "Use Java para pesquisar assinaturas Image em arquivos Rtf usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Image no arquivo Rtf"
description: "A API nativa do Java permite pesquisar assinaturas Image em arquivos Rtf já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Rtf usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Image em arquivos Rtf de seus aplicativos implementando algumas etapas fáceis.
