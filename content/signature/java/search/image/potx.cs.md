...
############################# Head ############################
head_title: "Vyhledejte podpisy Image v souboru Potx v Java"
head_description: "Použijte Java k vyhledávání podpisů Image v souborech Potx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Image v souboru Potx"
description: "Nativní API Java umožňuje vyhledávat podpisy Image v již podepsaných souborech Potx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Potx pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Image v souborech Potx z jejich aplikací implementací několika snadných kroků.
