...
############################# Head ############################
head_title: "Ieškokite Image parašų Odp faile Java"
head_description: "Naudokite Java, norėdami ieškoti Image parašų Odp failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Odp faile"
description: "Java savoji API leidžia ieškoti Image parašų jau pasirašytuose Odp failuose. Atlikite išplėstinę el. parašo paiešką savo Odp dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Image parašų Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Image parašų Odp failuose iš savo programų, atlikdami kelis paprastus veiksmus.
