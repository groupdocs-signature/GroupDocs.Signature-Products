...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Xltm dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Xltm menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Xltm."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Xltm yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Xltm anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Xltm daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
