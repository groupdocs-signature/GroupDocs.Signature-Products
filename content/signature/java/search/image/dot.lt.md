...
############################# Head ############################
head_title: "Ieškokite Image parašų Dot faile Java"
head_description: "Naudokite Java, norėdami ieškoti Image parašų Dot failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Dot faile"
description: "Java savoji API leidžia ieškoti Image parašų jau pasirašytuose Dot failuose. Atlikite išplėstinę el. parašo paiešką savo Dot dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Image parašų Dot failuose iš savo programų, atlikdami kelis paprastus veiksmus.
