...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Ppsm dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Ppsm menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Ppsm."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Ppsm yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Ppsm anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Image dalam Ppsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Ppsm daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
