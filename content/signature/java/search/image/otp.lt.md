...
############################# Head ############################
head_title: "Ieškokite Image parašų Otp faile Java"
head_description: "Naudokite Java, norėdami ieškoti Image parašų Otp failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Otp faile"
description: "Java savoji API leidžia ieškoti Image parašų jau pasirašytuose Otp failuose. Atlikite išplėstinę el. parašo paiešką savo Otp dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Image parašų Otp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Image parašų Otp failuose iš savo programų, atlikdami kelis paprastus veiksmus.
