...
############################# Head ############################
head_title: "Search for Image signatures in Xlsm file in Java"
head_description: "Use Java for searching for Image signatures in Xlsm files using a few lines of code."

############################# Header ############################
title: "Search for Image signatures in Xlsm file"
description: "Java native API allows to search for Image signatures in already signed Xlsm files. Perform advanced e-signature search within your Xlsm documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Image signatures in Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Image signatures in Xlsm files from their applications by implementing a few easy steps.
