...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Xlsm dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Xlsm menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Xlsm."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Xlsm yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Xlsm anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Image dalam Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Xlsm daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
