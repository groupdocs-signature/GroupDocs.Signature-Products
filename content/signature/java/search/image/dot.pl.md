...
############################# Head ############################
head_title: "Wyszukaj podpisy Image w pliku Dot w Java"
head_description: "Użyj Java do wyszukiwania podpisów Image w plikach Dot przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Image w pliku Dot"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Image w już podpisanych plikach Dot. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Dot, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Image w plikach Dot z ich aplikacji, wykonując kilka prostych kroków.
