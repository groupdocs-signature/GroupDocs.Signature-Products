...
############################# Head ############################
head_title: "Ieškokite Image parašų Xltm faile Java"
head_description: "Naudokite Java, norėdami ieškoti Image parašų Xltm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Xltm faile"
description: "Java savoji API leidžia ieškoti Image parašų jau pasirašytuose Xltm failuose. Atlikite išplėstinę el. parašo paiešką savo Xltm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Image parašų Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Image parašų Xltm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
