...
############################# Head ############################
head_title: "Cari tanda tangan Image dalam file Odp di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Image di file Odp menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Image di file Odp"
description: "Java API asli memungkinkan untuk mencari Image tanda tangan di file Odp yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Odp Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Image di Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Image dalam file Odp dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
