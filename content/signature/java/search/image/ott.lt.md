...
############################# Head ############################
head_title: "Ieškokite Image parašų Ott faile Java"
head_description: "Naudokite Java, norėdami ieškoti Image parašų Ott failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Ott faile"
description: "Java savoji API leidžia ieškoti Image parašų jau pasirašytuose Ott failuose. Atlikite išplėstinę el. parašo paiešką savo Ott dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Image parašų Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Image parašų Ott failuose iš savo programų, atlikdami kelis paprastus veiksmus.
