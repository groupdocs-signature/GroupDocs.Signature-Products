...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Dot dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Dot menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Dot."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Dot yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Dot anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Image dalam Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Dot daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
