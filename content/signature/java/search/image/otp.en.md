...
############################# Head ############################
head_title: "Search Image signatures in Otp file in Java"
head_description: "Use Java for searching Image signatures in Otp files using a few lines of code."

############################# Header ############################
title: "Search Image signatures in Otp file"
description: "Java native API to search Image signatures in already signed Otp file. Perform advanced e-signature operations within your Otp documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Image signatures in Otp files from within their applications by implementing a few easy steps.
