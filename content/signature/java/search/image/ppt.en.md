...
############################# Head ############################
head_title: "Search for Image signatures in Ppt file in Java"
head_description: "Use Java for searching for Image signatures in Ppt files using a few lines of code."

############################# Header ############################
title: "Search for Image signatures in Ppt file"
description: "Java native API allows to search for Image signatures in already signed Ppt files. Perform advanced e-signature search within your Ppt documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Image signatures in Ppt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Image signatures in Ppt files from their applications by implementing a few easy steps.
