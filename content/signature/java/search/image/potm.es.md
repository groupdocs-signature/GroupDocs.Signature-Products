...
############################# Head ############################
head_title: "Busque Image firmas en Potm archivo en Java"
head_description: "Use Java para buscar firmas Image en archivos Potm usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Image en el archivo Potm"
description: "Java API nativa permite buscar Image firmas en archivos Potm ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Potm utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Image en Potm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Image en archivos Potm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
