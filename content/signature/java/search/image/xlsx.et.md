...
############################# Head ############################
head_title: "Otsige allkirju Image failist Xlsx rakenduses Java"
head_description: "Kasutage Java allkirjade Image otsimiseks failides Xlsx, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Image allkirju Xlsx"
description: "Native API Java võimaldab otsida allkirju Image juba allkirjastatud Xlsx failides. Tehke oma Xlsx dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Image otsimine failivormingus Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Image otsimist oma rakendustest failides Xlsx, rakendades mõnda lihtsat sammu.
