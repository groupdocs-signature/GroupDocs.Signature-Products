...
############################# Head ############################
head_title: "Li Image îmzeyan di pela Tar de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Image di pelên Tar de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Tar de li îmzeyên Image bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Tar yên jixwe îmzekirî de li îmzeyên Image bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Tar de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Image di pelên Tar îmzeyan de ji sepanên xwe bigerin.
