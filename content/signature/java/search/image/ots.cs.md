...
############################# Head ############################
head_title: "Vyhledejte podpisy Image v souboru Ots v Java"
head_description: "Použijte Java k vyhledávání podpisů Image v souborech Ots pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Image v souboru Ots"
description: "Nativní API Java umožňuje vyhledávat podpisy Image v již podepsaných souborech Ots. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ots pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Image v souborech Ots z jejich aplikací implementací několika snadných kroků.
