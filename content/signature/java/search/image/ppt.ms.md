...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Ppt dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Ppt menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Ppt."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Ppt yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Ppt anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Image dalam Ppt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Ppt daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
