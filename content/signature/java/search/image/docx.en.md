...
############################# Head ############################
head_title: "Search for Image signatures in Docx file in Java"
head_description: "Use Java for searching for Image signatures in Docx files using a few lines of code."

############################# Header ############################
title: "Search for Image signatures in Docx file"
description: "Java native API allows to search for Image signatures in already signed Docx files. Perform advanced e-signature search within your Docx documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Image signatures in Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Image signatures in Docx files from their applications by implementing a few easy steps.
