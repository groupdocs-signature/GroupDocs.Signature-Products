...
############################# Head ############################
head_title: "მოძებნეთ Image ხელმოწერები Xlsm ფაილში Java"
head_description: "გამოიყენეთ Java Image ხელმოწერების მოსაძიებლად Xlsm ფაილებში კოდის რამდენიმე ხაზის გამოყენებით."

############################# Header ############################
title: "მოძებნეთ Image ხელმოწერები Xlsm ფაილში"
description: "Java მშობლიური API საშუალებას გაძლევთ მოძებნოთ Image ხელმოწერები უკვე ხელმოწერილ Xlsm ფაილებში. განახორციელეთ ელექტრონული ხელმოწერის გაფართოებული ძიება თქვენს {{ფაილის ფორმატში}} დოკუმენტებში კოდის რამდენიმე ხაზის გამოყენებით."
...
steps:
    enable: true
    title_left: "როგორ მოძებნოთ Image ხელმოწერები Xlsm-ში"
    content_left: |
