...
############################# Head ############################
head_title: "Ieškokite Image parašų Xlsx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Image parašų Xlsx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Xlsx faile"
description: "Java savoji API leidžia ieškoti Image parašų jau pasirašytuose Xlsx failuose. Atlikite išplėstinę el. parašo paiešką savo Xlsx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Image parašų Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Image parašų Xlsx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
