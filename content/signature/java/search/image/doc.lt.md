...
############################# Head ############################
head_title: "Ieškokite Image parašų Doc faile Java"
head_description: "Naudokite Java, norėdami ieškoti Image parašų Doc failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Doc faile"
description: "Java savoji API leidžia ieškoti Image parašų jau pasirašytuose Doc failuose. Atlikite išplėstinę el. parašo paiešką savo Doc dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Image parašų Doc failuose iš savo programų, atlikdami kelis paprastus veiksmus.
