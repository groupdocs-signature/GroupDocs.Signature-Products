...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Dot i Java"
head_description: "Úsáid Java chun sínithe Image a chuardach i gcomhaid Dot ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Image i gcomhaid Dot óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
