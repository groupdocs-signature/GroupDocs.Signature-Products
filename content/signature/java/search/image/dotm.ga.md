...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Dotm i Java"
head_description: "Úsáid Java chun sínithe Image a chuardach i gcomhaid Dotm ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Image sínithe i gcomhad Dotm"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Image sínithe i gcomhaid Dotm atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Dotm ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Image a chuardach i Dotm"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Image i gcomhaid Dotm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
