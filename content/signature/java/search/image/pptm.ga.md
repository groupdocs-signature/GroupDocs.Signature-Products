...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Pptm i Java"
head_description: "Úsáid Java chun sínithe Image a chuardach i gcomhaid Pptm ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Image sínithe i gcomhad Pptm"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Image sínithe i gcomhaid Pptm atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Pptm ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Image a chuardach i Pptm"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Image i gcomhaid Pptm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
