...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Odp dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Odp menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Odp."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Odp yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Odp anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Odp daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
