...
############################# Head ############################
head_title: "Java içinde Ods dosyasında Image imzasını arayın"
head_description: "Birkaç satır kod kullanarak Ods dosyalarında Image imzasını aramak için Java kullanın."

############################# Header ############################
title: "Ods dosyasında Image imzasını arayın"
description: "Java yerel API'si, önceden imzalanmış Ods dosyalarında Image imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Ods belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Ods içinde Image imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak Ods dosyalarında Image imzalarını aramasını kolaylaştırır.
