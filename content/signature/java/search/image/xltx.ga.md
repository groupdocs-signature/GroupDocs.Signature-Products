...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Xltx i Java"
head_description: "Úsáid Java chun sínithe Image a chuardach i gcomhaid Xltx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Image sínithe i gcomhad Xltx"
...
steps:
    enable: true
    title_left: "Conas síniú Image a chuardach i Xltx"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Image i gcomhaid Xltx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
