...
############################# Head ############################
head_title: "Search Image signatures in Dot file in Java"
head_description: "Use Java for searching Image signatures in Dot files using a few lines of code."

############################# Header ############################
title: "Search Image signatures in Dot file"
description: "Java native API to search Image signatures in already signed Dot file. Perform advanced e-signature operations within your Dot documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Image signatures in Dot files from within their applications by implementing a few easy steps.
