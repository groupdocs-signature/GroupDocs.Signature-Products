...
############################# Head ############################
head_title: "Søg efter Image signaturer i filen Ott i Java"
head_description: "Brug Java til at søge efter Image-signaturer i Ott-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Image-signaturer i filen Ott"
description: "Java native API gør det muligt at søge efter Image-signaturer i allerede signerede Ott-filer. Udfør avanceret e-signatursøgning i dine Ott dokumenter ved hjælp af et par linjer kode."
...
steps:
    enable: true
    title_left: "Sådan søger du efter Image-signaturer i Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gør det nemmere for Java-udviklere at søge efter Image-signaturer i Ott-filer fra deres applikationer ved at implementere nogle få nemme trin.
