...
############################# Head ############################
head_title: "Li Image îmzeyan di pela Potx de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Image di pelên Potx de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Potx de li îmzeyên Image bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Potx yên jixwe îmzekirî de li îmzeyên Image bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Potx de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Image di pelên Potx îmzeyan de ji sepanên xwe bigerin.
