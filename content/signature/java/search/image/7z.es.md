...
############################# Head ############################
head_title: "Busque Image firmas en 7z archivo en Java"
head_description: "Use Java para buscar firmas Image en archivos 7z usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Image en el archivo 7z"
description: "Java API nativa permite buscar Image firmas en archivos 7z ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos 7z utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Image en 7z"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Image en archivos 7z desde sus aplicaciones mediante la implementación de unos sencillos pasos.
