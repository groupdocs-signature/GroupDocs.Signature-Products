...
############################# Head ############################
head_title: "Cari tanda tangan Image dalam file Rtf di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Image di file Rtf menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Image di file Rtf"
description: "Java API asli memungkinkan untuk mencari Image tanda tangan di file Rtf yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Rtf Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Image di Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Image dalam file Rtf dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
