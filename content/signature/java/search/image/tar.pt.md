...
############################# Head ############################
head_title: "Procure por assinaturas Image no arquivo Tar em Java"
head_description: "Use Java para pesquisar assinaturas Image em arquivos Tar usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Image no arquivo Tar"
description: "A API nativa do Java permite pesquisar assinaturas Image em arquivos Tar já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Tar usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Image em arquivos Tar de seus aplicativos implementando algumas etapas fáceis.
