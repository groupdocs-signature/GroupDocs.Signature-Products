...
############################# Head ############################
head_title: "Search Image signatures in Rtf file in Java"
head_description: "Use Java for searching Image signatures in Rtf files using a few lines of code."

############################# Header ############################
title: "Search Image signatures in Rtf file"
description: "Java native API to search Image signatures in already signed Rtf file. Perform advanced e-signature operations within your Rtf documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search Image signatures in Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Image signatures in Rtf files from within their applications by implementing a few easy steps.
