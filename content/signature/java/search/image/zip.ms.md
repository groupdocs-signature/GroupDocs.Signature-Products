...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail Zip dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Image dalam fail Zip menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail Zip."
description: "API asli Java membenarkan untuk mencari tandatangan Image dalam fail Zip yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Zip anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Image dalam Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Image dalam fail Zip daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
