...
############################# Head ############################
head_title: "Căutați semnături Image în fișierul 7z în Java"
head_description: "Utilizați Java pentru a căuta semnături Image în fișiere 7z folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Image în fișierul 7z"
description: "API-ul nativ Java permite căutarea semnăturilor Image în fișierele 7z deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. 7z folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Image în 7z"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Image în fișierele 7z din aplicațiile lor prin implementarea câțiva pași simpli.
