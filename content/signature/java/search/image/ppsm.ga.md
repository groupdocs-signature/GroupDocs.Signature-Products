...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Ppsm i Java"
head_description: "Úsáid Java chun sínithe Image a chuardach i gcomhaid Ppsm ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Image sínithe i gcomhad Ppsm"
...
steps:
    enable: true
    title_left: "Conas síniú Image a chuardach i Ppsm"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Image i gcomhaid Ppsm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
