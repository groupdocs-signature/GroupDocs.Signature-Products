...
############################# Head ############################
head_title: "Cari tanda tangan Image dalam file Odt di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Image di file Odt menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Image di file Odt"
description: "Java API asli memungkinkan untuk mencari Image tanda tangan di file Odt yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Odt Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Image dalam file Odt dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
