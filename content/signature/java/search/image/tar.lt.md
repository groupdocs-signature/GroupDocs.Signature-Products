...
############################# Head ############################
head_title: "Ieškokite Image parašų Tar faile Java"
head_description: "Naudokite Java, norėdami ieškoti Image parašų Tar failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Tar faile"
description: "Java savoji API leidžia ieškoti Image parašų jau pasirašytuose Tar failuose. Atlikite išplėstinę el. parašo paiešką savo Tar dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Image parašų Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Image parašų Tar failuose iš savo programų, atlikdami kelis paprastus veiksmus.
