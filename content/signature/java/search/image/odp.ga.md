...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Odp i Java"
head_description: "Úsáid Java chun sínithe Image a chuardach i gcomhaid Odp ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Image sínithe i gcomhad Odp"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Image sínithe i gcomhaid Odp atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Odp ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Image i gcomhaid Odp óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
