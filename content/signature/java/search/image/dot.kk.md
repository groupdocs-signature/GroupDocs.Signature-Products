...
description: "Java жергілікті API бұрыннан қол қойылған Dot файлдарындағы Image қолтаңбаларын іздеуге мүмкіндік береді. Кодтың бірнеше жолын пайдаланып Dot құжаттарыңызда кеңейтілген электрондық қолтаңбаны іздеуді орындаңыз."
