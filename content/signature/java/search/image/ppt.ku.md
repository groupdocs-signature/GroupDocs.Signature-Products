...
############################# Head ############################
head_title: "Li Image îmzeyan di pela Ppt de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Image di pelên Ppt de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Ppt de li îmzeyên Image bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Ppt yên jixwe îmzekirî de li îmzeyên Image bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Ppt de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Image di Ppt de digere"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Image di pelên Ppt îmzeyan de ji sepanên xwe bigerin.
