...
############################# Head ############################
head_title: "Busque Image firmas en Odt archivo en Java"
head_description: "Use Java para buscar firmas Image en archivos Odt usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Image en el archivo Odt"
description: "Java API nativa permite buscar Image firmas en archivos Odt ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Odt utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Image en Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Image en archivos Odt desde sus aplicaciones mediante la implementación de unos sencillos pasos.
