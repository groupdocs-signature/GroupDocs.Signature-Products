...
############################# Head ############################
head_title: "Potražite Image potpise u datoteci Doc u Java"
head_description: "Upotrijebite Java za traženje potpisa Image u datotekama Doc pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Image potpise u Doc datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Image u već potpisanim Doc datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Doc dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Image potpise u Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Image u datotekama Doc iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
