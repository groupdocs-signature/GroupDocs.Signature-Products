...
############################# Head ############################
head_title: "Search Image signatures in Xlsx file in Java"
head_description: "Use Java for searching Image signatures in Xlsx files using a few lines of code."

############################# Header ############################
title: "Search Image signatures in Xlsx file"
description: "Java native API to search Image signatures in already signed Xlsx file. Perform advanced e-signature operations within your Xlsx documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search Image signatures in Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Image signatures in Xlsx files from within their applications by implementing a few easy steps.
