...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Otp i Java"
head_description: "Úsáid Java chun sínithe Image a chuardach i gcomhaid Otp ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Image sínithe i gcomhad Otp"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Image sínithe i gcomhaid Otp atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Otp ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Image a chuardach i Otp"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Image i gcomhaid Otp óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
