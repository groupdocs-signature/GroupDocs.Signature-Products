...
############################# Head ############################
head_title: "Ieškokite Barcode parašų Zip faile Java"
head_description: "Naudokite Java, norėdami ieškoti Barcode parašų Zip failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Barcode parašų Zip faile"
description: "Java savoji API leidžia ieškoti Barcode parašų jau pasirašytuose Zip failuose. Atlikite išplėstinę el. parašo paiešką savo Zip dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Barcode parašų Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Barcode parašų Zip failuose iš savo programų, atlikdami kelis paprastus veiksmus.
