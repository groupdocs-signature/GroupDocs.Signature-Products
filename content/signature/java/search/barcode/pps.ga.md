...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Pps i Java"
head_description: "Úsáid Java chun sínithe Barcode a chuardach i gcomhaid Pps ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Pps"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Barcode sínithe i gcomhaid Pps atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Pps ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Barcode a chuardach i Pps"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Barcode i gcomhaid Pps óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
