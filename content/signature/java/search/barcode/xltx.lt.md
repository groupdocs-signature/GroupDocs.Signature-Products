...
############################# Head ############################
head_title: "Ieškokite Barcode parašų Xltx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Barcode parašų Xltx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Barcode parašų Xltx faile"
description: "Java savoji API leidžia ieškoti Barcode parašų jau pasirašytuose Xltx failuose. Atlikite išplėstinę el. parašo paiešką savo Xltx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Barcode parašų Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Barcode parašų Xltx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
