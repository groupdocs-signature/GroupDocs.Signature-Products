...
############################# Head ############################
head_title: "Ieškokite Barcode parašų Wmf faile Java"
head_description: "Naudokite Java, norėdami ieškoti Barcode parašų Wmf failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Barcode parašų Wmf faile"
description: "Java savoji API leidžia ieškoti Barcode parašų jau pasirašytuose Wmf failuose. Atlikite išplėstinę el. parašo paiešką savo Wmf dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Barcode parašų Wmf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Barcode parašų Wmf failuose iš savo programų, atlikdami kelis paprastus veiksmus.
