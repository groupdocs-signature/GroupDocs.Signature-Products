...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Xlsx i Java"
head_description: "Úsáid Java chun sínithe Barcode a chuardach i gcomhaid Xlsx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Xlsx"
...
steps:
    enable: true
    title_left: "Conas síniú Barcode a chuardach i Xlsx"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Barcode i gcomhaid Xlsx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
