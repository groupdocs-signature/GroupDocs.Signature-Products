...
############################# Head ############################
head_title: "Rechercher les signatures Barcode dans le fichier Pps dans Java"
head_description: "Utilisez Java pour rechercher des signatures Barcode dans des fichiers Pps en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Barcode dans le fichier Pps"
description: "L'API native Java permet de rechercher des signatures Barcode dans des fichiers Pps déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Pps en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Barcode dans Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Barcode dans des fichiers Pps à partir de leurs applications en mettant en œuvre quelques étapes simples.
