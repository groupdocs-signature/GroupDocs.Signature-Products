...
############################# Head ############################
head_title: "Cari tandatangan Barcode dalam fail Jpg dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Barcode dalam fail Jpg menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Barcode dalam fail Jpg."
description: "API asli Java membenarkan untuk mencari tandatangan Barcode dalam fail Jpg yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Jpg anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Barcode dalam fail Jpg daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
