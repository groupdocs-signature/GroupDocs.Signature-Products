...
############################# Head ############################
head_title: "Căutați semnături Barcode în fișierul Tiff în Java"
head_description: "Utilizați Java pentru a căuta semnături Barcode în fișiere Tiff folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Barcode în fișierul Tiff"
description: "API-ul nativ Java permite căutarea semnăturilor Barcode în fișierele Tiff deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Tiff folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Barcode în Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Barcode în fișierele Tiff din aplicațiile lor prin implementarea câțiva pași simpli.
...
demos:
    ...
    content: |
       Căutați în document diferite semnături electronice în fișiere Tiff chiar acum, vizitând site-ul web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
