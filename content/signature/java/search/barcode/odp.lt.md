...
############################# Head ############################
head_title: "Ieškokite Barcode parašų Odp faile Java"
head_description: "Naudokite Java, norėdami ieškoti Barcode parašų Odp failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Barcode parašų Odp faile"
description: "Java savoji API leidžia ieškoti Barcode parašų jau pasirašytuose Odp failuose. Atlikite išplėstinę el. parašo paiešką savo Odp dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Barcode parašų Odp failuose iš savo programų, atlikdami kelis paprastus veiksmus.
