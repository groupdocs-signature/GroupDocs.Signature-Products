...
############################# Head ############################
head_title: "Busque Barcode firmas en Xltm archivo en Java"
head_description: "Use Java para buscar firmas Barcode en archivos Xltm usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Barcode en el archivo Xltm"
description: "Java API nativa permite buscar Barcode firmas en archivos Xltm ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Xltm utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Barcode en Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Barcode en archivos Xltm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
