...
############################# Head ############################
head_title: "Ieškokite Barcode parašų Ods faile Java"
head_description: "Naudokite Java, norėdami ieškoti Barcode parašų Ods failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Barcode parašų Ods faile"
description: "Java savoji API leidžia ieškoti Barcode parašų jau pasirašytuose Ods failuose. Atlikite išplėstinę el. parašo paiešką savo Ods dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Barcode parašų Ods failuose iš savo programų, atlikdami kelis paprastus veiksmus.
