...
############################# Head ############################
head_title: "Search for Barcode signatures in Xltx file in Java"
head_description: "Use Java for searching for Barcode signatures in Xltx files using a few lines of code."

############################# Header ############################
title: "Search for Barcode signatures in Xltx file"
description: "Java native API allows to search for Barcode signatures in already signed Xltx files. Perform advanced e-signature search within your Xltx documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Barcode signatures in Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Barcode signatures in Xltx files from their applications by implementing a few easy steps.
