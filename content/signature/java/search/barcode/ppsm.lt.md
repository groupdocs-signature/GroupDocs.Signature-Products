...
############################# Head ############################
head_title: "Ieškokite Barcode parašų Ppsm faile Java"
head_description: "Naudokite Java, norėdami ieškoti Barcode parašų Ppsm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Barcode parašų Ppsm faile"
description: "Java savoji API leidžia ieškoti Barcode parašų jau pasirašytuose Ppsm failuose. Atlikite išplėstinę el. parašo paiešką savo Ppsm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Barcode parašų Ppsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Barcode parašų Ppsm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
