...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Xltm i Java"
head_description: "Úsáid Java chun sínithe Barcode a chuardach i gcomhaid Xltm ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Xltm"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Xltm ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Barcode a chuardach i Xltm"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Barcode i gcomhaid Xltm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
...
demos:
    ...
    content: |
       Cuardaigh an doiciméad le haghaidh sínithe leictreonacha éagsúla ar chomhaid Xltm faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
