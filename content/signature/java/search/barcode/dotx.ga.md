...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Dotx i Java"
head_description: "Úsáid Java chun sínithe Barcode a chuardach i gcomhaid Dotx ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Barcode i gcomhaid Dotx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
