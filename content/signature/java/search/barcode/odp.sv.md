...
description: "Inbyggt API för Java gör det möjligt att söka efter Barcode-signaturer i redan signerade Odp-filer. Utför avancerad e-signatursökning i dina {{Filformat}}-dokument med några rader kod."
