...
############################# Head ############################
head_title: "Cerqueu signatures de Barcode al fitxer Rtf a Java"
head_description: "Utilitzeu Java per cercar signatures Barcode als fitxers Rtf mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Barcode al fitxer Rtf"
description: "L'API nativa de Java permet cercar signatures Barcode als fitxers Rtf ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Rtf amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Barcode a Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Barcode als fitxers Rtf des de les seves aplicacions implementant uns quants passos senzills.
