...
############################# Head ############################
head_title: "Cerqueu signatures de Barcode al fitxer Wmf a Java"
head_description: "Utilitzeu Java per cercar signatures Barcode als fitxers Wmf mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Barcode al fitxer Wmf"
description: "L'API nativa de Java permet cercar signatures Barcode als fitxers Wmf ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Wmf amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Barcode als fitxers Wmf des de les seves aplicacions implementant uns quants passos senzills.
