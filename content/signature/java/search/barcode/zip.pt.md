...
############################# Head ############################
head_title: "Procure por assinaturas Barcode no arquivo Zip em Java"
head_description: "Use Java para pesquisar assinaturas Barcode em arquivos Zip usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Barcode no arquivo Zip"
description: "A API nativa do Java permite pesquisar assinaturas Barcode em arquivos Zip já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Zip usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Barcode em Zip"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Barcode em arquivos Zip de seus aplicativos implementando algumas etapas fáceis.
