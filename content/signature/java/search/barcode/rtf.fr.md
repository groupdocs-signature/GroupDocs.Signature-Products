...
############################# Head ############################
head_title: "Rechercher les signatures Barcode dans le fichier Rtf dans Java"
head_description: "Utilisez Java pour rechercher des signatures Barcode dans des fichiers Rtf en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Barcode dans le fichier Rtf"
description: "L'API native Java permet de rechercher des signatures Barcode dans des fichiers Rtf déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Rtf en utilisant quelques lignes de code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Barcode dans des fichiers Rtf à partir de leurs applications en mettant en œuvre quelques étapes simples.
