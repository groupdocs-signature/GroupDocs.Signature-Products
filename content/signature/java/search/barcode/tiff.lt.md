...
############################# Head ############################
head_title: "Ieškokite Barcode parašų Tiff faile Java"
head_description: "Naudokite Java, norėdami ieškoti Barcode parašų Tiff failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Barcode parašų Tiff faile"
description: "Java savoji API leidžia ieškoti Barcode parašų jau pasirašytuose Tiff failuose. Atlikite išplėstinę el. parašo paiešką savo Tiff dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Barcode parašų Tiff failuose iš savo programų, atlikdami kelis paprastus veiksmus.
