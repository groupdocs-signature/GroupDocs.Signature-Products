...
############################# Head ############################
head_title: "Search Barcode signatures in Docm file in Java"
head_description: "Use Java for searching Barcode signatures in Docm files using a few lines of code."

############################# Header ############################
title: "Search Barcode signatures in Docm file"
description: "Java native API to search Barcode signatures in already signed Docm file. Perform advanced e-signature operations within your Docm documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search Barcode signatures in Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Barcode signatures in Docm files from within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
       Add Barcode electronic signatures to Docm file right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.
