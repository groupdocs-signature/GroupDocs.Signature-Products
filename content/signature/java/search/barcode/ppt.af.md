...
description: "Java se inheemse API laat toe om vir Barcode handtekeninge te soek in reeds ondertekende Ppt lêers. Voer gevorderde e-handtekeningsoektog binne jou Ppt dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    enable: true
    title_left: "Hoe om te soek vir Barcode handtekeninge in Ppt"
    content_left: |
