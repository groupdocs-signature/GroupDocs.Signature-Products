...
demos:
    ...
    content: |
       Add Barcode electronic signatures to Dotm file right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.
