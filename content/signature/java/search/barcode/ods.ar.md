...
############################# Head ############################
head_title: "ابحث عن توقيعات Barcode في ملف Ods في Java"
head_description: "استخدم Java للبحث عن توقيعات Barcode في ملفات Ods باستخدام بضعة أسطر من التعليمات البرمجية."

############################# Header ############################
title: "ابحث عن توقيعات Barcode في ملف Ods"
description: "تسمح واجهة برمجة التطبيقات الأصلية لـ Java بالبحث عن توقيعات Barcode في ملفات Ods الموقعة بالفعل. قم بإجراء بحث متقدم عن التوقيع الإلكتروني داخل مستندات Ods باستخدام بضعة أسطر من التعليمات البرمجية."
...
steps:
    enable: true
    title_left: "كيفية البحث عن توقيعات Barcode في Ods"
    content_left: |
        يسهّل [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) على مطوري Java البحث عن توقيعات Barcode في ملفات Ods من تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
