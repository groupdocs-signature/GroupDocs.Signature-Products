...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Potm i Java"
head_description: "Úsáid Java chun sínithe Barcode a chuardach i gcomhaid Potm ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Potm"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Barcode sínithe i gcomhaid Potm atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Potm ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Barcode a chuardach i Potm"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Barcode i gcomhaid Potm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
