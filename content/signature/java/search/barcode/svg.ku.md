...
############################# Head ############################
head_title: "Li Barcode îmzeyan di pela Svg de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Barcode di pelên Svg de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Svg de li îmzeyên Barcode bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Svg yên jixwe îmzekirî de li îmzeyên Barcode bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Svg de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Barcode di Svg de digere"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Barcode di pelên Svg îmzeyan de ji sepanên xwe bigerin.
...
demos:
    ...
    content: |
       Niha bi serdana malpera [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) di belgeyê de ji bo îmzeyên elektronîkî yên cihêreng ên pelên Svg bigerin.
