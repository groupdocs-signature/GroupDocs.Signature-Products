...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Xls i Java"
head_description: "Úsáid Java chun sínithe Barcode a chuardach i gcomhaid Xls ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Xls"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Barcode sínithe i gcomhaid Xls atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Xls ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Barcode a chuardach i Xls"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Barcode i gcomhaid Xls óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
