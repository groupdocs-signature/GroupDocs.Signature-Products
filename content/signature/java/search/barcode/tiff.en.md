...
############################# Head ############################
head_title: "Search for Barcode signatures in Tiff file in Java"
head_description: "Use Java for searching for Barcode signatures in Tiff files using a few lines of code."

############################# Header ############################
title: "Search for Barcode signatures in Tiff file"
description: "Java native API allows to search for Barcode signatures in already signed Tiff files. Perform advanced e-signature search within your Tiff documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Barcode signatures in Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Barcode signatures in Tiff files from their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
       Add various electronic signatures to Tiff files right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.
