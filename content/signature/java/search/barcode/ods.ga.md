...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Ods i Java"
head_description: "Úsáid Java chun sínithe Barcode a chuardach i gcomhaid Ods ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Ods"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Barcode sínithe i gcomhaid Ods atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Ods ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Barcode a chuardach i Ods"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Barcode i gcomhaid Ods óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
