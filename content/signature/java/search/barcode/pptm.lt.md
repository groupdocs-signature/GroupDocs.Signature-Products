...
############################# Head ############################
head_title: "Ieškokite Barcode parašų Pptm faile Java"
head_description: "Naudokite Java, norėdami ieškoti Barcode parašų Pptm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Barcode parašų Pptm faile"
description: "Java savoji API leidžia ieškoti Barcode parašų jau pasirašytuose Pptm failuose. Atlikite išplėstinę el. parašo paiešką savo Pptm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Barcode parašų Pptm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Barcode parašų Pptm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
