...
############################# Head ############################
head_title: "Procure por assinaturas Barcode no arquivo Bmp em Java"
head_description: "Use Java para pesquisar assinaturas Barcode em arquivos Bmp usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Barcode no arquivo Bmp"
description: "A API nativa do Java permite pesquisar assinaturas Barcode em arquivos Bmp já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Bmp usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Barcode em arquivos Bmp de seus aplicativos implementando algumas etapas fáceis.
