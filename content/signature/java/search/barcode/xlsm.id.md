...
############################# Head ############################
head_title: "Cari tanda tangan Barcode dalam file Xlsm di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Barcode di file Xlsm menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Barcode di file Xlsm"
description: "Java API asli memungkinkan untuk mencari Barcode tanda tangan di file Xlsm yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xlsm Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Barcode di Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Barcode dalam file Xlsm dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
