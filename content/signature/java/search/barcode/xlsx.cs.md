...
############################# Head ############################
head_title: "Vyhledejte podpisy Barcode v souboru Xlsx v Java"
head_description: "Použijte Java k vyhledávání podpisů Barcode v souborech Xlsx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Barcode v souboru Xlsx"
description: "Nativní API Java umožňuje vyhledávat podpisy Barcode v již podepsaných souborech Xlsx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Xlsx pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Barcode v Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Barcode v souborech Xlsx z jejich aplikací implementací několika snadných kroků.
