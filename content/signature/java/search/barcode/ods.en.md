...
############################# Head ############################
head_title: "Search for Barcode signatures in Ods file in Java"
head_description: "Use Java for searching for Barcode signatures in Ods files using a few lines of code."

############################# Header ############################
title: "Search for Barcode signatures in Ods file"
description: "Java native API allows to search for Barcode signatures in already signed Ods files. Perform advanced e-signature search within your Ods documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Barcode signatures in Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Barcode signatures in Ods files from their applications by implementing a few easy steps.
