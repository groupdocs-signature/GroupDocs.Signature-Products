...
############################# Head ############################
head_title: "Procure por assinaturas Barcode no arquivo Ott em Java"
head_description: "Use Java para pesquisar assinaturas Barcode em arquivos Ott usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Barcode no arquivo Ott"
description: "A API nativa do Java permite pesquisar assinaturas Barcode em arquivos Ott já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Ott usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Barcode em Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Barcode em arquivos Ott de seus aplicativos implementando algumas etapas fáceis.
