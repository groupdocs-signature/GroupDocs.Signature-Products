...
description: "Java se inheemse API laat toe om vir Barcode handtekeninge te soek in reeds ondertekende Bmp lêers. Voer gevorderde e-handtekeningsoektog binne jou Bmp dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    enable: true
    title_left: "Hoe om te soek vir Barcode handtekeninge in Bmp"
    content_left: |
