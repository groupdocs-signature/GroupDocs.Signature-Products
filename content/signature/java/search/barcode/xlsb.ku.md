...
############################# Head ############################
head_title: "Li Barcode îmzeyan di pela Xlsb de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Barcode di pelên Xlsb de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Xlsb de li îmzeyên Barcode bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Xlsb yên jixwe îmzekirî de li îmzeyên Barcode bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Xlsb de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Barcode di Xlsb de digere"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Barcode di pelên Xlsb îmzeyan de ji sepanên xwe bigerin.
