...
############################# Head ############################
head_title: "Search Barcode signatures in Dotx file in Java"
head_description: "Use Java for searching Barcode signatures in Dotx files using a few lines of code."

############################# Header ############################
title: "Search Barcode signatures in Dotx file"
description: "Java native API to search Barcode signatures in already signed Dotx file. Perform advanced e-signature operations within your Dotx documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search Barcode signatures in Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easy for Java developers to search Barcode signatures in Dotx files from within their applications by implementing a few easy steps.
