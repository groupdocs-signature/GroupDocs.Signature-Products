...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų 7z faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų 7z failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų 7z faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose 7z failuose. Atlikite išplėstinę el. parašo paiešką savo 7z dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų 7z failuose iš savo programų, atlikdami kelis paprastus veiksmus.
