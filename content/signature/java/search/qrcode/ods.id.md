...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Ods di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Qrcode di file Ods menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Ods"
description: "Java API asli memungkinkan untuk mencari Qrcode tanda tangan di file Ods yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ods Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Qrcode dalam file Ods dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
