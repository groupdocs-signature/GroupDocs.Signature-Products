...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Bmp v Java"
head_description: "Použijte Java k vyhledávání podpisů Qrcode v souborech Bmp pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Bmp"
description: "Nativní API Java umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Bmp. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Bmp pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Bmp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Qrcode v souborech Bmp z jejich aplikací implementací několika snadných kroků.
