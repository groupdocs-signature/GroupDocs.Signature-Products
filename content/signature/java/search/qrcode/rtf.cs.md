...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Rtf v Java"
head_description: "Použijte Java k vyhledávání podpisů Qrcode v souborech Rtf pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Rtf"
description: "Nativní API Java umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Rtf. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Rtf pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Qrcode v souborech Rtf z jejich aplikací implementací několika snadných kroků.
