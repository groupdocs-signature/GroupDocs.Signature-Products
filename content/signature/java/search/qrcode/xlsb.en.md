...
############################# Head ############################
head_title: "Search for Qrcode signatures in Xlsb file in Java"
head_description: "Use Java for searching for Qrcode signatures in Xlsb files using a few lines of code."

############################# Header ############################
title: "Search for Qrcode signatures in Xlsb file"
description: "Java native API allows to search for Qrcode signatures in already signed Xlsb files. Perform advanced e-signature search within your Xlsb documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Qrcode signatures in Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Qrcode signatures in Xlsb files from their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
       Search the document for various electronic signatures to Xlsb files right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.
