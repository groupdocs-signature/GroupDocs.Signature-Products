...
############################# Head ############################
head_title: "Sök efter Qrcode-signaturer i filen Xls i Java"
head_description: "Använd Java för att söka efter Qrcode-signaturer i Xls-filer med några rader kod."

############################# Header ############################
title: "Sök efter Qrcode-signaturer i filen Xls"
description: "Inbyggt API för Java gör det möjligt att söka efter Qrcode-signaturer i redan signerade Xls-filer. Utför avancerad e-signatursökning i dina Xls-dokument med några rader kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gör det enklare för Java-utvecklare att söka efter Qrcode-signaturer i Xls-filer från sina applikationer genom att implementera några enkla steg.
