...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Webp em Java"
head_description: "Use Java para pesquisar assinaturas Qrcode em arquivos Webp usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Webp"
description: "A API nativa do Java permite pesquisar assinaturas Qrcode em arquivos Webp já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Webp usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Qrcode em arquivos Webp de seus aplicativos implementando algumas etapas fáceis.
