...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Wmf u Java"
head_description: "Upotrijebite Java za traženje potpisa Qrcode u datotekama Wmf pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Wmf datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Qrcode u već potpisanim Wmf datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Wmf dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Qrcode potpise u Wmf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Qrcode u datotekama Wmf iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
