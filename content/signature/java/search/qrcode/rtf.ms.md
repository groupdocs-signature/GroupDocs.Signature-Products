...
############################# Head ############################
head_title: "Cari tandatangan Qrcode dalam fail Rtf dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Qrcode dalam fail Rtf menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Qrcode dalam fail Rtf."
description: "API asli Java membenarkan untuk mencari tandatangan Qrcode dalam fail Rtf yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Rtf anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Qrcode dalam Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Qrcode dalam fail Rtf daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
