...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file Zip in Java"
head_description: "Usa Java per cercare le firme Qrcode nei file Zip utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file Zip"
description: "L'API nativa Java consente di cercare firme Qrcode in file Zip già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Zip utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Qrcode nei file Zip dalle loro applicazioni implementando alcuni semplici passaggi.
