...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Pps di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Qrcode di file Pps menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Pps"
description: "Java API asli memungkinkan untuk mencari Qrcode tanda tangan di file Pps yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Pps Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Qrcode dalam file Pps dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
