...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Gif em Java"
head_description: "Use Java para pesquisar assinaturas Qrcode em arquivos Gif usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Gif"
description: "A API nativa do Java permite pesquisar assinaturas Qrcode em arquivos Gif já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Gif usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Qrcode em Gif"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Qrcode em arquivos Gif de seus aplicativos implementando algumas etapas fáceis.
