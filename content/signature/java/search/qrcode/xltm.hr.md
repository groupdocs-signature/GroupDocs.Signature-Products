...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Xltm u Java"
head_description: "Upotrijebite Java za traženje potpisa Qrcode u datotekama Xltm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Xltm datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Qrcode u već potpisanim Xltm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xltm dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Qrcode u datotekama Xltm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
