...
############################# Head ############################
head_title: "Search for Qrcode signatures in Svg file in Java"
head_description: "Use Java for searching for Qrcode signatures in Svg files using a few lines of code."

############################# Header ############################
title: "Search for Qrcode signatures in Svg file"
description: "Java native API allows to search for Qrcode signatures in already signed Svg files. Perform advanced e-signature search within your Svg documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Qrcode signatures in Svg"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Qrcode signatures in Svg files from their applications by implementing a few easy steps.
