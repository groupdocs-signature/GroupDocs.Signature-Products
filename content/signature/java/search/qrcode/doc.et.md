...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Doc rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Doc, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Doc"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Doc failides. Tehke oma Doc dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Doc, rakendades mõnda lihtsat sammu.
