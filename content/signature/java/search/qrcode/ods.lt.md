...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Ods faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Ods failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Ods faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Ods failuose. Atlikite išplėstinę el. parašo paiešką savo Ods dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Ods failuose iš savo programų, atlikdami kelis paprastus veiksmus.
