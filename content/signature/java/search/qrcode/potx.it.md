...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file Potx in Java"
head_description: "Usa Java per cercare le firme Qrcode nei file Potx utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file Potx"
description: "L'API nativa Java consente di cercare firme Qrcode in file Potx già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Potx utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Qrcode nei file Potx dalle loro applicazioni implementando alcuni semplici passaggi.
