...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Ott faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Ott failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Ott faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Ott failuose. Atlikite išplėstinę el. parašo paiešką savo Ott dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Ott failuose iš savo programų, atlikdami kelis paprastus veiksmus.
