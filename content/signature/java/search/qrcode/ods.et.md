...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Ods rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Ods, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Ods"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Ods failides. Tehke oma Ods dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Ods, rakendades mõnda lihtsat sammu.
