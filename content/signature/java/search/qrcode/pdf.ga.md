...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Pdf i Java"
head_description: "Úsáid Java chun sínithe Qrcode a chuardach i gcomhaid Pdf ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Pdf óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
