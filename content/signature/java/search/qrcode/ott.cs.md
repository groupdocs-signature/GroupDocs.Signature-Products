...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Ott v Java"
head_description: "Použijte Java k vyhledávání podpisů Qrcode v souborech Ott pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Ott"
description: "Nativní API Java umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Ott. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ott pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Qrcode v souborech Ott z jejich aplikací implementací několika snadných kroků.
