...
############################# Head ############################
head_title: "Poiščite podpise Qrcode v datoteki Potm v Java"
head_description: "Uporabite Java za iskanje podpisov Qrcode v datotekah Potm z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Qrcode v datoteki Potm"
description: "Izvorni API za Java omogoča iskanje podpisov Qrcode v že podpisanih datotekah Potm. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Potm z uporabo nekaj vrstic kode."
...
steps:
    enable: true
    title_left: "Kako poiskati podpise Qrcode v Potm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Qrcode v datotekah Potm iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
