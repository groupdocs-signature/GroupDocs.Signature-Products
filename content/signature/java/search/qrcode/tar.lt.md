...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Tar faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Tar failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Tar faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Tar failuose. Atlikite išplėstinę el. parašo paiešką savo Tar dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Tar"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Tar failuose iš savo programų, atlikdami kelis paprastus veiksmus.
