...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Dot di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Qrcode di file Dot menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Dot"
description: "Java API asli memungkinkan untuk mencari Qrcode tanda tangan di file Dot yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Dot Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Qrcode di Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Qrcode dalam file Dot dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
