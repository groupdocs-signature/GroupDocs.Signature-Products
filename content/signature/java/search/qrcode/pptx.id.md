...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Pptx di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Qrcode di file Pptx menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Pptx"
description: "Java API asli memungkinkan untuk mencari Qrcode tanda tangan di file Pptx yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Pptx Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Qrcode dalam file Pptx dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
