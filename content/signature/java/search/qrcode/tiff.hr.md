...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Tiff u Java"
head_description: "Upotrijebite Java za traženje potpisa Qrcode u datotekama Tiff pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Tiff datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Qrcode u već potpisanim Tiff datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Tiff dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Qrcode u datotekama Tiff iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
