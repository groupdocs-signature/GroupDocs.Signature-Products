...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Xltx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Xltx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Xltx faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Xltx failuose. Atlikite išplėstinę el. parašo paiešką savo Xltx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Xltx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
