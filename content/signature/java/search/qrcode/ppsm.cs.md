...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Ppsm v Java"
head_description: "Použijte Java k vyhledávání podpisů Qrcode v souborech Ppsm pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Ppsm"
description: "Nativní API Java umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Ppsm. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ppsm pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Qrcode v souborech Ppsm z jejich aplikací implementací několika snadných kroků.
