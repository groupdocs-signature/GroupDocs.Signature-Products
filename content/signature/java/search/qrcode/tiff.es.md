...
############################# Head ############################
head_title: "Busque Qrcode firmas en Tiff archivo en Java"
head_description: "Use Java para buscar firmas Qrcode en archivos Tiff usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Tiff"
description: "Java API nativa permite buscar Qrcode firmas en archivos Tiff ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Tiff utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Qrcode en Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Qrcode en archivos Tiff desde sus aplicaciones mediante la implementación de unos sencillos pasos.
