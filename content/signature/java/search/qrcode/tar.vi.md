...
############################# Head ############################
head_title: "Tìm kiếm chữ ký Qrcode trong tệp Tar trong Java"
head_description: "Sử dụng Java để tìm kiếm chữ ký Qrcode trong tệp Tar bằng một vài dòng mã."

############################# Header ############################
title: "Tìm kiếm chữ ký Qrcode trong tệp Tar"
description: "API gốc Java cho phép tìm kiếm chữ ký Qrcode trong các tệp Tar đã được ký. Thực hiện tìm kiếm chữ ký điện tử nâng cao trong tài liệu Tar của bạn bằng cách sử dụng một vài dòng mã."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) giúp các nhà phát triển Java tìm kiếm chữ ký Qrcode trong tệp Tar từ ứng dụng của họ dễ dàng hơn bằng cách thực hiện một vài bước đơn giản.
