...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Xls rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Xls, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Xls"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Xls failides. Tehke oma Xls dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Xls, rakendades mõnda lihtsat sammu.
