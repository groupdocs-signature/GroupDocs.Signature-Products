...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Xlsb rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Xlsb, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Xlsb"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Xlsb failides. Tehke oma Xlsb dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Xlsb, rakendades mõnda lihtsat sammu.
