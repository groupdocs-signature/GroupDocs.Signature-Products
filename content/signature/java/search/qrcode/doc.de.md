...
############################# Head ############################
head_title: "Suche nach Qrcode-Signaturen in der Datei Doc in Java"
head_description: "Verwenden Sie Java für die Suche nach Qrcode-Signaturen in Doc-Dateien mit ein paar Zeilen Code."

############################# Header ############################
title: "Suchen Sie nach Qrcode-Signaturen in der Datei Doc"
description: "Die native API von Java ermöglicht die Suche nach Qrcode-Signaturen in bereits signierten Doc-Dateien. Führen Sie mit wenigen Codezeilen eine erweiterte E-Signatur-Suche in Ihren Doc-Dokumenten durch."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) erleichtert Entwicklern von Java die Suche nach Qrcode-Signaturen in Doc-Dateien aus ihren Anwendungen, indem einige einfache Schritte implementiert werden.
