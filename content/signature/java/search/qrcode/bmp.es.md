...
############################# Head ############################
head_title: "Busque Qrcode firmas en Bmp archivo en Java"
head_description: "Use Java para buscar firmas Qrcode en archivos Bmp usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Bmp"
description: "Java API nativa permite buscar Qrcode firmas en archivos Bmp ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Bmp utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Qrcode en Bmp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Qrcode en archivos Bmp desde sus aplicaciones mediante la implementación de unos sencillos pasos.
