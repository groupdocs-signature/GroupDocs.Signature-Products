...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Tiff rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Tiff, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Tiff"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Tiff failides. Tehke oma Tiff dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Tiff, rakendades mõnda lihtsat sammu.
