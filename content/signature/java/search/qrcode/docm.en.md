...
############################# Head ############################
head_title: "Search for Qrcode signatures in Docm file in Java"
head_description: "Use Java for searching for Qrcode signatures in Docm files using a few lines of code."

############################# Header ############################
title: "Search for Qrcode signatures in Docm file"
description: "Java native API allows to search for Qrcode signatures in already signed Docm files. Perform advanced e-signature search within your Docm documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Qrcode signatures in Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Qrcode signatures in Docm files from their applications by implementing a few easy steps.
