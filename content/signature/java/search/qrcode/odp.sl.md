...
############################# Head ############################
head_title: "Poiščite podpise Qrcode v datoteki Odp v Java"
head_description: "Uporabite Java za iskanje podpisov Qrcode v datotekah Odp z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Qrcode v datoteki Odp"
description: "Izvorni API za Java omogoča iskanje podpisov Qrcode v že podpisanih datotekah Odp. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Odp z uporabo nekaj vrstic kode."
...
steps:
    enable: true
    title_left: "Kako poiskati podpise Qrcode v Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) razvijalcem za Java olajša iskanje podpisov Qrcode v datotekah Odp iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
...
demos:
    ...
    content: |
       Takoj zdaj poiščite v dokumentu različne elektronske podpise za datoteke Odp tako, da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
