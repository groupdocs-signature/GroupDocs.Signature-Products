...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Zip faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Zip failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Zip faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Zip failuose. Atlikite išplėstinę el. parašo paiešką savo Zip dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Zip failuose iš savo programų, atlikdami kelis paprastus veiksmus.
