...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Doc u Java"
head_description: "Upotrijebite Java za traženje potpisa Qrcode u datotekama Doc pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Doc datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Qrcode u već potpisanim Doc datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Doc dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Qrcode u datotekama Doc iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
