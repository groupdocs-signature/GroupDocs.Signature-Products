...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Ott rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Ott, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Ott"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Ott failides. Tehke oma Ott dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Ott, rakendades mõnda lihtsat sammu.
