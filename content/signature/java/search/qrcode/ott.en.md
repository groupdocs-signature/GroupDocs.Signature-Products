...
############################# Head ############################
head_title: "Search for Qrcode signatures in Ott file in Java"
head_description: "Use Java for searching for Qrcode signatures in Ott files using a few lines of code."

############################# Header ############################
title: "Search for Qrcode signatures in Ott file"
description: "Java native API allows to search for Qrcode signatures in already signed Ott files. Perform advanced e-signature search within your Ott documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Qrcode signatures in Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Qrcode signatures in Ott files from their applications by implementing a few easy steps.
