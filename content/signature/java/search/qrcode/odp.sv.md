...
############################# Head ############################
head_title: "Sök efter Qrcode-signaturer i filen Odp i Java"
head_description: "Använd Java för att söka efter Qrcode-signaturer i Odp-filer med några rader kod."

############################# Header ############################
title: "Sök efter Qrcode-signaturer i filen Odp"
description: "Inbyggt API för Java gör det möjligt att söka efter Qrcode-signaturer i redan signerade Odp-filer. Utför avancerad e-signatursökning i dina Odp-dokument med några rader kod."
...
steps:
    enable: true
    title_left: "Hur man söker efter Qrcode-signaturer i Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gör det enklare för Java-utvecklare att söka efter Qrcode-signaturer i Odp-filer från sina applikationer genom att implementera några enkla steg.
