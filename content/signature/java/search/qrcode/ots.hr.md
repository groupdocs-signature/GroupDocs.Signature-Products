...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Ots u Java"
head_description: "Upotrijebite Java za traženje potpisa Qrcode u datotekama Ots pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Ots datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Qrcode u već potpisanim Ots datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ots dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Qrcode potpise u Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Qrcode u datotekama Ots iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
