...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Xlsb faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Xlsb failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Xlsb faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Xlsb failuose. Atlikite išplėstinę el. parašo paiešką savo Xlsb dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Xlsb failuose iš savo programų, atlikdami kelis paprastus veiksmus.
