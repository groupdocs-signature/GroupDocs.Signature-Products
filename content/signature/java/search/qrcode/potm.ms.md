...
############################# Head ############################
head_title: "Cari tandatangan Qrcode dalam fail Potm dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Qrcode dalam fail Potm menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Qrcode dalam fail Potm."
description: "API asli Java membenarkan untuk mencari tandatangan Qrcode dalam fail Potm yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Potm anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Qrcode dalam fail Potm daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
