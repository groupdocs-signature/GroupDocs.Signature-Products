...
############################# Head ############################
head_title: "Cari tandatangan Qrcode dalam fail Bmp dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Qrcode dalam fail Bmp menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Qrcode dalam fail Bmp."
description: "API asli Java membenarkan untuk mencari tandatangan Qrcode dalam fail Bmp yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Bmp anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Qrcode dalam Bmp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Qrcode dalam fail Bmp daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
