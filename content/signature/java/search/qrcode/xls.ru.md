...
############################# Head ############################
head_title: "Поиск подписей Qrcode в файле Xls в Java"
head_description: "Используйте Java для поиска подписей Qrcode в файлах Xls с помощью нескольких строк кода."

############################# Header ############################
title: "Поиск подписей Qrcode в файле Xls"
description: "Собственный API Java позволяет искать подписи Qrcode в уже подписанных файлах Xls. Выполните расширенный поиск электронной подписи в документах Xls, используя несколько строк кода."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) упрощает разработчикам Java поиск подписей Qrcode в файлах Xls из своих приложений, выполняя несколько простых шагов.
