...
############################# Head ############################
head_title: "Wyszukaj podpisy Qrcode w pliku Xltm w Java"
head_description: "Użyj Java do wyszukiwania podpisów Qrcode w plikach Xltm przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Qrcode w pliku Xltm"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Qrcode w już podpisanych plikach Xltm. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Xltm, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Qrcode w Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Qrcode w plikach Xltm z ich aplikacji, wykonując kilka prostych kroków.
