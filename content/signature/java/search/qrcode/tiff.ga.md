...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Tiff i Java"
head_description: "Úsáid Java chun sínithe Qrcode a chuardach i gcomhaid Tiff ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Qrcode sínithe i gcomhad Tiff"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Qrcode sínithe i gcomhaid Tiff atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Tiff ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Qrcode a chuardach i Tiff"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Tiff óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
