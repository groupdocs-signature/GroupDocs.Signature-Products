...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Odt rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Odt, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Odt"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Odt failides. Tehke oma Odt dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Odt, rakendades mõnda lihtsat sammu.
