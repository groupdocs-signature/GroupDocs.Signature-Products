...
############################# Head ############################
head_title: "Căutați semnături Qrcode în fișierul Webp în Java"
head_description: "Utilizați Java pentru a căuta semnături Qrcode în fișiere Webp folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Qrcode în fișierul Webp"
description: "API-ul nativ Java permite căutarea semnăturilor Qrcode în fișierele Webp deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Webp folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Qrcode în Webp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilitează pentru dezvoltatorii Java să caute semnături Qrcode în fișierele Webp din aplicațiile lor prin implementarea câțiva pași simpli.
