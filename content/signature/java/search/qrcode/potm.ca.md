...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Potm a Java"
head_description: "Utilitzeu Java per cercar signatures Qrcode als fitxers Potm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Potm"
description: "L'API nativa de Java permet cercar signatures Qrcode als fitxers Potm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Potm amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Qrcode a Potm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Qrcode als fitxers Potm des de les seves aplicacions implementant uns quants passos senzills.
