...
############################# Head ############################
head_title: "Wyszukaj podpisy Qrcode w pliku Docm w Java"
head_description: "Użyj Java do wyszukiwania podpisów Qrcode w plikach Docm przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Qrcode w pliku Docm"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Qrcode w już podpisanych plikach Docm. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Docm, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Qrcode w Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Qrcode w plikach Docm z ich aplikacji, wykonując kilka prostych kroków.
