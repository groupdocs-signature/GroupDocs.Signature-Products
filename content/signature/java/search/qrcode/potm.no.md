...
############################# Head ############################
head_title: "Søk etter Qrcode-signaturer i filen Potm i Java"
head_description: "Bruk Java for å søke etter Qrcode-signaturer i Potm-filer ved å bruke noen få linjer med kode."

############################# Header ############################
title: "Søk etter Qrcode-signaturer i filen Potm"
description: "Java native API gjør det mulig å søke etter Qrcode-signaturer i allerede signerte Potm-filer. Utfør avansert e-signatursøk i Potm-dokumentene dine ved å bruke noen få linjer med kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gjør det enklere for Java-utviklere å søke etter Qrcode-signaturer i Potm-filer fra applikasjonene deres ved å implementere noen få enkle trinn.
