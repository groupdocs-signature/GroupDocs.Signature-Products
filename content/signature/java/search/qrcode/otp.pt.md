...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Otp em Java"
head_description: "Use Java para pesquisar assinaturas Qrcode em arquivos Otp usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Otp"
description: "A API nativa do Java permite pesquisar assinaturas Qrcode em arquivos Otp já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Otp usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Qrcode em arquivos Otp de seus aplicativos implementando algumas etapas fáceis.
