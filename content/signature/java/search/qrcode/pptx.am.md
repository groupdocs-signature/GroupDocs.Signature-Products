...
############################# Head ############################
head_title: "በJava ውስጥ በPptx ፋይል ውስጥ የQrcode ፊርማዎችን ይፈልጉ"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም በPptx ፋይሎች ውስጥ የQrcode ፊርማዎችን ለመፈለግ Javaን ይጠቀሙ።"

############################# Header ############################
title: "በPptx ፋይል ውስጥ የQrcode ፊርማዎችን ይፈልጉ"
description: "Java ቤተኛ ኤፒአይ አስቀድሞ በተፈረሙ Pptx ፋይሎች ውስጥ የQrcode ፊርማዎችን ለመፈለግ ይፈቅዳል። ጥቂት የኮድ መስመሮችን በመጠቀም በPptx ሰነዶችዎ ውስጥ የላቀ የኢ-ፊርማ ፍለጋን ያድርጉ።"
...
steps:
    enable: true
    title_left: "በPptx ውስጥ የQrcode ፊርማዎችን እንዴት መፈለግ እንደሚቻል"
    content_left: |
