...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Jpg rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Jpg, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Jpg"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Jpg failides. Tehke oma Jpg dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Jpg"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Jpg, rakendades mõnda lihtsat sammu.
