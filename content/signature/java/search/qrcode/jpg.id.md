...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Jpg di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Qrcode di file Jpg menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Jpg"
description: "Java API asli memungkinkan untuk mencari Qrcode tanda tangan di file Jpg yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Jpg Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Qrcode di Jpg"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Qrcode dalam file Jpg dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
