...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Dcm rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Dcm, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Dcm"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Dcm failides. Tehke oma Dcm dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Dcm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Dcm, rakendades mõnda lihtsat sammu.
