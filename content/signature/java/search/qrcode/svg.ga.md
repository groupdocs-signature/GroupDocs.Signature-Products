...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Svg i Java"
head_description: "Úsáid Java chun sínithe Qrcode a chuardach i gcomhaid Svg ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Qrcode sínithe i gcomhad Svg"
description: "Ceadaíonn API dúchais Java cuardach a dhéanamh ar Qrcode sínithe i gcomhaid Svg atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Svg ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Qrcode a chuardach i Svg"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Svg óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
