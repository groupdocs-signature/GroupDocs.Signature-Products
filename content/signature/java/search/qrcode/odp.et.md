...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Odp rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Odp, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Odp"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Odp failides. Tehke oma Odp dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Odp, rakendades mõnda lihtsat sammu.
