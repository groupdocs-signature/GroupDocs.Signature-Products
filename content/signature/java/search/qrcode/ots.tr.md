...
############################# Head ############################
head_title: "Java içinde Ots dosyasında Qrcode imzasını arayın"
head_description: "Birkaç satır kod kullanarak Ots dosyalarında Qrcode imzasını aramak için Java kullanın."

############################# Header ############################
title: "Ots dosyasında Qrcode imzasını arayın"
description: "Java yerel API'si, önceden imzalanmış Ots dosyalarında Qrcode imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Ots belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Ots içinde Qrcode imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak Ots dosyalarında Qrcode imzalarını aramasını kolaylaştırır.
