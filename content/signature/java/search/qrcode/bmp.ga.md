...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Bmp i Java"
head_description: "Úsáid Java chun sínithe Qrcode a chuardach i gcomhaid Bmp ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Qrcode sínithe i gcomhad Bmp"
...
steps:
    enable: true
    title_left: "Conas síniú Qrcode a chuardach i Bmp"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Bmp óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
