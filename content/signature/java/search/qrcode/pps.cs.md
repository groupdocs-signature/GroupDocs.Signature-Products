...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Pps v Java"
head_description: "Použijte Java k vyhledávání podpisů Qrcode v souborech Pps pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Pps"
description: "Nativní API Java umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Pps. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Pps pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Qrcode v souborech Pps z jejich aplikací implementací několika snadných kroků.
