...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Doc di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Qrcode di file Doc menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Doc"
description: "Java API asli memungkinkan untuk mencari Qrcode tanda tangan di file Doc yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Doc Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Qrcode dalam file Doc dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
