...
############################# Head ############################
head_title: "Keressen Qrcode aláírásokat a Potx fájlban a Java programban"
head_description: "A Java használatával kereshet Qrcode aláírásokat a Potx fájlokban néhány sornyi kód használatával."

############################# Header ############################
title: "Keressen Qrcode aláírásokat a Potx fájlban"
description: "A Java natív API lehetővé teszi a Qrcode aláírások keresését a már aláírt Potx fájlokban. Végezzen speciális e-aláírás-keresést a Potx dokumentumaiban néhány sornyi kód használatával."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy Qrcode aláírásokat keressenek alkalmazásaik Potx fájljaiban.
