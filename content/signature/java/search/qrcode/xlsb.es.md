...
############################# Head ############################
head_title: "Busque Qrcode firmas en Xlsb archivo en Java"
head_description: "Use Java para buscar firmas Qrcode en archivos Xlsb usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Xlsb"
description: "Java API nativa permite buscar Qrcode firmas en archivos Xlsb ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Xlsb utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Qrcode en Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Qrcode en archivos Xlsb desde sus aplicaciones mediante la implementación de unos sencillos pasos.
