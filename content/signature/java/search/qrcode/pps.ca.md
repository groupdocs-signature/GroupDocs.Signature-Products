...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Pps a Java"
head_description: "Utilitzeu Java per cercar signatures Qrcode als fitxers Pps mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Pps"
description: "L'API nativa de Java permet cercar signatures Qrcode als fitxers Pps ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Pps amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Qrcode als fitxers Pps des de les seves aplicacions implementant uns quants passos senzills.
