...
breadcrumb: Search Qrcode signatures at Odp with Java

############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Odp di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Qrcode di file Odp menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Odp"
description: "Java API asli memungkinkan untuk mencari Qrcode tanda tangan di file Odp yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Odp Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Qrcode di Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Qrcode dalam file Odp dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ...
        // search for Qrcode signatures in Odp document
...
demos:
    ...
    content: |
       Cari dokumen untuk berbagai tanda tangan elektronik ke file Odp sekarang juga dengan mengunjungi situs web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
