...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Ods v Java"
head_description: "Použijte Java k vyhledávání podpisů Qrcode v souborech Ods pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Ods"
description: "Nativní API Java umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Ods. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ods pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Qrcode v souborech Ods z jejich aplikací implementací několika snadných kroků.
