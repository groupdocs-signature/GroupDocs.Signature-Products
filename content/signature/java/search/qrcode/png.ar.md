...
############################# Head ############################
head_title: "ابحث عن توقيعات Qrcode في ملف Png في Java"
head_description: "استخدم Java للبحث عن توقيعات Qrcode في ملفات Png باستخدام بضعة أسطر من التعليمات البرمجية."

############################# Header ############################
title: "ابحث عن توقيعات Qrcode في ملف Png"
description: "تسمح واجهة برمجة التطبيقات الأصلية لـ Java بالبحث عن توقيعات Qrcode في ملفات Png الموقعة بالفعل. قم بإجراء بحث متقدم عن التوقيع الإلكتروني داخل مستندات Png باستخدام بضعة أسطر من التعليمات البرمجية."
...
steps:
    ...
    content_left: |
        يسهّل [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) على مطوري Java البحث عن توقيعات Qrcode في ملفات Png من تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
