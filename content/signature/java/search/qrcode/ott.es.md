...
############################# Head ############################
head_title: "Busque Qrcode firmas en Ott archivo en Java"
head_description: "Use Java para buscar firmas Qrcode en archivos Ott usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Ott"
description: "Java API nativa permite buscar Qrcode firmas en archivos Ott ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Ott utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Qrcode en archivos Ott desde sus aplicaciones mediante la implementación de unos sencillos pasos.
