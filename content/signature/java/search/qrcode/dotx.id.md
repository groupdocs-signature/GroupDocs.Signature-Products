...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Dotx di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Qrcode di file Dotx menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Dotx"
description: "Java API asli memungkinkan untuk mencari Qrcode tanda tangan di file Dotx yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Dotx Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Qrcode di Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Qrcode dalam file Dotx dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
