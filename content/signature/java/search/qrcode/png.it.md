...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file Png in Java"
head_description: "Usa Java per cercare le firme Qrcode nei file Png utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file Png"
description: "L'API nativa Java consente di cercare firme Qrcode in file Png già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Png utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Qrcode nei file Png dalle loro applicazioni implementando alcuni semplici passaggi.
