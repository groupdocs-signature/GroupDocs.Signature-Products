...
############################# Head ############################
head_title: "Wyszukaj podpisy Qrcode w pliku Ott w Java"
head_description: "Użyj Java do wyszukiwania podpisów Qrcode w plikach Ott przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Qrcode w pliku Ott"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Qrcode w już podpisanych plikach Ott. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Ott, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Qrcode w plikach Ott z ich aplikacji, wykonując kilka prostych kroków.
