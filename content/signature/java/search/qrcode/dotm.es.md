...
############################# Head ############################
head_title: "Busque Qrcode firmas en Dotm archivo en Java"
head_description: "Use Java para buscar firmas Qrcode en archivos Dotm usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Dotm"
description: "Java API nativa permite buscar Qrcode firmas en archivos Dotm ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Dotm utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Qrcode en Dotm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Qrcode en archivos Dotm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
