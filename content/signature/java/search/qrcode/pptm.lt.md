...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Pptm faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Pptm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Pptm faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Pptm failuose. Atlikite išplėstinę el. parašo paiešką savo Pptm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Pptm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
