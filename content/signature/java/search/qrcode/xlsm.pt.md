...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Xlsm em Java"
head_description: "Use Java para pesquisar assinaturas Qrcode em arquivos Xlsm usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Xlsm"
description: "A API nativa do Java permite pesquisar assinaturas Qrcode em arquivos Xlsm já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Xlsm usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Qrcode em arquivos Xlsm de seus aplicativos implementando algumas etapas fáceis.
