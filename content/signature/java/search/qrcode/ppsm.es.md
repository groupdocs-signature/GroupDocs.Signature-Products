...
############################# Head ############################
head_title: "Busque Qrcode firmas en Ppsm archivo en Java"
head_description: "Use Java para buscar firmas Qrcode en archivos Ppsm usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Ppsm"
description: "Java API nativa permite buscar Qrcode firmas en archivos Ppsm ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Ppsm utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita a los desarrolladores de Java la búsqueda de firmas Qrcode en archivos Ppsm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
