...
############################# Head ############################
head_title: "Rechercher les signatures Qrcode dans le fichier Xltm dans Java"
head_description: "Utilisez Java pour rechercher des signatures Qrcode dans des fichiers Xltm en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Qrcode dans le fichier Xltm"
description: "L'API native Java permet de rechercher des signatures Qrcode dans des fichiers Xltm déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Xltm en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Qrcode dans Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Qrcode dans des fichiers Xltm à partir de leurs applications en mettant en œuvre quelques étapes simples.
