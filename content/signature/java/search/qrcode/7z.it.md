...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file 7z in Java"
head_description: "Usa Java per cercare le firme Qrcode nei file 7z utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file 7z"
description: "L'API nativa Java consente di cercare firme Qrcode in file 7z già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti 7z utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Qrcode nei file 7z dalle loro applicazioni implementando alcuni semplici passaggi.
