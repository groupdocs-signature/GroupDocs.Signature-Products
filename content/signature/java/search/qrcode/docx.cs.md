...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Docx v Java"
head_description: "Použijte Java k vyhledávání podpisů Qrcode v souborech Docx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Docx"
description: "Nativní API Java umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Docx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Docx pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Qrcode v souborech Docx z jejich aplikací implementací několika snadných kroků.
