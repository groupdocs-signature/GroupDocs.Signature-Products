...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Wmf v Java"
head_description: "Použijte Java k vyhledávání podpisů Qrcode v souborech Wmf pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Wmf"
description: "Nativní API Java umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Wmf. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Wmf pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Wmf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Qrcode v souborech Wmf z jejich aplikací implementací několika snadných kroků.
