...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Odp a Java"
head_description: "Utilitzeu Java per cercar signatures Qrcode als fitxers Odp mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Odp"
description: "L'API nativa de Java permet cercar signatures Qrcode als fitxers Odp ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Odp amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Qrcode a Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Qrcode als fitxers Odp des de les seves aplicacions implementant uns quants passos senzills.
