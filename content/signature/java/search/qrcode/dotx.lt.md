...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Dotx faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Dotx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Dotx faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Dotx failuose. Atlikite išplėstinę el. parašo paiešką savo Dotx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Dotx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
