...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Docm faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Docm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Docm faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Docm failuose. Atlikite išplėstinę el. parašo paiešką savo Docm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Docm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
