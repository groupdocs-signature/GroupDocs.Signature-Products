...
############################# Head ############################
head_title: "Search for Qrcode signatures in Wmf file in Java"
head_description: "Use Java for searching for Qrcode signatures in Wmf files using a few lines of code."

############################# Header ############################
title: "Search for Qrcode signatures in Wmf file"
description: "Java native API allows to search for Qrcode signatures in already signed Wmf files. Perform advanced e-signature search within your Wmf documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Qrcode signatures in Wmf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Qrcode signatures in Wmf files from their applications by implementing a few easy steps.
