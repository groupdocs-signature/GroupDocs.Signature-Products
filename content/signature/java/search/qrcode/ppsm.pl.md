...
############################# Head ############################
head_title: "Wyszukaj podpisy Qrcode w pliku Ppsm w Java"
head_description: "Użyj Java do wyszukiwania podpisów Qrcode w plikach Ppsm przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Qrcode w pliku Ppsm"
description: "Natywny interfejs API Java umożliwia wyszukiwanie podpisów Qrcode w już podpisanych plikach Ppsm. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Ppsm, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Qrcode w Ppsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ułatwia programistom Java wyszukiwanie podpisów Qrcode w plikach Ppsm z ich aplikacji, wykonując kilka prostych kroków.
