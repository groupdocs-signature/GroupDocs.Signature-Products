...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Svg u Java"
head_description: "Upotrijebite Java za traženje potpisa Qrcode u datotekama Svg pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Svg datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Qrcode u već potpisanim Svg datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Svg dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Qrcode u datotekama Svg iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
