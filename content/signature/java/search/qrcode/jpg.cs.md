...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Jpg v Java"
head_description: "Použijte Java k vyhledávání podpisů Qrcode v souborech Jpg pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Jpg"
description: "Nativní API Java umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Jpg. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Jpg pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) usnadňuje vývojářům Java hledání podpisů Qrcode v souborech Jpg z jejich aplikací implementací několika snadných kroků.
