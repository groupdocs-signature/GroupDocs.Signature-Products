...
############################# Head ############################
head_title: "Որոնեք Qrcode ստորագրությունները Odt ֆայլում Java-ում"
head_description: "Օգտագործեք Java՝ Qrcode ստորագրությունները Odt ֆայլերում մի քանի տող կոդով որոնելու համար:"

############################# Header ############################
title: "Փնտրեք Qrcode ստորագրությունները Odt ֆայլում"
description: "Java բնօրինակ API-ն թույլ է տալիս որոնել Qrcode ստորագրություններ արդեն ստորագրված Odt ֆայլերում: Կատարեք էլեկտրոնային ստորագրության առաջադեմ որոնում ձեր Odt փաստաթղթերում՝ օգտագործելով մի քանի տող կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես որոնել Qrcode ստորագրությունները Odt-ում"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) հեշտացնում է Java ծրագրավորողների համար որոնել Qrcode ստորագրությունները Odt ֆայլերում իրենց հավելվածներից` իրականացնելով մի քանի հեշտ քայլեր:
