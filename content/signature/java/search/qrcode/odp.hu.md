...
############################# Head ############################
head_title: "Keressen Qrcode aláírásokat a Odp fájlban a Java programban"
head_description: "A Java használatával kereshet Qrcode aláírásokat a Odp fájlokban néhány sornyi kód használatával."

############################# Header ############################
title: "Keressen Qrcode aláírásokat a Odp fájlban"
description: "A Java natív API lehetővé teszi a Qrcode aláírások keresését a már aláírt Odp fájlokban. Végezzen speciális e-aláírás-keresést a Odp dokumentumaiban néhány sornyi kód használatával."
...
steps:
    enable: true
    title_left: "Qrcode aláírások keresése a Odp fájlban"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy Qrcode aláírásokat keressenek alkalmazásaik Odp fájljaiban.
...
demos:
    ...
    content: |
       A [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webhelyen azonnal kereshet a dokumentumban különféle elektronikus aláírásokat Odp fájlokhoz.
