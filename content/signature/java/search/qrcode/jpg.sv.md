...
############################# Head ############################
head_title: "Sök efter Qrcode-signaturer i filen Jpg i Java"
head_description: "Använd Java för att söka efter Qrcode-signaturer i Jpg-filer med några rader kod."

############################# Header ############################
title: "Sök efter Qrcode-signaturer i filen Jpg"
description: "Inbyggt API för Java gör det möjligt att söka efter Qrcode-signaturer i redan signerade Jpg-filer. Utför avancerad e-signatursökning i dina Jpg-dokument med några rader kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gör det enklare för Java-utvecklare att söka efter Qrcode-signaturer i Jpg-filer från sina applikationer genom att implementera några enkla steg.
