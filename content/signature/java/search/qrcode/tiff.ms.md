...
############################# Head ############################
head_title: "Cari tandatangan Qrcode dalam fail Tiff dalam Java"
head_description: "Gunakan Java untuk mencari tandatangan Qrcode dalam fail Tiff menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Qrcode dalam fail Tiff."
description: "API asli Java membenarkan untuk mencari tandatangan Qrcode dalam fail Tiff yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Tiff anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Qrcode dalam Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pembangun Java mencari tandatangan Qrcode dalam fail Tiff daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
