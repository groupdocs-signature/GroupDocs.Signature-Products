...
############################# Head ############################
head_title: "Li Qrcode îmzeyan di pela Xls de di Java de bigerin"
head_description: "Java ji bo lêgerîna îmzeyên Qrcode di pelên Xls de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Xls de li îmzeyên Qrcode bigerin"
description: "API-ya xwecihî ya Java destûrê dide ku meriv di pelên Xls yên jixwe îmzekirî de li îmzeyên Qrcode bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Xls de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji pêşdebirên Java re hêsantir dike ku bi pêkanîna çend gavên hêsan li Qrcode di pelên Xls îmzeyan de ji sepanên xwe bigerin.
