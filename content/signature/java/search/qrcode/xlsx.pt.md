...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Xlsx em Java"
head_description: "Use Java para pesquisar assinaturas Qrcode em arquivos Xlsx usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Xlsx"
description: "A API nativa do Java permite pesquisar assinaturas Qrcode em arquivos Xlsx já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Xlsx usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Qrcode em arquivos Xlsx de seus aplicativos implementando algumas etapas fáceis.
