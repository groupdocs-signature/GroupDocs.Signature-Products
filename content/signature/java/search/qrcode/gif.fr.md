...
breadcrumb: Search Qrcode signatures at Gif with Java

############################# Head ############################
head_title: "Rechercher les signatures Qrcode dans le fichier Gif dans Java"
head_description: "Utilisez Java pour rechercher des signatures Qrcode dans des fichiers Gif en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Qrcode dans le fichier Gif"
description: "L'API native Java permet de rechercher des signatures Qrcode dans des fichiers Gif déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Gif en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Qrcode dans Gif"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) permet aux développeurs de Java de rechercher plus facilement des signatures Qrcode dans des fichiers Gif à partir de leurs applications en mettant en œuvre quelques étapes simples.
    ...
    code: |
        ...
        // search for Qrcode signatures in Gif document
...
demos:
    ...
    content: |
       Recherchez dès maintenant dans le document diverses signatures électroniques dans des fichiers Gif en visitant le site Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
