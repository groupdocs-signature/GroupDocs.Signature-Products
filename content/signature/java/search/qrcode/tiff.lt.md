...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Tiff faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Tiff failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Tiff faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Tiff failuose. Atlikite išplėstinę el. parašo paiešką savo Tiff dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Tiff"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Tiff failuose iš savo programų, atlikdami kelis paprastus veiksmus.
