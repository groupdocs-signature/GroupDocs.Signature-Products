...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Otp faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Otp failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Otp faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Otp failuose. Atlikite išplėstinę el. parašo paiešką savo Otp dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Otp failuose iš savo programų, atlikdami kelis paprastus veiksmus.
