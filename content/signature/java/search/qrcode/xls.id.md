...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Xls di Java"
head_description: "Gunakan Java untuk mencari tanda tangan Qrcode di file Xls menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Xls"
description: "Java API asli memungkinkan untuk mencari Qrcode tanda tangan di file Xls yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xls Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Qrcode di Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) memudahkan pengembang Java untuk mencari tanda tangan Qrcode dalam file Xls dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
