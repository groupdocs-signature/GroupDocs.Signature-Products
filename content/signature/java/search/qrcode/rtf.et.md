...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Rtf rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Rtf, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Rtf"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Rtf failides. Tehke oma Rtf dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Rtf, rakendades mõnda lihtsat sammu.
