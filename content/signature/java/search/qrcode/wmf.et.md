...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Wmf rakenduses Java"
head_description: "Kasutage Java allkirjade Qrcode otsimiseks failides Wmf, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Wmf"
description: "Native API Java võimaldab otsida allkirju Qrcode juba allkirjastatud Wmf failides. Tehke oma Wmf dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hõlbustab toote Java arendajatel allkirjade Qrcode otsimist oma rakendustest failides Wmf, rakendades mõnda lihtsat sammu.
