...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Docm a Java"
head_description: "Utilitzeu Java per cercar signatures Qrcode als fitxers Docm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Docm"
description: "L'API nativa de Java permet cercar signatures Qrcode als fitxers Docm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Docm amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Qrcode a Docm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Qrcode als fitxers Docm des de les seves aplicacions implementant uns quants passos senzills.
...
demos:
    ...
    content: |
       Cerqueu al document diverses signatures electròniques als fitxers Docm ara mateix visitant el lloc web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
