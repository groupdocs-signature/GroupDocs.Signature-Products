...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Xlsb u Java"
head_description: "Upotrijebite Java za traženje potpisa Qrcode u datotekama Xlsb pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Xlsb datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Qrcode u već potpisanim Xlsb datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xlsb dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Qrcode potpise u Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Qrcode u datotekama Xlsb iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
