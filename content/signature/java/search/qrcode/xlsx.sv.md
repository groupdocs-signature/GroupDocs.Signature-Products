...
description: "Inbyggt API för Java gör det möjligt att söka efter Qrcode-signaturer i redan signerade Xlsx-filer. Utför avancerad e-signatursökning i dina {{Filformat}}-dokument med några rader kod."
