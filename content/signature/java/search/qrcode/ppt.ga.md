...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Ppt i Java"
head_description: "Úsáid Java chun sínithe Qrcode a chuardach i gcomhaid Ppt ag úsáid cúpla líne de chód."
...
steps:
    enable: true
    title_left: "Conas síniú Qrcode a chuardach i Ppt"
    content_left: |
        Déanann [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) é níos fusa d’fhorbróirí Java cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Ppt óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
