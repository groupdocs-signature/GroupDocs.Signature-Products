...
############################# Head ############################
head_title: "Sök efter Qrcode-signaturer i filen Dotx i Java"
head_description: "Använd Java för att söka efter Qrcode-signaturer i Dotx-filer med några rader kod."

############################# Header ############################
title: "Sök efter Qrcode-signaturer i filen Dotx"
description: "Inbyggt API för Java gör det möjligt att söka efter Qrcode-signaturer i redan signerade Dotx-filer. Utför avancerad e-signatursökning i dina Dotx-dokument med några rader kod."
...
steps:
    enable: true
    title_left: "Hur man söker efter Qrcode-signaturer i Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gör det enklare för Java-utvecklare att söka efter Qrcode-signaturer i Dotx-filer från sina applikationer genom att implementera några enkla steg.
