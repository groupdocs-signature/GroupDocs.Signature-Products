...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Ott u Java"
head_description: "Upotrijebite Java za traženje potpisa Qrcode u datotekama Ott pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Ott datoteci"
description: "Izvorni API za Java omogućuje pretraživanje potpisa Qrcode u već potpisanim Ott datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ott dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Qrcode potpise u Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) programerima proizvoda Java olakšava traženje potpisa Qrcode u datotekama Ott iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
