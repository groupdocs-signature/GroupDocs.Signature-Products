...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Gif a Java"
head_description: "Utilitzeu Java per cercar signatures Qrcode als fitxers Gif mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Gif"
description: "L'API nativa de Java permet cercar signatures Qrcode als fitxers Gif ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Gif amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Qrcode a Gif"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Qrcode als fitxers Gif des de les seves aplicacions implementant uns quants passos senzills.
