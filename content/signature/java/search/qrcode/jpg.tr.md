...
############################# Head ############################
head_title: "Java içinde Jpg dosyasında Qrcode imzasını arayın"
head_description: "Birkaç satır kod kullanarak Jpg dosyalarında Qrcode imzasını aramak için Java kullanın."

############################# Header ############################
title: "Jpg dosyasında Qrcode imzasını arayın"
description: "Java yerel API'si, önceden imzalanmış Jpg dosyalarında Qrcode imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Jpg belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Jpg içinde Qrcode imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak Jpg dosyalarında Qrcode imzalarını aramasını kolaylaştırır.
