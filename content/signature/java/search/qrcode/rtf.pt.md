...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Rtf em Java"
head_description: "Use Java para pesquisar assinaturas Qrcode em arquivos Rtf usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Rtf"
description: "A API nativa do Java permite pesquisar assinaturas Qrcode em arquivos Rtf já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Rtf usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) torna mais fácil para os desenvolvedores do Java pesquisar assinaturas Qrcode em arquivos Rtf de seus aplicativos implementando algumas etapas fáceis.
