...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file Xlsm in Java"
head_description: "Usa Java per cercare le firme Qrcode nei file Xlsm utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file Xlsm"
description: "L'API nativa Java consente di cercare firme Qrcode in file Xlsm già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Xlsm utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Qrcode in Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) consente agli sviluppatori di Java di cercare più facilmente le firme Qrcode nei file Xlsm dalle loro applicazioni implementando alcuni semplici passaggi.
