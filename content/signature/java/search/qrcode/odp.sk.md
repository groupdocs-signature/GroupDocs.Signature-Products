...
############################# Head ############################
head_title: "Vyhľadajte podpisy Qrcode v súbore Odp v Java"
head_description: "Použite Java na vyhľadávanie Qrcode podpisov v súboroch Odp pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Qrcode v súbore Odp"
description: "Natívne API Java umožňuje vyhľadávať podpisy Qrcode v už podpísaných súboroch Odp. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Odp pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Qrcode v Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) uľahčuje vývojárom Java vyhľadávanie podpisov Qrcode v súboroch Odp z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
...
demos:
    ...
    content: |
       Vyhľadajte v dokumente rôzne elektronické podpisy do súborov Odp práve teraz na webovej lokalite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
