...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Ppt faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Ppt failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Ppt faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Ppt failuose. Atlikite išplėstinę el. parašo paiešką savo Ppt dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Ppt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Ppt failuose iš savo programų, atlikdami kelis paprastus veiksmus.
