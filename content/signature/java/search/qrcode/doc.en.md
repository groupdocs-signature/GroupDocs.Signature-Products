...
############################# Head ############################
head_title: "Search for Qrcode signatures in Doc file in Java"
head_description: "Use Java for searching for Qrcode signatures in Doc files using a few lines of code."

############################# Header ############################
title: "Search for Qrcode signatures in Doc file"
description: "Java native API allows to search for Qrcode signatures in already signed Doc files. Perform advanced e-signature search within your Doc documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Qrcode signatures in Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) makes it easier for Java developers to search for Qrcode signatures in Doc files from their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
       Search the document for various electronic signatures to Doc files right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.
