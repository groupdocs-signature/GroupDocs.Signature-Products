...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Xls faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Xls failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Xls faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Xls failuose. Atlikite išplėstinę el. parašo paiešką savo Xls dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Xls failuose iš savo programų, atlikdami kelis paprastus veiksmus.
