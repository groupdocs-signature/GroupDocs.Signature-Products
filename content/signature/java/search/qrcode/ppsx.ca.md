...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Ppsx a Java"
head_description: "Utilitzeu Java per cercar signatures Qrcode als fitxers Ppsx mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Ppsx"
description: "L'API nativa de Java permet cercar signatures Qrcode als fitxers Ppsx ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Ppsx amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Qrcode a Ppsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Qrcode als fitxers Ppsx des de les seves aplicacions implementant uns quants passos senzills.
