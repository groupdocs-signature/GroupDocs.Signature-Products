...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Xltm a Java"
head_description: "Utilitzeu Java per cercar signatures Qrcode als fitxers Xltm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Xltm"
description: "L'API nativa de Java permet cercar signatures Qrcode als fitxers Xltm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Xltm amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) facilita que els desenvolupadors de Java cerquin signatures de Qrcode als fitxers Xltm des de les seves aplicacions implementant uns quants passos senzills.
