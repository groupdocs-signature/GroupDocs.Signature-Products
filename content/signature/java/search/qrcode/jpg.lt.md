...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Jpg faile Java"
head_description: "Naudokite Java, norėdami ieškoti Qrcode parašų Jpg failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Jpg faile"
description: "Java savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Jpg failuose. Atlikite išplėstinę el. parašo paiešką savo Jpg dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Jpg"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) leidžia Java kūrėjams lengviau ieškoti Qrcode parašų Jpg failuose iš savo programų, atlikdami kelis paprastus veiksmus.
