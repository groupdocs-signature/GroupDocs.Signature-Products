...
############################# Head ############################
head_title: "e-Sign DOCX files with Java apps"
head_description: "Use Java API to process DOCX files and apply various signature types, including PDF, Word, Excel, Presentations, and Images."

############################# Header ############################
title: "Electronic signatures for DOCX" 
...
steps:
    enable: true
    title: "Steps for signing DOCX using Java"
    content: |
      [GroupDocs.Signature](/signature/java/) enables adding customized signatures to DOCX files. Java developers can integrate signing functionality into their applications using our software.
