...
############################# Head ############################
head_title: "Assine arquivos PDF com aplicativos Java"
head_description: "Use a API Java para processar arquivos PDF e aplicar vários tipos de assinaturas, incluindo PDF, Word, Excel, Apresentações e Imagens."

############################# Header ############################
title: "Assinaturas eletrônicas para PDF" 
...
steps:
    enable: true
    title: "Etapas para assinar PDF usando Java"
    content: |
      [GroupDocs.Signature](/signature/java/) permite adicionar assinaturas personalizadas a arquivos PDF. Desenvolvedores de Java podem integrar a funcionalidade de assinatura em seus aplicativos usando nosso software.
      
      1. Forneça o arquivo PDF a ser assinado para a instância Signature.
