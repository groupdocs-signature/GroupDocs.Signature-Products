...
############################# Head ############################
head_title: "使用 Java 应用程序为 DOCX 文件电子签名"
head_description: "使用 Java API 处理 DOCX 文件并应用各种签名类型，包括 PDF、Word、Excel、演示文稿和图片。"
...
steps:
    enable: true
    title: "使用 Java 签署 DOCX 的步骤"
    content: |
      [GroupDocs.Signature](/signature/java/) 使得向 DOCX 文件添加自定义签名成为可能。Java 开发者可以使用我们的软件将签署功能集成到他们的应用程序中。
      
      1. 将要签名的 DOCX 文件提供给 Signature 实例。
