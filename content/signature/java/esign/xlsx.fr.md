...
############################# Head ############################
head_title: "Signer des fichiers XLSX avec des applications Java"
head_description: "Utilisez l'API Java pour traiter des fichiers XLSX et appliquer divers types de signatures, y compris PDF, Word, Excel, Présentations et Images."

############################# Header ############################
title: "Signatures électroniques pour XLSX" 
...
steps:
    enable: true
    title: "Étapes pour signer XLSX avec Java"
    content: |
      [GroupDocs.Signature](/signature/java/) permet d'ajouter des signatures personnalisées à des fichiers XLSX. Les développeurs Java peuvent intégrer la fonctionnalité de signature dans leurs applications en utilisant notre logiciel.
      
      1. Fournissez le fichier XLSX à signer à l'instance Signature.
