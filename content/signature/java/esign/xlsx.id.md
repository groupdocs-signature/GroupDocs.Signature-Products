...
############################# Head ############################
head_title: "Tanda tangan e-Sign berkas XLSX dengan aplikasi Java"
head_description: "Gunakan API Java untuk memproses berkas XLSX dan menerapkan berbagai jenis tanda tangan, termasuk PDF, Word, Excel, Presentasi, dan Gambar."

############################# Header ############################
title: "Tanda tangan elektronik untuk XLSX" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk menandatangani XLSX menggunakan Java"
    content: |
      [GroupDocs.Signature](/signature/java/) memungkinkan penambahan tanda tangan kustom ke berkas XLSX. Pengembang Java dapat mengintegrasikan fungsionalitas tanda tangan ke dalam aplikasi mereka menggunakan perangkat lunak kami.
      
      1. Berikan berkas XLSX yang akan ditandatangani ke instance Signature.
