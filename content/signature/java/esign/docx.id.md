...
############################# Head ############################
head_title: "Tanda tangan e-Sign berkas DOCX dengan aplikasi Java"
head_description: "Gunakan API Java untuk memproses berkas DOCX dan menerapkan berbagai jenis tanda tangan, termasuk PDF, Word, Excel, Presentasi, dan Gambar."

############################# Header ############################
title: "Tanda tangan elektronik untuk DOCX" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk menandatangani DOCX menggunakan Java"
    content: |
      [GroupDocs.Signature](/signature/java/) memungkinkan penambahan tanda tangan kustom ke berkas DOCX. Pengembang Java dapat mengintegrasikan fungsionalitas tanda tangan ke dalam aplikasi mereka menggunakan perangkat lunak kami.
      
      1. Berikan berkas DOCX yang akan ditandatangani ke instance Signature.
