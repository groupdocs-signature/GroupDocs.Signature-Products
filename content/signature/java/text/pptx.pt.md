...
############################# Head ############################
head_title: "Crie assinaturas de texto PPTX com Java"
head_description: "Aproveite a API Java para inserir assinaturas de texto em arquivos PPTX. Processe de forma integrada formatos de documento populares, incluindo PDF, Word, Excel, Apresentações, Imagens e ZIP."

############################# Header ############################
title: "Crie assinaturas de texto para PPTX" 
...
steps:
    enable: true
    title: "Passos para adicionar assinaturas de texto a PPTX usando Java"
    content: |
      [GroupDocs.Signature](/signature/java/) pode ser integrado a aplicações Java para adicionar assinaturas de texto a documentos PPTX. Os desenvolvedores podem rapidamente melhorar a funcionalidade de seus produtos utilizando nossas soluções.
      
      1. Use o documento PPTX como um parâmetro para o construtor da classe Signature.
