...
############################# Head ############################
head_title: "Create DOCX text signatures with Java"
...
############################# Header ############################
title: "Create text signatures for DOCX" 
...
steps:
    enable: true
    title: "Steps for adding text signatures to DOCX using Java"
    content: |
      ...
      1. Use the DOCX document as a parameter for the Signature class constructor.
