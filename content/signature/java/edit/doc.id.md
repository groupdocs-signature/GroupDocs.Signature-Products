...
head_title: "Contoh Kode Java untuk Melihat &amp; Edit Tanda Tangan Digital dari DOC File"
head_description: "Contoh kode Java untuk melihat dan mengedit tanda tangan digital dari file DOC menggunakan GroupDocs.Siganture API - tambahkan tanda tangan elektronik khusus ke dokumen bisnis populer dan format file gambar."

title: "Edit Tanda Tangan Digital di DOC melalui Java"
description: "Pustaka Java untuk melihat &amp; mengedit tanda tangan digital dalam file DOC menggunakan jenis tanda tangan elektronik populer. Kelola properti DOC dan sesuaikan opsi penandatanganan dalam dokumen dan gambar."
...
steps:
    enable: true
    title_left: "Cara Mengedit Tanda Tangan Digital di DOC"
    content_left: |
        Contoh kode di bawah ini dengan jelas menunjukkan langkah-langkah tentang **cara mengedit tanda tangan digital dalam file DOC yang sudah ditandatangani di Java** menggunakan pustaka [GroupDocs.Signature](/id/signature/java/) dengan menambahkan beberapa baris kode saja.
...
demos:
    enable: true
    title: "Edit DOC Signature Live Demo"
    content: |
