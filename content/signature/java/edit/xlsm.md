...
############################# Head ############################
head_title: "Java Code Example to View &amp; Edit Digital Signatures from XLSM Files"
head_description: "Java code example to view and edit digital signatures from a XLSM file using GroupDocs.Siganture API - add customized electronic signatures to popular business documents and image file formats."

############################# Header ############################
title: "Edit Digital Signatures in XLSM via Java"
description: "Java library to view &amp; edit digital signatures in a XLSM file using popular electronic signature types. Manage xlsm properties and customize signing options within documents and images."
...
steps:
    enable: true
    title_left: "How to Edit Digital Signatures in XLSM"
    content_left: |
        The code example below clearly demonstrates the steps about **how to edit digital signatures in an already signed XLSM file in Java** using [GroupDocs.Signature](https://products.groupdocs.com/signature/java) library by adding just a few lines of code.
...
demos:
    enable: true
    title: "Edit XLSM Signature Live Demos"
    content: |
