...
head_title: "Contoh Kode Java untuk Melihat &amp; Edit Tanda Tangan Digital dari CMX File"
head_description: "Contoh kode Java untuk melihat dan mengedit tanda tangan digital dari file CMX menggunakan GroupDocs.Siganture API - tambahkan tanda tangan elektronik khusus ke dokumen bisnis populer dan format file gambar."

title: "Edit Tanda Tangan Digital di CMX melalui Java"
description: "Pustaka Java untuk melihat &amp; mengedit tanda tangan digital dalam file CMX menggunakan jenis tanda tangan elektronik populer. Kelola properti CMX dan sesuaikan opsi penandatanganan dalam dokumen dan gambar."
...
steps:
    enable: true
    title_left: "Cara Mengedit Tanda Tangan Digital di CMX"
    content_left: |
        Contoh kode di bawah ini dengan jelas menunjukkan langkah-langkah tentang **cara mengedit tanda tangan digital dalam file CMX yang sudah ditandatangani di Java** menggunakan pustaka [GroupDocs.Signature](/id/signature/java/) dengan menambahkan beberapa baris kode saja.
    ...
    code: |
        ...
        try 
        {
            ...
            if (signatures.size() > 0)
            {
                ...
                boolean result = signature.update("sampleSigned-output.cmx",imageSignature);
                if (result)
                {
