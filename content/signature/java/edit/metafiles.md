...
############################# Head ############################
head_title: "Java Code Example to View &amp; Edit Digital Signatures from METAFILES Files"
head_description: "Java code example to view and edit digital signatures from a METAFILES file using GroupDocs.Siganture API - add customized electronic signatures to popular business documents and image file formats."

############################# Header ############################
title: "Edit Digital Signatures in METAFILES via Java"
description: "Java library to view &amp; edit digital signatures in a METAFILES file using popular electronic signature types. Manage metafiles properties and customize signing options within documents and images."
...
steps:
    enable: true
    title_left: "How to Edit Digital Signatures in METAFILES"
    content_left: |
        The code example below clearly demonstrates the steps about **how to edit digital signatures in an already signed METAFILES file in Java** using [GroupDocs.Signature](/signature/java/) library by adding just a few lines of code.
    ...
    code: |
        ...
        try 
        {
            ...
            if (signatures.size() > 0)
            {
                ...
                boolean result = signature.update("sampleSigned-output.metafiles",imageSignature);
                if (result)
                {
...
demos:
    enable: true
    title: "Edit METAFILES Signature Live Demos"
    content: |
        Add METAFILES file electronic signatures right now by visiting [GroupDocs.Signature Live Demos](https://products.groupdocs.app/signature/family) website.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-metafiles"
          title: "What is METAFILES File Format"
          content: |
