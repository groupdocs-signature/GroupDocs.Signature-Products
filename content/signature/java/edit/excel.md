...
############################# Head ############################
head_title: "Java Code Example to View &amp; Edit Digital Signatures from EXCEL Files"
head_description: "Java code example to view and edit digital signatures from a EXCEL file using GroupDocs.Siganture API - add customized electronic signatures to popular business documents and image file formats."

############################# Header ############################
title: "Edit Digital Signatures in EXCEL via Java"
description: "Java library to view &amp; edit digital signatures in a EXCEL file using popular electronic signature types. Manage excel properties and customize signing options within documents and images."
...
steps:
    ...
    content_left: |
        The code example below clearly demonstrates the steps about **how to edit digital signatures in an already signed EXCEL file in Java** using [GroupDocs.Signature](/signature/java/) library by adding just a few lines of code.
    ...
    code: |
        ...
        try 
        {
            ...
            if (signatures.size() > 0)
            {
                ...
                boolean result = signature.update("sampleSigned-output.excel",imageSignature);
                if (result)
                {
...
demos:
    enable: true
    title: "Edit EXCEL Signature Live Demos"
    content: |
