...
############################# Head ############################
head_title: "Java Code Example to View &amp; Edit Digital Signatures from JPF Files"
head_description: "Java code example to view and edit digital signatures from a JPF file using GroupDocs.Siganture API - add customized electronic signatures to popular business documents and image file formats."

############################# Header ############################
title: "Edit Digital Signatures in JPF via Java"
description: "Java library to view &amp; edit digital signatures in a JPF file using popular electronic signature types. Manage jpf properties and customize signing options within documents and images."
...
steps:
    enable: true
    title_left: "How to Edit Digital Signatures in JPF"
    content_left: |
        The code example below clearly demonstrates the steps about **how to edit digital signatures in an already signed JPF file in Java** using [GroupDocs.Signature](https://products.groupdocs.com/signature/java) library by adding just a few lines of code.
    ...
    code: |
        ...
        try 
        {
            ...
            if (signatures.size() > 0)
            {
                ...
                boolean result = signature.update("sampleSigned-output.jpf",imageSignature);
                if (result)
                {
...
demos:
    enable: true
    title: "Edit JPF Signature Live Demos"
    content: |
        Add JPF file electronic signatures right now by visiting [GroupDocs.Signature Live Demos](https://products.groupdocs.app/signature/family) website.
