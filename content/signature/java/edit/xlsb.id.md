...
head_title: "Contoh Kode Java untuk Melihat &amp; Edit Tanda Tangan Digital dari XLSB File"
head_description: "Contoh kode Java untuk melihat dan mengedit tanda tangan digital dari file XLSB menggunakan GroupDocs.Siganture API - tambahkan tanda tangan elektronik khusus ke dokumen bisnis populer dan format file gambar."

title: "Edit Tanda Tangan Digital di XLSB melalui Java"
description: "Pustaka Java untuk melihat &amp; mengedit tanda tangan digital dalam file XLSB menggunakan jenis tanda tangan elektronik populer. Kelola properti XLSB dan sesuaikan opsi penandatanganan dalam dokumen dan gambar."
...
steps:
    enable: true
    title_left: "Cara Mengedit Tanda Tangan Digital di XLSB"
    content_left: |
        Contoh kode di bawah ini dengan jelas menunjukkan langkah-langkah tentang **cara mengedit tanda tangan digital dalam file XLSB yang sudah ditandatangani di Java** menggunakan pustaka [GroupDocs.Signature](/id/signature/java/) dengan menambahkan beberapa baris kode saja.
    ...
    code: |
        ...
        try 
        {
            ...
            if (signatures.size() > 0)
            {
                ...
                boolean result = signature.update("sampleSigned-output.xlsb",imageSignature);
                if (result)
                {
