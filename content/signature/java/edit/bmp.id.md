...
head_title: "Contoh Kode Java untuk Melihat &amp; Edit Tanda Tangan Digital dari BMP File"
head_description: "Contoh kode Java untuk melihat dan mengedit tanda tangan digital dari file BMP menggunakan GroupDocs.Siganture API - tambahkan tanda tangan elektronik khusus ke dokumen bisnis populer dan format file gambar."

title: "Edit Tanda Tangan Digital di BMP melalui Java"
description: "Pustaka Java untuk melihat &amp; mengedit tanda tangan digital dalam file BMP menggunakan jenis tanda tangan elektronik populer. Kelola properti BMP dan sesuaikan opsi penandatanganan dalam dokumen dan gambar."
...
steps:
    ...
    content_left: |
        Contoh kode di bawah ini dengan jelas menunjukkan langkah-langkah tentang **cara mengedit tanda tangan digital dalam file BMP yang sudah ditandatangani di Java** menggunakan pustaka [GroupDocs.Signature](/id/signature/java/) dengan menambahkan beberapa baris kode saja.
...
demos:
    enable: true
    title: "Edit BMP Signature Live Demo"
    content: |
