...
############################# Head ############################
head_title: "Adicione códigos de barras a arquivos XLSX com Java"
head_description: "Crie e insira assinaturas de código de barras em documentos XLSX em Java. GroupDocs.Signature permite uma integração versátil de assinaturas para múltiplos formatos."
...
steps:
    enable: true
    title: "Passos para gerar e adicionar um código de barras ao arquivo XLSX"
    content: |
      [GroupDocs.Signature](/signature/java/) pode gerar códigos de barras em vários formatos populares e colocá-los nas páginas de XLSX. Com suporte a mais de 60 tipos de códigos de barras, aplicações Java podem ser facilmente aprimoradas com capacidades de assinatura de códigos de barras incorporando nossa biblioteca.
      
      1. Forneça o arquivo ou fluxo XLSX a ser processado.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Como criar uma assinatura de código de barras"
      content: |
        Este exemplo demonstra como colocar um código de barras personalizado nas páginas do documento XLSX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
