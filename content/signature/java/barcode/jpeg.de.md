...
############################# Head ############################
head_title: "Fügen Sie Barcodes ganz einfach zu JPEG-Dateien mit Java hinzu"
head_description: "Erstellen und fügen Sie Barcode-Signaturen in JPEG-Dokumenten in Java ein. GroupDocs.Signature ermöglicht eine vielseitige Integration von Signaturen für mehrere Formate."

############################# Header ############################
title: "Barcode für JPEG generieren" 
...
steps:
    enable: true
    title: "Schritte zum Generieren und Hinzufügen eines Barcodes zu einer JPEG-Datei"
    content: |
      [GroupDocs.Signature](/signature/java/) kann Barcodes in verschiedenen gängigen Formaten generieren und sie auf JPEG-Seiten platzieren. Mit Unterstützung für über 60 Barcode-Typen können Java-Anwendungen schnell mit Funktionen zum Signieren von Barcodes erweitert werden, indem wir unsere Bibliothek integrieren.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "So erstellen Sie eine Barcode-Signatur"
      content: |
        Dieses Beispiel zeigt, wie Sie einen benutzerdefinierten Barcode auf JPEG-Dokumentseiten platzieren.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
