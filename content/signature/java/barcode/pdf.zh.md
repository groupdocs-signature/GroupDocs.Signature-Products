...
############################# Head ############################
head_title: "使用 Java 轻松将条形码添加到 PDF 文件"
head_description: "在 Java 中创建并插入条形码签名到 PDF 文档中。GroupDocs.Signature 使多种格式的签名集成更加灵活。"
...
steps:
    enable: true
    title: "将条形码生成并添加到 PDF 文件的步骤"
    content: |
      [GroupDocs.Signature](/signature/java/) 可以生成多种流行格式的条形码并将其放置在 PDF 页面上。支持超过 60 种条形码类型，Java 应用程序可以通过集成我们的库轻松实现条形码签名功能。
