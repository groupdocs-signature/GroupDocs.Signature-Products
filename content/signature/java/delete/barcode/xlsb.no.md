...
############################# Head ############################
head_title: "Slett Barcode-signaturer fra Xlsb-filer via Java"
head_description: "Sletting av spesifikke Barcode-signaturer fra signerte Xlsb-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer som er plassert i Xlsb-filer"
description: "Slett forskjellige Barcode-signaturer fra Xlsb-dokumenter. Fjerning av Barcode-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Barcode-signaturer fra Xlsb-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Xlsb dokumenter for Barcode signaturer med noen få linjer med kode.
