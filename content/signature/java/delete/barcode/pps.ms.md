...
############################# Head ############################
head_title: "Padamkan tandatangan Barcode daripada fail Pps melalui Java"
head_description: "Pemadaman tandatangan Barcode tertentu daripada dokumen Pps yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Barcode yang diletakkan dalam fail Pps."
description: "Padamkan pelbagai tandatangan Barcode daripada dokumen Pps. Mengalih keluar tandatangan Barcode memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Barcode daripada dokumen Pps anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Pps dokumen daripada Barcode tandatangan dengan beberapa baris kod.
