...
############################# Head ############################
head_title: "Padamkan tandatangan Barcode daripada fail Pptx melalui Java"
head_description: "Pemadaman tandatangan Barcode tertentu daripada dokumen Pptx yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Barcode yang diletakkan dalam fail Pptx."
description: "Padamkan pelbagai tandatangan Barcode daripada dokumen Pptx. Mengalih keluar tandatangan Barcode memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Barcode daripada dokumen Pptx anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Pptx dokumen daripada Barcode tandatangan dengan beberapa baris kod.
