...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Doc via Java"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Doc assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Doc"
description: "Exclua várias assinaturas Barcode de documentos Doc. A remoção de assinaturas Barcode requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Barcode do seu documento Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Doc de assinaturas Barcode com algumas linhas de código.
