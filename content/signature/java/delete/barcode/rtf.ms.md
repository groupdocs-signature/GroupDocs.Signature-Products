...
############################# Head ############################
head_title: "Padamkan tandatangan Barcode daripada fail Rtf melalui Java"
head_description: "Pemadaman tandatangan Barcode tertentu daripada dokumen Rtf yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Barcode yang diletakkan dalam fail Rtf."
description: "Padamkan pelbagai tandatangan Barcode daripada dokumen Rtf. Mengalih keluar tandatangan Barcode memerlukan kod Java yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Rtf dokumen daripada Barcode tandatangan dengan beberapa baris kod.
