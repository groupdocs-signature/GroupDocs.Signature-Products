...
############################# Head ############################
head_title: "Slett Barcode-signaturer fra Ppsm-filer via Java"
head_description: "Sletting av spesifikke Barcode-signaturer fra signerte Ppsm-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer som er plassert i Ppsm-filer"
description: "Slett forskjellige Barcode-signaturer fra Ppsm-dokumenter. Fjerning av Barcode-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Barcode-signaturer fra Ppsm-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Ppsm dokumenter for Barcode signaturer med noen få linjer med kode.
...
more_formats:
    enable: true
    title: "Slett Barcode-signaturene dine med Java"
    content: |
