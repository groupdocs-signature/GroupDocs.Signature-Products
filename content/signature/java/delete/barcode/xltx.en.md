...
############################# Head ############################
head_title: "Delete Barcode signatures from Xltx files via Java"
head_description: "Deletion of specific Barcode signatures from signed Xltx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Barcode signatures which are placed in Xltx files"
description: "Delete various Barcode signatures from Xltx documents. Removing Barcode signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Xltx documents of Barcode signatures with a few lines of code.
