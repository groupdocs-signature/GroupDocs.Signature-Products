...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Potm via Java"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Potm assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Potm"
description: "Exclua várias assinaturas Barcode de documentos Potm. A remoção de assinaturas Barcode requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Potm de assinaturas Barcode com algumas linhas de código.
