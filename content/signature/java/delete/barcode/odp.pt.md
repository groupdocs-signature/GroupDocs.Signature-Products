...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Odp via Java"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Odp assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Odp"
description: "Exclua várias assinaturas Barcode de documentos Odp. A remoção de assinaturas Barcode requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Odp de assinaturas Barcode com algumas linhas de código.
