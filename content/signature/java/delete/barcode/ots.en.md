...
############################# Head ############################
head_title: "Delete Barcode signatures from Ots files via Java"
head_description: "Deletion of specific Barcode signatures from signed Ots documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Barcode signatures which are placed in Ots files"
description: "Delete various Barcode signatures from Ots documents. Removing Barcode signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Ots documents of Barcode signatures with a few lines of code.
