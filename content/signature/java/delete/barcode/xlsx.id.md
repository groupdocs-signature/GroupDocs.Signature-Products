...
############################# Head ############################
head_title: "Hapus tanda tangan Barcode dari file Xlsx melalui Java"
head_description: "Penghapusan tanda tangan Barcode tertentu dari dokumen Xlsx yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Barcode yang ditempatkan di file Xlsx"
description: "Hapus berbagai tanda tangan Barcode dari dokumen Xlsx. Menghapus tanda tangan Barcode memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Barcode dari dokumen Xlsx Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Xlsx dari Barcode tanda tangan dengan beberapa baris kode.
...
more_formats:
    enable: true
    title: "Hapus tanda tangan Barcode Anda dengan Java"
    content: |
