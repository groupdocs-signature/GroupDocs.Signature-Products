...
############################# Head ############################
head_title: "Eliminar Barcode firmas de Xltm archivos a través de Java"
head_description: "La eliminación de firmas Barcode específicas de documentos Xltm firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Barcode firmas que se colocan en archivos Xltm"
description: "Elimine varias firmas Barcode de los documentos Xltm. Eliminar las firmas Barcode requiere un código Java simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Xltm de Barcode firmas con unas pocas líneas de código.
