...
############################# Head ############################
head_title: "Törölje a Barcode aláírásokat a Ppt fájlokból a Java segítségével"
head_description: "Az aláírt Ppt dokumentumokból bizonyos Barcode aláírások törlése egyszerűen végrehajtható rövid Java kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Ppt dokumentumok Barcode aláírásainak néhány soros kóddal történő törléséhez.
