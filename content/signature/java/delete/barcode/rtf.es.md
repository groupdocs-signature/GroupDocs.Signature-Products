...
############################# Head ############################
head_title: "Eliminar Barcode firmas de Rtf archivos a través de Java"
head_description: "La eliminación de firmas Barcode específicas de documentos Rtf firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Barcode firmas que se colocan en archivos Rtf"
description: "Elimine varias firmas Barcode de los documentos Rtf. Eliminar las firmas Barcode requiere un código Java simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Barcode de su documento Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Rtf de Barcode firmas con unas pocas líneas de código.
