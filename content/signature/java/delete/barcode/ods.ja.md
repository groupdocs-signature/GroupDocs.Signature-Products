...
############################# Head ############################
head_title: "Java を介して Ods ファイルから Barcode 署名を削除します"
head_description: "署名済みの Ods ドキュメントから特定の Barcode 署名を削除するには、短い Java コードを使用すると簡単に実行できます。"

############################# Header ############################
title: "Ods ファイルに配置されている Barcode 署名を削除します"
description: "Ods ドキュメントからさまざまな Barcode 署名を削除します。 Barcode 署名を削除するには、単純な Java コードが必要です。"
...
steps:
    enable: true
    title_left: "Ods ドキュメントから Barcode 署名を削除する方法"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) は、数行のコードで Barcode 署名の Ods ドキュメントをクリアするための便利な機能を提供します。
