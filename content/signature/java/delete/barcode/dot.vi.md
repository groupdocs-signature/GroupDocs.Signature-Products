...
############################# Head ############################
head_title: "Xóa chữ ký Barcode khỏi tệp Dot qua Java"
head_description: "Việc xóa các chữ ký Barcode cụ thể khỏi các tài liệu Dot đã ký có thể được thực hiện dễ dàng với mã Java ngắn."

############################# Header ############################
title: "Xóa các chữ ký Barcode được đặt trong các tệp Dot"
description: "Xóa các chữ ký Barcode khác nhau khỏi tài liệu Dot. Việc xóa chữ ký Barcode yêu cầu mã Java đơn giản."
...
steps:
    enable: true
    title_left: "Cách xóa chữ ký Barcode khỏi tài liệu Dot của bạn"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp tính năng hữu ích để xóa các tài liệu Dot có chữ ký Barcode bằng một vài dòng mã.
