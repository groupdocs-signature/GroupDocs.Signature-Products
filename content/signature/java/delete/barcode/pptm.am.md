...
############################# Header ############################
title: "በPptm ፋይሎች ውስጥ የተቀመጡትን የBarcode ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የBarcode ፊርማዎችን ከPptm ሰነዶች ሰርዝ። የBarcode ፊርማዎችን ማስወገድ ቀላል የJava ኮድ ያስፈልገዋል።"
...
steps:
    enable: true
    title_left: "Barcode ፊርማዎችን ከPptm ሰነድዎ እንዴት ማስወገድ እንደሚቻል"
    content_left: |
