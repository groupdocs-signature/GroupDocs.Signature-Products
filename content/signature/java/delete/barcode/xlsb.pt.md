...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Xlsb via Java"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Xlsb assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Xlsb"
description: "Exclua várias assinaturas Barcode de documentos Xlsb. A remoção de assinaturas Barcode requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Xlsb de assinaturas Barcode com algumas linhas de código.
