...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Xlsm via Java"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Xlsm assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Xlsm"
description: "Exclua várias assinaturas Barcode de documentos Xlsm. A remoção de assinaturas Barcode requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Barcode do seu documento Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Xlsm de assinaturas Barcode com algumas linhas de código.
...
more_formats:
    enable: true
    title: "Exclua suas assinaturas Barcode com Java"
    content: |
