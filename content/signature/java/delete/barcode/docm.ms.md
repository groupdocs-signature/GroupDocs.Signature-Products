...
############################# Head ############################
head_title: "Padamkan tandatangan Barcode daripada fail Docm melalui Java"
head_description: "Pemadaman tandatangan Barcode tertentu daripada dokumen Docm yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Barcode yang diletakkan dalam fail Docm."
description: "Padamkan pelbagai tandatangan Barcode daripada dokumen Docm. Mengalih keluar tandatangan Barcode memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Barcode daripada dokumen Docm anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Docm dokumen daripada Barcode tandatangan dengan beberapa baris kod.
