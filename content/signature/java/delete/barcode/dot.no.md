...
############################# Head ############################
head_title: "Slett Barcode-signaturer fra Dot-filer via Java"
head_description: "Sletting av spesifikke Barcode-signaturer fra signerte Dot-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer som er plassert i Dot-filer"
description: "Slett forskjellige Barcode-signaturer fra Dot-dokumenter. Fjerning av Barcode-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Dot dokumenter for Barcode signaturer med noen få linjer med kode.
