...
############################# Head ############################
head_title: "Slet Barcode signaturer fra Dot filer via Java"
head_description: "Sletning af specifikke Barcode-signaturer fra signerede Dot-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer, der er placeret i Dot-filer"
description: "Slet forskellige Barcode-signaturer fra Dot-dokumenter. Fjernelse af Barcode signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Barcode-signaturer fra dit Dot-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Dot dokumenter for Barcode signaturer med et par linjer kode.
