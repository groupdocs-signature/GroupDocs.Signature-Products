...
############################# Head ############################
head_title: "Delete Barcode signatures from Xlsx files via Java"
head_description: "Deletion of specific Barcode signatures from signed Xlsx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Barcode signatures which are placed in Xlsx files"
description: "Delete various Barcode signatures from Xlsx documents. Removing Barcode signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Barcode signatures from your Xlsx document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Xlsx documents of Barcode signatures with a few lines of code.
