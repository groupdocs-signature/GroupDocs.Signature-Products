...
############################# Head ############################
head_title: "Slett Barcode-signaturer fra Rtf-filer via Java"
head_description: "Sletting av spesifikke Barcode-signaturer fra signerte Rtf-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer som er plassert i Rtf-filer"
description: "Slett forskjellige Barcode-signaturer fra Rtf-dokumenter. Fjerning av Barcode-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Barcode-signaturer fra Rtf-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Rtf dokumenter for Barcode signaturer med noen få linjer med kode.
