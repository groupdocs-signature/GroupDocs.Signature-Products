...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Rtf via Java"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Rtf assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Rtf"
description: "Exclua várias assinaturas Barcode de documentos Rtf. A remoção de assinaturas Barcode requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Barcode do seu documento Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Rtf de assinaturas Barcode com algumas linhas de código.
