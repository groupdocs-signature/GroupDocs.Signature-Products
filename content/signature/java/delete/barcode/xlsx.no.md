...
############################# Head ############################
head_title: "Slett Barcode-signaturer fra Xlsx-filer via Java"
head_description: "Sletting av spesifikke Barcode-signaturer fra signerte Xlsx-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer som er plassert i Xlsx-filer"
description: "Slett forskjellige Barcode-signaturer fra Xlsx-dokumenter. Fjerning av Barcode-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Xlsx dokumenter for Barcode signaturer med noen få linjer med kode.
