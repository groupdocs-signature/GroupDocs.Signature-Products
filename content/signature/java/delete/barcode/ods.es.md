...
############################# Head ############################
head_title: "Eliminar Barcode firmas de Ods archivos a través de Java"
head_description: "La eliminación de firmas Barcode específicas de documentos Ods firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Barcode firmas que se colocan en archivos Ods"
description: "Elimine varias firmas Barcode de los documentos Ods. Eliminar las firmas Barcode requiere un código Java simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Barcode de su documento Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Ods de Barcode firmas con unas pocas líneas de código.
