...
############################# Head ############################
head_title: "Slet Barcode signaturer fra Rtf filer via Java"
head_description: "Sletning af specifikke Barcode-signaturer fra signerede Rtf-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer, der er placeret i Rtf-filer"
description: "Slet forskellige Barcode-signaturer fra Rtf-dokumenter. Fjernelse af Barcode signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Barcode-signaturer fra dit Rtf-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Rtf dokumenter for Barcode signaturer med et par linjer kode.
