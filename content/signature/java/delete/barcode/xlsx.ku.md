...
############################# Head ############################
head_title: "Bi rêya Java îmzeyên Barcode ji pelên Xlsx jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Barcode ji belgeyên îmzekirî yên Xlsx dibe ku bi koda kurt a Java bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Barcode yên ku di pelên Xlsx de cih digirin rakin"
description: "Ji belgeyên Xlsx îmzeyên cihêreng ên Barcode jêbirin. Ji rakirina îmzeyên Barcode koda Java ya sade hewce dike."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji bo paqijkirina Xlsx belgeyên Barcode bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
