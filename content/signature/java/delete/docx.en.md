...
head_description: "Removing of Digital, Barcode, Text, Image, Metadata signatures from signed DOCX documents can be performed easily using GroupDocs.Signature for Java."

############################# Header ############################
title: "Delete signatures from DOCX" 
