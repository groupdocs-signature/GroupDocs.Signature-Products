...
############################# Head ############################
head_title: "Delete signatures from DOCX using Java"
head_description: "Deletion of Digital, Barcode, Text, Image, Metadata signatures from signed DOCX documents can be performed easily using GroupDocs.Signature for Java."

############################# Header ############################
title: "Remove signatures from DOCX" 
...
steps:
    enable: true
    title: "Steps for deleting e-signatures from DOCX using Java"
    content: |
      [GroupDocs.Signature](/signature/java/) makes it easy for Java developers to delete e-signatures in DOCX files using their applications by following a few simple steps.
