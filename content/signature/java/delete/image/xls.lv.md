...
############################# Head ############################
head_title: "Dzēst Image parakstus no Xls failiem, izmantojot Java"
head_description: "Konkrētu Image parakstu dzēšanu no parakstītiem Xls dokumentiem var viegli veikt, izmantojot īsu Java kodu."

############################# Header ############################
title: "Noņemiet Image parakstus, kas ir ievietoti Xls failos"
description: "Izdzēsiet dažādus Image parakstus no Xls dokumentiem. Lai noņemtu Image parakstus, ir nepieciešams vienkāršs Java kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina noderīgu līdzekli, lai no Xls dokumentiem notīrītu Image parakstus, izmantojot dažas koda rindiņas.
