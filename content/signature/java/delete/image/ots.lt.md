...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Ots failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Ots dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Ots failuose"
description: "Ištrinkite įvairius Image parašus iš Ots dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ots dokumentus nuo Image parašų naudojant kelias kodo eilutes.
