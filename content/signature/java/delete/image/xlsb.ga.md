...
############################# Head ############################
head_title: "Scrios Image sínithe ó chomhaid Xlsb trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Image ar leith ó dhoiciméid shínithe Xlsb le cód gearr Java."

############################# Header ############################
title: "Bain Image sínithe a chuirtear i gcomhaid Xlsb"
description: "Scrios Image sínithe éagsúla ó Xlsb doiciméid. Teastaíonn cód simplí Java chun sínithe Image a bhaint."
...
steps:
    enable: true
    title_left: "Conas Image sínithe a bhaint de do dhoiciméad Xlsb"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Xlsb doiciméad de Image sínithe a ghlanadh le cúpla líne de chód.
