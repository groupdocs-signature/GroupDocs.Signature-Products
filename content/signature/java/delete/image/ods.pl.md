...
############################# Head ############################
head_title: "Usuń podpisy Image z plików Ods przez Java"
head_description: "Usuwanie określonych podpisów Image z podpisanych dokumentów Ods można łatwo wykonać za pomocą krótkiego kodu Java."

############################# Header ############################
title: "Usuń Image podpisy umieszczone w plikach Ods"
description: "Usuń różne podpisy Image z dokumentów Ods. Usunięcie podpisów Image wymaga prostego kodu Java."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Image z dokumentu Ods?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zapewnia użyteczną funkcję do czyszczenia dokumentów Ods z podpisami Image za pomocą kilku linijek kodu.
