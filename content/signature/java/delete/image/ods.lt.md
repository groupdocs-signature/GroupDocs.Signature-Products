...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Ods failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Ods dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Ods failuose"
description: "Ištrinkite įvairius Image parašus iš Ods dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Ods dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ods dokumentus nuo Image parašų naudojant kelias kodo eilutes.
