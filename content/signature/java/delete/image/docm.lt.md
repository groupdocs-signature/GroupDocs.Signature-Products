...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Docm failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Docm dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Docm failuose"
description: "Ištrinkite įvairius Image parašus iš Docm dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Docm dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Docm dokumentus nuo Image parašų naudojant kelias kodo eilutes.
