...
############################# Head ############################
head_title: "Delete Image signatures from Pdf files in Java"
head_description: "Deletion of specific Image signatures from signed Pdf documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Image signatures which are in Pdf files"
description: "Delete various Image signatures from Pdf documents. Removing Image signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature of clearing Pdf documents of Image signatures with a few lines of code.
