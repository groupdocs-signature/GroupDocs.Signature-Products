...
############################# Head ############################
head_title: "احذف توقيعات Image من ملفات Odt عبر Java"
head_description: "يمكن إجراء حذف توقيعات معينة من Image من مستندات Odt الموقعة بسهولة باستخدام رمز Java القصير."

############################# Header ############################
title: "قم بإزالة Image التوقيعات التي يتم وضعها في ملفات Odt"
description: "احذف العديد من توقيعات Image من مستندات Odt. تتطلب إزالة توقيعات Image شفرة Java بسيطة."
...
steps:
    enable: true
    title_left: "كيفية إزالة توقيعات Image من مستندك Odt"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) ميزة مفيدة لمسح Odt مستندات توقيعات Image ببضعة أسطر من التعليمات البرمجية.
