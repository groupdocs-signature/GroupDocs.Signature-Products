...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Potm failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Potm dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Potm failuose"
description: "Ištrinkite įvairius Image parašus iš Potm dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Potm dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Potm dokumentus nuo Image parašų naudojant kelias kodo eilutes.
