...
############################# Head ############################
head_title: "Suprimeix les signatures de Image dels fitxers Xlsx mitjançant Java"
head_description: "L'eliminació de signatures específiques de Image dels documents signats Xlsx es pot dur a terme fàcilment amb un codi Java curt."

############################# Header ############################
title: "Elimineu les signatures de Image que es col·loquen als fitxers Xlsx"
description: "Suprimeix diverses signatures de Image dels documents Xlsx. L'eliminació de signatures Image requereix un codi Java senzill."
...
steps:
    enable: true
    title_left: "Com eliminar les signatures de Image del vostre document Xlsx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix una funció útil per esborrar documents de Xlsx de signatures de Image amb unes poques línies de codi.
