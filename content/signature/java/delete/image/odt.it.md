...
############################# Head ############################
head_title: "Elimina le firme Image dai file Odt tramite Java"
head_description: "L'eliminazione di firme Image specifiche da documenti Odt firmati può essere eseguita facilmente con il codice Java breve."

############################# Header ############################
title: "Rimuovi le firme Image che sono inserite nei file Odt"
description: "Elimina varie firme Image da documenti Odt. La rimozione delle firme Image richiede un semplice codice Java."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Image dal tuo documento Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornisce una funzione utile per cancellare documenti Odt di firme Image con poche righe di codice.
