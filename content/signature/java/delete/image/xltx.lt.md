...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Xltx failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Xltx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Xltx failuose"
description: "Ištrinkite įvairius Image parašus iš Xltx dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Xltx dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Xltx dokumentus nuo Image parašų naudojant kelias kodo eilutes.
