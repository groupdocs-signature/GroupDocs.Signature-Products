...
############################# Head ############################
head_title: "Ջնջել Image ստորագրությունները Xls ֆայլերից Java-ի միջոցով"
head_description: "Ստորագրված Xls փաստաթղթերից որոշակի Image ստորագրությունների ջնջումը կարող է հեշտությամբ իրականացվել կարճ Java կոդով:"

############################# Header ############################
title: "Հեռացրեք Image ստորագրությունները, որոնք տեղադրված են Xls ֆայլերում"
description: "Ջնջել տարբեր Image ստորագրությունները Xls փաստաթղթերից: Image ստորագրությունները հեռացնելու համար անհրաժեշտ է պարզ Java կոդ:"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) օգտակար հատկություն է տրամադրում Xls փաստաթղթերը Image ստորագրություններից մի քանի տող կոդով մաքրելու համար:
