...
############################# Head ############################
head_title: "Xóa chữ ký Image khỏi tệp Doc qua Java"
head_description: "Việc xóa các chữ ký Image cụ thể khỏi các tài liệu Doc đã ký có thể được thực hiện dễ dàng với mã Java ngắn."

############################# Header ############################
title: "Xóa các chữ ký Image được đặt trong các tệp Doc"
description: "Xóa các chữ ký Image khác nhau khỏi tài liệu Doc. Việc xóa chữ ký Image yêu cầu mã Java đơn giản."
...
steps:
    enable: true
    title_left: "Cách xóa chữ ký Image khỏi tài liệu Doc của bạn"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp tính năng hữu ích để xóa các tài liệu Doc có chữ ký Image bằng một vài dòng mã.
