...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Xls via Java"
head_description: "A exclusão de assinaturas Image específicas de documentos Xls assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Xls"
description: "Exclua várias assinaturas Image de documentos Xls. A remoção de assinaturas Image requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Xls de assinaturas Image com algumas linhas de código.
