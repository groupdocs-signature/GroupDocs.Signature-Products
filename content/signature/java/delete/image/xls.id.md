...
############################# Head ############################
head_title: "Hapus tanda tangan Image dari file Xls melalui Java"
head_description: "Penghapusan tanda tangan Image tertentu dari dokumen Xls yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Image yang ditempatkan di file Xls"
description: "Hapus berbagai tanda tangan Image dari dokumen Xls. Menghapus tanda tangan Image memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Image dari dokumen Xls Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Xls dari Image tanda tangan dengan beberapa baris kode.
