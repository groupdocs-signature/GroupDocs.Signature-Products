...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Potx via Java"
head_description: "A exclusão de assinaturas Image específicas de documentos Potx assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Potx"
description: "Exclua várias assinaturas Image de documentos Potx. A remoção de assinaturas Image requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Image do seu documento Potx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Potx de assinaturas Image com algumas linhas de código.
