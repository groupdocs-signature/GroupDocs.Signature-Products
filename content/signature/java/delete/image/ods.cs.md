...
############################# Head ############################
head_title: "Odstraňte podpisy Image ze souborů Ods prostřednictvím Java"
head_description: "Odstranění konkrétních podpisů Image z podepsaných dokumentů Ods lze snadno provést pomocí krátkého kódu Java."

############################# Header ############################
title: "Odstraňte Image podpisy, které jsou umístěny v souborech Ods"
description: "Odstraňte různé podpisy Image z dokumentů Ods. Odstranění podpisů Image vyžaduje jednoduchý kód Java."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Image z vašeho dokumentu Ods"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje užitečnou funkci pro vymazání Ods dokumentů od Image podpisů pomocí několika řádků kódu.
