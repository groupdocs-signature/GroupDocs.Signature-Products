...
############################# Head ############################
head_title: "Bi rêya Java îmzeyên Image ji pelên Odp jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Image ji belgeyên îmzekirî yên Odp dibe ku bi koda kurt a Java bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Image yên ku di pelên Odp de cih digirin rakin"
description: "Ji belgeyên Odp îmzeyên cihêreng ên Image jêbirin. Ji rakirina îmzeyên Image koda Java ya sade hewce dike."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji bo paqijkirina Odp belgeyên Image bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
