...
############################# Head ############################
head_title: "Kustutage Image allkirjad failist Ott läbi Java"
head_description: "Konkreetsete Image allkirjade kustutamine allkirjastatud Ott dokumentidest saab hõlpsasti teostada lühikese Java koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Image, mis on paigutatud failidesse Ott"
description: "Kustutage erinevad allkirjad Image dokumentidest Ott. Allkirjade Image eemaldamine nõuab lihtsat Java koodi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pakub kasulikku funktsiooni Ott dokumentide Image allkirjade eemaldamiseks mõne koodireaga.
