...
############################# Head ############################
head_title: "Delete Image signatures from Xltx files via Java"
head_description: "Deletion of specific Image signatures from signed Xltx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Image signatures which are placed in Xltx files"
description: "Delete various Image signatures from Xltx documents. Removing Image signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Xltx documents of Image signatures with a few lines of code.
