...
############################# Head ############################
head_title: "Slett Image-signaturer fra Xltm-filer via Java"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Xltm-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Xltm-filer"
description: "Slett forskjellige Image-signaturer fra Xltm-dokumenter. Fjerning av Image-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Xltm dokumenter for Image signaturer med noen få linjer med kode.
