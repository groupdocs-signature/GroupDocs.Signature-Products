...
############################# Head ############################
head_title: "Eliminar Image firmas de Pptm archivos a través de Java"
head_description: "La eliminación de firmas Image específicas de documentos Pptm firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Image firmas que se colocan en archivos Pptm"
description: "Elimine varias firmas Image de los documentos Pptm. Eliminar las firmas Image requiere un código Java simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Pptm de Image firmas con unas pocas líneas de código.
