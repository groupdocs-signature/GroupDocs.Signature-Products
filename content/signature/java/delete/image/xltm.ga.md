...
############################# Head ############################
head_title: "Scrios Image sínithe ó chomhaid Xltm trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Image ar leith ó dhoiciméid shínithe Xltm le cód gearr Java."

############################# Header ############################
title: "Bain Image sínithe a chuirtear i gcomhaid Xltm"
description: "Scrios Image sínithe éagsúla ó Xltm doiciméid. Teastaíonn cód simplí Java chun sínithe Image a bhaint."
...
steps:
    enable: true
    title_left: "Conas Image sínithe a bhaint de do dhoiciméad Xltm"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Xltm doiciméad de Image sínithe a ghlanadh le cúpla líne de chód.
