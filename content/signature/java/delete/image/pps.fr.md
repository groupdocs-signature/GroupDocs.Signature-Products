...
############################# Head ############################
head_title: "Supprimez les signatures Image des fichiers Pps via Java"
head_description: "La suppression de signatures Image spécifiques à partir de documents Pps signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Image qui sont placées dans les fichiers Pps"
description: "Supprimez diverses signatures Image des documents Pps. La suppression des signatures Image nécessite un code Java simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Pps des signatures Image avec quelques lignes de code.
