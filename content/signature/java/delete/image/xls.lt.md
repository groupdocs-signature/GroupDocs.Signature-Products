...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Xls failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Xls dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Xls failuose"
description: "Ištrinkite įvairius Image parašus iš Xls dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Xls dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Xls dokumentus nuo Image parašų naudojant kelias kodo eilutes.
