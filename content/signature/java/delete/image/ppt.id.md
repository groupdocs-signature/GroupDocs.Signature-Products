...
############################# Head ############################
head_title: "Hapus tanda tangan Image dari file Ppt melalui Java"
head_description: "Penghapusan tanda tangan Image tertentu dari dokumen Ppt yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Image yang ditempatkan di file Ppt"
description: "Hapus berbagai tanda tangan Image dari dokumen Ppt. Menghapus tanda tangan Image memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Image dari dokumen Ppt Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Ppt dari Image tanda tangan dengan beberapa baris kode.
