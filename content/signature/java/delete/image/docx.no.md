...
############################# Head ############################
head_title: "Slett Image-signaturer fra Docx-filer via Java"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Docx-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Docx-filer"
description: "Slett forskjellige Image-signaturer fra Docx-dokumenter. Fjerning av Image-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Docx dokumenter for Image signaturer med noen få linjer med kode.
