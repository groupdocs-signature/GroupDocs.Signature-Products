...
############################# Head ############################
head_title: "Slet Image signaturer fra Xlsb filer via Java"
head_description: "Sletning af specifikke Image-signaturer fra signerede Xlsb-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Image-signaturer, der er placeret i Xlsb-filer"
description: "Slet forskellige Image-signaturer fra Xlsb-dokumenter. Fjernelse af Image signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Image-signaturer fra dit Xlsb-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Xlsb dokumenter for Image signaturer med et par linjer kode.
