...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Otp failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Otp dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Otp failuose"
description: "Ištrinkite įvairius Image parašus iš Otp dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Otp dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Otp dokumentus nuo Image parašų naudojant kelias kodo eilutes.
