...
############################# Head ############################
head_title: "Удалите подписи Image из Doc файлов с помощью Java"
head_description: "Удаление определенных подписей Image из подписанных документов Doc можно легко выполнить с помощью короткого кода Java."

############################# Header ############################
title: "Удалить подписи Image, размещенные в файлах Doc"
description: "Удалите различные подписи Image из Doc документов. Для удаления подписей Image требуется простой код Java."
...
steps:
    enable: true
    title_left: "Как удалить подписи Image из документа Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставляет полезную функцию для очистки документов Doc от подписей Image с помощью нескольких строк кода.
