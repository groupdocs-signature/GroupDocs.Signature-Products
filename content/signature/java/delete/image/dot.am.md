...
############################# Head ############################
head_title: "የImage ፊርማዎችን ከDot ፋይሎች በJava በኩል ሰርዝ"
head_description: "ከተፈረሙ Dot ሰነዶች የተወሰኑ የImage ፊርማዎችን መሰረዝ በአጭር የJava ኮድ በቀላሉ ሊከናወን ይችላል።"

############################# Header ############################
title: "በDot ፋይሎች ውስጥ የተቀመጡትን የImage ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የImage ፊርማዎችን ከDot ሰነዶች ሰርዝ። የImage ፊርማዎችን ማስወገድ ቀላል የJava ኮድ ያስፈልገዋል።"
...
steps:
    enable: true
    title_left: "Image ፊርማዎችን ከDot ሰነድዎ እንዴት ማስወገድ እንደሚቻል"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የDot ሰነዶችን የImage ፊርማዎችን በጥቂት የኮድ መስመሮች ለማጽዳት ጠቃሚ ባህሪን ይሰጣል።
