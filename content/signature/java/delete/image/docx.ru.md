...
############################# Head ############################
head_title: "Удалите подписи Image из Docx файлов с помощью Java"
head_description: "Удаление определенных подписей Image из подписанных документов Docx можно легко выполнить с помощью короткого кода Java."

############################# Header ############################
title: "Удалить подписи Image, размещенные в файлах Docx"
description: "Удалите различные подписи Image из Docx документов. Для удаления подписей Image требуется простой код Java."
...
steps:
    enable: true
    title_left: "Как удалить подписи Image из документа Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставляет полезную функцию для очистки документов Docx от подписей Image с помощью нескольких строк кода.
