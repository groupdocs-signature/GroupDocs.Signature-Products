...
############################# Head ############################
head_title: "የImage ፊርማዎችን ከXltm ፋይሎች በJava በኩል ሰርዝ"
head_description: "ከተፈረሙ Xltm ሰነዶች የተወሰኑ የImage ፊርማዎችን መሰረዝ በአጭር የJava ኮድ በቀላሉ ሊከናወን ይችላል።"

############################# Header ############################
title: "በXltm ፋይሎች ውስጥ የተቀመጡትን የImage ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የImage ፊርማዎችን ከXltm ሰነዶች ሰርዝ። የImage ፊርማዎችን ማስወገድ ቀላል የJava ኮድ ያስፈልገዋል።"
...
steps:
    enable: true
    title_left: "Image ፊርማዎችን ከXltm ሰነድዎ እንዴት ማስወገድ እንደሚቻል"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የXltm ሰነዶችን የImage ፊርማዎችን በጥቂት የኮድ መስመሮች ለማጽዳት ጠቃሚ ባህሪን ይሰጣል።
