...
############################# Head ############################
head_title: "Slett Image-signaturer fra Ods-filer via Java"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Ods-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Ods-filer"
description: "Slett forskjellige Image-signaturer fra Ods-dokumenter. Fjerning av Image-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Image-signaturer fra Ods-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Ods dokumenter for Image signaturer med noen få linjer med kode.
