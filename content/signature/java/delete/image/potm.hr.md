...
############################# Head ############################
head_title: "Izbriši Image potpise iz Potm datoteka putem Java"
head_description: "Brisanje specifičnih Image potpisa iz potpisanih Potm dokumenata može se lako izvesti s kratkim Java kodom."

############################# Header ############################
title: "Uklonite potpise Image koji se nalaze u datotekama Potm"
description: "Izbrišite razne Image potpise iz Potm dokumenata. Uklanjanje Image potpisa zahtijeva jednostavan Java kod."
...
steps:
    enable: true
    title_left: "Kako ukloniti Image potpise iz vašeg Potm dokumenta"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža korisnu značajku za brisanje Potm dokumenata od Image potpisa s nekoliko redaka koda.
