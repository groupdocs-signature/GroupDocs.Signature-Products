...
############################# Head ############################
head_title: "احذف توقيعات Image من ملفات Xlsb عبر Java"
head_description: "يمكن إجراء حذف توقيعات معينة من Image من مستندات Xlsb الموقعة بسهولة باستخدام رمز Java القصير."

############################# Header ############################
title: "قم بإزالة Image التوقيعات التي يتم وضعها في ملفات Xlsb"
description: "احذف العديد من توقيعات Image من مستندات Xlsb. تتطلب إزالة توقيعات Image شفرة Java بسيطة."
...
steps:
    enable: true
    title_left: "كيفية إزالة توقيعات Image من مستندك Xlsb"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) ميزة مفيدة لمسح Xlsb مستندات توقيعات Image ببضعة أسطر من التعليمات البرمجية.
