...
############################# Head ############################
head_title: "Vee Image handtekeninge van Dotm lêers uit via Java"
head_description: "Die uitvee van spesifieke Image handtekeninge van getekende Dotm dokumente kan maklik uitgevoer word met kort Java kode."

############################# Header ############################
title: "Verwyder Image handtekeninge wat in Dotm lêers geplaas is"
description: "Vee verskeie Image handtekeninge uit Dotm dokumente uit. Die verwydering van Image handtekeninge vereis eenvoudige Java kode."
...
steps:
    enable: true
    title_left: "Hoe om Image-handtekeninge uit jou Dotm-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied nuttige kenmerk vir die skoonmaak van Dotm dokumente van Image handtekeninge met 'n paar reëls kode.
