...
############################# Head ############################
head_title: "Bi rêya Java îmzeyên Image ji pelên Ppsx jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Image ji belgeyên îmzekirî yên Ppsx dibe ku bi koda kurt a Java bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Image yên ku di pelên Ppsx de cih digirin rakin"
description: "Ji belgeyên Ppsx îmzeyên cihêreng ên Image jêbirin. Ji rakirina îmzeyên Image koda Java ya sade hewce dike."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzayên Image ji belgeya xweya Ppsx rabike"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji bo paqijkirina Ppsx belgeyên Image bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
