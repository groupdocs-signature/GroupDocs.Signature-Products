...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Doc failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Doc dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Doc failuose"
description: "Ištrinkite įvairius Image parašus iš Doc dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Doc dokumentus nuo Image parašų naudojant kelias kodo eilutes.
