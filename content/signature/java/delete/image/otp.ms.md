...
############################# Head ############################
head_title: "Padamkan tandatangan Image daripada fail Otp melalui Java"
head_description: "Pemadaman tandatangan Image tertentu daripada dokumen Otp yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Image yang diletakkan dalam fail Otp."
description: "Padamkan pelbagai tandatangan Image daripada dokumen Otp. Mengalih keluar tandatangan Image memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Image daripada dokumen Otp anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Otp dokumen daripada Image tandatangan dengan beberapa baris kod.
...
demos:
    ...
    content: |
       Tambahkan pelbagai tandatangan elektronik pada fail Otp sekarang dengan melawati tapak web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
