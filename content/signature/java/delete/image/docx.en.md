...
############################# Head ############################
head_title: "Delete Image signatures from Docx files via Java"
head_description: "Deletion of specific Image signatures from signed Docx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Image signatures which are placed in Docx files"
description: "Delete various Image signatures from Docx documents. Removing Image signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Docx documents of Image signatures with a few lines of code.
