...
############################# Head ############################
head_title: "Delete Image signatures from Ppsm files via Java"
head_description: "Deletion of specific Image signatures from signed Ppsm documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Image signatures which are placed in Ppsm files"
description: "Delete various Image signatures from Ppsm documents. Removing Image signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Image signatures from your Ppsm document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Ppsm documents of Image signatures with a few lines of code.
