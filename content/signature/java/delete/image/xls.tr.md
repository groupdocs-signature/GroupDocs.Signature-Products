...
############################# Head ############################
head_title: "Java aracılığıyla Xls dosyalarından Image imzasını silin"
head_description: "İmzalı Xls belgelerindeki belirli Image imzalarının silinmesi kısa Java koduyla kolayca gerçekleştirilebilir."

############################# Header ############################
title: "Xls dosyalarına yerleştirilmiş Image imzalarını kaldırın"
description: "Xls dokümanlarından çeşitli Image imzalarını silin. Image imzasını kaldırmak için basit Java kodu gerekir."
...
steps:
    enable: true
    title_left: "Xls belgenizden Image imzaları nasıl kaldırılır"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Xls belgelerindeki Image imzalarını birkaç satır kodla temizlemek için kullanışlı bir özellik sağlar.
