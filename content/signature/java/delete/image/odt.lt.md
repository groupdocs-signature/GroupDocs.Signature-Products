...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Odt failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Odt dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Odt failuose"
description: "Ištrinkite įvairius Image parašus iš Odt dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Odt dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Odt dokumentus nuo Image parašų naudojant kelias kodo eilutes.
