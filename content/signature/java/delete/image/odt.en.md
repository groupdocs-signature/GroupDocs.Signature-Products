...
############################# Head ############################
head_title: "Delete Image signatures from Odt files via Java"
head_description: "Deletion of specific Image signatures from signed Odt documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Image signatures which are placed in Odt files"
description: "Delete various Image signatures from Odt documents. Removing Image signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Image signatures from your Odt document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Odt documents of Image signatures with a few lines of code.
