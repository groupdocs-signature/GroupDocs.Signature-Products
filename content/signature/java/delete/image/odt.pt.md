...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Odt via Java"
head_description: "A exclusão de assinaturas Image específicas de documentos Odt assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Odt"
description: "Exclua várias assinaturas Image de documentos Odt. A remoção de assinaturas Image requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Image do seu documento Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Odt de assinaturas Image com algumas linhas de código.
