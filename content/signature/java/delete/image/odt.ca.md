...
############################# Head ############################
head_title: "Suprimeix les signatures de Image dels fitxers Odt mitjançant Java"
head_description: "L'eliminació de signatures específiques de Image dels documents signats Odt es pot dur a terme fàcilment amb un codi Java curt."

############################# Header ############################
title: "Elimineu les signatures de Image que es col·loquen als fitxers Odt"
description: "Suprimeix diverses signatures de Image dels documents Odt. L'eliminació de signatures Image requereix un codi Java senzill."
...
steps:
    enable: true
    title_left: "Com eliminar les signatures de Image del vostre document Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix una funció útil per esborrar documents de Odt de signatures de Image amb unes poques línies de codi.
