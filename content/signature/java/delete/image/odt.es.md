...
############################# Head ############################
head_title: "Eliminar Image firmas de Odt archivos a través de Java"
head_description: "La eliminación de firmas Image específicas de documentos Odt firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Image firmas que se colocan en archivos Odt"
description: "Elimine varias firmas Image de los documentos Odt. Eliminar las firmas Image requiere un código Java simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Image de su documento Odt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Odt de Image firmas con unas pocas líneas de código.
