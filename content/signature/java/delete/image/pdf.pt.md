...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Pdf via Java"
head_description: "A exclusão de assinaturas Image específicas de documentos Pdf assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Pdf"
description: "Exclua várias assinaturas Image de documentos Pdf. A remoção de assinaturas Image requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Image do seu documento Pdf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Pdf de assinaturas Image com algumas linhas de código.
