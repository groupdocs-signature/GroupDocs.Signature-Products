...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Ods via Java"
head_description: "A exclusão de assinaturas Image específicas de documentos Ods assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Ods"
description: "Exclua várias assinaturas Image de documentos Ods. A remoção de assinaturas Image requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Ods de assinaturas Image com algumas linhas de código.
