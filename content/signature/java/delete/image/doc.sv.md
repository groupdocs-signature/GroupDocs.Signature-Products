...
############################# Head ############################
head_title: "Ta bort Image-signaturer från Doc-filer via Java"
head_description: "Radering av specifika Image-signaturer från signerade Doc-dokument kan enkelt utföras med kort Java-kod."

############################# Header ############################
title: "Ta bort Image-signaturer som är placerade i Doc-filer"
description: "Ta bort olika Image-signaturer från Doc-dokument. Att ta bort Image-signaturer kräver enkel Java-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Image-signaturer från ditt Doc-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Doc dokument från Image signaturer med några rader kod.
