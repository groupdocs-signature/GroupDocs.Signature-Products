...
############################# Head ############################
head_title: "Slett Image-signaturer fra Odp-filer via Java"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Odp-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Odp-filer"
description: "Slett forskjellige Image-signaturer fra Odp-dokumenter. Fjerning av Image-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Image-signaturer fra Odp-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Odp dokumenter for Image signaturer med noen få linjer med kode.
