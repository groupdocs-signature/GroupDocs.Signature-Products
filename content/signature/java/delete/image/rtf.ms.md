...
############################# Head ############################
head_title: "Padamkan tandatangan Image daripada fail Rtf melalui Java"
head_description: "Pemadaman tandatangan Image tertentu daripada dokumen Rtf yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Image yang diletakkan dalam fail Rtf."
description: "Padamkan pelbagai tandatangan Image daripada dokumen Rtf. Mengalih keluar tandatangan Image memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Image daripada dokumen Rtf anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Rtf dokumen daripada Image tandatangan dengan beberapa baris kod.
