...
############################# Head ############################
head_title: "Törölje a Image aláírásokat a Xls fájlokból a Java segítségével"
head_description: "Az aláírt Xls dokumentumokból bizonyos Image aláírások törlése egyszerűen végrehajtható rövid Java kóddal."

############################# Header ############################
title: "Távolítsa el a Image aláírásokat, amelyek a Xls fájlokban vannak elhelyezve"
description: "Törölje a különböző Image aláírásokat a Xls dokumentumokból. A Image aláírások eltávolításához egyszerű Java kód szükséges."
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Image aláírásokat a Xls dokumentumból"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Xls dokumentumok Image aláírásainak néhány soros kóddal történő törléséhez.
