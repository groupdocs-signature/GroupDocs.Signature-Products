...
############################# Head ############################
head_title: "Kustutage Image allkirjad failist Dot läbi Java"
head_description: "Konkreetsete Image allkirjade kustutamine allkirjastatud Dot dokumentidest saab hõlpsasti teostada lühikese Java koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Image, mis on paigutatud failidesse Dot"
description: "Kustutage erinevad allkirjad Image dokumentidest Dot. Allkirjade Image eemaldamine nõuab lihtsat Java koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Image oma dokumendist Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pakub kasulikku funktsiooni Dot dokumentide Image allkirjade eemaldamiseks mõne koodireaga.
