...
############################# Head ############################
head_title: "Scrios Image sínithe ó chomhaid Doc trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Image ar leith ó dhoiciméid shínithe Doc le cód gearr Java."

############################# Header ############################
title: "Bain Image sínithe a chuirtear i gcomhaid Doc"
description: "Scrios Image sínithe éagsúla ó Doc doiciméid. Teastaíonn cód simplí Java chun sínithe Image a bhaint."
...
steps:
    enable: true
    title_left: "Conas Image sínithe a bhaint de do dhoiciméad Doc"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Doc doiciméad de Image sínithe a ghlanadh le cúpla líne de chód.
