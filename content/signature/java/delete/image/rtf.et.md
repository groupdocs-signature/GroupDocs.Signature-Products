...
############################# Head ############################
head_title: "Kustutage Image allkirjad failist Rtf läbi Java"
head_description: "Konkreetsete Image allkirjade kustutamine allkirjastatud Rtf dokumentidest saab hõlpsasti teostada lühikese Java koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Image, mis on paigutatud failidesse Rtf"
description: "Kustutage erinevad allkirjad Image dokumentidest Rtf. Allkirjade Image eemaldamine nõuab lihtsat Java koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Image oma dokumendist Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pakub kasulikku funktsiooni Rtf dokumentide Image allkirjade eemaldamiseks mõne koodireaga.
