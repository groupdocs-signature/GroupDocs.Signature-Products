...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Ott failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Ott dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Ott failuose"
description: "Ištrinkite įvairius Image parašus iš Ott dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Ott dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ott dokumentus nuo Image parašų naudojant kelias kodo eilutes.
