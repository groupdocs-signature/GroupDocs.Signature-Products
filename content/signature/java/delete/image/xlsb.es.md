...
############################# Head ############################
head_title: "Eliminar Image firmas de Xlsb archivos a través de Java"
head_description: "La eliminación de firmas Image específicas de documentos Xlsb firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Image firmas que se colocan en archivos Xlsb"
description: "Elimine varias firmas Image de los documentos Xlsb. Eliminar las firmas Image requiere un código Java simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Image de su documento Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Xlsb de Image firmas con unas pocas líneas de código.
