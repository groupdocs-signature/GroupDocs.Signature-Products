...
############################# Head ############################
head_title: "Delete Image signatures from Ott files via Java"
head_description: "Deletion of specific Image signatures from signed Ott documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Image signatures which are placed in Ott files"
description: "Delete various Image signatures from Ott documents. Removing Image signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Ott documents of Image signatures with a few lines of code.
