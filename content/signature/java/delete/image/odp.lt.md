...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Odp failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Odp dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Odp failuose"
description: "Ištrinkite įvairius Image parašus iš Odp dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Odp dokumentus nuo Image parašų naudojant kelias kodo eilutes.
