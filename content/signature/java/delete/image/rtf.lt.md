...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Rtf failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Rtf dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Rtf failuose"
description: "Ištrinkite įvairius Image parašus iš Rtf dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Rtf dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Rtf dokumentus nuo Image parašų naudojant kelias kodo eilutes.
