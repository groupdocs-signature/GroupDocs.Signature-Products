...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Ott via Java"
head_description: "A exclusão de assinaturas Image específicas de documentos Ott assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Ott"
description: "Exclua várias assinaturas Image de documentos Ott. A remoção de assinaturas Image requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Ott de assinaturas Image com algumas linhas de código.
