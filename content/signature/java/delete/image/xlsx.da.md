...
############################# Head ############################
head_title: "Slet Image signaturer fra Xlsx filer via Java"
head_description: "Sletning af specifikke Image-signaturer fra signerede Xlsx-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Image-signaturer, der er placeret i Xlsx-filer"
description: "Slet forskellige Image-signaturer fra Xlsx-dokumenter. Fjernelse af Image signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Image-signaturer fra dit Xlsx-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Xlsx dokumenter for Image signaturer med et par linjer kode.
