...
############################# Head ############################
head_title: "Supprimez les signatures Image des fichiers Pptx via Java"
head_description: "La suppression de signatures Image spécifiques à partir de documents Pptx signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Image qui sont placées dans les fichiers Pptx"
description: "Supprimez diverses signatures Image des documents Pptx. La suppression des signatures Image nécessite un code Java simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Image de votre document Pptx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Pptx des signatures Image avec quelques lignes de code.
