...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Dotx failų naudodami Java"
head_description: "Konkrečius Image parašus iš pasirašytų Dotx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Dotx failuose"
description: "Ištrinkite įvairius Image parašus iš Dotx dokumentų. Norint pašalinti Image parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Dotx dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Dotx dokumentus nuo Image parašų naudojant kelias kodo eilutes.
