...
############################# Head ############################
head_title: "Padamkan tandatangan Image daripada fail Docx melalui Java"
head_description: "Pemadaman tandatangan Image tertentu daripada dokumen Docx yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Image yang diletakkan dalam fail Docx."
description: "Padamkan pelbagai tandatangan Image daripada dokumen Docx. Mengalih keluar tandatangan Image memerlukan kod Java yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Docx dokumen daripada Image tandatangan dengan beberapa baris kod.
