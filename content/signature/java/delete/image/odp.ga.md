...
############################# Head ############################
head_title: "Scrios Image sínithe ó chomhaid Odp trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Image ar leith ó dhoiciméid shínithe Odp le cód gearr Java."

############################# Header ############################
title: "Bain Image sínithe a chuirtear i gcomhaid Odp"
description: "Scrios Image sínithe éagsúla ó Odp doiciméid. Teastaíonn cód simplí Java chun sínithe Image a bhaint."
...
steps:
    enable: true
    title_left: "Conas Image sínithe a bhaint de do dhoiciméad Odp"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Odp doiciméad de Image sínithe a ghlanadh le cúpla líne de chód.
