...
############################# Head ############################
head_title: "Slett Image-signaturer fra Ott-filer via Java"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Ott-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Ott-filer"
description: "Slett forskjellige Image-signaturer fra Ott-dokumenter. Fjerning av Image-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Image-signaturer fra Ott-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Ott dokumenter for Image signaturer med noen få linjer med kode.
