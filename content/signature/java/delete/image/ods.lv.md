...
############################# Head ############################
head_title: "Dzēst Image parakstus no Ods failiem, izmantojot Java"
head_description: "Konkrētu Image parakstu dzēšanu no parakstītiem Ods dokumentiem var viegli veikt, izmantojot īsu Java kodu."

############################# Header ############################
title: "Noņemiet Image parakstus, kas ir ievietoti Ods failos"
description: "Izdzēsiet dažādus Image parakstus no Ods dokumentiem. Lai noņemtu Image parakstus, ir nepieciešams vienkāršs Java kods."
...
steps:
    enable: true
    title_left: "Kā noņemt Image parakstus no sava Ods dokumenta"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina noderīgu līdzekli, lai no Ods dokumentiem notīrītu Image parakstus, izmantojot dažas koda rindiņas.
