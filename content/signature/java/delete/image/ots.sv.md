...
############################# Head ############################
head_title: "Ta bort Image-signaturer från Ots-filer via Java"
head_description: "Radering av specifika Image-signaturer från signerade Ots-dokument kan enkelt utföras med kort Java-kod."

############################# Header ############################
title: "Ta bort Image-signaturer som är placerade i Ots-filer"
description: "Ta bort olika Image-signaturer från Ots-dokument. Att ta bort Image-signaturer kräver enkel Java-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Image-signaturer från ditt Ots-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Ots dokument från Image signaturer med några rader kod.
