...
############################# Head ############################
head_title: "Supprimer les signatures de DOCX avec Java"
head_description: "La suppression de signatures numériques, de codes-barres, de texte, d'images et de métadonnées dans des documents DOCX signés peut être effectuée en utilisant GroupDocs.Signature for Java."

############################# Header ############################
title: "Supprimer les signatures de DOCX" 
...
steps:
    enable: true
    title: "Étapes pour supprimer des e-signatures de DOCX avec Java"
    content: |
      [GroupDocs.Signature](/signature/java/) facilite aux développeurs Java la suppression d'e-signatures dans des fichiers DOCX en suivant quelques étapes simples.
      
      1. Transmettez le chemin du DOCX à une instance de la classe Signature.
