...
############################# Head ############################
head_title: "Eliminar firmas de DOCX usando Java"
head_description: "La eliminación de firmas digitales, de código de barras, de texto, de imágenes y de metadatos de documentos DOCX firmados se puede realizar utilizando GroupDocs.Signature for Java."
...
steps:
    enable: true
    title: "Pasos para eliminar firmas electrónicas de DOCX usando Java"
    content: |
      [GroupDocs.Signature](/signature/java/) facilita a los desarrolladores de Java eliminar firmas electrónicas en archivos DOCX usando sus aplicaciones siguiendo unos pocos pasos simples.
      
      1. Pasa la ruta de DOCX a una instancia de la clase Signature.
