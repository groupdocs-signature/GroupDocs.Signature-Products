...
############################# Head ############################
head_title: "احذف توقيعات Qrcode من ملفات Potx عبر Java"
head_description: "يمكن إجراء حذف توقيعات معينة من Qrcode من مستندات Potx الموقعة بسهولة باستخدام رمز Java القصير."

############################# Header ############################
title: "قم بإزالة Qrcode التوقيعات التي يتم وضعها في ملفات Potx"
description: "احذف العديد من توقيعات Qrcode من مستندات Potx. تتطلب إزالة توقيعات Qrcode شفرة Java بسيطة."
...
steps:
    ...
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) ميزة مفيدة لمسح Potx مستندات توقيعات Qrcode ببضعة أسطر من التعليمات البرمجية.
