...
head_description: "Die uitvee van spesifieke Qrcode handtekeninge van getekende Xlsm dokumente kan maklik uitgevoer word met kort Java kode."

############################# Header ############################
title: "Verwyder Qrcode handtekeninge wat in Xlsm lêers geplaas is"
description: "Vee verskeie Qrcode handtekeninge uit Xlsm dokumente uit. Die verwydering van Qrcode handtekeninge vereis eenvoudige Java kode."
...
steps:
    enable: true
    title_left: "Hoe om Qrcode-handtekeninge uit jou Xlsm-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied nuttige kenmerk vir die skoonmaak van Xlsm dokumente van Qrcode handtekeninge met 'n paar reëls kode.
