...
############################# Head ############################
head_title: "Excluir assinaturas Qrcode de arquivos Dot via Java"
head_description: "A exclusão de assinaturas Qrcode específicas de documentos Dot assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Qrcode que são colocadas em arquivos Dot"
description: "Exclua várias assinaturas Qrcode de documentos Dot. A remoção de assinaturas Qrcode requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Dot de assinaturas Qrcode com algumas linhas de código.
