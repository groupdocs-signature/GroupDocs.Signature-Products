...
############################# Head ############################
head_title: "Excluir assinaturas Qrcode de arquivos Pptx via Java"
head_description: "A exclusão de assinaturas Qrcode específicas de documentos Pptx assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Qrcode que são colocadas em arquivos Pptx"
description: "Exclua várias assinaturas Qrcode de documentos Pptx. A remoção de assinaturas Qrcode requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Pptx de assinaturas Qrcode com algumas linhas de código.
