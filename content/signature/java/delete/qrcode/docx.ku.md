...
############################# Head ############################
head_title: "Bi rêya Java îmzeyên Qrcode ji pelên Docx jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Qrcode ji belgeyên îmzekirî yên Docx dibe ku bi koda kurt a Java bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Qrcode yên ku di pelên Docx de cih digirin rakin"
description: "Ji belgeyên Docx îmzeyên cihêreng ên Qrcode jêbirin. Ji rakirina îmzeyên Qrcode koda Java ya sade hewce dike."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzayên Qrcode ji belgeya xweya Docx rabike"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji bo paqijkirina Docx belgeyên Qrcode bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
