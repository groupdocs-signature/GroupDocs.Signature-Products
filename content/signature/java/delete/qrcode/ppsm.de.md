...
############################# Head ############################
head_title: "Löschen Sie Qrcode-Signaturen aus Ppsm-Dateien über Java"
head_description: "Das Löschen bestimmter Qrcode-Signaturen aus signierten Ppsm-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Qrcode-Signaturen, die in Ppsm-Dateien platziert sind"
description: "Löschen Sie verschiedene Qrcode-Signaturen aus Ppsm-Dokumenten. Das Entfernen von Qrcode-Signaturen erfordert einfachen Java-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Ppsm-Dokumenten von Qrcode-Signaturen mit ein paar Codezeilen.
