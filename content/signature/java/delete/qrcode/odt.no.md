...
############################# Head ############################
head_title: "Slett Qrcode-signaturer fra Odt-filer via Java"
head_description: "Sletting av spesifikke Qrcode-signaturer fra signerte Odt-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer som er plassert i Odt-filer"
description: "Slett forskjellige Qrcode-signaturer fra Odt-dokumenter. Fjerning av Qrcode-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Odt dokumenter for Qrcode signaturer med noen få linjer med kode.
