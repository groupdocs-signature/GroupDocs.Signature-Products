...
############################# Head ############################
head_title: "Hapus tanda tangan Qrcode dari file Ots melalui Java"
head_description: "Penghapusan tanda tangan Qrcode tertentu dari dokumen Ots yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Qrcode yang ditempatkan di file Ots"
description: "Hapus berbagai tanda tangan Qrcode dari dokumen Ots. Menghapus tanda tangan Qrcode memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Qrcode dari dokumen Ots Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Ots dari Qrcode tanda tangan dengan beberapa baris kode.
