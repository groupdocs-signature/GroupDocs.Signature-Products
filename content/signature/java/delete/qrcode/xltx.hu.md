...
############################# Head ############################
head_title: "Törölje a Qrcode aláírásokat a Xltx fájlokból a Java segítségével"
head_description: "Az aláírt Xltx dokumentumokból bizonyos Qrcode aláírások törlése egyszerűen végrehajtható rövid Java kóddal."

############################# Header ############################
title: "Távolítsa el a Qrcode aláírásokat, amelyek a Xltx fájlokban vannak elhelyezve"
description: "Törölje a különböző Qrcode aláírásokat a Xltx dokumentumokból. A Qrcode aláírások eltávolításához egyszerű Java kód szükséges."
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Qrcode aláírásokat a Xltx dokumentumból"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Xltx dokumentumok Qrcode aláírásainak néhány soros kóddal történő törléséhez.
