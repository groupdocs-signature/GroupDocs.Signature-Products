...
############################# Head ############################
head_title: "Delete Qrcode signatures from Xltx files via Java"
head_description: "Deletion of specific Qrcode signatures from signed Xltx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Xltx files"
description: "Delete various Qrcode signatures from Xltx documents. Removing Qrcode signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Qrcode signatures from your Xltx document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Xltx documents of Qrcode signatures with a few lines of code.
