...
############################# Head ############################
head_title: "Slett Qrcode-signaturer fra Odp-filer via Java"
head_description: "Sletting av spesifikke Qrcode-signaturer fra signerte Odp-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer som er plassert i Odp-filer"
description: "Slett forskjellige Qrcode-signaturer fra Odp-dokumenter. Fjerning av Qrcode-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Odp dokumenter for Qrcode signaturer med noen få linjer med kode.
