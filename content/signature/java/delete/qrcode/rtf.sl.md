...
############################# Head ############################
head_title: "Izbrišite podpise Qrcode iz datotek Rtf prek Java"
head_description: "Brisanje določenih podpisov Qrcode iz podpisanih dokumentov Rtf je mogoče preprosto izvesti s kratko kodo Java."

############################# Header ############################
title: "Odstranite podpise Qrcode, ki so v datotekah Rtf"
description: "Izbrišite različne podpise Qrcode iz dokumentov Rtf. Odstranjevanje podpisov Qrcode zahteva preprosto kodo Java."
...
steps:
    enable: true
    title_left: "Kako odstraniti podpise Qrcode iz vašega dokumenta Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nudi uporabno funkcijo za čiščenje dokumentov Rtf podpisov Qrcode z nekaj vrsticami kode.
