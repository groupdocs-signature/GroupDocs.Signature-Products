...
############################# Head ############################
head_title: "Padamkan tandatangan Qrcode daripada fail Pptx melalui Java"
head_description: "Pemadaman tandatangan Qrcode tertentu daripada dokumen Pptx yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Qrcode yang diletakkan dalam fail Pptx."
description: "Padamkan pelbagai tandatangan Qrcode daripada dokumen Pptx. Mengalih keluar tandatangan Qrcode memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Qrcode daripada dokumen Pptx anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Pptx dokumen daripada Qrcode tandatangan dengan beberapa baris kod.
