...
############################# Head ############################
head_title: "Hapus tanda tangan Qrcode dari file Odt melalui Java"
head_description: "Penghapusan tanda tangan Qrcode tertentu dari dokumen Odt yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Qrcode yang ditempatkan di file Odt"
description: "Hapus berbagai tanda tangan Qrcode dari dokumen Odt. Menghapus tanda tangan Qrcode memerlukan kode Java sederhana."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Odt dari Qrcode tanda tangan dengan beberapa baris kode.
