...
############################# Head ############################
head_title: "Xóa chữ ký Qrcode khỏi tệp Ods qua Java"
head_description: "Việc xóa các chữ ký Qrcode cụ thể khỏi các tài liệu Ods đã ký có thể được thực hiện dễ dàng với mã Java ngắn."

############################# Header ############################
title: "Xóa các chữ ký Qrcode được đặt trong các tệp Ods"
description: "Xóa các chữ ký Qrcode khác nhau khỏi tài liệu Ods. Việc xóa chữ ký Qrcode yêu cầu mã Java đơn giản."
...
steps:
    enable: true
    title_left: "Cách xóa chữ ký Qrcode khỏi tài liệu Ods của bạn"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp tính năng hữu ích để xóa các tài liệu Ods có chữ ký Qrcode bằng một vài dòng mã.
