...
############################# Head ############################
head_title: "Ջնջել Qrcode ստորագրությունները Xltm ֆայլերից Java-ի միջոցով"
head_description: "Ստորագրված Xltm փաստաթղթերից որոշակի Qrcode ստորագրությունների ջնջումը կարող է հեշտությամբ իրականացվել կարճ Java կոդով:"

############################# Header ############################
title: "Հեռացրեք Qrcode ստորագրությունները, որոնք տեղադրված են Xltm ֆայլերում"
description: "Ջնջել տարբեր Qrcode ստորագրությունները Xltm փաստաթղթերից: Qrcode ստորագրությունները հեռացնելու համար անհրաժեշտ է պարզ Java կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես հեռացնել Qrcode ստորագրությունները ձեր Xltm փաստաթղթից"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) օգտակար հատկություն է տրամադրում Xltm փաստաթղթերը Qrcode ստորագրություններից մի քանի տող կոդով մաքրելու համար:
...
more_formats:
    enable: true
    title: "Ջնջեք ձեր Qrcode ստորագրությունները Java-ով"
    content: |
