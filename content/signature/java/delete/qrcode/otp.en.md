...
############################# Head ############################
head_title: "Delete Qrcode signatures from Otp files via Java"
head_description: "Deletion of specific Qrcode signatures from signed Otp documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Otp files"
description: "Delete various Qrcode signatures from Otp documents. Removing Qrcode signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Otp documents of Qrcode signatures with a few lines of code.
