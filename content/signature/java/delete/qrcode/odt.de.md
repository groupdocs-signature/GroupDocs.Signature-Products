...
############################# Head ############################
head_title: "Löschen Sie Qrcode-Signaturen aus Odt-Dateien über Java"
head_description: "Das Löschen bestimmter Qrcode-Signaturen aus signierten Odt-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Qrcode-Signaturen, die in Odt-Dateien platziert sind"
description: "Löschen Sie verschiedene Qrcode-Signaturen aus Odt-Dokumenten. Das Entfernen von Qrcode-Signaturen erfordert einfachen Java-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Qrcode-Signaturen aus Ihrem Odt-Dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Odt-Dokumenten von Qrcode-Signaturen mit ein paar Codezeilen.
