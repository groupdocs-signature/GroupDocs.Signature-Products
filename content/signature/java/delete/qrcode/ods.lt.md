...
############################# Head ############################
head_title: "Ištrinkite Qrcode parašus iš Ods failų naudodami Java"
head_description: "Konkrečius Qrcode parašus iš pasirašytų Ods dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Qrcode parašus, kurie yra Ods failuose"
description: "Ištrinkite įvairius Qrcode parašus iš Ods dokumentų. Norint pašalinti Qrcode parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ods dokumentus nuo Qrcode parašų naudojant kelias kodo eilutes.
