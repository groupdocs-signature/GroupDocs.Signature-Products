...
############################# Head ############################
head_title: "Excluir assinaturas Qrcode de arquivos Pps via Java"
head_description: "A exclusão de assinaturas Qrcode específicas de documentos Pps assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Qrcode que são colocadas em arquivos Pps"
description: "Exclua várias assinaturas Qrcode de documentos Pps. A remoção de assinaturas Qrcode requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Qrcode do seu documento Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Pps de assinaturas Qrcode com algumas linhas de código.
