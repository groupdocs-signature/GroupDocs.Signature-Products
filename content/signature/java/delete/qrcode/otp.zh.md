...
############################# Head ############################
head_title: "通过 Java 从 Otp 文件中删除 Qrcode 签名"
head_description: "使用简短的 Java 代码可以轻松地从已签名的 Otp 文档中删除特定的 Qrcode 签名。"

############################# Header ############################
title: "删除放置在 Otp 文件中的 Qrcode 签名"
description: "从 Otp 文档中删除各种 Qrcode 签名。删除 Qrcode 签名需要简单的 Java 代码。"
...
steps:
    enable: true
    title_left: "如何从您的 Otp 文档中删除 Qrcode 签名"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) 提供了有用的功能，可通过几行代码清除 Qrcode 签名的 Otp 文档。
