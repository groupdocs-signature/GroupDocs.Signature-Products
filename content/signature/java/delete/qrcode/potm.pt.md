...
############################# Head ############################
head_title: "Excluir assinaturas Qrcode de arquivos Potm via Java"
head_description: "A exclusão de assinaturas Qrcode específicas de documentos Potm assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Qrcode que são colocadas em arquivos Potm"
description: "Exclua várias assinaturas Qrcode de documentos Potm. A remoção de assinaturas Qrcode requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Potm de assinaturas Qrcode com algumas linhas de código.
