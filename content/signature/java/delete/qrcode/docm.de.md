...
############################# Head ############################
head_title: "Löschen Sie Qrcode-Signaturen aus Docm-Dateien über Java"
head_description: "Das Löschen bestimmter Qrcode-Signaturen aus signierten Docm-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Qrcode-Signaturen, die in Docm-Dateien platziert sind"
description: "Löschen Sie verschiedene Qrcode-Signaturen aus Docm-Dokumenten. Das Entfernen von Qrcode-Signaturen erfordert einfachen Java-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Qrcode-Signaturen aus Ihrem Docm-Dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Docm-Dokumenten von Qrcode-Signaturen mit ein paar Codezeilen.
...
more_formats:
    enable: true
    title: "Löschen Sie Ihre Qrcode-Signaturen mit Java"
    content: |
