...
############################# Head ############################
head_title: "Bi rêya Java îmzeyên Qrcode ji pelên Pptm jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Qrcode ji belgeyên îmzekirî yên Pptm dibe ku bi koda kurt a Java bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Qrcode yên ku di pelên Pptm de cih digirin rakin"
description: "Ji belgeyên Pptm îmzeyên cihêreng ên Qrcode jêbirin. Ji rakirina îmzeyên Qrcode koda Java ya sade hewce dike."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzayên Qrcode ji belgeya xweya Pptm rabike"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji bo paqijkirina Pptm belgeyên Qrcode bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
