...
############################# Head ############################
head_title: "Löschen Sie Qrcode-Signaturen aus Ots-Dateien über Java"
head_description: "Das Löschen bestimmter Qrcode-Signaturen aus signierten Ots-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Qrcode-Signaturen, die in Ots-Dateien platziert sind"
description: "Löschen Sie verschiedene Qrcode-Signaturen aus Ots-Dokumenten. Das Entfernen von Qrcode-Signaturen erfordert einfachen Java-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Qrcode-Signaturen aus Ihrem Ots-Dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Ots-Dokumenten von Qrcode-Signaturen mit ein paar Codezeilen.
