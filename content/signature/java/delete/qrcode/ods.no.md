...
############################# Head ############################
head_title: "Slett Qrcode-signaturer fra Ods-filer via Java"
head_description: "Sletting av spesifikke Qrcode-signaturer fra signerte Ods-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer som er plassert i Ods-filer"
description: "Slett forskjellige Qrcode-signaturer fra Ods-dokumenter. Fjerning av Qrcode-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Ods dokumenter for Qrcode signaturer med noen få linjer med kode.
