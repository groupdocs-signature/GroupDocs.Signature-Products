...
############################# Head ############################
head_title: "Suprimeix les signatures de Qrcode dels fitxers Dotm mitjançant Java"
head_description: "L'eliminació de signatures específiques de Qrcode dels documents signats Dotm es pot dur a terme fàcilment amb un codi Java curt."

############################# Header ############################
title: "Elimineu les signatures de Qrcode que es col·loquen als fitxers Dotm"
description: "Suprimeix diverses signatures de Qrcode dels documents Dotm. L'eliminació de signatures Qrcode requereix un codi Java senzill."
...
steps:
    enable: true
    title_left: "Com eliminar les signatures de Qrcode del vostre document Dotm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix una funció útil per esborrar documents de Dotm de signatures de Qrcode amb unes poques línies de codi.
