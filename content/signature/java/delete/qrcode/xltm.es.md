...
############################# Head ############################
head_title: "Eliminar Qrcode firmas de Xltm archivos a través de Java"
head_description: "La eliminación de firmas Qrcode específicas de documentos Xltm firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Qrcode firmas que se colocan en archivos Xltm"
description: "Elimine varias firmas Qrcode de los documentos Xltm. Eliminar las firmas Qrcode requiere un código Java simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Qrcode de su documento Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Xltm de Qrcode firmas con unas pocas líneas de código.
