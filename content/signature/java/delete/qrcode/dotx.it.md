...
############################# Head ############################
head_title: "Elimina le firme Qrcode dai file Dotx tramite Java"
head_description: "L'eliminazione di firme Qrcode specifiche da documenti Dotx firmati può essere eseguita facilmente con il codice Java breve."

############################# Header ############################
title: "Rimuovi le firme Qrcode che sono inserite nei file Dotx"
description: "Elimina varie firme Qrcode da documenti Dotx. La rimozione delle firme Qrcode richiede un semplice codice Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornisce una funzione utile per cancellare documenti Dotx di firme Qrcode con poche righe di codice.
