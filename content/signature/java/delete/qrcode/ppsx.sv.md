...
description: "Ta bort olika Qrcode-signaturer från Ppsx-dokument. Att ta bort Qrcode-signaturer kräver enkel Java-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Ppsx dokument från Qrcode signaturer med några rader kod.
