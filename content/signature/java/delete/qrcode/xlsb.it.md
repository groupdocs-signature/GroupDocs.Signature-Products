...
############################# Head ############################
head_title: "Elimina le firme Qrcode dai file Xlsb tramite Java"
head_description: "L'eliminazione di firme Qrcode specifiche da documenti Xlsb firmati può essere eseguita facilmente con il codice Java breve."

############################# Header ############################
title: "Rimuovi le firme Qrcode che sono inserite nei file Xlsb"
description: "Elimina varie firme Qrcode da documenti Xlsb. La rimozione delle firme Qrcode richiede un semplice codice Java."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Qrcode dal tuo documento Xlsb"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornisce una funzione utile per cancellare documenti Xlsb di firme Qrcode con poche righe di codice.
