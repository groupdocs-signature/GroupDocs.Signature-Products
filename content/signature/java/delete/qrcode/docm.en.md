...
############################# Head ############################
head_title: "Delete Qrcode signatures from Docm files via Java"
head_description: "Deletion of specific Qrcode signatures from signed Docm documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Docm files"
description: "Delete various Qrcode signatures from Docm documents. Removing Qrcode signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Qrcode signatures from your Docm document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Docm documents of Qrcode signatures with a few lines of code.
