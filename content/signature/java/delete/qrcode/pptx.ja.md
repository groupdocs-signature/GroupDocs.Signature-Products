...
############################# Head ############################
head_title: "Java を介して Pptx ファイルから Qrcode 署名を削除します"
head_description: "署名済みの Pptx ドキュメントから特定の Qrcode 署名を削除するには、短い Java コードを使用すると簡単に実行できます。"

############################# Header ############################
title: "Pptx ファイルに配置されている Qrcode 署名を削除します"
description: "Pptx ドキュメントからさまざまな Qrcode 署名を削除します。 Qrcode 署名を削除するには、単純な Java コードが必要です。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) は、数行のコードで Qrcode 署名の Pptx ドキュメントをクリアするための便利な機能を提供します。
