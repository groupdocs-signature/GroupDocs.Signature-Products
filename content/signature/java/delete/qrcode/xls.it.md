...
############################# Head ############################
head_title: "Elimina le firme Qrcode dai file Xls tramite Java"
head_description: "L'eliminazione di firme Qrcode specifiche da documenti Xls firmati può essere eseguita facilmente con il codice Java breve."

############################# Header ############################
title: "Rimuovi le firme Qrcode che sono inserite nei file Xls"
description: "Elimina varie firme Qrcode da documenti Xls. La rimozione delle firme Qrcode richiede un semplice codice Java."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Qrcode dal tuo documento Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornisce una funzione utile per cancellare documenti Xls di firme Qrcode con poche righe di codice.
