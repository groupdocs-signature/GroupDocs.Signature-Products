...
############################# Head ############################
head_title: "Delete Qrcode signatures from Odt files via Java"
head_description: "Deletion of specific Qrcode signatures from signed Odt documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Odt files"
description: "Delete various Qrcode signatures from Odt documents. Removing Qrcode signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Qrcode signatures from your Odt document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Odt documents of Qrcode signatures with a few lines of code.
