...
############################# Head ############################
head_title: "Delete Qrcode signatures from Rtf files via Java"
head_description: "Deletion of specific Qrcode signatures from signed Rtf documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Rtf files"
description: "Delete various Qrcode signatures from Rtf documents. Removing Qrcode signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Rtf documents of Qrcode signatures with a few lines of code.
