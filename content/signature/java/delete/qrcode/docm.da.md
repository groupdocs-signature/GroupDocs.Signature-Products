...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Docm filer via Java"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Docm-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Docm-filer"
description: "Slet forskellige Qrcode-signaturer fra Docm-dokumenter. Fjernelse af Qrcode signaturer kræver simpel Java kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Docm dokumenter for Qrcode signaturer med et par linjer kode.
