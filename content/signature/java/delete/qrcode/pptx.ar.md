...
############################# Head ############################
head_title: "احذف توقيعات Qrcode من ملفات Pptx عبر Java"
head_description: "يمكن إجراء حذف توقيعات معينة من Qrcode من مستندات Pptx الموقعة بسهولة باستخدام رمز Java القصير."

############################# Header ############################
title: "قم بإزالة Qrcode التوقيعات التي يتم وضعها في ملفات Pptx"
description: "احذف العديد من توقيعات Qrcode من مستندات Pptx. تتطلب إزالة توقيعات Qrcode شفرة Java بسيطة."
...
steps:
    enable: true
    title_left: "كيفية إزالة توقيعات Qrcode من مستندك Pptx"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) ميزة مفيدة لمسح Pptx مستندات توقيعات Qrcode ببضعة أسطر من التعليمات البرمجية.
