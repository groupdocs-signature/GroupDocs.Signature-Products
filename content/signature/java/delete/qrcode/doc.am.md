...
############################# Head ############################
head_title: "የQrcode ፊርማዎችን ከDoc ፋይሎች በJava በኩል ሰርዝ"
head_description: "ከተፈረሙ Doc ሰነዶች የተወሰኑ የQrcode ፊርማዎችን መሰረዝ በአጭር የJava ኮድ በቀላሉ ሊከናወን ይችላል።"

############################# Header ############################
title: "በDoc ፋይሎች ውስጥ የተቀመጡትን የQrcode ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የQrcode ፊርማዎችን ከDoc ሰነዶች ሰርዝ። የQrcode ፊርማዎችን ማስወገድ ቀላል የJava ኮድ ያስፈልገዋል።"
...
steps:
    enable: true
    title_left: "Qrcode ፊርማዎችን ከDoc ሰነድዎ እንዴት ማስወገድ እንደሚቻል"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የDoc ሰነዶችን የQrcode ፊርማዎችን በጥቂት የኮድ መስመሮች ለማጽዳት ጠቃሚ ባህሪን ይሰጣል።
