...
############################# Head ############################
head_title: "احذف توقيعات Qrcode من ملفات Xltm عبر Java"
head_description: "يمكن إجراء حذف توقيعات معينة من Qrcode من مستندات Xltm الموقعة بسهولة باستخدام رمز Java القصير."

############################# Header ############################
title: "قم بإزالة Qrcode التوقيعات التي يتم وضعها في ملفات Xltm"
description: "احذف العديد من توقيعات Qrcode من مستندات Xltm. تتطلب إزالة توقيعات Qrcode شفرة Java بسيطة."
...
steps:
    enable: true
    title_left: "كيفية إزالة توقيعات Qrcode من مستندك Xltm"
    content_left: |
        يوفر [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) ميزة مفيدة لمسح Xltm مستندات توقيعات Qrcode ببضعة أسطر من التعليمات البرمجية.
