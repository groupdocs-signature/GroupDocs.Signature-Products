...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Ppt filer via Java"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Ppt-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Ppt-filer"
description: "Slet forskellige Qrcode-signaturer fra Ppt-dokumenter. Fjernelse af Qrcode signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Qrcode-signaturer fra dit Ppt-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Ppt dokumenter for Qrcode signaturer med et par linjer kode.
