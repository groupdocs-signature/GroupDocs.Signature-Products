...
############################# Head ############################
head_title: "Törölje a Qrcode aláírásokat a Odp fájlokból a Java segítségével"
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Qrcode aláírásokat a Odp dokumentumból"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Odp dokumentumok Qrcode aláírásainak néhány soros kóddal történő törléséhez.
