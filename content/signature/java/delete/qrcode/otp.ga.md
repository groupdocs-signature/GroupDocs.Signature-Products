...
############################# Head ############################
head_title: "Scrios Qrcode sínithe ó chomhaid Otp trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Qrcode ar leith ó dhoiciméid shínithe Otp le cód gearr Java."

############################# Header ############################
title: "Bain Qrcode sínithe a chuirtear i gcomhaid Otp"
description: "Scrios Qrcode sínithe éagsúla ó Otp doiciméid. Teastaíonn cód simplí Java chun sínithe Qrcode a bhaint."
...
steps:
    enable: true
    title_left: "Conas Qrcode sínithe a bhaint de do dhoiciméad Otp"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Otp doiciméad de Qrcode sínithe a ghlanadh le cúpla líne de chód.
