...
############################# Head ############################
head_title: "Удалите подписи Qrcode из Rtf файлов с помощью Java"
head_description: "Удаление определенных подписей Qrcode из подписанных документов Rtf можно легко выполнить с помощью короткого кода Java."

############################# Header ############################
title: "Удалить подписи Qrcode, размещенные в файлах Rtf"
description: "Удалите различные подписи Qrcode из Rtf документов. Для удаления подписей Qrcode требуется простой код Java."
...
steps:
    enable: true
    title_left: "Как удалить подписи Qrcode из документа Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставляет полезную функцию для очистки документов Rtf от подписей Qrcode с помощью нескольких строк кода.
