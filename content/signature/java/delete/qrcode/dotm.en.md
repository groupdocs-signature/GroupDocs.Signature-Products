...
############################# Head ############################
head_title: "Delete Qrcode signatures from Dotm files via Java"
head_description: "Deletion of specific Qrcode signatures from signed Dotm documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Dotm files"
description: "Delete various Qrcode signatures from Dotm documents. Removing Qrcode signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Dotm documents of Qrcode signatures with a few lines of code.
