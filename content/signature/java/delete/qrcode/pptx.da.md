...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Pptx filer via Java"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Pptx-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Pptx-filer"
description: "Slet forskellige Qrcode-signaturer fra Pptx-dokumenter. Fjernelse af Qrcode signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Qrcode-signaturer fra dit Pptx-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Pptx dokumenter for Qrcode signaturer med et par linjer kode.
