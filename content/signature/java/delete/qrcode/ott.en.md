...
############################# Head ############################
head_title: "Delete Qrcode signatures from Ott files via Java"
head_description: "Deletion of specific Qrcode signatures from signed Ott documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Ott files"
description: "Delete various Qrcode signatures from Ott documents. Removing Qrcode signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Ott documents of Qrcode signatures with a few lines of code.
