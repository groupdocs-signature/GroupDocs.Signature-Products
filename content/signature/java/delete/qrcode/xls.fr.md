...
############################# Head ############################
head_title: "Supprimez les signatures Qrcode des fichiers Xls via Java"
head_description: "La suppression de signatures Qrcode spécifiques à partir de documents Xls signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Qrcode qui sont placées dans les fichiers Xls"
description: "Supprimez diverses signatures Qrcode des documents Xls. La suppression des signatures Qrcode nécessite un code Java simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Qrcode de votre document Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Xls des signatures Qrcode avec quelques lignes de code.
