...
############################# Head ############################
head_title: "Kustutage Qrcode allkirjad failist Potm läbi Java"
head_description: "Konkreetsete Qrcode allkirjade kustutamine allkirjastatud Potm dokumentidest saab hõlpsasti teostada lühikese Java koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Qrcode, mis on paigutatud failidesse Potm"
description: "Kustutage erinevad allkirjad Qrcode dokumentidest Potm. Allkirjade Qrcode eemaldamine nõuab lihtsat Java koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Qrcode oma dokumendist Potm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pakub kasulikku funktsiooni Potm dokumentide Qrcode allkirjade eemaldamiseks mõne koodireaga.
