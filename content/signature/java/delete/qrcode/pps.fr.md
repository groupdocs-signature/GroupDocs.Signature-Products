...
############################# Head ############################
head_title: "Supprimez les signatures Qrcode des fichiers Pps via Java"
head_description: "La suppression de signatures Qrcode spécifiques à partir de documents Pps signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Qrcode qui sont placées dans les fichiers Pps"
description: "Supprimez diverses signatures Qrcode des documents Pps. La suppression des signatures Qrcode nécessite un code Java simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Qrcode de votre document Pps"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Pps des signatures Qrcode avec quelques lignes de code.
