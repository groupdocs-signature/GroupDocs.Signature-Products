...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Ppsx filer via Java"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Ppsx-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Ppsx-filer"
description: "Slet forskellige Qrcode-signaturer fra Ppsx-dokumenter. Fjernelse af Qrcode signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Qrcode-signaturer fra dit Ppsx-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Ppsx dokumenter for Qrcode signaturer med et par linjer kode.
