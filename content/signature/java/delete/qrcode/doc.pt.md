...
############################# Head ############################
head_title: "Excluir assinaturas Qrcode de arquivos Doc via Java"
head_description: "A exclusão de assinaturas Qrcode específicas de documentos Doc assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Qrcode que são colocadas em arquivos Doc"
description: "Exclua várias assinaturas Qrcode de documentos Doc. A remoção de assinaturas Qrcode requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Qrcode do seu documento Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Doc de assinaturas Qrcode com algumas linhas de código.
