...
############################# Head ############################
head_title: "Padamkan tandatangan Qrcode daripada fail Odt melalui Java"
head_description: "Pemadaman tandatangan Qrcode tertentu daripada dokumen Odt yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Qrcode yang diletakkan dalam fail Odt."
description: "Padamkan pelbagai tandatangan Qrcode daripada dokumen Odt. Mengalih keluar tandatangan Qrcode memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Qrcode daripada dokumen Odt anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Odt dokumen daripada Qrcode tandatangan dengan beberapa baris kod.
