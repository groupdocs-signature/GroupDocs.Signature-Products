...
############################# Head ############################
head_title: "Delete Qrcode signatures from Ppsx files via Java"
head_description: "Deletion of specific Qrcode signatures from signed Ppsx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Ppsx files"
description: "Delete various Qrcode signatures from Ppsx documents. Removing Qrcode signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Ppsx documents of Qrcode signatures with a few lines of code.
