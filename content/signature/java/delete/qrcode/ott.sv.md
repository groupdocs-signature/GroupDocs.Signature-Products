...
############################# Head ############################
head_title: "Ta bort Qrcode-signaturer från Ott-filer via Java"
head_description: "Radering av specifika Qrcode-signaturer från signerade Ott-dokument kan enkelt utföras med kort Java-kod."

############################# Header ############################
title: "Ta bort Qrcode-signaturer som är placerade i Ott-filer"
description: "Ta bort olika Qrcode-signaturer från Ott-dokument. Att ta bort Qrcode-signaturer kräver enkel Java-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Ott dokument från Qrcode signaturer med några rader kod.
