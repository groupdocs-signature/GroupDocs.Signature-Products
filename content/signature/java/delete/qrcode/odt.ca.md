...
############################# Head ############################
head_title: "Suprimeix les signatures de Qrcode dels fitxers Odt mitjançant Java"
head_description: "L'eliminació de signatures específiques de Qrcode dels documents signats Odt es pot dur a terme fàcilment amb un codi Java curt."

############################# Header ############################
title: "Elimineu les signatures de Qrcode que es col·loquen als fitxers Odt"
description: "Suprimeix diverses signatures de Qrcode dels documents Odt. L'eliminació de signatures Qrcode requereix un codi Java senzill."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix una funció útil per esborrar documents de Odt de signatures de Qrcode amb unes poques línies de codi.
