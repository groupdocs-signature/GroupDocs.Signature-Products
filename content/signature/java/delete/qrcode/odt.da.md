...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Odt filer via Java"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Odt-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Odt-filer"
description: "Slet forskellige Qrcode-signaturer fra Odt-dokumenter. Fjernelse af Qrcode signaturer kræver simpel Java kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Odt dokumenter for Qrcode signaturer med et par linjer kode.
