...
############################# Header ############################
title: "በDotx ፋይሎች ውስጥ የተቀመጡትን የQrcode ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የQrcode ፊርማዎችን ከDotx ሰነዶች ሰርዝ። የQrcode ፊርማዎችን ማስወገድ ቀላል የJava ኮድ ያስፈልገዋል።"
...
steps:
    enable: true
    title_left: "Qrcode ፊርማዎችን ከDotx ሰነድዎ እንዴት ማስወገድ እንደሚቻል"
    content_left: |
