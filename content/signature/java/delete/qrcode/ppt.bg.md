...
############################# Head ############################
head_title: "Изтрийте Qrcode подписи от Ppt файлове чрез Java"
head_description: "Изтриването на конкретни Qrcode подписи от подписани Ppt документи може да се извърши лесно с кратък Java код."

############################# Header ############################
title: "Премахнете Qrcode подписи, които са поставени във Ppt файлове"
description: "Изтрийте различни подписи Qrcode от Ppt документи. Премахването на подписи Qrcode изисква прост код Java."
...
steps:
    enable: true
    title_left: "Как да премахнете подписи Qrcode от вашия Ppt документ"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя полезна функция за изчистване на Ppt документи от Qrcode подписи с няколко реда код.
