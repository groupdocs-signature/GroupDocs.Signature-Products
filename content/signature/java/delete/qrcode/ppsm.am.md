...
############################# Header ############################
title: "በPpsm ፋይሎች ውስጥ የተቀመጡትን የQrcode ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የQrcode ፊርማዎችን ከPpsm ሰነዶች ሰርዝ። የQrcode ፊርማዎችን ማስወገድ ቀላል የJava ኮድ ያስፈልገዋል።"
...
steps:
    enable: true
    title_left: "Qrcode ፊርማዎችን ከPpsm ሰነድዎ እንዴት ማስወገድ እንደሚቻል"
    content_left: |
