...
############################# Head ############################
head_title: "Remove signatures from PDF using Java"
head_description: "Removing of Digital, Barcode, Text, Image, Metadata signatures from signed PDF documents can be performed easily using GroupDocs.Signature for Java."

############################# Header ############################
title: "Delete signatures from PDF" 
