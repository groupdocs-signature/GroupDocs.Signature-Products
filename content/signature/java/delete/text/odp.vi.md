...
############################# Head ############################
head_title: "Xóa chữ ký Text khỏi tệp Odp qua Java"
head_description: "Việc xóa các chữ ký Text cụ thể khỏi các tài liệu Odp đã ký có thể được thực hiện dễ dàng với mã Java ngắn."

############################# Header ############################
title: "Xóa các chữ ký Text được đặt trong các tệp Odp"
description: "Xóa các chữ ký Text khác nhau khỏi tài liệu Odp. Việc xóa chữ ký Text yêu cầu mã Java đơn giản."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp tính năng hữu ích để xóa các tài liệu Odp có chữ ký Text bằng một vài dòng mã.
