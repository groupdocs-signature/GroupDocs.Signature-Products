...
############################# Head ############################
head_title: "Delete Text signatures from Odt files via Java"
head_description: "Deletion of specific Text signatures from signed Odt documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Text signatures which are placed in Odt files"
description: "Delete various Text signatures from Odt documents. Removing Text signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Odt documents of Text signatures with a few lines of code.
