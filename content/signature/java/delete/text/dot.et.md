...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Dot läbi Java"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Dot dokumentidest saab hõlpsasti teostada lühikese Java koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Dot"
description: "Kustutage erinevad allkirjad Text dokumentidest Dot. Allkirjade Text eemaldamine nõuab lihtsat Java koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Text oma dokumendist Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pakub kasulikku funktsiooni Dot dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
