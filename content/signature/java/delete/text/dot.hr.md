...
############################# Head ############################
head_title: "Izbriši Text potpise iz Dot datoteka putem Java"
head_description: "Brisanje specifičnih Text potpisa iz potpisanih Dot dokumenata može se lako izvesti s kratkim Java kodom."

############################# Header ############################
title: "Uklonite potpise Text koji se nalaze u datotekama Dot"
description: "Izbrišite razne Text potpise iz Dot dokumenata. Uklanjanje Text potpisa zahtijeva jednostavan Java kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža korisnu značajku za brisanje Dot dokumenata od Text potpisa s nekoliko redaka koda.
