...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Ods-filer via Java"
head_description: "Radering av specifika Text-signaturer från signerade Ods-dokument kan enkelt utföras med kort Java-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Ods-filer"
description: "Ta bort olika Text-signaturer från Ods-dokument. Att ta bort Text-signaturer kräver enkel Java-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Ods dokument från Text signaturer med några rader kod.
