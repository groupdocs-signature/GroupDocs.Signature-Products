...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Potx failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Potx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Potx failuose"
description: "Ištrinkite įvairius Text parašus iš Potx dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Potx dokumentus nuo Text parašų naudojant kelias kodo eilutes.
