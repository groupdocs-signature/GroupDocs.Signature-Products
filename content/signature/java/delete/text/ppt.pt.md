...
############################# Head ############################
head_title: "Excluir assinaturas Text de arquivos Ppt via Java"
head_description: "A exclusão de assinaturas Text específicas de documentos Ppt assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Text que são colocadas em arquivos Ppt"
description: "Exclua várias assinaturas Text de documentos Ppt. A remoção de assinaturas Text requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Text do seu documento Ppt"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Ppt de assinaturas Text com algumas linhas de código.
