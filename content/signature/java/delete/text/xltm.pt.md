...
############################# Head ############################
head_title: "Excluir assinaturas Text de arquivos Xltm via Java"
head_description: "A exclusão de assinaturas Text específicas de documentos Xltm assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Text que são colocadas em arquivos Xltm"
description: "Exclua várias assinaturas Text de documentos Xltm. A remoção de assinaturas Text requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Xltm de assinaturas Text com algumas linhas de código.
