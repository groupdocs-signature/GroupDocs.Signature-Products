...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Ppt failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Ppt dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Ppt failuose"
description: "Ištrinkite įvairius Text parašus iš Ppt dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Ppt dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ppt dokumentus nuo Text parašų naudojant kelias kodo eilutes.
