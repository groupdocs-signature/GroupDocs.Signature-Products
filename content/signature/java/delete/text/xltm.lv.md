...
############################# Head ############################
head_title: "Dzēst Text parakstus no Xltm failiem, izmantojot Java"
head_description: "Konkrētu Text parakstu dzēšanu no parakstītiem Xltm dokumentiem var viegli veikt, izmantojot īsu Java kodu."

############################# Header ############################
title: "Noņemiet Text parakstus, kas ir ievietoti Xltm failos"
description: "Izdzēsiet dažādus Text parakstus no Xltm dokumentiem. Lai noņemtu Text parakstus, ir nepieciešams vienkāršs Java kods."
...
steps:
    enable: true
    title_left: "Kā noņemt Text parakstus no sava Xltm dokumenta"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina noderīgu līdzekli, lai no Xltm dokumentiem notīrītu Text parakstus, izmantojot dažas koda rindiņas.
