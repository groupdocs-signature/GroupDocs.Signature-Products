...
############################# Head ############################
head_title: "Slet Text signaturer fra Ppsx filer via Java"
head_description: "Sletning af specifikke Text-signaturer fra signerede Ppsx-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer, der er placeret i Ppsx-filer"
description: "Slet forskellige Text-signaturer fra Ppsx-dokumenter. Fjernelse af Text signaturer kræver simpel Java kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Ppsx dokumenter for Text signaturer med et par linjer kode.
