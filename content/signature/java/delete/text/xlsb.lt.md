...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Xlsb failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Xlsb dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Xlsb failuose"
description: "Ištrinkite įvairius Text parašus iš Xlsb dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Xlsb dokumentus nuo Text parašų naudojant kelias kodo eilutes.
