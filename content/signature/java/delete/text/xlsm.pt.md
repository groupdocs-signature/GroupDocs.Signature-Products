...
############################# Head ############################
head_title: "Excluir assinaturas Text de arquivos Xlsm via Java"
head_description: "A exclusão de assinaturas Text específicas de documentos Xlsm assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Text que são colocadas em arquivos Xlsm"
description: "Exclua várias assinaturas Text de documentos Xlsm. A remoção de assinaturas Text requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Text do seu documento Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Xlsm de assinaturas Text com algumas linhas de código.
