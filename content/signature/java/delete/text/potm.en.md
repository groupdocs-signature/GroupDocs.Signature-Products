...
############################# Head ############################
head_title: "Delete Text signatures from Potm files via Java"
head_description: "Deletion of specific Text signatures from signed Potm documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Text signatures which are placed in Potm files"
description: "Delete various Text signatures from Potm documents. Removing Text signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Potm documents of Text signatures with a few lines of code.
