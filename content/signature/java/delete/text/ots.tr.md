...
############################# Head ############################
head_title: "Java aracılığıyla Ots dosyalarından Text imzasını silin"
head_description: "İmzalı Ots belgelerindeki belirli Text imzalarının silinmesi kısa Java koduyla kolayca gerçekleştirilebilir."

############################# Header ############################
title: "Ots dosyalarına yerleştirilmiş Text imzalarını kaldırın"
description: "Ots dokümanlarından çeşitli Text imzalarını silin. Text imzasını kaldırmak için basit Java kodu gerekir."
...
steps:
    enable: true
    title_left: "Ots belgenizden Text imzaları nasıl kaldırılır"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Ots belgelerindeki Text imzalarını birkaç satır kodla temizlemek için kullanışlı bir özellik sağlar.
