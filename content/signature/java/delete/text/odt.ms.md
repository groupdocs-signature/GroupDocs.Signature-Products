...
############################# Head ############################
head_title: "Padamkan tandatangan Text daripada fail Odt melalui Java"
head_description: "Pemadaman tandatangan Text tertentu daripada dokumen Odt yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Text yang diletakkan dalam fail Odt."
description: "Padamkan pelbagai tandatangan Text daripada dokumen Odt. Mengalih keluar tandatangan Text memerlukan kod Java yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Odt dokumen daripada Text tandatangan dengan beberapa baris kod.
