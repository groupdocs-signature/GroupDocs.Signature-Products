...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Pptx failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Pptx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Pptx failuose"
description: "Ištrinkite įvairius Text parašus iš Pptx dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Pptx dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Pptx dokumentus nuo Text parašų naudojant kelias kodo eilutes.
