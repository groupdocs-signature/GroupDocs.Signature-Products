...
############################# Head ############################
head_title: "Löschen Sie Text-Signaturen aus Ots-Dateien über Java"
head_description: "Das Löschen bestimmter Text-Signaturen aus signierten Ots-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Text-Signaturen, die in Ots-Dateien platziert sind"
description: "Löschen Sie verschiedene Text-Signaturen aus Ots-Dokumenten. Das Entfernen von Text-Signaturen erfordert einfachen Java-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Ots-Dokumenten von Text-Signaturen mit ein paar Codezeilen.
