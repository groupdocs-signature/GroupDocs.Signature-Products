...
############################# Head ############################
head_title: "Usuń podpisy Text z plików Ots przez Java"
head_description: "Usuwanie określonych podpisów Text z podpisanych dokumentów Ots można łatwo wykonać za pomocą krótkiego kodu Java."

############################# Header ############################
title: "Usuń Text podpisy umieszczone w plikach Ots"
description: "Usuń różne podpisy Text z dokumentów Ots. Usunięcie podpisów Text wymaga prostego kodu Java."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Text z dokumentu Ots?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zapewnia użyteczną funkcję do czyszczenia dokumentów Ots z podpisami Text za pomocą kilku linijek kodu.
