...
############################# Head ############################
head_title: "Delete Text signatures from Docx files via Java"
head_description: "Deletion of specific Text signatures from signed Docx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Text signatures which are placed in Docx files"
description: "Delete various Text signatures from Docx documents. Removing Text signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Text signatures from your Docx document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Docx documents of Text signatures with a few lines of code.
