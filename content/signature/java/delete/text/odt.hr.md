...
############################# Head ############################
head_title: "Izbriši Text potpise iz Odt datoteka putem Java"
head_description: "Brisanje specifičnih Text potpisa iz potpisanih Odt dokumenata može se lako izvesti s kratkim Java kodom."

############################# Header ############################
title: "Uklonite potpise Text koji se nalaze u datotekama Odt"
description: "Izbrišite razne Text potpise iz Odt dokumenata. Uklanjanje Text potpisa zahtijeva jednostavan Java kod."
...
steps:
    enable: true
    title_left: "Kako ukloniti Text potpise iz vašeg Odt dokumenta"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža korisnu značajku za brisanje Odt dokumenata od Text potpisa s nekoliko redaka koda.
