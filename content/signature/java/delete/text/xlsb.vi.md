...
############################# Head ############################
head_title: "Xóa chữ ký Text khỏi tệp Xlsb qua Java"
head_description: "Việc xóa các chữ ký Text cụ thể khỏi các tài liệu Xlsb đã ký có thể được thực hiện dễ dàng với mã Java ngắn."

############################# Header ############################
title: "Xóa các chữ ký Text được đặt trong các tệp Xlsb"
description: "Xóa các chữ ký Text khác nhau khỏi tài liệu Xlsb. Việc xóa chữ ký Text yêu cầu mã Java đơn giản."
...
steps:
    enable: true
    title_left: "Cách xóa chữ ký Text khỏi tài liệu Xlsb của bạn"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp tính năng hữu ích để xóa các tài liệu Xlsb có chữ ký Text bằng một vài dòng mã.
