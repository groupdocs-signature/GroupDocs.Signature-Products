...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Docx failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Docx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Docx failuose"
description: "Ištrinkite įvairius Text parašus iš Docx dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Docx dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Docx dokumentus nuo Text parašų naudojant kelias kodo eilutes.
