...
############################# Head ############################
head_title: "Suprimeix les signatures de Text dels fitxers Pptx mitjançant Java"
head_description: "L'eliminació de signatures específiques de Text dels documents signats Pptx es pot dur a terme fàcilment amb un codi Java curt."

############################# Header ############################
title: "Elimineu les signatures de Text que es col·loquen als fitxers Pptx"
description: "Suprimeix diverses signatures de Text dels documents Pptx. L'eliminació de signatures Text requereix un codi Java senzill."
...
steps:
    enable: true
    title_left: "Com eliminar les signatures de Text del vostre document Pptx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix una funció útil per esborrar documents de Pptx de signatures de Text amb unes poques línies de codi.
