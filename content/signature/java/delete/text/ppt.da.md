...
############################# Head ############################
head_title: "Slet Text signaturer fra Ppt filer via Java"
head_description: "Sletning af specifikke Text-signaturer fra signerede Ppt-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer, der er placeret i Ppt-filer"
description: "Slet forskellige Text-signaturer fra Ppt-dokumenter. Fjernelse af Text signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Text-signaturer fra dit Ppt-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Ppt dokumenter for Text signaturer med et par linjer kode.
