...
############################# Head ############################
head_title: "Eliminar Text firmas de Odp archivos a través de Java"
head_description: "La eliminación de firmas Text específicas de documentos Odp firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Text firmas que se colocan en archivos Odp"
description: "Elimine varias firmas Text de los documentos Odp. Eliminar las firmas Text requiere un código Java simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Text de su documento Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Odp de Text firmas con unas pocas líneas de código.
