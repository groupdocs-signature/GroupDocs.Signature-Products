...
############################# Head ############################
head_title: "Vee Text handtekeninge van Doc lêers uit via Java"
head_description: "Die uitvee van spesifieke Text handtekeninge van getekende Doc dokumente kan maklik uitgevoer word met kort Java kode."

############################# Header ############################
title: "Verwyder Text handtekeninge wat in Doc lêers geplaas is"
description: "Vee verskeie Text handtekeninge uit Doc dokumente uit. Die verwydering van Text handtekeninge vereis eenvoudige Java kode."
...
steps:
    enable: true
    title_left: "Hoe om Text-handtekeninge uit jou Doc-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied nuttige kenmerk vir die skoonmaak van Doc dokumente van Text handtekeninge met 'n paar reëls kode.
