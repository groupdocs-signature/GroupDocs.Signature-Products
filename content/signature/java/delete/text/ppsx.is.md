...
############################# Head ############################
head_title: "Eyða Text undirskriftum úr Ppsx skrám í gegnum Java"
head_description: "Auðvelt er að eyða tilteknum Text undirskriftum úr undirrituðum Ppsx skjölum með stuttum Java kóða."

############################# Header ############################
title: "Fjarlægðu Text undirskriftir sem eru settar í Ppsx skrár"
description: "Eyða ýmsum Text undirskriftum úr Ppsx skjölum. Til að fjarlægja Text undirskrift þarf einfaldan Java kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að fjarlægja Text undirskriftir úr Ppsx skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) býður upp á gagnlegan eiginleika til að hreinsa Ppsx skjöl af Text undirskriftum með nokkrum línum af kóða.
