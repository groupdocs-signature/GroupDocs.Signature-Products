...
############################# Head ############################
head_title: "Excluir assinaturas Text de arquivos Xls via Java"
head_description: "A exclusão de assinaturas Text específicas de documentos Xls assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Text que são colocadas em arquivos Xls"
description: "Exclua várias assinaturas Text de documentos Xls. A remoção de assinaturas Text requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Xls de assinaturas Text com algumas linhas de código.
