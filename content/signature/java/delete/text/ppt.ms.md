...
############################# Head ############################
head_title: "Padamkan tandatangan Text daripada fail Ppt melalui Java"
head_description: "Pemadaman tandatangan Text tertentu daripada dokumen Ppt yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Text yang diletakkan dalam fail Ppt."
description: "Padamkan pelbagai tandatangan Text daripada dokumen Ppt. Mengalih keluar tandatangan Text memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Text daripada dokumen Ppt anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Ppt dokumen daripada Text tandatangan dengan beberapa baris kod.
