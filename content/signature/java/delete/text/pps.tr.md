...
############################# Head ############################
head_title: "Java aracılığıyla Pps dosyalarından Text imzasını silin"
head_description: "İmzalı Pps belgelerindeki belirli Text imzalarının silinmesi kısa Java koduyla kolayca gerçekleştirilebilir."

############################# Header ############################
title: "Pps dosyalarına yerleştirilmiş Text imzalarını kaldırın"
description: "Pps dokümanlarından çeşitli Text imzalarını silin. Text imzasını kaldırmak için basit Java kodu gerekir."
...
steps:
    enable: true
    title_left: "Pps belgenizden Text imzaları nasıl kaldırılır"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Pps belgelerindeki Text imzalarını birkaç satır kodla temizlemek için kullanışlı bir özellik sağlar.
