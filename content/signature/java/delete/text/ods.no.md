...
############################# Head ############################
head_title: "Slett Text-signaturer fra Ods-filer via Java"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Ods-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Ods-filer"
description: "Slett forskjellige Text-signaturer fra Ods-dokumenter. Fjerning av Text-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Text-signaturer fra Ods-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Ods dokumenter for Text signaturer med noen få linjer med kode.
