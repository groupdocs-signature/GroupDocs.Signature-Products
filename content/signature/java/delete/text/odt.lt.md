...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Odt failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Odt dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Odt failuose"
description: "Ištrinkite įvairius Text parašus iš Odt dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Odt dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Odt dokumentus nuo Text parašų naudojant kelias kodo eilutes.
