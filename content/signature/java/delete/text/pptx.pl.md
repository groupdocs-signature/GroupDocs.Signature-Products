...
############################# Head ############################
head_title: "Usuń podpisy Text z plików Pptx przez Java"
head_description: "Usuwanie określonych podpisów Text z podpisanych dokumentów Pptx można łatwo wykonać za pomocą krótkiego kodu Java."

############################# Header ############################
title: "Usuń Text podpisy umieszczone w plikach Pptx"
description: "Usuń różne podpisy Text z dokumentów Pptx. Usunięcie podpisów Text wymaga prostego kodu Java."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Text z dokumentu Pptx?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zapewnia użyteczną funkcję do czyszczenia dokumentów Pptx z podpisami Text za pomocą kilku linijek kodu.
