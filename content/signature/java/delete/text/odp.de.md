...
############################# Head ############################
head_title: "Löschen Sie Text-Signaturen aus Odp-Dateien über Java"
head_description: "Das Löschen bestimmter Text-Signaturen aus signierten Odp-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Text-Signaturen, die in Odp-Dateien platziert sind"
description: "Löschen Sie verschiedene Text-Signaturen aus Odp-Dokumenten. Das Entfernen von Text-Signaturen erfordert einfachen Java-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Text-Signaturen aus Ihrem Odp-Dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Odp-Dokumenten von Text-Signaturen mit ein paar Codezeilen.
