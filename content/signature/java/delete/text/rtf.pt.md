...
############################# Head ############################
head_title: "Excluir assinaturas Text de arquivos Rtf via Java"
head_description: "A exclusão de assinaturas Text específicas de documentos Rtf assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Text que são colocadas em arquivos Rtf"
description: "Exclua várias assinaturas Text de documentos Rtf. A remoção de assinaturas Text requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Text do seu documento Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Rtf de assinaturas Text com algumas linhas de código.
