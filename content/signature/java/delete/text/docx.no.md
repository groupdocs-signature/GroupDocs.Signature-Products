...
############################# Head ############################
head_title: "Slett Text-signaturer fra Docx-filer via Java"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Docx-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Docx-filer"
description: "Slett forskjellige Text-signaturer fra Docx-dokumenter. Fjerning av Text-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Docx dokumenter for Text signaturer med noen få linjer med kode.
