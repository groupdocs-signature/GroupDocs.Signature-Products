...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Xls fájlokból a Java segítségével"
head_description: "Az aláírt Xls dokumentumokból bizonyos Text aláírások törlése egyszerűen végrehajtható rövid Java kóddal."

############################# Header ############################
title: "Távolítsa el a Text aláírásokat, amelyek a Xls fájlokban vannak elhelyezve"
description: "Törölje a különböző Text aláírásokat a Xls dokumentumokból. A Text aláírások eltávolításához egyszerű Java kód szükséges."
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Text aláírásokat a Xls dokumentumból"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Xls dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
