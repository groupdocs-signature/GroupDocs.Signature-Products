...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Pptm fájlokból a Java segítségével"
head_description: "Az aláírt Pptm dokumentumokból bizonyos Text aláírások törlése egyszerűen végrehajtható rövid Java kóddal."

############################# Header ############################
title: "Távolítsa el a Text aláírásokat, amelyek a Pptm fájlokban vannak elhelyezve"
description: "Törölje a különböző Text aláírásokat a Pptm dokumentumokból. A Text aláírások eltávolításához egyszerű Java kód szükséges."
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Text aláírásokat a Pptm dokumentumból"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Pptm dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
