...
############################# Head ############################
head_title: "Slett Text-signaturer fra Xlsm-filer via Java"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Xlsm-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Xlsm-filer"
description: "Slett forskjellige Text-signaturer fra Xlsm-dokumenter. Fjerning av Text-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Xlsm dokumenter for Text signaturer med noen få linjer med kode.
