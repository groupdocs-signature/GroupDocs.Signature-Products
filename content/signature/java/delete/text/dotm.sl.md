...
############################# Head ############################
head_title: "Izbrišite podpise Text iz datotek Dotm prek Java"
head_description: "Brisanje določenih podpisov Text iz podpisanih dokumentov Dotm je mogoče preprosto izvesti s kratko kodo Java."

############################# Header ############################
title: "Odstranite podpise Text, ki so v datotekah Dotm"
description: "Izbrišite različne podpise Text iz dokumentov Dotm. Odstranjevanje podpisov Text zahteva preprosto kodo Java."
...
steps:
    enable: true
    title_left: "Kako odstraniti podpise Text iz vašega dokumenta Dotm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nudi uporabno funkcijo za čiščenje dokumentov Dotm podpisov Text z nekaj vrsticami kode.
