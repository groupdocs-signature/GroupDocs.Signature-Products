...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Otp failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Otp dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Otp failuose"
description: "Ištrinkite įvairius Text parašus iš Otp dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Otp dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Otp dokumentus nuo Text parašų naudojant kelias kodo eilutes.
