...
############################# Head ############################
head_title: "Padamkan tandatangan Text daripada fail Xltm melalui Java"
head_description: "Pemadaman tandatangan Text tertentu daripada dokumen Xltm yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Text yang diletakkan dalam fail Xltm."
description: "Padamkan pelbagai tandatangan Text daripada dokumen Xltm. Mengalih keluar tandatangan Text memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Text daripada dokumen Xltm anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Xltm dokumen daripada Text tandatangan dengan beberapa baris kod.
