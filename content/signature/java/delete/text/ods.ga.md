...
############################# Head ############################
head_title: "Scrios Text sínithe ó chomhaid Ods trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Text ar leith ó dhoiciméid shínithe Ods le cód gearr Java."

############################# Header ############################
title: "Bain Text sínithe a chuirtear i gcomhaid Ods"
description: "Scrios Text sínithe éagsúla ó Ods doiciméid. Teastaíonn cód simplí Java chun sínithe Text a bhaint."
...
steps:
    ...
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Ods doiciméad de Text sínithe a ghlanadh le cúpla líne de chód.
