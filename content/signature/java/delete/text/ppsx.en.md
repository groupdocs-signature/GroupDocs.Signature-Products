...
############################# Head ############################
head_title: "Delete Text signatures from Ppsx files in Java"
head_description: "Deletion of specific Text signatures from signed Ppsx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Text signatures which are in Ppsx files"
description: "Delete various Text signatures from Ppsx documents. Removing Text signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature of clearing Ppsx documents of Text signatures with a few lines of code.
