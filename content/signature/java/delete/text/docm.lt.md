...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Docm failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Docm dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Docm failuose"
description: "Ištrinkite įvairius Text parašus iš Docm dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Docm dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Docm dokumentus nuo Text parašų naudojant kelias kodo eilutes.
