...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Rtf failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Rtf dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Rtf failuose"
description: "Ištrinkite įvairius Text parašus iš Rtf dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Rtf dokumentus nuo Text parašų naudojant kelias kodo eilutes.
