...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Dot failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Dot dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Dot failuose"
description: "Ištrinkite įvairius Text parašus iš Dot dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Dot dokumentus nuo Text parašų naudojant kelias kodo eilutes.
