...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Ods failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Ods dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Ods failuose"
description: "Ištrinkite įvairius Text parašus iš Ods dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Ods dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ods dokumentus nuo Text parašų naudojant kelias kodo eilutes.
