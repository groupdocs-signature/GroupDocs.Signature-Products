...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Ott failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Ott dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Ott failuose"
description: "Ištrinkite įvairius Text parašus iš Ott dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Ott dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ott dokumentus nuo Text parašų naudojant kelias kodo eilutes.
