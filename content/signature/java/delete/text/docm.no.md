...
############################# Head ############################
head_title: "Slett Text-signaturer fra Docm-filer via Java"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Docm-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Docm-filer"
description: "Slett forskjellige Text-signaturer fra Docm-dokumenter. Fjerning av Text-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Text-signaturer fra Docm-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Docm dokumenter for Text signaturer med noen få linjer med kode.
