...
############################# Head ############################
head_title: "Supprimez les signatures Text des fichiers Ott via Java"
head_description: "La suppression de signatures Text spécifiques à partir de documents Ott signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Text qui sont placées dans les fichiers Ott"
description: "Supprimez diverses signatures Text des documents Ott. La suppression des signatures Text nécessite un code Java simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Text de votre document Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Ott des signatures Text avec quelques lignes de code.
