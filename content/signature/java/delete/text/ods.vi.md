...
############################# Head ############################
head_title: "Xóa chữ ký Text khỏi tệp Ods qua Java"
head_description: "Việc xóa các chữ ký Text cụ thể khỏi các tài liệu Ods đã ký có thể được thực hiện dễ dàng với mã Java ngắn."

############################# Header ############################
title: "Xóa các chữ ký Text được đặt trong các tệp Ods"
description: "Xóa các chữ ký Text khác nhau khỏi tài liệu Ods. Việc xóa chữ ký Text yêu cầu mã Java đơn giản."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp tính năng hữu ích để xóa các tài liệu Ods có chữ ký Text bằng một vài dòng mã.
