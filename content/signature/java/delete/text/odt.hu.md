...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Odt fájlokból a Java segítségével"
head_description: "Az aláírt Odt dokumentumokból bizonyos Text aláírások törlése egyszerűen végrehajtható rövid Java kóddal."

############################# Header ############################
title: "Távolítsa el a Text aláírásokat, amelyek a Odt fájlokban vannak elhelyezve"
description: "Törölje a különböző Text aláírásokat a Odt dokumentumokból. A Text aláírások eltávolításához egyszerű Java kód szükséges."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Odt dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
