...
############################# Head ############################
head_title: "Eyða Text undirskriftum úr Odt skrám í gegnum Java"
head_description: "Auðvelt er að eyða tilteknum Text undirskriftum úr undirrituðum Odt skjölum með stuttum Java kóða."

############################# Header ############################
title: "Fjarlægðu Text undirskriftir sem eru settar í Odt skrár"
description: "Eyða ýmsum Text undirskriftum úr Odt skjölum. Til að fjarlægja Text undirskrift þarf einfaldan Java kóða."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) býður upp á gagnlegan eiginleika til að hreinsa Odt skjöl af Text undirskriftum með nokkrum línum af kóða.
