...
############################# Head ############################
head_title: "Odstraňte podpisy Text ze souborů Odp prostřednictvím Java"
head_description: "Odstranění konkrétních podpisů Text z podepsaných dokumentů Odp lze snadno provést pomocí krátkého kódu Java."

############################# Header ############################
title: "Odstraňte Text podpisy, které jsou umístěny v souborech Odp"
description: "Odstraňte různé podpisy Text z dokumentů Odp. Odstranění podpisů Text vyžaduje jednoduchý kód Java."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Text z vašeho dokumentu Odp"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje užitečnou funkci pro vymazání Odp dokumentů od Text podpisů pomocí několika řádků kódu.
