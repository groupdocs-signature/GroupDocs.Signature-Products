...
############################# Head ############################
head_title: "Dzēst Text parakstus no Rtf failiem, izmantojot Java"
head_description: "Konkrētu Text parakstu dzēšanu no parakstītiem Rtf dokumentiem var viegli veikt, izmantojot īsu Java kodu."

############################# Header ############################
title: "Noņemiet Text parakstus, kas ir ievietoti Rtf failos"
description: "Izdzēsiet dažādus Text parakstus no Rtf dokumentiem. Lai noņemtu Text parakstus, ir nepieciešams vienkāršs Java kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina noderīgu līdzekli, lai no Rtf dokumentiem notīrītu Text parakstus, izmantojot dažas koda rindiņas.
