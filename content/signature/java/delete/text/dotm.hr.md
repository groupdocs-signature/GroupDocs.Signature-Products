...
############################# Head ############################
head_title: "Izbriši Text potpise iz Dotm datoteka putem Java"
head_description: "Brisanje specifičnih Text potpisa iz potpisanih Dotm dokumenata može se lako izvesti s kratkim Java kodom."

############################# Header ############################
title: "Uklonite potpise Text koji se nalaze u datotekama Dotm"
description: "Izbrišite razne Text potpise iz Dotm dokumenata. Uklanjanje Text potpisa zahtijeva jednostavan Java kod."
...
steps:
    enable: true
    title_left: "Kako ukloniti Text potpise iz vašeg Dotm dokumenta"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pruža korisnu značajku za brisanje Dotm dokumenata od Text potpisa s nekoliko redaka koda.
...
more_formats:
    enable: true
    title: "Izbrišite svoje Text potpise s Java"
    content: |
