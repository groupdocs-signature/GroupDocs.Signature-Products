...
############################# Head ############################
head_title: "Löschen Sie Text-Signaturen aus Ods-Dateien über Java"
head_description: "Das Löschen bestimmter Text-Signaturen aus signierten Ods-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Text-Signaturen, die in Ods-Dateien platziert sind"
description: "Löschen Sie verschiedene Text-Signaturen aus Ods-Dokumenten. Das Entfernen von Text-Signaturen erfordert einfachen Java-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Ods-Dokumenten von Text-Signaturen mit ein paar Codezeilen.
