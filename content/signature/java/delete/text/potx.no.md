...
############################# Head ############################
head_title: "Slett Text-signaturer fra Potx-filer via Java"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Potx-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Potx-filer"
description: "Slett forskjellige Text-signaturer fra Potx-dokumenter. Fjerning av Text-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Potx dokumenter for Text signaturer med noen få linjer med kode.
