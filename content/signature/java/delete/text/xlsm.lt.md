...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Xlsm failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Xlsm dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Xlsm failuose"
description: "Ištrinkite įvairius Text parašus iš Xlsm dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Xlsm dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Xlsm dokumentus nuo Text parašų naudojant kelias kodo eilutes.
