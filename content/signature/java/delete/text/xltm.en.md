...
############################# Head ############################
head_title: "Delete Text signatures from Xltm files via Java"
head_description: "Deletion of specific Text signatures from signed Xltm documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Text signatures which are placed in Xltm files"
description: "Delete various Text signatures from Xltm documents. Removing Text signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Xltm documents of Text signatures with a few lines of code.
