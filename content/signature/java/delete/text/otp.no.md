...
############################# Head ############################
head_title: "Slett Text-signaturer fra Otp-filer via Java"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Otp-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Otp-filer"
description: "Slett forskjellige Text-signaturer fra Otp-dokumenter. Fjerning av Text-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Text-signaturer fra Otp-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Otp dokumenter for Text signaturer med noen få linjer med kode.
