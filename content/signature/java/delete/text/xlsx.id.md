...
############################# Head ############################
head_title: "Hapus tanda tangan Text dari file Xlsx melalui Java"
head_description: "Penghapusan tanda tangan Text tertentu dari dokumen Xlsx yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Text yang ditempatkan di file Xlsx"
description: "Hapus berbagai tanda tangan Text dari dokumen Xlsx. Menghapus tanda tangan Text memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Text dari dokumen Xlsx Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Xlsx dari Text tanda tangan dengan beberapa baris kode.
