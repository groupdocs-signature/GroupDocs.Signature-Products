...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Dot fájlokból a Java segítségével"
head_description: "Az aláírt Dot dokumentumokból bizonyos Text aláírások törlése egyszerűen végrehajtható rövid Java kóddal."

############################# Header ############################
title: "Távolítsa el a Text aláírásokat, amelyek a Dot fájlokban vannak elhelyezve"
description: "Törölje a különböző Text aláírásokat a Dot dokumentumokból. A Text aláírások eltávolításához egyszerű Java kód szükséges."
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Text aláírásokat a Dot dokumentumból"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Dot dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
