...
############################# Head ############################
head_title: "Slett Text-signaturer fra Rtf-filer via Java"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Rtf-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Rtf-filer"
description: "Slett forskjellige Text-signaturer fra Rtf-dokumenter. Fjerning av Text-signaturer krever enkel Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Rtf dokumenter for Text signaturer med noen få linjer med kode.
