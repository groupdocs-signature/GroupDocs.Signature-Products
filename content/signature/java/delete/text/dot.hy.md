...
############################# Head ############################
head_title: "Ջնջել Text ստորագրությունները Dot ֆայլերից Java-ի միջոցով"
head_description: "Ստորագրված Dot փաստաթղթերից որոշակի Text ստորագրությունների ջնջումը կարող է հեշտությամբ իրականացվել կարճ Java կոդով:"

############################# Header ############################
title: "Հեռացրեք Text ստորագրությունները, որոնք տեղադրված են Dot ֆայլերում"
description: "Ջնջել տարբեր Text ստորագրությունները Dot փաստաթղթերից: Text ստորագրությունները հեռացնելու համար անհրաժեշտ է պարզ Java կոդ:"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) օգտակար հատկություն է տրամադրում Dot փաստաթղթերը Text ստորագրություններից մի քանի տող կոդով մաքրելու համար:
