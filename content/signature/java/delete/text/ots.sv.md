...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Ots-filer via Java"
head_description: "Radering av specifika Text-signaturer från signerade Ots-dokument kan enkelt utföras med kort Java-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Ots-filer"
description: "Ta bort olika Text-signaturer från Ots-dokument. Att ta bort Text-signaturer kräver enkel Java-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Ots dokument från Text signaturer med några rader kod.
