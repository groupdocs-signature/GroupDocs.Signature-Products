...
############################# Head ############################
head_title: "Slet Text signaturer fra Ots filer via Java"
head_description: "Sletning af specifikke Text-signaturer fra signerede Ots-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer, der er placeret i Ots-filer"
description: "Slet forskellige Text-signaturer fra Ots-dokumenter. Fjernelse af Text signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Text-signaturer fra dit Ots-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Ots dokumenter for Text signaturer med et par linjer kode.
