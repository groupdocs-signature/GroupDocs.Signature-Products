...
############################# Head ############################
head_title: "Ջնջել Text ստորագրությունները Docx ֆայլերից Java-ի միջոցով"
head_description: "Ստորագրված Docx փաստաթղթերից որոշակի Text ստորագրությունների ջնջումը կարող է հեշտությամբ իրականացվել կարճ Java կոդով:"

############################# Header ############################
title: "Հեռացրեք Text ստորագրությունները, որոնք տեղադրված են Docx ֆայլերում"
description: "Ջնջել տարբեր Text ստորագրությունները Docx փաստաթղթերից: Text ստորագրությունները հեռացնելու համար անհրաժեշտ է պարզ Java կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես հեռացնել Text ստորագրությունները ձեր Docx փաստաթղթից"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) օգտակար հատկություն է տրամադրում Docx փաստաթղթերը Text ստորագրություններից մի քանի տող կոդով մաքրելու համար:
