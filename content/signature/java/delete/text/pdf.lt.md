...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Pdf failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Pdf dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Pdf failuose"
description: "Ištrinkite įvairius Text parašus iš Pdf dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Pdf dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Pdf dokumentus nuo Text parašų naudojant kelias kodo eilutes.
