...
############################# Head ############################
head_title: "Elimina le firme Text dai file Dot tramite Java"
head_description: "L'eliminazione di firme Text specifiche da documenti Dot firmati può essere eseguita facilmente con il codice Java breve."

############################# Header ############################
title: "Rimuovi le firme Text che sono inserite nei file Dot"
description: "Elimina varie firme Text da documenti Dot. La rimozione delle firme Text richiede un semplice codice Java."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Text dal tuo documento Dot"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornisce una funzione utile per cancellare documenti Dot di firme Text con poche righe di codice.
