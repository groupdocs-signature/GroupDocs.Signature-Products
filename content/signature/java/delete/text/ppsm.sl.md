...
############################# Head ############################
head_title: "Izbrišite podpise Text iz datotek Ppsm prek Java"
head_description: "Brisanje določenih podpisov Text iz podpisanih dokumentov Ppsm je mogoče preprosto izvesti s kratko kodo Java."

############################# Header ############################
title: "Odstranite podpise Text, ki so v datotekah Ppsm"
description: "Izbrišite različne podpise Text iz dokumentov Ppsm. Odstranjevanje podpisov Text zahteva preprosto kodo Java."
...
steps:
    enable: true
    title_left: "Kako odstraniti podpise Text iz vašega dokumenta Ppsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nudi uporabno funkcijo za čiščenje dokumentov Ppsm podpisov Text z nekaj vrsticami kode.
