...
############################# Head ############################
head_title: "Slet Text signaturer fra Rtf filer via Java"
head_description: "Sletning af specifikke Text-signaturer fra signerede Rtf-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer, der er placeret i Rtf-filer"
description: "Slet forskellige Text-signaturer fra Rtf-dokumenter. Fjernelse af Text signaturer kræver simpel Java kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Rtf dokumenter for Text signaturer med et par linjer kode.
