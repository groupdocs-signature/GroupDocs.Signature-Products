...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Xlsm-filer via Java"
head_description: "Radering av specifika Text-signaturer från signerade Xlsm-dokument kan enkelt utföras med kort Java-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Xlsm-filer"
description: "Ta bort olika Text-signaturer från Xlsm-dokument. Att ta bort Text-signaturer kräver enkel Java-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Text-signaturer från ditt Xlsm-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Xlsm dokument från Text signaturer med några rader kod.
