...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Xltm failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Xltm dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Xltm failuose"
description: "Ištrinkite įvairius Text parašus iš Xltm dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Xltm dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Xltm dokumentus nuo Text parašų naudojant kelias kodo eilutes.
