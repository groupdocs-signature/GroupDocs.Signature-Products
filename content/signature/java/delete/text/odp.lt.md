...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Odp failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Odp dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Odp failuose"
description: "Ištrinkite įvairius Text parašus iš Odp dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Odp dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Odp dokumentus nuo Text parašų naudojant kelias kodo eilutes.
