...
############################# Head ############################
head_title: "Eliminar Text firmas de Xltx archivos a través de Java"
head_description: "La eliminación de firmas Text específicas de documentos Xltx firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Text firmas que se colocan en archivos Xltx"
description: "Elimine varias firmas Text de los documentos Xltx. Eliminar las firmas Text requiere un código Java simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Text de su documento Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Xltx de Text firmas con unas pocas líneas de código.
