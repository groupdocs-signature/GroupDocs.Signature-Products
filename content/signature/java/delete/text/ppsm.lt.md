...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Ppsm failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Ppsm dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Ppsm failuose"
description: "Ištrinkite įvairius Text parašus iš Ppsm dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Ppsm dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ppsm dokumentus nuo Text parašų naudojant kelias kodo eilutes.
