...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Dot-filer via Java"
head_description: "Radering av specifika Text-signaturer från signerade Dot-dokument kan enkelt utföras med kort Java-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Dot-filer"
description: "Ta bort olika Text-signaturer från Dot-dokument. Att ta bort Text-signaturer kräver enkel Java-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Text-signaturer från ditt Dot-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Dot dokument från Text signaturer med några rader kod.
