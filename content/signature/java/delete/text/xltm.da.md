...
############################# Head ############################
head_title: "Slet Text signaturer fra Xltm filer via Java"
head_description: "Sletning af specifikke Text-signaturer fra signerede Xltm-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer, der er placeret i Xltm-filer"
description: "Slet forskellige Text-signaturer fra Xltm-dokumenter. Fjernelse af Text signaturer kræver simpel Java kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Xltm dokumenter for Text signaturer med et par linjer kode.
