...
############################# Head ############################
head_title: "Excluir assinaturas Text de arquivos Pptx via Java"
head_description: "A exclusão de assinaturas Text específicas de documentos Pptx assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Text que são colocadas em arquivos Pptx"
description: "Exclua várias assinaturas Text de documentos Pptx. A remoção de assinaturas Text requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Pptx de assinaturas Text com algumas linhas de código.
