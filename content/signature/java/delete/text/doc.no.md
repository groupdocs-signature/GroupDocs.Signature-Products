...
############################# Head ############################
head_title: "Slett Text-signaturer fra Doc-filer via Java"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Doc-dokumenter kan enkelt utføres med kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Doc-filer"
description: "Slett forskjellige Text-signaturer fra Doc-dokumenter. Fjerning av Text-signaturer krever enkel Java-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Text-signaturer fra Doc-dokumentet"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gir nyttig funksjon for å tømme Doc dokumenter for Text signaturer med noen få linjer med kode.
