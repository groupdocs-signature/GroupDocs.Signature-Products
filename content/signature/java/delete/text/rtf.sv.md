...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Rtf-filer via Java"
head_description: "Radering av specifika Text-signaturer från signerade Rtf-dokument kan enkelt utföras med kort Java-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Rtf-filer"
description: "Ta bort olika Text-signaturer från Rtf-dokument. Att ta bort Text-signaturer kräver enkel Java-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Rtf dokument från Text signaturer med några rader kod.
