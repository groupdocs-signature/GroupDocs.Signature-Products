...
############################# Head ############################
head_title: "Dzēst Text parakstus no Xlsx failiem, izmantojot Java"
head_description: "Konkrētu Text parakstu dzēšanu no parakstītiem Xlsx dokumentiem var viegli veikt, izmantojot īsu Java kodu."

############################# Header ############################
title: "Noņemiet Text parakstus, kas ir ievietoti Xlsx failos"
description: "Izdzēsiet dažādus Text parakstus no Xlsx dokumentiem. Lai noņemtu Text parakstus, ir nepieciešams vienkāršs Java kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina noderīgu līdzekli, lai no Xlsx dokumentiem notīrītu Text parakstus, izmantojot dažas koda rindiņas.
