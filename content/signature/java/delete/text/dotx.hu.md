...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Dotx fájlokból a Java segítségével"
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Dotx dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
