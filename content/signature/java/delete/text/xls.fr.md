...
############################# Head ############################
head_title: "Supprimez les signatures Text des fichiers Xls via Java"
head_description: "La suppression de signatures Text spécifiques à partir de documents Xls signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Text qui sont placées dans les fichiers Xls"
description: "Supprimez diverses signatures Text des documents Xls. La suppression des signatures Text nécessite un code Java simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Text de votre document Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Xls des signatures Text avec quelques lignes de code.
