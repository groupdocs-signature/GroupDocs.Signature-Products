...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Rtf läbi Java"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Rtf dokumentidest saab hõlpsasti teostada lühikese Java koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Rtf"
description: "Kustutage erinevad allkirjad Text dokumentidest Rtf. Allkirjade Text eemaldamine nõuab lihtsat Java koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Text oma dokumendist Rtf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pakub kasulikku funktsiooni Rtf dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
