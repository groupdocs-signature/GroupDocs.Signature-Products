...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Potm failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Potm dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Potm failuose"
description: "Ištrinkite įvairius Text parašus iš Potm dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Potm dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Potm dokumentus nuo Text parašų naudojant kelias kodo eilutes.
