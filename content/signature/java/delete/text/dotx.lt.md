...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Dotx failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Dotx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Dotx failuose"
description: "Ištrinkite įvairius Text parašus iš Dotx dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Dotx dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Dotx dokumentus nuo Text parašų naudojant kelias kodo eilutes.
