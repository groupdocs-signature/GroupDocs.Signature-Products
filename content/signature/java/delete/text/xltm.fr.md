...
############################# Head ############################
head_title: "Supprimez les signatures Text des fichiers Xltm via Java"
head_description: "La suppression de signatures Text spécifiques à partir de documents Xltm signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Text qui sont placées dans les fichiers Xltm"
description: "Supprimez diverses signatures Text des documents Xltm. La suppression des signatures Text nécessite un code Java simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Text de votre document Xltm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Xltm des signatures Text avec quelques lignes de code.
