...
############################# Head ############################
head_title: "Delete Text signatures from Doc files via Java"
head_description: "Deletion of specific Text signatures from signed Doc documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Text signatures which are placed in Doc files"
description: "Delete various Text signatures from Doc documents. Removing Text signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Text signatures from your Doc document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Doc documents of Text signatures with a few lines of code.
