...
############################# Head ############################
head_title: "Scrios Text sínithe ó chomhaid Ots trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Text ar leith ó dhoiciméid shínithe Ots le cód gearr Java."

############################# Header ############################
title: "Bain Text sínithe a chuirtear i gcomhaid Ots"
description: "Scrios Text sínithe éagsúla ó Ots doiciméid. Teastaíonn cód simplí Java chun sínithe Text a bhaint."
...
steps:
    ...
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Ots doiciméad de Text sínithe a ghlanadh le cúpla líne de chód.
