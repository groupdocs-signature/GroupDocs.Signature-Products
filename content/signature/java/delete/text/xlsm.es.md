...
############################# Head ############################
head_title: "Eliminar Text firmas de Xlsm archivos a través de Java"
head_description: "La eliminación de firmas Text específicas de documentos Xlsm firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Text firmas que se colocan en archivos Xlsm"
description: "Elimine varias firmas Text de los documentos Xlsm. Eliminar las firmas Text requiere un código Java simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Text de su documento Xlsm"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Xlsm de Text firmas con unas pocas líneas de código.
