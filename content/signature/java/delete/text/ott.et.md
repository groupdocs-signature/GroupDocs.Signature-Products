...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Ott läbi Java"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Ott dokumentidest saab hõlpsasti teostada lühikese Java koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Ott"
description: "Kustutage erinevad allkirjad Text dokumentidest Ott. Allkirjade Text eemaldamine nõuab lihtsat Java koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Text oma dokumendist Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) pakub kasulikku funktsiooni Ott dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
