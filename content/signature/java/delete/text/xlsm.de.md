...
############################# Head ############################
head_title: "Löschen Sie Text-Signaturen aus Xlsm-Dateien über Java"
head_description: "Das Löschen bestimmter Text-Signaturen aus signierten Xlsm-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Text-Signaturen, die in Xlsm-Dateien platziert sind"
description: "Löschen Sie verschiedene Text-Signaturen aus Xlsm-Dokumenten. Das Entfernen von Text-Signaturen erfordert einfachen Java-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Xlsm-Dokumenten von Text-Signaturen mit ein paar Codezeilen.
