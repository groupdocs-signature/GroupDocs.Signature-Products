...
############################# Head ############################
head_title: "Slet Text signaturer fra Xlsm filer via Java"
head_description: "Sletning af specifikke Text-signaturer fra signerede Xlsm-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Text-signaturer, der er placeret i Xlsm-filer"
description: "Slet forskellige Text-signaturer fra Xlsm-dokumenter. Fjernelse af Text signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Text-signaturer fra dit Xlsm-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Xlsm dokumenter for Text signaturer med et par linjer kode.
