...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Ppsx failų naudodami Java"
head_description: "Konkrečius Text parašus iš pasirašytų Ppsx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Ppsx failuose"
description: "Ištrinkite įvairius Text parašus iš Ppsx dokumentų. Norint pašalinti Text parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Ppsx dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ppsx dokumentus nuo Text parašų naudojant kelias kodo eilutes.
...
more_formats:
    enable: true
    title: "Ištrinkite savo Text parašus naudodami Java"
    content: |
