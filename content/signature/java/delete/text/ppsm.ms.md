...
############################# Head ############################
head_title: "Padamkan tandatangan Text daripada fail Ppsm melalui Java"
head_description: "Pemadaman tandatangan Text tertentu daripada dokumen Ppsm yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Text yang diletakkan dalam fail Ppsm."
description: "Padamkan pelbagai tandatangan Text daripada dokumen Ppsm. Mengalih keluar tandatangan Text memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Text daripada dokumen Ppsm anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Ppsm dokumen daripada Text tandatangan dengan beberapa baris kod.
...
more_formats:
    enable: true
    title: "Padamkan tandatangan Text anda dengan Java"
    content: |
