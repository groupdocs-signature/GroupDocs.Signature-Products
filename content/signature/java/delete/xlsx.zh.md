...
############################# Head ############################
head_title: "使用 Java 从 XLSX 中删除签名"
head_description: "使用 GroupDocs.Signature for Java 可以轻松地从已签名的 XLSX 文档中删除数字签名、条形码、文本、图像及元数据签名。"
...
steps:
    enable: true
    title: "使用 Java 从 XLSX 中删除电子签名的步骤"
    content: |
      [GroupDocs.Signature](/signature/java/) 使 Java 开发者能够通过遵循几个简单的步骤，在其应用程序中删除 XLSX 文件中的电子签名。
      
      1. 将 XLSX 路径传递给 Signature 类的一个实例。
