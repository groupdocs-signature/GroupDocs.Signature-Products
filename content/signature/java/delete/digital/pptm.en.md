...
############################# Head ############################
head_title: "Delete Digital signatures from Pptm files via Java"
head_description: "Deletion of specific Digital signatures from signed Pptm documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Pptm files"
description: "Delete various Digital signatures from Pptm documents. Removing Digital signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Digital signatures from your Pptm document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Pptm documents of Digital signatures with a few lines of code.
