...
############################# Head ############################
head_title: "Izbrišite podpise Digital iz datotek Ots prek Java"
head_description: "Brisanje določenih podpisov Digital iz podpisanih dokumentov Ots je mogoče preprosto izvesti s kratko kodo Java."

############################# Header ############################
title: "Odstranite podpise Digital, ki so v datotekah Ots"
description: "Izbrišite različne podpise Digital iz dokumentov Ots. Odstranjevanje podpisov Digital zahteva preprosto kodo Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nudi uporabno funkcijo za čiščenje dokumentov Ots podpisov Digital z nekaj vrsticami kode.
