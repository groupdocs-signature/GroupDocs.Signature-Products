...
############################# Head ############################
head_title: "Löschen Sie Digital-Signaturen aus Docm-Dateien über Java"
head_description: "Das Löschen bestimmter Digital-Signaturen aus signierten Docm-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Digital-Signaturen, die in Docm-Dateien platziert sind"
description: "Löschen Sie verschiedene Digital-Signaturen aus Docm-Dokumenten. Das Entfernen von Digital-Signaturen erfordert einfachen Java-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Digital-Signaturen aus Ihrem Docm-Dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Docm-Dokumenten von Digital-Signaturen mit ein paar Codezeilen.
