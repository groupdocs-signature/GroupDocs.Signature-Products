...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Dot via Java"
head_description: "A exclusão de assinaturas Digital específicas de documentos Dot assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Dot"
description: "Exclua várias assinaturas Digital de documentos Dot. A remoção de assinaturas Digital requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Dot de assinaturas Digital com algumas linhas de código.
