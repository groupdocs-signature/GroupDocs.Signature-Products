...
############################# Head ############################
head_title: "Eliminar Digital firmas de Ods archivos a través de Java"
head_description: "La eliminación de firmas Digital específicas de documentos Ods firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Digital firmas que se colocan en archivos Ods"
description: "Elimine varias firmas Digital de los documentos Ods. Eliminar las firmas Digital requiere un código Java simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Ods de Digital firmas con unas pocas líneas de código.
