...
############################# Head ############################
head_title: "Odstraňte podpisy Digital ze souborů Dot prostřednictvím Java"
head_description: "Odstranění konkrétních podpisů Digital z podepsaných dokumentů Dot lze snadno provést pomocí krátkého kódu Java."

############################# Header ############################
title: "Odstraňte Digital podpisy, které jsou umístěny v souborech Dot"
description: "Odstraňte různé podpisy Digital z dokumentů Dot. Odstranění podpisů Digital vyžaduje jednoduchý kód Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje užitečnou funkci pro vymazání Dot dokumentů od Digital podpisů pomocí několika řádků kódu.
