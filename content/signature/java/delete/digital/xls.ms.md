...
############################# Head ############################
head_title: "Padamkan tandatangan Digital daripada fail Xls melalui Java"
head_description: "Pemadaman tandatangan Digital tertentu daripada dokumen Xls yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Digital yang diletakkan dalam fail Xls."
description: "Padamkan pelbagai tandatangan Digital daripada dokumen Xls. Mengalih keluar tandatangan Digital memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Digital daripada dokumen Xls anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Xls dokumen daripada Digital tandatangan dengan beberapa baris kod.
