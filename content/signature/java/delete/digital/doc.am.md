...
############################# Head ############################
head_title: "የDigital ፊርማዎችን ከDoc ፋይሎች በJava በኩል ሰርዝ"
head_description: "ከተፈረሙ Doc ሰነዶች የተወሰኑ የDigital ፊርማዎችን መሰረዝ በአጭር የJava ኮድ በቀላሉ ሊከናወን ይችላል።"

############################# Header ############################
title: "በDoc ፋይሎች ውስጥ የተቀመጡትን የDigital ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የDigital ፊርማዎችን ከDoc ሰነዶች ሰርዝ። የDigital ፊርማዎችን ማስወገድ ቀላል የJava ኮድ ያስፈልገዋል።"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የDoc ሰነዶችን የDigital ፊርማዎችን በጥቂት የኮድ መስመሮች ለማጽዳት ጠቃሚ ባህሪን ይሰጣል።
