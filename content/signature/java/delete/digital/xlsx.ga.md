...
############################# Head ############################
head_title: "Scrios Digital sínithe ó chomhaid Xlsx trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Digital ar leith ó dhoiciméid shínithe Xlsx le cód gearr Java."

############################# Header ############################
title: "Bain Digital sínithe a chuirtear i gcomhaid Xlsx"
description: "Scrios Digital sínithe éagsúla ó Xlsx doiciméid. Teastaíonn cód simplí Java chun sínithe Digital a bhaint."
...
steps:
    enable: true
    title_left: "Conas Digital sínithe a bhaint de do dhoiciméad Xlsx"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Xlsx doiciméad de Digital sínithe a ghlanadh le cúpla líne de chód.
