...
############################# Head ############################
head_title: "Elimina le firme Digital dai file Pptx tramite Java"
head_description: "L'eliminazione di firme Digital specifiche da documenti Pptx firmati può essere eseguita facilmente con il codice Java breve."

############################# Header ############################
title: "Rimuovi le firme Digital che sono inserite nei file Pptx"
description: "Elimina varie firme Digital da documenti Pptx. La rimozione delle firme Digital richiede un semplice codice Java."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Digital dal tuo documento Pptx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornisce una funzione utile per cancellare documenti Pptx di firme Digital con poche righe di codice.
