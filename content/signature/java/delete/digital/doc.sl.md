...
############################# Head ############################
head_title: "Izbrišite podpise Digital iz datotek Doc prek Java"
head_description: "Brisanje določenih podpisov Digital iz podpisanih dokumentov Doc je mogoče preprosto izvesti s kratko kodo Java."

############################# Header ############################
title: "Odstranite podpise Digital, ki so v datotekah Doc"
description: "Izbrišite različne podpise Digital iz dokumentov Doc. Odstranjevanje podpisov Digital zahteva preprosto kodo Java."
...
steps:
    enable: true
    title_left: "Kako odstraniti podpise Digital iz vašega dokumenta Doc"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nudi uporabno funkcijo za čiščenje dokumentov Doc podpisov Digital z nekaj vrsticami kode.
