...
############################# Head ############################
head_title: "Usuń podpisy Digital z plików Xlsx przez Java"
head_description: "Usuwanie określonych podpisów Digital z podpisanych dokumentów Xlsx można łatwo wykonać za pomocą krótkiego kodu Java."

############################# Header ############################
title: "Usuń Digital podpisy umieszczone w plikach Xlsx"
description: "Usuń różne podpisy Digital z dokumentów Xlsx. Usunięcie podpisów Digital wymaga prostego kodu Java."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Digital z dokumentu Xlsx?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zapewnia użyteczną funkcję do czyszczenia dokumentów Xlsx z podpisami Digital za pomocą kilku linijek kodu.
