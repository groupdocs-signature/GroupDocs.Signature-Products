...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Xls via Java"
head_description: "A exclusão de assinaturas Digital específicas de documentos Xls assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Xls"
description: "Exclua várias assinaturas Digital de documentos Xls. A remoção de assinaturas Digital requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Digital do seu documento Xls"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Xls de assinaturas Digital com algumas linhas de código.
