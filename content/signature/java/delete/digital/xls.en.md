...
############################# Head ############################
head_title: "Delete Digital signatures from Xls files via Java"
head_description: "Deletion of specific Digital signatures from signed Xls documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Xls files"
description: "Delete various Digital signatures from Xls documents. Removing Digital signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Xls documents of Digital signatures with a few lines of code.
