...
############################# Head ############################
head_title: "Usuń podpisy Digital z plików Xlsm przez Java"
head_description: "Usuwanie określonych podpisów Digital z podpisanych dokumentów Xlsm można łatwo wykonać za pomocą krótkiego kodu Java."

############################# Header ############################
title: "Usuń Digital podpisy umieszczone w plikach Xlsm"
description: "Usuń różne podpisy Digital z dokumentów Xlsm. Usunięcie podpisów Digital wymaga prostego kodu Java."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Digital z dokumentu Xlsm?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zapewnia użyteczną funkcję do czyszczenia dokumentów Xlsm z podpisami Digital za pomocą kilku linijek kodu.
