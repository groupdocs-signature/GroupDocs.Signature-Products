...
############################# Head ############################
head_title: "Bi rêya Java îmzeyên Digital ji pelên Pdf jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Digital ji belgeyên îmzekirî yên Pdf dibe ku bi koda kurt a Java bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Digital yên ku di pelên Pdf de cih digirin rakin"
description: "Ji belgeyên Pdf îmzeyên cihêreng ên Digital jêbirin. Ji rakirina îmzeyên Digital koda Java ya sade hewce dike."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji bo paqijkirina Pdf belgeyên Digital bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
