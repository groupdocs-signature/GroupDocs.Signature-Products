...
############################# Head ############################
head_title: "Hapus tanda tangan Digital dari file Odt melalui Java"
head_description: "Penghapusan tanda tangan Digital tertentu dari dokumen Odt yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Digital yang ditempatkan di file Odt"
description: "Hapus berbagai tanda tangan Digital dari dokumen Odt. Menghapus tanda tangan Digital memerlukan kode Java sederhana."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Odt dari Digital tanda tangan dengan beberapa baris kode.
