...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Odt via Java"
head_description: "A exclusão de assinaturas Digital específicas de documentos Odt assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Odt"
description: "Exclua várias assinaturas Digital de documentos Odt. A remoção de assinaturas Digital requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Odt de assinaturas Digital com algumas linhas de código.
