...
############################# Head ############################
head_title: "Delete Digital signatures from Xltx files via Java"
head_description: "Deletion of specific Digital signatures from signed Xltx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Xltx files"
description: "Delete various Digital signatures from Xltx documents. Removing Digital signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Xltx documents of Digital signatures with a few lines of code.
