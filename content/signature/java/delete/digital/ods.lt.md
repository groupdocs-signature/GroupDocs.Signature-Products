...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Ods failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Ods dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Ods failuose"
description: "Ištrinkite įvairius Digital parašus iš Ods dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Ods dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ods dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
