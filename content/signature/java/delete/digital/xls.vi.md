...
############################# Head ############################
head_title: "Xóa chữ ký Digital khỏi tệp Xls qua Java"
head_description: "Việc xóa các chữ ký Digital cụ thể khỏi các tài liệu Xls đã ký có thể được thực hiện dễ dàng với mã Java ngắn."

############################# Header ############################
title: "Xóa các chữ ký Digital được đặt trong các tệp Xls"
description: "Xóa các chữ ký Digital khác nhau khỏi tài liệu Xls. Việc xóa chữ ký Digital yêu cầu mã Java đơn giản."
...
steps:
    enable: true
    title_left: "Cách xóa chữ ký Digital khỏi tài liệu Xls của bạn"
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp tính năng hữu ích để xóa các tài liệu Xls có chữ ký Digital bằng một vài dòng mã.
