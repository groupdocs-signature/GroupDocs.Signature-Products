...
############################# Head ############################
head_title: "Delete Digital signatures from Odt files via Java"
head_description: "Deletion of specific Digital signatures from signed Odt documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Odt files"
description: "Delete various Digital signatures from Odt documents. Removing Digital signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Digital signatures from your Odt document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Odt documents of Digital signatures with a few lines of code.
