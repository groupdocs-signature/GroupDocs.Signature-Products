...
############################# Head ############################
head_title: "Izbrišite podpise Digital iz datotek Pdf prek Java"
head_description: "Brisanje določenih podpisov Digital iz podpisanih dokumentov Pdf je mogoče preprosto izvesti s kratko kodo Java."

############################# Header ############################
title: "Odstranite podpise Digital, ki so v datotekah Pdf"
description: "Izbrišite različne podpise Digital iz dokumentov Pdf. Odstranjevanje podpisov Digital zahteva preprosto kodo Java."
...
steps:
    enable: true
    title_left: "Kako odstraniti podpise Digital iz vašega dokumenta Pdf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nudi uporabno funkcijo za čiščenje dokumentov Pdf podpisov Digital z nekaj vrsticami kode.
