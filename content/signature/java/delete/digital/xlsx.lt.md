...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Xlsx failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Xlsx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Xlsx failuose"
description: "Ištrinkite įvairius Digital parašus iš Xlsx dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Xlsx dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Xlsx dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
