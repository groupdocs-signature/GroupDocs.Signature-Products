...
############################# Head ############################
head_title: "Padamkan tandatangan Digital daripada fail Dot melalui Java"
head_description: "Pemadaman tandatangan Digital tertentu daripada dokumen Dot yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Digital yang diletakkan dalam fail Dot."
description: "Padamkan pelbagai tandatangan Digital daripada dokumen Dot. Mengalih keluar tandatangan Digital memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Digital daripada dokumen Dot anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Dot dokumen daripada Digital tandatangan dengan beberapa baris kod.
