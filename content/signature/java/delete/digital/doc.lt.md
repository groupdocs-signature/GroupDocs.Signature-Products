...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Doc failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Doc dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Doc failuose"
description: "Ištrinkite įvairius Digital parašus iš Doc dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Doc dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
