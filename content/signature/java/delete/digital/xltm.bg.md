...
############################# Head ############################
head_title: "Изтрийте Digital подписи от Xltm файлове чрез Java"
head_description: "Изтриването на конкретни Digital подписи от подписани Xltm документи може да се извърши лесно с кратък Java код."

############################# Header ############################
title: "Премахнете Digital подписи, които са поставени във Xltm файлове"
description: "Изтрийте различни подписи Digital от Xltm документи. Премахването на подписи Digital изисква прост код Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) предоставя полезна функция за изчистване на Xltm документи от Digital подписи с няколко реда код.
