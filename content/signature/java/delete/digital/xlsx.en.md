...
############################# Head ############################
head_title: "Delete Digital signatures from Xlsx files via Java"
head_description: "Deletion of specific Digital signatures from signed Xlsx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Xlsx files"
description: "Delete various Digital signatures from Xlsx documents. Removing Digital signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Xlsx documents of Digital signatures with a few lines of code.
