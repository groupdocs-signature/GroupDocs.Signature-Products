...
############################# Head ############################
head_title: "Delete Digital signatures from Docx files via Java"
head_description: "Deletion of specific Digital signatures from signed Docx documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Docx files"
description: "Delete various Digital signatures from Docx documents. Removing Digital signatures requires simple Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Docx documents of Digital signatures with a few lines of code.
