...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Ots failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Ots dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Ots failuose"
description: "Ištrinkite įvairius Digital parašus iš Ots dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ots dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
