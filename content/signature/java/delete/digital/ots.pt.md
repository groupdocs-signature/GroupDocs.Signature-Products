...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Ots via Java"
head_description: "A exclusão de assinaturas Digital específicas de documentos Ots assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Ots"
description: "Exclua várias assinaturas Digital de documentos Ots. A remoção de assinaturas Digital requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Digital do seu documento Ots"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Ots de assinaturas Digital com algumas linhas de código.
