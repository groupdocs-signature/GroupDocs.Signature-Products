...
############################# Head ############################
head_title: "Hapus tanda tangan Digital dari file Pptx melalui Java"
head_description: "Penghapusan tanda tangan Digital tertentu dari dokumen Pptx yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Digital yang ditempatkan di file Pptx"
description: "Hapus berbagai tanda tangan Digital dari dokumen Pptx. Menghapus tanda tangan Digital memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Digital dari dokumen Pptx Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Pptx dari Digital tanda tangan dengan beberapa baris kode.
