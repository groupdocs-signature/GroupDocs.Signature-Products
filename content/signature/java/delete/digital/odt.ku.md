...
############################# Head ############################
head_title: "Bi rêya Java îmzeyên Digital ji pelên Odt jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Digital ji belgeyên îmzekirî yên Odt dibe ku bi koda kurt a Java bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Digital yên ku di pelên Odt de cih digirin rakin"
description: "Ji belgeyên Odt îmzeyên cihêreng ên Digital jêbirin. Ji rakirina îmzeyên Digital koda Java ya sade hewce dike."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzayên Digital ji belgeya xweya Odt rabike"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ji bo paqijkirina Odt belgeyên Digital bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
