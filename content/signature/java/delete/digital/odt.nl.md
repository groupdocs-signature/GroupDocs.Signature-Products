...
############################# Head ############################
head_title: "Verwijder Digital handtekeningen uit Odt bestanden via Java"
head_description: "Het verwijderen van specifieke Digital handtekeningen uit ondertekende Odt documenten kan gemakkelijk worden uitgevoerd met korte Java code."

############################# Header ############################
title: "Verwijder Digital handtekeningen die in Odt bestanden zijn geplaatst"
description: "Verwijder verschillende Digital handtekeningen uit Odt documenten. Voor het verwijderen van Digital-handtekeningen is een eenvoudige Java-code vereist."
...
steps:
    enable: true
    title_left: "Hoe Digital handtekeningen te verwijderen uit uw Odt document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt een handige functie voor het wissen van Odt documenten van Digital handtekeningen met een paar regels code.
