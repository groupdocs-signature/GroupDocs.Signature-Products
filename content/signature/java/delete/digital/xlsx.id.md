...
############################# Head ############################
head_title: "Hapus tanda tangan Digital dari file Xlsx melalui Java"
head_description: "Penghapusan tanda tangan Digital tertentu dari dokumen Xlsx yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Digital yang ditempatkan di file Xlsx"
description: "Hapus berbagai tanda tangan Digital dari dokumen Xlsx. Menghapus tanda tangan Digital memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Digital dari dokumen Xlsx Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Xlsx dari Digital tanda tangan dengan beberapa baris kode.
...
more_formats:
    enable: true
    title: "Hapus tanda tangan Digital Anda dengan Java"
    content: |
