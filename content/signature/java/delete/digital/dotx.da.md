...
############################# Head ############################
head_title: "Slet Digital signaturer fra Dotx filer via Java"
head_description: "Sletning af specifikke Digital-signaturer fra signerede Dotx-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Digital-signaturer, der er placeret i Dotx-filer"
description: "Slet forskellige Digital-signaturer fra Dotx-dokumenter. Fjernelse af Digital signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Digital-signaturer fra dit Dotx-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Dotx dokumenter for Digital signaturer med et par linjer kode.
