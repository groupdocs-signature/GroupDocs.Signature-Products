...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Xltx failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Xltx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Xltx failuose"
description: "Ištrinkite įvairius Digital parašus iš Xltx dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Xltx dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Xltx dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
