...
############################# Head ############################
head_title: "Scrios Digital sínithe ó chomhaid Xls trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Digital ar leith ó dhoiciméid shínithe Xls le cód gearr Java."

############################# Header ############################
title: "Bain Digital sínithe a chuirtear i gcomhaid Xls"
description: "Scrios Digital sínithe éagsúla ó Xls doiciméid. Teastaíonn cód simplí Java chun sínithe Digital a bhaint."
...
steps:
    enable: true
    title_left: "Conas Digital sínithe a bhaint de do dhoiciméad Xls"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Xls doiciméad de Digital sínithe a ghlanadh le cúpla líne de chód.
