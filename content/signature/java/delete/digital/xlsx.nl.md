...
############################# Head ############################
head_title: "Verwijder Digital handtekeningen uit Xlsx bestanden via Java"
head_description: "Het verwijderen van specifieke Digital handtekeningen uit ondertekende Xlsx documenten kan gemakkelijk worden uitgevoerd met korte Java code."

############################# Header ############################
title: "Verwijder Digital handtekeningen die in Xlsx bestanden zijn geplaatst"
description: "Verwijder verschillende Digital handtekeningen uit Xlsx documenten. Voor het verwijderen van Digital-handtekeningen is een eenvoudige Java-code vereist."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) biedt een handige functie voor het wissen van Xlsx documenten van Digital handtekeningen met een paar regels code.
