...
############################# Head ############################
head_title: "Usuń podpisy Digital z plików Xltm przez Java"
head_description: "Usuwanie określonych podpisów Digital z podpisanych dokumentów Xltm można łatwo wykonać za pomocą krótkiego kodu Java."

############################# Header ############################
title: "Usuń Digital podpisy umieszczone w plikach Xltm"
description: "Usuń różne podpisy Digital z dokumentów Xltm. Usunięcie podpisów Digital wymaga prostego kodu Java."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Digital z dokumentu Xltm?"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zapewnia użyteczną funkcję do czyszczenia dokumentów Xltm z podpisami Digital za pomocą kilku linijek kodu.
