...
############################# Head ############################
head_title: "Scrios Digital sínithe ó chomhaid Dotx trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Digital ar leith ó dhoiciméid shínithe Dotx le cód gearr Java."

############################# Header ############################
title: "Bain Digital sínithe a chuirtear i gcomhaid Dotx"
description: "Scrios Digital sínithe éagsúla ó Dotx doiciméid. Teastaíonn cód simplí Java chun sínithe Digital a bhaint."
...
steps:
    enable: true
    title_left: "Conas Digital sínithe a bhaint de do dhoiciméad Dotx"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Dotx doiciméad de Digital sínithe a ghlanadh le cúpla líne de chód.
