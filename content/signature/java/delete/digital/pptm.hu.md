...
############################# Head ############################
head_title: "Törölje a Digital aláírásokat a Pptm fájlokból a Java segítségével"
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Digital aláírásokat a Pptm dokumentumból"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Pptm dokumentumok Digital aláírásainak néhány soros kóddal történő törléséhez.
