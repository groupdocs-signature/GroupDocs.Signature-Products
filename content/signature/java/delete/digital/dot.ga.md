...
############################# Head ############################
head_title: "Scrios Digital sínithe ó chomhaid Dot trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Digital ar leith ó dhoiciméid shínithe Dot le cód gearr Java."

############################# Header ############################
title: "Bain Digital sínithe a chuirtear i gcomhaid Dot"
description: "Scrios Digital sínithe éagsúla ó Dot doiciméid. Teastaíonn cód simplí Java chun sínithe Digital a bhaint."
...
steps:
    ...
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Dot doiciméad de Digital sínithe a ghlanadh le cúpla líne de chód.
