...
############################# Head ############################
head_title: "Eliminar Digital firmas de Pptx archivos a través de Java"
head_description: "La eliminación de firmas Digital específicas de documentos Pptx firmados se puede realizar fácilmente con el código corto Java."

############################# Header ############################
title: "Eliminar Digital firmas que se colocan en archivos Pptx"
description: "Elimine varias firmas Digital de los documentos Pptx. Eliminar las firmas Digital requiere un código Java simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Digital de su documento Pptx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) proporciona una característica útil para borrar documentos Pptx de Digital firmas con unas pocas líneas de código.
