...
############################# Head ############################
head_title: "Java aracılığıyla Ots dosyalarından Digital imzasını silin"
head_description: "İmzalı Ots belgelerindeki belirli Digital imzalarının silinmesi kısa Java koduyla kolayca gerçekleştirilebilir."

############################# Header ############################
title: "Ots dosyalarına yerleştirilmiş Digital imzalarını kaldırın"
description: "Ots dokümanlarından çeşitli Digital imzalarını silin. Digital imzasını kaldırmak için basit Java kodu gerekir."
...
steps:
    enable: true
    title_left: "Ots belgenizden Digital imzaları nasıl kaldırılır"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Ots belgelerindeki Digital imzalarını birkaç satır kodla temizlemek için kullanışlı bir özellik sağlar.
