...
############################# Head ############################
head_title: "Törölje a Digital aláírásokat a Xltx fájlokból a Java segítségével"
head_description: "Az aláírt Xltx dokumentumokból bizonyos Digital aláírások törlése egyszerűen végrehajtható rövid Java kóddal."

############################# Header ############################
title: "Távolítsa el a Digital aláírásokat, amelyek a Xltx fájlokban vannak elhelyezve"
description: "Törölje a különböző Digital aláírásokat a Xltx dokumentumokból. A Digital aláírások eltávolításához egyszerű Java kód szükséges."
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Digital aláírásokat a Xltx dokumentumból"
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Xltx dokumentumok Digital aláírásainak néhány soros kóddal történő törléséhez.
