...
############################# Head ############################
head_title: "Supprimez les signatures Digital des fichiers Xltx via Java"
head_description: "La suppression de signatures Digital spécifiques à partir de documents Xltx signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Digital qui sont placées dans les fichiers Xltx"
description: "Supprimez diverses signatures Digital des documents Xltx. La suppression des signatures Digital nécessite un code Java simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Digital de votre document Xltx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Xltx des signatures Digital avec quelques lignes de code.
