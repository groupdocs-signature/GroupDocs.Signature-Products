...
############################# Head ############################
head_title: "Xóa chữ ký Digital khỏi tệp Pptm qua Java"
head_description: "Việc xóa các chữ ký Digital cụ thể khỏi các tài liệu Pptm đã ký có thể được thực hiện dễ dàng với mã Java ngắn."

############################# Header ############################
title: "Xóa các chữ ký Digital được đặt trong các tệp Pptm"
description: "Xóa các chữ ký Digital khác nhau khỏi tài liệu Pptm. Việc xóa chữ ký Digital yêu cầu mã Java đơn giản."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java] (https://products.groupdocs.com/signature/java/) cung cấp tính năng hữu ích để xóa các tài liệu Pptm có chữ ký Digital bằng một vài dòng mã.
