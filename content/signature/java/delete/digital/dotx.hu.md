...
############################# Head ############################
head_title: "Törölje a Digital aláírásokat a Dotx fájlokból a Java segítségével"
head_description: "Az aláírt Dotx dokumentumokból bizonyos Digital aláírások törlése egyszerűen végrehajtható rövid Java kóddal."

############################# Header ############################
title: "Távolítsa el a Digital aláírásokat, amelyek a Dotx fájlokban vannak elhelyezve"
description: "Törölje a különböző Digital aláírásokat a Dotx dokumentumokból. A Digital aláírások eltávolításához egyszerű Java kód szükséges."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Dotx dokumentumok Digital aláírásainak néhány soros kóddal történő törléséhez.
