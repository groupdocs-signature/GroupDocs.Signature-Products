...
############################# Head ############################
head_title: "Padamkan tandatangan Digital daripada fail Docm melalui Java"
head_description: "Pemadaman tandatangan Digital tertentu daripada dokumen Docm yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Digital yang diletakkan dalam fail Docm."
description: "Padamkan pelbagai tandatangan Digital daripada dokumen Docm. Mengalih keluar tandatangan Digital memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Digital daripada dokumen Docm anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Docm dokumen daripada Digital tandatangan dengan beberapa baris kod.
