...
############################# Head ############################
head_title: "Löschen Sie Digital-Signaturen aus Xlsx-Dateien über Java"
head_description: "Das Löschen bestimmter Digital-Signaturen aus signierten Xlsx-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Digital-Signaturen, die in Xlsx-Dateien platziert sind"
description: "Löschen Sie verschiedene Digital-Signaturen aus Xlsx-Dokumenten. Das Entfernen von Digital-Signaturen erfordert einfachen Java-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Xlsx-Dokumenten von Digital-Signaturen mit ein paar Codezeilen.
