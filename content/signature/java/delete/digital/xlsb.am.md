...
############################# Head ############################
head_title: "የDigital ፊርማዎችን ከXlsb ፋይሎች በJava በኩል ሰርዝ"
head_description: "ከተፈረሙ Xlsb ሰነዶች የተወሰኑ የDigital ፊርማዎችን መሰረዝ በአጭር የJava ኮድ በቀላሉ ሊከናወን ይችላል።"

############################# Header ############################
title: "በXlsb ፋይሎች ውስጥ የተቀመጡትን የDigital ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የDigital ፊርማዎችን ከXlsb ሰነዶች ሰርዝ። የDigital ፊርማዎችን ማስወገድ ቀላል የJava ኮድ ያስፈልገዋል።"
...
steps:
    enable: true
    title_left: "Digital ፊርማዎችን ከXlsb ሰነድዎ እንዴት ማስወገድ እንደሚቻል"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) የXlsb ሰነዶችን የDigital ፊርማዎችን በጥቂት የኮድ መስመሮች ለማጽዳት ጠቃሚ ባህሪን ይሰጣል።
