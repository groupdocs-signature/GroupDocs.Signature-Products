...
############################# Head ############################
head_title: "Suprimeix les signatures de Digital dels fitxers Dot mitjançant Java"
head_description: "L'eliminació de signatures específiques de Digital dels documents signats Dot es pot dur a terme fàcilment amb un codi Java curt."

############################# Header ############################
title: "Elimineu les signatures de Digital que es col·loquen als fitxers Dot"
description: "Suprimeix diverses signatures de Digital dels documents Dot. L'eliminació de signatures Digital requereix un codi Java senzill."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix una funció útil per esborrar documents de Dot de signatures de Digital amb unes poques línies de codi.
