...
############################# Head ############################
head_title: "Slet Digital signaturer fra Dot filer via Java"
head_description: "Sletning af specifikke Digital-signaturer fra signerede Dot-dokumenter kan udføres nemt med en kort Java-kode."

############################# Header ############################
title: "Fjern Digital-signaturer, der er placeret i Dot-filer"
description: "Slet forskellige Digital-signaturer fra Dot-dokumenter. Fjernelse af Digital signaturer kræver simpel Java kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Digital-signaturer fra dit Dot-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) giver nyttige funktioner til at rydde Dot dokumenter for Digital signaturer med et par linjer kode.
