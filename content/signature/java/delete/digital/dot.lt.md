...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Dot failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Dot dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Dot failuose"
description: "Ištrinkite įvairius Digital parašus iš Dot dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Dot dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Dot dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
