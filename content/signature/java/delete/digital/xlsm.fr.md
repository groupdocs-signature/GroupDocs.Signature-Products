...
############################# Head ############################
head_title: "Supprimez les signatures Digital des fichiers Xlsm via Java"
head_description: "La suppression de signatures Digital spécifiques à partir de documents Xlsm signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Digital qui sont placées dans les fichiers Xlsm"
description: "Supprimez diverses signatures Digital des documents Xlsm. La suppression des signatures Digital nécessite un code Java simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Xlsm des signatures Digital avec quelques lignes de code.
