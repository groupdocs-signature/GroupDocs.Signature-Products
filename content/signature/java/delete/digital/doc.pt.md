...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Doc via Java"
head_description: "A exclusão de assinaturas Digital específicas de documentos Doc assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Doc"
description: "Exclua várias assinaturas Digital de documentos Doc. A remoção de assinaturas Digital requer um código Java simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Doc de assinaturas Digital com algumas linhas de código.
