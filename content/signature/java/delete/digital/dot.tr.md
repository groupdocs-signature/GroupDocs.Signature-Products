...
############################# Head ############################
head_title: "Java aracılığıyla Dot dosyalarından Digital imzasını silin"
head_description: "İmzalı Dot belgelerindeki belirli Digital imzalarının silinmesi kısa Java koduyla kolayca gerçekleştirilebilir."

############################# Header ############################
title: "Dot dosyalarına yerleştirilmiş Digital imzalarını kaldırın"
description: "Dot dokümanlarından çeşitli Digital imzalarını silin. Digital imzasını kaldırmak için basit Java kodu gerekir."
...
steps:
    enable: true
    title_left: "Dot belgenizden Digital imzaları nasıl kaldırılır"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/), Dot belgelerindeki Digital imzalarını birkaç satır kodla temizlemek için kullanışlı bir özellik sağlar.
