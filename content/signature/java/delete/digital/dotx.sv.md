...
############################# Head ############################
head_title: "Ta bort Digital-signaturer från Dotx-filer via Java"
head_description: "Radering av specifika Digital-signaturer från signerade Dotx-dokument kan enkelt utföras med kort Java-kod."

############################# Header ############################
title: "Ta bort Digital-signaturer som är placerade i Dotx-filer"
description: "Ta bort olika Digital-signaturer från Dotx-dokument. Att ta bort Digital-signaturer kräver enkel Java-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Digital-signaturer från ditt Dotx-dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) tillhandahåller användbar funktion för att rensa Dotx dokument från Digital signaturer med några rader kod.
