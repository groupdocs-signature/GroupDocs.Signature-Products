...
############################# Head ############################
head_title: "Elimina le firme Digital dai file Ott tramite Java"
head_description: "L'eliminazione di firme Digital specifiche da documenti Ott firmati può essere eseguita facilmente con il codice Java breve."

############################# Header ############################
title: "Rimuovi le firme Digital che sono inserite nei file Ott"
description: "Elimina varie firme Digital da documenti Ott. La rimozione delle firme Digital richiede un semplice codice Java."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Digital dal tuo documento Ott"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornisce una funzione utile per cancellare documenti Ott di firme Digital con poche righe di codice.
