...
############################# Head ############################
head_title: "Hapus tanda tangan Digital dari file Dot melalui Java"
head_description: "Penghapusan tanda tangan Digital tertentu dari dokumen Dot yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Digital yang ditempatkan di file Dot"
description: "Hapus berbagai tanda tangan Digital dari dokumen Dot. Menghapus tanda tangan Digital memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Digital dari dokumen Dot Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Dot dari Digital tanda tangan dengan beberapa baris kode.
