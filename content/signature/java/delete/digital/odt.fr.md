...
############################# Head ############################
head_title: "Supprimez les signatures Digital des fichiers Odt via Java"
head_description: "La suppression de signatures Digital spécifiques à partir de documents Odt signés peut être effectuée facilement avec un code Java court."

############################# Header ############################
title: "Supprimer les signatures Digital qui sont placées dans les fichiers Odt"
description: "Supprimez diverses signatures Digital des documents Odt. La suppression des signatures Digital nécessite un code Java simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fournit une fonctionnalité utile pour effacer les documents Odt des signatures Digital avec quelques lignes de code.
