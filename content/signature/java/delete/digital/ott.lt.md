...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Ott failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Ott dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Ott failuose"
description: "Ištrinkite įvairius Digital parašus iš Ott dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Ott dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Ott dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
