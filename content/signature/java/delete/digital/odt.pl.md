...
############################# Head ############################
head_title: "Usuń podpisy Digital z plików Odt przez Java"
head_description: "Usuwanie określonych podpisów Digital z podpisanych dokumentów Odt można łatwo wykonać za pomocą krótkiego kodu Java."

############################# Header ############################
title: "Usuń Digital podpisy umieszczone w plikach Odt"
description: "Usuń różne podpisy Digital z dokumentów Odt. Usunięcie podpisów Digital wymaga prostego kodu Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) zapewnia użyteczną funkcję do czyszczenia dokumentów Odt z podpisami Digital za pomocą kilku linijek kodu.
