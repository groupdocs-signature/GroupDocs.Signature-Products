...
############################# Head ############################
head_title: "Vee Digital handtekeninge van Xls lêers uit via Java"
head_description: "Die uitvee van spesifieke Digital handtekeninge van getekende Xls dokumente kan maklik uitgevoer word met kort Java kode."

############################# Header ############################
title: "Verwyder Digital handtekeninge wat in Xls lêers geplaas is"
description: "Vee verskeie Digital handtekeninge uit Xls dokumente uit. Die verwydering van Digital handtekeninge vereis eenvoudige Java kode."
...
steps:
    enable: true
    title_left: "Hoe om Digital-handtekeninge uit jou Xls-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied nuttige kenmerk vir die skoonmaak van Xls dokumente van Digital handtekeninge met 'n paar reëls kode.
