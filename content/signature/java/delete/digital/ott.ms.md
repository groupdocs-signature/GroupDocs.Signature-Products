...
############################# Head ############################
head_title: "Padamkan tandatangan Digital daripada fail Ott melalui Java"
head_description: "Pemadaman tandatangan Digital tertentu daripada dokumen Ott yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Digital yang diletakkan dalam fail Ott."
description: "Padamkan pelbagai tandatangan Digital daripada dokumen Ott. Mengalih keluar tandatangan Digital memerlukan kod Java yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Ott dokumen daripada Digital tandatangan dengan beberapa baris kod.
