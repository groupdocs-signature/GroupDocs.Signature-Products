...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Docx via Java"
head_description: "A exclusão de assinaturas Digital específicas de documentos Docx assinados pode ser realizada facilmente com o código curto Java."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Docx"
description: "Exclua várias assinaturas Digital de documentos Docx. A remoção de assinaturas Digital requer um código Java simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Digital do seu documento Docx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) fornece um recurso útil para limpar documentos Docx de assinaturas Digital com algumas linhas de código.
...
more_formats:
    enable: true
    title: "Exclua suas assinaturas Digital com Java"
    content: |
