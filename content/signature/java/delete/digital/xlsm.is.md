...
############################# Head ############################
head_title: "Eyða Digital undirskriftum úr Xlsm skrám í gegnum Java"
head_description: "Auðvelt er að eyða tilteknum Digital undirskriftum úr undirrituðum Xlsm skjölum með stuttum Java kóða."

############################# Header ############################
title: "Fjarlægðu Digital undirskriftir sem eru settar í Xlsm skrár"
description: "Eyða ýmsum Digital undirskriftum úr Xlsm skjölum. Til að fjarlægja Digital undirskrift þarf einfaldan Java kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að fjarlægja Digital undirskriftir úr Xlsm skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) býður upp á gagnlegan eiginleika til að hreinsa Xlsm skjöl af Digital undirskriftum með nokkrum línum af kóða.
