...
############################# Head ############################
head_title: "Scrios Digital sínithe ó chomhaid Pptx trí Java"
head_description: "Seans go ndéanfaí scriosadh sínithe Digital ar leith ó dhoiciméid shínithe Pptx le cód gearr Java."

############################# Header ############################
title: "Bain Digital sínithe a chuirtear i gcomhaid Pptx"
description: "Scrios Digital sínithe éagsúla ó Pptx doiciméid. Teastaíonn cód simplí Java chun sínithe Digital a bhaint."
...
steps:
    enable: true
    title_left: "Conas Digital sínithe a bhaint de do dhoiciméad Pptx"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) gné úsáideach chun Pptx doiciméad de Digital sínithe a ghlanadh le cúpla líne de chód.
