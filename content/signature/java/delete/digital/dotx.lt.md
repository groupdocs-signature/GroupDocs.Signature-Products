...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Dotx failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Dotx dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Dotx failuose"
description: "Ištrinkite įvairius Digital parašus iš Dotx dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Dotx dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Dotx dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
