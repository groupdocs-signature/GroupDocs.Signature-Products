...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Odt failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Odt dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Odt failuose"
description: "Ištrinkite įvairius Digital parašus iš Odt dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Odt dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Odt dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
