...
############################# Head ############################
head_title: "Padamkan tandatangan Digital daripada fail Pptx melalui Java"
head_description: "Pemadaman tandatangan Digital tertentu daripada dokumen Pptx yang ditandatangani mungkin dilakukan dengan mudah dengan kod Java pendek."

############################# Header ############################
title: "Alih keluar tandatangan Digital yang diletakkan dalam fail Pptx."
description: "Padamkan pelbagai tandatangan Digital daripada dokumen Pptx. Mengalih keluar tandatangan Digital memerlukan kod Java yang mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengalih keluar tandatangan Digital daripada dokumen Pptx anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan ciri berguna untuk mengosongkan Pptx dokumen daripada Digital tandatangan dengan beberapa baris kod.
