...
############################# Head ############################
head_title: "Delete Digital signatures from Ott files via Java"
head_description: "Deletion of specific Digital signatures from signed Ott documents might be performed easily with short Java code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Ott files"
description: "Delete various Digital signatures from Ott documents. Removing Digital signatures requires simple Java code."
...
steps:
    enable: true
    title_left: "How to remove Digital signatures from your Ott document"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) provides useful feature for clearing Ott documents of Digital signatures with a few lines of code.
