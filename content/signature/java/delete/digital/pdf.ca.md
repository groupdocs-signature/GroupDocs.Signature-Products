...
############################# Head ############################
head_title: "Suprimeix les signatures de Digital dels fitxers Pdf mitjançant Java"
head_description: "L'eliminació de signatures específiques de Digital dels documents signats Pdf es pot dur a terme fàcilment amb un codi Java curt."

############################# Header ############################
title: "Elimineu les signatures de Digital que es col·loquen als fitxers Pdf"
description: "Suprimeix diverses signatures de Digital dels documents Pdf. L'eliminació de signatures Digital requereix un codi Java senzill."
...
steps:
    enable: true
    title_left: "Com eliminar les signatures de Digital del vostre document Pdf"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) ofereix una funció útil per esborrar documents de Pdf de signatures de Digital amb unes poques línies de codi.
