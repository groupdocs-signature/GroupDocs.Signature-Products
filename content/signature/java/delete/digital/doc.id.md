...
############################# Head ############################
head_title: "Hapus tanda tangan Digital dari file Doc melalui Java"
head_description: "Penghapusan tanda tangan Digital tertentu dari dokumen Doc yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Digital yang ditempatkan di file Doc"
description: "Hapus berbagai tanda tangan Digital dari dokumen Doc. Menghapus tanda tangan Digital memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Digital dari dokumen Doc Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Doc dari Digital tanda tangan dengan beberapa baris kode.
