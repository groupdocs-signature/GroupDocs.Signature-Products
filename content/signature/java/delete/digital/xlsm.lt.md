...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Xlsm failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Xlsm dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Xlsm failuose"
description: "Ištrinkite įvairius Digital parašus iš Xlsm dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Xlsm dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Xlsm dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
