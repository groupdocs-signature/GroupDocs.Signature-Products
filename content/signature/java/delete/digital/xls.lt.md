...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Xls failų naudodami Java"
head_description: "Konkrečius Digital parašus iš pasirašytų Xls dokumentų galima lengvai ištrinti naudojant trumpą Java kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Xls failuose"
description: "Ištrinkite įvairius Digital parašus iš Xls dokumentų. Norint pašalinti Digital parašus, reikia paprasto Java kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Xls dokumento"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) yra naudinga funkcija, skirta išvalyti Xls dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
