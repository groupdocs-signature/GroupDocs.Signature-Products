...
############################# Head ############################
head_title: "Eyða Digital undirskriftum úr Ods skrám í gegnum Java"
head_description: "Auðvelt er að eyða tilteknum Digital undirskriftum úr undirrituðum Ods skjölum með stuttum Java kóða."

############################# Header ############################
title: "Fjarlægðu Digital undirskriftir sem eru settar í Ods skrár"
description: "Eyða ýmsum Digital undirskriftum úr Ods skjölum. Til að fjarlægja Digital undirskrift þarf einfaldan Java kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að fjarlægja Digital undirskriftir úr Ods skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) býður upp á gagnlegan eiginleika til að hreinsa Ods skjöl af Digital undirskriftum með nokkrum línum af kóða.
