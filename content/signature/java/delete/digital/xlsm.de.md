...
############################# Head ############################
head_title: "Löschen Sie Digital-Signaturen aus Xlsm-Dateien über Java"
head_description: "Das Löschen bestimmter Digital-Signaturen aus signierten Xlsm-Dokumenten kann einfach mit dem kurzen Java-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Digital-Signaturen, die in Xlsm-Dateien platziert sind"
description: "Löschen Sie verschiedene Digital-Signaturen aus Xlsm-Dokumenten. Das Entfernen von Digital-Signaturen erfordert einfachen Java-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Digital-Signaturen aus Ihrem Xlsm-Dokument"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bietet eine nützliche Funktion zum Löschen von Xlsm-Dokumenten von Digital-Signaturen mit ein paar Codezeilen.
