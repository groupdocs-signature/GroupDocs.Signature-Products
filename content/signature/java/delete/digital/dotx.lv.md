...
############################# Head ############################
head_title: "Dzēst Digital parakstus no Dotx failiem, izmantojot Java"
head_description: "Konkrētu Digital parakstu dzēšanu no parakstītiem Dotx dokumentiem var viegli veikt, izmantojot īsu Java kodu."

############################# Header ############################
title: "Noņemiet Digital parakstus, kas ir ievietoti Dotx failos"
description: "Izdzēsiet dažādus Digital parakstus no Dotx dokumentiem. Lai noņemtu Digital parakstus, ir nepieciešams vienkāršs Java kods."
...
steps:
    enable: true
    title_left: "Kā noņemt Digital parakstus no sava Dotx dokumenta"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina noderīgu līdzekli, lai no Dotx dokumentiem notīrītu Digital parakstus, izmantojot dažas koda rindiņas.
