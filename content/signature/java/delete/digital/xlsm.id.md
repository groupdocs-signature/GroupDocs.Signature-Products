...
############################# Head ############################
head_title: "Hapus tanda tangan Digital dari file Xlsm melalui Java"
head_description: "Penghapusan tanda tangan Digital tertentu dari dokumen Xlsm yang ditandatangani dapat dilakukan dengan mudah dengan kode Java singkat."

############################# Header ############################
title: "Hapus tanda tangan Digital yang ditempatkan di file Xlsm"
description: "Hapus berbagai tanda tangan Digital dari dokumen Xlsm. Menghapus tanda tangan Digital memerlukan kode Java sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Digital dari dokumen Xlsm Anda"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) menyediakan fitur yang berguna untuk membersihkan dokumen Xlsm dari Digital tanda tangan dengan beberapa baris kode.
