...
############################# Head ############################
head_title: "Vee Digital handtekeninge van Pptm lêers uit via Java"
head_description: "Die uitvee van spesifieke Digital handtekeninge van getekende Pptm dokumente kan maklik uitgevoer word met kort Java kode."

############################# Header ############################
title: "Verwyder Digital handtekeninge wat in Pptm lêers geplaas is"
description: "Vee verskeie Digital handtekeninge uit Pptm dokumente uit. Die verwydering van Digital handtekeninge vereis eenvoudige Java kode."
...
steps:
    enable: true
    title_left: "Hoe om Digital-handtekeninge uit jou Pptm-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) bied nuttige kenmerk vir die skoonmaak van Pptm dokumente van Digital handtekeninge met 'n paar reëls kode.
