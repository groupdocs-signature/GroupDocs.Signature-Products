...
############################# Head ############################
head_title: "Dzēst Digital parakstus no Ott failiem, izmantojot Java"
head_description: "Konkrētu Digital parakstu dzēšanu no parakstītiem Ott dokumentiem var viegli veikt, izmantojot īsu Java kodu."

############################# Header ############################
title: "Noņemiet Digital parakstus, kas ir ievietoti Ott failos"
description: "Izdzēsiet dažādus Digital parakstus no Ott dokumentiem. Lai noņemtu Digital parakstus, ir nepieciešams vienkāršs Java kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) nodrošina noderīgu līdzekli, lai no Ott dokumentiem notīrītu Digital parakstus, izmantojot dažas koda rindiņas.
