...
############################# Head ############################
head_title: "Odstraňte podpisy Digital ze souborů Dotx prostřednictvím Java"
head_description: "Odstranění konkrétních podpisů Digital z podepsaných dokumentů Dotx lze snadno provést pomocí krátkého kódu Java."

############################# Header ############################
title: "Odstraňte Digital podpisy, které jsou umístěny v souborech Dotx"
description: "Odstraňte různé podpisy Digital z dokumentů Dotx. Odstranění podpisů Digital vyžaduje jednoduchý kód Java."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Digital z vašeho dokumentu Dotx"
    content_left: |
        [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) poskytuje užitečnou funkci pro vymazání Dotx dokumentů od Digital podpisů pomocí několika řádků kódu.
