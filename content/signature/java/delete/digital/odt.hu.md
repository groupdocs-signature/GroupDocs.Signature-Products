...
############################# Head ############################
head_title: "Törölje a Digital aláírásokat a Odt fájlokból a Java segítségével"
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for Java](https://products.groupdocs.com/signature/java/) hasznos funkciót biztosít a Odt dokumentumok Digital aláírásainak néhány soros kóddal történő törléséhez.
