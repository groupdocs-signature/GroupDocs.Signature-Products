...
############################# Head ############################
head_title: "Ajouter des cachets à JPEG en utilisant Java"
head_description: "Exploitez GroupDocs.Signature et Java pour créer des cachets personnalisés et les placer sur n'importe quelle page de documents JPEG."

############################# Header ############################
title: "Ajouter des cachets personnalisés à JPEG" 
...
steps:
    enable: true
    title: "Étapes pour ajouter des cachets à JPEG via Java"
    content: |
      ...
      1. Fournissez le document JPEG à tamponner.
