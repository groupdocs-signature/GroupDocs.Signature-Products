...
############################# Head ############################
head_title: "Java를 사용하여 XLSX에 스탬프 추가"
head_description: "GroupDocs.Signature와 Java를 활용하여 맞춤형 스탬프를 생성하고 XLSX 문서의 어느 페이지에나 배치하세요."

############################# Header ############################
title: "XLSX에 맞춤형 스탬프 추가" 
...
steps:
    enable: true
    title: "Java를 통해 XLSX에 스탬프를 추가하는 단계"
    content: |
