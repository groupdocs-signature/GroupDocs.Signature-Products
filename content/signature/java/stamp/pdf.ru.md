...
############################# Head ############################
head_title: "Добавьте штампы к PDF с использованием Java"
head_description: "Используйте GroupDocs.Signature и Java для создания пользовательских штампов и размещения их на любой странице документов PDF."

############################# Header ############################
title: "Добавьте пользовательские штампы к PDF" 
...
steps:
    enable: true
    title: "Шаги по добавлению штампов к PDF с помощью Java"
    content: |
      ...
      1. Предоставьте документ PDF, к которому нужно добавить штамп.
