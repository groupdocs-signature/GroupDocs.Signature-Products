...
############################# Head ############################
head_title: "Generate Stamps for DOCX Using Java"
head_description: "Leverage GroupDocs.Signature and Java to create custom stamps and place them on any page within DOCX documents."

############################# Header ############################
title: "Embed Custom Stamps in DOCX with Java" 
...
steps:
    enable: true
    title: "Steps for Adding Stamp Signatures to DOCX Documents via Java"
    content: |
