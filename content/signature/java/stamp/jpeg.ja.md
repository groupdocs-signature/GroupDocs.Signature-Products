...
############################# Head ############################
head_title: "Javaを使用してJPEGにスタンプを追加"
head_description: "GroupDocs.SignatureとJavaを活用して、カスタムスタンプを作成し、JPEGドキュメントの任意のページに配置します。"

############################# Header ############################
title: "JPEGにカスタムスタンプを追加" 
...
steps:
    enable: true
    title: "Javaを介してJPEGにスタンプを追加する手順"
    content: |
