...
############################# Head ############################
head_title: "Adicione carimbos ao DOCX usando Java"
head_description: "Aproveite o GroupDocs.Signature e Java para criar carimbos personalizados e colocá-los em qualquer página dentro de documentos DOCX."

############################# Header ############################
title: "Adicione carimbos personalizados ao DOCX" 
...
steps:
    enable: true
    title: "Passos para adicionar carimbos ao DOCX via Java"
    content: |
