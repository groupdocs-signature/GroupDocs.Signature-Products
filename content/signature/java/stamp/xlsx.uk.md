...
############################# Head ############################
head_title: "Додайте штампи до XLSX за допомогою Java"
head_description: "Використовуйте GroupDocs.Signature та Java для створення індивідуальних штампів і розміщення їх на будь-якій сторінці документів XLSX."

############################# Header ############################
title: "Додайте індивідуальні штампи до XLSX" 
...
steps:
    enable: true
    title: "Кроки для додавання штампів до XLSX за допомогою Java"
    content: |
      ...
      1. Надайте документ XLSX, який потрібно штампувати.
