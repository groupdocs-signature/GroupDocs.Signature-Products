...
############################# Head ############################
head_title: "Aggiungi timbri a PPTX utilizzando Java"
head_description: "Sfrutta GroupDocs.Signature e Java per creare timbri personalizzati e posizionarli su qualsiasi pagina all'interno dei documenti PPTX."

############################# Header ############################
title: "Aggiungi timbri personalizzati a PPTX" 
...
steps:
    enable: true
    title: "Passaggi per aggiungere timbri a PPTX tramite Java"
    content: |
