...
draft: false
############################# Head ############################
head_title: "Как добавить цифровые подписи в файлы METAFILES в Java"
head_description: "Узнайте, как добавлять цифровые подписи в файл METAFILES на Java с помощью API GroupDocs.Siganture — добавляйте настраиваемые электронные подписи в популярные форматы деловых документов и файлов изображений."
############################# Header ############################
title: "Добавьте цифровые подписи в METAFILES в Java"
description: "Защитите свои файлы METAFILES, добавив популярные типы цифровых подписей с помощью библиотеки Java. Управляйте свойствами электронных подписей и настраивайте параметры предварительной подписи в документах по мере необходимости."
...
steps:
    enable: true
    title_left: "Как добавить цифровые подписи в файл METAFILES"
    content_left: |
        В приведенном ниже примере кода четко показаны действия по **добавлению цифровых подписей в файл METAFILES с помощью библиотеки [GroupDocs.Signature](/ru/signature/java/) в Java** путем добавления всего нескольких строк кода.
...
demos:
    enable: true
    title: "Добавить живые демонстрации METAFILES Signature"
    content: |
