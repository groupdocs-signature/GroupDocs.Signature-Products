...
############################# Head ############################
head_title: "Sign Spreadsheets with Image Signatures in Java"
head_description: "Add image signatures to digitally sign Excel Spreadsheets in Java - add customized electronic signatures to popular business documents and image file formats."

############################# Header ############################
title: "Add Image Signatures to Spreadsheets in .NET"
description: "Add digital signatures to your Spreadsheets using popular image signature types. Securely add customized image signatures by manipulating the signature properties - set up advance signing options within documents that suit your needs."
...
steps:
    enable: true
    title_left: "Add Image Signatures to Spreadsheets"
    content_left: |
        [GroupDocs.Signature](https://products.groupdocs.com/signature/java) makes it easy for Java developers to add image signatures to Spreadsheets within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Add e-signatures to Spreadsheets right now by visiting [GroupDocs.Signature Live Demos](https://products.groupdocs.app/signature/family) website.  
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-excel-o"
          title: "About Spreadsheet File Formats"
          content: |
