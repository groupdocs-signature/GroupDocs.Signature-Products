...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/java/) makes it easy for Java developers to add image signatures to TIF files within their applications by implementing a few easy steps.
