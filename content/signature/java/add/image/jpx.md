...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/java/) makes it easy for Java developers to add image signatures to JPX files within their applications by implementing a few easy steps.
