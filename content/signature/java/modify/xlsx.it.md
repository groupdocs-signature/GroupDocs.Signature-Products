...
############################# Head ############################
head_title: "Modifica le firme XLSX con applicazioni Java"
head_description: "L'API di elaborazione delle firme Java consente di modificare le firme in file XLSX, inclusi PDF, Word, Excel, Presentazioni e Immagini."

############################# Header ############################
title: "Modifica le firme XLSX" 
...
steps:
    enable: true
    title: "Passi per modificare le firme di testo in XLSX utilizzando Java"
    content: |
      [GroupDocs.Signature](/signature/java/) consente agli sviluppatori Java di aggiornare il contenuto delle firme di testo precedentemente aggiunte a file XLSX. Migliora le applicazioni Java con capacità robuste.
      
      1. Aggiungi il file XLSX all'istanza Signature.
