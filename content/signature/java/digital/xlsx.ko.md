...
############################# Head ############################
head_title: "Java로 XLSX 파일에 디지털 전자 서명 추가하기"
head_description: "Java를 사용하여 XLSX 파일에 디지털 서명을 몇 줄의 코드로 추가하세요. GroupDocs.Signature for Java을 사용하여 다양한 파일 형식에 서명할 수 있습니다."

############################# Header ############################
title: "XLSX를 디지털 서명으로 보호하기" 
...
steps:
    enable: true
    title: "Java에서 디지털 인증서를 사용한 XLSX 보호를 위한 단계"
    content: |
      [GroupDocs.Signature](/signature/java/)는 Java 개발자가 디지털 서명을 사용하여 XLSX 문서의 변화를 방지할 수 있게 합니다. 중요한 데이터를 보호할 수 있는 기능을 비즈니스 애플리케이션에 사용하세요.
      
      1. Signature 클래스 생성자에 XLSX 문서를 전달합니다.
