...
############################# Head ############################
head_title: "Thêm chữ ký điện tử vào file PPTX bằng Java"
head_description: "Đặt chữ ký điện tử trên file PPTX bằng Java chỉ với vài dòng mã. Sử dụng GroupDocs.Signature for Java để ký nhiều định dạng file khác nhau."

############################# Header ############################
title: "Ký PPTX với chữ ký điện tử" 
...
steps:
    enable: true
    title: "Các bước bảo vệ PPTX bằng chứng chỉ điện tử trong Java"
    content: |
      [GroupDocs.Signature](/signature/java/) cho phép các nhà phát triển Java ngăn chặn các thay đổi trong tài liệu PPTX bằng cách sử dụng chữ ký điện tử. Tăng cường ứng dụng doanh nghiệp của bạn với khả năng bảo vệ dữ liệu quan trọng.
      
      1. Truyền tài liệu PPTX vào constructor của lớp Signature.
