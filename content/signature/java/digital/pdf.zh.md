...
############################# Head ############################
head_title: "使用 Java 为 PDF 文件添加数字电子签名"
head_description: "使用 Java 仅需少量代码即可将数字签名放置在 PDF 文件上。使用 GroupDocs.Signature for Java 签署多种文件格式。"
...
steps:
    enable: true
    title: "在 Java 中保护 PDF 的步骤使用数字证书"
    content: |
      [GroupDocs.Signature](/signature/java/) 允许 Java 开发人员通过数字签名防止 PDF 文档的更改。为您的商业应用程序赋予保护重要数据的能力。
