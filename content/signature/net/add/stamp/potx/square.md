...
############################# Head ############################
head_title: "Add Square Stamp and Sign POTX File| Sign Documents"
head_description: "Sign POTX files with Square stamp signatures - add stamps to popular business documents and image file formats."

############################# Header ############################
title: "Add Square Stamp Signatures to POTX File"
description: "Sign your POTX files using Square stamp in C#. Manipulate signature properties and set up advanced signing options within documents that suit your needs."
...
steps:
    enable: true
    title_left: "How to sign POTX file with Square Stamp"
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Square stamps to POTX files within their applications by implementing a few easy steps.
        ...
        *   Call Sign method of Signature class and pass output POTX file name with StampSignOptions to it.
...
demos:
    ...
    content: |
        Add Square stamps to POTX files right now by visiting [GroupDocs.Signature Live Demos](https://products.groupdocs.app/signature/family) website.  
