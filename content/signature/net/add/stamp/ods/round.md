...
############################# Head ############################
head_title: "Add Round Stamp and Sign ODS File| Sign Documents"
head_description: "Sign ODS files with Round stamp signatures - add stamps to popular business documents and image file formats."

############################# Header ############################
title: "Add Round Stamp Signatures to ODS File"
description: "Sign your ODS files using Round stamp in C#. Manipulate signature properties and set up advanced signing options within documents that suit your needs."
...
steps:
    enable: true
    title_left: "How to sign ODS file with Round Stamp"
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Round stamps to ODS files within their applications by implementing a few easy steps.
        ...
        *   Call Sign method of Signature class and pass output ODS file name with StampSignOptions to it.
...
demos:
    ...
    content: |
        Add Round stamps to ODS files right now by visiting [GroupDocs.Signature Live Demos](https://products.groupdocs.app/signature/family) website.  
