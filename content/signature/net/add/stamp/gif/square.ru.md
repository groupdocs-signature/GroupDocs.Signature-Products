...
draft: false
############################# Head ############################
head_title: "Добавьте квадратную печать и подпишите GIF-файл | Подписывать документы"
head_description: "Подписывайте GIF-файлы с помощью подписи Square Stamp — добавляйте штампы к популярным деловым документам и файлам изображений."
############################# Header ############################
title: "Добавить подписи Square Stamp в файл GIF"
description: "Подпишите файлы GIF, используя квадратную печать в C#. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как подписать файл GIF с помощью Square Stamp"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять штампы Square в файлы GIF в своих приложениях, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Добавьте штампы Square в файлы GIF прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
