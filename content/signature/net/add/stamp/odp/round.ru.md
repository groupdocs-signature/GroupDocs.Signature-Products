...
draft: false
############################# Head ############################
head_title: "Добавить круглую печать и подписать файл ODP | Подписывать документы"
head_description: "Подписывайте ODP-файлы с помощью круглых штампов — добавляйте штампы к популярным деловым документам и форматам файлов изображений."
############################# Header ############################
title: "Добавить подписи с круглым штампом в файл ODP"
description: "Подпишите файлы ODP, используя круглую печать на C#. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как подписать файл ODP с помощью круглой печати"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять круглые штампы в файлы ODP в своих приложениях, выполняя несколько простых шагов.
        ...
        * Вызовите метод Sign класса Signature и передайте ему имя выходного ODP-файла с StampSignOptions.
...
demos:
    ...
    content: |
        Добавьте штампы Round в файлы ODP прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
