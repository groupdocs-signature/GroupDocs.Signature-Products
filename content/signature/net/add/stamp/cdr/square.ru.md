...
draft: false
############################# Head ############################
head_title: "Добавить квадратную печать и подписать файл CDR | Подписывать документы"
head_description: "Подписывайте CDR-файлы с помощью подписи Square Stamp — добавляйте штампы к популярным деловым документам и файлам изображений."
############################# Header ############################
title: "Добавить подписи Square Stamp в файл CDR"
description: "Подпишите свои CDR-файлы, используя квадратную печать в C#. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как подписать файл CDR с помощью Square Stamp"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять штампы Square в файлы CDR в своих приложениях, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Добавьте штампы Square в файлы CDR прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
