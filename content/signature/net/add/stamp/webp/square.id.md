...
head_title: "Tambahkan Stempel SQUARE dan Tanda Tangani File WEBP| Menandatangani Dokumen"
head_description: "Tanda tangani file WEBP dengan tanda tangan stempel SQUARE - tambahkan stempel ke dokumen bisnis populer dan format file gambar."

title: "Tambahkan SQUARE Cap Tanda Tangan ke File WEBP"
description: "Masuk file WEBP Anda menggunakan stempel SQUARE di C#. Memanipulasi properti tanda tangan dan mengatur opsi penandatanganan lanjutan dalam dokumen yang sesuai dengan kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Cara menandatangani file WEBP dengan SQUARE Stamp"
    content_left: |
        [GroupDocs.Signature](/id/signature/net/) memudahkan pengembang .NET untuk menambahkan stempel SQUARE ke file WEBP dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        ...
        * Metode Tanda Panggil kelas Tanda Tangan dan berikan nama file keluaran WEBP dengan StampSignOptions ke dalamnya.
...
demos:
    ...
    content: |
        Tambahkan stempel SQUARE ke file WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Signature](https://products.groupdocs.app/signature/family). Demo langsung memiliki manfaat sebagai berikut.
