...
head_title: "Tambahkan Stempel SQUARE dan Tandatangani File POTM| Menandatangani Dokumen"
head_description: "Tanda tangani file POTM dengan tanda tangan stempel SQUARE - tambahkan stempel ke dokumen bisnis populer dan format file gambar."

title: "Tambahkan Tanda Tangan Cap SQUARE ke File POTM"
description: "Masuk file POTM Anda menggunakan cap SQUARE di C#. Memanipulasi properti tanda tangan dan mengatur opsi penandatanganan lanjutan dalam dokumen yang sesuai dengan kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Cara menandatangani file POTM dengan Stempel SQUARE"
    content_left: |
        [GroupDocs.Signature](/id/signature/net/) memudahkan pengembang .NET untuk menambahkan stempel SQUARE ke file POTM dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
        ...
        * Metode Tanda Panggil kelas Tanda Tangan dan berikan nama file POTM keluaran dengan StampSignOptions ke dalamnya.
...
demos:
    ...
    content: |
        Tambahkan stempel SQUARE ke file POTM sekarang juga dengan mengunjungi situs web [GroupDocs.Signature](https://products.groupdocs.app/signature/family). Demo langsung memiliki manfaat sebagai berikut.
