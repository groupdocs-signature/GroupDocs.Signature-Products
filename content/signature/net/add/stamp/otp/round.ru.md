...
draft: false
############################# Head ############################
head_title: "Добавить круглую печать и подписать файл OTP | Подписывать документы"
head_description: "Подписывайте OTP-файлы с подписями Round Stamp — добавляйте штампы к популярным деловым документам и форматам файлов изображений."
############################# Header ############################
title: "Добавить подписи с круглым штампом в файл OTP"
description: "Подпишите файлы OTP, используя круглую печать в C#. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как подписать файл OTP с помощью Round Stamp"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять круглые штампы в файлы OTP в своих приложениях, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Добавьте штампы Round в файлы OTP прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
