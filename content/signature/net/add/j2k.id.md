...
head_title: "Tambahkan Tanda Tangan Digital ke File J2K di .NET | Menandatangani Dokumen"
head_description: "Tanda tangani file J2K dengan tanda tangan digital di .NET - tambahkan tanda tangan elektronik khusus ke dokumen bisnis populer dan format file gambar."

title: "Tambahkan Tanda Tangan Digital ke File J2K"
description: "Tanda tangani file J2K Anda menggunakan jenis tanda tangan digital populer. Memanipulasi properti tanda tangan dan mengatur opsi penandatanganan lanjutan dalam dokumen yang sesuai dengan kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Cara Menambahkan Tanda Tangan Digital ke J2K"
    content_left: |
        [GroupDocs.Signature](/id/signature/net/) memudahkan pengembang .NET untuk menambahkan tanda tangan elektronik ke file J2K dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ...
        using (Signature signature = new Signature("sample.pdf"))
        {
            ...
            signature.Sign("signed.j2k", options);
        }
        ```
...
demos:
    ...
    content: |
        Tambahkan tanda tangan ke file J2K sekarang juga dengan mengunjungi situs web [GroupDocs.Signature](https://products.groupdocs.app/signature/family). Demo langsung memiliki manfaat sebagai berikut.
