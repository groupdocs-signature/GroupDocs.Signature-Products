...
draft: false
############################# Head ############################
head_title: "Подписывайте файлы SVG с помощью подписей изображений JPG в C# .NET"
head_description: "Добавляйте подписи изображений JPG для цифровой подписи документов SVG в C# .NET — добавляйте настраиваемые электронные подписи к популярным деловым документам и форматам файлов изображений."
############################# Header ############################
title: "Добавление подписей изображений к файлам SVG в .NET"
description: "Цифровая подпись файлов SVG с использованием JPG и других популярных типов подписи изображений. Управляйте свойствами подписи и настраивайте параметры предварительной подписи в документах в соответствии с вашими потребностями."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять подписи изображений к файлам SVG в своих приложениях, выполняя несколько простых шагов.
    ...
    code: |
        ...
        {
            ImageSignOptions options = new ImageSignOptions("signature.svg")
            {
...
demos:
    ...
    content: |
        Добавьте подписи к файлам SVG прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
