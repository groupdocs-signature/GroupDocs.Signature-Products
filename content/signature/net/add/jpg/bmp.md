...
############################# Head ############################
head_title: "Sign BMP files with JPG Image Signatures in C# .NET"
...
description: "Digitally sign your BMP files using JPG and other popular image signature types. Manipulate signature properties and set up advance signing options within documents that suit your needs."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add image signatures to BMP files within their applications by implementing a few easy steps.
