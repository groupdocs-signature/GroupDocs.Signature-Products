...
head_title: "Hasilkan AZTEC QR-code dan Masuk File WMF di .NET | Menandatangani Dokumen"
head_description: "Tanda tangani file WMF dengan tanda tangan kode QR AZTEC di .NET - tambahkan kode batang ke dokumen bisnis populer dan format file gambar."

title: "Tambahkan AZTEC kode QR ke File WMF di C#"
description: "Tanda tangani file WMF Anda menggunakan kode QR AZTEC. Memanipulasi properti tanda tangan dan mengatur opsi penandatanganan lanjutan dalam dokumen yang sesuai dengan kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Cara Menghasilkan AZTEC QR-code untuk file WMF di C#"
    content_left: |
        [GroupDocs.Signature](/id/signature/net/) memudahkan pengembang .NET untuk menambahkan kode batang AZTEC ke file WMF dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
        Tambahkan AZTEC qr-codes ke file WMF sekarang juga dengan mengunjungi situs web [GroupDocs.Signature](https://products.groupdocs.app/signature/family). Demo langsung memiliki manfaat sebagai berikut.
