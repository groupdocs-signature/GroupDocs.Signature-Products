...
draft: false
############################# Head ############################
head_title: "Создание QR-кода Aztec и подписание файла ODT в .NET | Подписывать документы"
head_description: "Подписывайте файлы ODT с помощью подписей QR-кода Aztec в .NET — добавляйте штрих-коды в популярные форматы деловых документов и файлов изображений."
############################# Header ############################
title: "Добавьте QR-коды Aztec в файл ODT на C#"
description: "Подпишите файлы ODT, используя QR-код Aztec. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как сгенерировать QR-код Aztec для файла ODT в C#"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять штрих-коды Aztec в файлы ODT в своих приложениях, выполняя несколько простых шагов.
        ...
        * Вызвать метод Sign класса Signature и передать ему имя выходного ODT-файла с QrCodeSignOptions.
    ...
    code: |
        ...
        using (Signature signature = new Signature("sample.odt"))
        {
            ...
            // Подписываем ODT файл и сохраняем результат 
...
demos:
    ...
    content: |
        Добавьте qr-коды Aztec в файлы ODT прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
