...
head_title: "Hasilkan kode QR QR dan Masuk File XLS di .NET | Menandatangani Dokumen"
head_description: "Tanda tangani file XLS dengan tanda tangan kode QR QR di .NET - tambahkan kode batang ke dokumen bisnis populer dan format file gambar."

title: "Tambahkan QR QR-kode ke File XLS di C#"
description: "Tanda tangani file XLS Anda menggunakan kode QR QR. Memanipulasi properti tanda tangan dan mengatur opsi penandatanganan lanjutan dalam dokumen yang sesuai dengan kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Cara Menghasilkan QR QR-kode untuk file XLS di C#"
    content_left: |
        [GroupDocs.Signature](/id/signature/net/) memudahkan pengembang .NET untuk menambahkan kode batang QR ke file XLS dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
        Tambahkan kode QR QR ke file XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Signature](https://products.groupdocs.app/signature/family). Demo langsung memiliki manfaat sebagai berikut.
