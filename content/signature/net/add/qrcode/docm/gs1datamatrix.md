...
############################# Head ############################
head_title: "Generate GS1DataMatrix QR-code and Sign DOCM File in .NET | Sign Documents"
head_description: "Sign DOCM files with GS1DataMatrix QR-code signatures in .NET - add barcodes to popular business documents and image file formats."

############################# Header ############################
title: "Add GS1DataMatrix QR-codes to DOCM File in C#"
description: "Sign your DOCM files using GS1DataMatrix QR-code. Manipulate signature properties and set up advanced signing options within documents that suit your needs."
...
steps:
    enable: true
    title_left: "How to Generate Gs1datamatrix QR-code for DOCM file in C#"
    content_left: |
        [GroupDocs.Signature](https://products.groupdocs.com/signature/net) makes it easy for .NET developers to add Gs1datamatrix barcodes to DOCM files within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Add Gs1datamatrix qr-codes to DOCM files right now by visiting [GroupDocs.Signature Live Demos](https://products.groupdocs.app/signature/family) website.  
