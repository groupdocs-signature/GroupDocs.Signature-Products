...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Deutschepostidentcode barcodes to XLSB files within their applications by implementing a few easy steps.
