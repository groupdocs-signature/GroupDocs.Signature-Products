...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Australianpost barcodes to DJVU files within their applications by implementing a few easy steps.
