...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Codablockf barcodes to PPSX files within their applications by implementing a few easy steps.
