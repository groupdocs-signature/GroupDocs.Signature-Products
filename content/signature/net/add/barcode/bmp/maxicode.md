...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Maxicode barcodes to BMP files within their applications by implementing a few easy steps.
