...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Gs1codablockf barcodes to PDF files within their applications by implementing a few easy steps.
