...
draft: false
############################# Head ############################
head_title: "Создание штрих-кода Standard2of5 и подписание PDF-файла в .NET | Подписывать документы"
head_description: "Подписывайте PDF-файлы с помощью подписей штрих-кода Standard2of5 в .NET — добавляйте штрих-коды в популярные деловые документы и форматы файлов изображений."
############################# Header ############################
title: "Добавить подписи штрих-кода Standard2of5 в PDF-файл на С#"
description: "Подпишите свои PDF-файлы, используя штрих-код Standard2of5. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как сгенерировать штрих-код Standard2of5 для файла PDF в C#"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять штрих-коды Standard2of5 в файлы PDF в своих приложениях, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Добавьте штрих-коды Standard2of5 в файлы PDF прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
