...
draft: false
############################# Head ############################
head_title: "Создание штрих-кода почты Австралии и подписание PDF-файла в .NET | Подписывать документы"
head_description: "Подписывайте PDF-файлы с подписями штрих-кода почты Австралии в .NET — добавляйте штрих-коды в популярные форматы деловых документов и файлов изображений."
############################# Header ############################
title: "Добавить подписи штрих-кода Australianpost в PDF-файл на C#"
description: "Подпишите свои PDF-файлы, используя штрих-код Почты Австралии. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как сгенерировать штрих-код Australianpost для PDF-файла на C#"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять штрих-коды почты Австралии в файлы PDF в своих приложениях, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Добавьте штрих-коды Australianpost в файлы PDF прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
