...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Databarstackedomnidirectional barcodes to GIF files within their applications by implementing a few easy steps.
