...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Ean8 barcodes to DOC files within their applications by implementing a few easy steps.
