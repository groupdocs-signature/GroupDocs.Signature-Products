...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Itf6 barcodes to DOCM files within their applications by implementing a few easy steps.
