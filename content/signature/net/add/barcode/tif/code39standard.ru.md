...
draft: false
############################# Head ############################
head_title: "Создание стандартного штрих-кода Code39 и подписание файла TIF в .NET | Подписывать документы"
head_description: "Подписывайте файлы TIF с помощью стандартных подписей штрих-кода Code39 в .NET — добавляйте штрих-коды в популярные форматы деловых документов и файлов изображений."
############################# Header ############################
title: "Добавление стандартных подписей штрих-кода Code39 в файл TIF на C#"
description: "Подпишите файлы TIF, используя стандартный штрих-код Code39. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как сгенерировать стандартный штрих-код Code39 для файла TIF в C#"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять стандартные штрих-коды Code39 в файлы TIF в своих приложениях, выполняя несколько простых шагов.
        * Создайте новый экземпляр класса Signature и передайте путь к исходному документу TIF в качестве параметра конструктора.
        ...
        * Вызовите метод Sign класса Signature и передайте ему имя выходного TIF-файла с BarcodeSignOptions.
    ...
    code: |
        ...
        using (Signature signature = new Signature("sample.tif"))
        {
            ...
            // Подпишите файл TIF и сохраните результат
...
demos:
    ...
    content: |
        Добавьте штрих-коды Code39standard в файлы TIF прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
