...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Upcags1databarcoupon barcodes to CMX files within their applications by implementing a few easy steps.
