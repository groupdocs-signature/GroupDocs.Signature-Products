...
head_title: "Hasilkan DATALOGIC2OF5 Barcode dan Masuk File DOCX di .NET | Menandatangani Dokumen"
head_description: "Tanda tangani file DOCX dengan tanda tangan kode batang DATALOGIC2OF5 di .NET - tambahkan kode batang ke dokumen bisnis populer dan format file gambar."

title: "Tambahkan DATALOGIC2OF5 Barcode Signatures ke File DOCX di C#"
description: "Tanda tangani file DOCX Anda menggunakan kode batang DATALOGIC2OF5. Memanipulasi properti tanda tangan dan mengatur opsi penandatanganan lanjutan dalam dokumen yang sesuai dengan kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Cara Menghasilkan DATALOGIC2OF5 Barcode untuk file DOCX di C#"
    content_left: |
        [GroupDocs.Signature](/id/signature/net/) memudahkan pengembang .NET untuk menambahkan kode batang DATALOGIC2OF5 ke file DOCX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance baru kelas Signature dan berikan jalur dokumen DOCX sumber sebagai parameter konstruktor.
        * Buat instance objek BarcodeSignOptions dengan teks yang diperlukan dan setel properti EncodeType ke DATALOGIC2OF5.
...
demos:
    enable: true
    title: "Demo Langsung - Aplikasi Online untuk Menghasilkan DATALOGIC2OF5 Barcode Signatures"
    content: |
        Tambahkan kode batang DATALOGIC2OF5 ke file DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Signature](https://products.groupdocs.app/signature/family). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "fas fa-barcode"
          title: "Tentang DATALOGIC2OF5 Barcode"
          content: |
            Datalogic 2 dari 5 (juga dikenal sebagai 2 dari 5 Datalogic dan China Post) adalah anggota keluarga simbologi Kode 2 dari 5, yang pertama kali dikembangkan pada tahun 1968. Datalogic 2 dari 5 digunakan oleh Layanan Pos China untuk pemrosesan otomatis dan penyortiran surat. Nama 2 dari 5 berasal dari fakta bahwa dari lima elemen (bilah dan spasi) yang digunakan untuk mengkodekan setiap karakter, dua lebar dan tiga sempit.

          link: ""

more_formats:
    enable: true
    title: "Menandatangani Format Dokumen Lain dengan DATALOGIC2OF5 Barcode menggunakan C#"
    content: |
