...
head_title: "Hasilkan EAN13 Barcode dan Masuk File DOCX di .NET | Menandatangani Dokumen"
head_description: "Tanda tangani file DOCX dengan tanda tangan kode batang EAN13 di .NET - tambahkan kode batang ke dokumen bisnis populer dan format file gambar."

title: "Tambahkan EAN13 Barcode Signatures ke File DOCX di C#"
description: "Tanda tangani file DOCX Anda menggunakan kode batang EAN13. Memanipulasi properti tanda tangan dan mengatur opsi penandatanganan lanjutan dalam dokumen yang sesuai dengan kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Cara Menghasilkan EAN13 Barcode untuk file DOCX di C#"
    content_left: |
        [GroupDocs.Signature](/id/signature/net/) memudahkan pengembang .NET untuk menambahkan kode batang EAN13 ke file DOCX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance baru kelas Signature dan berikan jalur dokumen DOCX sumber sebagai parameter konstruktor.
        * Buat instance objek BarcodeSignOptions dengan teks yang diperlukan dan setel properti EncodeType ke EAN13.
...
demos:
    enable: true
    title: "Demo Langsung - Aplikasi Online untuk Menghasilkan EAN13 Barcode Signatures"
    content: |
        Tambahkan kode batang EAN13 ke file DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Signature](https://products.groupdocs.app/signature/family). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "fas fa-barcode"
          title: "Tentang EAN13 Barcode"
          content: |
            Standar EAN yang paling umum digunakan adalah EAN-13 tiga belas digit, superset dari standar 12-digit Universal Product Code (UPC-A) asli yang dikembangkan pada tahun 1970 oleh George J. Laurer. Nomor EAN-13 mencakup awalan GS1 3 digit (menunjukkan negara pendaftaran atau jenis produk khusus). Awalan dengan digit pertama '0' menunjukkan kode UPC-A 12 digit berikut. Awalan dengan dua digit pertama '45' atau '49' menunjukkan Nomor Artikel Jepang (JAN) berikut.

          link: ""

more_formats:
    enable: true
    title: "Menandatangani Format Dokumen Lain dengan EAN13 Barcode menggunakan C#"
    content: |
