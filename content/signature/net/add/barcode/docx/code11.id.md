...
head_title: "Hasilkan CODE11 Barcode dan Masuk File DOCX di .NET | Menandatangani Dokumen"
head_description: "Tanda tangani file DOCX dengan tanda tangan kode batang CODE11 di .NET - tambahkan kode batang ke dokumen bisnis populer dan format file gambar."

title: "Tambahkan CODE11 Barcode Signatures ke File DOCX di C#"
description: "Tanda tangani file DOCX Anda menggunakan kode batang CODE11. Memanipulasi properti tanda tangan dan mengatur opsi penandatanganan lanjutan dalam dokumen yang sesuai dengan kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Cara Menghasilkan CODE11 Barcode untuk file DOCX di C#"
    content_left: |
        [GroupDocs.Signature](/id/signature/net/) memudahkan pengembang .NET untuk menambahkan kode batang CODE11 ke file DOCX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance baru kelas Signature dan berikan jalur dokumen DOCX sumber sebagai parameter konstruktor.
        * Buat instance objek BarcodeSignOptions dengan teks yang diperlukan dan setel properti EncodeType ke CODE11.
...
demos:
    enable: true
    title: "Demo Langsung - Aplikasi Online untuk Menghasilkan CODE11 Barcode Signatures"
    content: |
        Tambahkan kode batang CODE11 ke file DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Signature](https://products.groupdocs.app/signature/family). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "fas fa-barcode"
          title: "Tentang CODE11 Barcode"
          content: |
            Kode 11 adalah simbologi barcode yang dikembangkan oleh Intermec pada tahun 1977. Digunakan terutama dalam telekomunikasi. Simbol dapat mengkodekan string panjang apa pun yang terdiri dari angka 0-9 dan karakter tanda hubung (-). Kode kedua belas mewakili karakter mulai/berhenti, biasanya dicetak sebagai '*'. Satu atau dua digit pemeriksaan modulo-11 dapat disertakan.

          link: ""

more_formats:
    enable: true
    title: "Menandatangani Format Dokumen Lain dengan CODE11 Barcode menggunakan C#"
    content: |
