...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Interleaved2of5 barcodes to ODP files within their applications by implementing a few easy steps.
