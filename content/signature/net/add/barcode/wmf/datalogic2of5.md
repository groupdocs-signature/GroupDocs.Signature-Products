...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Datalogic2of5 barcodes to WMF files within their applications by implementing a few easy steps.
