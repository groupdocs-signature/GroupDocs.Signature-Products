...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Issn barcodes to PPTM files within their applications by implementing a few easy steps.
