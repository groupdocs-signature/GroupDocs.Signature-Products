...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Itf14 barcodes to PPTM files within their applications by implementing a few easy steps.
