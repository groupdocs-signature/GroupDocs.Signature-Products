...
draft: false
############################# Head ############################
head_title: "Создать расширенный штрих-код Code39 и подписать файл CDR в .NET | Подписывать документы"
head_description: "Подписывайте файлы CDR с расширенными подписями штрих-кода Code39 в .NET — добавляйте штрих-коды в популярные форматы деловых документов и файлов изображений."
############################# Header ############################
title: "Добавление расширенных подписей штрих-кода Code39 в файл CDR на C#"
description: "Подпишите файлы CDR, используя расширенный штрих-код Code39. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как сгенерировать расширенный штрих-код Code39 для файла CDR в C#"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять расширенные штрих-коды Code39 в файлы CDR в своих приложениях, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Добавьте штрих-коды Code39extended в файлы CDR прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
