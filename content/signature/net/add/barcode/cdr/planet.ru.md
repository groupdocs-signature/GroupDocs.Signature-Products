...
draft: false
############################# Head ############################
head_title: "Создать штрих-код Planet и подписать файл CDR в .NET | Подписывать документы"
head_description: "Подписывайте файлы CDR с помощью подписей штрих-кодов Planet в .NET — добавляйте штрих-коды в популярные форматы деловых документов и файлов изображений."
############################# Header ############################
title: "Добавить подписи штрих-кода планеты в файл CDR на C#"
description: "Подпишите свои файлы CDR, используя штрих-код Planet. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как сгенерировать штрих-код планеты для файла CDR в C#"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять штрих-коды Planet в файлы CDR в своих приложениях, выполняя несколько простых шагов.
        * Создайте новый экземпляр класса Signature и передайте путь к исходному документу CDR в качестве параметра конструктора.
        * Создайте экземпляр объекта BarcodeSignOptions с требуемым текстом и установите для свойства EncodeType значение Planet.
    ...
    code: |
        ...
        using (Signature signature = new Signature("sample.cdr"))
        {
            ...
            BarcodeSignOptions options = new BarcodeSignOptions("JohnSmith")
            {
                ...
                EncodeType = BarcodeTypes.Планета,
...
demos:
    enable: true
    title: "Живые демонстрации — онлайн-приложение для создания подписей штрих-кодов планет"
    content: |
        Добавьте штрих-коды Planet в файлы CDR прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
        # format loop
        - icon: "fas fa-barcode"
          title: "О планетарном штрих-коде"
          content: |
            Система символов почтового алфавитно-цифрового кодирования (PLANET) USPS была разработана Почтовой службой США (USPS) для автоматической идентификации, сортировки и отслеживания почтовых отправлений. Обычно он использовался в сочетании с символикой почтового числового кодирования USPS (USPS POSTNET).
          link: ""
############################# More Formats ############################
more_formats:
    enable: true
    title: "Подписание других форматов документов с помощью Planet Barcode с использованием C#"
    content: |
