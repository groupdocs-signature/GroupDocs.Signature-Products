...
draft: false
############################# Head ############################
head_title: "Создание штрих-кода Singaporepost и подписание CDR-файла в .NET | Подписывать документы"
head_description: "Подписывайте CDR-файлы с помощью подписей штрих-кодов Singaporepost в .NET — добавляйте штрих-коды в популярные форматы деловых документов и файлов изображений."
############################# Header ############################
title: "Добавление подписи штрих-кода Singaporepost в файл CDR на C#"
description: "Подпишите свои файлы CDR, используя штрих-код Singaporepost. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как сгенерировать штрих-код Singaporepost для файла CDR на C#"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять штрих-коды почты Сингапура в файлы CDR в своих приложениях, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Добавьте штрих-коды Singaporepost в файлы CDR прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
