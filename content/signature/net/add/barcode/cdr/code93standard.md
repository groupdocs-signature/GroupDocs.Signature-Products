...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Code93standard barcodes to CDR files within their applications by implementing a few easy steps.
