...
draft: false
############################# Head ############################
head_title: "Создать штрих-код Standard2of5 и подписать файл CDR в .NET | Подписывать документы"
head_description: "Подписывайте файлы CDR с помощью подписей штрих-кода Standard2of5 в .NET — добавляйте штрих-коды в популярные форматы деловых документов и файлов изображений."
############################# Header ############################
title: "Добавление подписей штрих-кода Standard2of5 в файл CDR на C#"
description: "Подпишите файлы CDR, используя штрих-код Standard2of5. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как сгенерировать штрих-код Standard2of5 для файла CDR в C#"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять штрих-коды Standard2of5 в файлы CDR в своих приложениях, выполняя несколько простых шагов.
        * Создайте новый экземпляр класса Signature и передайте путь к исходному документу CDR в качестве параметра конструктора.
        ...
        * Вызовите метод Sign класса Signature и передайте ему имя выходного CDR-файла с BarcodeSignOptions.
    ...
    code: |
        ...
        using (Signature signature = new Signature("sample.cdr"))
        {
            ...
            // Подпишите файл CDR и сохраните результат
...
demos:
    ...
    content: |
        Добавьте штрих-коды Standard2of5 в файлы CDR прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
