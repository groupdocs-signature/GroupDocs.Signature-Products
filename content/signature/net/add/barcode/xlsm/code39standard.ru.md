...
draft: false
############################# Head ############################
head_title: "Создание стандартного штрих-кода Code39 и подписание файла XLSM в .NET | Подписывать документы"
head_description: "Подписывайте файлы XLSM с помощью стандартных подписей штрих-кода Code39 в .NET — добавляйте штрих-коды в популярные форматы деловых документов и файлов изображений."
############################# Header ############################
title: "Добавление стандартных подписей штрих-кода Code39 в файл XLSM на C#"
description: "Подпишите файлы XLSM, используя стандартный штрих-код Code39. Управляйте свойствами подписи и настраивайте расширенные параметры подписи в документах в соответствии с вашими потребностями."
...
steps:
    enable: true
    title_left: "Как сгенерировать стандартный штрих-код Code39 для файла XLSM в C#"
    content_left: |
        [GroupDocs.Signature](/ru/signature/net/) позволяет разработчикам .NET легко добавлять стандартные штрих-коды Code39 в файлы XLSM в своих приложениях, выполняя несколько простых шагов.
        * Создайте новый экземпляр класса Signature и передайте исходный путь к документу XLSM в качестве параметра конструктора.
        * Создайте экземпляр объекта BarcodeSignOptions с требуемым текстом и установите для свойства EncodeType значение Code39Standard.
        * Вызовите метод Sign класса Signature и передайте ему имя выходного XLSM-файла с BarcodeSignOptions.
    ...
    code: |
        ...
        using (Signature signature = new Signature("sample.xlsm"))
        {
            ...
            // Подпишите файл XLSM и сохраните результат
...
demos:
    enable: true
    title: "Живые демонстрации — онлайн-приложение для создания стандартных подписей штрих-кода Code39"
    content: |
        Добавьте штрих-коды Code39standard в файлы XLSM прямо сейчас, посетив веб-сайт [GroupDocs.Signature Живые события](https://products.groupdocs.app/signature/family).
############################# About Formats ############################
about_formats:
    enable: true
    format:
        # format loop
        - icon: "fas fa-barcode"
          title: "О Code39Стандартный штрих-код"
          content: |
            Code 39 был разработан в 1974 году Дэвидом Алле и Рэймондом Стивенсом, затем совместно с Interface Mechanisms Inc. (теперь Intermec Corporation). Это была первая символика штрих-кода, в которой помимо цифровых цифр использовались буквенные символы. Варианты кода 39 широко использовались во многих отраслях, особенно в вооруженных силах США в качестве компонента системы логистических приложений автоматической маркировки и считывания символов (LOGMARS).
          link: ""
############################# More Formats ############################
more_formats:
    enable: true
    title: "Подписание других форматов документов с помощью стандартного штрих-кода Code39 с использованием C#"
    content: |
