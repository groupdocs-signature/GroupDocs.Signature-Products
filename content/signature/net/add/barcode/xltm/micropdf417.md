...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Micropdf417 barcodes to XLTM files within their applications by implementing a few easy steps.
