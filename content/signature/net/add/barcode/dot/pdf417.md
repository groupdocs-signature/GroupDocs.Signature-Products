...
steps:
    ...
    content_left: |
        [GroupDocs.Signature](/signature/net/) makes it easy for .NET developers to add Pdf417 barcodes to DOT files within their applications by implementing a few easy steps.
