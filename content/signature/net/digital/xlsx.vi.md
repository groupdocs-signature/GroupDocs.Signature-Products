...
############################# Head ############################
head_title: "Thêm chữ ký điện tử số vào tệp XLSX bằng C#"
head_description: "Đặt chữ ký số trên tệp XLSX bằng C# chỉ với vài dòng mã. Sử dụng GroupDocs.Signature for .NET để ký nhiều định dạng tệp khác nhau."

############################# Header ############################
title: "Ký XLSX bằng chữ ký số" 
...
steps:
    enable: true
    title: "Cách bảo mật XLSX bằng chứng chỉ số trong C#"
    content: |
      [GroupDocs.Signature](/signature/net/) giúp các nhà phát triển .NET bảo vệ tài liệu XLSX khỏi các thay đổi bằng cách sử dụng chữ ký số. Tăng cường khả năng bảo vệ dữ liệu cho ứng dụng kinh doanh của bạn.
      
      1. Chuyển tài liệu XLSX đến hàm khởi tạo lớp Signature.
