...
############################# Head ############################
head_title: "Menambahkan tanda tangan elektronik digital ke file PPTX dengan C#"
head_description: "Pasang tanda tangan digital pada file PPTX menggunakan C# dengan hanya beberapa baris kode. Gunakan GroupDocs.Signature for .NET untuk menandatangani berbagai format file."

############################# Header ############################
title: "eSign PPTX dengan tanda tangan digital" 
...
steps:
    enable: true
    title: "Cara mengamankan PPTX dengan sertifikat digital di C#"
    content: |
      [GroupDocs.Signature](/signature/net/) memberdayakan pengembang .NET untuk melindungi dokumen PPTX dari perubahan menggunakan tanda tangan digital. Tingkatkan aplikasi bisnis Anda dengan kemampuan perlindungan data yang kuat.
      
      1. Serahkan dokumen PPTX ke konstruktor kelas Signature.
