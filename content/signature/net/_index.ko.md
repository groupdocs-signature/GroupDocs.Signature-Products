...
overview:
    enable: true
    content: |
      .NET API용 GroupDocs.Signature를 사용하여 PDF, Microsoft Word, Excel 스프레드시트, PowerPoint 프레젠테이션, 이미지, OpenDocument 및 추가 소프트웨어를 설치할 필요 없이 다른 산업 표준 파일 형식. 이 전자 서명 라이브러리는 사용이 간편하며 .NET 개발자는 응용 프로그램에 고급 디지털 서명 기능을 쉽게 추가할 수 있으므로 사용자가 널리 사용되는 문서 형식에서 전자 서명에 안전하게 서명, 검색 및 확인할 수 있습니다. 텍스트, 이미지, 바코드, QR 코드, 양식 필드, 스탬프 및 메타데이터와 같은 다양한 서명 유형 구현을 지원합니다.  

      문서 서명 API는 문서에서 필요한 서명을 순식간에 찾을 수 있는 단순하고 고급 검색 옵션을 제공합니다. 서명 스타일, 모양 관리를 적용하고 치수, 그림자, 정렬 등과 같은 서명 속성을 사용자 지정하는 옵션도 이 풍부한 기능의 문서 서명 API를 사용하여 수행할 수 있습니다.  

      .NET용 GroupDocs.Signature는 .NET 플랫폼을 지원하는 모든 개발 환경에서 사용할 수 있습니다. 모든 .NET 기반 언어와 호환되며 Mono 또는 .NET 프레임워크(.NET Core 포함)를 설치할 수 있는 인기 있는 운영 체제(Windows, Linux, MacOS)를 지원합니다.
    tabs:
      enable: true
...
features:
    enable: true
    title: ".NET 기능을 위한 GroupDocs.Signature"
    ...
    feature:
      ...
      - icon: "fas fa-eye"
        content: "Excel 스프레드시트용 XML 고급 전자 서명(XAdES) 지정"

      - icon: "fas fa-bolt"
        content: "QR 코드, 바코드 및 이미지 서명으로 서명된 문서에서 이미지 콘텐츠 검색"
      
      - icon: "fas fa-file-powerpoint"
        content: "텍스트 또는 이미지 서명에 대한 높이, 너비, 여백 및 정렬 설정 및 특정 페이지에 배치"
      ...
      - icon: "fas fa-comment-slash"
        content: "특정 Excel 시트에 텍스트 또는 이미지 서명 적용 또는 모든 시트에 전자 서명 설정"
      ...
      - icon: "fas fa-wrench"
        content: "Excel 시트에 대한 텍스트 서명 테두리 스타일 및 글꼴 옵션 구성"

      - icon: "fas fa-columns"
        content: "이미지 서명 유형 설정, 예: 원형 또는 정사각형 및 여백 구성, 글꼴 색상, 회전"
      ...
      - icon: "fas fa-file-archive"
        content: "사용자 정의 개체 포함, PDF 문서의 메타데이터 서명 값 암호화 및 암호 해독 및 직렬화"
      ...
      - icon: "fas fa-file-excel"
        content: "Word 파일에 대한 서명 또는 전자 서명 확장 검증 처리를 위한 문서의 임의 페이지 지정"
      ...
      - icon: "fas fa-cube"
        content: "eSign 워크시트, PowerPoint 슬라이드, 메타데이터의 사용자 정의 개체가 있는 Word 문서 및 이미지"

      - icon: "fab fa-uncharted"
        content: "시그니처 브러시 스타일을 단색, 텍스처, 선형 그라데이션 및 방사형 그라데이션으로 설정"

      - icon: "fab fa-uncharted"
        content: "사용자 정의 암호화된 QR 코드 텍스트 또는 데이터로 문서 서명"

      - icon: "fab fa-uncharted"
        content: "이미지 문서로 DjVu 형식으로 파일 검색 및 서명"

      - icon: "fab fa-uncharted"
        content: "파일 URL을 통해 문서 정보(예: 페이지 수) 추출"

      - icon: "fab fa-uncharted"
        content: "CorelDraw 파일을 이미지 문서로 검색, 서명 및 확인"

      - icon: "fab fa-uncharted"
        content: "메타데이터에 저장된 처리 또는 삭제된 서명 정보의 기록 유지"

      - icon: "fab fa-uncharted"
        content: "QR 코드에 사용자 지정 데이터 개체, VCard 또는 이메일 개체 추가 및 PDF 파일의 암호화된 QR 코드 확인"
    ...
    more_feature:
      ...
      - title: "서명 및 인증서 검색"
        content: |
          .NET API용 GroupDocs.Signature를 사용하면 Word 문서, Excel 스프레드시트 및 PDF 파일에서 디지털 인증서를 검색할 수 있습니다. 시스템에 등록된 모든 디지털 인증서를 가져올 수도 있습니다. 메타데이터 서명은 .NET API용 GroupDocs.Signature를 사용하여 Word 문서, Excel 스프레드시트, 이미지 및 PDF 파일에서도 검색할 수 있습니다.  

          .NET API용 GroupDocs.Signature를 통해 모든 문서, 프레젠테이션, 스프레드시트, 이미지 및 PDF 파일에서 QR-Code 및 Barcode 서명을 검색하고 검색 진행률을 가져올 수 있습니다. QR 코드 서명으로 서명된 문서에서 사용자 정의 데이터 개체를 검색할 수도 있습니다.

      - title: "바코드에 대한 고급 검색 옵션"
        content: "서명 API가 고급 검색 옵션을 제공하므로 GroupDocs.Signature for.NET API를 통해 필요한 바코드를 매우 쉽게 검색하고 찾을 수 있습니다. 이를 통해 특정 페이지에서 바코드 검색, 문서 전체 검색, 검색할 다른 페이지 지정(첫 번째, 마지막, 짝수, 홀수), 특정 인코딩 유형의 바코드 검색, 특정 텍스트 문자열을 기반으로 바코드 검색 또는 바코드 검색을 수행할 수 있습니다. contains 옵션이 있는 문자열 기반."
...
solutions:
    enable: true
    title: "GroupDocs.Signature는 다른 인기 있는 개발 환경을 위한 문서 보기 API를 제공합니다."
