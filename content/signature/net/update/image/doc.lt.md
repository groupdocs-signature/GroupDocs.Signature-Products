...
############################# Head ############################
head_title: "Atnaujinkite Image parašus, pateiktus Doc failuose naudodami C#"
head_description: "Naudokite paprastą ir lengvai suprantamą .NET kodą Image parašų atnaujinimui pasirašytuose Doc dokumentuose."

############################# Header ############################
title: "Redaguoti ir atnaujinti Image parašus, esančius Doc failuose"
description: "API, skirta .NET, teikia Image parašų atnaujinimo funkciją Doc dokumentuose. Greitai ir lengvai atnaujinkite el. parašus savo Doc dokumentuose naudodami kelias C# kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip pakeisti Image parašus Doc dokumente"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingų funkcijų, pvz., Image parašų, esančių Doc dokumentuose, atnaujinimas. Tai leidžia pakeisti parašo funkcijas be papildomo kodo.
