...
############################# Head ############################
head_title: "Atualize assinaturas Image colocadas em arquivos Ppt com C#"
head_description: "Use o código .NET simples e fácil para atualização de assinaturas Image em documentos Ppt assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Image colocadas em arquivos Ppt"
description: "A API para .NET fornece funcionalidade para atualização de assinaturas Image em documentos Ppt. Atualize assinaturas eletrônicas dentro de seus documentos Ppt com algumas linhas de código C# de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como alterar assinaturas Image em seu documento Ppt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis como atualização de Image assinaturas colocadas em documentos Ppt. Possibilita alterar recursos de assinaturas sem código extra.
