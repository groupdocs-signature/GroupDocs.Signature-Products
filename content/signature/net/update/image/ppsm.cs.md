...
############################# Head ############################
head_title: "Aktualizujte podpisy Image umístěné v souborech Ppsm pomocí C#"
head_description: "Použijte jednoduchý a snadno pochopitelný kód .NET pro aktualizaci podpisů Image v podepsaných dokumentech Ppsm."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Image umístěné v souborech Ppsm"
description: "API pro .NET poskytuje funkce pro aktualizaci podpisů Image v dokumentech Ppsm. Aktualizujte elektronické podpisy ve svých dokumentech Ppsm pomocí několika řádků kódu C# rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je aktualizace podpisů Image umístěných v dokumentech Ppsm. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
