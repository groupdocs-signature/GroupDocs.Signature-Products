...
############################# Head ############################
head_title: "Actualitza les signatures de Image col·locades als fitxers Xlsb amb C#"
head_description: "Utilitzeu el codi .NET senzill i fàcil d'entendre per a l'actualització de signatures de Image en documents de Xlsb signats."

############################# Header ############################
title: "Editeu i actualitzeu les signatures Image col·locades als fitxers Xlsb"
description: "L'API per a .NET proporciona funcionalitat per a les signatures de Image que s'actualitzen als documents Xlsb. Actualitzeu les signatures electròniques dins dels vostres documents Xlsb amb un parell de línies de codi C# de manera ràpida i senzilla."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclou funcions útils com ara l'actualització de signatures de Image col·locades als documents Xlsb. Permet canviar les funcions de signatures sense codi addicional.
