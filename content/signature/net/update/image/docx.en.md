...
############################# Head ############################
head_title: "Update Image signatures placed at Docx files in C#"
head_description: "Use simple and easy to understand .NET code for Image signatures updation in signed Docx documents."

############################# Header ############################
title: "Edit and update Image signatures placed at Docx files"
description: "API for .NET provides functionality to edit and update Image signatures at Docx documents. Update e-signatures inside your Docx documents with a couple lines of code quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like updation of Image signatures placed at Docx documents. It is makes possible to change signatures features without excess code.
