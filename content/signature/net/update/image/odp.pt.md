...
############################# Head ############################
head_title: "Atualize assinaturas Image colocadas em arquivos Odp com C#"
head_description: "Use o código .NET simples e fácil para atualização de assinaturas Image em documentos Odp assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Image colocadas em arquivos Odp"
description: "A API para .NET fornece funcionalidade para atualização de assinaturas Image em documentos Odp. Atualize assinaturas eletrônicas dentro de seus documentos Odp com algumas linhas de código C# de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis como atualização de Image assinaturas colocadas em documentos Odp. Possibilita alterar recursos de assinaturas sem código extra.
