...
############################# Head ############################
head_title: "Actualice Image firmas colocadas en Odp archivos con C#"
head_description: "Use código simple y fácil de entender .NET para la actualización de firmas Image en documentos Odp firmados."

############################# Header ############################
title: "Edite y actualice Image firmas colocadas en Odp archivos"
description: "La API para .NET proporciona funcionalidad para la actualización de firmas Image en documentos Odp. Actualice las firmas electrónicas dentro de sus documentos Odp con un par de líneas de código C# rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la actualización de Image firmas colocadas en Odp documentos. Hace posible cambiar las características de las firmas sin código adicional.
