...
############################# Head ############################
head_title: "Nuashonraigh Image sínithe atá curtha i gcomhad Xlsm le C#"
head_description: "Úsáid cód .NET atá simplí agus éasca le tuiscint le haghaidh nuashonruithe sínithe Image i ndoiciméid sínithe Xlsm."

############################# Header ############################
title: "Cuir in eagar agus nuashonraigh Image sínithe atá curtha ag comhaid Xlsm"
description: "Soláthraíonn API le haghaidh .NET feidhmiúlacht le haghaidh sínithe Image nuashonraithe ag Xlsm doiciméad. Nuashonraigh ríomhshínithe taobh istigh de do dhoiciméid Xlsm le cúpla líne de chód C# go tapa agus go héasca."
...
steps:
    ...
    content_left: |
        Cuimsíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail nuashonrú ar Image sínithe a cuireadh i ndoiciméid Xlsm. Is féidir gnéithe sínithe a athrú gan cód breise.
