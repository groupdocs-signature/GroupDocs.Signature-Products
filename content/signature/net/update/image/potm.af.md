...
############################# Head ############################
head_title: "Dateer Image-handtekeninge wat by Potm-lêers geplaas is op met C#"
head_description: "Gebruik eenvoudig en maklik om .NET-kode te verstaan ​​vir opdatering van Image-handtekeninge in ondertekende Potm-dokumente."

############################# Header ############################
title: "Wysig en werk Image-handtekeninge op wat by Potm-lêers geplaas is"
description: "API vir .NET verskaf funksionaliteit vir Image handtekeninge wat by Potm dokumente opdateer. Dateer e-handtekeninge binne jou Potm dokumente op met 'n paar reëls van C# kode vinnig en maklik."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos opdatering van Image-handtekeninge wat by Potm-dokumente geplaas is. Dit maak dit moontlik om handtekeningkenmerke te verander sonder ekstra kode.
