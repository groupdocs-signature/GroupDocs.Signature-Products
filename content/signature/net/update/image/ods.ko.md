...
############################# Head ############################
head_title: "C#을(를) 사용하여 Ods 파일에 있는 Image 서명 업데이트"
head_description: "서명된 Ods 문서에서 Image 서명 업데이트를 위해 간단하고 이해하기 쉬운 .NET 코드를 사용하세요."

############################# Header ############################
title: "Ods 파일에 있는 Image 서명 편집 및 업데이트"
description: ".NET용 API는 Ods 문서에서 업데이트되는 Image 서명에 대한 기능을 제공합니다. 몇 줄의 C# 코드로 Ods 문서 내의 전자 서명을 빠르고 쉽게 업데이트하십시오."
...
steps:
    enable: true
    title_left: "Ods 문서에서 Image 서명을 변경하는 방법"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/)에는 Ods 문서에 있는 Image 서명 업데이트와 같은 유용한 기능이 포함되어 있습니다. 추가 코드 없이 서명 기능을 변경할 수 있습니다.
