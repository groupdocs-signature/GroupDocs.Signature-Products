...
############################# Head ############################
head_title: "使用 C# 更新放置在 Xlsb 文件中的 Image 签名"
head_description: "在已签名的 Xlsb 文档中使用简单易懂的 .NET 代码进行 Image 签名更新。"

############################# Header ############################
title: "编辑和更新放置在 Xlsb 文件中的 Image 签名"
description: ".NET 的 API 提供了在 Xlsb 文档中更新 Image 签名的功能。使用几行 C# 代码快速轻松地更新 Xlsb 文档中的电子签名。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) 包括有用的功能，例如更新放置在 Xlsb 文档中的 Image 签名。无需额外代码即可更改签名功能。
