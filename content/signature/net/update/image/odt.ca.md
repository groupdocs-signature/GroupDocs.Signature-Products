...
############################# Head ############################
head_title: "Actualitza les signatures de Image col·locades als fitxers Odt amb C#"
head_description: "Utilitzeu el codi .NET senzill i fàcil d'entendre per a l'actualització de signatures de Image en documents de Odt signats."

############################# Header ############################
title: "Editeu i actualitzeu les signatures Image col·locades als fitxers Odt"
description: "L'API per a .NET proporciona funcionalitat per a les signatures de Image que s'actualitzen als documents Odt. Actualitzeu les signatures electròniques dins dels vostres documents Odt amb un parell de línies de codi C# de manera ràpida i senzilla."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclou funcions útils com ara l'actualització de signatures de Image col·locades als documents Odt. Permet canviar les funcions de signatures sense codi addicional.
