...
############################# Head ############################
head_title: "Mettre à jour les signatures Image placées dans les fichiers Xlsx avec C#"
head_description: "Utilisez le code .NET simple et facile à comprendre pour la mise à jour des signatures Image dans les documents signés Xlsx."

############################# Header ############################
title: "Modifier et mettre à jour les signatures Image placées dans les fichiers Xlsx"
description: "L'API pour .NET fournit des fonctionnalités pour la mise à jour des signatures Image dans les documents Xlsx. Mettez à jour les signatures électroniques dans vos documents Xlsx avec quelques lignes de code C# rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment changer les signatures Image dans votre document Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclut des fonctionnalités utiles telles que la mise à jour des signatures Image placées dans les documents Xlsx. Il permet de modifier les fonctionnalités des signatures sans code supplémentaire.
...
demos:
    ...
    content: |
       Modifiez dès maintenant diverses signatures électroniques du document Xlsx en visitant le site Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          

############################# More Formats ############################
more_formats:
    enable: true
    title: "Mettre à jour diverses signatures Image via C#"
    content: |
