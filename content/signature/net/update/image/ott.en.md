...
############################# Head ############################
head_title: "Update Image signatures placed at Ott files with C#"
head_description: "Use simple and easy for understanding .NET code for Image signatures updation in signed Ott documents."

############################# Header ############################
title: "Edit and update Image signatures placed at Ott files"
description: "API for .NET provides functionality for Image signatures updating at Ott documents. Update e-signatures inside your Ott documents with a couple lines of C# code quickly and easily."
...
steps:
    enable: true
    title_left: "How to change Image signatures in your Ott document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like updation of Image signatures placed at Ott documents. It makes possible to change signatures features without extra code.
