...
############################# Head ############################
head_title: "Aktualizujte podpisy Image umístěné v souborech Potx pomocí C#"
head_description: "Použijte jednoduchý a snadno pochopitelný kód .NET pro aktualizaci podpisů Image v podepsaných dokumentech Potx."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Image umístěné v souborech Potx"
description: "API pro .NET poskytuje funkce pro aktualizaci podpisů Image v dokumentech Potx. Aktualizujte elektronické podpisy ve svých dokumentech Potx pomocí několika řádků kódu C# rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je aktualizace podpisů Image umístěných v dokumentech Potx. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
