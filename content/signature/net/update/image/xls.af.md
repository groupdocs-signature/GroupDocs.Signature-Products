...
############################# Head ############################
head_title: "Dateer Image-handtekeninge wat by Xls-lêers geplaas is op met C#"
head_description: "Gebruik eenvoudig en maklik om .NET-kode te verstaan ​​vir opdatering van Image-handtekeninge in ondertekende Xls-dokumente."

############################# Header ############################
title: "Wysig en werk Image-handtekeninge op wat by Xls-lêers geplaas is"
description: "API vir .NET verskaf funksionaliteit vir Image handtekeninge wat by Xls dokumente opdateer. Dateer e-handtekeninge binne jou Xls dokumente op met 'n paar reëls van C# kode vinnig en maklik."
...
steps:
    enable: true
    title_left: "Hoe om Image-handtekeninge in jou Xls-dokument te verander"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos opdatering van Image-handtekeninge wat by Xls-dokumente geplaas is. Dit maak dit moontlik om handtekeningkenmerke te verander sonder ekstra kode.
