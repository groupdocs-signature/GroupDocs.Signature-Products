...
############################# Head ############################
head_title: "Zaktualizuj podpisy Qrcode umieszczone w plikach Xlsb za pomocą C#"
head_description: "Użyj prostego i łatwego do zrozumienia kodu .NET do aktualizacji podpisów Qrcode w podpisanych dokumentach Xlsb."

############################# Header ############################
title: "Edytuj i aktualizuj podpisy Qrcode umieszczone w plikach Xlsb"
description: "Interfejs API dla .NET zapewnia funkcjonalność aktualizacji podpisów Qrcode w dokumentach Xlsb. Zaktualizuj podpisy elektroniczne w swoich dokumentach Xlsb za pomocą kilku linijek kodu C# szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zmienić podpisy Qrcode w dokumencie Xlsb?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak aktualizacja podpisów Qrcode umieszczonych w dokumentach Xlsb. Umożliwia zmianę funkcji podpisów bez dodatkowego kodu.
