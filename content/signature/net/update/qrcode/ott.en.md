...
############################# Head ############################
head_title: "Update Qrcode signatures placed at Ott files with C#"
head_description: "Use simple and easy for understanding .NET code for Qrcode signatures updation in signed Ott documents."

############################# Header ############################
title: "Edit and update Qrcode signatures placed at Ott files"
description: "API for .NET provides functionality for Qrcode signatures updating at Ott documents. Update e-signatures inside your Ott documents with a couple lines of C# code quickly and easily."
...
steps:
    enable: true
    title_left: "How to change Qrcode signatures in your Ott document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like updation of Qrcode signatures placed at Ott documents. It makes possible to change signatures features without extra code.
...
demos:
    ...
    content: |
       Edit various electronic signatures of the Ott document right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.          
