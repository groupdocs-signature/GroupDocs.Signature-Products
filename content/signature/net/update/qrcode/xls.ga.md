...
############################# Head ############################
head_title: "Nuashonraigh Qrcode sínithe atá curtha i gcomhad Xls le C#"
head_description: "Úsáid cód .NET atá simplí agus éasca le tuiscint le haghaidh nuashonruithe sínithe Qrcode i ndoiciméid sínithe Xls."

############################# Header ############################
title: "Cuir in eagar agus nuashonraigh Qrcode sínithe atá curtha ag comhaid Xls"
description: "Soláthraíonn API le haghaidh .NET feidhmiúlacht le haghaidh sínithe Qrcode nuashonraithe ag Xls doiciméad. Nuashonraigh ríomhshínithe taobh istigh de do dhoiciméid Xls le cúpla líne de chód C# go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Qrcode sínithe a athrú i do dhoiciméad Xls"
    content_left: |
        Cuimsíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail nuashonrú ar Qrcode sínithe a cuireadh i ndoiciméid Xls. Is féidir gnéithe sínithe a athrú gan cód breise.
