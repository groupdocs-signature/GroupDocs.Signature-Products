...
############################# Head ############################
head_title: "Actualitza les signatures de Qrcode col·locades als fitxers Xlsm amb C#"
head_description: "Utilitzeu el codi .NET senzill i fàcil d'entendre per a l'actualització de signatures de Qrcode en documents de Xlsm signats."

############################# Header ############################
title: "Editeu i actualitzeu les signatures Qrcode col·locades als fitxers Xlsm"
description: "L'API per a .NET proporciona funcionalitat per a les signatures de Qrcode que s'actualitzen als documents Xlsm. Actualitzeu les signatures electròniques dins dels vostres documents Xlsm amb un parell de línies de codi C# de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com canviar les signatures de Qrcode al vostre document Xlsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclou funcions útils com ara l'actualització de signatures de Qrcode col·locades als documents Xlsm. Permet canviar les funcions de signatures sense codi addicional.
