...
############################# Head ############################
head_title: "Atualize assinaturas Qrcode colocadas em arquivos Potm com C#"
head_description: "Use o código .NET simples e fácil para atualização de assinaturas Qrcode em documentos Potm assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Qrcode colocadas em arquivos Potm"
description: "A API para .NET fornece funcionalidade para atualização de assinaturas Qrcode em documentos Potm. Atualize assinaturas eletrônicas dentro de seus documentos Potm com algumas linhas de código C# de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis como atualização de Qrcode assinaturas colocadas em documentos Potm. Possibilita alterar recursos de assinaturas sem código extra.
