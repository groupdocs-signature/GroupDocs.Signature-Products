...
############################# Head ############################
head_title: "Perbarui tanda tangan Qrcode yang ditempatkan di file Pptx dengan C#"
head_description: "Gunakan kode .NET yang sederhana dan mudah dipahami untuk pembaruan tanda tangan Qrcode dalam dokumen Pptx yang ditandatangani."

############################# Header ############################
title: "Edit dan perbarui tanda tangan Qrcode yang ditempatkan di file Pptx"
description: "API untuk .NET menyediakan fungsionalitas untuk pembaruan tanda tangan Qrcode pada dokumen Pptx. Perbarui tanda tangan elektronik di dalam dokumen Pptx Anda dengan beberapa baris kode C# dengan cepat dan mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyertakan fitur berguna seperti pembaruan tanda tangan Qrcode yang ditempatkan di dokumen Pptx. Itu memungkinkan untuk mengubah fitur tanda tangan tanpa kode tambahan.
