...
############################# Head ############################
head_title: "Opdater Qrcode signaturer placeret på Pptx filer med C#"
head_description: "Brug enkel og nem at forstå .NET-koden til opdatering af Qrcode-signaturer i signerede Pptx-dokumenter."

############################# Header ############################
title: "Rediger og opdater Qrcode signaturer placeret på Pptx filer"
description: "API for .NET giver funktionalitet til Qrcode signaturer, der opdateres i Pptx dokumenter. Opdater e-signaturer i dine Pptx dokumenter med et par linjer med C# kode hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan ændrer du Qrcode-signaturer i dit Pptx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner som f.eks. opdatering af Qrcode signaturer placeret på Pptx dokumenter. Det gør det muligt at ændre signaturfunktioner uden ekstra kode.
