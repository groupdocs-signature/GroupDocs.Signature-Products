...
############################# Head ############################
head_title: "Aktualizujte podpisy Qrcode umístěné v souborech Odt pomocí C#"
head_description: "Použijte jednoduchý a snadno pochopitelný kód .NET pro aktualizaci podpisů Qrcode v podepsaných dokumentech Odt."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Qrcode umístěné v souborech Odt"
description: "API pro .NET poskytuje funkce pro aktualizaci podpisů Qrcode v dokumentech Odt. Aktualizujte elektronické podpisy ve svých dokumentech Odt pomocí několika řádků kódu C# rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je aktualizace podpisů Qrcode umístěných v dokumentech Odt. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
