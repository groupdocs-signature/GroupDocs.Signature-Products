...
############################# Head ############################
head_title: "Aktualizujte podpisy Qrcode umiestnené v súboroch Pptm pomocou C#"
head_description: "Použite jednoduchý a zrozumiteľný kód .NET na aktualizáciu podpisov Qrcode v podpísaných dokumentoch Pptm."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Qrcode umiestnené v súboroch Pptm"
description: "API pre .NET poskytuje funkcie pre aktualizácie podpisov Qrcode v dokumentoch Pptm. Rýchlo a jednoducho aktualizujte elektronické podpisy vo svojich dokumentoch Pptm pomocou niekoľkých riadkov kódu C#."
...
steps:
    enable: true
    title_left: "Ako zmeniť Qrcode podpisy vo vašom dokumente Pptm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je aktualizácia podpisov Qrcode umiestnených v dokumentoch Pptm. Umožňuje meniť funkcie podpisov bez dodatočného kódu.
