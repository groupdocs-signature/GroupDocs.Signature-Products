...
############################# Head ############################
head_title: "Actualitza les signatures de Qrcode col·locades als fitxers Potm amb C#"
head_description: "Utilitzeu el codi .NET senzill i fàcil d'entendre per a l'actualització de signatures de Qrcode en documents de Potm signats."

############################# Header ############################
title: "Editeu i actualitzeu les signatures Qrcode col·locades als fitxers Potm"
description: "L'API per a .NET proporciona funcionalitat per a les signatures de Qrcode que s'actualitzen als documents Potm. Actualitzeu les signatures electròniques dins dels vostres documents Potm amb un parell de línies de codi C# de manera ràpida i senzilla."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclou funcions útils com ara l'actualització de signatures de Qrcode col·locades als documents Potm. Permet canviar les funcions de signatures sense codi addicional.
