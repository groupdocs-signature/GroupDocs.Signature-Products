...
############################# Head ############################
head_title: "Frissítse a Dotx fájlokban elhelyezett Qrcode aláírásokat a C# segítségével"
head_description: "Használjon egyszerű és könnyen érthető .NET kódot a Qrcode aláírások frissítéséhez az aláírt Dotx dokumentumokban."

############################# Header ############################
title: "Szerkessze és frissítse a Dotx fájlokban elhelyezett Qrcode aláírásokat"
description: "A(z) .NET API a(z) Qrcode aláírások frissítését biztosítja a(z) Dotx dokumentumokban. Frissítse az e-aláírásokat Dotx dokumentumaiban néhány soros C# kóddal gyorsan és egyszerűen."
...
steps:
    enable: true
    title_left: "A Qrcode aláírások módosítása a Dotx dokumentumban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) olyan hasznos funkciókat tartalmaz, mint a Qrcode aláírások frissítése a Dotx dokumentumokban. Lehetővé teszi az aláírási funkciók módosítását extra kód nélkül.
...
demos:
    ...
    content: |
       Szerkessze a Dotx dokumentum különféle elektronikus aláírásait most a [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webhelyen.          
