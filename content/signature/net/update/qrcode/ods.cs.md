...
############################# Head ############################
head_title: "Aktualizujte podpisy Qrcode umístěné v souborech Ods pomocí C#"
head_description: "Použijte jednoduchý a snadno pochopitelný kód .NET pro aktualizaci podpisů Qrcode v podepsaných dokumentech Ods."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Qrcode umístěné v souborech Ods"
description: "API pro .NET poskytuje funkce pro aktualizaci podpisů Qrcode v dokumentech Ods. Aktualizujte elektronické podpisy ve svých dokumentech Ods pomocí několika řádků kódu C# rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak změnit podpisy Qrcode ve vašem dokumentu Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je aktualizace podpisů Qrcode umístěných v dokumentech Ods. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
