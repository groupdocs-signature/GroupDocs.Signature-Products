...
############################# Head ############################
head_title: "Nuashonraigh Qrcode sínithe atá curtha i gcomhad Odp le C#"
head_description: "Úsáid cód .NET atá simplí agus éasca le tuiscint le haghaidh nuashonruithe sínithe Qrcode i ndoiciméid sínithe Odp."

############################# Header ############################
title: "Cuir in eagar agus nuashonraigh Qrcode sínithe atá curtha ag comhaid Odp"
description: "Soláthraíonn API le haghaidh .NET feidhmiúlacht le haghaidh sínithe Qrcode nuashonraithe ag Odp doiciméad. Nuashonraigh ríomhshínithe taobh istigh de do dhoiciméid Odp le cúpla líne de chód C# go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Qrcode sínithe a athrú i do dhoiciméad Odp"
    content_left: |
        Cuimsíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail nuashonrú ar Qrcode sínithe a cuireadh i ndoiciméid Odp. Is féidir gnéithe sínithe a athrú gan cód breise.
...
demos:
    ...
    content: |
       Cuir sínithe leictreonacha éagsúla den doiciméad Odp in eagar faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
