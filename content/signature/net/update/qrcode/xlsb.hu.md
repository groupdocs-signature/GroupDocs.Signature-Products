...
############################# Head ############################
head_title: "Frissítse a Xlsb fájlokban elhelyezett Qrcode aláírásokat a C# segítségével"
head_description: "Használjon egyszerű és könnyen érthető .NET kódot a Qrcode aláírások frissítéséhez az aláírt Xlsb dokumentumokban."

############################# Header ############################
title: "Szerkessze és frissítse a Xlsb fájlokban elhelyezett Qrcode aláírásokat"
description: "A(z) .NET API a(z) Qrcode aláírások frissítését biztosítja a(z) Xlsb dokumentumokban. Frissítse az e-aláírásokat Xlsb dokumentumaiban néhány soros C# kóddal gyorsan és egyszerűen."
...
steps:
    enable: true
    title_left: "A Qrcode aláírások módosítása a Xlsb dokumentumban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) olyan hasznos funkciókat tartalmaz, mint a Qrcode aláírások frissítése a Xlsb dokumentumokban. Lehetővé teszi az aláírási funkciók módosítását extra kód nélkül.
...
more_formats:
    enable: true
    title: "Különféle Qrcode aláírások frissítése a C# segítségével"
    content: |
