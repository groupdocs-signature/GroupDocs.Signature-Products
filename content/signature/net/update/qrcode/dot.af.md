...
############################# Head ############################
head_title: "Dateer Qrcode-handtekeninge wat by Dot-lêers geplaas is op met C#"
head_description: "Gebruik eenvoudig en maklik om .NET-kode te verstaan ​​vir opdatering van Qrcode-handtekeninge in ondertekende Dot-dokumente."

############################# Header ############################
title: "Wysig en werk Qrcode-handtekeninge op wat by Dot-lêers geplaas is"
description: "API vir .NET verskaf funksionaliteit vir Qrcode handtekeninge wat by Dot dokumente opdateer. Dateer e-handtekeninge binne jou Dot dokumente op met 'n paar reëls van C# kode vinnig en maklik."
...
steps:
    enable: true
    title_left: "Hoe om Qrcode-handtekeninge in jou Dot-dokument te verander"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos opdatering van Qrcode-handtekeninge wat by Dot-dokumente geplaas is. Dit maak dit moontlik om handtekeningkenmerke te verander sonder ekstra kode.
