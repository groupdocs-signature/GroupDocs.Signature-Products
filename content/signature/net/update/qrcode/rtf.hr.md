...
############################# Head ############################
head_title: "Ažurirajte Qrcode potpise postavljene u datoteke Rtf s C#"
head_description: "Koristite jednostavan i razumljiv .NET kod za ažuriranje potpisa Qrcode u potpisanim Rtf dokumentima."

############################# Header ############################
title: "Uredite i ažurirajte Qrcode potpise postavljene u Rtf datoteke"
description: "API za .NET pruža funkcionalnost za ažuriranje potpisa Qrcode u dokumentima Rtf. Ažurirajte e-potpise unutar svojih Rtf dokumenata s nekoliko redaka C# koda brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako promijeniti Qrcode potpise u vašem Rtf dokumentu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je ažuriranje Qrcode potpisa postavljenih u dokumente Rtf. Omogućuje promjenu značajki potpisa bez dodatnog koda.
