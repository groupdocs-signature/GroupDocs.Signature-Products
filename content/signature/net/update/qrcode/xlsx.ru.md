...
############################# Head ############################
head_title: "Обновите подписи Qrcode, размещенные в файлах Xlsx, с помощью C#"
head_description: "Используйте простой и понятный код .NET для обновления подписей Qrcode в подписанных документах Xlsx."

############################# Header ############################
title: "Редактировать и обновлять подписи Qrcode, размещенные в файлах Xlsx"
description: "API для .NET предоставляет функциональные возможности для обновления подписей Qrcode в документах Xlsx. Быстро и легко обновляйте электронные подписи внутри ваших документов Xlsx с помощью пары строк кода C#."
...
steps:
    enable: true
    title_left: "Как изменить подписи Qrcode в документе Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) содержит полезные функции, такие как обновление подписей Qrcode, размещенных в документах Xlsx. Это позволяет изменять функции подписи без дополнительного кода.
...
demos:
    ...
    content: |
       Редактируйте различные электронные подписи документа Xlsx прямо сейчас, посетив веб-сайт [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
