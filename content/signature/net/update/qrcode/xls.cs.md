...
############################# Head ############################
head_title: "Aktualizujte podpisy Qrcode umístěné v souborech Xls pomocí C#"
head_description: "Použijte jednoduchý a snadno pochopitelný kód .NET pro aktualizaci podpisů Qrcode v podepsaných dokumentech Xls."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Qrcode umístěné v souborech Xls"
description: "API pro .NET poskytuje funkce pro aktualizaci podpisů Qrcode v dokumentech Xls. Aktualizujte elektronické podpisy ve svých dokumentech Xls pomocí několika řádků kódu C# rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je aktualizace podpisů Qrcode umístěných v dokumentech Xls. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
