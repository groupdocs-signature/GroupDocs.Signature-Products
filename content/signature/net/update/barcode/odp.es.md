...
############################# Head ############################
head_title: "Actualice Barcode firmas colocadas en Odp archivos con C#"
head_description: "Use código simple y fácil de entender .NET para la actualización de firmas Barcode en documentos Odp firmados."

############################# Header ############################
title: "Edite y actualice Barcode firmas colocadas en Odp archivos"
description: "La API para .NET proporciona funcionalidad para la actualización de firmas Barcode en documentos Odp. Actualice las firmas electrónicas dentro de sus documentos Odp con un par de líneas de código C# rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo cambiar las firmas Barcode en su documento Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la actualización de Barcode firmas colocadas en Odp documentos. Hace posible cambiar las características de las firmas sin código adicional.
