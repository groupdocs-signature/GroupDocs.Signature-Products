...
############################# Head ############################
head_title: "Aktualizujte podpisy Barcode umístěné v souborech Dotx pomocí C#"
head_description: "Použijte jednoduchý a snadno pochopitelný kód .NET pro aktualizaci podpisů Barcode v podepsaných dokumentech Dotx."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Barcode umístěné v souborech Dotx"
description: "API pro .NET poskytuje funkce pro aktualizaci podpisů Barcode v dokumentech Dotx. Aktualizujte elektronické podpisy ve svých dokumentech Dotx pomocí několika řádků kódu C# rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak změnit podpisy Barcode ve vašem dokumentu Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je aktualizace podpisů Barcode umístěných v dokumentech Dotx. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
