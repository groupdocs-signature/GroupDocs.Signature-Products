...
############################# Head ############################
head_title: "Update Barcode signatures placed at Doc files with C#"
head_description: "Use simple and easy for understanding .NET code for Barcode signatures updation in signed Doc documents."

############################# Header ############################
title: "Edit and update Barcode signatures placed at Doc files"
description: "API for .NET provides functionality for Barcode signatures updating at Doc documents. Update e-signatures inside your Doc documents with a couple lines of C# code quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like updation of Barcode signatures placed at Doc documents. It makes possible to change signatures features without extra code.
