...
############################# Head ############################
head_title: "Actualice Barcode firmas colocadas en Xltx archivos con C#"
head_description: "Use código simple y fácil de entender .NET para la actualización de firmas Barcode en documentos Xltx firmados."

############################# Header ############################
title: "Edite y actualice Barcode firmas colocadas en Xltx archivos"
description: "La API para .NET proporciona funcionalidad para la actualización de firmas Barcode en documentos Xltx. Actualice las firmas electrónicas dentro de sus documentos Xltx con un par de líneas de código C# rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la actualización de Barcode firmas colocadas en Xltx documentos. Hace posible cambiar las características de las firmas sin código adicional.
