...
############################# Head ############################
head_title: "Update Barcode signatures placed at Xlsx files in C#"
head_description: "Use simple and easy to understand .NET code for Barcode signatures updation in signed Xlsx documents."

############################# Header ############################
title: "Edit and update Barcode signatures placed at Xlsx files"
description: "API for .NET provides functionality to edit and update Barcode signatures at Xlsx documents. Update e-signatures inside your Xlsx documents with a couple lines of code quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like updation of Barcode signatures placed at Xlsx documents. It is makes possible to change signatures features without excess code.
