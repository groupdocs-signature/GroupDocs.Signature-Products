...
############################# Head ############################
head_title: "Aktualizujte podpisy Barcode umístěné v souborech Dot pomocí C#"
head_description: "Použijte jednoduchý a snadno pochopitelný kód .NET pro aktualizaci podpisů Barcode v podepsaných dokumentech Dot."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Barcode umístěné v souborech Dot"
description: "API pro .NET poskytuje funkce pro aktualizaci podpisů Barcode v dokumentech Dot. Aktualizujte elektronické podpisy ve svých dokumentech Dot pomocí několika řádků kódu C# rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je aktualizace podpisů Barcode umístěných v dokumentech Dot. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
