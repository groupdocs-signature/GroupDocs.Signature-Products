...
############################# Head ############################
head_title: "Update Barcode signatures placed at Ots files in C#"
head_description: "Use simple and easy to understand .NET code for Barcode signatures updation in signed Ots documents."

############################# Header ############################
title: "Edit and update Barcode signatures placed at Ots files"
description: "API for .NET provides functionality to edit and update Barcode signatures at Ots documents. Update e-signatures inside your Ots documents with a couple lines of code quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like updation of Barcode signatures placed at Ots documents. It is makes possible to change signatures features without excess code.
