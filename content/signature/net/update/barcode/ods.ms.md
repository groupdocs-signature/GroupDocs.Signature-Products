...
############################# Head ############################
head_title: "Kemas kini tandatangan Barcode yang diletakkan pada fail Ods dengan C#"
head_description: "Gunakan kod .NET yang ringkas dan mudah untuk kemas kini tandatangan Barcode dalam dokumen Ods yang ditandatangani."

############################# Header ############################
title: "Edit dan kemas kini tandatangan Barcode yang diletakkan pada fail Ods."
description: "API untuk .NET menyediakan kefungsian untuk tandatangan Barcode mengemas kini pada dokumen Ods. Kemas kini e-tandatangan di dalam dokumen Ods anda dengan beberapa baris kod C# dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Cara menukar tandatangan Barcode dalam dokumen Ods anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) termasuk ciri berguna seperti pengemaskinian tandatangan Barcode yang diletakkan pada dokumen Ods. Ia memungkinkan untuk menukar ciri tandatangan tanpa kod tambahan.
