...
############################# Head ############################
head_title: "Aktualizujte podpisy Text umístěné v souborech Xlsm pomocí C#"
head_description: "Použijte jednoduchý a snadno pochopitelný kód .NET pro aktualizaci podpisů Text v podepsaných dokumentech Xlsm."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Text umístěné v souborech Xlsm"
description: "API pro .NET poskytuje funkce pro aktualizaci podpisů Text v dokumentech Xlsm. Aktualizujte elektronické podpisy ve svých dokumentech Xlsm pomocí několika řádků kódu C# rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak změnit podpisy Text ve vašem dokumentu Xlsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je aktualizace podpisů Text umístěných v dokumentech Xlsm. Umožňuje měnit vlastnosti podpisů bez dalšího kódu.
