...
############################# Head ############################
head_title: "Update Text signatures placed at Odp files in C#"
head_description: "Use simple and easy to understand .NET code for Text signatures updation in signed Odp documents."

############################# Header ############################
title: "Edit and update Text signatures placed at Odp files"
description: "API for .NET provides functionality to edit and update Text signatures at Odp documents. Update e-signatures inside your Odp documents with a couple lines of code quickly and easily."
...
steps:
    enable: true
    title_left: "How to change Text signatures in your Odp document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like updation of Text signatures placed at Odp documents. It is makes possible to change signatures features without excess code.
