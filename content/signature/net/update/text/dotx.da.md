...
############################# Head ############################
head_title: "Opdater Text signaturer placeret på Dotx filer med C#"
head_description: "Brug enkel og nem at forstå .NET-koden til opdatering af Text-signaturer i signerede Dotx-dokumenter."

############################# Header ############################
title: "Rediger og opdater Text signaturer placeret på Dotx filer"
description: "API for .NET giver funktionalitet til Text signaturer, der opdateres i Dotx dokumenter. Opdater e-signaturer i dine Dotx dokumenter med et par linjer med C# kode hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner som f.eks. opdatering af Text signaturer placeret på Dotx dokumenter. Det gør det muligt at ændre signaturfunktioner uden ekstra kode.
