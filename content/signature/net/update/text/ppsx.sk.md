...
############################# Head ############################
head_title: "Aktualizujte podpisy Text umiestnené v súboroch Ppsx pomocou C#"
head_description: "Použite jednoduchý a zrozumiteľný kód .NET na aktualizáciu podpisov Text v podpísaných dokumentoch Ppsx."

############################# Header ############################
title: "Upravte a aktualizujte podpisy Text umiestnené v súboroch Ppsx"
description: "API pre .NET poskytuje funkcie pre aktualizácie podpisov Text v dokumentoch Ppsx. Rýchlo a jednoducho aktualizujte elektronické podpisy vo svojich dokumentoch Ppsx pomocou niekoľkých riadkov kódu C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je aktualizácia podpisov Text umiestnených v dokumentoch Ppsx. Umožňuje meniť funkcie podpisov bez dodatočného kódu.
