...
############################# Head ############################
head_title: "Frissítse a Ott fájlokban elhelyezett Text aláírásokat a C# segítségével"
head_description: "Használjon egyszerű és könnyen érthető .NET kódot a Text aláírások frissítéséhez az aláírt Ott dokumentumokban."

############################# Header ############################
title: "Szerkessze és frissítse a Ott fájlokban elhelyezett Text aláírásokat"
description: "A(z) .NET API a(z) Text aláírások frissítését biztosítja a(z) Ott dokumentumokban. Frissítse az e-aláírásokat Ott dokumentumaiban néhány soros C# kóddal gyorsan és egyszerűen."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) olyan hasznos funkciókat tartalmaz, mint a Text aláírások frissítése a Ott dokumentumokban. Lehetővé teszi az aláírási funkciók módosítását extra kód nélkül.
