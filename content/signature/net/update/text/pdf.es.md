...
############################# Head ############################
head_title: "Actualice Text firmas colocadas en Pdf archivos con C#"
head_description: "Use código simple y fácil de entender .NET para la actualización de firmas Text en documentos Pdf firmados."

############################# Header ############################
title: "Edite y actualice Text firmas colocadas en Pdf archivos"
description: "La API para .NET proporciona funcionalidad para la actualización de firmas Text en documentos Pdf. Actualice las firmas electrónicas dentro de sus documentos Pdf con un par de líneas de código C# rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo cambiar las firmas Text en su documento Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la actualización de Text firmas colocadas en Pdf documentos. Hace posible cambiar las características de las firmas sin código adicional.
...
demos:
    ...
    content: |
       Edite varias firmas electrónicas del documento Pdf ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
