...
############################# Head ############################
head_title: "Frissítse a Doc fájlokban elhelyezett Text aláírásokat a C# segítségével"
head_description: "Használjon egyszerű és könnyen érthető .NET kódot a Text aláírások frissítéséhez az aláírt Doc dokumentumokban."

############################# Header ############################
title: "Szerkessze és frissítse a Doc fájlokban elhelyezett Text aláírásokat"
description: "A(z) .NET API a(z) Text aláírások frissítését biztosítja a(z) Doc dokumentumokban. Frissítse az e-aláírásokat Doc dokumentumaiban néhány soros C# kóddal gyorsan és egyszerűen."
...
steps:
    enable: true
    title_left: "A Text aláírások módosítása a Doc dokumentumban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) olyan hasznos funkciókat tartalmaz, mint a Text aláírások frissítése a Doc dokumentumokban. Lehetővé teszi az aláírási funkciók módosítását extra kód nélkül.
