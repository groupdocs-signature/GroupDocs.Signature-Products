...
############################# Head ############################
head_title: "Zaktualizuj podpisy Text umieszczone w plikach Ods za pomocą C#"
head_description: "Użyj prostego i łatwego do zrozumienia kodu .NET do aktualizacji podpisów Text w podpisanych dokumentach Ods."

############################# Header ############################
title: "Edytuj i aktualizuj podpisy Text umieszczone w plikach Ods"
description: "Interfejs API dla .NET zapewnia funkcjonalność aktualizacji podpisów Text w dokumentach Ods. Zaktualizuj podpisy elektroniczne w swoich dokumentach Ods za pomocą kilku linijek kodu C# szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak aktualizacja podpisów Text umieszczonych w dokumentach Ods. Umożliwia zmianę funkcji podpisów bez dodatkowego kodu.
