...
############################# Head ############################
head_title: "Cập nhật chữ ký Text được đặt trong tệp Xls bằng C#"
head_description: "Sử dụng mã .NET đơn giản và dễ hiểu để cập nhật chữ ký Text trong tài liệu Xls đã ký."

############################# Header ############################
title: "Chỉnh sửa và cập nhật chữ ký Text được đặt trong tệp Xls"
description: "API cho .NET cung cấp chức năng cập nhật chữ ký Text tại tài liệu Xls. Cập nhật chữ ký điện tử bên trong tài liệu Xls của bạn bằng một vài dòng mã C# một cách nhanh chóng và dễ dàng."
...
steps:
    enable: true
    title_left: "Cách thay đổi chữ ký Text trong tài liệu Xls của bạn"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) bao gồm các tính năng hữu ích như cập nhật chữ ký Text được đặt trong tài liệu Xls. Có thể thay đổi các tính năng của chữ ký mà không cần thêm mã.
