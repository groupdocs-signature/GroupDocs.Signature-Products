...
############################# Head ############################
head_title: "Atnaujinkite Text parašus, pateiktus Dot failuose naudodami C#"
head_description: "Naudokite paprastą ir lengvai suprantamą .NET kodą Text parašų atnaujinimui pasirašytuose Dot dokumentuose."

############################# Header ############################
title: "Redaguoti ir atnaujinti Text parašus, esančius Dot failuose"
description: "API, skirta .NET, teikia Text parašų atnaujinimo funkciją Dot dokumentuose. Greitai ir lengvai atnaujinkite el. parašus savo Dot dokumentuose naudodami kelias C# kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip pakeisti Text parašus Dot dokumente"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingų funkcijų, pvz., Text parašų, esančių Dot dokumentuose, atnaujinimas. Tai leidžia pakeisti parašo funkcijas be papildomo kodo.
