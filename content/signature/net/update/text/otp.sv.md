...
############################# Head ############################
head_title: "Uppdatera Text-signaturer placerade i Otp-filer med C#"
head_description: "Använd enkel och lätt att förstå .NET-koden för uppdatering av Text-signaturer i signerade Otp-dokument."

############################# Header ############################
title: "Redigera och uppdatera Text-signaturer placerade i Otp-filer"
description: "API för .NET tillhandahåller funktionalitet för Text-signaturer som uppdateras i Otp-dokument. Uppdatera e-signaturer i dina Otp-dokument med ett par rader C#-kod snabbt och enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som uppdatering av Text-signaturer placerade i Otp-dokument. Det gör det möjligt att ändra signaturfunktioner utan extra kod.
