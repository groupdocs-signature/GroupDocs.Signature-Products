...
############################# Head ############################
head_title: "Atnaujinkite Text parašus, pateiktus Xls failuose naudodami C#"
head_description: "Naudokite paprastą ir lengvai suprantamą .NET kodą Text parašų atnaujinimui pasirašytuose Xls dokumentuose."

############################# Header ############################
title: "Redaguoti ir atnaujinti Text parašus, esančius Xls failuose"
description: "API, skirta .NET, teikia Text parašų atnaujinimo funkciją Xls dokumentuose. Greitai ir lengvai atnaujinkite el. parašus savo Xls dokumentuose naudodami kelias C# kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingų funkcijų, pvz., Text parašų, esančių Xls dokumentuose, atnaujinimas. Tai leidžia pakeisti parašo funkcijas be papildomo kodo.
