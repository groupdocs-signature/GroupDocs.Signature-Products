...
############################# Head ############################
head_title: "Update Text signatures placed at Csv files with C#"
head_description: "Use simple and easy for understanding .NET code for Text signatures updation in signed Csv documents."

############################# Header ############################
title: "Edit and update Text signatures placed at Csv files"
description: "API for .NET provides functionality for Text signatures updating at Csv documents. Update e-signatures inside your Csv documents with a couple lines of C# code quickly and easily."
...
steps:
    enable: true
    title_left: "How to change Text signatures in your Csv document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like updation of Text signatures placed at Csv documents. It makes possible to change signatures features without extra code.
