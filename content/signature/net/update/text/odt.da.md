...
############################# Head ############################
head_title: "Opdater Text signaturer placeret på Odt filer med C#"
head_description: "Brug enkel og nem at forstå .NET-koden til opdatering af Text-signaturer i signerede Odt-dokumenter."

############################# Header ############################
title: "Rediger og opdater Text signaturer placeret på Odt filer"
description: "API for .NET giver funktionalitet til Text signaturer, der opdateres i Odt dokumenter. Opdater e-signaturer i dine Odt dokumenter med et par linjer med C# kode hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan ændrer du Text-signaturer i dit Odt-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner som f.eks. opdatering af Text signaturer placeret på Odt dokumenter. Det gør det muligt at ændre signaturfunktioner uden ekstra kode.
