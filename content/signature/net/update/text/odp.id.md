...
############################# Head ############################
head_title: "Perbarui tanda tangan Text yang ditempatkan di file Odp dengan C#"
head_description: "Gunakan kode .NET yang sederhana dan mudah dipahami untuk pembaruan tanda tangan Text dalam dokumen Odp yang ditandatangani."

############################# Header ############################
title: "Edit dan perbarui tanda tangan Text yang ditempatkan di file Odp"
description: "API untuk .NET menyediakan fungsionalitas untuk pembaruan tanda tangan Text pada dokumen Odp. Perbarui tanda tangan elektronik di dalam dokumen Odp Anda dengan beberapa baris kode C# dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Cara mengubah tanda tangan Text di dokumen Odp Anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyertakan fitur berguna seperti pembaruan tanda tangan Text yang ditempatkan di dokumen Odp. Itu memungkinkan untuk mengubah fitur tanda tangan tanpa kode tambahan.
