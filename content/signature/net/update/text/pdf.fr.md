...
############################# Head ############################
head_title: "Mettre à jour les signatures Text placées dans les fichiers Pdf avec C#"
head_description: "Utilisez le code .NET simple et facile à comprendre pour la mise à jour des signatures Text dans les documents signés Pdf."

############################# Header ############################
title: "Modifier et mettre à jour les signatures Text placées dans les fichiers Pdf"
description: "L'API pour .NET fournit des fonctionnalités pour la mise à jour des signatures Text dans les documents Pdf. Mettez à jour les signatures électroniques dans vos documents Pdf avec quelques lignes de code C# rapidement et facilement."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclut des fonctionnalités utiles telles que la mise à jour des signatures Text placées dans les documents Pdf. Il permet de modifier les fonctionnalités des signatures sans code supplémentaire.
