...
############################# Head ############################
head_title: "Zaktualizuj podpisy Text umieszczone w plikach Xltx za pomocą C#"
head_description: "Użyj prostego i łatwego do zrozumienia kodu .NET do aktualizacji podpisów Text w podpisanych dokumentach Xltx."

############################# Header ############################
title: "Edytuj i aktualizuj podpisy Text umieszczone w plikach Xltx"
description: "Interfejs API dla .NET zapewnia funkcjonalność aktualizacji podpisów Text w dokumentach Xltx. Zaktualizuj podpisy elektroniczne w swoich dokumentach Xltx za pomocą kilku linijek kodu C# szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak aktualizacja podpisów Text umieszczonych w dokumentach Xltx. Umożliwia zmianę funkcji podpisów bez dodatkowego kodu.
