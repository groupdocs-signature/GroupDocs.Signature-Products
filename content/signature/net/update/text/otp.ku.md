...
############################# Head ############################
head_title: "Îmzeyên Text li pelên Otp bi C# hatine danîn nûve bikin"
head_description: "Ji bo têgihîştina koda .NET ji bo nûvekirina îmzeyan a Text di belgeyên Otp yên îmzekirî de hêsan û hêsan bikar bînin."

############################# Header ############################
title: "Îmzeyên ku li pelên Otp hatine danîn biguherînin û nûve bikin"
description: "API ji bo .NET fonksîyonê ji bo îmzeyên Text di belgeyên Otp de nûve dike. E-îmzeyan di hundirê belgeyên xwe yên Otp de bi çend rêzikên koda C# zû û bi hêsanî nûve bikin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) taybetmendiyên bikêrhatî yên mîna nûvekirina îmzeyên Text yên ku li belgeyên Otp hatine danîn, vedihewîne. Ew gengaz dike ku taybetmendiyên îmzeyan bêyî kodek zêde biguhezîne.
