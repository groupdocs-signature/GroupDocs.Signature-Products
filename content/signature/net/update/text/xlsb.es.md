...
############################# Head ############################
head_title: "Actualice Text firmas colocadas en Xlsb archivos con C#"
head_description: "Use código simple y fácil de entender .NET para la actualización de firmas Text en documentos Xlsb firmados."

############################# Header ############################
title: "Edite y actualice Text firmas colocadas en Xlsb archivos"
description: "La API para .NET proporciona funcionalidad para la actualización de firmas Text en documentos Xlsb. Actualice las firmas electrónicas dentro de sus documentos Xlsb con un par de líneas de código C# rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la actualización de Text firmas colocadas en Xlsb documentos. Hace posible cambiar las características de las firmas sin código adicional.
