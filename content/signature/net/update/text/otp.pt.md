...
############################# Head ############################
head_title: "Atualize assinaturas Text colocadas em arquivos Otp com C#"
head_description: "Use o código .NET simples e fácil para atualização de assinaturas Text em documentos Otp assinados."

############################# Header ############################
title: "Edite e atualize assinaturas Text colocadas em arquivos Otp"
description: "A API para .NET fornece funcionalidade para atualização de assinaturas Text em documentos Otp. Atualize assinaturas eletrônicas dentro de seus documentos Otp com algumas linhas de código C# de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis como atualização de Text assinaturas colocadas em documentos Otp. Possibilita alterar recursos de assinaturas sem código extra.
