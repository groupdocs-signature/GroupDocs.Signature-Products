...
############################# Head ############################
head_title: "Cerca le firme Text nel file Xltm in C#"
head_description: "Usa .NET per cercare le firme Text nei file Xltm utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Text nel file Xltm"
description: "L'API nativa .NET consente di cercare firme Text in file Xltm già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Xltm utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Text in Xltm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Text nei file Xltm dalle loro applicazioni implementando alcuni semplici passaggi.
...
more_formats:
    enable: true
    title: "Cerca altre firme Text utilizzando C#"
    content: |
