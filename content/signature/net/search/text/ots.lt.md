...
############################# Head ############################
head_title: "Ieškokite Text parašų Ots faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Ots failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Ots faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Ots failuose. Atlikite išplėstinę el. parašo paiešką savo Ots dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Ots failuose iš savo programų, atlikdami kelis paprastus veiksmus.
