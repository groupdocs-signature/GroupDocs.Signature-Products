...
############################# Head ############################
head_title: "Meklēt Text parakstus Dotx failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Text parakstus Dotx failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Text parakstus failā Dotx"
description: ".NET vietējais API ļauj meklēt Text parakstus jau parakstītos Dotx failos. Veiciet izvērsto e-paraksta meklēšanu savos Dotx dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    enable: true
    title_left: "Kā meklēt Text parakstus Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Text parakstus Dotx failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
