...
############################# Head ############################
head_title: "C# içinde 7z dosyasında Text imzasını arayın"
head_description: "Birkaç satır kod kullanarak 7z dosyalarında Text imzasını aramak için .NET kullanın."

############################# Header ############################
title: "7z dosyasında Text imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış 7z dosyalarında Text imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak 7z belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak 7z dosyalarında Text imzalarını aramasını kolaylaştırır.
