...
############################# Head ############################
head_title: "Otsige allkirju Text failist Ott rakenduses C#"
head_description: "Kasutage .NET allkirjade Text otsimiseks failides Ott, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Ott"
description: "Native API .NET võimaldab otsida allkirju Text juba allkirjastatud Ott failides. Tehke oma Ott dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Text otsimist oma rakendustest failides Ott, rakendades mõnda lihtsat sammu.
