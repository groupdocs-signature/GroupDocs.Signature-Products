...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Ots u C#"
head_description: "Upotrijebite .NET za traženje potpisa Text u datotekama Ots pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Ots datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Text u već potpisanim Ots datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ots dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Text u datotekama Ots iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
