...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Otp dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Text dalam fail Otp menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Otp."
description: "API asli .NET membenarkan untuk mencari tandatangan Text dalam fail Otp yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Otp anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Text dalam Otp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Text dalam fail Otp daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
