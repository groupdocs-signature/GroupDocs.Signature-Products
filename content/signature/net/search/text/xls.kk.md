...
description: ".NET жергілікті API бұрыннан қол қойылған Xls файлдарындағы Text қолтаңбаларын іздеуге мүмкіндік береді. Кодтың бірнеше жолын пайдаланып Xls құжаттарыңызда кеңейтілген электрондық қолтаңбаны іздеуді орындаңыз."
