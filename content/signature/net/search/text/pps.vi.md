...
############################# Head ############################
head_title: "Tìm kiếm chữ ký Text trong tệp Pps trong C#"
head_description: "Sử dụng .NET để tìm kiếm chữ ký Text trong tệp Pps bằng một vài dòng mã."

############################# Header ############################
title: "Tìm kiếm chữ ký Text trong tệp Pps"
description: "API gốc .NET cho phép tìm kiếm chữ ký Text trong các tệp Pps đã được ký. Thực hiện tìm kiếm chữ ký điện tử nâng cao trong tài liệu Pps của bạn bằng cách sử dụng một vài dòng mã."
...
steps:
    enable: true
    title_left: "Cách tìm kiếm chữ ký Text trong Pps"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) giúp các nhà phát triển .NET tìm kiếm chữ ký Text trong tệp Pps từ ứng dụng của họ dễ dàng hơn bằng cách thực hiện một vài bước đơn giản.
