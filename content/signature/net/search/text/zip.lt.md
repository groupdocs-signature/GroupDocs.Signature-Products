...
############################# Head ############################
head_title: "Ieškokite Text parašų Zip faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Zip failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Zip faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Zip failuose. Atlikite išplėstinę el. parašo paiešką savo Zip dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Zip failuose iš savo programų, atlikdami kelis paprastus veiksmus.
