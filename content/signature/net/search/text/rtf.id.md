...
breadcrumb: Search Text signatures at Rtf with C#

############################# Head ############################
head_title: "Cari tanda tangan Text dalam file Rtf di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Text di file Rtf menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Text di file Rtf"
description: ".NET API asli memungkinkan untuk mencari Text tanda tangan di file Rtf yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Rtf Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Text dalam file Rtf dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
more_formats:
    enable: true
    title: "Cari tanda tangan Text lainnya menggunakan C#"
    content: |
