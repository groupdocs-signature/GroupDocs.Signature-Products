...
############################# Head ############################
head_title: "Meklēt Text parakstus Rtf failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Text parakstus Rtf failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Text parakstus failā Rtf"
description: ".NET vietējais API ļauj meklēt Text parakstus jau parakstītos Rtf failos. Veiciet izvērsto e-paraksta meklēšanu savos Rtf dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    enable: true
    title_left: "Kā meklēt Text parakstus Rtf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Text parakstus Rtf failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
