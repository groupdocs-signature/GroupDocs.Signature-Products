...
############################# Head ############################
head_title: "C# içinde Pptm dosyasında Text imzasını arayın"
head_description: "Birkaç satır kod kullanarak Pptm dosyalarında Text imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Pptm dosyasında Text imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Pptm dosyalarında Text imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Pptm belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Pptm dosyalarında Text imzalarını aramasını kolaylaştırır.
