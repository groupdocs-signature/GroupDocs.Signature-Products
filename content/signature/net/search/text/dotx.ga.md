...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Dotx i C#"
head_description: "Úsáid .NET chun sínithe Text a chuardach i gcomhaid Dotx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Text sínithe i gcomhad Dotx"
...
steps:
    enable: true
    title_left: "Conas síniú Text a chuardach i Dotx"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Text i gcomhaid Dotx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
