...
############################# Head ############################
head_title: "Wyszukaj podpisy Text w pliku Xlsx w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Text w plikach Xlsx przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Text w pliku Xlsx"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Text w już podpisanych plikach Xlsx. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Xlsx, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Text w Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Text w plikach Xlsx z ich aplikacji, wykonując kilka prostych kroków.
