...
############################# Head ############################
head_title: "Procure por assinaturas Text no arquivo Potx em C#"
head_description: "Use .NET para pesquisar assinaturas Text em arquivos Potx usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Text no arquivo Potx"
description: "A API nativa do .NET permite pesquisar assinaturas Text em arquivos Potx já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Potx usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Text em arquivos Potx de seus aplicativos implementando algumas etapas fáceis.
