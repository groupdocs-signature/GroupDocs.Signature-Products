...
############################# Head ############################
head_title: "Wyszukaj podpisy Text w pliku Odp w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Text w plikach Odp przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Text w pliku Odp"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Text w już podpisanych plikach Odp. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Odp, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Text w Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Text w plikach Odp z ich aplikacji, wykonując kilka prostych kroków.
