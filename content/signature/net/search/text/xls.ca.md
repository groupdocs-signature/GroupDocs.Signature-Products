...
############################# Head ############################
head_title: "Cerqueu signatures de Text al fitxer Xls a C#"
head_description: "Utilitzeu .NET per cercar signatures Text als fitxers Xls mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Text al fitxer Xls"
description: "L'API nativa de .NET permet cercar signatures Text als fitxers Xls ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Xls amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Text a Xls"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Text als fitxers Xls des de les seves aplicacions implementant uns quants passos senzills.
