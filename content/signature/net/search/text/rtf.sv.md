...
description: "Inbyggt API för .NET gör det möjligt att söka efter Text-signaturer i redan signerade Rtf-filer. Utför avancerad e-signatursökning i dina {{Filformat}}-dokument med några rader kod."
