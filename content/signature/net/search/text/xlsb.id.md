...
############################# Head ############################
head_title: "Cari tanda tangan Text dalam file Xlsb di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Text di file Xlsb menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Text di file Xlsb"
description: ".NET API asli memungkinkan untuk mencari Text tanda tangan di file Xlsb yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xlsb Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Text dalam file Xlsb dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
