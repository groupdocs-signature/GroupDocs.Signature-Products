...
############################# Head ############################
head_title: "Otsige allkirju Text failist 7z rakenduses C#"
head_description: "Kasutage .NET allkirjade Text otsimiseks failides 7z, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju 7z"
description: "Native API .NET võimaldab otsida allkirju Text juba allkirjastatud 7z failides. Tehke oma 7z dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Text otsimist oma rakendustest failides 7z, rakendades mõnda lihtsat sammu.
