...
############################# Head ############################
head_title: "Keressen Text aláírásokat a Odt fájlban a C# programban"
head_description: "A .NET használatával kereshet Text aláírásokat a Odt fájlokban néhány sornyi kód használatával."

############################# Header ############################
title: "Keressen Text aláírásokat a Odt fájlban"
description: "A .NET natív API lehetővé teszi a Text aláírások keresését a már aláírt Odt fájlokban. Végezzen speciális e-aláírás-keresést a Odt dokumentumaiban néhány sornyi kód használatával."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a .NET fejlesztői számára, hogy Text aláírásokat keressenek alkalmazásaik Odt fájljaiban.
