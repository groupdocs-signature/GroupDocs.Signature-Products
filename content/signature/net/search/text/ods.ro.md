...
############################# Head ############################
head_title: "Căutați semnături Text în fișierul Ods în C#"
head_description: "Utilizați .NET pentru a căuta semnături Text în fișiere Ods folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Text în fișierul Ods"
description: "API-ul nativ .NET permite căutarea semnăturilor Text în fișierele Ods deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Ods folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Text în Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Text în fișierele Ods din aplicațiile lor prin implementarea câțiva pași simpli.
