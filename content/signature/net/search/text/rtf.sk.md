...
############################# Head ############################
head_title: "Vyhľadajte podpisy Text v súbore Rtf v C#"
head_description: "Použite .NET na vyhľadávanie Text podpisov v súboroch Rtf pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Text v súbore Rtf"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Text v už podpísaných súboroch Rtf. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Rtf pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Text v súboroch Rtf z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
