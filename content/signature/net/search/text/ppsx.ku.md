...
############################# Head ############################
head_title: "Li Text îmzeyan di pela Ppsx de di C# de bigerin"
head_description: ".NET ji bo lêgerîna îmzeyên Text di pelên Ppsx de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Ppsx de li îmzeyên Text bigerin"
description: "API-ya xwecihî ya .NET destûrê dide ku meriv di pelên Ppsx yên jixwe îmzekirî de li îmzeyên Text bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Ppsx de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Text di Ppsx de digere"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji pêşdebirên .NET re hêsantir dike ku bi pêkanîna çend gavên hêsan li Text di pelên Ppsx îmzeyan de ji sepanên xwe bigerin.
