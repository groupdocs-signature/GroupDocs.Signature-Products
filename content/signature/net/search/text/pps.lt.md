...
############################# Head ############################
head_title: "Ieškokite Text parašų Pps faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Pps failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Pps faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Pps failuose. Atlikite išplėstinę el. parašo paiešką savo Pps dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Pps failuose iš savo programų, atlikdami kelis paprastus veiksmus.
