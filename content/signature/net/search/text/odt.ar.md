...
############################# Head ############################
head_title: "ابحث عن توقيعات Text في ملف Odt في C#"
head_description: "استخدم .NET للبحث عن توقيعات Text في ملفات Odt باستخدام بضعة أسطر من التعليمات البرمجية."

############################# Header ############################
title: "ابحث عن توقيعات Text في ملف Odt"
description: "تسمح واجهة برمجة التطبيقات الأصلية لـ .NET بالبحث عن توقيعات Text في ملفات Odt الموقعة بالفعل. قم بإجراء بحث متقدم عن التوقيع الإلكتروني داخل مستندات Odt باستخدام بضعة أسطر من التعليمات البرمجية."
...
steps:
    ...
    content_left: |
        يسهّل [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) على مطوري .NET البحث عن توقيعات Text في ملفات Odt من تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
