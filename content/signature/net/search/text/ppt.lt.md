...
############################# Head ############################
head_title: "Ieškokite Text parašų Ppt faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Ppt failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Ppt faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Ppt failuose. Atlikite išplėstinę el. parašo paiešką savo Ppt dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Ppt failuose iš savo programų, atlikdami kelis paprastus veiksmus.
