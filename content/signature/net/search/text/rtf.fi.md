...
############################# Head ############################
head_title: "Etsi Text allekirjoituksia Rtf-tiedostosta C#"
head_description: "Käytä .NET:a etsiäksesi Text-allekirjoituksia Rtf-tiedostoista muutamalla koodirivillä."

############################# Header ############################
title: "Etsi Text allekirjoituksia Rtf-tiedostosta"
description: ".NET-natiivisovellusliittymä mahdollistaa Text-allekirjoitusten etsimisen jo allekirjoitetuista Rtf-tiedostoista. Suorita laajennettu sähköinen allekirjoitushaku Rtf-asiakirjoissasi muutaman koodirivin avulla."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) helpottaa .NET-kehittäjien etsimistä Text-allekirjoituksista Rtf-tiedostoista sovelluksistaan ​​toteuttamalla muutaman helpon vaiheen.
