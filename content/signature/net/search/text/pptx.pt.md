...
############################# Head ############################
head_title: "Procure por assinaturas Text no arquivo Pptx em C#"
head_description: "Use .NET para pesquisar assinaturas Text em arquivos Pptx usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Text no arquivo Pptx"
description: "A API nativa do .NET permite pesquisar assinaturas Text em arquivos Pptx já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Pptx usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Text em arquivos Pptx de seus aplicativos implementando algumas etapas fáceis.
