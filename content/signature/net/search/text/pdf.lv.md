...
############################# Head ############################
head_title: "Meklēt Text parakstus Pdf failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Text parakstus Pdf failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Text parakstus failā Pdf"
description: ".NET vietējais API ļauj meklēt Text parakstus jau parakstītos Pdf failos. Veiciet izvērsto e-paraksta meklēšanu savos Pdf dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Text parakstus Pdf failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
