...
############################# Head ############################
head_title: "Leitaðu að Text undirskriftum í Xltx skrá í C#"
head_description: "Notaðu .NET til að leita að Text undirskriftum í Xltx skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Text undirskriftum í Xltx skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Text undirskriftum í þegar undirrituðum Xltx skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Xltx skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að leita að Text undirskriftum í Xltx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Text undirskriftum í Xltx skrám úr forritum sínum með því að útfæra nokkur einföld skref.
