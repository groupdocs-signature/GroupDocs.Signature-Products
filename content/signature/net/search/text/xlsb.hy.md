...
############################# Head ############################
head_title: "Որոնեք Text ստորագրությունները Xlsb ֆայլում C#-ում"
head_description: "Օգտագործեք .NET՝ Text ստորագրությունները Xlsb ֆայլերում մի քանի տող կոդով որոնելու համար:"

############################# Header ############################
title: "Փնտրեք Text ստորագրությունները Xlsb ֆայլում"
description: ".NET բնօրինակ API-ն թույլ է տալիս որոնել Text ստորագրություններ արդեն ստորագրված Xlsb ֆայլերում: Կատարեք էլեկտրոնային ստորագրության առաջադեմ որոնում ձեր Xlsb փաստաթղթերում՝ օգտագործելով մի քանի տող կոդ:"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) հեշտացնում է .NET ծրագրավորողների համար որոնել Text ստորագրությունները Xlsb ֆայլերում իրենց հավելվածներից` իրականացնելով մի քանի հեշտ քայլեր:
