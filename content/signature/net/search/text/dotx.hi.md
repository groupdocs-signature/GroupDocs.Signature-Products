...
############################# Head ############################
head_title: "C# में Dotx फ़ाइल में Text हस्ताक्षर खोजें"
head_description: "कोड की कुछ पंक्तियों का उपयोग करके Dotx फ़ाइलों में Text हस्ताक्षर खोजने के लिए .NET का उपयोग करें।"

############################# Header ############################
title: "Text हस्ताक्षर के लिए Dotx फ़ाइल में खोजें"
description: ".NET नेटिव API पहले से हस्ताक्षरित Dotx फाइलों में Text हस्ताक्षर खोजने की अनुमति देता है। कोड की कुछ पंक्तियों का उपयोग करके अपने Dotx दस्तावेज़ों में उन्नत ई-हस्ताक्षर खोज करें।"
...
steps:
    enable: true
    title_left: "Text हस्ताक्षर को Dotx में कैसे खोजें"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) कुछ आसान चरणों को लागू करके .NET डेवलपर्स के लिए Text हस्ताक्षर को Dotx फाइलों में खोजना आसान बनाता है।
