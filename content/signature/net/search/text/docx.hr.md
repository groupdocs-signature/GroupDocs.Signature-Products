...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Docx u C#"
head_description: "Upotrijebite .NET za traženje potpisa Text u datotekama Docx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Docx datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Text u već potpisanim Docx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Docx dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Text u datotekama Docx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
