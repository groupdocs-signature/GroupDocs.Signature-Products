...
############################# Head ############################
head_title: "Leitaðu að Text undirskriftum í Dot skrá í C#"
head_description: "Notaðu .NET til að leita að Text undirskriftum í Dot skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Text undirskriftum í Dot skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Text undirskriftum í þegar undirrituðum Dot skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Dot skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að leita að Text undirskriftum í Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Text undirskriftum í Dot skrám úr forritum sínum með því að útfæra nokkur einföld skref.
