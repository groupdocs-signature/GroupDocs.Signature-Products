...
############################# Head ############################
head_title: "Vyhledejte podpisy Text v souboru Ppsx v C#"
head_description: "Použijte .NET k vyhledávání podpisů Text v souborech Ppsx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Text v souboru Ppsx"
description: "Nativní API .NET umožňuje vyhledávat podpisy Text v již podepsaných souborech Ppsx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ppsx pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Text v Ppsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Text v souborech Ppsx z jejich aplikací implementací několika snadných kroků.
