...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Docm u C#"
head_description: "Upotrijebite .NET za traženje potpisa Text u datotekama Docm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Docm datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Text u već potpisanim Docm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Docm dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Text u datotekama Docm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
