...
############################# Head ############################
head_title: "Tìm kiếm chữ ký Text trong tệp Docx trong C#"
head_description: "Sử dụng .NET để tìm kiếm chữ ký Text trong tệp Docx bằng một vài dòng mã."

############################# Header ############################
title: "Tìm kiếm chữ ký Text trong tệp Docx"
description: "API gốc .NET cho phép tìm kiếm chữ ký Text trong các tệp Docx đã được ký. Thực hiện tìm kiếm chữ ký điện tử nâng cao trong tài liệu Docx của bạn bằng cách sử dụng một vài dòng mã."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) giúp các nhà phát triển .NET tìm kiếm chữ ký Text trong tệp Docx từ ứng dụng của họ dễ dàng hơn bằng cách thực hiện một vài bước đơn giản.
