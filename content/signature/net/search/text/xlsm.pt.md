...
############################# Head ############################
head_title: "Procure por assinaturas Text no arquivo Xlsm em C#"
head_description: "Use .NET para pesquisar assinaturas Text em arquivos Xlsm usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Text no arquivo Xlsm"
description: "A API nativa do .NET permite pesquisar assinaturas Text em arquivos Xlsm já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Xlsm usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Text em Xlsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Text em arquivos Xlsm de seus aplicativos implementando algumas etapas fáceis.
