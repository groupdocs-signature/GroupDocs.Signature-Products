...
############################# Head ############################
head_title: "Rechercher les signatures Text dans le fichier Pps dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Text dans des fichiers Pps en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Text dans le fichier Pps"
description: "L'API native .NET permet de rechercher des signatures Text dans des fichiers Pps déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Pps en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Text dans Pps"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Text dans des fichiers Pps à partir de leurs applications en mettant en œuvre quelques étapes simples.
