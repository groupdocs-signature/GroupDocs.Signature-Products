...
############################# Head ############################
head_title: "Ieškokite Text parašų Odp faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Odp failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Odp faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Odp failuose. Atlikite išplėstinę el. parašo paiešką savo Odp dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Odp failuose iš savo programų, atlikdami kelis paprastus veiksmus.
