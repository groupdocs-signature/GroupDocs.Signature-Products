...
############################# Head ############################
head_title: "Wyszukaj podpisy Text w pliku Xls w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Text w plikach Xls przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Text w pliku Xls"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Text w już podpisanych plikach Xls. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Xls, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Text w Xls"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Text w plikach Xls z ich aplikacji, wykonując kilka prostych kroków.
