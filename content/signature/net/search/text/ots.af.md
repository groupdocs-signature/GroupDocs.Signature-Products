...
############################# Head ############################
head_title: "Soek vir Text handtekeninge in Ots lêer in C#"
head_description: "Gebruik .NET om na Text-handtekeninge in Ots-lêers te soek deur 'n paar reëls kode te gebruik."

############################# Header ############################
title: "Soek vir Text handtekeninge in Ots lêer"
description: ".NET se inheemse API laat toe om vir Text handtekeninge te soek in reeds ondertekende Ots lêers. Voer gevorderde e-handtekeningsoektog binne jou Ots dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    enable: true
    title_left: "Hoe om te soek vir Text handtekeninge in Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) maak dit makliker vir .NET-ontwikkelaars om vir Text-handtekeninge in Ots-lêers vanaf hul toepassings te soek deur 'n paar maklike stappe te implementeer.
