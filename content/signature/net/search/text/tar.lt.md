...
############################# Head ############################
head_title: "Ieškokite Text parašų Tar faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Tar failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Tar faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Tar failuose. Atlikite išplėstinę el. parašo paiešką savo Tar dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Text parašų Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Tar failuose iš savo programų, atlikdami kelis paprastus veiksmus.
