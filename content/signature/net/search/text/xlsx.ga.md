...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Xlsx i C#"
head_description: "Úsáid .NET chun sínithe Text a chuardach i gcomhaid Xlsx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Text sínithe i gcomhad Xlsx"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar Text sínithe i gcomhaid Xlsx atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Xlsx ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Text i gcomhaid Xlsx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
