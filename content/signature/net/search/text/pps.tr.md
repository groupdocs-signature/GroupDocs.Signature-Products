...
############################# Head ############################
head_title: "C# içinde Pps dosyasında Text imzasını arayın"
head_description: "Birkaç satır kod kullanarak Pps dosyalarında Text imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Pps dosyasında Text imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Pps dosyalarında Text imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Pps belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Pps içinde Text imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Pps dosyalarında Text imzalarını aramasını kolaylaştırır.
