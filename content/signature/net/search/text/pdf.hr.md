...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Pdf u C#"
head_description: "Upotrijebite .NET za traženje potpisa Text u datotekama Pdf pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Pdf datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Text u već potpisanim Pdf datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Pdf dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Text potpise u Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Text u datotekama Pdf iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
