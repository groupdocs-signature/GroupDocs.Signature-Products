...
description: ".NET жергілікті API бұрыннан қол қойылған Odp файлдарындағы Text қолтаңбаларын іздеуге мүмкіндік береді. Кодтың бірнеше жолын пайдаланып Odp құжаттарыңызда кеңейтілген электрондық қолтаңбаны іздеуді орындаңыз."
