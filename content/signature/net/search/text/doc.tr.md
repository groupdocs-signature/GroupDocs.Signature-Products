...
############################# Head ############################
head_title: "C# içinde Doc dosyasında Text imzasını arayın"
head_description: "Birkaç satır kod kullanarak Doc dosyalarında Text imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Doc dosyasında Text imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Doc dosyalarında Text imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Doc belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Doc dosyalarında Text imzalarını aramasını kolaylaştırır.
