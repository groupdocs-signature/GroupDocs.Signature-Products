...
############################# Head ############################
head_title: "Cerqueu signatures de Text al fitxer Otp a C#"
head_description: "Utilitzeu .NET per cercar signatures Text als fitxers Otp mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Text al fitxer Otp"
description: "L'API nativa de .NET permet cercar signatures Text als fitxers Otp ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Otp amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Text als fitxers Otp des de les seves aplicacions implementant uns quants passos senzills.
