...
############################# Head ############################
head_title: "Ieškokite Text parašų Pdf faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Pdf failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Pdf faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Pdf failuose. Atlikite išplėstinę el. parašo paiešką savo Pdf dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Pdf failuose iš savo programų, atlikdami kelis paprastus veiksmus.
