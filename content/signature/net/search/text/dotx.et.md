...
############################# Head ############################
head_title: "Otsige allkirju Text failist Dotx rakenduses C#"
head_description: "Kasutage .NET allkirjade Text otsimiseks failides Dotx, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Dotx"
description: "Native API .NET võimaldab otsida allkirju Text juba allkirjastatud Dotx failides. Tehke oma Dotx dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Text otsimist oma rakendustest failides Dotx, rakendades mõnda lihtsat sammu.
