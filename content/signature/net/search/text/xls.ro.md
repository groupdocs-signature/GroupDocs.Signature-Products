...
############################# Head ############################
head_title: "Căutați semnături Text în fișierul Xls în C#"
head_description: "Utilizați .NET pentru a căuta semnături Text în fișiere Xls folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Text în fișierul Xls"
description: "API-ul nativ .NET permite căutarea semnăturilor Text în fișierele Xls deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Xls folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Text în fișierele Xls din aplicațiile lor prin implementarea câțiva pași simpli.
