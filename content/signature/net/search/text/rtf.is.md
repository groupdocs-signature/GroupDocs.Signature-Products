...
############################# Head ############################
head_title: "Leitaðu að Text undirskriftum í Rtf skrá í C#"
head_description: "Notaðu .NET til að leita að Text undirskriftum í Rtf skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Text undirskriftum í Rtf skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Text undirskriftum í þegar undirrituðum Rtf skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Rtf skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Text undirskriftum í Rtf skrám úr forritum sínum með því að útfæra nokkur einföld skref.
