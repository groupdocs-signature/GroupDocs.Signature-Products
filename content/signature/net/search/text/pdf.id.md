...
############################# Head ############################
head_title: "Cari tanda tangan Text dalam file Pdf di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Text di file Pdf menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Text di file Pdf"
description: ".NET API asli memungkinkan untuk mencari Text tanda tangan di file Pdf yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Pdf Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Text dalam file Pdf dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
