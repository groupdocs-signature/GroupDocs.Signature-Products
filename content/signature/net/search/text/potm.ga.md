...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Potm i C#"
head_description: "Úsáid .NET chun sínithe Text a chuardach i gcomhaid Potm ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Text i gcomhaid Potm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
