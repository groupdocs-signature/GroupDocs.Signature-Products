...
############################# Head ############################
head_title: "Cari tanda tangan Text dalam file Pptm di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Text di file Pptm menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Text di file Pptm"
description: ".NET API asli memungkinkan untuk mencari Text tanda tangan di file Pptm yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Pptm Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Text dalam file Pptm dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
