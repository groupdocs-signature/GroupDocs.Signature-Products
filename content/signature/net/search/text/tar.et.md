...
############################# Head ############################
head_title: "Otsige allkirju Text failist Tar rakenduses C#"
head_description: "Kasutage .NET allkirjade Text otsimiseks failides Tar, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Tar"
description: "Native API .NET võimaldab otsida allkirju Text juba allkirjastatud Tar failides. Tehke oma Tar dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Text otsimist oma rakendustest failides Tar, rakendades mõnda lihtsat sammu.
