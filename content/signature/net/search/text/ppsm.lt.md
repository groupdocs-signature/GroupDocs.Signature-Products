...
############################# Head ############################
head_title: "Ieškokite Text parašų Ppsm faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Ppsm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Ppsm faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Ppsm failuose. Atlikite išplėstinę el. parašo paiešką savo Ppsm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Ppsm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
