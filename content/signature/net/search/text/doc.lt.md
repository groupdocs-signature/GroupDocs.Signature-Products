...
############################# Head ############################
head_title: "Ieškokite Text parašų Doc faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Doc failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Doc faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Doc failuose. Atlikite išplėstinę el. parašo paiešką savo Doc dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Doc failuose iš savo programų, atlikdami kelis paprastus veiksmus.
