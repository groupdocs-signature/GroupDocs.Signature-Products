...
############################# Head ############################
head_title: "Leitaðu að Text undirskriftum í Pps skrá í C#"
head_description: "Notaðu .NET til að leita að Text undirskriftum í Pps skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Text undirskriftum í Pps skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Text undirskriftum í þegar undirrituðum Pps skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Pps skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Text undirskriftum í Pps skrám úr forritum sínum með því að útfæra nokkur einföld skref.
