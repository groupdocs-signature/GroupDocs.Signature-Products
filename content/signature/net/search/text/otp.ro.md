...
############################# Head ############################
head_title: "Căutați semnături Text în fișierul Otp în C#"
head_description: "Utilizați .NET pentru a căuta semnături Text în fișiere Otp folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Text în fișierul Otp"
description: "API-ul nativ .NET permite căutarea semnăturilor Text în fișierele Otp deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Otp folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Text în Otp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Text în fișierele Otp din aplicațiile lor prin implementarea câțiva pași simpli.
