...
############################# Head ############################
head_title: "Cerca le firme Text nel file Rtf in C#"
head_description: "Usa .NET per cercare le firme Text nei file Rtf utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Text nel file Rtf"
description: "L'API nativa .NET consente di cercare firme Text in file Rtf già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Rtf utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Text nei file Rtf dalle loro applicazioni implementando alcuni semplici passaggi.
