...
############################# Head ############################
head_title: "Cuardaigh Text síniú i gcomhad Xls i C#"
head_description: "Úsáid .NET chun sínithe Text a chuardach i gcomhaid Xls ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Text sínithe i gcomhad Xls"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar Text sínithe i gcomhaid Xls atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Xls ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Text a chuardach i Xls"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Text i gcomhaid Xls óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
...
demos:
    ...
    content: |
       Cuardaigh an doiciméad le haghaidh sínithe leictreonacha éagsúla ar chomhaid Xls faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
