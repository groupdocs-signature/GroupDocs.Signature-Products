...
############################# Head ############################
head_title: "Ieškokite Text parašų Xls faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Xls failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Xls faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Xls failuose. Atlikite išplėstinę el. parašo paiešką savo Xls dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Xls failuose iš savo programų, atlikdami kelis paprastus veiksmus.
