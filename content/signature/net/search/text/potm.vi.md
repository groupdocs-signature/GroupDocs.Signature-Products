...
############################# Head ############################
head_title: "Tìm kiếm chữ ký Text trong tệp Potm trong C#"
head_description: "Sử dụng .NET để tìm kiếm chữ ký Text trong tệp Potm bằng một vài dòng mã."

############################# Header ############################
title: "Tìm kiếm chữ ký Text trong tệp Potm"
description: "API gốc .NET cho phép tìm kiếm chữ ký Text trong các tệp Potm đã được ký. Thực hiện tìm kiếm chữ ký điện tử nâng cao trong tài liệu Potm của bạn bằng cách sử dụng một vài dòng mã."
...
steps:
    enable: true
    title_left: "Cách tìm kiếm chữ ký Text trong Potm"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) giúp các nhà phát triển .NET tìm kiếm chữ ký Text trong tệp Potm từ ứng dụng của họ dễ dàng hơn bằng cách thực hiện một vài bước đơn giản.
