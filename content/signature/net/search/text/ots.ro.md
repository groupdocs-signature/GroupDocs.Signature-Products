...
############################# Head ############################
head_title: "Căutați semnături Text în fișierul Ots în C#"
head_description: "Utilizați .NET pentru a căuta semnături Text în fișiere Ots folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Text în fișierul Ots"
description: "API-ul nativ .NET permite căutarea semnăturilor Text în fișierele Ots deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Ots folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Text în fișierele Ots din aplicațiile lor prin implementarea câțiva pași simpli.
