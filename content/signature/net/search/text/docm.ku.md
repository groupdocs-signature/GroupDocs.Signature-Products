...
############################# Head ############################
head_title: "Li Text îmzeyan di pela Docm de di C# de bigerin"
head_description: ".NET ji bo lêgerîna îmzeyên Text di pelên Docm de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Docm de li îmzeyên Text bigerin"
description: "API-ya xwecihî ya .NET destûrê dide ku meriv di pelên Docm yên jixwe îmzekirî de li îmzeyên Text bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Docm de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Text di Docm de digere"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji pêşdebirên .NET re hêsantir dike ku bi pêkanîna çend gavên hêsan li Text di pelên Docm îmzeyan de ji sepanên xwe bigerin.
...
demos:
    ...
    content: |
       Niha bi serdana malpera [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) di belgeyê de ji bo îmzeyên elektronîkî yên cihêreng ên pelên Docm bigerin.
