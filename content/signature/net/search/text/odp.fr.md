...
############################# Head ############################
head_title: "Rechercher les signatures Text dans le fichier Odp dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Text dans des fichiers Odp en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Text dans le fichier Odp"
description: "L'API native .NET permet de rechercher des signatures Text dans des fichiers Odp déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Odp en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Text dans Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Text dans des fichiers Odp à partir de leurs applications en mettant en œuvre quelques étapes simples.
