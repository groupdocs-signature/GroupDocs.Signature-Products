...
############################# Head ############################
head_title: "Li Text îmzeyan di pela Doc de di C# de bigerin"
head_description: ".NET ji bo lêgerîna îmzeyên Text di pelên Doc de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Doc de li îmzeyên Text bigerin"
description: "API-ya xwecihî ya .NET destûrê dide ku meriv di pelên Doc yên jixwe îmzekirî de li îmzeyên Text bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Doc de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Text di Doc de digere"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji pêşdebirên .NET re hêsantir dike ku bi pêkanîna çend gavên hêsan li Text di pelên Doc îmzeyan de ji sepanên xwe bigerin.
