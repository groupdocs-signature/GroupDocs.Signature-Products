...
############################# Head ############################
head_title: "Search for Text signatures in Xlsb file in C#"
head_description: "Use .NET for searching for Text signatures in Xlsb files using a few lines of code."

############################# Header ############################
title: "Search for Text signatures in Xlsb file"
description: ".NET native API allows to search for Text signatures in already signed Xlsb files. Perform advanced e-signature search within your Xlsb documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Text signatures in Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Text signatures in Xlsb files from their applications by implementing a few easy steps.
