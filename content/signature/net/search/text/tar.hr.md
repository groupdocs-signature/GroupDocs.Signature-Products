...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Tar u C#"
head_description: "Upotrijebite .NET za traženje potpisa Text u datotekama Tar pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Tar datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Text u već potpisanim Tar datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Tar dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Text u datotekama Tar iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
