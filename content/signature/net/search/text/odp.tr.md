...
############################# Head ############################
head_title: "C# içinde Odp dosyasında Text imzasını arayın"
head_description: "Birkaç satır kod kullanarak Odp dosyalarında Text imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Odp dosyasında Text imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Odp dosyalarında Text imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Odp belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Odp içinde Text imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Odp dosyalarında Text imzalarını aramasını kolaylaştırır.
