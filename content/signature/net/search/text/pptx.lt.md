...
############################# Head ############################
head_title: "Ieškokite Text parašų Pptx faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Pptx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Pptx faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Pptx failuose. Atlikite išplėstinę el. parašo paiešką savo Pptx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Pptx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
