...
############################# Head ############################
head_title: "Otsige allkirju Text failist Dot rakenduses C#"
head_description: "Kasutage .NET allkirjade Text otsimiseks failides Dot, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Text allkirju Dot"
description: "Native API .NET võimaldab otsida allkirju Text juba allkirjastatud Dot failides. Tehke oma Dot dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Text otsimist oma rakendustest failides Dot, rakendades mõnda lihtsat sammu.
