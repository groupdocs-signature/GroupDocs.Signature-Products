...
############################# Head ############################
head_title: "Vyhľadajte podpisy Text v súbore 7z v C#"
head_description: "Použite .NET na vyhľadávanie Text podpisov v súboroch 7z pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Text v súbore 7z"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Text v už podpísaných súboroch 7z. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch 7z pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Text v súboroch 7z z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
