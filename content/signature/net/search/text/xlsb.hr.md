...
############################# Head ############################
head_title: "Potražite Text potpise u datoteci Xlsb u C#"
head_description: "Upotrijebite .NET za traženje potpisa Text u datotekama Xlsb pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Text potpise u Xlsb datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Text u već potpisanim Xlsb datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xlsb dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Text u datotekama Xlsb iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
