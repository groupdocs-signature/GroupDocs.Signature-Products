...
############################# Head ############################
head_title: "Որոնեք Text ստորագրությունները Ott ֆայլում C#-ում"
head_description: "Օգտագործեք .NET՝ Text ստորագրությունները Ott ֆայլերում մի քանի տող կոդով որոնելու համար:"

############################# Header ############################
title: "Փնտրեք Text ստորագրությունները Ott ֆայլում"
description: ".NET բնօրինակ API-ն թույլ է տալիս որոնել Text ստորագրություններ արդեն ստորագրված Ott ֆայլերում: Կատարեք էլեկտրոնային ստորագրության առաջադեմ որոնում ձեր Ott փաստաթղթերում՝ օգտագործելով մի քանի տող կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես որոնել Text ստորագրությունները Ott-ում"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) հեշտացնում է .NET ծրագրավորողների համար որոնել Text ստորագրությունները Ott ֆայլերում իրենց հավելվածներից` իրականացնելով մի քանի հեշտ քայլեր:
