...
############################# Head ############################
head_title: "Busque Text firmas en Tar archivo en C#"
head_description: "Use .NET para buscar firmas Text en archivos Tar usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Text en el archivo Tar"
description: ".NET API nativa permite buscar Text firmas en archivos Tar ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Tar utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Text en archivos Tar desde sus aplicaciones mediante la implementación de unos sencillos pasos.
