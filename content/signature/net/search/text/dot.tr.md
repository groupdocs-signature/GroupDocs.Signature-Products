...
############################# Head ############################
head_title: "C# içinde Dot dosyasında Text imzasını arayın"
head_description: "Birkaç satır kod kullanarak Dot dosyalarında Text imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Dot dosyasında Text imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Dot dosyalarında Text imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Dot belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Dot dosyalarında Text imzalarını aramasını kolaylaştırır.
