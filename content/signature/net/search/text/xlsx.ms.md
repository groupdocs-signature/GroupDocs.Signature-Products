...
############################# Head ############################
head_title: "Cari tandatangan Text dalam fail Xlsx dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Text dalam fail Xlsx menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Text dalam fail Xlsx."
description: "API asli .NET membenarkan untuk mencari tandatangan Text dalam fail Xlsx yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Xlsx anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Text dalam fail Xlsx daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
