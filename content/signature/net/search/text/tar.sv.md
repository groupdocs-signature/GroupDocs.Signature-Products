...
############################# Head ############################
head_title: "Sök efter Text-signaturer i filen Tar i C#"
head_description: "Använd .NET för att söka efter Text-signaturer i Tar-filer med några rader kod."

############################# Header ############################
title: "Sök efter Text-signaturer i filen Tar"
description: "Inbyggt API för .NET gör det möjligt att söka efter Text-signaturer i redan signerade Tar-filer. Utför avancerad e-signatursökning i dina Tar-dokument med några rader kod."
...
steps:
    enable: true
    title_left: "Hur man söker efter Text-signaturer i Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gör det enklare för .NET-utvecklare att söka efter Text-signaturer i Tar-filer från sina applikationer genom att implementera några enkla steg.
