...
############################# Head ############################
head_title: "Meklēt Text parakstus 7z failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Text parakstus 7z failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Text parakstus failā 7z"
description: ".NET vietējais API ļauj meklēt Text parakstus jau parakstītos 7z failos. Veiciet izvērsto e-paraksta meklēšanu savos 7z dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    enable: true
    title_left: "Kā meklēt Text parakstus 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Text parakstus 7z failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
