...
############################# Head ############################
head_title: "Căutați semnături Text în fișierul Potm în C#"
head_description: "Utilizați .NET pentru a căuta semnături Text în fișiere Potm folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Text în fișierul Potm"
description: "API-ul nativ .NET permite căutarea semnăturilor Text în fișierele Potm deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Potm folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Text în Potm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Text în fișierele Potm din aplicațiile lor prin implementarea câțiva pași simpli.
