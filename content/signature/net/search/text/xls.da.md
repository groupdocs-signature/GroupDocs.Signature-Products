...
############################# Head ############################
head_title: "Søg efter Text signaturer i filen {{Filformat}} i C#"
head_description: "Brug .NET til at søge efter Text-signaturer i Xls-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Text-signaturer i filen {{Filformat}}"
description: ".NET native API gør det muligt at søge efter Text-signaturer i allerede signerede Xls-filer. Udfør avanceret e-signatursøgning i dine {{Filformat}} dokumenter ved hjælp af et par linjer kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gør det nemmere for .NET-udviklere at søge efter Text-signaturer i Xls-filer fra deres applikationer ved at implementere nogle få nemme trin.
...
demos:
    ...
    content: |
       Søg i dokumentet efter forskellige elektroniske signaturer til Xls-filer lige nu ved at besøge webstedet [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
