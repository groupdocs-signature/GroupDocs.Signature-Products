...
############################# Head ############################
head_title: "Wyszukaj podpisy Text w pliku Ott w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Text w plikach Ott przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Text w pliku Ott"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Text w już podpisanych plikach Ott. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Ott, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Text w Ott"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Text w plikach Ott z ich aplikacji, wykonując kilka prostych kroków.
