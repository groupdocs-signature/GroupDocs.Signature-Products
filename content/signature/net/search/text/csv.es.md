...
############################# Head ############################
head_title: "Busque Text firmas en Csv archivo en C#"
head_description: "Use .NET para buscar firmas Text en archivos Csv usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Text en el archivo Csv"
description: ".NET API nativa permite buscar Text firmas en archivos Csv ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Csv utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Text en Csv"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Text en archivos Csv desde sus aplicaciones mediante la implementación de unos sencillos pasos.
