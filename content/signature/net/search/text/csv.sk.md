...
############################# Head ############################
head_title: "Vyhľadajte podpisy Text v súbore Csv v C#"
head_description: "Použite .NET na vyhľadávanie Text podpisov v súboroch Csv pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Text v súbore Csv"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Text v už podpísaných súboroch Csv. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Csv pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Text v súboroch Csv z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
