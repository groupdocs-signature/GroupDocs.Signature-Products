...
head_description: "Brug .NET til at søge efter Text-signaturer i Xltx-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Text-signaturer i filen {{Filformat}}"
description: ".NET native API gør det muligt at søge efter Text-signaturer i allerede signerede Xltx-filer. Udfør avanceret e-signatursøgning i dine {{Filformat}} dokumenter ved hjælp af et par linjer kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gør det nemmere for .NET-udviklere at søge efter Text-signaturer i Xltx-filer fra deres applikationer ved at implementere nogle få nemme trin.
