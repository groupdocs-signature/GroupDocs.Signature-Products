...
############################# Head ############################
head_title: "Ieškokite Text parašų Pptm faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Text parašų Pptm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Text parašų Pptm faile"
description: ".NET savoji API leidžia ieškoti Text parašų jau pasirašytuose Pptm failuose. Atlikite išplėstinę el. parašo paiešką savo Pptm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Text parašų Pptm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
...
more_formats:
    enable: true
    title: "Ieškokite kitų Text parašų naudodami C#"
    content: |
