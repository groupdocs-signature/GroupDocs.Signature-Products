...
############################# Head ############################
head_title: "Poiščite podpise Qrcode v datoteki Docx v C#"
head_description: "Uporabite .NET za iskanje podpisov Qrcode v datotekah Docx z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Qrcode v datoteki Docx"
description: "Izvorni API za .NET omogoča iskanje podpisov Qrcode v že podpisanih datotekah Docx. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Docx z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) razvijalcem za .NET olajša iskanje podpisov Qrcode v datotekah Docx iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
