...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Ots v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech Ots pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Ots"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Ots. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ots pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech Ots z jejich aplikací implementací několika snadných kroků.
