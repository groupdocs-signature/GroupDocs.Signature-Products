...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Dotm faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Dotm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Dotm faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Dotm failuose. Atlikite išplėstinę el. parašo paiešką savo Dotm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Dotm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
