...
############################# Head ############################
head_title: "Busque Qrcode firmas en Xltx archivo en C#"
head_description: "Use .NET para buscar firmas Qrcode en archivos Xltx usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Xltx"
description: ".NET API nativa permite buscar Qrcode firmas en archivos Xltx ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Xltx utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Qrcode en Xltx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Qrcode en archivos Xltx desde sus aplicaciones mediante la implementación de unos sencillos pasos.
...
demos:
    enable: true
    title: "Buscar Qrcode firmas electrónicas Demostración en vivo"
    content: |
       Busque en el documento varias firmas electrónicas para archivos Xltx ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).

        
############################# More Formats ############################
more_formats:
    enable: true
    title: "Busque otras firmas Qrcode usando C#"
    content: |
