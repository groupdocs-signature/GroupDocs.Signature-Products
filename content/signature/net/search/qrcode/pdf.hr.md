...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Pdf u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Pdf pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Pdf datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Pdf datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Pdf dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Pdf iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
