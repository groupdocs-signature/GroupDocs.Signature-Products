...
############################# Head ############################
head_title: "Poiščite podpise Qrcode v datoteki 7z v C#"
head_description: "Uporabite .NET za iskanje podpisov Qrcode v datotekah 7z z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Qrcode v datoteki 7z"
description: "Izvorni API za .NET omogoča iskanje podpisov Qrcode v že podpisanih datotekah 7z. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov 7z z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) razvijalcem za .NET olajša iskanje podpisov Qrcode v datotekah 7z iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
