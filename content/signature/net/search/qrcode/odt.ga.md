...
breadcrumb: Search Qrcode signatures at Odt with C#

############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Odt i C#"
head_description: "Úsáid .NET chun sínithe Qrcode a chuardach i gcomhaid Odt ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Qrcode sínithe i gcomhad Odt"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Odt ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Qrcode a chuardach i Odt"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Odt óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
...
demos:
    ...
    content: |
       Cuardaigh an doiciméad le haghaidh sínithe leictreonacha éagsúla ar chomhaid Odt faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
