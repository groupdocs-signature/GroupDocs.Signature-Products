...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Odp v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech Odp pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Odp"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Odp. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Odp pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech Odp z jejich aplikací implementací několika snadných kroků.
...
demos:
    ...
    content: |
       Navštivte web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) a vyhledejte v dokumentu různé elektronické podpisy do souborů Odp právě teď.
