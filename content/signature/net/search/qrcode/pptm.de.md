...
############################# Head ############################
head_title: "Suche nach Qrcode-Signaturen in der Datei Pptm in C#"
head_description: "Verwenden Sie .NET für die Suche nach Qrcode-Signaturen in Pptm-Dateien mit ein paar Zeilen Code."

############################# Header ############################
title: "Suchen Sie nach Qrcode-Signaturen in der Datei Pptm"
description: "Die native API von .NET ermöglicht die Suche nach Qrcode-Signaturen in bereits signierten Pptm-Dateien. Führen Sie mit wenigen Codezeilen eine erweiterte E-Signatur-Suche in Ihren Pptm-Dokumenten durch."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) erleichtert Entwicklern von .NET die Suche nach Qrcode-Signaturen in Pptm-Dateien aus ihren Anwendungen, indem einige einfache Schritte implementiert werden.
