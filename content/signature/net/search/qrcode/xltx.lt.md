...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Xltx faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Xltx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Xltx faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Xltx failuose. Atlikite išplėstinę el. parašo paiešką savo Xltx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Xltx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Xltx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
