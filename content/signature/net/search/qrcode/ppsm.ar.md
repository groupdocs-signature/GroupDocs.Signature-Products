...
############################# Head ############################
head_title: "ابحث عن توقيعات Qrcode في ملف Ppsm في C#"
head_description: "استخدم .NET للبحث عن توقيعات Qrcode في ملفات Ppsm باستخدام بضعة أسطر من التعليمات البرمجية."

############################# Header ############################
title: "ابحث عن توقيعات Qrcode في ملف Ppsm"
description: "تسمح واجهة برمجة التطبيقات الأصلية لـ .NET بالبحث عن توقيعات Qrcode في ملفات Ppsm الموقعة بالفعل. قم بإجراء بحث متقدم عن التوقيع الإلكتروني داخل مستندات Ppsm باستخدام بضعة أسطر من التعليمات البرمجية."
...
steps:
    ...
    content_left: |
        يسهّل [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) على مطوري .NET البحث عن توقيعات Qrcode في ملفات Ppsm من تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
