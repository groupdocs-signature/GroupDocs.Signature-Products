...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Ott di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Qrcode di file Ott menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Ott"
description: ".NET API asli memungkinkan untuk mencari Qrcode tanda tangan di file Ott yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ott Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Qrcode di Ott"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Qrcode dalam file Ott dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
