...
breadcrumb: Search Qrcode signatures at Xlsm with C#

############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Xlsm di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Qrcode di file Xlsm menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Xlsm"
description: ".NET API asli memungkinkan untuk mencari Qrcode tanda tangan di file Xlsm yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xlsm Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Qrcode dalam file Xlsm dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
more_formats:
    enable: true
    title: "Cari tanda tangan Qrcode lainnya menggunakan C#"
    content: |
