...
############################# Head ############################
head_title: "Søg efter Qrcode signaturer i filen Odp i C#"
head_description: "Brug .NET til at søge efter Qrcode-signaturer i Odp-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Qrcode-signaturer i filen Odp"
description: ".NET native API gør det muligt at søge efter Qrcode-signaturer i allerede signerede Odp-filer. Udfør avanceret e-signatursøgning i dine Odp dokumenter ved hjælp af et par linjer kode."
...
steps:
    enable: true
    title_left: "Sådan søger du efter Qrcode-signaturer i Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gør det nemmere for .NET-udviklere at søge efter Qrcode-signaturer i Odp-filer fra deres applikationer ved at implementere nogle få nemme trin.
