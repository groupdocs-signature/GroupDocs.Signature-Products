...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Tiff rakenduses C#"
head_description: "Kasutage .NET allkirjade Qrcode otsimiseks failides Tiff, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Tiff"
description: "Native API .NET võimaldab otsida allkirju Qrcode juba allkirjastatud Tiff failides. Tehke oma Tiff dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Qrcode otsimist oma rakendustest failides Tiff, rakendades mõnda lihtsat sammu.
