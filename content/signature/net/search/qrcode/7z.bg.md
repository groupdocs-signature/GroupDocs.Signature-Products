...
############################# Head ############################
head_title: "Търсене на подписи Qrcode във файл 7z в C#"
head_description: "Използвайте .NET за търсене на подписи Qrcode във файлове 7z, като използвате няколко реда код."

############################# Header ############################
title: "Търсене на подписи Qrcode във файл 7z"
description: "Нативният API на .NET позволява търсене на подписи на Qrcode във вече подписани файлове на 7z. Извършете разширено търсене с електронен подпис във вашите 7z документи, като използвате няколко реда код."
...
steps:
    enable: true
    title_left: "Как да търсите Qrcode подписи във 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) улеснява разработчиците на .NET да търсят подписи на Qrcode във файловете на 7z от техните приложения чрез прилагане на няколко лесни стъпки.
