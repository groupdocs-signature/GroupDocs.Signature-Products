...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Doc rakenduses C#"
head_description: "Kasutage .NET allkirjade Qrcode otsimiseks failides Doc, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Doc"
description: "Native API .NET võimaldab otsida allkirju Qrcode juba allkirjastatud Doc failides. Tehke oma Doc dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Qrcode otsimist oma rakendustest failides Doc, rakendades mõnda lihtsat sammu.
