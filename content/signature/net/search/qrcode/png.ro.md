...
############################# Head ############################
head_title: "Căutați semnături Qrcode în fișierul Png în C#"
head_description: "Utilizați .NET pentru a căuta semnături Qrcode în fișiere Png folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Qrcode în fișierul Png"
description: "API-ul nativ .NET permite căutarea semnăturilor Qrcode în fișierele Png deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Png folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Qrcode în Png"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Qrcode în fișierele Png din aplicațiile lor prin implementarea câțiva pași simpli.
