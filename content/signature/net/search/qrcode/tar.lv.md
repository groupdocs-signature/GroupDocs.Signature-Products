...
############################# Head ############################
head_title: "Meklēt Qrcode parakstus Tar failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Qrcode parakstus Tar failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Qrcode parakstus failā Tar"
description: ".NET vietējais API ļauj meklēt Qrcode parakstus jau parakstītos Tar failos. Veiciet izvērsto e-paraksta meklēšanu savos Tar dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Qrcode parakstus Tar failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
