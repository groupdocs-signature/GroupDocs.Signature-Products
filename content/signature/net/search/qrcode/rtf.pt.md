...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Rtf em C#"
head_description: "Use .NET para pesquisar assinaturas Qrcode em arquivos Rtf usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Rtf"
description: "A API nativa do .NET permite pesquisar assinaturas Qrcode em arquivos Rtf já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Rtf usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Qrcode em Rtf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Qrcode em arquivos Rtf de seus aplicativos implementando algumas etapas fáceis.
