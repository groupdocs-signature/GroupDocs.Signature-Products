...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Png v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech Png pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Png"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Png. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Png pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Png"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech Png z jejich aplikací implementací několika snadných kroků.
...
demos:
    ...
    content: |
       Navštivte web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) a vyhledejte v dokumentu různé elektronické podpisy do souborů Png právě teď.
