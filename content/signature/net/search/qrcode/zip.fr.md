...
breadcrumb: Search Qrcode signatures at Zip with C#

############################# Head ############################
head_title: "Rechercher les signatures Qrcode dans le fichier Zip dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Qrcode dans des fichiers Zip en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Qrcode dans le fichier Zip"
description: "L'API native .NET permet de rechercher des signatures Qrcode dans des fichiers Zip déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Zip en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Qrcode dans Zip"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Qrcode dans des fichiers Zip à partir de leurs applications en mettant en œuvre quelques étapes simples.
...
demos:
    ...
    content: |
       Recherchez dès maintenant dans le document diverses signatures électroniques dans des fichiers Zip en visitant le site Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
