...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Dotx faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Dotx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Dotx faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Dotx failuose. Atlikite išplėstinę el. parašo paiešką savo Dotx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Dotx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
