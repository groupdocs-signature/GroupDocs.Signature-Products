...
############################# Head ############################
head_title: "Cari tandatangan Qrcode dalam fail Svg dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Qrcode dalam fail Svg menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Qrcode dalam fail Svg."
description: "API asli .NET membenarkan untuk mencari tandatangan Qrcode dalam fail Svg yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Svg anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Qrcode dalam Svg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Qrcode dalam fail Svg daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
