...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Ppt v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech Ppt pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Ppt"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Ppt. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ppt pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Ppt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech Ppt z jejich aplikací implementací několika snadných kroků.
...
demos:
    ...
    content: |
       Navštivte web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) a vyhledejte v dokumentu různé elektronické podpisy do souborů Ppt právě teď.
