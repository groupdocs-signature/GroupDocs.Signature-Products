...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Tar a C#"
head_description: "Utilitzeu .NET per cercar signatures Qrcode als fitxers Tar mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Tar"
description: "L'API nativa de .NET permet cercar signatures Qrcode als fitxers Tar ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Tar amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Qrcode als fitxers Tar des de les seves aplicacions implementant uns quants passos senzills.
