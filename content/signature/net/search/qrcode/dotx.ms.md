...
############################# Head ############################
head_title: "Cari tandatangan Qrcode dalam fail Dotx dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Qrcode dalam fail Dotx menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Qrcode dalam fail Dotx."
description: "API asli .NET membenarkan untuk mencari tandatangan Qrcode dalam fail Dotx yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Dotx anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Qrcode dalam Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Qrcode dalam fail Dotx daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
