...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Dcm u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Dcm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Dcm datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Dcm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Dcm dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Dcm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
