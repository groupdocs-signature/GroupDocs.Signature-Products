...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Docx faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Docx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Docx faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Docx failuose. Atlikite išplėstinę el. parašo paiešką savo Docx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Docx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
