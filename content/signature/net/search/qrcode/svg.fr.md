...
############################# Head ############################
head_title: "Rechercher les signatures Qrcode dans le fichier Svg dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Qrcode dans des fichiers Svg en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Qrcode dans le fichier Svg"
description: "L'API native .NET permet de rechercher des signatures Qrcode dans des fichiers Svg déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Svg en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Qrcode dans Svg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Qrcode dans des fichiers Svg à partir de leurs applications en mettant en œuvre quelques étapes simples.
