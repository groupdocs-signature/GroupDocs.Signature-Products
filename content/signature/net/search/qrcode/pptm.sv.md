...
############################# Head ############################
head_title: "Sök efter Qrcode-signaturer i filen Pptm i C#"
head_description: "Använd .NET för att söka efter Qrcode-signaturer i Pptm-filer med några rader kod."

############################# Header ############################
title: "Sök efter Qrcode-signaturer i filen Pptm"
description: "Inbyggt API för .NET gör det möjligt att söka efter Qrcode-signaturer i redan signerade Pptm-filer. Utför avancerad e-signatursökning i dina Pptm-dokument med några rader kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gör det enklare för .NET-utvecklare att söka efter Qrcode-signaturer i Pptm-filer från sina applikationer genom att implementera några enkla steg.
