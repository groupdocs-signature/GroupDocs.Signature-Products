...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Rtf u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Rtf pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Rtf datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Rtf datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Rtf dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Rtf iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
