...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Dot u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Dot pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Dot datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Dot datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Dot dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Dot iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
