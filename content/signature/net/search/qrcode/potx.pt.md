...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Potx em C#"
head_description: "Use .NET para pesquisar assinaturas Qrcode em arquivos Potx usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Potx"
description: "A API nativa do .NET permite pesquisar assinaturas Qrcode em arquivos Potx já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Potx usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Qrcode em arquivos Potx de seus aplicativos implementando algumas etapas fáceis.
