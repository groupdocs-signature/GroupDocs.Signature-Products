...
############################# Head ############################
head_title: "Cari tandatangan Qrcode dalam fail Ots dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Qrcode dalam fail Ots menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Qrcode dalam fail Ots."
description: "API asli .NET membenarkan untuk mencari tandatangan Qrcode dalam fail Ots yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Ots anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Qrcode dalam fail Ots daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
