...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file 7z in C#"
head_description: "Usa .NET per cercare le firme Qrcode nei file 7z utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file 7z"
description: "L'API nativa .NET consente di cercare firme Qrcode in file 7z già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti 7z utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Qrcode in 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Qrcode nei file 7z dalle loro applicazioni implementando alcuni semplici passaggi.
...
demos:
    ...
    content: |
       Cerca subito nel documento varie firme elettroniche nei file 7z visitando il sito Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
