...
############################# Head ############################
head_title: "Soek vir Qrcode handtekeninge in Doc lêer in C#"
head_description: "Gebruik .NET om na Qrcode-handtekeninge in Doc-lêers te soek deur 'n paar reëls kode te gebruik."

############################# Header ############################
title: "Soek vir Qrcode handtekeninge in Doc lêer"
description: ".NET se inheemse API laat toe om vir Qrcode handtekeninge te soek in reeds ondertekende Doc lêers. Voer gevorderde e-handtekeningsoektog binne jou Doc dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) maak dit makliker vir .NET-ontwikkelaars om vir Qrcode-handtekeninge in Doc-lêers vanaf hul toepassings te soek deur 'n paar maklike stappe te implementeer.
