...
############################# Head ############################
head_title: "Busque Qrcode firmas en Rtf archivo en C#"
head_description: "Use .NET para buscar firmas Qrcode en archivos Rtf usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Rtf"
description: ".NET API nativa permite buscar Qrcode firmas en archivos Rtf ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Rtf utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Qrcode en Rtf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Qrcode en archivos Rtf desde sus aplicaciones mediante la implementación de unos sencillos pasos.
