...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Dotx i C#"
head_description: "Úsáid .NET chun sínithe Qrcode a chuardach i gcomhaid Dotx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Qrcode sínithe i gcomhad Dotx"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Dotx ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Qrcode a chuardach i Dotx"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Dotx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
