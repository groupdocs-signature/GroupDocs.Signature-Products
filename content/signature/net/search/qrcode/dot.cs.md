...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Dot v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech Dot pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Dot"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Dot. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Dot pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech Dot z jejich aplikací implementací několika snadných kroků.
