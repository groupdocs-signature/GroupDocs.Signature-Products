...
############################# Head ############################
head_title: "Căutați semnături Qrcode în fișierul Dot în C#"
head_description: "Utilizați .NET pentru a căuta semnături Qrcode în fișiere Dot folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Qrcode în fișierul Dot"
description: "API-ul nativ .NET permite căutarea semnăturilor Qrcode în fișierele Dot deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Dot folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Qrcode în fișierele Dot din aplicațiile lor prin implementarea câțiva pași simpli.
