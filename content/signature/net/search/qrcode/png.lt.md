...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Png faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Png failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Png faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Png failuose. Atlikite išplėstinę el. parašo paiešką savo Png dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Png failuose iš savo programų, atlikdami kelis paprastus veiksmus.
