...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Ppt i C#"
head_description: "Úsáid .NET chun sínithe Qrcode a chuardach i gcomhaid Ppt ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Ppt óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
