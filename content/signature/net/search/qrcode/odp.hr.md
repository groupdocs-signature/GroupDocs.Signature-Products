...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Odp u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Odp pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Odp datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Odp datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Odp dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Odp iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
