...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Zip di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Qrcode di file Zip menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Zip"
description: ".NET API asli memungkinkan untuk mencari Qrcode tanda tangan di file Zip yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Zip Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Qrcode di Zip"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Qrcode dalam file Zip dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
       Cari dokumen untuk berbagai tanda tangan elektronik ke file Zip sekarang juga dengan mengunjungi situs web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
