...
############################# Head ############################
head_title: "Busque Qrcode firmas en Bmp archivo en C#"
head_description: "Use .NET para buscar firmas Qrcode en archivos Bmp usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Bmp"
description: ".NET API nativa permite buscar Qrcode firmas en archivos Bmp ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Bmp utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Qrcode en archivos Bmp desde sus aplicaciones mediante la implementación de unos sencillos pasos.
