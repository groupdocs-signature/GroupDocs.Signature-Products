...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Ods di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Qrcode di file Ods menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Ods"
description: ".NET API asli memungkinkan untuk mencari Qrcode tanda tangan di file Ods yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ods Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Qrcode di Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Qrcode dalam file Ods dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
       Cari dokumen untuk berbagai tanda tangan elektronik ke file Ods sekarang juga dengan mengunjungi situs web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
