...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Jpg v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech Jpg pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Jpg"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Jpg. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Jpg pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Jpg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech Jpg z jejich aplikací implementací několika snadných kroků.
