...
############################# Head ############################
head_title: "Căutați semnături Qrcode în fișierul Xlsx în C#"
head_description: "Utilizați .NET pentru a căuta semnături Qrcode în fișiere Xlsx folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Qrcode în fișierul Xlsx"
description: "API-ul nativ .NET permite căutarea semnăturilor Qrcode în fișierele Xlsx deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Xlsx folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Qrcode în Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Qrcode în fișierele Xlsx din aplicațiile lor prin implementarea câțiva pași simpli.
...
demos:
    ...
    content: |
       Căutați în document diferite semnături electronice în fișiere Xlsx chiar acum, vizitând site-ul web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
