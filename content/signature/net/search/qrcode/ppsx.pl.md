...
############################# Head ############################
head_title: "Wyszukaj podpisy Qrcode w pliku Ppsx w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Qrcode w plikach Ppsx przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Qrcode w pliku Ppsx"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Qrcode w już podpisanych plikach Ppsx. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Ppsx, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Qrcode w plikach Ppsx z ich aplikacji, wykonując kilka prostych kroków.
