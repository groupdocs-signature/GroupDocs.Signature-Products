...
############################# Head ############################
head_title: "Search for Qrcode signatures in Pptx file in C#"
head_description: "Use .NET for searching for Qrcode signatures in Pptx files using a few lines of code."

############################# Header ############################
title: "Search for Qrcode signatures in Pptx file"
description: ".NET native API allows to search for Qrcode signatures in already signed Pptx files. Perform advanced e-signature search within your Pptx documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Qrcode signatures in Pptx files from their applications by implementing a few easy steps.
