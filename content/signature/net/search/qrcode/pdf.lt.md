...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Pdf faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Pdf failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Pdf faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Pdf failuose. Atlikite išplėstinę el. parašo paiešką savo Pdf dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Pdf failuose iš savo programų, atlikdami kelis paprastus veiksmus.
