...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Bmp i C#"
head_description: "Úsáid .NET chun sínithe Qrcode a chuardach i gcomhaid Bmp ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Bmp óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
