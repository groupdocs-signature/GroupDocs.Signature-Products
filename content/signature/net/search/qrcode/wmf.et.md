...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Wmf rakenduses C#"
head_description: "Kasutage .NET allkirjade Qrcode otsimiseks failides Wmf, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Wmf"
description: "Native API .NET võimaldab otsida allkirju Qrcode juba allkirjastatud Wmf failides. Tehke oma Wmf dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Wmf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Qrcode otsimist oma rakendustest failides Wmf, rakendades mõnda lihtsat sammu.
