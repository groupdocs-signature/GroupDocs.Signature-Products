...
############################# Head ############################
head_title: "C# içinde Dotx dosyasında Qrcode imzasını arayın"
head_description: "Birkaç satır kod kullanarak Dotx dosyalarında Qrcode imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Dotx dosyasında Qrcode imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Dotx dosyalarında Qrcode imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Dotx belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Dotx dosyalarında Qrcode imzalarını aramasını kolaylaştırır.
