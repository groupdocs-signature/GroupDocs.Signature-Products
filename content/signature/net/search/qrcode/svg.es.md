...
steps:
    enable: true
    title_left: "Cómo buscar firmas Qrcode en Svg"
    content_left: |
...
demos:
    ...
    content: |
       Agregue varias firmas electrónicas a los archivos Svg ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
