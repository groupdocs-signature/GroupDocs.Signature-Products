...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Jpg di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Qrcode di file Jpg menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Jpg"
description: ".NET API asli memungkinkan untuk mencari Qrcode tanda tangan di file Jpg yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Jpg Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Qrcode dalam file Jpg dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
