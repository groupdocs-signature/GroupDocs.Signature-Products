...
############################# Head ############################
head_title: "Wyszukaj podpisy Qrcode w pliku Png w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Qrcode w plikach Png przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Qrcode w pliku Png"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Qrcode w już podpisanych plikach Png. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Png, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Qrcode w Png"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Qrcode w plikach Png z ich aplikacji, wykonując kilka prostych kroków.
...
demos:
    ...
    content: |
       Wyszukaj w dokumencie różne podpisy elektroniczne w plikach Png, odwiedzając witrynę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
