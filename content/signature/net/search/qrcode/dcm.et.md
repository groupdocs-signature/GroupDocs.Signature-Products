...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Dcm rakenduses C#"
head_description: "Kasutage .NET allkirjade Qrcode otsimiseks failides Dcm, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Dcm"
description: "Native API .NET võimaldab otsida allkirju Qrcode juba allkirjastatud Dcm failides. Tehke oma Dcm dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Qrcode otsimist oma rakendustest failides Dcm, rakendades mõnda lihtsat sammu.
