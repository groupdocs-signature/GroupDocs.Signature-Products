...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file Otp in C#"
head_description: "Usa .NET per cercare le firme Qrcode nei file Otp utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file Otp"
description: "L'API nativa .NET consente di cercare firme Qrcode in file Otp già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Otp utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Qrcode nei file Otp dalle loro applicazioni implementando alcuni semplici passaggi.
