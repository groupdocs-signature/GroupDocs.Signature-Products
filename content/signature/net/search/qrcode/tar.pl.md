...
############################# Head ############################
head_title: "Wyszukaj podpisy Qrcode w pliku Tar w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Qrcode w plikach Tar przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Qrcode w pliku Tar"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Qrcode w już podpisanych plikach Tar. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Tar, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Qrcode w plikach Tar z ich aplikacji, wykonując kilka prostych kroków.
