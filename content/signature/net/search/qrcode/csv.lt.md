...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Csv faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Csv failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Csv faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Csv failuose. Atlikite išplėstinę el. parašo paiešką savo Csv dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Csv"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Csv failuose iš savo programų, atlikdami kelis paprastus veiksmus.
