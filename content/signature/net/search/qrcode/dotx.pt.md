...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Dotx em C#"
head_description: "Use .NET para pesquisar assinaturas Qrcode em arquivos Dotx usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Dotx"
description: "A API nativa do .NET permite pesquisar assinaturas Qrcode em arquivos Dotx já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Dotx usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Qrcode em arquivos Dotx de seus aplicativos implementando algumas etapas fáceis.
