...
############################# Head ############################
head_title: "C# içinde Dcm dosyasında Qrcode imzasını arayın"
head_description: "Birkaç satır kod kullanarak Dcm dosyalarında Qrcode imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Dcm dosyasında Qrcode imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Dcm dosyalarında Qrcode imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Dcm belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Dcm içinde Qrcode imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Dcm dosyalarında Qrcode imzalarını aramasını kolaylaştırır.
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web sitesini ziyaret ederek belgede Dcm dosyalarına yönelik çeşitli elektronik imzaları arayın.
