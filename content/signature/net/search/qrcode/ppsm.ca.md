...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Ppsm a C#"
head_description: "Utilitzeu .NET per cercar signatures Qrcode als fitxers Ppsm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Ppsm"
description: "L'API nativa de .NET permet cercar signatures Qrcode als fitxers Ppsm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Ppsm amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Qrcode a Ppsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Qrcode als fitxers Ppsm des de les seves aplicacions implementant uns quants passos senzills.
