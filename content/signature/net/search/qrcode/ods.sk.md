...
############################# Head ############################
head_title: "Vyhľadajte podpisy Qrcode v súbore Ods v C#"
head_description: "Použite .NET na vyhľadávanie Qrcode podpisov v súboroch Ods pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Qrcode v súbore Ods"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Qrcode v už podpísaných súboroch Ods. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Ods pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Qrcode v súboroch Ods z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
