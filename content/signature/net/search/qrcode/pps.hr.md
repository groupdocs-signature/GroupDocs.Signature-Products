...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Pps u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Pps pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Pps datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Pps datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Pps dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Qrcode potpise u Pps"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Pps iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
