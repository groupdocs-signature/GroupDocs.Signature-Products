...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Svg rakenduses C#"
head_description: "Kasutage .NET allkirjade Qrcode otsimiseks failides Svg, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Svg"
description: "Native API .NET võimaldab otsida allkirju Qrcode juba allkirjastatud Svg failides. Tehke oma Svg dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Svg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Qrcode otsimist oma rakendustest failides Svg, rakendades mõnda lihtsat sammu.
