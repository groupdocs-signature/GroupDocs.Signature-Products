...
############################# Head ############################
head_title: "Procure por assinaturas Qrcode no arquivo Svg em C#"
head_description: "Use .NET para pesquisar assinaturas Qrcode em arquivos Svg usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Qrcode no arquivo Svg"
description: "A API nativa do .NET permite pesquisar assinaturas Qrcode em arquivos Svg já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Svg usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Qrcode em Svg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Qrcode em arquivos Svg de seus aplicativos implementando algumas etapas fáceis.
