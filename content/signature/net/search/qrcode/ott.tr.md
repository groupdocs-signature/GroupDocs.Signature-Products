...
############################# Head ############################
head_title: "C# içinde Ott dosyasında Qrcode imzasını arayın"
head_description: "Birkaç satır kod kullanarak Ott dosyalarında Qrcode imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Ott dosyasında Qrcode imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Ott dosyalarında Qrcode imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Ott belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Ott dosyalarında Qrcode imzalarını aramasını kolaylaştırır.
