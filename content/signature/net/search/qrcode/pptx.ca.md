...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Pptx a C#"
head_description: "Utilitzeu .NET per cercar signatures Qrcode als fitxers Pptx mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Pptx"
description: "L'API nativa de .NET permet cercar signatures Qrcode als fitxers Pptx ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Pptx amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Qrcode a Pptx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Qrcode als fitxers Pptx des de les seves aplicacions implementant uns quants passos senzills.
