...
############################# Head ############################
head_title: "Шукайте підписи Qrcode у файлі Ppt у C#"
head_description: "Використовуйте .NET для пошуку підписів Qrcode у файлах Ppt за допомогою кількох рядків коду."

############################# Header ############################
title: "Шукайте підписи Qrcode у файлі Ppt"
description: "Власний API .NET дозволяє шукати підписи Qrcode у вже підписаних файлах Ppt. Виконайте розширений пошук електронного підпису в документах Ppt за допомогою кількох рядків коду."
...
steps:
    enable: true
    title_left: "Як шукати підписи Qrcode у Ppt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) полегшує розробникам .NET пошук підписів Qrcode у файлах Ppt у їхніх програмах, виконавши кілька простих кроків.
