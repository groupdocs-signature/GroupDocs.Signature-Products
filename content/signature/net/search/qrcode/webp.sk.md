...
############################# Head ############################
head_title: "Vyhľadajte podpisy Qrcode v súbore Webp v C#"
head_description: "Použite .NET na vyhľadávanie Qrcode podpisov v súboroch Webp pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Qrcode v súbore Webp"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Qrcode v už podpísaných súboroch Webp. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Webp pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Qrcode v súboroch Webp z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
