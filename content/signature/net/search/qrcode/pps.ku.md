...
############################# Head ############################
head_title: "Li Qrcode îmzeyan di pela Pps de di C# de bigerin"
head_description: ".NET ji bo lêgerîna îmzeyên Qrcode di pelên Pps de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Pps de li îmzeyên Qrcode bigerin"
description: "API-ya xwecihî ya .NET destûrê dide ku meriv di pelên Pps yên jixwe îmzekirî de li îmzeyên Qrcode bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Pps de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji pêşdebirên .NET re hêsantir dike ku bi pêkanîna çend gavên hêsan li Qrcode di pelên Pps îmzeyan de ji sepanên xwe bigerin.
