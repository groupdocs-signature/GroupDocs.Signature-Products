...
############################# Head ############################
head_title: "Wyszukaj podpisy Qrcode w pliku Xltm w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Qrcode w plikach Xltm przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Qrcode w pliku Xltm"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Qrcode w już podpisanych plikach Xltm. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Xltm, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Qrcode w plikach Xltm z ich aplikacji, wykonując kilka prostych kroków.
