...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Tiff faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Tiff failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Tiff faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Tiff failuose. Atlikite išplėstinę el. parašo paiešką savo Tiff dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Tiff failuose iš savo programų, atlikdami kelis paprastus veiksmus.
