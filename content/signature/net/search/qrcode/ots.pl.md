...
############################# Head ############################
head_title: "Wyszukaj podpisy Qrcode w pliku Ots w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Qrcode w plikach Ots przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Qrcode w pliku Ots"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Qrcode w już podpisanych plikach Ots. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Ots, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Qrcode w plikach Ots z ich aplikacji, wykonując kilka prostych kroków.
