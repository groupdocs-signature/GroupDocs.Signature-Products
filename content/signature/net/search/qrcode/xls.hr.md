...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Xls u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Xls pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Xls datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Xls datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xls dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Qrcode potpise u Xls"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Xls iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
