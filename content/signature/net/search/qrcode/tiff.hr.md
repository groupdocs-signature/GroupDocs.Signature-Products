...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Tiff u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Tiff pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Tiff datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Tiff datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Tiff dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Qrcode potpise u Tiff"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Tiff iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
