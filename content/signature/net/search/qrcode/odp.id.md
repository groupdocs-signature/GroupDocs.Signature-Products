...
breadcrumb: Search Qrcode signatures at Odp with C#

############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Odp di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Qrcode di file Odp menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Odp"
description: ".NET API asli memungkinkan untuk mencari Qrcode tanda tangan di file Odp yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Odp Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Qrcode dalam file Odp dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
