...
############################# Head ############################
head_title: "Sök efter Qrcode-signaturer i filen Xlsb i C#"
head_description: "Använd .NET för att söka efter Qrcode-signaturer i Xlsb-filer med några rader kod."

############################# Header ############################
title: "Sök efter Qrcode-signaturer i filen Xlsb"
description: "Inbyggt API för .NET gör det möjligt att söka efter Qrcode-signaturer i redan signerade Xlsb-filer. Utför avancerad e-signatursökning i dina Xlsb-dokument med några rader kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gör det enklare för .NET-utvecklare att söka efter Qrcode-signaturer i Xlsb-filer från sina applikationer genom att implementera några enkla steg.
