...
############################# Head ############################
head_title: "Cari tandatangan Qrcode dalam fail Potm dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Qrcode dalam fail Potm menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Qrcode dalam fail Potm."
description: "API asli .NET membenarkan untuk mencari tandatangan Qrcode dalam fail Potm yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Potm anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Qrcode dalam Potm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Qrcode dalam fail Potm daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
