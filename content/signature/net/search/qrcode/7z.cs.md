...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru 7z v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech 7z pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru 7z"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech 7z. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech 7z pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech 7z z jejich aplikací implementací několika snadných kroků.
