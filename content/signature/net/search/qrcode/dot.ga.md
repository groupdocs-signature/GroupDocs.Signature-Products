...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Dot i C#"
head_description: "Úsáid .NET chun sínithe Qrcode a chuardach i gcomhaid Dot ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Qrcode sínithe i gcomhad Dot"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Dot ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Qrcode a chuardach i Dot"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Dot óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
