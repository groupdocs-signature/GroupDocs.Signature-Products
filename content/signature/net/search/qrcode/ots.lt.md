...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Ots faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Ots failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Ots faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Ots failuose. Atlikite išplėstinę el. parašo paiešką savo Ots dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Ots failuose iš savo programų, atlikdami kelis paprastus veiksmus.
