...
############################# Head ############################
head_title: "Otsige allkirju Qrcode failist Xlsx rakenduses C#"
head_description: "Kasutage .NET allkirjade Qrcode otsimiseks failides Xlsx, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Qrcode allkirju Xlsx"
description: "Native API .NET võimaldab otsida allkirju Qrcode juba allkirjastatud Xlsx failides. Tehke oma Xlsx dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Qrcode otsimine failivormingus Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Qrcode otsimist oma rakendustest failides Xlsx, rakendades mõnda lihtsat sammu.
