...
############################# Head ############################
head_title: "Cari tandatangan Qrcode dalam fail Tar dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Qrcode dalam fail Tar menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Qrcode dalam fail Tar."
description: "API asli .NET membenarkan untuk mencari tandatangan Qrcode dalam fail Tar yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Tar anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Qrcode dalam Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Qrcode dalam fail Tar daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
