...
############################# Head ############################
head_title: "Шукайте підписи Qrcode у файлі Odt у C#"
head_description: "Використовуйте .NET для пошуку підписів Qrcode у файлах Odt за допомогою кількох рядків коду."

############################# Header ############################
title: "Шукайте підписи Qrcode у файлі Odt"
description: "Власний API .NET дозволяє шукати підписи Qrcode у вже підписаних файлах Odt. Виконайте розширений пошук електронного підпису в документах Odt за допомогою кількох рядків коду."
...
steps:
    enable: true
    title_left: "Як шукати підписи Qrcode у Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) полегшує розробникам .NET пошук підписів Qrcode у файлах Odt у їхніх програмах, виконавши кілька простих кроків.
