...
############################# Head ############################
head_title: "Търсене на подписи Qrcode във файл Doc в C#"
head_description: "Използвайте .NET за търсене на подписи Qrcode във файлове Doc, като използвате няколко реда код."

############################# Header ############################
title: "Търсене на подписи Qrcode във файл Doc"
description: "Нативният API на .NET позволява търсене на подписи на Qrcode във вече подписани файлове на Doc. Извършете разширено търсене с електронен подпис във вашите Doc документи, като използвате няколко реда код."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) улеснява разработчиците на .NET да търсят подписи на Qrcode във файловете на Doc от техните приложения чрез прилагане на няколко лесни стъпки.
