...
############################# Head ############################
head_title: "Поиск подписей Qrcode в файле Dotx в C#"
head_description: "Используйте .NET для поиска подписей Qrcode в файлах Dotx с помощью нескольких строк кода."

############################# Header ############################
title: "Поиск подписей Qrcode в файле Dotx"
description: "Собственный API .NET позволяет искать подписи Qrcode в уже подписанных файлах Dotx. Выполните расширенный поиск электронной подписи в документах Dotx, используя несколько строк кода."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) упрощает разработчикам .NET поиск подписей Qrcode в файлах Dotx из своих приложений, выполняя несколько простых шагов.
