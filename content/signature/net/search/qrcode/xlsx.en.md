...
############################# Head ############################
head_title: "Search Qrcode signatures in Xlsx file in C#"
head_description: "Use .NET for searching Qrcode signatures in Xlsx files using a few lines of code."

############################# Header ############################
title: "Search Qrcode signatures in Xlsx file"
description: ".NET native API to search Qrcode signatures in already signed Xlsx file. Perform advanced e-signature operations within your Xlsx documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easy for .NET developers to search Qrcode signatures in Xlsx files from within their applications by implementing a few easy steps.
