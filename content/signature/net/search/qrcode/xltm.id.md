...
############################# Head ############################
head_title: "Cari tanda tangan Qrcode dalam file Xltm di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Qrcode di file Xltm menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Qrcode di file Xltm"
description: ".NET API asli memungkinkan untuk mencari Qrcode tanda tangan di file Xltm yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xltm Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Qrcode dalam file Xltm dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
