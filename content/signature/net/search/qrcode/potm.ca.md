...
############################# Head ############################
head_title: "Cerqueu signatures de Qrcode al fitxer Potm a C#"
head_description: "Utilitzeu .NET per cercar signatures Qrcode als fitxers Potm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Qrcode al fitxer Potm"
description: "L'API nativa de .NET permet cercar signatures Qrcode als fitxers Potm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Potm amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Qrcode als fitxers Potm des de les seves aplicacions implementant uns quants passos senzills.
