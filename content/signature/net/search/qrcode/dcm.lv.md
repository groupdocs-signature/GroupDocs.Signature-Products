...
############################# Head ############################
head_title: "Meklēt Qrcode parakstus Dcm failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Qrcode parakstus Dcm failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Qrcode parakstus failā Dcm"
description: ".NET vietējais API ļauj meklēt Qrcode parakstus jau parakstītos Dcm failos. Veiciet izvērsto e-paraksta meklēšanu savos Dcm dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    enable: true
    title_left: "Kā meklēt Qrcode parakstus Dcm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Qrcode parakstus Dcm failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
