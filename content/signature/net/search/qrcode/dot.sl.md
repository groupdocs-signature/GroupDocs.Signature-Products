...
############################# Head ############################
head_title: "Poiščite podpise Qrcode v datoteki Dot v C#"
head_description: "Uporabite .NET za iskanje podpisov Qrcode v datotekah Dot z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Qrcode v datoteki Dot"
description: "Izvorni API za .NET omogoča iskanje podpisov Qrcode v že podpisanih datotekah Dot. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Dot z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) razvijalcem za .NET olajša iskanje podpisov Qrcode v datotekah Dot iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
