...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Doc u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Doc pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Doc datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Doc datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Doc dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Qrcode potpise u Doc"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Doc iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
