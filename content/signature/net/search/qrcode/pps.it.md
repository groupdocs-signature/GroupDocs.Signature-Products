...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file Pps in C#"
head_description: "Usa .NET per cercare le firme Qrcode nei file Pps utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file Pps"
description: "L'API nativa .NET consente di cercare firme Qrcode in file Pps già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Pps utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Qrcode nei file Pps dalle loro applicazioni implementando alcuni semplici passaggi.
