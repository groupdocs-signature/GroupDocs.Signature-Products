...
############################# Head ############################
head_title: "Rechercher les signatures Qrcode dans le fichier Ppsm dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Qrcode dans des fichiers Ppsm en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Qrcode dans le fichier Ppsm"
description: "L'API native .NET permet de rechercher des signatures Qrcode dans des fichiers Ppsm déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Ppsm en utilisant quelques lignes de code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Qrcode dans des fichiers Ppsm à partir de leurs applications en mettant en œuvre quelques étapes simples.
