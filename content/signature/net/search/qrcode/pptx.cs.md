...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Pptx v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech Pptx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Pptx"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Pptx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Pptx pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Pptx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech Pptx z jejich aplikací implementací několika snadných kroků.
