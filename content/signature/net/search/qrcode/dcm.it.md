...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file Dcm in C#"
head_description: "Usa .NET per cercare le firme Qrcode nei file Dcm utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file Dcm"
description: "L'API nativa .NET consente di cercare firme Qrcode in file Dcm già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Dcm utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Qrcode in Dcm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Qrcode nei file Dcm dalle loro applicazioni implementando alcuni semplici passaggi.
