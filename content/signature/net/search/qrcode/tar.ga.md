...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Tar i C#"
head_description: "Úsáid .NET chun sínithe Qrcode a chuardach i gcomhaid Tar ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Qrcode sínithe i gcomhad Tar"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar Qrcode sínithe i gcomhaid Tar atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Tar ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Tar óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
