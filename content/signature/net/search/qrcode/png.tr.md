...
############################# Head ############################
head_title: "C# içinde Png dosyasında Qrcode imzasını arayın"
head_description: "Birkaç satır kod kullanarak Png dosyalarında Qrcode imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Png dosyasında Qrcode imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Png dosyalarında Qrcode imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Png belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Png içinde Qrcode imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Png dosyalarında Qrcode imzalarını aramasını kolaylaştırır.
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web sitesini ziyaret ederek belgede Png dosyalarına yönelik çeşitli elektronik imzaları arayın.
