...
############################# Head ############################
head_title: "C# の Rtf ファイルで Qrcode 署名を検索します"
head_description: "数行のコードを使用して Rtf ファイル内の Qrcode 署名を検索するには、.NET を使用します。"

############################# Header ############################
title: "Rtf ファイルで Qrcode 署名を検索します"
description: ".NET ネイティブ API により、署名済みの Rtf ファイルで Qrcode 署名を検索できます。数行のコードを使用して、Rtf ドキュメント内で高度な電子署名検索を実行します。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) を使用すると、いくつかの簡単な手順を実装することで、.NET の開発者がアプリケーションから Rtf ファイル内の Qrcode 署名を簡単に検索できるようになります。
