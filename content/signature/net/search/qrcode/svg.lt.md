...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Svg faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Svg failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Svg faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Svg failuose. Atlikite išplėstinę el. parašo paiešką savo Svg dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Qrcode parašų Svg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Svg failuose iš savo programų, atlikdami kelis paprastus veiksmus.
...
demos:
    ...
    content: |
       Dabar ieškokite dokumente įvairių elektroninių parašų prie Svg failų, apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje.
