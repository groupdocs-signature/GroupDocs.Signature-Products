...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Webp faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Webp failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Webp faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Webp failuose. Atlikite išplėstinę el. parašo paiešką savo Webp dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Webp failuose iš savo programų, atlikdami kelis paprastus veiksmus.
