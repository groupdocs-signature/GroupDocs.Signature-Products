...
############################# Head ############################
head_title: "Cerca le firme Qrcode nel file Ots in C#"
head_description: "Usa .NET per cercare le firme Qrcode nei file Ots utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Qrcode nel file Ots"
description: "L'API nativa .NET consente di cercare firme Qrcode in file Ots già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Ots utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Qrcode in Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Qrcode nei file Ots dalle loro applicazioni implementando alcuni semplici passaggi.
