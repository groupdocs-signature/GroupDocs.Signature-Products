...
############################# Head ############################
head_title: "Busque Qrcode firmas en Ppt archivo en C#"
head_description: "Use .NET para buscar firmas Qrcode en archivos Ppt usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Qrcode en el archivo Ppt"
description: ".NET API nativa permite buscar Qrcode firmas en archivos Ppt ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Ppt utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Qrcode en Ppt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Qrcode en archivos Ppt desde sus aplicaciones mediante la implementación de unos sencillos pasos.
