...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Xlsb v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech Xlsb pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Xlsb"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Xlsb. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Xlsb pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech Xlsb z jejich aplikací implementací několika snadných kroků.
