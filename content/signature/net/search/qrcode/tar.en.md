...
############################# Head ############################
head_title: "Search for Qrcode signatures in Tar file in C#"
head_description: "Use .NET for searching for Qrcode signatures in Tar files using a few lines of code."

############################# Header ############################
title: "Search for Qrcode signatures in Tar file"
description: ".NET native API allows to search for Qrcode signatures in already signed Tar files. Perform advanced e-signature search within your Tar documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Qrcode signatures in Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Qrcode signatures in Tar files from their applications by implementing a few easy steps.
