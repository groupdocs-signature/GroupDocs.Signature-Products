...
############################# Head ############################
head_title: "Vyhľadajte podpisy Qrcode v súbore Pdf v C#"
head_description: "Použite .NET na vyhľadávanie Qrcode podpisov v súboroch Pdf pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Qrcode v súbore Pdf"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Qrcode v už podpísaných súboroch Pdf. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Pdf pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Qrcode v súboroch Pdf z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
