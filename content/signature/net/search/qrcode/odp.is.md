...
############################# Head ############################
head_title: "Leitaðu að Qrcode undirskriftum í Odp skrá í C#"
head_description: "Notaðu .NET til að leita að Qrcode undirskriftum í Odp skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Qrcode undirskriftum í Odp skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Qrcode undirskriftum í þegar undirrituðum Odp skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Odp skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að leita að Qrcode undirskriftum í Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Qrcode undirskriftum í Odp skrám úr forritum sínum með því að útfæra nokkur einföld skref.
...
demos:
    ...
    content: |
       Leitaðu í skjalinu að ýmsum rafrænum undirskriftum í Odp skrár núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna.
