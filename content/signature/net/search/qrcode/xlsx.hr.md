...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Xlsx u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Xlsx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Xlsx datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Xlsx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xlsx dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Xlsx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
