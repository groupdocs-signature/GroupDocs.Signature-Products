...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Ott i C#"
head_description: "Úsáid .NET chun sínithe Qrcode a chuardach i gcomhaid Ott ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Qrcode sínithe i gcomhad Ott"
...
steps:
    enable: true
    title_left: "Conas síniú Qrcode a chuardach i Ott"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Ott óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
