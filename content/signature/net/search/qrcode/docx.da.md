...
############################# Head ############################
head_title: "Søg efter Qrcode signaturer i filen Docx i C#"
head_description: "Brug .NET til at søge efter Qrcode-signaturer i Docx-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Qrcode-signaturer i filen Docx"
description: ".NET native API gør det muligt at søge efter Qrcode-signaturer i allerede signerede Docx-filer. Udfør avanceret e-signatursøgning i dine Docx dokumenter ved hjælp af et par linjer kode."
...
steps:
    enable: true
    title_left: "Sådan søger du efter Qrcode-signaturer i Docx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gør det nemmere for .NET-udviklere at søge efter Qrcode-signaturer i Docx-filer fra deres applikationer ved at implementere nogle få nemme trin.
