...
############################# Head ############################
head_title: "Vyhledejte podpisy Qrcode v souboru Zip v C#"
head_description: "Použijte .NET k vyhledávání podpisů Qrcode v souborech Zip pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Qrcode v souboru Zip"
description: "Nativní API .NET umožňuje vyhledávat podpisy Qrcode v již podepsaných souborech Zip. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Zip pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Qrcode v Zip"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Qrcode v souborech Zip z jejich aplikací implementací několika snadných kroků.
