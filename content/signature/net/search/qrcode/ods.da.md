...
############################# Head ############################
head_title: "Søg efter Qrcode signaturer i filen Ods i C#"
head_description: "Brug .NET til at søge efter Qrcode-signaturer i Ods-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Qrcode-signaturer i filen Ods"
description: ".NET native API gør det muligt at søge efter Qrcode-signaturer i allerede signerede Ods-filer. Udfør avanceret e-signatursøgning i dine Ods dokumenter ved hjælp af et par linjer kode."
...
steps:
    enable: true
    title_left: "Sådan søger du efter Qrcode-signaturer i Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gør det nemmere for .NET-udviklere at søge efter Qrcode-signaturer i Ods-filer fra deres applikationer ved at implementere nogle få nemme trin.
