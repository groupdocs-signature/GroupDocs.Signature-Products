...
############################# Head ############################
head_title: "Potražite Qrcode potpise u datoteci Odt u C#"
head_description: "Upotrijebite .NET za traženje potpisa Qrcode u datotekama Odt pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Qrcode potpise u Odt datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Qrcode u već potpisanim Odt datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Odt dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Qrcode u datotekama Odt iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
