...
description: ".NET жергілікті API бұрыннан қол қойылған Pptm файлдарындағы Qrcode қолтаңбаларын іздеуге мүмкіндік береді. Кодтың бірнеше жолын пайдаланып Pptm құжаттарыңызда кеңейтілген электрондық қолтаңбаны іздеуді орындаңыз."
