...
############################# Head ############################
head_title: "Ieškokite Qrcode parašų Jpg faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Qrcode parašų Jpg failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Qrcode parašų Jpg faile"
description: ".NET savoji API leidžia ieškoti Qrcode parašų jau pasirašytuose Jpg failuose. Atlikite išplėstinę el. parašo paiešką savo Jpg dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Qrcode parašų Jpg failuose iš savo programų, atlikdami kelis paprastus veiksmus.
