...
############################# Head ############################
head_title: "Vyhľadajte podpisy Qrcode v súbore Wmf v C#"
head_description: "Použite .NET na vyhľadávanie Qrcode podpisov v súboroch Wmf pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Qrcode v súbore Wmf"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Qrcode v už podpísaných súboroch Wmf. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Wmf pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Qrcode v súboroch Wmf z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
