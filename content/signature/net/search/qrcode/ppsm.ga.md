...
############################# Head ############################
head_title: "Cuardaigh Qrcode síniú i gcomhad Ppsm i C#"
head_description: "Úsáid .NET chun sínithe Qrcode a chuardach i gcomhaid Ppsm ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Qrcode sínithe i gcomhad Ppsm"
...
steps:
    enable: true
    title_left: "Conas síniú Qrcode a chuardach i Ppsm"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Qrcode i gcomhaid Ppsm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
