...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Ppsm i C#"
head_description: "Úsáid .NET chun sínithe Barcode a chuardach i gcomhaid Ppsm ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Ppsm"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Ppsm ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Barcode i gcomhaid Ppsm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
