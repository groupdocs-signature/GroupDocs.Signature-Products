...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Xlsb i C#"
head_description: "Úsáid .NET chun sínithe Barcode a chuardach i gcomhaid Xlsb ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Xlsb"
...
steps:
    enable: true
    title_left: "Conas síniú Barcode a chuardach i Xlsb"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Barcode i gcomhaid Xlsb óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
