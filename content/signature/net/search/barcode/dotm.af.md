...
description: ".NET se inheemse API laat toe om vir Barcode handtekeninge te soek in reeds ondertekende Dotm lêers. Voer gevorderde e-handtekeningsoektog binne jou Dotm dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    enable: true
    title_left: "Hoe om te soek vir Barcode handtekeninge in Dotm"
    content_left: |
