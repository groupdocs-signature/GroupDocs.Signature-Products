...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Rtf i C#"
head_description: "Úsáid .NET chun sínithe Barcode a chuardach i gcomhaid Rtf ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Rtf"
...
steps:
    enable: true
    title_left: "Conas síniú Barcode a chuardach i Rtf"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Barcode i gcomhaid Rtf óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
