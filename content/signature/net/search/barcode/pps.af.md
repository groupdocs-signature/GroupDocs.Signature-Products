...
description: ".NET se inheemse API laat toe om vir Barcode handtekeninge te soek in reeds ondertekende Pps lêers. Voer gevorderde e-handtekeningsoektog binne jou Pps dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    enable: true
    title_left: "Hoe om te soek vir Barcode handtekeninge in Pps"
    content_left: |
