...
############################# Head ############################
head_title: "Search for Barcode signatures in 7z file in C#"
head_description: "Use .NET for searching for Barcode signatures in 7z files using a few lines of code."

############################# Header ############################
title: "Search for Barcode signatures in 7z file"
description: ".NET native API allows to search for Barcode signatures in already signed 7z files. Perform advanced e-signature search within your 7z documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Barcode signatures in 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Barcode signatures in 7z files from their applications by implementing a few easy steps.
