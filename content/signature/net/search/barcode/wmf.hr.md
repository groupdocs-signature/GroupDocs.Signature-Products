...
############################# Head ############################
head_title: "Potražite Barcode potpise u datoteci Wmf u C#"
head_description: "Upotrijebite .NET za traženje potpisa Barcode u datotekama Wmf pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Barcode potpise u Wmf datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Barcode u već potpisanim Wmf datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Wmf dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Barcode u datotekama Wmf iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
