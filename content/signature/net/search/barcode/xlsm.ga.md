...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Xlsm i C#"
head_description: "Úsáid .NET chun sínithe Barcode a chuardach i gcomhaid Xlsm ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Barcode i gcomhaid Xlsm óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
