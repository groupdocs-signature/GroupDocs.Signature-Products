...
############################# Head ############################
head_title: "მოძებნეთ Barcode ხელმოწერები Xltm ფაილში C#"
head_description: "გამოიყენეთ .NET Barcode ხელმოწერების მოსაძიებლად Xltm ფაილებში კოდის რამდენიმე ხაზის გამოყენებით."

############################# Header ############################
title: "მოძებნეთ Barcode ხელმოწერები Xltm ფაილში"
description: ".NET მშობლიური API საშუალებას გაძლევთ მოძებნოთ Barcode ხელმოწერები უკვე ხელმოწერილ Xltm ფაილებში. განახორციელეთ ელექტრონული ხელმოწერის გაფართოებული ძიება თქვენს {{ფაილის ფორმატში}} დოკუმენტებში კოდის რამდენიმე ხაზის გამოყენებით."
...
steps:
    enable: true
    title_left: "როგორ მოძებნოთ Barcode ხელმოწერები Xltm-ში"
    content_left: |
