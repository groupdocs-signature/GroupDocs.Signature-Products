...
description: "Inbyggt API för .NET gör det möjligt att söka efter Barcode-signaturer i redan signerade Pps-filer. Utför avancerad e-signatursökning i dina {{Filformat}}-dokument med några rader kod."
