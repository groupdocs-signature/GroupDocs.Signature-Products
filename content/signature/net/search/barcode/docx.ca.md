...
############################# Head ############################
head_title: "Cerqueu signatures de Barcode al fitxer Docx a C#"
head_description: "Utilitzeu .NET per cercar signatures Barcode als fitxers Docx mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Barcode al fitxer Docx"
description: "L'API nativa de .NET permet cercar signatures Barcode als fitxers Docx ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Docx amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Barcode als fitxers Docx des de les seves aplicacions implementant uns quants passos senzills.
