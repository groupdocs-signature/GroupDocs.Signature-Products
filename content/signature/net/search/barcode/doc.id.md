...
############################# Head ############################
head_title: "Cari tanda tangan Barcode dalam file Doc di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Barcode di file Doc menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Barcode di file Doc"
description: ".NET API asli memungkinkan untuk mencari Barcode tanda tangan di file Doc yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Doc Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Barcode dalam file Doc dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
