...
demos:
    ...
    content: |
       Add various electronic signatures to Bmp files right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.
