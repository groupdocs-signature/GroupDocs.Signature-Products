...
############################# Head ############################
head_title: "Cuardaigh Barcode síniú i gcomhad Tar i C#"
head_description: "Úsáid .NET chun sínithe Barcode a chuardach i gcomhaid Tar ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Barcode sínithe i gcomhad Tar"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar Barcode sínithe i gcomhaid Tar atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Tar ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Barcode i gcomhaid Tar óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
