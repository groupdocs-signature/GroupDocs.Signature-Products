...
############################# Head ############################
head_title: "Cari tanda tangan Barcode dalam file Odt di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Barcode di file Odt menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Barcode di file Odt"
description: ".NET API asli memungkinkan untuk mencari Barcode tanda tangan di file Odt yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Odt Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Barcode di Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Barcode dalam file Odt dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
