...
############################# Head ############################
head_title: "Cari tanda tangan Barcode dalam file Ods di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Barcode di file Ods menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Barcode di file Ods"
description: ".NET API asli memungkinkan untuk mencari Barcode tanda tangan di file Ods yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ods Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Barcode dalam file Ods dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
