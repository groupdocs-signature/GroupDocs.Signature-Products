...
############################# Head ############################
head_title: "Li Barcode îmzeyan di pela Rtf de di C# de bigerin"
head_description: ".NET ji bo lêgerîna îmzeyên Barcode di pelên Rtf de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Rtf de li îmzeyên Barcode bigerin"
description: "API-ya xwecihî ya .NET destûrê dide ku meriv di pelên Rtf yên jixwe îmzekirî de li îmzeyên Barcode bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Rtf de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Barcode di Rtf de digere"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji pêşdebirên .NET re hêsantir dike ku bi pêkanîna çend gavên hêsan li Barcode di pelên Rtf îmzeyan de ji sepanên xwe bigerin.
