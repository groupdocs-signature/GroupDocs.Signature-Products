...
############################# Head ############################
head_title: "Procure por assinaturas Barcode no arquivo Pdf em C#"
head_description: "Use .NET para pesquisar assinaturas Barcode em arquivos Pdf usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Barcode no arquivo Pdf"
description: "A API nativa do .NET permite pesquisar assinaturas Barcode em arquivos Pdf já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Pdf usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Barcode em Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Barcode em arquivos Pdf de seus aplicativos implementando algumas etapas fáceis.
