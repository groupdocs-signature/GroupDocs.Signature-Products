...
############################# Head ############################
head_title: "Vyhledejte podpisy Barcode v souboru Ods v C#"
head_description: "Použijte .NET k vyhledávání podpisů Barcode v souborech Ods pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Barcode v souboru Ods"
description: "Nativní API .NET umožňuje vyhledávat podpisy Barcode v již podepsaných souborech Ods. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ods pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Barcode v Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Barcode v souborech Ods z jejich aplikací implementací několika snadných kroků.
