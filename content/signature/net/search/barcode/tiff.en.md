...
############################# Head ############################
head_title: "Search Barcode signatures in Tiff file in C#"
head_description: "Use .NET for searching Barcode signatures in Tiff files using a few lines of code."

############################# Header ############################
title: "Search Barcode signatures in Tiff file"
description: ".NET native API to search Barcode signatures in already signed Tiff file. Perform advanced e-signature operations within your Tiff documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easy for .NET developers to search Barcode signatures in Tiff files from within their applications by implementing a few easy steps.
