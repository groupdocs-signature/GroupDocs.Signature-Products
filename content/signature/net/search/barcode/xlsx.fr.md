...
############################# Head ############################
head_title: "Rechercher les signatures Barcode dans le fichier Xlsx dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Barcode dans des fichiers Xlsx en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Barcode dans le fichier Xlsx"
description: "L'API native .NET permet de rechercher des signatures Barcode dans des fichiers Xlsx déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Xlsx en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Barcode dans Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Barcode dans des fichiers Xlsx à partir de leurs applications en mettant en œuvre quelques étapes simples.
