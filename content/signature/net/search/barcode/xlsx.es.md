...
############################# Head ############################
head_title: "Busque Barcode firmas en Xlsx archivo en C#"
head_description: "Use .NET para buscar firmas Barcode en archivos Xlsx usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Barcode en el archivo Xlsx"
description: ".NET API nativa permite buscar Barcode firmas en archivos Xlsx ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Xlsx utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas Barcode en Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Barcode en archivos Xlsx desde sus aplicaciones mediante la implementación de unos sencillos pasos.
