...
description: ".NET se inheemse API laat toe om vir Barcode handtekeninge te soek in reeds ondertekende Dot lêers. Voer gevorderde e-handtekeningsoektog binne jou Dot dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    enable: true
    title_left: "Hoe om te soek vir Barcode handtekeninge in Dot"
    content_left: |
