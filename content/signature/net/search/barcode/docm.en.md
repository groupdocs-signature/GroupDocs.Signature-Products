...
############################# Head ############################
head_title: "Search for Barcode signatures in Docm file in C#"
head_description: "Use .NET for searching for Barcode signatures in Docm files using a few lines of code."

############################# Header ############################
title: "Search for Barcode signatures in Docm file"
description: ".NET native API allows to search for Barcode signatures in already signed Docm files. Perform advanced e-signature search within your Docm documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Barcode signatures in Docm files from their applications by implementing a few easy steps.
