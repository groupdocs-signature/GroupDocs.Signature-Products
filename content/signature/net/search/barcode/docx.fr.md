...
############################# Head ############################
head_title: "Rechercher les signatures Barcode dans le fichier Docx dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Barcode dans des fichiers Docx en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Barcode dans le fichier Docx"
description: "L'API native .NET permet de rechercher des signatures Barcode dans des fichiers Docx déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Docx en utilisant quelques lignes de code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Barcode dans des fichiers Docx à partir de leurs applications en mettant en œuvre quelques étapes simples.
