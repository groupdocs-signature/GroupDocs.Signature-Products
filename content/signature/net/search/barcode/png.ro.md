...
############################# Head ############################
head_title: "Căutați semnături Barcode în fișierul Png în C#"
head_description: "Utilizați .NET pentru a căuta semnături Barcode în fișiere Png folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Barcode în fișierul Png"
description: "API-ul nativ .NET permite căutarea semnăturilor Barcode în fișierele Png deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Png folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Barcode în fișierele Png din aplicațiile lor prin implementarea câțiva pași simpli.
