...
############################# Head ############################
head_title: "Cari tandatangan Barcode dalam fail Svg dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Barcode dalam fail Svg menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Barcode dalam fail Svg."
description: "API asli .NET membenarkan untuk mencari tandatangan Barcode dalam fail Svg yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Svg anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Barcode dalam fail Svg daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
