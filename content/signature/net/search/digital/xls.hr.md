...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Xls u C#"
head_description: "Upotrijebite .NET za traženje potpisa Digital u datotekama Xls pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Xls datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Digital u već potpisanim Xls datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xls dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Digital u datotekama Xls iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
