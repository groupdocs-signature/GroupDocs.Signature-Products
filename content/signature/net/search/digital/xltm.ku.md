...
############################# Head ############################
head_title: "Li Digital îmzeyan di pela Xltm de di C# de bigerin"
head_description: ".NET ji bo lêgerîna îmzeyên Digital di pelên Xltm de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Xltm de li îmzeyên Digital bigerin"
description: "API-ya xwecihî ya .NET destûrê dide ku meriv di pelên Xltm yên jixwe îmzekirî de li îmzeyên Digital bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Xltm de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji pêşdebirên .NET re hêsantir dike ku bi pêkanîna çend gavên hêsan li Digital di pelên Xltm îmzeyan de ji sepanên xwe bigerin.
