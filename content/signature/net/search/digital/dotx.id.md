...
############################# Head ############################
head_title: "Cari tanda tangan Digital dalam file Dotx di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Digital di file Dotx menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Digital di file Dotx"
description: ".NET API asli memungkinkan untuk mencari Digital tanda tangan di file Dotx yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Dotx Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Digital di Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Digital dalam file Dotx dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
