...
############################# Head ############################
head_title: "Sök efter Digital-signaturer i filen Odt i C#"
head_description: "Använd .NET för att söka efter Digital-signaturer i Odt-filer med några rader kod."

############################# Header ############################
title: "Sök efter Digital-signaturer i filen Odt"
description: "Inbyggt API för .NET gör det möjligt att söka efter Digital-signaturer i redan signerade Odt-filer. Utför avancerad e-signatursökning i dina Odt-dokument med några rader kod."
...
steps:
    enable: true
    title_left: "Hur man söker efter Digital-signaturer i Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gör det enklare för .NET-utvecklare att söka efter Digital-signaturer i Odt-filer från sina applikationer genom att implementera några enkla steg.
