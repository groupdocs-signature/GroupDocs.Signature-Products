...
############################# Head ############################
head_title: "ابحث عن توقيعات Digital في ملف Pptx في C#"
head_description: "استخدم .NET للبحث عن توقيعات Digital في ملفات Pptx باستخدام بضعة أسطر من التعليمات البرمجية."

############################# Header ############################
title: "ابحث عن توقيعات Digital في ملف Pptx"
description: "تسمح واجهة برمجة التطبيقات الأصلية لـ .NET بالبحث عن توقيعات Digital في ملفات Pptx الموقعة بالفعل. قم بإجراء بحث متقدم عن التوقيع الإلكتروني داخل مستندات Pptx باستخدام بضعة أسطر من التعليمات البرمجية."
...
steps:
    ...
    content_left: |
        يسهّل [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) على مطوري .NET البحث عن توقيعات Digital في ملفات Pptx من تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
