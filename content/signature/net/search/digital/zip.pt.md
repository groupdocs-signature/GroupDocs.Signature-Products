...
############################# Head ############################
head_title: "Procure por assinaturas Digital no arquivo Zip em C#"
head_description: "Use .NET para pesquisar assinaturas Digital em arquivos Zip usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Digital no arquivo Zip"
description: "A API nativa do .NET permite pesquisar assinaturas Digital em arquivos Zip já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Zip usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Digital em Zip"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Digital em arquivos Zip de seus aplicativos implementando algumas etapas fáceis.
