...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Xltx u C#"
head_description: "Upotrijebite .NET za traženje potpisa Digital u datotekama Xltx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Xltx datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Digital u već potpisanim Xltx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xltx dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Digital potpise u Xltx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Digital u datotekama Xltx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
