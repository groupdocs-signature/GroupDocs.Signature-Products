...
############################# Head ############################
head_title: "Rechercher les signatures Digital dans le fichier Pdf dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Digital dans des fichiers Pdf en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Digital dans le fichier Pdf"
description: "L'API native .NET permet de rechercher des signatures Digital dans des fichiers Pdf déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Pdf en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Digital dans Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Digital dans des fichiers Pdf à partir de leurs applications en mettant en œuvre quelques étapes simples.
