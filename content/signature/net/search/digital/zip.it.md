...
############################# Head ############################
head_title: "Cerca le firme Digital nel file Zip in C#"
head_description: "Usa .NET per cercare le firme Digital nei file Zip utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Digital nel file Zip"
description: "L'API nativa .NET consente di cercare firme Digital in file Zip già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Zip utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Digital in Zip"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Digital nei file Zip dalle loro applicazioni implementando alcuni semplici passaggi.
