...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Pptx u C#"
head_description: "Upotrijebite .NET za traženje potpisa Digital u datotekama Pptx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Pptx datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Digital u već potpisanim Pptx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Pptx dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Digital potpise u Pptx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Digital u datotekama Pptx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
