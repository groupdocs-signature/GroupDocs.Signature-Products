...
############################# Head ############################
head_title: "Cari tanda tangan Digital dalam file Xltx di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Digital di file Xltx menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Digital di file Xltx"
description: ".NET API asli memungkinkan untuk mencari Digital tanda tangan di file Xltx yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xltx Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Digital dalam file Xltx dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
