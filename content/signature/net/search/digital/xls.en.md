...
############################# Head ############################
head_title: "Search for Digital signatures in Xls file in C#"
head_description: "Use .NET for searching for Digital signatures in Xls files using a few lines of code."

############################# Header ############################
title: "Search for Digital signatures in Xls file"
description: ".NET native API allows to search for Digital signatures in already signed Xls files. Perform advanced e-signature search within your Xls documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Digital signatures in Xls files from their applications by implementing a few easy steps.
