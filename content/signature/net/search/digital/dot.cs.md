...
############################# Head ############################
head_title: "Vyhledejte podpisy Digital v souboru Dot v C#"
head_description: "Použijte .NET k vyhledávání podpisů Digital v souborech Dot pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Digital v souboru Dot"
description: "Nativní API .NET umožňuje vyhledávat podpisy Digital v již podepsaných souborech Dot. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Dot pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Digital v Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Digital v souborech Dot z jejich aplikací implementací několika snadných kroků.
