...
############################# Head ############################
head_title: "Vyhledejte podpisy Digital v souboru Xltm v C#"
head_description: "Použijte .NET k vyhledávání podpisů Digital v souborech Xltm pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Digital v souboru Xltm"
description: "Nativní API .NET umožňuje vyhledávat podpisy Digital v již podepsaných souborech Xltm. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Xltm pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Digital v souborech Xltm z jejich aplikací implementací několika snadných kroků.
