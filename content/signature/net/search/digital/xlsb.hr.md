...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Xlsb u C#"
head_description: "Upotrijebite .NET za traženje potpisa Digital u datotekama Xlsb pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Xlsb datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Digital u već potpisanim Xlsb datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xlsb dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Digital potpise u Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Digital u datotekama Xlsb iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
