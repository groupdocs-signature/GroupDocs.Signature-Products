...
############################# Head ############################
head_title: "Vyhledejte podpisy Digital v souboru Dotx v C#"
head_description: "Použijte .NET k vyhledávání podpisů Digital v souborech Dotx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Digital v souboru Dotx"
description: "Nativní API .NET umožňuje vyhledávat podpisy Digital v již podepsaných souborech Dotx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Dotx pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Digital v Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Digital v souborech Dotx z jejich aplikací implementací několika snadných kroků.
...
demos:
    ...
    content: |
       Navštivte web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) a vyhledejte v dokumentu různé elektronické podpisy do souborů Dotx právě teď.

        
############################# More Formats ############################
more_formats:
    enable: true
    title: "Vyhledejte další podpisy Digital pomocí C#"
    content: |
