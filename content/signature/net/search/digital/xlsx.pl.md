...
############################# Head ############################
head_title: "Wyszukaj podpisy Digital w pliku Xlsx w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Digital w plikach Xlsx przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Digital w pliku Xlsx"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Digital w już podpisanych plikach Xlsx. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Xlsx, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Digital w Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Digital w plikach Xlsx z ich aplikacji, wykonując kilka prostych kroków.
