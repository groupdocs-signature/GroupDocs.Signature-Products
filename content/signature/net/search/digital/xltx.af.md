...
description: ".NET se inheemse API laat toe om vir Digital handtekeninge te soek in reeds ondertekende Xltx lêers. Voer gevorderde e-handtekeningsoektog binne jou Xltx dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    enable: true
    title_left: "Hoe om te soek vir Digital handtekeninge in Xltx"
    content_left: |
