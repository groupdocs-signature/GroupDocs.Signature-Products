...
############################# Head ############################
head_title: "Meklēt Digital parakstus Dot failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Digital parakstus Dot failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Digital parakstus failā Dot"
description: ".NET vietējais API ļauj meklēt Digital parakstus jau parakstītos Dot failos. Veiciet izvērsto e-paraksta meklēšanu savos Dot dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Digital parakstus Dot failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
