...
############################# Head ############################
head_title: "Ieškokite Digital parašų Doc faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Digital parašų Doc failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Doc faile"
description: ".NET savoji API leidžia ieškoti Digital parašų jau pasirašytuose Doc failuose. Atlikite išplėstinę el. parašo paiešką savo Doc dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Digital parašų Doc failuose iš savo programų, atlikdami kelis paprastus veiksmus.
