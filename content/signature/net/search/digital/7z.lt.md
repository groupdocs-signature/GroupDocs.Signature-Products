...
############################# Head ############################
head_title: "Ieškokite Digital parašų 7z faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Digital parašų 7z failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų 7z faile"
description: ".NET savoji API leidžia ieškoti Digital parašų jau pasirašytuose 7z failuose. Atlikite išplėstinę el. parašo paiešką savo 7z dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Digital parašų 7z failuose iš savo programų, atlikdami kelis paprastus veiksmus.
