...
############################# Head ############################
head_title: "Meklēt Digital parakstus Dotx failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Digital parakstus Dotx failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Digital parakstus failā Dotx"
description: ".NET vietējais API ļauj meklēt Digital parakstus jau parakstītos Dotx failos. Veiciet izvērsto e-paraksta meklēšanu savos Dotx dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Digital parakstus Dotx failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
