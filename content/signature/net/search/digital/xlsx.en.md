...
############################# Head ############################
head_title: "Search for Digital signatures in Xlsx file in C#"
head_description: "Use .NET for searching for Digital signatures in Xlsx files using a few lines of code."

############################# Header ############################
title: "Search for Digital signatures in Xlsx file"
description: ".NET native API allows to search for Digital signatures in already signed Xlsx files. Perform advanced e-signature search within your Xlsx documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Digital signatures in Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Digital signatures in Xlsx files from their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
       Search the document for various electronic signatures to Xlsx files right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.

        
############################# More Formats ############################
more_formats:
    enable: true
    title: "Search for other Digital signatures using C#"
    content: |
