...
############################# Head ############################
head_title: "Wyszukaj podpisy Digital w pliku Dot w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Digital w plikach Dot przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Digital w pliku Dot"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Digital w już podpisanych plikach Dot. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Dot, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Digital w plikach Dot z ich aplikacji, wykonując kilka prostych kroków.
