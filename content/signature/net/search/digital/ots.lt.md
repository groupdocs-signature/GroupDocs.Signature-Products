...
############################# Head ############################
head_title: "Ieškokite Digital parašų Ots faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Digital parašų Ots failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Ots faile"
description: ".NET savoji API leidžia ieškoti Digital parašų jau pasirašytuose Ots failuose. Atlikite išplėstinę el. parašo paiešką savo Ots dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Digital parašų Ots failuose iš savo programų, atlikdami kelis paprastus veiksmus.
