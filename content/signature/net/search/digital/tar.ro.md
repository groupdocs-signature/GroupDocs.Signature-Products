...
############################# Head ############################
head_title: "Căutați semnături Digital în fișierul Tar în C#"
head_description: "Utilizați .NET pentru a căuta semnături Digital în fișiere Tar folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Digital în fișierul Tar"
description: "API-ul nativ .NET permite căutarea semnăturilor Digital în fișierele Tar deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Tar folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Digital în Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Digital în fișierele Tar din aplicațiile lor prin implementarea câțiva pași simpli.
