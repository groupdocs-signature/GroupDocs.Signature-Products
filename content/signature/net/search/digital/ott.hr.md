...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Ott u C#"
head_description: "Upotrijebite .NET za traženje potpisa Digital u datotekama Ott pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Ott datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Digital u već potpisanim Ott datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ott dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Digital potpise u Ott"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Digital u datotekama Ott iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
