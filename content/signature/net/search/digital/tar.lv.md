...
############################# Head ############################
head_title: "Meklēt Digital parakstus Tar failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Digital parakstus Tar failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Digital parakstus failā Tar"
description: ".NET vietējais API ļauj meklēt Digital parakstus jau parakstītos Tar failos. Veiciet izvērsto e-paraksta meklēšanu savos Tar dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Digital parakstus Tar failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
