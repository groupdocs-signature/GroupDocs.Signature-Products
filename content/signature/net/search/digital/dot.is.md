...
############################# Head ############################
head_title: "Leitaðu að Digital undirskriftum í Dot skrá í C#"
head_description: "Notaðu .NET til að leita að Digital undirskriftum í Dot skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Digital undirskriftum í Dot skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Digital undirskriftum í þegar undirrituðum Dot skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Dot skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að leita að Digital undirskriftum í Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Digital undirskriftum í Dot skrám úr forritum sínum með því að útfæra nokkur einföld skref.
