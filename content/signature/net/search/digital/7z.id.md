...
############################# Head ############################
head_title: "Cari tanda tangan Digital dalam file 7z di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Digital di file 7z menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Digital di file 7z"
description: ".NET API asli memungkinkan untuk mencari Digital tanda tangan di file 7z yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen 7z Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Digital dalam file 7z dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
