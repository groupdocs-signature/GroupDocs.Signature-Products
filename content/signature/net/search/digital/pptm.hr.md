...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Pptm u C#"
head_description: "Upotrijebite .NET za traženje potpisa Digital u datotekama Pptm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Pptm datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Digital u već potpisanim Pptm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Pptm dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Digital potpise u Pptm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Digital u datotekama Pptm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
