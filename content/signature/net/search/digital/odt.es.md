...
############################# Head ############################
head_title: "Busque Digital firmas en Odt archivo en C#"
head_description: "Use .NET para buscar firmas Digital en archivos Odt usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Digital en el archivo Odt"
description: ".NET API nativa permite buscar Digital firmas en archivos Odt ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Odt utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Digital en archivos Odt desde sus aplicaciones mediante la implementación de unos sencillos pasos.
