...
############################# Head ############################
head_title: "Wyszukaj podpisy Digital w pliku 7z w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Digital w plikach 7z przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Digital w pliku 7z"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Digital w już podpisanych plikach 7z. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach 7z, używając kilku linijek kodu."
...
steps:
    enable: true
    title_left: "Jak wyszukiwać podpisy Digital w 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Digital w plikach 7z z ich aplikacji, wykonując kilka prostych kroków.
