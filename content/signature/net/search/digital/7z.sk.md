...
############################# Head ############################
head_title: "Vyhľadajte podpisy Digital v súbore 7z v C#"
head_description: "Použite .NET na vyhľadávanie Digital podpisov v súboroch 7z pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Digital v súbore 7z"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Digital v už podpísaných súboroch 7z. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch 7z pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Digital v súboroch 7z z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
