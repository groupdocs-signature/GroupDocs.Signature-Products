...
############################# Head ############################
head_title: "Vyhľadajte podpisy Digital v súbore Dotx v C#"
head_description: "Použite .NET na vyhľadávanie Digital podpisov v súboroch Dotx pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Digital v súbore Dotx"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Digital v už podpísaných súboroch Dotx. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Dotx pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Digital v Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Digital v súboroch Dotx z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
