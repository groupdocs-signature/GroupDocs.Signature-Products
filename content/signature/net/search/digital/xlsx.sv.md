...
############################# Head ############################
head_title: "Sök efter Digital-signaturer i filen Xlsx i C#"
head_description: "Använd .NET för att söka efter Digital-signaturer i Xlsx-filer med några rader kod."

############################# Header ############################
title: "Sök efter Digital-signaturer i filen Xlsx"
description: "Inbyggt API för .NET gör det möjligt att söka efter Digital-signaturer i redan signerade Xlsx-filer. Utför avancerad e-signatursökning i dina Xlsx-dokument med några rader kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gör det enklare för .NET-utvecklare att söka efter Digital-signaturer i Xlsx-filer från sina applikationer genom att implementera några enkla steg.
