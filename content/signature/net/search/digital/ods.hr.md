...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Ods u C#"
head_description: "Upotrijebite .NET za traženje potpisa Digital u datotekama Ods pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Ods datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Digital u već potpisanim Ods datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ods dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Digital u datotekama Ods iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
