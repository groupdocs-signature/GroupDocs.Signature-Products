...
############################# Head ############################
head_title: "Ieškokite Digital parašų Docm faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Digital parašų Docm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Docm faile"
description: ".NET savoji API leidžia ieškoti Digital parašų jau pasirašytuose Docm failuose. Atlikite išplėstinę el. parašo paiešką savo Docm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Digital parašų Docm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Digital parašų Docm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
