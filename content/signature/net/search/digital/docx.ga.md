...
############################# Head ############################
head_title: "Cuardaigh Digital síniú i gcomhad Docx i C#"
head_description: "Úsáid .NET chun sínithe Digital a chuardach i gcomhaid Docx ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Digital i gcomhaid Docx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
