...
############################# Head ############################
head_title: "Procure por assinaturas Digital no arquivo Docm em C#"
head_description: "Use .NET para pesquisar assinaturas Digital em arquivos Docm usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Digital no arquivo Docm"
description: "A API nativa do .NET permite pesquisar assinaturas Digital em arquivos Docm já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Docm usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Digital em arquivos Docm de seus aplicativos implementando algumas etapas fáceis.
