...
############################# Head ############################
head_title: "Cerqueu signatures de Digital al fitxer Pdf a C#"
head_description: "Utilitzeu .NET per cercar signatures Digital als fitxers Pdf mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Digital al fitxer Pdf"
description: "L'API nativa de .NET permet cercar signatures Digital als fitxers Pdf ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Pdf amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Digital als fitxers Pdf des de les seves aplicacions implementant uns quants passos senzills.
