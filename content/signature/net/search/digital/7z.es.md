...
############################# Head ############################
head_title: "Busque Digital firmas en 7z archivo en C#"
head_description: "Use .NET para buscar firmas Digital en archivos 7z usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Digital en el archivo 7z"
description: ".NET API nativa permite buscar Digital firmas en archivos 7z ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos 7z utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Digital en 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Digital en archivos 7z desde sus aplicaciones mediante la implementación de unos sencillos pasos.
