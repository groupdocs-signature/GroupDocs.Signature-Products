...
############################# Head ############################
head_title: "Potražite Digital potpise u datoteci Docx u C#"
head_description: "Upotrijebite .NET za traženje potpisa Digital u datotekama Docx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Digital potpise u Docx datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Digital u već potpisanim Docx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Docx dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Digital u datotekama Docx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
