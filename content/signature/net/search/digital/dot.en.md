...
############################# Head ############################
head_title: "Search for Digital signatures in Dot file in C#"
head_description: "Use .NET for searching for Digital signatures in Dot files using a few lines of code."

############################# Header ############################
title: "Search for Digital signatures in Dot file"
description: ".NET native API allows to search for Digital signatures in already signed Dot files. Perform advanced e-signature search within your Dot documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Digital signatures in Dot files from their applications by implementing a few easy steps.
