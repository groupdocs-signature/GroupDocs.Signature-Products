...
############################# Head ############################
head_title: "Meklēt Digital parakstus Zip failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Digital parakstus Zip failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Digital parakstus failā Zip"
description: ".NET vietējais API ļauj meklēt Digital parakstus jau parakstītos Zip failos. Veiciet izvērsto e-paraksta meklēšanu savos Zip dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Digital parakstus Zip failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
