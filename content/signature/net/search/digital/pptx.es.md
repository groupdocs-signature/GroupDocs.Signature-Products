...
############################# Head ############################
head_title: "Busque Digital firmas en Pptx archivo en C#"
head_description: "Use .NET para buscar firmas Digital en archivos Pptx usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Digital en el archivo Pptx"
description: ".NET API nativa permite buscar Digital firmas en archivos Pptx ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Pptx utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Digital en archivos Pptx desde sus aplicaciones mediante la implementación de unos sencillos pasos.
