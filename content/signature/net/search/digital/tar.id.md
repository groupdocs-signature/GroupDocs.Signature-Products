...
############################# Head ############################
head_title: "Cari tanda tangan Digital dalam file Tar di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Digital di file Tar menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Digital di file Tar"
description: ".NET API asli memungkinkan untuk mencari Digital tanda tangan di file Tar yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Tar Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Digital dalam file Tar dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
