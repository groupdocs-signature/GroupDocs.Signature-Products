...
############################# Head ############################
head_title: "Cari tanda tangan Digital dalam file Dot di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Digital di file Dot menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Digital di file Dot"
description: ".NET API asli memungkinkan untuk mencari Digital tanda tangan di file Dot yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Dot Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Digital dalam file Dot dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
