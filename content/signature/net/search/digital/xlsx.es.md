...
############################# Head ############################
head_title: "Busque Digital firmas en Xlsx archivo en C#"
head_description: "Use .NET para buscar firmas Digital en archivos Xlsx usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Digital en el archivo Xlsx"
description: ".NET API nativa permite buscar Digital firmas en archivos Xlsx ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Xlsx utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Digital en Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Digital en archivos Xlsx desde sus aplicaciones mediante la implementación de unos sencillos pasos.
