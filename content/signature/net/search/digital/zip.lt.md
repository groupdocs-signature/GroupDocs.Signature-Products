...
############################# Head ############################
head_title: "Ieškokite Digital parašų Zip faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Digital parašų Zip failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Zip faile"
description: ".NET savoji API leidžia ieškoti Digital parašų jau pasirašytuose Zip failuose. Atlikite išplėstinę el. parašo paiešką savo Zip dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Digital parašų Zip"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Digital parašų Zip failuose iš savo programų, atlikdami kelis paprastus veiksmus.
