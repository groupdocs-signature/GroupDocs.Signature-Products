...
############################# Head ############################
head_title: "Search for Digital signatures in Odt file in C#"
head_description: "Use .NET for searching for Digital signatures in Odt files using a few lines of code."

############################# Header ############################
title: "Search for Digital signatures in Odt file"
description: ".NET native API allows to search for Digital signatures in already signed Odt files. Perform advanced e-signature search within your Odt documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Digital signatures in Odt files from their applications by implementing a few easy steps.
