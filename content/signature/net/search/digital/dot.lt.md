...
############################# Head ############################
head_title: "Ieškokite Digital parašų Dot faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Digital parašų Dot failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Digital parašų Dot faile"
description: ".NET savoji API leidžia ieškoti Digital parašų jau pasirašytuose Dot failuose. Atlikite išplėstinę el. parašo paiešką savo Dot dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Digital parašų Dot failuose iš savo programų, atlikdami kelis paprastus veiksmus.
