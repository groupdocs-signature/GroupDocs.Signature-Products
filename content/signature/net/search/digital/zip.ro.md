...
############################# Head ############################
head_title: "Căutați semnături Digital în fișierul Zip în C#"
head_description: "Utilizați .NET pentru a căuta semnături Digital în fișiere Zip folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Digital în fișierul Zip"
description: "API-ul nativ .NET permite căutarea semnăturilor Digital în fișierele Zip deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Zip folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Digital în fișierele Zip din aplicațiile lor prin implementarea câțiva pași simpli.
