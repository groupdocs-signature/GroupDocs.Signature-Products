...
############################# Head ############################
head_title: "Vyhledejte podpisy Digital v souboru 7z v C#"
head_description: "Použijte .NET k vyhledávání podpisů Digital v souborech 7z pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Digital v souboru 7z"
description: "Nativní API .NET umožňuje vyhledávat podpisy Digital v již podepsaných souborech 7z. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech 7z pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Digital v souborech 7z z jejich aplikací implementací několika snadných kroků.
