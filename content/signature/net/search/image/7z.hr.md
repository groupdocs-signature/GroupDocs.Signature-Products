...
############################# Head ############################
head_title: "Potražite Image potpise u datoteci 7z u C#"
head_description: "Upotrijebite .NET za traženje potpisa Image u datotekama 7z pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Image potpise u 7z datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Image u već potpisanim 7z datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih 7z dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Image potpise u 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Image u datotekama 7z iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
