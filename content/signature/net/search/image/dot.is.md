...
############################# Head ############################
head_title: "Leitaðu að Image undirskriftum í Dot skrá í C#"
head_description: "Notaðu .NET til að leita að Image undirskriftum í Dot skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Image undirskriftum í Dot skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Image undirskriftum í þegar undirrituðum Dot skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Dot skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að leita að Image undirskriftum í Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Image undirskriftum í Dot skrám úr forritum sínum með því að útfæra nokkur einföld skref.
...
demos:
    ...
    content: |
       Leitaðu í skjalinu að ýmsum rafrænum undirskriftum í Dot skrár núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna.
