...
############################# Head ############################
head_title: "C# içinde Ods dosyasında Image imzasını arayın"
head_description: "Birkaç satır kod kullanarak Ods dosyalarında Image imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Ods dosyasında Image imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Ods dosyalarında Image imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Ods belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Ods dosyalarında Image imzalarını aramasını kolaylaştırır.
