...
############################# Head ############################
head_title: "Busque Image firmas en Pptm archivo en C#"
head_description: "Use .NET para buscar firmas Image en archivos Pptm usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Image en el archivo Pptm"
description: ".NET API nativa permite buscar Image firmas en archivos Pptm ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Pptm utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Image en archivos Pptm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
