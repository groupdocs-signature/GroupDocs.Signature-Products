...
############################# Head ############################
head_title: "Sök efter Image-signaturer i filen Odt i C#"
head_description: "Använd .NET för att söka efter Image-signaturer i Odt-filer med några rader kod."

############################# Header ############################
title: "Sök efter Image-signaturer i filen Odt"
description: "Inbyggt API för .NET gör det möjligt att söka efter Image-signaturer i redan signerade Odt-filer. Utför avancerad e-signatursökning i dina Odt-dokument med några rader kod."
...
steps:
    enable: true
    title_left: "Hur man söker efter Image-signaturer i Odt"
    content_left: |
