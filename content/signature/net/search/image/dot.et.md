...
############################# Head ############################
head_title: "Otsige allkirju Image failist Dot rakenduses C#"
head_description: "Kasutage .NET allkirjade Image otsimiseks failides Dot, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Image allkirju Dot"
description: "Native API .NET võimaldab otsida allkirju Image juba allkirjastatud Dot failides. Tehke oma Dot dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Image otsimist oma rakendustest failides Dot, rakendades mõnda lihtsat sammu.
