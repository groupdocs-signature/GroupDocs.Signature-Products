...
############################# Head ############################
head_title: "Căutați semnături Image în fișierul Doc în C#"
head_description: "Utilizați .NET pentru a căuta semnături Image în fișiere Doc folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Image în fișierul Doc"
description: "API-ul nativ .NET permite căutarea semnăturilor Image în fișierele Doc deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Doc folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Image în fișierele Doc din aplicațiile lor prin implementarea câțiva pași simpli.
