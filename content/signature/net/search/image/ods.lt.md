...
############################# Head ############################
head_title: "Ieškokite Image parašų Ods faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Image parašų Ods failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Ods faile"
description: ".NET savoji API leidžia ieškoti Image parašų jau pasirašytuose Ods failuose. Atlikite išplėstinę el. parašo paiešką savo Ods dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Image parašų Ods failuose iš savo programų, atlikdami kelis paprastus veiksmus.
