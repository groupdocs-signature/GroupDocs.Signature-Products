...
############################# Head ############################
head_title: "Potražite Image potpise u datoteci Rtf u C#"
head_description: "Upotrijebite .NET za traženje potpisa Image u datotekama Rtf pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Image potpise u Rtf datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Image u već potpisanim Rtf datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Rtf dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Image u datotekama Rtf iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
