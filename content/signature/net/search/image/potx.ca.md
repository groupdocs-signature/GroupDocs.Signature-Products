...
############################# Head ############################
head_title: "Cerqueu signatures de Image al fitxer Potx a C#"
head_description: "Utilitzeu .NET per cercar signatures Image als fitxers Potx mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Image al fitxer Potx"
description: "L'API nativa de .NET permet cercar signatures Image als fitxers Potx ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Potx amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Image a Potx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Image als fitxers Potx des de les seves aplicacions implementant uns quants passos senzills.
