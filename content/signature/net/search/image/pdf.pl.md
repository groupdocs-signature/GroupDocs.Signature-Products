...
############################# Head ############################
head_title: "Wyszukaj podpisy Image w pliku Pdf w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Image w plikach Pdf przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Image w pliku Pdf"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Image w już podpisanych plikach Pdf. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Pdf, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Image w plikach Pdf z ich aplikacji, wykonując kilka prostych kroków.
