...
############################# Head ############################
head_title: "Busque Image firmas en Docm archivo en C#"
head_description: "Use .NET para buscar firmas Image en archivos Docm usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Image en el archivo Docm"
description: ".NET API nativa permite buscar Image firmas en archivos Docm ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Docm utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Image en archivos Docm desde sus aplicaciones mediante la implementación de unos sencillos pasos.
