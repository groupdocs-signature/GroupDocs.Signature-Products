...
############################# Head ############################
head_title: "Vyhledejte podpisy Image v souboru Pps v C#"
head_description: "Použijte .NET k vyhledávání podpisů Image v souborech Pps pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Image v souboru Pps"
description: "Nativní API .NET umožňuje vyhledávat podpisy Image v již podepsaných souborech Pps. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Pps pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Image v Pps"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Image v souborech Pps z jejich aplikací implementací několika snadných kroků.
