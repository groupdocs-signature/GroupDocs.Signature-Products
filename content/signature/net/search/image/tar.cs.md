...
############################# Head ############################
head_title: "Vyhledejte podpisy Image v souboru Tar v C#"
head_description: "Použijte .NET k vyhledávání podpisů Image v souborech Tar pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Image v souboru Tar"
description: "Nativní API .NET umožňuje vyhledávat podpisy Image v již podepsaných souborech Tar. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Tar pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Image v Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Image v souborech Tar z jejich aplikací implementací několika snadných kroků.
