...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Otp i C#"
head_description: "Úsáid .NET chun sínithe Image a chuardach i gcomhaid Otp ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Image sínithe i gcomhad Otp"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar Image sínithe i gcomhaid Otp atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Otp ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Image i gcomhaid Otp óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
