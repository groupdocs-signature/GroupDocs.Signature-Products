...
############################# Head ############################
head_title: "Ieškokite Image parašų Dot faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Image parašų Dot failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Image parašų Dot faile"
description: ".NET savoji API leidžia ieškoti Image parašų jau pasirašytuose Dot failuose. Atlikite išplėstinę el. parašo paiešką savo Dot dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Image parašų Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Image parašų Dot failuose iš savo programų, atlikdami kelis paprastus veiksmus.
