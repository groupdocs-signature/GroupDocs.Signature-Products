...
############################# Head ############################
head_title: "Li Image îmzeyan di pela Zip de di C# de bigerin"
head_description: ".NET ji bo lêgerîna îmzeyên Image di pelên Zip de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Zip de li îmzeyên Image bigerin"
description: "API-ya xwecihî ya .NET destûrê dide ku meriv di pelên Zip yên jixwe îmzekirî de li îmzeyên Image bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Zip de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji pêşdebirên .NET re hêsantir dike ku bi pêkanîna çend gavên hêsan li Image di pelên Zip îmzeyan de ji sepanên xwe bigerin.
