...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Dot i C#"
head_description: "Úsáid .NET chun sínithe Image a chuardach i gcomhaid Dot ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Image sínithe i gcomhad Dot"
...
steps:
    enable: true
    title_left: "Conas síniú Image a chuardach i Dot"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Image i gcomhaid Dot óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
