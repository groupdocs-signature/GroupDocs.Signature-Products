...
############################# Head ############################
head_title: "Vyhledejte podpisy Image v souboru Ppt v C#"
head_description: "Použijte .NET k vyhledávání podpisů Image v souborech Ppt pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Image v souboru Ppt"
description: "Nativní API .NET umožňuje vyhledávat podpisy Image v již podepsaných souborech Ppt. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Ppt pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Image v Ppt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Image v souborech Ppt z jejich aplikací implementací několika snadných kroků.
