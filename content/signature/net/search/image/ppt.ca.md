...
############################# Head ############################
head_title: "Cerqueu signatures de Image al fitxer Ppt a C#"
head_description: "Utilitzeu .NET per cercar signatures Image als fitxers Ppt mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Image al fitxer Ppt"
description: "L'API nativa de .NET permet cercar signatures Image als fitxers Ppt ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Ppt amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Image a Ppt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Image als fitxers Ppt des de les seves aplicacions implementant uns quants passos senzills.
