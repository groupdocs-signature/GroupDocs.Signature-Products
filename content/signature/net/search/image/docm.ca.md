...
############################# Head ############################
head_title: "Cerqueu signatures de Image al fitxer Docm a C#"
head_description: "Utilitzeu .NET per cercar signatures Image als fitxers Docm mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Image al fitxer Docm"
description: "L'API nativa de .NET permet cercar signatures Image als fitxers Docm ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Docm amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Image als fitxers Docm des de les seves aplicacions implementant uns quants passos senzills.
