...
description: "Inbyggt API för .NET gör det möjligt att söka efter Image-signaturer i redan signerade Odp-filer. Utför avancerad e-signatursökning i dina {{Filformat}}-dokument med några rader kod."
