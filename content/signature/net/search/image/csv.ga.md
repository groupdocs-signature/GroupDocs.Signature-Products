...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Csv i C#"
head_description: "Úsáid .NET chun sínithe Image a chuardach i gcomhaid Csv ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Image sínithe i gcomhad Csv"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar Image sínithe i gcomhaid Csv atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Csv ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Image i gcomhaid Csv óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
