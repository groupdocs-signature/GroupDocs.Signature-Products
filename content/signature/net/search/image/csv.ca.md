...
############################# Head ############################
head_title: "Cerqueu signatures de Image al fitxer Csv a C#"
head_description: "Utilitzeu .NET per cercar signatures Image als fitxers Csv mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Image al fitxer Csv"
description: "L'API nativa de .NET permet cercar signatures Image als fitxers Csv ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Csv amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Image als fitxers Csv des de les seves aplicacions implementant uns quants passos senzills.
