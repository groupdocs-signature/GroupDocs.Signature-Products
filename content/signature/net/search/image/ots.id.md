...
############################# Head ############################
head_title: "Cari tanda tangan Image dalam file Ots di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Image di file Ots menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Image di file Ots"
description: ".NET API asli memungkinkan untuk mencari Image tanda tangan di file Ots yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ots Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Image di Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Image dalam file Ots dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
