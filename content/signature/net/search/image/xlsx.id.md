...
############################# Head ############################
head_title: "Cari tanda tangan Image dalam file Xlsx di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Image di file Xlsx menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Image di file Xlsx"
description: ".NET API asli memungkinkan untuk mencari Image tanda tangan di file Xlsx yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xlsx Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Image dalam file Xlsx dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
