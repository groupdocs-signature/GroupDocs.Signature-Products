...
############################# Head ############################
head_title: "Vyhledejte podpisy Image v souboru Docm v C#"
head_description: "Použijte .NET k vyhledávání podpisů Image v souborech Docm pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Image v souboru Docm"
description: "Nativní API .NET umožňuje vyhledávat podpisy Image v již podepsaných souborech Docm. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Docm pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Image v Docm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Image v souborech Docm z jejich aplikací implementací několika snadných kroků.
