...
############################# Head ############################
head_title: "Cari tanda tangan Image dalam file Xls di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Image di file Xls menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Image di file Xls"
description: ".NET API asli memungkinkan untuk mencari Image tanda tangan di file Xls yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xls Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Image dalam file Xls dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
