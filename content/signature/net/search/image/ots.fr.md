...
############################# Head ############################
head_title: "Rechercher les signatures Image dans le fichier Ots dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Image dans des fichiers Ots en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Image dans le fichier Ots"
description: "L'API native .NET permet de rechercher des signatures Image dans des fichiers Ots déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Ots en utilisant quelques lignes de code."
...
steps:
    enable: true
    title_left: "Comment rechercher des signatures Image dans Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Image dans des fichiers Ots à partir de leurs applications en mettant en œuvre quelques étapes simples.
