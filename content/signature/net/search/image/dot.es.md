...
############################# Head ############################
head_title: "Busque Image firmas en Dot archivo en C#"
head_description: "Use .NET para buscar firmas Image en archivos Dot usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Image en el archivo Dot"
description: ".NET API nativa permite buscar Image firmas en archivos Dot ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Dot utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Image en archivos Dot desde sus aplicaciones mediante la implementación de unos sencillos pasos.
