...
############################# Head ############################
head_title: "Otsige allkirju Image failist Tar rakenduses C#"
head_description: "Kasutage .NET allkirjade Image otsimiseks failides Tar, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Image allkirju Tar"
description: "Native API .NET võimaldab otsida allkirju Image juba allkirjastatud Tar failides. Tehke oma Tar dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Image otsimist oma rakendustest failides Tar, rakendades mõnda lihtsat sammu.
