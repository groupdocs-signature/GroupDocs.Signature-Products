...
############################# Head ############################
head_title: "Vyhľadajte podpisy Image v súbore Potm v C#"
head_description: "Použite .NET na vyhľadávanie Image podpisov v súboroch Potm pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Image v súbore Potm"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Image v už podpísaných súboroch Potm. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Potm pomocou niekoľkých riadkov kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Image v súboroch Potm z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
