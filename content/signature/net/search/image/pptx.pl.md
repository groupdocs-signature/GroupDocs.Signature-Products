...
############################# Head ############################
head_title: "Wyszukaj podpisy Image w pliku Pptx w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Image w plikach Pptx przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Image w pliku Pptx"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Image w już podpisanych plikach Pptx. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Pptx, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Image w plikach Pptx z ich aplikacji, wykonując kilka prostych kroków.
