...
############################# Head ############################
head_title: "Sök efter Image-signaturer i filen 7z i C#"
head_description: "Använd .NET för att söka efter Image-signaturer i 7z-filer med några rader kod."

############################# Header ############################
title: "Sök efter Image-signaturer i filen 7z"
description: "Inbyggt API för .NET gör det möjligt att söka efter Image-signaturer i redan signerade 7z-filer. Utför avancerad e-signatursökning i dina 7z-dokument med några rader kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gör det enklare för .NET-utvecklare att söka efter Image-signaturer i 7z-filer från sina applikationer genom att implementera några enkla steg.
