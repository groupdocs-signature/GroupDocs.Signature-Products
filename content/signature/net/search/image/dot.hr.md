...
############################# Head ############################
head_title: "Potražite Image potpise u datoteci Dot u C#"
head_description: "Upotrijebite .NET za traženje potpisa Image u datotekama Dot pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Image potpise u Dot datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Image u već potpisanim Dot datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Dot dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Image potpise u Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Image u datotekama Dot iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
