...
############################# Head ############################
head_title: "Busque Image firmas en Xltx archivo en C#"
head_description: "Use .NET para buscar firmas Image en archivos Xltx usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Image en el archivo Xltx"
description: ".NET API nativa permite buscar Image firmas en archivos Xltx ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Xltx utilizando unas pocas líneas de código."
...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Image en Xltx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Image en archivos Xltx desde sus aplicaciones mediante la implementación de unos sencillos pasos.
