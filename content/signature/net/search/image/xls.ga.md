...
############################# Head ############################
head_title: "Cuardaigh Image síniú i gcomhad Xls i C#"
head_description: "Úsáid .NET chun sínithe Image a chuardach i gcomhaid Xls ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Image i gcomhaid Xls óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
