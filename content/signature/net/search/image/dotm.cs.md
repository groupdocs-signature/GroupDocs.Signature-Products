...
############################# Head ############################
head_title: "Vyhledejte podpisy Image v souboru Dotm v C#"
head_description: "Použijte .NET k vyhledávání podpisů Image v souborech Dotm pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Image v souboru Dotm"
description: "Nativní API .NET umožňuje vyhledávat podpisy Image v již podepsaných souborech Dotm. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Dotm pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Image v souborech Dotm z jejich aplikací implementací několika snadných kroků.
