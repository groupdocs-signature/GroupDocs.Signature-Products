...
############################# Head ############################
head_title: "Cari tandatangan Image dalam fail 7z dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Image dalam fail 7z menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Image dalam fail 7z."
description: "API asli .NET membenarkan untuk mencari tandatangan Image dalam fail 7z yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen 7z anda menggunakan beberapa baris kod."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mencari tandatangan Image dalam 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Image dalam fail 7z daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
