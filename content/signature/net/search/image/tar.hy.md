...
############################# Head ############################
head_title: "Որոնեք Image ստորագրությունները Tar ֆայլում C#-ում"
head_description: "Օգտագործեք .NET՝ Image ստորագրությունները Tar ֆայլերում մի քանի տող կոդով որոնելու համար:"

############################# Header ############################
title: "Փնտրեք Image ստորագրությունները Tar ֆայլում"
description: ".NET բնօրինակ API-ն թույլ է տալիս որոնել Image ստորագրություններ արդեն ստորագրված Tar ֆայլերում: Կատարեք էլեկտրոնային ստորագրության առաջադեմ որոնում ձեր Tar փաստաթղթերում՝ օգտագործելով մի քանի տող կոդ:"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) հեշտացնում է .NET ծրագրավորողների համար որոնել Image ստորագրությունները Tar ֆայլերում իրենց հավելվածներից` իրականացնելով մի քանի հեշտ քայլեր:
