...
############################# Head ############################
head_title: "Rechercher les signatures Image dans le fichier Doc dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Image dans des fichiers Doc en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Image dans le fichier Doc"
description: "L'API native .NET permet de rechercher des signatures Image dans des fichiers Doc déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Doc en utilisant quelques lignes de code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Image dans des fichiers Doc à partir de leurs applications en mettant en œuvre quelques étapes simples.
