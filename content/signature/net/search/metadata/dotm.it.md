...
############################# Head ############################
head_title: "Cerca le firme Metadata nel file Dotm in C#"
head_description: "Usa .NET per cercare le firme Metadata nei file Dotm utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Metadata nel file Dotm"
description: "L'API nativa .NET consente di cercare firme Metadata in file Dotm già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Dotm utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Metadata nei file Dotm dalle loro applicazioni implementando alcuni semplici passaggi.
