...
############################# Head ############################
head_title: "Cari tanda tangan Metadata dalam file Xlsm di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Metadata di file Xlsm menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Metadata di file Xlsm"
description: ".NET API asli memungkinkan untuk mencari Metadata tanda tangan di file Xlsm yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Xlsm Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Metadata dalam file Xlsm dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
