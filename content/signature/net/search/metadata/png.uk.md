...
############################# Head ############################
head_title: "Шукайте підписи Metadata у файлі Png у C#"
head_description: "Використовуйте .NET для пошуку підписів Metadata у файлах Png за допомогою кількох рядків коду."

############################# Header ############################
title: "Шукайте підписи Metadata у файлі Png"
description: "Власний API .NET дозволяє шукати підписи Metadata у вже підписаних файлах Png. Виконайте розширений пошук електронного підпису в документах Png за допомогою кількох рядків коду."
...
steps:
    enable: true
    title_left: "Як шукати підписи Metadata у Png"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) полегшує розробникам .NET пошук підписів Metadata у файлах Png у їхніх програмах, виконавши кілька простих кроків.
