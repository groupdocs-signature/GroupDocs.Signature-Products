...
############################# Head ############################
head_title: "C# içinde Svg dosyasında Metadata imzasını arayın"
head_description: "Birkaç satır kod kullanarak Svg dosyalarında Metadata imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Svg dosyasında Metadata imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Svg dosyalarında Metadata imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Svg belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Svg dosyalarında Metadata imzalarını aramasını kolaylaştırır.
