...
############################# Head ############################
head_title: "Søg efter Metadata signaturer i filen Docm i C#"
head_description: "Brug .NET til at søge efter Metadata-signaturer i Docm-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Metadata-signaturer i filen Docm"
description: ".NET native API gør det muligt at søge efter Metadata-signaturer i allerede signerede Docm-filer. Udfør avanceret e-signatursøgning i dine Docm dokumenter ved hjælp af et par linjer kode."
...
steps:
    enable: true
    title_left: "Sådan søger du efter Metadata-signaturer i Docm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gør det nemmere for .NET-udviklere at søge efter Metadata-signaturer i Docm-filer fra deres applikationer ved at implementere nogle få nemme trin.
