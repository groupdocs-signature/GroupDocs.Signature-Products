...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Doc rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Doc, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Doc"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Doc failides. Tehke oma Doc dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Doc"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Doc, rakendades mõnda lihtsat sammu.
...
demos:
    ...
    content: |
       Otsige kohe dokumendist erinevaid elektroonilisi allkirju Doc-failidele, külastades veebisaiti [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
