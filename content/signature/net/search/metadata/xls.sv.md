...
description: "Inbyggt API för .NET gör det möjligt att söka efter Metadata-signaturer i redan signerade Xls-filer. Utför avancerad e-signatursökning i dina {{Filformat}}-dokument med några rader kod."
