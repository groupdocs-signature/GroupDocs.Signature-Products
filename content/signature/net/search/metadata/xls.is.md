...
############################# Head ############################
head_title: "Leitaðu að Metadata undirskriftum í Xls skrá í C#"
head_description: "Notaðu .NET til að leita að Metadata undirskriftum í Xls skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Metadata undirskriftum í Xls skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Metadata undirskriftum í þegar undirrituðum Xls skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Xls skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að leita að Metadata undirskriftum í Xls"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Metadata undirskriftum í Xls skrám úr forritum sínum með því að útfæra nokkur einföld skref.
...
demos:
    ...
    content: |
       Leitaðu í skjalinu að ýmsum rafrænum undirskriftum í Xls skrár núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna.
