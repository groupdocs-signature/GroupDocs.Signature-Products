...
############################# Head ############################
head_title: "Որոնեք Metadata ստորագրությունները Dotm ֆայլում C#-ում"
head_description: "Օգտագործեք .NET՝ Metadata ստորագրությունները Dotm ֆայլերում մի քանի տող կոդով որոնելու համար:"

############################# Header ############################
title: "Փնտրեք Metadata ստորագրությունները Dotm ֆայլում"
description: ".NET բնօրինակ API-ն թույլ է տալիս որոնել Metadata ստորագրություններ արդեն ստորագրված Dotm ֆայլերում: Կատարեք էլեկտրոնային ստորագրության առաջադեմ որոնում ձեր Dotm փաստաթղթերում՝ օգտագործելով մի քանի տող կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես որոնել Metadata ստորագրությունները Dotm-ում"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) հեշտացնում է .NET ծրագրավորողների համար որոնել Metadata ստորագրությունները Dotm ֆայլերում իրենց հավելվածներից` իրականացնելով մի քանի հեշտ քայլեր:
