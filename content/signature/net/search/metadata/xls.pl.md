...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Xls w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Metadata w plikach Xls przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Xls"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Xls. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Xls, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Metadata w plikach Xls z ich aplikacji, wykonując kilka prostych kroków.
