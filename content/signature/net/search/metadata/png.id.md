...
############################# Head ############################
head_title: "Cari tanda tangan Metadata dalam file Png di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Metadata di file Png menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Metadata di file Png"
description: ".NET API asli memungkinkan untuk mencari Metadata tanda tangan di file Png yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Png Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Metadata di Png"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Metadata dalam file Png dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
