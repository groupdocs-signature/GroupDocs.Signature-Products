...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Docm faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Docm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Docm faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Docm failuose. Atlikite išplėstinę el. parašo paiešką savo Docm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Metadata parašų Docm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Docm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
