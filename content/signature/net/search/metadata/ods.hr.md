...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Ods u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Ods pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Ods datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Ods datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ods dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Ods iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
