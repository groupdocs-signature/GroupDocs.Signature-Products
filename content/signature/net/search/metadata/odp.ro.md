...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Odp în C#"
head_description: "Utilizați .NET pentru a căuta semnături Metadata în fișiere Odp folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Odp"
description: "API-ul nativ .NET permite căutarea semnăturilor Metadata în fișierele Odp deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Odp folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Metadata în Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Metadata în fișierele Odp din aplicațiile lor prin implementarea câțiva pași simpli.
