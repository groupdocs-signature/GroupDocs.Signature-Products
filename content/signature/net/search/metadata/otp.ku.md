...
############################# Head ############################
head_title: "Li Metadata îmzeyan di pela Otp de di C# de bigerin"
head_description: ".NET ji bo lêgerîna îmzeyên Metadata di pelên Otp de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Otp de li îmzeyên Metadata bigerin"
description: "API-ya xwecihî ya .NET destûrê dide ku meriv di pelên Otp yên jixwe îmzekirî de li îmzeyên Metadata bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Otp de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji pêşdebirên .NET re hêsantir dike ku bi pêkanîna çend gavên hêsan li Metadata di pelên Otp îmzeyan de ji sepanên xwe bigerin.
