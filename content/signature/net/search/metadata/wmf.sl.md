...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Wmf v C#"
head_description: "Uporabite .NET za iskanje podpisov Metadata v datotekah Wmf z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Wmf"
description: "Izvorni API za .NET omogoča iskanje podpisov Metadata v že podpisanih datotekah Wmf. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Wmf z uporabo nekaj vrstic kode."
...
steps:
    enable: true
    title_left: "Kako poiskati podpise Metadata v Wmf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) razvijalcem za .NET olajša iskanje podpisov Metadata v datotekah Wmf iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
...
demos:
    ...
    content: |
       Takoj zdaj poiščite v dokumentu različne elektronske podpise za datoteke Wmf tako, da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
