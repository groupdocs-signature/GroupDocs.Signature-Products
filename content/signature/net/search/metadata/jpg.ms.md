...
############################# Head ############################
head_title: "Cari tandatangan Metadata dalam fail Jpg dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Metadata dalam fail Jpg menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Metadata dalam fail Jpg."
description: "API asli .NET membenarkan untuk mencari tandatangan Metadata dalam fail Jpg yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Jpg anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Metadata dalam fail Jpg daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
