...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Doc i C#"
head_description: "Úsáid .NET chun sínithe Metadata a chuardach i gcomhaid Doc ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Doc"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar Metadata sínithe i gcomhaid Doc atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Doc ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Metadata i gcomhaid Doc óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
