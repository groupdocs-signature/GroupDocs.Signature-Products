...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Xltm u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Xltm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Xltm datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Xltm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xltm dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Xltm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
