...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Doc u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Doc pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Doc datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Doc datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Doc dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Doc iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
