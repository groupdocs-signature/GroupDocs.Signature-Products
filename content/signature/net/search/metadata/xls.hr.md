...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Xls u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Xls pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Xls datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Xls datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Xls dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Xls iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
