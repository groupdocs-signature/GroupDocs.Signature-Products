...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Dotm faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Dotm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Dotm faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Dotm failuose. Atlikite išplėstinę el. parašo paiešką savo Dotm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Dotm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
