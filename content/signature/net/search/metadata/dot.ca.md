...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Dot a C#"
head_description: "Utilitzeu .NET per cercar signatures Metadata als fitxers Dot mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Dot"
description: "L'API nativa de .NET permet cercar signatures Metadata als fitxers Dot ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Dot amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Metadata als fitxers Dot des de les seves aplicacions implementant uns quants passos senzills.
