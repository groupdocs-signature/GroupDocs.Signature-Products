...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Ppsx faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Ppsx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Ppsx faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Ppsx failuose. Atlikite išplėstinę el. parašo paiešką savo Ppsx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Ppsx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
