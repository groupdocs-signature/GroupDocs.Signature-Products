...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Potx u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Potx pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Potx datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Potx datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Potx dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Potx iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
