...
############################# Head ############################
head_title: "Busque Metadata firmas en Ots archivo en C#"
head_description: "Use .NET para buscar firmas Metadata en archivos Ots usando unas pocas líneas de código."

############################# Header ############################
title: "Buscar firmas Metadata en el archivo Ots"
description: ".NET API nativa permite buscar Metadata firmas en archivos Ots ya firmados. Realice una búsqueda avanzada de firmas electrónicas dentro de sus documentos Ots utilizando unas pocas líneas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita a los desarrolladores de .NET la búsqueda de firmas Metadata en archivos Ots desde sus aplicaciones mediante la implementación de unos sencillos pasos.
