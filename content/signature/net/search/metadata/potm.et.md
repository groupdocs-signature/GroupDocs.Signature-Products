...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Potm rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Potm, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Potm"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Potm failides. Tehke oma Potm dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Potm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Potm, rakendades mõnda lihtsat sammu.
