...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Ots a C#"
head_description: "Utilitzeu .NET per cercar signatures Metadata als fitxers Ots mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Ots"
description: "L'API nativa de .NET permet cercar signatures Metadata als fitxers Ots ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Ots amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Metadata a Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Metadata als fitxers Ots des de les seves aplicacions implementant uns quants passos senzills.
...
demos:
    ...
    content: |
       Cerqueu al document diverses signatures electròniques als fitxers Ots ara mateix visitant el lloc web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
