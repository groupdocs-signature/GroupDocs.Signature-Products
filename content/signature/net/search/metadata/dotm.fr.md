...
############################# Head ############################
head_title: "Rechercher les signatures Metadata dans le fichier Dotm dans C#"
head_description: "Utilisez .NET pour rechercher des signatures Metadata dans des fichiers Dotm en utilisant quelques lignes de code."

############################# Header ############################
title: "Rechercher les signatures Metadata dans le fichier Dotm"
description: "L'API native .NET permet de rechercher des signatures Metadata dans des fichiers Dotm déjà signés. Effectuez une recherche avancée de signature électronique dans vos documents Dotm en utilisant quelques lignes de code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet aux développeurs de .NET de rechercher plus facilement des signatures Metadata dans des fichiers Dotm à partir de leurs applications en mettant en œuvre quelques étapes simples.
