...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Png i C#"
head_description: "Úsáid .NET chun sínithe Metadata a chuardach i gcomhaid Png ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Png"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Png ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Metadata a chuardach i Png"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Metadata i gcomhaid Png óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
