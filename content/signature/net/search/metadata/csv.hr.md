...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Csv u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Csv pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Csv datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Csv datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Csv dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Csv iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
