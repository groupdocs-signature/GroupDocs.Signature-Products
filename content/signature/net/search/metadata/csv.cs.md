...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Csv v C#"
head_description: "Použijte .NET k vyhledávání podpisů Metadata v souborech Csv pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Csv"
description: "Nativní API .NET umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Csv. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Csv pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Metadata v souborech Csv z jejich aplikací implementací několika snadných kroků.
