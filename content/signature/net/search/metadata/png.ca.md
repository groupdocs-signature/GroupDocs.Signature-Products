...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Png a C#"
head_description: "Utilitzeu .NET per cercar signatures Metadata als fitxers Png mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Png"
description: "L'API nativa de .NET permet cercar signatures Metadata als fitxers Png ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Png amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Metadata a Png"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Metadata als fitxers Png des de les seves aplicacions implementant uns quants passos senzills.
