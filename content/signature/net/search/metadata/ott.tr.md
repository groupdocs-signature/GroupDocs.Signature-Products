...
############################# Head ############################
head_title: "C# içinde Ott dosyasında Metadata imzasını arayın"
head_description: "Birkaç satır kod kullanarak Ott dosyalarında Metadata imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Ott dosyasında Metadata imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Ott dosyalarında Metadata imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Ott belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Ott dosyalarında Metadata imzalarını aramasını kolaylaştırır.
