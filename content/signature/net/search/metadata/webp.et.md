...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Webp rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Webp, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Webp"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Webp failides. Tehke oma Webp dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Webp, rakendades mõnda lihtsat sammu.
