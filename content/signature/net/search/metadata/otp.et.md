...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Otp rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Otp, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Otp"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Otp failides. Tehke oma Otp dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Otp, rakendades mõnda lihtsat sammu.
