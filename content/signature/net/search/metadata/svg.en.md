...
############################# Head ############################
head_title: "Search Metadata signatures in Svg file in C#"
head_description: "Use .NET for searching Metadata signatures in Svg files using a few lines of code."

############################# Header ############################
title: "Search Metadata signatures in Svg file"
description: ".NET native API to search Metadata signatures in already signed Svg file. Perform advanced e-signature operations within your Svg documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search Metadata signatures in Svg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easy for .NET developers to search Metadata signatures in Svg files from within their applications by implementing a few easy steps.
