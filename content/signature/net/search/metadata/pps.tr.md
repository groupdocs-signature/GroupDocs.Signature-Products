...
############################# Head ############################
head_title: "C# içinde Pps dosyasında Metadata imzasını arayın"
head_description: "Birkaç satır kod kullanarak Pps dosyalarında Metadata imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Pps dosyasında Metadata imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Pps dosyalarında Metadata imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Pps belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Pps içinde Metadata imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Pps dosyalarında Metadata imzalarını aramasını kolaylaştırır.
