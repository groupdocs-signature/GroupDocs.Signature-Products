...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Potx rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Potx, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Potx"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Potx failides. Tehke oma Potx dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Potx, rakendades mõnda lihtsat sammu.
