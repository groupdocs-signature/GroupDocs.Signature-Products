...
############################# Head ############################
head_title: "C# içinde Doc dosyasında Metadata imzasını arayın"
head_description: "Birkaç satır kod kullanarak Doc dosyalarında Metadata imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Doc dosyasında Metadata imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Doc dosyalarında Metadata imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Doc belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Doc içinde Metadata imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Doc dosyalarında Metadata imzalarını aramasını kolaylaştırır.
