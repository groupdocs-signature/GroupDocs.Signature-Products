...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Dotx faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Dotx failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Dotx faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Dotx failuose. Atlikite išplėstinę el. parašo paiešką savo Dotx dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Dotx failuose iš savo programų, atlikdami kelis paprastus veiksmus.
