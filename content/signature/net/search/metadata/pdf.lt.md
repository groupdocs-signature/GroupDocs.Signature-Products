...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Pdf faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Pdf failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Pdf faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Pdf failuose. Atlikite išplėstinę el. parašo paiešką savo Pdf dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Pdf failuose iš savo programų, atlikdami kelis paprastus veiksmus.
