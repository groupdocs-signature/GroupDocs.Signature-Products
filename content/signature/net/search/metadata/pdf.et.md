...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Pdf rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Pdf, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Pdf"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Pdf failides. Tehke oma Pdf dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Pdf, rakendades mõnda lihtsat sammu.
