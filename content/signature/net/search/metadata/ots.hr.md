...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Ots u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Ots pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Ots datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Ots datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Ots dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Ots iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
