...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Pps w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Metadata w plikach Pps przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Pps"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Pps. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Pps, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Metadata w plikach Pps z ich aplikacji, wykonując kilka prostych kroków.
