...
demos:
    ...
    content: |
       Add Metadata electronic signatures to Webp file right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.
