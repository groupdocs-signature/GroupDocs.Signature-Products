...
############################# Head ############################
head_title: "Cerca le firme Metadata nel file Xlsb in C#"
head_description: "Usa .NET per cercare le firme Metadata nei file Xlsb utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Metadata nel file Xlsb"
description: "L'API nativa .NET consente di cercare firme Metadata in file Xlsb già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Xlsb utilizzando poche righe di codice."
...
steps:
    enable: true
    title_left: "Come cercare le firme Metadata in Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Metadata nei file Xlsb dalle loro applicazioni implementando alcuni semplici passaggi.
