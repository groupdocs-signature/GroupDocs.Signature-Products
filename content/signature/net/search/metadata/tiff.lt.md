...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Tiff faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Tiff failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Tiff faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Tiff failuose. Atlikite išplėstinę el. parašo paiešką savo Tiff dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Metadata parašų Tiff"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Tiff failuose iš savo programų, atlikdami kelis paprastus veiksmus.
...
demos:
    ...
    content: |
       Dabar ieškokite dokumente įvairių elektroninių parašų prie Tiff failų, apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje.
