...
############################# Head ############################
head_title: "Search for Metadata signatures in Jpg file in C#"
head_description: "Use .NET for searching for Metadata signatures in Jpg files using a few lines of code."

############################# Header ############################
title: "Search for Metadata signatures in Jpg file"
description: ".NET native API allows to search for Metadata signatures in already signed Jpg files. Perform advanced e-signature search within your Jpg documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Metadata signatures in Jpg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Metadata signatures in Jpg files from their applications by implementing a few easy steps.
