...
############################# Head ############################
head_title: "Search Metadata signatures in Jpg file in C#"
head_description: "Use .NET for searching Metadata signatures in Jpg files using a few lines of code."

############################# Header ############################
title: "Search Metadata signatures in Jpg file"
description: ".NET native API to search Metadata signatures in already signed Jpg file. Perform advanced e-signature operations within your Jpg documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search Metadata signatures in Jpg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easy for .NET developers to search Metadata signatures in Jpg files from within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
       Add Metadata electronic signatures to Jpg file right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.
