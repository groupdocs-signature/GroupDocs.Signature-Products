...
############################# Head ############################
head_title: "Vyhľadajte podpisy Metadata v súbore Wmf v C#"
head_description: "Použite .NET na vyhľadávanie Metadata podpisov v súboroch Wmf pomocou niekoľkých riadkov kódu."

############################# Header ############################
title: "Vyhľadajte podpisy Metadata v súbore Wmf"
description: "Natívne API .NET umožňuje vyhľadávať podpisy Metadata v už podpísaných súboroch Wmf. Vykonajte rozšírené vyhľadávanie elektronických podpisov vo svojich dokumentoch Wmf pomocou niekoľkých riadkov kódu."
...
steps:
    enable: true
    title_left: "Ako vyhľadať podpisy Metadata v Wmf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uľahčuje vývojárom .NET vyhľadávanie podpisov Metadata v súboroch Wmf z ich aplikácií implementáciou niekoľkých jednoduchých krokov.
