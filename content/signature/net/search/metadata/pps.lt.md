...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Pps faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Pps failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Pps faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Pps failuose. Atlikite išplėstinę el. parašo paiešką savo Pps dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Metadata parašų Pps"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Pps failuose iš savo programų, atlikdami kelis paprastus veiksmus.
...
demos:
    ...
    content: |
       Dabar ieškokite dokumente įvairių elektroninių parašų prie Pps failų, apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje.
