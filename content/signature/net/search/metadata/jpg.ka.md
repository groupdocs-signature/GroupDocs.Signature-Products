...
############################# Head ############################
head_title: "მოძებნეთ Metadata ხელმოწერები Jpg ფაილში C#"
head_description: "გამოიყენეთ .NET Metadata ხელმოწერების მოსაძიებლად Jpg ფაილებში კოდის რამდენიმე ხაზის გამოყენებით."

############################# Header ############################
title: "მოძებნეთ Metadata ხელმოწერები Jpg ფაილში"
description: ".NET მშობლიური API საშუალებას გაძლევთ მოძებნოთ Metadata ხელმოწერები უკვე ხელმოწერილ Jpg ფაილებში. განახორციელეთ ელექტრონული ხელმოწერის გაფართოებული ძიება თქვენს {{ფაილის ფორმატში}} დოკუმენტებში კოდის რამდენიმე ხაზის გამოყენებით."
