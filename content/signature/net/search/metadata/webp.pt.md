...
############################# Head ############################
head_title: "Procure por assinaturas Metadata no arquivo Webp em C#"
head_description: "Use .NET para pesquisar assinaturas Metadata em arquivos Webp usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Metadata no arquivo Webp"
description: "A API nativa do .NET permite pesquisar assinaturas Metadata em arquivos Webp já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Webp usando algumas linhas de código."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Metadata em arquivos Webp de seus aplicativos implementando algumas etapas fáceis.
