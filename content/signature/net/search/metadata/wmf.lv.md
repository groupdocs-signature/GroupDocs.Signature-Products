...
############################# Head ############################
head_title: "Meklēt Metadata parakstus Wmf failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Metadata parakstus Wmf failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Metadata parakstus failā Wmf"
description: ".NET vietējais API ļauj meklēt Metadata parakstus jau parakstītos Wmf failos. Veiciet izvērsto e-paraksta meklēšanu savos Wmf dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Metadata parakstus Wmf failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
