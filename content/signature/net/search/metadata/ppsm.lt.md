...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Ppsm faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Ppsm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Ppsm faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Ppsm failuose. Atlikite išplėstinę el. parašo paiešką savo Ppsm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Ppsm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
