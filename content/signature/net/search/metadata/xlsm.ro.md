...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Xlsm în C#"
head_description: "Utilizați .NET pentru a căuta semnături Metadata în fișiere Xlsm folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Xlsm"
description: "API-ul nativ .NET permite căutarea semnăturilor Metadata în fișierele Xlsm deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Xlsm folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Metadata în Xlsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Metadata în fișierele Xlsm din aplicațiile lor prin implementarea câțiva pași simpli.
