...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Odt v C#"
head_description: "Uporabite .NET za iskanje podpisov Metadata v datotekah Odt z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Odt"
description: "Izvorni API za .NET omogoča iskanje podpisov Metadata v že podpisanih datotekah Odt. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Odt z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) razvijalcem za .NET olajša iskanje podpisov Metadata v datotekah Odt iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
