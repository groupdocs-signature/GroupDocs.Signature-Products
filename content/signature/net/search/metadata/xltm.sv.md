...
############################# Head ############################
head_title: "Sök efter Metadata-signaturer i filen Xltm i C#"
head_description: "Använd .NET för att söka efter Metadata-signaturer i Xltm-filer med några rader kod."

############################# Header ############################
title: "Sök efter Metadata-signaturer i filen Xltm"
description: "Inbyggt API för .NET gör det möjligt att söka efter Metadata-signaturer i redan signerade Xltm-filer. Utför avancerad e-signatursökning i dina Xltm-dokument med några rader kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gör det enklare för .NET-utvecklare att söka efter Metadata-signaturer i Xltm-filer från sina applikationer genom att implementera några enkla steg.
