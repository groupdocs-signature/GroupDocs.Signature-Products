...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Dotx v C#"
head_description: "Použijte .NET k vyhledávání podpisů Metadata v souborech Dotx pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Dotx"
description: "Nativní API .NET umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Dotx. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Dotx pomocí několika řádků kódu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Metadata v souborech Dotx z jejich aplikací implementací několika snadných kroků.
