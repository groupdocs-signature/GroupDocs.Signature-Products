...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Png v C#"
head_description: "Použijte .NET k vyhledávání podpisů Metadata v souborech Png pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Png"
description: "Nativní API .NET umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Png. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Png pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Png"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Metadata v souborech Png z jejich aplikací implementací několika snadných kroků.
