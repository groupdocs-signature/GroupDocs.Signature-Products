...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Wmf v C#"
head_description: "Použijte .NET k vyhledávání podpisů Metadata v souborech Wmf pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Wmf"
description: "Nativní API .NET umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Wmf. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Wmf pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Wmf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Metadata v souborech Wmf z jejich aplikací implementací několika snadných kroků.
