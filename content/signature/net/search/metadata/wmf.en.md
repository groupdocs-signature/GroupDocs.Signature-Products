...
############################# Head ############################
head_title: "Search for Metadata signatures in Wmf file in C#"
head_description: "Use .NET for searching for Metadata signatures in Wmf files using a few lines of code."

############################# Header ############################
title: "Search for Metadata signatures in Wmf file"
description: ".NET native API allows to search for Metadata signatures in already signed Wmf files. Perform advanced e-signature search within your Wmf documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to search for Metadata signatures in Wmf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Metadata signatures in Wmf files from their applications by implementing a few easy steps.
