...
############################# Head ############################
head_title: "Cari tanda tangan Metadata dalam file Ppsm di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Metadata di file Ppsm menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Metadata di file Ppsm"
description: ".NET API asli memungkinkan untuk mencari Metadata tanda tangan di file Ppsm yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Ppsm Anda menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Cara mencari tanda tangan Metadata di Ppsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Metadata dalam file Ppsm dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
