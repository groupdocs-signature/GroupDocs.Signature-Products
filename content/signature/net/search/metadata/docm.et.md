...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Docm rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Docm, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Docm"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Docm failides. Tehke oma Docm dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Docm, rakendades mõnda lihtsat sammu.
