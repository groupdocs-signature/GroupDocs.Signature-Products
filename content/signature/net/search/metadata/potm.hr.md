...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Potm u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Potm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Potm datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Potm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Potm dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Potm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
