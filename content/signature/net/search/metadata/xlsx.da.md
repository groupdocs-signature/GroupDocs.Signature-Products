...
############################# Head ############################
head_title: "Søg efter Metadata signaturer i filen Xlsx i C#"
head_description: "Brug .NET til at søge efter Metadata-signaturer i Xlsx-filer ved hjælp af et par linjer kode."

############################# Header ############################
title: "Søg efter Metadata-signaturer i filen Xlsx"
description: ".NET native API gør det muligt at søge efter Metadata-signaturer i allerede signerede Xlsx-filer. Udfør avanceret e-signatursøgning i dine Xlsx dokumenter ved hjælp af et par linjer kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gør det nemmere for .NET-udviklere at søge efter Metadata-signaturer i Xlsx-filer fra deres applikationer ved at implementere nogle få nemme trin.
