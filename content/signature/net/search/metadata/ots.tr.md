...
############################# Head ############################
head_title: "C# içinde Ots dosyasında Metadata imzasını arayın"
head_description: "Birkaç satır kod kullanarak Ots dosyalarında Metadata imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Ots dosyasında Metadata imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Ots dosyalarında Metadata imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Ots belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    enable: true
    title_left: "Ots içinde Metadata imzası nasıl aranır?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Ots dosyalarında Metadata imzalarını aramasını kolaylaştırır.
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web sitesini ziyaret ederek belgede Ots dosyalarına yönelik çeşitli elektronik imzaları arayın.
