...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Pptm u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Pptm pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Pptm datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Pptm datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Pptm dokumenata pomoću nekoliko redaka koda."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Pptm iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
