...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Pdf u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Pdf pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Pdf datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Pdf datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Pdf dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Pdf iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
