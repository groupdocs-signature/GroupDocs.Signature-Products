...
############################# Head ############################
head_title: "Leitaðu að Metadata undirskriftum í Ods skrá í C#"
head_description: "Notaðu .NET til að leita að Metadata undirskriftum í Ods skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Metadata undirskriftum í Ods skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Metadata undirskriftum í þegar undirrituðum Ods skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Ods skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að leita að Metadata undirskriftum í Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Metadata undirskriftum í Ods skrám úr forritum sínum með því að útfæra nokkur einföld skref.
...
demos:
    ...
    content: |
       Leitaðu í skjalinu að ýmsum rafrænum undirskriftum í Ods skrár núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna.

        
############################# More Formats ############################
more_formats:
    enable: true
    title: "Leitaðu að öðrum Metadata undirskriftum með því að nota C#"
    content: |
