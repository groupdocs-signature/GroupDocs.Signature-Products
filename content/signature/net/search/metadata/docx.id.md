...
############################# Head ############################
head_title: "Cari tanda tangan Metadata dalam file Docx di C#"
head_description: "Gunakan .NET untuk mencari tanda tangan Metadata di file Docx menggunakan beberapa baris kode."

############################# Header ############################
title: "Cari tanda tangan Metadata di file Docx"
description: ".NET API asli memungkinkan untuk mencari Metadata tanda tangan di file Docx yang sudah ditandatangani. Lakukan pencarian tanda tangan elektronik lanjutan dalam dokumen Docx Anda menggunakan beberapa baris kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pengembang .NET untuk mencari tanda tangan Metadata dalam file Docx dari aplikasi mereka dengan menerapkan beberapa langkah mudah.
