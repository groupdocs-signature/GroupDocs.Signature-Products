...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Png faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Png failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Png faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Png failuose. Atlikite išplėstinę el. parašo paiešką savo Png dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Metadata parašų Png"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Png failuose iš savo programų, atlikdami kelis paprastus veiksmus.
