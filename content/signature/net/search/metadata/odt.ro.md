...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Odt în C#"
head_description: "Utilizați .NET pentru a căuta semnături Metadata în fișiere Odt folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Odt"
description: "API-ul nativ .NET permite căutarea semnăturilor Metadata în fișierele Odt deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Odt folosind câteva rânduri de cod."
...
steps:
    enable: true
    title_left: "Cum să căutați semnături Metadata în Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Metadata în fișierele Odt din aplicațiile lor prin implementarea câțiva pași simpli.
