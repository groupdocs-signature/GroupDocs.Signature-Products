...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Docx rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Docx, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Docx"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Docx failides. Tehke oma Docx dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Docx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Docx, rakendades mõnda lihtsat sammu.
