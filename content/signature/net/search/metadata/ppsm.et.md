...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Ppsm rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Ppsm, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Ppsm"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Ppsm failides. Tehke oma Ppsm dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Ppsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Ppsm, rakendades mõnda lihtsat sammu.
