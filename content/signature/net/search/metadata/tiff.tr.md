...
############################# Head ############################
head_title: "C# içinde Tiff dosyasında Metadata imzasını arayın"
head_description: "Birkaç satır kod kullanarak Tiff dosyalarında Metadata imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Tiff dosyasında Metadata imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Tiff dosyalarında Metadata imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Tiff belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Tiff dosyalarında Metadata imzalarını aramasını kolaylaştırır.
