...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Tiff în C#"
head_description: "Utilizați .NET pentru a căuta semnături Metadata în fișiere Tiff folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Tiff"
description: "API-ul nativ .NET permite căutarea semnăturilor Metadata în fișierele Tiff deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Tiff folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Metadata în fișierele Tiff din aplicațiile lor prin implementarea câțiva pași simpli.
