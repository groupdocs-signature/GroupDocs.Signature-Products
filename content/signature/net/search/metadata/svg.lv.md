...
############################# Head ############################
head_title: "Meklēt Metadata parakstus Svg failā programmā C#"
head_description: "Izmantojiet .NET, lai meklētu Metadata parakstus Svg failos, izmantojot dažas koda rindiņas."

############################# Header ############################
title: "Meklējiet Metadata parakstus failā Svg"
description: ".NET vietējais API ļauj meklēt Metadata parakstus jau parakstītos Svg failos. Veiciet izvērsto e-paraksta meklēšanu savos Svg dokumentos, izmantojot dažas koda rindiņas."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ļauj .NET izstrādātājiem vieglāk meklēt Metadata parakstus Svg failos no savām lietojumprogrammām, veicot dažas vienkāršas darbības.
