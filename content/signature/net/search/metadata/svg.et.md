...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Svg rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Svg, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Svg"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Svg failides. Tehke oma Svg dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Svg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Svg, rakendades mõnda lihtsat sammu.
