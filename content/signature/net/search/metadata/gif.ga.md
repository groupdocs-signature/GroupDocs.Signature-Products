...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Gif i C#"
head_description: "Úsáid .NET chun sínithe Metadata a chuardach i gcomhaid Gif ag úsáid cúpla líne de chód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Metadata i gcomhaid Gif óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
