...
############################# Head ############################
head_title: "Cari tandatangan Metadata dalam fail Xltx dalam C#"
head_description: "Gunakan .NET untuk mencari tandatangan Metadata dalam fail Xltx menggunakan beberapa baris kod."

############################# Header ############################
title: "Cari tandatangan Metadata dalam fail Xltx."
description: "API asli .NET membenarkan untuk mencari tandatangan Metadata dalam fail Xltx yang telah ditandatangani. Lakukan carian e-tandatangan lanjutan dalam dokumen Xltx anda menggunakan beberapa baris kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memudahkan pembangun .NET mencari tandatangan Metadata dalam fail Xltx daripada aplikasi mereka dengan melaksanakan beberapa langkah mudah.
