...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Potm w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Metadata w plikach Potm przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Potm"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Potm. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Potm, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Metadata w plikach Potm z ich aplikacji, wykonując kilka prostych kroków.
