...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Ott faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Ott failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Ott faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Ott failuose. Atlikite išplėstinę el. parašo paiešką savo Ott dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Ott failuose iš savo programų, atlikdami kelis paprastus veiksmus.
