...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Rtf rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Rtf, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Rtf"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Rtf failides. Tehke oma Rtf dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Rtf, rakendades mõnda lihtsat sammu.
