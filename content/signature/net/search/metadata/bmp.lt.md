...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Bmp faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Bmp failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Bmp faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Bmp failuose. Atlikite išplėstinę el. parašo paiešką savo Bmp dokumentuose naudodami kelias kodo eilutes."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Bmp failuose iš savo programų, atlikdami kelis paprastus veiksmus.
