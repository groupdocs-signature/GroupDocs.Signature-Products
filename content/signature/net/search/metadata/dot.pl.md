...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Dot w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Metadata w plikach Dot przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Dot"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Dot. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Dot, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Metadata w plikach Dot z ich aplikacji, wykonując kilka prostych kroków.
