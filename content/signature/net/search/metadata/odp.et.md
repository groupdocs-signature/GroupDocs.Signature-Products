...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Odp rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Odp, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Odp"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Odp failides. Tehke oma Odp dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Odp, rakendades mõnda lihtsat sammu.
