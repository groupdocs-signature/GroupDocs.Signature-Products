...
############################# Head ############################
head_title: "Poiščite podpise Metadata v datoteki Rtf v C#"
head_description: "Uporabite .NET za iskanje podpisov Metadata v datotekah Rtf z uporabo nekaj vrstic kode."

############################# Header ############################
title: "Poiščite podpise Metadata v datoteki Rtf"
description: "Izvorni API za .NET omogoča iskanje podpisov Metadata v že podpisanih datotekah Rtf. Izvedite napredno iskanje e-podpisov znotraj svojih dokumentov Rtf z uporabo nekaj vrstic kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) razvijalcem za .NET olajša iskanje podpisov Metadata v datotekah Rtf iz njihovih aplikacij z implementacijo nekaj preprostih korakov.
