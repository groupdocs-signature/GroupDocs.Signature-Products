...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Pps a C#"
head_description: "Utilitzeu .NET per cercar signatures Metadata als fitxers Pps mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Pps"
description: "L'API nativa de .NET permet cercar signatures Metadata als fitxers Pps ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Pps amb unes poques línies de codi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Metadata als fitxers Pps des de les seves aplicacions implementant uns quants passos senzills.
