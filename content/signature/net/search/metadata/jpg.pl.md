...
############################# Head ############################
head_title: "Wyszukaj podpisy Metadata w pliku Jpg w C#"
head_description: "Użyj .NET do wyszukiwania podpisów Metadata w plikach Jpg przy użyciu kilku linijek kodu."

############################# Header ############################
title: "Wyszukaj podpisy Metadata w pliku Jpg"
description: "Natywny interfejs API .NET umożliwia wyszukiwanie podpisów Metadata w już podpisanych plikach Jpg. Przeprowadź zaawansowane wyszukiwanie podpisu elektronicznego w swoich dokumentach Jpg, używając kilku linijek kodu."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ułatwia programistom .NET wyszukiwanie podpisów Metadata w plikach Jpg z ich aplikacji, wykonując kilka prostych kroków.
