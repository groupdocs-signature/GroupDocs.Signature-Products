...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Tiff rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Tiff, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Tiff"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Tiff failides. Tehke oma Tiff dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Tiff, rakendades mõnda lihtsat sammu.
