...
############################# Head ############################
head_title: "Li Metadata îmzeyan di pela Pps de di C# de bigerin"
head_description: ".NET ji bo lêgerîna îmzeyên Metadata di pelên Pps de bi karanîna çend rêzikên kodê bikar bînin."

############################# Header ############################
title: "Di pela Pps de li îmzeyên Metadata bigerin"
description: "API-ya xwecihî ya .NET destûrê dide ku meriv di pelên Pps yên jixwe îmzekirî de li îmzeyên Metadata bigere. Lêgerîna pêşkeftî ya e-îmzayê di nav belgeyên xwe yên Pps de bi karanîna çend rêzikên kodê pêk bînin."
...
steps:
    enable: true
    title_left: "Meriv çawa li îmzeyên Metadata di Pps de digere"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji pêşdebirên .NET re hêsantir dike ku bi pêkanîna çend gavên hêsan li Metadata di pelên Pps îmzeyan de ji sepanên xwe bigerin.
