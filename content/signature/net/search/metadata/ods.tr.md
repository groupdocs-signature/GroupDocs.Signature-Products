...
############################# Head ############################
head_title: "C# içinde Ods dosyasında Metadata imzasını arayın"
head_description: "Birkaç satır kod kullanarak Ods dosyalarında Metadata imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Ods dosyasında Metadata imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Ods dosyalarında Metadata imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Ods belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Ods dosyalarında Metadata imzalarını aramasını kolaylaştırır.
