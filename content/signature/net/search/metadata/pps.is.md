...
############################# Head ############################
head_title: "Leitaðu að Metadata undirskriftum í Pps skrá í C#"
head_description: "Notaðu .NET til að leita að Metadata undirskriftum í Pps skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Metadata undirskriftum í Pps skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Metadata undirskriftum í þegar undirrituðum Pps skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Pps skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að leita að Metadata undirskriftum í Pps"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Metadata undirskriftum í Pps skrám úr forritum sínum með því að útfæra nokkur einföld skref.
...
demos:
    ...
    content: |
       Leitaðu í skjalinu að ýmsum rafrænum undirskriftum í Pps skrár núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna.
