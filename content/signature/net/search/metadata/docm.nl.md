...
############################# Head ############################
head_title: "Zoek naar Metadata handtekeningen in Docm bestand in C#"
head_description: "Gebruik .NET om te zoeken naar Metadata handtekeningen in Docm bestanden met een paar regels code."

############################# Header ############################
title: "Zoek naar Metadata handtekeningen in Docm bestand"
description: ".NET native API maakt het mogelijk om te zoeken naar Metadata handtekeningen in reeds ondertekende Docm bestanden. Voer geavanceerd zoeken naar elektronische handtekeningen uit in uw Docm-documenten met een paar regels code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) maakt het voor .NET-ontwikkelaars gemakkelijker om te zoeken naar Metadata-handtekeningen in Docm-bestanden vanuit hun applicaties door een paar eenvoudige stappen te implementeren.
