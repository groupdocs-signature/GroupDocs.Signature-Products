...
############################# Head ############################
head_title: "Cerqueu signatures de Metadata al fitxer Xlsx a C#"
head_description: "Utilitzeu .NET per cercar signatures Metadata als fitxers Xlsx mitjançant unes poques línies de codi."

############################# Header ############################
title: "Cerqueu signatures Metadata al fitxer Xlsx"
description: "L'API nativa de .NET permet cercar signatures Metadata als fitxers Xlsx ja signats. Feu una cerca avançada de signatura electrònica als vostres documents Xlsx amb unes poques línies de codi."
...
steps:
    enable: true
    title_left: "Com cercar signatures de Metadata a Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilita que els desenvolupadors de .NET cerquin signatures de Metadata als fitxers Xlsx des de les seves aplicacions implementant uns quants passos senzills.
