...
############################# Head ############################
head_title: "Cerca le firme Metadata nel file Odt in C#"
head_description: "Usa .NET per cercare le firme Metadata nei file Odt utilizzando poche righe di codice."

############################# Header ############################
title: "Cerca le firme Metadata nel file Odt"
description: "L'API nativa .NET consente di cercare firme Metadata in file Odt già firmati. Esegui una ricerca avanzata di firme elettroniche all'interno dei tuoi documenti Odt utilizzando poche righe di codice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) consente agli sviluppatori di .NET di cercare più facilmente le firme Metadata nei file Odt dalle loro applicazioni implementando alcuni semplici passaggi.
