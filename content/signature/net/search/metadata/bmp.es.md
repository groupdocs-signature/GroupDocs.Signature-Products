...
steps:
    enable: true
    title_left: "Cómo buscar firmas de Metadata en Bmp"
    content_left: |
...
demos:
    ...
    content: |
       Busque en el documento varias firmas electrónicas para archivos Bmp ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).
