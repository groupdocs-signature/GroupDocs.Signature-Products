...
############################# Head ############################
head_title: "Ieškokite Metadata parašų Xltm faile C#"
head_description: "Naudokite .NET, norėdami ieškoti Metadata parašų Xltm failuose naudodami kelias kodo eilutes."

############################# Header ############################
title: "Ieškokite Metadata parašų Xltm faile"
description: ".NET savoji API leidžia ieškoti Metadata parašų jau pasirašytuose Xltm failuose. Atlikite išplėstinę el. parašo paiešką savo Xltm dokumentuose naudodami kelias kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip ieškoti Metadata parašų Xltm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) leidžia .NET kūrėjams lengviau ieškoti Metadata parašų Xltm failuose iš savo programų, atlikdami kelis paprastus veiksmus.
