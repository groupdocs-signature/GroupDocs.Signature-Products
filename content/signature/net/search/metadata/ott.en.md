...
############################# Head ############################
head_title: "Search for Metadata signatures in Ott file in C#"
head_description: "Use .NET for searching for Metadata signatures in Ott files using a few lines of code."

############################# Header ############################
title: "Search for Metadata signatures in Ott file"
description: ".NET native API allows to search for Metadata signatures in already signed Ott files. Perform advanced e-signature search within your Ott documents using a few lines of code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) makes it easier for .NET developers to search for Metadata signatures in Ott files from their applications by implementing a few easy steps.
