...
############################# Head ############################
head_title: "C# içinde Pptm dosyasında Metadata imzasını arayın"
head_description: "Birkaç satır kod kullanarak Pptm dosyalarında Metadata imzasını aramak için .NET kullanın."

############################# Header ############################
title: "Pptm dosyasında Metadata imzasını arayın"
description: ".NET yerel API'si, önceden imzalanmış Pptm dosyalarında Metadata imzalarının aranmasına olanak tanır. Birkaç satır kod kullanarak Pptm belgelerinizde gelişmiş e-imza araması yapın."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), .NET geliştiricilerinin birkaç kolay adımı uygulayarak Pptm dosyalarında Metadata imzalarını aramasını kolaylaştırır.
