...
############################# Head ############################
head_title: "Soek vir Metadata handtekeninge in Wmf lêer in C#"
head_description: "Gebruik .NET om na Metadata-handtekeninge in Wmf-lêers te soek deur 'n paar reëls kode te gebruik."

############################# Header ############################
title: "Soek vir Metadata handtekeninge in Wmf lêer"
description: ".NET se inheemse API laat toe om vir Metadata handtekeninge te soek in reeds ondertekende Wmf lêers. Voer gevorderde e-handtekeningsoektog binne jou Wmf dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    enable: true
    title_left: "Hoe om te soek vir Metadata handtekeninge in Wmf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) maak dit makliker vir .NET-ontwikkelaars om vir Metadata-handtekeninge in Wmf-lêers vanaf hul toepassings te soek deur 'n paar maklike stappe te implementeer.
