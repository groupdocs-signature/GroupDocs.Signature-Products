...
############################# Head ############################
head_title: "Soek vir Metadata handtekeninge in Jpg lêer in C#"
head_description: "Gebruik .NET om na Metadata-handtekeninge in Jpg-lêers te soek deur 'n paar reëls kode te gebruik."

############################# Header ############################
title: "Soek vir Metadata handtekeninge in Jpg lêer"
description: ".NET se inheemse API laat toe om vir Metadata handtekeninge te soek in reeds ondertekende Jpg lêers. Voer gevorderde e-handtekeningsoektog binne jou Jpg dokumente uit deur 'n paar reëls kode te gebruik."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) maak dit makliker vir .NET-ontwikkelaars om vir Metadata-handtekeninge in Jpg-lêers vanaf hul toepassings te soek deur 'n paar maklike stappe te implementeer.
