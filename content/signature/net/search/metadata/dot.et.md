...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Dot rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Dot, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Dot"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Dot failides. Tehke oma Dot dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    enable: true
    title_left: "Allkirjade Metadata otsimine failivormingus Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Dot, rakendades mõnda lihtsat sammu.
