...
############################# Head ############################
head_title: "Potražite Metadata potpise u datoteci Dot u C#"
head_description: "Upotrijebite .NET za traženje potpisa Metadata u datotekama Dot pomoću nekoliko redaka koda."

############################# Header ############################
title: "Potražite Metadata potpise u Dot datoteci"
description: "Izvorni API za .NET omogućuje pretraživanje potpisa Metadata u već potpisanim Dot datotekama. Izvršite napredno pretraživanje e-potpisa unutar svojih Dot dokumenata pomoću nekoliko redaka koda."
...
steps:
    enable: true
    title_left: "Kako tražiti Metadata potpise u Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) programerima proizvoda .NET olakšava traženje potpisa Metadata u datotekama Dot iz njihovih aplikacija implementacijom nekoliko jednostavnih koraka.
