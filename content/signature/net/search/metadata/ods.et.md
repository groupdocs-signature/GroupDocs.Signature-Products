...
############################# Head ############################
head_title: "Otsige allkirju Metadata failist Ods rakenduses C#"
head_description: "Kasutage .NET allkirjade Metadata otsimiseks failides Ods, kasutades paari koodirida."

############################# Header ############################
title: "Otsige failist Metadata allkirju Ods"
description: "Native API .NET võimaldab otsida allkirju Metadata juba allkirjastatud Ods failides. Tehke oma Ods dokumentides täpsem e-allkirjaotsing, kasutades paari koodirida."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hõlbustab toote .NET arendajatel allkirjade Metadata otsimist oma rakendustest failides Ods, rakendades mõnda lihtsat sammu.
