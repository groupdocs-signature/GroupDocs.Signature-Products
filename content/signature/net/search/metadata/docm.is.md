...
############################# Head ############################
head_title: "Leitaðu að Metadata undirskriftum í Docm skrá í C#"
head_description: "Notaðu .NET til að leita að Metadata undirskriftum í Docm skrám með því að nota nokkrar línur af kóða."

############################# Header ############################
title: "Leitaðu að Metadata undirskriftum í Docm skrá"
description: "Innbyggt forritaskil .NET gerir kleift að leita að Metadata undirskriftum í þegar undirrituðum Docm skrám. Framkvæmdu háþróaða leit með rafrænum undirskriftum í Docm skjölunum þínum með því að nota nokkrar línur af kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að leita að Metadata undirskriftum í Docm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) auðveldar forriturum .NET að leita að Metadata undirskriftum í Docm skrám úr forritum sínum með því að útfæra nokkur einföld skref.
...
demos:
    ...
    content: |
       Leitaðu í skjalinu að ýmsum rafrænum undirskriftum í Docm skrár núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna.
