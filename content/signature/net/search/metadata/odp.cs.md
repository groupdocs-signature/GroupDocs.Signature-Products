...
############################# Head ############################
head_title: "Vyhledejte podpisy Metadata v souboru Odp v C#"
head_description: "Použijte .NET k vyhledávání podpisů Metadata v souborech Odp pomocí několika řádků kódu."

############################# Header ############################
title: "Vyhledejte podpisy Metadata v souboru Odp"
description: "Nativní API .NET umožňuje vyhledávat podpisy Metadata v již podepsaných souborech Odp. Proveďte pokročilé vyhledávání elektronických podpisů ve svých dokumentech Odp pomocí několika řádků kódu."
...
steps:
    enable: true
    title_left: "Jak hledat podpisy Metadata v Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) usnadňuje vývojářům .NET hledání podpisů Metadata v souborech Odp z jejich aplikací implementací několika snadných kroků.
