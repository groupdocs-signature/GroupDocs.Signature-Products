...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Dotx i C#"
head_description: "Úsáid .NET chun sínithe Metadata a chuardach i gcomhaid Dotx ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Dotx"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar Metadata sínithe i gcomhaid Dotx atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Dotx ag úsáid cúpla líne cód."
...
steps:
    ...
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Metadata i gcomhaid Dotx óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
