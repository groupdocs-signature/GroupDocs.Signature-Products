...
############################# Head ############################
head_title: "Cuardaigh Metadata síniú i gcomhad Bmp i C#"
head_description: "Úsáid .NET chun sínithe Metadata a chuardach i gcomhaid Bmp ag úsáid cúpla líne de chód."

############################# Header ############################
title: "Cuardaigh le haghaidh Metadata sínithe i gcomhad Bmp"
description: "Ceadaíonn API dúchais .NET cuardach a dhéanamh ar {{ Signaturetype}} sínithe i gcomhaid {{ Fileformat}} atá sínithe cheana féin. Déan ard-chuardach ríomhshínithe laistigh de do dhoiciméid Bmp ag úsáid cúpla líne cód."
...
steps:
    enable: true
    title_left: "Conas síniú Metadata a chuardach i Bmp"
    content_left: |
        Déanann [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) é níos fusa d’fhorbróirí .NET cuardach a dhéanamh ar shínithe Metadata i gcomhaid Bmp óna bhfeidhmchláir trí roinnt céimeanna éasca a chur i bhfeidhm.
