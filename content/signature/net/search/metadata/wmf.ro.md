...
############################# Head ############################
head_title: "Căutați semnături Metadata în fișierul Wmf în C#"
head_description: "Utilizați .NET pentru a căuta semnături Metadata în fișiere Wmf folosind câteva rânduri de cod."

############################# Header ############################
title: "Căutați semnături Metadata în fișierul Wmf"
description: "API-ul nativ .NET permite căutarea semnăturilor Metadata în fișierele Wmf deja semnate. Efectuați o căutare avansată de semnătură electronică în documentele dvs. Wmf folosind câteva rânduri de cod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) facilitează pentru dezvoltatorii .NET să caute semnături Metadata în fișierele Wmf din aplicațiile lor prin implementarea câțiva pași simpli.
