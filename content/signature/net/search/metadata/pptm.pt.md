...
############################# Head ############################
head_title: "Procure por assinaturas Metadata no arquivo Pptm em C#"
head_description: "Use .NET para pesquisar assinaturas Metadata em arquivos Pptm usando algumas linhas de código."

############################# Header ############################
title: "Procure por assinaturas Metadata no arquivo Pptm"
description: "A API nativa do .NET permite pesquisar assinaturas Metadata em arquivos Pptm já assinados. Realize uma pesquisa avançada de assinatura eletrônica em seus documentos Pptm usando algumas linhas de código."
...
steps:
    enable: true
    title_left: "Como pesquisar assinaturas de Metadata em Pptm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) torna mais fácil para os desenvolvedores do .NET pesquisar assinaturas Metadata em arquivos Pptm de seus aplicativos implementando algumas etapas fáceis.
