...
############################# Head ############################
head_title: "Search &amp; Validate Digital Signatures in a DOCM file in C# .NET"
head_description: "C# .NET API to search digital signatures in a signed DOCM file, other images and document file formats using a few lines of code."

############################# Header ############################
title: "Search Digital Signatures in DOCM File"
description: "C# .NET native API to view &amp; search digital signatures in an already signed DOCM file and analyze signature certificate. Perform advanced e-signature operations within your documents using a few lines of code."
...
steps:
    enable: true
    title_left: "How to Search Signatures in DOCM"
    content_left: |
        [GroupDocs.Signature](https://products.groupdocs.com/signature/net) makes it easy for .NET developers to view & search digital signatures in DOCM files from within their applications by implementing a few easy steps.
...
demos:
    enable: true
    title: "Search DOCM Signature Live Demos"
    content: |
