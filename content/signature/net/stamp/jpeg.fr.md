...
############################# Head ############################
head_title: "Tampons ronds et carrés JPEG via C#"
head_description: "Utilisez GroupDocs.Signature for .NET pour générer et intégrer des tampons personnalisés dans vos fichiers JPEG."

############################# Header ############################
title: "Générez des tampons pour des fichiers JPEG" 
...
steps:
    enable: true
    title: "Comment intégrer un tampon dans JPEG en utilisant C#"
    content: |
