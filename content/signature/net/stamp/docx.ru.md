...
############################# Head ############################
head_title: "Круглые и квадратные штампы DOCX через C#"
head_description: "Используйте GroupDocs.Signature for .NET для генерации и внедрения персонализированных штампов в файлы DOCX."

############################# Header ############################
title: "Генерация штампов для файлов DOCX" 
...
steps:
    enable: true
    title: "Как встроить штамп в DOCX с помощью C#"
    content: |
      ...
      1. Предоставьте документ DOCX, который нужно подписать.
