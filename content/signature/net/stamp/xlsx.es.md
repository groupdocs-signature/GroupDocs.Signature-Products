...
############################# Head ############################
head_title: "Sellos redondos y cuadrados XLSX a través de C#"
head_description: "Utiliza GroupDocs.Signature for .NET para generar e incrustar sellos personalizados en archivos XLSX."

############################# Header ############################
title: "Generar sellos para archivos XLSX" 
...
steps:
    enable: true
    title: "Cómo incrustar un sello en XLSX usando C#"
    content: |
      ...
      1. Proporciona el documento XLSX que debe ser sellado.
