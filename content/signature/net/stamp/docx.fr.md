...
############################# Head ############################
head_title: "Tampons ronds et carrés DOCX via C#"
head_description: "Utilisez GroupDocs.Signature for .NET pour générer et intégrer des tampons personnalisés dans vos fichiers DOCX."

############################# Header ############################
title: "Générez des tampons pour des fichiers DOCX" 
...
steps:
    enable: true
    title: "Comment intégrer un tampon dans DOCX en utilisant C#"
    content: |
      ...
      1. Fournissez le document DOCX à tamponner.
