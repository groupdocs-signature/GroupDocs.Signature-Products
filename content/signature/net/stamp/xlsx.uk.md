...
############################# Head ############################
head_title: "Округлі та квадратні штампи XLSX через C#"
head_description: "Використовуйте GroupDocs.Signature for .NET для генерації та встраювання персоналізованих штампів у файли XLSX."

############################# Header ############################
title: "Генеруйте штампи для файлів XLSX" 
...
steps:
    enable: true
    title: "Як вбудувати штамп у XLSX за допомогою C#"
    content: |
      ...
      1. Надайте документ XLSX, що підлягає штампуванню.
