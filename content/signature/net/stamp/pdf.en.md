...
############################# Head ############################
head_title: "Round and square stamps PDF via C#"
head_description: "Use GroupDocs.Signature for .NET to generate and embed personalized stamps across PDF files."
...
steps:
    enable: true
    title: "How to embed stamp into PDF using C#"
    content: |
