...
############################# Head ############################
head_title: "Runde und quadratische Stempel XLSX über C#"
head_description: "Verwenden Sie GroupDocs.Signature for .NET, um personalisierte Stempel in XLSX-Dateien zu generieren und einzubetten."

############################# Header ############################
title: "Stempel für XLSX-Dateien generieren" 
...
steps:
    enable: true
    title: "Wie man einen Stempel in XLSX mit C# einfügt"
    content: |
      ...
      1. Stellen Sie das XLSX-Dokument bereit, das gestempelt werden soll.
