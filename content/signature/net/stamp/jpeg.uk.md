...
############################# Head ############################
head_title: "Округлі та квадратні штампи JPEG через C#"
head_description: "Використовуйте GroupDocs.Signature for .NET для генерації та встраювання персоналізованих штампів у файли JPEG."

############################# Header ############################
title: "Генеруйте штампи для файлів JPEG" 
...
steps:
    enable: true
    title: "Як вбудувати штамп у JPEG за допомогою C#"
    content: |
      ...
      1. Надайте документ JPEG, що підлягає штампуванню.
