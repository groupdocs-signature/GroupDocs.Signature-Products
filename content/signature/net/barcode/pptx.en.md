...
############################# Head ############################
head_title: "Generate barcode for PPTX using C# API"
head_description: "Generate a barcode signature and secure PPTX document using C# with just a few lines of code. Utilize GroupDocs.Signature for signing a wide range of file formats."

############################# Header ############################
title: "Generate barcode for PPTX documents" 
...
steps:
    enable: true
    title: "Steps to generate and embed a barcode in PPTX file"
    content: |
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "How to generate a barcode signature"
      content: |
        This example shows how to embed a customized barcode on PPTX document pages.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
