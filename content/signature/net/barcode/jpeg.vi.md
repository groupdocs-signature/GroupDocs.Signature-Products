...
############################# Head ############################
head_title: "Tạo mã vạch cho JPEG bằng API C#"
head_description: "Tạo chữ ký mã vạch và bảo vệ tài liệu JPEG bằng C# chỉ trong vài dòng mã. Sử dụng GroupDocs.Signature để ký một loạt các định dạng tệp."

############################# Header ############################
title: "Tạo mã vạch cho tài liệu JPEG" 
...
steps:
    enable: true
    title: "Các bước để tạo và nhúng một mã vạch vào tệp JPEG"
    content: |
      [GroupDocs.Signature](/signature/net/) tạo điều kiện cho việc tạo mã vạch ở nhiều định dạng phổ biến và việc đặt chúng trên các trang JPEG. Với hơn 60 loại mã vạch được hỗ trợ, các ứng dụng .NET có thể dễ dàng được mở rộng với các chức năng ký mã vạch bằng cách tích hợp thư viện của chúng tôi.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cách tạo chữ ký mã vạch"
      content: |
        Ví dụ này cho thấy cách nhúng một mã vạch tùy chỉnh vào các trang tài liệu JPEG.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
