...
############################# Head ############################
head_title: "Barcode generation for PDF using C#"
head_description: "Leverage C# applications in conjunction with GroupDocs.Signature to generate and incorporate barcodes across any place of your PDF documents."

############################# Header ############################
title: "Generate barcode and embed it into PDF Documents" 
...
steps:
    enable: true
    title: "Steps to generate and embed a barcode in PDF files"
    content: |
