...
############################# Head ############################
head_title: "Generate barcode for PDF using C# Applications"
head_description: "Generate a barcode signature and add it to a PDF document using C# with just a few lines of code. Utilize GroupDocs.Signature for signing a wide range of file formats."

############################# Header ############################
title: "Generate barcode and add it into PDF" 
...
steps:
    enable: true
    title: "Steps to generate and embed a barcode in PDF file"
    content: |
