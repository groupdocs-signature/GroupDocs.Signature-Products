...
############################# Head ############################
head_title: "Barcode für XLSX mit C# API generieren"
head_description: "Erzeugen Sie eine Barcode-Signatur und sichern Sie Ihr XLSX-Dokument mit C# in nur wenigen Codezeilen. Nutzen Sie GroupDocs.Signature für die Unterzeichnung einer Vielzahl von Dateiformaten."

############################# Header ############################
title: "Barcode für XLSX-Dokumente generieren" 
...
steps:
    enable: true
    title: "Schritte zur Generierung und Einbettung eines Barcodes in eine XLSX-Datei"
    content: |
      [GroupDocs.Signature](/signature/net/) ermöglicht die Generierung von Barcodes in zahlreichen gängigen Formaten und deren Platzierung auf XLSX-Seiten. Mit Unterstützung für über 60 Barcodetypen können .NET-Anwendungen mühelos mit Barcode-Signierfunktionen aufgestockt werden, indem unsere Bibliothek integriert wird.
      
      1. Liefern Sie die XLSX-Datei oder den Stream zur Verarbeitung.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Wie man eine Barcode-Signatur generiert"
      content: |
        Dieses Beispiel zeigt, wie man einen maßgeschneiderten Barcode auf XLSX-Dokumentseiten einfügt.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
