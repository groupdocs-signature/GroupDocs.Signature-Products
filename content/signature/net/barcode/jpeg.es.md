...
############################# Head ############################
head_title: "Generar código de barras para JPEG utilizando la API C#"
head_description: "Genera una firma de código de barras y asegura el documento JPEG utilizando C# con solo unas pocas líneas de código. Utiliza GroupDocs.Signature para firmar una amplia gama de formatos de archivo."

############################# Header ############################
title: "Generar código de barras para documentos JPEG" 
...
steps:
    enable: true
    title: "Pasos para generar e incrustar un código de barras en un archivo JPEG"
    content: |
      [GroupDocs.Signature](/signature/net/) facilita la generación de códigos de barras en numerosos formatos populares y su colocación en páginas de JPEG. Con más de 60 tipos de códigos de barras compatibles, las aplicaciones .NET se pueden ampliar sin esfuerzo con funciones de firma de códigos de barras al integrar nuestra biblioteca.
      
      1. Proporciona el archivo o flujo JPEG para su procesamiento.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cómo generar una firma de código de barras"
      content: |
        Este ejemplo muestra cómo incrustar un código de barras personalizado en las páginas de un documento JPEG.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
