...
############################# Head ############################
head_title: "Genera codice a barre per PDF utilizzando l'API C#"
head_description: "Genera una firma con codice a barre e proteggi il documento PDF utilizzando C# con sole poche righe di codice. Sfrutta GroupDocs.Signature per firmare un'ampia gamma di formati di file."

############################# Header ############################
title: "Genera codice a barre per documenti PDF" 
...
steps:
    enable: true
    title: "Passaggi per generare e incorporare un codice a barre in un file PDF"
    content: |
      [GroupDocs.Signature](/signature/net/) facilita la generazione di codici a barre in numerosi formati popolari e la loro collocazione su pagine PDF. Supportando oltre 60 tipi di codice a barre, le applicazioni .NET possono essere agevolmente ampliate con le funzionalità di firma con codice a barre integrando la nostra libreria.
      
      1. Fornisci il file PDF o lo stream per l'elaborazione.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Come generare una firma con codice a barre"
      content: |
        Questo esempio mostra come incorporare un codice a barre personalizzato sulle pagine del documento PDF.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
