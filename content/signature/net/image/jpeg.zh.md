...
############################# Head ############################
head_title: "在JPEG文件中添加图像签名，使用C#"
head_description: "通过几行代码在JPEG文件上添加图像签名。使用GroupDocs.Signature for .NET API来添加图像。"
...
steps:
    enable: true
    title: "如何在JPEG的任意位置添加图像，使用C#"
    content: |
      利用[GroupDocs.Signature](/signature/net/)为.NET应用赋能，能够准确地将签名嵌入到JPEG文档的任何页面中。通过集成我们的解决方案，无缝增强产品的能力。
      
      1. 用JPEG文档实例化Signature类。
