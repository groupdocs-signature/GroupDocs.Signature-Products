...
############################# Head ############################
head_title: "Adding Image signatures to JPEG file with C#"
head_description: "Put image signature on JPEG file for .NET using a few lines of code. Use GroupDocs.Signature for .NET API to add images."

############################# Header ############################
title: "Add image signature to JPEG files" 
...
steps:
    enable: true
    title: "How to add an image in any place of a JPEG using C#"
    content: |
