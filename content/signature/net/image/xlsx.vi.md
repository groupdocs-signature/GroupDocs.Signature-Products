...
############################# Head ############################
head_title: "Thêm chữ ký hình ảnh vào tệp XLSX bằng C#"
head_description: "Đặt chữ ký hình ảnh lên tệp XLSX cho .NET chỉ với một vài dòng mã. Sử dụng API GroupDocs.Signature for .NET để thêm hình ảnh."

############################# Header ############################
title: "Thêm chữ ký hình ảnh vào tệp XLSX" 
...
steps:
    enable: true
    title: "Cách thêm hình ảnh vào bất kỳ vị trí nào trong tệp XLSX bằng C#"
    content: |
      Tận dụng [GroupDocs.Signature](/signature/net/) để hỗ trợ các ứng dụng .NET khả năng nhúng chính xác chữ ký vào bất kỳ trang nào của tài liệu XLSX. Nâng cao khả năng của sản phẩm bạn một cách liền mạch bằng cách tích hợp giải pháp của chúng tôi.
      
      1. Khởi tạo lớp Signature với tài liệu XLSX.
