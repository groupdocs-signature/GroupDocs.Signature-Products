...
############################# Head ############################
head_title: "通过 C# 将元数据电子签名附加到 Ods 文档"
head_description: "使用几行 C# 代码将元数据用作 Ods 文档中的隐藏电子签名。使用 GroupDocs 文档签名 API 使用元数据信息对您的业务文档和文件进行电子签名。"

############################# Header ############################
title: "通过 .NET 的 Ods 文档的元数据电子签名简单易用！"
...
steps:
    enable: true
    title_left: "在 C# 中使用 Metadata 签署 Ods 的步骤"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) 提供使用 Metadata 签名快速轻松地签署 Ods 文档的能力。
