...
############################# Head ############################
head_title: "Pridėkite metaduomenų elektroninius parašus prie Tiff dokumentų per C#"
head_description: "Naudokite metaduomenis kaip paslėptus elektroninius parašus savo Tiff dokumentuose naudodami kelias C# kodo eilutes. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus su metaduomenų informacija."

############################# Header ############################
title: "Dokumento Tiff metaduomenų elektroniniai parašai naudojant .NET yra paprasti ir lengvai naudojami!"
description: "e. Pasirašykite savo Tiff dokumentus ir sutartis su paslėptais metaduomenų įrašais. Kurkite PDF, MS Word dokumentų, MS Excel darbaknygių, MS PowerPoint pristatymų ir įvairių vaizdo formatų metaduomenis be problemų ir papildomo kodavimo."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Tiff naudojant Metadata programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Tiff dokumentus su Metadata parašais.
...
demos:
    enable: true
    title: "Dokumentų Tiff pasirašymas naudojant Metadata tiesioginę demonstraciją"
    content: |
