...
############################# Head ############################
head_title: "Legg til metadata elektroniske signaturer til Pptx dokumenter via C#"
head_description: "Bruk Metadata som skjulte elektroniske signaturer i Pptx-dokumentene dine ved å bruke et par linjer med C#-kode. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med metadatainformasjon."

############################# Header ############################
title: "Metadata elektroniske signaturer for Pptx dokument via .NET er enkle og enkle å bruke!"
...
steps:
    enable: true
    title_left: "Trinn for å signere Pptx med Metadata i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Pptx-dokumenter med Metadata-signaturer raskt og enkelt.
