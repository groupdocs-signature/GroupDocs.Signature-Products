...
steps:
    enable: true
    title_left: "Étapes pour signer Ott avec Metadata dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Ott avec des signatures Metadata.
