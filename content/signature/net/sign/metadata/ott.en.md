...
############################# Head ############################
head_title: "Append Metadata electronic signatures to Ott documents via C#"
head_description: "Use Metadata as hidden electronic signatures inside your Ott documents using a couple lines of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with Metadata information."

############################# Header ############################
title: "Metadata electronic signatures for Ott document via .NET are simple and easy for using!"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Ott documents with Metadata signatures quickly and easily.
