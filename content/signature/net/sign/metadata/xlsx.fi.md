...
############################# Head ############################
head_title: "Liitä metatietojen sähköiset allekirjoitukset Xlsx-asiakirjoihin C#:n kautta"
head_description: "Käytä metatietoja piilotettuina sähköisinä allekirjoituksina Xlsx-asiakirjoissasi käyttämällä pari riviä C#-koodia. Käytä GroupDocs Document Signature API:ta yrityksesi dokumenttien ja tiedostojen sähköiseen allekirjoittamiseen metatietotiedoilla."

############################# Header ############################
title: "Metatietojen sähköiset allekirjoitukset asiakirjalle Xlsx tuotteen .NET kautta ovat yksinkertaisia ​​ja helppokäyttöisiä!"
...
steps:
    enable: true
    title_left: "Vaiheet Xlsx:n allekirjoittamiseen Metadata -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Xlsx-asiakirjoja Metadata-allekirjoituksella nopeasti ja helposti.
