...
############################# Head ############################
head_title: "Pievienojiet metadatu elektroniskos parakstus Xlsx dokumentiem, izmantojot C#"
head_description: "Izmantojiet metadatus kā slēptos elektroniskos parakstus savos Xlsx dokumentos, izmantojot dažas C# koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar metadatu informāciju."

############################# Header ############################
title: "Metadatu elektroniskie paraksti dokumentam Xlsx, izmantojot .NET, ir vienkārši un ērti lietojami!"
description: "eParakstiet savus Xlsx dokumentus un līgumus ar slēptiem metadatu ierakstiem. Ģenerējiet metadatus PDF failiem, MS Word dokumentiem, MS Excel darbgrāmatām, MS PowerPoint prezentācijām un dažādiem attēlu formātiem bez problēmām un papildu kodēšanas."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Xlsx ar Metadata programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Xlsx dokumentus ar Metadata parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Xlsx parakstīšana, izmantojot Metadata tiešraides demonstrāciju"
    content: |
