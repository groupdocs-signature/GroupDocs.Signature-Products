...
############################# Head ############################
head_title: "Voeg elektronische handtekeningen met metagegevens toe aan Doc documenten via C#"
head_description: "Gebruik metadata als verborgen elektronische handtekeningen in uw Doc-documenten met een paar regels C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met metadata-informatie."

############################# Header ############################
title: "Metadata elektronische handtekeningen voor Doc document via .NET zijn eenvoudig en gemakkelijk te gebruiken!"
...
steps:
    enable: true
    title_left: "Stappen om Doc te ondertekenen met Metadata in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Doc documenten snel en gemakkelijk te ondertekenen met Metadata handtekeningen.
