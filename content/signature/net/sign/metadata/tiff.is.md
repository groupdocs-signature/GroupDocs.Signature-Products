...
############################# Head ############################
head_title: "Bættu rafrænum undirskriftum lýsigagna við Tiff skjöl í gegnum C#"
head_description: "Notaðu Lýsigögn sem falin rafræn undirskrift í Tiff skjölunum þínum með því að nota nokkrar línur af C# kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með upplýsingum um lýsigögn."

############################# Header ############################
title: "Rafrænar undirskriftir með lýsigögnum fyrir Tiff skjal í gegnum .NET eru einfaldar og auðveldar í notkun!"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Tiff með Metadata í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Tiff skjöl með Metadata undirskrift fljótt og auðveldlega.
