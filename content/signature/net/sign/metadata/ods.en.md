...
############################# Head ############################
head_title: "Append Metadata electronic signatures to the Ods documents via C#"
head_description: "Use Metadata as hidden electronic signatures incide the Ods documents for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with Metadata information."
