...
############################# Head ############################
head_title: "Anexar assinaturas eletrônicas de metadados a documentos Dotx via C#"
head_description: "Use metadados como assinaturas eletrônicas ocultas dentro de seus documentos Dotx usando algumas linhas de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com informações de metadados."

############################# Header ############################
title: "Assinaturas eletrônicas de metadados para o documento Dotx via .NET são simples e fáceis de usar!"
...
steps:
    enable: true
    title_left: "Etapas para assinar Dotx com Metadata em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Dotx com assinaturas Metadata de forma rápida e fácil.
