...
############################# Head ############################
head_title: "Anexar assinaturas eletrônicas de metadados a documentos Pptm via C#"
head_description: "Use metadados como assinaturas eletrônicas ocultas dentro de seus documentos Pptm usando algumas linhas de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com informações de metadados."

############################# Header ############################
title: "Assinaturas eletrônicas de metadados para o documento Pptm via .NET são simples e fáceis de usar!"
description: "Assine seus documentos e contratos Pptm com entradas de metadados ocultas. Gere metadados para PDFs, documentos do MS Word, pastas de trabalho do MS Excel, apresentações do MS PowerPoint e vários formatos de imagem sem problemas e codificação extra."
...
steps:
    enable: true
    title_left: "Etapas para assinar Pptm com Metadata em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Pptm com assinaturas Metadata de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Pptm documentos com Metadata Demonstração ao vivo"
    content: |
