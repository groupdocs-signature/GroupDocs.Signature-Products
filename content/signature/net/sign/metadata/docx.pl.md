...
############################# Head ############################
head_title: "Dołącz podpisy elektroniczne metadanych do dokumentów Docx za pośrednictwem C#"
head_description: "Użyj metadanych jako ukrytych podpisów elektronicznych w swoich dokumentach Docx, używając kilku wierszy kodu C#. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą informacji metadanych."

############################# Header ############################
title: "Elektroniczne podpisy metadanych dla dokumentu Docx za pośrednictwem .NET są proste i łatwe w użyciu!"
description: "Podpisz elektronicznie dokumenty i umowy Docx z ukrytymi wpisami metadanych. Generuj metadane dla plików PDF, dokumentów MS Word, skoroszytów MS Excel, prezentacji MS PowerPoint i różnych formatów obrazów bez problemów i dodatkowego kodowania."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Docx za pomocą Metadata w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Docx za pomocą podpisów Metadata.
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Docx za pomocą Metadata Demo na żywo"
    content: |
