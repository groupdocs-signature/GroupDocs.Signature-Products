...
############################# Head ############################
head_title: "Voeg elektronische handtekeningen met metagegevens toe aan Dot documenten via C#"
head_description: "Gebruik metadata als verborgen elektronische handtekeningen in uw Dot-documenten met een paar regels C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met metadata-informatie."

############################# Header ############################
title: "Metadata elektronische handtekeningen voor Dot document via .NET zijn eenvoudig en gemakkelijk te gebruiken!"
description: "Onderteken uw Dot documenten en contracten met verborgen metadata-items. Genereer probleemloos metadata voor PDF's, MS Word-documenten, MS Excel-werkmappen, MS PowerPoint-presentaties en verschillende afbeeldingsformaten."
...
steps:
    enable: true
    title_left: "Stappen om Dot te ondertekenen met Metadata in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Dot documenten snel en gemakkelijk te ondertekenen met Metadata handtekeningen.
...
demos:
    enable: true
    title: "Dot documenten ondertekenen met Metadata Live Demo"
    content: |
