...
############################# Head ############################
head_title: "Nối chữ ký điện tử Siêu dữ liệu vào tài liệu Xltx qua C#"
head_description: "Sử dụng Siêu dữ liệu làm chữ ký điện tử ẩn bên trong tài liệu Xltx của bạn bằng cách sử dụng một vài dòng mã C#. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp kinh doanh của bạn bằng thông tin Siêu dữ liệu."

############################# Header ############################
title: "Chữ ký điện tử siêu dữ liệu cho tài liệu Xltx qua .NET rất đơn giản và dễ sử dụng!"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Xltx bằng Metadata trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Xltx bằng chữ ký Metadata một cách nhanh chóng và dễ dàng.
