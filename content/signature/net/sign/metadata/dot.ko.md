...
steps:
    enable: true
    title_left: "C#에서 Metadata으로 Dot에 서명하는 단계"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/)은 Metadata 서명으로 Dot 문서에 빠르고 쉽게 서명할 수 있는 기능을 제공합니다.
