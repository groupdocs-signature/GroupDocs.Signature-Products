...
############################# Head ############################
head_title: "Pievienojiet metadatu elektroniskos parakstus Ott dokumentiem, izmantojot C#"
head_description: "Izmantojiet metadatus kā slēptos elektroniskos parakstus savos Ott dokumentos, izmantojot dažas C# koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar metadatu informāciju."

############################# Header ############################
title: "Metadatu elektroniskie paraksti dokumentam Ott, izmantojot .NET, ir vienkārši un ērti lietojami!"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Ott ar Metadata programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Ott dokumentus ar Metadata parakstiem.
