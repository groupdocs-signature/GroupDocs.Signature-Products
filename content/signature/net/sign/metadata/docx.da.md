...
############################# Head ############################
head_title: "Tilføj metadata elektroniske signaturer til Docx dokumenter via C#"
head_description: "Brug Metadata som skjulte elektroniske signaturer i dine Docx-dokumenter ved at bruge et par linjer med C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med metadataoplysninger."

############################# Header ############################
title: "Metadata elektroniske signaturer for Docx dokument via .NET er enkle og nemme at bruge!"
description: "eSignér dine Docx dokumenter og kontrakter med skjulte metadataposter. Generer metadata til PDF'er, MS Word-dokumenter, MS Excel-projektmapper, MS PowerPoint-præsentationer og forskellige billedformater uden problemer og ekstra kodning."
...
steps:
    enable: true
    title_left: "Trin til at signere Docx med Metadata i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Docx dokumenter med Metadata signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Docx dokumenter med Metadata Live Demo"
    content: |
