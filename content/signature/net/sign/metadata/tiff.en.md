...
############################# Head ############################
head_title: "Append Metadata electronic signatures to Tiff documents via C#"
head_description: "Use Metadata as hidden electronic signatures inside your Tiff documents using a couple lines of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with Metadata information."

############################# Header ############################
title: "Metadata electronic signatures for Tiff document via .NET are simple and easy for using!"
...
steps:
    enable: true
    title_left: "Steps to sign Tiff with Metadata in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Tiff documents with Metadata signatures quickly and easily.
