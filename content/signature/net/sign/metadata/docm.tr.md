...
############################# Head ############################
head_title: "C# aracılığıyla Docm belgelerine Meta Veri elektronik imzaları ekleyin"
head_description: "Meta Verileri, birkaç satır C# kodu kullanarak Docm belgelerinizin içinde gizli elektronik imzalar olarak kullanın. İş belgelerinizi ve dosyalarınızı Meta Veri bilgileriyle e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: ".NET aracılığıyla Docm belgesi için meta veri elektronik imzaları basit ve kullanımı kolaydır!"
description: "Gizli Meta Veri girişleriyle Docm belgelerinizi ve sözleşmelerinizi e-imzalayın. PDF'ler, MS Word belgeleri, MS Excel çalışma kitapları, MS PowerPoint sunumları ve çeşitli görüntü formatları için sorunsuz ve ekstra kodlama olmadan Meta Veriler oluşturun."
...
steps:
    enable: true
    title_left: "C# içinde Metadata ile Docm imzalama adımları"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Docm belgelerini Metadata imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Docm dokümanı Metadata Canlı Demo ile imzalama"
    content: |
