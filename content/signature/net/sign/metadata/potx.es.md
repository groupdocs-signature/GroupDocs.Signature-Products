...
steps:
    enable: true
    title_left: "Pasos para firmar Potx con Metadata en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Potx con Metadata firmas de forma rápida y sencilla.
