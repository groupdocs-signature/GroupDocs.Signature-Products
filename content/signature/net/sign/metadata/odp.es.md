...
steps:
    enable: true
    title_left: "Pasos para firmar Odp con Metadata en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Odp con Metadata firmas de forma rápida y sencilla.
