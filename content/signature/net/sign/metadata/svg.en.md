...
############################# Head ############################
head_title: "Append Metadata electronic signatures to Svg documents via C#"
head_description: "Use Metadata as hidden electronic signatures inside your Svg documents using a couple lines of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with Metadata information."

############################# Header ############################
title: "Metadata electronic signatures for Svg document via .NET are simple and easy for using!"
