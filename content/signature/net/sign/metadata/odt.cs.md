...
############################# Head ############################
head_title: "Připojte elektronické podpisy metadat k dokumentům Odt prostřednictvím C#"
head_description: "Použijte metadata jako skryté elektronické podpisy ve svých dokumentech Odt pomocí několika řádků kódu C#. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí metadat."

############################# Header ############################
title: "Elektronické podpisy metadat pro dokument Odt prostřednictvím .NET jsou jednoduché a snadno se používají!"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Odt pomocí Metadata v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Odt pomocí podpisů Metadata.
