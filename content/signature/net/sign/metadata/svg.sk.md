...
############################# Head ############################
head_title: "Pripojte elektronické podpisy metadát k dokumentom Svg cez C#"
head_description: "Použite metadáta ako skryté elektronické podpisy vo svojich dokumentoch Svg pomocou niekoľkých riadkov kódu C#. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou informácií o metadátach."

############################# Header ############################
title: "Elektronické podpisy metadát pre dokument Svg prostredníctvom .NET sú jednoduché a ľahko sa používajú!"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Svg pomocou Metadata v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Svg pomocou podpisov Metadata.
