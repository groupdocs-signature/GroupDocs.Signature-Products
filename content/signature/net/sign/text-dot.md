...
head_description: "Put TEXT Signature on DOT file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Operating TEXT Signatures in .DOT files with C#"
...
steps:
    enable: true
    title_left: "Steps to sign DOT with TEXT in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign DOT documents with TEXT signatures quick and easily.
