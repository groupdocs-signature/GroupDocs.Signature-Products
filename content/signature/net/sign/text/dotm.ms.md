...
############################# Head ############################
head_title: "Cipta tandatangan elektronik Teks ke fail Dotm dengan C#"
head_description: "Letakkan Text eSignature pada fail Dotm untuk .NET menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Dotm dengan tandatangan Text dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Dotm dengan Text dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Dotm dengan tandatangan Text dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Dotm dengan Text Demo Langsung"
    content: |
