...
############################# Head ############################
head_title: "Crie assinaturas eletrônicas de texto para o arquivo Csv com C#"
head_description: "Coloque Text eSignature no arquivo Csv para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Csv arquivos com assinaturas Text em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Csv com Text em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Csv com assinaturas Text de forma rápida e fácil.
