...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Webp käyttämällä C#"
head_description: "Aseta Text eSignature Webp-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Webp tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Webp:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Webp-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
