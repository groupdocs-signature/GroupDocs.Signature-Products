...
############################# Head ############################
head_title: "Cipta tandatangan elektronik Teks ke fail Bmp dengan C#"
head_description: "Letakkan Text eSignature pada fail Bmp untuk .NET menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Bmp dengan tandatangan Text dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Bmp dengan Text dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Bmp dengan tandatangan Text dengan cepat dan mudah.
