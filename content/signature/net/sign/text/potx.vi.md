...
############################# Head ############################
head_title: "Tạo chữ ký điện tử Văn bản vào tệp Potx với C#"
head_description: "Đặt Text eSignature vào tệp Potx cho .NET bằng cách sử dụng một vài dòng mã. Sử dụng API chữ ký tài liệu GroupDocs để ký hàng chục định dạng tệp."

############################# Header ############################
title: "Ký các tệp Potx bằng chữ ký Text trong C#"
description: "Cách thêm Chữ ký Text bằng một vài dòng mã .NET"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Potx bằng Text trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Potx bằng chữ ký Text một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Potx bằng Text Live Demo"
    content: |
...
more_formats:
    enable: true
    title: "Các chữ ký Text được hỗ trợ khác cho C#"
    content: |
