...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Zip rakendusega C#"
head_description: "Pane Text e-allkiri .NET-faili Zip, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Zip allkirjadega Text rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Zip allkirjastamiseks rakendusega Text rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Zip dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Zip allkirjastamine Text reaalajas demoga"
    content: |
