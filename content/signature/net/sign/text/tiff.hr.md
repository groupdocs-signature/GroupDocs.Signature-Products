...
############################# Head ############################
head_title: "Stvorite tekstualne elektroničke potpise u datoteku Tiff s C#"
head_description: "Stavite e-potpis Text na datoteku Tiff za .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Tiff datoteke s Text potpisima u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Tiff s Text u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Tiff dokumenata s Text potpisima.
