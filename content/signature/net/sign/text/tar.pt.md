...
############################# Head ############################
head_title: "Crie assinaturas eletrônicas de texto para o arquivo Tar com C#"
head_description: "Coloque Text eSignature no arquivo Tar para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Tar arquivos com assinaturas Text em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Tar com Text em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Tar com assinaturas Text de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Tar documentos com Text Demonstração ao vivo"
    content: |
