...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Odp pomocí C#"
head_description: "Vložte elektronický podpis Text do souboru Odp pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Odp pomocí podpisů Text v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Odp pomocí Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Odp pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Odp pomocí živé ukázky Text"
    content: |
