...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Otp fájlhoz a C# segítségével"
head_description: "Helyezze a Text eSignature-t a .NET Otp fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Otp fájl aláírása Text aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Otp aláírásának lépései a Text segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Otp dokumentumok gyors és egyszerű aláírását Text aláírással.
