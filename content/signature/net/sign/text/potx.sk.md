...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Potx pomocou C#"
head_description: "Vložte elektronický podpis Text do súboru Potx pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Potx pomocou podpisov Text v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Potx pomocou Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Potx pomocou podpisov Text.
