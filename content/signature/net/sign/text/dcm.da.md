...
############################# Head ############################
head_title: "Opret elektroniske tekstsignaturer til filen Dcm med C#"
head_description: "Sæt Text eSignature på filen Dcm for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."
...
steps:
    enable: true
    title_left: "Trin til at signere Dcm med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Dcm dokumenter med Text signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Dcm dokumenter med Text Live Demo"
    content: |
