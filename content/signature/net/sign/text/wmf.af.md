...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Wmf lêer met C#"
head_description: "Plaas Text eSignature op Wmf lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Wmf lêers met Text handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Wmf met Text in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Wmf dokumente met Text handtekeninge vinnig en maklik te onderteken.
