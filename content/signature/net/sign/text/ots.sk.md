...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Ots pomocou C#"
head_description: "Vložte elektronický podpis Text do súboru Ots pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Ots pomocou podpisov Text v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Ots pomocou Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Ots pomocou podpisov Text.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Ots pomocou živej ukážky Text"
    content: |
