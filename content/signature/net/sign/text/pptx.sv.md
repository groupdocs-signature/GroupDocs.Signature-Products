...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen Pptx med C#"
head_description: "Sätt Text eSignature på filen Pptx för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Pptx-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Pptx med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Pptx-dokument med Text-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Pptx dokument med Text Live Demo"
    content: |
