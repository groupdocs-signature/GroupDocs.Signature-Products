...
############################# Head ############################
head_title: "Erstellen Sie mit C# elektronische Textsignaturen für die Ott-Datei"
head_description: "Fügen Sie Text eSignature in Ott-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Ott-Dateien mit Text-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Ott mit Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Ott-Dokumente mit Text-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Ott-Dokumenten mit Text Live-Demo"
    content: |
