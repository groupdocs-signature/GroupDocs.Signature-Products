...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Bmp pomocou C#"
head_description: "Vložte elektronický podpis Text do súboru Bmp pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Bmp pomocou podpisov Text v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Bmp pomocou Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Bmp pomocou podpisov Text.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Bmp pomocou živej ukážky Text"
    content: |
