...
############################# Head ############################
head_title: "Crie assinaturas eletrônicas de texto para o arquivo Svg com C#"
head_description: "Coloque Text eSignature no arquivo Svg para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Svg arquivos com assinaturas Text em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Svg com Text em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Svg com assinaturas Text de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Svg documentos com Text Demonstração ao vivo"
    content: |
