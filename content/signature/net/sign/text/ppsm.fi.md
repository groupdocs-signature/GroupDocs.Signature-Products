...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Ppsm käyttämällä C#"
head_description: "Aseta Text eSignature Ppsm-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Ppsm tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Ppsm:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Ppsm-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
