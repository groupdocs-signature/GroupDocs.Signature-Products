...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Potm käyttämällä C#"
head_description: "Aseta Text eSignature Potm-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Potm tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Potm:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Potm-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
