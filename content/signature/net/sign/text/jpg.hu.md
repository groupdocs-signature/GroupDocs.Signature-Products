...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Jpg fájlhoz a C# segítségével"
head_description: "Helyezze a Text eSignature-t a .NET Jpg fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Jpg fájl aláírása Text aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Jpg aláírásának lépései a Text segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Jpg dokumentumok gyors és egyszerű aláírását Text aláírással.
...
demos:
    enable: true
    title: "Jpg dokumentumok aláírása Text élő bemutatóval"
    content: |
