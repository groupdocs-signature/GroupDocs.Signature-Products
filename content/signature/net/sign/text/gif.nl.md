...
############################# Head ############################
head_title: "Maak elektronische teksthandtekeningen naar een Gif-bestand met C#"
head_description: "Zet Text eSignature op Gif bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Gif bestanden met Text handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Gif te ondertekenen met Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Gif documenten snel en gemakkelijk te ondertekenen met Text handtekeningen.
