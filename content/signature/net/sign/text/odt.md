...
breadcrumb: Create TEXT signature on ODT for C#

############################# Head ############################
head_title: "Adding TEXT signatures in a ODT file with C#"
head_description: "Put TEXT Signature on ODT file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your ODT files with TEXT signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
        You can put TEXT on ODT file in a very convenient way and for free. Besides that it is possible to sign ODT files using advanced TEXT options. 
        ...
        * furthermore file can be encrypted with password or saved to memory stream.
        ...
        Signing ODT files with TEXT provides vast amount opportunities for users. Moreover there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc.
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign ODT documents with TEXT signatures quick and easily.
...
demos:
    ...
    content: |
       Sign ODT file with TEXT signature right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website. Free online demo waiting for you.
