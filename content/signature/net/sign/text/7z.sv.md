...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen 7z med C#"
head_description: "Sätt Text eSignature på filen 7z för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera 7z-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera 7z med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera 7z-dokument med Text-signaturer snabbt och enkelt.
