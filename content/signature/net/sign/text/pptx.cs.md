...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Pptx pomocí C#"
head_description: "Vložte elektronický podpis Text do souboru Pptx pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Pptx pomocí podpisů Text v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Pptx pomocí Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Pptx pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Pptx pomocí živé ukázky Text"
    content: |
