...
############################# Head ############################
head_title: "Maak elektronische teksthandtekeningen naar een Ppsx-bestand met C#"
head_description: "Zet Text eSignature op Ppsx bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Ppsx bestanden met Text handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Ppsx te ondertekenen met Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Ppsx documenten snel en gemakkelijk te ondertekenen met Text handtekeningen.
