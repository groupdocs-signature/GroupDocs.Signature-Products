...
############################# Head ############################
head_title: "Sukurkite tekstinius elektroninius parašus į failą Odt naudodami C#"
head_description: "Įdėkite Text el. parašą į Odt failą, skirtą .NET, naudodami kelias kodo eilutes. Norėdami pasirašyti daugybę failų formatų, naudokite GroupDocs Document Signature API."

############################# Header ############################
title: "Pasirašykite Odt failus naudodami Text parašus C#"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Odt naudojant Text programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Odt dokumentus su Text parašais.
...
demos:
    enable: true
    title: "Dokumentų Odt pasirašymas naudojant Text tiesioginę demonstraciją"
    content: |
