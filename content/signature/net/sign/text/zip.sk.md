...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Zip pomocou C#"
head_description: "Vložte elektronický podpis Text do súboru Zip pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Zip pomocou podpisov Text v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Zip pomocou Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Zip pomocou podpisov Text.
