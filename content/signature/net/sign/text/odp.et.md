...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Odp rakendusega C#"
head_description: "Pane Text e-allkiri .NET-faili Odp, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Odp allkirjadega Text rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Odp allkirjastamiseks rakendusega Text rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Odp dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Odp allkirjastamine Text reaalajas demoga"
    content: |
