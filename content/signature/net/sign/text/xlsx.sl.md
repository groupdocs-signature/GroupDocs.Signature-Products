...
############################# Head ############################
head_title: "Ustvarite besedilne elektronske podpise v datoteko Xlsx z C#"
head_description: "Vstavite e-podpis Text v datoteko Xlsx za .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Xlsx datoteke s podpisi Text v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Xlsx z Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Xlsx s podpisi Text.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Xlsx z Text Live Demo"
    content: |
