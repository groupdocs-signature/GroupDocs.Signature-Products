...
############################# Head ############################
head_title: "Ji bo pelê Svg bi C# re îmzeyên elektronîkî yên nivîsê biafirînin"
head_description: "Ji bo .NET Text eSignature li ser pela Svg bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Svg bi îmzeyên Text di C# de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Svg bi Text di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Svg bi îmzeyên Text zû û bi hêsanî peyda dike.
