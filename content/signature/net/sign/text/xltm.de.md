...
############################# Head ############################
head_title: "Erstellen Sie mit C# elektronische Textsignaturen für die Xltm-Datei"
head_description: "Fügen Sie Text eSignature in Xltm-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Xltm-Dateien mit Text-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Xltm mit Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Xltm-Dokumente mit Text-Signaturen schnell und einfach zu signieren.
