...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Otp rakendusega C#"
head_description: "Pane Text e-allkiri .NET-faili Otp, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Otp allkirjadega Text rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Otp allkirjastamiseks rakendusega Text rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Otp dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Otp allkirjastamine Text reaalajas demoga"
    content: |
