...
############################# Head ############################
head_title: "Создайте текстовые электронные подписи для файла Odp с помощью C#"
head_description: "Поместите электронную подпись Text в файл Odp для .NET, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "Подпишите файлы Odp с подписями Text в C#"
...
steps:
    enable: true
    title_left: "Действия по подписанию Odp с помощью Text в C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) позволяет быстро и легко подписывать документы Odp с подписями Text.
