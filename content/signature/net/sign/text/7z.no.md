...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen 7z med C#"
head_description: "Sett Text eSignature på 7z-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer 7z-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere 7z med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere 7z-dokumenter med Text-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av 7z dokumenter med Text Live Demo"
    content: |
