...
############################# Head ############################
head_title: "Maak elektronische teksthandtekeningen naar een Wmf-bestand met C#"
head_description: "Zet Text eSignature op Wmf bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Wmf bestanden met Text handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Wmf te ondertekenen met Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Wmf documenten snel en gemakkelijk te ondertekenen met Text handtekeningen.
...
demos:
    enable: true
    title: "Wmf documenten ondertekenen met Text Live Demo"
    content: |
