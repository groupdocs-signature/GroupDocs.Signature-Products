...
############################# Head ############################
head_title: "Opret elektroniske tekstsignaturer til filen Doc med C#"
head_description: "Sæt Text eSignature på filen Doc for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Doc-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trin til at signere Doc med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Doc dokumenter med Text signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Doc dokumenter med Text Live Demo"
    content: |
