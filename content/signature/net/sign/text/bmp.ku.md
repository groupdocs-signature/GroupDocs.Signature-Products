...
############################# Head ############################
head_title: "Ji bo pelê Bmp bi C# re îmzeyên elektronîkî yên nivîsê biafirînin"
head_description: "Ji bo .NET Text eSignature li ser pela Bmp bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Bmp bi îmzeyên Text di C# de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Bmp bi Text di C# de"
    content_left: |
