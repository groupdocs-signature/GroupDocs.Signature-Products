...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen Dotx med C#"
head_description: "Sätt Text eSignature på filen Dotx för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Dotx-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Dotx med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Dotx-dokument med Text-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Dotx dokument med Text Live Demo"
    content: |
