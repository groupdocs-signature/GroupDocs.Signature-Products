...
############################# Head ############################
head_title: "Create Text electronic signatures to Doc file with C#"
head_description: "Put Text eSignature on Doc file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "Sign Doc files with Text signatures in C#"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Doc documents with Text signatures quickly and easily.
