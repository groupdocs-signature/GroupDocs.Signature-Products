...
############################# Head ############################
head_title: "Maak elektronische teksthandtekeningen naar een Odp-bestand met C#"
head_description: "Zet Text eSignature op Odp bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Odp bestanden met Text handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Odp te ondertekenen met Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Odp documenten snel en gemakkelijk te ondertekenen met Text handtekeningen.
