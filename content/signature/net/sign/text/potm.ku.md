...
############################# Head ############################
head_title: "Ji bo pelê Potm bi C# re îmzeyên elektronîkî yên nivîsê biafirînin"
head_description: "Ji bo .NET Text eSignature li ser pela Potm bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Potm bi îmzeyên Text di C# de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Potm bi Text di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Potm bi îmzeyên Text zû û bi hêsanî peyda dike.
