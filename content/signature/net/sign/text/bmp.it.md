...
############################# Head ############################
head_title: "Crea firme elettroniche di testo su file Bmp con C#"
head_description: "Inserisci Text eSignature nel file Bmp per .NET utilizzando poche righe di codice. Usa l'API per la firma dei documenti di GroupDocs per firmare decine di formati di file."

############################# Header ############################
title: "Firma file Bmp con firme Text in C#"
...
steps:
    enable: true
    title_left: "Passaggi per firmare Bmp con Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Bmp con firme Text in modo rapido e semplice.
...
demos:
    enable: true
    title: "Firma di documenti Bmp con Text Demo live"
    content: |
