...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Docm rakendusega C#"
head_description: "Pane Text e-allkiri .NET-faili Docm, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Docm allkirjadega Text rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Docm allkirjastamiseks rakendusega Text rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Docm dokumente Text allkirjaga.
