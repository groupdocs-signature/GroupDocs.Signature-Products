...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Pptm käyttämällä C#"
head_description: "Aseta Text eSignature Pptm-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Pptm tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Pptm:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Pptm-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
