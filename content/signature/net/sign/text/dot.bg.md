...
############################# Head ############################
head_title: "Създайте текстови електронни подписи към Dot файл с C#"
head_description: "Поставете електронен подпис Text във файл Dot за .NET, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature, за да подписвате десетки файлови формати."

############################# Header ############################
title: "Подпишете Dot файлове с Text подписи в C#"
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Dot с Text в C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя възможност за бързо и лесно подписване на Dot документи с Text подписи.
