...
############################# Head ############################
head_title: "C# ile Svg dosyasına Metin elektronik imzaları oluşturun"
head_description: "Birkaç satır kod kullanarak .NET için Svg dosyasına Text eSignature koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Svg dosyalarını Text imzasıyla C# içinde imzalayın"
...
steps:
    enable: true
    title_left: "C# içinde Text ile Svg imzalama adımları"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Svg belgelerini Text imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Svg dokümanı Text Canlı Demo ile imzalama"
    content: |
