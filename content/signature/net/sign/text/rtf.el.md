...
############################# Head ############################
head_title: "Δημιουργία ηλεκτρονικών υπογραφών κειμένου σε αρχείο Rtf με C#"
head_description: "Τοποθετήστε το Text eSignature στο αρχείο Rtf για το .NET χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε δεκάδες μορφές αρχείων."

############################# Header ############################
title: "Υπογράψτε αρχεία Rtf με υπογραφές Text στο C#"
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Rtf με Text στο C#"
    content_left: |
        Το [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) παρέχει τη δυνατότητα υπογραφής εγγράφων Rtf με υπογραφές Text γρήγορα και εύκολα.
