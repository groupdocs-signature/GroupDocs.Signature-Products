...
############################# Head ############################
head_title: "Utwórz tekstowe podpisy elektroniczne do pliku Jpg za pomocą C#"
head_description: "Umieść Text eSignature w pliku Jpg dla .NET, używając kilku linijek kodu. Użyj interfejsu GroupDocs Document Signature API, aby podpisać dziesiątki formatów plików."

############################# Header ############################
title: "Podpisz pliki Jpg z podpisami Text w C#"
...
steps:
    enable: true
    title_left: "Kroki do podpisania Jpg za pomocą Text w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Jpg za pomocą podpisów Text.
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Jpg za pomocą Text Demo na żywo"
    content: |
