...
############################# Head ############################
head_title: "Ստեղծեք տեքստային էլեկտրոնային ստորագրություններ Xls ֆայլում C#-ով"
head_description: "Տեղադրեք Text eSignature-ը Xls ֆայլում .NET-ի համար՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տասնյակ ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստորագրեք Xls ֆայլեր Text ստորագրություններով C#-ում"
...
steps:
    enable: true
    title_left: "Xls-ը Text-ով C#-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Xls փաստաթղթերը Text ստորագրություններով:
