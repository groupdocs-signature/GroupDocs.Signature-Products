...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Svg rakendusega C#"
head_description: "Pane Text e-allkiri .NET-faili Svg, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Svg allkirjadega Text rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Svg allkirjastamiseks rakendusega Text rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Svg dokumente Text allkirjaga.
