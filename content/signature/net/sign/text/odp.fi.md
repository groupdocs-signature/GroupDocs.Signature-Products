...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Odp käyttämällä C#"
head_description: "Aseta Text eSignature Odp-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Odp tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Odp:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Odp-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
