...
############################# Head ############################
head_title: "Cipta tandatangan elektronik Teks ke fail Xltx dengan C#"
head_description: "Letakkan Text eSignature pada fail Xltx untuk .NET menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Xltx dengan tandatangan Text dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xltx dengan Text dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Xltx dengan tandatangan Text dengan cepat dan mudah.
