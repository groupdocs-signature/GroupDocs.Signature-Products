...
############################# Head ############################
head_title: "Izveidojiet teksta elektroniskos parakstus failam Xls, izmantojot C#"
head_description: "Ievietojiet Text eParaksts Xls failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Xls failus ar Text parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Xls ar Text programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Xls dokumentus ar Text parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Xls parakstīšana, izmantojot Text tiešraides demonstrāciju"
    content: |
