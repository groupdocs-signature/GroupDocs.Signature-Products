...
breadcrumb: Create TEXT signature on JPEG for C#

############################# Head ############################
head_title: "Adding TEXT signatures in a JPEG file with C#"
head_description: "Put TEXT Signature on JPEG file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .JPEG files with TEXT signatures in C#"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your JPEG files with TEXT signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
        You can put TEXT on JPEG file in a very convenient way and for free. Besides that it is possible to sign JPEG files using advanced TEXT options. 
        ...
        * furthermore file can be encrypted with password or saved to memory stream.
        ...
        Signing JPEG files with TEXT provides vast amount opportunities for users. Moreover there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc.


############################# Steps ############################
steps:
    enable: true
    title_left: "Steps to sign JPEG with TEXT in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign JPEG documents with TEXT signatures quick and easily.
...
demos:
    enable: true
    title: "Signing JPEG documents with TEXT Live Demo"
    content: |
       Sign JPEG file with TEXT signature right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website. Free online demo waiting for you.
