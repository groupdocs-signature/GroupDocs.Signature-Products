...
############################# Head ############################
head_title: "Opret elektroniske tekstsignaturer til filen Xltx med C#"
head_description: "Sæt Text eSignature på filen Xltx for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Xltx-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trin til at signere Xltx med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Xltx dokumenter med Text signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Xltx dokumenter med Text Live Demo"
    content: |
