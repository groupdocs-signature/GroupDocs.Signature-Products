...
############################# Head ############################
head_title: "Izveidojiet teksta elektroniskos parakstus failam Tiff, izmantojot C#"
head_description: "Ievietojiet Text eParaksts Tiff failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Tiff failus ar Text parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Tiff ar Text programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Tiff dokumentus ar Text parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Tiff parakstīšana, izmantojot Text tiešraides demonstrāciju"
    content: |
