...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Docm pomocí C#"
head_description: "Vložte elektronický podpis Text do souboru Docm pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Docm pomocí podpisů Text v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Docm pomocí Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Docm pomocí podpisů Text.
