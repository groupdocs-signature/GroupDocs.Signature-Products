...
############################# Head ############################
head_title: "Ustvarite besedilne elektronske podpise v datoteko Dot z C#"
head_description: "Vstavite e-podpis Text v datoteko Dot za .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Dot datoteke s podpisi Text v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Dot z Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Dot s podpisi Text.
