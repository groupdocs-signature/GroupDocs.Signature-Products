...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Bmp rakendusega C#"
head_description: "Pane Text e-allkiri .NET-faili Bmp, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Bmp allkirjadega Text rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Bmp allkirjastamiseks rakendusega Text rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Bmp dokumente Text allkirjaga.
