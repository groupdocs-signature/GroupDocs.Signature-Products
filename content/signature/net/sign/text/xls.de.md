...
############################# Head ############################
head_title: "Erstellen Sie mit C# elektronische Textsignaturen für die Xls-Datei"
head_description: "Fügen Sie Text eSignature in Xls-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Xls-Dateien mit Text-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Xls mit Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Xls-Dokumente mit Text-Signaturen schnell und einfach zu signieren.
