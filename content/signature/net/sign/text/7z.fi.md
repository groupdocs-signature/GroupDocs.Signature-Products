...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon 7z käyttämällä C#"
head_description: "Aseta Text eSignature 7z-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita 7z tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet 7z:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa 7z-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
