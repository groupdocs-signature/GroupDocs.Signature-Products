...
############################# Head ############################
head_title: "Izveidojiet teksta elektroniskos parakstus failam Pdf, izmantojot C#"
head_description: "Ievietojiet Text eParaksts Pdf failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Pdf failus ar Text parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Pdf ar Text programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Pdf dokumentus ar Text parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Pdf parakstīšana, izmantojot Text tiešraides demonstrāciju"
    content: |
