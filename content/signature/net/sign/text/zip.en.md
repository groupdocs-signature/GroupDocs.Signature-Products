...
############################# Head ############################
head_title: "Create Text electronic signatures to Zip file with C#"
head_description: "Put Text eSignature on Zip file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "Sign Zip files with Text signatures in C#"
...
steps:
    enable: true
    title_left: "Steps to sign Zip with Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Zip documents with Text signatures quickly and easily.
...
demos:
    enable: true
    title: "Signing Zip documents with Text Live Demo"
    content: |
