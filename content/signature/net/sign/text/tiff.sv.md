...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen Tiff med C#"
head_description: "Sätt Text eSignature på filen Tiff för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Tiff-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Tiff med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Tiff-dokument med Text-signaturer snabbt och enkelt.
