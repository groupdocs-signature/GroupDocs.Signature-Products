...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Tiff käyttämällä C#"
head_description: "Aseta Text eSignature Tiff-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Tiff tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Tiff:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Tiff-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Tiff asiakirjoja Text Live-demolla"
    content: |
