...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Doc lêer met C#"
head_description: "Plaas Text eSignature op Doc lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Doc lêers met Text handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Doc met Text in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Doc dokumente met Text handtekeninge vinnig en maklik te onderteken.
