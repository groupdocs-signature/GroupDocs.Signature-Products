...
############################# Head ############################
head_title: "Створіть текстові електронні підписи до файлу Xltm за допомогою C#"
head_description: "Додайте електронний підпис Text у файл Xltm для .NET за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs, щоб підписувати десятки форматів файлів."

############################# Header ############################
title: "Підпишіть файли Xltm підписами Text у C#"
...
steps:
    enable: true
    title_left: "Кроки для підпису Xltm за допомогою Text у C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає можливість швидко та легко підписувати документи Xltm за допомогою підписів Text.
