...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Png rakendusega C#"
head_description: "Pane Text e-allkiri .NET-faili Png, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Png allkirjadega Text rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Png allkirjastamiseks rakendusega Text rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Png dokumente Text allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Png allkirjastamine Text reaalajas demoga"
    content: |
