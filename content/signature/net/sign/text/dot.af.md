...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Dot lêer met C#"
head_description: "Plaas Text eSignature op Dot lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Dot lêers met Text handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Dot met Text in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Dot dokumente met Text handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Dot dokumente met Text Regstreekse Demo"
    content: |
