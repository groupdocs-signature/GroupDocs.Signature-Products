...
############################# Head ############################
head_title: "Erstellen Sie mit C# elektronische Textsignaturen für die Odt-Datei"
head_description: "Fügen Sie Text eSignature in Odt-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Odt-Dateien mit Text-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Odt mit Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Odt-Dokumente mit Text-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Odt-Dokumenten mit Text Live-Demo"
    content: |
