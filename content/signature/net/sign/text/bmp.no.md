...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Bmp med C#"
head_description: "Sett Text eSignature på Bmp-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."
...
steps:
    enable: true
    title_left: "Trinn for å signere Bmp med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Bmp-dokumenter med Text-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Bmp dokumenter med Text Live Demo"
    content: |
