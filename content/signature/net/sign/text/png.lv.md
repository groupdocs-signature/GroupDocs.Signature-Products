...
############################# Head ############################
head_title: "Izveidojiet teksta elektroniskos parakstus failam Png, izmantojot C#"
head_description: "Ievietojiet Text eParaksts Png failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Png failus ar Text parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Png ar Text programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Png dokumentus ar Text parakstiem.
