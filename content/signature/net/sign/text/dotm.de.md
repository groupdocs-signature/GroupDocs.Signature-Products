...
############################# Head ############################
head_title: "Hinzufügen von Text-Signaturen zur Dotm-Datei mit C#"
head_description: "Fügen Sie die Text-Signatur in die Dotm-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Dotm-Dateien mit Text-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Dotm mit Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Dotm-Dokumente mit Text-Signaturen schnell und einfach zu signieren.
