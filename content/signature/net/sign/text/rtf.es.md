...
############################# Head ############################
head_title: "Cree firmas electrónicas de texto en un archivo Rtf con C#"
head_description: "Coloque Text eSignature en el archivo Rtf para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "Firme Rtf archivos con Text firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Rtf con Text en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Rtf con Text firmas de forma rápida y sencilla.
