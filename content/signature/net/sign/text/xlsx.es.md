...
############################# Head ############################
head_title: "Cree firmas electrónicas de texto en un archivo Xlsx con C#"
head_description: "Coloque Text eSignature en el archivo Xlsx para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "Firme Xlsx archivos con Text firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Xlsx con Text en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Xlsx con Text firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Xlsx documentos con Text Live Demo"
    content: |
