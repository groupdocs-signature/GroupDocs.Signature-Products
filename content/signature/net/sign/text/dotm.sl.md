...
############################# Head ############################
head_title: "Ustvarite besedilne elektronske podpise v datoteko Dotm z C#"
head_description: "Vstavite e-podpis Text v datoteko Dotm za .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Dotm datoteke s podpisi Text v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Dotm z Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Dotm s podpisi Text.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Dotm z Text Live Demo"
    content: |
