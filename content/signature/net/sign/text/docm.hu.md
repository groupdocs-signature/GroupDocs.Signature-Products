...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Docm fájlhoz a C# segítségével"
head_description: "Helyezze a Text eSignature-t a .NET Docm fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Docm fájl aláírása Text aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Docm aláírásának lépései a Text segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Docm dokumentumok gyors és egyszerű aláírását Text aláírással.
...
demos:
    enable: true
    title: "Docm dokumentumok aláírása Text élő bemutatóval"
    content: |
