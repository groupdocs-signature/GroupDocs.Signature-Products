...
############################# Head ############################
head_title: "C#을(를) 사용하여 Ots 파일에 텍스트 전자 서명 생성"
head_description: "몇 줄의 코드를 사용하여 .NET의 Ots 파일에 Text eSignature를 넣습니다. GroupDocs 문서 서명 API를 사용하여 수십 가지 파일 형식에 서명합니다."

############################# Header ############################
title: "C#에서 Text 서명으로 Ots 파일 서명"
...
steps:
    enable: true
    title_left: "C#에서 Text으로 Ots에 서명하는 단계"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/)은 Text 서명으로 Ots 문서에 빠르고 쉽게 서명할 수 있는 기능을 제공합니다.
