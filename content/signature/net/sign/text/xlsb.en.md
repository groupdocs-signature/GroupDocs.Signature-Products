...
############################# Head ############################
head_title: "Create Text electronic signatures to Xlsb file with C#"
head_description: "Put Text eSignature on Xlsb file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "Sign Xlsb files with Text signatures in C#"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Xlsb documents with Text signatures quickly and easily.
