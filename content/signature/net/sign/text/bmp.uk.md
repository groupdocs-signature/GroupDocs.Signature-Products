...
############################# Head ############################
head_title: "Створіть текстові електронні підписи до файлу Bmp за допомогою C#"
head_description: "Додайте електронний підпис Text у файл Bmp для .NET за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs, щоб підписувати десятки форматів файлів."

############################# Header ############################
title: "Підпишіть файли Bmp підписами Text у C#"
...
steps:
    enable: true
    title_left: "Кроки для підпису Bmp за допомогою Text у C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає можливість швидко та легко підписувати документи Bmp за допомогою підписів Text.
...
demos:
    enable: true
    title: "Підпис документів Bmp за допомогою Text Live Demo"
    content: |
