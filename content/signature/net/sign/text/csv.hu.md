...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Csv fájlhoz a C# segítségével"
head_description: "Helyezze a Text eSignature-t a .NET Csv fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Csv fájl aláírása Text aláírással a C# alkalmazásban"
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Csv dokumentumok gyors és egyszerű aláírását Text aláírással.
