...
############################# Head ############################
head_title: "Cruthaigh sínithe leictreonacha Téacs chun Ppt a chomhdú le C#"
head_description: "Cuir Text eSignature ar Ppt comhad le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Ppt comhad le sínithe Text in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Ppt a shíniú le Text in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Ppt a shíniú le sínithe Text go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Ppt doiciméad le Text Taispeántas Beo"
    content: |
