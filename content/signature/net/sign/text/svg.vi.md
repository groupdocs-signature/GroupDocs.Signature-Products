...
############################# Head ############################
head_title: "Tạo chữ ký điện tử Văn bản vào tệp Svg với C#"
head_description: "Đặt Text eSignature vào tệp Svg cho .NET bằng cách sử dụng một vài dòng mã. Sử dụng API chữ ký tài liệu GroupDocs để ký hàng chục định dạng tệp."

############################# Header ############################
title: "Ký các tệp Svg bằng chữ ký Text trong C#"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Svg bằng Text trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Svg bằng chữ ký Text một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Svg bằng Text Live Demo"
    content: |
