...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Svg käyttämällä C#"
head_description: "Aseta Text eSignature Svg-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Svg tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Svg:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Svg-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
