...
breadcrumb: Create TEXT signature on BMP for C#

############################# Head ############################
head_title: "Adding TEXT signatures in a BMP file with C#"
head_description: "Put TEXT Signature on BMP file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .BMP files with TEXT signatures in C#"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your BMP files with TEXT signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to sign BMP with TEXT in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign BMP documents with TEXT signatures quick and easily.
