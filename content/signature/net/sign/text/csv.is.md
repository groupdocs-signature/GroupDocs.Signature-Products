...
############################# Head ############################
head_title: "Búðu til rafrænar undirskriftir í Csv skrá með C#"
head_description: "Settu Text eSignature á Csv skrá fyrir .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "Undirritaðu Csv skrár með Text undirskriftum í C#"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Csv með Text í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Csv skjöl með Text undirskrift fljótt og auðveldlega.
