...
############################# Head ############################
head_title: "Opret elektroniske tekstsignaturer til filen Docx med C#"
head_description: "Sæt Text eSignature på filen Docx for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Docx-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trin til at signere Docx med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Docx dokumenter med Text signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Docx dokumenter med Text Live Demo"
    content: |
