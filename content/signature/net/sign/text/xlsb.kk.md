...
############################# Head ############################
head_title: "C# көмегімен Xlsb файлына мәтіндік электрондық қолтаңба жасау"
head_description: "Кодтың бірнеше жолын пайдаланып .NET үшін Text eSignature Xlsb файлына қойыңыз. Ондаған файл пішіміне қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "Xlsb файлдарға C# жүйесінде Text қолтаңбаларымен қол қойыңыз"
...
steps:
    enable: true
    title_left: "C# жүйесінде Text арқылы Xlsb файлына қол қою қадамдары"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) Xlsb құжаттарға Text қолтаңбаларымен жылдам және оңай қол қою мүмкіндігін береді.
