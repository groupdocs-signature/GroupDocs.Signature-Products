...
############################# Head ############################
head_title: "შექმენით ტექსტური ელექტრონული ხელმოწერები Ott ფაილზე C#-ით"
head_description: "განათავსეთ Text eSignature Ott ფაილზე .NET კოდის რამდენიმე ხაზის გამოყენებით. გამოიყენეთ GroupDocs Document Signature API ათობით ფაილის ფორმატის ხელმოწერისთვის."

############################# Header ############################
title: "შედით Ott ფაილებში Text ხელმოწერებით C#-ში"
...
steps:
    enable: true
    title_left: "Ott-ით ხელმოწერის ნაბიჯები Text-ით C#-ში"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) იძლევა შესაძლებლობას მოაწეროთ Ott დოკუმენტები Text ხელმოწერებით სწრაფად და მარტივად.
