...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen Docm med C#"
head_description: "Sätt Text eSignature på filen Docm för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Docm-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Docm med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Docm-dokument med Text-signaturer snabbt och enkelt.
