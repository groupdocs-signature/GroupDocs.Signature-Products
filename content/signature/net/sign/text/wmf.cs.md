...
############################# Head ############################
head_title: "Vytvořte textové elektronické podpisy do souboru Wmf pomocí C#"
head_description: "Vložte elektronický podpis Text do souboru Wmf pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Wmf pomocí podpisů Text v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Wmf pomocí Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Wmf pomocí podpisů Text.
...
demos:
    enable: true
    title: "Podepisování dokumentů Wmf pomocí živé ukázky Text"
    content: |
