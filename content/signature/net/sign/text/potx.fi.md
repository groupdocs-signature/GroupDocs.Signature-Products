...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Potx käyttämällä C#"
head_description: "Aseta Text eSignature Potx-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Potx tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Potx:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Potx-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
