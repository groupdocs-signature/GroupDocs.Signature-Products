...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Tar käyttämällä C#"
head_description: "Aseta Text eSignature Tar-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Tar tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Tar:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Tar-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
