...
############################# Head ############################
head_title: "Ji bo pelê Xltm bi C# re îmzeyên elektronîkî yên nivîsê biafirînin"
head_description: "Ji bo .NET Text eSignature li ser pela Xltm bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Xltm bi îmzeyên Text di C# de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Xltm bi Text di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Xltm bi îmzeyên Text zû û bi hêsanî peyda dike.
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Xltm bi Text Demoya Zindî"
    content: |
