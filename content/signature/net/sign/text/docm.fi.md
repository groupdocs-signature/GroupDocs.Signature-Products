...
############################# Head ############################
head_title: "Luo teksti-sähköiset allekirjoitukset tiedostoon Docm käyttämällä C#"
head_description: "Aseta Text eSignature Docm-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Docm tiedostot Text allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Docm:n allekirjoittamiseen Text -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Docm-asiakirjoja Text-allekirjoituksella nopeasti ja helposti.
