...
############################# Head ############################
head_title: "Cruthaigh sínithe leictreonacha Téacs chun Xlsb a chomhdú le C#"
head_description: "Cuir Text eSignature ar Xlsb comhad le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Xlsb comhad le sínithe Text in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Xlsb a shíniú le Text in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Xlsb a shíniú le sínithe Text go tapa agus go héasca.
