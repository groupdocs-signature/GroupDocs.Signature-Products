...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru 7z pomocou C#"
head_description: "Vložte elektronický podpis Text do súboru 7z pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory 7z pomocou podpisov Text v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie 7z pomocou Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty 7z pomocou podpisov Text.
