...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Xlsm pomocou C#"
head_description: "Vložte elektronický podpis Text do súboru Xlsm pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Xlsm pomocou podpisov Text v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xlsm pomocou Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xlsm pomocou podpisov Text.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Xlsm pomocou živej ukážky Text"
    content: |
