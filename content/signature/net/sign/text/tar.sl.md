...
############################# Head ############################
head_title: "Ustvarite besedilne elektronske podpise v datoteko Tar z C#"
head_description: "Vstavite e-podpis Text v datoteko Tar za .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Tar datoteke s podpisi Text v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Tar z Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Tar s podpisi Text.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Tar z Text Live Demo"
    content: |
