...
############################# Head ############################
head_title: "Erstellen Sie mit C# elektronische Textsignaturen für die Png-Datei"
head_description: "Fügen Sie Text eSignature in Png-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Png-Dateien mit Text-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Png mit Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Png-Dokumente mit Text-Signaturen schnell und einfach zu signieren.
