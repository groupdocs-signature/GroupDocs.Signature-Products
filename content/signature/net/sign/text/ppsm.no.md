...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Ppsm med C#"
head_description: "Sett Text eSignature på Ppsm-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Ppsm-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Ppsm med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Ppsm-dokumenter med Text-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Ppsm dokumenter med Text Live Demo"
    content: |
