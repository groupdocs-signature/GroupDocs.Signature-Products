...
############################# Head ############################
head_title: "Looge tekstiga elektroonilised allkirjad failile Docx rakendusega C#"
head_description: "Pane Text e-allkiri .NET-faili Docx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Docx allkirjadega Text rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Docx allkirjastamiseks rakendusega Text rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Docx dokumente Text allkirjaga.
