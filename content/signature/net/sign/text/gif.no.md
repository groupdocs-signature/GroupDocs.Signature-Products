...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Gif med C#"
head_description: "Sett Text eSignature på Gif-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."
...
steps:
    enable: true
    title_left: "Trinn for å signere Gif med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Gif-dokumenter med Text-signaturer raskt og enkelt.
