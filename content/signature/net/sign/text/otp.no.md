...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Otp med C#"
head_description: "Sett Text eSignature på Otp-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Otp-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Otp med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Otp-dokumenter med Text-signaturer raskt og enkelt.
