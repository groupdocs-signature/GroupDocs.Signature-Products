...
############################# Head ############################
head_title: "Opprett elektroniske tekstsignaturer til filen Tar med C#"
head_description: "Sett Text eSignature på Tar-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Tar-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Tar med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Tar-dokumenter med Text-signaturer raskt og enkelt.
