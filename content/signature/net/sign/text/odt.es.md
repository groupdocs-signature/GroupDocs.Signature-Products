...
############################# Head ############################
head_title: "Agregando Text firmas al archivo Odt con C#"
head_description: "Coloque la firma Text en el archivo Odt para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."
...
demos:
    enable: true
    title: "Firma de Odt documentos con Text Live Demo"
    content: |
