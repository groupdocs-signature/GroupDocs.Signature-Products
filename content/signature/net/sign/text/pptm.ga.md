...
############################# Head ############################
head_title: "Cruthaigh sínithe leictreonacha Téacs chun Pptm a chomhdú le C#"
head_description: "Cuir Text eSignature ar Pptm comhad le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Pptm comhad le sínithe Text in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Pptm a shíniú le Text in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Pptm a shíniú le sínithe Text go tapa agus go héasca.
