...
############################# Head ############################
head_title: "Cipta tandatangan elektronik Teks ke fail Potx dengan C#"
head_description: "Letakkan Text eSignature pada fail Potx untuk .NET menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Potx dengan tandatangan Text dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Potx dengan Text dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Potx dengan tandatangan Text dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Potx dengan Text Demo Langsung"
    content: |
