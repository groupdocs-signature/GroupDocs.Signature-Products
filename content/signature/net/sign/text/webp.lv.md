...
############################# Head ############################
head_title: "Izveidojiet teksta elektroniskos parakstus failam Webp, izmantojot C#"
head_description: "Ievietojiet Text eParaksts Webp failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Webp failus ar Text parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Webp ar Text programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Webp dokumentus ar Text parakstiem.
