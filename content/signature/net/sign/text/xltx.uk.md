...
############################# Head ############################
head_title: "Створіть текстові електронні підписи до файлу Xltx за допомогою C#"
head_description: "Додайте електронний підпис Text у файл Xltx для .NET за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs, щоб підписувати десятки форматів файлів."

############################# Header ############################
title: "Підпишіть файли Xltx підписами Text у C#"
...
steps:
    enable: true
    title_left: "Кроки для підпису Xltx за допомогою Text у C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає можливість швидко та легко підписувати документи Xltx за допомогою підписів Text.
