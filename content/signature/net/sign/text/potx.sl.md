...
############################# Head ############################
head_title: "Ustvarite besedilne elektronske podpise v datoteko Potx z C#"
head_description: "Vstavite e-podpis Text v datoteko Potx za .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Potx datoteke s podpisi Text v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Potx z Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Potx s podpisi Text.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Potx z Text Live Demo"
    content: |
