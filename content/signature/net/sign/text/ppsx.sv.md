...
############################# Head ############################
head_title: "Skapa elektroniska textsignaturer till filen Ppsx med C#"
head_description: "Sätt Text eSignature på filen Ppsx för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Ppsx-filer med Text-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Ppsx med Text i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Ppsx-dokument med Text-signaturer snabbt och enkelt.
