...
############################# Head ############################
head_title: "Skep teks elektroniese handtekeninge na Bmp lêer met C#"
head_description: "Plaas Text eSignature op Bmp lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Bmp lêers met Text handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Bmp met Text in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Bmp dokumente met Text handtekeninge vinnig en maklik te onderteken.
