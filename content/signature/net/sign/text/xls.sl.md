...
############################# Head ############################
head_title: "Ustvarite besedilne elektronske podpise v datoteko Xls z C#"
head_description: "Vstavite e-podpis Text v datoteko Xls za .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Xls datoteke s podpisi Text v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Xls z Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Xls s podpisi Text.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Xls z Text Live Demo"
    content: |
