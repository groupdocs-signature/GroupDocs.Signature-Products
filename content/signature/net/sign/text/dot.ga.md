...
############################# Head ############################
head_title: "Cruthaigh sínithe leictreonacha Téacs chun Dot a chomhdú le C#"
head_description: "Cuir Text eSignature ar Dot comhad le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Dot comhad le sínithe Text in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Dot a shíniú le Text in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Dot a shíniú le sínithe Text go tapa agus go héasca.
