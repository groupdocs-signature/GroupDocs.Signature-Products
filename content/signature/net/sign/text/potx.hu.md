...
############################# Head ############################
head_title: "Szöveges elektronikus aláírások létrehozása a Potx fájlhoz a C# segítségével"
head_description: "Helyezze a Text eSignature-t a .NET Potx fájljába néhány sor kóddal. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Potx fájl aláírása Text aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Potx aláírásának lépései a Text segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Potx dokumentumok gyors és egyszerű aláírását Text aláírással.
