...
############################# Head ############################
head_title: "Créez des signatures électroniques de texte dans le fichier Ots avec C#"
head_description: "Mettez Text eSignature sur le fichier Ots pour .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "Signez des fichiers Ots avec des signatures Text en C#"
...
steps:
    enable: true
    title_left: "Étapes pour signer Ots avec Text dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Ots avec des signatures Text.
