...
############################# Head ############################
head_title: "Ustvarite besedilne elektronske podpise v datoteko Ppt z C#"
head_description: "Vstavite e-podpis Text v datoteko Ppt za .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Ppt datoteke s podpisi Text v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Ppt z Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Ppt s podpisi Text.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Ppt z Text Live Demo"
    content: |
