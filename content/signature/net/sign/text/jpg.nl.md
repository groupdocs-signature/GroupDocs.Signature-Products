...
############################# Head ############################
head_title: "Maak elektronische teksthandtekeningen naar een Jpg-bestand met C#"
head_description: "Zet Text eSignature op Jpg bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Jpg bestanden met Text handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Jpg te ondertekenen met Text in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Jpg documenten snel en gemakkelijk te ondertekenen met Text handtekeningen.
...
demos:
    enable: true
    title: "Jpg documenten ondertekenen met Text Live Demo"
    content: |
