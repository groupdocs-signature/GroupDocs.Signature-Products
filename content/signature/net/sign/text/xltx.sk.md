...
############################# Head ############################
head_title: "Vytvorte textové elektronické podpisy do súboru Xltx pomocou C#"
head_description: "Vložte elektronický podpis Text do súboru Xltx pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Xltx pomocou podpisov Text v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xltx pomocou Text v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xltx pomocou podpisov Text.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Xltx pomocou živej ukážky Text"
    content: |
