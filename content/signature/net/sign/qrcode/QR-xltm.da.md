...
head_description: "Opret QR QR-kode og læg den i Xltm-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Xltm dokument i C#"
description: "eSignér dine Xltm-dokumenter og kontrakter med QR QR-kode. Generer QR-kodesignatur hurtigt og nemt."
