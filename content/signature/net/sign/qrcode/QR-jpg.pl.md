...
############################# Head ############################
head_title: "Podpisz dokument Jpg z kodem QR QR w C#"
head_description: "Utwórz kod QR QR i umieść go w pliku Jpg za pomocą .NET z krótkim fragmentem kodu C#. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis QR kodu QR dla dokumentu Jpg w C#"
description: "Podpisz elektronicznie dokumenty i umowy w Jpg za pomocą kodu QR QR. Szybko i łatwo generuj podpis QR Code."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Jpg za pomocą Qrcode w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Jpg za pomocą podpisów Qrcode.
        
        * Utwórz instancję klasy Signature podając plik Jpg do podpisania jako ścieżkę lub strumień pamięci
        * Utwórz wystąpienie klasy SignOptions i ustaw wszystkie wymagane dane.
        * Wywołaj metodę Signature.Sign() przekazującą wyjściowy plik Jpg lub strumień pamięci
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Jpg za pomocą Qrcode Demo na żywo"
    content: |
       Podpisz teraz plik Jpg różnymi podpisami, odwiedzając witrynę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Darmowe demo online czeka na Ciebie.
...
more_formats:
    ...
    content: |
        "Możesz także podpisać Jpg innymi typami podpisów. Zobacz poniższą listę."
    format: 
