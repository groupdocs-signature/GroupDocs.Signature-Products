...
description: "eSínigh do dhoiciméid agus conarthaí Xlsx le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Xlsx doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
