...
############################# Head ############################
head_title: "eSign Dot document avec QR QR Code en C#"
head_description: "Créez le code QR QR et placez-le dans le fichier Dot en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR QR pour le document Dot en C#"
description: "Signez électroniquement vos documents et contrats Dot avec QR QR Code. Générez une signature QR Code rapidement et facilement."
