...
############################# Head ############################
head_title: "Podpisz dokument Dcm z kodem QR G S1 Data Matrix w C#"
head_description: "Utwórz kod QR G S1 Data Matrix i umieść go w pliku Dcm za pomocą .NET z krótkim fragmentem kodu C#. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis G S1 Data Matrix kodu QR dla dokumentu Dcm w C#"
description: "Podpisz elektronicznie dokumenty i umowy w Dcm za pomocą kodu QR G S1 Data Matrix. Szybko i łatwo generuj podpis QR Code."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Dcm za pomocą Qrcode w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Dcm za pomocą podpisów Qrcode.
        
        * Utwórz instancję klasy Signature podając plik Dcm do podpisania jako ścieżkę lub strumień pamięci
        * Utwórz wystąpienie klasy SignOptions i ustaw wszystkie wymagane dane.
        * Wywołaj metodę Signature.Sign() przekazującą wyjściowy plik Dcm lub strumień pamięci
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Dcm za pomocą Qrcode Demo na żywo"
    content: |
       Podpisz teraz plik Dcm różnymi podpisami, odwiedzając witrynę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Darmowe demo online czeka na Ciebie.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix to wariant Data Matrix zgodny ze specyfikacją GS1. Użyj GS1 DataMatrix do zakodowania informacji, takich jak, ale nie wyłącznie, następujące informacje: AI(01) Globalny Numer Jednostki Handlowej (GTIN), AI(17) Data ważności, AI(10) Numer partii, AI(21) Numer seryjny .
          characterset: |
             Zestaw znaków: duże i małe litery oraz znaki specjalne $@%*+-./:=<>;&*_,'! wszystkie z poprawnymi Identyfikatorami Zastosowania.
          textcapacity: |
             Pojemność kodu: do 3116 cyfr lub 2335 znaków alfanumerycznych.
          image: |
...
more_formats:
    ...
    content: |
        "Możesz także podpisać Dcm innymi typami podpisów. Zobacz poniższą listę."
    format: 
