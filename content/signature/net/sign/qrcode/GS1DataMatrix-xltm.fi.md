...
############################# Head ############################
head_title: "eSign Xltm -asiakirja G S1 Data Matrix QR-koodilla C#"
head_description: "Luo QR-koodi G S1 Data Matrix ja laita se Xltm-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo G S1 Data Matrix QR-koodiallekirjoitus asiakirjalle Xltm kohteessa C#"
description: "eAllekirjoita Xltm-asiakirjat ja sopimukset QR-koodilla G S1 Data Matrix. Luo QR-koodin allekirjoitus nopeasti ja helposti."
...
steps:
    enable: true
    title_left: "Vaiheet Xltm:n allekirjoittamiseen Qrcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Xltm-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
