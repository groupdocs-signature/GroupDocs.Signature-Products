...
############################# Head ############################
head_title: "eSign Pps-dokument met G S1 Data Matrix QR-kode in C#"
head_description: "Skep G S1 Data Matrix QR-kode en plaas dit op Pps-lêer deur .NET met 'n kort stukkie C#-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR-kode handtekening vir Pps dokument in C#"
description: "eTeken jou Pps dokumente en kontrakte met G S1 Data Matrix QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Pps met Qrcode in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Pps dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
