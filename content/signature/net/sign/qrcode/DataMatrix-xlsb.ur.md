...
############################# Head ############################
head_title: "C# میں Data Matrix QR کوڈ کے ساتھ eSign Xlsb دستاویز"
head_description: "Data Matrix QR کوڈ بنائیں اور اسے .NET کا استعمال کرتے ہوئے C# کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Xlsb فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "C# میں Xlsb دستاویز کے لیے Data Matrix QR کوڈ دستخط بنائیں"
