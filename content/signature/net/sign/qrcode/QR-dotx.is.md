...
############################# Head ############################
head_title: "eSign Dotx skjal með QR QR kóða í C#"
head_description: "Búðu til QR QR kóða og settu hann á Dotx skrá með því að nota .NET með stuttu stykki af C# kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til QR QR kóða undirskrift fyrir Dotx skjal í C#"
description: "eSignaðu Dotx skjölin þín og samninga með QR QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Dotx með Qrcode í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Dotx skjöl með Qrcode undirskrift fljótt og auðveldlega.
