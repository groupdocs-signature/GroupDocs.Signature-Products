...
############################# Head ############################
head_title: "eSign Ods dokumen dengan G S1 Data Matrix QR Code di C#"
head_description: "Buat Kode QR G S1 Data Matrix dan letakkan di file Ods menggunakan .NET dengan potongan pendek kode C#. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat G S1 Data Matrix tanda tangan Kode QR untuk dokumen Ods di C#"
description: "eTandatangani dokumen dan kontrak Ods Anda dengan Kode QR G S1 Data Matrix. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Ods dengan Qrcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Ods dengan Qrcode tanda tangan dengan cepat dan mudah.
