...
############################# Head ############################
head_title: "eSign Odp dokumen dengan Data Matrix QR Code dalam C#"
head_description: "Cipta Data Matrix Kod QR dan letakkan pada fail Odp menggunakan .NET dengan sekeping pendek kod C#. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan Data Matrix tandatangan Kod QR untuk Odp dokumen dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Odp dengan Qrcode dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Odp dengan tandatangan Qrcode dengan cepat dan mudah.
