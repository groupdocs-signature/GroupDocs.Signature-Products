...
############################# Head ############################
head_title: "eSign Jpg-dokument med Data Matrix QR-kode i C#"
head_description: "Lag Data Matrix QR-kode og legg den til Jpg-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer Data Matrix QR-kodesignatur for Jpg-dokument i C#"
