...
############################# Head ############################
head_title: "eSign Pptx dokuments ar Aztec QR kodu programmā C#"
head_description: "Izveidojiet Aztec QR kodu un ievietojiet to failā Pptx, izmantojot .NET un īsu C# kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt Aztec QR koda parakstu dokumentam Pptx programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Pptx ar Qrcode programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Pptx dokumentus ar Qrcode parakstiem.
