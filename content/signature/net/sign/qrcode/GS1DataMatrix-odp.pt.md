...
############################# Head ############################
head_title: "eSign Odp documento com G S1 Data Matrix QR Code em C#"
head_description: "Crie G S1 Data Matrix QR Code e coloque-o no arquivo Odp usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere G S1 Data Matrix assinatura de QR Code para Odp documento em C#"
description: "Assine seus documentos e contratos Odp com G S1 Data Matrix QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Odp com Qrcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Odp com assinaturas Qrcode de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Odp documentos com Qrcode Demonstração ao vivo"
    content: |
