...
############################# Head ############################
head_title: "eSigniere Gif-Dokument mit Data Matrix-QR-Code in C#"
head_description: "Erstellen Sie einen Data Matrix-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Gif-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Data Matrix-QR-Code-Signatur für Gif-Dokument in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Gif mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Gif-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
