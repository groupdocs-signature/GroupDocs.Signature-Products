...
############################# Head ############################
head_title: "eSign Potx փաստաթուղթը QR QR կոդով C#-ում"
head_description: "Ստեղծեք QR QR կոդ և դրեք այն Potx ֆայլի վրա՝ օգտագործելով .NET՝ C# կոդի կարճ հատվածով: Օգտագործեք GroupDocs Document Signature API-ը՝ ձեր բիզնես փաստաթղթերն ու ֆայլերը QR կոդով էլեկտրոնային ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք QR QR կոդ ստորագրություն Potx փաստաթղթի համար C#-ում"
description: "e-ստորագրեք ձեր Potx փաստաթղթերն ու պայմանագրերը QR QR կոդով: Արագ և հեշտությամբ ստեղծեք QR Code ստորագրություն:"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR կոդը (կրճատված է Արագ արձագանքման կոդից) ապրանքանիշն է մատրիցային շտրիխ կոդի (կամ երկչափ շտրիխ կոդի) տեսակի համար: Սա երկչափ կոդի ամենատարածված և լայնորեն օգտագործվող տեսակն է: Գործնականում QR կոդերը հաճախ պարունակում են տվյալներ տեղորոշիչի, նույնացուցիչի կամ հետագծողի համար, որը մատնանշում է կայք կամ հավելված:
          characterset: |
             Բոլոր 256 ASCII նիշերը + Kanji
          textcapacity: |
             Մինչև 7089 թվային նիշ, 4296 այբբենական նիշ, 2953 բայթ (երկուական տվյալներ) կամ 1817 Կանջի նիշ:
          image: |
