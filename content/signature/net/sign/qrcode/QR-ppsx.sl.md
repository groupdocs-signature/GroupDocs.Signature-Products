...
############################# Head ############################
head_title: "eSign Ppsx dokument s QR QR kodo v C#"
head_description: "Ustvarite QR kodo QR in jo postavite v datoteko Ppsx z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari QR podpis kode QR za dokument Ppsx v C#"
description: "e-Podpišite svoje Ppsx dokumente in pogodbe s QR QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Ppsx z Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Ppsx s podpisi Qrcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Ppsx z Qrcode Live Demo"
    content: |
