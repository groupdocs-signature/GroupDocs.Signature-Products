...
############################# Head ############################
head_title: "eSign Webp dokument G S1 Data Matrix QR-koodiga rakenduses C#"
head_description: "Looge QR-kood G S1 Data Matrix ja sisestage see faili Webp, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Webp QR-koodi allkiri G S1 Data Matrix"
description: "eAllkirjasta oma Webp dokumendid ja lepingud QR-koodiga G S1 Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
demos:
    enable: true
    title: "Dokumentide Webp allkirjastamine Qrcode reaalajas demoga"
    content: |
       Allkirjastage fail Webp erinevate allkirjadega kohe, külastades veebisaiti [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Tasuta online demo ootab teid.
...
more_formats:
    enable: true
    title: "Muud toetatud Qrcode allkirjad C# jaoks"
    content: |
        "Saate allkirjastada faili Webp ka muude allkirjatüüpidega. Vaadake allolevat loendit."
    format: 
