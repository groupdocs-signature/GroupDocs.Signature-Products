...
############################# Head ############################
head_title: "eSign Rtf skjal með QR QR kóða í C#"
head_description: "Búðu til QR QR kóða og settu hann á Rtf skrá með því að nota .NET með stuttu stykki af C# kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til QR QR kóða undirskrift fyrir Rtf skjal í C#"
description: "eSignaðu Rtf skjölin þín og samninga með QR QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
