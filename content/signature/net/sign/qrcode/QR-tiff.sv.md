...
############################# Head ############################
head_title: "eSign Tiff-dokument med QR QR-kod i C#"
head_description: "Skapa QR QR-kod och lägg den i filen Tiff med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera QR QR-kodsignatur för Tiff dokument i C#"
