...
############################# Head ############################
head_title: "在 C# 中带有 Data Matrix QR 码的 eSign Gif 文档"
head_description: "创建 Data Matrix 二维码并使用 .NET 和一小段 C# 代码将其放在 Gif 文件中。使用 GroupDocs 文档签名 API 使用 QR 码对您的业务文档和文件进行电子签名。"

############################# Header ############################
title: "在 C# 中为 Gif 文档生成 Data Matrix 二维码签名"
