...
############################# Head ############################
head_title: "eSign Webp documento con Aztec codice QR in C#"
head_description: "Crea il codice QR Aztec e inseriscilo nel file Webp utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Aztec firma del codice QR per il documento Webp in C#"
description: "Firma i tuoi documenti e contratti Webp con il codice QR Aztec. Genera la firma del codice QR in modo rapido e semplice."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Il codice azteco è una simbologia di matrice bidimensionale (2-D) per uso generale progettata per avere una precisione maggiore rispetto ad altre simbologie 2-D. Un simbolo del codice azteco può codificare fino a 3.832 cifre numeriche; 3.067 caratteri alfabetici; o 1.914 byte di dati.
          characterset: |
             Tutti i 256 caratteri ASCII.
          textcapacity: |
             Fino a 3.832 cifre numeriche o 3.067 caratteri alfabetici o 1.914 byte di dati.
          image: |
