...
############################# Head ############################
head_title: "eSign documentul Pptm cu codul QR G S1 Data Matrix în C#"
head_description: "Creați codul QR G S1 Data Matrix și puneți-l în fișierul Pptm folosind .NET cu o scurtă bucată de cod C#. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura G S1 Data Matrix cod QR pentru documentul Pptm în C#"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Pptm cu Qrcode în C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) oferă posibilitatea de a semna documente Pptm cu semnături Qrcode rapid și ușor.
