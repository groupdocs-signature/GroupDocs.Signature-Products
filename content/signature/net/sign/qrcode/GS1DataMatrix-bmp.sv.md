...
############################# Head ############################
head_title: "eSign Bmp-dokument med G S1 Data Matrix QR-kod i C#"
head_description: "Skapa G S1 Data Matrix QR-kod och lägg den i filen Bmp med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera G S1 Data Matrix QR-kodsignatur för Bmp dokument i C#"
description: "esignera dina Bmp-dokument och kontrakt med G S1 Data Matrix QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Bmp med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Bmp-dokument med Qrcode-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Bmp dokument med Qrcode Live Demo"
    content: |
