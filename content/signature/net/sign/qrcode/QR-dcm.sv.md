...
############################# Head ############################
head_title: "eSign Dcm-dokument med QR QR-kod i C#"
head_description: "Skapa QR QR-kod och lägg den i filen Dcm med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera QR QR-kodsignatur för Dcm dokument i C#"
description: "esignera dina Dcm-dokument och kontrakt med QR QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR Code (förkortat Quick Response Code) är varumärket för en typ av matrisstreckkod (eller tvådimensionell streckkod). Det är den mest populära och mest använda typen av tvådimensionell kod. I praktiken innehåller QR-koder ofta data för en lokaliserare, identifierare eller spårare som pekar på en webbplats eller applikation.
          characterset: |
             Alla 256 ASCII-tecken + Kanji
          textcapacity: |
             Upp till 7089 numeriska tecken, 4296 alfanumeriska tecken, 2953 byte (binära data) eller 1817 Kanji-tecken.
          image: |
