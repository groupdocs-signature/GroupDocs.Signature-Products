...
############################# Head ############################
head_title: "C# içinde QR QR Kodu ile Xls belgesini eSign"
head_description: "QR QR Kodu oluşturun ve kısa bir C# kodu parçasıyla .NET kullanarak Xls dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "C# içinde Xls belgesi için QR QR Kodu imzası oluşturun"
