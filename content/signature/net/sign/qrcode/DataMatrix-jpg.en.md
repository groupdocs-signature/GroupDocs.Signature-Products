...
head_description: "Create Data Matrix QR Code and put it on Jpg file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Data Matrix QR Code signature for Jpg document in C#"
description: "eSign your Jpg documents and contracts with Data Matrix QR Code. Generate QR Code signature quickly and easily."
