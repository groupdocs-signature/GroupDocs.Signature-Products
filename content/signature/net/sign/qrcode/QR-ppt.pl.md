...
############################# Head ############################
head_title: "Podpisz dokument Ppt z kodem QR QR w C#"
head_description: "Utwórz kod QR QR i umieść go w pliku Ppt za pomocą .NET z krótkim fragmentem kodu C#. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis QR kodu QR dla dokumentu Ppt w C#"
description: "Podpisz elektronicznie dokumenty i umowy w Ppt za pomocą kodu QR QR. Szybko i łatwo generuj podpis QR Code."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Ppt za pomocą Qrcode w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Ppt za pomocą podpisów Qrcode.
        
        * Utwórz instancję klasy Signature podając plik Ppt do podpisania jako ścieżkę lub strumień pamięci
        * Utwórz wystąpienie klasy SignOptions i ustaw wszystkie wymagane dane.
        * Wywołaj metodę Signature.Sign() przekazującą wyjściowy plik Ppt lub strumień pamięci
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Ppt za pomocą Qrcode Demo na żywo"
    content: |
       Podpisz teraz plik Ppt różnymi podpisami, odwiedzając witrynę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Darmowe demo online czeka na Ciebie.
...
more_formats:
    ...
    content: |
        "Możesz także podpisać Ppt innymi typami podpisów. Zobacz poniższą listę."
    format: 
