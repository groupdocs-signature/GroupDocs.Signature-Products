...
############################# Head ############################
head_title: "eSign Dcm документ із G S1 Q R QR-кодом у C#"
head_description: "Створіть QR-код G S1 Q R і помістіть його у файл Dcm за допомогою .NET із коротким фрагментом коду C#. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду G S1 Q R для документа Dcm у C#"
description: "Електронно підписуйте свої Dcm документи та контракти за допомогою G S1 Q R QR-коду. Згенеруйте підпис QR-коду швидко та легко."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR-код GS1 — це варіант QR-коду, який відповідає специфікаціям GS1. Він був розроблений спеціально для обміну розширеною інформацією про упаковку, такою як номер партії, ідентифікатор продукту та кількість.
          characterset: |
             Великі та малі літери та спеціальні символи $%*+-./: усі з правильними ідентифікаторами програми
          textcapacity: |
             До 7089 цифрових символів, 4296 буквено-цифрових символів
          image: |
