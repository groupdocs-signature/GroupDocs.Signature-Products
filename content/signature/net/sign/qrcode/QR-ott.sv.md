...
############################# Head ############################
head_title: "eSign Ott-dokument med QR QR-kod i C#"
head_description: "Skapa QR QR-kod och lägg den i filen Ott med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera QR QR-kodsignatur för Ott dokument i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Ott med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Ott-dokument med Qrcode-signaturer snabbt och enkelt.
