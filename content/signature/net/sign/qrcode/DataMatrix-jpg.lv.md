...
############################# Head ############################
head_title: "eSign Jpg dokuments ar Data Matrix QR kodu programmā C#"
head_description: "Izveidojiet Data Matrix QR kodu un ievietojiet to failā Jpg, izmantojot .NET un īsu C# kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt Data Matrix QR koda parakstu dokumentam Jpg programmā C#"
description: "eParakstiet savus Jpg dokumentus un līgumus ar Data Matrix QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
