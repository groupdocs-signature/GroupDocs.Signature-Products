...
############################# Head ############################
head_title: "eSign Docm dokument s G S1 Data Matrix QR kódom v C#"
head_description: "Vytvorte G S1 Data Matrix QR kód a vložte ho do súboru Docm pomocou .NET s krátkym kódom C#. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte G S1 Data Matrix podpis QR kódu pre dokument Docm v C#"
description: "ePodpíšte svoje Docm dokumenty a zmluvy pomocou G S1 Data Matrix QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Docm pomocou živej ukážky Qrcode"
    content: |
       Podpíšte súbor Docm pomocou rôznych podpisov práve teraz na webovej lokalite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čaká.
...
more_formats:
    enable: true
    title: "Ďalšie podporované podpisy Qrcode pre C#"
    content: |
        "Docm môžete podpísať aj inými typmi podpisov. Pozrite si zoznam nižšie."
    format: 
