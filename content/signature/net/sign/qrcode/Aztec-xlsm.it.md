...
############################# Head ############################
head_title: "eSign Xlsm documento con Aztec codice QR in C#"
head_description: "Crea il codice QR Aztec e inseriscilo nel file Xlsm utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Aztec firma del codice QR per il documento Xlsm in C#"
description: "Firma i tuoi documenti e contratti Xlsm con il codice QR Aztec. Genera la firma del codice QR in modo rapido e semplice."
