...
############################# Head ############################
head_title: "eSign Dotm-dokument med Aztec QR-kode i C#"
head_description: "Opret Aztec QR-kode og læg den i Dotm-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer Aztec QR-kodesignatur for Dotm dokument i C#"
description: "eSignér dine Dotm-dokumenter og kontrakter med Aztec QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Trin til at signere Dotm med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Dotm dokumenter med Qrcode signaturer hurtigt og nemt.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code er en todimensionel (2-D) matrix-symbologi til generelle formål, der er designet til at have højere nøjagtighed end andre 2-D-symbologier. Et Aztec Code-symbol kan kode op til 3.832 numeriske cifre; 3.067 alfabetiske tegn; eller 1.914 bytes data.
          characterset: |
             Alle 256 ASCII-tegn.
          textcapacity: |
             Op til 3.832 numeriske cifre eller 3.067 alfabetiske tegn eller 1.914 bytes data.
          image: |
