...
############################# Head ############################
head_title: "eSigniere Pptm-Dokument mit Data Matrix-QR-Code in C#"
head_description: "Erstellen Sie einen Data Matrix-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Pptm-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Data Matrix-QR-Code-Signatur für Pptm-Dokument in C#"
description: "Unterzeichnen Sie Ihre Pptm-Dokumente und -Verträge mit dem Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Pptm mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Pptm-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
        
        * Erstellen Sie eine Instanz der Signature-Klasse, die die Pptm-Datei bereitstellt, die als Pfad oder Speicherstream signiert werden soll
        * Instanziieren Sie die SignOptions-Klasse und legen Sie alle erforderlichen Daten fest.
        * Rufen Sie die Signature.Sign()-Methode auf und übergeben Sie die Pptm-Ausgabedatei oder den Speicherstream
...
demos:
    enable: true
    title: "Signieren von Pptm-Dokumenten mit Qrcode Live-Demo"
    content: |
       Signieren Sie die Datei Pptm jetzt mit verschiedenen Signaturen, indem Sie die Website [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) besuchen. Kostenlose Online-Demo wartet auf Sie.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix ist ein zweidimensionaler Code, der aus schwarzen und weißen „Zellen“ oder Punkten besteht, die entweder in einem quadratischen oder rechteckigen Muster angeordnet sind, auch bekannt als Matrix. Die zu codierenden Informationen können Text oder numerische Daten sein.
          characterset: |
             Unterstützt alle 256 ASCII-Zeichen, alle ISO-Zeichen und alle Extended Binary Coded Decimal Interchange Code (EBCDIC)-Zeichen.
          textcapacity: |
             Bis zu 3116 Ziffern oder 2335 alphanumerische Zeichen oder 1556 Binärzeichen.
          image: |
...
more_formats:
    ...
    content: |
        "Sie können Pptm auch mit anderen Signaturtypen signieren. Bitte sehen Sie sich die Liste unten an."
    format: 
