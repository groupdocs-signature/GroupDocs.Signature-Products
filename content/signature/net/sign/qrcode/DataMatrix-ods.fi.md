...
############################# Head ############################
head_title: "eSign Ods -asiakirja Data Matrix QR-koodilla C#"
head_description: "Luo QR-koodi Data Matrix ja laita se Ods-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo Data Matrix QR-koodiallekirjoitus asiakirjalle Ods kohteessa C#"
...
steps:
    enable: true
    title_left: "Vaiheet Ods:n allekirjoittamiseen Qrcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Ods-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
