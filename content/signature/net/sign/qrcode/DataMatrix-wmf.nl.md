...
############################# Head ############################
head_title: "eSign Wmf document met Data Matrix QR-code in C#"
head_description: "Maak een Data Matrix QR-code en plaats deze in het Wmf-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Data Matrix QR Code handtekening voor Wmf document in C#"
...
steps:
    enable: true
    title_left: "Stappen om Wmf te ondertekenen met Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Wmf documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
