...
############################# Head ############################
head_title: "eSign 7z doiciméad le Data Matrix Cód QR in C#"
head_description: "Cruthaigh Data Matrix Cód QR agus cuir ar chomhad 7z é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Data Matrix don doiciméad 7z in C#"
description: "eSínigh do dhoiciméid agus conarthaí 7z le Data Matrix Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
