...
############################# Head ############################
head_title: "eSign Xls документ із G S1 Data Matrix QR-кодом у C#"
head_description: "Створіть QR-код G S1 Data Matrix і помістіть його у файл Xls за допомогою .NET із коротким фрагментом коду C#. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду G S1 Data Matrix для документа Xls у C#"
...
steps:
    enable: true
    title_left: "Кроки для підпису Xls за допомогою Qrcode у C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає можливість швидко та легко підписувати документи Xls за допомогою підписів Qrcode.
