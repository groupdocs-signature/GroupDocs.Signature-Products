...
############################# Head ############################
head_title: "eSign Pdf-dokument met QR QR-kode in C#"
head_description: "Skep QR QR-kode en plaas dit op Pdf-lêer deur .NET met 'n kort stukkie C#-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer QR QR-kode handtekening vir Pdf dokument in C#"
description: "eTeken jou Pdf dokumente en kontrakte met QR QR-kode. Genereer QR-kode handtekening vinnig en maklik."
