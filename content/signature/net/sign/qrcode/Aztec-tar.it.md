...
############################# Head ############################
head_title: "eSign Tar documento con Aztec codice QR in C#"
head_description: "Crea il codice QR Aztec e inseriscilo nel file Tar utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Aztec firma del codice QR per il documento Tar in C#"
description: "Firma i tuoi documenti e contratti Tar con il codice QR Aztec. Genera la firma del codice QR in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Tar con Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Tar con firme Qrcode in modo rapido e semplice.
...
demos:
    enable: true
    title: "Firma di documenti Tar con Qrcode Demo live"
    content: |
