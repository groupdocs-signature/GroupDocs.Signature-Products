...
############################# Head ############################
head_title: "eSign Dcm-dokument med Data Matrix QR-kod i C#"
head_description: "Skapa Data Matrix QR-kod och lägg den i filen Dcm med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera Data Matrix QR-kodsignatur för Dcm dokument i C#"
description: "esignera dina Dcm-dokument och kontrakt med Data Matrix QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Datamatris är en tvådimensionell kod som består av svarta och vita "celler" eller punkter arrangerade i antingen ett kvadratiskt eller rektangulärt mönster, även känd som en matris. Informationen som ska kodas kan vara text eller numerisk data.
          characterset: |
             Stöder alla 256 ASCII-tecken, alla ISO-tecken och alla EBCDIC-tecken (Extended Binary Coded Decimal Interchange Code).
          textcapacity: |
             Upp till 3116 numeriska siffror, eller 2335 alfanumeriska tecken, eller 1556 binära tecken.
          image: |
