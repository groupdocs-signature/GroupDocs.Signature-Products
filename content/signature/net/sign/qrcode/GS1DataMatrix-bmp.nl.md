...
############################# Head ############################
head_title: "eSign Bmp document met G S1 Data Matrix QR-code in C#"
head_description: "Maak een G S1 Data Matrix QR-code en plaats deze in het Bmp-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR Code handtekening voor Bmp document in C#"
description: "Onderteken uw Bmp documenten en contracten met G S1 Data Matrix QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Bmp te ondertekenen met Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Bmp documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
        ...
        * Roep de Signature.Sign()-methode op en geef uitvoer Bmp-bestand of geheugenstroom
...
demos:
    enable: true
    title: "Bmp documenten ondertekenen met Qrcode Live Demo"
    content: |
