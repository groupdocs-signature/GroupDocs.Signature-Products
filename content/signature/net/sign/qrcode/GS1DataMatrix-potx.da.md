...
head_description: "Opret G S1 Data Matrix QR-kode og læg den i Potx-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer G S1 Data Matrix QR-kodesignatur for Potx dokument i C#"
description: "eSignér dine Potx-dokumenter og kontrakter med G S1 Data Matrix QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Trin til at signere Potx med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Potx dokumenter med Qrcode signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Potx dokumenter med Qrcode Live Demo"
    content: |
