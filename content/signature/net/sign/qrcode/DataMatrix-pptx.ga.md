...
############################# Head ############################
head_title: "eSign Pptx doiciméad le Data Matrix Cód QR in C#"
head_description: "Cruthaigh Data Matrix Cód QR agus cuir ar chomhad Pptx é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Data Matrix don doiciméad Pptx in C#"
description: "eSínigh do dhoiciméid agus conarthaí Pptx le Data Matrix Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Céimeanna chun Pptx a shíniú le Qrcode in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Pptx a shíniú le sínithe Qrcode go tapa agus go héasca.
...
more_formats:
    ...
    content: |
        "Is féidir leat Pptx a shíniú le cineálacha sínithe eile freisin. Féach ar an liosta thíos le do thoil."
    format: 
