...
############################# Head ############################
head_title: "C# ішінде G S1 Data Matrix QR коды бар eSign Pps құжаты"
head_description: "G S1 Data Matrix QR кодын жасаңыз және оны .NET арқылы C# кодының қысқа бөлігімен Pps файлына салыңыз. QR коды арқылы іскери құжаттар мен файлдарға электрондық қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "C# ішінде Pps құжаты үшін G S1 Data Matrix QR код қолтаңбасын жасаңыз"
description: "Pps құжаттарыңыз бен келісім-шарттарыңызға G S1 Data Matrix QR Code арқылы қол қойыңыз. QR Code қолтаңбасын тез және оңай жасаңыз."
...
steps:
    enable: true
    title_left: "C# жүйесінде Qrcode арқылы Pps файлына қол қою қадамдары"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) Pps құжаттарға Qrcode қолтаңбаларымен жылдам және оңай қол қою мүмкіндігін береді.
...
demos:
    enable: true
    title: "Pps құжаттарға Qrcode тікелей көрсетілімі арқылы қол қою"
    content: |
