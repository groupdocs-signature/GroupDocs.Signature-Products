...
############################# Head ############################
head_title: "eSign Zip document met QR QR-code in C#"
head_description: "Maak een QR QR-code en plaats deze in het Zip-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer QR QR Code handtekening voor Zip document in C#"
description: "Onderteken uw Zip documenten en contracten met QR QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Zip te ondertekenen met Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Zip documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
