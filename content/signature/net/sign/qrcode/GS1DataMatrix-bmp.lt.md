...
############################# Head ############################
head_title: "eSign Bmp dokumentas su G S1 Data Matrix QR kodu C#"
head_description: "Sukurkite QR kodą G S1 Data Matrix ir įdėkite jį į failą Bmp naudodami .NET su trumpu C# kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Data Matrix QR kodo parašą Bmp dokumentui C#"
description: "e. Pasirašykite Bmp dokumentus ir sutartis naudodami G S1 Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Bmp naudojant Qrcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Bmp dokumentus su Qrcode parašais.
        
        * Sukurkite parašo klasės egzempliorių, pateikiantį Bmp failą, kuris turėtų būti pasirašytas kaip kelias arba atminties srautas
        * Sukurkite SignOptions klasę ir nustatykite visus reikalingus duomenis.
        * Iškvieskite Signature.Sign() metodą, perduodantį išvesties Bmp failą arba atminties srautą
...
demos:
    enable: true
    title: "Dokumentų Bmp pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
       Pasirašykite Bmp failą įvairiais parašais dabar apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje. Jūsų laukia nemokama internetinė demonstracinė versija.
...
more_formats:
    ...
    content: |
        "Taip pat galite pasirašyti Bmp naudodami kitų tipų parašus. Žiūrėkite žemiau esantį sąrašą."
    format: 
