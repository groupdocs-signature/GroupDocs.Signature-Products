...
############################# Head ############################
head_title: "eSign Pdf dokument s Data Matrix QR kodo v C#"
head_description: "Ustvarite QR kodo Data Matrix in jo postavite v datoteko Pdf z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari Data Matrix podpis kode QR za dokument Pdf v C#"
description: "e-Podpišite svoje Pdf dokumente in pogodbe s Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Pdf z Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Pdf s podpisi Qrcode.
        
        * Ustvarite primerek razreda podpisa, ki zagotavlja datoteko Pdf, ki naj bi se podpisala kot pot ali pomnilniški tok
        * Instanciirajte razred SignOptions in nastavite vse zahtevane podatke.
        * Prikličite metodo Signature.Sign(), ki posreduje izhodno datoteko Pdf ali pomnilniški tok
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Pdf z Qrcode Live Demo"
    content: |
       Takoj zdaj podpišite datoteko Pdf z različnimi podpisi, tako da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Brezplačna spletna predstavitev čaka na vas.
...
more_formats:
    ...
    content: |
        "Pdf lahko podpišete tudi z drugimi vrstami podpisov. Oglejte si spodnji seznam."
    format: 
