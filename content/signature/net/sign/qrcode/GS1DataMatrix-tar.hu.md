...
############################# Head ############################
head_title: "eSign Tar dokumentum G S1 Data Matrix QR-kóddal a C# nyelven"
head_description: "Hozzon létre G S1 Data Matrix QR-kódot, és helyezze el a Tar fájlba a .NET használatával egy rövid C# kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon G S1 Data Matrix QR-kód aláírást a Tar dokumentumhoz a C# programban"
description: "eAláírja Tar dokumentumait és szerződéseit G S1 Data Matrix QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
