...
############################# Head ############################
head_title: "Dokument eSign Gif s QR QR kódem v C#"
head_description: "Vytvořte QR kód QR a vložte jej do souboru Gif pomocí .NET s krátkým kódem C#. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis QR QR kódu pro dokument Gif v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Gif pomocí Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Gif pomocí podpisů Qrcode.
