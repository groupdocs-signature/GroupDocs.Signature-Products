...
description: "eSínigh do dhoiciméid agus conarthaí Tiff le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Tiff doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
