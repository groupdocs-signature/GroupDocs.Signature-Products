...
############################# Head ############################
head_title: "eSigniere Bmp-Dokument mit G S1 Data Matrix-QR-Code in C#"
head_description: "Erstellen Sie einen G S1 Data Matrix-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Bmp-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere G S1 Data Matrix-QR-Code-Signatur für Bmp-Dokument in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Bmp mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Bmp-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
