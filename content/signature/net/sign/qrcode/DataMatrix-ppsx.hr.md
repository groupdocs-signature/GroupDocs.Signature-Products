...
############################# Head ############################
head_title: "eSign Ppsx dokument s Data Matrix QR kodom u C#"
head_description: "Napravite Data Matrix QR kod i stavite ga u datoteku Ppsx koristeći .NET s kratkim dijelom C# koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj Data Matrix potpis QR koda za Ppsx dokument u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Ppsx s Qrcode u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Ppsx dokumenata s Qrcode potpisima.
