...
############################# Head ############################
head_title: "Podpisz dokument Bmp z kodem QR Data Matrix w C#"
head_description: "Utwórz kod QR Data Matrix i umieść go w pliku Bmp za pomocą .NET z krótkim fragmentem kodu C#. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis Data Matrix kodu QR dla dokumentu Bmp w C#"
description: "Podpisz elektronicznie dokumenty i umowy w Bmp za pomocą kodu QR Data Matrix. Szybko i łatwo generuj podpis QR Code."
