...
############################# Head ############################
head_title: "Belgeya eSign Xlsx bi QR Koda QR di C#"
head_description: "Koda QR-a QR biafirînin û bi koda C# bi koda .NET li pelê Xlsx bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."
