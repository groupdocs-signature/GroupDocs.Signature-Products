...
############################# Head ############################
head_title: "eSign 7z -asiakirja QR QR-koodilla C#"
head_description: "Luo QR-koodi QR ja laita se 7z-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo QR QR-koodiallekirjoitus asiakirjalle 7z kohteessa C#"
...
steps:
    enable: true
    title_left: "Vaiheet 7z:n allekirjoittamiseen Qrcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa 7z-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
