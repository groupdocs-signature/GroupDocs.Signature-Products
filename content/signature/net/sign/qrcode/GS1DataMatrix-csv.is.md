...
############################# Head ############################
head_title: "eSign Csv skjal með G S1 Data Matrix QR kóða í C#"
head_description: "Búðu til G S1 Data Matrix QR kóða og settu hann á Csv skrá með því að nota .NET með stuttu stykki af C# kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til G S1 Data Matrix QR kóða undirskrift fyrir Csv skjal í C#"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Csv með Qrcode í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Csv skjöl með Qrcode undirskrift fljótt og auðveldlega.
