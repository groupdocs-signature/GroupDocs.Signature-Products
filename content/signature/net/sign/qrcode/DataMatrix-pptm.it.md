...
############################# Head ############################
head_title: "eSign Pptm documento con Data Matrix codice QR in C#"
head_description: "Crea il codice QR Data Matrix e inseriscilo nel file Pptm utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Data Matrix firma del codice QR per il documento Pptm in C#"
description: "Firma i tuoi documenti e contratti Pptm con il codice QR Data Matrix. Genera la firma del codice QR in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Pptm con Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Pptm con firme Qrcode in modo rapido e semplice.
        
        * Crea un'istanza della classe Signature che fornisce il file Pptm che dovrebbe firmare come percorso o flusso di memoria
        * Crea un'istanza della classe SignOptions e imposta tutti i dati richiesti.
        * Richiama il metodo Signature.Sign() passando il file di output Pptm o il flusso di memoria
...
demos:
    enable: true
    title: "Firma di documenti Pptm con Qrcode Demo live"
    content: |
       Firma subito il file Pptm con varie firme visitando il sito web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo online gratuita ti aspetta.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix è un codice bidimensionale costituito da "celle" o punti in bianco e nero disposti in uno schema quadrato o rettangolare, noto anche come matrice. Le informazioni da codificare possono essere di testo o dati numerici.
          characterset: |
             Supporta tutti i 256 caratteri ASCII, tutti i caratteri ISO e tutti i caratteri EBCDIC (Extended Binary Coded Decimal Interchange Code).
          textcapacity: |
             Fino a 3116 cifre numeriche o 2335 caratteri alfanumerici o 1556 caratteri binari.
          image: |
...
more_formats:
    ...
    content: |
        "Puoi anche firmare Pptm con altri tipi di firma. Si prega di consultare l'elenco di seguito."
    format: 
