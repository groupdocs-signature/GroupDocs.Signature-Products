...
############################# Head ############################
head_title: "eSign Docm-dokument med G S1 Data Matrix QR-kode i C#"
head_description: "Lag G S1 Data Matrix QR-kode og legg den til Docm-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer G S1 Data Matrix QR-kodesignatur for Docm-dokument i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Docm med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Docm-dokumenter med Qrcode-signaturer raskt og enkelt.
