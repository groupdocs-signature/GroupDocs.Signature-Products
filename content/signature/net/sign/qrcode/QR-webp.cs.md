...
############################# Head ############################
head_title: "Dokument eSign Webp s QR QR kódem v C#"
head_description: "Vytvořte QR kód QR a vložte jej do souboru Webp pomocí .NET s krátkým kódem C#. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis QR QR kódu pro dokument Webp v C#"
description: "ePodepište své dokumenty a smlouvy ve formátu Webp pomocí QR kódu QR. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Webp pomocí Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Webp pomocí podpisů Qrcode.
