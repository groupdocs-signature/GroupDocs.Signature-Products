...
############################# Head ############################
head_title: "eSign documentul Pps cu codul QR Data Matrix în C#"
head_description: "Creați codul QR Data Matrix și puneți-l în fișierul Pps folosind .NET cu o scurtă bucată de cod C#. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura Data Matrix cod QR pentru documentul Pps în C#"
