...
############################# Head ############################
head_title: "eSign Ots document with Aztec QR Code in C#"
head_description: "Create Aztec QR Code and put it on Ots file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."
