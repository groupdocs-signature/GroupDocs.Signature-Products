...
############################# Head ############################
head_title: "eSign Tar document met Aztec QR-code in C#"
head_description: "Maak een Aztec QR-code en plaats deze in het Tar-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Aztec QR Code handtekening voor Tar document in C#"
description: "Onderteken uw Tar documenten en contracten met Aztec QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
