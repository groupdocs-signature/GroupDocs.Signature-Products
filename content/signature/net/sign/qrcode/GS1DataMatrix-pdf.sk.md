...
############################# Head ############################
head_title: "eSign Pdf dokument s G S1 Data Matrix QR kódom v C#"
head_description: "Vytvorte G S1 Data Matrix QR kód a vložte ho do súboru Pdf pomocou .NET s krátkym kódom C#. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte G S1 Data Matrix podpis QR kódu pre dokument Pdf v C#"
description: "ePodpíšte svoje Pdf dokumenty a zmluvy pomocou G S1 Data Matrix QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Pdf pomocou Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Pdf pomocou podpisov Qrcode.
        
        * Vytvorte inštanciu triedy Signature poskytujúcej súbor Pdf, ktorý sa má podpisovať ako cesta alebo prúd pamäte
        * Instanciujte triedu SignOptions a nastavte všetky požadované údaje.
        * Vyvolajte metódu Signature.Sign() odovzdajúc výstupný súbor Pdf alebo prúd pamäte
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Pdf pomocou živej ukážky Qrcode"
    content: |
       Podpíšte súbor Pdf pomocou rôznych podpisov práve teraz na webovej lokalite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čaká.
...
more_formats:
    ...
    content: |
        "Pdf môžete podpísať aj inými typmi podpisov. Pozrite si zoznam nižšie."
    format: 
