...
############################# Head ############################
head_title: "C# で Data Matrix QR コードを使用して Jpg 文書に eSign"
head_description: "Data Matrix QR コードを作成し、短い C# コードを含む .NET を使用して Jpg ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の Jpg ドキュメントの Data Matrix QR コード署名を生成します"
