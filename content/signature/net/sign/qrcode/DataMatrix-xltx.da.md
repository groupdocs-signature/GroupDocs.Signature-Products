...
############################# Head ############################
head_title: "eSign Xltx-dokument med Data Matrix QR-kode i C#"
head_description: "Opret Data Matrix QR-kode og læg den i Xltx-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer Data Matrix QR-kodesignatur for Xltx dokument i C#"
description: "eSignér dine Xltx-dokumenter og kontrakter med Data Matrix QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix er en todimensionel kode, der består af sorte og hvide 'celler' eller prikker arrangeret i enten et kvadratisk eller rektangulært mønster, også kendt som en matrix. Den information, der skal kodes, kan være tekst eller numeriske data.
          characterset: |
             Understøtter alle 256 ASCII-tegn, alle ISO-tegn og alle EBCDIC-tegn (Extended Binary Coded Decimal Interchange Code).
          textcapacity: |
             Op til 3116 numeriske cifre eller 2335 alfanumeriske tegn eller 1556 binære tegn.
          image: |
