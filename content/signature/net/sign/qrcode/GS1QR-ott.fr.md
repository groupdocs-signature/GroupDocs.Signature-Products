...
############################# Head ############################
head_title: "eSign Ott document avec G S1 Q R QR Code en C#"
head_description: "Créez le code QR G S1 Q R et placez-le dans le fichier Ott en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR G S1 Q R pour le document Ott en C#"
description: "Signez électroniquement vos documents et contrats Ott avec G S1 Q R QR Code. Générez une signature QR Code rapidement et facilement."
