...
############################# Head ############################
head_title: "eSign Pptx dokumentum QR QR-kóddal a C# nyelven"
head_description: "Hozzon létre QR QR-kódot, és helyezze el a Pptx fájlba a .NET használatával egy rövid C# kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon QR QR-kód aláírást a Pptx dokumentumhoz a C# programban"
description: "eAláírja Pptx dokumentumait és szerződéseit QR QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
...
steps:
    enable: true
    title_left: "A Pptx aláírásának lépései a Qrcode segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Pptx dokumentumok gyors és egyszerű aláírását Qrcode aláírással.
        
        * Hozzon létre egy példányt a Signature osztályból, amely Pptx fájlt tartalmaz, amelyet elérési útként vagy memóriafolyamként kell aláírni
        * Példányosítsa a SignOptions osztályt, és állítsa be az összes kért adatot.
        * Hívja meg a Signature.Sign() metódust, amely átadja a kimeneti Pptx fájlt vagy memóriafolyamot
...
demos:
    enable: true
    title: "Pptx dokumentumok aláírása Qrcode élő bemutatóval"
    content: |
       A [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webhelyen azonnal írjon alá Pptx fájlt különféle aláírásokkal. Ingyenes online demo vár rád.
...
more_formats:
    ...
    content: |
        "A Pptx más aláírástípusokkal is aláírható. Kérjük, tekintse meg az alábbi listát."
    format: 
