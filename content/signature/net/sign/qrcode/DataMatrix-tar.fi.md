...
############################# Head ############################
head_title: "eSign Tar -asiakirja Data Matrix QR-koodilla C#"
head_description: "Luo QR-koodi Data Matrix ja laita se Tar-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo Data Matrix QR-koodiallekirjoitus asiakirjalle Tar kohteessa C#"
