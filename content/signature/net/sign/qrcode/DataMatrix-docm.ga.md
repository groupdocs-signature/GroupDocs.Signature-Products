...
############################# Head ############################
head_title: "eSign Docm doiciméad le Data Matrix Cód QR in C#"
head_description: "Cruthaigh Data Matrix Cód QR agus cuir ar chomhad Docm é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Data Matrix don doiciméad Docm in C#"
description: "eSínigh do dhoiciméid agus conarthaí Docm le Data Matrix Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is cód déthoiseach é Maitrís Sonraí a chuimsíonn 'cealla' nó poncanna dubha agus bána eagraithe i bpatrún cearnach nó dronuilleogach, ar a dtugtar maitrís freisin. Is féidir sonraí téacs nó uimhriúla a bheith san fhaisnéis atá le hionchódú.
          characterset: |
             Tacaíonn sé le gach 256 carachtar ASCII, gach carachtar ISO, agus gach carachtar Leathnaithe Dénártha Idirmhalartaithe Deachúil Cód (EBCDIC).
          textcapacity: |
             Suas le 3116 dhigit uimhriúil, nó 2335 carachtar alfa-uimhriúil, nó 1556 carachtar dénártha.
          image: |
