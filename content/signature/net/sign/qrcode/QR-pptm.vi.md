...
############################# Head ############################
head_title: "eSign Pptm tài liệu với QR Mã QR trong C#"
head_description: "Tạo Mã QR QR và đặt nó vào tệp Pptm bằng cách sử dụng .NET với một đoạn mã C# ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR QR cho tài liệu Pptm trong C#"
description: "eSign các tài liệu và hợp đồng Pptm của bạn bằng Mã QR QR. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
