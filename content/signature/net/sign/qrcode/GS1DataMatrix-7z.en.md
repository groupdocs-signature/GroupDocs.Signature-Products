...
############################# Head ############################
head_title: "eSign 7z document with G S1 Data Matrix QR Code in C#"
head_description: "Create G S1 Data Matrix QR Code and put it on 7z file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Data Matrix QR Code signature for 7z document in C#"
...
steps:
    enable: true
    title_left: "Steps to sign 7z with Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign 7z documents with Qrcode signatures quickly and easily.
