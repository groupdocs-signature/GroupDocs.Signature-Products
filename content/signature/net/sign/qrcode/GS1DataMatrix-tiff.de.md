...
############################# Head ############################
head_title: "eSigniere Tiff-Dokument mit G S1 Data Matrix-QR-Code in C#"
head_description: "Erstellen Sie einen G S1 Data Matrix-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Tiff-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere G S1 Data Matrix-QR-Code-Signatur für Tiff-Dokument in C#"
description: "Unterzeichnen Sie Ihre Tiff-Dokumente und -Verträge mit dem G S1 Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
demos:
    enable: true
    title: "Signieren von Tiff-Dokumenten mit Qrcode Live-Demo"
    content: |
       Signieren Sie die Datei Tiff jetzt mit verschiedenen Signaturen, indem Sie die Website [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) besuchen. Kostenlose Online-Demo wartet auf Sie.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix ist eine Variante von Data Matrix, die den GS1-Spezifikationen entspricht. Verwenden Sie GS1 DataMatrix, um die Informationen zu codieren, wie z. B., aber nicht beschränkt auf die folgenden: AI(01) Global Trade Item Number (GTIN), AI(17) Expiration Date, AI(10) Batch Number, AI(21) Serial Number .
          characterset: |
             Zeichensatz: Groß- und Kleinbuchstaben sowie Sonderzeichen $@%*+-./:=<>;&*_,'! alle mit korrekten Anwendungskennungen.
          textcapacity: |
             Codetext-Kapazität: bis zu 3116 numerische Ziffern oder 2335 alphanumerische Zeichen.
          image: |
...
more_formats:
    ...
    content: |
        "Sie können Tiff auch mit anderen Signaturtypen signieren. Bitte sehen Sie sich die Liste unten an."
    format: 
