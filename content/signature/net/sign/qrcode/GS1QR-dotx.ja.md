...
############################# Head ############################
head_title: "C# で G S1 Q R QR コードを使用して Dotx 文書に eSign"
head_description: "G S1 Q R QR コードを作成し、短い C# コードを含む .NET を使用して Dotx ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の Dotx ドキュメントの G S1 Q R QR コード署名を生成します"
description: "Dotx ドキュメントと契約書に G S1 Q R QR コードで電子署名します。 QR コード署名をすばやく簡単に生成します。"
