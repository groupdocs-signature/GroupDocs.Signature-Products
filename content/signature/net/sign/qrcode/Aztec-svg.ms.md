...
############################# Head ############################
head_title: "eSign Svg dokumen dengan Aztec QR Code dalam C#"
head_description: "Cipta Aztec Kod QR dan letakkan pada fail Svg menggunakan .NET dengan sekeping pendek kod C#. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan Aztec tandatangan Kod QR untuk Svg dokumen dalam C#"
description: "eTandatangani dokumen dan kontrak Svg anda dengan Kod QR Aztec. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Svg dengan Qrcode dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Svg dengan tandatangan Qrcode dengan cepat dan mudah.
