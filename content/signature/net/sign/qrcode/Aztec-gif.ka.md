...
############################# Head ############################
head_title: "eSign Gif დოკუმენტი Aztec QR კოდით C#-ში"
head_description: "შექმენით Aztec QR კოდი და განათავსეთ ის Gif ფაილზე .NET-ის გამოყენებით C# კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით Aztec QR კოდის ხელმოწერა Gif დოკუმენტისთვის C#-ში"
...
steps:
    enable: true
    title_left: "Gif-ით ხელმოწერის ნაბიჯები Qrcode-ით C#-ში"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) იძლევა შესაძლებლობას მოაწეროთ Gif დოკუმენტები Qrcode ხელმოწერებით სწრაფად და მარტივად.
