...
############################# Head ############################
head_title: "eSign Bmp documento con G S1 Data Matrix codice QR in C#"
head_description: "Crea il codice QR G S1 Data Matrix e inseriscilo nel file Bmp utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera G S1 Data Matrix firma del codice QR per il documento Bmp in C#"
description: "Firma i tuoi documenti e contratti Bmp con il codice QR G S1 Data Matrix. Genera la firma del codice QR in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Bmp con Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Bmp con firme Qrcode in modo rapido e semplice.
        
        * Crea un'istanza della classe Signature che fornisce il file Bmp che dovrebbe firmare come percorso o flusso di memoria
        * Crea un'istanza della classe SignOptions e imposta tutti i dati richiesti.
        * Richiama il metodo Signature.Sign() passando il file di output Bmp o il flusso di memoria
...
demos:
    enable: true
    title: "Firma di documenti Bmp con Qrcode Demo live"
    content: |
       Firma subito il file Bmp con varie firme visitando il sito web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demo online gratuita ti aspetta.
...
more_formats:
    ...
    content: |
        "Puoi anche firmare Bmp con altri tipi di firma. Si prega di consultare l'elenco di seguito."
    format: 
