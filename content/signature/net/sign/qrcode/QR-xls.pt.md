...
############################# Head ############################
head_title: "eSign Xls documento com QR QR Code em C#"
head_description: "Crie QR QR Code e coloque-o no arquivo Xls usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere QR assinatura de QR Code para Xls documento em C#"
description: "Assine seus documentos e contratos Xls com QR QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Xls com Qrcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Xls com assinaturas Qrcode de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Xls documentos com Qrcode Demonstração ao vivo"
    content: |
