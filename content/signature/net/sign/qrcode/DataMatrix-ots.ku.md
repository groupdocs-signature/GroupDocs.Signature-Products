...
############################# Head ############################
head_title: "Belgeya eSign Ots bi Data Matrix Koda QR di C#"
head_description: "Koda QR-a Data Matrix biafirînin û bi koda C# bi koda .NET li pelê Ots bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."
