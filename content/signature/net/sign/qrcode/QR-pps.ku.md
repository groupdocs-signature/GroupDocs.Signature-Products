...
############################# Head ############################
head_title: "Belgeya eSign Pps bi QR Koda QR di C#"
head_description: "Koda QR-a QR biafirînin û bi koda C# bi koda .NET li pelê Pps bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Pps bi Qrcode di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Pps bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
