...
head_description: "Create Aztec QR Code and put it on Webp file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Webp document in C#"
description: "eSign your Webp documents and contracts with Aztec QR Code. Generate QR Code signature quickly and easily."
