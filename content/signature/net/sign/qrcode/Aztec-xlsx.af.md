...
############################# Head ############################
head_title: "eSign Xlsx-dokument met Aztec QR-kode in C#"
head_description: "Skep Aztec QR-kode en plaas dit op Xlsx-lêer deur .NET met 'n kort stukkie C#-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer Aztec QR-kode handtekening vir Xlsx dokument in C#"
description: "eTeken jou Xlsx dokumente en kontrakte met Aztec QR-kode. Genereer QR-kode handtekening vinnig en maklik."
