...
############################# Head ############################
head_title: "eSigniere Pps-Dokument mit QR-QR-Code in C#"
head_description: "Erstellen Sie einen QR-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Pps-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere QR-QR-Code-Signatur für Pps-Dokument in C#"
description: "Unterzeichnen Sie Ihre Pps-Dokumente und -Verträge mit dem QR-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
