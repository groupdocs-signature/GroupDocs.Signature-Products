...
############################# Head ############################
head_title: "C# で QR QR コードを使用して 7z 文書に eSign"
head_description: "QR QR コードを作成し、短い C# コードを含む .NET を使用して 7z ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の 7z ドキュメントの QR QR コード署名を生成します"
