...
head_description: "Create G S1 Q R QR Code and put it on Dotx file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Q R QR Code signature for Dotx document in C#"
description: "eSign your Dotx documents and contracts with G S1 Q R QR Code. Generate QR Code signature quickly and easily."
