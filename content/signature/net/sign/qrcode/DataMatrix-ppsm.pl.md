...
############################# Head ############################
head_title: "Podpisz dokument Ppsm z kodem QR Data Matrix w C#"
head_description: "Utwórz kod QR Data Matrix i umieść go w pliku Ppsm za pomocą .NET z krótkim fragmentem kodu C#. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis Data Matrix kodu QR dla dokumentu Ppsm w C#"
