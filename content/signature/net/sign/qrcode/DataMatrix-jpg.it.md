...
############################# Head ############################
head_title: "eSign Jpg documento con Data Matrix codice QR in C#"
head_description: "Crea il codice QR Data Matrix e inseriscilo nel file Jpg utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Data Matrix firma del codice QR per il documento Jpg in C#"
