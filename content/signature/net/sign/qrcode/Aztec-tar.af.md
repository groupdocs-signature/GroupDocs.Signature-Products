...
############################# Head ############################
head_title: "eSign Tar-dokument met Aztec QR-kode in C#"
head_description: "Skep Aztec QR-kode en plaas dit op Tar-lêer deur .NET met 'n kort stukkie C#-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer Aztec QR-kode handtekening vir Tar dokument in C#"
description: "eTeken jou Tar dokumente en kontrakte met Aztec QR-kode. Genereer QR-kode handtekening vinnig en maklik."
...
steps:
    enable: true
    title_left: "Stappe om Tar met Qrcode in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Tar dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
        
        * Skep 'n instansie van Signature-klas wat Tar-lêer verskaf wat veronderstel is om te onderteken as pad of geheuestroom
        * Instansieer SignOptions-klas en stel alle verlangde data in.
        * Roep die Signature.Sign()-metode deur die uitvoer Tar-lêer of geheuestroom deur te gee
...
demos:
    enable: true
    title: "Teken Tar dokumente met Qrcode Regstreekse Demo"
    content: |
       Teken nou die Tar-lêer met verskeie handtekeninge deur die [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) webwerf te besoek. Gratis aanlyn demo wag vir jou.
...
more_formats:
    ...
    content: |
        "Jy kan ook Tar met ander handtekeningtipes onderteken. Sien asseblief die lys hieronder."
    format: 
