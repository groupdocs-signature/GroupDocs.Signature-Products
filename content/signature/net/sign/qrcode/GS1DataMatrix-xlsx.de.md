...
############################# Head ############################
head_title: "eSigniere Xlsx-Dokument mit G S1 Data Matrix-QR-Code in C#"
head_description: "Erstellen Sie einen G S1 Data Matrix-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Xlsx-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere G S1 Data Matrix-QR-Code-Signatur für Xlsx-Dokument in C#"
description: "Unterzeichnen Sie Ihre Xlsx-Dokumente und -Verträge mit dem G S1 Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Xlsx mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Xlsx-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
        ...
        * Rufen Sie die Signature.Sign()-Methode auf und übergeben Sie die Xlsx-Ausgabedatei oder den Speicherstream
...
demos:
    enable: true
    title: "Signieren von Xlsx-Dokumenten mit Qrcode Live-Demo"
    content: |
