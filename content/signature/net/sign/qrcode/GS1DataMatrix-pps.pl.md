...
############################# Head ############################
head_title: "Podpisz dokument Pps z kodem QR G S1 Data Matrix w C#"
head_description: "Utwórz kod QR G S1 Data Matrix i umieść go w pliku Pps za pomocą .NET z krótkim fragmentem kodu C#. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis G S1 Data Matrix kodu QR dla dokumentu Pps w C#"
...
steps:
    enable: true
    title_left: "Kroki do podpisania Pps za pomocą Qrcode w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Pps za pomocą podpisów Qrcode.
