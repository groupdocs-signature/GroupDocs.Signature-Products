...
############################# Head ############################
head_title: "eSign Dcm document met Aztec QR-code in C#"
head_description: "Maak een Aztec QR-code en plaats deze in het Dcm-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Aztec QR Code handtekening voor Dcm document in C#"
description: "Onderteken uw Dcm documenten en contracten met Aztec QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          textcapacity: |
             Tot 3.832 numerieke cijfers, of 3.067 alfabetische tekens, of 1.914 bytes aan gegevens.
          image: |
