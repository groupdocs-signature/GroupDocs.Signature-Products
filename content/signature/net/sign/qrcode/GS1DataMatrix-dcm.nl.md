...
breadcrumb: Put  Qrcode signature on Dcm for C#

############################# Head ############################
head_title: "eSign Dcm document met G S1 Data Matrix QR-code in C#"
head_description: "Maak een G S1 Data Matrix QR-code en plaats deze in het Dcm-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR Code handtekening voor Dcm document in C#"
description: "Onderteken uw Dcm documenten en contracten met G S1 Data Matrix QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
about:
    enable: true
    title: "Over GroupDocs.Signature for .NET QR Code handtekeningen API"
    content: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) is een volwassen API voor het maken en genereren van QR-codehandtekeningen voor de documenten. Gebruikers kunnen QR-codehandtekeningen genereren met tekst om deze te downloaden of als afbeelding via de sociale media te delen. Het ondertekende document kan worden gescand met API of gewoon via de mobiele camera! Onderteken uw zakelijke contracten en officiële documenten elektronisch door een QR-codehandtekening toe te voegen en manipuleer deze. Elke handtekening met een QR-code bevat unieke aangepaste informatie om de ondertekenaar te identificeren of het document te autoriseren. Bovendien kan de inhoud van de QR-code programmatisch worden versleuteld en ontsleuteld met persoonlijke sleutels. Dat opent veel mogelijkheden om gevoelige gegevens in de openbare documenten te delen. Na de ondertekening kan de gebruiker de QR-codes bijwerken, verifiëren, verwijderen, bekijken of zoeken in PDF's, MS Word-documenten, MS Excel-werkmappen, MS PowerPoint-presentaties, Adobe Photoshop-bestanden en verschillende afbeeldingsformaten. QR-codes kunnen bovendien worden aangepast.
    

############################# Steps ############################
steps:
    enable: true
    title_left: "Stappen om Dcm te ondertekenen met Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Dcm documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
        
        * Maak een instantie van de Signature-klasse die een Dcm-bestand levert dat moet worden ondertekend als pad of geheugenstroom
        * Instantieer SignOptions klasse en stel alle gevraagde gegevens in.
        * Roep de Signature.Sign()-methode op en geef uitvoer Dcm-bestand of geheugenstroom
...
demos:
    enable: true
    title: "Dcm documenten ondertekenen met Qrcode Live Demo"
    content: |
       Onderteken het Dcm-bestand met verschillende handtekeningen op dit moment door naar de website [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) te gaan. Gratis online demo voor u klaar.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix is ​​een variant van Data Matrix die voldoet aan de GS1-specificaties. Gebruik GS1 DataMatrix om de informatie te coderen, zoals, maar niet beperkt tot, het volgende: AI(01) Global Trade Item Number (GTIN), AI(17) Expiration Date, AI(10) Batch Number, AI(21) Serienummer .
          characterset: |
             Tekenset: hoofdletters en kleine letters en speciale tekens $@%*+-./:=<>;&*_,'! allemaal met de juiste applicatie-ID's.
          textcapacity: |
             Codetekstcapaciteit: tot 3116 numerieke cijfers of 2335 alfanumerieke tekens.
          image: |
...
more_formats:
    enable: true
    title: "Andere ondersteunde Qrcode handtekeningen voor C#"
    content: |
        "U kunt Dcm ook ondertekenen met andere soorten handtekeningen. Zie de lijst hieronder."
    format: 
