...
############################# Head ############################
head_title: "eSign Webp dokumentum QR QR-kóddal a C# nyelven"
head_description: "Hozzon létre QR QR-kódot, és helyezze el a Webp fájlba a .NET használatával egy rövid C# kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon QR QR-kód aláírást a Webp dokumentumhoz a C# programban"
description: "eAláírja Webp dokumentumait és szerződéseit QR QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Webp dokumentumok gyors és egyszerű aláírását Qrcode aláírással.
...
demos:
    enable: true
    title: "Webp dokumentumok aláírása Qrcode élő bemutatóval"
    content: |
