...
############################# Head ############################
head_title: "C# میں Data Matrix QR کوڈ کے ساتھ eSign Zip دستاویز"
head_description: "Data Matrix QR کوڈ بنائیں اور اسے .NET کا استعمال کرتے ہوئے C# کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Zip فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "C# میں Zip دستاویز کے لیے Data Matrix QR کوڈ دستخط بنائیں"
...
steps:
    enable: true
    title_left: "C# میں Qrcode کے ساتھ Zip پر دستخط کرنے کے مراحل"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) جلد اور آسانی سے Qrcode دستخطوں کے ساتھ Zip دستاویزات پر دستخط کرنے کی صلاحیت فراہم کرتا ہے۔
