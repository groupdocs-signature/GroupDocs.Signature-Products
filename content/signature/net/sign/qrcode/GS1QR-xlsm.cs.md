...
############################# Head ############################
head_title: "Dokument eSign Xlsm s G S1 Q R QR kódem v C#"
head_description: "Vytvořte QR kód G S1 Q R a vložte jej do souboru Xlsm pomocí .NET s krátkým kódem C#. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis G S1 Q R QR kódu pro dokument Xlsm v C#"
description: "ePodepište své dokumenty a smlouvy ve formátu Xlsm pomocí QR kódu G S1 Q R. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsm pomocí Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Xlsm pomocí podpisů Qrcode.
