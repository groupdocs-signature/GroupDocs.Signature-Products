...
############################# Head ############################
head_title: "eSign Dotm -asiakirja G S1 Data Matrix QR-koodilla C#"
head_description: "Luo QR-koodi G S1 Data Matrix ja laita se Dotm-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo G S1 Data Matrix QR-koodiallekirjoitus asiakirjalle Dotm kohteessa C#"
description: "eAllekirjoita Dotm-asiakirjat ja sopimukset QR-koodilla G S1 Data Matrix. Luo QR-koodin allekirjoitus nopeasti ja helposti."
...
steps:
    enable: true
    title_left: "Vaiheet Dotm:n allekirjoittamiseen Qrcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Dotm-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
