...
############################# Head ############################
head_title: "eSign Svg document met G S1 Data Matrix QR-code in C#"
head_description: "Maak een G S1 Data Matrix QR-code en plaats deze in het Svg-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR Code handtekening voor Svg document in C#"
...
steps:
    enable: true
    title_left: "Stappen om Svg te ondertekenen met Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Svg documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
