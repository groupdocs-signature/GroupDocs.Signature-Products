...
############################# Head ############################
head_title: "eSign Xltx փաստաթուղթը QR QR կոդով C#-ում"
head_description: "Ստեղծեք QR QR կոդ և դրեք այն Xltx ֆայլի վրա՝ օգտագործելով .NET՝ C# կոդի կարճ հատվածով: Օգտագործեք GroupDocs Document Signature API-ը՝ ձեր բիզնես փաստաթղթերն ու ֆայլերը QR կոդով էլեկտրոնային ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք QR QR կոդ ստորագրություն Xltx փաստաթղթի համար C#-ում"
