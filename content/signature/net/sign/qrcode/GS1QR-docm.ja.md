...
############################# Head ############################
head_title: "C# で G S1 Q R QR コードを使用して Docm 文書に eSign"
head_description: "G S1 Q R QR コードを作成し、短い C# コードを含む .NET を使用して Docm ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の Docm ドキュメントの G S1 Q R QR コード署名を生成します"
