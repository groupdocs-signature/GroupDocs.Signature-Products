...
head_description: "Opret QR QR-kode og læg den i Dotx-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Dotx dokument i C#"
description: "eSignér dine Dotx-dokumenter og kontrakter med QR QR-kode. Generer QR-kodesignatur hurtigt og nemt."
