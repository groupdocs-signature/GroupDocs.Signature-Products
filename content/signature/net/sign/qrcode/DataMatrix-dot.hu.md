...
############################# Head ############################
head_title: "eSign Dot dokumentum Data Matrix QR-kóddal a C# nyelven"
head_description: "Hozzon létre Data Matrix QR-kódot, és helyezze el a Dot fájlba a .NET használatával egy rövid C# kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon Data Matrix QR-kód aláírást a Dot dokumentumhoz a C# programban"
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Dot dokumentumok gyors és egyszerű aláírását Qrcode aláírással.
