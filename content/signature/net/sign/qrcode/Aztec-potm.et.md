...
############################# Head ############################
head_title: "eSign Potm dokument Aztec QR-koodiga rakenduses C#"
head_description: "Looge QR-kood Aztec ja sisestage see faili Potm, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Potm QR-koodi allkiri Aztec"
description: "eAllkirjasta oma Potm dokumendid ja lepingud QR-koodiga Aztec. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Potm allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Potm dokumente Qrcode allkirjaga.
