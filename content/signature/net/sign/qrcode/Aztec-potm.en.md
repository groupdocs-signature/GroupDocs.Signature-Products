...
head_description: "Create Aztec QR Code Signature on Potm file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Potm document in C#"
description: "eSign your Potm documents and contracts with Aztec QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options."
