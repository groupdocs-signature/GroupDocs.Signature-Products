...
############################# Head ############################
head_title: "eSign Ott document met Aztec QR-code in C#"
head_description: "Maak een Aztec QR-code en plaats deze in het Ott-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Aztec QR Code handtekening voor Ott document in C#"
description: "Onderteken uw Ott documenten en contracten met Aztec QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
