...
############################# Head ############################
head_title: "eSign Jpg document with Aztec QR Code in C#"
head_description: "Create Aztec QR Code Signature on Jpg file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Jpg document in C#"
description: "eSign your Jpg documents and contracts with Aztec QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
