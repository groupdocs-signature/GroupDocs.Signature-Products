...
############################# Head ############################
head_title: "eSign Dot-dokument med QR QR-kode i C#"
head_description: "Lag QR QR-kode og legg den til Dot-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Dot-dokument i C#"
description: "eSigner Dot-dokumentene og kontraktene dine med QR-koden QR. Generer QR-kodesignatur raskt og enkelt."
