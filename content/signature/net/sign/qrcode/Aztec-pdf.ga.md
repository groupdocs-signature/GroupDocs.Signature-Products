...
############################# Head ############################
head_title: "eSign Pdf doiciméad le Aztec Cód QR in C#"
head_description: "Cruthaigh Aztec Cód QR agus cuir ar chomhad Pdf é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Aztec don doiciméad Pdf in C#"
description: "eSínigh do dhoiciméid agus conarthaí Pdf le Aztec Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
