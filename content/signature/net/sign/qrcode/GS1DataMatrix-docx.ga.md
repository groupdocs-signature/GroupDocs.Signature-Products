...
description: "eSínigh do dhoiciméid agus conarthaí Docx le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Docx doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
