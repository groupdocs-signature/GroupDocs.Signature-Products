...
############################# Head ############################
head_title: "مستند eSign Bmp مع رمز الاستجابة السريعة QR في C#"
head_description: "أنشئ رمز الاستجابة السريعة QR وضعه في ملف Bmp باستخدام .NET مع جزء قصير من كود C#. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء QR توقيع رمز الاستجابة السريعة لمستند Bmp في C#"
