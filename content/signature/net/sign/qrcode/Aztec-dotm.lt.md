...
############################# Head ############################
head_title: "eSign Dotm dokumentas su Aztec QR kodu C#"
head_description: "Sukurkite QR kodą Aztec ir įdėkite jį į failą Dotm naudodami .NET su trumpu C# kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite Aztec QR kodo parašą Dotm dokumentui C#"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Dotm naudojant Qrcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Dotm dokumentus su Qrcode parašais.
