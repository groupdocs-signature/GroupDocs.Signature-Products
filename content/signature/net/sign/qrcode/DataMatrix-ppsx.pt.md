...
############################# Head ############################
head_title: "eSign Ppsx documento com Data Matrix QR Code em C#"
head_description: "Crie Data Matrix QR Code e coloque-o no arquivo Ppsx usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere Data Matrix assinatura de QR Code para Ppsx documento em C#"
description: "Assine seus documentos e contratos Ppsx com Data Matrix QR Code. Gere assinatura de QR Code de forma rápida e fácil."
