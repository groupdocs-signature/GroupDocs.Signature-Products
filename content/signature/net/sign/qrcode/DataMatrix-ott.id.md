...
############################# Head ############################
head_title: "eSign Ott dokumen dengan Data Matrix QR Code di C#"
head_description: "Buat Kode QR Data Matrix dan letakkan di file Ott menggunakan .NET dengan potongan pendek kode C#. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat Data Matrix tanda tangan Kode QR untuk dokumen Ott di C#"
description: "eTandatangani dokumen dan kontrak Ott Anda dengan Kode QR Data Matrix. Hasilkan tanda tangan Kode QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Ott dengan Qrcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Ott dengan Qrcode tanda tangan dengan cepat dan mudah.
