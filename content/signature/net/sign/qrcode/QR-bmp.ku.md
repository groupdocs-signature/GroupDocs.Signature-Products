...
############################# Head ############################
head_title: "Belgeya eSign Bmp bi QR Koda QR di C#"
head_description: "Koda QR-a QR biafirînin û bi koda C# bi koda .NET li pelê Bmp bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."
