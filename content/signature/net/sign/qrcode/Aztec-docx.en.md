...
############################# Head ############################
head_title: "eSign Docx document with Aztec QR Code in C#"
head_description: "Create Aztec QR Code Signature on Docx file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Docx document in C#"
