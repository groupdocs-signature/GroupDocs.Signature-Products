...
description: "eSínigh do dhoiciméid agus conarthaí Potm le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Potm doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
