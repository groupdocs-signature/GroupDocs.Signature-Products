...
############################# Head ############################
head_title: "مستند eSign Pdf مع رمز الاستجابة السريعة QR في C#"
head_description: "أنشئ رمز الاستجابة السريعة QR وضعه في ملف Pdf باستخدام .NET مع جزء قصير من كود C#. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء QR توقيع رمز الاستجابة السريعة لمستند Pdf في C#"
description: "قم بتوقيع Pdf على المستندات والعقود باستخدام رمز الاستجابة السريعة QR. قم بإنشاء توقيع QR Code بسرعة وسهولة."
