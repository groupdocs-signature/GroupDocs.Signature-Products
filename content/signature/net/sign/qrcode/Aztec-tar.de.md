...
############################# Head ############################
head_title: "eSigniere Tar-Dokument mit Aztec-QR-Code in C#"
head_description: "Erstellen Sie einen Aztec-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Tar-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Aztec-QR-Code-Signatur für Tar-Dokument in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Tar mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Tar-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
