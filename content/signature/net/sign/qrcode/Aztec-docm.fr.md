...
############################# Head ############################
head_title: "eSign Docm document avec Aztec QR Code en C#"
head_description: "Créez le code QR Aztec et placez-le dans le fichier Docm en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR Aztec pour le document Docm en C#"
