...
############################# Head ############################
head_title: "eSign Dcm დოკუმენტი Data Matrix QR კოდით C#-ში"
head_description: "შექმენით Data Matrix QR კოდი და განათავსეთ ის Dcm ფაილზე .NET-ის გამოყენებით C# კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით Data Matrix QR კოდის ხელმოწერა Dcm დოკუმენტისთვის C#-ში"
description: "მოაწერეთ თქვენი Dcm დოკუმენტები და კონტრაქტები Data Matrix QR კოდით. შექმენით QR კოდის ხელმოწერა სწრაფად და მარტივად."
...
demos:
    enable: true
    title: "დოკუმენტების Dcm ხელმოწერა Qrcode Live Demo-ით"
    content: |
       მოაწერეთ Dcm ფაილი სხვადასხვა ხელმოწერებით ახლავე, ეწვიეთ [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) ვებსაიტს. უფასო ონლაინ დემო გელოდებათ.
...
more_formats:
    enable: true
    title: "სხვა მხარდაჭერილი Qrcode ხელმოწერები C#-ისთვის"
    content: |
        "თქვენ ასევე შეგიძლიათ მოაწეროთ Dcm ხელმოწერის სხვა ტიპებით. გთხოვთ იხილოთ სია ქვემოთ."
    format: 
