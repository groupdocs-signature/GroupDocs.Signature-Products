...
############################# Head ############################
head_title: "eSign Zip documento com G S1 Data Matrix QR Code em C#"
head_description: "Crie G S1 Data Matrix QR Code e coloque-o no arquivo Zip usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere G S1 Data Matrix assinatura de QR Code para Zip documento em C#"
description: "Assine seus documentos e contratos Zip com G S1 Data Matrix QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Zip com Qrcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Zip com assinaturas Qrcode de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Zip documentos com Qrcode Demonstração ao vivo"
    content: |
