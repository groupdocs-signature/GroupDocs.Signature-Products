...
############################# Head ############################
head_title: "eSign Dotx dokument s Aztec QR kódom v C#"
head_description: "Vytvorte Aztec QR kód a vložte ho do súboru Dotx pomocou .NET s krátkym kódom C#. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte Aztec podpis QR kódu pre dokument Dotx v C#"
description: "ePodpíšte svoje Dotx dokumenty a zmluvy pomocou Aztec QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
