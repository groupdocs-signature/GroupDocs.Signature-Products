...
############################# Head ############################
head_title: "eSign Zip document with G S1 Data Matrix QR Code in C#"
head_description: "Create G S1 Data Matrix QR Code and put it on Zip file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Data Matrix QR Code signature for Zip document in C#"
description: "eSign your Zip documents and contracts with G S1 Data Matrix QR Code. Generate QR Code signature quickly and easily."
...
steps:
    enable: true
    title_left: "Steps to sign Zip with Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Zip documents with Qrcode signatures quickly and easily.
...
demos:
    enable: true
    title: "Signing Zip documents with Qrcode Live Demo"
    content: |
