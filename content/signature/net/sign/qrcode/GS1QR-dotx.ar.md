...
############################# Head ############################
head_title: "مستند eSign Dotx مع رمز الاستجابة السريعة G S1 Q R في C#"
head_description: "أنشئ رمز الاستجابة السريعة G S1 Q R وضعه في ملف Dotx باستخدام .NET مع جزء قصير من كود C#. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء G S1 Q R توقيع رمز الاستجابة السريعة لمستند Dotx في C#"
