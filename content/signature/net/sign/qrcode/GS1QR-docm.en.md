...
############################# Head ############################
head_title: "eSign Docm document with G S1 Q R QR Code in C#"
head_description: "Create G S1 Q R QR Code Signature on Docm file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Q R QR Code signature for Docm document in C#"
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with G S1 Q R Qrcode using C#"
    content: |
        .NET G S1 Q R Qrcode signatures management API for documents and images. Add G S1 Q R Qrcode signatures to some of the popular file formats as stated below.
    format: 
