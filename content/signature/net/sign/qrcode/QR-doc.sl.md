...
############################# Head ############################
head_title: "eSign Doc dokument s QR QR kodo v C#"
head_description: "Ustvarite QR kodo QR in jo postavite v datoteko Doc z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari QR podpis kode QR za dokument Doc v C#"
description: "e-Podpišite svoje Doc dokumente in pogodbe s QR QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Doc z Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Doc s podpisi Qrcode.
        
        * Ustvarite primerek razreda podpisa, ki zagotavlja datoteko Doc, ki naj bi se podpisala kot pot ali pomnilniški tok
        * Instanciirajte razred SignOptions in nastavite vse zahtevane podatke.
        * Prikličite metodo Signature.Sign(), ki posreduje izhodno datoteko Doc ali pomnilniški tok
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Doc z Qrcode Live Demo"
    content: |
       Takoj zdaj podpišite datoteko Doc z različnimi podpisi, tako da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Brezplačna spletna predstavitev čaka na vas.
...
more_formats:
    ...
    content: |
        "Doc lahko podpišete tudi z drugimi vrstami podpisov. Oglejte si spodnji seznam."
    format: 
