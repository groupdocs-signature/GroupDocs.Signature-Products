...
############################# Head ############################
head_title: "eSign Pptx dokumen dengan Data Matrix QR Code dalam C#"
head_description: "Cipta Data Matrix Kod QR dan letakkan pada fail Pptx menggunakan .NET dengan sekeping pendek kod C#. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan Data Matrix tandatangan Kod QR untuk Pptx dokumen dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pptx dengan Qrcode dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Pptx dengan tandatangan Qrcode dengan cepat dan mudah.
