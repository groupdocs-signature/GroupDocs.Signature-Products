...
description: "eSínigh do dhoiciméid agus conarthaí Ppsm le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Ppsm doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
