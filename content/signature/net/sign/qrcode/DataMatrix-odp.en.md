...
############################# Head ############################
head_title: "eSign Odp document with Data Matrix QR Code in C#"
head_description: "Create Data Matrix QR Code Signature on Odp file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Data Matrix QR Code signature for Odp document in C#"
description: "eSign your Odp documents and contracts with Data Matrix QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Odp files with Qrcode signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
        You can put Qrcode on Odp file in a very convenient way and for free. Besides that it is possible to sign Odp files using advanced Qrcode options. 
        ...
        * furthermore file can be encrypted with password or saved to memory stream.
        ...
        Signing Odp files with Qrcode provides vast amount opportunities for users. Moreover there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc.


############################# Steps ############################
steps:
    enable: true
    title_left: "Steps to sign Odp with Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Odp documents with Qrcode signatures quick and easily.
...
demos:
    enable: true
    title: "Signing Odp documents with Qrcode Live Demo"
    content: |
       Sign Odp file with Qrcode signature right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website. Free online demo waiting for you.
