...
############################# Head ############################
head_title: "eSign Potx dokumen dengan QR QR Code dalam C#"
head_description: "Cipta QR Kod QR dan letakkan pada fail Potx menggunakan .NET dengan sekeping pendek kod C#. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan QR tandatangan Kod QR untuk Potx dokumen dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Potx dengan Qrcode dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Potx dengan tandatangan Qrcode dengan cepat dan mudah.
