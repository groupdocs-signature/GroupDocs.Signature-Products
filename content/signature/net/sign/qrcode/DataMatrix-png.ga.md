...
description: "eSínigh do dhoiciméid agus conarthaí Png le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Png doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
