...
############################# Head ############################
head_title: "eSign Odp tài liệu với G S1 Data Matrix Mã QR trong C#"
head_description: "Tạo Mã QR G S1 Data Matrix và đặt nó vào tệp Odp bằng cách sử dụng .NET với một đoạn mã C# ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Data Matrix cho tài liệu Odp trong C#"
