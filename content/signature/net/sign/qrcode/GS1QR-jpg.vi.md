...
############################# Head ############################
head_title: "eSign Jpg tài liệu với G S1 Q R Mã QR trong C#"
head_description: "Tạo Mã QR G S1 Q R và đặt nó vào tệp Jpg bằng cách sử dụng .NET với một đoạn mã C# ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Q R cho tài liệu Jpg trong C#"
