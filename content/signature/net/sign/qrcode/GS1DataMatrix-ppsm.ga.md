...
############################# Head ############################
head_title: "eSign Ppsm doiciméad le G S1 Data Matrix Cód QR in C#"
head_description: "Cruthaigh G S1 Data Matrix Cód QR agus cuir ar chomhad Ppsm é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR G S1 Data Matrix don doiciméad Ppsm in C#"
