...
############################# Head ############################
head_title: "C# में Data Matrix QR कोड के साथ eSign Doc दस्तावेज़"
head_description: "Data Matrix QR कोड बनाएं और C# कोड के एक छोटे टुकड़े के साथ .NET का उपयोग करके इसे Doc फ़ाइल में डालें। QR कोड के साथ अपने व्यावसायिक दस्तावेज़ों और फ़ाइलों पर ई-हस्ताक्षर करने के लिए GroupDocs दस्तावेज़ हस्ताक्षर API का उपयोग करें।"

############################# Header ############################
title: "C# में Doc दस्तावेज़ के लिए Data Matrix QR कोड हस्ताक्षर जेनरेट करें"
description: "अपने Doc दस्तावेज़ों और अनुबंधों पर Data Matrix QR कोड के साथ ई-हस्ताक्षर करें। क्यूआर कोड हस्ताक्षर जल्दी और आसानी से उत्पन्न करें।"
...
steps:
    enable: true
    title_left: "C# में Qrcode के साथ Doc पर हस्ताक्षर करने के चरण"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) जल्दी और आसानी से Qrcode हस्ताक्षर के साथ Doc दस्तावेज़ों पर हस्ताक्षर करने की क्षमता प्रदान करता है।
...
demos:
    enable: true
    title: "Qrcode लाइव डेमो के साथ Doc दस्तावेज़ों पर हस्ताक्षर करना"
    content: |
