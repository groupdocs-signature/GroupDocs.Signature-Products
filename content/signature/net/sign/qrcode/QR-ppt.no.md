...
head_description: "Lag QR QR-kode og legg den til Ppt-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."
...
steps:
    enable: true
    title_left: "Trinn for å signere Ppt med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Ppt-dokumenter med Qrcode-signaturer raskt og enkelt.
