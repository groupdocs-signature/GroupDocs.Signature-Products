...
############################# Head ############################
head_title: "C#의 Data Matrix QR 코드로 Dcm 문서에 전자 서명"
head_description: "짧은 C# 코드와 함께 .NET을(를) 사용하여 Data Matrix QR 코드를 생성하고 Dcm 파일에 넣습니다. GroupDocs 문서 서명 API를 사용하여 QR 코드로 비즈니스 문서 및 파일에 전자 서명하십시오."

############################# Header ############################
title: "C#에서 Dcm 문서에 대한 Data Matrix QR 코드 서명 생성"
description: "Data Matrix QR 코드로 Dcm 문서 및 계약에 전자 서명합니다. QR 코드 서명을 빠르고 쉽게 생성합니다."
...
about:
    enable: true
    title: "GroupDocs.Signature for .NET QR Code 서명 API 정보"
    content: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/)은 문서에 대한 QR 코드 서명을 만들고 생성하기 위한 성숙한 API입니다. 사용자는 텍스트를 제공하는 QR 코드 서명을 생성하여 다운로드하거나 이미지로 소셜 미디어에 공유할 수 있습니다. 서명된 문서는 API로 스캔하거나 모바일 카메라를 통해 간단히 스캔할 수 있습니다! QR 코드 서명을 추가하여 비즈니스 계약 및 공식 문서에 전자 서명하고 조작하십시오. 모든 QR 코드 서명에는 서명자를 식별하거나 문서를 승인하는 고유한 사용자 지정 정보가 포함됩니다. 또한 QR 코드 콘텐츠는 프로그래밍 방식으로 개인 키로 암호화 및 해독할 수 있습니다. 이는 공개 문서 내에서 중요한 데이터를 공유할 수 있는 많은 기능을 제공합니다. 서명 후 사용자는 PDF, MS Word 문서, MS Excel 통합 문서, MS PowerPoint 프레젠테이션, Adobe Photoshop 파일 및 다양한 이미지 형식 내에서 QR 코드를 업데이트, 확인, 삭제, 미리보기 또는 검색할 수 있습니다. QR 코드는 추가로 사용자 정의할 수 있습니다.
    

############################# Steps ############################
steps:
    enable: true
    title_left: "C#에서 Qrcode으로 Dcm에 서명하는 단계"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/)은 Qrcode 서명으로 Dcm 문서에 빠르고 쉽게 서명할 수 있는 기능을 제공합니다.
        
        * 경로 또는 메모리 스트림으로 서명해야 하는 Dcm 파일을 제공하는 Signature 클래스의 인스턴스 생성
        * SignOptions 클래스를 인스턴스화하고 필요한 모든 데이터를 설정합니다.
        * 출력 Dcm 파일 또는 메모리 스트림을 전달하는 Signature.Sign() 메서드를 호출합니다.
...
demos:
    enable: true
    title: "Qrcode 라이브 데모로 Dcm 문서 서명"
    content: |
       지금 바로 [GroupDocs.Signature 앱](https://products.groupdocs.app/signature/family) 웹사이트에서 다양한 서명으로 Dcm 파일에 서명하세요. 무료 온라인 데모가 여러분을 기다리고 있습니다.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            데이터 매트릭스는 매트릭스라고도 하는 정사각형 또는 직사각형 패턴으로 배열된 흑백 '셀' 또는 점으로 구성된 2차원 코드입니다. 인코딩할 정보는 텍스트 또는 숫자 데이터일 수 있습니다.
          characterset: |
             모든 256 ASCII 문자, 모든 ISO 문자 및 모든 EBCDIC(Extended Binary Coded Decimal Interchange Code) 문자를 지원합니다.
          textcapacity: |
             최대 3116개의 숫자, 2335개의 영숫자 또는 1556개의 이진 문자.
          image: |
...
more_formats:
    enable: true
    title: "C#에 대해 지원되는 기타 Qrcode 서명"
    content: |
        "다른 서명 유형으로 Dcm에 서명할 수도 있습니다. 아래 목록을 참조하십시오."
    format: 
