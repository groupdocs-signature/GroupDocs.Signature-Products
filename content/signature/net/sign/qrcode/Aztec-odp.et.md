...
############################# Head ############################
head_title: "eSign Odp dokument Aztec QR-koodiga rakenduses C#"
head_description: "Looge QR-kood Aztec ja sisestage see faili Odp, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Odp QR-koodi allkiri Aztec"
description: "eAllkirjasta oma Odp dokumendid ja lepingud QR-koodiga Aztec. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Odp allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Odp dokumente Qrcode allkirjaga.
