...
############################# Head ############################
head_title: "eSign Dcm dokumen dengan G S1 Q R QR Code di C#"
head_description: "Buat Kode QR G S1 Q R dan letakkan di file Dcm menggunakan .NET dengan potongan pendek kode C#. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat G S1 Q R tanda tangan Kode QR untuk dokumen Dcm di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Dcm dengan Qrcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Dcm dengan Qrcode tanda tangan dengan cepat dan mudah.
