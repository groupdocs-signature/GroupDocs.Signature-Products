...
############################# Head ############################
head_title: "مستند eSign Xls مع رمز الاستجابة السريعة G S1 Q R في C#"
head_description: "أنشئ رمز الاستجابة السريعة G S1 Q R وضعه في ملف Xls باستخدام .NET مع جزء قصير من كود C#. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء G S1 Q R توقيع رمز الاستجابة السريعة لمستند Xls في C#"
description: "قم بتوقيع Xls على المستندات والعقود باستخدام رمز الاستجابة السريعة G S1 Q R. قم بإنشاء توقيع QR Code بسرعة وسهولة."
...
steps:
    enable: true
    title_left: "خطوات تسجيل Xls باستخدام Qrcode في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Xls بتوقيعات Qrcode بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Xls باستخدام العرض التوضيحي المباشر Qrcode"
    content: |
