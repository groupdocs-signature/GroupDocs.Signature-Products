...
############################# Head ############################
head_title: "eSign Jpg tài liệu với Data Matrix Mã QR trong C#"
head_description: "Tạo Mã QR Data Matrix và đặt nó vào tệp Jpg bằng cách sử dụng .NET với một đoạn mã C# ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR Data Matrix cho tài liệu Jpg trong C#"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Jpg bằng Qrcode trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Jpg bằng chữ ký Qrcode một cách nhanh chóng và dễ dàng.
