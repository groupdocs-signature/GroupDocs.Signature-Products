...
head_description: "Opret G S1 Data Matrix QR-kode og læg den i Jpg-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."
...
steps:
    enable: true
    title_left: "Trin til at signere Jpg med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Jpg dokumenter med Qrcode signaturer hurtigt og nemt.
