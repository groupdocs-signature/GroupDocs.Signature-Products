...
############################# Head ############################
head_title: "eSign Dcm dokument Data Matrix QR-koodiga rakenduses C#"
head_description: "Looge QR-kood Data Matrix ja sisestage see faili Dcm, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Dcm QR-koodi allkiri Data Matrix"
description: "eAllkirjasta oma Dcm dokumendid ja lepingud QR-koodiga Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Dcm allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Dcm dokumente Qrcode allkirjaga.
