...
############################# Head ############################
head_title: "eSign Jpg dokument G S1 Q R QR-koodiga rakenduses C#"
head_description: "Looge QR-kood G S1 Q R ja sisestage see faili Jpg, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Jpg QR-koodi allkiri G S1 Q R"
description: "eAllkirjasta oma Jpg dokumendid ja lepingud QR-koodiga G S1 Q R. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Jpg allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Jpg dokumente Qrcode allkirjaga.
