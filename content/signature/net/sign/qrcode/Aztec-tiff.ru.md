...
############################# Head ############################
head_title: "eSign Tiff документ с QR-кодом Aztec в C#"
head_description: "Создайте QR-код Aztec и поместите его в файл Tiff, используя .NET с коротким фрагментом кода C#. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода Aztec для документа Tiff в C#"
