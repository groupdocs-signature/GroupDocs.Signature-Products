...
breadcrumb: Create QRCODE signature on TIF for C#

############################# Head ############################
head_title: "Adding QRCODE signatures in a TIF file with C#"
head_description: "Put QRCODE Signature on TIF file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .TIF files with QRCODE signatures in C#"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your TIF files with QRCODE signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to sign TIF with QRCODE in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign TIF documents with QRCODE signatures quick and easily.
