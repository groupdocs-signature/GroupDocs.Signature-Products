...
############################# Head ############################
head_title: "eSign Odt-dokument med Data Matrix QR-kod i C#"
head_description: "Skapa Data Matrix QR-kod och lägg den i filen Odt med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera Data Matrix QR-kodsignatur för Odt dokument i C#"
