...
############################# Head ############################
head_title: "eSign Potx έγγραφο με G S1 Data Matrix QR Code στο C#"
head_description: "Δημιουργήστε G S1 Data Matrix κώδικα QR και τοποθετήστε τον σε αρχείο Potx χρησιμοποιώντας το .NET με ένα σύντομο κομμάτι κώδικα C#. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε ηλεκτρονικά τα έγγραφα και τα αρχεία της επιχείρησής σας με QR Code."

############################# Header ############################
title: "Δημιουργήστε G S1 Data Matrix υπογραφή κώδικα QR για το έγγραφο Potx στο C#"
description: "Ηλεκτρονικά υπογράψτε τα έγγραφα και τις συμβάσεις του Potx με τον κωδικό QR G S1 Data Matrix. Δημιουργήστε υπογραφή κωδικού QR γρήγορα και εύκολα."
...
demos:
    enable: true
    title: "Υπογραφή εγγράφων Potx με Qrcode Ζωντανή επίδειξη"
    content: |
       Υπογράψτε το αρχείο Potx με διάφορες υπογραφές αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Δωρεάν online demo σας περιμένει.
...
more_formats:
    enable: true
    title: "Άλλες υποστηριζόμενες υπογραφές Qrcode για C#"
    content: |
        "Μπορείτε επίσης να υπογράψετε το Potx με άλλους τύπους υπογραφής. Δείτε την παρακάτω λίστα."
    format: 
