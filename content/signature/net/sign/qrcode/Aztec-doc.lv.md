...
############################# Head ############################
head_title: "eSign Doc dokuments ar Aztec QR kodu programmā C#"
head_description: "Izveidojiet Aztec QR kodu un ievietojiet to failā Doc, izmantojot .NET un īsu C# kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt Aztec QR koda parakstu dokumentam Doc programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Doc ar Qrcode programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Doc dokumentus ar Qrcode parakstiem.
