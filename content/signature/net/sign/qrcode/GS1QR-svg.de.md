...
############################# Head ############################
head_title: "eSigniere Svg-Dokument mit G S1 Q R-QR-Code in C#"
head_description: "Erstellen Sie einen G S1 Q R-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Svg-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere G S1 Q R-QR-Code-Signatur für Svg-Dokument in C#"
description: "Unterzeichnen Sie Ihre Svg-Dokumente und -Verträge mit dem G S1 Q R-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
