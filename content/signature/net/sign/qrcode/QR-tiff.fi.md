...
############################# Head ############################
head_title: "eSign Tiff -asiakirja QR QR-koodilla C#"
head_description: "Luo QR-koodi QR ja laita se Tiff-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo QR QR-koodiallekirjoitus asiakirjalle Tiff kohteessa C#"
...
steps:
    enable: true
    title_left: "Vaiheet Tiff:n allekirjoittamiseen Qrcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Tiff-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
