...
############################# Head ############################
head_title: "eSign Gif doiciméad le Aztec Cód QR in C#"
head_description: "Cruthaigh Aztec Cód QR agus cuir ar chomhad Gif é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Aztec don doiciméad Gif in C#"
description: "eSínigh do dhoiciméid agus conarthaí Gif le Aztec Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
