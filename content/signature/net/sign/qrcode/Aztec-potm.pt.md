...
############################# Head ############################
head_title: "eSign Potm documento com Aztec QR Code em C#"
head_description: "Crie Aztec QR Code e coloque-o no arquivo Potm usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere Aztec assinatura de QR Code para Potm documento em C#"
description: "Assine seus documentos e contratos Potm com Aztec QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Potm com Qrcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Potm com assinaturas Qrcode de forma rápida e fácil.
