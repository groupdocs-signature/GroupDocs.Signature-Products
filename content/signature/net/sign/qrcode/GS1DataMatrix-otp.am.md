...
############################# Head ############################
head_title: "eSign Otp ሰነድ በG S1 Data Matrix QR ኮድ በC#"
head_description: "G S1 Data Matrix QR ኮድ ይፍጠሩ እና በOtp ፋይል ላይ .NETን በመጠቀም በአጭር የC# ኮድ ያስቀምጡት። የንግድ ሰነዶችዎን እና ፋይሎችዎን በQR ኮድ ኢ-ለመፈረም የGroupDocs ሰነድ ፊርማ ኤፒአይ ይጠቀሙ።"

############################# Header ############################
title: "በC# ውስጥ ለOtp ሰነድ የG S1 Data Matrix QR ኮድ ፊርማ ይፍጠሩ"
...
steps:
    enable: true
    title_left: "Otpን በ{{Signturetype}} በC# ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) የOtp ሰነዶችን በQrcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
