...
############################# Head ############################
head_title: "eSign Docm փաստաթուղթը G S1 Data Matrix QR կոդով C#-ում"
head_description: "Ստեղծեք G S1 Data Matrix QR կոդ և դրեք այն Docm ֆայլի վրա՝ օգտագործելով .NET՝ C# կոդի կարճ հատվածով: Օգտագործեք GroupDocs Document Signature API-ը՝ ձեր բիզնես փաստաթղթերն ու ֆայլերը QR կոդով էլեկտրոնային ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք G S1 Data Matrix QR կոդ ստորագրություն Docm փաստաթղթի համար C#-ում"
description: "e-ստորագրեք ձեր Docm փաստաթղթերն ու պայմանագրերը G S1 Data Matrix QR կոդով: Արագ և հեշտությամբ ստեղծեք QR Code ստորագրություն:"
...
demos:
    enable: true
    title: "Docm փաստաթղթերի ստորագրում Qrcode Live Demo-ով"
    content: |
       Ստորագրեք Docm ֆայլը տարբեր ստորագրություններով հենց հիմա՝ այցելելով [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) կայքը: Անվճար առցանց ցուցադրություն սպասում է ձեզ:
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix-ը Տվյալների մատրիցայի տարբերակն է, որը համապատասխանում է GS1 բնութագրերին: Օգտագործեք GS1 DataMatrix՝ կոդավորելու այնպիսի տեղեկությունները, ինչպիսիք են, սակայն չսահմանափակվելով հետևյալով. AI(01) Համաշխարհային առևտրային ապրանքի համար (GTIN), AI(17) պիտանելիության ամսաթիվ, AI(10) խմբաքանակի համար, AI(21) սերիական համար: .
          characterset: |
             Նիշերի հավաքածու՝ մեծ և փոքրատառ տառեր և հատուկ նիշեր $@%*+-./:=<>;&*_,'! բոլորը ճիշտ հայտի նույնացուցիչներով:
          textcapacity: |
             Կոդտեքստի հզորությունը՝ մինչև 3116 թվային նիշ կամ 2335 ալֆա թվային նիշ:
          image: |
...
more_formats:
    enable: true
    title: "Այլ աջակցվող Qrcode ստորագրություններ C#-ի համար"
    content: |
        "Դուք կարող եք նաև ստորագրել Docm ստորագրության այլ տեսակներով: Խնդրում ենք տեսնել ստորև ներկայացված ցուցակը:"
    format: 
