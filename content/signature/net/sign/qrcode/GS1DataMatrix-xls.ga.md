...
description: "eSínigh do dhoiciméid agus conarthaí Xls le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Xls doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
