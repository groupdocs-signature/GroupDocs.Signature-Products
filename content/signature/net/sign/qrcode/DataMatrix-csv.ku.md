...
############################# Head ############################
head_title: "Belgeya eSign Csv bi Data Matrix Koda QR di C#"
head_description: "Koda QR-a Data Matrix biafirînin û bi koda C# bi koda .NET li pelê Csv bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di C# de ji bo belgeya Data Matrix îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên Csv bi koda QR-a Data Matrix îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Csv bi Qrcode di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Csv bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
