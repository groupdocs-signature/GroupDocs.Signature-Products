...
############################# Head ############################
head_title: "eSign Ott dokumentas su G S1 Data Matrix QR kodu C#"
head_description: "Sukurkite QR kodą G S1 Data Matrix ir įdėkite jį į failą Ott naudodami .NET su trumpu C# kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Data Matrix QR kodo parašą Ott dokumentui C#"
description: "e. Pasirašykite Ott dokumentus ir sutartis naudodami G S1 Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Ott naudojant Qrcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Ott dokumentus su Qrcode parašais.
        
        * Sukurkite parašo klasės egzempliorių, pateikiantį Ott failą, kuris turėtų būti pasirašytas kaip kelias arba atminties srautas
        * Sukurkite SignOptions klasę ir nustatykite visus reikalingus duomenis.
        * Iškvieskite Signature.Sign() metodą, perduodantį išvesties Ott failą arba atminties srautą
...
demos:
    enable: true
    title: "Dokumentų Ott pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
       Pasirašykite Ott failą įvairiais parašais dabar apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje. Jūsų laukia nemokama internetinė demonstracinė versija.
...
more_formats:
    ...
    content: |
        "Taip pat galite pasirašyti Ott naudodami kitų tipų parašus. Žiūrėkite žemiau esantį sąrašą."
    format: 
