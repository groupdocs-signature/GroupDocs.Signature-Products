...
############################# Head ############################
head_title: "eSign Webp document avec Data Matrix QR Code en C#"
head_description: "Créez le code QR Data Matrix et placez-le dans le fichier Webp en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR Data Matrix pour le document Webp en C#"
description: "Signez électroniquement vos documents et contrats Webp avec Data Matrix QR Code. Générez une signature QR Code rapidement et facilement."
...
steps:
    enable: true
    title_left: "Étapes pour signer Webp avec Qrcode dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Webp avec des signatures Qrcode.
        
        * Créez une instance de la classe Signature fournissant le fichier Webp censé signer en tant que chemin ou flux de mémoire
        * Instanciez la classe SignOptions et définissez toutes les données demandées.
        * Appelez la méthode Signature.Sign() en transmettant le fichier de sortie Webp ou le flux de mémoire
...
demos:
    enable: true
    title: "Signature de documents Webp avec Qrcode Live Demo"
    content: |
       Signez dès maintenant le fichier Webp avec différentes signatures en visitant le site Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Une démo en ligne gratuite vous attend.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix est un code bidimensionnel constitué de « cellules » ou de points noirs et blancs disposés selon un motif carré ou rectangulaire, également connu sous le nom de matrice. Les informations à encoder peuvent être du texte ou des données numériques.
          characterset: |
             Prend en charge les 256 caractères ASCII, tous les caractères ISO et tous les caractères EBCDIC (Extended Binary Coded Decimal Interchange Code).
          textcapacity: |
             Jusqu'à 3116 chiffres numériques, ou 2335 caractères alphanumériques, ou 1556 caractères binaires.
          image: |
...
more_formats:
    ...
    content: |
        "Vous pouvez également signer Webp avec d'autres types de signature. Veuillez consulter la liste ci-dessous."
    format: 
