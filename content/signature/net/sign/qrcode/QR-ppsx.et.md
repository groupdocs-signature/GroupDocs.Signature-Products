...
############################# Head ############################
head_title: "eSign Ppsx dokument QR QR-koodiga rakenduses C#"
head_description: "Looge QR-kood QR ja sisestage see faili Ppsx, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Ppsx QR-koodi allkiri QR"
description: "eAllkirjasta oma Ppsx dokumendid ja lepingud QR-koodiga QR. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Ppsx allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Ppsx dokumente Qrcode allkirjaga.
