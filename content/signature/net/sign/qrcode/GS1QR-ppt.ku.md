...
############################# Head ############################
head_title: "Belgeya eSign Ppt bi G S1 Q R Koda QR di C#"
head_description: "Koda QR-a G S1 Q R biafirînin û bi koda C# bi koda .NET li pelê Ppt bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di C# de ji bo belgeya G S1 Q R îmzeya Koda QR çêbike"
description: "Belge û peymanên xwe yên Ppt bi koda QR-a G S1 Q R îmze bikin. Zû û bi hêsanî îmzeya QR Code biafirînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Ppt bi Qrcode di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Ppt bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
