...
############################# Head ############################
head_title: "eSign Xltx document avec G S1 Data Matrix QR Code en C#"
head_description: "Créez le code QR G S1 Data Matrix et placez-le dans le fichier Xltx en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR G S1 Data Matrix pour le document Xltx en C#"
description: "Signez électroniquement vos documents et contrats Xltx avec G S1 Data Matrix QR Code. Générez une signature QR Code rapidement et facilement."
...
steps:
    enable: true
    title_left: "Étapes pour signer Xltx avec Qrcode dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Xltx avec des signatures Qrcode.
...
demos:
    enable: true
    title: "Signature de documents Xltx avec Qrcode Live Demo"
    content: |
