...
############################# Head ############################
head_title: "eSign Rtf doiciméad le QR Cód QR in C#"
head_description: "Cruthaigh QR Cód QR agus cuir ar chomhad Rtf é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR QR don doiciméad Rtf in C#"
