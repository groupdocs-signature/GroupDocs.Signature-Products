...
description: "eSínigh do dhoiciméid agus conarthaí Dotm le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Dotm doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
