...
############################# Head ############################
head_title: "eSign Pps documento con QR codice QR in C#"
head_description: "Crea il codice QR QR e inseriscilo nel file Pps utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera QR firma del codice QR per il documento Pps in C#"
description: "Firma i tuoi documenti e contratti Pps con il codice QR QR. Genera la firma del codice QR in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Pps con Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Pps con firme Qrcode in modo rapido e semplice.
...
demos:
    enable: true
    title: "Firma di documenti Pps con Qrcode Demo live"
    content: |
