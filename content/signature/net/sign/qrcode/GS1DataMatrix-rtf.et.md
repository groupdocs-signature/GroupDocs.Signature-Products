...
############################# Head ############################
head_title: "eSign Rtf dokument G S1 Data Matrix QR-koodiga rakenduses C#"
head_description: "Looge QR-kood G S1 Data Matrix ja sisestage see faili Rtf, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Rtf QR-koodi allkiri G S1 Data Matrix"
description: "eAllkirjasta oma Rtf dokumendid ja lepingud QR-koodiga G S1 Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Rtf allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Rtf dokumente Qrcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Rtf allkirjastamine Qrcode reaalajas demoga"
    content: |
