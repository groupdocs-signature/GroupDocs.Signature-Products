...
############################# Head ############################
head_title: "eSign Ots-dokument med Aztec QR-kod i C#"
head_description: "Skapa Aztec QR-kod och lägg den i filen Ots med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera Aztec QR-kodsignatur för Ots dokument i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Ots med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Ots-dokument med Qrcode-signaturer snabbt och enkelt.
