...
############################# Head ############################
head_title: "eSigniere Dot-Dokument mit Data Matrix-QR-Code in C#"
head_description: "Erstellen Sie einen Data Matrix-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Dot-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Data Matrix-QR-Code-Signatur für Dot-Dokument in C#"
description: "Unterzeichnen Sie Ihre Dot-Dokumente und -Verträge mit dem Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
