...
############################# Head ############################
head_title: "Document electrònic Ppt amb codi QR QR a C#"
head_description: "Creeu QR codi QR i col·loqueu-lo al fitxer Ppt amb .NET amb un tros curt de codi C#. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de QR per al document Ppt a C#"
description: "eSigneu els vostres documents i contractes de Ppt amb el codi QR de QR. Genereu la signatura del codi QR de manera ràpida i senzilla."
