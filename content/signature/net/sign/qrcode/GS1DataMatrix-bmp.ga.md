...
description: "eSínigh do dhoiciméid agus conarthaí Bmp le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Bmp doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
