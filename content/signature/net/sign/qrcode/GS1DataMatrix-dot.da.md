...
head_description: "Opret G S1 Data Matrix QR-kode og læg den i Dot-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer G S1 Data Matrix QR-kodesignatur for Dot dokument i C#"
description: "eSignér dine Dot-dokumenter og kontrakter med G S1 Data Matrix QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Trin til at signere Dot med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Dot dokumenter med Qrcode signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Dot dokumenter med Qrcode Live Demo"
    content: |
