...
############################# Head ############################
head_title: "eSign Csv dokumentas su G S1 Data Matrix QR kodu C#"
head_description: "Sukurkite QR kodą G S1 Data Matrix ir įdėkite jį į failą Csv naudodami .NET su trumpu C# kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Data Matrix QR kodo parašą Csv dokumentui C#"
description: "e. Pasirašykite Csv dokumentus ir sutartis naudodami G S1 Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Csv naudojant Qrcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Csv dokumentus su Qrcode parašais.
...
demos:
    enable: true
    title: "Dokumentų Csv pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
