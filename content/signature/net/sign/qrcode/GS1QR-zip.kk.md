...
############################# Head ############################
head_title: "C# ішінде G S1 Q R QR коды бар eSign Zip құжаты"
head_description: "G S1 Q R QR кодын жасаңыз және оны .NET арқылы C# кодының қысқа бөлігімен Zip файлына салыңыз. QR коды арқылы іскери құжаттар мен файлдарға электрондық қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "C# ішінде Zip құжаты үшін G S1 Q R QR код қолтаңбасын жасаңыз"
...
steps:
    enable: true
    title_left: "C# жүйесінде Qrcode арқылы Zip файлына қол қою қадамдары"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) Zip құжаттарға Qrcode қолтаңбаларымен жылдам және оңай қол қою мүмкіндігін береді.
