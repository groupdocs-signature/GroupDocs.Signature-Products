...
############################# Head ############################
head_title: "eSign 7z dokument s QR QR kodom u C#"
head_description: "Napravite QR QR kod i stavite ga u datoteku 7z koristeći .NET s kratkim dijelom C# koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj QR potpis QR koda za 7z dokument u C#"
description: "ePotpišite svoje 7z dokumente i ugovore s QR QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje 7z s Qrcode u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja 7z dokumenata s Qrcode potpisima.
        
        * Stvorite instancu klase potpisa koja daje 7z datoteku koja bi se trebala potpisati kao put ili memorijski tok
        * Instancirajte klasu SignOptions i postavite sve tražene podatke.
        * Pozovite metodu Signature.Sign() prosljeđujući izlaznu datoteku 7z ili memorijski tok
...
demos:
    enable: true
    title: "Potpisivanje 7z dokumenata s Qrcode Live Demo"
    content: |
       Potpišite datoteku 7z raznim potpisima upravo sada tako da posjetite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web mjesto. Besplatan online demo čeka na vas.
...
more_formats:
    ...
    content: |
        "Također možete potpisati 7z drugim vrstama potpisa. Pogledajte popis u nastavku."
    format: 
