...
############################# Head ############################
head_title: "eSign Ppsm dokument s G S1 Q R QR kodo v C#"
head_description: "Ustvarite QR kodo G S1 Q R in jo postavite v datoteko Ppsm z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari G S1 Q R podpis kode QR za dokument Ppsm v C#"
description: "e-Podpišite svoje Ppsm dokumente in pogodbe s G S1 Q R QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Koda QR GS1 je različica kode QR, ki je v skladu s specifikacijami GS1. Zasnovan je bil posebej za izmenjavo razširjenih informacij o embalaži, kot so številka serije, ID izdelka in količina.
          characterset: |
             Velike in male črke ter posebni znaki $%*+-./: vse s pravilnimi aplikacijskimi identifikatorji
          textcapacity: |
             Do 7089 numeričnih znakov, 4296 alfanumeričnih znakov
          image: |
