...
############################# Head ############################
head_title: "Podpisz dokument Xlsm z kodem QR G S1 Data Matrix w C#"
head_description: "Utwórz kod QR G S1 Data Matrix i umieść go w pliku Xlsm za pomocą .NET z krótkim fragmentem kodu C#. Użyj interfejsu GroupDocs Document Signature API do elektronicznego podpisywania dokumentów biznesowych i plików za pomocą kodu QR."

############################# Header ############################
title: "Wygeneruj podpis G S1 Data Matrix kodu QR dla dokumentu Xlsm w C#"
description: "Podpisz elektronicznie dokumenty i umowy w Xlsm za pomocą kodu QR G S1 Data Matrix. Szybko i łatwo generuj podpis QR Code."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Xlsm za pomocą Qrcode w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Xlsm za pomocą podpisów Qrcode.
        
        * Utwórz instancję klasy Signature podając plik Xlsm do podpisania jako ścieżkę lub strumień pamięci
        * Utwórz wystąpienie klasy SignOptions i ustaw wszystkie wymagane dane.
        * Wywołaj metodę Signature.Sign() przekazującą wyjściowy plik Xlsm lub strumień pamięci
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Xlsm za pomocą Qrcode Demo na żywo"
    content: |
       Podpisz teraz plik Xlsm różnymi podpisami, odwiedzając witrynę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Darmowe demo online czeka na Ciebie.
...
more_formats:
    ...
    content: |
        "Możesz także podpisać Xlsm innymi typami podpisów. Zobacz poniższą listę."
    format: 
