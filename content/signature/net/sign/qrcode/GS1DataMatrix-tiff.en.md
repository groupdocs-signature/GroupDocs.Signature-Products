...
head_description: "Create G S1 Data Matrix QR Code and put it on Tiff file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Data Matrix QR Code signature for Tiff document in C#"
description: "eSign your Tiff documents and contracts with G S1 Data Matrix QR Code. Generate QR Code signature quickly and easily."
