...
############################# Head ############################
head_title: "eSign Dotx document avec QR QR Code en C#"
head_description: "Créez le code QR QR et placez-le dans le fichier Dotx en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR QR pour le document Dotx en C#"
description: "Signez électroniquement vos documents et contrats Dotx avec QR QR Code. Générez une signature QR Code rapidement et facilement."
...
steps:
    enable: true
    title_left: "Étapes pour signer Dotx avec Qrcode dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Dotx avec des signatures Qrcode.
...
demos:
    enable: true
    title: "Signature de documents Dotx avec Qrcode Live Demo"
    content: |
