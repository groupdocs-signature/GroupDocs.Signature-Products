...
############################# Head ############################
head_title: "eSign Docx document avec G S1 Q R QR Code en C#"
head_description: "Créez le code QR G S1 Q R et placez-le dans le fichier Docx en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR G S1 Q R pour le document Docx en C#"
description: "Signez électroniquement vos documents et contrats Docx avec G S1 Q R QR Code. Générez une signature QR Code rapidement et facilement."
