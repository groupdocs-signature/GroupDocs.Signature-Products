...
############################# Head ############################
head_title: "eSign documentul Xlsb cu codul QR Data Matrix în C#"
head_description: "Creați codul QR Data Matrix și puneți-l în fișierul Xlsb folosind .NET cu o scurtă bucată de cod C#. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura Data Matrix cod QR pentru documentul Xlsb în C#"
description: "eSemnați documentele și contractele Xlsb cu codul QR Data Matrix. Generați semnătura codului QR rapid și ușor."
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xlsb cu Qrcode în C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) oferă posibilitatea de a semna documente Xlsb cu semnături Qrcode rapid și ușor.
