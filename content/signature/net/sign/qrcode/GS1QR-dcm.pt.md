...
############################# Head ############################
head_title: "eSign Dcm documento com G S1 Q R QR Code em C#"
head_description: "Crie G S1 Q R QR Code e coloque-o no arquivo Dcm usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere G S1 Q R assinatura de QR Code para Dcm documento em C#"
description: "Assine seus documentos e contratos Dcm com G S1 Q R QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR Code é uma variante do QR Code que está em conformidade com as especificações GS1. Ele foi projetado especificamente para compartilhar informações de embalagem estendidas, como número de lote, ID do produto e quantidade.
          characterset: |
             Letras maiúsculas e minúsculas e caracteres especiais $%*+-./: todos com Identificadores de Aplicação corretos
          textcapacity: |
             Até 7089 caracteres numéricos, 4296 caracteres alfanuméricos
          image: |
