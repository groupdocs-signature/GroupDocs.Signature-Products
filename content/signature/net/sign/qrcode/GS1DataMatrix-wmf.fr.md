...
############################# Head ############################
head_title: "eSign Wmf document avec G S1 Data Matrix QR Code en C#"
head_description: "Créez le code QR G S1 Data Matrix et placez-le dans le fichier Wmf en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR G S1 Data Matrix pour le document Wmf en C#"
description: "Signez électroniquement vos documents et contrats Wmf avec G S1 Data Matrix QR Code. Générez une signature QR Code rapidement et facilement."
...
demos:
    enable: true
    title: "Signature de documents Wmf avec Qrcode Live Demo"
    content: |
       Signez dès maintenant le fichier Wmf avec différentes signatures en visitant le site Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Une démo en ligne gratuite vous attend.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix est une variante de Data Matrix conforme aux spécifications GS1. Utilisez GS1 DataMatrix pour coder les informations telles que, mais sans s'y limiter, les suivantes : AI(01) Numéro d'article international (GTIN), AI(17) Date d'expiration, AI(10) Numéro de lot, AI(21) Numéro de série .
          characterset: |
             Jeu de caractères : lettres majuscules et minuscules et caractères spéciaux $@%*+-./:=<>;&*_,' ! tous avec des identificateurs d'application corrects.
          textcapacity: |
             Capacité du texte codé : jusqu'à 3 116 chiffres numériques ou 2 335 caractères alphanumériques.
          image: |
...
more_formats:
    enable: true
    title: "Autres signatures Qrcode prises en charge pour C#"
    content: |
        "Vous pouvez également signer Wmf avec d'autres types de signature. Veuillez consulter la liste ci-dessous."
    format: 
