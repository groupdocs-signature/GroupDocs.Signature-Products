...
############################# Head ############################
head_title: "eSign Xlsb dokument s G S1 Data Matrix QR kodo v C#"
head_description: "Ustvarite QR kodo G S1 Data Matrix in jo postavite v datoteko Xlsb z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari G S1 Data Matrix podpis kode QR za dokument Xlsb v C#"
description: "e-Podpišite svoje Xlsb dokumente in pogodbe s G S1 Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Xlsb z Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Xlsb s podpisi Qrcode.
        
        * Ustvarite primerek razreda podpisa, ki zagotavlja datoteko Xlsb, ki naj bi se podpisala kot pot ali pomnilniški tok
        * Instanciirajte razred SignOptions in nastavite vse zahtevane podatke.
        * Prikličite metodo Signature.Sign(), ki posreduje izhodno datoteko Xlsb ali pomnilniški tok
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Xlsb z Qrcode Live Demo"
    content: |
       Takoj zdaj podpišite datoteko Xlsb z različnimi podpisi, tako da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Brezplačna spletna predstavitev čaka na vas.
...
more_formats:
    ...
    content: |
        "Xlsb lahko podpišete tudi z drugimi vrstami podpisov. Oglejte si spodnji seznam."
    format: 
