...
############################# Head ############################
head_title: "Document electrònic Pps amb codi QR Aztec a C#"
head_description: "Creeu Aztec codi QR i col·loqueu-lo al fitxer Pps amb .NET amb un tros curt de codi C#. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de Aztec per al document Pps a C#"
description: "eSigneu els vostres documents i contractes de Pps amb el codi QR de Aztec. Genereu la signatura del codi QR de manera ràpida i senzilla."
