...
############################# Head ############################
head_title: "eSign Xltm dokument G S1 Data Matrix QR-koodiga rakenduses C#"
head_description: "Looge QR-kood G S1 Data Matrix ja sisestage see faili Xltm, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Xltm QR-koodi allkiri G S1 Data Matrix"
...
steps:
    enable: true
    title_left: "Toimingud Xltm allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Xltm dokumente Qrcode allkirjaga.
