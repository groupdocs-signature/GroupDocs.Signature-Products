...
############################# Head ############################
head_title: "eSigniere Svg-Dokument mit G S1 Data Matrix-QR-Code in C#"
head_description: "Erstellen Sie einen G S1 Data Matrix-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Svg-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere G S1 Data Matrix-QR-Code-Signatur für Svg-Dokument in C#"
description: "Unterzeichnen Sie Ihre Svg-Dokumente und -Verträge mit dem G S1 Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Svg mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Svg-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
        ...
        * Rufen Sie die Signature.Sign()-Methode auf und übergeben Sie die Svg-Ausgabedatei oder den Speicherstream
...
demos:
    enable: true
    title: "Signieren von Svg-Dokumenten mit Qrcode Live-Demo"
    content: |
