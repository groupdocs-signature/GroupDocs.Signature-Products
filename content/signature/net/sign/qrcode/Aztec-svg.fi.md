...
############################# Head ############################
head_title: "eSign Svg -asiakirja Aztec QR-koodilla C#"
head_description: "Luo QR-koodi Aztec ja laita se Svg-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo Aztec QR-koodiallekirjoitus asiakirjalle Svg kohteessa C#"
...
steps:
    enable: true
    title_left: "Vaiheet Svg:n allekirjoittamiseen Qrcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Svg-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
