...
############################# Head ############################
head_title: "eSigniere Ott-Dokument mit Aztec-QR-Code in C#"
head_description: "Erstellen Sie einen Aztec-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Ott-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Aztec-QR-Code-Signatur für Ott-Dokument in C#"
description: "Unterzeichnen Sie Ihre Ott-Dokumente und -Verträge mit dem Aztec-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Ott mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Ott-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Ott-Dokumenten mit Qrcode Live-Demo"
    content: |
       Signieren Sie die Datei Ott jetzt mit verschiedenen Signaturen, indem Sie die Website [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) besuchen. Kostenlose Online-Demo wartet auf Sie.
...
more_formats:
    ...
    content: |
        "Sie können Ott auch mit anderen Signaturtypen signieren. Bitte sehen Sie sich die Liste unten an."
    format: 
