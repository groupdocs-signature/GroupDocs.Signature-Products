...
############################# Head ############################
head_title: "eSign Jpg documento com QR QR Code em C#"
head_description: "Crie QR QR Code e coloque-o no arquivo Jpg usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere QR assinatura de QR Code para Jpg documento em C#"
description: "Assine seus documentos e contratos Jpg com QR QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Jpg com Qrcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Jpg com assinaturas Qrcode de forma rápida e fácil.
        
        * Crie uma instância da classe Signature fornecendo o arquivo Jpg para assinar como caminho ou fluxo de memória
        * Instancie a classe SignOptions e defina todos os dados exigidos.
        * Invoque o método Signature.Sign() passando o arquivo de saída Jpg ou fluxo de memória
...
demos:
    enable: true
    title: "Assinando Jpg documentos com Qrcode Demonstração ao vivo"
    content: |
       Assine o arquivo Jpg com várias assinaturas agora mesmo visitando o site [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demonstração online gratuita esperando por você.
...
more_formats:
    ...
    content: |
        "Você também pode assinar Jpg com outros tipos de assinatura. Por favor, veja a lista abaixo."
    format: 
