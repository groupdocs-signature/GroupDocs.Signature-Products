...
############################# Head ############################
head_title: "eSign Odt เอกสารด้วย G S1 Data Matrix QR Code ใน C#"
head_description: "สร้าง G S1 Data Matrix QR Code และใส่ลงในไฟล์ Odt โดยใช้ .NET ด้วยโค้ดสั้นๆ C# ใช้ GroupDocs Document Signature API เพื่อลงนามในเอกสารทางธุรกิจและไฟล์ทางอิเล็กทรอนิกส์ด้วย QR Code"

############################# Header ############################
title: "สร้าง G S1 Data Matrix ลายเซ็นรหัส QR สำหรับเอกสาร Odt ใน C#"
