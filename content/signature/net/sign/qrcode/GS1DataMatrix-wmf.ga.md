...
description: "eSínigh do dhoiciméid agus conarthaí Wmf le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Wmf doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
