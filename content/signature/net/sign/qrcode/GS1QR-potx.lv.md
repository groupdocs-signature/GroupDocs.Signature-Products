...
############################# Head ############################
head_title: "eSign Potx dokuments ar G S1 Q R QR kodu programmā C#"
head_description: "Izveidojiet G S1 Q R QR kodu un ievietojiet to failā Potx, izmantojot .NET un īsu C# kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Q R QR koda parakstu dokumentam Potx programmā C#"
description: "eParakstiet savus Potx dokumentus un līgumus ar G S1 Q R QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Potx ar Qrcode programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Potx dokumentus ar Qrcode parakstiem.
