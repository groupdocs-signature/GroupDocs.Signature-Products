...
breadcrumb: Create QRCODE signature on POTX for C#

############################# Head ############################
head_title: "Adding QRCODE signatures in a POTX file with C#"
head_description: "Put QRCODE Signature on POTX file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .POTX files with QRCODE signatures in C#"
    ...
    code: |
        ...
        using (var signature = new GroupDocs.Signature.Signature(filePath))
        {
                ...
                QrCodeSignOptions options = new QrCodeSignOptions("JohnSmith")
                {
                    ...
                    EncodeType = QrCodeTypes.GS1DATAMATRIX,
