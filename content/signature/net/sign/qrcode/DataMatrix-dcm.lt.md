...
############################# Head ############################
head_title: "eSign Dcm dokumentas su Data Matrix QR kodu C#"
head_description: "Sukurkite QR kodą Data Matrix ir įdėkite jį į failą Dcm naudodami .NET su trumpu C# kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite Data Matrix QR kodo parašą Dcm dokumentui C#"
description: "e. Pasirašykite Dcm dokumentus ir sutartis naudodami Data Matrix QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Dcm naudojant Qrcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Dcm dokumentus su Qrcode parašais.
        
        * Sukurkite parašo klasės egzempliorių, pateikiantį Dcm failą, kuris turėtų būti pasirašytas kaip kelias arba atminties srautas
        * Sukurkite SignOptions klasę ir nustatykite visus reikalingus duomenis.
        * Iškvieskite Signature.Sign() metodą, perduodantį išvesties Dcm failą arba atminties srautą
...
demos:
    enable: true
    title: "Dokumentų Dcm pasirašymas naudojant Qrcode tiesioginę demonstraciją"
    content: |
       Pasirašykite Dcm failą įvairiais parašais dabar apsilankę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) svetainėje. Jūsų laukia nemokama internetinė demonstracinė versija.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Duomenų matrica yra dvimatis kodas, susidedantis iš nespalvotų langelių arba taškų, išdėstytų kvadratu arba stačiakampiu, taip pat žinomas kaip matrica. Koduotina informacija gali būti tekstinė arba skaitmeninė informacija.
          characterset: |
             Palaiko visus 256 ASCII simbolius, visus ISO simbolius ir visus išplėstinio dvejetainio kodo dešimtainio mainų kodo (EBCDIC) simbolius.
          textcapacity: |
             Iki 3116 skaitmeninių skaitmenų arba 2335 raidinių skaitmeninių simbolių arba 1556 dvejetainių simbolių.
          image: |
...
more_formats:
    ...
    content: |
        "Taip pat galite pasirašyti Dcm naudodami kitų tipų parašus. Žiūrėkite žemiau esantį sąrašą."
    format: 
