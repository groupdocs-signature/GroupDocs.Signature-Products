...
############################# Head ############################
head_title: "eSign Tar dokumen dengan G S1 Data Matrix QR Code dalam C#"
head_description: "Cipta G S1 Data Matrix Kod QR dan letakkan pada fail Tar menggunakan .NET dengan sekeping pendek kod C#. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan G S1 Data Matrix tandatangan Kod QR untuk Tar dokumen dalam C#"
