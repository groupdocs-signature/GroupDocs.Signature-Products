...
############################# Head ############################
head_title: "eSign Pps dokument s QR QR kodo v C#"
head_description: "Ustvarite QR kodo QR in jo postavite v datoteko Pps z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari QR podpis kode QR za dokument Pps v C#"
description: "e-Podpišite svoje Pps dokumente in pogodbe s QR QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Pps z Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Pps s podpisi Qrcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Pps z Qrcode Live Demo"
    content: |
