...
description: "eSínigh do dhoiciméid agus conarthaí Odt le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Odt doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
