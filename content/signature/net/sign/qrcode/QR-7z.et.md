...
############################# Head ############################
head_title: "eSign 7z dokument QR QR-koodiga rakenduses C#"
head_description: "Looge QR-kood QR ja sisestage see faili 7z, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile 7z QR-koodi allkiri QR"
description: "eAllkirjasta oma 7z dokumendid ja lepingud QR-koodiga QR. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud 7z allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada 7z dokumente Qrcode allkirjaga.
