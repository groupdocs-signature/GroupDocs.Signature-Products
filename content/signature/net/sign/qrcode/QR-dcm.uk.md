...
############################# Head ############################
head_title: "eSign Dcm документ із QR QR-кодом у C#"
head_description: "Створіть QR-код QR і помістіть його у файл Dcm за допомогою .NET із коротким фрагментом коду C#. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду QR для документа Dcm у C#"
description: "Електронно підписуйте свої Dcm документи та контракти за допомогою QR QR-коду. Згенеруйте підпис QR-коду швидко та легко."
...
steps:
    enable: true
    title_left: "Кроки для підпису Dcm за допомогою Qrcode у C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає можливість швидко та легко підписувати документи Dcm за допомогою підписів Qrcode.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            QR-код (скорочено від Quick Response Code) — торгова марка типу матричного штрих-коду (або двовимірного штрих-коду). Це найпопулярніший і широко використовуваний тип двовимірного коду. На практиці QR-коди часто містять дані для локатора, ідентифікатора або трекера, які вказують на веб-сайт або програму.
          characterset: |
             Усі 256 символів ASCII + кандзі
          textcapacity: |
             До 7089 цифрових символів, 4296 буквено-цифрових символів, 2953 байтів (двійкові дані) або 1817 символів кандзі.
          image: |
