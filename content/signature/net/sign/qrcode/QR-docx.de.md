...
############################# Head ############################
head_title: "eSigniere Docx-Dokument mit QR-QR-Code in C#"
head_description: "Erstellen Sie einen QR-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Docx-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere QR-QR-Code-Signatur für Docx-Dokument in C#"
