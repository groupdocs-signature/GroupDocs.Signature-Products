...
############################# Head ############################
head_title: "eSign Xlsx dokumentas su QR QR kodu C#"
head_description: "Sukurkite QR kodą QR ir įdėkite jį į failą Xlsx naudodami .NET su trumpu C# kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite QR QR kodo parašą Xlsx dokumentui C#"
description: "e. Pasirašykite Xlsx dokumentus ir sutartis naudodami QR QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
