...
############################# Head ############################
head_title: "eSign Dotm-dokument med G S1 Q R QR-kode i C#"
head_description: "Opret G S1 Q R QR-kode og læg den i Dotm-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer G S1 Q R QR-kodesignatur for Dotm dokument i C#"
description: "eSignér dine Dotm-dokumenter og kontrakter med G S1 Q R QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR Code er en variant af QR Code, der er i overensstemmelse med GS1 specifikationer. Det blev designet specifikt til at dele udvidede emballageoplysninger, såsom lotnummer, produkt-id og antal.
          characterset: |
             Store og små bogstaver og specialtegn $%*+-./: alle med korrekte applikations-id'er
          textcapacity: |
             Op til 7089 numeriske tegn, 4296 alfanumeriske tegn
          image: |
