...
############################# Head ############################
head_title: "eSign Docx document met G S1 Q R QR-code in C#"
head_description: "Maak een G S1 Q R QR-code en plaats deze in het Docx-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Q R QR Code handtekening voor Docx document in C#"
description: "Onderteken uw Docx documenten en contracten met G S1 Q R QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Docx te ondertekenen met Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Docx documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
        ...
        * Roep de methode Signature.Sign() op en geef uitvoer Docx-bestand of geheugenstroom
...
demos:
    enable: true
    title: "Docx documenten ondertekenen met Qrcode Live Demo"
    content: |
