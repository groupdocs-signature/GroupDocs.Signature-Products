...
############################# Head ############################
head_title: "eSign Potm dokumentum QR QR-kóddal a C# nyelven"
head_description: "Hozzon létre QR QR-kódot, és helyezze el a Potm fájlba a .NET használatával egy rövid C# kóddal. Használja a GroupDocs Document Signature API-t üzleti dokumentumok és fájlok QR-kóddal történő elektronikus aláírásához."

############################# Header ############################
title: "Generáljon QR QR-kód aláírást a Potm dokumentumhoz a C# programban"
description: "eAláírja Potm dokumentumait és szerződéseit QR QR-kóddal. Gyorsan és egyszerűen generálhat QR-kód aláírást."
...
steps:
    enable: true
    title_left: "A Potm aláírásának lépései a Qrcode segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Potm dokumentumok gyors és egyszerű aláírását Qrcode aláírással.
