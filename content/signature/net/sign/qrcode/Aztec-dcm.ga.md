...
############################# Head ############################
head_title: "eSign Dcm doiciméad le Aztec Cód QR in C#"
head_description: "Cruthaigh Aztec Cód QR agus cuir ar chomhad Dcm é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Aztec don doiciméad Dcm in C#"
description: "eSínigh do dhoiciméid agus conarthaí Dcm le Aztec Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is siombaleolaíocht maitrís ghinearálta dháthoiseach (2-T) é Cód Aztec atá deartha chun cruinneas níos airde a bheith aige ná siombailí 2-T eile. Is féidir le siombail Cód Aztec suas le 3,832 dhigit uimhriúil a ionchódú; 3,067 carachtar aibítre; nó 1,914 beart sonraí.
          characterset: |
             Gach 256 carachtar ASCII.
          textcapacity: |
             Suas le 3,832 dhigit uimhriúil, nó 3,067 carachtar aibítre, nó 1,914 beart sonraí.
          image: |
