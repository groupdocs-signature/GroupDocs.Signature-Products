...
############################# Head ############################
head_title: "eSign Ott dokuments ar G S1 Q R QR kodu programmā C#"
head_description: "Izveidojiet G S1 Q R QR kodu un ievietojiet to failā Ott, izmantojot .NET un īsu C# kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Q R QR koda parakstu dokumentam Ott programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Ott ar Qrcode programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Ott dokumentus ar Qrcode parakstiem.
