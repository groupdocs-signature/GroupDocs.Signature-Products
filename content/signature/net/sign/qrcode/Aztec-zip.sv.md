...
############################# Head ############################
head_title: "eSign Zip-dokument med Aztec QR-kod i C#"
head_description: "Skapa Aztec QR-kod och lägg den i filen Zip med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera Aztec QR-kodsignatur för Zip dokument i C#"
