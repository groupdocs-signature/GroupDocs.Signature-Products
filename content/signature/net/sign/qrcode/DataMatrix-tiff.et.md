...
############################# Head ############################
head_title: "eSign Tiff dokument Data Matrix QR-koodiga rakenduses C#"
head_description: "Looge QR-kood Data Matrix ja sisestage see faili Tiff, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Tiff QR-koodi allkiri Data Matrix"
description: "eAllkirjasta oma Tiff dokumendid ja lepingud QR-koodiga Data Matrix. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Tiff allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Tiff dokumente Qrcode allkirjaga.
