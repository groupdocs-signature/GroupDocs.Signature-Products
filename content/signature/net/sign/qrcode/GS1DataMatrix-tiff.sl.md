...
############################# Head ############################
head_title: "eSign Tiff dokument s G S1 Data Matrix QR kodo v C#"
head_description: "Ustvarite QR kodo G S1 Data Matrix in jo postavite v datoteko Tiff z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari G S1 Data Matrix podpis kode QR za dokument Tiff v C#"
description: "e-Podpišite svoje Tiff dokumente in pogodbe s G S1 Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Tiff z Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Tiff s podpisi Qrcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Tiff z Qrcode Live Demo"
    content: |
