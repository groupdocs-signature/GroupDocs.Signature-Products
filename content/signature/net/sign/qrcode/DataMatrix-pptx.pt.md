...
############################# Head ############################
head_title: "eSign Pptx documento com Data Matrix QR Code em C#"
head_description: "Crie Data Matrix QR Code e coloque-o no arquivo Pptx usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere Data Matrix assinatura de QR Code para Pptx documento em C#"
description: "Assine seus documentos e contratos Pptx com Data Matrix QR Code. Gere assinatura de QR Code de forma rápida e fácil."
