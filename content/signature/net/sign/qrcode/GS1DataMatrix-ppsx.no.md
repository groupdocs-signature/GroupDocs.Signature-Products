...
head_description: "Lag G S1 Data Matrix QR-kode og legg den til Ppsx-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."
...
steps:
    enable: true
    title_left: "Trinn for å signere Ppsx med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Ppsx-dokumenter med Qrcode-signaturer raskt og enkelt.
