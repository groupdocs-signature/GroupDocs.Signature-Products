...
############################# Head ############################
head_title: "C# میں G S1 Data Matrix QR کوڈ کے ساتھ eSign 7z دستاویز"
head_description: "G S1 Data Matrix QR کوڈ بنائیں اور اسے .NET کا استعمال کرتے ہوئے C# کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ 7z فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "C# میں 7z دستاویز کے لیے G S1 Data Matrix QR کوڈ دستخط بنائیں"
