...
############################# Head ############################
head_title: "C# içinde G S1 Data Matrix QR Kodu ile Jpg belgesini eSign"
head_description: "G S1 Data Matrix QR Kodu oluşturun ve kısa bir C# kodu parçasıyla .NET kullanarak Jpg dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "C# içinde Jpg belgesi için G S1 Data Matrix QR Kodu imzası oluşturun"
description: "Jpg belgelerinizi ve sözleşmelerinizi G S1 Data Matrix QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
steps:
    enable: true
    title_left: "C# içinde Qrcode ile Jpg imzalama adımları"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Jpg belgelerini Qrcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Jpg dokümanı Qrcode Canlı Demo ile imzalama"
    content: |
