...
############################# Head ############################
head_title: "eSign Ppt documento com G S1 Q R QR Code em C#"
head_description: "Crie G S1 Q R QR Code e coloque-o no arquivo Ppt usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere G S1 Q R assinatura de QR Code para Ppt documento em C#"
description: "Assine seus documentos e contratos Ppt com G S1 Q R QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Ppt com Qrcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Ppt com assinaturas Qrcode de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Ppt documentos com Qrcode Demonstração ao vivo"
    content: |
