...
############################# Head ############################
head_title: "eSign Potm документ із G S1 Q R QR-кодом у C#"
head_description: "Створіть QR-код G S1 Q R і помістіть його у файл Potm за допомогою .NET із коротким фрагментом коду C#. Використовуйте API підпису документів GroupDocs для електронного підпису своїх ділових документів і файлів за допомогою QR-коду."

############################# Header ############################
title: "Згенеруйте підпис QR-коду G S1 Q R для документа Potm у C#"
description: "Електронно підписуйте свої Potm документи та контракти за допомогою G S1 Q R QR-коду. Згенеруйте підпис QR-коду швидко та легко."
