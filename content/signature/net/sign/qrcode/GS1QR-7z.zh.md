...
############################# Head ############################
head_title: "在 C# 中带有 G S1 Q R QR 码的 eSign 7z 文档"
head_description: "创建 G S1 Q R 二维码并使用 .NET 和一小段 C# 代码将其放在 7z 文件中。使用 GroupDocs 文档签名 API 使用 QR 码对您的业务文档和文件进行电子签名。"

############################# Header ############################
title: "在 C# 中为 7z 文档生成 G S1 Q R 二维码签名"
description: "使用 G S1 Q R 二维码对您的 7z 文档和合同进行电子签名。快速轻松地生成二维码签名。"
...
steps:
    enable: true
    title_left: "在 C# 中使用 Qrcode 签署 7z 的步骤"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) 提供使用 Qrcode 签名快速轻松地签署 7z 文档的能力。
