...
############################# Head ############################
head_title: "C# で Data Matrix QR コードを使用して Odp 文書に eSign"
head_description: "Data Matrix QR コードを作成し、短い C# コードを含む .NET を使用して Odp ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の Odp ドキュメントの Data Matrix QR コード署名を生成します"
description: "Odp ドキュメントと契約書に Data Matrix QR コードで電子署名します。 QR コード署名をすばやく簡単に生成します。"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            データ マトリックスは、マトリックスとも呼ばれる正方形または長方形のパターンに配置された白黒の「セル」またはドットで構成される 2 次元コードです。エンコードされる情報は、テキストまたは数値データです。
          characterset: |
             256 個の ASCII 文字すべて、すべての ISO 文字、およびすべての Extended Binary Coded Decimal Interchange Code (EBCDIC) 文字をサポートします。
          textcapacity: |
             最大 3116 桁の数字、または 2335 個の英数字、または 1556 個の 2 進数文字。
          image: |
