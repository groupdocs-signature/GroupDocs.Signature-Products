...
############################# Head ############################
head_title: "eSign documentul Ods cu codul QR G S1 Q R în C#"
head_description: "Creați codul QR G S1 Q R și puneți-l în fișierul Ods folosind .NET cu o scurtă bucată de cod C#. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura G S1 Q R cod QR pentru documentul Ods în C#"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Ods cu Qrcode în C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) oferă posibilitatea de a semna documente Ods cu semnături Qrcode rapid și ușor.
