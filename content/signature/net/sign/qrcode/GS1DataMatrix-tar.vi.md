...
############################# Head ############################
head_title: "eSign Tar tài liệu với G S1 Data Matrix Mã QR trong C#"
head_description: "Tạo Mã QR G S1 Data Matrix và đặt nó vào tệp Tar bằng cách sử dụng .NET với một đoạn mã C# ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR G S1 Data Matrix cho tài liệu Tar trong C#"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Tar bằng Qrcode trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Tar bằng chữ ký Qrcode một cách nhanh chóng và dễ dàng.
