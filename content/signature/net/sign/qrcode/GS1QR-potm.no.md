...
############################# Head ############################
head_title: "eSign Potm-dokument med G S1 Q R QR-kode i C#"
head_description: "Lag G S1 Q R QR-kode og legg den til Potm-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer G S1 Q R QR-kodesignatur for Potm-dokument i C#"
description: "eSigner Potm-dokumentene og kontraktene dine med QR-koden G S1 Q R. Generer QR-kodesignatur raskt og enkelt."
...
steps:
    enable: true
    title_left: "Trinn for å signere Potm med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Potm-dokumenter med Qrcode-signaturer raskt og enkelt.
