...
############################# Head ############################
head_title: "eSign Dcm-dokument med Data Matrix QR-kode i C#"
head_description: "Opret Data Matrix QR-kode og læg den i Dcm-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer Data Matrix QR-kodesignatur for Dcm dokument i C#"
description: "eSignér dine Dcm-dokumenter og kontrakter med Data Matrix QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Trin til at signere Dcm med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Dcm dokumenter med Qrcode signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Dcm dokumenter med Qrcode Live Demo"
    content: |
