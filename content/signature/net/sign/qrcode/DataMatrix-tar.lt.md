...
############################# Head ############################
head_title: "eSign Tar dokumentas su Data Matrix QR kodu C#"
head_description: "Sukurkite QR kodą Data Matrix ir įdėkite jį į failą Tar naudodami .NET su trumpu C# kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite Data Matrix QR kodo parašą Tar dokumentui C#"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Tar naudojant Qrcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Tar dokumentus su Qrcode parašais.
