...
############################# Head ############################
head_title: "eSign Xlsm-dokument med Data Matrix QR-kod i C#"
head_description: "Skapa Data Matrix QR-kod och lägg den i filen Xlsm med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera Data Matrix QR-kodsignatur för Xlsm dokument i C#"
description: "esignera dina Xlsm-dokument och kontrakt med Data Matrix QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Xlsm med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Xlsm-dokument med Qrcode-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Xlsm dokument med Qrcode Live Demo"
    content: |
