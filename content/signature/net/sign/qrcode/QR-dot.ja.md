...
############################# Head ############################
head_title: "C# で QR QR コードを使用して Dot 文書に eSign"
head_description: "QR QR コードを作成し、短い C# コードを含む .NET を使用して Dot ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の Dot ドキュメントの QR QR コード署名を生成します"
description: "Dot ドキュメントと契約書に QR QR コードで電子署名します。 QR コード署名をすばやく簡単に生成します。"
