...
############################# Head ############################
head_title: "eSign Docm dokument s Data Matrix QR kodom u C#"
head_description: "Napravite Data Matrix QR kod i stavite ga u datoteku Docm koristeći .NET s kratkim dijelom C# koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj Data Matrix potpis QR koda za Docm dokument u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Docm s Qrcode u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Docm dokumenata s Qrcode potpisima.
