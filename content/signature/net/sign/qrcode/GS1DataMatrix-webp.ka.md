...
############################# Head ############################
head_title: "eSign Webp დოკუმენტი G S1 Data Matrix QR კოდით C#-ში"
head_description: "შექმენით G S1 Data Matrix QR კოდი და განათავსეთ ის Webp ფაილზე .NET-ის გამოყენებით C# კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით G S1 Data Matrix QR კოდის ხელმოწერა Webp დოკუმენტისთვის C#-ში"
description: "მოაწერეთ თქვენი Webp დოკუმენტები და კონტრაქტები G S1 Data Matrix QR კოდით. შექმენით QR კოდის ხელმოწერა სწრაფად და მარტივად."
...
steps:
    enable: true
    title_left: "Webp-ით ხელმოწერის ნაბიჯები Qrcode-ით C#-ში"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) იძლევა შესაძლებლობას მოაწეროთ Webp დოკუმენტები Qrcode ხელმოწერებით სწრაფად და მარტივად.
