...
############################# Head ############################
head_title: "C# ішінде Data Matrix QR коды бар eSign Ots құжаты"
head_description: "Data Matrix QR кодын жасаңыз және оны .NET арқылы C# кодының қысқа бөлігімен Ots файлына салыңыз. QR коды арқылы іскери құжаттар мен файлдарға электрондық қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "C# ішінде Ots құжаты үшін Data Matrix QR код қолтаңбасын жасаңыз"
