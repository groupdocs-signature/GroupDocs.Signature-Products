...
############################# Head ############################
head_title: "eSign Xltx documento con QR codice QR in C#"
head_description: "Crea il codice QR QR e inseriscilo nel file Xltx utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera QR firma del codice QR per il documento Xltx in C#"
