...
############################# Head ############################
head_title: "eSign Otp-dokument med QR QR-kod i C#"
head_description: "Skapa QR QR-kod och lägg den i filen Otp med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera QR QR-kodsignatur för Otp dokument i C#"
description: "esignera dina Otp-dokument och kontrakt med QR QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Otp med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Otp-dokument med Qrcode-signaturer snabbt och enkelt.
