...
############################# Head ############################
head_title: "eSign Dcm doiciméad le G S1 Data Matrix Cód QR in C#"
head_description: "Cruthaigh G S1 Data Matrix Cód QR agus cuir ar chomhad Dcm é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR G S1 Data Matrix don doiciméad Dcm in C#"
description: "eSínigh do dhoiciméid agus conarthaí Dcm le G S1 Data Matrix Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Dcm doiciméad le Qrcode Taispeántas Beo"
    content: |
       Sínigh Dcm comhad le sínithe éagsúla faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Saor in aisce taispeána ar líne ag fanacht leat.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Is leagan de Mhaitrís Sonraí é GS1 Data Matrix a chloíonn le sonraíochtaí GS1. Úsáid GS1 DataMatrix chun an fhaisnéis a ionchódú mar, ach gan a bheith teoranta dóibh seo a leanas: AI(01) Uimhir Mhíre Trádála Dhomhanda (GTIN), AI(17) Dáta Éaga, Baiscuimhir AI(10), Sraithuimhir AI(21). .
          characterset: |
             Tacar carachtar: litreacha cás uachtair agus cás íochtair agus carachtair speisialta $@%*+-./:=<>;&*_,'! go léir le hAitheantóirí Feidhmchláir chearta.
          textcapacity: |
             Acmhainn códtéacs: suas le 3116 dhigit uimhriúil, nó 2335 carachtar alfa-uimhriúil.
          image: |
...
more_formats:
    enable: true
    title: "Sínithe Qrcode eile a dtacaítear leo le haghaidh C#"
    content: |
        "Is féidir leat Dcm a shíniú le cineálacha sínithe eile freisin. Féach ar an liosta thíos le do thoil."
    format: 
