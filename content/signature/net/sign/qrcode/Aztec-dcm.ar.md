...
############################# Head ############################
head_title: "مستند eSign Dcm مع رمز الاستجابة السريعة Aztec في C#"
head_description: "أنشئ رمز الاستجابة السريعة Aztec وضعه في ملف Dcm باستخدام .NET مع جزء قصير من كود C#. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء Aztec توقيع رمز الاستجابة السريعة لمستند Dcm في C#"
description: "قم بتوقيع Dcm على المستندات والعقود باستخدام رمز الاستجابة السريعة Aztec. قم بإنشاء توقيع QR Code بسرعة وسهولة."
...
steps:
    enable: true
    title_left: "خطوات تسجيل Dcm باستخدام Qrcode في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Dcm بتوقيعات Qrcode بسرعة وسهولة.
        
        * قم بإنشاء مثيل لفئة التوقيع بتوفير ملف Dcm من المفترض أن يتم توقيعه كمسار أو دفق ذاكرة
        * إنشاء فئة SignOptions وتعيين جميع البيانات المطلوبة.
        * استدعاء أسلوب Signature.Sign () تمرير ملف الإخراج Dcm أو دفق الذاكرة
...
demos:
    enable: true
    title: "توقيع مستندات Dcm باستخدام العرض التوضيحي المباشر Qrcode"
    content: |
       وقّع ملف Dcm بتوقيعات مختلفة الآن من خلال زيارة موقع ويب [GroupDocs.Signature App] (https://products.groupdocs.app/signature/family). عرض تجريبي مجاني على الإنترنت في انتظارك.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            رمز Aztec هو رمز مصفوفة للأغراض العامة ثنائي الأبعاد (2-D) تم تصميمه للحصول على دقة أعلى من الرموز ثنائية الأبعاد الأخرى. يمكن أن يشفر رمز Aztec Code ما يصل إلى 3832 رقمًا ؛ 3067 حرفًا أبجديًا ؛ أو 1914 بايت من البيانات.
          characterset: |
             جميع الأحرف الـ 256 ASCII.
          textcapacity: |
             ما يصل إلى 3832 رقمًا أو 3067 حرفًا أبجديًا أو 1914 بايت من البيانات.
          image: |
...
more_formats:
    ...
    content: |
        "يمكنك أيضًا توقيع Dcm بأنواع التوقيع الأخرى. يرجى الاطلاع على القائمة أدناه."
    format: 
