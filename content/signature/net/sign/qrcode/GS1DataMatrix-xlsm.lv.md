...
############################# Head ############################
head_title: "eSign Xlsm dokuments ar G S1 Data Matrix QR kodu programmā C#"
head_description: "Izveidojiet G S1 Data Matrix QR kodu un ievietojiet to failā Xlsm, izmantojot .NET un īsu C# kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Data Matrix QR koda parakstu dokumentam Xlsm programmā C#"
description: "eParakstiet savus Xlsm dokumentus un līgumus ar G S1 Data Matrix QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Xlsm ar Qrcode programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Xlsm dokumentus ar Qrcode parakstiem.
