...
############################# Head ############################
head_title: "C# میں G S1 Data Matrix QR کوڈ کے ساتھ eSign Xlsm دستاویز"
head_description: "G S1 Data Matrix QR کوڈ بنائیں اور اسے .NET کا استعمال کرتے ہوئے C# کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Xlsm فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "C# میں Xlsm دستاویز کے لیے G S1 Data Matrix QR کوڈ دستخط بنائیں"
description: "اپنے Xlsm دستاویزات اور معاہدوں پر G S1 Data Matrix QR کوڈ کے ساتھ دستخط کریں۔ QR کوڈ دستخط جلدی اور آسانی سے بنائیں۔"
...
steps:
    enable: true
    title_left: "C# میں Qrcode کے ساتھ Xlsm پر دستخط کرنے کے مراحل"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) جلد اور آسانی سے Qrcode دستخطوں کے ساتھ Xlsm دستاویزات پر دستخط کرنے کی صلاحیت فراہم کرتا ہے۔
...
demos:
    enable: true
    title: "Qrcode لائیو ڈیمو کے ساتھ Xlsm دستاویزات پر دستخط کرنا"
    content: |
