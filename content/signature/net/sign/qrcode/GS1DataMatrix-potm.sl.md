...
############################# Head ############################
head_title: "eSign Potm dokument s G S1 Data Matrix QR kodo v C#"
head_description: "Ustvarite QR kodo G S1 Data Matrix in jo postavite v datoteko Potm z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari G S1 Data Matrix podpis kode QR za dokument Potm v C#"
description: "e-Podpišite svoje Potm dokumente in pogodbe s G S1 Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Potm z Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Potm s podpisi Qrcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Potm z Qrcode Live Demo"
    content: |
