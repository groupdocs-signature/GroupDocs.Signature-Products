...
############################# Head ############################
head_title: "eSign Tiff dokuments ar Aztec QR kodu programmā C#"
head_description: "Izveidojiet Aztec QR kodu un ievietojiet to failā Tiff, izmantojot .NET un īsu C# kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt Aztec QR koda parakstu dokumentam Tiff programmā C#"
description: "eParakstiet savus Tiff dokumentus un līgumus ar Aztec QR Code. Ātri un viegli ģenerējiet QR koda parakstu."
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Tiff ar Qrcode programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Tiff dokumentus ar Qrcode parakstiem.
