...
############################# Head ############################
head_title: "eSigniere Doc-Dokument mit Aztec-QR-Code in C#"
head_description: "Erstellen Sie einen Aztec-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Doc-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Aztec-QR-Code-Signatur für Doc-Dokument in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Doc mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Doc-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
