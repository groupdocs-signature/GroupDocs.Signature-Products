...
############################# Head ############################
head_title: "eSign Tar-dokument med Aztec QR-kod i C#"
head_description: "Skapa Aztec QR-kod och lägg den i filen Tar med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera Aztec QR-kodsignatur för Tar dokument i C#"
description: "esignera dina Tar-dokument och kontrakt med Aztec QR-kod. Generera QR-kodsignatur snabbt och enkelt."
