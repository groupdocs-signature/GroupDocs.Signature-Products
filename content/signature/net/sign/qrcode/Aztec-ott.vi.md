...
############################# Head ############################
head_title: "eSign Ott tài liệu với Aztec Mã QR trong C#"
head_description: "Tạo Mã QR Aztec và đặt nó vào tệp Ott bằng cách sử dụng .NET với một đoạn mã C# ngắn. Sử dụng API chữ ký tài liệu GroupDocs để ký điện tử các tài liệu và tệp doanh nghiệp của bạn bằng Mã QR."

############################# Header ############################
title: "Tạo chữ ký Mã QR Aztec cho tài liệu Ott trong C#"
description: "eSign các tài liệu và hợp đồng Ott của bạn bằng Mã QR Aztec. Tạo chữ ký Mã QR nhanh chóng và dễ dàng."
