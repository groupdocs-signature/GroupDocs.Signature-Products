...
############################# Head ############################
head_title: "eSign Xlsx dokument s G S1 Data Matrix QR kodom u C#"
head_description: "Napravite G S1 Data Matrix QR kod i stavite ga u datoteku Xlsx koristeći .NET s kratkim dijelom C# koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj G S1 Data Matrix potpis QR koda za Xlsx dokument u C#"
description: "ePotpišite svoje Xlsx dokumente i ugovore s G S1 Data Matrix QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
demos:
    enable: true
    title: "Potpisivanje Xlsx dokumenata s Qrcode Live Demo"
    content: |
       Potpišite datoteku Xlsx raznim potpisima upravo sada tako da posjetite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web mjesto. Besplatan online demo čeka na vas.
...
more_formats:
    enable: true
    title: "Drugi podržani potpisi Qrcode za C#"
    content: |
        "Također možete potpisati Xlsx drugim vrstama potpisa. Pogledajte popis u nastavku."
    format: 
