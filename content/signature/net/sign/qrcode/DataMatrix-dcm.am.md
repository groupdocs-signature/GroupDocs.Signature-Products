...
############################# Head ############################
head_title: "eSign Dcm ሰነድ በData Matrix QR ኮድ በC#"
head_description: "Data Matrix QR ኮድ ይፍጠሩ እና በDcm ፋይል ላይ .NETን በመጠቀም በአጭር የC# ኮድ ያስቀምጡት። የንግድ ሰነዶችዎን እና ፋይሎችዎን በQR ኮድ ኢ-ለመፈረም የGroupDocs ሰነድ ፊርማ ኤፒአይ ይጠቀሙ።"

############################# Header ############################
title: "በC# ውስጥ ለDcm ሰነድ የData Matrix QR ኮድ ፊርማ ይፍጠሩ"
description: "የእርስዎን Dcm ሰነዶች እና ኮንትራቶች በData Matrix QR ኮድ ይፈርሙ። የQR ኮድ ፊርማ በፍጥነት እና በቀላሉ ይፍጠሩ።"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ዳታ ማትሪክስ ጥቁር እና ነጭ ‹ሴሎች› ወይም ነጥቦችን በካሬ ወይም በአራት ማዕዘን ቅርፅ የተደረደሩ ባለ ሁለት ገጽታ ኮድ ነው፣ እንዲሁም ማትሪክስ በመባልም ይታወቃል። የሚቀየረው መረጃ የጽሑፍ ወይም የቁጥር ውሂብ ሊሆን ይችላል።
          characterset: |
             ሁሉንም 256 ASCII ቁምፊዎች፣ ሁሉንም ISO ቁምፊዎች እና ሁሉንም የተራዘመ ሁለትዮሽ ኮድ የአስርዮሽ ኮድ (ኢቢዲአይሲ) ቁምፊዎችን ይደግፋል።
          textcapacity: |
             እስከ 3116 አሃዛዊ አሃዞች፣ ወይም 2335 የአልፋ አሃዛዊ ቁምፊዎች፣ ወይም 1556 ሁለትዮሽ ቁምፊዎች።
          image: |
