...
############################# Head ############################
head_title: "eSign Dot documento com QR QR Code em C#"
head_description: "Crie QR QR Code e coloque-o no arquivo Dot usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere QR assinatura de QR Code para Dot documento em C#"
description: "Assine seus documentos e contratos Dot com QR QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Dot com Qrcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Dot com assinaturas Qrcode de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Dot documentos com Qrcode Demonstração ao vivo"
    content: |
