...
############################# Head ############################
head_title: "eSign Zip document avec Data Matrix QR Code en C#"
head_description: "Créez le code QR Data Matrix et placez-le dans le fichier Zip en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR Data Matrix pour le document Zip en C#"
