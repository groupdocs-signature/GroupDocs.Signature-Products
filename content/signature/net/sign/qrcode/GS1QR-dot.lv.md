...
############################# Head ############################
head_title: "eSign Dot dokuments ar G S1 Q R QR kodu programmā C#"
head_description: "Izveidojiet G S1 Q R QR kodu un ievietojiet to failā Dot, izmantojot .NET un īsu C# kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Q R QR koda parakstu dokumentam Dot programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Dot ar Qrcode programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Dot dokumentus ar Qrcode parakstiem.
