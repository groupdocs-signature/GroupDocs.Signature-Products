...
############################# Head ############################
head_title: "eSign Csv-dokument med Data Matrix QR-kode i C#"
head_description: "Opret Data Matrix QR-kode og læg den i Csv-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer Data Matrix QR-kodesignatur for Csv dokument i C#"
description: "eSignér dine Csv-dokumenter og kontrakter med Data Matrix QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Trin til at signere Csv med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Csv dokumenter med Qrcode signaturer hurtigt og nemt.
        
        * Opret en forekomst af signaturklassen, der leverer Csv-fil, der skal signere som sti eller hukommelsesstrøm
        * Instantiér SignOptions-klassen og indstil alle krævede data.
        * Kald Signature.Sign()-metoden ved at sende output Csv-fil eller hukommelsesstrøm
...
demos:
    enable: true
    title: "Signering af Csv dokumenter med Qrcode Live Demo"
    content: |
       Signer Csv-filen med forskellige signaturer lige nu ved at besøge webstedet [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Gratis online demo venter på dig.
...
more_formats:
    ...
    content: |
        "Du kan også signere Csv med andre signaturtyper. Se venligst listen nedenfor."
    format: 
