...
############################# Head ############################
head_title: "eSign Odp-dokument med QR QR-kode i C#"
head_description: "Lag QR QR-kode og legg den til Odp-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Odp-dokument i C#"
description: "eSigner Odp-dokumentene og kontraktene dine med QR-koden QR. Generer QR-kodesignatur raskt og enkelt."
