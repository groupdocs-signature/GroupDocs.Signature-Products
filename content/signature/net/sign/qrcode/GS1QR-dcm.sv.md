...
############################# Head ############################
head_title: "eSign Dcm-dokument med G S1 Q R QR-kod i C#"
head_description: "Skapa G S1 Q R QR-kod och lägg den i filen Dcm med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera G S1 Q R QR-kodsignatur för Dcm dokument i C#"
description: "esignera dina Dcm-dokument och kontrakt med G S1 Q R QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR-kod är en variant av QR-kod som överensstämmer med GS1-specifikationerna. Den designades speciellt för att dela utökad förpackningsinformation, såsom partinummer, produkt-ID och kvantitet.
          characterset: |
             Versaler och gemener och specialtecken $%*+-./: alla med korrekta applikationsidentifierare
          textcapacity: |
             Upp till 7089 numeriska tecken, 4296 alfanumeriska tecken
          image: |
