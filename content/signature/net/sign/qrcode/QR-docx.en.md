...
############################# Head ############################
head_title: "eSign Docx document with QR QR Code in C#"
head_description: "Create QR QR Code Signature on Docx file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate QR QR Code signature for Docx document in C#"
description: "eSign your Docx documents and contracts with QR QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options."
