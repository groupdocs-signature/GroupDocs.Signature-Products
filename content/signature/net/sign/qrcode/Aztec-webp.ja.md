...
############################# Head ############################
head_title: "C# で Aztec QR コードを使用して Webp 文書に eSign"
head_description: "Aztec QR コードを作成し、短い C# コードを含む .NET を使用して Webp ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の Webp ドキュメントの Aztec QR コード署名を生成します"
