...
############################# Head ############################
head_title: "eSign Doc документ с QR-кодом G S1 Data Matrix в C#"
head_description: "Создайте QR-код G S1 Data Matrix и поместите его в файл Doc, используя .NET с коротким фрагментом кода C#. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода G S1 Data Matrix для документа Doc в C#"
