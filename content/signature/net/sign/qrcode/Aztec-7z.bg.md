...
############################# Head ############################
head_title: "eSign 7z документ с Aztec QR код в C#"
head_description: "Създайте Aztec QR код и го поставете във файл 7z, като използвате .NET с кратка част от C# код. Използвайте API за подписване на документи на GroupDocs, за да подпишете електронно вашите бизнес документи и файлове с QR код."

############################# Header ############################
title: "Генерирайте Aztec QR Code подпис за 7z документ в C#"
description: "Електронно подпишете вашите 7z документи и договори с Aztec QR код. Генерирайте QR код подпис бързо и лесно."
...
steps:
    enable: true
    title_left: "Стъпки за подписване на 7z с Qrcode в C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя възможност за бързо и лесно подписване на 7z документи с Qrcode подписи.
