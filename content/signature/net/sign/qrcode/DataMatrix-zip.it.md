...
############################# Head ############################
head_title: "eSign Zip documento con Data Matrix codice QR in C#"
head_description: "Crea il codice QR Data Matrix e inseriscilo nel file Zip utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera Data Matrix firma del codice QR per il documento Zip in C#"
description: "Firma i tuoi documenti e contratti Zip con il codice QR Data Matrix. Genera la firma del codice QR in modo rapido e semplice."
