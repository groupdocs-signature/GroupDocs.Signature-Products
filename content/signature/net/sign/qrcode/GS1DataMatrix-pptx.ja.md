...
############################# Head ############################
head_title: "C# で G S1 Data Matrix QR コードを使用して Pptx 文書に eSign"
head_description: "G S1 Data Matrix QR コードを作成し、短い C# コードを含む .NET を使用して Pptx ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の Pptx ドキュメントの G S1 Data Matrix QR コード署名を生成します"
