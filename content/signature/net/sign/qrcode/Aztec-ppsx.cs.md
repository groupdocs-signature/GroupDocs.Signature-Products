...
############################# Head ############################
head_title: "Dokument eSign Ppsx s Aztec QR kódem v C#"
head_description: "Vytvořte QR kód Aztec a vložte jej do souboru Ppsx pomocí .NET s krátkým kódem C#. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis Aztec QR kódu pro dokument Ppsx v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Ppsx pomocí Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Ppsx pomocí podpisů Qrcode.
