...
############################# Head ############################
head_title: "eSign Pps-dokument med QR QR-kode i C#"
head_description: "Lag QR QR-kode og legg den til Pps-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Pps-dokument i C#"
description: "eSigner Pps-dokumentene og kontraktene dine med QR-koden QR. Generer QR-kodesignatur raskt og enkelt."
...
steps:
    enable: true
    title_left: "Trinn for å signere Pps med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Pps-dokumenter med Qrcode-signaturer raskt og enkelt.
