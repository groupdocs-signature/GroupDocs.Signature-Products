...
############################# Head ############################
head_title: "eSign Dotm document with QR QR Code in C#"
head_description: "Create QR QR Code and put it on Dotm file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate QR QR Code signature for Dotm document in C#"
