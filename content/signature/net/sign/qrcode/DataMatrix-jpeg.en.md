...
breadcrumb: Put  Qrcode signature on Jpeg for C#

############################# Head ############################
head_title: "eSign Jpeg document with Data Matrix QR Code in C#"
head_description: "Create Data Matrix QR Code Signature on Jpeg file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Data Matrix QR Code signature for Jpeg document in C#"
description: "eSign your Jpeg documents and contracts with Data Matrix QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Jpeg files with Qrcode signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to sign Jpeg with Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Jpeg documents with Qrcode signatures quick and easily.
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with Data Matrix Qrcode using C#"
    content: |
        .NET Data Matrix Qrcode signatures management API for documents and images. Add Data Matrix Qrcode signatures to some of the popular file formats as stated below.
    format: 
