...
############################# Head ############################
head_title: "eSign Jpeg document with QR QR Code in C#"
head_description: "Create QR QR Code Signature on Jpeg file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate QR QR Code signature for Jpeg document in C#"
description: "eSign your Jpeg documents and contracts with QR QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with QR Qrcode using C#"
    content: |
        .NET QR Qrcode signatures management API for documents and images. Add QR Qrcode signatures to some of the popular file formats as stated below.
    format: 
