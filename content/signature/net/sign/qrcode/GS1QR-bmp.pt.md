...
############################# Head ############################
head_title: "eSign Bmp documento com G S1 Q R QR Code em C#"
head_description: "Crie G S1 Q R QR Code e coloque-o no arquivo Bmp usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere G S1 Q R assinatura de QR Code para Bmp documento em C#"
description: "Assine seus documentos e contratos Bmp com G S1 Q R QR Code. Gere assinatura de QR Code de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Etapas para assinar Bmp com Qrcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Bmp com assinaturas Qrcode de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Bmp documentos com Qrcode Demonstração ao vivo"
    content: |
