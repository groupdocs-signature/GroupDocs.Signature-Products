...
############################# Head ############################
head_title: "eSign Ots documento con G S1 Data Matrix codice QR in C#"
head_description: "Crea il codice QR G S1 Data Matrix e inseriscilo nel file Ots utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera G S1 Data Matrix firma del codice QR per il documento Ots in C#"
