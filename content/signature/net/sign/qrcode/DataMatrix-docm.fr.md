...
############################# Head ############################
head_title: "eSign Docm document avec Data Matrix QR Code en C#"
head_description: "Créez le code QR Data Matrix et placez-le dans le fichier Docm en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR Data Matrix pour le document Docm en C#"
description: "Signez électroniquement vos documents et contrats Docm avec Data Matrix QR Code. Générez une signature QR Code rapidement et facilement."
