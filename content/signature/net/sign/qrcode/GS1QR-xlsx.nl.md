...
############################# Head ############################
head_title: "eSign Xlsx document met G S1 Q R QR-code in C#"
head_description: "Maak een G S1 Q R QR-code en plaats deze in het Xlsx-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Q R QR Code handtekening voor Xlsx document in C#"
