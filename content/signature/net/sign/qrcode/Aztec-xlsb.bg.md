...
############################# Head ############################
head_title: "eSign Xlsb документ с Aztec QR код в C#"
head_description: "Създайте Aztec QR код и го поставете във файл Xlsb, като използвате .NET с кратка част от C# код. Използвайте API за подписване на документи на GroupDocs, за да подпишете електронно вашите бизнес документи и файлове с QR код."

############################# Header ############################
title: "Генерирайте Aztec QR Code подпис за Xlsb документ в C#"
