...
############################# Head ############################
head_title: "eSign Webp փաստաթուղթը QR QR կոդով C#-ում"
head_description: "Ստեղծեք QR QR կոդ և դրեք այն Webp ֆայլի վրա՝ օգտագործելով .NET՝ C# կոդի կարճ հատվածով: Օգտագործեք GroupDocs Document Signature API-ը՝ ձեր բիզնես փաստաթղթերն ու ֆայլերը QR կոդով էլեկտրոնային ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք QR QR կոդ ստորագրություն Webp փաստաթղթի համար C#-ում"
description: "e-ստորագրեք ձեր Webp փաստաթղթերն ու պայմանագրերը QR QR կոդով: Արագ և հեշտությամբ ստեղծեք QR Code ստորագրություն:"
...
steps:
    enable: true
    title_left: "Webp-ը Qrcode-ով C#-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Webp փաստաթղթերը Qrcode ստորագրություններով:
...
demos:
    enable: true
    title: "Webp փաստաթղթերի ստորագրում Qrcode Live Demo-ով"
    content: |
