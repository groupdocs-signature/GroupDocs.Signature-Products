...
############################# Head ############################
head_title: "C# で Aztec QR コードを使用して Xltm 文書に eSign"
head_description: "Aztec QR コードを作成し、短い C# コードを含む .NET を使用して Xltm ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の Xltm ドキュメントの Aztec QR コード署名を生成します"
