...
############################# Head ############################
head_title: "eSigniere Tiff-Dokument mit Aztec-QR-Code in C#"
head_description: "Erstellen Sie einen Aztec-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Tiff-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Aztec-QR-Code-Signatur für Tiff-Dokument in C#"
description: "Unterzeichnen Sie Ihre Tiff-Dokumente und -Verträge mit dem Aztec-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Aztec Code ist eine zweidimensionale (2-D) Allzweck-Matrix-Symbologie, die für eine höhere Genauigkeit als andere 2-D-Symbologien ausgelegt ist. Ein Aztec Code-Symbol kann bis zu 3.832 Ziffern kodieren; 3.067 alphabetische Zeichen; oder 1.914 Byte Daten.
          characterset: |
             Alle 256 ASCII-Zeichen.
          textcapacity: |
             Bis zu 3.832 numerische Ziffern oder 3.067 alphabetische Zeichen oder 1.914 Datenbytes.
          image: |
