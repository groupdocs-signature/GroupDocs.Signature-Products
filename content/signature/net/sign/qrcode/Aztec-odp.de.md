...
############################# Head ############################
head_title: "eSigniere Odp-Dokument mit Aztec-QR-Code in C#"
head_description: "Erstellen Sie einen Aztec-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Odp-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere Aztec-QR-Code-Signatur für Odp-Dokument in C#"
description: "Unterzeichnen Sie Ihre Odp-Dokumente und -Verträge mit dem Aztec-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Odp mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Odp-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Odp-Dokumenten mit Qrcode Live-Demo"
    content: |
