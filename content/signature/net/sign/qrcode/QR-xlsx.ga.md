...
############################# Head ############################
head_title: "eSign Xlsx doiciméad le QR Cód QR in C#"
head_description: "Cruthaigh QR Cód QR agus cuir ar chomhad Xlsx é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR QR don doiciméad Xlsx in C#"
description: "eSínigh do dhoiciméid agus conarthaí Xlsx le QR Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
