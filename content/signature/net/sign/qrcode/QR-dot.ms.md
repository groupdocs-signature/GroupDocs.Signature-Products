...
############################# Head ############################
head_title: "eSign Dot dokumen dengan QR QR Code dalam C#"
head_description: "Cipta QR Kod QR dan letakkan pada fail Dot menggunakan .NET dengan sekeping pendek kod C#. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan QR tandatangan Kod QR untuk Dot dokumen dalam C#"
description: "eTandatangani dokumen dan kontrak Dot anda dengan Kod QR QR. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Dot dengan Qrcode dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Dot dengan tandatangan Qrcode dengan cepat dan mudah.
