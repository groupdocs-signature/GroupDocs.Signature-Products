...
description: "eSínigh do dhoiciméid agus conarthaí Ots le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Ots doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
