...
############################# Head ############################
head_title: "eSign Doc doiciméad le Data Matrix Cód QR in C#"
head_description: "Cruthaigh Data Matrix Cód QR agus cuir ar chomhad Doc é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR Data Matrix don doiciméad Doc in C#"
description: "eSínigh do dhoiciméid agus conarthaí Doc le Data Matrix Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Céimeanna chun Doc a shíniú le Qrcode in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Doc a shíniú le sínithe Qrcode go tapa agus go héasca.
        ...
        * Iarr ar an modh Signature.Sign() aschuir Doc comhad nó sruth cuimhne a rith
...
demos:
    enable: true
    title: "Ag síniú Doc doiciméad le Qrcode Taispeántas Beo"
    content: |
