...
############################# Head ############################
head_title: "eSign Xltm დოკუმენტი G S1 Data Matrix QR კოდით C#-ში"
head_description: "შექმენით G S1 Data Matrix QR კოდი და განათავსეთ ის Xltm ფაილზე .NET-ის გამოყენებით C# კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით G S1 Data Matrix QR კოდის ხელმოწერა Xltm დოკუმენტისთვის C#-ში"
...
steps:
    enable: true
    title_left: "Xltm-ით ხელმოწერის ნაბიჯები Qrcode-ით C#-ში"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) იძლევა შესაძლებლობას მოაწეროთ Xltm დოკუმენტები Qrcode ხელმოწერებით სწრაფად და მარტივად.
