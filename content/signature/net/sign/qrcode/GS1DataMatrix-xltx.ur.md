...
############################# Head ############################
head_title: "C# میں G S1 Data Matrix QR کوڈ کے ساتھ eSign Xltx دستاویز"
head_description: "G S1 Data Matrix QR کوڈ بنائیں اور اسے .NET کا استعمال کرتے ہوئے C# کوڈ کے ایک چھوٹے ٹکڑے کے ساتھ Xltx فائل پر رکھیں۔ QR کوڈ کے ساتھ اپنے کاروباری دستاویزات اور فائلوں پر ای سائن کرنے کے لیے GroupDocs Document Signature API کا استعمال کریں۔"

############################# Header ############################
title: "C# میں Xltx دستاویز کے لیے G S1 Data Matrix QR کوڈ دستخط بنائیں"
description: "اپنے Xltx دستاویزات اور معاہدوں پر G S1 Data Matrix QR کوڈ کے ساتھ دستخط کریں۔ QR کوڈ دستخط جلدی اور آسانی سے بنائیں۔"
...
steps:
    enable: true
    title_left: "C# میں Qrcode کے ساتھ Xltx پر دستخط کرنے کے مراحل"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) جلد اور آسانی سے Qrcode دستخطوں کے ساتھ Xltx دستاویزات پر دستخط کرنے کی صلاحیت فراہم کرتا ہے۔
...
demos:
    enable: true
    title: "Qrcode لائیو ڈیمو کے ساتھ Xltx دستاویزات پر دستخط کرنا"
    content: |
