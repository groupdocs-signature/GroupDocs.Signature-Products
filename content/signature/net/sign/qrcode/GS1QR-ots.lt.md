...
############################# Head ############################
head_title: "eSign Ots dokumentas su G S1 Q R QR kodu C#"
head_description: "Sukurkite QR kodą G S1 Q R ir įdėkite jį į failą Ots naudodami .NET su trumpu C# kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Q R QR kodo parašą Ots dokumentui C#"
description: "e. Pasirašykite Ots dokumentus ir sutartis naudodami G S1 Q R QR kodą. Greitai ir lengvai sugeneruokite QR kodo parašą."
