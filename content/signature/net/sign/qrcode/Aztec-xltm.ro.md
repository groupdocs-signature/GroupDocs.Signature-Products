...
############################# Head ############################
head_title: "eSign documentul Xltm cu codul QR Aztec în C#"
head_description: "Creați codul QR Aztec și puneți-l în fișierul Xltm folosind .NET cu o scurtă bucată de cod C#. Utilizați API-ul GroupDocs Document Signature pentru a vă semna electronic documentele și fișierele de afaceri cu codul QR."

############################# Header ############################
title: "Generați semnătura Aztec cod QR pentru documentul Xltm în C#"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xltm cu Qrcode în C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) oferă posibilitatea de a semna documente Xltm cu semnături Qrcode rapid și ușor.
