...
############################# Head ############################
head_title: "eSign Docx documento con G S1 Data Matrix codice QR in C#"
head_description: "Crea il codice QR G S1 Data Matrix e inseriscilo nel file Docx utilizzando .NET con un breve pezzo di codice C#. Usa l'API per la firma dei documenti di GroupDocs per firmare elettronicamente i tuoi documenti e file aziendali con il codice QR."

############################# Header ############################
title: "Genera G S1 Data Matrix firma del codice QR per il documento Docx in C#"
description: "Firma i tuoi documenti e contratti Docx con il codice QR G S1 Data Matrix. Genera la firma del codice QR in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Docx con Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Docx con firme Qrcode in modo rapido e semplice.
...
demos:
    enable: true
    title: "Firma di documenti Docx con Qrcode Demo live"
    content: |
