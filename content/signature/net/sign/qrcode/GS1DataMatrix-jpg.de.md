...
############################# Head ############################
head_title: "eSigniere Jpg-Dokument mit G S1 Data Matrix-QR-Code in C#"
head_description: "Erstellen Sie einen G S1 Data Matrix-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Jpg-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere G S1 Data Matrix-QR-Code-Signatur für Jpg-Dokument in C#"
description: "Unterzeichnen Sie Ihre Jpg-Dokumente und -Verträge mit dem G S1 Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Jpg mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Jpg-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Jpg-Dokumenten mit Qrcode Live-Demo"
    content: |
