...
description: "eSínigh do dhoiciméid agus conarthaí Ott le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Ott doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
