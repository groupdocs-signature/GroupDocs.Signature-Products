...
head_description: "Create Aztec QR Code and put it on Bmp file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Bmp documents with Qrcode signatures quickly and easily.
