...
############################# Head ############################
head_title: "eSign Dcm dokument s Data Matrix QR kodo v C#"
head_description: "Ustvarite QR kodo Data Matrix in jo postavite v datoteko Dcm z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari Data Matrix podpis kode QR za dokument Dcm v C#"
description: "e-Podpišite svoje Dcm dokumente in pogodbe s Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Data Matrix je dvodimenzionalna koda, sestavljena iz črno-belih 'celic' ali pik, razporejenih v kvadratni ali pravokotni vzorec, znan tudi kot matrika. Informacije, ki jih je treba kodirati, so lahko besedilni ali številski podatki.
          characterset: |
             Podpira vseh 256 znakov ASCII, vse znake ISO in vse znake Extended Binary Coded Decimal Interchange Code (EBCDIC).
          textcapacity: |
             Do 3116 številskih števk ali 2335 alfanumeričnih znakov ali 1556 binarnih znakov.
          image: |
