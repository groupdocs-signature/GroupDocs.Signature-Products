...
############################# Head ############################
head_title: "eSign Xlsx document met Data Matrix QR-code in C#"
head_description: "Maak een Data Matrix QR-code en plaats deze in het Xlsx-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Data Matrix QR Code handtekening voor Xlsx document in C#"
description: "Onderteken uw Xlsx documenten en contracten met Data Matrix QR-code. Genereer snel en gemakkelijk een QR-codehandtekening."
...
steps:
    enable: true
    title_left: "Stappen om Xlsx te ondertekenen met Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Xlsx documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
        ...
        * Roep de Signature.Sign()-methode op en geef uitvoer Xlsx-bestand of geheugenstroom
...
demos:
    enable: true
    title: "Xlsx documenten ondertekenen met Qrcode Live Demo"
    content: |
