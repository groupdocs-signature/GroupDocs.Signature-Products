...
############################# Head ############################
head_title: "eSign Potm document met Data Matrix QR-code in C#"
head_description: "Maak een Data Matrix QR-code en plaats deze in het Potm-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Data Matrix QR Code handtekening voor Potm document in C#"
