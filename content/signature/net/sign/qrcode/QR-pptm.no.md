...
############################# Head ############################
head_title: "eSign Pptm-dokument med QR QR-kode i C#"
head_description: "Lag QR QR-kode og legg den til Pptm-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer QR QR-kodesignatur for Pptm-dokument i C#"
description: "eSigner Pptm-dokumentene og kontraktene dine med QR-koden QR. Generer QR-kodesignatur raskt og enkelt."
