...
############################# Head ############################
head_title: "Belgeya eSign Xls bi G S1 Q R Koda QR di C#"
head_description: "Koda QR-a G S1 Q R biafirînin û bi koda C# bi koda .NET li pelê Xls bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Xls bi Qrcode di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Xls bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
