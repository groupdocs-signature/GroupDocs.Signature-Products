...
############################# Head ############################
head_title: "eSign Potx document met G S1 Data Matrix QR-code in C#"
head_description: "Maak een G S1 Data Matrix QR-code en plaats deze in het Potx-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer G S1 Data Matrix QR Code handtekening voor Potx document in C#"
...
steps:
    enable: true
    title_left: "Stappen om Potx te ondertekenen met Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Potx documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
