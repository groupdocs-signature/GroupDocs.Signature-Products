...
############################# Head ############################
head_title: "eSign Potx skjal með G S1 Data Matrix QR kóða í C#"
head_description: "Búðu til G S1 Data Matrix QR kóða og settu hann á Potx skrá með því að nota .NET með stuttu stykki af C# kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til G S1 Data Matrix QR kóða undirskrift fyrir Potx skjal í C#"
description: "eSignaðu Potx skjölin þín og samninga með G S1 Data Matrix QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Potx með Qrcode í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Potx skjöl með Qrcode undirskrift fljótt og auðveldlega.
