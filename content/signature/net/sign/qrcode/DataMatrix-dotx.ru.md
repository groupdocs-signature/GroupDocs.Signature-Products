...
############################# Head ############################
head_title: "eSign Dotx документ с QR-кодом Data Matrix в C#"
head_description: "Создайте QR-код Data Matrix и поместите его в файл Dotx, используя .NET с коротким фрагментом кода C#. Используйте API подписи документов GroupDocs для электронной подписи ваших деловых документов и файлов с помощью QR-кода."

############################# Header ############################
title: "Создайте подпись QR-кода Data Matrix для документа Dotx в C#"
description: "Электронная подпись Dotx документов и контрактов с Data Matrix QR-кодом. Создавайте подпись QR-кода быстро и легко."
