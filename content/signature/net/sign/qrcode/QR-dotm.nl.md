...
############################# Head ############################
head_title: "eSign Dotm document met QR QR-code in C#"
head_description: "Maak een QR QR-code en plaats deze in het Dotm-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer QR QR Code handtekening voor Dotm document in C#"
