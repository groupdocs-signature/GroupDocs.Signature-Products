...
############################# Head ############################
head_title: "eSign Potx փաստաթուղթը G S1 Q R QR կոդով C#-ում"
head_description: "Ստեղծեք G S1 Q R QR կոդ և դրեք այն Potx ֆայլի վրա՝ օգտագործելով .NET՝ C# կոդի կարճ հատվածով: Օգտագործեք GroupDocs Document Signature API-ը՝ ձեր բիզնես փաստաթղթերն ու ֆայլերը QR կոդով էլեկտրոնային ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք G S1 Q R QR կոդ ստորագրություն Potx փաստաթղթի համար C#-ում"
description: "e-ստորագրեք ձեր Potx փաստաթղթերն ու պայմանագրերը G S1 Q R QR կոդով: Արագ և հեշտությամբ ստեղծեք QR Code ստորագրություն:"
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR կոդը QR կոդի տարբերակ է, որը համապատասխանում է GS1 բնութագրերին: Այն ստեղծվել է հատուկ փաթեթավորման ընդլայնված տեղեկատվության փոխանակման համար, ինչպիսիք են լոտի համարը, ապրանքի ID-ն և քանակը:
          characterset: |
             Մեծ և փոքրատառ տառեր և հատուկ նիշեր $%*+-./. բոլորը ճիշտ հավելվածի նույնացուցիչներով
          textcapacity: |
             Մինչև 7089 թվային նիշ, 4296 այբբենական նիշ
          image: |
