...
head_description: "Opret Aztec QR-kode og læg den i Rtf-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer Aztec QR-kodesignatur for Rtf dokument i C#"
description: "eSignér dine Rtf-dokumenter og kontrakter med Aztec QR-kode. Generer QR-kodesignatur hurtigt og nemt."
