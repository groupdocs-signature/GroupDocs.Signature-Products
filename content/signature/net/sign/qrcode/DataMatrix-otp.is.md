...
############################# Head ############################
head_title: "eSign Otp skjal með Data Matrix QR kóða í C#"
head_description: "Búðu til Data Matrix QR kóða og settu hann á Otp skrá með því að nota .NET með stuttu stykki af C# kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til Data Matrix QR kóða undirskrift fyrir Otp skjal í C#"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Otp með Qrcode í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Otp skjöl með Qrcode undirskrift fljótt og auðveldlega.
