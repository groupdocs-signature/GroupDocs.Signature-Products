...
############################# Head ############################
head_title: "Belgeya eSign Ppsx bi G S1 Data Matrix Koda QR di C#"
head_description: "Koda QR-a G S1 Data Matrix biafirînin û bi koda C# bi koda .NET li pelê Ppsx bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku belge û pelên karsaziya xwe bi QR Code e-îmza bikin."

############################# Header ############################
title: "Di C# de ji bo belgeya G S1 Data Matrix îmzeya Koda QR çêbike"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Ppsx bi Qrcode di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Ppsx bi îmzeyên Qrcode zû û bi hêsanî peyda dike.
