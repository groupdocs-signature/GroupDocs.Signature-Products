...
############################# Head ############################
head_title: "C# ішінде QR QR коды бар eSign Ots құжаты"
head_description: "QR QR кодын жасаңыз және оны .NET арқылы C# кодының қысқа бөлігімен Ots файлына салыңыз. QR коды арқылы іскери құжаттар мен файлдарға электрондық қол қою үшін GroupDocs Document Signature API пайдаланыңыз."

############################# Header ############################
title: "C# ішінде Ots құжаты үшін QR QR код қолтаңбасын жасаңыз"
...
steps:
    enable: true
    title_left: "C# жүйесінде Qrcode арқылы Ots файлына қол қою қадамдары"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) Ots құжаттарға Qrcode қолтаңбаларымен жылдам және оңай қол қою мүмкіндігін береді.
