...
############################# Head ############################
head_title: "eSign Ppsx dokumen dengan Data Matrix QR Code dalam C#"
head_description: "Cipta Data Matrix Kod QR dan letakkan pada fail Ppsx menggunakan .NET dengan sekeping pendek kod C#. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan Data Matrix tandatangan Kod QR untuk Ppsx dokumen dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Ppsx dengan Qrcode dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Ppsx dengan tandatangan Qrcode dengan cepat dan mudah.
