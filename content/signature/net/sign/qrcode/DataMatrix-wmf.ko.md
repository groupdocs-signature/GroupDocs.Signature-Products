...
############################# Head ############################
head_title: "C#의 Data Matrix QR 코드로 Wmf 문서에 전자 서명"
head_description: "짧은 C# 코드와 함께 .NET을(를) 사용하여 Data Matrix QR 코드를 생성하고 Wmf 파일에 넣습니다. GroupDocs 문서 서명 API를 사용하여 QR 코드로 비즈니스 문서 및 파일에 전자 서명하십시오."

############################# Header ############################
title: "C#에서 Wmf 문서에 대한 Data Matrix QR 코드 서명 생성"
...
steps:
    enable: true
    title_left: "C#에서 Qrcode으로 Wmf에 서명하는 단계"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/)은 Qrcode 서명으로 Wmf 문서에 빠르고 쉽게 서명할 수 있는 기능을 제공합니다.
