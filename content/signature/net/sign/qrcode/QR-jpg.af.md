...
############################# Head ############################
head_title: "eSign Jpg-dokument met QR QR-kode in C#"
head_description: "Skep QR QR-kode en plaas dit op Jpg-lêer deur .NET met 'n kort stukkie C#-kode te gebruik. Gebruik die GroupDocs Document Signature API om jou besigheidsdokumente en lêers met QR-kode te e-teken."

############################# Header ############################
title: "Genereer QR QR-kode handtekening vir Jpg dokument in C#"
...
steps:
    enable: true
    title_left: "Stappe om Jpg met Qrcode in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Jpg dokumente met Qrcode handtekeninge vinnig en maklik te onderteken.
