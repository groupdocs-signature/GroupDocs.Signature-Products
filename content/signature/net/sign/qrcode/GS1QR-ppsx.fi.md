...
############################# Head ############################
head_title: "eSign Ppsx -asiakirja G S1 Q R QR-koodilla C#"
head_description: "Luo QR-koodi G S1 Q R ja laita se Ppsx-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo G S1 Q R QR-koodiallekirjoitus asiakirjalle Ppsx kohteessa C#"
...
steps:
    enable: true
    title_left: "Vaiheet Ppsx:n allekirjoittamiseen Qrcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Ppsx-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
