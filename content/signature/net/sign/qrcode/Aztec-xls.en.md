...
head_description: "Create Aztec QR Code and put it on Xls file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Aztec QR Code signature for Xls document in C#"
description: "eSign your Xls documents and contracts with Aztec QR Code. Generate QR Code signature quickly and easily."
