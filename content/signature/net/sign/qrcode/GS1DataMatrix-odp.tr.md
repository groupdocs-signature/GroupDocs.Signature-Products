...
############################# Head ############################
head_title: "C# içinde G S1 Data Matrix QR Kodu ile Odp belgesini eSign"
head_description: "G S1 Data Matrix QR Kodu oluşturun ve kısa bir C# kodu parçasıyla .NET kullanarak Odp dosyasına koyun. İş belgelerinizi ve dosyalarınızı QR Kodu ile e-imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "C# içinde Odp belgesi için G S1 Data Matrix QR Kodu imzası oluşturun"
description: "Odp belgelerinizi ve sözleşmelerinizi G S1 Data Matrix QR Kodu ile e-imzalayın. Hızlı ve kolay bir şekilde QR Kodu imzası oluşturun."
...
steps:
    enable: true
    title_left: "C# içinde Qrcode ile Odp imzalama adımları"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Odp belgelerini Qrcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
        
        * Yol veya bellek akışı olarak imzalaması gereken Odp dosyasını sağlayan bir Signature sınıfı örneği oluşturun
        * SignOptions sınıfını örnekleyin ve istenen tüm verileri ayarlayın.
        * Çıkış Odp dosyasını veya bellek akışını geçen Signature.Sign() yöntemini çağırın
...
demos:
    enable: true
    title: "Odp dokümanı Qrcode Canlı Demo ile imzalama"
    content: |
       Hemen şimdi [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web sitesini ziyaret ederek çeşitli imzalarla Odp dosyasını imzalayın. Ücretsiz çevrimiçi demo sizi bekliyor.
...
more_formats:
    ...
    content: |
        "Odp'ı diğer imza türleriyle de imzalayabilirsiniz. Lütfen aşağıdaki listeye bakın."
    format: 
