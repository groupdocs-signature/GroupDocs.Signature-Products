...
############################# Head ############################
head_title: "eSigniere Xltm-Dokument mit G S1 Data Matrix-QR-Code in C#"
head_description: "Erstellen Sie einen G S1 Data Matrix-QR-Code und fügen Sie ihn mit .NET und einem kurzen Stück C#-Code in eine Xltm-Datei ein. Verwenden Sie die GroupDocs Document Signature API, um Ihre Geschäftsdokumente und Dateien mit QR-Code elektronisch zu signieren."

############################# Header ############################
title: "Generiere G S1 Data Matrix-QR-Code-Signatur für Xltm-Dokument in C#"
description: "Unterzeichnen Sie Ihre Xltm-Dokumente und -Verträge mit dem G S1 Data Matrix-QR-Code. Generieren Sie schnell und einfach eine QR-Code-Signatur."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Xltm mit Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Xltm-Dokumente mit Qrcode-Signaturen schnell und einfach zu signieren.
        
        * Erstellen Sie eine Instanz der Signature-Klasse, die die Xltm-Datei bereitstellt, die als Pfad oder Speicherstream signiert werden soll
        * Instanziieren Sie die SignOptions-Klasse und legen Sie alle erforderlichen Daten fest.
        * Rufen Sie die Signature.Sign()-Methode auf und übergeben Sie die Xltm-Ausgabedatei oder den Speicherstream
...
demos:
    enable: true
    title: "Signieren von Xltm-Dokumenten mit Qrcode Live-Demo"
    content: |
       Signieren Sie die Datei Xltm jetzt mit verschiedenen Signaturen, indem Sie die Website [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) besuchen. Kostenlose Online-Demo wartet auf Sie.
...
more_formats:
    ...
    content: |
        "Sie können Xltm auch mit anderen Signaturtypen signieren. Bitte sehen Sie sich die Liste unten an."
    format: 
