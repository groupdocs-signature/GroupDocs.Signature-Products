...
############################# Head ############################
head_title: "eSign Dot dokumen dengan G S1 Data Matrix QR Code di C#"
head_description: "Buat Kode QR G S1 Data Matrix dan letakkan di file Dot menggunakan .NET dengan potongan pendek kode C#. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani dokumen dan file bisnis Anda secara elektronik dengan Kode QR."

############################# Header ############################
title: "Buat G S1 Data Matrix tanda tangan Kode QR untuk dokumen Dot di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Dot dengan Qrcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Dot dengan Qrcode tanda tangan dengan cepat dan mudah.
