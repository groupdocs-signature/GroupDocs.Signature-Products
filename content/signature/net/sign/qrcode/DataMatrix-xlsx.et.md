...
############################# Head ############################
head_title: "eSign Xlsx dokument Data Matrix QR-koodiga rakenduses C#"
head_description: "Looge QR-kood Data Matrix ja sisestage see faili Xlsx, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Xlsx QR-koodi allkiri Data Matrix"
...
steps:
    enable: true
    title_left: "Toimingud Xlsx allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Xlsx dokumente Qrcode allkirjaga.
