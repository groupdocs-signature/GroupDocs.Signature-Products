...
############################# Head ############################
head_title: "eSign Doc dokument s Data Matrix QR kodom u C#"
head_description: "Napravite Data Matrix QR kod i stavite ga u datoteku Doc koristeći .NET s kratkim dijelom C# koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj Data Matrix potpis QR koda za Doc dokument u C#"
description: "ePotpišite svoje Doc dokumente i ugovore s Data Matrix QR kodom. Brzo i jednostavno generirajte potpis QR koda."
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Doc s Qrcode u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Doc dokumenata s Qrcode potpisima.
