...
############################# Head ############################
head_title: "eSign Tiff document with G S1 Q R QR Code in C#"
head_description: "Create G S1 Q R QR Code Signature on Tiff file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate G S1 Q R QR Code signature for Tiff document in C#"
description: "eSign your Tiff documents and contracts with G S1 Q R QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Tiff files with Qrcode signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
        You can put Qrcode on Tiff file in a very convenient way and for free. Besides that it is possible to sign Tiff files using advanced Qrcode options. 
        ...
        * furthermore file can be encrypted with password or saved to memory stream.
        ...
        Signing Tiff files with Qrcode provides vast amount opportunities for users. Moreover there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc.


############################# Steps ############################
steps:
    enable: true
    title_left: "Steps to sign Tiff with Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Tiff documents with Qrcode signatures quick and easily.
...
demos:
    ...
    content: |
       Sign Tiff file with Qrcode signature right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website. Free online demo waiting for you.
