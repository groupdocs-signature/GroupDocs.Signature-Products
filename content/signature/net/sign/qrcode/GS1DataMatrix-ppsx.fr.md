...
############################# Head ############################
head_title: "eSign Ppsx document avec G S1 Data Matrix QR Code en C#"
head_description: "Créez le code QR G S1 Data Matrix et placez-le dans le fichier Ppsx en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR G S1 Data Matrix pour le document Ppsx en C#"
