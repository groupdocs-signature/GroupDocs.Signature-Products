...
description: "eSínigh do dhoiciméid agus conarthaí Xlsb le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Xlsb doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
