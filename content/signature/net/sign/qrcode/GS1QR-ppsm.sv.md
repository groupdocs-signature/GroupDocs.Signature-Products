...
############################# Head ############################
head_title: "eSign Ppsm-dokument med G S1 Q R QR-kod i C#"
head_description: "Skapa G S1 Q R QR-kod och lägg den i filen Ppsm med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera G S1 Q R QR-kodsignatur för Ppsm dokument i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Ppsm med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Ppsm-dokument med Qrcode-signaturer snabbt och enkelt.
