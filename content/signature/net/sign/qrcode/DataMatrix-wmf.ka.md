...
description: "მოაწერეთ თქვენი Wmf დოკუმენტები და კონტრაქტები Data Matrix QR კოდით. შექმენით QR კოდის ხელმოწერა სწრაფად და მარტივად."
...
demos:
    enable: true
    title: "დოკუმენტების Wmf ხელმოწერა Qrcode Live Demo-ით"
    content: |
