...
############################# Head ############################
head_title: "eSign Pptm dokumen dengan Aztec QR Code dalam C#"
head_description: "Cipta Aztec Kod QR dan letakkan pada fail Pptm menggunakan .NET dengan sekeping pendek kod C#. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan Aztec tandatangan Kod QR untuk Pptm dokumen dalam C#"
description: "eTandatangani dokumen dan kontrak Pptm anda dengan Kod QR Aztec. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pptm dengan Qrcode dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Pptm dengan tandatangan Qrcode dengan cepat dan mudah.
