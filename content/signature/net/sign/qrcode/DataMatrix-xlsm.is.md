...
############################# Head ############################
head_title: "eSign Xlsm skjal með Data Matrix QR kóða í C#"
head_description: "Búðu til Data Matrix QR kóða og settu hann á Xlsm skrá með því að nota .NET með stuttu stykki af C# kóða. Notaðu GroupDocs Document Signature API til að rafrænt undirrita viðskiptaskjölin þín og skrár með QR kóða."

############################# Header ############################
title: "Búðu til Data Matrix QR kóða undirskrift fyrir Xlsm skjal í C#"
description: "eSignaðu Xlsm skjölin þín og samninga með Data Matrix QR kóða. Búðu til QR kóða undirskrift fljótt og auðveldlega."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Xlsm með Qrcode í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Xlsm skjöl með Qrcode undirskrift fljótt og auðveldlega.
        
        * Búðu til tilvik af Signature class sem gefur upp Xlsm skrá sem á að undirrita sem slóð eða minnisstraum
        * Upphafðu SignOptions flokkinn og stilltu öll umbeðin gögn.
        * Kallaðu á Signature.Sign() aðferðina sem sendir úttak Xlsm skrá eða minnisstraum
...
demos:
    enable: true
    title: "Undirritar Xlsm skjöl með Qrcode lifandi kynningu"
    content: |
       Skrifaðu undir Xlsm skrána með ýmsum undirskriftum núna með því að fara á [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) vefsíðuna. Ókeypis kynning á netinu bíður þín.
...
more_formats:
    ...
    content: |
        "Þú getur líka skrifað undir Xlsm með öðrum undirskriftartegundum. Vinsamlegast skoðaðu listann hér að neðan."
    format: 
