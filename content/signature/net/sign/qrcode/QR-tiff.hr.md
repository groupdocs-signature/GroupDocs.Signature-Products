...
############################# Head ############################
head_title: "eSign Tiff dokument s QR QR kodom u C#"
head_description: "Napravite QR QR kod i stavite ga u datoteku Tiff koristeći .NET s kratkim dijelom C# koda. Koristite GroupDocs Document Signature API za e-potpisivanje vaših poslovnih dokumenata i datoteka pomoću QR koda."

############################# Header ############################
title: "Generiraj QR potpis QR koda za Tiff dokument u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Tiff s Qrcode u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Tiff dokumenata s Qrcode potpisima.
