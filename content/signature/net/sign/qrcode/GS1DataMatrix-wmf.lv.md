...
############################# Head ############################
head_title: "eSign Wmf dokuments ar G S1 Data Matrix QR kodu programmā C#"
head_description: "Izveidojiet G S1 Data Matrix QR kodu un ievietojiet to failā Wmf, izmantojot .NET un īsu C# kodu. Izmantojiet GroupDocs Document Signature API, lai e-parakstītu savus biznesa dokumentus un failus ar QR kodu."

############################# Header ############################
title: "Ģenerēt G S1 Data Matrix QR koda parakstu dokumentam Wmf programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Wmf ar Qrcode programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Wmf dokumentus ar Qrcode parakstiem.
