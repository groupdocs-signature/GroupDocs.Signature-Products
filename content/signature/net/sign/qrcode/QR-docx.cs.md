...
############################# Head ############################
head_title: "Dokument eSign Docx s QR QR kódem v C#"
head_description: "Vytvořte QR kód QR a vložte jej do souboru Docx pomocí .NET s krátkým kódem C#. Použijte GroupDocs Document Signature API k elektronickému podepisování obchodních dokumentů a souborů pomocí QR kódu."

############################# Header ############################
title: "Vygenerujte podpis QR QR kódu pro dokument Docx v C#"
description: "ePodepište své dokumenty a smlouvy ve formátu Docx pomocí QR kódu QR. Vygenerujte podpis QR kódu rychle a snadno."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Docx pomocí Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Docx pomocí podpisů Qrcode.
...
demos:
    enable: true
    title: "Podepisování dokumentů Docx pomocí živé ukázky Qrcode"
    content: |
