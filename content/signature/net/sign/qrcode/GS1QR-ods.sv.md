...
############################# Head ############################
head_title: "eSign Ods-dokument med G S1 Q R QR-kod i C#"
head_description: "Skapa G S1 Q R QR-kod och lägg den i filen Ods med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera G S1 Q R QR-kodsignatur för Ods dokument i C#"
description: "esignera dina Ods-dokument och kontrakt med G S1 Q R QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Ods med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Ods-dokument med Qrcode-signaturer snabbt och enkelt.
