...
############################# Head ############################
head_title: "eSign Dcm dokument s G S1 Data Matrix QR kodo v C#"
head_description: "Ustvarite QR kodo G S1 Data Matrix in jo postavite v datoteko Dcm z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari G S1 Data Matrix podpis kode QR za dokument Dcm v C#"
description: "e-Podpišite svoje Dcm dokumente in pogodbe s G S1 Data Matrix QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Dcm z Qrcode Live Demo"
    content: |
       Takoj zdaj podpišite datoteko Dcm z različnimi podpisi, tako da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Brezplačna spletna predstavitev čaka na vas.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix je različica podatkovne matrice, ki je v skladu s specifikacijami GS1. Uporabite GS1 DataMatrix za kodiranje informacij, kot so, vendar ne omejeno na naslednje: AI(01) globalna številka trgovskega artikla (GTIN), AI(17) datum poteka, AI(10) številka serije, AI(21) serijska številka .
          characterset: |
             Nabor znakov: velike in male črke ter posebni znaki $@%*+-./:=<>;&*_,'! vse s pravilnimi identifikatorji aplikacije.
          textcapacity: |
             Zmogljivost kodnega besedila: do 3116 številk ali 2335 alfanumeričnih znakov.
          image: |
...
more_formats:
    enable: true
    title: "Drugi podprti podpisi Qrcode za C#"
    content: |
        "Dcm lahko podpišete tudi z drugimi vrstami podpisov. Oglejte si spodnji seznam."
    format: 
