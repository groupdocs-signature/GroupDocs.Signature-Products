...
############################# Head ############################
head_title: "Document electrònic Rtf amb codi QR Data Matrix a C#"
head_description: "Creeu Data Matrix codi QR i col·loqueu-lo al fitxer Rtf amb .NET amb un tros curt de codi C#. Utilitzeu l'API de signatura de documents de GroupDocs per signar electrònicament els vostres documents i fitxers empresarials amb el codi QR."

############################# Header ############################
title: "Genereu la signatura del codi QR de Data Matrix per al document Rtf a C#"
...
steps:
    enable: true
    title_left: "Passos per signar Rtf amb Qrcode a C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix la possibilitat de signar documents Rtf amb signatures Qrcode de manera ràpida i senzilla.
