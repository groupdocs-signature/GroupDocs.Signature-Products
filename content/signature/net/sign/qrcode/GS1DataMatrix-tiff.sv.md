...
############################# Head ############################
head_title: "eSign Tiff-dokument med G S1 Data Matrix QR-kod i C#"
head_description: "Skapa G S1 Data Matrix QR-kod och lägg den i filen Tiff med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera G S1 Data Matrix QR-kodsignatur för Tiff dokument i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Tiff med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Tiff-dokument med Qrcode-signaturer snabbt och enkelt.
