...
############################# Head ############################
head_title: "eSign Dcm dokument s G S1 Q R QR kódom v C#"
head_description: "Vytvorte G S1 Q R QR kód a vložte ho do súboru Dcm pomocou .NET s krátkym kódom C#. Použite rozhranie GroupDocs Document Signature API na elektronické podpisovanie obchodných dokumentov a súborov pomocou QR kódu."

############################# Header ############################
title: "Vygenerujte G S1 Q R podpis QR kódu pre dokument Dcm v C#"
description: "ePodpíšte svoje Dcm dokumenty a zmluvy pomocou G S1 Q R QR kódu. Vygenerujte podpis QR kódu rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Dcm pomocou Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Dcm pomocou podpisov Qrcode.
        
        * Vytvorte inštanciu triedy Signature poskytujúcej súbor Dcm, ktorý sa má podpisovať ako cesta alebo prúd pamäte
        * Instanciujte triedu SignOptions a nastavte všetky požadované údaje.
        * Vyvolajte metódu Signature.Sign() odovzdajúc výstupný súbor Dcm alebo prúd pamäte
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Dcm pomocou živej ukážky Qrcode"
    content: |
       Podpíšte súbor Dcm pomocou rôznych podpisov práve teraz na webovej lokalite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Bezplatné online demo na vás čaká.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 QR Code je variantom QR kódu, ktorý zodpovedá špecifikáciám GS1. Bol navrhnutý špeciálne na zdieľanie rozšírených informácií o balení, ako je číslo šarže, ID produktu a množstvo.
          characterset: |
             Veľké a malé písmená a špeciálne znaky $%*+-./: všetko so správnymi identifikátormi aplikácie
          textcapacity: |
             Až 7089 numerických znakov, 4296 alfanumerických znakov
          image: |
...
more_formats:
    ...
    content: |
        "Dcm môžete podpísať aj inými typmi podpisov. Pozrite si zoznam nižšie."
    format: 
