...
description: "eSínigh do dhoiciméid agus conarthaí Ppsx le {{ Codetype}} Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
demos:
    enable: true
    title: "Ag síniú Ppsx doiciméad le {{ Signaturetype}} Taispeántas Beo"
    content: |
