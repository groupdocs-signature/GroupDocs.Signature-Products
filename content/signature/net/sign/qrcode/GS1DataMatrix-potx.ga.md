...
############################# Head ############################
head_title: "eSign Potx doiciméad le G S1 Data Matrix Cód QR in C#"
head_description: "Cruthaigh G S1 Data Matrix Cód QR agus cuir ar chomhad Potx é ag úsáid .NET le píosa gairid de chód C#. Bain úsáid as an GroupDocs Document Signature API chun do dhoiciméid agus do chomhaid ghnó a ríomhshíniú le Cód QR."

############################# Header ############################
title: "Gin síniú an Chóid QR G S1 Data Matrix don doiciméad Potx in C#"
description: "eSínigh do dhoiciméid agus conarthaí Potx le G S1 Data Matrix Cód QR. Gin síniú an Chóid QR go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Céimeanna chun Potx a shíniú le Qrcode in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Potx a shíniú le sínithe Qrcode go tapa agus go héasca.
        ...
        * Iarr ar an modh Signature.Sign() aschuir Potx comhad nó sruth cuimhne a rith
...
demos:
    enable: true
    title: "Ag síniú Potx doiciméad le Qrcode Taispeántas Beo"
    content: |
