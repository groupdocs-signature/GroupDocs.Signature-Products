...
############################# Head ############################
head_title: "eSign Zip document with QR QR Code in C#"
head_description: "Create QR QR Code and put it on Zip file using .NET with a short piece of C# code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate QR QR Code signature for Zip document in C#"
description: "eSign your Zip documents and contracts with QR QR Code. Generate QR Code signature quickly and easily."
