...
############################# Head ############################
head_title: "eSign Xls -asiakirja Aztec QR-koodilla C#"
head_description: "Luo QR-koodi Aztec ja laita se Xls-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo Aztec QR-koodiallekirjoitus asiakirjalle Xls kohteessa C#"
description: "eAllekirjoita Xls-asiakirjat ja sopimukset QR-koodilla Aztec. Luo QR-koodin allekirjoitus nopeasti ja helposti."
...
steps:
    enable: true
    title_left: "Vaiheet Xls:n allekirjoittamiseen Qrcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Xls-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
