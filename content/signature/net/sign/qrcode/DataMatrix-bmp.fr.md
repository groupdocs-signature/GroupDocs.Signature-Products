...
############################# Head ############################
head_title: "eSign Bmp document avec Data Matrix QR Code en C#"
head_description: "Créez le code QR Data Matrix et placez-le dans le fichier Bmp en utilisant .NET avec un court morceau de code C#. Utilisez l'API GroupDocs Document Signature pour signer électroniquement vos documents et fichiers commerciaux avec QR Code."

############################# Header ############################
title: "Générer la signature de code QR Data Matrix pour le document Bmp en C#"
description: "Signez électroniquement vos documents et contrats Bmp avec Data Matrix QR Code. Générez une signature QR Code rapidement et facilement."
...
steps:
    enable: true
    title_left: "Étapes pour signer Bmp avec Qrcode dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Bmp avec des signatures Qrcode.
        
        * Créez une instance de la classe Signature fournissant le fichier Bmp censé signer en tant que chemin ou flux de mémoire
        * Instanciez la classe SignOptions et définissez toutes les données demandées.
        * Appelez la méthode Signature.Sign() en transmettant le fichier de sortie Bmp ou le flux de mémoire
...
demos:
    enable: true
    title: "Signature de documents Bmp avec Qrcode Live Demo"
    content: |
       Signez dès maintenant le fichier Bmp avec différentes signatures en visitant le site Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Une démo en ligne gratuite vous attend.
...
more_formats:
    ...
    content: |
        "Vous pouvez également signer Bmp avec d'autres types de signature. Veuillez consulter la liste ci-dessous."
    format: 
