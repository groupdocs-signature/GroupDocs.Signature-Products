...
############################# Head ############################
head_title: "eSign Pptx-dokument med G S1 Data Matrix QR-kode i C#"
head_description: "Opret G S1 Data Matrix QR-kode og læg den i Pptx-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer G S1 Data Matrix QR-kodesignatur for Pptx dokument i C#"
description: "eSignér dine Pptx-dokumenter og kontrakter med G S1 Data Matrix QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Trin til at signere Pptx med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Pptx dokumenter med Qrcode signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Pptx dokumenter med Qrcode Live Demo"
    content: |
