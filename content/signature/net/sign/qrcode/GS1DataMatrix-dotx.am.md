...
############################# Head ############################
head_title: "eSign Dotx ሰነድ በG S1 Data Matrix QR ኮድ በC#"
head_description: "G S1 Data Matrix QR ኮድ ይፍጠሩ እና በDotx ፋይል ላይ .NETን በመጠቀም በአጭር የC# ኮድ ያስቀምጡት። የንግድ ሰነዶችዎን እና ፋይሎችዎን በQR ኮድ ኢ-ለመፈረም የGroupDocs ሰነድ ፊርማ ኤፒአይ ይጠቀሙ።"

############################# Header ############################
title: "በC# ውስጥ ለDotx ሰነድ የG S1 Data Matrix QR ኮድ ፊርማ ይፍጠሩ"
...
steps:
    enable: true
    title_left: "Dotxን በ{{Signturetype}} በC# ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) የDotx ሰነዶችን በQrcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
