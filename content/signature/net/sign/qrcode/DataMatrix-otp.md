...
############################# Head ############################
head_title: "Adding Qrcode signatures in a Otp file with C#"
head_description: "Put Qrcode Signature on Otp file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Sign .Otp files with Qrcode signatures in C#"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Otp files with Qrcode signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to sign Otp with Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Otp documents with Qrcode signatures quick and easily.
