...
############################# Head ############################
head_title: "eSign Dotx-dokument med G S1 Data Matrix QR-kod i C#"
head_description: "Skapa G S1 Data Matrix QR-kod och lägg den i filen Dotx med .NET med en kort bit av C#-koden. Använd GroupDocs Document Signature API för att e-signera dina affärsdokument och filer med QR-kod."

############################# Header ############################
title: "Generera G S1 Data Matrix QR-kodsignatur för Dotx dokument i C#"
description: "esignera dina Dotx-dokument och kontrakt med G S1 Data Matrix QR-kod. Generera QR-kodsignatur snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Steg för att signera Dotx med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Dotx-dokument med Qrcode-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Dotx dokument med Qrcode Live Demo"
    content: |
