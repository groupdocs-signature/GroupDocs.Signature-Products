...
############################# Head ############################
head_title: "مستند eSign Pptx مع رمز الاستجابة السريعة Data Matrix في C#"
head_description: "أنشئ رمز الاستجابة السريعة Data Matrix وضعه في ملف Pptx باستخدام .NET مع جزء قصير من كود C#. استخدم واجهة برمجة تطبيقات GroupDocs Document Signature للتوقيع الإلكتروني على مستندات وملفات عملك باستخدام رمز الاستجابة السريعة."

############################# Header ############################
title: "إنشاء Data Matrix توقيع رمز الاستجابة السريعة لمستند Pptx في C#"
