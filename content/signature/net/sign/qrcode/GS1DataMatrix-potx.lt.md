...
############################# Head ############################
head_title: "eSign Potx dokumentas su G S1 Data Matrix QR kodu C#"
head_description: "Sukurkite QR kodą G S1 Data Matrix ir įdėkite jį į failą Potx naudodami .NET su trumpu C# kodo fragmentu. Naudokite GroupDocs Document Signature API norėdami el. pasirašyti savo verslo dokumentus ir failus naudodami QR kodą."

############################# Header ############################
title: "Sukurkite G S1 Data Matrix QR kodo parašą Potx dokumentui C#"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Potx naudojant Qrcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Potx dokumentus su Qrcode parašais.
