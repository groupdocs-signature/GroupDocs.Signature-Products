...
############################# Head ############################
head_title: "eSign Doc փաստաթուղթը Aztec QR կոդով C#-ում"
head_description: "Ստեղծեք Aztec QR կոդ և դրեք այն Doc ֆայլի վրա՝ օգտագործելով .NET՝ C# կոդի կարճ հատվածով: Օգտագործեք GroupDocs Document Signature API-ը՝ ձեր բիզնես փաստաթղթերն ու ֆայլերը QR կոդով էլեկտրոնային ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք Aztec QR կոդ ստորագրություն Doc փաստաթղթի համար C#-ում"
description: "e-ստորագրեք ձեր Doc փաստաթղթերն ու պայմանագրերը Aztec QR կոդով: Արագ և հեշտությամբ ստեղծեք QR Code ստորագրություն:"
...
steps:
    enable: true
    title_left: "Doc-ը Qrcode-ով C#-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Doc փաստաթղթերը Qrcode ստորագրություններով:
...
demos:
    enable: true
    title: "Doc փաստաթղթերի ստորագրում Qrcode Live Demo-ով"
    content: |
