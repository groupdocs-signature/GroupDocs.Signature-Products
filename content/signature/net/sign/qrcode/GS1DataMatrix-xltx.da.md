...
############################# Head ############################
head_title: "eSign Xltx-dokument med G S1 Data Matrix QR-kode i C#"
head_description: "Opret G S1 Data Matrix QR-kode og læg den i Xltx-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer G S1 Data Matrix QR-kodesignatur for Xltx dokument i C#"
description: "eSignér dine Xltx-dokumenter og kontrakter med G S1 Data Matrix QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
demos:
    enable: true
    title: "Signering af Xltx dokumenter med Qrcode Live Demo"
    content: |
       Signer Xltx-filen med forskellige signaturer lige nu ved at besøge webstedet [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Gratis online demo venter på dig.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            GS1 Data Matrix er en variant af Data Matrix, der er i overensstemmelse med GS1 specifikationer. Brug GS1 DataMatrix til at kode oplysningerne såsom, men ikke begrænset til, følgende: AI(01) Global Trade Item Number (GTIN), AI(17) Udløbsdato, AI(10) Batchnummer, AI(21) Serienummer .
          characterset: |
             Tegnsæt: store og små bogstaver og specialtegn $@%*+-./:=<>;&*_,'! alle med korrekte applikations-id'er.
          textcapacity: |
             Kodetekstkapacitet: op til 3116 numeriske cifre eller 2335 alfanumeriske tegn.
          image: |
...
more_formats:
    ...
    content: |
        "Du kan også signere Xltx med andre signaturtyper. Se venligst listen nedenfor."
    format: 
