...
############################# Head ############################
head_title: "eSign Xlsx documento com QR QR Code em C#"
head_description: "Crie QR QR Code e coloque-o no arquivo Xlsx usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere QR assinatura de QR Code para Xlsx documento em C#"
description: "Assine seus documentos e contratos Xlsx com QR QR Code. Gere assinatura de QR Code de forma rápida e fácil."
