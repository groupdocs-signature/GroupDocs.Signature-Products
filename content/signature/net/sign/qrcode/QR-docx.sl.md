...
############################# Head ############################
head_title: "eSign Docx dokument s QR QR kodo v C#"
head_description: "Ustvarite QR kodo QR in jo postavite v datoteko Docx z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari QR podpis kode QR za dokument Docx v C#"
description: "e-Podpišite svoje Docx dokumente in pogodbe s QR QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Docx z Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Docx s podpisi Qrcode.
        
        * Ustvarite primerek razreda podpisa, ki zagotavlja datoteko Docx, ki naj bi se podpisala kot pot ali pomnilniški tok
        * Instanciirajte razred SignOptions in nastavite vse zahtevane podatke.
        * Prikličite metodo Signature.Sign(), ki posreduje izhodno datoteko Docx ali pomnilniški tok
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Docx z Qrcode Live Demo"
    content: |
       Takoj zdaj podpišite datoteko Docx z različnimi podpisi, tako da obiščete spletno mesto [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Brezplačna spletna predstavitev čaka na vas.
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            Koda QR (skrajšano od Quick Response Code) je blagovna znamka za vrsto matrične črtne kode (ali dvodimenzionalne črtne kode). Je najbolj priljubljena in pogosto uporabljena vrsta dvodimenzionalne kode. V praksi kode QR pogosto vsebujejo podatke za lokator, identifikator ali sledilnik, ki kaže na spletno mesto ali aplikacijo.
          characterset: |
             Vseh 256 znakov ASCII + kanji
          textcapacity: |
             Do 7089 številskih znakov, 4296 alfanumeričnih znakov, 2953 bajtov (binarni podatki) ali 1817 znakov Kanji.
          image: |
...
more_formats:
    ...
    content: |
        "Docx lahko podpišete tudi z drugimi vrstami podpisov. Oglejte si spodnji seznam."
    format: 
