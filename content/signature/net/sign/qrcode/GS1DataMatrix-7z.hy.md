...
############################# Head ############################
head_title: "eSign 7z փաստաթուղթը G S1 Data Matrix QR կոդով C#-ում"
head_description: "Ստեղծեք G S1 Data Matrix QR կոդ և դրեք այն 7z ֆայլի վրա՝ օգտագործելով .NET՝ C# կոդի կարճ հատվածով: Օգտագործեք GroupDocs Document Signature API-ը՝ ձեր բիզնես փաստաթղթերն ու ֆայլերը QR կոդով էլեկտրոնային ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք G S1 Data Matrix QR կոդ ստորագրություն 7z փաստաթղթի համար C#-ում"
description: "e-ստորագրեք ձեր 7z փաստաթղթերն ու պայմանագրերը G S1 Data Matrix QR կոդով: Արագ և հեշտությամբ ստեղծեք QR Code ստորագրություն:"
...
steps:
    enable: true
    title_left: "7z-ը Qrcode-ով C#-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել 7z փաստաթղթերը Qrcode ստորագրություններով:
...
demos:
    enable: true
    title: "7z փաստաթղթերի ստորագրում Qrcode Live Demo-ով"
    content: |
