...
############################# Head ############################
head_title: "eSign Ott document with Data Matrix QR Code in C#"
head_description: "Create Data Matrix QR Code Signature on Ott file for .NET using a few lines of code. Use the GroupDocs Document Signature API to e-sign your business documents and files with QR Code."

############################# Header ############################
title: "Generate Data Matrix QR Code signature for Ott document in C#"
description: "eSign your Ott documents and contracts with Data Matrix QR Code. Generate QR Code signature quick, easy and simple with few lines of code to set up options.!"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Ott files with Qrcode signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to sign Ott with Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Ott documents with Qrcode signatures quick and easily.
