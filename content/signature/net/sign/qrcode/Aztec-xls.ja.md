...
############################# Head ############################
head_title: "C# で Aztec QR コードを使用して Xls 文書に eSign"
head_description: "Aztec QR コードを作成し、短い C# コードを含む .NET を使用して Xls ファイルに配置します。 GroupDocs Document Signature API を使用して、ビジネス ドキュメントやファイルに QR コードで電子署名します。"

############################# Header ############################
title: "C# の Xls ドキュメントの Aztec QR コード署名を生成します"
description: "Xls ドキュメントと契約書に Aztec QR コードで電子署名します。 QR コード署名をすばやく簡単に生成します。"
