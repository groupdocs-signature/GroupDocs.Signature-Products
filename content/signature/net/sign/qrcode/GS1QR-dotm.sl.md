...
############################# Head ############################
head_title: "eSign Dotm dokument s G S1 Q R QR kodo v C#"
head_description: "Ustvarite QR kodo G S1 Q R in jo postavite v datoteko Dotm z uporabo .NET s kratkim delom kode C#. Uporabite API za podpisovanje dokumentov GroupDocs za e-podpisovanje poslovnih dokumentov in datotek s kodo QR."

############################# Header ############################
title: "Ustvari G S1 Q R podpis kode QR za dokument Dotm v C#"
description: "e-Podpišite svoje Dotm dokumente in pogodbe s G S1 Q R QR kodo. Hitro in enostavno ustvarite podpis kode QR."
...
steps:
    enable: true
    title_left: "Koraki za podpis Dotm z Qrcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Dotm s podpisi Qrcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Dotm z Qrcode Live Demo"
    content: |
