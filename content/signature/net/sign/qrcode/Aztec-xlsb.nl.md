...
############################# Head ############################
head_title: "eSign Xlsb document met Aztec QR-code in C#"
head_description: "Maak een Aztec QR-code en plaats deze in het Xlsb-bestand met behulp van .NET met een kort stukje C#-code. Gebruik de GroupDocs Document Signature API om uw zakelijke documenten en bestanden elektronisch te ondertekenen met QR-code."

############################# Header ############################
title: "Genereer Aztec QR Code handtekening voor Xlsb document in C#"
...
steps:
    enable: true
    title_left: "Stappen om Xlsb te ondertekenen met Qrcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Xlsb documenten snel en gemakkelijk te ondertekenen met Qrcode handtekeningen.
