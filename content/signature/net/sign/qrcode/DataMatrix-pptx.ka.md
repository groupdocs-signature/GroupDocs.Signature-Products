...
############################# Head ############################
head_title: "eSign Pptx დოკუმენტი Data Matrix QR კოდით C#-ში"
head_description: "შექმენით Data Matrix QR კოდი და განათავსეთ ის Pptx ფაილზე .NET-ის გამოყენებით C# კოდის მოკლე ნაწილით. გამოიყენეთ GroupDocs Document Signature API თქვენი ბიზნეს დოკუმენტებისა და ფაილების ელექტრონული ხელმოწერისთვის QR კოდით."

############################# Header ############################
title: "შექმენით Data Matrix QR კოდის ხელმოწერა Pptx დოკუმენტისთვის C#-ში"
...
steps:
    enable: true
    title_left: "Pptx-ით ხელმოწერის ნაბიჯები Qrcode-ით C#-ში"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) იძლევა შესაძლებლობას მოაწეროთ Pptx დოკუმენტები Qrcode ხელმოწერებით სწრაფად და მარტივად.
