...
############################# Head ############################
head_title: "eSign Xlsb dokumen dengan Data Matrix QR Code dalam C#"
head_description: "Cipta Data Matrix Kod QR dan letakkan pada fail Xlsb menggunakan .NET dengan sekeping pendek kod C#. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani dokumen dan fail perniagaan anda dengan Kod QR."

############################# Header ############################
title: "Hasilkan Data Matrix tandatangan Kod QR untuk Xlsb dokumen dalam C#"
description: "eTandatangani dokumen dan kontrak Xlsb anda dengan Kod QR Data Matrix. Hasilkan tandatangan Kod QR dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xlsb dengan Qrcode dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Xlsb dengan tandatangan Qrcode dengan cepat dan mudah.
