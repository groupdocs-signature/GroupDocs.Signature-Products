...
############################# Head ############################
head_title: "eSign Xlsb dokument G S1 Q R QR-koodiga rakenduses C#"
head_description: "Looge QR-kood G S1 Q R ja sisestage see faili Xlsb, kasutades .NET koos lühikese C# koodijupiga. Kasutage GroupDocs Document Signature API-t oma äridokumentide ja failide e-allkirjastamiseks QR-koodiga."

############################# Header ############################
title: "Looge C# dokumendile Xlsb QR-koodi allkiri G S1 Q R"
description: "eAllkirjasta oma Xlsb dokumendid ja lepingud QR-koodiga G S1 Q R. Looge QR-koodi allkiri kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Toimingud Xlsb allkirjastamiseks rakendusega Qrcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Xlsb dokumente Qrcode allkirjaga.
