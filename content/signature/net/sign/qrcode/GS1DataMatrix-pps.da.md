...
############################# Head ############################
head_title: "eSign Pps-dokument med G S1 Data Matrix QR-kode i C#"
head_description: "Opret G S1 Data Matrix QR-kode og læg den i Pps-filen ved hjælp af .NET med et kort stykke C#-kode. Brug GroupDocs Document Signature API til at e-signere dine forretningsdokumenter og filer med QR-kode."

############################# Header ############################
title: "Generer G S1 Data Matrix QR-kodesignatur for Pps dokument i C#"
description: "eSignér dine Pps-dokumenter og kontrakter med G S1 Data Matrix QR-kode. Generer QR-kodesignatur hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Trin til at signere Pps med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Pps dokumenter med Qrcode signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Pps dokumenter med Qrcode Live Demo"
    content: |
