...
############################# Head ############################
head_title: "eSign Odp-dokument med G S1 Q R QR-kode i C#"
head_description: "Lag G S1 Q R QR-kode og legg den til Odp-filen ved å bruke .NET med en kort bit av C#-koden. Bruk GroupDocs Document Signature API til å e-signere forretningsdokumentene og filene dine med QR-kode."

############################# Header ############################
title: "Generer G S1 Q R QR-kodesignatur for Odp-dokument i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Odp med Qrcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Odp-dokumenter med Qrcode-signaturer raskt og enkelt.
