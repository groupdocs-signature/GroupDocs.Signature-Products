...
############################# Head ############################
head_title: "eSign Webp documento com Aztec QR Code em C#"
head_description: "Crie Aztec QR Code e coloque-o no arquivo Webp usando .NET com um pequeno pedaço de código C#. Use a API de assinatura de documentos do GroupDocs para assinar seus documentos e arquivos comerciais com QR Code."

############################# Header ############################
title: "Gere Aztec assinatura de QR Code para Webp documento em C#"
description: "Assine seus documentos e contratos Webp com Aztec QR Code. Gere assinatura de QR Code de forma rápida e fácil."
