...
############################# Head ############################
head_title: "eSign Ott -asiakirja G S1 Data Matrix QR-koodilla C#"
head_description: "Luo QR-koodi G S1 Data Matrix ja laita se Ott-tiedostoon käyttämällä .NET lyhyttä C#-koodia. Käytä GroupDocs Document Signature APIa yrityksesi asiakirjat ja tiedostot sähköiseen allekirjoitukseen QR-koodilla."

############################# Header ############################
title: "Luo G S1 Data Matrix QR-koodiallekirjoitus asiakirjalle Ott kohteessa C#"
...
steps:
    enable: true
    title_left: "Vaiheet Ott:n allekirjoittamiseen Qrcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Ott-asiakirjoja Qrcode-allekirjoituksella nopeasti ja helposti.
