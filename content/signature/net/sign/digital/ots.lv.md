...
############################# Head ############################
head_title: "Digitālo elektronisko parakstu pievienošana failam Ots, izmantojot C#"
head_description: "Ievietojiet digitālo parakstu Ots failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "eSign Ots faili ar Digital parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Ots ar Digital programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Ots dokumentus ar Digital parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Ots parakstīšana, izmantojot Digital tiešraides demonstrāciju"
    content: |
