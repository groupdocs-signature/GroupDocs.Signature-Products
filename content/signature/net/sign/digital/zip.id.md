...
############################# Head ############################
head_title: "Menambahkan tanda tangan elektronik digital ke file Zip dengan C#"
head_description: "Letakkan Tanda Tangan Digital pada file Zip untuk .NET menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "eSign Zip file dengan Digital tanda tangan di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Zip dengan Digital di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Zip dengan Digital tanda tangan dengan cepat dan mudah.
