...
############################# Head ############################
head_title: "Adición de firmas electrónicas digitales al archivo Xltx con C#"
head_description: "Coloque la firma digital en el archivo Xltx para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "eSign Xltx archivos con Digital firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Xltx con Digital en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Xltx con Digital firmas de forma rápida y sencilla.
