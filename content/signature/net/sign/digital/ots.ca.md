...
############################# Head ############################
head_title: "Afegir signatures electròniques digitals al fitxer Ots amb C#"
head_description: "Col·loqueu la signatura digital al fitxer Ots per a .NET utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "eSign fitxers Ots amb signatures Digital a C#"
...
steps:
    enable: true
    title_left: "Passos per signar Ots amb Digital a C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix la possibilitat de signar documents Ots amb signatures Digital de manera ràpida i senzilla.
