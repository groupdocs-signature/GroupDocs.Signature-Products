...
############################# Head ############################
head_title: "Dodavanje digitalnih elektroničkih potpisa u datoteku Odt s C#"
head_description: "Stavite digitalni potpis na datoteku Odt za .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "eSign Odt datoteke s Digital potpisima u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Odt s Digital u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Odt dokumenata s Digital potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Odt dokumenata s Digital Live Demo"
    content: |
