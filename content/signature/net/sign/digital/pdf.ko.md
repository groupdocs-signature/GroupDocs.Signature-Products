...
############################# Head ############################
head_title: "C#을(를) 사용하여 Pdf 파일에 디지털 전자 서명 추가"
head_description: "몇 줄의 코드를 사용하여 .NET에 대한 Pdf 파일에 디지털 서명을 넣습니다. GroupDocs 문서 서명 API를 사용하여 수십 가지 파일 형식에 서명합니다."

############################# Header ############################
title: "C#에서 Digital 서명이 있는 Pdf 파일에 eSign"
...
steps:
    enable: true
    title_left: "C#에서 Digital으로 Pdf에 서명하는 단계"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/)은 Digital 서명으로 Pdf 문서에 빠르고 쉽게 서명할 수 있는 기능을 제공합니다.
