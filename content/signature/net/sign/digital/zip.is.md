...
############################# Head ############################
head_title: "Bætir stafrænum rafrænum undirskriftum við Zip skrá með C#"
head_description: "Settu stafræna undirskrift á Zip skrá fyrir .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "eSign Zip skrár með Digital undirskriftum í C#"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Zip með Digital í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Zip skjöl með Digital undirskrift fljótt og auðveldlega.
