...
############################# Head ############################
head_title: "Adición de firmas electrónicas digitales al archivo 7z con C#"
head_description: "Coloque la firma digital en el archivo 7z para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "eSign 7z archivos con Digital firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar 7z con Digital en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos 7z con Digital firmas de forma rápida y sencilla.
