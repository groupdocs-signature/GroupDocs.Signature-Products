...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a 7z fájlhoz a C# segítségével"
head_description: "Helyezze el a digitális aláírást a .NET 7z fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign 7z fájlok Digital aláírással a C# nyelven"
...
steps:
    enable: true
    title_left: "A 7z aláírásának lépései a Digital segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a 7z dokumentumok gyors és egyszerű aláírását Digital aláírással.
