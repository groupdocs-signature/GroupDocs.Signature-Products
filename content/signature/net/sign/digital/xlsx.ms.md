...
############################# Head ############################
head_title: "Menambahkan tandatangan elektronik Digital pada fail Xlsx dengan C#"
head_description: "Letakkan Tandatangan Digital pada fail Xlsx untuk .NET menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "eSign Xlsx fail dengan Digital tandatangan dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xlsx dengan Digital dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Xlsx dengan tandatangan Digital dengan cepat dan mudah.
