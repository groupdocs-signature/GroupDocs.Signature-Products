...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a Pptx fájlhoz a C# segítségével"
head_description: "Helyezze el a digitális aláírást a .NET Pptx fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign Pptx fájlok Digital aláírással a C# nyelven"
...
steps:
    enable: true
    title_left: "A Pptx aláírásának lépései a Digital segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Pptx dokumentumok gyors és egyszerű aláírását Digital aláírással.
...
demos:
    enable: true
    title: "Pptx dokumentumok aláírása Digital élő bemutatóval"
    content: |
