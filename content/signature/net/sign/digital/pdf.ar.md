...
############################# Head ############################
head_title: "إضافة التوقيعات الإلكترونية الرقمية إلى ملف Pdf باستخدام C#"
head_description: "ضع التوقيع الرقمي على ملف Pdf لـ .NET باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "ملفات eSign Pdf ذات توقيعات Digital في C#"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Pdf باستخدام Digital في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Pdf بتوقيعات Digital بسرعة وسهولة.
