...
############################# Head ############################
head_title: "Adición de firmas electrónicas digitales al archivo Pdf con C#"
head_description: "Coloque la firma digital en el archivo Pdf para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "eSign Pdf archivos con Digital firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Pdf con Digital en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Pdf con Digital firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Pdf documentos con Digital Live Demo"
    content: |
