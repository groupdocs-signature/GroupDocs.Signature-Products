...
############################# Head ############################
head_title: "Pridanie digitálnych elektronických podpisov do súboru Xls pomocou C#"
head_description: "Vložte digitálny podpis do súboru Xls pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "eSign Xls súbory s Digital podpismi v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xls pomocou Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xls pomocou podpisov Digital.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Xls pomocou živej ukážky Digital"
    content: |
