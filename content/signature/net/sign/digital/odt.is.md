...
############################# Head ############################
head_title: "Bætir stafrænum rafrænum undirskriftum við Odt skrá með C#"
head_description: "Settu stafræna undirskrift á Odt skrá fyrir .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "eSign Odt skrár með Digital undirskriftum í C#"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Odt með Digital í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Odt skjöl með Digital undirskrift fljótt og auðveldlega.
