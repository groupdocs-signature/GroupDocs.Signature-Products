...
############################# Head ############################
head_title: "Digitale elektronische handtekeningen toevoegen aan Tar bestand met C#"
head_description: "Zet de digitale handtekening op het Tar-bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "eSign Tar bestanden met Digital handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Tar te ondertekenen met Digital in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Tar documenten snel en gemakkelijk te ondertekenen met Digital handtekeningen.
