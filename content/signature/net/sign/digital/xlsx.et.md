...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Xlsx rakendusega C#"
head_description: "Sisestage digitaalallkiri toote .NET failile Xlsx, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Xlsx failid Digital allkirjaga rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Xlsx allkirjastamiseks rakendusega Digital rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Xlsx dokumente Digital allkirjaga.
