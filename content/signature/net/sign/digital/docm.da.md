...
############################# Head ############################
head_title: "Tilføjelse af digitale elektroniske signaturer til filen Docm med C#"
head_description: "Sæt digital signatur på filen Docm for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "eSign Docm filer med Digital signaturer i C#"
...
steps:
    enable: true
    title_left: "Trin til at signere Docm med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Docm dokumenter med Digital signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Docm dokumenter med Digital Live Demo"
    content: |
