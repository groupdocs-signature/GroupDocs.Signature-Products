...
steps:
    enable: true
    title_left: "Stappe om Pdf met Digital in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Pdf dokumente met Digital handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Pdf dokumente met Digital Regstreekse Demo"
    content: |
