...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad Zip le C#"
head_description: "Cuir Síniú Digiteach ar chomhad Zip le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh Zip comhaid le Digital sínithe in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Zip a shíniú le Digital in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Zip a shíniú le sínithe Digital go tapa agus go héasca.
