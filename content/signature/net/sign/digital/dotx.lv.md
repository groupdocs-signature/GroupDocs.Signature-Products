...
############################# Head ############################
head_title: "Digitālo elektronisko parakstu pievienošana failam Dotx, izmantojot C#"
head_description: "Ievietojiet digitālo parakstu Dotx failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "eSign Dotx faili ar Digital parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Dotx ar Digital programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Dotx dokumentus ar Digital parakstiem.
