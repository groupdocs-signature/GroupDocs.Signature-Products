...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad 7z le C#"
head_description: "Cuir Síniú Digiteach ar chomhad 7z le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh 7z comhaid le Digital sínithe in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun 7z a shíniú le Digital in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid 7z a shíniú le sínithe Digital go tapa agus go héasca.
