...
############################# Head ############################
head_title: "Menambahkan tanda tangan elektronik digital ke file Odt dengan C#"
head_description: "Letakkan Tanda Tangan Digital pada file Odt untuk .NET menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "eSign Odt file dengan Digital tanda tangan di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Odt dengan Digital di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Odt dengan Digital tanda tangan dengan cepat dan mudah.
