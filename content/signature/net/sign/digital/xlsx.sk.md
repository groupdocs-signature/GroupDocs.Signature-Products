...
############################# Head ############################
head_title: "Pridanie digitálnych elektronických podpisov do súboru Xlsx pomocou C#"
head_description: "Vložte digitálny podpis do súboru Xlsx pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "eSign Xlsx súbory s Digital podpismi v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xlsx pomocou Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xlsx pomocou podpisov Digital.
