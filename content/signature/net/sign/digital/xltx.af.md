...
############################# Head ############################
head_title: "Voeg digitale elektroniese handtekeninge by Xltx-lêer met C#"
head_description: "Plaas digitale handtekening op Xltx-lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "eSign Xltx lêers met Digital handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Xltx met Digital in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Xltx dokumente met Digital handtekeninge vinnig en maklik te onderteken.
