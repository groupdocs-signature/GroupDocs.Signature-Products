...
############################# Head ############################
head_title: "Dodavanje digitalnih elektroničkih potpisa u datoteku Xltm s C#"
head_description: "Stavite digitalni potpis na datoteku Xltm za .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "eSign Xltm datoteke s Digital potpisima u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xltm s Digital u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Xltm dokumenata s Digital potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Xltm dokumenata s Digital Live Demo"
    content: |
