...
############################# Head ############################
head_title: "使用 C# 将 Digital 签名添加到 Ods 文件"
head_description: "使用几行代码将 Digital 签名放在 .NET 的 Ods 文件上。使用 GroupDocs 文档签名 API 对数十种文件格式进行签名。"

############################# Header ############################
title: "在 C# 中使用 Digital 签名对 Ods 文件进行签名"
