...
############################# Head ############################
head_title: "Lägger till digitala elektroniska signaturer i filen Zip med C#"
head_description: "Lägg digital signatur på filen Zip för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."
...
steps:
    enable: true
    title_left: "Steg för att signera Zip med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Zip-dokument med Digital-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Zip dokument med Digital Live Demo"
    content: |
