...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a Xls fájlhoz a C# segítségével"
head_description: "Helyezze el a digitális aláírást a .NET Xls fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign Xls fájlok Digital aláírással a C# nyelven"
...
steps:
    enable: true
    title_left: "A Xls aláírásának lépései a Digital segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Xls dokumentumok gyors és egyszerű aláírását Digital aláírással.
...
demos:
    enable: true
    title: "Xls dokumentumok aláírása Digital élő bemutatóval"
    content: |
