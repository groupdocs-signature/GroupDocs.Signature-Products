...
############################# Head ############################
head_title: "Digitale elektronische handtekeningen toevoegen aan Xltm bestand met C#"
head_description: "Zet de digitale handtekening op het Xltm-bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "eSign Xltm bestanden met Digital handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Xltm te ondertekenen met Digital in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Xltm documenten snel en gemakkelijk te ondertekenen met Digital handtekeningen.
...
demos:
    enable: true
    title: "Xltm documenten ondertekenen met Digital Live Demo"
    content: |
