...
head_description: "Letakkan Tanda Tangan Digital pada file Pptx untuk .NET menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "eSign Pptx file dengan Digital tanda tangan di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pptx dengan Digital di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Pptx dengan Digital tanda tangan dengan cepat dan mudah.
