...
############################# Head ############################
head_title: "Hinzufügen von Digital-Signaturen zur Pdf-Datei mit C#"
head_description: "Fügen Sie die Digital-Signatur in die Pdf-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Pdf-Dateien mit Digital-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Pdf mit Digital in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Pdf-Dokumente mit Digital-Signaturen schnell und einfach zu signieren.
