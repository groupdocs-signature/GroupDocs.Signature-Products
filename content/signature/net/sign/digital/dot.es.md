...
############################# Head ############################
head_title: "Adición de firmas electrónicas digitales al archivo Dot con C#"
head_description: "Coloque la firma digital en el archivo Dot para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "eSign Dot archivos con Digital firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Dot con Digital en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Dot con Digital firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Dot documentos con Digital Live Demo"
    content: |
