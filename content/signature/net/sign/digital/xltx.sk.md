...
############################# Head ############################
head_title: "Pridanie digitálnych elektronických podpisov do súboru Xltx pomocou C#"
head_description: "Vložte digitálny podpis do súboru Xltx pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "eSign Xltx súbory s Digital podpismi v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xltx pomocou Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xltx pomocou podpisov Digital.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Xltx pomocou živej ukážky Digital"
    content: |
