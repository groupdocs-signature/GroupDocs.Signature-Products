...
############################# Head ############################
head_title: "Ajout de signatures Digital au fichier Docx avec C#"
head_description: "Mettez Digital Signature sur le fichier Docx pour .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "Signez des fichiers Docx avec des signatures Digital en C#"
...
steps:
    enable: true
    title_left: "Étapes pour signer Docx avec Digital dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Docx avec des signatures Digital.
