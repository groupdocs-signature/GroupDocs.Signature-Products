...
head_description: "Mettez la signature numérique sur le fichier Docx pour .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "eSign Docx fichiers avec Digital signatures en C#"
