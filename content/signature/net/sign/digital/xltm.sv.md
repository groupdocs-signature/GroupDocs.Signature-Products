...
############################# Head ############################
head_title: "Lägger till digitala elektroniska signaturer i filen Xltm med C#"
head_description: "Lägg digital signatur på filen Xltm för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."
...
steps:
    enable: true
    title_left: "Steg för att signera Xltm med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Xltm-dokument med Digital-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Xltm dokument med Digital Live Demo"
    content: |
