...
############################# Head ############################
head_title: "Adicionando assinaturas eletrônicas digitais ao arquivo Xlsm com C#"
head_description: "Coloque a assinatura digital no arquivo Xlsm para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "eSign Xlsm arquivos com assinaturas Digital em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Xlsm com Digital em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Xlsm com assinaturas Digital de forma rápida e fácil.
