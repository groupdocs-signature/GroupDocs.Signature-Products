...
############################# Head ############################
head_title: "Digitale elektronische handtekeningen toevoegen aan 7z bestand met C#"
head_description: "Zet de digitale handtekening op het 7z-bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "eSign 7z bestanden met Digital handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om 7z te ondertekenen met Digital in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om 7z documenten snel en gemakkelijk te ondertekenen met Digital handtekeningen.
