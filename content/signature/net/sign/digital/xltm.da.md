...
############################# Head ############################
head_title: "Tilføjelse af digitale elektroniske signaturer til filen Xltm med C#"
head_description: "Sæt digital signatur på filen Xltm for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."
...
steps:
    enable: true
    title_left: "Trin til at signere Xltm med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Xltm dokumenter med Digital signaturer hurtigt og nemt.
