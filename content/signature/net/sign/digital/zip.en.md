...
############################# Head ############################
head_title: "Adding Digital electronic signatures to Zip file with C#"
head_description: "Put Digital Signature on Zip file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "eSign Zip files with Digital signatures in C#"
...
steps:
    enable: true
    title_left: "Steps to sign Zip with Digital in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Zip documents with Digital signatures quickly and easily.
