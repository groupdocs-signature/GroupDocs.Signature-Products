...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a Ods fájlhoz a C# segítségével"
head_description: "Helyezze el a digitális aláírást a .NET Ods fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign Ods fájlok Digital aláírással a C# nyelven"
...
steps:
    enable: true
    title_left: "A Ods aláírásának lépései a Digital segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Ods dokumentumok gyors és egyszerű aláírását Digital aláírással.
...
demos:
    enable: true
    title: "Ods dokumentumok aláírása Digital élő bemutatóval"
    content: |
