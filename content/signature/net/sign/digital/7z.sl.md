...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki 7z z C#"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko 7z za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign 7z s podpisi Digital v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis 7z z Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov 7z s podpisi Digital.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov 7z z Digital Live Demo"
    content: |
