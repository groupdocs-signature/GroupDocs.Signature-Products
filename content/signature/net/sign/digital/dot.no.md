...
############################# Head ############################
head_title: "Legger til digitale elektroniske signaturer i filen Dot med C#"
head_description: "Sett digital signatur på Dot-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."
...
steps:
    enable: true
    title_left: "Trinn for å signere Dot med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Dot-dokumenter med Digital-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Dot dokumenter med Digital Live Demo"
    content: |
