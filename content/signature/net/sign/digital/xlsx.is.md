...
############################# Head ############################
head_title: "Bætir stafrænum rafrænum undirskriftum við Xlsx skrá með C#"
head_description: "Settu stafræna undirskrift á Xlsx skrá fyrir .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita heilmikið af skráarsniðum."

############################# Header ############################
title: "eSign Xlsx skrár með Digital undirskriftum í C#"
...
steps:
    enable: true
    title_left: "Skref til að undirrita Xlsx með Digital í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Xlsx skjöl með Digital undirskrift fljótt og auðveldlega.
