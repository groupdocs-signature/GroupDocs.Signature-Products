...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a Xltm fájlhoz a C# segítségével"
head_description: "Helyezze el a digitális aláírást a .NET Xltm fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign Xltm fájlok Digital aláírással a C# nyelven"
...
steps:
    enable: true
    title_left: "A Xltm aláírásának lépései a Digital segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Xltm dokumentumok gyors és egyszerű aláírását Digital aláírással.
