...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Xltm rakendusega C#"
head_description: "Sisestage digitaalallkiri toote .NET failile Xltm, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Xltm failid Digital allkirjaga rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Xltm allkirjastamiseks rakendusega Digital rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Xltm dokumente Digital allkirjaga.
