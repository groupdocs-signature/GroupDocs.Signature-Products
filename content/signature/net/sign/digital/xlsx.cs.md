...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru Xlsx pomocí C#"
head_description: "Vložte digitální podpis do souboru Xlsx pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign Xlsx s podpisy Digital v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsx pomocí Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Xlsx pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů Xlsx pomocí živé ukázky Digital"
    content: |
