...
head_description: "Coloque a assinatura digital no arquivo Xlsx para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "eSign Xlsx arquivos com assinaturas Digital em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Xlsx com Digital em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Xlsx com assinaturas Digital de forma rápida e fácil.
