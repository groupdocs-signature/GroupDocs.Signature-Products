...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Pdf rakendusega C#"
head_description: "Sisestage digitaalallkiri toote .NET failile Pdf, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Pdf failid Digital allkirjaga rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Pdf allkirjastamiseks rakendusega Digital rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Pdf dokumente Digital allkirjaga.
