...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Docx z C#"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Docx za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Docx s podpisi Digital v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Docx z Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Docx s podpisi Digital.
