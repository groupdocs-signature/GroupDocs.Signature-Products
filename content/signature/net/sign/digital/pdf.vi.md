...
############################# Head ############################
head_title: "Thêm chữ ký điện tử kỹ thuật số vào tệp Pdf với C#"
head_description: "Đặt Chữ ký số vào tệp Pdf cho .NET bằng cách sử dụng một vài dòng mã. Sử dụng API chữ ký tài liệu GroupDocs để ký hàng chục định dạng tệp."

############################# Header ############################
title: "eSign các tệp Pdf có chữ ký Digital trong C#"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Pdf bằng Digital trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Pdf bằng chữ ký Digital một cách nhanh chóng và dễ dàng.
