...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile 7z rakendusega C#"
head_description: "Sisestage digitaalallkiri toote .NET failile 7z, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign 7z failid Digital allkirjaga rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud 7z allkirjastamiseks rakendusega Digital rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada 7z dokumente Digital allkirjaga.
