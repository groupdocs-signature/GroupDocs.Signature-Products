...
############################# Head ############################
head_title: "Ajout de signatures électroniques numériques au fichier Tar avec C#"
head_description: "Mettez la signature numérique sur le fichier Tar pour .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer des dizaines de formats de fichiers."

############################# Header ############################
title: "eSign Tar fichiers avec Digital signatures en C#"
...
steps:
    enable: true
    title_left: "Étapes pour signer Tar avec Digital dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Tar avec des signatures Digital.
...
demos:
    enable: true
    title: "Signature de documents Tar avec Digital Live Demo"
    content: |
