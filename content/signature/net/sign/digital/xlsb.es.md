...
############################# Head ############################
head_title: "Adición de firmas electrónicas digitales al archivo Xlsb con C#"
head_description: "Coloque la firma digital en el archivo Xlsb para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "eSign Xlsb archivos con Digital firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Xlsb con Digital en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Xlsb con Digital firmas de forma rápida y sencilla.
