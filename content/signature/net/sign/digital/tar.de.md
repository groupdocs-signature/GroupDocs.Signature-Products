...
############################# Head ############################
head_title: "Hinzufügen digitaler elektronischer Signaturen zur Tar-Datei mit C#"
head_description: "Fügen Sie der Tar-Datei für .NET mit ein paar Codezeilen eine digitale Signatur hinzu. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "eSigniere Tar-Dateien mit Digital-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Tar mit Digital in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Tar-Dokumente mit Digital-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Tar-Dokumenten mit Digital Live-Demo"
    content: |
