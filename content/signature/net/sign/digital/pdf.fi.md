...
############################# Head ############################
head_title: "Digitaalisten sähköisten allekirjoitusten lisääminen tiedostoon Pdf ohjelmalla C#"
head_description: "Aseta digitaalinen allekirjoitus Pdf-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "eSign Pdf tiedostot Digital allekirjoituksella C#"
...
steps:
    enable: true
    title_left: "Vaiheet Pdf:n allekirjoittamiseen Digital -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Pdf-asiakirjoja Digital-allekirjoituksella nopeasti ja helposti.
