...
############################# Head ############################
head_title: "Afegir signatures electròniques digitals al fitxer Docx amb C#"
head_description: "Col·loqueu la signatura digital al fitxer Docx per a .NET utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "eSign fitxers Docx amb signatures Digital a C#"
...
steps:
    enable: true
    title_left: "Passos per signar Docx amb Digital a C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix la possibilitat de signar documents Docx amb signatures Digital de manera ràpida i senzilla.
...
demos:
    enable: true
    title: "Signant documents de Docx amb Digital Demostració en directe"
    content: |
