...
############################# Head ############################
head_title: "Dodavanje digitalnih elektroničkih potpisa u datoteku Xlsx s C#"
head_description: "Stavite digitalni potpis na datoteku Xlsx za .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "eSign Xlsx datoteke s Digital potpisima u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xlsx s Digital u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Xlsx dokumenata s Digital potpisima.
