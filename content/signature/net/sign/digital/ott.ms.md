...
############################# Head ############################
head_title: "Menambahkan tandatangan elektronik Digital pada fail Ott dengan C#"
head_description: "Letakkan Tandatangan Digital pada fail Ott untuk .NET menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "eSign Ott fail dengan Digital tandatangan dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Ott dengan Digital dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Ott dengan tandatangan Digital dengan cepat dan mudah.
