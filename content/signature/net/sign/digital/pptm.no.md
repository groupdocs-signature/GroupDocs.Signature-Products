...
############################# Head ############################
head_title: "Legger til digitale elektroniske signaturer i filen Pptm med C#"
head_description: "Sett digital signatur på Pptm-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "eSign Pptm-filer med Digital-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Pptm med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Pptm-dokumenter med Digital-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Pptm dokumenter med Digital Live Demo"
    content: |
