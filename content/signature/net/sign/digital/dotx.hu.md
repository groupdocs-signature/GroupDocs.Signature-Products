...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a Dotx fájlhoz a C# segítségével"
head_description: "Helyezze el a digitális aláírást a .NET Dotx fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign Dotx fájlok Digital aláírással a C# nyelven"
...
steps:
    enable: true
    title_left: "A Dotx aláírásának lépései a Digital segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Dotx dokumentumok gyors és egyszerű aláírását Digital aláírással.
