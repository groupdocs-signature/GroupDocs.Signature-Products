...
############################# Head ############################
head_title: "Digitaalisten sähköisten allekirjoitusten lisääminen tiedostoon Dot ohjelmalla C#"
head_description: "Aseta digitaalinen allekirjoitus Dot-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "eSign Dot tiedostot Digital allekirjoituksella C#"
...
steps:
    enable: true
    title_left: "Vaiheet Dot:n allekirjoittamiseen Digital -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Dot-asiakirjoja Digital-allekirjoituksella nopeasti ja helposti.
