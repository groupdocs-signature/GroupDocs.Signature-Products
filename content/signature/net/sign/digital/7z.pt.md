...
############################# Head ############################
head_title: "Adicionando assinaturas eletrônicas digitais ao arquivo 7z com C#"
head_description: "Coloque a assinatura digital no arquivo 7z para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "eSign 7z arquivos com assinaturas Digital em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar 7z com Digital em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos 7z com assinaturas Digital de forma rápida e fácil.
