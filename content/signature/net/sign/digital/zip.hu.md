...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a Zip fájlhoz a C# segítségével"
head_description: "Helyezze el a digitális aláírást a .NET Zip fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign Zip fájlok Digital aláírással a C# nyelven"
...
steps:
    enable: true
    title_left: "A Zip aláírásának lépései a Digital segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Zip dokumentumok gyors és egyszerű aláírását Digital aláírással.
...
demos:
    enable: true
    title: "Zip dokumentumok aláírása Digital élő bemutatóval"
    content: |
