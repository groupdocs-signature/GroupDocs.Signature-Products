...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Ots z C#"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Ots za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Ots s podpisi Digital v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Ots z Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Ots s podpisi Digital.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Ots z Digital Live Demo"
    content: |
