...
############################# Head ############################
head_title: "Legger til digitale elektroniske signaturer i filen Ott med C#"
head_description: "Sett digital signatur på Ott-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."
...
steps:
    enable: true
    title_left: "Trinn for å signere Ott med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Ott-dokumenter med Digital-signaturer raskt og enkelt.
