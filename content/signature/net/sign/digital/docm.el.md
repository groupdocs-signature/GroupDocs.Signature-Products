...
############################# Head ############################
head_title: "Προσθήκη ψηφιακών ηλεκτρονικών υπογραφών στο αρχείο Docm με C#"
head_description: "Τοποθετήστε την ψηφιακή υπογραφή στο αρχείο Docm για το .NET χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε δεκάδες μορφές αρχείων."

############################# Header ############################
title: "Αρχεία eSign Docm με υπογραφές Digital στο C#"
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Docm με Digital στο C#"
    content_left: |
        Το [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) παρέχει τη δυνατότητα υπογραφής εγγράφων Docm με υπογραφές Digital γρήγορα και εύκολα.
