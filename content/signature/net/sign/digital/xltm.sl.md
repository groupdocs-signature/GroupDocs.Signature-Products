...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Xltm z C#"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Xltm za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Xltm s podpisi Digital v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Xltm z Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Xltm s podpisi Digital.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Xltm z Digital Live Demo"
    content: |
