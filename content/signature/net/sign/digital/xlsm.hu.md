...
############################# Head ############################
head_title: "Digitális elektronikus aláírás hozzáadása a Xlsm fájlhoz a C# segítségével"
head_description: "Helyezze el a digitális aláírást a .NET Xlsm fájljába néhány sor kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "eSign Xlsm fájlok Digital aláírással a C# nyelven"
...
steps:
    enable: true
    title_left: "A Xlsm aláírásának lépései a Digital segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Xlsm dokumentumok gyors és egyszerű aláírását Digital aláírással.
