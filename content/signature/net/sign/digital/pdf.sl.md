...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Pdf z C#"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Pdf za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Pdf s podpisi Digital v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Pdf z Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Pdf s podpisi Digital.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Pdf z Digital Live Demo"
    content: |
