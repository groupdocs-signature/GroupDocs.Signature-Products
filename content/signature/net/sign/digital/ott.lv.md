...
############################# Head ############################
head_title: "Digitālo elektronisko parakstu pievienošana failam Ott, izmantojot C#"
head_description: "Ievietojiet digitālo parakstu Ott failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "eSign Ott faili ar Digital parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Ott ar Digital programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Ott dokumentus ar Digital parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Ott parakstīšana, izmantojot Digital tiešraides demonstrāciju"
    content: |
