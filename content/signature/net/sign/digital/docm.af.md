...
steps:
    enable: true
    title_left: "Stappe om Docm met Digital in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Docm dokumente met Digital handtekeninge vinnig en maklik te onderteken.
