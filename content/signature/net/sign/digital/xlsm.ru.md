...
############################# Head ############################
head_title: "Добавление цифровых электронных подписей в файл Xlsm с C#"
head_description: "Поместите цифровую подпись в файл Xlsm для .NET, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "eSign Xlsm файлов с подписями Digital в C#"
...
steps:
    enable: true
    title_left: "Действия по подписанию Xlsm с помощью Digital в C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) позволяет быстро и легко подписывать документы Xlsm с подписями Digital.
