...
############################# Head ############################
head_title: "Dodawanie podpisów elektronicznych do pliku Pptm za pomocą C#"
head_description: "Umieść podpis cyfrowy w pliku Pptm dla .NET, używając kilku linijek kodu. Użyj interfejsu GroupDocs Document Signature API, aby podpisać dziesiątki formatów plików."

############################# Header ############################
title: "eSign Pptm pliki z podpisami Digital w C#"
...
steps:
    enable: true
    title_left: "Kroki do podpisania Pptm za pomocą Digital w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Pptm za pomocą podpisów Digital.
