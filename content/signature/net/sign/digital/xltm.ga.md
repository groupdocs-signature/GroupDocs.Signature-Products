...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad Xltm le C#"
head_description: "Cuir Síniú Digiteach ar chomhad Xltm le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "eSínigh Xltm comhaid le Digital sínithe in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Xltm a shíniú le Digital in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Xltm a shíniú le sínithe Digital go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Xltm doiciméad le Digital Taispeántas Beo"
    content: |
