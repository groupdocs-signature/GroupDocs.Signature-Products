...
############################# Head ############################
head_title: "Menambahkan tanda tangan elektronik digital ke file Pptm dengan C#"
head_description: "Letakkan Tanda Tangan Digital pada file Pptm untuk .NET menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "eSign Pptm file dengan Digital tanda tangan di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pptm dengan Digital di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Pptm dengan Digital tanda tangan dengan cepat dan mudah.
