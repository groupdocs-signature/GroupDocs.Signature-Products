...
############################# Head ############################
head_title: "Lägger till digitala elektroniska signaturer i filen Pptm med C#"
head_description: "Lägg digital signatur på filen Pptm för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."
...
steps:
    enable: true
    title_left: "Steg för att signera Pptm med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Pptm-dokument med Digital-signaturer snabbt och enkelt.
