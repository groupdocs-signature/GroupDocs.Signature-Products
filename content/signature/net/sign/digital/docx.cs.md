...
############################# Head ############################
head_title: "Přidání digitálních elektronických podpisů do souboru Docx pomocí C#"
head_description: "Vložte digitální podpis do souboru Docx pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Soubory eSign Docx s podpisy Digital v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Docx pomocí Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Docx pomocí podpisů Digital.
...
demos:
    enable: true
    title: "Podepisování dokumentů Docx pomocí živé ukázky Digital"
    content: |
