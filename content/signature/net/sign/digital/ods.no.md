...
############################# Head ############################
head_title: "Legger til digitale elektroniske signaturer i filen Ods med C#"
head_description: "Sett digital signatur på Ods-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "eSign Ods-filer med Digital-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Ods med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Ods-dokumenter med Digital-signaturer raskt og enkelt.
