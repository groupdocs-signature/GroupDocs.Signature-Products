...
############################# Head ############################
head_title: "Pridanie digitálnych elektronických podpisov do súboru Pptm pomocou C#"
head_description: "Vložte digitálny podpis do súboru Pptm pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "eSign Pptm súbory s Digital podpismi v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Pptm pomocou Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Pptm pomocou podpisov Digital.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Pptm pomocou živej ukážky Digital"
    content: |
