...
############################# Head ############################
head_title: "Hinzufügen von Digital-Signaturen zur Docm-Datei mit C#"
head_description: "Fügen Sie die Digital-Signatur in die Docm-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Docm-Dateien mit Digital-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Docm mit Digital in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Docm-Dokumente mit Digital-Signaturen schnell und einfach zu signieren.
