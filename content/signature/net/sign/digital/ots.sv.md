...
############################# Head ############################
head_title: "Lägger till digitala elektroniska signaturer i filen Ots med C#"
head_description: "Lägg digital signatur på filen Ots för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "eSign Ots-filer med Digital-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Ots med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Ots-dokument med Digital-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Ots dokument med Digital Live Demo"
    content: |
