...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Xls rakendusega C#"
head_description: "Sisestage digitaalallkiri toote .NET failile Xls, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Xls failid Digital allkirjaga rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Xls allkirjastamiseks rakendusega Digital rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Xls dokumente Digital allkirjaga.
