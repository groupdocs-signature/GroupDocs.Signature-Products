...
############################# Head ############################
head_title: "Skaitmeninių elektroninių parašų pridėjimas prie failo Xltm naudojant C#"
head_description: "Įdėkite skaitmeninį parašą į Xltm failą, skirtą .NET, naudodami kelias kodo eilutes. Norėdami pasirašyti daugybę failų formatų, naudokite GroupDocs Document Signature API."

############################# Header ############################
title: "eSign Xltm failai su Digital parašais C#"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Xltm naudojant Digital programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Xltm dokumentus su Digital parašais.
...
demos:
    enable: true
    title: "Dokumentų Xltm pasirašymas naudojant Digital tiesioginę demonstraciją"
    content: |
