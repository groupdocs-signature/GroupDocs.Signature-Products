...
############################# Head ############################
head_title: "إضافة التوقيعات الإلكترونية الرقمية إلى ملف Xlsm باستخدام C#"
head_description: "ضع التوقيع الرقمي على ملف Xlsm لـ .NET باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "ملفات eSign Xlsm ذات توقيعات Digital في C#"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Xlsm باستخدام Digital في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Xlsm بتوقيعات Digital بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Xlsm باستخدام العرض التوضيحي المباشر Digital"
    content: |
