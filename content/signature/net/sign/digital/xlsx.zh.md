...
############################# Head ############################
head_title: "使用 C# 将 Digital 签名添加到 Xlsx 文件"
head_description: "使用几行代码将 Digital 签名放在 .NET 的 Xlsx 文件上。使用 GroupDocs 文档签名 API 对数十种文件格式进行签名。"

############################# Header ############################
title: "在 C# 中使用 Digital 签名对 Xlsx 文件进行签名"
...
steps:
    enable: true
    title_left: "在 C# 中使用 Digital 签署 Xlsx 的步骤"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) 提供使用 Digital 签名快速轻松地签署 Xlsx 文档的能力。
