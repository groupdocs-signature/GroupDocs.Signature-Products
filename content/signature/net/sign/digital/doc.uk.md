...
############################# Head ############################
head_title: "Додавання цифрових електронних підписів до файлу Doc за допомогою C#"
head_description: "Помістіть цифровий підпис у файл Doc для .NET за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs, щоб підписувати десятки форматів файлів."

############################# Header ############################
title: "Файли eSign Doc із підписами Digital у C#"
...
steps:
    enable: true
    title_left: "Кроки для підпису Doc за допомогою Digital у C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає можливість швидко та легко підписувати документи Doc за допомогою підписів Digital.
