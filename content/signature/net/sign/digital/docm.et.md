...
############################# Head ############################
head_title: "Digitaalsete elektrooniliste allkirjade lisamine failile Docm rakendusega C#"
head_description: "Sisestage digitaalallkiri toote .NET failile Docm, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "eSign Docm failid Digital allkirjaga rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Docm allkirjastamiseks rakendusega Digital rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Docm dokumente Digital allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Docm allkirjastamine Digital reaalajas demoga"
    content: |
