...
############################# Head ############################
head_title: "Sínithe leictreonacha digiteacha á gcur le comhad Pptx le C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Pptx a shíniú le Digital in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Pptx a shíniú le sínithe Digital go tapa agus go héasca.
