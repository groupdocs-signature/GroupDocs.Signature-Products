...
############################# Head ############################
head_title: "Dodajanje digitalnih elektronskih podpisov datoteki Pptm z C#"
head_description: "Z nekaj vrsticami kode postavite digitalni podpis na datoteko Pptm za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Datoteke eSign Pptm s podpisi Digital v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Pptm z Digital v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Pptm s podpisi Digital.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Pptm z Digital Live Demo"
    content: |
