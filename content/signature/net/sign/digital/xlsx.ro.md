...
############################# Head ############################
head_title: "Adăugarea semnăturilor electronice digitale la fișierul Xlsx cu C#"
head_description: "Puneți semnătura digitală pe fișierul Xlsx pentru .NET folosind câteva rânduri de cod. Utilizați API-ul GroupDocs Document Signature pentru a semna zeci de formate de fișiere."

############################# Header ############################
title: "eSign fișiere Xlsx cu semnături Digital în C#"
...
steps:
    enable: true
    title_left: "Pași pentru a semna Xlsx cu Digital în C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) oferă posibilitatea de a semna documente Xlsx cu semnături Digital rapid și ușor.
