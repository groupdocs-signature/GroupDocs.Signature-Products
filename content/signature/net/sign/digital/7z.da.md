...
############################# Head ############################
head_title: "Tilføjelse af digitale elektroniske signaturer til filen 7z med C#"
head_description: "Sæt digital signatur på filen 7z for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."
...
steps:
    enable: true
    title_left: "Trin til at signere 7z med Digital i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere 7z dokumenter med Digital signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af 7z dokumenter med Digital Live Demo"
    content: |
