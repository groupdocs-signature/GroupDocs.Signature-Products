...
############################# Head ############################
head_title: "Digitaalisten sähköisten allekirjoitusten lisääminen tiedostoon 7z ohjelmalla C#"
head_description: "Aseta digitaalinen allekirjoitus 7z-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "eSign 7z tiedostot Digital allekirjoituksella C#"
...
steps:
    enable: true
    title_left: "Vaiheet 7z:n allekirjoittamiseen Digital -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa 7z-asiakirjoja Digital-allekirjoituksella nopeasti ja helposti.
