...
############################# Head ############################
head_title: "Digitālo elektronisko parakstu pievienošana failam Docx, izmantojot C#"
head_description: "Ievietojiet digitālo parakstu Docx failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "eSign Docx faili ar Digital parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Docx ar Digital programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Docx dokumentus ar Digital parakstiem.
