...
############################# Head ############################
head_title: "Adicionando assinaturas eletrônicas digitais ao arquivo Pdf com C#"
head_description: "Coloque a assinatura digital no arquivo Pdf para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "eSign Pdf arquivos com assinaturas Digital em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Pdf com Digital em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Pdf com assinaturas Digital de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Pdf documentos com Digital Demonstração ao vivo"
    content: |
