...
############################# Head ############################
head_title: "eSign 7z-dokument met Interleaved2of5 Strepiekode in C#"
head_description: "Skep Interleaved2of5 Strepiekode Handtekening en plaas dit op 7z dokument met .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer Interleaved2of5 strepieskode-handtekening vir 7z-dokument in C#"
description: "eTeken jou 7z besigheidsdokumente met Interleaved2of5 Streepkode. Genereer strepieskode-handtekening vinnig en maklik met 'n paar reëls kode om ondertekenopsies op te stel."
...
steps:
    enable: true
    title_left: "Stappe om 7z met Barcode in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om 7z dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
