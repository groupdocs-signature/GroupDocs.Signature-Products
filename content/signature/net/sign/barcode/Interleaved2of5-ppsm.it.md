...
############################# Head ############################
head_title: "eSign Ppsm documento con codice a barre Interleaved2of5 in C#"
head_description: "Crea Interleaved2of5 Firma codice a barre e inseriscilo nel documento Ppsm con .NET utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Interleaved2of5 firma del codice a barre per il documento Ppsm in C#"
description: "Firma elettronicamente i tuoi documenti aziendali Ppsm con il codice a barre Interleaved2of5. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Ppsm con Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Ppsm con firme Barcode in modo rapido e semplice.
