...
############################# Head ############################
head_title: "وثيقة eSign Svg مع E A N14 رمز شريطي في C#"
head_description: "أنشئ E A N14 Barcode Signature وضعه في مستند Svg باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء E A N14 توقيع الرمز الشريطي للمستند Svg في C#"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Svg باستخدام Barcode في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Svg بتوقيعات Barcode بسرعة وسهولة.
