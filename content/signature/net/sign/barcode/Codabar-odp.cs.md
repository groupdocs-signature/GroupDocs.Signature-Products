...
############################# Head ############################
head_title: "Dokument eSign Odp s čárovým kódem Codabar v C#"
head_description: "Vytvořte podpis čárového kódu Codabar a vložte jej do dokumentu Odp s .NET pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu Codabar pro dokument Odp v C#"
description: "ePodepište své obchodní dokumenty ve formátu Odp pomocí čárového kódu Codabar. Vygenerujte podpis čárového kódu rychle a snadno pomocí několika řádků kódu pro nastavení možností podepisování."
...
steps:
    enable: true
    title_left: "Kroky k podepsání Odp pomocí Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Odp pomocí podpisů Barcode.
