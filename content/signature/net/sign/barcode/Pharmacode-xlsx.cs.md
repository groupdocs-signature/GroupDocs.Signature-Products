...
############################# Head ############################
head_title: "Dokument eSign Xlsx s čárovým kódem Pharmacode v C#"
head_description: "Vytvořte podpis čárového kódu Pharmacode a vložte jej do dokumentu Xlsx s .NET pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu Pharmacode pro dokument Xlsx v C#"
