...
############################# Head ############################
head_title: "Document electrònic Xlsm amb codi de barres UPCE a C#"
head_description: "Creeu la signatura de codi de barres UPCE i poseu-la al document Xlsm amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu UPCE signatura de codi de barres per al document Xlsm a C#"
description: "eSigne els vostres documents comercials de Xlsm amb el codi de barres UPCE. Genereu la signatura de codi de barres de manera ràpida i senzilla amb unes poques línies de codi per configurar les opcions de signatura."
...
steps:
    enable: true
    title_left: "Passos per signar Xlsm amb Barcode a C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix la possibilitat de signar documents Xlsm amb signatures Barcode de manera ràpida i senzilla.
...
demos:
    enable: true
    title: "Signant documents de Xlsm amb Barcode Demostració en directe"
    content: |
