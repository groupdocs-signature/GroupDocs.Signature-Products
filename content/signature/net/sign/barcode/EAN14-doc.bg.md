...
############################# Head ############################
head_title: "eSign Doc документ с E A N14 баркод в C#"
head_description: "Създайте E A N14 баркод подпис и го поставете в Doc документ с .NET, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature за подписване на различни файлови формати."

############################# Header ############################
title: "Генерирайте E A N14 баркод подпис за документ Doc в C#"
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Doc с Barcode в C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя възможност за бързо и лесно подписване на Doc документи с Barcode подписи.
