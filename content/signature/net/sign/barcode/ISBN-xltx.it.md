...
############################# Head ############################
head_title: "eSign Xltx documento con codice a barre ISBN in C#"
head_description: "Crea ISBN Firma codice a barre e inseriscilo nel documento Xltx con .NET utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera ISBN firma del codice a barre per il documento Xltx in C#"
