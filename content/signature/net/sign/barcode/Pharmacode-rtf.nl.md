...
############################# Head ############################
head_title: "eSign Rtf document met Pharmacode Barcode in C#"
head_description: "Maak een Pharmacode Barcode Signature en plaats deze op het Rtf document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."

############################# Header ############################
title: "Genereer Pharmacode Barcode handtekening voor Rtf document in C#"
description: "Onderteken uw Rtf zakelijke documenten met Pharmacode Barcode. Genereer snel en eenvoudig een barcodehandtekening met een paar regels code om ondertekeningsopties in te stellen."
...
steps:
    enable: true
    title_left: "Stappen om Rtf te ondertekenen met Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Rtf documenten snel en gemakkelijk te ondertekenen met Barcode handtekeningen.
