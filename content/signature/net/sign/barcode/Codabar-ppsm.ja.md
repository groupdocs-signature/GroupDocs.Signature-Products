...
############################# Head ############################
head_title: "C# で Codabar バーコードを使用して Ppsm 文書に eSign"
head_description: "Codabar バーコード署名を作成し、数行のコードを使用して .NET で Ppsm ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "C# の Ppsm ドキュメントの Codabar バーコード署名を生成します"
