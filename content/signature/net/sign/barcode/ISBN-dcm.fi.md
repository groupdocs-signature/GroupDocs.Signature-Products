...
############################# Head ############################
head_title: "eSign Dcm -asiakirja ISBN-viivakoodilla C#"
head_description: "Luo ISBN Viivakoodiallekirjoitus ja laita se Dcm-asiakirjaan, jossa on .NET muutamalla rivillä koodia. Käytä GroupDocs Document Signature API:ta eri tiedostomuotojen allekirjoittamiseen."

############################# Header ############################
title: "Luo ISBN viivakoodiallekirjoitus asiakirjalle Dcm ohjelmassa C#"
...
steps:
    enable: true
    title_left: "Vaiheet Dcm:n allekirjoittamiseen Barcode -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Dcm-asiakirjoja Barcode-allekirjoituksella nopeasti ja helposti.
