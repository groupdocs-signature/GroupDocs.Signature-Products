...
############################# Head ############################
head_title: "Firmar electrónicamente Pptx documento con UPCE código de barras en C#"
head_description: "Cree la firma de código de barras UPCE y colóquela en el documento Pptx con .NET usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras UPCE para el documento Pptx en C#"
