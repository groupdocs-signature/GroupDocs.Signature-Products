...
############################# Head ############################
head_title: "Document electrònic Dotm amb codi de barres UPCE a C#"
head_description: "Creeu la signatura de codi de barres UPCE i poseu-la al document Dotm amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu UPCE signatura de codi de barres per al document Dotm a C#"
description: "eSigne els vostres documents comercials de Dotm amb el codi de barres UPCE. Genereu la signatura de codi de barres de manera ràpida i senzilla amb unes poques línies de codi per configurar les opcions de signatura."
...
steps:
    enable: true
    title_left: "Passos per signar Dotm amb Barcode a C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix la possibilitat de signar documents Dotm amb signatures Barcode de manera ràpida i senzilla.
