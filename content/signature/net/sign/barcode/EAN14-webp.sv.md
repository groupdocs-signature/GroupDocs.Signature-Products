...
############################# Head ############################
head_title: "eSign Webp dokument med E A N14 streckkod i C#"
head_description: "Skapa E A N14 streckkodsignatur och lägg den på Webp dokument med .NET med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera E A N14 streckkodsignatur för Webp dokument i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Webp med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Webp-dokument med Barcode-signaturer snabbt och enkelt.
