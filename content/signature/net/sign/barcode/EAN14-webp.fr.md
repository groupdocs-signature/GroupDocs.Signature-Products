...
############################# Head ############################
head_title: "eSign Webp document avec E A N14 Barcode in C#"
head_description: "Créez E A N14 Barcode Signature et placez-le sur le document Webp avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres E A N14 pour le document Webp dans C#"
...
steps:
    enable: true
    title_left: "Étapes pour signer Webp avec Barcode dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Webp avec des signatures Barcode.
