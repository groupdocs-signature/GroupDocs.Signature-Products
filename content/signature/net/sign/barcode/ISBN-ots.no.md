...
############################# Head ############################
head_title: "eSign Ots-dokument med ISBN strekkode i C#"
head_description: "Opprett ISBN strekkodesignatur og legg den på Ots-dokumentet med .NET ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer ISBN strekkodesignatur for Ots dokument i C#"
description: "eSignér Ots-bedriftsdokumentene dine med ISBN strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
steps:
    enable: true
    title_left: "Trinn for å signere Ots med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Ots-dokumenter med Barcode-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Ots dokumenter med Barcode Live Demo"
    content: |
