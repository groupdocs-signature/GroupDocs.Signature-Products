...
############################# Head ############################
head_title: "Podpisz dokument Dot z kodem kreskowym Interleaved2of5 w C#"
head_description: "Utwórz podpis z kodem kreskowym Interleaved2of5 i umieść go w dokumencie Dot za pomocą .NET, używając kilku linijek kodu. Użyj interfejsu GroupDocs Document Signature API do podpisywania różnych formatów plików."

############################# Header ############################
title: "Wygeneruj Interleaved2of5 podpis z kodem kreskowym dla dokumentu Dot w C#"
description: "ePodpisz swoje dokumenty biznesowe w Dot za pomocą kodu kreskowego Interleaved2of5. Szybko i łatwo generuj podpis z kodem kreskowym za pomocą kilku linijek kodu, aby skonfigurować opcje podpisywania."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Dot za pomocą Barcode w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Dot za pomocą podpisów Barcode.
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Dot za pomocą Barcode Demo na żywo"
    content: |
