...
############################# Head ############################
head_title: "eSign Ods document with Code39 Barcode in C#"
head_description: "Create Code39 Barcode Signature on Ods file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Generate Code39 Barcode signature for Ods document in C#"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Ods documents with Barcode signatures quickly and easily.
