...
############################# Head ############################
head_title: "eSign Docx document avec Pharmacode Barcode in C#"
head_description: "Créez Pharmacode Barcode Signature et placez-le sur le document Docx avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres Pharmacode pour le document Docx dans C#"
