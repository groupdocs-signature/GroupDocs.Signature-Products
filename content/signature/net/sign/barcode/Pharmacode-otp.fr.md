...
############################# Head ############################
head_title: "eSign Otp document avec Pharmacode Barcode in C#"
head_description: "Créez Pharmacode Barcode Signature et placez-le sur le document Otp avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres Pharmacode pour le document Otp dans C#"
