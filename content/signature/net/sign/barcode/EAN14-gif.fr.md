...
############################# Head ############################
head_title: "eSign Gif document avec E A N14 Barcode in C#"
head_description: "Créez E A N14 Barcode Signature et placez-le sur le document Gif avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres E A N14 pour le document Gif dans C#"
description: "Signez électroniquement vos documents commerciaux Gif avec E A N14 Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
...
steps:
    enable: true
    title_left: "Étapes pour signer Gif avec Barcode dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Gif avec des signatures Barcode.
