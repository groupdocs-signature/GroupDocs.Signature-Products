...
############################# Head ############################
head_title: "وثيقة eSign Xlsb مع ISBN رمز شريطي في C#"
head_description: "أنشئ ISBN Barcode Signature وضعه في مستند Xlsb باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء ISBN توقيع الرمز الشريطي للمستند Xlsb في C#"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Xlsb باستخدام Barcode في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Xlsb بتوقيعات Barcode بسرعة وسهولة.
