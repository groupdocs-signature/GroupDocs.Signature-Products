...
############################# Head ############################
head_title: "eSign Gif belgeya bi Pharmacode Barcode di C#"
head_description: "Îmzeya barkodê ya Pharmacode biafirîne û bi çend rêzikên kodê bi .NET li ser belgeya Gif biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."
