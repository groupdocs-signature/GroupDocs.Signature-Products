...
############################# Head ############################
head_title: "eSign 7z document avec ISBN Barcode in C#"
head_description: "Créez ISBN Barcode Signature et placez-le sur le document 7z avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres ISBN pour le document 7z dans C#"
...
steps:
    enable: true
    title_left: "Étapes pour signer 7z avec Barcode dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents 7z avec des signatures Barcode.
