...
head_description: "Create Pharmacode Barcode Signature and put it on Tiff document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."
