...
############################# Head ############################
head_title: "C# で Interleaved2of5 バーコードを使用して Jpg 文書に eSign"
head_description: "Interleaved2of5 バーコード署名を作成し、数行のコードを使用して .NET で Jpg ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "C# の Jpg ドキュメントの Interleaved2of5 バーコード署名を生成します"
description: "Jpg ビジネス文書に Interleaved2of5 バーコードで電子署名します。署名オプションを設定するための数行のコードで、バーコード署名をすばやく簡単に生成します。"
...
steps:
    enable: true
    title_left: "C# で Barcode を使用して Jpg に署名する手順"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) は、Jpg ドキュメントに Barcode 署名ですばやく簡単に署名する機能を提供します。
...
demos:
    enable: true
    title: "Barcode ライブ デモで Jpg ドキュメントに署名"
    content: |
