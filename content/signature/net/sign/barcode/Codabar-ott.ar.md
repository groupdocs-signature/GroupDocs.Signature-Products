...
############################# Head ############################
head_title: "وثيقة eSign Ott مع Codabar رمز شريطي في C#"
head_description: "أنشئ Codabar Barcode Signature وضعه في مستند Ott باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Codabar توقيع الرمز الشريطي للمستند Ott في C#"
description: "قم بتوقيع Ott على مستندات الأعمال باستخدام الرمز الشريطي Codabar. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
...
steps:
    enable: true
    title_left: "خطوات تسجيل Ott باستخدام Barcode في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Ott بتوقيعات Barcode بسرعة وسهولة.
