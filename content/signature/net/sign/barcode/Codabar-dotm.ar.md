...
############################# Head ############################
head_title: "وثيقة eSign Dotm مع Codabar رمز شريطي في C#"
head_description: "أنشئ Codabar Barcode Signature وضعه في مستند Dotm باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Codabar توقيع الرمز الشريطي للمستند Dotm في C#"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Dotm باستخدام Barcode في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Dotm بتوقيعات Barcode بسرعة وسهولة.
