...
############################# Head ############################
head_title: "وثيقة eSign Docm مع Pharmacode رمز شريطي في C#"
head_description: "أنشئ Pharmacode Barcode Signature وضعه في مستند Docm باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Pharmacode توقيع الرمز الشريطي للمستند Docm في C#"
