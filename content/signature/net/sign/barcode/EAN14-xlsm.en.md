...
head_description: "Create E A N14 Barcode Signature on Xlsm file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."
