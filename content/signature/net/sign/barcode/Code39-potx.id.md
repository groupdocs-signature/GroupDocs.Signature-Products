...
############################# Head ############################
head_title: "eSign Potx dokumen dengan Code39 Barcode di C#"
head_description: "Buat Code39 Tanda Tangan Barcode dan letakkan di dokumen Potx dengan .NET menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat Code39 Tanda tangan kode batang untuk dokumen Potx di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Potx dengan Barcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Potx dengan Barcode tanda tangan dengan cepat dan mudah.
