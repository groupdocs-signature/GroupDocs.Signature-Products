...
############################# Head ############################
head_title: "eSign Dcm belgeya bi E A N14 Barcode di C#"
head_description: "Îmzeya barkodê ya E A N14 biafirîne û bi çend rêzikên kodê bi .NET li ser belgeya Dcm biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Dcm bi Barcode di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Dcm bi îmzeyên Barcode zû û bi hêsanî peyda dike.
