...
############################# Head ############################
head_title: "eSign Docm документ с ISBN баркод в C#"
head_description: "Създайте ISBN баркод подпис и го поставете в Docm документ с .NET, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature за подписване на различни файлови формати."

############################# Header ############################
title: "Генерирайте ISBN баркод подпис за документ Docm в C#"
description: "Електронно подпишете вашите Docm бизнес документи с ISBN баркод. Генерирайте баркод подпис бързо и лесно с няколко реда код, за да зададете опции за подписване."
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Docm с Barcode в C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя възможност за бързо и лесно подписване на Docm документи с Barcode подписи.
