...
############################# Head ############################
head_title: "eSign Xltx เอกสารด้วยบาร์โค้ด Codabar ใน C#"
head_description: "สร้าง Codabar Barcode Signature และใส่ลงในเอกสาร Xltx ด้วย .NET โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API สำหรับการลงนามรูปแบบไฟล์ต่างๆ"

############################# Header ############################
title: "สร้าง Codabar ลายเซ็นบาร์โค้ดสำหรับเอกสาร Xltx ใน C#"
