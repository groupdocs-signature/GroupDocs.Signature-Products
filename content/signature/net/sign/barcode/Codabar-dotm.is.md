...
############################# Head ############################
head_title: "eSign Dotm skjal með Codabar Strikamerki í C#"
head_description: "Búðu til Codabar Strikamerki undirskrift og settu hana á Dotm skjal með .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita ýmis skráarsnið."

############################# Header ############################
title: "Búðu til Codabar Strikamerki undirskrift fyrir Dotm skjal í C#"
description: "eSignaðu Dotm viðskiptaskjölin þín með Codabar Strikamerki. Búðu til Strikamerki undirskrift fljótt og auðveldlega með nokkrum línum af kóða til að setja upp undirskriftarmöguleika."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Dotm með Barcode í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Dotm skjöl með Barcode undirskrift fljótt og auðveldlega.
