...
############################# Head ############################
head_title: "eSign Tar dokument med ISBN stregkode i C#"
head_description: "Opret ISBN stregkodesignatur og læg den på Tar dokument med .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer ISBN Stregkodesignatur for Tar dokument i C#"
description: "eSignér dine Tar forretningsdokumenter med ISBN stregkode. Generer stregkodesignatur hurtigt og nemt med et par linjer kode for at opsætte signeringsmuligheder."
...
steps:
    enable: true
    title_left: "Trin til at signere Tar med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Tar dokumenter med Barcode signaturer hurtigt og nemt.
