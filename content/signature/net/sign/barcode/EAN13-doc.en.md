...
head_description: "Create E A N13 Barcode Signature and put it on Doc document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."
