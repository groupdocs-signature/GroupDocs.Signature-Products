...
############################# Head ############################
head_title: "eSign Xltm документ со штрих-кодом Pdf417 в C#"
head_description: "Создайте подпись штрих-кода Pdf417 и поместите ее в документ Xltm с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода Pdf417 для документа Xltm в C#"
description: "Подпишите свои бизнес-документы Xltm с помощью штрих-кода Pdf417. Быстро и легко создавайте подпись штрих-кода с помощью нескольких строк кода для настройки параметров подписи."
