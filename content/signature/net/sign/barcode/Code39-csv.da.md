...
############################# Head ############################
head_title: "eSign Csv dokument med Code39 stregkode i C#"
head_description: "Opret Code39 stregkodesignatur og læg den på Csv dokument med .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere forskellige filformater."

############################# Header ############################
title: "Generer Code39 Stregkodesignatur for Csv dokument i C#"
...
steps:
    enable: true
    title_left: "Trin til at signere Csv med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Csv dokumenter med Barcode signaturer hurtigt og nemt.
