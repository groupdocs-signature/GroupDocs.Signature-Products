...
############################# Head ############################
head_title: "eSign Xltm dokumen dengan Interleaved2of5 Barcode di C#"
head_description: "Buat Interleaved2of5 Tanda Tangan Barcode dan letakkan di dokumen Xltm dengan .NET menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat Interleaved2of5 Tanda tangan kode batang untuk dokumen Xltm di C#"
description: "eSign dokumen bisnis Xltm Anda dengan Interleaved2of5 Barcode. Hasilkan tanda tangan Barcode dengan cepat dan mudah dengan beberapa baris kode untuk menyiapkan opsi penandatanganan."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xltm dengan Barcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Xltm dengan Barcode tanda tangan dengan cepat dan mudah.
...
demos:
    enable: true
    title: "Menandatangani dokumen Xltm dengan Barcode Demo Langsung"
    content: |
