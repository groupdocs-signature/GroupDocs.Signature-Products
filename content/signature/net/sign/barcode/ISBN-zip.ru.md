...
############################# Head ############################
head_title: "eSign Zip документ со штрих-кодом ISBN в C#"
head_description: "Создайте подпись штрих-кода ISBN и поместите ее в документ Zip с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода ISBN для документа Zip в C#"
description: "Подпишите свои бизнес-документы Zip с помощью штрих-кода ISBN. Быстро и легко создавайте подпись штрих-кода с помощью нескольких строк кода для настройки параметров подписи."
