...
############################# Head ############################
head_title: "Xltm-Dokument mit Interleaved2of5-Barcode in C# eSignieren"
head_description: "Erstellen Sie eine Interleaved2of5-Barcode-Signatur und fügen Sie sie mit ein paar Codezeilen in ein Xltm-Dokument mit .NET ein. Verwenden Sie die GroupDocs Document Signature API zum Signieren verschiedener Dateiformate."

############################# Header ############################
title: "Interleaved2of5-Barcode-Signatur für Xltm-Dokument in C# generieren"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Xltm mit Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Xltm-Dokumente mit Barcode-Signaturen schnell und einfach zu signieren.
