...
############################# Head ############################
head_title: "eSign Bmp документ со штрих-кодом Codabar в C#"
head_description: "Создайте подпись штрих-кода Codabar и поместите ее в документ Bmp с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода Codabar для документа Bmp в C#"
