...
############################# Head ############################
head_title: "Firmar electrónicamente Ott documento con Pdf417 código de barras en C#"
head_description: "Cree la firma de código de barras Pdf417 y colóquela en el documento Ott con .NET usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras Pdf417 para el documento Ott en C#"
description: "Firme electrónicamente sus documentos comerciales de Ott con Pdf417 Barcode. Genere una firma de código de barras rápida y fácilmente con unas pocas líneas de código para configurar las opciones de firma."
...
steps:
    enable: true
    title_left: "Pasos para firmar Ott con Barcode en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Ott con Barcode firmas de forma rápida y sencilla.
