...
############################# Head ############################
head_title: "eSign Pptm documento con codice a barre Pdf417 in C#"
head_description: "Crea Pdf417 Firma codice a barre e inseriscilo nel documento Pptm con .NET utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Pdf417 firma del codice a barre per il documento Pptm in C#"
...
steps:
    enable: true
    title_left: "Passaggi per firmare Pptm con Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Pptm con firme Barcode in modo rapido e semplice.
