...
############################# Head ############################
head_title: "eSign Dotx-dokument met Interleaved2of5 Strepiekode in C#"
head_description: "Skep Interleaved2of5 Strepiekode Handtekening en plaas dit op Dotx dokument met .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer Interleaved2of5 strepieskode-handtekening vir Dotx-dokument in C#"
description: "eTeken jou Dotx besigheidsdokumente met Interleaved2of5 Streepkode. Genereer strepieskode-handtekening vinnig en maklik met 'n paar reëls kode om ondertekenopsies op te stel."
...
steps:
    enable: true
    title_left: "Stappe om Dotx met Barcode in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Dotx dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
