...
############################# Head ############################
head_title: "eSign Dotx document avec Postnet Barcode in C#"
head_description: "Créez Postnet Barcode Signature et placez-le sur le document Dotx avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres Postnet pour le document Dotx dans C#"
description: "Signez électroniquement vos documents commerciaux Dotx avec Postnet Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
