...
############################# Head ############################
head_title: "eSign Xlsb เอกสารด้วยบาร์โค้ด ISBN ใน C#"
head_description: "สร้าง ISBN Barcode Signature และใส่ลงในเอกสาร Xlsb ด้วย .NET โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API สำหรับการลงนามรูปแบบไฟล์ต่างๆ"

############################# Header ############################
title: "สร้าง ISBN ลายเซ็นบาร์โค้ดสำหรับเอกสาร Xlsb ใน C#"
...
steps:
    enable: true
    title_left: "ขั้นตอนในการลงนาม Xlsb กับ Barcode ใน C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ให้ความสามารถในการลงนามในเอกสาร Xlsb ด้วยลายเซ็น Barcode อย่างรวดเร็วและง่ายดาย
