...
############################# Head ############################
head_title: "eSign Pdf tài liệu với E A N14 Mã vạch trong C#"
head_description: "Tạo Chữ ký Mã vạch E A N14 và đưa nó vào tài liệu Pdf với .NET bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo E A N14 Chữ ký mã vạch cho tài liệu Pdf trong C#"
description: "eSign các tài liệu kinh doanh Pdf của bạn bằng Mã vạch E A N14. Tạo chữ ký mã vạch nhanh chóng và dễ dàng với một vài dòng mã để thiết lập các tùy chọn ký."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Pdf bằng Barcode trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Pdf bằng chữ ký Barcode một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Pdf bằng Barcode Live Demo"
    content: |
