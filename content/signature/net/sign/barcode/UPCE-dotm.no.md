...
############################# Head ############################
head_title: "eSign Dotm-dokument med UPCE strekkode i C#"
head_description: "Opprett UPCE strekkodesignatur og legg den på Dotm-dokumentet med .NET ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer UPCE strekkodesignatur for Dotm dokument i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Dotm med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Dotm-dokumenter med Barcode-signaturer raskt og enkelt.
