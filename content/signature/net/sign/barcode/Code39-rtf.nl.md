...
head_description: "Maak Code39 Barcode Signature en plaats deze op Rtf document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
