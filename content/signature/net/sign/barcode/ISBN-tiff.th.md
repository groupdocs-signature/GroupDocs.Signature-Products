...
############################# Head ############################
head_title: "eSign Tiff เอกสารด้วยบาร์โค้ด ISBN ใน C#"
head_description: "สร้าง ISBN Barcode Signature และใส่ลงในเอกสาร Tiff ด้วย .NET โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API สำหรับการลงนามรูปแบบไฟล์ต่างๆ"

############################# Header ############################
title: "สร้าง ISBN ลายเซ็นบาร์โค้ดสำหรับเอกสาร Tiff ใน C#"
description: "eSign เอกสารทางธุรกิจ Tiff ของคุณด้วยบาร์โค้ด ISBN สร้างลายเซ็นบาร์โค้ดอย่างรวดเร็วและง่ายดายด้วยรหัสสองสามบรรทัดเพื่อตั้งค่าตัวเลือกการเซ็นชื่อ"
...
steps:
    enable: true
    title_left: "ขั้นตอนในการลงนาม Tiff กับ Barcode ใน C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ให้ความสามารถในการลงนามในเอกสาร Tiff ด้วยลายเซ็น Barcode อย่างรวดเร็วและง่ายดาย
