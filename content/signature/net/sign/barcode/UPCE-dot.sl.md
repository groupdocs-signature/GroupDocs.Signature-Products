...
############################# Head ############################
head_title: "eSign Dot dokument s črtno kodo UPCE v C#"
head_description: "Ustvarite podpis črtne kode UPCE in ga postavite na dokument Dot z .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari UPCE podpis črtne kode za Dot dokument v C#"
description: "e-Podpišite svoje Dot poslovne dokumente s črtno kodo UPCE. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Dot z Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Dot s podpisi Barcode.
