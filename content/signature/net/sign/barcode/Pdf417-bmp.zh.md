...
############################# Head ############################
head_title: "在 C# 中带有 Pdf417 条码的 eSign Bmp 文档"
head_description: "创建 Pdf417 条码签名并使用几行代码将其放在带有 .NET 的 Bmp 文档中。使用 GroupDocs 文档签名 API 对各种文件格式进行签名。"

############################# Header ############################
title: "在 C# 中为 Bmp 文档生成 Pdf417 条码签名"
