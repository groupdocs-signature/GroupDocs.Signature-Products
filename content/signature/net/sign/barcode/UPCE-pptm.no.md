...
############################# Head ############################
head_title: "eSign Pptm-dokument med UPCE strekkode i C#"
head_description: "Opprett UPCE strekkodesignatur og legg den på Pptm-dokumentet med .NET ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer UPCE strekkodesignatur for Pptm dokument i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Pptm med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Pptm-dokumenter med Barcode-signaturer raskt og enkelt.
