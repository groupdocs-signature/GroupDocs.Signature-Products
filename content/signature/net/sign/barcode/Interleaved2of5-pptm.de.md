...
############################# Head ############################
head_title: "Pptm-Dokument mit Interleaved2of5-Barcode in C# eSignieren"
head_description: "Erstellen Sie eine Interleaved2of5-Barcode-Signatur und fügen Sie sie mit ein paar Codezeilen in ein Pptm-Dokument mit .NET ein. Verwenden Sie die GroupDocs Document Signature API zum Signieren verschiedener Dateiformate."

############################# Header ############################
title: "Interleaved2of5-Barcode-Signatur für Pptm-Dokument in C# generieren"
description: "Unterzeichnen Sie Ihre Pptm-Geschäftsdokumente mit Interleaved2of5-Barcode. Generieren Sie Barcode-Signaturen schnell und einfach mit wenigen Codezeilen, um Signaturoptionen einzurichten."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Pptm mit Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Pptm-Dokumente mit Barcode-Signaturen schnell und einfach zu signieren.
