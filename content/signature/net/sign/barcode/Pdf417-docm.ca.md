...
############################# Head ############################
head_title: "Document electrònic Docm amb codi de barres Pdf417 a C#"
head_description: "Creeu la signatura de codi de barres Pdf417 i poseu-la al document Docm amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu Pdf417 signatura de codi de barres per al document Docm a C#"
