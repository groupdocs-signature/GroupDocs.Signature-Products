...
############################# Head ############################
head_title: "eSign Pptm dokument s črtno kodo Pharmacode v C#"
head_description: "Ustvarite podpis črtne kode Pharmacode in ga postavite na dokument Pptm z .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari Pharmacode podpis črtne kode za Pptm dokument v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Pptm z Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Pptm s podpisi Barcode.
