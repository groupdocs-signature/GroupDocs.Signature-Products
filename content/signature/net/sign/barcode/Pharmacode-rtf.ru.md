...
############################# Head ############################
head_title: "eSign Rtf документ со штрих-кодом Pharmacode в C#"
head_description: "Создайте подпись штрих-кода Pharmacode и поместите ее в документ Rtf с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода Pharmacode для документа Rtf в C#"
