...
############################# Head ############################
head_title: "eSign Docx belgeya bi E A N14 Barcode di C#"
head_description: "Îmzeya barkodê ya E A N14 biafirîne û bi çend rêzikên kodê bi .NET li ser belgeya Docx biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Docx bi Barcode di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Docx bi îmzeyên Barcode zû û bi hêsanî peyda dike.
