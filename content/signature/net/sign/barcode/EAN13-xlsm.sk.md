...
############################# Head ############################
head_title: "eSign Xlsm dokument s E A N13 čiarovým kódom v C#"
head_description: "Vytvorte podpis čiarového kódu E A N13 a vložte ho do dokumentu Xlsm s .NET pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte E A N13 podpis čiarového kódu pre dokument Xlsm v C#"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Xlsm pomocou čiarového kódu E A N13. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xlsm pomocou Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xlsm pomocou podpisov Barcode.
