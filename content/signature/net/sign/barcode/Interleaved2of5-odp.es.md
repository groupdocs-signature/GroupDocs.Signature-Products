...
############################# Head ############################
head_title: "Firmar electrónicamente Odp documento con Interleaved2of5 código de barras en C#"
head_description: "Cree la firma de código de barras Interleaved2of5 y colóquela en el documento Odp con .NET usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras Interleaved2of5 para el documento Odp en C#"
description: "Firme electrónicamente sus documentos comerciales de Odp con Interleaved2of5 Barcode. Genere una firma de código de barras rápida y fácilmente con unas pocas líneas de código para configurar las opciones de firma."
...
steps:
    enable: true
    title_left: "Pasos para firmar Odp con Barcode en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Odp con Barcode firmas de forma rápida y sencilla.
