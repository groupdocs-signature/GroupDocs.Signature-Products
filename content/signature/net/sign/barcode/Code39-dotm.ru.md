...
############################# Head ############################
head_title: "eSign Dotm документ со штрих-кодом Code39 в C#"
head_description: "Создайте подпись штрих-кода Code39 и поместите ее в документ Dotm с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода Code39 для документа Dotm в C#"
