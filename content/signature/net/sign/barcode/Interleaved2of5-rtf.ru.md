...
############################# Head ############################
head_title: "eSign Rtf документ со штрих-кодом Interleaved2of5 в C#"
head_description: "Создайте подпись штрих-кода Interleaved2of5 и поместите ее в документ Rtf с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода Interleaved2of5 для документа Rtf в C#"
