...
############################# Head ############################
head_title: "C# で Pharmacode バーコードを使用して Potx 文書に eSign"
head_description: "Pharmacode バーコード署名を作成し、数行のコードを使用して .NET で Potx ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "C# の Potx ドキュメントの Pharmacode バーコード署名を生成します"
