...
############################# Head ############################
head_title: "eSign Ots documento con codice a barre E A N14 in C#"
head_description: "Crea E A N14 Firma codice a barre e inseriscilo nel documento Ots con .NET utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera E A N14 firma del codice a barre per il documento Ots in C#"
...
steps:
    enable: true
    title_left: "Passaggi per firmare Ots con Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Ots con firme Barcode in modo rapido e semplice.
