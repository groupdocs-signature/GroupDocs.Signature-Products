...
head_description: "Maak ISBN Barcode Signature en plaats deze op Xls document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
