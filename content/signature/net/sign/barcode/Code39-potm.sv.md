...
############################# Head ############################
head_title: "eSign Potm dokument med Code39 streckkod i C#"
head_description: "Skapa Code39 streckkodsignatur och lägg den på Potm dokument med .NET med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera Code39 streckkodsignatur för Potm dokument i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Potm med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Potm-dokument med Barcode-signaturer snabbt och enkelt.
