...
############################# Head ############################
head_title: "eSign Ods doiciméad le ISBN Barcode in C#"
head_description: "Cruthaigh ISBN Síniú Barrachóid agus cuir ar Ods doiciméad le .NET ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid ISBN don doiciméad Ods in C#"
description: "eSínigh do dhoiciméid ghnó Ods le Barrachóid ISBN. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
steps:
    enable: true
    title_left: "Céimeanna chun Ods a shíniú le Barcode in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Ods a shíniú le sínithe Barcode go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Ods doiciméad le Barcode Taispeántas Beo"
    content: |
