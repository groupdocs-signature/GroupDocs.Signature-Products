...
############################# Head ############################
head_title: "وثيقة eSign Xltm مع Pharmacode رمز شريطي في C#"
head_description: "أنشئ Pharmacode Barcode Signature وضعه في مستند Xltm باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Pharmacode توقيع الرمز الشريطي للمستند Xltm في C#"
