...
############################# Head ############################
head_title: "eSign Pps dokumentum ISBN vonalkóddal a C# nyelven"
head_description: "Hozzon létre ISBN vonalkód-aláírást, és helyezze el a Pps dokumentumra a .NET termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "ISBN vonalkód aláírás létrehozása a Pps dokumentumhoz a C# programban"
...
steps:
    enable: true
    title_left: "A Pps aláírásának lépései a Barcode segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Pps dokumentumok gyors és egyszerű aláírását Barcode aláírással.
