...
############################# Head ############################
head_title: "Document electrònic Rtf amb codi de barres Code39 a C#"
head_description: "Creeu la signatura de codi de barres Code39 i poseu-la al document Rtf amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu Code39 signatura de codi de barres per al document Rtf a C#"
...
steps:
    enable: true
    title_left: "Passos per signar Rtf amb Barcode a C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix la possibilitat de signar documents Rtf amb signatures Barcode de manera ràpida i senzilla.
