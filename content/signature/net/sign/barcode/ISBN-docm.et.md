...
############################# Head ############################
head_title: "eSign Docm dokument ISBN vöötkoodiga keeles C#"
head_description: "Looge ISBN vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile Docm tootega .NET. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge C#-s dokumendile Docm vöötkoodiallkiri ISBN"
...
steps:
    enable: true
    title_left: "Toimingud Docm allkirjastamiseks rakendusega Barcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Docm dokumente Barcode allkirjaga.
