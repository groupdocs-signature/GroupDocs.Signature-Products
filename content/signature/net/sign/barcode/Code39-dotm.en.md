...
head_description: "Create Code39 Barcode Signature and put it on Dotm document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."
