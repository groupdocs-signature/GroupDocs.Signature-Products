...
############################# Head ############################
head_title: "Firmar electrónicamente Dotx documento con I T F14 código de barras en C#"
head_description: "Cree la firma de código de barras I T F14 y colóquela en el documento Dotx con .NET usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras I T F14 para el documento Dotx en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Dotx con Barcode en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Dotx con Barcode firmas de forma rápida y sencilla.
