...
############################# Head ############################
head_title: "eSign Wmf-dokument met Code39 Strepiekode in C#"
head_description: "Skep Code39 Strepiekode Handtekening en plaas dit op Wmf dokument met .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer Code39 strepieskode-handtekening vir Wmf-dokument in C#"
...
steps:
    enable: true
    title_left: "Stappe om Wmf met Barcode in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Wmf dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
