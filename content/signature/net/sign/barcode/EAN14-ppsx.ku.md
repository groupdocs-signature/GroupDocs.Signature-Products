...
############################# Head ############################
head_title: "eSign Ppsx belgeya bi E A N14 Barcode di C#"
head_description: "Îmzeya barkodê ya E A N14 biafirîne û bi çend rêzikên kodê bi .NET li ser belgeya Ppsx biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."

############################# Header ############################
title: "Di C# de ji bo belgeya E A N14 îmzeya barkodê çêbike"
description: "Belgeyên karsaziya xwe yên Ppsx bi E A N14 Barkodê îmze bikin. Bi çend rêzikên kodê re zû û bi hêsanî îmzeya Barkodê biafirînin da ku vebijarkên îmzekirinê saz bikin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Ppsx bi Barcode di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Ppsx bi îmzeyên Barcode zû û bi hêsanî peyda dike.
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Ppsx bi Barcode Demoya Zindî"
    content: |
