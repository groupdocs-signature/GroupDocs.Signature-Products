...
############################# Head ############################
head_title: "eSign Zip dokument s E A N13 čiarovým kódom v C#"
head_description: "Vytvorte podpis čiarového kódu E A N13 a vložte ho do dokumentu Zip s .NET pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte E A N13 podpis čiarového kódu pre dokument Zip v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Zip pomocou Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Zip pomocou podpisov Barcode.
