...
############################# Head ############################
head_title: "eSign Svg dokumentum Pharmacode vonalkóddal a C# nyelven"
head_description: "Hozzon létre Pharmacode vonalkód-aláírást, és helyezze el a Svg dokumentumra a .NET termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "Pharmacode vonalkód aláírás létrehozása a Svg dokumentumhoz a C# programban"
description: "eAláírja Svg üzleti dokumentumait Pharmacode vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
steps:
    enable: true
    title_left: "A Svg aláírásának lépései a Barcode segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Svg dokumentumok gyors és egyszerű aláírását Barcode aláírással.
...
demos:
    enable: true
    title: "Svg dokumentumok aláírása Barcode élő bemutatóval"
    content: |
