...
############################# Head ############################
head_title: "eSign Pptm document with Interleaved2of5 Barcode in C#"
head_description: "Create Interleaved2of5 Barcode Signature and put it on Pptm document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."

############################# Header ############################
title: "Generate Interleaved2of5 Barcode signature for Pptm document in C#"
description: "eSign your Pptm business documents with Interleaved2of5 Barcode. Generate Barcode signature quickly and easily with a few lines of code to set up signing options."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Pptm documents with Barcode signatures quickly and easily.
