...
############################# Head ############################
head_title: "eSign Xlsb dokument med E A N13 streckkod i C#"
head_description: "Skapa E A N13 streckkodsignatur och lägg den på Xlsb dokument med .NET med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera E A N13 streckkodsignatur för Xlsb dokument i C#"
description: "esignera dina Xlsb affärsdokument med E A N13 streckkod. Skapa streckkodsignatur snabbt och enkelt med några rader kod för att ställa in signeringsalternativ."
...
steps:
    enable: true
    title_left: "Steg för att signera Xlsb med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Xlsb-dokument med Barcode-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Xlsb dokument med Barcode Live Demo"
    content: |
