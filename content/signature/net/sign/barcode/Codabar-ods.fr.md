...
############################# Head ############################
head_title: "eSign Ods document avec Codabar Barcode in C#"
head_description: "Créez Codabar Barcode Signature et placez-le sur le document Ods avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres Codabar pour le document Ods dans C#"
