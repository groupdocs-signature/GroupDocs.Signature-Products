...
############################# Head ############################
head_title: "eSign Odp documento con codice a barre Pharmacode in C#"
head_description: "Crea Pharmacode Firma codice a barre e inseriscilo nel documento Odp con .NET utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Pharmacode firma del codice a barre per il documento Odp in C#"
description: "Firma elettronicamente i tuoi documenti aziendali Odp con il codice a barre Pharmacode. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
