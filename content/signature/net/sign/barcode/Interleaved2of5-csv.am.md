...
############################# Head ############################
head_title: "eSign Csv ሰነድ በInterleaved2of5 ባርኮድ በC#"
head_description: "የInterleaved2of5 ባርኮድ ፊርማ ይፍጠሩ እና በCsv ሰነድ ላይ በ.NET ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በC# ውስጥ ለCsv ሰነድ የInterleaved2of5 ባርኮድ ፊርማ ይፍጠሩ"
...
steps:
    enable: true
    title_left: "Csvን በBarcode በC# ለመፈረም ደረጃዎች"
    content_left: |
