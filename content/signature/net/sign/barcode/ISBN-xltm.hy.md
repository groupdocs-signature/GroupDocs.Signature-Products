...
############################# Head ############################
head_title: "eSign Xltm փաստաթուղթը ISBN շտրիխ կոդով C#-ում"
head_description: "Ստեղծեք ISBN շտրիխ կոդի ստորագրություն և դրեք այն Xltm փաստաթղթում .NET-ով` օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տարբեր ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք ISBN շտրիխ կոդ ստորագրություն Xltm փաստաթղթի համար C#-ում"
