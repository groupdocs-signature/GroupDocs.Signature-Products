...
############################# Head ############################
head_title: "eSign Png dokument s E A N13 čiarovým kódom v C#"
head_description: "Vytvorte podpis čiarového kódu E A N13 a vložte ho do dokumentu Png s .NET pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte E A N13 podpis čiarového kódu pre dokument Png v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Png pomocou Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Png pomocou podpisov Barcode.
