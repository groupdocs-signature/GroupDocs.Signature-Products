...
############################# Head ############################
head_title: "C# içinde UPCE Barkodlu eSign Dot belgesi"
head_description: "UPCE Barkod İmzası oluşturun ve birkaç satır kod kullanarak .NET ile Dot belgesine koyun. Çeşitli dosya biçimlerini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "C# içinde Dot belgesi için UPCE Barkod imzası oluşturun"
description: "Dot iş belgelerinizi UPCE Barkod ile e-imzalayın. İmzalama seçeneklerini ayarlamak için birkaç satır kodla hızlı ve kolay bir şekilde Barkod imzası oluşturun."
...
steps:
    enable: true
    title_left: "C# içinde Barcode ile Dot imzalama adımları"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Dot belgelerini Barcode imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Dot dokümanı Barcode Canlı Demo ile imzalama"
    content: |
