...
head_description: "Create Pdf417 Barcode Signature on Dotx file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."
