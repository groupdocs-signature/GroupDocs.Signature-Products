...
############################# Head ############################
head_title: "eSign Ods dokument Code39 vöötkoodiga keeles C#"
head_description: "Looge Code39 vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile Ods tootega .NET. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge C#-s dokumendile Ods vöötkoodiallkiri Code39"
description: "eAllkirjasta oma Ods äridokumendid Code39 vöötkoodiga. Looge vöötkoodisignatuur kiiresti ja lihtsalt mõne koodirea abil allkirjastamisvalikute seadistamiseks."
...
steps:
    enable: true
    title_left: "Toimingud Ods allkirjastamiseks rakendusega Barcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Ods dokumente Barcode allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Ods allkirjastamine Barcode reaalajas demoga"
    content: |
