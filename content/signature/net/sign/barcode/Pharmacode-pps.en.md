...
head_description: "Create Pharmacode Barcode Signature and put it on Pps document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Pps documents with Barcode signatures quickly and easily.
