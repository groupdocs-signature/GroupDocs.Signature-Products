...
head_description: "Maak een Pdf417 Barcode Signature en plaats deze op het Docx document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
