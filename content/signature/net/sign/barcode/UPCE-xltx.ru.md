...
############################# Head ############################
head_title: "eSign Xltx документ со штрих-кодом UPCE в C#"
head_description: "Создайте подпись штрих-кода UPCE и поместите ее в документ Xltx с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода UPCE для документа Xltx в C#"
