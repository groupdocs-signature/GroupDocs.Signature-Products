...
############################# Head ############################
head_title: "eSign Docx doiciméad le ISBN Barcode in C#"
head_description: "Cruthaigh ISBN Síniú Barrachóid agus cuir ar Docx doiciméad le .NET ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid ISBN don doiciméad Docx in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Docx a shíniú le Barcode in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Docx a shíniú le sínithe Barcode go tapa agus go héasca.
