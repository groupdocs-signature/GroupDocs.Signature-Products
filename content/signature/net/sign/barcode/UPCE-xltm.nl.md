...
############################# Head ############################
head_title: "eSign Xltm document met UPCE Barcode in C#"
head_description: "Maak UPCE Barcode Signature en plaats deze op Xltm document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."

############################# Header ############################
title: "Genereer UPCE Barcode handtekening voor Xltm document in C#"
...
steps:
    enable: true
    title_left: "Stappen om Xltm te ondertekenen met Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Xltm documenten snel en gemakkelijk te ondertekenen met Barcode handtekeningen.
