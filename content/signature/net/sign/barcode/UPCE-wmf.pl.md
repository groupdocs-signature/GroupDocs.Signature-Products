...
############################# Head ############################
head_title: "Podpisz dokument Wmf z kodem kreskowym UPCE w C#"
head_description: "Utwórz podpis z kodem kreskowym UPCE i umieść go w dokumencie Wmf za pomocą .NET, używając kilku linijek kodu. Użyj interfejsu GroupDocs Document Signature API do podpisywania różnych formatów plików."

############################# Header ############################
title: "Wygeneruj UPCE podpis z kodem kreskowym dla dokumentu Wmf w C#"
