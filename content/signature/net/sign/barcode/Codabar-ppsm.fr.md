...
############################# Head ############################
head_title: "eSign Ppsm document avec Codabar Barcode in C#"
head_description: "Créez Codabar Barcode Signature et placez-le sur le document Ppsm avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres Codabar pour le document Ppsm dans C#"
description: "Signez électroniquement vos documents commerciaux Ppsm avec Codabar Barcode. Générez une signature de code-barres rapidement et facilement avec quelques lignes de code pour configurer les options de signature."
