...
############################# Head ############################
head_title: "Document electrònic Ppsx amb codi de barres Pharmacode a C#"
head_description: "Creeu la signatura de codi de barres Pharmacode i poseu-la al document Ppsx amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu Pharmacode signatura de codi de barres per al document Ppsx a C#"
