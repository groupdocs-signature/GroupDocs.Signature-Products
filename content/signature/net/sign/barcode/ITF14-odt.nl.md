...
head_description: "Maak I T F14 Barcode Signature en plaats deze op Odt document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
