...
############################# Head ############################
head_title: "Document electrònic Xltx amb codi de barres UPCE a C#"
head_description: "Creeu la signatura de codi de barres UPCE i poseu-la al document Xltx amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu UPCE signatura de codi de barres per al document Xltx a C#"
...
steps:
    enable: true
    title_left: "Passos per signar Xltx amb Barcode a C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix la possibilitat de signar documents Xltx amb signatures Barcode de manera ràpida i senzilla.
