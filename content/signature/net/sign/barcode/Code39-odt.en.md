...
############################# Head ############################
head_title: "eSign Odt document with Code39 Barcode in C#"
head_description: "Create Code39 Barcode Signature on Odt file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Generate Code39 Barcode signature for Odt document in C#"
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with Code39 Barcode using C#"
    content: |
        .NET Code39 Barcode signatures management API for documents and images. Add Code39 Barcode signatures to some of the popular file formats as stated below.
    format: 
