...
############################# Head ############################
head_title: "Dokument eSign Xlsm s čárovým kódem UPCE v C#"
head_description: "Vytvořte podpis čárového kódu UPCE a vložte jej do dokumentu Xlsm s .NET pomocí několika řádků kódu. K podepisování různých formátů souborů použijte rozhraní GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte podpis čárového kódu UPCE pro dokument Xlsm v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsm pomocí Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Xlsm pomocí podpisů Barcode.
