...
############################# Head ############################
head_title: "eSign Svg tài liệu với Code39 Mã vạch trong C#"
head_description: "Tạo Chữ ký Mã vạch Code39 và đưa nó vào tài liệu Svg với .NET bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo Code39 Chữ ký mã vạch cho tài liệu Svg trong C#"
