...
############################# Head ############################
head_title: "وثيقة eSign Xlsx مع ISBN رمز شريطي في C#"
head_description: "أنشئ ISBN Barcode Signature وضعه في مستند Xlsx باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء ISBN توقيع الرمز الشريطي للمستند Xlsx في C#"
description: "قم بتوقيع Xlsx على مستندات الأعمال باستخدام الرمز الشريطي ISBN. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
