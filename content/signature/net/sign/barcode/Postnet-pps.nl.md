...
head_description: "Maak een Postnet Barcode Signature en plaats deze op het Pps document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
