...
############################# Head ############################
head_title: "eSign Pps dokumentas su Codabar brūkšniniu kodu C#"
head_description: "Sukurkite Codabar brūkšninio kodo parašą ir įdėkite jį į Pps dokumentą su .NET naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite Codabar brūkšninio kodo parašą Pps dokumentui C#"
description: "e. Pasirašykite Pps verslo dokumentus naudodami Codabar brūkšninį kodą. Greitai ir lengvai sugeneruokite brūkšninio kodo parašą naudodami kelias kodo eilutes, kad nustatytumėte pasirašymo parinktis."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Pps naudojant Barcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Pps dokumentus su Barcode parašais.
...
demos:
    enable: true
    title: "Dokumentų Pps pasirašymas naudojant Barcode tiesioginę demonstraciją"
    content: |
