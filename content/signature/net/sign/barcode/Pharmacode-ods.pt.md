...
############################# Head ############################
head_title: "eSign Ods documento com Pharmacode Código de barras em C#"
head_description: "Crie uma assinatura de código de barras Pharmacode e coloque-a no documento Ods com .NET usando algumas linhas de código. Use a API de assinatura de documento do GroupDocs para assinar vários formatos de arquivo."

############################# Header ############################
title: "Gere assinatura de código de barras Pharmacode para Ods documento em C#"
description: "Assine seus documentos comerciais Ods com o código de barras Pharmacode. Gere assinatura de código de barras de forma rápida e fácil com algumas linhas de código para configurar as opções de assinatura."
...
steps:
    enable: true
    title_left: "Etapas para assinar Ods com Barcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Ods com assinaturas Barcode de forma rápida e fácil.
