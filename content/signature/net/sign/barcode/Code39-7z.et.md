...
############################# Head ############################
head_title: "eSign 7z dokument Code39 vöötkoodiga keeles C#"
head_description: "Looge Code39 vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile 7z tootega .NET. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge C#-s dokumendile 7z vöötkoodiallkiri Code39"
description: "eAllkirjasta oma 7z äridokumendid Code39 vöötkoodiga. Looge vöötkoodisignatuur kiiresti ja lihtsalt mõne koodirea abil allkirjastamisvalikute seadistamiseks."
...
steps:
    enable: true
    title_left: "Toimingud 7z allkirjastamiseks rakendusega Barcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada 7z dokumente Barcode allkirjaga.
