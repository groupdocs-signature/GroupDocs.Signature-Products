...
more_formats:
    ...
    content: |
        .NET GS1CODABLOCKF BARCODE signatures management API for documents and images. Add GS1CODABLOCKF BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
