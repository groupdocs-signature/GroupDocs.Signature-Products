...
############################# Head ############################
head_title: "eSign Pptx documento com Codabar Código de barras em C#"
head_description: "Crie uma assinatura de código de barras Codabar e coloque-a no documento Pptx com .NET usando algumas linhas de código. Use a API de assinatura de documento do GroupDocs para assinar vários formatos de arquivo."

############################# Header ############################
title: "Gere assinatura de código de barras Codabar para Pptx documento em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Pptx com Barcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Pptx com assinaturas Barcode de forma rápida e fácil.
