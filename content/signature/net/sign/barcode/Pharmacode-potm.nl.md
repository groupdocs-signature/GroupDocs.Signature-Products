...
############################# Head ############################
head_title: "eSign Potm document met Pharmacode Barcode in C#"
head_description: "Maak een Pharmacode Barcode Signature en plaats deze op het Potm document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."

############################# Header ############################
title: "Genereer Pharmacode Barcode handtekening voor Potm document in C#"
