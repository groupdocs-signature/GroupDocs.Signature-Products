...
head_description: "Maak een Interleaved2of5 Barcode Signature en plaats deze op het Odp document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
