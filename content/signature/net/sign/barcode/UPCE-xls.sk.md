...
############################# Head ############################
head_title: "eSign Xls dokument s UPCE čiarovým kódom v C#"
head_description: "Vytvorte podpis čiarového kódu UPCE a vložte ho do dokumentu Xls s .NET pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte UPCE podpis čiarového kódu pre dokument Xls v C#"
