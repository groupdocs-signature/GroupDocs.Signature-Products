...
############################# Head ############################
head_title: "Document electrònic Docm amb codi de barres ISBN a C#"
head_description: "Creeu la signatura de codi de barres ISBN i poseu-la al document Docm amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu ISBN signatura de codi de barres per al document Docm a C#"
