...
############################# Head ############################
head_title: "Document electrònic Pdf amb codi de barres Code39 a C#"
head_description: "Creeu la signatura de codi de barres Code39 i poseu-la al document Pdf amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu Code39 signatura de codi de barres per al document Pdf a C#"
