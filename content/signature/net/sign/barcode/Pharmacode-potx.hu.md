...
############################# Head ############################
head_title: "eSign Potx dokumentum Pharmacode vonalkóddal a C# nyelven"
head_description: "Hozzon létre Pharmacode vonalkód-aláírást, és helyezze el a Potx dokumentumra a .NET termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "Pharmacode vonalkód aláírás létrehozása a Potx dokumentumhoz a C# programban"
...
steps:
    enable: true
    title_left: "A Potx aláírásának lépései a Barcode segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Potx dokumentumok gyors és egyszerű aláírását Barcode aláírással.
