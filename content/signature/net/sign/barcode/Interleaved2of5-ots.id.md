...
############################# Head ############################
head_title: "eSign Ots dokumen dengan Interleaved2of5 Barcode di C#"
head_description: "Buat Interleaved2of5 Tanda Tangan Barcode dan letakkan di dokumen Ots dengan .NET menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat Interleaved2of5 Tanda tangan kode batang untuk dokumen Ots di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Ots dengan Barcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Ots dengan Barcode tanda tangan dengan cepat dan mudah.
