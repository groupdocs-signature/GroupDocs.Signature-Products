...
############################# Head ############################
head_title: "eSign Png-dokument med UPCE strekkode i C#"
head_description: "Opprett UPCE strekkodesignatur og legg den på Png-dokumentet med .NET ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer UPCE strekkodesignatur for Png dokument i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Png med Barcode i C#"
    content_left: |
