...
############################# Head ############################
head_title: "eSign Pdf doiciméad le Pharmacode Barcode in C#"
head_description: "Cruthaigh Pharmacode Síniú Barrachóid agus cuir ar Pdf doiciméad le .NET ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid Pharmacode don doiciméad Pdf in C#"
description: "eSínigh do dhoiciméid ghnó Pdf le Barrachóid Pharmacode. Gin síniú Barrachóid go tapa agus go héasca le cúpla líne de chód chun roghanna sínithe a shocrú."
...
steps:
    enable: true
    title_left: "Céimeanna chun Pdf a shíniú le Barcode in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Pdf a shíniú le sínithe Barcode go tapa agus go héasca.
