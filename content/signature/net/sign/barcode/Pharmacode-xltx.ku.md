...
############################# Head ############################
head_title: "eSign Xltx belgeya bi Pharmacode Barcode di C#"
head_description: "Îmzeya barkodê ya Pharmacode biafirîne û bi çend rêzikên kodê bi .NET li ser belgeya Xltx biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."
