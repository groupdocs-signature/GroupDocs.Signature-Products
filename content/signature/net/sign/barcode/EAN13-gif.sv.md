...
############################# Head ############################
head_title: "eSign Gif dokument med E A N13 streckkod i C#"
head_description: "Skapa E A N13 streckkodsignatur och lägg den på Gif dokument med .NET med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera E A N13 streckkodsignatur för Gif dokument i C#"
description: "esignera dina Gif affärsdokument med E A N13 streckkod. Skapa streckkodsignatur snabbt och enkelt med några rader kod för att ställa in signeringsalternativ."
...
steps:
    enable: true
    title_left: "Steg för att signera Gif med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Gif-dokument med Barcode-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Gif dokument med Barcode Live Demo"
    content: |
