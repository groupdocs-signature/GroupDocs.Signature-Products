...
head_description: "Create ISBN Barcode Signature and put it on Dot document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."
