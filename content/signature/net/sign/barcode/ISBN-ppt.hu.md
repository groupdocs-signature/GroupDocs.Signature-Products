...
############################# Head ############################
head_title: "eSign Ppt dokumentum ISBN vonalkóddal a C# nyelven"
head_description: "Hozzon létre ISBN vonalkód-aláírást, és helyezze el a Ppt dokumentumra a .NET termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "ISBN vonalkód aláírás létrehozása a Ppt dokumentumhoz a C# programban"
description: "eAláírja Ppt üzleti dokumentumait ISBN vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
steps:
    enable: true
    title_left: "A Ppt aláírásának lépései a Barcode segítségével a C# programban"
    content_left: |
