...
############################# Head ############################
head_title: "eSign Otp dokument s Pharmacode crtičnim kodom u C#"
head_description: "Stvorite Pharmacode potpis crtičnog koda i stavite ga na Otp dokument s .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje različitih formata datoteka."

############################# Header ############################
title: "Generirajte Pharmacode potpis crtičnog koda za Otp dokument u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Otp s Barcode u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Otp dokumenata s Barcode potpisima.
