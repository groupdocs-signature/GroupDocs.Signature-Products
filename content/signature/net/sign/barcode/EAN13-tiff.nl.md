...
############################# Head ############################
head_title: "eSign Tiff document met E A N13 Barcode in C#"
head_description: "Maak een E A N13 Barcode Signature en plaats deze op het Tiff document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."

############################# Header ############################
title: "Genereer E A N13 Barcode handtekening voor Tiff document in C#"
...
steps:
    enable: true
    title_left: "Stappen om Tiff te ondertekenen met Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Tiff documenten snel en gemakkelijk te ondertekenen met Barcode handtekeningen.
