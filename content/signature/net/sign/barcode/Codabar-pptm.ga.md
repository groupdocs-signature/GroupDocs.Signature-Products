...
############################# Head ############################
head_title: "eSign Pptm doiciméad le Codabar Barcode in C#"
head_description: "Cruthaigh Codabar Síniú Barrachóid agus cuir ar Pptm doiciméad le .NET ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid Codabar don doiciméad Pptm in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Pptm a shíniú le Barcode in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Pptm a shíniú le sínithe Barcode go tapa agus go héasca.
