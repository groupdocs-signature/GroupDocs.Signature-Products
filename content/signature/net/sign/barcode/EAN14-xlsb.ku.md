...
############################# Head ############################
head_title: "eSign Xlsb belgeya bi E A N14 Barcode di C#"
head_description: "Îmzeya barkodê ya E A N14 biafirîne û bi çend rêzikên kodê bi .NET li ser belgeya Xlsb biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Xlsb bi Barcode di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Xlsb bi îmzeyên Barcode zû û bi hêsanî peyda dike.
