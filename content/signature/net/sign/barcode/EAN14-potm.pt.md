...
############################# Head ############################
head_title: "eSign Potm documento com E A N14 Código de barras em C#"
head_description: "Crie uma assinatura de código de barras E A N14 e coloque-a no documento Potm com .NET usando algumas linhas de código. Use a API de assinatura de documento do GroupDocs para assinar vários formatos de arquivo."

############################# Header ############################
title: "Gere assinatura de código de barras E A N14 para Potm documento em C#"
description: "Assine seus documentos comerciais Potm com o código de barras E A N14. Gere assinatura de código de barras de forma rápida e fácil com algumas linhas de código para configurar as opções de assinatura."
...
steps:
    enable: true
    title_left: "Etapas para assinar Potm com Barcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Potm com assinaturas Barcode de forma rápida e fácil.
        
        * Crie uma instância da classe Signature fornecendo o arquivo Potm para assinar como caminho ou fluxo de memória
        * Instancie a classe SignOptions e defina todos os dados exigidos.
        * Invoque o método Signature.Sign() passando o arquivo de saída Potm ou fluxo de memória
...
demos:
    enable: true
    title: "Assinando Potm documentos com Barcode Demonstração ao vivo"
    content: |
       Assine o arquivo Potm com várias assinaturas agora mesmo visitando o site [GroupDocs.Signature App](https://products.groupdocs.app/signature/family). Demonstração online gratuita esperando por você.
...
more_formats:
    ...
    content: |
        "Você também pode assinar Potm com outros tipos de assinatura. Por favor, veja a lista abaixo."
    format: 
