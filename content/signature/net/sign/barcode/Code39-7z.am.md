...
############################# Head ############################
head_title: "eSign 7z ሰነድ በCode39 ባርኮድ በC#"
head_description: "የCode39 ባርኮድ ፊርማ ይፍጠሩ እና በ7z ሰነድ ላይ በ.NET ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በC# ውስጥ ለ7z ሰነድ የCode39 ባርኮድ ፊርማ ይፍጠሩ"
...
steps:
    enable: true
    title_left: "7zን በBarcode በC# ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) የ7z ሰነዶችን በBarcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
