...
############################# Head ############################
head_title: "eSign Xls документ со штрих-кодом UPCE в C#"
head_description: "Создайте подпись штрих-кода UPCE и поместите ее в документ Xls с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода UPCE для документа Xls в C#"
description: "Подпишите свои бизнес-документы Xls с помощью штрих-кода UPCE. Быстро и легко создавайте подпись штрих-кода с помощью нескольких строк кода для настройки параметров подписи."
