...
############################# Head ############################
head_title: "وثيقة eSign Otp مع E A N14 رمز شريطي في C#"
head_description: "أنشئ E A N14 Barcode Signature وضعه في مستند Otp باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء E A N14 توقيع الرمز الشريطي للمستند Otp في C#"
description: "قم بتوقيع Otp على مستندات الأعمال باستخدام الرمز الشريطي E A N14. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
...
steps:
    enable: true
    title_left: "خطوات تسجيل Otp باستخدام Barcode في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Otp بتوقيعات Barcode بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Otp باستخدام العرض التوضيحي المباشر Barcode"
    content: |
