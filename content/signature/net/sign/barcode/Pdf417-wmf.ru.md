...
############################# Head ############################
head_title: "eSign Wmf документ со штрих-кодом Pdf417 в C#"
head_description: "Создайте подпись штрих-кода Pdf417 и поместите ее в документ Wmf с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода Pdf417 для документа Wmf в C#"
