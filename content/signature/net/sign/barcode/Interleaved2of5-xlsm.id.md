...
############################# Head ############################
head_title: "eSign Xlsm dokumen dengan Interleaved2of5 Barcode di C#"
head_description: "Buat Interleaved2of5 Tanda Tangan Barcode dan letakkan di dokumen Xlsm dengan .NET menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat Interleaved2of5 Tanda tangan kode batang untuk dokumen Xlsm di C#"
description: "eSign dokumen bisnis Xlsm Anda dengan Interleaved2of5 Barcode. Hasilkan tanda tangan Barcode dengan cepat dan mudah dengan beberapa baris kode untuk menyiapkan opsi penandatanganan."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Xlsm dengan Barcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Xlsm dengan Barcode tanda tangan dengan cepat dan mudah.
