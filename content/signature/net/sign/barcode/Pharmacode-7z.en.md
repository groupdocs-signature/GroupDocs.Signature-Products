...
############################# Head ############################
head_title: "eSign 7z document with Pharmacode Barcode in C#"
head_description: "Create Pharmacode Barcode Signature and put it on 7z document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."

############################# Header ############################
title: "Generate Pharmacode Barcode signature for 7z document in C#"
...
steps:
    enable: true
    title_left: "Steps to sign 7z with Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign 7z documents with Barcode signatures quickly and easily.
