...
############################# Head ############################
head_title: "eSign 7z dokument med E A N14 streckkod i C#"
head_description: "Skapa E A N14 streckkodsignatur och lägg den på 7z dokument med .NET med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera E A N14 streckkodsignatur för 7z dokument i C#"
description: "esignera dina 7z affärsdokument med E A N14 streckkod. Skapa streckkodsignatur snabbt och enkelt med några rader kod för att ställa in signeringsalternativ."
...
steps:
    enable: true
    title_left: "Steg för att signera 7z med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera 7z-dokument med Barcode-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar 7z dokument med Barcode Live Demo"
    content: |
