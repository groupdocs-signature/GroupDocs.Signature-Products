...
############################# Head ############################
head_title: "C#의 I T F14 바코드로 Ppsx 문서에 전자 서명"
head_description: "I T F14 Barcode Signature를 생성하고 몇 줄의 코드를 사용하여 .NET를 사용하여 Ppsx 문서에 넣습니다. 다양한 파일 형식에 서명하려면 GroupDocs 문서 서명 API를 사용하십시오."

############################# Header ############################
title: "C#에서 Ppsx 문서에 대한 I T F14 바코드 서명 생성"
description: "I T F14 바코드로 Ppsx 비즈니스 문서에 전자 서명하세요. 서명 옵션을 설정하는 몇 줄의 코드로 빠르고 쉽게 바코드 서명을 생성합니다."
...
about_formats:
    ...
    format:
        ...
        - icon: "fas fa-barcode"
          ...
          content: |
            ITF-14는 국제 무역 품목 번호를 인코딩하기 위해 Interleaved 2 of 5(ITF) 바코드를 구현한 GS1입니다.
          characterset: |
             숫자(0-9).
          textcapacity: |
             13자리 + 1 체크 디지트.
