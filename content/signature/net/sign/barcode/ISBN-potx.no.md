...
############################# Head ############################
head_title: "eSign Potx-dokument med ISBN strekkode i C#"
head_description: "Opprett ISBN strekkodesignatur og legg den på Potx-dokumentet med .NET ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer ISBN strekkodesignatur for Potx dokument i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Potx med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Potx-dokumenter med Barcode-signaturer raskt og enkelt.
