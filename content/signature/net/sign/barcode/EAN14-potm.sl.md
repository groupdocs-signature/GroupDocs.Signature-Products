...
############################# Head ############################
head_title: "eSign Potm dokument s črtno kodo E A N14 v C#"
head_description: "Ustvarite podpis črtne kode E A N14 in ga postavite na dokument Potm z .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari E A N14 podpis črtne kode za Potm dokument v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Potm z Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Potm s podpisi Barcode.
