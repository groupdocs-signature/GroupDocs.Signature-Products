...
############################# Head ############################
head_title: "eSign Bmp dokument med UPCA streckkod i C#"
head_description: "Skapa UPCA streckkodsignatur och lägg den på Bmp dokument med .NET med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera UPCA streckkodsignatur för Bmp dokument i C#"
