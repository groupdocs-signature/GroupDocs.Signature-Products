...
############################# Head ############################
head_title: "eSign Rtf tài liệu với UPCE Mã vạch trong C#"
head_description: "Tạo Chữ ký Mã vạch UPCE và đưa nó vào tài liệu Rtf với .NET bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo UPCE Chữ ký mã vạch cho tài liệu Rtf trong C#"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Rtf bằng Barcode trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Rtf bằng chữ ký Barcode một cách nhanh chóng và dễ dàng.
