...
############################# Head ############################
head_title: "eSign Rtf dokumentas su E A N14 brūkšniniu kodu C#"
head_description: "Sukurkite E A N14 brūkšninio kodo parašą ir įdėkite jį į Rtf dokumentą su .NET naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite E A N14 brūkšninio kodo parašą Rtf dokumentui C#"
description: "e. Pasirašykite Rtf verslo dokumentus naudodami E A N14 brūkšninį kodą. Greitai ir lengvai sugeneruokite brūkšninio kodo parašą naudodami kelias kodo eilutes, kad nustatytumėte pasirašymo parinktis."
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Rtf naudojant Barcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Rtf dokumentus su Barcode parašais.
...
demos:
    enable: true
    title: "Dokumentų Rtf pasirašymas naudojant Barcode tiesioginę demonstraciją"
    content: |
