...
############################# Head ############################
head_title: "eSign Docm document avec UPCA Barcode in C#"
head_description: "Créez UPCA Barcode Signature et placez-le sur le document Docm avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres UPCA pour le document Docm dans C#"
