...
############################# Head ############################
head_title: "C# で I T F14 バーコードを使用して Ods 文書に eSign"
head_description: "I T F14 バーコード署名を作成し、数行のコードを使用して .NET で Ods ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "C# の Ods ドキュメントの I T F14 バーコード署名を生成します"
description: "Ods ビジネス文書に I T F14 バーコードで電子署名します。署名オプションを設定するための数行のコードで、バーコード署名をすばやく簡単に生成します。"
