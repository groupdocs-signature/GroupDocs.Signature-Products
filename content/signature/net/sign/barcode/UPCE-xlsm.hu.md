...
############################# Head ############################
head_title: "eSign Xlsm dokumentum UPCE vonalkóddal a C# nyelven"
head_description: "Hozzon létre UPCE vonalkód-aláírást, és helyezze el a Xlsm dokumentumra a .NET termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "UPCE vonalkód aláírás létrehozása a Xlsm dokumentumhoz a C# programban"
...
steps:
    enable: true
    title_left: "A Xlsm aláírásának lépései a Barcode segítségével a C# programban"
    content_left: |
