...
############################# Head ############################
head_title: "eSign Png ሰነድ በCode39 ባርኮድ በC#"
head_description: "የCode39 ባርኮድ ፊርማ ይፍጠሩ እና በPng ሰነድ ላይ በ.NET ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በC# ውስጥ ለPng ሰነድ የCode39 ባርኮድ ፊርማ ይፍጠሩ"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) የPng ሰነዶችን በBarcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
