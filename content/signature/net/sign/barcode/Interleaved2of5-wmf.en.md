...
head_description: "Create Interleaved2of5 Barcode Signature and put it on Wmf document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."
