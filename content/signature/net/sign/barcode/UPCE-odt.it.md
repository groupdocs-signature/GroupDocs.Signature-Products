...
############################# Head ############################
head_title: "eSign Odt documento con codice a barre UPCE in C#"
head_description: "Crea UPCE Firma codice a barre e inseriscilo nel documento Odt con .NET utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera UPCE firma del codice a barre per il documento Odt in C#"
