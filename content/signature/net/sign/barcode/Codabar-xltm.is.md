...
############################# Head ############################
head_title: "eSign Xltm skjal með Codabar Strikamerki í C#"
head_description: "Búðu til Codabar Strikamerki undirskrift og settu hana á Xltm skjal með .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Signature API til að undirrita ýmis skráarsnið."

############################# Header ############################
title: "Búðu til Codabar Strikamerki undirskrift fyrir Xltm skjal í C#"
description: "eSignaðu Xltm viðskiptaskjölin þín með Codabar Strikamerki. Búðu til Strikamerki undirskrift fljótt og auðveldlega með nokkrum línum af kóða til að setja upp undirskriftarmöguleika."
...
steps:
    enable: true
    title_left: "Skref til að undirrita Xltm með Barcode í C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) veitir möguleika á að undirrita Xltm skjöl með Barcode undirskrift fljótt og auðveldlega.
...
demos:
    enable: true
    title: "Undirritar Xltm skjöl með Barcode lifandi kynningu"
    content: |
