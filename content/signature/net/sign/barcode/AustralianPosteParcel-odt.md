...
more_formats:
    ...
    content: |
        .NET AUSTRALIANPOSTEPARCEL BARCODE signatures management API for documents and images. Add AUSTRALIANPOSTEPARCEL BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
