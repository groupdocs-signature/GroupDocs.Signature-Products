...
############################# Head ############################
head_title: "Firmar electrónicamente Odt documento con Pdf417 código de barras en C#"
head_description: "Cree la firma de código de barras Pdf417 y colóquela en el documento Odt con .NET usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras Pdf417 para el documento Odt en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Odt con Barcode en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Odt con Barcode firmas de forma rápida y sencilla.
