...
############################# Head ############################
head_title: "وثيقة eSign Rtf مع Code39 رمز شريطي في C#"
head_description: "أنشئ Code39 Barcode Signature وضعه في مستند Rtf باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Code39 توقيع الرمز الشريطي للمستند Rtf في C#"
description: "قم بتوقيع Rtf على مستندات الأعمال باستخدام الرمز الشريطي Code39. قم بإنشاء توقيع الرمز الشريطي بسرعة وسهولة باستخدام بضعة أسطر من التعليمات البرمجية لإعداد خيارات التوقيع."
