...
############################# Head ############################
head_title: "eSign Tiff ሰነድ በCode39 ባርኮድ በC#"
head_description: "የCode39 ባርኮድ ፊርማ ይፍጠሩ እና በTiff ሰነድ ላይ በ.NET ሁለት የኮድ መስመሮችን በመጠቀም ያስቀምጡት። የተለያዩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "በC# ውስጥ ለTiff ሰነድ የCode39 ባርኮድ ፊርማ ይፍጠሩ"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) የTiff ሰነዶችን በBarcode ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
