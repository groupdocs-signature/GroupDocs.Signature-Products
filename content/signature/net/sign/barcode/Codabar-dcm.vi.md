...
############################# Head ############################
head_title: "eSign Dcm tài liệu với Codabar Mã vạch trong C#"
head_description: "Tạo Chữ ký Mã vạch Codabar và đưa nó vào tài liệu Dcm với .NET bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo Codabar Chữ ký mã vạch cho tài liệu Dcm trong C#"
description: "eSign các tài liệu kinh doanh Dcm của bạn bằng Mã vạch Codabar. Tạo chữ ký mã vạch nhanh chóng và dễ dàng với một vài dòng mã để thiết lập các tùy chọn ký."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Dcm bằng Barcode trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Dcm bằng chữ ký Barcode một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Dcm bằng Barcode Live Demo"
    content: |
