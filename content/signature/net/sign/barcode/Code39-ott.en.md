...
############################# Head ############################
head_title: "eSign Ott document with Code39 Barcode in C#"
head_description: "Create Code39 Barcode Signature on Ott file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Generate Code39 Barcode signature for Ott document in C#"
description: "eSign your Ott business documents with Code39 Barcode. Generate Barcode signature quick, easy and simple with few lines of code to set up signing options."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Ott documents with Barcode signatures quickly and easily.
