...
############################# Head ############################
head_title: "eSign Xls-dokument met ISBN Strepiekode in C#"
head_description: "Skep ISBN Strepiekode Handtekening en plaas dit op Xls dokument met .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer ISBN strepieskode-handtekening vir Xls-dokument in C#"
...
steps:
    enable: true
    title_left: "Stappe om Xls met Barcode in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Xls dokumente met Barcode handtekeninge vinnig en maklik te onderteken.
