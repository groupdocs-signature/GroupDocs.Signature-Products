...
############################# Head ############################
head_title: "Document electrònic Docx amb codi de barres UPCA a C#"
head_description: "Creeu la signatura de codi de barres UPCA i poseu-la al document Docx amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu UPCA signatura de codi de barres per al document Docx a C#"
