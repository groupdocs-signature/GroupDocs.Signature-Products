...
############################# Head ############################
head_title: "eSign Xltm-dokument med Codabar strekkode i C#"
head_description: "Opprett Codabar strekkodesignatur og legg den på Xltm-dokumentet med .NET ved å bruke et par linjer med kode. Bruk GroupDocs Document Signature API for å signere ulike filformater."

############################# Header ############################
title: "Generer Codabar strekkodesignatur for Xltm dokument i C#"
description: "eSignér Xltm-bedriftsdokumentene dine med Codabar strekkode. Generer strekkodesignatur raskt og enkelt med noen få linjer med kode for å sette opp signeringsalternativer."
...
steps:
    enable: true
    title_left: "Trinn for å signere Xltm med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Xltm-dokumenter med Barcode-signaturer raskt og enkelt.
