...
############################# Head ############################
head_title: "eSign Doc documento con codice a barre Postnet in C#"
head_description: "Crea Postnet Firma codice a barre e inseriscilo nel documento Doc con .NET utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Postnet firma del codice a barre per il documento Doc in C#"
