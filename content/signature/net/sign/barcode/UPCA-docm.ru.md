...
############################# Head ############################
head_title: "eSign Docm документ со штрих-кодом UPCA в C#"
head_description: "Создайте подпись штрих-кода UPCA и поместите ее в документ Docm с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода UPCA для документа Docm в C#"
