...
############################# Head ############################
head_title: "eSign Png document avec E A N14 Barcode in C#"
head_description: "Créez E A N14 Barcode Signature et placez-le sur le document Png avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres E A N14 pour le document Png dans C#"
...
steps:
    enable: true
    title_left: "Étapes pour signer Png avec Barcode dans C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permet de signer rapidement et facilement des documents Png avec des signatures Barcode.
