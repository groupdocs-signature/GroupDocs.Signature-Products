...
############################# Head ############################
head_title: "eSign Bmp doiciméad le UPCE Barcode in C#"
head_description: "Cruthaigh UPCE Síniú Barrachóid agus cuir ar Bmp doiciméad le .NET ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid UPCE don doiciméad Bmp in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Bmp a shíniú le Barcode in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Bmp a shíniú le sínithe Barcode go tapa agus go héasca.
