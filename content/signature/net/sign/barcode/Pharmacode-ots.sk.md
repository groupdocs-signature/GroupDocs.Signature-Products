...
############################# Head ############################
head_title: "eSign Ots dokument s Pharmacode čiarovým kódom v C#"
head_description: "Vytvorte podpis čiarového kódu Pharmacode a vložte ho do dokumentu Ots s .NET pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte Pharmacode podpis čiarového kódu pre dokument Ots v C#"
