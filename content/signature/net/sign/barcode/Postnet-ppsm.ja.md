...
############################# Head ############################
head_title: "C# で Postnet バーコードを使用して Ppsm 文書に eSign"
head_description: "Postnet バーコード署名を作成し、数行のコードを使用して .NET で Ppsm ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "C# の Ppsm ドキュメントの Postnet バーコード署名を生成します"
description: "Ppsm ビジネス文書に Postnet バーコードで電子署名します。署名オプションを設定するための数行のコードで、バーコード署名をすばやく簡単に生成します。"
