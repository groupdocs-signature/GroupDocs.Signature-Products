...
############################# Head ############################
head_title: "eSign Ppt dokumen dengan ISBN Barcode di C#"
head_description: "Buat ISBN Tanda Tangan Barcode dan letakkan di dokumen Ppt dengan .NET menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat ISBN Tanda tangan kode batang untuk dokumen Ppt di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Ppt dengan Barcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Ppt dengan Barcode tanda tangan dengan cepat dan mudah.
