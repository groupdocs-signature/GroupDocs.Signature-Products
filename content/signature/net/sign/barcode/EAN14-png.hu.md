...
############################# Head ############################
head_title: "eSign Png dokumentum E A N14 vonalkóddal a C# nyelven"
head_description: "Hozzon létre E A N14 vonalkód-aláírást, és helyezze el a Png dokumentumra a .NET termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "E A N14 vonalkód aláírás létrehozása a Png dokumentumhoz a C# programban"
...
steps:
    enable: true
    title_left: "A Png aláírásának lépései a Barcode segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Png dokumentumok gyors és egyszerű aláírását Barcode aláírással.
