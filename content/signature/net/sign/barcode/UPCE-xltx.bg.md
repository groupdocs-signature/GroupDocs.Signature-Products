...
############################# Head ############################
head_title: "eSign Xltx документ с UPCE баркод в C#"
head_description: "Създайте UPCE баркод подпис и го поставете в Xltx документ с .NET, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature за подписване на различни файлови формати."

############################# Header ############################
title: "Генерирайте UPCE баркод подпис за документ Xltx в C#"
