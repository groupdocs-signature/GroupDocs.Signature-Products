...
############################# Head ############################
head_title: "eSign Dotm tài liệu với Codabar Mã vạch trong C#"
head_description: "Tạo Chữ ký Mã vạch Codabar và đưa nó vào tài liệu Dotm với .NET bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo Codabar Chữ ký mã vạch cho tài liệu Dotm trong C#"
description: "eSign các tài liệu kinh doanh Dotm của bạn bằng Mã vạch Codabar. Tạo chữ ký mã vạch nhanh chóng và dễ dàng với một vài dòng mã để thiết lập các tùy chọn ký."
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Dotm bằng Barcode trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Dotm bằng chữ ký Barcode một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Dotm bằng Barcode Live Demo"
    content: |
