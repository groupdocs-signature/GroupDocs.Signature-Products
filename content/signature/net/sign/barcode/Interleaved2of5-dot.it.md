...
############################# Head ############################
head_title: "eSign Dot documento con codice a barre Interleaved2of5 in C#"
head_description: "Crea Interleaved2of5 Firma codice a barre e inseriscilo nel documento Dot con .NET utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera Interleaved2of5 firma del codice a barre per il documento Dot in C#"
...
steps:
    enable: true
    title_left: "Passaggi per firmare Dot con Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Dot con firme Barcode in modo rapido e semplice.
