...
head_description: "Create I T F14 Barcode Signature on Ods file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."
