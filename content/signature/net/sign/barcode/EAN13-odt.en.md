...
############################# Head ############################
head_title: "eSign Odt document with E A N13 Barcode in C#"
head_description: "Create E A N13 Barcode Signature on Odt file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens file formats."

############################# Header ############################
title: "Generate E A N13 Barcode signature for Odt document in C#"
description: "eSign your Odt business documents with E A N13 Barcode. Generate Barcode signature quick, easy and simple with few lines of code to set up signing options.!"
...
more_formats:
    enable: true
    title: "Signing Other Document Formats with E A N13 Barcode using C#"
    content: |
        .NET E A N13 Barcode signatures management API for documents and images. Add E A N13 Barcode signatures to some of the popular file formats as stated below.
    format: 
