...
############################# Head ############################
head_title: "eSign Bmp documento com E A N14 Código de barras em C#"
head_description: "Crie uma assinatura de código de barras E A N14 e coloque-a no documento Bmp com .NET usando algumas linhas de código. Use a API de assinatura de documento do GroupDocs para assinar vários formatos de arquivo."

############################# Header ############################
title: "Gere assinatura de código de barras E A N14 para Bmp documento em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Bmp com Barcode em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Bmp com assinaturas Barcode de forma rápida e fácil.
