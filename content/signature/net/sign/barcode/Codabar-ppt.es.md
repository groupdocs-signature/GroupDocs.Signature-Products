...
############################# Head ############################
head_title: "Firmar electrónicamente Ppt documento con Codabar código de barras en C#"
head_description: "Cree la firma de código de barras Codabar y colóquela en el documento Ppt con .NET usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras Codabar para el documento Ppt en C#"
