...
############################# Head ############################
head_title: "eSign Doc dokument s črtno kodo Pharmacode v C#"
head_description: "Ustvarite podpis črtne kode Pharmacode in ga postavite na dokument Doc z .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari Pharmacode podpis črtne kode za Doc dokument v C#"
description: "e-Podpišite svoje Doc poslovne dokumente s črtno kodo Pharmacode. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Doc z Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Doc s podpisi Barcode.
