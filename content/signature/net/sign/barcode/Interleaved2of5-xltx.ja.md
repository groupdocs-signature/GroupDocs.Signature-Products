...
############################# Head ############################
head_title: "C# で Interleaved2of5 バーコードを使用して Xltx 文書に eSign"
head_description: "Interleaved2of5 バーコード署名を作成し、数行のコードを使用して .NET で Xltx ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "C# の Xltx ドキュメントの Interleaved2of5 バーコード署名を生成します"
...
steps:
    enable: true
    title_left: "C# で Barcode を使用して Xltx に署名する手順"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) は、Xltx ドキュメントに Barcode 署名ですばやく簡単に署名する機能を提供します。
