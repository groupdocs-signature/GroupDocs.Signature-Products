...
############################# Head ############################
head_title: "eSign Dotm dokument med E A N13 streckkod i C#"
head_description: "Skapa E A N13 streckkodsignatur och lägg den på Dotm dokument med .NET med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera E A N13 streckkodsignatur för Dotm dokument i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Dotm med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Dotm-dokument med Barcode-signaturer snabbt och enkelt.
