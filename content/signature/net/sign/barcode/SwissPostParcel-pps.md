...
more_formats:
    ...
    content: |
        .NET SWISSPOSTPARCEL BARCODE signatures management API for documents and images. Add SWISSPOSTPARCEL BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
