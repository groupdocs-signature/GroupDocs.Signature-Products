...
############################# Head ############################
head_title: "eSign Csv dokument s črtno kodo E A N14 v C#"
head_description: "Ustvarite podpis črtne kode E A N14 in ga postavite na dokument Csv z .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari E A N14 podpis črtne kode za Csv dokument v C#"
description: "e-Podpišite svoje Csv poslovne dokumente s črtno kodo E A N14. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Csv z Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Csv s podpisi Barcode.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Csv z Barcode Live Demo"
    content: |
