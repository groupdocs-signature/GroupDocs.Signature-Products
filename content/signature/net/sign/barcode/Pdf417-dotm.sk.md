...
############################# Head ############################
head_title: "eSign Dotm dokument s Pdf417 čiarovým kódom v C#"
head_description: "Vytvorte podpis čiarového kódu Pdf417 a vložte ho do dokumentu Dotm s .NET pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte Pdf417 podpis čiarového kódu pre dokument Dotm v C#"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Dotm pomocou čiarového kódu Pdf417. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
