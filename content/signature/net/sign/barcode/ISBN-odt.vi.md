...
############################# Head ############################
head_title: "eSign Odt tài liệu với ISBN Mã vạch trong C#"
head_description: "Tạo Chữ ký Mã vạch ISBN và đưa nó vào tài liệu Odt với .NET bằng cách sử dụng một vài dòng mã. Sử dụng API Chữ ký Tài liệu GroupDocs để ký các định dạng tệp khác nhau."

############################# Header ############################
title: "Tạo ISBN Chữ ký mã vạch cho tài liệu Odt trong C#"
