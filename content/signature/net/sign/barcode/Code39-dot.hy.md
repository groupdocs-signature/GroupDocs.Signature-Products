...
############################# Head ############################
head_title: "eSign Dot փաստաթուղթը Code39 շտրիխ կոդով C#-ում"
head_description: "Ստեղծեք Code39 շտրիխ կոդի ստորագրություն և դրեք այն Dot փաստաթղթում .NET-ով` օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs Document Signature API-ը՝ տարբեր ֆայլերի ձևաչափեր ստորագրելու համար:"

############################# Header ############################
title: "Ստեղծեք Code39 շտրիխ կոդ ստորագրություն Dot փաստաթղթի համար C#-ում"
...
steps:
    enable: true
    title_left: "Dot-ը Barcode-ով C#-ով ստորագրելու քայլեր"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) հնարավորություն է տալիս արագ և հեշտությամբ ստորագրել Dot փաստաթղթերը Barcode ստորագրություններով:
