...
############################# Head ############################
head_title: "Документ eSign Dotm зі штрих-кодом E A N14 у C#"
head_description: "Створіть підпис штрих-коду E A N14 і додайте його в документ Dotm за допомогою .NET за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs для підпису різних форматів файлів."

############################# Header ############################
title: "Згенеруйте підпис штрих-коду E A N14 для документа Dotm у C#"
description: "Електронно підписуйте свої ділові документи Dotm штрих-кодом E A N14. Згенеруйте підпис штрих-коду швидко та легко за допомогою кількох рядків коду, щоб налаштувати параметри підпису."
...
steps:
    enable: true
    title_left: "Кроки для підпису Dotm за допомогою Barcode у C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає можливість швидко та легко підписувати документи Dotm за допомогою підписів Barcode.
...
demos:
    enable: true
    title: "Підпис документів Dotm за допомогою Barcode Live Demo"
    content: |
