...
############################# Head ############################
head_title: "eSign Png doiciméad le ISBN Barcode in C#"
head_description: "Cruthaigh ISBN Síniú Barrachóid agus cuir ar Png doiciméad le .NET ag baint úsáide as cúpla líne de chód. Bain úsáid as an GroupDocs Document Signature API chun formáidí éagsúla comhaid a shíniú."

############################# Header ############################
title: "Gin síniú barrachóid ISBN don doiciméad Png in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Png a shíniú le Barcode in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Png a shíniú le sínithe Barcode go tapa agus go héasca.
