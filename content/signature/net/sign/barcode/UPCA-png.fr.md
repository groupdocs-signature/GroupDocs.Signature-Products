...
############################# Head ############################
head_title: "eSign Png document avec UPCA Barcode in C#"
head_description: "Créez UPCA Barcode Signature et placez-le sur le document Png avec .NET en utilisant quelques lignes de code. Utilisez l'API GroupDocs Document Signature pour signer divers formats de fichiers."

############################# Header ############################
title: "Générer la signature de code-barres UPCA pour le document Png dans C#"
