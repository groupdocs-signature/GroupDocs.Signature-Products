...
head_description: "Create Codabar Barcode Signature and put it on Potx document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."
