...
############################# Head ############################
head_title: "eSign Potm dokumentum UPCE vonalkóddal a C# nyelven"
head_description: "Hozzon létre UPCE vonalkód-aláírást, és helyezze el a Potm dokumentumra a .NET termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "UPCE vonalkód aláírás létrehozása a Potm dokumentumhoz a C# programban"
description: "eAláírja Potm üzleti dokumentumait UPCE vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
steps:
    enable: true
    title_left: "A Potm aláírásának lépései a Barcode segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Potm dokumentumok gyors és egyszerű aláírását Barcode aláírással.
...
demos:
    enable: true
    title: "Potm dokumentumok aláírása Barcode élő bemutatóval"
    content: |
