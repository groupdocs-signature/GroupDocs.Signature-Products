...
############################# Head ############################
head_title: "Xltx-Dokument mit E A N14-Barcode in C# eSignieren"
head_description: "Erstellen Sie eine E A N14-Barcode-Signatur und fügen Sie sie mit ein paar Codezeilen in ein Xltx-Dokument mit .NET ein. Verwenden Sie die GroupDocs Document Signature API zum Signieren verschiedener Dateiformate."

############################# Header ############################
title: "E A N14-Barcode-Signatur für Xltx-Dokument in C# generieren"
description: "Unterzeichnen Sie Ihre Xltx-Geschäftsdokumente mit E A N14-Barcode. Generieren Sie Barcode-Signaturen schnell und einfach mit wenigen Codezeilen, um Signaturoptionen einzurichten."
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Xltx mit Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Xltx-Dokumente mit Barcode-Signaturen schnell und einfach zu signieren.
...
demos:
    enable: true
    title: "Signieren von Xltx-Dokumenten mit Barcode Live-Demo"
    content: |
