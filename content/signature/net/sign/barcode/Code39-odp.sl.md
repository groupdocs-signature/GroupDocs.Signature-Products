...
############################# Head ############################
head_title: "eSign Odp dokument s črtno kodo Code39 v C#"
head_description: "Ustvarite podpis črtne kode Code39 in ga postavite na dokument Odp z .NET z nekaj vrsticami kode. Uporabite API za podpis dokumentov GroupDocs za podpisovanje različnih formatov datotek."

############################# Header ############################
title: "Ustvari Code39 podpis črtne kode za Odp dokument v C#"
description: "e-Podpišite svoje Odp poslovne dokumente s črtno kodo Code39. Hitro in preprosto ustvarite podpis črtne kode z nekaj vrsticami kode za nastavitev možnosti podpisovanja."
...
steps:
    enable: true
    title_left: "Koraki za podpis Odp z Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Odp s podpisi Barcode.
