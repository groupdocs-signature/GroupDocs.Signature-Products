...
############################# Head ############################
head_title: "eSign Pptm dokumen dengan Code39 Barcode di C#"
head_description: "Buat Code39 Tanda Tangan Barcode dan letakkan di dokumen Pptm dengan .NET menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat Code39 Tanda tangan kode batang untuk dokumen Pptm di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Pptm dengan Barcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Pptm dengan Barcode tanda tangan dengan cepat dan mudah.
