...
############################# Head ############################
head_title: "وثيقة eSign Ppsm مع Codabar رمز شريطي في C#"
head_description: "أنشئ Codabar Barcode Signature وضعه في مستند Ppsm باستخدام .NET باستخدام سطرين من الشفرة. استخدم GroupDocs Document Signature API لتوقيع تنسيقات ملفات متنوعة."

############################# Header ############################
title: "إنشاء Codabar توقيع الرمز الشريطي للمستند Ppsm في C#"
