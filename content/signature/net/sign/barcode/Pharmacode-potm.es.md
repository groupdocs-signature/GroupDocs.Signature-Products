...
############################# Head ############################
head_title: "Firmar electrónicamente Potm documento con Pharmacode código de barras en C#"
head_description: "Cree la firma de código de barras Pharmacode y colóquela en el documento Potm con .NET usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras Pharmacode para el documento Potm en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Potm con Barcode en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Potm con Barcode firmas de forma rápida y sencilla.
