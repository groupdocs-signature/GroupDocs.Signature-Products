...
############################# Head ############################
head_title: "eSign Ott-dokument met UPCE Strepiekode in C#"
head_description: "Skep UPCE Strepiekode Handtekening en plaas dit op Ott dokument met .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API vir die ondertekening van verskeie lêerformate."

############################# Header ############################
title: "Genereer UPCE strepieskode-handtekening vir Ott-dokument in C#"
