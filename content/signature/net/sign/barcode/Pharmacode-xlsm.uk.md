...
############################# Head ############################
head_title: "Документ eSign Xlsm зі штрих-кодом Pharmacode у C#"
head_description: "Створіть підпис штрих-коду Pharmacode і додайте його в документ Xlsm за допомогою .NET за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs для підпису різних форматів файлів."

############################# Header ############################
title: "Згенеруйте підпис штрих-коду Pharmacode для документа Xlsm у C#"
