...
############################# Head ############################
head_title: "eSign Ott dokument Code39 vöötkoodiga keeles C#"
head_description: "Looge Code39 vöötkoodisignatuur ja lisage see paari koodirea abil dokumendile Ott tootega .NET. Kasutage GroupDocs Document Signature API-d erinevate failivormingute allkirjastamiseks."

############################# Header ############################
title: "Looge C#-s dokumendile Ott vöötkoodiallkiri Code39"
description: "eAllkirjasta oma Ott äridokumendid Code39 vöötkoodiga. Looge vöötkoodisignatuur kiiresti ja lihtsalt mõne koodirea abil allkirjastamisvalikute seadistamiseks."
...
steps:
    enable: true
    title_left: "Toimingud Ott allkirjastamiseks rakendusega Barcode rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Ott dokumente Barcode allkirjaga.
