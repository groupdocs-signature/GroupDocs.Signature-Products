...
############################# Head ############################
head_title: "eSign Pptm dokumentum UPCE vonalkóddal a C# nyelven"
head_description: "Hozzon létre UPCE vonalkód-aláírást, és helyezze el a Pptm dokumentumra a .NET termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "UPCE vonalkód aláírás létrehozása a Pptm dokumentumhoz a C# programban"
...
steps:
    enable: true
    title_left: "A Pptm aláírásának lépései a Barcode segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Pptm dokumentumok gyors és egyszerű aláírását Barcode aláírással.
