...
############################# Head ############################
head_title: "eSign Xls documento con codice a barre E A N14 in C#"
head_description: "Crea E A N14 Firma codice a barre e inseriscilo nel documento Xls con .NET utilizzando un paio di righe di codice. Utilizza l'API per la firma dei documenti di GroupDocs per firmare vari formati di file."

############################# Header ############################
title: "Genera E A N14 firma del codice a barre per il documento Xls in C#"
description: "Firma elettronicamente i tuoi documenti aziendali Xls con il codice a barre E A N14. Genera la firma del codice a barre in modo rapido e semplice con poche righe di codice per impostare le opzioni di firma."
...
steps:
    enable: true
    title_left: "Passaggi per firmare Xls con Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) offre la possibilità di firmare documenti Xls con firme Barcode in modo rapido e semplice.
