...
############################# Head ############################
head_title: "C# で Interleaved2of5 バーコードを使用して Ppsx 文書に eSign"
head_description: "Interleaved2of5 バーコード署名を作成し、数行のコードを使用して .NET で Ppsx ドキュメントに配置します。 GroupDocs Document Signature API を使用して、さまざまなファイル形式に署名します。"

############################# Header ############################
title: "C# の Ppsx ドキュメントの Interleaved2of5 バーコード署名を生成します"
