...
############################# Head ############################
head_title: "eSign Webp dokumentas su Code39 brūkšniniu kodu C#"
head_description: "Sukurkite Code39 brūkšninio kodo parašą ir įdėkite jį į Webp dokumentą su .NET naudodami kelias kodo eilutes. Naudokite GroupDocs Document Signature API norėdami pasirašyti įvairius failų formatus."

############################# Header ############################
title: "Sugeneruokite Code39 brūkšninio kodo parašą Webp dokumentui C#"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Webp naudojant Barcode programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Webp dokumentus su Barcode parašais.
