...
more_formats:
    ...
    content: |
        .NET ITALIANPOST25 BARCODE signatures management API for documents and images. Add ITALIANPOST25 BARCODE signatures to some of the popular file formats as stated below.
    format: 
        # format loop
