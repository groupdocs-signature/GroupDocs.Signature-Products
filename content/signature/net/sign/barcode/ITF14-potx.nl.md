...
head_description: "Maak een I T F14 Barcode Signature en plaats deze op het Potx document met .NET met behulp van een paar regels code. Gebruik de GroupDocs Document Signature API voor het ondertekenen van verschillende bestandsindelingen."
