...
############################# Head ############################
head_title: "Firmar electrónicamente Ppt documento con E A N14 código de barras en C#"
head_description: "Cree la firma de código de barras E A N14 y colóquela en el documento Ppt con .NET usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras E A N14 para el documento Ppt en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Ppt con Barcode en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Ppt con Barcode firmas de forma rápida y sencilla.
