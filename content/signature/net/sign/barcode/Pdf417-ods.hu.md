...
############################# Head ############################
head_title: "eSign Ods dokumentum Pdf417 vonalkóddal a C# nyelven"
head_description: "Hozzon létre Pdf417 vonalkód-aláírást, és helyezze el a Ods dokumentumra a .NET termékkel, néhány sor kóddal. Használja a GroupDocs Document Signature API-t különböző fájlformátumok aláírásához."

############################# Header ############################
title: "Pdf417 vonalkód aláírás létrehozása a Ods dokumentumhoz a C# programban"
description: "eAláírja Ods üzleti dokumentumait Pdf417 vonalkóddal. Néhány soros kóddal gyorsan és egyszerűen generálhat vonalkód-aláírást az aláírási lehetőségek beállításához."
...
steps:
    enable: true
    title_left: "A Ods aláírásának lépései a Barcode segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Ods dokumentumok gyors és egyszerű aláírását Barcode aláírással.
