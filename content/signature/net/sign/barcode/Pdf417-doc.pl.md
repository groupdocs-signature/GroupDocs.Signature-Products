...
############################# Head ############################
head_title: "Podpisz dokument Doc z kodem kreskowym Pdf417 w C#"
head_description: "Utwórz podpis z kodem kreskowym Pdf417 i umieść go w dokumencie Doc za pomocą .NET, używając kilku linijek kodu. Użyj interfejsu GroupDocs Document Signature API do podpisywania różnych formatów plików."

############################# Header ############################
title: "Wygeneruj Pdf417 podpis z kodem kreskowym dla dokumentu Doc w C#"
description: "ePodpisz swoje dokumenty biznesowe w Doc za pomocą kodu kreskowego Pdf417. Szybko i łatwo generuj podpis z kodem kreskowym za pomocą kilku linijek kodu, aby skonfigurować opcje podpisywania."
...
steps:
    enable: true
    title_left: "Kroki do podpisania Doc za pomocą Barcode w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Doc za pomocą podpisów Barcode.
