...
############################# Head ############################
head_title: "eSign Xlsb dokument s Code39 čiarovým kódom v C#"
head_description: "Vytvorte podpis čiarového kódu Code39 a vložte ho do dokumentu Xlsb s .NET pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte Code39 podpis čiarového kódu pre dokument Xlsb v C#"
description: "ePodpíšte svoje obchodné dokumenty vo formáte Xlsb pomocou čiarového kódu Code39. Vygenerujte podpis čiarového kódu rýchlo a jednoducho pomocou niekoľkých riadkov kódu na nastavenie možností podpisovania."
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xlsb pomocou Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xlsb pomocou podpisov Barcode.
