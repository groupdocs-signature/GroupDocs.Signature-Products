...
############################# Head ############################
head_title: "Документ eSign Xlsb зі штрих-кодом Interleaved2of5 у C#"
head_description: "Створіть підпис штрих-коду Interleaved2of5 і додайте його в документ Xlsb за допомогою .NET за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs для підпису різних форматів файлів."

############################# Header ############################
title: "Згенеруйте підпис штрих-коду Interleaved2of5 для документа Xlsb у C#"
