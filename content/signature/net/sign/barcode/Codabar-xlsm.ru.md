...
############################# Head ############################
head_title: "eSign Xlsm документ со штрих-кодом Codabar в C#"
head_description: "Создайте подпись штрих-кода Codabar и поместите ее в документ Xlsm с .NET, используя пару строк кода. Используйте API подписи документов GroupDocs для подписи файлов различных форматов."

############################# Header ############################
title: "Создайте подпись штрих-кода Codabar для документа Xlsm в C#"
description: "Подпишите свои бизнес-документы Xlsm с помощью штрих-кода Codabar. Быстро и легко создавайте подпись штрих-кода с помощью нескольких строк кода для настройки параметров подписи."
