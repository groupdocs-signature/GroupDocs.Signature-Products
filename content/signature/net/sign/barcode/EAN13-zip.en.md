...
############################# Head ############################
head_title: "eSign Zip document with E A N13 Barcode in C#"
head_description: "Create E A N13 Barcode Signature and put it on Zip document with .NET using a couple lines of code. Use the GroupDocs Document Signature API for signing various file formats."

############################# Header ############################
title: "Generate E A N13 Barcode signature for Zip document in C#"
...
steps:
    enable: true
    title_left: "Steps to sign Zip with Barcode in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Zip documents with Barcode signatures quickly and easily.
