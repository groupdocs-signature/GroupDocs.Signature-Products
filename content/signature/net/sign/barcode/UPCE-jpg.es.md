...
############################# Head ############################
head_title: "Firmar electrónicamente Jpg documento con UPCE código de barras en C#"
head_description: "Cree la firma de código de barras UPCE y colóquela en el documento Jpg con .NET usando un par de líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar varios formatos de archivo."

############################# Header ############################
title: "Genere la firma de código de barras UPCE para el documento Jpg en C#"
