...
############################# Head ############################
head_title: "eSign Odt dokument med E A N13 streckkod i C#"
head_description: "Skapa E A N13 streckkodsignatur och lägg den på Odt dokument med .NET med ett par rader kod. Använd GroupDocs Document Signature API för att signera olika filformat."

############################# Header ############################
title: "Generera E A N13 streckkodsignatur för Odt dokument i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Odt med Barcode i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Odt-dokument med Barcode-signaturer snabbt och enkelt.
