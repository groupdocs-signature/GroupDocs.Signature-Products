...
############################# Head ############################
head_title: "eSign Wmf dokument s Code39 čiarovým kódom v C#"
head_description: "Vytvorte podpis čiarového kódu Code39 a vložte ho do dokumentu Wmf s .NET pomocou niekoľkých riadkov kódu. Na podpisovanie rôznych formátov súborov použite rozhranie GroupDocs Document Signature API."

############################# Header ############################
title: "Vygenerujte Code39 podpis čiarového kódu pre dokument Wmf v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Wmf pomocou Barcode v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Wmf pomocou podpisov Barcode.
