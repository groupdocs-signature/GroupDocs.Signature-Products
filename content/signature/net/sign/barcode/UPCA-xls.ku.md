...
############################# Head ############################
head_title: "eSign Xls belgeya bi UPCA Barcode di C#"
head_description: "Îmzeya barkodê ya UPCA biafirîne û bi çend rêzikên kodê bi .NET li ser belgeya Xls biafirîne. Ji bo îmzekirina cûrbecûr formatên pelan API-ya Îmzekirina Belgeya GroupDocs bikar bînin."
