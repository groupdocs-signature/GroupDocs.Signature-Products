...
############################# Head ############################
head_title: "Document electrònic Png amb codi de barres UPCE a C#"
head_description: "Creeu la signatura de codi de barres UPCE i poseu-la al document Png amb .NET utilitzant un parell de línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar diversos formats de fitxer."

############################# Header ############################
title: "Genereu UPCE signatura de codi de barres per al document Png a C#"
...
steps:
    enable: true
    title_left: "Passos per signar Png amb Barcode a C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix la possibilitat de signar documents Png amb signatures Barcode de manera ràpida i senzilla.
