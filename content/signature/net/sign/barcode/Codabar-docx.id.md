...
############################# Head ############################
head_title: "eSign Docx dokumen dengan Codabar Barcode di C#"
head_description: "Buat Codabar Tanda Tangan Barcode dan letakkan di dokumen Docx dengan .NET menggunakan beberapa baris kode. Gunakan API Tanda Tangan Dokumen GroupDocs untuk menandatangani berbagai format file."

############################# Header ############################
title: "Buat Codabar Tanda tangan kode batang untuk dokumen Docx di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Docx dengan Barcode di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Docx dengan Barcode tanda tangan dengan cepat dan mudah.
