...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Png lêer met C#"
head_description: "Plaas Image Handtekening op Png lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Png lêers met Image handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Png met Image in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Png dokumente met Image handtekeninge vinnig en maklik te onderteken.
