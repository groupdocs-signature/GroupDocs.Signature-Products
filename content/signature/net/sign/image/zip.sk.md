...
############################# Head ############################
head_title: "Pridanie podpisov Image do súboru Zip pomocou C#"
head_description: "Vložte podpis Image do súboru Zip pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Zip pomocou podpisov Image v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Zip pomocou Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Zip pomocou podpisov Image.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Zip pomocou živej ukážky Image"
    content: |
