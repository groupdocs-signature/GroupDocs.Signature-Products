...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Xls rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Xls, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Xls allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Xls allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Xls dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Xls allkirjastamine Image reaalajas demoga"
    content: |
