...
############################# Head ############################
head_title: "Adicionando assinaturas Image ao arquivo Otp com C#"
head_description: "Coloque a assinatura Image no arquivo Otp para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Otp arquivos com assinaturas Image em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Otp com Image em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Otp com assinaturas Image de forma rápida e fácil.
