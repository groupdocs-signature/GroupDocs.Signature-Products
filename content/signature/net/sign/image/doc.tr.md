...
############################# Head ############################
head_title: "C# ile Doc dosyasına Image imza ekleme"
head_description: "Birkaç satır kod kullanarak .NET için Doc dosyasına Image İmza koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Doc dosyalarını Image imzasıyla C# içinde imzalayın"
...
steps:
    enable: true
    title_left: "C# içinde Image ile Doc imzalama adımları"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Doc belgelerini Image imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
...
demos:
    enable: true
    title: "Doc dokümanı Image Canlı Demo ile imzalama"
    content: |
