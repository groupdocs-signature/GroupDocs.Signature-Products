...
############################# Head ############################
head_title: "Tilføjelse af Image-signaturer til Xls-fil med C#"
head_description: "Sæt Image Signatur på Xls fil for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Xls-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trin til at signere Xls med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Xls dokumenter med Image signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Xls dokumenter med Image Live Demo"
    content: |
