...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko Ots z C#"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko Ots za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Ots datoteke s podpisi Image v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Ots z Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Ots s podpisi Image.
