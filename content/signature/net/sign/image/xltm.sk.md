...
############################# Head ############################
head_title: "Pridanie podpisov Image do súboru Xltm pomocou C#"
head_description: "Vložte podpis Image do súboru Xltm pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Xltm pomocou podpisov Image v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xltm pomocou Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xltm pomocou podpisov Image.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Xltm pomocou živej ukážky Image"
    content: |
