...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Tiff lêer met C#"
head_description: "Plaas Image Handtekening op Tiff lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Tiff lêers met Image handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Tiff met Image in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Tiff dokumente met Image handtekeninge vinnig en maklik te onderteken.
...
demos:
    enable: true
    title: "Teken Tiff dokumente met Image Regstreekse Demo"
    content: |
