...
############################# Head ############################
head_title: "Ag cur Image sínithe le comhad Ott le C#"
head_description: "Cuir Image Síniú ar Ott comhad le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Ott comhad le sínithe Image in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Ott a shíniú le Image in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Ott a shíniú le sínithe Image go tapa agus go héasca.
