...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Ppsx lêer met C#"
head_description: "Plaas Image Handtekening op Ppsx lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Ppsx lêers met Image handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Ppsx met Image in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Ppsx dokumente met Image handtekeninge vinnig en maklik te onderteken.
