...
############################# Head ############################
head_title: "Legger til Image-signaturer til Xlsb-filen med C#"
head_description: "Sett Image-signatur på Xlsb-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Xlsb-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Xlsb med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Xlsb-dokumenter med Image-signaturer raskt og enkelt.
