...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Pps rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Pps, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Pps allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Pps allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Pps dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Pps allkirjastamine Image reaalajas demoga"
    content: |
