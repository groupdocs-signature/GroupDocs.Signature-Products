...
############################# Head ############################
head_title: "Image handtekeningen toevoegen aan Dotm bestand met C#"
head_description: "Zet Image Signature op Dotm bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Dotm bestanden met Image handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Dotm te ondertekenen met Image in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Dotm documenten snel en gemakkelijk te ondertekenen met Image handtekeningen.
