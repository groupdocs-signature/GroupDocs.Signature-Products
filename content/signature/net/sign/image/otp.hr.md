...
############################# Head ############################
head_title: "Dodavanje potpisa Image u datoteku Otp s C#"
head_description: "Stavite potpis Image na datoteku Otp za .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Otp datoteke s Image potpisima u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Otp s Image u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Otp dokumenata s Image potpisima.
...
demos:
    enable: true
    title: "Potpisivanje Otp dokumenata s Image Live Demo"
    content: |
