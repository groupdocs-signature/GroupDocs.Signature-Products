...
############################# Head ############################
head_title: "Додавання підписів Image до файлу Docm за допомогою C#"
head_description: "Додайте підпис Image до файлу Docm для .NET за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs, щоб підписувати десятки форматів файлів."

############################# Header ############################
title: "Підпишіть файли Docm підписами Image у C#"
...
steps:
    enable: true
    title_left: "Кроки для підпису Docm за допомогою Image у C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає можливість швидко та легко підписувати документи Docm за допомогою підписів Image.
...
demos:
    enable: true
    title: "Підпис документів Docm за допомогою Image Live Demo"
    content: |
