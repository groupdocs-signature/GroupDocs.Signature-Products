...
############################# Head ############################
head_title: "Allekirjoitusten Image lisääminen tiedostoon Svg ohjelmalla C#"
head_description: "Aseta Image Allekirjoitus Svg-tiedostoon .NET käyttämällä muutamaa koodiriviä. Käytä GroupDocs Document Signature API allekirjoittaaksesi kymmeniä tiedostomuotoja."

############################# Header ############################
title: "Allekirjoita Svg tiedostot Image allekirjoituksilla C#"
...
steps:
    enable: true
    title_left: "Vaiheet Svg:n allekirjoittamiseen Image -sovelluksella C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tarjoaa mahdollisuuden allekirjoittaa Svg-asiakirjoja Image-allekirjoituksella nopeasti ja helposti.
...
demos:
    enable: true
    title: "Allekirjoitetaan Svg asiakirjoja Image Live-demolla"
    content: |
