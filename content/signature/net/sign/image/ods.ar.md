...
############################# Head ############################
head_title: "إضافة Image توقيعات إلى ملف Ods باستخدام C#"
head_description: "ضع Image التوقيع على ملف Ods لـ .NET باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات Ods بتوقيعات Image في C#"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Ods باستخدام Image في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Ods بتوقيعات Image بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Ods باستخدام العرض التوضيحي المباشر Image"
    content: |
