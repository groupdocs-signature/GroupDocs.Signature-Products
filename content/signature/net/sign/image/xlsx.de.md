...
############################# Head ############################
head_title: "Hinzufügen von Image-Signaturen zur Xlsx-Datei mit C#"
head_description: "Fügen Sie die Image-Signatur in die Xlsx-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Xlsx-Dateien mit Image-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Xlsx mit Image in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Xlsx-Dokumente mit Image-Signaturen schnell und einfach zu signieren.
