...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Svg fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET Svg fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Svg fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Svg aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Svg dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Svg dokumentumok aláírása Image élő bemutatóval"
    content: |
