...
############################# Head ############################
head_title: "Tilføjelse af Image-signaturer til Ppsm-fil med C#"
head_description: "Sæt Image Signatur på Ppsm fil for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Ppsm-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trin til at signere Ppsm med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Ppsm dokumenter med Image signaturer hurtigt og nemt.
