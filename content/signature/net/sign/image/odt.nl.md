...
############################# Head ############################
head_title: "Image handtekeningen toevoegen aan Odt bestand met C#"
head_description: "Zet Image Signature op Odt bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Odt bestanden met Image handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Odt te ondertekenen met Image in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Odt documenten snel en gemakkelijk te ondertekenen met Image handtekeningen.
