...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam Potx, izmantojot C#"
head_description: "Ievietojiet Image parakstu Potx failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Potx failus ar Image parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Potx ar Image programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Potx dokumentus ar Image parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Potx parakstīšana, izmantojot Image tiešraides demonstrāciju"
    content: |
