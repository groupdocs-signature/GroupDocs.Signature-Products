...
############################# Head ############################
head_title: "የImage ፊርማዎችን ወደ Pps ፋይል በC# ማከል"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም የImage ፊርማ በPps ፋይል ላይ ለ.NET ያድርጉ። በደርዘን የሚቆጠሩ የፋይል ቅርጸቶችን ለመፈረም የGroupDocs Document Signature API ይጠቀሙ።"

############################# Header ############################
title: "Pps ፋይሎችን በImage ፊርማዎች በC# ይፈርሙ"
...
steps:
    enable: true
    title_left: "Ppsን በImage በC# ለመፈረም ደረጃዎች"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) የPps ሰነዶችን በImage ፊርማ በፍጥነት እና በቀላሉ የመፈረም ችሎታን ይሰጣል።
