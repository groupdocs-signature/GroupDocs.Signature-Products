...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Xlsx pomocí C#"
head_description: "Vložte podpis Image do souboru Xlsx pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Xlsx pomocí podpisů Image v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Xlsx pomocí Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Xlsx pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Xlsx pomocí živé ukázky Image"
    content: |
