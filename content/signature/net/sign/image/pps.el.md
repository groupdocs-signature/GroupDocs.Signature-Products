...
############################# Head ############################
head_title: "Προσθήκη υπογραφών Image στο αρχείο Pps με C#"
head_description: "Τοποθετήστε το Image Signature στο αρχείο Pps για το .NET χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε δεκάδες μορφές αρχείων."

############################# Header ############################
title: "Υπογράψτε αρχεία Pps με υπογραφές Image στο C#"
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Pps με Image στο C#"
    content_left: |
        Το [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) παρέχει τη δυνατότητα υπογραφής εγγράφων Pps με υπογραφές Image γρήγορα και εύκολα.
