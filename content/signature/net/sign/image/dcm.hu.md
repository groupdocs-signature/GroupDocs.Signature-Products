...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Dcm fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET Dcm fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Dcm fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Dcm aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Dcm dokumentumok gyors és egyszerű aláírását Image aláírással.
