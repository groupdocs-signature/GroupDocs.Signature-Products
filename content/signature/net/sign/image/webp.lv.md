...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam Webp, izmantojot C#"
head_description: "Ievietojiet Image parakstu Webp failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Webp failus ar Image parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Webp ar Image programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Webp dokumentus ar Image parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Webp parakstīšana, izmantojot Image tiešraides demonstrāciju"
    content: |
