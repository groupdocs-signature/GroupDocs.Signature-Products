...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Gif pomocí C#"
head_description: "Vložte podpis Image do souboru Gif pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Gif pomocí podpisů Image v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Gif pomocí Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Gif pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Gif pomocí živé ukázky Image"
    content: |
