...
############################# Head ############################
head_title: "Dodavanje potpisa Image u datoteku Ppt s C#"
head_description: "Stavite potpis Image na datoteku Ppt za .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Ppt datoteke s Image potpisima u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Ppt s Image u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Ppt dokumenata s Image potpisima.
