...
############################# Head ############################
head_title: "Legger til Image-signaturer til Xltx-filen med C#"
head_description: "Sett Image-signatur på Xltx-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Xltx-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Xltx med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Xltx-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Xltx dokumenter med Image Live Demo"
    content: |
