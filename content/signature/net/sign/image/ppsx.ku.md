...
############################# Head ############################
head_title: "Zêdekirina Image îmzeyan li pelê Ppsx bi C#"
head_description: "Ji bo .NET Image îmza li ser pela Ppsx bi çend rêzên kodê bixin. API-ya Îmzekirina Belgeya GroupDocs bikar bînin da ku bi dehan formatên pelan îmze bikin."

############################# Header ############################
title: "Pelên Ppsx bi îmzeyên Image di C# de îmze bikin"
...
steps:
    enable: true
    title_left: "Gavên îmzekirina Ppsx bi Image di C# de"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) îmzakirina belgeyên Ppsx bi îmzeyên Image zû û bi hêsanî peyda dike.
...
demos:
    enable: true
    title: "Îmzekirina belgeyên Ppsx bi Image Demoya Zindî"
    content: |
