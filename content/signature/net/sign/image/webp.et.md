...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Webp rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Webp, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Webp allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Webp allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Webp dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Webp allkirjastamine Image reaalajas demoga"
    content: |
