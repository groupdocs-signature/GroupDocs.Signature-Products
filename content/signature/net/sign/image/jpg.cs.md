...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Jpg pomocí C#"
head_description: "Vložte podpis Image do souboru Jpg pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Jpg pomocí podpisů Image v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Jpg pomocí Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Jpg pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Jpg pomocí živé ukázky Image"
    content: |
