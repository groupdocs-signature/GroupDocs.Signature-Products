...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Tar lêer met C#"
head_description: "Plaas Image Handtekening op Tar lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Tar lêers met Image handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Tar met Image in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Tar dokumente met Image handtekeninge vinnig en maklik te onderteken.
