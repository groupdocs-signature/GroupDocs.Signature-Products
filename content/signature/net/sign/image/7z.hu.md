...
############################# Head ############################
head_title: "Image aláírás hozzáadása a 7z fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET 7z fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "7z fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A 7z aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a 7z dokumentumok gyors és egyszerű aláírását Image aláírással.
