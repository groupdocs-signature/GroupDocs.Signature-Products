...
############################# Head ############################
head_title: "إضافة Image توقيعات إلى ملف Otp باستخدام C#"
head_description: "ضع Image التوقيع على ملف Otp لـ .NET باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات Otp بتوقيعات Image في C#"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Otp باستخدام Image في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Otp بتوقيعات Image بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Otp باستخدام العرض التوضيحي المباشر Image"
    content: |
