...
############################# Head ############################
head_title: "Adicionando assinaturas Image ao arquivo Pps com C#"
head_description: "Coloque a assinatura Image no arquivo Pps para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Pps arquivos com assinaturas Image em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Pps com Image em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Pps com assinaturas Image de forma rápida e fácil.
