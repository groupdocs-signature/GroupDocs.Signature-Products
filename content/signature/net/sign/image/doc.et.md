...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Doc rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Doc, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Doc allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Doc allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Doc dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Doc allkirjastamine Image reaalajas demoga"
    content: |
