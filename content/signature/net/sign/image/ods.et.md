...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Ods rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Ods, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Ods allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Ods allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Ods dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Ods allkirjastamine Image reaalajas demoga"
    content: |
