...
############################# Head ############################
head_title: "Image handtekeningen toevoegen aan Xlsm bestand met C#"
head_description: "Zet Image Signature op Xlsm bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Xlsm bestanden met Image handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Xlsm te ondertekenen met Image in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Xlsm documenten snel en gemakkelijk te ondertekenen met Image handtekeningen.
