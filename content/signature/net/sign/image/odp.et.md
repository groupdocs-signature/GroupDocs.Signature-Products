...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Odp rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Odp, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Odp allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Odp allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Odp dokumente Image allkirjaga.
