...
############################# Head ############################
head_title: "Voeg Image handtekeninge by 7z lêer met C#"
head_description: "Plaas Image Handtekening op 7z lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken 7z lêers met Image handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om 7z met Image in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om 7z dokumente met Image handtekeninge vinnig en maklik te onderteken.
