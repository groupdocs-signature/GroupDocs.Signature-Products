...
############################# Head ############################
head_title: "Добавяне на подписи Image към файл Tiff с C#"
head_description: "Поставете подпис Image върху файл Tiff за .NET, като използвате няколко реда код. Използвайте API на GroupDocs Document Signature, за да подписвате десетки файлови формати."

############################# Header ############################
title: "Подпишете Tiff файлове с Image подписи в C#"
...
steps:
    enable: true
    title_left: "Стъпки за подписване на Tiff с Image в C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя възможност за бързо и лесно подписване на Tiff документи с Image подписи.
