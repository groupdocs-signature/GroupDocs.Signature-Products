...
############################# Head ############################
head_title: "Додавання підписів Image до файлу Pptx за допомогою C#"
head_description: "Додайте підпис Image до файлу Pptx для .NET за допомогою кількох рядків коду. Використовуйте API підпису документів GroupDocs, щоб підписувати десятки форматів файлів."

############################# Header ############################
title: "Підпишіть файли Pptx підписами Image у C#"
...
steps:
    enable: true
    title_left: "Кроки для підпису Pptx за допомогою Image у C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає можливість швидко та легко підписувати документи Pptx за допомогою підписів Image.
...
demos:
    enable: true
    title: "Підпис документів Pptx за допомогою Image Live Demo"
    content: |
