...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Tiff pomocí C#"
head_description: "Vložte podpis Image do souboru Tiff pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Tiff pomocí podpisů Image v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Tiff pomocí Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Tiff pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Tiff pomocí živé ukázky Image"
    content: |
