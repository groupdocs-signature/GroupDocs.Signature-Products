...
############################# Head ############################
head_title: "Hinzufügen von Image-Signaturen zur Ods-Datei mit C#"
head_description: "Fügen Sie die Image-Signatur in die Ods-Datei für .NET ein, indem Sie ein paar Codezeilen verwenden. Verwenden Sie die GroupDocs Document Signature API, um Dutzende von Dateiformaten zu signieren."

############################# Header ############################
title: "Signiere Ods-Dateien mit Image-Signaturen in C#"
...
steps:
    enable: true
    title_left: "Schritte zum Signieren von Ods mit Image in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet die Möglichkeit, Ods-Dokumente mit Image-Signaturen schnell und einfach zu signieren.
