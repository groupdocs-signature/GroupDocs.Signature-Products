...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Doc fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET Doc fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Doc fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Doc aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Doc dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Doc dokumentumok aláírása Image élő bemutatóval"
    content: |
