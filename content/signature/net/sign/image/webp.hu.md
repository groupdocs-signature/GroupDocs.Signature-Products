...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Webp fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET Webp fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Webp fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Webp aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Webp dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Webp dokumentumok aláírása Image élő bemutatóval"
    content: |
