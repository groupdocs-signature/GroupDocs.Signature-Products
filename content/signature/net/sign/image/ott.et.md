...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Ott rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Ott, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Ott allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Ott allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Ott dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Ott allkirjastamine Image reaalajas demoga"
    content: |
