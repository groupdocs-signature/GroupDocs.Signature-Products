...
############################# Head ############################
head_title: "Adding Image signatures to Zip file with C#"
head_description: "Put Image Signature on Zip file for .NET using a few lines of code. Use the GroupDocs Document Signature API to sign dozens of file formats."

############################# Header ############################
title: "Sign Zip files with Image signatures in C#"
...
steps:
    enable: true
    title_left: "Steps to sign Zip with Image in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Zip documents with Image signatures quickly and easily.
