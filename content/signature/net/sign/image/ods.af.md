...
############################# Header ############################
title: "Teken Ods lêers met Image handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Ods met Image in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Ods dokumente met Image handtekeninge vinnig en maklik te onderteken.
