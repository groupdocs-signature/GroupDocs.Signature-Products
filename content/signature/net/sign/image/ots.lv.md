...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam Ots, izmantojot C#"
head_description: "Ievietojiet Image parakstu Ots failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Ots failus ar Image parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Ots ar Image programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Ots dokumentus ar Image parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Ots parakstīšana, izmantojot Image tiešraides demonstrāciju"
    content: |
