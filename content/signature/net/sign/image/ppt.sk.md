...
############################# Head ############################
head_title: "Pridanie podpisov Image do súboru Ppt pomocou C#"
head_description: "Vložte podpis Image do súboru Ppt pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Ppt pomocou podpisov Image v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Ppt pomocou Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Ppt pomocou podpisov Image.
