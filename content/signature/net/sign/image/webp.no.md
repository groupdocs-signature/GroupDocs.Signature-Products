...
############################# Head ############################
head_title: "Legger til Image-signaturer til Webp-filen med C#"
head_description: "Sett Image-signatur på Webp-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Webp-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Webp med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Webp-dokumenter med Image-signaturer raskt og enkelt.
...
demos:
    enable: true
    title: "Signering av Webp dokumenter med Image Live Demo"
    content: |
