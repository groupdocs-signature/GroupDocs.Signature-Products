...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Tar pomocí C#"
head_description: "Vložte podpis Image do souboru Tar pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Tar pomocí podpisů Image v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Tar pomocí Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Tar pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Tar pomocí živé ukázky Image"
    content: |
