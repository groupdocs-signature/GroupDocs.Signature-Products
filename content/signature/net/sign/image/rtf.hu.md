...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Rtf fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET Rtf fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Rtf fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Rtf aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Rtf dokumentumok gyors és egyszerű aláírását Image aláírással.
