...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko Ppsx z C#"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko Ppsx za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Ppsx datoteke s podpisi Image v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Ppsx z Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Ppsx s podpisi Image.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Ppsx z Image Live Demo"
    content: |
