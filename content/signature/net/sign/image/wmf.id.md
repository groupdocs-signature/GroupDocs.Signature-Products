...
############################# Head ############################
head_title: "Menambahkan tanda tangan Image ke file Wmf dengan C#"
head_description: "Letakkan Image Signature pada file Wmf untuk .NET menggunakan beberapa baris kode. Gunakan GroupDocs Document Signature API untuk menandatangani lusinan format file."

############################# Header ############################
title: "Tanda tangani file Wmf dengan tanda tangan Image di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Wmf dengan Image di C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) memberikan kemampuan untuk menandatangani dokumen Wmf dengan Image tanda tangan dengan cepat dan mudah.
