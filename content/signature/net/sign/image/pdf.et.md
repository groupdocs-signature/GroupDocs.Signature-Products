...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Pdf rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Pdf, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Pdf allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Pdf allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Pdf dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Pdf allkirjastamine Image reaalajas demoga"
    content: |
