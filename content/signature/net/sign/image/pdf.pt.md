...
############################# Head ############################
head_title: "Adicionando assinaturas Image ao arquivo Pdf com C#"
head_description: "Coloque a assinatura Image no arquivo Pdf para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Pdf arquivos com assinaturas Image em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Pdf com Image em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Pdf com assinaturas Image de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Pdf documentos com Image Demonstração ao vivo"
    content: |
