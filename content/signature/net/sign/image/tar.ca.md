...
############################# Head ############################
head_title: "Afegint Image signatures al fitxer Tar amb C#"
head_description: "Poseu la signatura Image al fitxer Tar per a .NET utilitzant unes quantes línies de codi. Utilitzeu l'API de signatura de documents de GroupDocs per signar desenes de formats de fitxer."

############################# Header ############################
title: "Signa fitxers Tar amb signatures Image a C#"
...
steps:
    enable: true
    title_left: "Passos per signar Tar amb Image a C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix la possibilitat de signar documents Tar amb signatures Image de manera ràpida i senzilla.
...
demos:
    enable: true
    title: "Signant documents de Tar amb Image Demostració en directe"
    content: |
