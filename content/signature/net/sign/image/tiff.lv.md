...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam Tiff, izmantojot C#"
head_description: "Ievietojiet Image parakstu Tiff failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Tiff failus ar Image parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Tiff ar Image programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Tiff dokumentus ar Image parakstiem.
