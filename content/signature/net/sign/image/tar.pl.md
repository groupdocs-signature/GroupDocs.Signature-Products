...
############################# Head ############################
head_title: "Dodawanie podpisów Image do pliku Tar za pomocą C#"
head_description: "Umieść podpis Image w pliku Tar dla .NET, używając kilku linijek kodu. Użyj interfejsu GroupDocs Document Signature API, aby podpisać dziesiątki formatów plików."

############################# Header ############################
title: "Podpisz pliki Tar z podpisami Image w C#"
...
steps:
    enable: true
    title_left: "Kroki do podpisania Tar za pomocą Image w C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umożliwia szybkie i łatwe podpisywanie dokumentów w formacie Tar za pomocą podpisów Image.
...
demos:
    enable: true
    title: "Podpisywanie dokumentów Tar za pomocą Image Demo na żywo"
    content: |
