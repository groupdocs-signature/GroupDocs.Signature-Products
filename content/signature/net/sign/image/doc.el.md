...
############################# Head ############################
head_title: "Προσθήκη υπογραφών Image στο αρχείο Doc με C#"
head_description: "Τοποθετήστε το Image Signature στο αρχείο Doc για το .NET χρησιμοποιώντας μερικές γραμμές κώδικα. Χρησιμοποιήστε το GroupDocs Document Signature API για να υπογράψετε δεκάδες μορφές αρχείων."

############################# Header ############################
title: "Υπογράψτε αρχεία Doc με υπογραφές Image στο C#"
...
steps:
    enable: true
    title_left: "Βήματα για την υπογραφή Doc με Image στο C#"
    content_left: |
        Το [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) παρέχει τη δυνατότητα υπογραφής εγγράφων Doc με υπογραφές Image γρήγορα και εύκολα.
