...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Xlsb fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET Xlsb fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Xlsb fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Xlsb aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Xlsb dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Xlsb dokumentumok aláírása Image élő bemutatóval"
    content: |
