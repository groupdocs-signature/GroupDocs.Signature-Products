...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Wmf fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET Wmf fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Wmf fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Wmf aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Wmf dokumentumok gyors és egyszerű aláírását Image aláírással.
...
demos:
    enable: true
    title: "Wmf dokumentumok aláírása Image élő bemutatóval"
    content: |
