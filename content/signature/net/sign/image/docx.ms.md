...
############################# Head ############################
head_title: "Menambahkan tandatangan Image pada fail Docx dengan C#"
head_description: "Letakkan Image Tandatangan pada fail Docx untuk .NET menggunakan beberapa baris kod. Gunakan API Tandatangan Dokumen GroupDocs untuk menandatangani berpuluh-puluh format fail."

############################# Header ############################
title: "Tandatangani fail Docx dengan tandatangan Image dalam C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk menandatangani Docx dengan Image dalam C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan keupayaan untuk menandatangani dokumen Docx dengan tandatangan Image dengan cepat dan mudah.
