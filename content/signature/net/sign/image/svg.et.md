...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Svg rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Svg, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Svg allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Svg allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Svg dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Svg allkirjastamine Image reaalajas demoga"
    content: |
