...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam Zip, izmantojot C#"
head_description: "Ievietojiet Image parakstu Zip failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Zip failus ar Image parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Zip ar Image programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Zip dokumentus ar Image parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Zip parakstīšana, izmantojot Image tiešraides demonstrāciju"
    content: |
