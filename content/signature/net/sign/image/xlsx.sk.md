...
############################# Head ############################
head_title: "Pridanie podpisov Image do súboru Xlsx pomocou C#"
head_description: "Vložte podpis Image do súboru Xlsx pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Xlsx pomocou podpisov Image v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xlsx pomocou Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xlsx pomocou podpisov Image.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Xlsx pomocou živej ukážky Image"
    content: |
