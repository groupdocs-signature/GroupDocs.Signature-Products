...
############################# Head ############################
head_title: "Tilføjelse af Image-signaturer til Pptx-fil med C#"
head_description: "Sæt Image Signatur på Pptx fil for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."
...
steps:
    enable: true
    title_left: "Trin til at signere Pptx med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Pptx dokumenter med Image signaturer hurtigt og nemt.
...
demos:
    enable: true
    title: "Signering af Pptx dokumenter med Image Live Demo"
    content: |
