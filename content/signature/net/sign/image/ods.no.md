...
############################# Head ############################
head_title: "Legger til Image-signaturer til Ods-filen med C#"
head_description: "Sett Image-signatur på Ods-filen for .NET ved å bruke noen få linjer med kode. Bruk GroupDocs Document Signature API til å signere dusinvis av filformater."

############################# Header ############################
title: "Signer Ods-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trinn for å signere Ods med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir mulighet til å signere Ods-dokumenter med Image-signaturer raskt og enkelt.
