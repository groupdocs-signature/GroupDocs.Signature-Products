...
############################# Head ############################
head_title: "Agregando Image firmas al archivo Csv con C#"
head_description: "Coloque la firma Image en el archivo Csv para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "Firme Csv archivos con Image firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Csv con Image en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Csv con Image firmas de forma rápida y sencilla.
