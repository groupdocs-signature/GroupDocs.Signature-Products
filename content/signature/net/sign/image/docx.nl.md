...
############################# Head ############################
head_title: "Image handtekeningen toevoegen aan Docx bestand met C#"
head_description: "Zet Image Signature op Docx bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Docx bestanden met Image handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Docx te ondertekenen met Image in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Docx documenten snel en gemakkelijk te ondertekenen met Image handtekeningen.
...
demos:
    enable: true
    title: "Docx documenten ondertekenen met Image Live Demo"
    content: |
