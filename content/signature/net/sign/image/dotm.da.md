...
############################# Head ############################
head_title: "Tilføjelse af Image-signaturer til Dotm-fil med C#"
head_description: "Sæt Image Signatur på Dotm fil for .NET ved hjælp af et par linjer kode. Brug GroupDocs Document Signature API til at signere snesevis af filformater."

############################# Header ############################
title: "Signer Dotm-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Trin til at signere Dotm med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver mulighed for at signere Dotm dokumenter med Image signaturer hurtigt og nemt.
