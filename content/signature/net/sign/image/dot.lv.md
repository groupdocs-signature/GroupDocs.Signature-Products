...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam Dot, izmantojot C#"
head_description: "Ievietojiet Image parakstu Dot failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Dot failus ar Image parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Dot ar Image programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Dot dokumentus ar Image parakstiem.
