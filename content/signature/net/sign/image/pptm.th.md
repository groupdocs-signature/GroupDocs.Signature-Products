...
############################# Head ############################
head_title: "การเพิ่มลายเซ็น Image ให้กับไฟล์ Pptm ด้วย C#"
head_description: "ใส่ Image ลายเซ็นบนไฟล์ Pptm สำหรับ .NET โดยใช้โค้ดสองสามบรรทัด ใช้ GroupDocs Document Signature API เพื่อลงนามรูปแบบไฟล์มากมาย"

############################# Header ############################
title: "เซ็นชื่อไฟล์ Pptm ด้วยลายเซ็น Image ใน C#"
...
steps:
    enable: true
    title_left: "ขั้นตอนในการลงนาม Pptm กับ Image ใน C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ให้ความสามารถในการลงนามในเอกสาร Pptm ด้วยลายเซ็น Image อย่างรวดเร็วและง่ายดาย
...
demos:
    enable: true
    title: "การลงนามเอกสาร Pptm ด้วย Image Live Demo"
    content: |
