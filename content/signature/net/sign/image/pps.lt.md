...
############################# Head ############################
head_title: "Image parašų pridėjimas prie Pps failo naudojant C#"
head_description: "Įdėkite Image parašą į Pps failą, skirtą .NET, naudodami kelias kodo eilutes. Norėdami pasirašyti daugybę failų formatų, naudokite GroupDocs Document Signature API."

############################# Header ############################
title: "Pasirašykite Pps failus naudodami Image parašus C#"
...
steps:
    enable: true
    title_left: "Veiksmai norint pasirašyti Pps naudojant Image programoje C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) suteikia galimybę greitai ir lengvai pasirašyti Pps dokumentus su Image parašais.
...
demos:
    enable: true
    title: "Dokumentų Pps pasirašymas naudojant Image tiesioginę demonstraciją"
    content: |
