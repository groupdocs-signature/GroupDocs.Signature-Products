...
############################# Head ############################
head_title: "Ag cur Image sínithe le comhad Csv le C#"
head_description: "Cuir Image Síniú ar Csv comhad le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Csv comhad le sínithe Image in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Csv a shíniú le Image in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Csv a shíniú le sínithe Image go tapa agus go héasca.
