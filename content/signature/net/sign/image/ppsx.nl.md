...
############################# Head ############################
head_title: "Image handtekeningen toevoegen aan Ppsx bestand met C#"
head_description: "Zet Image Signature op Ppsx bestand voor .NET met een paar regels code. Gebruik de GroupDocs Document Signature API om tientallen bestandsindelingen te ondertekenen."

############################# Header ############################
title: "Onderteken Ppsx bestanden met Image handtekeningen in C#"
...
steps:
    enable: true
    title_left: "Stappen om Ppsx te ondertekenen met Image in C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt de mogelijkheid om Ppsx documenten snel en gemakkelijk te ondertekenen met Image handtekeningen.
...
demos:
    enable: true
    title: "Ppsx documenten ondertekenen met Image Live Demo"
    content: |
