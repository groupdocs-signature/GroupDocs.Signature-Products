...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Webp med C#"
head_description: "Sätt Image Signatur på Webp-filen för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Webp-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Webp med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Webp-dokument med Image-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Webp dokument med Image Live Demo"
    content: |
