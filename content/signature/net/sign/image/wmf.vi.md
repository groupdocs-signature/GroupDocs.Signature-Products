...
############################# Head ############################
head_title: "Thêm chữ ký Image vào tệp Wmf bằng C#"
head_description: "Đặt Image Chữ ký trên tệp Wmf cho .NET bằng cách sử dụng một vài dòng mã. Sử dụng API chữ ký tài liệu GroupDocs để ký hàng chục định dạng tệp."

############################# Header ############################
title: "Ký các tệp Wmf bằng chữ ký Image trong C#"
...
steps:
    enable: true
    title_left: "Các bước để đăng nhập Wmf bằng Image trong C#"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp khả năng ký các tài liệu Wmf bằng chữ ký Image một cách nhanh chóng và dễ dàng.
...
demos:
    enable: true
    title: "Ký tài liệu Wmf bằng Image Live Demo"
    content: |
