...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko Xlsx z C#"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko Xlsx za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite Xlsx datoteke s podpisi Image v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis Xlsx z Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov Xlsx s podpisi Image.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov Xlsx z Image Live Demo"
    content: |
