...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Potm fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET Potm fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Potm fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Potm aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Potm dokumentumok gyors és egyszerű aláírását Image aláírással.
