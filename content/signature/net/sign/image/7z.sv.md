...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen 7z med C#"
head_description: "Sätt Image Signatur på 7z-filen för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera 7z-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera 7z med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera 7z-dokument med Image-signaturer snabbt och enkelt.
