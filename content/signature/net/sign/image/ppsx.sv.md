...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Ppsx med C#"
head_description: "Sätt Image Signatur på Ppsx-filen för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Ppsx-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Ppsx med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Ppsx-dokument med Image-signaturer snabbt och enkelt.
