...
############################# Head ############################
head_title: "Добавление подписей Image в файл Docx с C#"
head_description: "Поместите подпись Image в файл Docx для .NET, используя несколько строк кода. Используйте API подписи документов GroupDocs для подписи десятков форматов файлов."

############################# Header ############################
title: "Подпишите файлы Docx с подписями Image в C#"
...
steps:
    enable: true
    title_left: "Действия по подписанию Docx с помощью Image в C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) позволяет быстро и легко подписывать документы Docx с подписями Image.
