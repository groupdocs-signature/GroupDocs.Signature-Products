...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Pps pomocí C#"
head_description: "Vložte podpis Image do souboru Pps pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Pps pomocí podpisů Image v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Pps pomocí Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Pps pomocí podpisů Image.
