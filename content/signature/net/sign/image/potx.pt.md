...
############################# Head ############################
head_title: "Adicionando assinaturas Image ao arquivo Potx com C#"
head_description: "Coloque a assinatura Image no arquivo Potx para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Potx arquivos com assinaturas Image em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Potx com Image em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Potx com assinaturas Image de forma rápida e fácil.
