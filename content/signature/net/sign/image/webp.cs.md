...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Webp pomocí C#"
head_description: "Vložte podpis Image do souboru Webp pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Webp pomocí podpisů Image v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Webp pomocí Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Webp pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Webp pomocí živé ukázky Image"
    content: |
