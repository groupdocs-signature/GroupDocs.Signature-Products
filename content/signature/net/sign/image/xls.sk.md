...
############################# Head ############################
head_title: "Pridanie podpisov Image do súboru Xls pomocou C#"
head_description: "Vložte podpis Image do súboru Xls pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Xls pomocou podpisov Image v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Xls pomocou Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Xls pomocou podpisov Image.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Xls pomocou živej ukážky Image"
    content: |
