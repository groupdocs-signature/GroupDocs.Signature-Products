...
############################# Head ############################
head_title: "إضافة Image توقيعات إلى ملف Odt باستخدام C#"
head_description: "ضع Image التوقيع على ملف Odt لـ .NET باستخدام بضعة أسطر من التعليمات البرمجية. استخدم GroupDocs Document Signature API لتوقيع عشرات تنسيقات الملفات."

############################# Header ############################
title: "توقيع ملفات Odt بتوقيعات Image في C#"
...
steps:
    enable: true
    title_left: "خطوات تسجيل Odt باستخدام Image في C#"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) إمكانية توقيع مستندات Odt بتوقيعات Image بسرعة وسهولة.
...
demos:
    enable: true
    title: "توقيع مستندات Odt باستخدام العرض التوضيحي المباشر Image"
    content: |
