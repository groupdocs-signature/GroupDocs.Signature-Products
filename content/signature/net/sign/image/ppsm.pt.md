...
############################# Head ############################
head_title: "Adicionando assinaturas Image ao arquivo Ppsm com C#"
head_description: "Coloque a assinatura Image no arquivo Ppsm para .NET usando algumas linhas de código. Use a API de assinatura de documentos do GroupDocs para assinar dezenas de formatos de arquivo."

############################# Header ############################
title: "Assine Ppsm arquivos com assinaturas Image em C#"
...
steps:
    enable: true
    title_left: "Etapas para assinar Ppsm com Image em C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) permite assinar documentos Ppsm com assinaturas Image de forma rápida e fácil.
...
demos:
    enable: true
    title: "Assinando Ppsm documentos com Image Demonstração ao vivo"
    content: |
