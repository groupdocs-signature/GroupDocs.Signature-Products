...
############################# Head ############################
head_title: "Přidání podpisů Image do souboru Docm pomocí C#"
head_description: "Vložte podpis Image do souboru Docm pro .NET pomocí několika řádků kódu. Pomocí rozhraní GroupDocs Document Signature API podepisujte desítky formátů souborů."

############################# Header ############################
title: "Podepisujte soubory Docm pomocí podpisů Image v C#"
...
steps:
    enable: true
    title_left: "Kroky k podepsání Docm pomocí Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) umožňuje rychle a snadno podepisovat dokumenty Docm pomocí podpisů Image.
...
demos:
    enable: true
    title: "Podepisování dokumentů Docm pomocí živé ukázky Image"
    content: |
