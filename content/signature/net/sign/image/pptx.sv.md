...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Pptx med C#"
head_description: "Sätt Image Signatur på Pptx-filen för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Pptx-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Pptx med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Pptx-dokument med Image-signaturer snabbt och enkelt.
