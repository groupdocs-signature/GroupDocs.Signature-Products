...
############################# Head ############################
head_title: "Voeg Image handtekeninge by Zip lêer met C#"
head_description: "Plaas Image Handtekening op Zip lêer vir .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Signature API om dosyne lêerformate te onderteken."

############################# Header ############################
title: "Teken Zip lêers met Image handtekeninge in C#"
...
steps:
    enable: true
    title_left: "Stappe om Zip met Image in C# te onderteken"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied die vermoë om Zip dokumente met Image handtekeninge vinnig en maklik te onderteken.
