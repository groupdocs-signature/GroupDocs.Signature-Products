...
############################# Head ############################
head_title: "Dodavanje potpisa Image u datoteku Odp s C#"
head_description: "Stavite potpis Image na datoteku Odp za .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Odp datoteke s Image potpisima u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Odp s Image u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Odp dokumenata s Image potpisima.
