...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Wmf rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Wmf, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Wmf allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Wmf allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Wmf dokumente Image allkirjaga.
