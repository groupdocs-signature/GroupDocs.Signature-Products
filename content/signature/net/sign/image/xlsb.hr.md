...
############################# Head ############################
head_title: "Dodavanje potpisa Image u datoteku Xlsb s C#"
head_description: "Stavite potpis Image na datoteku Xlsb za .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Signature API za potpisivanje desetaka formata datoteka."

############################# Header ############################
title: "Potpišite Xlsb datoteke s Image potpisima u C#"
...
steps:
    enable: true
    title_left: "Koraci za potpisivanje Xlsb s Image u C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža mogućnost brzog i jednostavnog potpisivanja Xlsb dokumenata s Image potpisima.
