...
############################# Head ############################
head_title: "Image aláírás hozzáadása a Ppt fájlhoz a C# segítségével"
head_description: "Helyezzen Image aláírást a .NET Ppt fájljába néhány sornyi kód használatával. A GroupDocs Document Signature API segítségével több tucat fájlformátumot írhat alá."

############################# Header ############################
title: "Ppt fájl aláírása Image aláírással a C# alkalmazásban"
...
steps:
    enable: true
    title_left: "A Ppt aláírásának lépései a Image segítségével a C# programban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) lehetővé teszi a Ppt dokumentumok gyors és egyszerű aláírását Image aláírással.
