...
############################# Head ############################
head_title: "Pridanie podpisov Image do súboru Webp pomocou C#"
head_description: "Vložte podpis Image do súboru Webp pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Webp pomocou podpisov Image v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Webp pomocou Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Webp pomocou podpisov Image.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Webp pomocou živej ukážky Image"
    content: |
