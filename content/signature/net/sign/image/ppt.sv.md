...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Ppt med C#"
head_description: "Sätt Image Signatur på Ppt-filen för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Ppt-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Ppt med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Ppt-dokument med Image-signaturer snabbt och enkelt.
