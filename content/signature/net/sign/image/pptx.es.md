...
############################# Head ############################
head_title: "Agregando Image firmas al archivo Pptx con C#"
head_description: "Coloque la firma Image en el archivo Pptx para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "Firme Pptx archivos con Image firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Pptx con Image en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Pptx con Image firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Pptx documentos con Image Live Demo"
    content: |
