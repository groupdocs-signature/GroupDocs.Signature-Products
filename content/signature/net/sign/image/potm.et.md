...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Potm rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Potm, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Potm allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Potm allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Potm dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Potm allkirjastamine Image reaalajas demoga"
    content: |
