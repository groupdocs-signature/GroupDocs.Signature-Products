...
############################# Head ############################
head_title: "Allkirjade Image lisamine failile Tiff rakendusega C#"
head_description: "Pane allkiri Image allkiri .NET failile Tiff, kasutades mõnda koodirida. Kasutage GroupDocs Document Signature API-t kümnete failivormingute allkirjastamiseks."

############################# Header ############################
title: "Allkirjastage failid Tiff allkirjadega Image rakenduses C#"
...
steps:
    enable: true
    title_left: "Toimingud Tiff allkirjastamiseks rakendusega Image rakenduses C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) võimaldab kiiresti ja lihtsalt allkirjastada Tiff dokumente Image allkirjaga.
...
demos:
    enable: true
    title: "Dokumentide Tiff allkirjastamine Image reaalajas demoga"
    content: |
