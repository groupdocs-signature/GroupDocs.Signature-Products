...
############################# Head ############################
head_title: "Agregando Image firmas al archivo Wmf con C#"
head_description: "Coloque la firma Image en el archivo Wmf para .NET usando unas pocas líneas de código. Utilice la API de firma de documentos de GroupDocs para firmar docenas de formatos de archivo."

############################# Header ############################
title: "Firme Wmf archivos con Image firmas en C#"
...
steps:
    enable: true
    title_left: "Pasos para firmar Wmf con Image en C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona la capacidad de firmar documentos Wmf con Image firmas de forma rápida y sencilla.
...
demos:
    enable: true
    title: "Firma de Wmf documentos con Image Live Demo"
    content: |
