...
############################# Head ############################
head_title: "Dodajanje podpisov Image v datoteko 7z z C#"
head_description: "Z nekaj vrsticami kode postavite podpis Image na datoteko 7z za .NET. Uporabite API za podpis dokumentov GroupDocs za podpis na desetine formatov datotek."

############################# Header ############################
title: "Podpišite 7z datoteke s podpisi Image v C#"
...
steps:
    enable: true
    title_left: "Koraki za podpis 7z z Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) omogoča hitro in enostavno podpisovanje dokumentov 7z s podpisi Image.
...
demos:
    enable: true
    title: "Podpisovanje dokumentov 7z z Image Live Demo"
    content: |
