...
############################# Head ############################
head_title: "C# ile Svg dosyasına Image imza ekleme"
head_description: "Birkaç satır kod kullanarak .NET için Svg dosyasına Image İmza koyun. Düzinelerce dosya biçimini imzalamak için GroupDocs Belge İmza API'sini kullanın."

############################# Header ############################
title: "Svg dosyalarını Image imzasıyla C# içinde imzalayın"
...
steps:
    enable: true
    title_left: "C# içinde Image ile Svg imzalama adımları"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Svg belgelerini Image imzasıyla hızlı ve kolay bir şekilde imzalama olanağı sağlar.
