...
############################# Head ############################
head_title: "Pridanie podpisov Image do súboru Potx pomocou C#"
head_description: "Vložte podpis Image do súboru Potx pre .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Signature API na podpisovanie desiatok formátov súborov."

############################# Header ############################
title: "Podpíšte súbory Potx pomocou podpisov Image v C#"
...
steps:
    enable: true
    title_left: "Kroky na podpísanie Potx pomocou Image v C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje možnosť rýchlo a jednoducho podpisovať dokumenty Potx pomocou podpisov Image.
...
demos:
    enable: true
    title: "Podpisovanie dokumentov Potx pomocou živej ukážky Image"
    content: |
