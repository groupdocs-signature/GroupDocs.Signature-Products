...
############################# Head ############################
head_title: "Adding Image signatures in a Tiff file with C#"
...
overview:
    ...
    title: "Overview API"
    content: |
        Sign your Tiff files with Image signatures using .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides ability to sign Tiff documents with Image signatures quick and easily.
