...
############################# Head ############################
head_title: "Lägger till Image-signaturer i filen Jpg med C#"
head_description: "Sätt Image Signatur på Jpg-filen för .NET med några rader kod. Använd GroupDocs Document Signature API för att signera dussintals filformat."

############################# Header ############################
title: "Signera Jpg-filer med Image-signaturer i C#"
...
steps:
    enable: true
    title_left: "Steg för att signera Jpg med Image i C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ger möjlighet att signera Jpg-dokument med Image-signaturer snabbt och enkelt.
...
demos:
    enable: true
    title: "Signerar Jpg dokument med Image Live Demo"
    content: |
