...
############################# Head ############################
head_title: "Parakstu Image pievienošana failam Otp, izmantojot C#"
head_description: "Ievietojiet Image parakstu Otp failā .NET, izmantojot dažas koda rindiņas. Izmantojiet GroupDocs Document Signature API, lai parakstītu desmitiem failu formātu."

############################# Header ############################
title: "Parakstīt Otp failus ar Image parakstiem programmā C#"
...
steps:
    enable: true
    title_left: "Darbības, lai parakstītu Otp ar Image programmā C#"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina iespēju ātri un vienkārši parakstīt Otp dokumentus ar Image parakstiem.
...
demos:
    enable: true
    title: "Dokumentu Otp parakstīšana, izmantojot Image tiešraides demonstrāciju"
    content: |
