...
############################# Head ############################
head_title: "Ag cur Image sínithe le comhad Potm le C#"
head_description: "Cuir Image Síniú ar Potm comhad le haghaidh .NET ag baint úsáide as cúpla líne de chód. Úsáid an GroupDocs Document Signature API chun mórán formáidí comhaid a shíniú."

############################# Header ############################
title: "Sínigh Potm comhad le sínithe Image in C#"
...
steps:
    enable: true
    title_left: "Céimeanna chun Potm a shíniú le Image in C#"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) cumas chun doiciméid Potm a shíniú le sínithe Image go tapa agus go héasca.
...
demos:
    enable: true
    title: "Ag síniú Potm doiciméad le Image Taispeántas Beo"
    content: |
