...
############################# Head ############################
head_title: "Generate QR code for DOCX files using C#"
head_description: "Harness the GroupDocs.Signature API to generate QR code for DOCX files. Seamlessly embed QR codes on any page for enhanced functionality."
...
steps:
    enable: true
    title: "How to generate and insert a QR code in any place within a DOCX"
    content: |
