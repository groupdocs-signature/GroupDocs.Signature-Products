...
############################# Head ############################
head_title: "Gere código QR para arquivos PPTX usando C#"
head_description: "Aproveite a API GroupDocs.Signature para gerar código QR para arquivos PPTX. Integre códigos QR em qualquer página para funcionalidade aprimorada."

############################# Header ############################
title: "Gere códigos QR para PPTX" 
...
steps:
    enable: true
    title: "Como gerar e inserir um código QR em qualquer lugar dentro de um PPTX"
    content: |
      [GroupDocs.Signature](/signature/net/) facilita a geração de códigos QR em vários formatos populares e sua colocação em páginas de PPTX. Com suporte a mais de 10 tipos de códigos QR, nossa biblioteca pode ser integrada facilmente em aplicações .NET. Aprimore seus documentos com assinaturas de código QR utilizando nosso produto.
      
      1. Adquira o arquivo ou fluxo PPTX a ser assinado com um código QR.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Como gerar um código QR com várias opções?"
      content: |
        Este exemplo demonstra como posicionar um código QR personalizado em uma página PPTX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
