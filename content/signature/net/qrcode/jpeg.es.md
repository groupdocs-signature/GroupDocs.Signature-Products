...
############################# Head ############################
head_title: "Generar código QR para archivos JPEG usando C#"
head_description: "Aproveche la API de GroupDocs.Signature para generar códigos QR para archivos JPEG. Incorpore sin problemas códigos QR en cualquier página para mejorar la funcionalidad."
...
steps:
    enable: true
    title: "Cómo generar e insertar un código QR en cualquier lugar dentro de un JPEG"
    content: |
