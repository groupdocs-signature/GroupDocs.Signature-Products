...
############################# Head ############################
head_title: "Hasilkan kode QR untuk file XLSX menggunakan C#"
head_description: "Manfaatkan API GroupDocs.Signature untuk menghasilkan kode QR untuk file XLSX. Madalkan kode QR pada halaman mana pun untuk meningkatkan fungsionalitas."
...
steps:
    enable: true
    title: "Cara menghasilkan dan menyisipkan kode QR di mana saja dalam XLSX"
    content: |
      [GroupDocs.Signature](/signature/net/) memfasilitasi penghasilan kode QR dalam berbagai format populer dan penempatannya pada halaman XLSX. Mendukung lebih dari 10 jenis kode QR, perpustakaan kami dapat diintegrasikan dengan mulus ke dalam aplikasi .NET. Tingkatkan dokumen Anda dengan tanda tangan kode QR menggunakan produk kami.
      
      1. Dapatkan file XLSX atau aliran yang akan ditandatangani dengan kode QR.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cara menghasilkan kode QR dengan berbagai opsi?"
      content: |
        Contoh ini menunjukkan bagaimana menempatkan kode QR yang disesuaikan pada halaman XLSX.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
