...
############################# Head ############################
head_title: "Generar código QR para archivos PDF usando C#"
head_description: "Aproveche la API de GroupDocs.Signature para generar códigos QR para archivos PDF. Incorpore sin problemas códigos QR en cualquier página para mejorar la funcionalidad."
...
steps:
    enable: true
    title: "Cómo generar e insertar un código QR en cualquier lugar dentro de un PDF"
    content: |
      [GroupDocs.Signature](/signature/net/) facilita la generación de códigos QR en varios formatos populares y su colocación en páginas PDF. Con el soporte de más de 10 tipos de códigos QR, nuestra biblioteca se puede integrar sin problemas en aplicaciones de .NET. Mejora tus documentos con firmas de código QR usando nuestro producto.
      
      1. Adquiere el archivo PDF o flujo que será firmado con un código QR.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "¿Cómo generar un código QR con varias opciones?"
      content: |
        Este ejemplo demuestra cómo colocar un código QR personalizado en una página PDF.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
