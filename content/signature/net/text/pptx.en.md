...
############################# Head ############################
head_title: "Create text signatures for PPTX using C# apps"
...
############################# Header ############################
title: "Seamlessly embed text signatures in PPTX" 
...
steps:
    enable: true
    title: "How to create and add text signatures to PPTX using C#"
    content: |
      ...
      1. Pass the PPTX document as a parameter to the Signature class constructor.
