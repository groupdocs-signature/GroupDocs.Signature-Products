...
############################# Head ############################
head_title: "Create text signatures for XLSX using C# apps"
...
############################# Header ############################
title: "Seamlessly embed text signatures in XLSX" 
...
steps:
    enable: true
    title: "How to create and add text signatures to XLSX using C#"
    content: |
