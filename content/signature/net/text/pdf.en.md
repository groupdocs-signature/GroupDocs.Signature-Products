...
############################# Head ############################
head_title: "Create text signatures for PDF using C# apps"
...
############################# Header ############################
title: "Seamlessly embed text signatures in PDF" 
...
steps:
    enable: true
    title: "How to create and add text signatures to PDF using C#"
    content: |
