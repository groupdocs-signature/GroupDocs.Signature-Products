...
############################# Head ############################
head_title: "DOCX デジタル署名の検証を C# で行う"
head_description: "GroupDocs.Signature for .NET を活用して、DOCX ファイルに埋め込まれた署名を認証します。PDF、Word、Excel、プレゼンテーション、画像、ZIP形式の署名の正当性を検証します。"

############################# Header ############################
title: "DOCX デジタル署名の検証" 
...
steps:
    enable: true
    title: "C# を使用して DOCX 内の署名を検証する手順"
    content: |
      [GroupDocs.Signature](/signature/net/) は、DOCX ドキュメント内の特定の署名の存在を認証できます。.NET の開発者は、当社のソリューションが提供する機能を組み込むことで、アプリケーションを強化できます。
      
      1. Signature インスタンスに DOCX ファイルをロードします。
