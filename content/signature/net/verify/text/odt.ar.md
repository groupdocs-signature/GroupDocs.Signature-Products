...
############################# Head ############################
head_title: "التحقق من توقيعات Text لملفات Odt عبر C#"
head_description: "استخدم فقط بضعة أسطر من كود .NET للتحقق من مستندات Odt وتوقيعاتها Text."

############################# Header ############################
title: "التحقق من صحة التوقيعات Text لملفات Odt"
description: "توفر واجهة برمجة التطبيقات لـ .NET فرصة للتحقق من توقيعات Text في مستندات Odt. قد يتم التحقق من صحة التوقيعات الإلكترونية داخل مستندات Odt بسرعة وسهولة."
...
steps:
    ...
    content_left: |
        يتضمن [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) ميزات مفيدة مثل التحقق من التوقيعات Text الموضوعة في مستندات Odt. اغتنم هذه الفرصة دون تنفيذ كود إضافي.
