...
############################# Head ############################
head_title: "Fíorú Text sínithe do chomhaid Rtf trí C#"
head_description: "Ná húsáid ach cúpla líne de chód .NET chun doiciméid Rtf agus a gcuid sínithe Text a fhíorú."

############################# Header ############################
title: "Text fíorú sínithe le haghaidh comhad Rtf"
description: "Soláthraíonn API do .NET deis chun Text sínithe ag Rtf doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Rtf a fhíorú go tapa agus go héasca."
...
steps:
    ...
    content_left: |
        Áiríonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail fíorú Text sínithe atá curtha ag Rtf doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
