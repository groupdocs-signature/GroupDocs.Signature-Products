...
############################# Head ############################
head_title: "Verification of Text signatures for Odt files in C#"
head_description: "Use only a few lines of .NET code to verify Odt documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Odt files"
description: "API for .NET provides opportunity to verify Text signatures at Odt documents. Verification of e-signatures inside your Odt documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Text signatures in your Odt document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Text signatures placed at Odt documents. Use this opportunity without implementing extra code.
