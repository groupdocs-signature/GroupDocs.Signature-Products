...
############################# Head ############################
head_title: "Verificarea semnăturilor Text pentru fișierele Xls prin C#"
head_description: "Utilizați doar câteva rânduri de cod .NET pentru a verifica documentele Xls și semnăturile acestora Text."

############################# Header ############################
title: "Text verificarea semnăturilor pentru fișiere Xls"
description: "API-ul pentru .NET oferă posibilitatea de a verifica semnăturile Text în documentele Xls. Verificarea semnăturilor electronice din documentele dvs. Xls poate fi efectuată rapid și ușor."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) include funcții utile, cum ar fi verificarea semnăturilor Text plasate în documentele Xls. Folosiți această oportunitate fără a implementa cod suplimentar.
