...
############################# Head ############################
head_title: "Verification of Text signatures for Ppt files via C#"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like verification of Text signatures placed at Ppt documents. Use this opportunity without implementing extra code.
