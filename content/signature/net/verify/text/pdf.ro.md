...
############################# Head ############################
head_title: "Verificarea semnăturilor Text pentru fișierele Pdf prin C#"
head_description: "Utilizați doar câteva rânduri de cod .NET pentru a verifica documentele Pdf și semnăturile acestora Text."

############################# Header ############################
title: "Text verificarea semnăturilor pentru fișiere Pdf"
description: "API-ul pentru .NET oferă posibilitatea de a verifica semnăturile Text în documentele Pdf. Verificarea semnăturilor electronice din documentele dvs. Pdf poate fi efectuată rapid și ușor."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) include funcții utile, cum ar fi verificarea semnăturilor Text plasate în documentele Pdf. Folosiți această oportunitate fără a implementa cod suplimentar.
