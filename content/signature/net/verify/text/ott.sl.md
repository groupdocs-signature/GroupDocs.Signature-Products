...
############################# Head ############################
head_title: "Preverjanje podpisov Text za datoteke Ott prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Ott in njihovih podpisov Text."

############################# Header ############################
title: "Preverjanje podpisov Text za datoteke Ott"
description: "API za .NET ponuja možnost preverjanja podpisov Text v dokumentih Ott. Preverjanje e-podpisov v vaših Ott dokumentih lahko izvedete hitro in enostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Text v dokumentih Ott. Izkoristite to priložnost brez implementacije dodatne kode.
