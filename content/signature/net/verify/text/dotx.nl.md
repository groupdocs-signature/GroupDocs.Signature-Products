...
############################# Head ############################
head_title: "Verificatie van Text handtekeningen voor Dotx bestanden via C#"
head_description: "Gebruik slechts een paar regels .NET-code om Dotx-documenten en hun Text-handtekeningen te verifiëren."

############################# Header ############################
title: "Text handtekeningverificatie voor Dotx bestanden"
description: "API voor .NET biedt de mogelijkheid om Text handtekeningen te verifiëren bij Dotx documenten. Verificatie van elektronische handtekeningen in uw Dotx documenten kan snel en gemakkelijk worden uitgevoerd."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bevat handige functies zoals verificatie van Text handtekeningen die bij Dotx documenten zijn geplaatst. Gebruik deze mogelijkheid zonder extra code te implementeren.
