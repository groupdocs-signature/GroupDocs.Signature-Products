...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Ppsx przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Ppsx i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Ppsx"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Text w dokumentach Ppsx. Weryfikacja podpisów elektronicznych w dokumentach Ppsx może być przeprowadzona szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zweryfikować podpisy Text w dokumencie Ppsx?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Ppsx. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
...
demos:
    ...
    content: |
       Dodaj różne podpisy elektroniczne do pliku Ppsx już teraz, odwiedzając witrynę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          

############################# More Formats ############################
more_formats:
    enable: true
    title: "Zweryfikuj inne podpisy Text za pomocą C#"
    content: |
