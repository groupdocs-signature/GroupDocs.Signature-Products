...
############################# Head ############################
head_title: "Bekræftelse af Text signaturer for Tar filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Tar-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekræftelse for Tar filer"
description: "API for .NET giver mulighed for at bekræfte Text-signaturer på Tar-dokumenter. Bekræftelse af e-signaturer i dine Tar-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Text signaturer placeret på Tar dokumenter. Brug denne mulighed uden at implementere ekstra kode.
