...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Potm przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Potm i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Potm"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Text w dokumentach Potm. Weryfikacja podpisów elektronicznych w dokumentach Potm może być przeprowadzona szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zweryfikować podpisy Text w dokumencie Potm?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Potm. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
...
demos:
    ...
    content: |
       Dodaj różne podpisy elektroniczne do pliku Potm już teraz, odwiedzając witrynę [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
