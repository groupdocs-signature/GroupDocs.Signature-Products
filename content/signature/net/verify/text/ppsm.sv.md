...
description: "API för .NET ger möjlighet att verifiera Text-signaturer i Ppsm-dokument. Verifiering av e-signaturer i dina {{Filformat}}-dokument kan utföras snabbt och enkelt."
