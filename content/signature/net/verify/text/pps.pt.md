...
############################# Head ############################
head_title: "Verificação de assinaturas Text para arquivos Pps via C#"
head_description: "Use apenas algumas linhas de código .NET para verificar documentos Pps e suas assinaturas Text."

############################# Header ############################
title: "Text verificação de assinaturas para Pps arquivos"
description: "A API para .NET oferece a oportunidade de verificar assinaturas Text em documentos Pps. A verificação de assinaturas eletrônicas dentro de seus documentos Pps pode ser realizada de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis, como verificação de Text assinaturas colocadas em documentos Pps. Use esta oportunidade sem implementar código extra.
