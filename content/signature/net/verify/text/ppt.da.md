...
############################# Head ############################
head_title: "Bekræftelse af Text signaturer for Ppt filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Ppt-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekræftelse for Ppt filer"
description: "API for .NET giver mulighed for at bekræfte Text-signaturer på Ppt-dokumenter. Bekræftelse af e-signaturer i dine Ppt-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Text signaturer placeret på Ppt dokumenter. Brug denne mulighed uden at implementere ekstra kode.
