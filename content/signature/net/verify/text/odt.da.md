...
############################# Head ############################
head_title: "Bekræftelse af Text signaturer for Odt filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Odt-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekræftelse for Odt filer"
description: "API for .NET giver mulighed for at bekræfte Text-signaturer på Odt-dokumenter. Bekræftelse af e-signaturer i dine Odt-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Text-signaturer i dit Odt-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Text signaturer placeret på Odt dokumenter. Brug denne mulighed uden at implementere ekstra kode.
