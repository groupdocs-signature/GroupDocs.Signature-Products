...
############################# Head ############################
head_title: "Verifiering av Text-signaturer för Otp-filer via C#"
head_description: "Använd bara några rader med .NET-kod för att verifiera Otp-dokument och deras Text-signaturer."

############################# Header ############################
title: "Text signaturverifiering för Otp-filer"
description: "API för .NET ger möjlighet att verifiera Text-signaturer i Otp-dokument. Verifiering av e-signaturer i dina Otp-dokument kan utföras snabbt och enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Text-signaturer placerade i Otp-dokument. Använd denna möjlighet utan att implementera extra kod.
