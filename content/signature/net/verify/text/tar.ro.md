...
############################# Head ############################
head_title: "Verificarea semnăturilor Text pentru fișierele Tar prin C#"
head_description: "Utilizați doar câteva rânduri de cod .NET pentru a verifica documentele Tar și semnăturile acestora Text."

############################# Header ############################
title: "Text verificarea semnăturilor pentru fișiere Tar"
description: "API-ul pentru .NET oferă posibilitatea de a verifica semnăturile Text în documentele Tar. Verificarea semnăturilor electronice din documentele dvs. Tar poate fi efectuată rapid și ușor."
...
steps:
    enable: true
    title_left: "Cum să validați semnăturile Text în documentul dvs. Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) include funcții utile, cum ar fi verificarea semnăturilor Text plasate în documentele Tar. Folosiți această oportunitate fără a implementa cod suplimentar.
...
demos:
    ...
    content: |
       Adăugați diverse semnături electronice în fișierul Tar chiar acum, vizitând site-ul web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
