...
############################# Head ############################
head_title: "Provjera Text potpisa za Docm datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Docm dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za Docm datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Text u dokumentima Docm. Provjera e-potpisa unutar vaših Docm dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente Docm. Iskoristite ovu priliku bez implementacije dodatnog koda.
