...
############################# Head ############################
head_title: "Ověření podpisů Text pro soubory Doc prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Doc a jejich podpisů Text."

############################# Header ############################
title: "Ověření podpisů Text pro soubory Doc"
description: "API pro .NET poskytuje příležitost ověřit podpisy Text v dokumentech Doc. Ověření elektronických podpisů ve vašich dokumentech Doc může být provedeno rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Text umístěných v dokumentech Doc. Využijte tuto příležitost bez implementace dalšího kódu.
