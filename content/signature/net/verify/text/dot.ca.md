...
############################# Head ############################
head_title: "Verificació de signatures de Text per a fitxers Dot mitjançant C#"
head_description: "Utilitzeu només unes poques línies de codi .NET per verificar els documents Dot i les seves signatures Text."

############################# Header ############################
title: "Text verificació de signatures per a fitxers Dot"
description: "L'API per a .NET ofereix l'oportunitat de verificar les signatures de Text als documents Dot. La verificació de les signatures electròniques dins dels vostres documents Dot es pot fer de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com validar les signatures de Text al vostre document Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclou funcions útils com la verificació de les signatures de Text col·locades als documents de Dot. Aprofiteu aquesta oportunitat sense implementar codi addicional.
