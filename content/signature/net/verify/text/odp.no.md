...
############################# Head ############################
head_title: "Bekreftelse av Text signaturer for Odp filer via C#"
head_description: "Bruk bare noen få linjer med .NET-kode for å bekrefte Odp-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekreftelse for Odp-filer"
description: "API for .NET gir mulighet til å bekrefte Text-signaturer i Odp-dokumenter. Verifisering av e-signaturer i Odp-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funksjoner som bekreftelse av Text-signaturer plassert på Odp-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
