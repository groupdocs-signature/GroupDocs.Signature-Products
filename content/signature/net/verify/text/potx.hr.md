...
############################# Head ############################
head_title: "Provjera Text potpisa za Potx datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Potx dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za Potx datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Text u dokumentima Potx. Provjera e-potpisa unutar vaših Potx dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente Potx. Iskoristite ovu priliku bez implementacije dodatnog koda.
