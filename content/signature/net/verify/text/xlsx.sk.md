...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Xlsx cez C#"
head_description: "Na overenie dokumentov Xlsx a ich podpisov Text použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Xlsx"
description: "API pre .NET poskytuje možnosť overiť podpisy Text v dokumentoch Xlsx. Overenie elektronických podpisov vo vašich dokumentoch Xlsx môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Xlsx. Využite túto príležitosť bez implementácie dodatočného kódu.
