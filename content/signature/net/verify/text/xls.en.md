...
############################# Head ############################
head_title: "Verification of Text signatures for Xls files in C#"
head_description: "Use only a few lines of .NET code to verify Xls documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Xls files"
description: "API for .NET provides opportunity to verify Text signatures at Xls documents. Verification of e-signatures inside your Xls documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Text signatures in your Xls document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Text signatures placed at Xls documents. Use this opportunity without implementing extra code.
