...
############################# Head ############################
head_title: "Verification of Text signatures for Xls files via C#"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like verification of Text signatures placed at Xls documents. Use this opportunity without implementing extra code.
