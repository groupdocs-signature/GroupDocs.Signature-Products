...
############################# Head ############################
head_title: "Vérification des signatures Text pour les fichiers Pptx via C#"
head_description: "Utilisez seulement quelques lignes de code .NET pour vérifier les documents Pptx et leurs signatures Text."

############################# Header ############################
title: "Vérification des signatures Text pour les fichiers Pptx"
description: "L'API pour .NET offre la possibilité de vérifier les signatures Text sur les documents Pptx. La vérification des signatures électroniques dans vos documents Pptx peut être effectuée rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment valider les signatures Text dans votre document Pptx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclut des fonctionnalités utiles telles que la vérification des signatures Text placées sur les documents Pptx. Utilisez cette opportunité sans implémenter de code supplémentaire.
