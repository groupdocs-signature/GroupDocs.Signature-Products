...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Tar cez C#"
head_description: "Na overenie dokumentov Tar a ich podpisov Text použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Tar"
description: "API pre .NET poskytuje možnosť overiť podpisy Text v dokumentoch Tar. Overenie elektronických podpisov vo vašich dokumentoch Tar môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Text vo vašom dokumente Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Tar. Využite túto príležitosť bez implementácie dodatočného kódu.
