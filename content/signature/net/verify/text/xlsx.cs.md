...
############################# Head ############################
head_title: "Ověření podpisů Text pro soubory Xlsx prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Xlsx a jejich podpisů Text."

############################# Header ############################
title: "Ověření podpisů Text pro soubory Xlsx"
description: "API pro .NET poskytuje příležitost ověřit podpisy Text v dokumentech Xlsx. Ověření elektronických podpisů ve vašich dokumentech Xlsx může být provedeno rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Text umístěných v dokumentech Xlsx. Využijte tuto příležitost bez implementace dalšího kódu.
