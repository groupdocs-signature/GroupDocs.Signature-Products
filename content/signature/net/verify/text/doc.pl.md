...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Doc przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Doc i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Doc"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Text w dokumentach Doc. Weryfikacja podpisów elektronicznych w dokumentach Doc może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Doc. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
