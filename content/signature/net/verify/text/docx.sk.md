...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Docx cez C#"
head_description: "Na overenie dokumentov Docx a ich podpisov Text použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Docx"
description: "API pre .NET poskytuje možnosť overiť podpisy Text v dokumentoch Docx. Overenie elektronických podpisov vo vašich dokumentoch Docx môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Docx. Využite túto príležitosť bez implementácie dodatočného kódu.
