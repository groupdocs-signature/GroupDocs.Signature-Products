...
############################# Head ############################
head_title: "Text allkirjade kontrollimine failide Csv jaoks läbi C#"
head_description: "Kasutage Csv dokumentide ja nende allkirjade Text kontrollimiseks ainult mõnda rida .NET koodi."

############################# Header ############################
title: "Text allkirjade kontrollimine faili Csv jaoks"
description: "API for .NET annab võimaluse kontrollida Text allkirju Csv dokumentides. Teie Csv dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sisaldab kasulikke funktsioone, nagu Text allkirjade kontrollimine, mis on pandud dokumentidele Csv. Kasutage seda võimalust lisakoodi rakendamata.
