...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Pptm przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Pptm i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Pptm"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Text w dokumentach Pptm. Weryfikacja podpisów elektronicznych w dokumentach Pptm może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Pptm. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
