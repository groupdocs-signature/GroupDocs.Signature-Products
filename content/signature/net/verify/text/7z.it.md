...
############################# Head ############################
head_title: "Verifica delle firme Text per i file 7z tramite C#"
head_description: "Utilizza solo poche righe di codice .NET per verificare i documenti 7z e le relative firme Text."

############################# Header ############################
title: "Verifica delle firme Text per i file 7z"
description: "L'API per .NET offre l'opportunità di verificare le firme Text nei documenti 7z. La verifica delle firme elettroniche all'interno dei tuoi documenti 7z potrebbe essere eseguita in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Come convalidare le firme Text nel tuo documento 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) include funzioni utili come la verifica delle firme Text apposte in 7z documenti. Usa questa opportunità senza implementare codice aggiuntivo.
