...
############################# Head ############################
head_title: "Pengesahan tandatangan Text untuk fail Pdf melalui C#"
head_description: "Gunakan hanya beberapa baris kod .NET untuk mengesahkan dokumen Pdf dan tandatangan Text mereka."

############################# Header ############################
title: "Text pengesahan tandatangan untuk fail Pdf."
description: "API untuk .NET memberi peluang untuk mengesahkan tandatangan Text pada dokumen Pdf. Pengesahan e-tandatangan di dalam dokumen Pdf anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengesahkan tandatangan Text dalam dokumen Pdf anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) termasuk ciri berguna seperti pengesahan tandatangan Text yang diletakkan pada dokumen Pdf. Gunakan peluang ini tanpa melaksanakan kod tambahan.
