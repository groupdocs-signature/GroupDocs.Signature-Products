...
############################# Head ############################
head_title: "Bekræftelse af Text signaturer for Doc filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Doc-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekræftelse for Doc filer"
description: "API for .NET giver mulighed for at bekræfte Text-signaturer på Doc-dokumenter. Bekræftelse af e-signaturer i dine Doc-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Text-signaturer i dit Doc-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Text signaturer placeret på Doc dokumenter. Brug denne mulighed uden at implementere ekstra kode.
