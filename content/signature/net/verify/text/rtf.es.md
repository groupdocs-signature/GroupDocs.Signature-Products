...
############################# Head ############################
head_title: "Verificación de Text firmas para Rtf archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Rtf y sus firmas Text."

############################# Header ############################
title: "Text verificación de firmas para Rtf archivos"
description: "La API para .NET brinda la oportunidad de verificar Text firmas en Rtf documentos. La verificación de las firmas electrónicas dentro de sus documentos Rtf se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Text firmas en su documento Rtf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Text firmas colocadas en Rtf documentos. Aproveche esta oportunidad sin implementar código adicional.
