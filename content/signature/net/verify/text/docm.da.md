...
############################# Head ############################
head_title: "Bekræftelse af Text signaturer for Docm filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Docm-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekræftelse for Docm filer"
description: "API for .NET giver mulighed for at bekræfte Text-signaturer på Docm-dokumenter. Bekræftelse af e-signaturer i dine Docm-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Text signaturer placeret på Docm dokumenter. Brug denne mulighed uden at implementere ekstra kode.
