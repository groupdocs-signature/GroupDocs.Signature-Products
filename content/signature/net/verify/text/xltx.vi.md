...
############################# Head ############################
head_title: "Xác minh chữ ký Text cho tệp Xltx qua C#"
head_description: "Chỉ sử dụng một vài dòng mã .NET để xác minh tài liệu Xltx và chữ ký Text của chúng."

############################# Header ############################
title: "Xác minh chữ ký Text cho các tệp Xltx"
description: "API cho .NET cung cấp cơ hội xác minh chữ ký Text tại tài liệu Xltx. Việc xác minh chữ ký điện tử bên trong tài liệu Xltx của bạn có thể được thực hiện nhanh chóng và dễ dàng."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) bao gồm các tính năng hữu ích như xác minh chữ ký Text được đặt trong tài liệu Xltx. Sử dụng cơ hội này mà không cần triển khai thêm mã.
