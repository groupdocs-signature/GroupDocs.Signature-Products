...
############################# Head ############################
head_title: "Vérification des signatures Text pour les fichiers Ott via C#"
head_description: "Utilisez seulement quelques lignes de code .NET pour vérifier les documents Ott et leurs signatures Text."

############################# Header ############################
title: "Vérification des signatures Text pour les fichiers Ott"
description: "L'API pour .NET offre la possibilité de vérifier les signatures Text sur les documents Ott. La vérification des signatures électroniques dans vos documents Ott peut être effectuée rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment valider les signatures Text dans votre document Ott"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclut des fonctionnalités utiles telles que la vérification des signatures Text placées sur les documents Ott. Utilisez cette opportunité sans implémenter de code supplémentaire.
