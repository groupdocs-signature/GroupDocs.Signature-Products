...
############################# Head ############################
head_title: "Odp dosyaları için Text imzalarının C# aracılığıyla doğrulanması"
head_description: "Odp belgelerini ve bunların Text imzalarını doğrulamak için yalnızca birkaç satır .NET kodu kullanın."

############################# Header ############################
title: "Odp dosyaları için Text imza doğrulaması"
description: ".NET için API, Odp belgelerinde Text imzalarını doğrulama fırsatı sunar. Odp belgelerinizdeki e-imzaların doğrulanması hızlı ve kolay bir şekilde gerçekleştirilebilir."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Odp belgelerine yerleştirilen Text imzalarının doğrulanması gibi faydalı özellikler içerir. Ekstra kod uygulamadan bu fırsatı kullanın.
