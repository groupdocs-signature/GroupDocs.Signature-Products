...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Pps cez C#"
head_description: "Na overenie dokumentov Pps a ich podpisov Text použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Pps"
description: "API pre .NET poskytuje možnosť overiť podpisy Text v dokumentoch Pps. Overenie elektronických podpisov vo vašich dokumentoch Pps môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Pps. Využite túto príležitosť bez implementácie dodatočného kódu.
