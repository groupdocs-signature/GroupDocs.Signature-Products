...
############################# Head ############################
head_title: "Provjera Text potpisa za Dot datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Dot dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za Dot datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Text u dokumentima Dot. Provjera e-potpisa unutar vaših Dot dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Text u vašem Dot dokumentu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente Dot. Iskoristite ovu priliku bez implementacije dodatnog koda.
