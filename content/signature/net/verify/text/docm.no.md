...
############################# Head ############################
head_title: "Bekreftelse av Text signaturer for Docm filer via C#"
head_description: "Bruk bare noen få linjer med .NET-kode for å bekrefte Docm-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekreftelse for Docm-filer"
description: "API for .NET gir mulighet til å bekrefte Text-signaturer i Docm-dokumenter. Verifisering av e-signaturer i Docm-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funksjoner som bekreftelse av Text-signaturer plassert på Docm-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
