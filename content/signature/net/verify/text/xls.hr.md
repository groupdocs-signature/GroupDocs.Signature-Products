...
############################# Head ############################
head_title: "Provjera Text potpisa za Xls datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Xls dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za Xls datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Text u dokumentima Xls. Provjera e-potpisa unutar vaših Xls dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente Xls. Iskoristite ovu priliku bez implementacije dodatnog koda.
