...
############################# Head ############################
head_title: "Fíorú Text sínithe do chomhaid Pptx trí C#"
head_description: "Ná húsáid ach cúpla líne de chód .NET chun doiciméid Pptx agus a gcuid sínithe Text a fhíorú."

############################# Header ############################
title: "Text fíorú sínithe le haghaidh comhad Pptx"
description: "Soláthraíonn API do .NET deis chun Text sínithe ag Pptx doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Pptx a fhíorú go tapa agus go héasca."
...
steps:
    ...
    content_left: |
        Áiríonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail fíorú Text sínithe atá curtha ag Pptx doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
