...
############################# Head ############################
head_title: "Verificació de signatures de Text per a fitxers Ods mitjançant C#"
head_description: "Utilitzeu només unes poques línies de codi .NET per verificar els documents Ods i les seves signatures Text."

############################# Header ############################
title: "Text verificació de signatures per a fitxers Ods"
description: "L'API per a .NET ofereix l'oportunitat de verificar les signatures de Text als documents Ods. La verificació de les signatures electròniques dins dels vostres documents Ods es pot fer de manera ràpida i senzilla."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclou funcions útils com la verificació de les signatures de Text col·locades als documents de Ods. Aprofiteu aquesta oportunitat sense implementar codi addicional.
