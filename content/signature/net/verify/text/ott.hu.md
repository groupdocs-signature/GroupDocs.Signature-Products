...
############################# Head ############################
head_title: "A Text aláírások ellenőrzése a Ott fájlokhoz a C# segítségével"
head_description: "Csak néhány sornyi .NET kódot használjon a Ott dokumentumok és a hozzájuk tartozó Text aláírások ellenőrzéséhez."

############################# Header ############################
title: "Text aláírás ellenőrzése a Ott fájlokhoz"
description: "A(z) .NET API lehetőséget biztosít a(z) Text aláírások ellenőrzésére a(z) Ott dokumentumoknál. A Ott dokumentumaiban lévő e-aláírások ellenőrzése gyorsan és egyszerűen elvégezhető."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) olyan hasznos funkciókat tartalmaz, mint a Text aláírások ellenőrzése a Ott dokumentumokban. Használja ki ezt a lehetőséget extra kód alkalmazása nélkül.
