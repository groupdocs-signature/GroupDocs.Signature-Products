...
############################# Head ############################
head_title: "የText ፊርማዎች ለOdp ፋይሎች በC# በኩል ማረጋገጫ"
head_description: "Odp ሰነዶችን እና Text ፊርማቸውን ለማረጋገጥ ጥቂት የ.NET ኮድ መስመሮችን ብቻ ይጠቀሙ።"

############################# Header ############################
title: "ለOdp ፋይሎች የText ፊርማ ማረጋገጫ"
description: "ኤፒአይ ለ.NET የText ፊርማዎችን በOdp ሰነዶች ለማረጋገጥ እድል ይሰጣል። በእርስዎ Odp ሰነዶች ውስጥ ያሉ የኢ-ፊርማዎች ማረጋገጫ በፍጥነት እና በቀላሉ ሊከናወን ይችላል።"
...
steps:
    enable: true
    title_left: "በእርስዎ Odp ሰነድ ውስጥ የText ፊርማዎችን እንዴት ማረጋገጥ እንደሚቻል"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) በOdp ሰነዶች ላይ የተቀመጡ የText ፊርማዎችን ማረጋገጥ ያሉ ጠቃሚ ባህሪያትን ያካትታል። ተጨማሪ ኮድ ሳይተገብሩ ይህንን እድል ይጠቀሙ።
