...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory 7z cez C#"
head_description: "Na overenie dokumentov 7z a ich podpisov Text použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Text pre súbory 7z"
description: "API pre .NET poskytuje možnosť overiť podpisy Text v dokumentoch 7z. Overenie elektronických podpisov vo vašich dokumentoch 7z môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch 7z. Využite túto príležitosť bez implementácie dodatočného kódu.
