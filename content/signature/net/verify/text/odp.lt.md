...
############################# Head ############################
head_title: "Text failų Odp parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Odp dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Odp failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Text parašus Odp dokumentuose. El. parašų patvirtinimas jūsų Odp dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Odp dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
