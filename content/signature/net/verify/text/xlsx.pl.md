...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Xlsx przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Xlsx i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Xlsx"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Text w dokumentach Xlsx. Weryfikacja podpisów elektronicznych w dokumentach Xlsx może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Xlsx. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
