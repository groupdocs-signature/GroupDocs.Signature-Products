...
############################# Head ############################
head_title: "Verifikasie van Text handtekeninge vir Doc lêers via C#"
head_description: "Gebruik slegs 'n paar reëls van .NET-kode om Doc-dokumente en hul Text-handtekeninge te verifieer."

############################# Header ############################
title: "Text handtekeningverifikasie vir Doc lêers"
description: "API vir .NET bied geleentheid om Text handtekeninge by Doc dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Doc dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos verifikasie van Text-handtekeninge wat by Doc-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
