...
############################# Head ############################
head_title: "Preverjanje podpisov Text za datoteke Odp prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Odp in njihovih podpisov Text."

############################# Header ############################
title: "Preverjanje podpisov Text za datoteke Odp"
description: "API za .NET ponuja možnost preverjanja podpisov Text v dokumentih Odp. Preverjanje e-podpisov v vaših Odp dokumentih lahko izvedete hitro in enostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Text v dokumentih Odp. Izkoristite to priložnost brez implementacije dodatne kode.
