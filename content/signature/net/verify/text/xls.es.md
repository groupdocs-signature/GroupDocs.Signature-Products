...
############################# Head ############################
head_title: "Verificación de Text firmas para Xls archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Xls y sus firmas Text."

############################# Header ############################
title: "Text verificación de firmas para Xls archivos"
description: "La API para .NET brinda la oportunidad de verificar Text firmas en Xls documentos. La verificación de las firmas electrónicas dentro de sus documentos Xls se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Text firmas colocadas en Xls documentos. Aproveche esta oportunidad sin implementar código adicional.
