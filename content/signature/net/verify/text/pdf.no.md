...
############################# Head ############################
head_title: "Bekreftelse av Text signaturer for Pdf filer via C#"
head_description: "Bruk bare noen få linjer med .NET-kode for å bekrefte Pdf-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekreftelse for {{Filformat}}-filer"
description: "API for .NET gir mulighet til å bekrefte Text-signaturer i Pdf-dokumenter. Verifisering av e-signaturer i Pdf-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funksjoner som bekreftelse av Text-signaturer plassert på Pdf-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
