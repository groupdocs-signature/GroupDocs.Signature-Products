...
############################# Head ############################
head_title: "Preverjanje podpisov Text za datoteke Docm prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Docm in njihovih podpisov Text."

############################# Header ############################
title: "Preverjanje podpisov Text za datoteke Docm"
description: "API za .NET ponuja možnost preverjanja podpisov Text v dokumentih Docm. Preverjanje e-podpisov v vaših Docm dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Text v dokumentu Docm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Text v dokumentih Docm. Izkoristite to priložnost brez implementacije dodatne kode.
