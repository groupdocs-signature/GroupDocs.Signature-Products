...
############################# Head ############################
head_title: "Vérification des signatures Text pour les fichiers Odt via C#"
head_description: "Utilisez seulement quelques lignes de code .NET pour vérifier les documents Odt et leurs signatures Text."

############################# Header ############################
title: "Vérification des signatures Text pour les fichiers Odt"
description: "L'API pour .NET offre la possibilité de vérifier les signatures Text sur les documents Odt. La vérification des signatures électroniques dans vos documents Odt peut être effectuée rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment valider les signatures Text dans votre document Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclut des fonctionnalités utiles telles que la vérification des signatures Text placées sur les documents Odt. Utilisez cette opportunité sans implémenter de code supplémentaire.
