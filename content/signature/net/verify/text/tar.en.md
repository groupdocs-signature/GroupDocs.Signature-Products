...
############################# Head ############################
head_title: "Verification of Text signatures for Tar files via C#"
head_description: "Use only a few lines of .NET code to verify Tar documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Tar files"
description: "API for .NET provides opportunity to verify Text signatures at Tar documents. Verification of e-signatures inside your Tar documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Text signatures in your Tar document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like verification of Text signatures placed at Tar documents. Use this opportunity without implementing extra code.
