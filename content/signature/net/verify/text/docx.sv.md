...
############################# Head ############################
head_title: "Verifiering av Text-signaturer för Docx-filer via C#"
head_description: "Använd bara några rader med .NET-kod för att verifiera Docx-dokument och deras Text-signaturer."

############################# Header ############################
title: "Text signaturverifiering för Docx-filer"
description: "API för .NET ger möjlighet att verifiera Text-signaturer i Docx-dokument. Verifiering av e-signaturer i dina Docx-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Text-signaturer i ditt Docx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Text-signaturer placerade i Docx-dokument. Använd denna möjlighet utan att implementera extra kod.
