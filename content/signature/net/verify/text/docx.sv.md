...
description: "API för .NET ger möjlighet att verifiera Text-signaturer i Docx-dokument. Verifiering av e-signaturer i dina {{Filformat}}-dokument kan utföras snabbt och enkelt."
