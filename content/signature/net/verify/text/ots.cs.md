...
############################# Head ############################
head_title: "Ověření podpisů Text pro soubory Ots prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Ots a jejich podpisů Text."

############################# Header ############################
title: "Ověření podpisů Text pro soubory Ots"
description: "API pro .NET poskytuje příležitost ověřit podpisy Text v dokumentech Ots. Ověření elektronických podpisů ve vašich dokumentech Ots může být provedeno rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Text umístěných v dokumentech Ots. Využijte tuto příležitost bez implementace dalšího kódu.
