...
############################# Head ############################
head_title: "Verification of Text signatures for Rtf files in C#"
head_description: "Use only a few lines of .NET code to verify Rtf documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Rtf files"
description: "API for .NET provides opportunity to verify Text signatures at Rtf documents. Verification of e-signatures inside your Rtf documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Text signatures placed at Rtf documents. Use this opportunity without implementing extra code.
