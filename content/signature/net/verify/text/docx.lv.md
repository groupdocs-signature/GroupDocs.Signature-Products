...
############################# Head ############################
head_title: "Text parakstu pārbaude failiem Docx, izmantojot C#"
head_description: "Izmantojiet tikai dažas .NET koda rindiņas, lai pārbaudītu Docx dokumentus un to Text parakstus."

############################# Header ############################
title: "Text parakstu pārbaude failiem Docx"
description: ".NET API nodrošina iespēju pārbaudīt Text parakstus Docx dokumentos. E-parakstu pārbaude jūsu Docx dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ietver tādas noderīgas funkcijas kā Text parakstu pārbaude, kas ievietoti Docx dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
