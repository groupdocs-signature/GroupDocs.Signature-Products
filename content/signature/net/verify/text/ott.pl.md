...
############################# Head ############################
head_title: "Weryfikacja podpisów Text dla plików Ott przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Ott i ich podpisy Text."

############################# Header ############################
title: "Weryfikacja podpisów Text dla plików Ott"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Text w dokumentach Ott. Weryfikacja podpisów elektronicznych w dokumentach Ott może być przeprowadzona szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zweryfikować podpisy Text w dokumencie Ott?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Text umieszczonych w dokumentach Ott. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
