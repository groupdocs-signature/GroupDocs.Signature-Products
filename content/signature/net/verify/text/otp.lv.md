...
############################# Head ############################
head_title: "Text parakstu pārbaude failiem Otp, izmantojot C#"
head_description: "Izmantojiet tikai dažas .NET koda rindiņas, lai pārbaudītu Otp dokumentus un to Text parakstus."

############################# Header ############################
title: "Text parakstu pārbaude failiem Otp"
description: ".NET API nodrošina iespēju pārbaudīt Text parakstus Otp dokumentos. E-parakstu pārbaude jūsu Otp dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ietver tādas noderīgas funkcijas kā Text parakstu pārbaude, kas ievietoti Otp dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
