...
############################# Head ############################
head_title: "Pengesahan tandatangan Text untuk fail Pptm melalui C#"
head_description: "Gunakan hanya beberapa baris kod .NET untuk mengesahkan dokumen Pptm dan tandatangan Text mereka."

############################# Header ############################
title: "Text pengesahan tandatangan untuk fail Pptm."
description: "API untuk .NET memberi peluang untuk mengesahkan tandatangan Text pada dokumen Pptm. Pengesahan e-tandatangan di dalam dokumen Pptm anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) termasuk ciri berguna seperti pengesahan tandatangan Text yang diletakkan pada dokumen Pptm. Gunakan peluang ini tanpa melaksanakan kod tambahan.
