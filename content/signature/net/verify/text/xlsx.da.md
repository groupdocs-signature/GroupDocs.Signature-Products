...
description: "API for .NET giver mulighed for at bekræfte Text-signaturer på Xlsx-dokumenter. Bekræftelse af e-signaturer i dine {{Filformat}}-dokumenter kan udføres hurtigt og nemt."
