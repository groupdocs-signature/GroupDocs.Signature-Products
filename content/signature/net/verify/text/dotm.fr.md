...
############################# Head ############################
head_title: "Vérification des signatures Text pour les fichiers Dotm via C#"
head_description: "Utilisez seulement quelques lignes de code .NET pour vérifier les documents Dotm et leurs signatures Text."

############################# Header ############################
title: "Vérification des signatures Text pour les fichiers Dotm"
description: "L'API pour .NET offre la possibilité de vérifier les signatures Text sur les documents Dotm. La vérification des signatures électroniques dans vos documents Dotm peut être effectuée rapidement et facilement."
...
steps:
    enable: true
    title_left: "Comment valider les signatures Text dans votre document Dotm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclut des fonctionnalités utiles telles que la vérification des signatures Text placées sur les documents Dotm. Utilisez cette opportunité sans implémenter de code supplémentaire.
...
more_formats:
    enable: true
    title: "Vérifiez les autres signatures Text à l'aide de C#"
    content: |
