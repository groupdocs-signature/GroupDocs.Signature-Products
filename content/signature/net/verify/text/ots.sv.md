...
############################# Head ############################
head_title: "Verifiering av Text-signaturer för Ots-filer via C#"
head_description: "Använd bara några rader med .NET-kod för att verifiera Ots-dokument och deras Text-signaturer."

############################# Header ############################
title: "Text signaturverifiering för Ots-filer"
description: "API för .NET ger möjlighet att verifiera Text-signaturer i Ots-dokument. Verifiering av e-signaturer i dina Ots-dokument kan utföras snabbt och enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Text-signaturer placerade i Ots-dokument. Använd denna möjlighet utan att implementera extra kod.
