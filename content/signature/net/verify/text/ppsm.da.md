...
############################# Head ############################
head_title: "Bekræftelse af Text signaturer for Ppsm filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Ppsm-dokumenter og deres Text-signaturer."

############################# Header ############################
title: "Text signaturbekræftelse for Ppsm filer"
description: "API for .NET giver mulighed for at bekræfte Text-signaturer på Ppsm-dokumenter. Bekræftelse af e-signaturer i dine Ppsm-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Text signaturer placeret på Ppsm dokumenter. Brug denne mulighed uden at implementere ekstra kode.
