...
############################# Head ############################
head_title: "Ověření podpisů Text pro soubory Ppsm prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Ppsm a jejich podpisů Text."

############################# Header ############################
title: "Ověření podpisů Text pro soubory Ppsm"
description: "API pro .NET poskytuje příležitost ověřit podpisy Text v dokumentech Ppsm. Ověření elektronických podpisů ve vašich dokumentech Ppsm může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Text ve vašem dokumentu Ppsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Text umístěných v dokumentech Ppsm. Využijte tuto příležitost bez implementace dalšího kódu.
