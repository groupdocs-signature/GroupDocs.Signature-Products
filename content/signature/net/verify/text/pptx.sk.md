...
############################# Head ############################
head_title: "Overenie Text podpisov pre súbory Pptx cez C#"
head_description: "Na overenie dokumentov Pptx a ich podpisov Text použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Text pre súbory Pptx"
description: "API pre .NET poskytuje možnosť overiť podpisy Text v dokumentoch Pptx. Overenie elektronických podpisov vo vašich dokumentoch Pptx môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Text umiestnených v dokumentoch Pptx. Využite túto príležitosť bez implementácie dodatočného kódu.
