...
############################# Head ############################
head_title: "Verificación de Text firmas para Dot archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Dot y sus firmas Text."

############################# Header ############################
title: "Text verificación de firmas para Dot archivos"
description: "La API para .NET brinda la oportunidad de verificar Text firmas en Dot documentos. La verificación de las firmas electrónicas dentro de sus documentos Dot se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Text firmas en su documento Dot"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Text firmas colocadas en Dot documentos. Aproveche esta oportunidad sin implementar código adicional.
