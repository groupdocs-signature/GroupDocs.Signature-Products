...
############################# Head ############################
head_title: "Fíorú Text sínithe do chomhaid Pptm trí C#"
head_description: "Ná húsáid ach cúpla líne de chód .NET chun doiciméid Pptm agus a gcuid sínithe Text a fhíorú."

############################# Header ############################
title: "Text fíorú sínithe le haghaidh comhad Pptm"
description: "Soláthraíonn API do .NET deis chun Text sínithe ag Pptm doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Pptm a fhíorú go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Text sínithe i do dhoiciméad Pptm a bhailíochtú"
    content_left: |
        Áiríonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail fíorú Text sínithe atá curtha ag Pptm doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
...
demos:
    ...
    content: |
       Cuir sínithe leictreonacha éagsúla le comhad Pptm faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
