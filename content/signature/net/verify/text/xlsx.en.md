...
############################# Head ############################
head_title: "Verification of Text signatures for Xlsx files in C#"
head_description: "Use only a few lines of .NET code to verify Xlsx documents and their Text signatures."

############################# Header ############################
title: "Text signatures verification for Xlsx files"
description: "API for .NET provides opportunity to verify Text signatures at Xlsx documents. Verification of e-signatures inside your Xlsx documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Text signatures placed at Xlsx documents. Use this opportunity without implementing extra code.
