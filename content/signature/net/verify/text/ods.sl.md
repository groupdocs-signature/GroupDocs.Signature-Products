...
############################# Head ############################
head_title: "Preverjanje podpisov Text za datoteke Ods prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Ods in njihovih podpisov Text."

############################# Header ############################
title: "Preverjanje podpisov Text za datoteke Ods"
description: "API za .NET ponuja možnost preverjanja podpisov Text v dokumentih Ods. Preverjanje e-podpisov v vaših Ods dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Text v dokumentu Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Text v dokumentih Ods. Izkoristite to priložnost brez implementacije dodatne kode.
