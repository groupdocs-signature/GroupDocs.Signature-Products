...
############################# Head ############################
head_title: "Preverjanje podpisov Text za datoteke Odt prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Odt in njihovih podpisov Text."

############################# Header ############################
title: "Preverjanje podpisov Text za datoteke Odt"
description: "API za .NET ponuja možnost preverjanja podpisov Text v dokumentih Odt. Preverjanje e-podpisov v vaših Odt dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Text v dokumentu Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Text v dokumentih Odt. Izkoristite to priložnost brez implementacije dodatne kode.
