...
############################# Head ############################
head_title: "Verificatie van Text handtekeningen voor Doc bestanden via C#"
head_description: "Gebruik slechts een paar regels .NET-code om Doc-documenten en hun Text-handtekeningen te verifiëren."

############################# Header ############################
title: "Text handtekeningverificatie voor Doc bestanden"
description: "API voor .NET biedt de mogelijkheid om Text handtekeningen te verifiëren bij Doc documenten. Verificatie van elektronische handtekeningen in uw Doc documenten kan snel en gemakkelijk worden uitgevoerd."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bevat handige functies zoals verificatie van Text handtekeningen die bij Doc documenten zijn geplaatst. Gebruik deze mogelijkheid zonder extra code te implementeren.
