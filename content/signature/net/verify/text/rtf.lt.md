...
############################# Head ############################
head_title: "Text failų Rtf parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Rtf dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Rtf failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Text parašus Rtf dokumentuose. El. parašų patvirtinimas jūsų Rtf dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Rtf dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
