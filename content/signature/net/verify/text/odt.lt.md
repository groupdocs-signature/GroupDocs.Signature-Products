...
############################# Head ############################
head_title: "Text failų Odt parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Odt dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Odt failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Text parašus Odt dokumentuose. El. parašų patvirtinimas jūsų Odt dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Odt dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
