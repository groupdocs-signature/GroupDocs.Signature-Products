...
############################# Head ############################
head_title: "Provjera Text potpisa za Xltm datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Xltm dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za Xltm datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Text u dokumentima Xltm. Provjera e-potpisa unutar vaših Xltm dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente Xltm. Iskoristite ovu priliku bez implementacije dodatnog koda.
