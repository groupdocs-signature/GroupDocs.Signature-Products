...
############################# Head ############################
head_title: "Text failų Dotx parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Dotx dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Dotx failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Text parašus Dotx dokumentuose. El. parašų patvirtinimas jūsų Dotx dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Dotx dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
