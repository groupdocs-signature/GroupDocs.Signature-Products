...
############################# Head ############################
head_title: "Text failų Docx parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Docx dokumentus ir jų Text parašus."

############################# Header ############################
title: "Text parašų patvirtinimas Docx failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Text parašus Docx dokumentuose. El. parašų patvirtinimas jūsų Docx dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Text parašų, pateiktų Docx dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
