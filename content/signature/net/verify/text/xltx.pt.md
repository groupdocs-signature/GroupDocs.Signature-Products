...
############################# Head ############################
head_title: "Verificação de assinaturas Text para arquivos Xltx via C#"
head_description: "Use apenas algumas linhas de código .NET para verificar documentos Xltx e suas assinaturas Text."

############################# Header ############################
title: "Text verificação de assinaturas para Xltx arquivos"
description: "A API para .NET oferece a oportunidade de verificar assinaturas Text em documentos Xltx. A verificação de assinaturas eletrônicas dentro de seus documentos Xltx pode ser realizada de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis, como verificação de Text assinaturas colocadas em documentos Xltx. Use esta oportunidade sem implementar código extra.
