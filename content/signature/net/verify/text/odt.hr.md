...
############################# Head ############################
head_title: "Provjera Text potpisa za Odt datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Odt dokumenata i njihovih Text potpisa."

############################# Header ############################
title: "Provjera potpisa Text za Odt datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Text u dokumentima Odt. Provjera e-potpisa unutar vaših Odt dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Text u vašem Odt dokumentu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Text postavljenih na dokumente Odt. Iskoristite ovu priliku bez implementacije dodatnog koda.
