...
############################# Head ############################
head_title: "Verifikasie van Text handtekeninge vir Xlsb lêers via C#"
head_description: "Gebruik slegs 'n paar reëls van .NET-kode om Xlsb-dokumente en hul Text-handtekeninge te verifieer."

############################# Header ############################
title: "Text handtekeningverifikasie vir Xlsb lêers"
description: "API vir .NET bied geleentheid om Text handtekeninge by Xlsb dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Xlsb dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos verifikasie van Text-handtekeninge wat by Xlsb-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
