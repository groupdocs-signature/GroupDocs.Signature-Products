...
############################# Head ############################
head_title: "Verificarea semnăturilor Text pentru fișierele Xlsx prin C#"
head_description: "Utilizați doar câteva rânduri de cod .NET pentru a verifica documentele Xlsx și semnăturile acestora Text."

############################# Header ############################
title: "Text verificarea semnăturilor pentru fișiere Xlsx"
description: "API-ul pentru .NET oferă posibilitatea de a verifica semnăturile Text în documentele Xlsx. Verificarea semnăturilor electronice din documentele dvs. Xlsx poate fi efectuată rapid și ușor."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) include funcții utile, cum ar fi verificarea semnăturilor Text plasate în documentele Xlsx. Folosiți această oportunitate fără a implementa cod suplimentar.
