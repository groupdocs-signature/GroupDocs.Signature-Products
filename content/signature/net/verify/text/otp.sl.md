...
############################# Head ############################
head_title: "Preverjanje podpisov Text za datoteke Otp prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Otp in njihovih podpisov Text."

############################# Header ############################
title: "Preverjanje podpisov Text za datoteke Otp"
description: "API za .NET ponuja možnost preverjanja podpisov Text v dokumentih Otp. Preverjanje e-podpisov v vaših Otp dokumentih lahko izvedete hitro in enostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Text v dokumentih Otp. Izkoristite to priložnost brez implementacije dodatne kode.
