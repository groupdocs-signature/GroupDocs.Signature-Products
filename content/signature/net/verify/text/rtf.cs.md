...
############################# Head ############################
head_title: "Ověření podpisů Text pro soubory Rtf prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Rtf a jejich podpisů Text."

############################# Header ############################
title: "Ověření podpisů Text pro soubory Rtf"
description: "API pro .NET poskytuje příležitost ověřit podpisy Text v dokumentech Rtf. Ověření elektronických podpisů ve vašich dokumentech Rtf může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Text ve vašem dokumentu Rtf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Text umístěných v dokumentech Rtf. Využijte tuto příležitost bez implementace dalšího kódu.
