...
############################# Head ############################
head_title: "Bekræftelse af Digital signaturer for Ott filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Ott-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekræftelse for Ott filer"
description: "API for .NET giver mulighed for at bekræfte Digital-signaturer på Ott-dokumenter. Bekræftelse af e-signaturer i dine Ott-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Digital signaturer placeret på Ott dokumenter. Brug denne mulighed uden at implementere ekstra kode.
