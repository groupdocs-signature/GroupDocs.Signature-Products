...
############################# Head ############################
head_title: "Verifikasie van Digital handtekeninge vir Xlsm lêers via C#"
head_description: "Gebruik slegs 'n paar reëls van .NET-kode om Xlsm-dokumente en hul Digital-handtekeninge te verifieer."

############################# Header ############################
title: "Digital handtekeningverifikasie vir Xlsm lêers"
description: "API vir .NET bied geleentheid om Digital handtekeninge by Xlsm dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Xlsm dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos verifikasie van Digital-handtekeninge wat by Xlsm-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
