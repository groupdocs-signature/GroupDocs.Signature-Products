...
############################# Head ############################
head_title: "Проверка на Digital подписи за Ots файлове чрез C#"
head_description: "Използвайте само няколко реда от кода на .NET, за да проверите документите Ots и техните подписи Digital."

############################# Header ############################
title: "Digital проверка на подписи за Ots файлове"
description: "API за .NET предоставя възможност за проверка на Digital подписи в Ots документи. Проверката на електронните подписи във вашите Ots документи може да се извърши бързо и лесно."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) включва полезни функции като проверка на подписи Digital, поставени в Ots документи. Използвайте тази възможност без внедряване на допълнителен код.
