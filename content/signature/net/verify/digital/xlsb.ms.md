...
############################# Head ############################
head_title: "Pengesahan tandatangan Digital untuk fail Xlsb melalui C#"
head_description: "Gunakan hanya beberapa baris kod .NET untuk mengesahkan dokumen Xlsb dan tandatangan Digital mereka."

############################# Header ############################
title: "Digital pengesahan tandatangan untuk fail Xlsb."
description: "API untuk .NET memberi peluang untuk mengesahkan tandatangan Digital pada dokumen Xlsb. Pengesahan e-tandatangan di dalam dokumen Xlsb anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) termasuk ciri berguna seperti pengesahan tandatangan Digital yang diletakkan pada dokumen Xlsb. Gunakan peluang ini tanpa melaksanakan kod tambahan.
