...
############################# Head ############################
head_title: "Verification of Digital signatures for Xltx files in C#"
head_description: "Use only a few lines of .NET code to verify Xltx documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Xltx files"
description: "API for .NET provides opportunity to verify Digital signatures at Xltx documents. Verification of e-signatures inside your Xltx documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Digital signatures placed at Xltx documents. Use this opportunity without implementing extra code.
