...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory Xlsx cez C#"
head_description: "Na overenie dokumentov Xlsx a ich podpisov Digital použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory Xlsx"
description: "API pre .NET poskytuje možnosť overiť podpisy Digital v dokumentoch Xlsx. Overenie elektronických podpisov vo vašich dokumentoch Xlsx môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Digital vo vašom dokumente Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch Xlsx. Využite túto príležitosť bez implementácie dodatočného kódu.
