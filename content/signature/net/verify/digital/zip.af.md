...
############################# Head ############################
head_title: "Verifikasie van Digital handtekeninge vir Zip lêers via C#"
head_description: "Gebruik slegs 'n paar reëls van .NET-kode om Zip-dokumente en hul Digital-handtekeninge te verifieer."

############################# Header ############################
title: "Digital handtekeningverifikasie vir Zip lêers"
description: "API vir .NET bied geleentheid om Digital handtekeninge by Zip dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Zip dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos verifikasie van Digital-handtekeninge wat by Zip-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
