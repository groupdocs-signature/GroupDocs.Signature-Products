...
############################# Head ############################
head_title: "Проверка на Digital подписи за Docx файлове чрез C#"
head_description: "Използвайте само няколко реда от кода на .NET, за да проверите документите Docx и техните подписи Digital."

############################# Header ############################
title: "Digital проверка на подписи за Docx файлове"
description: "API за .NET предоставя възможност за проверка на Digital подписи в Docx документи. Проверката на електронните подписи във вашите Docx документи може да се извърши бързо и лесно."
...
steps:
    enable: true
    title_left: "Как да валидирате Digital подписи във вашия Docx документ"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) включва полезни функции като проверка на подписи Digital, поставени в Docx документи. Използвайте тази възможност без внедряване на допълнителен код.
