...
############################# Head ############################
head_title: "Bekræftelse af Digital signaturer for Docx filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Docx-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekræftelse for Docx filer"
description: "API for .NET giver mulighed for at bekræfte Digital-signaturer på Docx-dokumenter. Bekræftelse af e-signaturer i dine Docx-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Digital-signaturer i dit Docx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Digital signaturer placeret på Docx dokumenter. Brug denne mulighed uden at implementere ekstra kode.
