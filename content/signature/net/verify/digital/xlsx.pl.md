...
############################# Head ############################
head_title: "Weryfikacja podpisów Digital dla plików Xlsx przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Xlsx i ich podpisy Digital."

############################# Header ############################
title: "Weryfikacja podpisów Digital dla plików Xlsx"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Digital w dokumentach Xlsx. Weryfikacja podpisów elektronicznych w dokumentach Xlsx może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Digital umieszczonych w dokumentach Xlsx. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
