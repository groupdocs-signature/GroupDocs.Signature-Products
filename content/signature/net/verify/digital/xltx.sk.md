...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory Xltx cez C#"
head_description: "Na overenie dokumentov Xltx a ich podpisov Digital použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory Xltx"
description: "API pre .NET poskytuje možnosť overiť podpisy Digital v dokumentoch Xltx. Overenie elektronických podpisov vo vašich dokumentoch Xltx môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Digital vo vašom dokumente Xltx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch Xltx. Využite túto príležitosť bez implementácie dodatočného kódu.
