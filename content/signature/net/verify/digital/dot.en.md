...
############################# Head ############################
head_title: "Verification of Digital signatures for Dot files in C#"
head_description: "Use only a few lines of .NET code to verify Dot documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Dot files"
description: "API for .NET provides opportunity to verify Digital signatures at Dot documents. Verification of e-signatures inside your Dot documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Digital signatures placed at Dot documents. Use this opportunity without implementing extra code.
