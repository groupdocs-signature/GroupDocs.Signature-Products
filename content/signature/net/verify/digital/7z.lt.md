...
############################# Head ############################
head_title: "Digital failų 7z parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte 7z dokumentus ir jų Digital parašus."

############################# Header ############################
title: "Digital parašų patvirtinimas 7z failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Digital parašus 7z dokumentuose. El. parašų patvirtinimas jūsų 7z dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Digital parašų, pateiktų 7z dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
