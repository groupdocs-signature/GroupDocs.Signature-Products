...
############################# Head ############################
head_title: "Pengesahan tandatangan Digital untuk fail Zip melalui C#"
head_description: "Gunakan hanya beberapa baris kod .NET untuk mengesahkan dokumen Zip dan tandatangan Digital mereka."

############################# Header ############################
title: "Digital pengesahan tandatangan untuk fail Zip."
description: "API untuk .NET memberi peluang untuk mengesahkan tandatangan Digital pada dokumen Zip. Pengesahan e-tandatangan di dalam dokumen Zip anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) termasuk ciri berguna seperti pengesahan tandatangan Digital yang diletakkan pada dokumen Zip. Gunakan peluang ini tanpa melaksanakan kod tambahan.
