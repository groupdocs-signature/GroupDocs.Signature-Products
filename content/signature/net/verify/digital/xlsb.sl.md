...
############################# Head ############################
head_title: "Preverjanje podpisov Digital za datoteke Xlsb prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Xlsb in njihovih podpisov Digital."

############################# Header ############################
title: "Preverjanje podpisov Digital za datoteke Xlsb"
description: "API za .NET ponuja možnost preverjanja podpisov Digital v dokumentih Xlsb. Preverjanje e-podpisov v vaših Xlsb dokumentih lahko izvedete hitro in enostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Digital v dokumentih Xlsb. Izkoristite to priložnost brez implementacije dodatne kode.
