...
############################# Head ############################
head_title: "Weryfikacja podpisów Digital dla plików Dot przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Dot i ich podpisy Digital."

############################# Header ############################
title: "Weryfikacja podpisów Digital dla plików Dot"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Digital w dokumentach Dot. Weryfikacja podpisów elektronicznych w dokumentach Dot może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Digital umieszczonych w dokumentach Dot. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
