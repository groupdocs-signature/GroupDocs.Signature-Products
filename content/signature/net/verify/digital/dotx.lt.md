...
############################# Head ############################
head_title: "Digital failų Dotx parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Dotx dokumentus ir jų Digital parašus."

############################# Header ############################
title: "Digital parašų patvirtinimas Dotx failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Digital parašus Dotx dokumentuose. El. parašų patvirtinimas jūsų Dotx dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Digital parašų, pateiktų Dotx dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
