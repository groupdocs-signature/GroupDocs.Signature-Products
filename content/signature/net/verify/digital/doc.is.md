...
############################# Head ############################
head_title: "Staðfesting á Digital undirskriftum fyrir Doc skrár í gegnum C#"
head_description: "Notaðu aðeins nokkrar línur af .NET kóða til að staðfesta Doc skjöl og Digital undirskrift þeirra."

############################# Header ############################
title: "Digital staðfesting á undirskriftum fyrir Doc skrár"
description: "API fyrir .NET veitir tækifæri til að staðfesta Digital undirskriftir á Doc skjölum. Staðfesting á rafrænum undirskriftum inni í Doc skjölunum þínum gæti verið framkvæmd fljótt og auðveldlega."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inniheldur gagnlega eiginleika eins og staðfestingu á Digital undirskriftum sem settar eru á Doc skjöl. Notaðu þetta tækifæri án þess að innleiða aukakóða.
