...
############################# Head ############################
head_title: "Verificació de signatures de Digital per a fitxers Odt mitjançant C#"
head_description: "Utilitzeu només unes poques línies de codi .NET per verificar els documents Odt i les seves signatures Digital."

############################# Header ############################
title: "Digital verificació de signatures per a fitxers Odt"
description: "L'API per a .NET ofereix l'oportunitat de verificar les signatures de Digital als documents Odt. La verificació de les signatures electròniques dins dels vostres documents Odt es pot fer de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com validar les signatures de Digital al vostre document Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclou funcions útils com la verificació de les signatures de Digital col·locades als documents de Odt. Aprofiteu aquesta oportunitat sense implementar codi addicional.
