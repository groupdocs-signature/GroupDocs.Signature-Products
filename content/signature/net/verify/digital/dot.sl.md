...
############################# Head ############################
head_title: "Preverjanje podpisov Digital za datoteke Dot prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Dot in njihovih podpisov Digital."

############################# Header ############################
title: "Preverjanje podpisov Digital za datoteke Dot"
description: "API za .NET ponuja možnost preverjanja podpisov Digital v dokumentih Dot. Preverjanje e-podpisov v vaših Dot dokumentih lahko izvedete hitro in enostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Digital v dokumentih Dot. Izkoristite to priložnost brez implementacije dodatne kode.
