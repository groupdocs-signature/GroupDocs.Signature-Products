...
############################# Head ############################
head_title: "Verificación de Digital firmas para Doc archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Doc y sus firmas Digital."

############################# Header ############################
title: "Digital verificación de firmas para Doc archivos"
description: "La API para .NET brinda la oportunidad de verificar Digital firmas en Doc documentos. La verificación de las firmas electrónicas dentro de sus documentos Doc se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Digital firmas en su documento Doc"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Digital firmas colocadas en Doc documentos. Aproveche esta oportunidad sin implementar código adicional.
