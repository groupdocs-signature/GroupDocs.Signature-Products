...
############################# Head ############################
head_title: "Ověření podpisů Digital pro soubory Pdf prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Pdf a jejich podpisů Digital."

############################# Header ############################
title: "Ověření podpisů Digital pro soubory Pdf"
description: "API pro .NET poskytuje příležitost ověřit podpisy Digital v dokumentech Pdf. Ověření elektronických podpisů ve vašich dokumentech Pdf může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Digital ve vašem dokumentu Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Digital umístěných v dokumentech Pdf. Využijte tuto příležitost bez implementace dalšího kódu.
