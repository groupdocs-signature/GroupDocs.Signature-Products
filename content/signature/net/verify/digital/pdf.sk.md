...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory Pdf cez C#"
head_description: "Na overenie dokumentov Pdf a ich podpisov Digital použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory Pdf"
description: "API pre .NET poskytuje možnosť overiť podpisy Digital v dokumentoch Pdf. Overenie elektronických podpisov vo vašich dokumentoch Pdf môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Digital vo vašom dokumente Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch Pdf. Využite túto príležitosť bez implementácie dodatočného kódu.
...
demos:
    ...
    content: |
       Pridajte rôzne elektronické podpisy do súboru Pdf hneď teraz na webovej lokalite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
