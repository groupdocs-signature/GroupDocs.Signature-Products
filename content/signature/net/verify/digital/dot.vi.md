...
############################# Head ############################
head_title: "Xác minh chữ ký Digital cho tệp Dot qua C#"
head_description: "Chỉ sử dụng một vài dòng mã .NET để xác minh tài liệu Dot và chữ ký Digital của chúng."

############################# Header ############################
title: "Xác minh chữ ký Digital cho các tệp Dot"
description: "API cho .NET cung cấp cơ hội xác minh chữ ký Digital tại tài liệu Dot. Việc xác minh chữ ký điện tử bên trong tài liệu Dot của bạn có thể được thực hiện nhanh chóng và dễ dàng."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) bao gồm các tính năng hữu ích như xác minh chữ ký Digital được đặt trong tài liệu Dot. Sử dụng cơ hội này mà không cần triển khai thêm mã.
