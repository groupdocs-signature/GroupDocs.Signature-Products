...
############################# Head ############################
head_title: "Ověření podpisů Digital pro soubory Doc prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Doc a jejich podpisů Digital."

############################# Header ############################
title: "Ověření podpisů Digital pro soubory Doc"
description: "API pro .NET poskytuje příležitost ověřit podpisy Digital v dokumentech Doc. Ověření elektronických podpisů ve vašich dokumentech Doc může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Digital ve vašem dokumentu Doc"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Digital umístěných v dokumentech Doc. Využijte tuto příležitost bez implementace dalšího kódu.
