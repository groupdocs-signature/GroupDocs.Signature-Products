...
############################# Head ############################
head_title: "Verification of Digital signatures for Odt files in C#"
head_description: "Use only a few lines of .NET code to verify Odt documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Odt files"
description: "API for .NET provides opportunity to verify Digital signatures at Odt documents. Verification of e-signatures inside your Odt documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Digital signatures in your Odt document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Digital signatures placed at Odt documents. Use this opportunity without implementing extra code.
