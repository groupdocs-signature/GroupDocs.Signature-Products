...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory 7z cez C#"
head_description: "Na overenie dokumentov 7z a ich podpisov Digital použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory 7z"
description: "API pre .NET poskytuje možnosť overiť podpisy Digital v dokumentoch 7z. Overenie elektronických podpisov vo vašich dokumentoch 7z môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Digital vo vašom dokumente 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch 7z. Využite túto príležitosť bez implementácie dodatočného kódu.
