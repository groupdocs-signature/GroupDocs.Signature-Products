...
############################# Head ############################
head_title: "Digital failų Odt parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Odt dokumentus ir jų Digital parašus."

############################# Header ############################
title: "Digital parašų patvirtinimas Odt failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Digital parašus Odt dokumentuose. El. parašų patvirtinimas jūsų Odt dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    enable: true
    title_left: "Kaip patvirtinti Digital parašus Odt dokumente"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Digital parašų, pateiktų Odt dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
