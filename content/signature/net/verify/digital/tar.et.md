...
############################# Head ############################
head_title: "Digital allkirjade kontrollimine failide Tar jaoks läbi C#"
head_description: "Kasutage Tar dokumentide ja nende allkirjade Digital kontrollimiseks ainult mõnda rida .NET koodi."

############################# Header ############################
title: "Digital allkirjade kontrollimine faili Tar jaoks"
description: "API for .NET annab võimaluse kontrollida Digital allkirju Tar dokumentides. Teie Tar dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    enable: true
    title_left: "Kuidas kontrollida allkirja Digital oma dokumendis Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sisaldab kasulikke funktsioone, nagu Digital allkirjade kontrollimine, mis on pandud dokumentidele Tar. Kasutage seda võimalust lisakoodi rakendamata.
