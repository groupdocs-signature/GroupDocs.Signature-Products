...
############################# Head ############################
head_title: "Provjera Digital potpisa za Doc datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Doc dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za Doc datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Digital u dokumentima Doc. Provjera e-potpisa unutar vaših Doc dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente Doc. Iskoristite ovu priliku bez implementacije dodatnog koda.
