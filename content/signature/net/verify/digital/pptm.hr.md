...
############################# Head ############################
head_title: "Provjera Digital potpisa za Pptm datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Pptm dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za Pptm datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Digital u dokumentima Pptm. Provjera e-potpisa unutar vaših Pptm dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente Pptm. Iskoristite ovu priliku bez implementacije dodatnog koda.
