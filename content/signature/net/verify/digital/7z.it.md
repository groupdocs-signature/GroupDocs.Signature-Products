...
############################# Head ############################
head_title: "Verifica delle firme Digital per i file 7z tramite C#"
head_description: "Utilizza solo poche righe di codice .NET per verificare i documenti 7z e le relative firme Digital."

############################# Header ############################
title: "Verifica delle firme Digital per i file 7z"
description: "L'API per .NET offre l'opportunità di verificare le firme Digital nei documenti 7z. La verifica delle firme elettroniche all'interno dei tuoi documenti 7z potrebbe essere eseguita in modo rapido e semplice."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) include funzioni utili come la verifica delle firme Digital apposte in 7z documenti. Usa questa opportunità senza implementare codice aggiuntivo.
