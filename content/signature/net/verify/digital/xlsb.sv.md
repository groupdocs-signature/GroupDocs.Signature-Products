...
############################# Head ############################
head_title: "Verifiering av Digital-signaturer för Xlsb-filer via C#"
head_description: "Använd bara några rader med .NET-kod för att verifiera Xlsb-dokument och deras Digital-signaturer."

############################# Header ############################
title: "Digital signaturverifiering för Xlsb-filer"
description: "API för .NET ger möjlighet att verifiera Digital-signaturer i Xlsb-dokument. Verifiering av e-signaturer i dina Xlsb-dokument kan utföras snabbt och enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Digital-signaturer placerade i Xlsb-dokument. Använd denna möjlighet utan att implementera extra kod.
