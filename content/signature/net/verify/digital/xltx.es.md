...
############################# Head ############################
head_title: "Verificación de Digital firmas para Xltx archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Xltx y sus firmas Digital."

############################# Header ############################
title: "Digital verificación de firmas para Xltx archivos"
description: "La API para .NET brinda la oportunidad de verificar Digital firmas en Xltx documentos. La verificación de las firmas electrónicas dentro de sus documentos Xltx se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Digital firmas en su documento Xltx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Digital firmas colocadas en Xltx documentos. Aproveche esta oportunidad sin implementar código adicional.
...
more_formats:
    enable: true
    title: "Verificar otras firmas Digital usando C#"
    content: |
