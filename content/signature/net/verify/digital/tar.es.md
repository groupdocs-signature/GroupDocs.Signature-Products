...
############################# Head ############################
head_title: "Verificación de Digital firmas para Tar archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Tar y sus firmas Digital."

############################# Header ############################
title: "Digital verificación de firmas para Tar archivos"
description: "La API para .NET brinda la oportunidad de verificar Digital firmas en Tar documentos. La verificación de las firmas electrónicas dentro de sus documentos Tar se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Digital firmas en su documento Tar"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Digital firmas colocadas en Tar documentos. Aproveche esta oportunidad sin implementar código adicional.
...
demos:
    ...
    content: |
       Agregue varias firmas electrónicas al archivo Tar ahora mismo visitando el sitio web de [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
