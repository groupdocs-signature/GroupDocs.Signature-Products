...
############################# Head ############################
head_title: "Provjera Digital potpisa za Zip datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Zip dokumenata i njihovih Digital potpisa."

############################# Header ############################
title: "Provjera potpisa Digital za Zip datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Digital u dokumentima Zip. Provjera e-potpisa unutar vaših Zip dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Digital postavljenih na dokumente Zip. Iskoristite ovu priliku bez implementacije dodatnog koda.
