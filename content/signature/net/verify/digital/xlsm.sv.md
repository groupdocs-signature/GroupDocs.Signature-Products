...
description: "API för .NET ger möjlighet att verifiera Digital-signaturer i Xlsm-dokument. Verifiering av e-signaturer i dina {{Filformat}}-dokument kan utföras snabbt och enkelt."
