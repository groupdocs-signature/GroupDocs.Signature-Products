...
############################# Head ############################
head_title: "Staðfesting á Digital undirskriftum fyrir Tar skrár í gegnum C#"
head_description: "Notaðu aðeins nokkrar línur af .NET kóða til að staðfesta Tar skjöl og Digital undirskrift þeirra."

############################# Header ############################
title: "Digital staðfesting á undirskriftum fyrir Tar skrár"
description: "API fyrir .NET veitir tækifæri til að staðfesta Digital undirskriftir á Tar skjölum. Staðfesting á rafrænum undirskriftum inni í Tar skjölunum þínum gæti verið framkvæmd fljótt og auðveldlega."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inniheldur gagnlega eiginleika eins og staðfestingu á Digital undirskriftum sem settar eru á Tar skjöl. Notaðu þetta tækifæri án þess að innleiða aukakóða.
