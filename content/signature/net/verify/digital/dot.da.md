...
############################# Head ############################
head_title: "Bekræftelse af Digital signaturer for Dot filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Dot-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekræftelse for Dot filer"
description: "API for .NET giver mulighed for at bekræfte Digital-signaturer på Dot-dokumenter. Bekræftelse af e-signaturer i dine Dot-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Digital-signaturer i dit Dot-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Digital signaturer placeret på Dot dokumenter. Brug denne mulighed uden at implementere ekstra kode.
