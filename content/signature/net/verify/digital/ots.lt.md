...
############################# Head ############################
head_title: "Digital failų Ots parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Ots dokumentus ir jų Digital parašus."

############################# Header ############################
title: "Digital parašų patvirtinimas Ots failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Digital parašus Ots dokumentuose. El. parašų patvirtinimas jūsų Ots dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Digital parašų, pateiktų Ots dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
