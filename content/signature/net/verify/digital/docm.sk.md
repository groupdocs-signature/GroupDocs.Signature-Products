...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory Docm cez C#"
head_description: "Na overenie dokumentov Docm a ich podpisov Digital použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory Docm"
description: "API pre .NET poskytuje možnosť overiť podpisy Digital v dokumentoch Docm. Overenie elektronických podpisov vo vašich dokumentoch Docm môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch Docm. Využite túto príležitosť bez implementácie dodatočného kódu.
