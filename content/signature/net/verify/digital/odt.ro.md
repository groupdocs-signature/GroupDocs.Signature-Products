...
############################# Head ############################
head_title: "Verificarea semnăturilor Digital pentru fișierele Odt prin C#"
head_description: "Utilizați doar câteva rânduri de cod .NET pentru a verifica documentele Odt și semnăturile acestora Digital."

############################# Header ############################
title: "Digital verificarea semnăturilor pentru fișiere Odt"
description: "API-ul pentru .NET oferă posibilitatea de a verifica semnăturile Digital în documentele Odt. Verificarea semnăturilor electronice din documentele dvs. Odt poate fi efectuată rapid și ușor."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) include funcții utile, cum ar fi verificarea semnăturilor Digital plasate în documentele Odt. Folosiți această oportunitate fără a implementa cod suplimentar.
