...
############################# Head ############################
head_title: "Ověření podpisů Digital pro soubory Docm prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Docm a jejich podpisů Digital."

############################# Header ############################
title: "Ověření podpisů Digital pro soubory Docm"
description: "API pro .NET poskytuje příležitost ověřit podpisy Digital v dokumentech Docm. Ověření elektronických podpisů ve vašich dokumentech Docm může být provedeno rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Digital umístěných v dokumentech Docm. Využijte tuto příležitost bez implementace dalšího kódu.
