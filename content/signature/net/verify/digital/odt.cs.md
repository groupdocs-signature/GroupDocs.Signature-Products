...
############################# Head ############################
head_title: "Ověření podpisů Digital pro soubory Odt prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Odt a jejich podpisů Digital."

############################# Header ############################
title: "Ověření podpisů Digital pro soubory Odt"
description: "API pro .NET poskytuje příležitost ověřit podpisy Digital v dokumentech Odt. Ověření elektronických podpisů ve vašich dokumentech Odt může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Digital ve vašem dokumentu Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Digital umístěných v dokumentech Odt. Využijte tuto příležitost bez implementace dalšího kódu.
