...
############################# Head ############################
head_title: "Dot dosyaları için Digital imzalarının C# aracılığıyla doğrulanması"
head_description: "Dot belgelerini ve bunların Digital imzalarını doğrulamak için yalnızca birkaç satır .NET kodu kullanın."

############################# Header ############################
title: "Dot dosyaları için Digital imza doğrulaması"
description: ".NET için API, Dot belgelerinde Digital imzalarını doğrulama fırsatı sunar. Dot belgelerinizdeki e-imzaların doğrulanması hızlı ve kolay bir şekilde gerçekleştirilebilir."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Dot belgelerine yerleştirilen Digital imzalarının doğrulanması gibi faydalı özellikler içerir. Ekstra kod uygulamadan bu fırsatı kullanın.
