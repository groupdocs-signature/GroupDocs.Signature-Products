...
############################# Head ############################
head_title: "Verification of Digital signatures for Ots files in C#"
head_description: "Use only a few lines of .NET code to verify Ots documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Ots files"
description: "API for .NET provides opportunity to verify Digital signatures at Ots documents. Verification of e-signatures inside your Ots documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Digital signatures placed at Ots documents. Use this opportunity without implementing extra code.
