...
############################# Head ############################
head_title: "Verifiering av Digital-signaturer för Tar-filer via C#"
head_description: "Använd bara några rader med .NET-kod för att verifiera Tar-dokument och deras Digital-signaturer."

############################# Header ############################
title: "Digital signaturverifiering för Tar-filer"
description: "API för .NET ger möjlighet att verifiera Digital-signaturer i Tar-dokument. Verifiering av e-signaturer i dina Tar-dokument kan utföras snabbt och enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Digital-signaturer placerade i Tar-dokument. Använd denna möjlighet utan att implementera extra kod.
