...
############################# Head ############################
head_title: "Verificació de signatures de Digital per a fitxers Pdf mitjançant C#"
head_description: "Utilitzeu només unes poques línies de codi .NET per verificar els documents Pdf i les seves signatures Digital."

############################# Header ############################
title: "Digital verificació de signatures per a fitxers Pdf"
description: "L'API per a .NET ofereix l'oportunitat de verificar les signatures de Digital als documents Pdf. La verificació de les signatures electròniques dins dels vostres documents Pdf es pot fer de manera ràpida i senzilla."
...
steps:
    enable: true
    title_left: "Com validar les signatures de Digital al vostre document Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclou funcions útils com la verificació de les signatures de Digital col·locades als documents de Pdf. Aprofiteu aquesta oportunitat sense implementar codi addicional.
...
demos:
    ...
    content: |
       Afegiu diverses signatures electròniques al fitxer Pdf ara mateix visitant el lloc web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
