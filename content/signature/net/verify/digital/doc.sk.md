...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory Doc cez C#"
head_description: "Na overenie dokumentov Doc a ich podpisov Digital použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory Doc"
description: "API pre .NET poskytuje možnosť overiť podpisy Digital v dokumentoch Doc. Overenie elektronických podpisov vo vašich dokumentoch Doc môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Digital vo vašom dokumente Doc"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch Doc. Využite túto príležitosť bez implementácie dodatočného kódu.
