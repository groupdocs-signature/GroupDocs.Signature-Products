...
############################# Head ############################
head_title: "Ověření podpisů Digital pro soubory Xls prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Xls a jejich podpisů Digital."

############################# Header ############################
title: "Ověření podpisů Digital pro soubory Xls"
description: "API pro .NET poskytuje příležitost ověřit podpisy Digital v dokumentech Xls. Ověření elektronických podpisů ve vašich dokumentech Xls může být provedeno rychle a snadno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Digital umístěných v dokumentech Xls. Využijte tuto příležitost bez implementace dalšího kódu.
