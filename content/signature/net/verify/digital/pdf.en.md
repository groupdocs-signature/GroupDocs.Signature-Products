...
############################# Head ############################
head_title: "Verification of Digital signatures for Pdf files in C#"
head_description: "Use only a few lines of .NET code to verify Pdf documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Pdf files"
description: "API for .NET provides opportunity to verify Digital signatures at Pdf documents. Verification of e-signatures inside your Pdf documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Digital signatures placed at Pdf documents. Use this opportunity without implementing extra code.
