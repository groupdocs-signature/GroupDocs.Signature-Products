...
############################# Head ############################
head_title: "Bekræftelse af Digital signaturer for Doc filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Doc-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekræftelse for Doc filer"
description: "API for .NET giver mulighed for at bekræfte Digital-signaturer på Doc-dokumenter. Bekræftelse af e-signaturer i dine Doc-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Digital signaturer placeret på Doc dokumenter. Brug denne mulighed uden at implementere ekstra kode.
