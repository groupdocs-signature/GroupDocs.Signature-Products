...
############################# Head ############################
head_title: "Bekreftelse av Digital signaturer for Doc filer via C#"
head_description: "Bruk bare noen få linjer med .NET-kode for å bekrefte Doc-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekreftelse for {{Filformat}}-filer"
description: "API for .NET gir mulighet til å bekrefte Digital-signaturer i Doc-dokumenter. Verifisering av e-signaturer i Doc-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funksjoner som bekreftelse av Digital-signaturer plassert på Doc-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
...
demos:
    ...
    content: |
       Legg til ulike elektroniske signaturer i Doc-filen akkurat nå ved å gå til nettstedet [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
