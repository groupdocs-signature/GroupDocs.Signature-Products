...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory Pptm cez C#"
head_description: "Na overenie dokumentov Pptm a ich podpisov Digital použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory Pptm"
description: "API pre .NET poskytuje možnosť overiť podpisy Digital v dokumentoch Pptm. Overenie elektronických podpisov vo vašich dokumentoch Pptm môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch Pptm. Využite túto príležitosť bez implementácie dodatočného kódu.
