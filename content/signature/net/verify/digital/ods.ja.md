...
############################# Head ############################
head_title: "C# による Ods ファイルの Digital 署名の検証"
head_description: "数行の .NET コードを使用して、Ods ドキュメントとその Digital 署名を検証します。"

############################# Header ############################
title: "Ods ファイルの Digital 署名検証"
description: ".NET の API は、Ods ドキュメントで Digital 署名を検証する機会を提供します。 Ods ドキュメント内の電子署名の検証は、迅速かつ簡単に実行できます。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) には、Ods ドキュメントに配置された Digital 署名の検証などの便利な機能が含まれています。余分なコードを実装せずに、この機会を利用してください。
