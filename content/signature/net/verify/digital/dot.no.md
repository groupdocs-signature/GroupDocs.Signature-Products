...
############################# Head ############################
head_title: "Bekreftelse av Digital signaturer for Dot filer via C#"
head_description: "Bruk bare noen få linjer med .NET-kode for å bekrefte Dot-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekreftelse for {{Filformat}}-filer"
description: "API for .NET gir mulighet til å bekrefte Digital-signaturer i Dot-dokumenter. Verifisering av e-signaturer i Dot-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funksjoner som bekreftelse av Digital-signaturer plassert på Dot-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
