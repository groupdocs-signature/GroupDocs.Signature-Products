...
############################# Head ############################
head_title: "Verificação de assinaturas Digital para arquivos Xlsx via C#"
head_description: "Use apenas algumas linhas de código .NET para verificar documentos Xlsx e suas assinaturas Digital."

############################# Header ############################
title: "Digital verificação de assinaturas para Xlsx arquivos"
description: "A API para .NET oferece a oportunidade de verificar assinaturas Digital em documentos Xlsx. A verificação de assinaturas eletrônicas dentro de seus documentos Xlsx pode ser realizada de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis, como verificação de Digital assinaturas colocadas em documentos Xlsx. Use esta oportunidade sem implementar código extra.
