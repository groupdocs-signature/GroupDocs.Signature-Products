...
############################# Head ############################
head_title: "Verification of Digital signatures for Doc files in C#"
head_description: "Use only a few lines of .NET code to verify Doc documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Doc files"
description: "API for .NET provides opportunity to verify Digital signatures at Doc documents. Verification of e-signatures inside your Doc documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Digital signatures in your Doc document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Digital signatures placed at Doc documents. Use this opportunity without implementing extra code.
