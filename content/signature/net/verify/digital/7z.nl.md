...
############################# Head ############################
head_title: "Verificatie van Digital handtekeningen voor 7z bestanden via C#"
head_description: "Gebruik slechts een paar regels .NET-code om 7z-documenten en hun Digital-handtekeningen te verifiëren."

############################# Header ############################
title: "Digital handtekeningverificatie voor 7z bestanden"
description: "API voor .NET biedt de mogelijkheid om Digital handtekeningen te verifiëren bij 7z documenten. Verificatie van elektronische handtekeningen in uw 7z documenten kan snel en gemakkelijk worden uitgevoerd."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bevat handige functies zoals verificatie van Digital handtekeningen die bij 7z documenten zijn geplaatst. Gebruik deze mogelijkheid zonder extra code te implementeren.
