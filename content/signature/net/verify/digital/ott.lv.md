...
############################# Head ############################
head_title: "Digital parakstu pārbaude failiem Ott, izmantojot C#"
head_description: "Izmantojiet tikai dažas .NET koda rindiņas, lai pārbaudītu Ott dokumentus un to Digital parakstus."

############################# Header ############################
title: "Digital parakstu pārbaude failiem Ott"
description: ".NET API nodrošina iespēju pārbaudīt Digital parakstus Ott dokumentos. E-parakstu pārbaude jūsu Ott dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ietver tādas noderīgas funkcijas kā Digital parakstu pārbaude, kas ievietoti Ott dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
