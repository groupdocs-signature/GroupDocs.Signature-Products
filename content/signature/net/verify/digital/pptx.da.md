...
############################# Head ############################
head_title: "Bekræftelse af Digital signaturer for Pptx filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Pptx-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekræftelse for Pptx filer"
description: "API for .NET giver mulighed for at bekræfte Digital-signaturer på Pptx-dokumenter. Bekræftelse af e-signaturer i dine Pptx-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Digital-signaturer i dit Pptx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Digital signaturer placeret på Pptx dokumenter. Brug denne mulighed uden at implementere ekstra kode.
