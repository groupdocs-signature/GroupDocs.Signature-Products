...
############################# Head ############################
head_title: "Verifiering av Digital-signaturer för Pptx-filer via C#"
...
steps:
    enable: true
    title_left: "Så här validerar du Digital-signaturer i ditt Pptx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Digital-signaturer placerade i Pptx-dokument. Använd denna möjlighet utan att implementera extra kod.
