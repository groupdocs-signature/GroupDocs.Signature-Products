...
############################# Head ############################
head_title: "Verificación de Digital firmas para Pdf archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Pdf y sus firmas Digital."

############################# Header ############################
title: "Digital verificación de firmas para Pdf archivos"
description: "La API para .NET brinda la oportunidad de verificar Digital firmas en Pdf documentos. La verificación de las firmas electrónicas dentro de sus documentos Pdf se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Digital firmas colocadas en Pdf documentos. Aproveche esta oportunidad sin implementar código adicional.
