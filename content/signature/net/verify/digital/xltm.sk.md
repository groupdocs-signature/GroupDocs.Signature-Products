...
############################# Head ############################
head_title: "Overenie Digital podpisov pre súbory Xltm cez C#"
head_description: "Na overenie dokumentov Xltm a ich podpisov Digital použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Digital pre súbory Xltm"
description: "API pre .NET poskytuje možnosť overiť podpisy Digital v dokumentoch Xltm. Overenie elektronických podpisov vo vašich dokumentoch Xltm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Digital vo vašom dokumente Xltm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Digital umiestnených v dokumentoch Xltm. Využite túto príležitosť bez implementácie dodatočného kódu.
