...
############################# Head ############################
head_title: "Verification of Digital signatures for Xltm files in C#"
head_description: "Use only a few lines of .NET code to verify Xltm documents and their Digital signatures."

############################# Header ############################
title: "Digital signatures verification for Xltm files"
description: "API for .NET provides opportunity to verify Digital signatures at Xltm documents. Verification of e-signatures inside your Xltm documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Digital signatures in your Xltm document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Digital signatures placed at Xltm documents. Use this opportunity without implementing extra code.
