...
############################# Head ############################
head_title: "Digital parakstu pārbaude failiem Docm, izmantojot C#"
head_description: "Izmantojiet tikai dažas .NET koda rindiņas, lai pārbaudītu Docm dokumentus un to Digital parakstus."

############################# Header ############################
title: "Digital parakstu pārbaude failiem Docm"
description: ".NET API nodrošina iespēju pārbaudīt Digital parakstus Docm dokumentos. E-parakstu pārbaude jūsu Docm dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ietver tādas noderīgas funkcijas kā Digital parakstu pārbaude, kas ievietoti Docm dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
