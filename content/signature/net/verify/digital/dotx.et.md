...
############################# Head ############################
head_title: "Digital allkirjade kontrollimine failide Dotx jaoks läbi C#"
head_description: "Kasutage Dotx dokumentide ja nende allkirjade Digital kontrollimiseks ainult mõnda rida .NET koodi."

############################# Header ############################
title: "Digital allkirjade kontrollimine faili Dotx jaoks"
description: "API for .NET annab võimaluse kontrollida Digital allkirju Dotx dokumentides. Teie Dotx dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sisaldab kasulikke funktsioone, nagu Digital allkirjade kontrollimine, mis on pandud dokumentidele Dotx. Kasutage seda võimalust lisakoodi rakendamata.
