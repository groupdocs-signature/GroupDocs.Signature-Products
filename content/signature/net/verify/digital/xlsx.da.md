...
############################# Head ############################
head_title: "Bekræftelse af Digital signaturer for Xlsx filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Xlsx-dokumenter og deres Digital-signaturer."

############################# Header ############################
title: "Digital signaturbekræftelse for Xlsx filer"
description: "API for .NET giver mulighed for at bekræfte Digital-signaturer på Xlsx-dokumenter. Bekræftelse af e-signaturer i dine Xlsx-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Digital signaturer placeret på Xlsx dokumenter. Brug denne mulighed uden at implementere ekstra kode.
