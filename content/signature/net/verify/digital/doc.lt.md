...
############################# Head ############################
head_title: "Digital failų Doc parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Doc dokumentus ir jų Digital parašus."

############################# Header ############################
title: "Digital parašų patvirtinimas Doc failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Digital parašus Doc dokumentuose. El. parašų patvirtinimas jūsų Doc dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Digital parašų, pateiktų Doc dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
