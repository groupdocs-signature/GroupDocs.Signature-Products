...
############################# Head ############################
head_title: "Verificación de Qrcode firmas para Jpg archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Jpg y sus firmas Qrcode."

############################# Header ############################
title: "Qrcode verificación de firmas para Jpg archivos"
description: "La API para .NET brinda la oportunidad de verificar Qrcode firmas en Jpg documentos. La verificación de las firmas electrónicas dentro de sus documentos Jpg se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Qrcode firmas en su documento Jpg"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Qrcode firmas colocadas en Jpg documentos. Aproveche esta oportunidad sin implementar código adicional.
