...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Jpg datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Jpg dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Jpg datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Jpg. Provjera e-potpisa unutar vaših Jpg dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Jpg. Iskoristite ovu priliku bez implementacije dodatnog koda.
