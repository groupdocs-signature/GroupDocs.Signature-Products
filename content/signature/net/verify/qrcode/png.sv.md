...
############################# Head ############################
head_title: "Verifiering av Qrcode-signaturer för Png-filer via C#"
head_description: "Använd bara några rader med .NET-kod för att verifiera Png-dokument och deras Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturverifiering för Png-filer"
description: "API för .NET ger möjlighet att verifiera Qrcode-signaturer i Png-dokument. Verifiering av e-signaturer i dina Png-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Qrcode-signaturer i ditt Png-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Qrcode-signaturer placerade i Png-dokument. Använd denna möjlighet utan att implementera extra kod.
