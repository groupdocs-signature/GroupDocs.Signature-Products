...
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Odt-dokumenter. Bekræftelse af e-signaturer i dine {{Filformat}}-dokumenter kan udføres hurtigt og nemt."
