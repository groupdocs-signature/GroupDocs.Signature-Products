...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke Ots prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Ots in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke Ots"
description: "API za .NET ponuja možnost preverjanja podpisov Qrcode v dokumentih Ots. Preverjanje e-podpisov v vaših Ots dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Qrcode v dokumentu Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih Ots. Izkoristite to priložnost brez implementacije dodatne kode.
