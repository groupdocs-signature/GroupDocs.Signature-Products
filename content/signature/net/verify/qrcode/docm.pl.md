...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Docm przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Docm i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Docm"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Qrcode w dokumentach Docm. Weryfikacja podpisów elektronicznych w dokumentach Docm może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Docm. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
