...
############################# Head ############################
head_title: "Qrcode parakstu pārbaude failiem Tiff, izmantojot C#"
head_description: "Izmantojiet tikai dažas .NET koda rindiņas, lai pārbaudītu Tiff dokumentus un to Qrcode parakstus."

############################# Header ############################
title: "Qrcode parakstu pārbaude failiem Tiff"
description: ".NET API nodrošina iespēju pārbaudīt Qrcode parakstus Tiff dokumentos. E-parakstu pārbaude jūsu Tiff dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ietver tādas noderīgas funkcijas kā Qrcode parakstu pārbaude, kas ievietoti Tiff dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
