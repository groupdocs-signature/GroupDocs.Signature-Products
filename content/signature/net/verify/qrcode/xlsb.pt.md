...
############################# Head ############################
head_title: "Verificação de assinaturas Qrcode para arquivos Xlsb via C#"
head_description: "Use apenas algumas linhas de código .NET para verificar documentos Xlsb e suas assinaturas Qrcode."

############################# Header ############################
title: "Qrcode verificação de assinaturas para Xlsb arquivos"
description: "A API para .NET oferece a oportunidade de verificar assinaturas Qrcode em documentos Xlsb. A verificação de assinaturas eletrônicas dentro de seus documentos Xlsb pode ser realizada de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como validar assinaturas Qrcode em seu documento Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis, como verificação de Qrcode assinaturas colocadas em documentos Xlsb. Use esta oportunidade sem implementar código extra.
