...
############################# Head ############################
head_title: "Verificação de assinaturas Qrcode para arquivos Dotm via C#"
head_description: "Use apenas algumas linhas de código .NET para verificar documentos Dotm e suas assinaturas Qrcode."

############################# Header ############################
title: "Qrcode verificação de assinaturas para Dotm arquivos"
description: "A API para .NET oferece a oportunidade de verificar assinaturas Qrcode em documentos Dotm. A verificação de assinaturas eletrônicas dentro de seus documentos Dotm pode ser realizada de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como validar assinaturas Qrcode em seu documento Dotm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis, como verificação de Qrcode assinaturas colocadas em documentos Dotm. Use esta oportunidade sem implementar código extra.
