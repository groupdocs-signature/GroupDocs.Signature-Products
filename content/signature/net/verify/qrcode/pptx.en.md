...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Pptx files in C#"
head_description: "Use only a few lines of .NET code to verify Pptx documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Pptx files"
description: "API for .NET provides opportunity to verify Qrcode signatures at Pptx documents. Verification of e-signatures inside your Pptx documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Qrcode signatures placed at Pptx documents. Use this opportunity without implementing extra code.
