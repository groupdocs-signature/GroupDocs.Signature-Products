...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Gif cez C#"
head_description: "Na overenie dokumentov Gif a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Gif"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Gif. Overenie elektronických podpisov vo vašich dokumentoch Gif môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Gif. Využite túto príležitosť bez implementácie dodatočného kódu.
