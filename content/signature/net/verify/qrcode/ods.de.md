...
############################# Head ############################
head_title: "Überprüfung von Qrcode-Signaturen für Ods-Dateien über C#"
head_description: "Verwenden Sie nur wenige Zeilen .NET-Code, um Ods-Dokumente und ihre Qrcode-Signaturen zu überprüfen."

############################# Header ############################
title: "Qrcode-Signaturüberprüfung für Ods-Dateien"
description: "Die API für .NET bietet die Möglichkeit, Qrcode-Signaturen bei Ods-Dokumenten zu überprüfen. Die Überprüfung elektronischer Signaturen in Ihren Ods-Dokumenten kann schnell und einfach durchgeführt werden."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) enthält nützliche Funktionen wie die Überprüfung von Qrcode-Signaturen, die in Ods-Dokumenten platziert wurden. Nutzen Sie diese Gelegenheit, ohne zusätzlichen Code zu implementieren.
