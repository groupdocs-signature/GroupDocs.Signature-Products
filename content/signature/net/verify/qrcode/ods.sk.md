...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Ods cez C#"
head_description: "Na overenie dokumentov Ods a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Ods"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Ods. Overenie elektronických podpisov vo vašich dokumentoch Ods môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Ods. Využite túto príležitosť bez implementácie dodatočného kódu.
