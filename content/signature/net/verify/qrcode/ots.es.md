...
############################# Head ############################
head_title: "Verificación de Qrcode firmas para Ots archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Ots y sus firmas Qrcode."

############################# Header ############################
title: "Qrcode verificación de firmas para Ots archivos"
description: "La API para .NET brinda la oportunidad de verificar Qrcode firmas en Ots documentos. La verificación de las firmas electrónicas dentro de sus documentos Ots se puede realizar rápida y fácilmente."
...
steps:
    enable: true
    title_left: "Cómo validar Qrcode firmas en su documento Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Qrcode firmas colocadas en Ots documentos. Aproveche esta oportunidad sin implementar código adicional.
