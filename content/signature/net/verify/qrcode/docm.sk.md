...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Docm cez C#"
head_description: "Na overenie dokumentov Docm a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Docm"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Docm. Overenie elektronických podpisov vo vašich dokumentoch Docm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Docm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Docm. Využite túto príležitosť bez implementácie dodatočného kódu.
