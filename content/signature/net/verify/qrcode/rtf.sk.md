...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Rtf cez C#"
head_description: "Na overenie dokumentov Rtf a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Rtf"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Rtf. Overenie elektronických podpisov vo vašich dokumentoch Rtf môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Rtf. Využite túto príležitosť bez implementácie dodatočného kódu.
