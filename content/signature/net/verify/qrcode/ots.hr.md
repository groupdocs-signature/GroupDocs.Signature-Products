...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Ots datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Ots dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Ots datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Ots. Provjera e-potpisa unutar vaših Ots dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Ots. Iskoristite ovu priliku bez implementacije dodatnog koda.
