...
############################# Head ############################
head_title: "Überprüfung von Qrcode-Signaturen für Docx-Dateien über C#"
head_description: "Verwenden Sie nur wenige Zeilen .NET-Code, um Docx-Dokumente und ihre Qrcode-Signaturen zu überprüfen."

############################# Header ############################
title: "Qrcode-Signaturüberprüfung für Docx-Dateien"
description: "Die API für .NET bietet die Möglichkeit, Qrcode-Signaturen bei Docx-Dokumenten zu überprüfen. Die Überprüfung elektronischer Signaturen in Ihren Docx-Dokumenten kann schnell und einfach durchgeführt werden."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) enthält nützliche Funktionen wie die Überprüfung von Qrcode-Signaturen, die in Docx-Dokumenten platziert wurden. Nutzen Sie diese Gelegenheit, ohne zusätzlichen Code zu implementieren.
