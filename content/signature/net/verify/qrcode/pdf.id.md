...
############################# Head ############################
head_title: "Verifikasi tanda tangan Qrcode untuk file Pdf melalui C#"
head_description: "Gunakan hanya beberapa baris kode .NET untuk memverifikasi dokumen Pdf dan tanda tangan Qrcode mereka."

############################# Header ############################
title: "Qrcode verifikasi tanda tangan untuk file Pdf"
description: "API untuk .NET memberikan kesempatan untuk memverifikasi tanda tangan Qrcode pada dokumen Pdf. Verifikasi tanda tangan elektronik di dalam dokumen Pdf Anda dapat dilakukan dengan cepat dan mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyertakan fitur berguna seperti verifikasi tanda tangan Qrcode yang ditempatkan di dokumen Pdf. Gunakan kesempatan ini tanpa menerapkan kode tambahan.
