...
############################# Head ############################
head_title: "Qrcode failų 7z parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte 7z dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas 7z failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Qrcode parašus 7z dokumentuose. El. parašų patvirtinimas jūsų 7z dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų 7z dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
