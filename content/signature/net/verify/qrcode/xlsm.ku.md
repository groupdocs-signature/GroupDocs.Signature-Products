...
############################# Head ############################
head_title: "Verastkirina îmzeyên Qrcode ji bo pelên Xlsm bi rêya C#"
head_description: "Tenê çend rêzên koda .NET bikar bînin da ku belgeyên Xlsm û îmzeyên wan ên Qrcode rast bikin."

############################# Header ############################
title: "Verastkirina îmzeyan ji bo pelên Qrcode"
description: "API ji bo .NET firsendê dide ku hûn îmzeyên Qrcode li ser belgeyên Xlsm verast bikin. Verastkirina e-îmzeyan di hundirê belgeyên we yên {{Pelformat}} de dibe ku zû û bi hêsanî were kirin."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzeyên Qrcode di belgeya xweya Xlsm de rast bike"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) taybetmendîyên bikêrhatî yên wekî verastkirina îmzayên Qrcode yên ku li belgeyên Xlsm hatine danîn dihewîne. Vê derfetê bêyî pêkanîna kodek zêde bikar bînin.
