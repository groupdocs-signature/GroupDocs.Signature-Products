...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke Rtf prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Rtf in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke Rtf"
description: "API za .NET ponuja možnost preverjanja podpisov Qrcode v dokumentih Rtf. Preverjanje e-podpisov v vaših Rtf dokumentih lahko izvedete hitro in enostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih Rtf. Izkoristite to priložnost brez implementacije dodatne kode.
