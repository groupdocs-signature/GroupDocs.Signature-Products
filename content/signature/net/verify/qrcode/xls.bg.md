...
############################# Head ############################
head_title: "Проверка на Qrcode подписи за Xls файлове чрез C#"
head_description: "Използвайте само няколко реда от кода на .NET, за да проверите документите Xls и техните подписи Qrcode."

############################# Header ############################
title: "Qrcode проверка на подписи за Xls файлове"
description: "API за .NET предоставя възможност за проверка на Qrcode подписи в Xls документи. Проверката на електронните подписи във вашите Xls документи може да се извърши бързо и лесно."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) включва полезни функции като проверка на подписи Qrcode, поставени в Xls документи. Използвайте тази възможност без внедряване на допълнителен код.
