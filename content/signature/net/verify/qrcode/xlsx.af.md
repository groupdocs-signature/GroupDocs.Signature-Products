...
############################# Head ############################
head_title: "Verifikasie van Qrcode handtekeninge vir Xlsx lêers via C#"
head_description: "Gebruik slegs 'n paar reëls van .NET-kode om Xlsx-dokumente en hul Qrcode-handtekeninge te verifieer."

############################# Header ############################
title: "Qrcode handtekeningverifikasie vir Xlsx lêers"
description: "API vir .NET bied geleentheid om Qrcode handtekeninge by Xlsx dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Xlsx dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos verifikasie van Qrcode-handtekeninge wat by Xlsx-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
