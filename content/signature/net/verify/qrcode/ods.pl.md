...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Ods przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Ods i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Ods"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Qrcode w dokumentach Ods. Weryfikacja podpisów elektronicznych w dokumentach Ods może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Ods. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
