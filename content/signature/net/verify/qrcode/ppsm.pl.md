...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Ppsm przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Ppsm i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Ppsm"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Qrcode w dokumentach Ppsm. Weryfikacja podpisów elektronicznych w dokumentach Ppsm może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Ppsm. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
