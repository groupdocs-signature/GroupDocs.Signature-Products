...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Potx cez C#"
head_description: "Na overenie dokumentov Potx a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Potx"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Potx. Overenie elektronických podpisov vo vašich dokumentoch Potx môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Potx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Potx. Využite túto príležitosť bez implementácie dodatočného kódu.
...
demos:
    ...
    content: |
       Pridajte rôzne elektronické podpisy do súboru Potx hneď teraz na webovej lokalite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
