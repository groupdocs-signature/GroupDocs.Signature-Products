...
############################# Head ############################
head_title: "Verificación de Qrcode firmas para Pptm archivos a través de C#"
head_description: "Use solo unas pocas líneas de código .NET para verificar los documentos Pptm y sus firmas Qrcode."

############################# Header ############################
title: "Qrcode verificación de firmas para Pptm archivos"
description: "La API para .NET brinda la oportunidad de verificar Qrcode firmas en Pptm documentos. La verificación de las firmas electrónicas dentro de sus documentos Pptm se puede realizar rápida y fácilmente."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) incluye funciones útiles como la verificación de Qrcode firmas colocadas en Pptm documentos. Aproveche esta oportunidad sin implementar código adicional.
