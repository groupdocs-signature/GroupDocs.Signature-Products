...
############################# Head ############################
head_title: "Bekreftelse av Qrcode signaturer for Tar filer via C#"
head_description: "Bruk bare noen få linjer med .NET-kode for å bekrefte Tar-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekreftelse for Tar-filer"
description: "API for .NET gir mulighet til å bekrefte Qrcode-signaturer i Tar-dokumenter. Verifisering av e-signaturer i Tar-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funksjoner som bekreftelse av Qrcode-signaturer plassert på Tar-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
