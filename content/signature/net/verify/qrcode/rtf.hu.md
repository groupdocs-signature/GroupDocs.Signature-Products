...
############################# Head ############################
head_title: "A Qrcode aláírások ellenőrzése a Rtf fájlokhoz a C# segítségével"
head_description: "Csak néhány sornyi .NET kódot használjon a Rtf dokumentumok és a hozzájuk tartozó Qrcode aláírások ellenőrzéséhez."

############################# Header ############################
title: "Qrcode aláírás ellenőrzése a Rtf fájlokhoz"
description: "A(z) .NET API lehetőséget biztosít a(z) Qrcode aláírások ellenőrzésére a(z) Rtf dokumentumoknál. A Rtf dokumentumaiban lévő e-aláírások ellenőrzése gyorsan és egyszerűen elvégezhető."
...
steps:
    enable: true
    title_left: "A Qrcode aláírások érvényesítése a Rtf dokumentumban"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) olyan hasznos funkciókat tartalmaz, mint a Qrcode aláírások ellenőrzése a Rtf dokumentumokban. Használja ki ezt a lehetőséget extra kód alkalmazása nélkül.
