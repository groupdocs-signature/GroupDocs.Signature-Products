...
############################# Head ############################
head_title: "Verificació de signatures de Qrcode per a fitxers Bmp mitjançant C#"
head_description: "Utilitzeu només unes poques línies de codi .NET per verificar els documents Bmp i les seves signatures Qrcode."

############################# Header ############################
title: "Qrcode verificació de signatures per a fitxers Bmp"
description: "L'API per a .NET ofereix l'oportunitat de verificar les signatures de Qrcode als documents Bmp. La verificació de les signatures electròniques dins dels vostres documents Bmp es pot fer de manera ràpida i senzilla."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclou funcions útils com la verificació de les signatures de Qrcode col·locades als documents de Bmp. Aprofiteu aquesta oportunitat sense implementar codi addicional.
