...
############################# Head ############################
head_title: "C#을 통해 Ods 파일에 대한 Qrcode 서명 확인"
head_description: "몇 줄의 .NET 코드만 사용하여 Ods 문서와 Qrcode 서명을 확인하십시오."

############################# Header ############################
title: "Ods 파일에 대한 Qrcode 서명 확인"
description: ".NET용 API는 Ods 문서에서 Qrcode 서명을 확인할 수 있는 기회를 제공합니다. Ods 문서 내의 전자 서명 확인은 빠르고 쉽게 수행될 수 있습니다."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/)에는 Ods 문서에 있는 Qrcode 서명 확인과 같은 유용한 기능이 포함되어 있습니다. 추가 코드를 구현하지 않고 이 기회를 사용하십시오.
