...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Pdf cez C#"
head_description: "Na overenie dokumentov Pdf a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Pdf"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Pdf. Overenie elektronických podpisov vo vašich dokumentoch Pdf môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Pdf. Využite túto príležitosť bez implementácie dodatočného kódu.
