...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Xls filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Xls-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Xls filer"
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Xls-dokumenter. Bekræftelse af e-signaturer i dine Xls-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Qrcode-signaturer i dit Xls-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Xls dokumenter. Brug denne mulighed uden at implementere ekstra kode.
