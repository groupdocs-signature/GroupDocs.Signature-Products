...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Odp przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Odp i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Odp"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Qrcode w dokumentach Odp. Weryfikacja podpisów elektronicznych w dokumentach Odp może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Odp. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
