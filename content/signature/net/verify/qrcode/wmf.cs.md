...
############################# Head ############################
head_title: "Ověření podpisů Qrcode pro soubory Wmf prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Wmf a jejich podpisů Qrcode."

############################# Header ############################
title: "Ověření podpisů Qrcode pro soubory Wmf"
description: "API pro .NET poskytuje příležitost ověřit podpisy Qrcode v dokumentech Wmf. Ověření elektronických podpisů ve vašich dokumentech Wmf může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Qrcode ve vašem dokumentu Wmf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Qrcode umístěných v dokumentech Wmf. Využijte tuto příležitost bez implementace dalšího kódu.
