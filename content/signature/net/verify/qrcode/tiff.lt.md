...
############################# Head ############################
head_title: "Qrcode failų Tiff parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Tiff dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas Tiff failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Qrcode parašus Tiff dokumentuose. El. parašų patvirtinimas jūsų Tiff dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų Tiff dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
