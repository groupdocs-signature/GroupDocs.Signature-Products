...
############################# Head ############################
head_title: "Qrcode failų Wmf parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Wmf dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas Wmf failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Qrcode parašus Wmf dokumentuose. El. parašų patvirtinimas jūsų Wmf dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų Wmf dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
