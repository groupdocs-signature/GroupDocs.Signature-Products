...
############################# Head ############################
head_title: "Fíorú Qrcode sínithe do chomhaid Bmp trí C#"
head_description: "Ná húsáid ach cúpla líne de chód .NET chun doiciméid Bmp agus a gcuid sínithe Qrcode a fhíorú."

############################# Header ############################
title: "Qrcode fíorú sínithe le haghaidh comhad Bmp"
description: "Soláthraíonn API do .NET deis chun Qrcode sínithe ag Bmp doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Bmp a fhíorú go tapa agus go héasca."
...
steps:
    ...
    content_left: |
        Áiríonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail fíorú Qrcode sínithe atá curtha ag Bmp doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
