...
############################# Head ############################
head_title: "Bekreftelse av Qrcode signaturer for Jpg filer via C#"
head_description: "Bruk bare noen få linjer med .NET-kode for å bekrefte Jpg-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekreftelse for Jpg-filer"
description: "API for .NET gir mulighet til å bekrefte Qrcode-signaturer i Jpg-dokumenter. Verifisering av e-signaturer i Jpg-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funksjoner som bekreftelse av Qrcode-signaturer plassert på Jpg-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
