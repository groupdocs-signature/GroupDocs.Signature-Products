...
############################# Head ############################
head_title: "Qrcode failų Rtf parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Rtf dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas Rtf failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Qrcode parašus Rtf dokumentuose. El. parašų patvirtinimas jūsų Rtf dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų Rtf dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
