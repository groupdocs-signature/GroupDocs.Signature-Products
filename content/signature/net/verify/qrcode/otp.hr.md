...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Otp datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Otp dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Otp datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Otp. Provjera e-potpisa unutar vaših Otp dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Otp. Iskoristite ovu priliku bez implementacije dodatnog koda.
