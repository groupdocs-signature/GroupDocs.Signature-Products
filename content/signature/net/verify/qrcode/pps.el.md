...
description: "Το API για το .NET παρέχει την ευκαιρία να επαληθεύσετε τις υπογραφές Qrcode σε έγγραφα Pps. Η επαλήθευση των ηλεκτρονικών υπογραφών στα έγγραφά σας Pps μπορεί να πραγματοποιηθεί γρήγορα και εύκολα."
