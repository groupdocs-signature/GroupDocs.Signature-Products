...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Ppsm filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Ppsm-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for {{Filformat}} filer"
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Ppsm-dokumenter. Bekræftelse af e-signaturer i dine {{Filformat}}-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Ppsm dokumenter. Brug denne mulighed uden at implementere ekstra kode.
