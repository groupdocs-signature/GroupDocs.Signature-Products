...
############################# Head ############################
head_title: "Qrcode failų Webp parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Webp dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas Webp failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Qrcode parašus Webp dokumentuose. El. parašų patvirtinimas jūsų Webp dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų Webp dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
