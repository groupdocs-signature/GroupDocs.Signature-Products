...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Xltm datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Xltm dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Xltm datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Xltm. Provjera e-potpisa unutar vaših Xltm dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Xltm dokumentu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Xltm. Iskoristite ovu priliku bez implementacije dodatnog koda.
...
demos:
    ...
    content: |
       Odmah dodajte različite elektroničke potpise u datoteku Xltm tako da posjetite [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) web mjesto.          

############################# More Formats ############################
more_formats:
    enable: true
    title: "Provjerite druge Qrcode potpise koristeći C#"
    content: |
