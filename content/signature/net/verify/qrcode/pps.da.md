...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Pps filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Pps-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Pps filer"
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Pps-dokumenter. Bekræftelse af e-signaturer i dine Pps-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Qrcode-signaturer i dit Pps-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Pps dokumenter. Brug denne mulighed uden at implementere ekstra kode.
