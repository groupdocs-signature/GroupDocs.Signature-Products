...
############################# Head ############################
head_title: "Verificação de assinaturas Qrcode para arquivos Webp via C#"
head_description: "Use apenas algumas linhas de código .NET para verificar documentos Webp e suas assinaturas Qrcode."

############################# Header ############################
title: "Qrcode verificação de assinaturas para Webp arquivos"
description: "A API para .NET oferece a oportunidade de verificar assinaturas Qrcode em documentos Webp. A verificação de assinaturas eletrônicas dentro de seus documentos Webp pode ser realizada de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis, como verificação de Qrcode assinaturas colocadas em documentos Webp. Use esta oportunidade sem implementar código extra.
