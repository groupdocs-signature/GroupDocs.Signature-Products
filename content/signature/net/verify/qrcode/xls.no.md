...
############################# Head ############################
head_title: "Bekreftelse av Qrcode signaturer for Xls filer via C#"
head_description: "Bruk bare noen få linjer med .NET-kode for å bekrefte Xls-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekreftelse for Xls-filer"
description: "API for .NET gir mulighet til å bekrefte Qrcode-signaturer i Xls-dokumenter. Verifisering av e-signaturer i Xls-dokumentene dine kan utføres raskt og enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funksjoner som bekreftelse av Qrcode-signaturer plassert på Xls-dokumenter. Bruk denne muligheten uten å implementere ekstra kode.
