...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke Pptm prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Pptm in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke Pptm"
description: "API za .NET ponuja možnost preverjanja podpisov Qrcode v dokumentih Pptm. Preverjanje e-podpisov v vaših Pptm dokumentih lahko izvedete hitro in enostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih Pptm. Izkoristite to priložnost brez implementacije dodatne kode.
