...
############################# Head ############################
head_title: "Ověření podpisů Qrcode pro soubory Docx prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Docx a jejich podpisů Qrcode."

############################# Header ############################
title: "Ověření podpisů Qrcode pro soubory Docx"
description: "API pro .NET poskytuje příležitost ověřit podpisy Qrcode v dokumentech Docx. Ověření elektronických podpisů ve vašich dokumentech Docx může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Qrcode ve vašem dokumentu Docx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Qrcode umístěných v dokumentech Docx. Využijte tuto příležitost bez implementace dalšího kódu.
