...
############################# Head ############################
head_title: "Verificatie van Qrcode handtekeningen voor Ppsm bestanden via C#"
head_description: "Gebruik slechts een paar regels .NET-code om Ppsm-documenten en hun Qrcode-handtekeningen te verifiëren."

############################# Header ############################
title: "Qrcode handtekeningverificatie voor Ppsm bestanden"
description: "API voor .NET biedt de mogelijkheid om Qrcode handtekeningen te verifiëren bij Ppsm documenten. Verificatie van elektronische handtekeningen in uw Ppsm documenten kan snel en gemakkelijk worden uitgevoerd."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bevat handige functies zoals verificatie van Qrcode handtekeningen die bij Ppsm documenten zijn geplaatst. Gebruik deze mogelijkheid zonder extra code te implementeren.
