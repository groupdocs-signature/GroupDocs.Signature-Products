...
############################# Head ############################
head_title: "Ods dosyaları için Qrcode imzalarının C# aracılığıyla doğrulanması"
head_description: "Ods belgelerini ve bunların Qrcode imzalarını doğrulamak için yalnızca birkaç satır .NET kodu kullanın."

############################# Header ############################
title: "Ods dosyaları için Qrcode imza doğrulaması"
description: ".NET için API, Ods belgelerinde Qrcode imzalarını doğrulama fırsatı sunar. Ods belgelerinizdeki e-imzaların doğrulanması hızlı ve kolay bir şekilde gerçekleştirilebilir."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Ods belgelerine yerleştirilen Qrcode imzalarının doğrulanması gibi faydalı özellikler içerir. Ekstra kod uygulamadan bu fırsatı kullanın.
