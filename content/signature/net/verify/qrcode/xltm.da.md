...
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Xltm-dokumenter. Bekræftelse af e-signaturer i dine {{Filformat}}-dokumenter kan udføres hurtigt og nemt."
