...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Png filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Png-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Png filer"
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Png-dokumenter. Bekræftelse af e-signaturer i dine Png-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Qrcode-signaturer i dit Png-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Png dokumenter. Brug denne mulighed uden at implementere ekstra kode.
