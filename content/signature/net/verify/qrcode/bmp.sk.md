...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Bmp cez C#"
head_description: "Na overenie dokumentov Bmp a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Bmp"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Bmp. Overenie elektronických podpisov vo vašich dokumentoch Bmp môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Bmp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Bmp. Využite túto príležitosť bez implementácie dodatočného kódu.
