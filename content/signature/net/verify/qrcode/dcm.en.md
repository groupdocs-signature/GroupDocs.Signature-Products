...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Dcm files via C#"
head_description: "Use only a few lines of .NET code to verify Dcm documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Dcm files"
description: "API for .NET provides opportunity to verify Qrcode signatures at Dcm documents. Verification of e-signatures inside your Dcm documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Qrcode signatures in your Dcm document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like verification of Qrcode signatures placed at Dcm documents. Use this opportunity without implementing extra code.
...
demos:
    ...
    content: |
       Add various electronic signatures to Dcm file right now by visiting the [GroupDocs.Signature App](https://products.groupdocs.app/signature/family) website.          
