...
############################# Head ############################
head_title: "Pengesahan tandatangan Qrcode untuk fail Xltm melalui C#"
head_description: "Gunakan hanya beberapa baris kod .NET untuk mengesahkan dokumen Xltm dan tandatangan Qrcode mereka."

############################# Header ############################
title: "Qrcode pengesahan tandatangan untuk fail Xltm."
description: "API untuk .NET memberi peluang untuk mengesahkan tandatangan Qrcode pada dokumen Xltm. Pengesahan e-tandatangan di dalam dokumen Xltm anda mungkin dilakukan dengan cepat dan mudah."
...
steps:
    enable: true
    title_left: "Bagaimana untuk mengesahkan tandatangan Qrcode dalam dokumen Xltm anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) termasuk ciri berguna seperti pengesahan tandatangan Qrcode yang diletakkan pada dokumen Xltm. Gunakan peluang ini tanpa melaksanakan kod tambahan.
