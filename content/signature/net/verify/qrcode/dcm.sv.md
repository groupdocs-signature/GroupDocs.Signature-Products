...
############################# Head ############################
head_title: "Verifiering av Qrcode-signaturer för Dcm-filer via C#"
head_description: "Använd bara några rader med .NET-kod för att verifiera Dcm-dokument och deras Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturverifiering för Dcm-filer"
description: "API för .NET ger möjlighet att verifiera Qrcode-signaturer i Dcm-dokument. Verifiering av e-signaturer i dina Dcm-dokument kan utföras snabbt och enkelt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Qrcode-signaturer placerade i Dcm-dokument. Använd denna möjlighet utan att implementera extra kod.
