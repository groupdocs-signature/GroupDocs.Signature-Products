...
############################# Head ############################
head_title: "Проверка подписей Qrcode для файлов Xlsb с помощью C#"
head_description: "Используйте всего несколько строк кода .NET для проверки документов Xlsb и их подписей Qrcode."

############################# Header ############################
title: "Проверка подписей Qrcode для Xlsb файлов"
description: "API для .NET предоставляет возможность проверять подписи Qrcode в документах Xlsb. Проверка электронных подписей внутри ваших документов Xlsb может быть выполнена быстро и легко."
...
steps:
    enable: true
    title_left: "Как проверить подписи Qrcode в документе Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) содержит полезные функции, такие как проверка подписей Qrcode, размещенных в документах Xlsb. Используйте эту возможность, не внедряя дополнительный код.
