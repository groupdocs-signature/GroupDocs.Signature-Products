...
############################# Head ############################
head_title: "Qrcode parakstu pārbaude failiem Dotx, izmantojot C#"
head_description: "Izmantojiet tikai dažas .NET koda rindiņas, lai pārbaudītu Dotx dokumentus un to Qrcode parakstus."

############################# Header ############################
title: "Qrcode parakstu pārbaude failiem Dotx"
description: ".NET API nodrošina iespēju pārbaudīt Qrcode parakstus Dotx dokumentos. E-parakstu pārbaude jūsu Dotx dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ietver tādas noderīgas funkcijas kā Qrcode parakstu pārbaude, kas ievietoti Dotx dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
