...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Odt cez C#"
head_description: "Na overenie dokumentov Odt a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Odt"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Odt. Overenie elektronických podpisov vo vašich dokumentoch Odt môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Odt. Využite túto príležitosť bez implementácie dodatočného kódu.
