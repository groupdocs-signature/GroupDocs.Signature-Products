...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Xlsm files in C#"
head_description: "Use only a few lines of .NET code to verify Xlsm documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Xlsm files"
description: "API for .NET provides opportunity to verify Qrcode signatures at Xlsm documents. Verification of e-signatures inside your Xlsm documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Qrcode signatures placed at Xlsm documents. Use this opportunity without implementing extra code.
