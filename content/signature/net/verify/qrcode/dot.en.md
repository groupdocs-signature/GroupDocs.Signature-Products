...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Dot files in C#"
head_description: "Use only a few lines of .NET code to verify Dot documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Dot files"
description: "API for .NET provides opportunity to verify Qrcode signatures at Dot documents. Verification of e-signatures inside your Dot documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Qrcode signatures placed at Dot documents. Use this opportunity without implementing extra code.
