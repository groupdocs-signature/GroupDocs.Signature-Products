...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Svg datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Svg dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Svg datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Svg. Provjera e-potpisa unutar vaših Svg dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Svg. Iskoristite ovu priliku bez implementacije dodatnog koda.
