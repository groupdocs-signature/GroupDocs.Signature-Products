...
############################# Head ############################
head_title: "A Qrcode aláírások ellenőrzése a Odp fájlokhoz a C# segítségével"
head_description: "Csak néhány sornyi .NET kódot használjon a Odp dokumentumok és a hozzájuk tartozó Qrcode aláírások ellenőrzéséhez."

############################# Header ############################
title: "Qrcode aláírás ellenőrzése a Odp fájlokhoz"
description: "A(z) .NET API lehetőséget biztosít a(z) Qrcode aláírások ellenőrzésére a(z) Odp dokumentumoknál. A Odp dokumentumaiban lévő e-aláírások ellenőrzése gyorsan és egyszerűen elvégezhető."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) olyan hasznos funkciókat tartalmaz, mint a Qrcode aláírások ellenőrzése a Odp dokumentumokban. Használja ki ezt a lehetőséget extra kód alkalmazása nélkül.
