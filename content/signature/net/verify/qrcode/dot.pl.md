...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Dot przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Dot i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Dot"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Qrcode w dokumentach Dot. Weryfikacja podpisów elektronicznych w dokumentach Dot może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Dot. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
