...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Tiff przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Tiff i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Tiff"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Qrcode w dokumentach Tiff. Weryfikacja podpisów elektronicznych w dokumentach Tiff może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Tiff. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
