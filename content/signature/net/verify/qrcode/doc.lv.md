...
############################# Head ############################
head_title: "Qrcode parakstu pārbaude failiem Doc, izmantojot C#"
head_description: "Izmantojiet tikai dažas .NET koda rindiņas, lai pārbaudītu Doc dokumentus un to Qrcode parakstus."

############################# Header ############################
title: "Qrcode parakstu pārbaude failiem Doc"
description: ".NET API nodrošina iespēju pārbaudīt Qrcode parakstus Doc dokumentos. E-parakstu pārbaude jūsu Doc dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ietver tādas noderīgas funkcijas kā Qrcode parakstu pārbaude, kas ievietoti Doc dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
