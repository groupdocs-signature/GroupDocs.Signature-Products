...
############################# Head ############################
head_title: "Qrcode failų Tar parašų patvirtinimas naudojant C#"
head_description: "Naudokite tik kelias .NET kodo eilutes, kad patikrintumėte Tar dokumentus ir jų Qrcode parašus."

############################# Header ############################
title: "Qrcode parašų patvirtinimas Tar failams"
description: "API, skirta .NET, suteikia galimybę patvirtinti Qrcode parašus Tar dokumentuose. El. parašų patvirtinimas jūsų Tar dokumentuose gali būti atliktas greitai ir paprastai."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) apima naudingas funkcijas, pvz., Qrcode parašų, pateiktų Tar dokumentuose, patvirtinimą. Pasinaudokite šia galimybe neįdiegę papildomo kodo.
