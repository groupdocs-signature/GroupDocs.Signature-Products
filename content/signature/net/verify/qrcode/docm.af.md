...
############################# Head ############################
head_title: "Verifikasie van Qrcode handtekeninge vir Docm lêers via C#"
head_description: "Gebruik slegs 'n paar reëls van .NET-kode om Docm-dokumente en hul Qrcode-handtekeninge te verifieer."

############################# Header ############################
title: "Qrcode handtekeningverifikasie vir Docm lêers"
description: "API vir .NET bied geleentheid om Qrcode handtekeninge by Docm dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Docm dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    enable: true
    title_left: "Hoe om Qrcode handtekeninge in jou Docm dokument te bekragtig"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos verifikasie van Qrcode-handtekeninge wat by Docm-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
