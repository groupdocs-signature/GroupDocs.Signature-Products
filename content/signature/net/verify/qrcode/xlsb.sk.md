...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Xlsb cez C#"
head_description: "Na overenie dokumentov Xlsb a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Xlsb"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Xlsb. Overenie elektronických podpisov vo vašich dokumentoch Xlsb môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Xlsb. Využite túto príležitosť bez implementácie dodatočného kódu.
