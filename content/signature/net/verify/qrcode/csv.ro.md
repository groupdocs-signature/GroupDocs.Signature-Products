...
############################# Head ############################
head_title: "Verificarea semnăturilor Qrcode pentru fișierele Csv prin C#"
head_description: "Utilizați doar câteva rânduri de cod .NET pentru a verifica documentele Csv și semnăturile acestora Qrcode."

############################# Header ############################
title: "Qrcode verificarea semnăturilor pentru fișiere Csv"
description: "API-ul pentru .NET oferă posibilitatea de a verifica semnăturile Qrcode în documentele Csv. Verificarea semnăturilor electronice din documentele dvs. Csv poate fi efectuată rapid și ușor."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) include funcții utile, cum ar fi verificarea semnăturilor Qrcode plasate în documentele Csv. Folosiți această oportunitate fără a implementa cod suplimentar.
