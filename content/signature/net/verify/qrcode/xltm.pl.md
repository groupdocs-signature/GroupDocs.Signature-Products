...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Xltm przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Xltm i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Xltm"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Qrcode w dokumentach Xltm. Weryfikacja podpisów elektronicznych w dokumentach Xltm może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Xltm. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
