...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Potm files in C#"
head_description: "Use only a few lines of .NET code to verify Potm documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Potm files"
description: "API for .NET provides opportunity to verify Qrcode signatures at Potm documents. Verification of e-signatures inside your Potm documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Qrcode signatures placed at Potm documents. Use this opportunity without implementing extra code.
