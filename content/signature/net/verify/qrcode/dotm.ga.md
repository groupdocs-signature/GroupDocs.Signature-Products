...
############################# Head ############################
head_title: "Fíorú Qrcode sínithe do chomhaid Dotm trí C#"
head_description: "Ná húsáid ach cúpla líne de chód .NET chun doiciméid Dotm agus a gcuid sínithe Qrcode a fhíorú."

############################# Header ############################
title: "Qrcode fíorú sínithe le haghaidh comhad Dotm"
description: "Soláthraíonn API do .NET deis chun Qrcode sínithe ag Dotm doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Dotm a fhíorú go tapa agus go héasca."
...
steps:
    ...
    content_left: |
        Áiríonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail fíorú Qrcode sínithe atá curtha ag Dotm doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
