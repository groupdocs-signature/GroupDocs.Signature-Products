...
############################# Head ############################
head_title: "Verifikasie van Qrcode handtekeninge vir Tar lêers via C#"
head_description: "Gebruik slegs 'n paar reëls van .NET-kode om Tar-dokumente en hul Qrcode-handtekeninge te verifieer."

############################# Header ############################
title: "Qrcode handtekeningverifikasie vir Tar lêers"
description: "API vir .NET bied geleentheid om Qrcode handtekeninge by Tar dokumente te verifieer. Verifikasie van e-handtekeninge binne jou Tar dokumente kan vinnig en maklik uitgevoer word."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sluit nuttige kenmerke in soos verifikasie van Qrcode-handtekeninge wat by Tar-dokumente geplaas word. Gebruik hierdie geleentheid sonder om ekstra kode te implementeer.
