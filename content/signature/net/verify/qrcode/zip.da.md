...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Zip filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Zip-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Zip filer"
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Zip-dokumenter. Bekræftelse af e-signaturer i dine Zip-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Zip dokumenter. Brug denne mulighed uden at implementere ekstra kode.
