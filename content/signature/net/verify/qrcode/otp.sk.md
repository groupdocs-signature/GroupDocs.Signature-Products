...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Otp cez C#"
head_description: "Na overenie dokumentov Otp a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Otp"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Otp. Overenie elektronických podpisov vo vašich dokumentoch Otp môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Otp. Využite túto príležitosť bez implementácie dodatočného kódu.
