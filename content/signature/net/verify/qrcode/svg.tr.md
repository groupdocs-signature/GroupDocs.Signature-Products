...
############################# Head ############################
head_title: "Svg dosyaları için Qrcode imzalarının C# aracılığıyla doğrulanması"
head_description: "Svg belgelerini ve bunların Qrcode imzalarını doğrulamak için yalnızca birkaç satır .NET kodu kullanın."

############################# Header ############################
title: "Svg dosyaları için Qrcode imza doğrulaması"
description: ".NET için API, Svg belgelerinde Qrcode imzalarını doğrulama fırsatı sunar. Svg belgelerinizdeki e-imzaların doğrulanması hızlı ve kolay bir şekilde gerçekleştirilebilir."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Svg belgelerine yerleştirilen Qrcode imzalarının doğrulanması gibi faydalı özellikler içerir. Ekstra kod uygulamadan bu fırsatı kullanın.
