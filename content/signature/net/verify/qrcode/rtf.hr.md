...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Rtf datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Rtf dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Rtf datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Rtf. Provjera e-potpisa unutar vaših Rtf dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Rtf dokumentu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Rtf. Iskoristite ovu priliku bez implementacije dodatnog koda.
