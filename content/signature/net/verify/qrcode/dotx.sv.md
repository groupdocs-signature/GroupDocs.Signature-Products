...
description: "API för .NET ger möjlighet att verifiera Qrcode-signaturer i Dotx-dokument. Verifiering av e-signaturer i dina {{Filformat}}-dokument kan utföras snabbt och enkelt."
