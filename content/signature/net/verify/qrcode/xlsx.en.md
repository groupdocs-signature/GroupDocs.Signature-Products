...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Xlsx files in C#"
head_description: "Use only a few lines of .NET code to verify Xlsx documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Xlsx files"
description: "API for .NET provides opportunity to verify Qrcode signatures at Xlsx documents. Verification of e-signatures inside your Xlsx documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Qrcode signatures placed at Xlsx documents. Use this opportunity without implementing extra code.
