...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Xltx cez C#"
head_description: "Na overenie dokumentov Xltx a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Xltx"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Xltx. Overenie elektronických podpisov vo vašich dokumentoch Xltx môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Xltx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Xltx. Využite túto príležitosť bez implementácie dodatočného kódu.
