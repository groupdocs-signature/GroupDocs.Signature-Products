...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Xlsb datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Xlsb dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Xlsb datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Xlsb. Provjera e-potpisa unutar vaših Xlsb dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Xlsb. Iskoristite ovu priliku bez implementacije dodatnog koda.
