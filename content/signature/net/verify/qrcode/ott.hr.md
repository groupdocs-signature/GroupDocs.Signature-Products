...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Ott datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Ott dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Ott datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Ott. Provjera e-potpisa unutar vaših Ott dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    enable: true
    title_left: "Kako provjeriti valjanost potpisa Qrcode u vašem Ott dokumentu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Ott. Iskoristite ovu priliku bez implementacije dodatnog koda.
