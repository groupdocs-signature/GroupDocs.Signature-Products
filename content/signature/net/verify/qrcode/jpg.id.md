...
############################# Head ############################
head_title: "Verifikasi tanda tangan Qrcode untuk file Jpg melalui C#"
head_description: "Gunakan hanya beberapa baris kode .NET untuk memverifikasi dokumen Jpg dan tanda tangan Qrcode mereka."

############################# Header ############################
title: "Qrcode verifikasi tanda tangan untuk file Jpg"
description: "API untuk .NET memberikan kesempatan untuk memverifikasi tanda tangan Qrcode pada dokumen Jpg. Verifikasi tanda tangan elektronik di dalam dokumen Jpg Anda dapat dilakukan dengan cepat dan mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyertakan fitur berguna seperti verifikasi tanda tangan Qrcode yang ditempatkan di dokumen Jpg. Gunakan kesempatan ini tanpa menerapkan kode tambahan.
