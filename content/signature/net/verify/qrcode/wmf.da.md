...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Wmf filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Wmf-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Wmf filer"
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Wmf-dokumenter. Bekræftelse af e-signaturer i dine Wmf-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Wmf dokumenter. Brug denne mulighed uden at implementere ekstra kode.
