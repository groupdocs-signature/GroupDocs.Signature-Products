...
############################# Head ############################
head_title: "Verification of Qrcode signatures for Tar files via C#"
head_description: "Use only a few lines of .NET code to verify Tar documents and their Qrcode signatures."

############################# Header ############################
title: "Qrcode signatures verification for Tar files"
description: "API for .NET provides opportunity to verify Qrcode signatures at Tar documents. Verification of e-signatures inside your Tar documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like verification of Qrcode signatures placed at Tar documents. Use this opportunity without implementing extra code.
