...
############################# Head ############################
head_title: "Ověření podpisů Qrcode pro soubory Ods prostřednictvím C#"
head_description: "Použijte pouze několik řádků kódu .NET k ověření dokumentů Ods a jejich podpisů Qrcode."

############################# Header ############################
title: "Ověření podpisů Qrcode pro soubory Ods"
description: "API pro .NET poskytuje příležitost ověřit podpisy Qrcode v dokumentech Ods. Ověření elektronických podpisů ve vašich dokumentech Ods může být provedeno rychle a snadno."
...
steps:
    enable: true
    title_left: "Jak ověřit podpisy Qrcode ve vašem dokumentu Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitečné funkce, jako je ověřování podpisů Qrcode umístěných v dokumentech Ods. Využijte tuto příležitost bez implementace dalšího kódu.
...
demos:
    ...
    content: |
       Přidejte různé elektronické podpisy do souboru Ods právě teď na webu [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
