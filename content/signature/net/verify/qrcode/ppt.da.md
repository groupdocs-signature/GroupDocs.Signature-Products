...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Ppt filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Ppt-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Ppt filer"
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Ppt-dokumenter. Bekræftelse af e-signaturer i dine Ppt-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Ppt dokumenter. Brug denne mulighed uden at implementere ekstra kode.
