...
description: "Το API για το .NET παρέχει την ευκαιρία να επαληθεύσετε τις υπογραφές Qrcode σε έγγραφα Ott. Η επαλήθευση των ηλεκτρονικών υπογραφών στα έγγραφά σας Ott μπορεί να πραγματοποιηθεί γρήγορα και εύκολα."
