...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for Dotm filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Dotm-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for Dotm filer"
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på Dotm-dokumenter. Bekræftelse af e-signaturer i dine Dotm-dokumenter kan udføres hurtigt og nemt."
...
steps:
    enable: true
    title_left: "Sådan validerer du Qrcode-signaturer i dit Dotm-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på Dotm dokumenter. Brug denne mulighed uden at implementere ekstra kode.
