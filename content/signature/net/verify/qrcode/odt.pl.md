...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Odt przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Odt i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Odt"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Qrcode w dokumentach Odt. Weryfikacja podpisów elektronicznych w dokumentach Odt może być przeprowadzona szybko i łatwo."
...
steps:
    enable: true
    title_left: "Jak zweryfikować podpisy Qrcode w dokumencie Odt?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Odt. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
