...
############################# Head ############################
head_title: "Bekræftelse af Qrcode signaturer for 7z filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte 7z-dokumenter og deres Qrcode-signaturer."

############################# Header ############################
title: "Qrcode signaturbekræftelse for 7z filer"
description: "API for .NET giver mulighed for at bekræfte Qrcode-signaturer på 7z-dokumenter. Bekræftelse af e-signaturer i dine 7z-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Qrcode signaturer placeret på 7z dokumenter. Brug denne mulighed uden at implementere ekstra kode.
