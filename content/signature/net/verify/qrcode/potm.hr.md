...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Potm datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Potm dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Potm datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Potm. Provjera e-potpisa unutar vaših Potm dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Potm. Iskoristite ovu priliku bez implementacije dodatnog koda.
