...
############################# Head ############################
head_title: "Verifica delle firme Qrcode per i file Dcm tramite C#"
head_description: "Utilizza solo poche righe di codice .NET per verificare i documenti Dcm e le relative firme Qrcode."

############################# Header ############################
title: "Verifica delle firme Qrcode per i file Dcm"
description: "L'API per .NET offre l'opportunità di verificare le firme Qrcode nei documenti Dcm. La verifica delle firme elettroniche all'interno dei tuoi documenti Dcm potrebbe essere eseguita in modo rapido e semplice."
...
steps:
    enable: true
    title_left: "Come convalidare le firme Qrcode nel tuo documento Dcm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) include funzioni utili come la verifica delle firme Qrcode apposte in Dcm documenti. Usa questa opportunità senza implementare codice aggiuntivo.
...
demos:
    ...
    content: |
       Aggiungi subito varie firme elettroniche al file Dcm visitando il sito Web [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          
