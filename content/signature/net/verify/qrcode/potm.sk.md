...
############################# Head ############################
head_title: "Overenie Qrcode podpisov pre súbory Potm cez C#"
head_description: "Na overenie dokumentov Potm a ich podpisov Qrcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Qrcode pre súbory Potm"
description: "API pre .NET poskytuje možnosť overiť podpisy Qrcode v dokumentoch Potm. Overenie elektronických podpisov vo vašich dokumentoch Potm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Qrcode vo vašom dokumente Potm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Qrcode umiestnených v dokumentoch Potm. Využite túto príležitosť bez implementácie dodatočného kódu.
