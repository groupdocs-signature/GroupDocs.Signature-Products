...
############################# Head ############################
head_title: "Provjera Qrcode potpisa za Ppt datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Ppt dokumenata i njihovih Qrcode potpisa."

############################# Header ############################
title: "Provjera potpisa Qrcode za Ppt datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Qrcode u dokumentima Ppt. Provjera e-potpisa unutar vaših Ppt dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Qrcode postavljenih na dokumente Ppt. Iskoristite ovu priliku bez implementacije dodatnog koda.
