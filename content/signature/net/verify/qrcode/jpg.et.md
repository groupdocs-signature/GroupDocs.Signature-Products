...
############################# Head ############################
head_title: "Qrcode allkirjade kontrollimine failide Jpg jaoks läbi C#"
head_description: "Kasutage Jpg dokumentide ja nende allkirjade Qrcode kontrollimiseks ainult mõnda rida .NET koodi."

############################# Header ############################
title: "Qrcode allkirjade kontrollimine faili Jpg jaoks"
description: "API for .NET annab võimaluse kontrollida Qrcode allkirju Jpg dokumentides. Teie Jpg dokumentides olevate e-allkirjade kontrollimine võib toimuda kiiresti ja lihtsalt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) sisaldab kasulikke funktsioone, nagu Qrcode allkirjade kontrollimine, mis on pandud dokumentidele Jpg. Kasutage seda võimalust lisakoodi rakendamata.
