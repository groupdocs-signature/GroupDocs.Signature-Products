...
############################# Head ############################
head_title: "Weryfikacja podpisów Qrcode dla plików Xltx przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Xltx i ich podpisy Qrcode."

############################# Header ############################
title: "Weryfikacja podpisów Qrcode dla plików Xltx"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Qrcode w dokumentach Xltx. Weryfikacja podpisów elektronicznych w dokumentach Xltx może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Qrcode umieszczonych w dokumentach Xltx. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
