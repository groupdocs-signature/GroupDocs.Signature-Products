...
############################# Head ############################
head_title: "Preverjanje podpisov Qrcode za datoteke 7z prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov 7z in njihovih podpisov Qrcode."

############################# Header ############################
title: "Preverjanje podpisov Qrcode za datoteke 7z"
description: "API za .NET ponuja možnost preverjanja podpisov Qrcode v dokumentih 7z. Preverjanje e-podpisov v vaših 7z dokumentih lahko izvedete hitro in enostavno."
...
steps:
    enable: true
    title_left: "Kako potrditi podpise Qrcode v dokumentu 7z"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Qrcode v dokumentih 7z. Izkoristite to priložnost brez implementacije dodatne kode.
