...
############################# Head ############################
head_title: "Überprüfung von Qrcode-Signaturen für Rtf-Dateien über C#"
head_description: "Verwenden Sie nur wenige Zeilen .NET-Code, um Rtf-Dokumente und ihre Qrcode-Signaturen zu überprüfen."

############################# Header ############################
title: "Qrcode-Signaturüberprüfung für Rtf-Dateien"
description: "Die API für .NET bietet die Möglichkeit, Qrcode-Signaturen bei Rtf-Dokumenten zu überprüfen. Die Überprüfung elektronischer Signaturen in Ihren Rtf-Dokumenten kann schnell und einfach durchgeführt werden."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) enthält nützliche Funktionen wie die Überprüfung von Qrcode-Signaturen, die in Rtf-Dokumenten platziert wurden. Nutzen Sie diese Gelegenheit, ohne zusätzlichen Code zu implementieren.
