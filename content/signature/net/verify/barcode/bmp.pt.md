...
############################# Head ############################
head_title: "Verificação de assinaturas Barcode para arquivos Bmp via C#"
head_description: "Use apenas algumas linhas de código .NET para verificar documentos Bmp e suas assinaturas Barcode."

############################# Header ############################
title: "Barcode verificação de assinaturas para Bmp arquivos"
description: "A API para .NET oferece a oportunidade de verificar assinaturas Barcode em documentos Bmp. A verificação de assinaturas eletrônicas dentro de seus documentos Bmp pode ser realizada de forma rápida e fácil."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis, como verificação de Barcode assinaturas colocadas em documentos Bmp. Use esta oportunidade sem implementar código extra.
