...
############################# Head ############################
head_title: "Verification of Barcode signatures for Jpg files in C#"
head_description: "Use only a few lines of .NET code to verify Jpg documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Jpg files"
description: "API for .NET provides opportunity to verify Barcode signatures at Jpg documents. Verification of e-signatures inside your Jpg documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Barcode signatures placed at Jpg documents. Use this opportunity without implementing extra code.
