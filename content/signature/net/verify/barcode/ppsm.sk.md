...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Ppsm cez C#"
head_description: "Na overenie dokumentov Ppsm a ich podpisov Barcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Ppsm"
description: "API pre .NET poskytuje možnosť overiť podpisy Barcode v dokumentoch Ppsm. Overenie elektronických podpisov vo vašich dokumentoch Ppsm môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Ppsm. Využite túto príležitosť bez implementácie dodatočného kódu.
