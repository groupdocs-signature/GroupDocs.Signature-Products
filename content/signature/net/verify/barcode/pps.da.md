...
description: "API for .NET giver mulighed for at bekræfte Barcode-signaturer på Pps-dokumenter. Bekræftelse af e-signaturer i dine {{Filformat}}-dokumenter kan udføres hurtigt og nemt."
