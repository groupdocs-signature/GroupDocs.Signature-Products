...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Potx cez C#"
head_description: "Na overenie dokumentov Potx a ich podpisov Barcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Potx"
description: "API pre .NET poskytuje možnosť overiť podpisy Barcode v dokumentoch Potx. Overenie elektronických podpisov vo vašich dokumentoch Potx môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Potx. Využite túto príležitosť bez implementácie dodatočného kódu.
