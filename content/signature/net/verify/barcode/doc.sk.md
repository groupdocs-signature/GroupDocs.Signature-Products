...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Doc cez C#"
head_description: "Na overenie dokumentov Doc a ich podpisov Barcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Doc"
description: "API pre .NET poskytuje možnosť overiť podpisy Barcode v dokumentoch Doc. Overenie elektronických podpisov vo vašich dokumentoch Doc môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Doc. Využite túto príležitosť bez implementácie dodatočného kódu.
