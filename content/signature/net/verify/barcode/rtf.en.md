...
############################# Head ############################
head_title: "Verification of Barcode signatures for Rtf files in C#"
head_description: "Use only a few lines of .NET code to verify Rtf documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Rtf files"
description: "API for .NET provides opportunity to verify Barcode signatures at Rtf documents. Verification of e-signatures inside your Rtf documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Barcode signatures placed at Rtf documents. Use this opportunity without implementing extra code.
