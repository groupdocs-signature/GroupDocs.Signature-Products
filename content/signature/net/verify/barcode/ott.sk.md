...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Ott cez C#"
head_description: "Na overenie dokumentov Ott a ich podpisov Barcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Ott"
description: "API pre .NET poskytuje možnosť overiť podpisy Barcode v dokumentoch Ott. Overenie elektronických podpisov vo vašich dokumentoch Ott môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Ott. Využite túto príležitosť bez implementácie dodatočného kódu.
