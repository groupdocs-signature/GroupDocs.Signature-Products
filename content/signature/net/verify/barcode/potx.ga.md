...
############################# Head ############################
head_title: "Fíorú Barcode sínithe do chomhaid Potx trí C#"
head_description: "Ná húsáid ach cúpla líne de chód .NET chun doiciméid Potx agus a gcuid sínithe Barcode a fhíorú."

############################# Header ############################
title: "Barcode fíorú sínithe le haghaidh comhad Potx"
description: "Soláthraíonn API do .NET deis chun Barcode sínithe ag Potx doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Potx a fhíorú go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Barcode sínithe i do dhoiciméad Potx a bhailíochtú"
    content_left: |
        Áiríonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail fíorú Barcode sínithe atá curtha ag Potx doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
...
demos:
    ...
    content: |
       Cuir sínithe leictreonacha éagsúla le comhad Potx faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Signature App](https://products.groupdocs.app/signature/family).          

############################# More Formats ############################
more_formats:
    enable: true
    title: "Fíoraigh Barcode sínithe eile ag úsáid C#"
    content: |
