...
############################# Head ############################
head_title: "Fíorú Barcode sínithe do chomhaid Ppsx trí C#"
head_description: "Ná húsáid ach cúpla líne de chód .NET chun doiciméid Ppsx agus a gcuid sínithe Barcode a fhíorú."

############################# Header ############################
title: "Barcode fíorú sínithe le haghaidh comhad Ppsx"
description: "Soláthraíonn API do .NET deis chun Barcode sínithe ag Ppsx doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Ppsx a fhíorú go tapa agus go héasca."
...
steps:
    ...
    content_left: |
        Áiríonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail fíorú Barcode sínithe atá curtha ag Ppsx doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
