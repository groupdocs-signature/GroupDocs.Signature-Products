...
############################# Head ############################
head_title: "Verification of Barcode signatures for Zip files via C#"
head_description: "Use only a few lines of .NET code to verify Zip documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Zip files"
description: "API for .NET provides opportunity to verify Barcode signatures at Zip documents. Verification of e-signatures inside your Zip documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like verification of Barcode signatures placed at Zip documents. Use this opportunity without implementing extra code.
