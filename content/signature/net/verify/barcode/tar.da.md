...
############################# Head ############################
head_title: "Bekræftelse af Barcode signaturer for Tar filer via C#"
head_description: "Brug kun et par linjer med .NET-kode til at bekræfte Tar-dokumenter og deres Barcode-signaturer."

############################# Header ############################
title: "Barcode signaturbekræftelse for Tar filer"
description: "API for .NET giver mulighed for at bekræfte Barcode-signaturer på Tar-dokumenter. Bekræftelse af e-signaturer i dine Tar-dokumenter kan udføres hurtigt og nemt."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inkluderer nyttige funktioner såsom bekræftelse af Barcode signaturer placeret på Tar dokumenter. Brug denne mulighed uden at implementere ekstra kode.
