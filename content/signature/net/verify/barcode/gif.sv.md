...
description: "API för .NET ger möjlighet att verifiera Barcode-signaturer i Gif-dokument. Verifiering av e-signaturer i dina {{Filformat}}-dokument kan utföras snabbt och enkelt."
