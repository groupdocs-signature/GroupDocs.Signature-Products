...
############################# Head ############################
head_title: "Barcode parakstu pārbaude failiem Tar, izmantojot C#"
head_description: "Izmantojiet tikai dažas .NET koda rindiņas, lai pārbaudītu Tar dokumentus un to Barcode parakstus."

############################# Header ############################
title: "Barcode parakstu pārbaude failiem Tar"
description: ".NET API nodrošina iespēju pārbaudīt Barcode parakstus Tar dokumentos. E-parakstu pārbaude jūsu Tar dokumentos var tikt veikta ātri un vienkārši."
...
steps:
    enable: true
    title_left: "Kā pārbaudīt Barcode parakstus savā Tar dokumentā"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ietver tādas noderīgas funkcijas kā Barcode parakstu pārbaude, kas ievietoti Tar dokumentos. Izmantojiet šo iespēju, neieviešot papildu kodu.
