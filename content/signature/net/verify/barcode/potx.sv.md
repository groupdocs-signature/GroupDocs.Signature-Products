...
############################# Head ############################
head_title: "Verifiering av Barcode-signaturer för Potx-filer via C#"
...
steps:
    enable: true
    title_left: "Så här validerar du Barcode-signaturer i ditt Potx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Barcode-signaturer placerade i Potx-dokument. Använd denna möjlighet utan att implementera extra kod.
