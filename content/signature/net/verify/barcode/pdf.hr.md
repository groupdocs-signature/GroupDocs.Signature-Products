...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Pdf datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Pdf dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Pdf datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Barcode u dokumentima Pdf. Provjera e-potpisa unutar vaših Pdf dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Pdf. Iskoristite ovu priliku bez implementacije dodatnog koda.
