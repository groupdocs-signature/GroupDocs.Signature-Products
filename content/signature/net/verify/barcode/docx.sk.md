...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Docx cez C#"
head_description: "Na overenie dokumentov Docx a ich podpisov Barcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Docx"
description: "API pre .NET poskytuje možnosť overiť podpisy Barcode v dokumentoch Docx. Overenie elektronických podpisov vo vašich dokumentoch Docx môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Docx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Docx. Využite túto príležitosť bez implementácie dodatočného kódu.
