...
############################# Head ############################
head_title: "Verificação de assinaturas Barcode para arquivos Dotx via C#"
head_description: "Use apenas algumas linhas de código .NET para verificar documentos Dotx e suas assinaturas Barcode."

############################# Header ############################
title: "Barcode verificação de assinaturas para Dotx arquivos"
description: "A API para .NET oferece a oportunidade de verificar assinaturas Barcode em documentos Dotx. A verificação de assinaturas eletrônicas dentro de seus documentos Dotx pode ser realizada de forma rápida e fácil."
...
steps:
    enable: true
    title_left: "Como validar assinaturas Barcode em seu documento Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) inclui recursos úteis, como verificação de Barcode assinaturas colocadas em documentos Dotx. Use esta oportunidade sem implementar código extra.
