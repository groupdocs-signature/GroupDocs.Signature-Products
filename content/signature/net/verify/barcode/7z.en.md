...
############################# Head ############################
head_title: "Verification of Barcode signatures for 7z files via C#"
head_description: "Use only a few lines of .NET code to verify 7z documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for 7z files"
description: "API for .NET provides opportunity to verify Barcode signatures at 7z documents. Verification of e-signatures inside your 7z documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Barcode signatures in your 7z document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like verification of Barcode signatures placed at 7z documents. Use this opportunity without implementing extra code.
