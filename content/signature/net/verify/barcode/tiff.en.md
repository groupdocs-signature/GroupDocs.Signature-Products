...
############################# Head ############################
head_title: "Verification of Barcode signatures for Tiff files in C#"
head_description: "Use only a few lines of .NET code to verify Tiff documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Tiff files"
description: "API for .NET provides opportunity to verify Barcode signatures at Tiff documents. Verification of e-signatures inside your Tiff documents might be performed quickly and easily."
...
steps:
    enable: true
    title_left: "How to validate Barcode signatures in your Tiff document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) for .NET includes useful features like verification of Barcode signatures placed at Tiff documents. Use this opportunity without implementing extra code.
