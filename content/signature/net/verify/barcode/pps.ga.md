...
############################# Head ############################
head_title: "Fíorú Barcode sínithe do chomhaid Pps trí C#"
head_description: "Ná húsáid ach cúpla líne de chód .NET chun doiciméid Pps agus a gcuid sínithe Barcode a fhíorú."

############################# Header ############################
title: "Barcode fíorú sínithe le haghaidh comhad Pps"
description: "Soláthraíonn API do .NET deis chun Barcode sínithe ag Pps doiciméid a fhíorú. Seans go ndéanfar ríomhshínithe laistigh de do dhoiciméid Pps a fhíorú go tapa agus go héasca."
...
steps:
    enable: true
    title_left: "Conas Barcode sínithe i do dhoiciméad Pps a bhailíochtú"
    content_left: |
        Áiríonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gnéithe úsáideacha amhail fíorú Barcode sínithe atá curtha ag Pps doiciméad. Bain úsáid as an deis seo gan cód breise a chur i bhfeidhm.
