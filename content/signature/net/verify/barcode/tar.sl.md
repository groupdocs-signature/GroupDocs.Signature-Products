...
############################# Head ############################
head_title: "Preverjanje podpisov Barcode za datoteke Tar prek C#"
head_description: "Uporabite samo nekaj vrstic kode .NET za preverjanje dokumentov Tar in njihovih podpisov Barcode."

############################# Header ############################
title: "Preverjanje podpisov Barcode za datoteke Tar"
description: "API za .NET ponuja možnost preverjanja podpisov Barcode v dokumentih Tar. Preverjanje e-podpisov v vaših Tar dokumentih lahko izvedete hitro in enostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) vključuje uporabne funkcije, kot je preverjanje podpisov Barcode v dokumentih Tar. Izkoristite to priložnost brez implementacije dodatne kode.
