...
description: "API för .NET ger möjlighet att verifiera Barcode-signaturer i Pdf-dokument. Verifiering av e-signaturer i dina Pdf-dokument kan utföras snabbt och enkelt."
