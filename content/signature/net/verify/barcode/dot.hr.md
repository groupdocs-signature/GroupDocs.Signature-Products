...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Dot datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Dot dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Dot datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Barcode u dokumentima Dot. Provjera e-potpisa unutar vaših Dot dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Dot. Iskoristite ovu priliku bez implementacije dodatnog koda.
