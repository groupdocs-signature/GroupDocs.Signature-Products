...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Ods datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Ods dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Ods datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Barcode u dokumentima Ods. Provjera e-potpisa unutar vaših Ods dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Ods. Iskoristite ovu priliku bez implementacije dodatnog koda.
