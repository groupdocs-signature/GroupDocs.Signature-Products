...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Dcm cez C#"
head_description: "Na overenie dokumentov Dcm a ich podpisov Barcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Dcm"
description: "API pre .NET poskytuje možnosť overiť podpisy Barcode v dokumentoch Dcm. Overenie elektronických podpisov vo vašich dokumentoch Dcm môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Dcm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Dcm. Využite túto príležitosť bez implementácie dodatočného kódu.
