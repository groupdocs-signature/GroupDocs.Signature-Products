...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Wmf datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Wmf dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Wmf datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Barcode u dokumentima Wmf. Provjera e-potpisa unutar vaših Wmf dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Wmf. Iskoristite ovu priliku bez implementacije dodatnog koda.
