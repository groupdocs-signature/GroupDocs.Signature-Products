...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Odp datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Odp dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Odp datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Barcode u dokumentima Odp. Provjera e-potpisa unutar vaših Odp dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Odp. Iskoristite ovu priliku bez implementacije dodatnog koda.
