...
############################# Head ############################
head_title: "Verifiering av Barcode-signaturer för Wmf-filer via C#"
head_description: "Använd bara några rader med .NET-kod för att verifiera Wmf-dokument och deras Barcode-signaturer."

############################# Header ############################
title: "Barcode signaturverifiering för Wmf-filer"
description: "API för .NET ger möjlighet att verifiera Barcode-signaturer i Wmf-dokument. Verifiering av e-signaturer i dina Wmf-dokument kan utföras snabbt och enkelt."
...
steps:
    enable: true
    title_left: "Så här validerar du Barcode-signaturer i ditt Wmf-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) innehåller användbara funktioner som verifiering av Barcode-signaturer placerade i Wmf-dokument. Använd denna möjlighet utan att implementera extra kod.
