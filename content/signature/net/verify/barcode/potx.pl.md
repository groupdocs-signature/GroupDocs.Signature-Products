...
############################# Head ############################
head_title: "Weryfikacja podpisów Barcode dla plików Potx przez C#"
head_description: "Użyj tylko kilku wierszy kodu .NET, aby zweryfikować dokumenty Potx i ich podpisy Barcode."

############################# Header ############################
title: "Weryfikacja podpisów Barcode dla plików Potx"
description: "Interfejs API dla .NET umożliwia weryfikację podpisów Barcode w dokumentach Potx. Weryfikacja podpisów elektronicznych w dokumentach Potx może być przeprowadzona szybko i łatwo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zawiera przydatne funkcje, takie jak weryfikacja podpisów Barcode umieszczonych w dokumentach Potx. Skorzystaj z tej możliwości bez implementowania dodatkowego kodu.
