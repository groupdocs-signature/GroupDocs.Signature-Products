...
############################# Head ############################
head_title: "Provjera Barcode potpisa za Rtf datoteke putem C#"
head_description: "Upotrijebite samo nekoliko redaka .NET koda za provjeru Rtf dokumenata i njihovih Barcode potpisa."

############################# Header ############################
title: "Provjera potpisa Barcode za Rtf datoteke"
description: "API za .NET pruža priliku za provjeru potpisa Barcode u dokumentima Rtf. Provjera e-potpisa unutar vaših Rtf dokumenata može se izvršiti brzo i jednostavno."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) uključuje korisne značajke kao što je provjera potpisa Barcode postavljenih na dokumente Rtf. Iskoristite ovu priliku bez implementacije dodatnog koda.
