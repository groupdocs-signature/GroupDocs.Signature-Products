...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Xlsb cez C#"
head_description: "Na overenie dokumentov Xlsb a ich podpisov Barcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Xlsb"
description: "API pre .NET poskytuje možnosť overiť podpisy Barcode v dokumentoch Xlsb. Overenie elektronických podpisov vo vašich dokumentoch Xlsb môže byť vykonané rýchlo a jednoducho."
...
steps:
    enable: true
    title_left: "Ako overiť podpisy Barcode vo vašom dokumente Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Xlsb. Využite túto príležitosť bez implementácie dodatočného kódu.
