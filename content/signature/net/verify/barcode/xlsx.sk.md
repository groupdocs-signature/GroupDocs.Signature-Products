...
############################# Head ############################
head_title: "Overenie Barcode podpisov pre súbory Xlsx cez C#"
head_description: "Na overenie dokumentov Xlsx a ich podpisov Barcode použite iba niekoľko riadkov kódu .NET."

############################# Header ############################
title: "Overenie podpisov Barcode pre súbory Xlsx"
description: "API pre .NET poskytuje možnosť overiť podpisy Barcode v dokumentoch Xlsx. Overenie elektronických podpisov vo vašich dokumentoch Xlsx môže byť vykonané rýchlo a jednoducho."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) obsahuje užitočné funkcie, ako je overenie podpisov Barcode umiestnených v dokumentoch Xlsx. Využite túto príležitosť bez implementácie dodatočného kódu.
