...
############################# Head ############################
head_title: "Verification of Barcode signatures for Dcm files via C#"
head_description: "Use only a few lines of .NET code to verify Dcm documents and their Barcode signatures."

############################# Header ############################
title: "Barcode signatures verification for Dcm files"
description: "API for .NET provides opportunity to verify Barcode signatures at Dcm documents. Verification of e-signatures inside your Dcm documents might be performed quickly and easily."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) includes useful features like verification of Barcode signatures placed at Dcm documents. Use this opportunity without implementing extra code.
