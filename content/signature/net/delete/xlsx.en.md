...
############################# Head ############################
head_title: "Delete signatures from XLSX using C#"
head_description: "Deletion of Digital, Barcode, Text, Image, Metadata signatures from signed XLSX documents can be performed easily using GroupDocs.Signature for .NET."

############################# Header ############################
title: "Remove signatures from XLSX efficiently" 
...
steps:
    enable: true
    title: "How to delete e-signatures from XLSX using C#"
    content: |
