...
############################# Head ############################
head_title: "Eliminar firmas de PDF usando C#"
head_description: "La eliminación de firmas digitales, de código de barras, de texto, de imágenes y de metadatos de documentos PDF firmados se puede realizar con GroupDocs.Signature for .NET."

############################# Header ############################
title: "Elimine firmas de PDF de manera eficiente" 
...
steps:
    enable: true
    title: "Cómo eliminar firmas electrónicas de PDF usando C#"
    content: |
      [GroupDocs.Signature](/signature/net/) simplifica la tarea para los desarrolladores de .NET de eliminar firmas electrónicas en archivos PDF implementando algunos pasos sencillos.
      
      1. Proporcione la ruta del archivo PDF a una instancia de la clase Signature.
