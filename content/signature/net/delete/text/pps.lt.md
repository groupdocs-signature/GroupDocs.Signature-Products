...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Pps failų naudodami C#"
head_description: "Konkrečius Text parašus iš pasirašytų Pps dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Pps failuose"
description: "Ištrinkite įvairius Text parašus iš Pps dokumentų. Norint pašalinti Text parašus, reikia paprasto C# kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Pps dokumento"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Pps dokumentus nuo Text parašų naudojant kelias kodo eilutes.
