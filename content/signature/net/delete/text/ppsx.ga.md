...
############################# Head ############################
head_title: "Scrios Text sínithe ó chomhaid Ppsx trí C#"
head_description: "Seans go ndéanfaí scriosadh sínithe Text ar leith ó dhoiciméid shínithe Ppsx le cód gearr .NET."

############################# Header ############################
title: "Bain Text sínithe a chuirtear i gcomhaid Ppsx"
description: "Scrios Text sínithe éagsúla ó Ppsx doiciméid. Teastaíonn cód simplí C# chun sínithe Text a bhaint."
...
steps:
    enable: true
    title_left: "Conas Text sínithe a bhaint de do dhoiciméad Ppsx"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gné úsáideach chun Ppsx doiciméad de Text sínithe a ghlanadh le cúpla líne de chód.
