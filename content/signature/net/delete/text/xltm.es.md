...
############################# Head ############################
head_title: "Eliminar Text firmas de Xltm archivos a través de C#"
head_description: "La eliminación de firmas Text específicas de documentos Xltm firmados se puede realizar fácilmente con el código corto .NET."

############################# Header ############################
title: "Eliminar Text firmas que se colocan en archivos Xltm"
description: "Elimine varias firmas Text de los documentos Xltm. Eliminar las firmas Text requiere un código C# simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Text de su documento Xltm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona una característica útil para borrar documentos Xltm de Text firmas con unas pocas líneas de código.
