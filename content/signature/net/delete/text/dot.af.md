...
############################# Head ############################
head_title: "Vee Text handtekeninge van Dot lêers uit via C#"
head_description: "Die uitvee van spesifieke Text handtekeninge van getekende Dot dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Text handtekeninge wat in Dot lêers geplaas is"
description: "Vee verskeie Text handtekeninge uit Dot dokumente uit. Die verwydering van Text handtekeninge vereis eenvoudige C# kode."
...
steps:
    enable: true
    title_left: "Hoe om Text-handtekeninge uit jou Dot-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Dot dokumente van Text handtekeninge met 'n paar reëls kode.
