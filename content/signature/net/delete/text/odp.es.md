...
############################# Head ############################
head_title: "Eliminar Text firmas de Odp archivos a través de C#"
head_description: "La eliminación de firmas Text específicas de documentos Odp firmados se puede realizar fácilmente con el código corto .NET."

############################# Header ############################
title: "Eliminar Text firmas que se colocan en archivos Odp"
description: "Elimine varias firmas Text de los documentos Odp. Eliminar las firmas Text requiere un código C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona una característica útil para borrar documentos Odp de Text firmas con unas pocas líneas de código.
