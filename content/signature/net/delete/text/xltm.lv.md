...
############################# Head ############################
head_title: "Dzēst Text parakstus no Xltm failiem, izmantojot C#"
head_description: "Konkrētu Text parakstu dzēšanu no parakstītiem Xltm dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Text parakstus, kas ir ievietoti Xltm failos"
description: "Izdzēsiet dažādus Text parakstus no Xltm dokumentiem. Lai noņemtu Text parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Xltm dokumentiem notīrītu Text parakstus, izmantojot dažas koda rindiņas.
