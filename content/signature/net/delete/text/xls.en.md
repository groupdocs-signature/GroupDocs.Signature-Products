...
############################# Head ############################
head_title: "Delete Text signatures from Xls files via C#"
head_description: "Deletion of specific Text signatures from signed Xls documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Text signatures which are placed in Xls files"
description: "Delete various Text signatures from Xls documents. Removing Text signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Text signatures from your Xls document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Xls documents of Text signatures with a few lines of code.
