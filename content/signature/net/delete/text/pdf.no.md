...
############################# Head ############################
head_title: "Slett Text-signaturer fra Pdf-filer via C#"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Pdf-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Pdf-filer"
description: "Slett forskjellige Text-signaturer fra Pdf-dokumenter. Fjerning av Text-signaturer krever enkel C#-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Text-signaturer fra Pdf-dokumentet"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Pdf dokumenter for Text signaturer med noen få linjer med kode.
