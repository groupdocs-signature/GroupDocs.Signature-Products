...
############################# Head ############################
head_title: "Scrios Text sínithe ó chomhaid Xltm trí C#"
head_description: "Seans go ndéanfaí scriosadh sínithe Text ar leith ó dhoiciméid shínithe Xltm le cód gearr .NET."

############################# Header ############################
title: "Bain Text sínithe a chuirtear i gcomhaid Xltm"
description: "Scrios Text sínithe éagsúla ó Xltm doiciméid. Teastaíonn cód simplí C# chun sínithe Text a bhaint."
...
steps:
    enable: true
    title_left: "Conas Text sínithe a bhaint de do dhoiciméad Xltm"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gné úsáideach chun Xltm doiciméad de Text sínithe a ghlanadh le cúpla líne de chód.
