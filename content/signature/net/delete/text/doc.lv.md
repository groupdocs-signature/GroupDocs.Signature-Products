...
############################# Head ############################
head_title: "Dzēst Text parakstus no Doc failiem, izmantojot C#"
head_description: "Konkrētu Text parakstu dzēšanu no parakstītiem Doc dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Text parakstus, kas ir ievietoti Doc failos"
description: "Izdzēsiet dažādus Text parakstus no Doc dokumentiem. Lai noņemtu Text parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Doc dokumentiem notīrītu Text parakstus, izmantojot dažas koda rindiņas.
