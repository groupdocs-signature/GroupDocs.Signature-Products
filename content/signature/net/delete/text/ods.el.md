...
############################# Head ############################
head_title: "Διαγραφή υπογραφών Text από αρχεία Ods μέσω C#"
head_description: "Η διαγραφή συγκεκριμένων υπογραφών Text από υπογεγραμμένα έγγραφα Ods μπορεί να πραγματοποιηθεί εύκολα με σύντομο κωδικό .NET."

############################# Header ############################
title: "Καταργήστε τις υπογραφές Text που τοποθετούνται σε αρχεία Ods"
description: "Διαγράψτε διάφορες υπογραφές Text από έγγραφα Ods. Η κατάργηση υπογραφών Text απαιτεί απλό κώδικα C#."
...
steps:
    ...
    content_left: |
        Το [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) παρέχει χρήσιμη δυνατότητα για τη διαγραφή εγγράφων Ods από υπογραφές Text με μερικές γραμμές κώδικα.
