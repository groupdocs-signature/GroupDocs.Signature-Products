...
############################# Head ############################
head_title: "Slett Text-signaturer fra Doc-filer via C#"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Doc-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Doc-filer"
description: "Slett forskjellige Text-signaturer fra Doc-dokumenter. Fjerning av Text-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Doc dokumenter for Text signaturer med noen få linjer med kode.
