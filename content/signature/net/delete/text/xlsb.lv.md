...
############################# Head ############################
head_title: "Dzēst Text parakstus no Xlsb failiem, izmantojot C#"
head_description: "Konkrētu Text parakstu dzēšanu no parakstītiem Xlsb dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Text parakstus, kas ir ievietoti Xlsb failos"
description: "Izdzēsiet dažādus Text parakstus no Xlsb dokumentiem. Lai noņemtu Text parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    enable: true
    title_left: "Kā noņemt Text parakstus no sava Xlsb dokumenta"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Xlsb dokumentiem notīrītu Text parakstus, izmantojot dažas koda rindiņas.
