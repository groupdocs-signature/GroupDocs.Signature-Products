...
############################# Head ############################
head_title: "Удалите подписи Text из Pps файлов с помощью C#"
head_description: "Удаление определенных подписей Text из подписанных документов Pps можно легко выполнить с помощью короткого кода .NET."

############################# Header ############################
title: "Удалить подписи Text, размещенные в файлах Pps"
description: "Удалите различные подписи Text из Pps документов. Для удаления подписей Text требуется простой код C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставляет полезную функцию для очистки документов Pps от подписей Text с помощью нескольких строк кода.
