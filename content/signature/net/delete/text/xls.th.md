...
############################# Head ############################
head_title: "ลบลายเซ็น Text จากไฟล์ Xls ผ่าน C#"
head_description: "การลบลายเซ็น Text เฉพาะจากเอกสาร Xls ที่ลงนามแล้วอาจทำได้ง่ายๆ ด้วยรหัส .NET แบบสั้น"

############################# Header ############################
title: "ลบลายเซ็น Text ที่อยู่ใน Xls files"
description: "ลบลายเซ็น Text ต่างๆ จากเอกสาร Xls การลบลายเซ็น Text ต้องใช้โค้ด C# อย่างง่าย"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) มีคุณลักษณะที่เป็นประโยชน์สำหรับการล้างเอกสาร Xls ของ Text ลายเซ็นด้วยโค้ดไม่กี่บรรทัด
