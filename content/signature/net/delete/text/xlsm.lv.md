...
############################# Head ############################
head_title: "Dzēst Text parakstus no Xlsm failiem, izmantojot C#"
head_description: "Konkrētu Text parakstu dzēšanu no parakstītiem Xlsm dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Text parakstus, kas ir ievietoti Xlsm failos"
description: "Izdzēsiet dažādus Text parakstus no Xlsm dokumentiem. Lai noņemtu Text parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Xlsm dokumentiem notīrītu Text parakstus, izmantojot dažas koda rindiņas.
