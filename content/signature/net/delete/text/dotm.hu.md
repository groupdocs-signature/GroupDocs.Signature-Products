...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Dotm fájlokból a C# segítségével"
head_description: "Az aláírt Dotm dokumentumokból bizonyos Text aláírások törlése egyszerűen végrehajtható rövid .NET kóddal."

############################# Header ############################
title: "Távolítsa el a Text aláírásokat, amelyek a Dotm fájlokban vannak elhelyezve"
description: "Törölje a különböző Text aláírásokat a Dotm dokumentumokból. A Text aláírások eltávolításához egyszerű C# kód szükséges."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Dotm dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
