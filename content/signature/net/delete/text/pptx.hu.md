...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Pptx fájlokból a C# segítségével"
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Pptx dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
