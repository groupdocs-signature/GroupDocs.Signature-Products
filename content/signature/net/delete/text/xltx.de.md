...
############################# Head ############################
head_title: "Löschen Sie Text-Signaturen aus Xltx-Dateien über C#"
head_description: "Das Löschen bestimmter Text-Signaturen aus signierten Xltx-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Text-Signaturen, die in Xltx-Dateien platziert sind"
description: "Löschen Sie verschiedene Text-Signaturen aus Xltx-Dokumenten. Das Entfernen von Text-Signaturen erfordert einfachen C#-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Xltx-Dokumenten von Text-Signaturen mit ein paar Codezeilen.
