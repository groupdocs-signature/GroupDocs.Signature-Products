...
############################# Head ############################
head_title: "Supprimez les signatures Text des fichiers Odt via C#"
head_description: "La suppression de signatures Text spécifiques à partir de documents Odt signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Text qui sont placées dans les fichiers Odt"
description: "Supprimez diverses signatures Text des documents Odt. La suppression des signatures Text nécessite un code C# simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Text de votre document Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Odt des signatures Text avec quelques lignes de code.
