...
############################# Head ############################
head_title: "Usuń podpisy Text z plików Xlsx przez C#"
head_description: "Usuwanie określonych podpisów Text z podpisanych dokumentów Xlsx można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Text podpisy umieszczone w plikach Xlsx"
description: "Usuń różne podpisy Text z dokumentów Xlsx. Usunięcie podpisów Text wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Text z dokumentu Xlsx?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Xlsx z podpisami Text za pomocą kilku linijek kodu.
