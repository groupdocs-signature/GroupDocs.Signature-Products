...
############################# Head ############################
head_title: "Excluir assinaturas Text de arquivos Pptx via C#"
head_description: "A exclusão de assinaturas Text específicas de documentos Pptx assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Text que são colocadas em arquivos Pptx"
description: "Exclua várias assinaturas Text de documentos Pptx. A remoção de assinaturas Text requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Text do seu documento Pptx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Pptx de assinaturas Text com algumas linhas de código.
...
more_formats:
    enable: true
    title: "Exclua suas assinaturas Text com C#"
    content: |
