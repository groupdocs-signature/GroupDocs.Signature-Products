...
############################# Head ############################
head_title: "Löschen Sie Text-Signaturen aus Otp-Dateien über C#"
head_description: "Das Löschen bestimmter Text-Signaturen aus signierten Otp-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Text-Signaturen, die in Otp-Dateien platziert sind"
description: "Löschen Sie verschiedene Text-Signaturen aus Otp-Dokumenten. Das Entfernen von Text-Signaturen erfordert einfachen C#-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Text-Signaturen aus Ihrem Otp-Dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Otp-Dokumenten von Text-Signaturen mit ein paar Codezeilen.
