...
############################# Head ############################
head_title: "Delete Text signatures from Ods files via C#"
head_description: "Deletion of specific Text signatures from signed Ods documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Text signatures which are placed in Ods files"
description: "Delete various Text signatures from Ods documents. Removing Text signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Ods documents of Text signatures with a few lines of code.
