...
############################# Head ############################
head_title: "Hapus tanda tangan Text dari file Pdf melalui C#"
head_description: "Penghapusan tanda tangan Text tertentu dari dokumen Pdf yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Text yang ditempatkan di file Pdf"
description: "Hapus berbagai tanda tangan Text dari dokumen Pdf. Menghapus tanda tangan Text memerlukan kode C# sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Text dari dokumen Pdf Anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Pdf dari Text tanda tangan dengan beberapa baris kode.
