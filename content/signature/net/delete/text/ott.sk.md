...
############################# Head ############################
head_title: "Odstrániť Text podpisy zo súborov Ott cez C#"
head_description: "Odstránenie špecifických podpisov Text z podpísaných dokumentov Ott možno jednoducho vykonať pomocou krátkeho kódu .NET."

############################# Header ############################
title: "Odstráňte Text podpisy, ktoré sú umiestnené v súboroch Ott"
description: "Odstráňte rôzne podpisy Text z dokumentov Ott. Odstránenie podpisov Text vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Ako odstrániť podpisy Text z dokumentu Ott"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitočnú funkciu na vymazanie Ott dokumentov od Text podpisov pomocou niekoľkých riadkov kódu.
