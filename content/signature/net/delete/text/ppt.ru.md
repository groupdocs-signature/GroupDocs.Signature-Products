...
############################# Head ############################
head_title: "Удалите подписи Text из Ppt файлов с помощью C#"
head_description: "Удаление определенных подписей Text из подписанных документов Ppt можно легко выполнить с помощью короткого кода .NET."

############################# Header ############################
title: "Удалить подписи Text, размещенные в файлах Ppt"
description: "Удалите различные подписи Text из Ppt документов. Для удаления подписей Text требуется простой код C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставляет полезную функцию для очистки документов Ppt от подписей Text с помощью нескольких строк кода.
