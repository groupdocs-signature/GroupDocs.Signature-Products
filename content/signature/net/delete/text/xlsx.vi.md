...
############################# Head ############################
head_title: "Xóa chữ ký Text khỏi tệp Xlsx qua C#"
head_description: "Việc xóa các chữ ký Text cụ thể khỏi các tài liệu Xlsx đã ký có thể được thực hiện dễ dàng với mã .NET ngắn."

############################# Header ############################
title: "Xóa các chữ ký Text được đặt trong các tệp Xlsx"
description: "Xóa các chữ ký Text khác nhau khỏi tài liệu Xlsx. Việc xóa chữ ký Text yêu cầu mã C# đơn giản."
...
steps:
    enable: true
    title_left: "Cách xóa chữ ký Text khỏi tài liệu Xlsx của bạn"
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp tính năng hữu ích để xóa các tài liệu Xlsx có chữ ký Text bằng một vài dòng mã.
...
more_formats:
    enable: true
    title: "Xóa chữ ký Text của bạn bằng C#"
    content: |
