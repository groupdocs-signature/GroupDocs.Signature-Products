...
############################# Head ############################
head_title: "Supprimez les signatures Text des fichiers Xls via C#"
head_description: "La suppression de signatures Text spécifiques à partir de documents Xls signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Text qui sont placées dans les fichiers Xls"
description: "Supprimez diverses signatures Text des documents Xls. La suppression des signatures Text nécessite un code C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Xls des signatures Text avec quelques lignes de code.
