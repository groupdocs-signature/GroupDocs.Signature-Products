...
description: "Slett forskjellige Text-signaturer fra Dotx-dokumenter. Fjerning av Text-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Dotx dokumenter for Text signaturer med noen få linjer med kode.
