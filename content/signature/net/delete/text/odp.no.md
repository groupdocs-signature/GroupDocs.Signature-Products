...
############################# Head ############################
head_title: "Slett Text-signaturer fra Odp-filer via C#"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Odp-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Odp-filer"
description: "Slett forskjellige Text-signaturer fra Odp-dokumenter. Fjerning av Text-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Odp dokumenter for Text signaturer med noen få linjer med kode.
