...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Potm failų naudodami C#"
head_description: "Konkrečius Text parašus iš pasirašytų Potm dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Potm failuose"
description: "Ištrinkite įvairius Text parašus iš Potm dokumentų. Norint pašalinti Text parašus, reikia paprasto C# kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Potm dokumentus nuo Text parašų naudojant kelias kodo eilutes.
