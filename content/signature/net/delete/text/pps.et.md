...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Pps läbi C#"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Pps dokumentidest saab hõlpsasti teostada lühikese .NET koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Pps"
description: "Kustutage erinevad allkirjad Text dokumentidest Pps. Allkirjade Text eemaldamine nõuab lihtsat C# koodi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pakub kasulikku funktsiooni Pps dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
