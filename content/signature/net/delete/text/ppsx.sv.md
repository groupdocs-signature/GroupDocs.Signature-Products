...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Ppsx-filer via C#"
head_description: "Radering av specifika Text-signaturer från signerade Ppsx-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Ppsx-filer"
description: "Ta bort olika Text-signaturer från Ppsx-dokument. Att ta bort Text-signaturer kräver enkel C#-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Ppsx dokument från Text signaturer med några rader kod.
