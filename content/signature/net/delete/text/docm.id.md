...
############################# Head ############################
head_title: "Hapus tanda tangan Text dari file Docm melalui C#"
head_description: "Penghapusan tanda tangan Text tertentu dari dokumen Docm yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Text yang ditempatkan di file Docm"
description: "Hapus berbagai tanda tangan Text dari dokumen Docm. Menghapus tanda tangan Text memerlukan kode C# sederhana."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Docm dari Text tanda tangan dengan beberapa baris kode.
