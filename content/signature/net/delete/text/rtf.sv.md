...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Rtf-filer via C#"
head_description: "Radering av specifika Text-signaturer från signerade Rtf-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Rtf-filer"
description: "Ta bort olika Text-signaturer från Rtf-dokument. Att ta bort Text-signaturer kräver enkel C#-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Text-signaturer från ditt Rtf-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Rtf dokument från Text signaturer med några rader kod.
