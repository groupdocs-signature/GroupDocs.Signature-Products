...
############################# Head ############################
head_title: "Padamkan tandatangan Text daripada fail Pptm melalui C#"
head_description: "Pemadaman tandatangan Text tertentu daripada dokumen Pptm yang ditandatangani mungkin dilakukan dengan mudah dengan kod .NET pendek."

############################# Header ############################
title: "Alih keluar tandatangan Text yang diletakkan dalam fail Pptm."
description: "Padamkan pelbagai tandatangan Text daripada dokumen Pptm. Mengalih keluar tandatangan Text memerlukan kod C# yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan ciri berguna untuk mengosongkan Pptm dokumen daripada Text tandatangan dengan beberapa baris kod.
