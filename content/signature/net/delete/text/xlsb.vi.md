...
############################# Head ############################
head_title: "Xóa chữ ký Text khỏi tệp Xlsb qua C#"
head_description: "Việc xóa các chữ ký Text cụ thể khỏi các tài liệu Xlsb đã ký có thể được thực hiện dễ dàng với mã .NET ngắn."

############################# Header ############################
title: "Xóa các chữ ký Text được đặt trong các tệp Xlsb"
description: "Xóa các chữ ký Text khác nhau khỏi tài liệu Xlsb. Việc xóa chữ ký Text yêu cầu mã C# đơn giản."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp tính năng hữu ích để xóa các tài liệu Xlsb có chữ ký Text bằng một vài dòng mã.
