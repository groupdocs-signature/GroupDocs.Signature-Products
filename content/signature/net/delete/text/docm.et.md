...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Docm läbi C#"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Docm dokumentidest saab hõlpsasti teostada lühikese .NET koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Docm"
description: "Kustutage erinevad allkirjad Text dokumentidest Docm. Allkirjade Text eemaldamine nõuab lihtsat C# koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Text oma dokumendist Docm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pakub kasulikku funktsiooni Docm dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
