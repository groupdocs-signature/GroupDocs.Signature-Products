...
############################# Head ############################
head_title: "Excluir assinaturas Text de arquivos Xlsb via C#"
head_description: "A exclusão de assinaturas Text específicas de documentos Xlsb assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Text que são colocadas em arquivos Xlsb"
description: "Exclua várias assinaturas Text de documentos Xlsb. A remoção de assinaturas Text requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Xlsb de assinaturas Text com algumas linhas de código.
