...
############################# Head ############################
head_title: "Izbriši Text potpise iz Otp datoteka putem C#"
head_description: "Brisanje specifičnih Text potpisa iz potpisanih Otp dokumenata može se lako izvesti s kratkim .NET kodom."

############################# Header ############################
title: "Uklonite potpise Text koji se nalaze u datotekama Otp"
description: "Izbrišite razne Text potpise iz Otp dokumenata. Uklanjanje Text potpisa zahtijeva jednostavan C# kod."
...
steps:
    enable: true
    title_left: "Kako ukloniti Text potpise iz vašeg Otp dokumenta"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža korisnu značajku za brisanje Otp dokumenata od Text potpisa s nekoliko redaka koda.
