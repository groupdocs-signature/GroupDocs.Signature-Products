...
############################# Head ############################
head_title: "Supprimez les signatures Text des fichiers Xlsm via C#"
head_description: "La suppression de signatures Text spécifiques à partir de documents Xlsm signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Text qui sont placées dans les fichiers Xlsm"
description: "Supprimez diverses signatures Text des documents Xlsm. La suppression des signatures Text nécessite un code C# simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Text de votre document Xlsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Xlsm des signatures Text avec quelques lignes de code.
