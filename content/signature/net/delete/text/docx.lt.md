...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Docx failų naudodami C#"
head_description: "Konkrečius Text parašus iš pasirašytų Docx dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Docx failuose"
description: "Ištrinkite įvairius Text parašus iš Docx dokumentų. Norint pašalinti Text parašus, reikia paprasto C# kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Docx dokumentus nuo Text parašų naudojant kelias kodo eilutes.
