...
############################# Head ############################
head_title: "Delete Text signatures from Ott files via C#"
head_description: "Deletion of specific Text signatures from signed Ott documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Text signatures which are placed in Ott files"
description: "Delete various Text signatures from Ott documents. Removing Text signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Ott documents of Text signatures with a few lines of code.
