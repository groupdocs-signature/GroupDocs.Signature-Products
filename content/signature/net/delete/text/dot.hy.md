...
############################# Head ############################
head_title: "Ջնջել Text ստորագրությունները Dot ֆայլերից C#-ի միջոցով"
head_description: "Ստորագրված Dot փաստաթղթերից որոշակի Text ստորագրությունների ջնջումը կարող է հեշտությամբ իրականացվել կարճ .NET կոդով:"

############################# Header ############################
title: "Հեռացրեք Text ստորագրությունները, որոնք տեղադրված են Dot ֆայլերում"
description: "Ջնջել տարբեր Text ստորագրությունները Dot փաստաթղթերից: Text ստորագրությունները հեռացնելու համար անհրաժեշտ է պարզ C# կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես հեռացնել Text ստորագրությունները ձեր Dot փաստաթղթից"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) օգտակար հատկություն է տրամադրում Dot փաստաթղթերը Text ստորագրություններից մի քանի տող կոդով մաքրելու համար:
