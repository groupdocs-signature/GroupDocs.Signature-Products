...
############################# Head ############################
head_title: "Slet Text signaturer fra Xlsm filer via C#"
head_description: "Sletning af specifikke Text-signaturer fra signerede Xlsm-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Text-signaturer, der er placeret i Xlsm-filer"
description: "Slet forskellige Text-signaturer fra Xlsm-dokumenter. Fjernelse af Text signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Xlsm dokumenter for Text signaturer med et par linjer kode.
