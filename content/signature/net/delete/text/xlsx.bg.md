...
############################# Head ############################
head_title: "Изтрийте Text подписи от Xlsx файлове чрез C#"
head_description: "Изтриването на конкретни Text подписи от подписани Xlsx документи може да се извърши лесно с кратък .NET код."

############################# Header ############################
title: "Премахнете Text подписи, които са поставени във Xlsx файлове"
description: "Изтрийте различни подписи Text от Xlsx документи. Премахването на подписи Text изисква прост код C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя полезна функция за изчистване на Xlsx документи от Text подписи с няколко реда код.
