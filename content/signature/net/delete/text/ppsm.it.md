...
############################# Head ############################
head_title: "Elimina le firme Text dai file Ppsm tramite C#"
head_description: "L'eliminazione di firme Text specifiche da documenti Ppsm firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Text che sono inserite nei file Ppsm"
description: "Elimina varie firme Text da documenti Ppsm. La rimozione delle firme Text richiede un semplice codice C#."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Text dal tuo documento Ppsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Ppsm di firme Text con poche righe di codice.
