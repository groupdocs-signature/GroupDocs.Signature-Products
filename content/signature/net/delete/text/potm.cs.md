...
############################# Head ############################
head_title: "Odstraňte podpisy Text ze souborů Potm prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Text z podepsaných dokumentů Potm lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Text podpisy, které jsou umístěny v souborech Potm"
description: "Odstraňte různé podpisy Text z dokumentů Potm. Odstranění podpisů Text vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Text z vašeho dokumentu Potm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Potm dokumentů od Text podpisů pomocí několika řádků kódu.
