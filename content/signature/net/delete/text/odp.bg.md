...
############################# Head ############################
head_title: "Изтрийте Text подписи от Odp файлове чрез C#"
head_description: "Изтриването на конкретни Text подписи от подписани Odp документи може да се извърши лесно с кратък .NET код."

############################# Header ############################
title: "Премахнете Text подписи, които са поставени във Odp файлове"
description: "Изтрийте различни подписи Text от Odp документи. Премахването на подписи Text изисква прост код C#."
...
steps:
    enable: true
    title_left: "Как да премахнете подписи Text от вашия Odp документ"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя полезна функция за изчистване на Odp документи от Text подписи с няколко реда код.
