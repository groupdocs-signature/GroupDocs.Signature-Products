...
############################# Head ############################
head_title: "Padamkan tandatangan Text daripada fail Xlsm melalui C#"
head_description: "Pemadaman tandatangan Text tertentu daripada dokumen Xlsm yang ditandatangani mungkin dilakukan dengan mudah dengan kod .NET pendek."

############################# Header ############################
title: "Alih keluar tandatangan Text yang diletakkan dalam fail Xlsm."
description: "Padamkan pelbagai tandatangan Text daripada dokumen Xlsm. Mengalih keluar tandatangan Text memerlukan kod C# yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan ciri berguna untuk mengosongkan Xlsm dokumen daripada Text tandatangan dengan beberapa baris kod.
