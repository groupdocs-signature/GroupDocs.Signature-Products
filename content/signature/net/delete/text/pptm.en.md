...
############################# Head ############################
head_title: "Delete Text signatures from Pptm files via C#"
head_description: "Deletion of specific Text signatures from signed Pptm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Text signatures which are placed in Pptm files"
description: "Delete various Text signatures from Pptm documents. Removing Text signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Pptm documents of Text signatures with a few lines of code.
