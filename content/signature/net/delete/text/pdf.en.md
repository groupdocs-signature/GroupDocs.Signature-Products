...
############################# Head ############################
head_title: "Delete Text signatures from Pdf files via C#"
head_description: "Deletion of specific Text signatures from signed Pdf documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Text signatures which are placed in Pdf files"
description: "Delete various Text signatures from Pdf documents. Removing Text signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Text signatures from your Pdf document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Pdf documents of Text signatures with a few lines of code.
