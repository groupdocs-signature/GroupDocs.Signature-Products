...
############################# Head ############################
head_title: "Видалити підписи Text із файлів Dot через C#"
head_description: "Видалення певних підписів Text із підписаних документів Dot можна легко виконати за допомогою короткого коду .NET."

############################# Header ############################
title: "Видаліть підписи Text, розміщені у файлах Dot"
description: "Видаліть різні підписи Text з документів Dot. Для видалення підписів Text потрібен простий код C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) надає корисну функцію для очищення документів Dot від підписів Text за допомогою кількох рядків коду.
