...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Xlsx failų naudodami C#"
head_description: "Konkrečius Text parašus iš pasirašytų Xlsx dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Xlsx failuose"
description: "Ištrinkite įvairius Text parašus iš Xlsx dokumentų. Norint pašalinti Text parašus, reikia paprasto C# kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Xlsx dokumento"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Xlsx dokumentus nuo Text parašų naudojant kelias kodo eilutes.
