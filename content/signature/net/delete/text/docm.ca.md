...
############################# Head ############################
head_title: "Suprimeix les signatures de Text dels fitxers Docm mitjançant C#"
head_description: "L'eliminació de signatures específiques de Text dels documents signats Docm es pot dur a terme fàcilment amb un codi .NET curt."

############################# Header ############################
title: "Elimineu les signatures de Text que es col·loquen als fitxers Docm"
description: "Suprimeix diverses signatures de Text dels documents Docm. L'eliminació de signatures Text requereix un codi C# senzill."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix una funció útil per esborrar documents de Docm de signatures de Text amb unes poques línies de codi.
