...
############################# Head ############################
head_title: "احذف توقيعات Text من ملفات Xlsb عبر C#"
head_description: "يمكن إجراء حذف توقيعات معينة من Text من مستندات Xlsb الموقعة بسهولة باستخدام رمز .NET القصير."

############################# Header ############################
title: "قم بإزالة Text التوقيعات التي يتم وضعها في ملفات Xlsb"
description: "احذف العديد من توقيعات Text من مستندات Xlsb. تتطلب إزالة توقيعات Text شفرة C# بسيطة."
...
steps:
    ...
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) ميزة مفيدة لمسح Xlsb مستندات توقيعات Text ببضعة أسطر من التعليمات البرمجية.
