...
############################# Head ############################
head_title: "Изтрийте Text подписи от Pptm файлове чрез C#"
head_description: "Изтриването на конкретни Text подписи от подписани Pptm документи може да се извърши лесно с кратък .NET код."

############################# Header ############################
title: "Премахнете Text подписи, които са поставени във Pptm файлове"
description: "Изтрийте различни подписи Text от Pptm документи. Премахването на подписи Text изисква прост код C#."
...
steps:
    enable: true
    title_left: "Как да премахнете подписи Text от вашия Pptm документ"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя полезна функция за изчистване на Pptm документи от Text подписи с няколко реда код.
