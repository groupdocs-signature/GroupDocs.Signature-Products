...
############################# Head ############################
head_title: "Usuń podpisy Text z plików Doc przez C#"
head_description: "Usuwanie określonych podpisów Text z podpisanych dokumentów Doc można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Text podpisy umieszczone w plikach Doc"
description: "Usuń różne podpisy Text z dokumentów Doc. Usunięcie podpisów Text wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Text z dokumentu Doc?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Doc z podpisami Text za pomocą kilku linijek kodu.
