...
############################# Head ############################
head_title: "Elimina le firme Text dai file Dotx tramite C#"
head_description: "L'eliminazione di firme Text specifiche da documenti Dotx firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Text che sono inserite nei file Dotx"
description: "Elimina varie firme Text da documenti Dotx. La rimozione delle firme Text richiede un semplice codice C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Dotx di firme Text con poche righe di codice.
