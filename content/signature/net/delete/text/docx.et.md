...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Docx läbi C#"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Docx dokumentidest saab hõlpsasti teostada lühikese .NET koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Docx"
description: "Kustutage erinevad allkirjad Text dokumentidest Docx. Allkirjade Text eemaldamine nõuab lihtsat C# koodi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pakub kasulikku funktsiooni Docx dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
