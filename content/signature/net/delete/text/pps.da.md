...
############################# Head ############################
head_title: "Slet Text signaturer fra Pps filer via C#"
head_description: "Sletning af specifikke Text-signaturer fra signerede Pps-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Text-signaturer, der er placeret i Pps-filer"
description: "Slet forskellige Text-signaturer fra Pps-dokumenter. Fjernelse af Text signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Pps dokumenter for Text signaturer med et par linjer kode.
