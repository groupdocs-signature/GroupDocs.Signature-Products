...
############################# Head ############################
head_title: "احذف توقيعات Text من ملفات Docx عبر C#"
head_description: "يمكن إجراء حذف توقيعات معينة من Text من مستندات Docx الموقعة بسهولة باستخدام رمز .NET القصير."

############################# Header ############################
title: "قم بإزالة Text التوقيعات التي يتم وضعها في ملفات Docx"
description: "احذف العديد من توقيعات Text من مستندات Docx. تتطلب إزالة توقيعات Text شفرة C# بسيطة."
...
steps:
    enable: true
    title_left: "كيفية إزالة توقيعات Text من مستندك Docx"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) ميزة مفيدة لمسح Docx مستندات توقيعات Text ببضعة أسطر من التعليمات البرمجية.
