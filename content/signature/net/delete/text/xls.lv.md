...
############################# Head ############################
head_title: "Dzēst Text parakstus no Xls failiem, izmantojot C#"
head_description: "Konkrētu Text parakstu dzēšanu no parakstītiem Xls dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Text parakstus, kas ir ievietoti Xls failos"
description: "Izdzēsiet dažādus Text parakstus no Xls dokumentiem. Lai noņemtu Text parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    enable: true
    title_left: "Kā noņemt Text parakstus no sava Xls dokumenta"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Xls dokumentiem notīrītu Text parakstus, izmantojot dažas koda rindiņas.
