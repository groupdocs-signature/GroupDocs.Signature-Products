...
############################# Head ############################
head_title: "Usuń podpisy Text z plików Xls przez C#"
head_description: "Usuwanie określonych podpisów Text z podpisanych dokumentów Xls można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Text podpisy umieszczone w plikach Xls"
description: "Usuń różne podpisy Text z dokumentów Xls. Usunięcie podpisów Text wymaga prostego kodu C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Xls z podpisami Text za pomocą kilku linijek kodu.
