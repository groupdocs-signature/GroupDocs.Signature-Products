...
############################# Head ############################
head_title: "Slett Text-signaturer fra Pptm-filer via C#"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Pptm-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Pptm-filer"
description: "Slett forskjellige Text-signaturer fra Pptm-dokumenter. Fjerning av Text-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Pptm dokumenter for Text signaturer med noen få linjer med kode.
