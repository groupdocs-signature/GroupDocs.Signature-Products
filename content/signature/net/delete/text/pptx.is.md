...
############################# Head ############################
head_title: "Eyða Text undirskriftum úr Pptx skrám í gegnum C#"
head_description: "Auðvelt er að eyða tilteknum Text undirskriftum úr undirrituðum Pptx skjölum með stuttum .NET kóða."

############################# Header ############################
title: "Fjarlægðu Text undirskriftir sem eru settar í Pptx skrár"
description: "Eyða ýmsum Text undirskriftum úr Pptx skjölum. Til að fjarlægja Text undirskrift þarf einfaldan C# kóða."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) býður upp á gagnlegan eiginleika til að hreinsa Pptx skjöl af Text undirskriftum með nokkrum línum af kóða.
