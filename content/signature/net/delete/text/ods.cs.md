...
############################# Head ############################
head_title: "Odstraňte podpisy Text ze souborů Ods prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Text z podepsaných dokumentů Ods lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Text podpisy, které jsou umístěny v souborech Ods"
description: "Odstraňte různé podpisy Text z dokumentů Ods. Odstranění podpisů Text vyžaduje jednoduchý kód C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Ods dokumentů od Text podpisů pomocí několika řádků kódu.
