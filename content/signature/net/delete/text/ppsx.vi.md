...
############################# Head ############################
head_title: "Xóa chữ ký Text khỏi tệp Ppsx qua C#"
head_description: "Việc xóa các chữ ký Text cụ thể khỏi các tài liệu Ppsx đã ký có thể được thực hiện dễ dàng với mã .NET ngắn."

############################# Header ############################
title: "Xóa các chữ ký Text được đặt trong các tệp Ppsx"
description: "Xóa các chữ ký Text khác nhau khỏi tài liệu Ppsx. Việc xóa chữ ký Text yêu cầu mã C# đơn giản."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp tính năng hữu ích để xóa các tài liệu Ppsx có chữ ký Text bằng một vài dòng mã.
