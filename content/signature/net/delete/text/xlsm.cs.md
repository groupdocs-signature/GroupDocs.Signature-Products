...
############################# Head ############################
head_title: "Odstraňte podpisy Text ze souborů Xlsm prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Text z podepsaných dokumentů Xlsm lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Text podpisy, které jsou umístěny v souborech Xlsm"
description: "Odstraňte různé podpisy Text z dokumentů Xlsm. Odstranění podpisů Text vyžaduje jednoduchý kód C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Xlsm dokumentů od Text podpisů pomocí několika řádků kódu.
