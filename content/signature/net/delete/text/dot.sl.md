...
############################# Head ############################
head_title: "Izbrišite podpise Text iz datotek Dot prek C#"
head_description: "Brisanje določenih podpisov Text iz podpisanih dokumentov Dot je mogoče preprosto izvesti s kratko kodo .NET."

############################# Header ############################
title: "Odstranite podpise Text, ki so v datotekah Dot"
description: "Izbrišite različne podpise Text iz dokumentov Dot. Odstranjevanje podpisov Text zahteva preprosto kodo C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nudi uporabno funkcijo za čiščenje dokumentov Dot podpisov Text z nekaj vrsticami kode.
