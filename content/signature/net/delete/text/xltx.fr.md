...
############################# Head ############################
head_title: "Supprimez les signatures Text des fichiers Xltx via C#"
head_description: "La suppression de signatures Text spécifiques à partir de documents Xltx signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Text qui sont placées dans les fichiers Xltx"
description: "Supprimez diverses signatures Text des documents Xltx. La suppression des signatures Text nécessite un code C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Xltx des signatures Text avec quelques lignes de code.
