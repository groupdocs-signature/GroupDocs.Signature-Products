...
############################# Head ############################
head_title: "Izbriši Text potpise iz Doc datoteka putem C#"
head_description: "Brisanje specifičnih Text potpisa iz potpisanih Doc dokumenata može se lako izvesti s kratkim .NET kodom."

############################# Header ############################
title: "Uklonite potpise Text koji se nalaze u datotekama Doc"
description: "Izbrišite razne Text potpise iz Doc dokumenata. Uklanjanje Text potpisa zahtijeva jednostavan C# kod."
...
steps:
    enable: true
    title_left: "Kako ukloniti Text potpise iz vašeg Doc dokumenta"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža korisnu značajku za brisanje Doc dokumenata od Text potpisa s nekoliko redaka koda.
