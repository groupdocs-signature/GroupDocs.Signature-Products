...
############################# Head ############################
head_title: "Odstraňte podpisy Text ze souborů Dotm prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Text z podepsaných dokumentů Dotm lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Text podpisy, které jsou umístěny v souborech Dotm"
description: "Odstraňte různé podpisy Text z dokumentů Dotm. Odstranění podpisů Text vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Text z vašeho dokumentu Dotm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Dotm dokumentů od Text podpisů pomocí několika řádků kódu.
