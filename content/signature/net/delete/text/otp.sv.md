...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Otp-filer via C#"
head_description: "Radering av specifika Text-signaturer från signerade Otp-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Otp-filer"
description: "Ta bort olika Text-signaturer från Otp-dokument. Att ta bort Text-signaturer kräver enkel C#-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Otp dokument från Text signaturer med några rader kod.
