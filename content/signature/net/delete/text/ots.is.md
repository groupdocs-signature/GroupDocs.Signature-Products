...
############################# Head ############################
head_title: "Eyða Text undirskriftum úr Ots skrám í gegnum C#"
head_description: "Auðvelt er að eyða tilteknum Text undirskriftum úr undirrituðum Ots skjölum með stuttum .NET kóða."

############################# Header ############################
title: "Fjarlægðu Text undirskriftir sem eru settar í Ots skrár"
description: "Eyða ýmsum Text undirskriftum úr Ots skjölum. Til að fjarlægja Text undirskrift þarf einfaldan C# kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að fjarlægja Text undirskriftir úr Ots skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) býður upp á gagnlegan eiginleika til að hreinsa Ots skjöl af Text undirskriftum með nokkrum línum af kóða.
