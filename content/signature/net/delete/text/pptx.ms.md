...
############################# Head ############################
head_title: "Padamkan tandatangan Text daripada fail Pptx melalui C#"
head_description: "Pemadaman tandatangan Text tertentu daripada dokumen Pptx yang ditandatangani mungkin dilakukan dengan mudah dengan kod .NET pendek."

############################# Header ############################
title: "Alih keluar tandatangan Text yang diletakkan dalam fail Pptx."
description: "Padamkan pelbagai tandatangan Text daripada dokumen Pptx. Mengalih keluar tandatangan Text memerlukan kod C# yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan ciri berguna untuk mengosongkan Pptx dokumen daripada Text tandatangan dengan beberapa baris kod.
