...
############################# Head ############################
head_title: "Delete Text signatures from Potm files via C#"
head_description: "Deletion of specific Text signatures from signed Potm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Text signatures which are placed in Potm files"
description: "Delete various Text signatures from Potm documents. Removing Text signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Text signatures from your Potm document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Potm documents of Text signatures with a few lines of code.
