...
############################# Head ############################
head_title: "Verwijder Text handtekeningen uit Pptm bestanden via C#"
head_description: "Het verwijderen van specifieke Text handtekeningen uit ondertekende Pptm documenten kan gemakkelijk worden uitgevoerd met korte .NET code."

############################# Header ############################
title: "Verwijder Text handtekeningen die in Pptm bestanden zijn geplaatst"
description: "Verwijder verschillende Text handtekeningen uit Pptm documenten. Voor het verwijderen van Text-handtekeningen is een eenvoudige C#-code vereist."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt een handige functie voor het wissen van Pptm documenten van Text handtekeningen met een paar regels code.
