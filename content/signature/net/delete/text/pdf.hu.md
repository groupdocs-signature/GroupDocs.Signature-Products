...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Pdf fájlokból a C# segítségével"
head_description: "Az aláírt Pdf dokumentumokból bizonyos Text aláírások törlése egyszerűen végrehajtható rövid .NET kóddal."

############################# Header ############################
title: "Távolítsa el a Text aláírásokat, amelyek a Pdf fájlokban vannak elhelyezve"
description: "Törölje a különböző Text aláírásokat a Pdf dokumentumokból. A Text aláírások eltávolításához egyszerű C# kód szükséges."
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Text aláírásokat a Pdf dokumentumból"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Pdf dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
