...
############################# Head ############################
head_title: "Slet Text signaturer fra Xlsx filer via C#"
head_description: "Sletning af specifikke Text-signaturer fra signerede Xlsx-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Text-signaturer, der er placeret i Xlsx-filer"
description: "Slet forskellige Text-signaturer fra Xlsx-dokumenter. Fjernelse af Text signaturer kræver simpel C# kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Text-signaturer fra dit Xlsx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Xlsx dokumenter for Text signaturer med et par linjer kode.
