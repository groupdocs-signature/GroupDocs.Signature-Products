...
############################# Head ############################
head_title: "Supprimez les signatures Text des fichiers Potm via C#"
head_description: "La suppression de signatures Text spécifiques à partir de documents Potm signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Text qui sont placées dans les fichiers Potm"
description: "Supprimez diverses signatures Text des documents Potm. La suppression des signatures Text nécessite un code C# simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Text de votre document Potm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Potm des signatures Text avec quelques lignes de code.
