...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Docx fájlokból a C# segítségével"
head_description: "Az aláírt Docx dokumentumokból bizonyos Text aláírások törlése egyszerűen végrehajtható rövid .NET kóddal."

############################# Header ############################
title: "Távolítsa el a Text aláírásokat, amelyek a Docx fájlokban vannak elhelyezve"
description: "Törölje a különböző Text aláírásokat a Docx dokumentumokból. A Text aláírások eltávolításához egyszerű C# kód szükséges."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Docx dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
