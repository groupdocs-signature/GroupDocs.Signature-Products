...
############################# Head ############################
head_title: "Odstraňte podpisy Text ze souborů Odt prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Text z podepsaných dokumentů Odt lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Text podpisy, které jsou umístěny v souborech Odt"
description: "Odstraňte různé podpisy Text z dokumentů Odt. Odstranění podpisů Text vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Text z vašeho dokumentu Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Odt dokumentů od Text podpisů pomocí několika řádků kódu.
