...
############################# Head ############################
head_title: "C# aracılığıyla Dotm dosyalarından Text imzasını silin"
head_description: "İmzalı Dotm belgelerindeki belirli Text imzalarının silinmesi kısa .NET koduyla kolayca gerçekleştirilebilir."

############################# Header ############################
title: "Dotm dosyalarına yerleştirilmiş Text imzalarını kaldırın"
description: "Dotm dokümanlarından çeşitli Text imzalarını silin. Text imzasını kaldırmak için basit C# kodu gerekir."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Dotm belgelerindeki Text imzalarını birkaç satır kodla temizlemek için kullanışlı bir özellik sağlar.
