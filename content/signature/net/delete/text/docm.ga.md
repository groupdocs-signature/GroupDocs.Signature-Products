...
############################# Head ############################
head_title: "Scrios Text sínithe ó chomhaid Docm trí C#"
head_description: "Seans go ndéanfaí scriosadh sínithe Text ar leith ó dhoiciméid shínithe Docm le cód gearr .NET."

############################# Header ############################
title: "Bain Text sínithe a chuirtear i gcomhaid Docm"
description: "Scrios Text sínithe éagsúla ó Docm doiciméid. Teastaíonn cód simplí C# chun sínithe Text a bhaint."
...
steps:
    enable: true
    title_left: "Conas Text sínithe a bhaint de do dhoiciméad Docm"
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gné úsáideach chun Docm doiciméad de Text sínithe a ghlanadh le cúpla líne de chód.
