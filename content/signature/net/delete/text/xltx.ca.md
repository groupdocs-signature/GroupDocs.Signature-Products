...
############################# Head ############################
head_title: "Suprimeix les signatures de Text dels fitxers Xltx mitjançant C#"
head_description: "L'eliminació de signatures específiques de Text dels documents signats Xltx es pot dur a terme fàcilment amb un codi .NET curt."

############################# Header ############################
title: "Elimineu les signatures de Text que es col·loquen als fitxers Xltx"
description: "Suprimeix diverses signatures de Text dels documents Xltx. L'eliminació de signatures Text requereix un codi C# senzill."
...
steps:
    enable: true
    title_left: "Com eliminar les signatures de Text del vostre document Xltx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix una funció útil per esborrar documents de Xltx de signatures de Text amb unes poques línies de codi.
