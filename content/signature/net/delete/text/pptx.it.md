...
############################# Head ############################
head_title: "Elimina le firme Text dai file Pptx tramite C#"
head_description: "L'eliminazione di firme Text specifiche da documenti Pptx firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Text che sono inserite nei file Pptx"
description: "Elimina varie firme Text da documenti Pptx. La rimozione delle firme Text richiede un semplice codice C#."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Text dal tuo documento Pptx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Pptx di firme Text con poche righe di codice.
