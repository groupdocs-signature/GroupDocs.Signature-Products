...
############################# Head ############################
head_title: "Izbriši Text potpise iz Potm datoteka putem C#"
head_description: "Brisanje specifičnih Text potpisa iz potpisanih Potm dokumenata može se lako izvesti s kratkim .NET kodom."

############################# Header ############################
title: "Uklonite potpise Text koji se nalaze u datotekama Potm"
description: "Izbrišite razne Text potpise iz Potm dokumenata. Uklanjanje Text potpisa zahtijeva jednostavan C# kod."
...
steps:
    enable: true
    title_left: "Kako ukloniti Text potpise iz vašeg Potm dokumenta"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža korisnu značajku za brisanje Potm dokumenata od Text potpisa s nekoliko redaka koda.
