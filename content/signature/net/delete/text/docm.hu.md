...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Docm fájlokból a C# segítségével"
head_description: "Az aláírt Docm dokumentumokból bizonyos Text aláírások törlése egyszerűen végrehajtható rövid .NET kóddal."

############################# Header ############################
title: "Távolítsa el a Text aláírásokat, amelyek a Docm fájlokban vannak elhelyezve"
description: "Törölje a különböző Text aláírásokat a Docm dokumentumokból. A Text aláírások eltávolításához egyszerű C# kód szükséges."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Docm dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
