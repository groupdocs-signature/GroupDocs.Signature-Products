...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Dotm failų naudodami C#"
head_description: "Konkrečius Text parašus iš pasirašytų Dotm dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Dotm failuose"
description: "Ištrinkite įvairius Text parašus iš Dotm dokumentų. Norint pašalinti Text parašus, reikia paprasto C# kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Dotm dokumento"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Dotm dokumentus nuo Text parašų naudojant kelias kodo eilutes.
