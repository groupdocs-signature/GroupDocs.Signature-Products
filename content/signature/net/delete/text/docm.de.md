...
############################# Head ############################
head_title: "Löschen Sie Text-Signaturen aus Docm-Dateien über C#"
head_description: "Das Löschen bestimmter Text-Signaturen aus signierten Docm-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Text-Signaturen, die in Docm-Dateien platziert sind"
description: "Löschen Sie verschiedene Text-Signaturen aus Docm-Dokumenten. Das Entfernen von Text-Signaturen erfordert einfachen C#-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Text-Signaturen aus Ihrem Docm-Dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Docm-Dokumenten von Text-Signaturen mit ein paar Codezeilen.
