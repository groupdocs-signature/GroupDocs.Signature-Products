...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Pptx läbi C#"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Pptx dokumentidest saab hõlpsasti teostada lühikese .NET koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Pptx"
description: "Kustutage erinevad allkirjad Text dokumentidest Pptx. Allkirjade Text eemaldamine nõuab lihtsat C# koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Text oma dokumendist Pptx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pakub kasulikku funktsiooni Pptx dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
