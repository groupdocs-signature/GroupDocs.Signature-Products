...
############################# Head ############################
head_title: "Delete Text signatures from Otp files in C#"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature of clearing Otp documents of Text signatures with a few lines of code.
