...
############################# Head ############################
head_title: "Verwijder Text handtekeningen uit Xls bestanden via C#"
head_description: "Het verwijderen van specifieke Text handtekeningen uit ondertekende Xls documenten kan gemakkelijk worden uitgevoerd met korte .NET code."

############################# Header ############################
title: "Verwijder Text handtekeningen die in Xls bestanden zijn geplaatst"
description: "Verwijder verschillende Text handtekeningen uit Xls documenten. Voor het verwijderen van Text-handtekeningen is een eenvoudige C#-code vereist."
...
steps:
    enable: true
    title_left: "Hoe Text handtekeningen te verwijderen uit uw Xls document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt een handige functie voor het wissen van Xls documenten van Text handtekeningen met een paar regels code.
