...
############################# Head ############################
head_title: "Delete Text signatures from Dotm files via C#"
head_description: "Deletion of specific Text signatures from signed Dotm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Text signatures which are placed in Dotm files"
description: "Delete various Text signatures from Dotm documents. Removing Text signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Text signatures from your Dotm document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Dotm documents of Text signatures with a few lines of code.
