...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Odp failų naudodami C#"
head_description: "Konkrečius Text parašus iš pasirašytų Odp dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Odp failuose"
description: "Ištrinkite įvairius Text parašus iš Odp dokumentų. Norint pašalinti Text parašus, reikia paprasto C# kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Odp dokumentus nuo Text parašų naudojant kelias kodo eilutes.
