...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Otp läbi C#"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Otp dokumentidest saab hõlpsasti teostada lühikese .NET koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Otp"
description: "Kustutage erinevad allkirjad Text dokumentidest Otp. Allkirjade Text eemaldamine nõuab lihtsat C# koodi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pakub kasulikku funktsiooni Otp dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
