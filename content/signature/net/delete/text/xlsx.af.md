...
############################# Head ############################
head_title: "Vee Text handtekeninge van Xlsx lêers uit via C#"
head_description: "Die uitvee van spesifieke Text handtekeninge van getekende Xlsx dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Text handtekeninge wat in Xlsx lêers geplaas is"
description: "Vee verskeie Text handtekeninge uit Xlsx dokumente uit. Die verwydering van Text handtekeninge vereis eenvoudige C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Xlsx dokumente van Text handtekeninge met 'n paar reëls kode.
