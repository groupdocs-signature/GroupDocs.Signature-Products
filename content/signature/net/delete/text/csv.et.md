...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Csv läbi C#"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Csv dokumentidest saab hõlpsasti teostada lühikese .NET koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Csv"
description: "Kustutage erinevad allkirjad Text dokumentidest Csv. Allkirjade Text eemaldamine nõuab lihtsat C# koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Text oma dokumendist Csv"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pakub kasulikku funktsiooni Csv dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
