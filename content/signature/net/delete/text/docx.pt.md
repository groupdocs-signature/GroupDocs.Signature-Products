...
############################# Head ############################
head_title: "Excluir assinaturas Text de arquivos Docx via C#"
head_description: "A exclusão de assinaturas Text específicas de documentos Docx assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Text que são colocadas em arquivos Docx"
description: "Exclua várias assinaturas Text de documentos Docx. A remoção de assinaturas Text requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Text do seu documento Docx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Docx de assinaturas Text com algumas linhas de código.
