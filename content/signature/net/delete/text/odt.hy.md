...
############################# Head ############################
head_title: "Ջնջել Text ստորագրությունները Odt ֆայլերից C#-ի միջոցով"
head_description: "Ստորագրված Odt փաստաթղթերից որոշակի Text ստորագրությունների ջնջումը կարող է հեշտությամբ իրականացվել կարճ .NET կոդով:"

############################# Header ############################
title: "Հեռացրեք Text ստորագրությունները, որոնք տեղադրված են Odt ֆայլերում"
description: "Ջնջել տարբեր Text ստորագրությունները Odt փաստաթղթերից: Text ստորագրությունները հեռացնելու համար անհրաժեշտ է պարզ C# կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես հեռացնել Text ստորագրությունները ձեր Odt փաստաթղթից"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) օգտակար հատկություն է տրամադրում Odt փաստաթղթերը Text ստորագրություններից մի քանի տող կոդով մաքրելու համար:
