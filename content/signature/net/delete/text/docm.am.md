...
############################# Header ############################
title: "በDocm ፋይሎች ውስጥ የተቀመጡትን የText ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የText ፊርማዎችን ከDocm ሰነዶች ሰርዝ። የText ፊርማዎችን ማስወገድ ቀላል የC# ኮድ ያስፈልገዋል።"
...
steps:
    enable: true
    title_left: "Text ፊርማዎችን ከDocm ሰነድዎ እንዴት ማስወገድ እንደሚቻል"
    content_left: |
...
more_formats:
    enable: true
    title: "የእርስዎን Text ፊርማዎች በC# ይሰርዙ"
    content: |
