...
############################# Header ############################
title: "በOds ፋይሎች ውስጥ የተቀመጡትን የText ፊርማዎችን ያስወግዱ"
description: "የተለያዩ የText ፊርማዎችን ከOds ሰነዶች ሰርዝ። የText ፊርማዎችን ማስወገድ ቀላል የC# ኮድ ያስፈልገዋል።"
...
steps:
    enable: true
    title_left: "Text ፊርማዎችን ከOds ሰነድዎ እንዴት ማስወገድ እንደሚቻል"
    content_left: |
