...
############################# Head ############################
head_title: "C# aracılığıyla Xls dosyalarından Text imzasını silin"
head_description: "İmzalı Xls belgelerindeki belirli Text imzalarının silinmesi kısa .NET koduyla kolayca gerçekleştirilebilir."

############################# Header ############################
title: "Xls dosyalarına yerleştirilmiş Text imzalarını kaldırın"
description: "Xls dokümanlarından çeşitli Text imzalarını silin. Text imzasını kaldırmak için basit C# kodu gerekir."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Xls belgelerindeki Text imzalarını birkaç satır kodla temizlemek için kullanışlı bir özellik sağlar.
