...
############################# Head ############################
head_title: "通过 C# 从 Rtf 文件中删除 Text 签名"
head_description: "使用简短的 .NET 代码可以轻松地从已签名的 Rtf 文档中删除特定的 Text 签名。"

############################# Header ############################
title: "删除放置在 Rtf 文件中的 Text 签名"
description: "从 Rtf 文档中删除各种 Text 签名。删除 Text 签名需要简单的 C# 代码。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) 提供了有用的功能，可通过几行代码清除 Text 签名的 Rtf 文档。
