...
############################# Head ############################
head_title: "Kustutage Text allkirjad failist Doc läbi C#"
head_description: "Konkreetsete Text allkirjade kustutamine allkirjastatud Doc dokumentidest saab hõlpsasti teostada lühikese .NET koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Text, mis on paigutatud failidesse Doc"
description: "Kustutage erinevad allkirjad Text dokumentidest Doc. Allkirjade Text eemaldamine nõuab lihtsat C# koodi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pakub kasulikku funktsiooni Doc dokumentide Text allkirjade eemaldamiseks mõne koodireaga.
