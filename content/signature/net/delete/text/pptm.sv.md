...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Pptm-filer via C#"
head_description: "Radering av specifika Text-signaturer från signerade Pptm-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Pptm-filer"
description: "Ta bort olika Text-signaturer från Pptm-dokument. Att ta bort Text-signaturer kräver enkel C#-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Text-signaturer från ditt Pptm-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Pptm dokument från Text signaturer med några rader kod.
