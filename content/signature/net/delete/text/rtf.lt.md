...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Rtf failų naudodami C#"
head_description: "Konkrečius Text parašus iš pasirašytų Rtf dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Rtf failuose"
description: "Ištrinkite įvairius Text parašus iš Rtf dokumentų. Norint pašalinti Text parašus, reikia paprasto C# kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Rtf dokumento"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Rtf dokumentus nuo Text parašų naudojant kelias kodo eilutes.
