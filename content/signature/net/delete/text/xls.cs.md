...
############################# Head ############################
head_title: "Odstraňte podpisy Text ze souborů Xls prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Text z podepsaných dokumentů Xls lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Text podpisy, které jsou umístěny v souborech Xls"
description: "Odstraňte různé podpisy Text z dokumentů Xls. Odstranění podpisů Text vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Text z vašeho dokumentu Xls"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Xls dokumentů od Text podpisů pomocí několika řádků kódu.
