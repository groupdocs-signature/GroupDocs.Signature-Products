...
############################# Head ############################
head_title: "Suprimeix les signatures de Text dels fitxers Ppt mitjançant C#"
head_description: "L'eliminació de signatures específiques de Text dels documents signats Ppt es pot dur a terme fàcilment amb un codi .NET curt."

############################# Header ############################
title: "Elimineu les signatures de Text que es col·loquen als fitxers Ppt"
description: "Suprimeix diverses signatures de Text dels documents Ppt. L'eliminació de signatures Text requereix un codi C# senzill."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix una funció útil per esborrar documents de Ppt de signatures de Text amb unes poques línies de codi.
