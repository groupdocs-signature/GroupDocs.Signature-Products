...
############################# Head ############################
head_title: "Usuń podpisy Text z plików Ods przez C#"
head_description: "Usuwanie określonych podpisów Text z podpisanych dokumentów Ods można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Text podpisy umieszczone w plikach Ods"
description: "Usuń różne podpisy Text z dokumentów Ods. Usunięcie podpisów Text wymaga prostego kodu C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Ods z podpisami Text za pomocą kilku linijek kodu.
