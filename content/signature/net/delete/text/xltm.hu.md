...
############################# Head ############################
head_title: "Törölje a Text aláírásokat a Xltm fájlokból a C# segítségével"
head_description: "Az aláírt Xltm dokumentumokból bizonyos Text aláírások törlése egyszerűen végrehajtható rövid .NET kóddal."

############################# Header ############################
title: "Távolítsa el a Text aláírásokat, amelyek a Xltm fájlokban vannak elhelyezve"
description: "Törölje a különböző Text aláírásokat a Xltm dokumentumokból. A Text aláírások eltávolításához egyszerű C# kód szükséges."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Xltm dokumentumok Text aláírásainak néhány soros kóddal történő törléséhez.
