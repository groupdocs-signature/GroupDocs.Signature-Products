...
############################# Head ############################
head_title: "Odstraňte podpisy Text ze souborů Doc prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Text z podepsaných dokumentů Doc lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Text podpisy, které jsou umístěny v souborech Doc"
description: "Odstraňte různé podpisy Text z dokumentů Doc. Odstranění podpisů Text vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Text z vašeho dokumentu Doc"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Doc dokumentů od Text podpisů pomocí několika řádků kódu.
