...
############################# Head ############################
head_title: "Elimina le firme Text dai file Ods tramite C#"
head_description: "L'eliminazione di firme Text specifiche da documenti Ods firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Text che sono inserite nei file Ods"
description: "Elimina varie firme Text da documenti Ods. La rimozione delle firme Text richiede un semplice codice C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Ods di firme Text con poche righe di codice.
