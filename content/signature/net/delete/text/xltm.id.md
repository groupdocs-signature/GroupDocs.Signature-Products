...
############################# Head ############################
head_title: "Hapus tanda tangan Text dari file Xltm melalui C#"
head_description: "Penghapusan tanda tangan Text tertentu dari dokumen Xltm yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Text yang ditempatkan di file Xltm"
description: "Hapus berbagai tanda tangan Text dari dokumen Xltm. Menghapus tanda tangan Text memerlukan kode C# sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Text dari dokumen Xltm Anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Xltm dari Text tanda tangan dengan beberapa baris kode.
