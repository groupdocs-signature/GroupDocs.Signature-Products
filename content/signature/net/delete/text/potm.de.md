...
############################# Head ############################
head_title: "Löschen Sie Text-Signaturen aus Potm-Dateien über C#"
head_description: "Das Löschen bestimmter Text-Signaturen aus signierten Potm-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Text-Signaturen, die in Potm-Dateien platziert sind"
description: "Löschen Sie verschiedene Text-Signaturen aus Potm-Dokumenten. Das Entfernen von Text-Signaturen erfordert einfachen C#-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Potm-Dokumenten von Text-Signaturen mit ein paar Codezeilen.
