...
############################# Head ############################
head_title: "Ištrinkite Text parašus iš Potx failų naudodami C#"
head_description: "Konkrečius Text parašus iš pasirašytų Potx dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Text parašus, kurie yra Potx failuose"
description: "Ištrinkite įvairius Text parašus iš Potx dokumentų. Norint pašalinti Text parašus, reikia paprasto C# kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Text parašus iš Potx dokumento"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Potx dokumentus nuo Text parašų naudojant kelias kodo eilutes.
