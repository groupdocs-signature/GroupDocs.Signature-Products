...
############################# Head ############################
head_title: "Elimina le firme Text dai file Ott tramite C#"
head_description: "L'eliminazione di firme Text specifiche da documenti Ott firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Text che sono inserite nei file Ott"
description: "Elimina varie firme Text da documenti Ott. La rimozione delle firme Text richiede un semplice codice C#."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Text dal tuo documento Ott"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Ott di firme Text con poche righe di codice.
