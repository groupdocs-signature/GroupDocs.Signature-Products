...
############################# Head ############################
head_title: "Löschen Sie Text-Signaturen aus Docx-Dateien über C#"
head_description: "Das Löschen bestimmter Text-Signaturen aus signierten Docx-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Text-Signaturen, die in Docx-Dateien platziert sind"
description: "Löschen Sie verschiedene Text-Signaturen aus Docx-Dokumenten. Das Entfernen von Text-Signaturen erfordert einfachen C#-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Text-Signaturen aus Ihrem Docx-Dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Docx-Dokumenten von Text-Signaturen mit ein paar Codezeilen.
