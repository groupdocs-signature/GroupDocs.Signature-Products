...
head_description: "Die uitvee van spesifieke Text handtekeninge van getekende Xls dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Text handtekeninge wat in Xls lêers geplaas is"
description: "Vee verskeie Text handtekeninge uit Xls dokumente uit. Die verwydering van Text handtekeninge vereis eenvoudige C# kode."
...
steps:
    enable: true
    title_left: "Hoe om Text-handtekeninge uit jou Xls-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Xls dokumente van Text handtekeninge met 'n paar reëls kode.
