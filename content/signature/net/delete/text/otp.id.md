...
############################# Head ############################
head_title: "Hapus tanda tangan Text dari file Otp melalui C#"
head_description: "Penghapusan tanda tangan Text tertentu dari dokumen Otp yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Text yang ditempatkan di file Otp"
description: "Hapus berbagai tanda tangan Text dari dokumen Otp. Menghapus tanda tangan Text memerlukan kode C# sederhana."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Otp dari Text tanda tangan dengan beberapa baris kode.
