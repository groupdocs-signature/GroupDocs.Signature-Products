...
############################# Head ############################
head_title: "Slett Text-signaturer fra Docm-filer via C#"
head_description: "Sletting av spesifikke Text-signaturer fra signerte Docm-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Text-signaturer som er plassert i Docm-filer"
description: "Slett forskjellige Text-signaturer fra Docm-dokumenter. Fjerning av Text-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Docm dokumenter for Text signaturer med noen få linjer med kode.
