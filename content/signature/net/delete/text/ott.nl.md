...
############################# Head ############################
head_title: "Verwijder Text handtekeningen uit Ott bestanden via C#"
head_description: "Het verwijderen van specifieke Text handtekeningen uit ondertekende Ott documenten kan gemakkelijk worden uitgevoerd met korte .NET code."

############################# Header ############################
title: "Verwijder Text handtekeningen die in Ott bestanden zijn geplaatst"
description: "Verwijder verschillende Text handtekeningen uit Ott documenten. Voor het verwijderen van Text-handtekeningen is een eenvoudige C#-code vereist."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt een handige functie voor het wissen van Ott documenten van Text handtekeningen met een paar regels code.
