...
############################# Head ############################
head_title: "Vee Text handtekeninge van Pptm lêers uit via C#"
head_description: "Die uitvee van spesifieke Text handtekeninge van getekende Pptm dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Text handtekeninge wat in Pptm lêers geplaas is"
description: "Vee verskeie Text handtekeninge uit Pptm dokumente uit. Die verwydering van Text handtekeninge vereis eenvoudige C# kode."
...
steps:
    enable: true
    title_left: "Hoe om Text-handtekeninge uit jou Pptm-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Pptm dokumente van Text handtekeninge met 'n paar reëls kode.
