...
############################# Head ############################
head_title: "Elimina le firme Text dai file Docm tramite C#"
head_description: "L'eliminazione di firme Text specifiche da documenti Docm firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Text che sono inserite nei file Docm"
description: "Elimina varie firme Text da documenti Docm. La rimozione delle firme Text richiede un semplice codice C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Docm di firme Text con poche righe di codice.
