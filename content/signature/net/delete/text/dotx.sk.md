...
############################# Head ############################
head_title: "Odstrániť Text podpisy zo súborov Dotx cez C#"
head_description: "Odstránenie špecifických podpisov Text z podpísaných dokumentov Dotx možno jednoducho vykonať pomocou krátkeho kódu .NET."

############################# Header ############################
title: "Odstráňte Text podpisy, ktoré sú umiestnené v súboroch Dotx"
description: "Odstráňte rôzne podpisy Text z dokumentov Dotx. Odstránenie podpisov Text vyžaduje jednoduchý kód C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitočnú funkciu na vymazanie Dotx dokumentov od Text podpisov pomocou niekoľkých riadkov kódu.
