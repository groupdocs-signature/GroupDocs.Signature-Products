...
############################# Head ############################
head_title: "Usuń podpisy Text z plików Rtf przez C#"
head_description: "Usuwanie określonych podpisów Text z podpisanych dokumentów Rtf można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Text podpisy umieszczone w plikach Rtf"
description: "Usuń różne podpisy Text z dokumentów Rtf. Usunięcie podpisów Text wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Text z dokumentu Rtf?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Rtf z podpisami Text za pomocą kilku linijek kodu.
