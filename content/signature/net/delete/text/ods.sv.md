...
############################# Head ############################
head_title: "Ta bort Text-signaturer från Ods-filer via C#"
head_description: "Radering av specifika Text-signaturer från signerade Ods-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Text-signaturer som är placerade i Ods-filer"
description: "Ta bort olika Text-signaturer från Ods-dokument. Att ta bort Text-signaturer kräver enkel C#-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Text-signaturer från ditt Ods-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Ods dokument från Text signaturer med några rader kod.
