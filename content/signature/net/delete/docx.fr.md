...
############################# Head ############################
head_title: "Supprimer des signatures de DOCX en utilisant C#"
head_description: "La suppression de signatures numériques, de codes-barres, de texte, d'images et de métadonnées à partir de documents DOCX signés peut être effectuée en utilisant GroupDocs.Signature for .NET."

############################# Header ############################
title: "Supprimer les signatures de DOCX efficacement" 
...
steps:
    enable: true
    title: "Comment supprimer des signatures électroniques de DOCX en utilisant C#"
    content: |
      [GroupDocs.Signature](/signature/net/) simplifie la tâche pour les développeurs .NET de supprimer les signatures électroniques dans les fichiers DOCX en mettant en œuvre quelques étapes simples.
