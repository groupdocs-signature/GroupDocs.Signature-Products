...
############################# Head ############################
head_title: "Slett Image-signaturer fra Docx-filer via C#"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Docx-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Docx-filer"
description: "Slett forskjellige Image-signaturer fra Docx-dokumenter. Fjerning av Image-signaturer krever enkel C#-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Image-signaturer fra Docx-dokumentet"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Docx dokumenter for Image signaturer med noen få linjer med kode.
