...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Dotx via C#"
head_description: "A exclusão de assinaturas Image específicas de documentos Dotx assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Dotx"
description: "Exclua várias assinaturas Image de documentos Dotx. A remoção de assinaturas Image requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Image do seu documento Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Dotx de assinaturas Image com algumas linhas de código.
