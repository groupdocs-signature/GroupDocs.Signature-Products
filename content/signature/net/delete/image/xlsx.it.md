...
############################# Head ############################
head_title: "Elimina le firme Image dai file Xlsx tramite C#"
head_description: "L'eliminazione di firme Image specifiche da documenti Xlsx firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Image che sono inserite nei file Xlsx"
description: "Elimina varie firme Image da documenti Xlsx. La rimozione delle firme Image richiede un semplice codice C#."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Image dal tuo documento Xlsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Xlsx di firme Image con poche righe di codice.
