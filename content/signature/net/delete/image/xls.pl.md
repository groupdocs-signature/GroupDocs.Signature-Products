...
############################# Head ############################
head_title: "Usuń podpisy Image z plików Xls przez C#"
head_description: "Usuwanie określonych podpisów Image z podpisanych dokumentów Xls można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Image podpisy umieszczone w plikach Xls"
description: "Usuń różne podpisy Image z dokumentów Xls. Usunięcie podpisów Image wymaga prostego kodu C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Xls z podpisami Image za pomocą kilku linijek kodu.
