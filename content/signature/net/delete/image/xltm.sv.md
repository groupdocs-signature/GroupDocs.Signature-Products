...
############################# Head ############################
head_title: "Ta bort Image-signaturer från Xltm-filer via C#"
head_description: "Radering av specifika Image-signaturer från signerade Xltm-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Image-signaturer som är placerade i Xltm-filer"
description: "Ta bort olika Image-signaturer från Xltm-dokument. Att ta bort Image-signaturer kräver enkel C#-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Xltm dokument från Image signaturer med några rader kod.
