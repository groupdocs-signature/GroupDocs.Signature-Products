...
############################# Head ############################
head_title: "Delete Image signatures from Otp files via C#"
head_description: "Deletion of specific Image signatures from signed Otp documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Image signatures which are placed in Otp files"
description: "Delete various Image signatures from Otp documents. Removing Image signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Image signatures from your Otp document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Otp documents of Image signatures with a few lines of code.
