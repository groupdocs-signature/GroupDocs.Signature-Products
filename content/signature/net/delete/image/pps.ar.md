...
############################# Head ############################
head_title: "احذف توقيعات Image من ملفات Pps عبر C#"
head_description: "يمكن إجراء حذف توقيعات معينة من Image من مستندات Pps الموقعة بسهولة باستخدام رمز .NET القصير."

############################# Header ############################
title: "قم بإزالة Image التوقيعات التي يتم وضعها في ملفات Pps"
description: "احذف العديد من توقيعات Image من مستندات Pps. تتطلب إزالة توقيعات Image شفرة C# بسيطة."
...
steps:
    enable: true
    title_left: "كيفية إزالة توقيعات Image من مستندك Pps"
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) ميزة مفيدة لمسح Pps مستندات توقيعات Image ببضعة أسطر من التعليمات البرمجية.
