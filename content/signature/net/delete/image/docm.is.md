...
############################# Head ############################
head_title: "Eyða Image undirskriftum úr Docm skrám í gegnum C#"
head_description: "Auðvelt er að eyða tilteknum Image undirskriftum úr undirrituðum Docm skjölum með stuttum .NET kóða."

############################# Header ############################
title: "Fjarlægðu Image undirskriftir sem eru settar í Docm skrár"
description: "Eyða ýmsum Image undirskriftum úr Docm skjölum. Til að fjarlægja Image undirskrift þarf einfaldan C# kóða."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) býður upp á gagnlegan eiginleika til að hreinsa Docm skjöl af Image undirskriftum með nokkrum línum af kóða.
