...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Xltx failų naudodami C#"
head_description: "Konkrečius Image parašus iš pasirašytų Xltx dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Xltx failuose"
description: "Ištrinkite įvairius Image parašus iš Xltx dokumentų. Norint pašalinti Image parašus, reikia paprasto C# kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Xltx dokumentus nuo Image parašų naudojant kelias kodo eilutes.
