...
############################# Head ############################
head_title: "Dzēst Image parakstus no Ott failiem, izmantojot C#"
head_description: "Konkrētu Image parakstu dzēšanu no parakstītiem Ott dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Image parakstus, kas ir ievietoti Ott failos"
description: "Izdzēsiet dažādus Image parakstus no Ott dokumentiem. Lai noņemtu Image parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Ott dokumentiem notīrītu Image parakstus, izmantojot dažas koda rindiņas.
