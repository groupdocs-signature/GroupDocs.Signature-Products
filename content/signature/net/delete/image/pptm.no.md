...
############################# Head ############################
head_title: "Slett Image-signaturer fra Pptm-filer via C#"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Pptm-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Pptm-filer"
description: "Slett forskjellige Image-signaturer fra Pptm-dokumenter. Fjerning av Image-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Pptm dokumenter for Image signaturer med noen få linjer med kode.
