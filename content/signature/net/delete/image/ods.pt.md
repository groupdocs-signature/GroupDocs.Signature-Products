...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Ods via C#"
head_description: "A exclusão de assinaturas Image específicas de documentos Ods assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Ods"
description: "Exclua várias assinaturas Image de documentos Ods. A remoção de assinaturas Image requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Image do seu documento Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Ods de assinaturas Image com algumas linhas de código.
