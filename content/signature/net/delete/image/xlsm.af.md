...
head_description: "Die uitvee van spesifieke Image handtekeninge van getekende Xlsm dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Image handtekeninge wat in Xlsm lêers geplaas is"
description: "Vee verskeie Image handtekeninge uit Xlsm dokumente uit. Die verwydering van Image handtekeninge vereis eenvoudige C# kode."
...
steps:
    enable: true
    title_left: "Hoe om Image-handtekeninge uit jou Xlsm-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Xlsm dokumente van Image handtekeninge met 'n paar reëls kode.
