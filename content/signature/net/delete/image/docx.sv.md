...
############################# Head ############################
head_title: "Ta bort Image-signaturer från Docx-filer via C#"
head_description: "Radering av specifika Image-signaturer från signerade Docx-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Image-signaturer som är placerade i Docx-filer"
description: "Ta bort olika Image-signaturer från Docx-dokument. Att ta bort Image-signaturer kräver enkel C#-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Docx dokument från Image signaturer med några rader kod.
