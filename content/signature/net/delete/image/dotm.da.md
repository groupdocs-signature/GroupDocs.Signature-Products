...
############################# Head ############################
head_title: "Slet Image signaturer fra Dotm filer via C#"
head_description: "Sletning af specifikke Image-signaturer fra signerede Dotm-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer, der er placeret i Dotm-filer"
description: "Slet forskellige Image-signaturer fra Dotm-dokumenter. Fjernelse af Image signaturer kræver simpel C# kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Image-signaturer fra dit Dotm-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Dotm dokumenter for Image signaturer med et par linjer kode.
...
more_formats:
    enable: true
    title: "Slet dine Image-signaturer med C#"
    content: |
