...
############################# Head ############################
head_title: "Ջնջել Image ստորագրությունները Doc ֆայլերից C#-ի միջոցով"
head_description: "Ստորագրված Doc փաստաթղթերից որոշակի Image ստորագրությունների ջնջումը կարող է հեշտությամբ իրականացվել կարճ .NET կոդով:"

############################# Header ############################
title: "Հեռացրեք Image ստորագրությունները, որոնք տեղադրված են Doc ֆայլերում"
description: "Ջնջել տարբեր Image ստորագրությունները Doc փաստաթղթերից: Image ստորագրությունները հեռացնելու համար անհրաժեշտ է պարզ C# կոդ:"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) օգտակար հատկություն է տրամադրում Doc փաստաթղթերը Image ստորագրություններից մի քանի տող կոդով մաքրելու համար:
