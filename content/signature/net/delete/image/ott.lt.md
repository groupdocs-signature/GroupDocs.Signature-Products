...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Ott failų naudodami C#"
head_description: "Konkrečius Image parašus iš pasirašytų Ott dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Ott failuose"
description: "Ištrinkite įvairius Image parašus iš Ott dokumentų. Norint pašalinti Image parašus, reikia paprasto C# kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Ott dokumentus nuo Image parašų naudojant kelias kodo eilutes.
