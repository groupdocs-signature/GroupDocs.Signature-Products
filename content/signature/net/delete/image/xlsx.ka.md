...
############################# Head ############################
head_title: "წაშალეთ Image ხელმოწერა Xlsx ფაილებიდან C#-ით"
head_description: "კონკრეტული Image ხელმოწერების წაშლა ხელმოწერილი Xlsx დოკუმენტებიდან შეიძლება მარტივად განხორციელდეს მოკლე .NET კოდით."

############################# Header ############################
title: "წაშალეთ Image ხელმოწერები, რომლებიც განთავსებულია Xlsx ფაილში"
description: "წაშალეთ სხვადასხვა Image ხელმოწერა Xlsx დოკუმენტებიდან. Image ხელმოწერის ამოღებას სჭირდება მარტივი C# კოდი."
...
steps:
    enable: true
    title_left: "როგორ ამოიღოთ Image ხელმოწერა თქვენი Xlsx დოკუმენტიდან"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) გთავაზობთ სასარგებლო ფუნქციას Xlsx დოკუმენტების Image ხელმოწერების გასასუფთავებლად რამდენიმე სტრიქონის კოდით.
