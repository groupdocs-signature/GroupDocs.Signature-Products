...
############################# Head ############################
head_title: "Slett Image-signaturer fra Csv-filer via C#"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Csv-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Csv-filer"
description: "Slett forskjellige Image-signaturer fra Csv-dokumenter. Fjerning av Image-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Csv dokumenter for Image signaturer med noen få linjer med kode.
