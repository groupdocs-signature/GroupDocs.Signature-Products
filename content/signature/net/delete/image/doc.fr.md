...
############################# Head ############################
head_title: "Supprimez les signatures Image des fichiers Doc via C#"
head_description: "La suppression de signatures Image spécifiques à partir de documents Doc signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Image qui sont placées dans les fichiers Doc"
description: "Supprimez diverses signatures Image des documents Doc. La suppression des signatures Image nécessite un code C# simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Image de votre document Doc"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Doc des signatures Image avec quelques lignes de code.
