...
############################# Head ############################
head_title: "Padamkan tandatangan Image daripada fail Docm melalui C#"
head_description: "Pemadaman tandatangan Image tertentu daripada dokumen Docm yang ditandatangani mungkin dilakukan dengan mudah dengan kod .NET pendek."

############################# Header ############################
title: "Alih keluar tandatangan Image yang diletakkan dalam fail Docm."
description: "Padamkan pelbagai tandatangan Image daripada dokumen Docm. Mengalih keluar tandatangan Image memerlukan kod C# yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan ciri berguna untuk mengosongkan Docm dokumen daripada Image tandatangan dengan beberapa baris kod.
