...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Ots failų naudodami C#"
head_description: "Konkrečius Image parašus iš pasirašytų Ots dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Ots failuose"
description: "Ištrinkite įvairius Image parašus iš Ots dokumentų. Norint pašalinti Image parašus, reikia paprasto C# kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Ots dokumento"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Ots dokumentus nuo Image parašų naudojant kelias kodo eilutes.
