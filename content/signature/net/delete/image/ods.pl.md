...
############################# Head ############################
head_title: "Usuń podpisy Image z plików Ods przez C#"
head_description: "Usuwanie określonych podpisów Image z podpisanych dokumentów Ods można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Image podpisy umieszczone w plikach Ods"
description: "Usuń różne podpisy Image z dokumentów Ods. Usunięcie podpisów Image wymaga prostego kodu C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Ods z podpisami Image za pomocą kilku linijek kodu.
