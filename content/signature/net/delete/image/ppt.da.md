...
############################# Head ############################
head_title: "Slet Image signaturer fra Ppt filer via C#"
head_description: "Sletning af specifikke Image-signaturer fra signerede Ppt-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer, der er placeret i Ppt-filer"
description: "Slet forskellige Image-signaturer fra Ppt-dokumenter. Fjernelse af Image signaturer kræver simpel C# kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Image-signaturer fra dit Ppt-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Ppt dokumenter for Image signaturer med et par linjer kode.
