...
############################# Head ############################
head_title: "Ta bort Image-signaturer från Potm-filer via C#"
head_description: "Radering av specifika Image-signaturer från signerade Potm-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Image-signaturer som är placerade i Potm-filer"
description: "Ta bort olika Image-signaturer från Potm-dokument. Att ta bort Image-signaturer kräver enkel C#-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Image-signaturer från ditt Potm-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Potm dokument från Image signaturer med några rader kod.
