...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Xlsb via C#"
head_description: "A exclusão de assinaturas Image específicas de documentos Xlsb assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Xlsb"
description: "Exclua várias assinaturas Image de documentos Xlsb. A remoção de assinaturas Image requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Xlsb de assinaturas Image com algumas linhas de código.
