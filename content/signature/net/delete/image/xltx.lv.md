...
############################# Head ############################
head_title: "Dzēst Image parakstus no Xltx failiem, izmantojot C#"
head_description: "Konkrētu Image parakstu dzēšanu no parakstītiem Xltx dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Image parakstus, kas ir ievietoti Xltx failos"
description: "Izdzēsiet dažādus Image parakstus no Xltx dokumentiem. Lai noņemtu Image parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Xltx dokumentiem notīrītu Image parakstus, izmantojot dažas koda rindiņas.
