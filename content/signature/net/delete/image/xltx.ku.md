...
############################# Head ############################
head_title: "Bi rêya C# îmzeyên Image ji pelên Xltx jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Image ji belgeyên îmzekirî yên Xltx dibe ku bi koda kurt a .NET bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Image yên ku di pelên Xltx de cih digirin rakin"
description: "Ji belgeyên Xltx îmzeyên cihêreng ên Image jêbirin. Ji rakirina îmzeyên Image koda C# ya sade hewce dike."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji bo paqijkirina Xltx belgeyên Image bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
