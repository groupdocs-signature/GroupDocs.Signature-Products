...
############################# Head ############################
head_title: "Ištrinkite Image parašus iš Odp failų naudodami C#"
head_description: "Konkrečius Image parašus iš pasirašytų Odp dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Image parašus, kurie yra Odp failuose"
description: "Ištrinkite įvairius Image parašus iš Odp dokumentų. Norint pašalinti Image parašus, reikia paprasto C# kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Image parašus iš Odp dokumento"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Odp dokumentus nuo Image parašų naudojant kelias kodo eilutes.
