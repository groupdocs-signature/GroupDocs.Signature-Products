...
############################# Head ############################
head_title: "Delete Image signatures from Ods files via C#"
head_description: "Deletion of specific Image signatures from signed Ods documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Image signatures which are placed in Ods files"
description: "Delete various Image signatures from Ods documents. Removing Image signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Image signatures from your Ods document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Ods documents of Image signatures with a few lines of code.
