...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Docx via C#"
head_description: "A exclusão de assinaturas Image específicas de documentos Docx assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Docx"
description: "Exclua várias assinaturas Image de documentos Docx. A remoção de assinaturas Image requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Docx de assinaturas Image com algumas linhas de código.
