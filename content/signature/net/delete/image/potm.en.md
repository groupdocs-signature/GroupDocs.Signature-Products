...
############################# Head ############################
head_title: "Delete Image signatures from Potm files via C#"
head_description: "Deletion of specific Image signatures from signed Potm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Image signatures which are placed in Potm files"
description: "Delete various Image signatures from Potm documents. Removing Image signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Image signatures from your Potm document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Potm documents of Image signatures with a few lines of code.
