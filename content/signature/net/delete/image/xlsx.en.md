...
############################# Head ############################
head_title: "Delete Image signatures from Xlsx files via C#"
head_description: "Deletion of specific Image signatures from signed Xlsx documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Image signatures which are placed in Xlsx files"
description: "Delete various Image signatures from Xlsx documents. Removing Image signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Xlsx documents of Image signatures with a few lines of code.
