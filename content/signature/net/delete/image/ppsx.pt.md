...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Ppsx via C#"
head_description: "A exclusão de assinaturas Image específicas de documentos Ppsx assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Ppsx"
description: "Exclua várias assinaturas Image de documentos Ppsx. A remoção de assinaturas Image requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Image do seu documento Ppsx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Ppsx de assinaturas Image com algumas linhas de código.
