...
############################# Head ############################
head_title: "Изтрийте Image подписи от Ots файлове чрез C#"
head_description: "Изтриването на конкретни Image подписи от подписани Ots документи може да се извърши лесно с кратък .NET код."

############################# Header ############################
title: "Премахнете Image подписи, които са поставени във Ots файлове"
description: "Изтрийте различни подписи Image от Ots документи. Премахването на подписи Image изисква прост код C#."
...
steps:
    enable: true
    title_left: "Как да премахнете подписи Image от вашия Ots документ"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя полезна функция за изчистване на Ots документи от Image подписи с няколко реда код.
