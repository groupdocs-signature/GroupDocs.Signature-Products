...
############################# Head ############################
head_title: "Ta bort Image-signaturer från Xls-filer via C#"
head_description: "Radering av specifika Image-signaturer från signerade Xls-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Image-signaturer som är placerade i Xls-filer"
description: "Ta bort olika Image-signaturer från Xls-dokument. Att ta bort Image-signaturer kräver enkel C#-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Xls dokument från Image signaturer med några rader kod.
