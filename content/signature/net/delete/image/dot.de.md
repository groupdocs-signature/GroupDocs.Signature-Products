...
############################# Head ############################
head_title: "Löschen Sie Image-Signaturen aus Dot-Dateien über C#"
head_description: "Das Löschen bestimmter Image-Signaturen aus signierten Dot-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Image-Signaturen, die in Dot-Dateien platziert sind"
description: "Löschen Sie verschiedene Image-Signaturen aus Dot-Dokumenten. Das Entfernen von Image-Signaturen erfordert einfachen C#-Code."
...
steps:
    enable: true
    title_left: "So entfernen Sie Image-Signaturen aus Ihrem Dot-Dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Dot-Dokumenten von Image-Signaturen mit ein paar Codezeilen.
