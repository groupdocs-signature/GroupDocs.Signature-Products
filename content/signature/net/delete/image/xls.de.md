...
############################# Head ############################
head_title: "Löschen Sie Image-Signaturen aus Xls-Dateien über C#"
head_description: "Das Löschen bestimmter Image-Signaturen aus signierten Xls-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Image-Signaturen, die in Xls-Dateien platziert sind"
description: "Löschen Sie verschiedene Image-Signaturen aus Xls-Dokumenten. Das Entfernen von Image-Signaturen erfordert einfachen C#-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Xls-Dokumenten von Image-Signaturen mit ein paar Codezeilen.
