...
############################# Head ############################
head_title: "Hapus tanda tangan Image dari file Ots melalui C#"
head_description: "Penghapusan tanda tangan Image tertentu dari dokumen Ots yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Image yang ditempatkan di file Ots"
description: "Hapus berbagai tanda tangan Image dari dokumen Ots. Menghapus tanda tangan Image memerlukan kode C# sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Image dari dokumen Ots Anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Ots dari Image tanda tangan dengan beberapa baris kode.
