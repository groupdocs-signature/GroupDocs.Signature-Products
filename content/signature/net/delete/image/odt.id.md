...
############################# Head ############################
head_title: "Hapus tanda tangan Image dari file Odt melalui C#"
head_description: "Penghapusan tanda tangan Image tertentu dari dokumen Odt yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Image yang ditempatkan di file Odt"
description: "Hapus berbagai tanda tangan Image dari dokumen Odt. Menghapus tanda tangan Image memerlukan kode C# sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Image dari dokumen Odt Anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Odt dari Image tanda tangan dengan beberapa baris kode.
