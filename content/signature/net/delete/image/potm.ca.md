...
############################# Head ############################
head_title: "Suprimeix les signatures de Image dels fitxers Potm mitjançant C#"
head_description: "L'eliminació de signatures específiques de Image dels documents signats Potm es pot dur a terme fàcilment amb un codi .NET curt."

############################# Header ############################
title: "Elimineu les signatures de Image que es col·loquen als fitxers Potm"
description: "Suprimeix diverses signatures de Image dels documents Potm. L'eliminació de signatures Image requereix un codi C# senzill."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix una funció útil per esborrar documents de Potm de signatures de Image amb unes poques línies de codi.
