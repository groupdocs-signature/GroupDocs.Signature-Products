...
############################# Head ############################
head_title: "Ta bort Image-signaturer från Dotx-filer via C#"
head_description: "Radering av specifika Image-signaturer från signerade Dotx-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Image-signaturer som är placerade i Dotx-filer"
description: "Ta bort olika Image-signaturer från Dotx-dokument. Att ta bort Image-signaturer kräver enkel C#-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Image-signaturer från ditt Dotx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Dotx dokument från Image signaturer med några rader kod.
