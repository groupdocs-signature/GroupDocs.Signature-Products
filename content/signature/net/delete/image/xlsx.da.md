...
############################# Head ############################
head_title: "Slet Image signaturer fra Xlsx filer via C#"
head_description: "Sletning af specifikke Image-signaturer fra signerede Xlsx-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer, der er placeret i Xlsx-filer"
description: "Slet forskellige Image-signaturer fra Xlsx-dokumenter. Fjernelse af Image signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Xlsx dokumenter for Image signaturer med et par linjer kode.
