...
############################# Head ############################
head_title: "Supprimez les signatures Image des fichiers Ods via C#"
head_description: "La suppression de signatures Image spécifiques à partir de documents Ods signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Image qui sont placées dans les fichiers Ods"
description: "Supprimez diverses signatures Image des documents Ods. La suppression des signatures Image nécessite un code C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Ods des signatures Image avec quelques lignes de code.
