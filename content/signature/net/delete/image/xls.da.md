...
############################# Head ############################
head_title: "Slet Image signaturer fra Xls filer via C#"
head_description: "Sletning af specifikke Image-signaturer fra signerede Xls-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer, der er placeret i Xls-filer"
description: "Slet forskellige Image-signaturer fra Xls-dokumenter. Fjernelse af Image signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Xls dokumenter for Image signaturer med et par linjer kode.
