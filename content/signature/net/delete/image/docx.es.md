...
############################# Head ############################
head_title: "Eliminar Image firmas de Docx archivos a través de C#"
head_description: "La eliminación de firmas Image específicas de documentos Docx firmados se puede realizar fácilmente con el código corto .NET."

############################# Header ############################
title: "Eliminar Image firmas que se colocan en archivos Docx"
description: "Elimine varias firmas Image de los documentos Docx. Eliminar las firmas Image requiere un código C# simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Image de su documento Docx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona una característica útil para borrar documentos Docx de Image firmas con unas pocas líneas de código.
