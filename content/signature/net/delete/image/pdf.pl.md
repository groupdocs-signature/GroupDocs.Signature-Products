...
############################# Head ############################
head_title: "Usuń podpisy Image z plików Pdf przez C#"
head_description: "Usuwanie określonych podpisów Image z podpisanych dokumentów Pdf można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Image podpisy umieszczone w plikach Pdf"
description: "Usuń różne podpisy Image z dokumentów Pdf. Usunięcie podpisów Image wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Image z dokumentu Pdf?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Pdf z podpisami Image za pomocą kilku linijek kodu.
