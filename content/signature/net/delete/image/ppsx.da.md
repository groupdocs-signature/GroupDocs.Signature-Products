...
############################# Head ############################
head_title: "Slet Image signaturer fra Ppsx filer via C#"
head_description: "Sletning af specifikke Image-signaturer fra signerede Ppsx-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer, der er placeret i Ppsx-filer"
description: "Slet forskellige Image-signaturer fra Ppsx-dokumenter. Fjernelse af Image signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Ppsx dokumenter for Image signaturer med et par linjer kode.
