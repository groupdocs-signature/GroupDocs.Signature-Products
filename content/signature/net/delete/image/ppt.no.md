...
############################# Head ############################
head_title: "Slett Image-signaturer fra Ppt-filer via C#"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Ppt-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Ppt-filer"
description: "Slett forskjellige Image-signaturer fra Ppt-dokumenter. Fjerning av Image-signaturer krever enkel C#-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Image-signaturer fra Ppt-dokumentet"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Ppt dokumenter for Image signaturer med noen få linjer med kode.
