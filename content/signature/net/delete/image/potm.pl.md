...
############################# Head ############################
head_title: "Usuń podpisy Image z plików Potm przez C#"
head_description: "Usuwanie określonych podpisów Image z podpisanych dokumentów Potm można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Image podpisy umieszczone w plikach Potm"
description: "Usuń różne podpisy Image z dokumentów Potm. Usunięcie podpisów Image wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Image z dokumentu Potm?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Potm z podpisami Image za pomocą kilku linijek kodu.
