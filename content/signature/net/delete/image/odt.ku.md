...
############################# Head ############################
head_title: "Bi rêya C# îmzeyên Image ji pelên Odt jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Image ji belgeyên îmzekirî yên Odt dibe ku bi koda kurt a .NET bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Image yên ku di pelên Odt de cih digirin rakin"
description: "Ji belgeyên Odt îmzeyên cihêreng ên Image jêbirin. Ji rakirina îmzeyên Image koda C# ya sade hewce dike."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzayên Image ji belgeya xweya Odt rabike"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji bo paqijkirina Odt belgeyên Image bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
