...
############################# Head ############################
head_title: "Slett Image-signaturer fra Dotx-filer via C#"
head_description: "Sletting av spesifikke Image-signaturer fra signerte Dotx-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Image-signaturer som er plassert i Dotx-filer"
description: "Slett forskjellige Image-signaturer fra Dotx-dokumenter. Fjerning av Image-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Dotx dokumenter for Image signaturer med noen få linjer med kode.
