...
############################# Head ############################
head_title: "Excluir assinaturas Image de arquivos Ppsm via C#"
head_description: "A exclusão de assinaturas Image específicas de documentos Ppsm assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Image que são colocadas em arquivos Ppsm"
description: "Exclua várias assinaturas Image de documentos Ppsm. A remoção de assinaturas Image requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Ppsm de assinaturas Image com algumas linhas de código.
