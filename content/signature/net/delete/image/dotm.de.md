...
############################# Head ############################
head_title: "Löschen Sie Image-Signaturen aus Dotm-Dateien über C#"
head_description: "Das Löschen bestimmter Image-Signaturen aus signierten Dotm-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Image-Signaturen, die in Dotm-Dateien platziert sind"
description: "Löschen Sie verschiedene Image-Signaturen aus Dotm-Dokumenten. Das Entfernen von Image-Signaturen erfordert einfachen C#-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Dotm-Dokumenten von Image-Signaturen mit ein paar Codezeilen.
