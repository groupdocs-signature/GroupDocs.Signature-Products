...
############################# Head ############################
head_title: "Padamkan tandatangan Image daripada fail Pptx melalui C#"
head_description: "Pemadaman tandatangan Image tertentu daripada dokumen Pptx yang ditandatangani mungkin dilakukan dengan mudah dengan kod .NET pendek."

############################# Header ############################
title: "Alih keluar tandatangan Image yang diletakkan dalam fail Pptx."
description: "Padamkan pelbagai tandatangan Image daripada dokumen Pptx. Mengalih keluar tandatangan Image memerlukan kod C# yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan ciri berguna untuk mengosongkan Pptx dokumen daripada Image tandatangan dengan beberapa baris kod.
