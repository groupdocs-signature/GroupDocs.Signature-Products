...
############################# Head ############################
head_title: "Delete Image signatures from Dotm files via C#"
head_description: "Deletion of specific Image signatures from signed Dotm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Image signatures which are placed in Dotm files"
description: "Delete various Image signatures from Dotm documents. Removing Image signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Image signatures from your Dotm document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Dotm documents of Image signatures with a few lines of code.
