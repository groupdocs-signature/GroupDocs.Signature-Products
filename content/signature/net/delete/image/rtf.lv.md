...
############################# Head ############################
head_title: "Dzēst Image parakstus no Rtf failiem, izmantojot C#"
head_description: "Konkrētu Image parakstu dzēšanu no parakstītiem Rtf dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Image parakstus, kas ir ievietoti Rtf failos"
description: "Izdzēsiet dažādus Image parakstus no Rtf dokumentiem. Lai noņemtu Image parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Rtf dokumentiem notīrītu Image parakstus, izmantojot dažas koda rindiņas.
