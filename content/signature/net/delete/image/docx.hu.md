...
############################# Head ############################
head_title: "Törölje a Image aláírásokat a Docx fájlokból a C# segítségével"
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Docx dokumentumok Image aláírásainak néhány soros kóddal történő törléséhez.
