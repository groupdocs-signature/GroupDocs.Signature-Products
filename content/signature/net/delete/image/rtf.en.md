...
############################# Head ############################
head_title: "Delete Image signatures from Rtf files in C#"
head_description: "Deletion of specific Image signatures from signed Rtf documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Image signatures which are in Rtf files"
description: "Delete various Image signatures from Rtf documents. Removing Image signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature of clearing Rtf documents of Image signatures with a few lines of code.
