...
############################# Head ############################
head_title: "Remove signatures from DOCX using C#"
...
############################# Header ############################
title: "Efficiently remove signatures from DOCX files" 
...
steps:
    enable: true
    title: "How to delete text signatures from DOCX using C#"
    content: |
