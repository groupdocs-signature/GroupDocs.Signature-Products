...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Xltx via C#"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Xltx assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Xltx"
description: "Exclua várias assinaturas Barcode de documentos Xltx. A remoção de assinaturas Barcode requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Xltx de assinaturas Barcode com algumas linhas de código.
