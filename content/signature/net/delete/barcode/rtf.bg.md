...
############################# Head ############################
head_title: "Изтрийте Barcode подписи от Rtf файлове чрез C#"
head_description: "Изтриването на конкретни Barcode подписи от подписани Rtf документи може да се извърши лесно с кратък .NET код."

############################# Header ############################
title: "Премахнете Barcode подписи, които са поставени във Rtf файлове"
description: "Изтрийте различни подписи Barcode от Rtf документи. Премахването на подписи Barcode изисква прост код C#."
...
steps:
    enable: true
    title_left: "Как да премахнете подписи Barcode от вашия Rtf документ"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя полезна функция за изчистване на Rtf документи от Barcode подписи с няколко реда код.
