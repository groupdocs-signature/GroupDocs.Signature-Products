...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Dotx via C#"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Dotx assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Dotx"
description: "Exclua várias assinaturas Barcode de documentos Dotx. A remoção de assinaturas Barcode requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Barcode do seu documento Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Dotx de assinaturas Barcode com algumas linhas de código.
