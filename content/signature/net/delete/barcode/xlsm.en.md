...
############################# Head ############################
head_title: "Delete Barcode signatures from Xlsm files via C#"
head_description: "Deletion of specific Barcode signatures from signed Xlsm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Barcode signatures which are placed in Xlsm files"
description: "Delete various Barcode signatures from Xlsm documents. Removing Barcode signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Xlsm documents of Barcode signatures with a few lines of code.
