...
############################# Head ############################
head_title: "Supprimez les signatures Barcode des fichiers Ott via C#"
head_description: "La suppression de signatures Barcode spécifiques à partir de documents Ott signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Barcode qui sont placées dans les fichiers Ott"
description: "Supprimez diverses signatures Barcode des documents Ott. La suppression des signatures Barcode nécessite un code C# simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Barcode de votre document Ott"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Ott des signatures Barcode avec quelques lignes de code.
