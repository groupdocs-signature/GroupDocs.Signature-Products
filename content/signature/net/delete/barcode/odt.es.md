...
############################# Head ############################
head_title: "Eliminar Barcode firmas de Odt archivos a través de C#"
head_description: "La eliminación de firmas Barcode específicas de documentos Odt firmados se puede realizar fácilmente con el código corto .NET."

############################# Header ############################
title: "Eliminar Barcode firmas que se colocan en archivos Odt"
description: "Elimine varias firmas Barcode de los documentos Odt. Eliminar las firmas Barcode requiere un código C# simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Barcode de su documento Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona una característica útil para borrar documentos Odt de Barcode firmas con unas pocas líneas de código.
