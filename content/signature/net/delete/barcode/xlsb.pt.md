...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Xlsb via C#"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Xlsb assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Xlsb"
description: "Exclua várias assinaturas Barcode de documentos Xlsb. A remoção de assinaturas Barcode requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Barcode do seu documento Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Xlsb de assinaturas Barcode com algumas linhas de código.
