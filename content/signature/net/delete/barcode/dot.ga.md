...
############################# Head ############################
head_title: "Scrios Barcode sínithe ó chomhaid Dot trí C#"
head_description: "Seans go ndéanfaí scriosadh sínithe Barcode ar leith ó dhoiciméid shínithe Dot le cód gearr .NET."

############################# Header ############################
title: "Bain Barcode sínithe a chuirtear i gcomhaid Dot"
description: "Scrios Barcode sínithe éagsúla ó Dot doiciméid. Teastaíonn cód simplí C# chun sínithe Barcode a bhaint."
...
steps:
    ...
    content_left: |
        Soláthraíonn [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gné úsáideach chun Dot doiciméad de Barcode sínithe a ghlanadh le cúpla líne de chód.
