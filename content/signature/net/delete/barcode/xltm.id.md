...
############################# Head ############################
head_title: "Hapus tanda tangan Barcode dari file Xltm melalui C#"
head_description: "Penghapusan tanda tangan Barcode tertentu dari dokumen Xltm yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Barcode yang ditempatkan di file Xltm"
description: "Hapus berbagai tanda tangan Barcode dari dokumen Xltm. Menghapus tanda tangan Barcode memerlukan kode C# sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Barcode dari dokumen Xltm Anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Xltm dari Barcode tanda tangan dengan beberapa baris kode.
