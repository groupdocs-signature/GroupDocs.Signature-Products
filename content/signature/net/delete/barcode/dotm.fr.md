...
############################# Head ############################
head_title: "Supprimez les signatures Barcode des fichiers Dotm via C#"
head_description: "La suppression de signatures Barcode spécifiques à partir de documents Dotm signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Barcode qui sont placées dans les fichiers Dotm"
description: "Supprimez diverses signatures Barcode des documents Dotm. La suppression des signatures Barcode nécessite un code C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Dotm des signatures Barcode avec quelques lignes de code.
