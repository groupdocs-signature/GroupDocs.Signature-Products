...
############################# Head ############################
head_title: "Delete Barcode signatures from Doc files in C#"
head_description: "Deletion of specific Barcode signatures from signed Doc documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Barcode signatures which are in Doc files"
description: "Delete various Barcode signatures from Doc documents. Removing Barcode signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature of clearing Doc documents of Barcode signatures with a few lines of code.
