...
############################# Head ############################
head_title: "Slett Barcode-signaturer fra Dot-filer via C#"
head_description: "Sletting av spesifikke Barcode-signaturer fra signerte Dot-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer som er plassert i Dot-filer"
description: "Slett forskjellige Barcode-signaturer fra Dot-dokumenter. Fjerning av Barcode-signaturer krever enkel C#-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Barcode-signaturer fra Dot-dokumentet"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Dot dokumenter for Barcode signaturer med noen få linjer med kode.
