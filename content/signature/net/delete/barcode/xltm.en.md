...
############################# Head ############################
head_title: "Delete Barcode signatures from Xltm files via C#"
head_description: "Deletion of specific Barcode signatures from signed Xltm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Barcode signatures which are placed in Xltm files"
description: "Delete various Barcode signatures from Xltm documents. Removing Barcode signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Barcode signatures from your Xltm document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Xltm documents of Barcode signatures with a few lines of code.
