...
############################# Head ############################
head_title: "Slet Barcode signaturer fra Doc filer via C#"
head_description: "Sletning af specifikke Barcode-signaturer fra signerede Doc-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer, der er placeret i Doc-filer"
description: "Slet forskellige Barcode-signaturer fra Doc-dokumenter. Fjernelse af Barcode signaturer kræver simpel C# kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Barcode-signaturer fra dit Doc-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Doc dokumenter for Barcode signaturer med et par linjer kode.
