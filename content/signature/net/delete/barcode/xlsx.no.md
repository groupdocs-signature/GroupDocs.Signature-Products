...
############################# Head ############################
head_title: "Slett Barcode-signaturer fra Xlsx-filer via C#"
head_description: "Sletting av spesifikke Barcode-signaturer fra signerte Xlsx-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer som er plassert i Xlsx-filer"
description: "Slett forskjellige Barcode-signaturer fra Xlsx-dokumenter. Fjerning av Barcode-signaturer krever enkel C#-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Barcode-signaturer fra Xlsx-dokumentet"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Xlsx dokumenter for Barcode signaturer med noen få linjer med kode.
...
more_formats:
    enable: true
    title: "Slett Barcode-signaturene dine med C#"
    content: |
