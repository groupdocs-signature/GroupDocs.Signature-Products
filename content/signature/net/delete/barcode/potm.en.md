...
############################# Head ############################
head_title: "Delete Barcode signatures from Potm files via C#"
head_description: "Deletion of specific Barcode signatures from signed Potm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Barcode signatures which are placed in Potm files"
description: "Delete various Barcode signatures from Potm documents. Removing Barcode signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Barcode signatures from your Potm document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Potm documents of Barcode signatures with a few lines of code.
