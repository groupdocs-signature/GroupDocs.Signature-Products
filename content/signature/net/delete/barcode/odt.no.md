...
############################# Head ############################
head_title: "Slett Barcode-signaturer fra Odt-filer via C#"
head_description: "Sletting av spesifikke Barcode-signaturer fra signerte Odt-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Barcode-signaturer som er plassert i Odt-filer"
description: "Slett forskjellige Barcode-signaturer fra Odt-dokumenter. Fjerning av Barcode-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Odt dokumenter for Barcode signaturer med noen få linjer med kode.
