...
############################# Head ############################
head_title: "Hapus tanda tangan Barcode dari file Pptm melalui C#"
head_description: "Penghapusan tanda tangan Barcode tertentu dari dokumen Pptm yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Barcode yang ditempatkan di file Pptm"
description: "Hapus berbagai tanda tangan Barcode dari dokumen Pptm. Menghapus tanda tangan Barcode memerlukan kode C# sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Barcode dari dokumen Pptm Anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Pptm dari Barcode tanda tangan dengan beberapa baris kode.
