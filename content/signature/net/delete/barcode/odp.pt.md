...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Odp via C#"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Odp assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Odp"
description: "Exclua várias assinaturas Barcode de documentos Odp. A remoção de assinaturas Barcode requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Barcode do seu documento Odp"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Odp de assinaturas Barcode com algumas linhas de código.
