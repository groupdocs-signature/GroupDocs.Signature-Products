...
############################# Head ############################
head_title: "Delete Barcode signatures from Ots files via C#"
head_description: "Deletion of specific Barcode signatures from signed Ots documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Barcode signatures which are placed in Ots files"
description: "Delete various Barcode signatures from Ots documents. Removing Barcode signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Barcode signatures from your Ots document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Ots documents of Barcode signatures with a few lines of code.
