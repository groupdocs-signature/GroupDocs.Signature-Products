...
############################# Head ############################
head_title: "Delete Barcode signatures from Rtf files via C#"
head_description: "Deletion of specific Barcode signatures from signed Rtf documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Barcode signatures which are placed in Rtf files"
description: "Delete various Barcode signatures from Rtf documents. Removing Barcode signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Rtf documents of Barcode signatures with a few lines of code.
