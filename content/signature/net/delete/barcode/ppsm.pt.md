...
############################# Head ############################
head_title: "Excluir assinaturas Barcode de arquivos Ppsm via C#"
head_description: "A exclusão de assinaturas Barcode específicas de documentos Ppsm assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Barcode que são colocadas em arquivos Ppsm"
description: "Exclua várias assinaturas Barcode de documentos Ppsm. A remoção de assinaturas Barcode requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Ppsm de assinaturas Barcode com algumas linhas de código.
