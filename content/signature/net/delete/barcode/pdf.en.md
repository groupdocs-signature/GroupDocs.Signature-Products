...
############################# Head ############################
head_title: "Delete Barcode signatures from Pdf files via C#"
head_description: "Deletion of specific Barcode signatures from signed Pdf documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Barcode signatures which are placed in Pdf files"
description: "Delete various Barcode signatures from Pdf documents. Removing Barcode signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Pdf documents of Barcode signatures with a few lines of code.
