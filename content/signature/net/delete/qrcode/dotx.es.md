...
############################# Head ############################
head_title: "Eliminar Qrcode firmas de Dotx archivos a través de C#"
head_description: "La eliminación de firmas Qrcode específicas de documentos Dotx firmados se puede realizar fácilmente con el código corto .NET."

############################# Header ############################
title: "Eliminar Qrcode firmas que se colocan en archivos Dotx"
description: "Elimine varias firmas Qrcode de los documentos Dotx. Eliminar las firmas Qrcode requiere un código C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona una característica útil para borrar documentos Dotx de Qrcode firmas con unas pocas líneas de código.
