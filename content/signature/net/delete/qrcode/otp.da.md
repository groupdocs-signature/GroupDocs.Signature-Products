...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Otp filer via C#"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Otp-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Otp-filer"
description: "Slet forskellige Qrcode-signaturer fra Otp-dokumenter. Fjernelse af Qrcode signaturer kræver simpel C# kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Qrcode-signaturer fra dit Otp-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Otp dokumenter for Qrcode signaturer med et par linjer kode.
