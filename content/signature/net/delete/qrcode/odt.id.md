...
############################# Head ############################
head_title: "Hapus tanda tangan Qrcode dari file Odt melalui C#"
head_description: "Penghapusan tanda tangan Qrcode tertentu dari dokumen Odt yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Qrcode yang ditempatkan di file Odt"
description: "Hapus berbagai tanda tangan Qrcode dari dokumen Odt. Menghapus tanda tangan Qrcode memerlukan kode C# sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Qrcode dari dokumen Odt Anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Odt dari Qrcode tanda tangan dengan beberapa baris kode.
