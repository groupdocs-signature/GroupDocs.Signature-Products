...
############################# Head ############################
head_title: "Löschen Sie Qrcode-Signaturen aus Ott-Dateien über C#"
head_description: "Das Löschen bestimmter Qrcode-Signaturen aus signierten Ott-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Qrcode-Signaturen, die in Ott-Dateien platziert sind"
description: "Löschen Sie verschiedene Qrcode-Signaturen aus Ott-Dokumenten. Das Entfernen von Qrcode-Signaturen erfordert einfachen C#-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Ott-Dokumenten von Qrcode-Signaturen mit ein paar Codezeilen.
