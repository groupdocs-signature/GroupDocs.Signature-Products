...
############################# Head ############################
head_title: "Xóa chữ ký Qrcode khỏi tệp Potm qua C#"
head_description: "Việc xóa các chữ ký Qrcode cụ thể khỏi các tài liệu Potm đã ký có thể được thực hiện dễ dàng với mã .NET ngắn."

############################# Header ############################
title: "Xóa các chữ ký Qrcode được đặt trong các tệp Potm"
description: "Xóa các chữ ký Qrcode khác nhau khỏi tài liệu Potm. Việc xóa chữ ký Qrcode yêu cầu mã C# đơn giản."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) cung cấp tính năng hữu ích để xóa các tài liệu Potm có chữ ký Qrcode bằng một vài dòng mã.
