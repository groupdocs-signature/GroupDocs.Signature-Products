...
############################# Head ############################
head_title: "Delete Qrcode signatures from Xltx files via C#"
head_description: "Deletion of specific Qrcode signatures from signed Xltx documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Xltx files"
description: "Delete various Qrcode signatures from Xltx documents. Removing Qrcode signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Xltx documents of Qrcode signatures with a few lines of code.
