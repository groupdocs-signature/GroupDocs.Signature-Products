...
############################# Head ############################
head_title: "Odstraňte podpisy Qrcode ze souborů Doc prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Qrcode z podepsaných dokumentů Doc lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Qrcode podpisy, které jsou umístěny v souborech Doc"
description: "Odstraňte různé podpisy Qrcode z dokumentů Doc. Odstranění podpisů Qrcode vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Qrcode z vašeho dokumentu Doc"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Doc dokumentů od Qrcode podpisů pomocí několika řádků kódu.
