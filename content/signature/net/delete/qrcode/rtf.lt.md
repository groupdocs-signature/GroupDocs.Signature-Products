...
############################# Head ############################
head_title: "Ištrinkite Qrcode parašus iš Rtf failų naudodami C#"
head_description: "Konkrečius Qrcode parašus iš pasirašytų Rtf dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Qrcode parašus, kurie yra Rtf failuose"
description: "Ištrinkite įvairius Qrcode parašus iš Rtf dokumentų. Norint pašalinti Qrcode parašus, reikia paprasto C# kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Rtf dokumentus nuo Qrcode parašų naudojant kelias kodo eilutes.
