...
############################# Head ############################
head_title: "Excluir assinaturas Qrcode de arquivos Potx via C#"
head_description: "A exclusão de assinaturas Qrcode específicas de documentos Potx assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Qrcode que são colocadas em arquivos Potx"
description: "Exclua várias assinaturas Qrcode de documentos Potx. A remoção de assinaturas Qrcode requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Potx de assinaturas Qrcode com algumas linhas de código.
