...
############################# Head ############################
head_title: "Excluir assinaturas Qrcode de arquivos Odp via C#"
head_description: "A exclusão de assinaturas Qrcode específicas de documentos Odp assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Qrcode que são colocadas em arquivos Odp"
description: "Exclua várias assinaturas Qrcode de documentos Odp. A remoção de assinaturas Qrcode requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Odp de assinaturas Qrcode com algumas linhas de código.
