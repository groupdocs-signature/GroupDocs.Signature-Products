...
############################# Head ############################
head_title: "Ta bort Qrcode-signaturer från Ott-filer via C#"
head_description: "Radering av specifika Qrcode-signaturer från signerade Ott-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Qrcode-signaturer som är placerade i Ott-filer"
description: "Ta bort olika Qrcode-signaturer från Ott-dokument. Att ta bort Qrcode-signaturer kräver enkel C#-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Qrcode-signaturer från ditt Ott-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Ott dokument från Qrcode signaturer med några rader kod.
