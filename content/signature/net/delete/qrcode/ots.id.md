...
############################# Head ############################
head_title: "Hapus tanda tangan Qrcode dari file Ots melalui C#"
head_description: "Penghapusan tanda tangan Qrcode tertentu dari dokumen Ots yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Qrcode yang ditempatkan di file Ots"
description: "Hapus berbagai tanda tangan Qrcode dari dokumen Ots. Menghapus tanda tangan Qrcode memerlukan kode C# sederhana."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Ots dari Qrcode tanda tangan dengan beberapa baris kode.
