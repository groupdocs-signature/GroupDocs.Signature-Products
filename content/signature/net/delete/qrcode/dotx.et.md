...
############################# Head ############################
head_title: "Kustutage Qrcode allkirjad failist Dotx läbi C#"
head_description: "Konkreetsete Qrcode allkirjade kustutamine allkirjastatud Dotx dokumentidest saab hõlpsasti teostada lühikese .NET koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Qrcode, mis on paigutatud failidesse Dotx"
description: "Kustutage erinevad allkirjad Qrcode dokumentidest Dotx. Allkirjade Qrcode eemaldamine nõuab lihtsat C# koodi."
...
steps:
    enable: true
    title_left: "Kuidas eemaldada allkirjad Qrcode oma dokumendist Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pakub kasulikku funktsiooni Dotx dokumentide Qrcode allkirjade eemaldamiseks mõne koodireaga.
