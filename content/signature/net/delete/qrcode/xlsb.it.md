...
############################# Head ############################
head_title: "Elimina le firme Qrcode dai file Xlsb tramite C#"
head_description: "L'eliminazione di firme Qrcode specifiche da documenti Xlsb firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Qrcode che sono inserite nei file Xlsb"
description: "Elimina varie firme Qrcode da documenti Xlsb. La rimozione delle firme Qrcode richiede un semplice codice C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Xlsb di firme Qrcode con poche righe di codice.
