...
############################# Head ############################
head_title: "Vee Qrcode handtekeninge van Xlsm lêers uit via C#"
head_description: "Die uitvee van spesifieke Qrcode handtekeninge van getekende Xlsm dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Qrcode handtekeninge wat in Xlsm lêers geplaas is"
description: "Vee verskeie Qrcode handtekeninge uit Xlsm dokumente uit. Die verwydering van Qrcode handtekeninge vereis eenvoudige C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Xlsm dokumente van Qrcode handtekeninge met 'n paar reëls kode.
