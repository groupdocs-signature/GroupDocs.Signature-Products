...
############################# Head ############################
head_title: "Supprimez les signatures Qrcode des fichiers Pdf via C#"
head_description: "La suppression de signatures Qrcode spécifiques à partir de documents Pdf signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Qrcode qui sont placées dans les fichiers Pdf"
description: "Supprimez diverses signatures Qrcode des documents Pdf. La suppression des signatures Qrcode nécessite un code C# simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Qrcode de votre document Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Pdf des signatures Qrcode avec quelques lignes de code.
