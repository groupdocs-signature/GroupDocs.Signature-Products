...
############################# Head ############################
head_title: "Supprimez les signatures Qrcode des fichiers Rtf via C#"
head_description: "La suppression de signatures Qrcode spécifiques à partir de documents Rtf signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Qrcode qui sont placées dans les fichiers Rtf"
description: "Supprimez diverses signatures Qrcode des documents Rtf. La suppression des signatures Qrcode nécessite un code C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Rtf des signatures Qrcode avec quelques lignes de code.
