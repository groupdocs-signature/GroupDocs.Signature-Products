...
############################# Head ############################
head_title: "Slett Qrcode-signaturer fra Dotm-filer via C#"
head_description: "Sletting av spesifikke Qrcode-signaturer fra signerte Dotm-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer som er plassert i Dotm-filer"
description: "Slett forskjellige Qrcode-signaturer fra Dotm-dokumenter. Fjerning av Qrcode-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Dotm dokumenter for Qrcode signaturer med noen få linjer med kode.
