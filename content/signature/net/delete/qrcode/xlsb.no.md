...
############################# Head ############################
head_title: "Slett Qrcode-signaturer fra Xlsb-filer via C#"
head_description: "Sletting av spesifikke Qrcode-signaturer fra signerte Xlsb-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer som er plassert i Xlsb-filer"
description: "Slett forskjellige Qrcode-signaturer fra Xlsb-dokumenter. Fjerning av Qrcode-signaturer krever enkel C#-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Qrcode-signaturer fra Xlsb-dokumentet"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Xlsb dokumenter for Qrcode signaturer med noen få linjer med kode.
