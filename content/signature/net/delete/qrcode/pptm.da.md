...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Pptm filer via C#"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Pptm-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Pptm-filer"
description: "Slet forskellige Qrcode-signaturer fra Pptm-dokumenter. Fjernelse af Qrcode signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Pptm dokumenter for Qrcode signaturer med et par linjer kode.
