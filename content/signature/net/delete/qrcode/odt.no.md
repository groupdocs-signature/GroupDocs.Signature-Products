...
############################# Head ############################
head_title: "Slett Qrcode-signaturer fra Odt-filer via C#"
head_description: "Sletting av spesifikke Qrcode-signaturer fra signerte Odt-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer som er plassert i Odt-filer"
description: "Slett forskjellige Qrcode-signaturer fra Odt-dokumenter. Fjerning av Qrcode-signaturer krever enkel C#-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Qrcode-signaturer fra Odt-dokumentet"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Odt dokumenter for Qrcode signaturer med noen få linjer med kode.
