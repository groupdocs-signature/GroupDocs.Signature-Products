...
############################# Head ############################
head_title: "Изтрийте Qrcode подписи от Dot файлове чрез C#"
head_description: "Изтриването на конкретни Qrcode подписи от подписани Dot документи може да се извърши лесно с кратък .NET код."

############################# Header ############################
title: "Премахнете Qrcode подписи, които са поставени във Dot файлове"
description: "Изтрийте различни подписи Qrcode от Dot документи. Премахването на подписи Qrcode изисква прост код C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя полезна функция за изчистване на Dot документи от Qrcode подписи с няколко реда код.
