...
############################# Head ############################
head_title: "Verwijder Qrcode handtekeningen uit Odp bestanden via C#"
head_description: "Het verwijderen van specifieke Qrcode handtekeningen uit ondertekende Odp documenten kan gemakkelijk worden uitgevoerd met korte .NET code."

############################# Header ############################
title: "Verwijder Qrcode handtekeningen die in Odp bestanden zijn geplaatst"
description: "Verwijder verschillende Qrcode handtekeningen uit Odp documenten. Voor het verwijderen van Qrcode-handtekeningen is een eenvoudige C#-code vereist."
...
steps:
    enable: true
    title_left: "Hoe Qrcode handtekeningen te verwijderen uit uw Odp document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt een handige functie voor het wissen van Odp documenten van Qrcode handtekeningen met een paar regels code.
