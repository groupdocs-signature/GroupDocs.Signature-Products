...
############################# Head ############################
head_title: "Elimina le firme Qrcode dai file Pdf tramite C#"
head_description: "L'eliminazione di firme Qrcode specifiche da documenti Pdf firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Qrcode che sono inserite nei file Pdf"
description: "Elimina varie firme Qrcode da documenti Pdf. La rimozione delle firme Qrcode richiede un semplice codice C#."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Qrcode dal tuo documento Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Pdf di firme Qrcode con poche righe di codice.
