...
############################# Head ############################
head_title: "Törölje a Qrcode aláírásokat a Xltx fájlokból a C# segítségével"
head_description: "Az aláírt Xltx dokumentumokból bizonyos Qrcode aláírások törlése egyszerűen végrehajtható rövid .NET kóddal."

############################# Header ############################
title: "Távolítsa el a Qrcode aláírásokat, amelyek a Xltx fájlokban vannak elhelyezve"
description: "Törölje a különböző Qrcode aláírásokat a Xltx dokumentumokból. A Qrcode aláírások eltávolításához egyszerű C# kód szükséges."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Xltx dokumentumok Qrcode aláírásainak néhány soros kóddal történő törléséhez.
