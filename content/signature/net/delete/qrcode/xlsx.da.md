...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Xlsx filer via C#"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Xlsx-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Xlsx-filer"
description: "Slet forskellige Qrcode-signaturer fra Xlsx-dokumenter. Fjernelse af Qrcode signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Xlsx dokumenter for Qrcode signaturer med et par linjer kode.
