...
description: "Ta bort olika Qrcode-signaturer från Odp-dokument. Att ta bort Qrcode-signaturer kräver enkel C#-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Odp dokument från Qrcode signaturer med några rader kod.
