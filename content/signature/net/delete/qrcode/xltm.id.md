...
############################# Head ############################
head_title: "Hapus tanda tangan Qrcode dari file Xltm melalui C#"
head_description: "Penghapusan tanda tangan Qrcode tertentu dari dokumen Xltm yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Qrcode yang ditempatkan di file Xltm"
description: "Hapus berbagai tanda tangan Qrcode dari dokumen Xltm. Menghapus tanda tangan Qrcode memerlukan kode C# sederhana."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Xltm dari Qrcode tanda tangan dengan beberapa baris kode.
