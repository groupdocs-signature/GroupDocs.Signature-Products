...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Pps filer via C#"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Pps-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Pps-filer"
description: "Slet forskellige Qrcode-signaturer fra Pps-dokumenter. Fjernelse af Qrcode signaturer kræver simpel C# kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Qrcode-signaturer fra dit Pps-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Pps dokumenter for Qrcode signaturer med et par linjer kode.
