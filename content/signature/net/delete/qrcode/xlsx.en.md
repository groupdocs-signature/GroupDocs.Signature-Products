...
############################# Head ############################
head_title: "Delete Qrcode signatures from Xlsx files via C#"
head_description: "Deletion of specific Qrcode signatures from signed Xlsx documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Xlsx files"
description: "Delete various Qrcode signatures from Xlsx documents. Removing Qrcode signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Qrcode signatures from your Xlsx document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Xlsx documents of Qrcode signatures with a few lines of code.
