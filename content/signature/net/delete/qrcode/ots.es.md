...
############################# Head ############################
head_title: "Eliminar Qrcode firmas de Ots archivos a través de C#"
head_description: "La eliminación de firmas Qrcode específicas de documentos Ots firmados se puede realizar fácilmente con el código corto .NET."

############################# Header ############################
title: "Eliminar Qrcode firmas que se colocan en archivos Ots"
description: "Elimine varias firmas Qrcode de los documentos Ots. Eliminar las firmas Qrcode requiere un código C# simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Qrcode de su documento Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona una característica útil para borrar documentos Ots de Qrcode firmas con unas pocas líneas de código.
