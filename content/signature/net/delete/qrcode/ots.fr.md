...
############################# Head ############################
head_title: "Supprimez les signatures Qrcode des fichiers Ots via C#"
head_description: "La suppression de signatures Qrcode spécifiques à partir de documents Ots signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Qrcode qui sont placées dans les fichiers Ots"
description: "Supprimez diverses signatures Qrcode des documents Ots. La suppression des signatures Qrcode nécessite un code C# simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Qrcode de votre document Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Ots des signatures Qrcode avec quelques lignes de code.
