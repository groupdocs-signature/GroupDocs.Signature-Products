...
############################# Head ############################
head_title: "Suprimeix les signatures de Qrcode dels fitxers Dotx mitjançant C#"
head_description: "L'eliminació de signatures específiques de Qrcode dels documents signats Dotx es pot dur a terme fàcilment amb un codi .NET curt."

############################# Header ############################
title: "Elimineu les signatures de Qrcode que es col·loquen als fitxers Dotx"
description: "Suprimeix diverses signatures de Qrcode dels documents Dotx. L'eliminació de signatures Qrcode requereix un codi C# senzill."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix una funció útil per esborrar documents de Dotx de signatures de Qrcode amb unes poques línies de codi.
