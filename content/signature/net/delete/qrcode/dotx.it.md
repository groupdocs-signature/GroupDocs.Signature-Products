...
############################# Head ############################
head_title: "Elimina le firme Qrcode dai file Dotx tramite C#"
head_description: "L'eliminazione di firme Qrcode specifiche da documenti Dotx firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Qrcode che sono inserite nei file Dotx"
description: "Elimina varie firme Qrcode da documenti Dotx. La rimozione delle firme Qrcode richiede un semplice codice C#."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Qrcode dal tuo documento Dotx"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Dotx di firme Qrcode con poche righe di codice.
