...
############################# Head ############################
head_title: "Slett Qrcode-signaturer fra Dot-filer via C#"
head_description: "Sletting av spesifikke Qrcode-signaturer fra signerte Dot-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer som er plassert i Dot-filer"
description: "Slett forskjellige Qrcode-signaturer fra Dot-dokumenter. Fjerning av Qrcode-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Dot dokumenter for Qrcode signaturer med noen få linjer med kode.
