...
############################# Head ############################
head_title: "Törölje a Qrcode aláírásokat a Ppsx fájlokból a C# segítségével"
head_description: "Az aláírt Ppsx dokumentumokból bizonyos Qrcode aláírások törlése egyszerűen végrehajtható rövid .NET kóddal."

############################# Header ############################
title: "Távolítsa el a Qrcode aláírásokat, amelyek a Ppsx fájlokban vannak elhelyezve"
description: "Törölje a különböző Qrcode aláírásokat a Ppsx dokumentumokból. A Qrcode aláírások eltávolításához egyszerű C# kód szükséges."
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Qrcode aláírásokat a Ppsx dokumentumból"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Ppsx dokumentumok Qrcode aláírásainak néhány soros kóddal történő törléséhez.
