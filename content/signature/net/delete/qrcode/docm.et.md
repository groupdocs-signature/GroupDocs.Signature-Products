...
############################# Head ############################
head_title: "Kustutage Qrcode allkirjad failist Docm läbi C#"
head_description: "Konkreetsete Qrcode allkirjade kustutamine allkirjastatud Docm dokumentidest saab hõlpsasti teostada lühikese .NET koodiga."

############################# Header ############################
title: "Eemaldage allkirjad Qrcode, mis on paigutatud failidesse Docm"
description: "Kustutage erinevad allkirjad Qrcode dokumentidest Docm. Allkirjade Qrcode eemaldamine nõuab lihtsat C# koodi."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pakub kasulikku funktsiooni Docm dokumentide Qrcode allkirjade eemaldamiseks mõne koodireaga.
