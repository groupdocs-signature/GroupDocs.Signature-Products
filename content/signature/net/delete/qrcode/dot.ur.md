...
############################# Head ############################
head_title: "C# کے ذریعے Dot فائلوں سے Qrcode دستخطوں کو حذف کریں"
head_description: "دستخط شدہ Dot دستاویزات سے مخصوص Qrcode دستخطوں کو حذف کرنا مختصر .NET کوڈ کے ساتھ آسانی سے انجام دیا جا سکتا ہے۔"

############################# Header ############################
title: "Qrcode دستخطوں کو ہٹا دیں جو Dot فائلوں میں رکھے گئے ہیں"
description: "Dot دستاویزات سے مختلف Qrcode دستخطوں کو حذف کریں۔ Qrcode دستخطوں کو ہٹانے کے لیے سادہ C# کوڈ کی ضرورت ہے۔"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) کوڈ کی چند سطروں کے ساتھ Qrcode دستخطوں کی Dot دستاویزات کو صاف کرنے کے لیے مفید خصوصیت فراہم کرتا ہے۔
