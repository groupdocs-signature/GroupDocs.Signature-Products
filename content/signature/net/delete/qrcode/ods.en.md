...
############################# Head ############################
head_title: "Delete Qrcode signatures from Ods files via C#"
head_description: "Deletion of specific Qrcode signatures from signed Ods documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Ods files"
description: "Delete various Qrcode signatures from Ods documents. Removing Qrcode signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Qrcode signatures from your Ods document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Ods documents of Qrcode signatures with a few lines of code.
