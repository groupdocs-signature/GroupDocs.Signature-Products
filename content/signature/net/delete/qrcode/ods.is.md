...
############################# Head ############################
head_title: "Eyða Qrcode undirskriftum úr Ods skrám í gegnum C#"
head_description: "Auðvelt er að eyða tilteknum Qrcode undirskriftum úr undirrituðum Ods skjölum með stuttum .NET kóða."

############################# Header ############################
title: "Fjarlægðu Qrcode undirskriftir sem eru settar í Ods skrár"
description: "Eyða ýmsum Qrcode undirskriftum úr Ods skjölum. Til að fjarlægja Qrcode undirskrift þarf einfaldan C# kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að fjarlægja Qrcode undirskriftir úr Ods skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) býður upp á gagnlegan eiginleika til að hreinsa Ods skjöl af Qrcode undirskriftum með nokkrum línum af kóða.
