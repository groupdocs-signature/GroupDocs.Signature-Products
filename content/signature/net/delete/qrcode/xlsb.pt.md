...
############################# Head ############################
head_title: "Excluir assinaturas Qrcode de arquivos Xlsb via C#"
head_description: "A exclusão de assinaturas Qrcode específicas de documentos Xlsb assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Qrcode que são colocadas em arquivos Xlsb"
description: "Exclua várias assinaturas Qrcode de documentos Xlsb. A remoção de assinaturas Qrcode requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Qrcode do seu documento Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Xlsb de assinaturas Qrcode com algumas linhas de código.
