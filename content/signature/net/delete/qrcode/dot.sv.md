...
############################# Head ############################
head_title: "Ta bort Qrcode-signaturer från Dot-filer via C#"
head_description: "Radering av specifika Qrcode-signaturer från signerade Dot-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Qrcode-signaturer som är placerade i Dot-filer"
description: "Ta bort olika Qrcode-signaturer från Dot-dokument. Att ta bort Qrcode-signaturer kräver enkel C#-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Qrcode-signaturer från ditt Dot-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Dot dokument från Qrcode signaturer med några rader kod.
