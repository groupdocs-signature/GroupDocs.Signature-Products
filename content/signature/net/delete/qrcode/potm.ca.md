...
############################# Head ############################
head_title: "Suprimeix les signatures de Qrcode dels fitxers Potm mitjançant C#"
head_description: "L'eliminació de signatures específiques de Qrcode dels documents signats Potm es pot dur a terme fàcilment amb un codi .NET curt."

############################# Header ############################
title: "Elimineu les signatures de Qrcode que es col·loquen als fitxers Potm"
description: "Suprimeix diverses signatures de Qrcode dels documents Potm. L'eliminació de signatures Qrcode requereix un codi C# senzill."
...
steps:
    enable: true
    title_left: "Com eliminar les signatures de Qrcode del vostre document Potm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ofereix una funció útil per esborrar documents de Potm de signatures de Qrcode amb unes poques línies de codi.
