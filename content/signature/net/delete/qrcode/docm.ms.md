...
############################# Head ############################
head_title: "Padamkan tandatangan Qrcode daripada fail Docm melalui C#"
head_description: "Pemadaman tandatangan Qrcode tertentu daripada dokumen Docm yang ditandatangani mungkin dilakukan dengan mudah dengan kod .NET pendek."

############################# Header ############################
title: "Alih keluar tandatangan Qrcode yang diletakkan dalam fail Docm."
description: "Padamkan pelbagai tandatangan Qrcode daripada dokumen Docm. Mengalih keluar tandatangan Qrcode memerlukan kod C# yang mudah."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan ciri berguna untuk mengosongkan Docm dokumen daripada Qrcode tandatangan dengan beberapa baris kod.
