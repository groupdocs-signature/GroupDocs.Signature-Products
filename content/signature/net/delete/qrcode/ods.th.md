...
############################# Head ############################
head_title: "ลบลายเซ็น Qrcode จากไฟล์ Ods ผ่าน C#"
head_description: "การลบลายเซ็น Qrcode เฉพาะจากเอกสาร Ods ที่ลงนามแล้วอาจทำได้ง่ายๆ ด้วยรหัส .NET แบบสั้น"

############################# Header ############################
title: "ลบลายเซ็น Qrcode ที่อยู่ใน Ods files"
description: "ลบลายเซ็น Qrcode ต่างๆ จากเอกสาร Ods การลบลายเซ็น Qrcode ต้องใช้โค้ด C# อย่างง่าย"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) มีคุณลักษณะที่เป็นประโยชน์สำหรับการล้างเอกสาร Ods ของ Qrcode ลายเซ็นด้วยโค้ดไม่กี่บรรทัด
