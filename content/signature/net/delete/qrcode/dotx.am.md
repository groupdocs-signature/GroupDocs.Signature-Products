...
############################# Head ############################
head_title: "የQrcode ፊርማዎችን ከDotx ፋይሎች በC# በኩል ሰርዝ"
head_description: "ከተፈረሙ Dotx ሰነዶች የተወሰኑ የQrcode ፊርማዎችን መሰረዝ በአጭር የ.NET ኮድ በቀላሉ ሊከናወን ይችላል።"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) የDotx ሰነዶችን የQrcode ፊርማዎችን በጥቂት የኮድ መስመሮች ለማጽዳት ጠቃሚ ባህሪን ይሰጣል።
