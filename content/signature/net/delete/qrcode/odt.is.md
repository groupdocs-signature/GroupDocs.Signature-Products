...
############################# Head ############################
head_title: "Eyða Qrcode undirskriftum úr Odt skrám í gegnum C#"
head_description: "Auðvelt er að eyða tilteknum Qrcode undirskriftum úr undirrituðum Odt skjölum með stuttum .NET kóða."

############################# Header ############################
title: "Fjarlægðu Qrcode undirskriftir sem eru settar í Odt skrár"
description: "Eyða ýmsum Qrcode undirskriftum úr Odt skjölum. Til að fjarlægja Qrcode undirskrift þarf einfaldan C# kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að fjarlægja Qrcode undirskriftir úr Odt skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) býður upp á gagnlegan eiginleika til að hreinsa Odt skjöl af Qrcode undirskriftum með nokkrum línum af kóða.
