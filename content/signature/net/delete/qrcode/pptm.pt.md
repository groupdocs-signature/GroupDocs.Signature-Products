...
############################# Head ############################
head_title: "Excluir assinaturas Qrcode de arquivos Pptm via C#"
head_description: "A exclusão de assinaturas Qrcode específicas de documentos Pptm assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Qrcode que são colocadas em arquivos Pptm"
description: "Exclua várias assinaturas Qrcode de documentos Pptm. A remoção de assinaturas Qrcode requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Qrcode do seu documento Pptm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Pptm de assinaturas Qrcode com algumas linhas de código.
