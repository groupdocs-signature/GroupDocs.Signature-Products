...
############################# Head ############################
head_title: "C# を介して Ots ファイルから Qrcode 署名を削除します"
head_description: "署名済みの Ots ドキュメントから特定の Qrcode 署名を削除するには、短い .NET コードを使用すると簡単に実行できます。"

############################# Header ############################
title: "Ots ファイルに配置されている Qrcode 署名を削除します"
description: "Ots ドキュメントからさまざまな Qrcode 署名を削除します。 Qrcode 署名を削除するには、単純な C# コードが必要です。"
...
steps:
    enable: true
    title_left: "Ots ドキュメントから Qrcode 署名を削除する方法"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) は、数行のコードで Qrcode 署名の Ots ドキュメントをクリアするための便利な機能を提供します。
