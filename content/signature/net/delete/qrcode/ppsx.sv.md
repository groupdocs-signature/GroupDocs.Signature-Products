...
############################# Head ############################
head_title: "Ta bort Qrcode-signaturer från Ppsx-filer via C#"
head_description: "Radering av specifika Qrcode-signaturer från signerade Ppsx-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Qrcode-signaturer som är placerade i Ppsx-filer"
description: "Ta bort olika Qrcode-signaturer från Ppsx-dokument. Att ta bort Qrcode-signaturer kräver enkel C#-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Qrcode-signaturer från ditt Ppsx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Ppsx dokument från Qrcode signaturer med några rader kod.
