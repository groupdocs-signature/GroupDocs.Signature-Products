...
############################# Head ############################
head_title: "Delete Qrcode signatures from Potx files via C#"
head_description: "Deletion of specific Qrcode signatures from signed Potx documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Potx files"
description: "Delete various Qrcode signatures from Potx documents. Removing Qrcode signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Potx documents of Qrcode signatures with a few lines of code.
