...
############################# Head ############################
head_title: "Odstraňte podpisy Qrcode ze souborů Dotm prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Qrcode z podepsaných dokumentů Dotm lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Qrcode podpisy, které jsou umístěny v souborech Dotm"
description: "Odstraňte různé podpisy Qrcode z dokumentů Dotm. Odstranění podpisů Qrcode vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Qrcode z vašeho dokumentu Dotm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Dotm dokumentů od Qrcode podpisů pomocí několika řádků kódu.
...
more_formats:
    enable: true
    title: "Odstraňte své podpisy Qrcode pomocí C#"
    content: |
