...
############################# Head ############################
head_title: "Usuń podpisy Qrcode z plików Pptx przez C#"
head_description: "Usuwanie określonych podpisów Qrcode z podpisanych dokumentów Pptx można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Qrcode podpisy umieszczone w plikach Pptx"
description: "Usuń różne podpisy Qrcode z dokumentów Pptx. Usunięcie podpisów Qrcode wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Qrcode z dokumentu Pptx?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Pptx z podpisami Qrcode za pomocą kilku linijek kodu.
