...
############################# Head ############################
head_title: "Delete Qrcode signatures from Odp files via C#"
head_description: "Deletion of specific Qrcode signatures from signed Odp documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Odp files"
description: "Delete various Qrcode signatures from Odp documents. Removing Qrcode signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Qrcode signatures from your Odp document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Odp documents of Qrcode signatures with a few lines of code.
