...
description: "Slett forskjellige Qrcode-signaturer fra {{Filformat}}-dokumenter. Fjerning av Qrcode-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme {{Filformat}} dokumenter for Qrcode signaturer med noen få linjer med kode.
