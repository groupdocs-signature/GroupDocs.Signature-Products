...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Pdf filer via C#"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Pdf-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Pdf-filer"
description: "Slet forskellige Qrcode-signaturer fra Pdf-dokumenter. Fjernelse af Qrcode signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Pdf dokumenter for Qrcode signaturer med et par linjer kode.
