...
############################# Head ############################
head_title: "Usuń podpisy Qrcode z plików Ots przez C#"
head_description: "Usuwanie określonych podpisów Qrcode z podpisanych dokumentów Ots można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Qrcode podpisy umieszczone w plikach Ots"
description: "Usuń różne podpisy Qrcode z dokumentów Ots. Usunięcie podpisów Qrcode wymaga prostego kodu C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Ots z podpisami Qrcode za pomocą kilku linijek kodu.
