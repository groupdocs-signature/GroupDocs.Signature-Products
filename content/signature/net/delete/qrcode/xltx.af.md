...
############################# Head ############################
head_title: "Vee Qrcode handtekeninge van Xltx lêers uit via C#"
head_description: "Die uitvee van spesifieke Qrcode handtekeninge van getekende {{Lêerformaat}} dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Qrcode handtekeninge wat in {{Lêerformaat}} lêers geplaas is"
description: "Vee verskeie Qrcode handtekeninge uit {{Lêerformaat}} dokumente uit. Die verwydering van Qrcode handtekeninge vereis eenvoudige C# kode."
...
steps:
    enable: true
    title_left: "Hoe om Qrcode-handtekeninge uit jou {{Lêerformaat}}-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van {{Lêerformaat}} dokumente van Qrcode handtekeninge met 'n paar reëls kode.
...
more_formats:
    enable: true
    title: "Vee jou Qrcode handtekeninge uit met C#"
    content: |
