...
############################# Head ############################
head_title: "Usuń podpisy Qrcode z plików Docm przez C#"
head_description: "Usuwanie określonych podpisów Qrcode z podpisanych dokumentów Docm można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Qrcode podpisy umieszczone w plikach Docm"
description: "Usuń różne podpisy Qrcode z dokumentów Docm. Usunięcie podpisów Qrcode wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Qrcode z dokumentu Docm?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Docm z podpisami Qrcode za pomocą kilku linijek kodu.
