...
############################# Head ############################
head_title: "Elimina le firme Qrcode dai file Ots tramite C#"
head_description: "L'eliminazione di firme Qrcode specifiche da documenti Ots firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Qrcode che sono inserite nei file Ots"
description: "Elimina varie firme Qrcode da documenti Ots. La rimozione delle firme Qrcode richiede un semplice codice C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Ots di firme Qrcode con poche righe di codice.
