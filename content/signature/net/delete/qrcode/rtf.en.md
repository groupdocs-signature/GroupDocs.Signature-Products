...
############################# Head ############################
head_title: "Delete Qrcode signatures from Rtf files via C#"
head_description: "Deletion of specific Qrcode signatures from signed Rtf documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Rtf files"
description: "Delete various Qrcode signatures from Rtf documents. Removing Qrcode signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Qrcode signatures from your Rtf document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Rtf documents of Qrcode signatures with a few lines of code.
