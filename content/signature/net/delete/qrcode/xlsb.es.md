...
############################# Head ############################
head_title: "Eliminar Qrcode firmas de Xlsb archivos a través de C#"
head_description: "La eliminación de firmas Qrcode específicas de documentos Xlsb firmados se puede realizar fácilmente con el código corto .NET."

############################# Header ############################
title: "Eliminar Qrcode firmas que se colocan en archivos Xlsb"
description: "Elimine varias firmas Qrcode de los documentos Xlsb. Eliminar las firmas Qrcode requiere un código C# simple."
...
steps:
    enable: true
    title_left: "Cómo eliminar las firmas Qrcode de su documento Xlsb"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona una característica útil para borrar documentos Xlsb de Qrcode firmas con unas pocas líneas de código.
