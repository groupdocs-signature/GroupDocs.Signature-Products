...
############################# Head ############################
head_title: "Delete Qrcode signatures from Otp files via C#"
head_description: "Deletion of specific Qrcode signatures from signed Otp documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Otp files"
description: "Delete various Qrcode signatures from Otp documents. Removing Qrcode signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Qrcode signatures from your Otp document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Otp documents of Qrcode signatures with a few lines of code.
