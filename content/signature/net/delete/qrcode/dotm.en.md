...
############################# Head ############################
head_title: "Delete Qrcode signatures from Dotm files via C#"
head_description: "Deletion of specific Qrcode signatures from signed Dotm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Dotm files"
description: "Delete various Qrcode signatures from Dotm documents. Removing Qrcode signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Qrcode signatures from your Dotm document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Dotm documents of Qrcode signatures with a few lines of code.
