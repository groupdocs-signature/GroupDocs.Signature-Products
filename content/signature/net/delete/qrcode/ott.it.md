...
############################# Head ############################
head_title: "Elimina le firme Qrcode dai file Ott tramite C#"
head_description: "L'eliminazione di firme Qrcode specifiche da documenti Ott firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Qrcode che sono inserite nei file Ott"
description: "Elimina varie firme Qrcode da documenti Ott. La rimozione delle firme Qrcode richiede un semplice codice C#."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Qrcode dal tuo documento Ott"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Ott di firme Qrcode con poche righe di codice.
