...
############################# Head ############################
head_title: "Elimina le firme Qrcode dai file Ods tramite C#"
head_description: "L'eliminazione di firme Qrcode specifiche da documenti Ods firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Qrcode che sono inserite nei file Ods"
description: "Elimina varie firme Qrcode da documenti Ods. La rimozione delle firme Qrcode richiede un semplice codice C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Ods di firme Qrcode con poche righe di codice.
