...
############################# Head ############################
head_title: "Ta bort Qrcode-signaturer från Pptm-filer via C#"
head_description: "Radering av specifika Qrcode-signaturer från signerade Pptm-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Qrcode-signaturer som är placerade i Pptm-filer"
description: "Ta bort olika Qrcode-signaturer från Pptm-dokument. Att ta bort Qrcode-signaturer kräver enkel C#-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Pptm dokument från Qrcode signaturer med några rader kod.
