...
############################# Head ############################
head_title: "Delete Qrcode signatures from Docm files via C#"
head_description: "Deletion of specific Qrcode signatures from signed Docm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Qrcode signatures which are placed in Docm files"
description: "Delete various Qrcode signatures from Docm documents. Removing Qrcode signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Docm documents of Qrcode signatures with a few lines of code.
