...
############################# Head ############################
head_title: "Ta bort Qrcode-signaturer från Potm-filer via C#"
head_description: "Radering av specifika Qrcode-signaturer från signerade Potm-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Qrcode-signaturer som är placerade i Potm-filer"
description: "Ta bort olika Qrcode-signaturer från Potm-dokument. Att ta bort Qrcode-signaturer kräver enkel C#-kod."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Potm dokument från Qrcode signaturer med några rader kod.
