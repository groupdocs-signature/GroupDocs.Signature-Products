...
description: "Slett forskjellige Qrcode-signaturer fra Docx-dokumenter. Fjerning av Qrcode-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Docx dokumenter for Qrcode signaturer med noen få linjer med kode.
