...
############################# Head ############################
head_title: "Supprimez les signatures Qrcode des fichiers Xlsb via C#"
head_description: "La suppression de signatures Qrcode spécifiques à partir de documents Xlsb signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Qrcode qui sont placées dans les fichiers Xlsb"
description: "Supprimez diverses signatures Qrcode des documents Xlsb. La suppression des signatures Qrcode nécessite un code C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Xlsb des signatures Qrcode avec quelques lignes de code.
