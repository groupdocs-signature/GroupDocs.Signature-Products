...
############################# Head ############################
head_title: "Slett Qrcode-signaturer fra Odp-filer via C#"
head_description: "Sletting av spesifikke Qrcode-signaturer fra signerte Odp-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer som er plassert i Odp-filer"
description: "Slett forskjellige Qrcode-signaturer fra Odp-dokumenter. Fjerning av Qrcode-signaturer krever enkel C#-kode."
...
steps:
    enable: true
    title_left: "Slik fjerner du Qrcode-signaturer fra Odp-dokumentet"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Odp dokumenter for Qrcode signaturer med noen få linjer med kode.
