...
############################# Head ############################
head_title: "Eyða Qrcode undirskriftum úr Xls skrám í gegnum C#"
head_description: "Auðvelt er að eyða tilteknum Qrcode undirskriftum úr undirrituðum Xls skjölum með stuttum .NET kóða."

############################# Header ############################
title: "Fjarlægðu Qrcode undirskriftir sem eru settar í Xls skrár"
description: "Eyða ýmsum Qrcode undirskriftum úr Xls skjölum. Til að fjarlægja Qrcode undirskrift þarf einfaldan C# kóða."
...
steps:
    enable: true
    title_left: "Hvernig á að fjarlægja Qrcode undirskriftir úr Xls skjalinu þínu"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) býður upp á gagnlegan eiginleika til að hreinsa Xls skjöl af Qrcode undirskriftum með nokkrum línum af kóða.
