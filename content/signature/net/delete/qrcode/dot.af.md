...
############################# Head ############################
head_title: "Vee Qrcode handtekeninge van Dot lêers uit via C#"
head_description: "Die uitvee van spesifieke Qrcode handtekeninge van getekende Dot dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Qrcode handtekeninge wat in Dot lêers geplaas is"
description: "Vee verskeie Qrcode handtekeninge uit Dot dokumente uit. Die verwydering van Qrcode handtekeninge vereis eenvoudige C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Dot dokumente van Qrcode handtekeninge met 'n paar reëls kode.
