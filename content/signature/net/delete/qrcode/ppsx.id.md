...
############################# Head ############################
head_title: "Hapus tanda tangan Qrcode dari file Ppsx melalui C#"
head_description: "Penghapusan tanda tangan Qrcode tertentu dari dokumen Ppsx yang ditandatangani dapat dilakukan dengan mudah dengan kode .NET singkat."

############################# Header ############################
title: "Hapus tanda tangan Qrcode yang ditempatkan di file Ppsx"
description: "Hapus berbagai tanda tangan Qrcode dari dokumen Ppsx. Menghapus tanda tangan Qrcode memerlukan kode C# sederhana."
...
steps:
    enable: true
    title_left: "Cara menghapus tanda tangan Qrcode dari dokumen Ppsx Anda"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) menyediakan fitur yang berguna untuk membersihkan dokumen Ppsx dari Qrcode tanda tangan dengan beberapa baris kode.
...
more_formats:
    enable: true
    title: "Hapus tanda tangan Qrcode Anda dengan C#"
    content: |
