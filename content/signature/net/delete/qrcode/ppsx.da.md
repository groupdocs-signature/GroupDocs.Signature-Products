...
############################# Head ############################
head_title: "Slet Qrcode signaturer fra Ppsx filer via C#"
head_description: "Sletning af specifikke Qrcode-signaturer fra signerede Ppsx-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Qrcode-signaturer, der er placeret i Ppsx-filer"
description: "Slet forskellige Qrcode-signaturer fra Ppsx-dokumenter. Fjernelse af Qrcode signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Ppsx dokumenter for Qrcode signaturer med et par linjer kode.
