...
############################# Head ############################
head_title: "Удалите подписи Digital из Docm файлов с помощью C#"
head_description: "Удаление определенных подписей Digital из подписанных документов Docm можно легко выполнить с помощью короткого кода .NET."

############################# Header ############################
title: "Удалить подписи Digital, размещенные в файлах Docm"
description: "Удалите различные подписи Digital из Docm документов. Для удаления подписей Digital требуется простой код C#."
...
steps:
    enable: true
    title_left: "Как удалить подписи Digital из документа Docm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставляет полезную функцию для очистки документов Docm от подписей Digital с помощью нескольких строк кода.
