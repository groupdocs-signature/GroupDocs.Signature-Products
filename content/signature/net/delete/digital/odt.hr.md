...
############################# Head ############################
head_title: "Izbriši Digital potpise iz Odt datoteka putem C#"
head_description: "Brisanje specifičnih Digital potpisa iz potpisanih Odt dokumenata može se lako izvesti s kratkim .NET kodom."

############################# Header ############################
title: "Uklonite potpise Digital koji se nalaze u datotekama Odt"
description: "Izbrišite razne Digital potpise iz Odt dokumenata. Uklanjanje Digital potpisa zahtijeva jednostavan C# kod."
...
steps:
    enable: true
    title_left: "Kako ukloniti Digital potpise iz vašeg Odt dokumenta"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) pruža korisnu značajku za brisanje Odt dokumenata od Digital potpisa s nekoliko redaka koda.
