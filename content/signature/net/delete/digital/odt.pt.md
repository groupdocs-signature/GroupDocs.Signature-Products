...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Odt via C#"
head_description: "A exclusão de assinaturas Digital específicas de documentos Odt assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Odt"
description: "Exclua várias assinaturas Digital de documentos Odt. A remoção de assinaturas Digital requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Digital do seu documento Odt"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Odt de assinaturas Digital com algumas linhas de código.
