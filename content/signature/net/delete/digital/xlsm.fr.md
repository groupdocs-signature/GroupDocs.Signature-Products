...
############################# Head ############################
head_title: "Supprimez les signatures Digital des fichiers Xlsm via C#"
head_description: "La suppression de signatures Digital spécifiques à partir de documents Xlsm signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Digital qui sont placées dans les fichiers Xlsm"
description: "Supprimez diverses signatures Digital des documents Xlsm. La suppression des signatures Digital nécessite un code C# simple."
...
steps:
    enable: true
    title_left: "Comment supprimer les signatures Digital de votre document Xlsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Xlsm des signatures Digital avec quelques lignes de code.
