...
############################# Head ############################
head_title: "Delete Digital signatures from Ott files via C#"
head_description: "Deletion of specific Digital signatures from signed Ott documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Ott files"
description: "Delete various Digital signatures from Ott documents. Removing Digital signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Ott documents of Digital signatures with a few lines of code.
