...
############################# Head ############################
head_title: "Vee Digital handtekeninge van Xlsm lêers uit via C#"
head_description: "Die uitvee van spesifieke Digital handtekeninge van getekende Xlsm dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Digital handtekeninge wat in Xlsm lêers geplaas is"
description: "Vee verskeie Digital handtekeninge uit Xlsm dokumente uit. Die verwydering van Digital handtekeninge vereis eenvoudige C# kode."
...
steps:
    enable: true
    title_left: "Hoe om Digital-handtekeninge uit jou Xlsm-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Xlsm dokumente van Digital handtekeninge met 'n paar reëls kode.
