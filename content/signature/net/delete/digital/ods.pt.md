...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Ods via C#"
head_description: "A exclusão de assinaturas Digital específicas de documentos Ods assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Ods"
description: "Exclua várias assinaturas Digital de documentos Ods. A remoção de assinaturas Digital requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Ods de assinaturas Digital com algumas linhas de código.
