...
############################# Head ############################
head_title: "Bi rêya C# îmzeyên Digital ji pelên Xlsb jêbirin"
head_description: "Jêbirina îmzayên taybetî yên Digital ji belgeyên îmzekirî yên Xlsb dibe ku bi koda kurt a .NET bi hêsanî were kirin."

############################# Header ############################
title: "Nîşanên Digital yên ku di pelên Xlsb de cih digirin rakin"
description: "Ji belgeyên Xlsb îmzeyên cihêreng ên Digital jêbirin. Ji rakirina îmzeyên Digital koda C# ya sade hewce dike."
...
steps:
    enable: true
    title_left: "Meriv çawa îmzayên Digital ji belgeya xweya Xlsb rabike"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) ji bo paqijkirina Xlsb belgeyên Digital bi çend rêzikên kodê taybetmendiyek bikêr peyda dike.
