...
############################# Head ############################
head_title: "Eyða Digital undirskriftum úr Xlsm skrám í gegnum C#"
head_description: "Auðvelt er að eyða tilteknum Digital undirskriftum úr undirrituðum Xlsm skjölum með stuttum .NET kóða."

############################# Header ############################
title: "Fjarlægðu Digital undirskriftir sem eru settar í Xlsm skrár"
description: "Eyða ýmsum Digital undirskriftum úr Xlsm skjölum. Til að fjarlægja Digital undirskrift þarf einfaldan C# kóða."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) býður upp á gagnlegan eiginleika til að hreinsa Xlsm skjöl af Digital undirskriftum með nokkrum línum af kóða.
