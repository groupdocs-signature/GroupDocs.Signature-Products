...
############################# Head ############################
head_title: "Usuń podpisy Digital z plików Pptx przez C#"
head_description: "Usuwanie określonych podpisów Digital z podpisanych dokumentów Pptx można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Digital podpisy umieszczone w plikach Pptx"
description: "Usuń różne podpisy Digital z dokumentów Pptx. Usunięcie podpisów Digital wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Digital z dokumentu Pptx?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Pptx z podpisami Digital za pomocą kilku linijek kodu.
