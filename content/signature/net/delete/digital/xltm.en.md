...
############################# Head ############################
head_title: "Delete Digital signatures from Xltm files via C#"
head_description: "Deletion of specific Digital signatures from signed Xltm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Xltm files"
description: "Delete various Digital signatures from Xltm documents. Removing Digital signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Xltm documents of Digital signatures with a few lines of code.
