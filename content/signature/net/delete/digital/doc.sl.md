...
############################# Head ############################
head_title: "Izbrišite podpise Digital iz datotek Doc prek C#"
head_description: "Brisanje določenih podpisov Digital iz podpisanih dokumentov Doc je mogoče preprosto izvesti s kratko kodo .NET."

############################# Header ############################
title: "Odstranite podpise Digital, ki so v datotekah Doc"
description: "Izbrišite različne podpise Digital iz dokumentov Doc. Odstranjevanje podpisov Digital zahteva preprosto kodo C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nudi uporabno funkcijo za čiščenje dokumentov Doc podpisov Digital z nekaj vrsticami kode.
