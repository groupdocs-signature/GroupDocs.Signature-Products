...
############################# Head ############################
head_title: "Ta bort Digital-signaturer från Docm-filer via C#"
head_description: "Radering av specifika Digital-signaturer från signerade Docm-dokument kan enkelt utföras med kort .NET-kod."

############################# Header ############################
title: "Ta bort Digital-signaturer som är placerade i Docm-filer"
description: "Ta bort olika Digital-signaturer från Docm-dokument. Att ta bort Digital-signaturer kräver enkel C#-kod."
...
steps:
    enable: true
    title_left: "Hur man tar bort Digital-signaturer från ditt Docm-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) tillhandahåller användbar funktion för att rensa Docm dokument från Digital signaturer med några rader kod.
