...
############################# Head ############################
head_title: "Elimina le firme Digital dai file Odt tramite C#"
head_description: "L'eliminazione di firme Digital specifiche da documenti Odt firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Digital che sono inserite nei file Odt"
description: "Elimina varie firme Digital da documenti Odt. La rimozione delle firme Digital richiede un semplice codice C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Odt di firme Digital con poche righe di codice.
