...
############################# Head ############################
head_title: "Törölje a Digital aláírásokat a Xlsx fájlokból a C# segítségével"
head_description: "Az aláírt Xlsx dokumentumokból bizonyos Digital aláírások törlése egyszerűen végrehajtható rövid .NET kóddal."

############################# Header ############################
title: "Távolítsa el a Digital aláírásokat, amelyek a Xlsx fájlokban vannak elhelyezve"
description: "Törölje a különböző Digital aláírásokat a Xlsx dokumentumokból. A Digital aláírások eltávolításához egyszerű C# kód szükséges."
...
steps:
    enable: true
    title_left: "Hogyan távolíthatja el a Digital aláírásokat a Xlsx dokumentumból"
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Xlsx dokumentumok Digital aláírásainak néhány soros kóddal történő törléséhez.
