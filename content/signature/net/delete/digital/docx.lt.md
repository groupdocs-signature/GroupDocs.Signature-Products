...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Docx failų naudodami C#"
head_description: "Konkrečius Digital parašus iš pasirašytų Docx dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Docx failuose"
description: "Ištrinkite įvairius Digital parašus iš Docx dokumentų. Norint pašalinti Digital parašus, reikia paprasto C# kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Docx dokumento"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Docx dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
