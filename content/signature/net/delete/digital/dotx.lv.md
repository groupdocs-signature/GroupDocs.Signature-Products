...
############################# Head ############################
head_title: "Dzēst Digital parakstus no Dotx failiem, izmantojot C#"
head_description: "Konkrētu Digital parakstu dzēšanu no parakstītiem Dotx dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Digital parakstus, kas ir ievietoti Dotx failos"
description: "Izdzēsiet dažādus Digital parakstus no Dotx dokumentiem. Lai noņemtu Digital parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Dotx dokumentiem notīrītu Digital parakstus, izmantojot dažas koda rindiņas.
