...
############################# Head ############################
head_title: "Vee Digital handtekeninge van Ots lêers uit via C#"
head_description: "Die uitvee van spesifieke Digital handtekeninge van getekende Ots dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Digital handtekeninge wat in Ots lêers geplaas is"
description: "Vee verskeie Digital handtekeninge uit Ots dokumente uit. Die verwydering van Digital handtekeninge vereis eenvoudige C# kode."
...
steps:
    enable: true
    title_left: "Hoe om Digital-handtekeninge uit jou Ots-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Ots dokumente van Digital handtekeninge met 'n paar reëls kode.
