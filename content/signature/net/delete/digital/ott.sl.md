...
############################# Head ############################
head_title: "Izbrišite podpise Digital iz datotek Ott prek C#"
head_description: "Brisanje določenih podpisov Digital iz podpisanih dokumentov Ott je mogoče preprosto izvesti s kratko kodo .NET."

############################# Header ############################
title: "Odstranite podpise Digital, ki so v datotekah Ott"
description: "Izbrišite različne podpise Digital iz dokumentov Ott. Odstranjevanje podpisov Digital zahteva preprosto kodo C#."
...
steps:
    enable: true
    title_left: "Kako odstraniti podpise Digital iz vašega dokumenta Ott"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nudi uporabno funkcijo za čiščenje dokumentov Ott podpisov Digital z nekaj vrsticami kode.
