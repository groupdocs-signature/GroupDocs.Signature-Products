...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Dotx via C#"
head_description: "A exclusão de assinaturas Digital específicas de documentos Dotx assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Dotx"
description: "Exclua várias assinaturas Digital de documentos Dotx. A remoção de assinaturas Digital requer um código C# simples."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Dotx de assinaturas Digital com algumas linhas de código.
