...
############################# Head ############################
head_title: "Delete Digital signatures from Docm files via C#"
head_description: "Deletion of specific Digital signatures from signed Docm documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Docm files"
description: "Delete various Digital signatures from Docm documents. Removing Digital signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Docm documents of Digital signatures with a few lines of code.
