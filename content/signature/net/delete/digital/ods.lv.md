...
############################# Head ############################
head_title: "Dzēst Digital parakstus no Ods failiem, izmantojot C#"
head_description: "Konkrētu Digital parakstu dzēšanu no parakstītiem Ods dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Digital parakstus, kas ir ievietoti Ods failos"
description: "Izdzēsiet dažādus Digital parakstus no Ods dokumentiem. Lai noņemtu Digital parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    enable: true
    title_left: "Kā noņemt Digital parakstus no sava Ods dokumenta"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Ods dokumentiem notīrītu Digital parakstus, izmantojot dažas koda rindiņas.
