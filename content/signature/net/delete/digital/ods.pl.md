...
############################# Head ############################
head_title: "Usuń podpisy Digital z plików Ods przez C#"
head_description: "Usuwanie określonych podpisów Digital z podpisanych dokumentów Ods można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Digital podpisy umieszczone w plikach Ods"
description: "Usuń różne podpisy Digital z dokumentów Ods. Usunięcie podpisów Digital wymaga prostego kodu C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Ods z podpisami Digital za pomocą kilku linijek kodu.
