...
############################# Head ############################
head_title: "Удалите подписи Digital из Xlsx файлов с помощью C#"
head_description: "Удаление определенных подписей Digital из подписанных документов Xlsx можно легко выполнить с помощью короткого кода .NET."

############################# Header ############################
title: "Удалить подписи Digital, размещенные в файлах Xlsx"
description: "Удалите различные подписи Digital из Xlsx документов. Для удаления подписей Digital требуется простой код C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставляет полезную функцию для очистки документов Xlsx от подписей Digital с помощью нескольких строк кода.
