...
############################# Head ############################
head_title: "Vee Digital handtekeninge van Dot lêers uit via C#"
head_description: "Die uitvee van spesifieke Digital handtekeninge van getekende Dot dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Digital handtekeninge wat in Dot lêers geplaas is"
description: "Vee verskeie Digital handtekeninge uit Dot dokumente uit. Die verwydering van Digital handtekeninge vereis eenvoudige C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Dot dokumente van Digital handtekeninge met 'n paar reëls kode.
