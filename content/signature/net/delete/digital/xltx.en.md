...
############################# Head ############################
head_title: "Delete Digital signatures from Xltx files via C#"
head_description: "Deletion of specific Digital signatures from signed Xltx documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Xltx files"
description: "Delete various Digital signatures from Xltx documents. Removing Digital signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Digital signatures from your Xltx document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Xltx documents of Digital signatures with a few lines of code.
