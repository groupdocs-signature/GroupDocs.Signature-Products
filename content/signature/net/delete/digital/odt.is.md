...
############################# Head ############################
head_title: "Eyða Digital undirskriftum úr Odt skrám í gegnum C#"
head_description: "Auðvelt er að eyða tilteknum Digital undirskriftum úr undirrituðum Odt skjölum með stuttum .NET kóða."

############################# Header ############################
title: "Fjarlægðu Digital undirskriftir sem eru settar í Odt skrár"
description: "Eyða ýmsum Digital undirskriftum úr Odt skjölum. Til að fjarlægja Digital undirskrift þarf einfaldan C# kóða."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) býður upp á gagnlegan eiginleika til að hreinsa Odt skjöl af Digital undirskriftum með nokkrum línum af kóða.
