...
############################# Head ############################
head_title: "Ջնջել Digital ստորագրությունները Dotx ֆայլերից C#-ի միջոցով"
head_description: "Ստորագրված Dotx փաստաթղթերից որոշակի Digital ստորագրությունների ջնջումը կարող է հեշտությամբ իրականացվել կարճ .NET կոդով:"

############################# Header ############################
title: "Հեռացրեք Digital ստորագրությունները, որոնք տեղադրված են Dotx ֆայլերում"
description: "Ջնջել տարբեր Digital ստորագրությունները Dotx փաստաթղթերից: Digital ստորագրությունները հեռացնելու համար անհրաժեշտ է պարզ C# կոդ:"
...
steps:
    enable: true
    title_left: "Ինչպես հեռացնել Digital ստորագրությունները ձեր Dotx փաստաթղթից"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) օգտակար հատկություն է տրամադրում Dotx փաստաթղթերը Digital ստորագրություններից մի քանի տող կոդով մաքրելու համար:
