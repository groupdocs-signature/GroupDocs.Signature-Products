...
############################# Head ############################
head_title: "Usuń podpisy Digital z plików Docm przez C#"
head_description: "Usuwanie określonych podpisów Digital z podpisanych dokumentów Docm można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Digital podpisy umieszczone w plikach Docm"
description: "Usuń różne podpisy Digital z dokumentów Docm. Usunięcie podpisów Digital wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Digital z dokumentu Docm?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Docm z podpisami Digital za pomocą kilku linijek kodu.
