...
############################# Head ############################
head_title: "Usuń podpisy Digital z plików Xltm przez C#"
head_description: "Usuwanie określonych podpisów Digital z podpisanych dokumentów Xltm można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Digital podpisy umieszczone w plikach Xltm"
description: "Usuń różne podpisy Digital z dokumentów Xltm. Usunięcie podpisów Digital wymaga prostego kodu C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Xltm z podpisami Digital za pomocą kilku linijek kodu.
