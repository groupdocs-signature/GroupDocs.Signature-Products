...
############################# Head ############################
head_title: "Izbrišite podpise Digital iz datotek Ots prek C#"
head_description: "Brisanje določenih podpisov Digital iz podpisanih dokumentov Ots je mogoče preprosto izvesti s kratko kodo .NET."

############################# Header ############################
title: "Odstranite podpise Digital, ki so v datotekah Ots"
description: "Izbrišite različne podpise Digital iz dokumentov Ots. Odstranjevanje podpisov Digital zahteva preprosto kodo C#."
...
steps:
    enable: true
    title_left: "Kako odstraniti podpise Digital iz vašega dokumenta Ots"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nudi uporabno funkcijo za čiščenje dokumentov Ots podpisov Digital z nekaj vrsticami kode.
