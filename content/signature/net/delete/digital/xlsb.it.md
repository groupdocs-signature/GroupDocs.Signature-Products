...
############################# Head ############################
head_title: "Elimina le firme Digital dai file Xlsb tramite C#"
head_description: "L'eliminazione di firme Digital specifiche da documenti Xlsb firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Digital che sono inserite nei file Xlsb"
description: "Elimina varie firme Digital da documenti Xlsb. La rimozione delle firme Digital richiede un semplice codice C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Xlsb di firme Digital con poche righe di codice.
