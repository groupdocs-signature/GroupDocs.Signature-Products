...
############################# Head ############################
head_title: "Slett Digital-signaturer fra Xlsx-filer via C#"
head_description: "Sletting av spesifikke Digital-signaturer fra signerte Xlsx-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Digital-signaturer som er plassert i Xlsx-filer"
description: "Slett forskjellige Digital-signaturer fra Xlsx-dokumenter. Fjerning av Digital-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Xlsx dokumenter for Digital signaturer med noen få linjer med kode.
