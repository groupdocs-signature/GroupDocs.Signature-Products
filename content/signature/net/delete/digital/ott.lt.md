...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Ott failų naudodami C#"
head_description: "Konkrečius Digital parašus iš pasirašytų Ott dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Ott failuose"
description: "Ištrinkite įvairius Digital parašus iš Ott dokumentų. Norint pašalinti Digital parašus, reikia paprasto C# kodo."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Ott dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
