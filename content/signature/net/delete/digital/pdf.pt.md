...
############################# Head ############################
head_title: "Excluir assinaturas Digital de arquivos Pdf via C#"
head_description: "A exclusão de assinaturas Digital específicas de documentos Pdf assinados pode ser realizada facilmente com o código curto .NET."

############################# Header ############################
title: "Remova as assinaturas Digital que são colocadas em arquivos Pdf"
description: "Exclua várias assinaturas Digital de documentos Pdf. A remoção de assinaturas Digital requer um código C# simples."
...
steps:
    enable: true
    title_left: "Como remover assinaturas Digital do seu documento Pdf"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornece um recurso útil para limpar documentos Pdf de assinaturas Digital com algumas linhas de código.
