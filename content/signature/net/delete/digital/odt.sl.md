...
############################# Head ############################
head_title: "Izbrišite podpise Digital iz datotek Odt prek C#"
head_description: "Brisanje določenih podpisov Digital iz podpisanih dokumentov Odt je mogoče preprosto izvesti s kratko kodo .NET."

############################# Header ############################
title: "Odstranite podpise Digital, ki so v datotekah Odt"
description: "Izbrišite različne podpise Digital iz dokumentov Odt. Odstranjevanje podpisov Digital zahteva preprosto kodo C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nudi uporabno funkcijo za čiščenje dokumentov Odt podpisov Digital z nekaj vrsticami kode.
