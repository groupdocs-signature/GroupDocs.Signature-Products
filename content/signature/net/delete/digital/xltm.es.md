...
############################# Head ############################
head_title: "Eliminar Digital firmas de Xltm archivos a través de C#"
head_description: "La eliminación de firmas Digital específicas de documentos Xltm firmados se puede realizar fácilmente con el código corto .NET."

############################# Header ############################
title: "Eliminar Digital firmas que se colocan en archivos Xltm"
description: "Elimine varias firmas Digital de los documentos Xltm. Eliminar las firmas Digital requiere un código C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona una característica útil para borrar documentos Xltm de Digital firmas con unas pocas líneas de código.
