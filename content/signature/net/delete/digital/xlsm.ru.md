...
############################# Head ############################
head_title: "Удалите подписи Digital из Xlsm файлов с помощью C#"
head_description: "Удаление определенных подписей Digital из подписанных документов Xlsm можно легко выполнить с помощью короткого кода .NET."

############################# Header ############################
title: "Удалить подписи Digital, размещенные в файлах Xlsm"
description: "Удалите различные подписи Digital из Xlsm документов. Для удаления подписей Digital требуется простой код C#."
...
steps:
    enable: true
    title_left: "Как удалить подписи Digital из документа Xlsm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставляет полезную функцию для очистки документов Xlsm от подписей Digital с помощью нескольких строк кода.
