...
############################# Head ############################
head_title: "احذف توقيعات Digital من ملفات Ott عبر C#"
head_description: "يمكن إجراء حذف توقيعات معينة من Digital من مستندات Ott الموقعة بسهولة باستخدام رمز .NET القصير."

############################# Header ############################
title: "قم بإزالة Digital التوقيعات التي يتم وضعها في ملفات Ott"
description: "احذف العديد من توقيعات Digital من مستندات Ott. تتطلب إزالة توقيعات Digital شفرة C# بسيطة."
...
steps:
    ...
    content_left: |
        يوفر [GroupDocs.Signature for .NET] (https://products.groupdocs.com/signature/net/) ميزة مفيدة لمسح Ott مستندات توقيعات Digital ببضعة أسطر من التعليمات البرمجية.
