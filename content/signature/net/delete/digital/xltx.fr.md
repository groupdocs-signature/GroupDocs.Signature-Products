...
############################# Head ############################
head_title: "Supprimez les signatures Digital des fichiers Xltx via C#"
head_description: "La suppression de signatures Digital spécifiques à partir de documents Xltx signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Digital qui sont placées dans les fichiers Xltx"
description: "Supprimez diverses signatures Digital des documents Xltx. La suppression des signatures Digital nécessite un code C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Xltx des signatures Digital avec quelques lignes de code.
