...
############################# Head ############################
head_title: "Delete Digital signatures from Pdf files via C#"
head_description: "Deletion of specific Digital signatures from signed Pdf documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Pdf files"
description: "Delete various Digital signatures from Pdf documents. Removing Digital signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Pdf documents of Digital signatures with a few lines of code.
