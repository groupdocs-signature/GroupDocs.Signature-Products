...
############################# Head ############################
head_title: "Slet Digital signaturer fra Pdf filer via C#"
head_description: "Sletning af specifikke Digital-signaturer fra signerede Pdf-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Digital-signaturer, der er placeret i Pdf-filer"
description: "Slet forskellige Digital-signaturer fra Pdf-dokumenter. Fjernelse af Digital signaturer kræver simpel C# kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Digital-signaturer fra dit Pdf-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Pdf dokumenter for Digital signaturer med et par linjer kode.
