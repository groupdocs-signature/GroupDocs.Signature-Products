...
############################# Head ############################
head_title: "Vee Digital handtekeninge van Xltm lêers uit via C#"
head_description: "Die uitvee van spesifieke Digital handtekeninge van getekende Xltm dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Digital handtekeninge wat in Xltm lêers geplaas is"
description: "Vee verskeie Digital handtekeninge uit Xltm dokumente uit. Die verwydering van Digital handtekeninge vereis eenvoudige C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Xltm dokumente van Digital handtekeninge met 'n paar reëls kode.
