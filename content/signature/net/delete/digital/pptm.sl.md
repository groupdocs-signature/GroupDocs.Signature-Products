...
############################# Head ############################
head_title: "Izbrišite podpise Digital iz datotek Pptm prek C#"
head_description: "Brisanje določenih podpisov Digital iz podpisanih dokumentov Pptm je mogoče preprosto izvesti s kratko kodo .NET."

############################# Header ############################
title: "Odstranite podpise Digital, ki so v datotekah Pptm"
description: "Izbrišite različne podpise Digital iz dokumentov Pptm. Odstranjevanje podpisov Digital zahteva preprosto kodo C#."
...
steps:
    enable: true
    title_left: "Kako odstraniti podpise Digital iz vašega dokumenta Pptm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nudi uporabno funkcijo za čiščenje dokumentov Pptm podpisov Digital z nekaj vrsticami kode.
