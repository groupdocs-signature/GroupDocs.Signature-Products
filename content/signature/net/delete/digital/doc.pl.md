...
############################# Head ############################
head_title: "Usuń podpisy Digital z plików Doc przez C#"
head_description: "Usuwanie określonych podpisów Digital z podpisanych dokumentów Doc można łatwo wykonać za pomocą krótkiego kodu .NET."

############################# Header ############################
title: "Usuń Digital podpisy umieszczone w plikach Doc"
description: "Usuń różne podpisy Digital z dokumentów Doc. Usunięcie podpisów Digital wymaga prostego kodu C#."
...
steps:
    enable: true
    title_left: "Jak usunąć podpisy Digital z dokumentu Doc?"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) zapewnia użyteczną funkcję do czyszczenia dokumentów Doc z podpisami Digital za pomocą kilku linijek kodu.
