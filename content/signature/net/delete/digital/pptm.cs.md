...
############################# Head ############################
head_title: "Odstraňte podpisy Digital ze souborů Pptm prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Digital z podepsaných dokumentů Pptm lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Digital podpisy, které jsou umístěny v souborech Pptm"
description: "Odstraňte různé podpisy Digital z dokumentů Pptm. Odstranění podpisů Digital vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Digital z vašeho dokumentu Pptm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Pptm dokumentů od Digital podpisů pomocí několika řádků kódu.
