...
############################# Head ############################
head_title: "Slet Digital signaturer fra Xlsx filer via C#"
head_description: "Sletning af specifikke Digital-signaturer fra signerede Xlsx-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Digital-signaturer, der er placeret i Xlsx-filer"
description: "Slet forskellige Digital-signaturer fra Xlsx-dokumenter. Fjernelse af Digital signaturer kræver simpel C# kode."
...
steps:
    enable: true
    title_left: "Sådan fjerner du Digital-signaturer fra dit Xlsx-dokument"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Xlsx dokumenter for Digital signaturer med et par linjer kode.
