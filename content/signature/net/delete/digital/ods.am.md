...
############################# Head ############################
head_title: "የDigital ፊርማዎችን ከOds ፋይሎች በC# በኩል ሰርዝ"
head_description: "ከተፈረሙ Ods ሰነዶች የተወሰኑ የDigital ፊርማዎችን መሰረዝ በአጭር የ.NET ኮድ በቀላሉ ሊከናወን ይችላል።"
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) የOds ሰነዶችን የDigital ፊርማዎችን በጥቂት የኮድ መስመሮች ለማጽዳት ጠቃሚ ባህሪን ይሰጣል።
