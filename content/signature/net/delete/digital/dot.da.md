...
############################# Head ############################
head_title: "Slet Digital signaturer fra Dot filer via C#"
head_description: "Sletning af specifikke Digital-signaturer fra signerede Dot-dokumenter kan udføres nemt med en kort .NET-kode."

############################# Header ############################
title: "Fjern Digital-signaturer, der er placeret i Dot-filer"
description: "Slet forskellige Digital-signaturer fra Dot-dokumenter. Fjernelse af Digital signaturer kræver simpel C# kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) giver nyttige funktioner til at rydde Dot dokumenter for Digital signaturer med et par linjer kode.
