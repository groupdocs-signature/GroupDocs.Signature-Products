...
############################# Head ############################
head_title: "Supprimez les signatures Digital des fichiers Pdf via C#"
head_description: "La suppression de signatures Digital spécifiques à partir de documents Pdf signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Digital qui sont placées dans les fichiers Pdf"
description: "Supprimez diverses signatures Digital des documents Pdf. La suppression des signatures Digital nécessite un code C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Pdf des signatures Digital avec quelques lignes de code.
