...
############################# Head ############################
head_title: "Delete Digital signatures from Odt files via C#"
head_description: "Deletion of specific Digital signatures from signed Odt documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Odt files"
description: "Delete various Digital signatures from Odt documents. Removing Digital signatures requires simple C# code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Odt documents of Digital signatures with a few lines of code.
