...
############################# Head ############################
head_title: "Supprimez les signatures Digital des fichiers Pptx via C#"
head_description: "La suppression de signatures Digital spécifiques à partir de documents Pptx signés peut être effectuée facilement avec un code .NET court."

############################# Header ############################
title: "Supprimer les signatures Digital qui sont placées dans les fichiers Pptx"
description: "Supprimez diverses signatures Digital des documents Pptx. La suppression des signatures Digital nécessite un code C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fournit une fonctionnalité utile pour effacer les documents Pptx des signatures Digital avec quelques lignes de code.
