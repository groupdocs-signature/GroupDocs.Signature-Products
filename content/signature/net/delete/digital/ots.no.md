...
############################# Head ############################
head_title: "Slett Digital-signaturer fra Ots-filer via C#"
head_description: "Sletting av spesifikke Digital-signaturer fra signerte Ots-dokumenter kan enkelt utføres med kort .NET-kode."

############################# Header ############################
title: "Fjern Digital-signaturer som er plassert i Ots-filer"
description: "Slett forskjellige Digital-signaturer fra Ots-dokumenter. Fjerning av Digital-signaturer krever enkel C#-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) gir nyttig funksjon for å tømme Ots dokumenter for Digital signaturer med noen få linjer med kode.
