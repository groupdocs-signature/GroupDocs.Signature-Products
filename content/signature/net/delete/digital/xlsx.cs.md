...
############################# Head ############################
head_title: "Odstraňte podpisy Digital ze souborů Xlsx prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Digital z podepsaných dokumentů Xlsx lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Digital podpisy, které jsou umístěny v souborech Xlsx"
description: "Odstraňte různé podpisy Digital z dokumentů Xlsx. Odstranění podpisů Digital vyžaduje jednoduchý kód C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Xlsx dokumentů od Digital podpisů pomocí několika řádků kódu.
