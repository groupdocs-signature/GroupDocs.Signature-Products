...
############################# Head ############################
head_title: "Ištrinkite Digital parašus iš Ots failų naudodami C#"
head_description: "Konkrečius Digital parašus iš pasirašytų Ots dokumentų galima lengvai ištrinti naudojant trumpą .NET kodą."

############################# Header ############################
title: "Pašalinkite Digital parašus, kurie yra Ots failuose"
description: "Ištrinkite įvairius Digital parašus iš Ots dokumentų. Norint pašalinti Digital parašus, reikia paprasto C# kodo."
...
steps:
    enable: true
    title_left: "Kaip pašalinti Digital parašus iš Ots dokumento"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) yra naudinga funkcija, skirta išvalyti Ots dokumentus nuo Digital parašų naudojant kelias kodo eilutes.
