...
############################# Head ############################
head_title: "Dzēst Digital parakstus no Docx failiem, izmantojot C#"
head_description: "Konkrētu Digital parakstu dzēšanu no parakstītiem Docx dokumentiem var viegli veikt, izmantojot īsu .NET kodu."

############################# Header ############################
title: "Noņemiet Digital parakstus, kas ir ievietoti Docx failos"
description: "Izdzēsiet dažādus Digital parakstus no Docx dokumentiem. Lai noņemtu Digital parakstus, ir nepieciešams vienkāršs C# kods."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) nodrošina noderīgu līdzekli, lai no Docx dokumentiem notīrītu Digital parakstus, izmantojot dažas koda rindiņas.
