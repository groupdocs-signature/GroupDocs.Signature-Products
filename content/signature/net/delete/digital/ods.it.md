...
############################# Head ############################
head_title: "Elimina le firme Digital dai file Ods tramite C#"
head_description: "L'eliminazione di firme Digital specifiche da documenti Ods firmati può essere eseguita facilmente con il codice .NET breve."

############################# Header ############################
title: "Rimuovi le firme Digital che sono inserite nei file Ods"
description: "Elimina varie firme Digital da documenti Ods. La rimozione delle firme Digital richiede un semplice codice C#."
...
steps:
    enable: true
    title_left: "Come rimuovere le firme Digital dal tuo documento Ods"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) fornisce una funzione utile per cancellare documenti Ods di firme Digital con poche righe di codice.
