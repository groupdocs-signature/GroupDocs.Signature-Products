...
############################# Head ############################
head_title: "Verwijder Digital handtekeningen uit Odt bestanden via C#"
head_description: "Het verwijderen van specifieke Digital handtekeningen uit ondertekende Odt documenten kan gemakkelijk worden uitgevoerd met korte .NET code."

############################# Header ############################
title: "Verwijder Digital handtekeningen die in Odt bestanden zijn geplaatst"
description: "Verwijder verschillende Digital handtekeningen uit Odt documenten. Voor het verwijderen van Digital-handtekeningen is een eenvoudige C#-code vereist."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) biedt een handige functie voor het wissen van Odt documenten van Digital handtekeningen met een paar regels code.
