...
############################# Head ############################
head_title: "Vee Digital handtekeninge van Docx lêers uit via C#"
head_description: "Die uitvee van spesifieke Digital handtekeninge van getekende Docx dokumente kan maklik uitgevoer word met kort .NET kode."

############################# Header ############################
title: "Verwyder Digital handtekeninge wat in Docx lêers geplaas is"
description: "Vee verskeie Digital handtekeninge uit Docx dokumente uit. Die verwydering van Digital handtekeninge vereis eenvoudige C# kode."
...
steps:
    enable: true
    title_left: "Hoe om Digital-handtekeninge uit jou Docx-dokument te verwyder"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bied nuttige kenmerk vir die skoonmaak van Docx dokumente van Digital handtekeninge met 'n paar reëls kode.
