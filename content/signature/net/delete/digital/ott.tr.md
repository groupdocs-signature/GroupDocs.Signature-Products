...
############################# Head ############################
head_title: "C# aracılığıyla Ott dosyalarından Digital imzasını silin"
head_description: "İmzalı Ott belgelerindeki belirli Digital imzalarının silinmesi kısa .NET koduyla kolayca gerçekleştirilebilir."

############################# Header ############################
title: "Ott dosyalarına yerleştirilmiş Digital imzalarını kaldırın"
description: "Ott dokümanlarından çeşitli Digital imzalarını silin. Digital imzasını kaldırmak için basit C# kodu gerekir."
...
steps:
    enable: true
    title_left: "Ott belgenizden Digital imzaları nasıl kaldırılır"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/), Ott belgelerindeki Digital imzalarını birkaç satır kodla temizlemek için kullanışlı bir özellik sağlar.
