...
############################# Head ############################
head_title: "Изтрийте Digital подписи от Xlsx файлове чрез C#"
head_description: "Изтриването на конкретни Digital подписи от подписани Xlsx документи може да се извърши лесно с кратък .NET код."

############################# Header ############################
title: "Премахнете Digital подписи, които са поставени във Xlsx файлове"
description: "Изтрийте различни подписи Digital от Xlsx документи. Премахването на подписи Digital изисква прост код C#."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) предоставя полезна функция за изчистване на Xlsx документи от Digital подписи с няколко реда код.
