...
############################# Head ############################
head_title: "Törölje a Digital aláírásokat a Ods fájlokból a C# segítségével"
head_description: "Az aláírt Ods dokumentumokból bizonyos Digital aláírások törlése egyszerűen végrehajtható rövid .NET kóddal."

############################# Header ############################
title: "Távolítsa el a Digital aláírásokat, amelyek a Ods fájlokban vannak elhelyezve"
description: "Törölje a különböző Digital aláírásokat a Ods dokumentumokból. A Digital aláírások eltávolításához egyszerű C# kód szükséges."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) hasznos funkciót biztosít a Ods dokumentumok Digital aláírásainak néhány soros kóddal történő törléséhez.
