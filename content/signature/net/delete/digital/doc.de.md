...
############################# Head ############################
head_title: "Löschen Sie Digital-Signaturen aus Doc-Dateien über C#"
head_description: "Das Löschen bestimmter Digital-Signaturen aus signierten Doc-Dokumenten kann einfach mit dem kurzen .NET-Code durchgeführt werden."

############################# Header ############################
title: "Entfernen Sie Digital-Signaturen, die in Doc-Dateien platziert sind"
description: "Löschen Sie verschiedene Digital-Signaturen aus Doc-Dokumenten. Das Entfernen von Digital-Signaturen erfordert einfachen C#-Code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) bietet eine nützliche Funktion zum Löschen von Doc-Dokumenten von Digital-Signaturen mit ein paar Codezeilen.
