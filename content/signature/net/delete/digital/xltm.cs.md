...
############################# Head ############################
head_title: "Odstraňte podpisy Digital ze souborů Xltm prostřednictvím C#"
head_description: "Odstranění konkrétních podpisů Digital z podepsaných dokumentů Xltm lze snadno provést pomocí krátkého kódu .NET."

############################# Header ############################
title: "Odstraňte Digital podpisy, které jsou umístěny v souborech Xltm"
description: "Odstraňte různé podpisy Digital z dokumentů Xltm. Odstranění podpisů Digital vyžaduje jednoduchý kód C#."
...
steps:
    enable: true
    title_left: "Jak odstranit podpisy Digital z vašeho dokumentu Xltm"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) poskytuje užitečnou funkci pro vymazání Xltm dokumentů od Digital podpisů pomocí několika řádků kódu.
