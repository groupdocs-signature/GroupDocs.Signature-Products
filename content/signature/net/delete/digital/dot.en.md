...
############################# Head ############################
head_title: "Delete Digital signatures from Dot files via C#"
head_description: "Deletion of specific Digital signatures from signed Dot documents might be performed easily with short .NET code."

############################# Header ############################
title: "Remove Digital signatures which are placed in Dot files"
description: "Delete various Digital signatures from Dot documents. Removing Digital signatures requires simple C# code."
...
steps:
    enable: true
    title_left: "How to remove Digital signatures from your Dot document"
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) provides useful feature for clearing Dot documents of Digital signatures with a few lines of code.
