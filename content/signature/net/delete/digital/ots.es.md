...
############################# Head ############################
head_title: "Eliminar Digital firmas de Ots archivos a través de C#"
head_description: "La eliminación de firmas Digital específicas de documentos Ots firmados se puede realizar fácilmente con el código corto .NET."

############################# Header ############################
title: "Eliminar Digital firmas que se colocan en archivos Ots"
description: "Elimine varias firmas Digital de los documentos Ots. Eliminar las firmas Digital requiere un código C# simple."
...
steps:
    ...
    content_left: |
        [GroupDocs.Signature for .NET](https://products.groupdocs.com/signature/net/) proporciona una característica útil para borrar documentos Ots de Digital firmas con unas pocas líneas de código.
