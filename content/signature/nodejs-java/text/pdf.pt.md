...
############################# Head ############################
head_title: "Adicione assinaturas de texto a PDF via JavaScript"
head_description: "Utilize a API JavaScript para integrar assinaturas de texto em documentos PDF de forma simplificada. Nossa API suporta uma ampla gama de formatos, incluindo PDF, Word, Excel, Apresentações, Imagens e arquivos ZIP."
...
steps:
    enable: true
    title: "Guia para criar assinaturas de texto para PDF usando JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) permite a adição de assinaturas de texto a documentos PDF dentro de aplicações Node.js via Java. Melhore rapidamente as capacidades do seu produto com nossas soluções robustas.
