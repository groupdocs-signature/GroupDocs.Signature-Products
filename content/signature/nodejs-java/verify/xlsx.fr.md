...
############################# Head ############################
head_title: "Vérifiez les signatures numériques dans XLSX via JavaScript"
head_description: "Avec GroupDocs.Signature for Node.js via Java, vous pouvez vérifier efficacement l'authenticité des signatures dans les documents XLSX. Vérifiez sans effort les signatures dans les PDF, Word, Excel, Présentations, Images, fichiers ZIP, et plus encore."

############################# Header ############################
title: "Vérifiez les signatures numériques dans XLSX" 
...
steps:
    enable: true
    title: "Comment vérifier les signatures dans XLSX avec JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) peut authentifier la présence de signatures spécifiques dans un document XLSX. Les développeurs Node.js via Java peuvent facilement améliorer leurs applications en intégrant nos fonctionnalités de vérification.
      
      1. Chargez le document XLSX dans l'instance Signature.
