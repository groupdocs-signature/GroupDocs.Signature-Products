...
############################# Head ############################
head_title: "XLSX에서 JavaScript를 사용하여 디지털 서명 검증"
head_description: "GroupDocs.Signature for Node.js via Java를 사용하면 XLSX 문서 내 서명의 진위를 효율적으로 검증할 수 있습니다. PDF, Word, Excel, 프레젠테이션, 이미지, ZIP 파일 등에서 서명을 원활하게 확인하세요."

############################# Header ############################
title: "XLSX에서 디지털 서명 검증" 
...
steps:
    enable: true
    title: "JavaScript를 사용하여 XLSX에서 서명을 검증하는 방법"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/)는 XLSX 문서에서 특정 서명의 존재를 인증할 수 있습니다. Node.js via Java 개발자는 당사의 검증 기능을 통합하여 애플리케이션을 향상시킬 수 있습니다.
      
      1. Signature 인스턴스에 XLSX 문서를 로드합니다.
