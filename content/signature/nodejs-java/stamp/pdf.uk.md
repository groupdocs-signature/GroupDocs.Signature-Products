...
############################# Head ############################
head_title: "Генерація та додавання штампів до PDF через JavaScript"
head_description: "Скористайтеся потужністю GroupDocs.Signature та JavaScript, щоб генерувати та розміщувати індивідуальні штампи на будь-якій сторінці ваших документів PDF."

############################# Header ############################
title: "Вставка налаштованих штампів у файли PDF" 
...
steps:
    enable: true
    title: "Посібник з вбудовування штампів у PDF за допомогою JavaScript"
    content: |
      ...
      1. Введіть документ PDF, який потребує штампування.
