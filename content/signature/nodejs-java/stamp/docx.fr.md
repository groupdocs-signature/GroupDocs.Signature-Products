...
############################# Head ############################
head_title: "Générez et ajoutez des tampons aux DOCX via JavaScript"
head_description: "Profitez de la puissance de GroupDocs.Signature et JavaScript pour créer et placer des tampons personnalisés sur n'importe quelle page de vos documents DOCX."

############################# Header ############################
title: "Insérez des tampons personnalisés dans des fichiers DOCX" 
...
steps:
    enable: true
    title: "Guide pour intégrer des tampons dans DOCX avec JavaScript"
    content: |
      ...
      1. Saisissez le document DOCX nécessitant le tampon.
