...
############################# Head ############################
head_title: "Генерация и добавление штампов в XLSX с помощью JavaScript"
head_description: "Используйте возможности GroupDocs.Signature и JavaScript для создания и размещения пользовательских штампов на любой странице ваших документов XLSX."

############################# Header ############################
title: "Вставка индивидуализированных штампов в файлы XLSX" 
...
steps:
    enable: true
    title: "Руководство по вставке штампов в XLSX с использованием JavaScript"
    content: |
      ...
      1. Введите документ XLSX, который требует штамповки.
