...
############################# Head ############################
head_title: "Generar y añadir sellos a XLSX mediante JavaScript"
head_description: "Aproveche el poder de GroupDocs.Signature y JavaScript para generar y colocar sellos personalizados en cualquier página de sus documentos XLSX."

############################# Header ############################
title: "Inserte sellos personalizados en archivos XLSX" 
...
steps:
    enable: true
    title: "Guía para incrustar sellos en XLSX usando JavaScript"
    content: |
      ...
      1. Introduzca el documento XLSX que necesita ser sellado.
