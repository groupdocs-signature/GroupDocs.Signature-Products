...
############################# Head ############################
head_title: "Genera e aggiungi timbri a JPEG tramite JavaScript"
head_description: "Sfrutta la potenza di GroupDocs.Signature e JavaScript per generare e posizionare timbri personalizzati su qualsiasi pagina dei tuoi documenti JPEG."

############################# Header ############################
title: "Inserisci timbri personalizzati nei file JPEG" 
...
steps:
    enable: true
    title: "Guida all'inserimento di timbri in JPEG utilizzando JavaScript"
    content: |
      ...
      1. Inserisci il documento JPEG che richiede timbratura.
