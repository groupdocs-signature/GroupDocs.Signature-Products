...
############################# Head ############################
head_title: "Buat dan tambahkan cap ke XLSX melalui JavaScript"
head_description: "Manfaatkan kekuatan GroupDocs.Signature dan JavaScript untuk menghasilkan dan menempatkan cap kustom di setiap halaman dalam dokumen XLSX Anda."

############################# Header ############################
title: "Sisipkan cap kustom ke dalam file XLSX" 
...
steps:
    enable: true
    title: "Panduan untuk menyematkan cap di XLSX menggunakan JavaScript"
    content: |
      ...
      1. Masukkan dokumen XLSX yang memerlukan cap.
