...
############################# Head ############################
head_title: "PPTX에 JavaScript를 통한 스탬프 생성 및 추가"
head_description: "GroupDocs.Signature와 JavaScript의 힘을 활용하여 귀하의 PPTX 문서 내 모든 페이지에 맞춤형 스탬프를 생성하고 배치하십시오."

############################# Header ############################
title: "PPTX 파일에 맞춤형 스탬프 삽입" 
...
steps:
    enable: true
    title: "JavaScript를 사용한 PPTX에 스탬프 삽입 가이드"
    content: |
