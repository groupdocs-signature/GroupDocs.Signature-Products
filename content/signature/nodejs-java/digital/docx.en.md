...
############################# Head ############################
head_title: "Adding digital electronic signatures to DOCX file with JavaScript"
head_description: "Put a digital signature on a DOCX file using JavaScript with just a few lines of code. Use GroupDocs.Signature for Node.js via Java to sign numerous file formats."
...
steps:
    enable: true
    title: "Guidelines for securing DOCX with digital certificates in JavaScript"
    content: |
