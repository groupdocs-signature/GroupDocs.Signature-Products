...
############################# Head ############################
head_title: "Adicionando assinaturas eletrônicas digitais a arquivos PDF com JavaScript"
head_description: "Coloque uma assinatura digital em um arquivo PDF usando JavaScript com apenas algumas linhas de código. Utilize GroupDocs.Signature for Node.js via Java para assinar diversos formatos de arquivo."

############################# Header ############################
title: "Proteja PDF com certificados digitais" 
...
steps:
    enable: true
    title: "Diretrizes para proteger PDF com certificados digitais em JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) permite aos desenvolvedores Node.js via Java proteger documentos PDF contra modificações utilizando assinaturas digitais. Melhore suas aplicações empresariais com recursos abrangentes de segurança de dados.
