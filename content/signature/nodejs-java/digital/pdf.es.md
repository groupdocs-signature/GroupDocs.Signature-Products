...
############################# Head ############################
head_title: "Agregar firmas electrónicas digitales a archivos PDF con JavaScript"
head_description: "Coloca una firma digital en un archivo PDF usando JavaScript con solo unas pocas líneas de código. Usa GroupDocs.Signature for Node.js via Java para firmar numerosos formatos de archivo."

############################# Header ############################
title: "Protege PDF con certificados digitales" 
...
steps:
    enable: true
    title: "Guías para asegurar PDF con certificados digitales en JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) permite a los desarrolladores de Node.js via Java proteger documentos PDF de modificaciones mediante la utilización de firmas digitales. Mejora tus aplicaciones empresariales con sólidos recursos de seguridad de datos.
