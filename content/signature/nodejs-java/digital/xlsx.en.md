...
############################# Head ############################
head_title: "Protect XLSX from Unauthorized Modifications Using JavaScript Applications"
head_description: "Harness the power of JavaScript applications with GroupDocs.Signature to secure XLSX documents through digital certificates."

############################# Header ############################
title: "Safeguard XLSX with Digital Certificates via JavaScript" 
...
steps:
    enable: true
    title: "Guidelines for Securing XLSX Documents with Digital Certificates in JavaScript"
    content: |
      ...
      1. Pass the XLSX document to the Signature class constructor.
