...
############################# Head ############################
head_title: "Generate QR codes in JPEG docs with JavaScript"
...
steps:
    enable: true
    title: "Guide to generating and embedding a QR code in any place within a JPEG"
    content: |
