...
############################# Head ############################
head_title: "Hasilkan kode QR dalam dokumen PPTX dengan JavaScript"
head_description: "Manfaatkan API GroupDocs.Signature untuk membuat dan mengintegrasikan barcode 2D ke dalam file PPTX. Tempatkan kode QR di halaman dokumen mana pun."
...
steps:
    enable: true
    title: "Panduan untuk menghasilkan dan menyematkan kode QR di mana saja dalam PPTX"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) memungkinkan pembuatan kode QR dalam berbagai format yang banyak digunakan dan integrasinya ke dalam halaman PPTX. Mendukung lebih dari 10 jenis kode QR yang berbeda, solusi kami dapat dengan mulus diintegrasikan ke dalam aplikasi Node.js via Java, memperkaya mereka dengan kemampuan tanda tangan kode QR.
      
      1. Sediakan file atau stream PPTX untuk penandatanganan kode QR.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Menyesuaikan kode QR yang dihasilkan"
      content: |
        Contoh ini menjelaskan proses penambahan kode QR yang disesuaikan ke halaman PPTX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
