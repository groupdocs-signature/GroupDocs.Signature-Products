...
############################# Head ############################
head_title: "Tạo mã QR trong tài liệu XLSX với JavaScript"
head_description: "Sử dụng API GroupDocs.Signature để tạo và tích hợp mã vạch 2D vào các tệp XLSX. Đặt mã QR một cách linh hoạt trên bất kỳ trang tài liệu nào."
...
steps:
    enable: true
    title: "Hướng dẫn tạo và nhúng mã QR vào bất kỳ vị trí nào trong XLSX"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) cho phép tạo mã QR trong nhiều định dạng phổ biến và tích hợp chúng vào các trang XLSX. Hỗ trợ hơn 10 loại mã QR khác nhau, giải pháp của chúng tôi có thể được tích hợp liền mạch vào các ứng dụng Node.js via Java, làm phong phú thêm khả năng ký mã QR.
      
      1. Cung cấp tệp XLSX hoặc luồng để ký mã QR.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Tùy chỉnh mã QR được tạo ra"
      content: |
        Ví dụ này chi tiết quy trình thêm mã QR tùy chỉnh vào một trang XLSX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
