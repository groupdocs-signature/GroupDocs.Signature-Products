...
############################# Head ############################
head_title: "JavaScript로 PPTX에 전자 서명하기"
head_description: "JavaScript API의 기능을 활용하여 PDF, Word 문서, Excel 시트, 프레젠테이션 및 이미지 형식을 포함한 PPTX 파일을 디지털 서명하고 보호합니다."

############################# Header ############################
title: "PPTX 파일을 전자적으로 서명하기" 
...
steps:
    enable: true
    title: "JavaScript를 사용하여 PPTX에 서명하는 단계"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/)는 PPTX 파일에 사용자 지정 서명을 추가하는 과정을 간소화합니다. Node.js via Java 개발자는 애플리케이션에 서명 기능을 원활하게 통합할 수 있습니다.
      
      1. Signature 인스턴스에 PPTX 문서를 로드합니다.
