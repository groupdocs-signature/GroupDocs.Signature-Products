...
############################# Head ############################
head_title: "Firma XLSX con firme elettroniche in JavaScript"
head_description: "Sfrutta le capacità dell'API JavaScript per firmare digitalmente e proteggere i file XLSX, inclusi PDF, documenti Word, fogli Excel, presentazioni e formati immagine."

############################# Header ############################
title: "Firma file XLSX elettronicamente" 
...
steps:
    enable: true
    title: "Passaggi per firmare XLSX utilizzando JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) semplifica il processo di aggiunta di firme personalizzate a file XLSX. Gli sviluppatori Node.js via Java possono incorporare senza difficoltà la funzionalità di firma nelle loro applicazioni.
