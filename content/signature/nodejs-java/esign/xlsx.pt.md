...
############################# Head ############################
head_title: "Assine XLSX com assinaturas eletrônicas em JavaScript"
head_description: "Aproveite as capacidades da API JavaScript para assinar digitalmente e proteger arquivos XLSX, incluindo PDFs, documentos Word, planilhas Excel, apresentações e formatos de imagem."

############################# Header ############################
title: "Assine arquivos XLSX eletronicamente" 
...
steps:
    enable: true
    title: "Passos para assinar XLSX usando JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) facilita o processo de adição de assinaturas personalizadas a arquivos XLSX. Desenvolvedores Node.js via Java podem incorporar de forma fluida a funcionalidade de assinatura em suas aplicações.
