...
############################# Head ############################
head_title: "JavaScript で JPEG に電子署名を行う"
head_description: "JavaScript API の機能を活用して、PDF、Word 文書、Excel シート、プレゼンテーション、画像形式を含む JPEG ファイルにデジタル署名を付与し、保護します。"

############################# Header ############################
title: "電子的に JPEG ファイルに署名する" 
...
steps:
    enable: true
    title: "JavaScriptを使用して JPEG に署名する手順"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) は、JPEG ファイルにカスタマイズされた署名を追加するプロセスを簡素化します。Node.js via Java 開発者は、アプリケーションに署名機能をシームレスに組み込むことができます。
      
      1. Signature インスタンスに JPEG 文書をロードします。
