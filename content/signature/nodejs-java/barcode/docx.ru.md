...
############################# Head ############################
head_title: "Создание штрих-кода для DOCX с использованием приложений JavaScript"
head_description: "Быстро создавайте и встраивайте штрих-код в документ DOCX с помощью JavaScript, используя всего несколько строк кода. GroupDocs.Signature поддерживает подписание в нескольких форматах файлов."

############################# Header ############################
title: "Создавайте и добавляйте штрих-коды в DOCX с минимальными усилиями" 
...
steps:
    enable: true
    title: "Как создать и встроить штрих-коды в файл DOCX"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) позволяет генерировать и размещать штрих-коды в различных популярных форматах на страницах DOCX. С поддержкой более 60 типов штрих-кодов, приложения Node.js via Java могут быть легко улучшены с помощью функций подписания штрих-кодов, интегрируя нашу библиотеку.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Как применить подпись штрих-кодом"
      content: |
        Этот пример иллюстрирует, как встроить настроенный штрих-код на страницы документа DOCX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
