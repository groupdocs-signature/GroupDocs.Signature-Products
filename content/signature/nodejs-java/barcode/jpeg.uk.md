...
############################# Head ############################
head_title: "Генерація штрих-коду для JPEG за допомогою JavaScript додатків"
head_description: "Швидке генерування та вбудовування підпису штрих-коду в документ JPEG за допомогою JavaScript лише за кілька рядків коду. GroupDocs.Signature підтримує підписування в різних форматах файлів."

############################# Header ############################
title: "Генеруйте та додавайте штрих-коди в JPEG" 
...
steps:
    enable: true
    title: "Як згенерувати та вбудувати штрих-коди в файл JPEG"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) дозволяє генерувати та розміщувати штрих-коди в різних популярних форматах на сторінках JPEG. Підтримуючи понад 60 типів штрих-кодів, додатки Node.js via Java можуть бути легко розширені можливостями підпису штрих-кодів за допомогою інтеграції нашої бібліотеки.
      
      1. Надайте файл або потік JPEG для обробки.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Як застосувати підпис штрих-коду"
      content: |
        Цей приклад ілюструє, як вбудувати індивідуальний штрих-код на сторінки документа JPEG.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
