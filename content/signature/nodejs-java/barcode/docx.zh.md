...
############################# Head ############################
head_title: "使用 JavaScript 应用程序为 DOCX 生成条形码"
head_description: "仅需几行代码即可快速生成并嵌入条形码签名到 DOCX 文档中。GroupDocs.Signature 支持多种文件格式的签名。"

############################# Header ############################
title: "轻松生成并添加条形码到 DOCX" 
...
steps:
    enable: true
    title: "如何在 DOCX 文件中生成并嵌入条形码"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) 可以在 DOCX 页面上生成并放置条形码，支持超过 60 种条形码类型，Node.js via Java 应用程序可以通过集成我们的库轻松增强条形码签名功能。
