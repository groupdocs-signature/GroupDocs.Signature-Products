...
############################# Head ############################
head_title: "Generar código de barras para XLSX utilizando aplicaciones JavaScript"
head_description: "Genera rápidamente e incrusta una firma de código de barras en un documento XLSX con JavaScript usando solo unas pocas líneas de código. GroupDocs.Signature admite la firma en múltiples formatos de archivo."

############################# Header ############################
title: "Genera y añade códigos de barras en XLSX sin esfuerzo" 
...
steps:
    enable: true
    title: "Cómo generar e incrustar códigos de barras en archivos XLSX"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) permite la generación y colocación de códigos de barras en una variedad de formatos populares en páginas XLSX. Con soporte para más de 60 tipos de códigos de barras, las aplicaciones Node.js via Java se pueden mejorar fácilmente con funciones de firma de códigos de barras integrando nuestra biblioteca.
      
      1. Proporcionar el archivo XLSX o flujo para su procesamiento.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cómo aplicar una firma de código de barras"
      content: |
        Este ejemplo ilustra cómo incrustar un código de barras personalizado en las páginas del documento XLSX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
