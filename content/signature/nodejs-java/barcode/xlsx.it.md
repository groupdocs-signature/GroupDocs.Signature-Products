...
############################# Head ############################
head_title: "Genera codice a barre per XLSX utilizzando applicazioni JavaScript"
head_description: "Genera e integra rapidamente una firma codice a barre in un documento XLSX con JavaScript utilizzando solo poche righe di codice. GroupDocs.Signature supporta la firma su più formati di file."

############################# Header ############################
title: "Genera e aggiungi codici a barre in XLSX senza sforzo" 
...
steps:
    enable: true
    title: "Come generare e incorporare codici a barre in un file XLSX"
    content: |
      ...
      1. Fornisci il file o il flusso XLSX per l'elaborazione.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Come applicare una firma codice a barre"
      content: |
        Questo esempio illustra come incorporare un codice a barre personalizzato nelle pagine del documento XLSX.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
