...
############################# Head ############################
head_title: "JavaScript을(를) 이용한 DOCX 파일에서 전자 서명 검색"
...
steps:
    enable: true
    title: "JavaScript을(를) 이용한 DOCX에서 서명 검색 가이드"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/)은(는) DOCX 파일 내에서 디지털 서명을 찾기 위한 강력한 도구입니다. Node.js via Java 개발자는 저희 솔루션을 통해 손쉽게 애플리케이션 기능을 확장할 수 있습니다.
      
      1. DOCX 파일 경로를 지정하여 서명 검색을 시작합니다.
