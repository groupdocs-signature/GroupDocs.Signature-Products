...
############################# Head ############################
head_title: "Signatures search in DOCX files with JavaScript"
head_description: "Harness the power of the GroupDocs.Signature for Node.js via Java API to detect and search for electronic signatures across DOCX files, including PDFs, Word documents, Excel spreadsheets, Presentations, and Images."

############################# Header ############################
title: "Search signatures in DOCX documents" 
...
steps:
    enable: true
    title: "Guide to searching for signatures in DOCX using JavaScript"
    content: |
