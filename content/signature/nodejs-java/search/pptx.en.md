...
############################# Head ############################
head_title: "Signature Detection in PPTX Files with JavaScript"
head_description: "Harness the power of the GroupDocs.Signature for Node.js via Java API to detect and search for electronic signatures across PPTX files, including PDFs, Word documents, Excel spreadsheets, Presentations, and Images."

############################# Header ############################
title: "Locate Signatures in PPTX Documents Using GroupDocs.Signature" 
...
steps:
    enable: true
    title: "Guidelines for Searching for Signatures in PPTX using JavaScript"
    content: |
      ...
      1. Specify the path of the PPTX file for signature search.
