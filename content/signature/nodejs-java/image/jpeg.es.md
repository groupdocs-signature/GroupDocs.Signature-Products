...
############################# Head ############################
head_title: "Añadiendo firmas de imagen a archivos JPEG con JavaScript"
head_description: "Coloca la firma de imagen en archivos JPEG para Node.js utilizando unas pocas líneas de código. Utiliza la API de GroupDocs.Signature for Node.js via Java para agregar imágenes."

############################# Header ############################
title: "Firma archivos JPEG utilizando firmas de imagen" 
...
steps:
    enable: true
    title: "Guía para añadir imágenes en JPEG utilizando JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) permite a las aplicaciones Node.js via Java integrar firmas de imagen sin problemas en documentos JPEG. Mejora las capacidades de tu aplicación con nuestra biblioteca integral.
      
      1. Instancia Signature con el documento JPEG
