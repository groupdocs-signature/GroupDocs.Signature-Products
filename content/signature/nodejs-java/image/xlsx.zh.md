...
############################# Head ############################
head_title: "使用 JavaScript 向 XLSX 文件添加图像签名"
head_description: "在 Node.js 中使用几行代码在 XLSX 文件上放置图像签名。使用 GroupDocs.Signature for Node.js via Java API 添加图像。"
...
steps:
    enable: true
    title: "使用 JavaScript 在 XLSX 中添加图像的指南"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) 使 Node.js via Java 应用程序能够无缝地将图像签名集成到 XLSX 文档中。利用我们的全面库增强您的应用程序功能。
      
      1. 用 XLSX 文档实例化 Signature
