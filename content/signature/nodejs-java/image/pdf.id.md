...
############################# Head ############################
head_title: "Menambahkan Tanda Tangan Gambar ke file PDF dengan JavaScript"
head_description: "Tempatkan tanda tangan gambar pada file PDF untuk Node.js hanya dengan beberapa baris kode. Gunakan API GroupDocs.Signature for Node.js via Java untuk menambahkan gambar."

############################# Header ############################
title: "Tandai file PDF menggunakan tanda tangan gambar" 
...
steps:
    enable: true
    title: "Panduan untuk menambahkan gambar di PDF menggunakan JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) memberdayakan aplikasi Node.js via Java untuk secara seamless mengintegrasikan tanda tangan gambar ke dalam dokumen PDF. Tingkatkan kemampuan aplikasi Anda dengan perpustakaan komprehensif kami.
      
      1. Instantiate Signature dengan dokumen PDF
