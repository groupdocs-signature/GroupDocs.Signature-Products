...
############################# Head ############################
head_title: "Thêm chữ ký hình ảnh vào tệp XLSX bằng JavaScript"
head_description: "Đặt chữ ký hình ảnh trên tệp XLSX cho Node.js bằng một vài dòng mã. Sử dụng API GroupDocs.Signature for Node.js via Java để thêm hình ảnh."

############################# Header ############################
title: "Ký tệp XLSX bằng chữ ký hình ảnh" 
...
steps:
    enable: true
    title: "Hướng dẫn thêm hình ảnh vào XLSX bằng JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) giúp các ứng dụng Node.js via Java tích hợp chữ ký hình ảnh vào tài liệu XLSX một cách liền mạch. Nâng cao khả năng của ứng dụng bạn với thư viện toàn diện của chúng tôi.
      
      1. Khởi tạo Signature với tài liệu XLSX
