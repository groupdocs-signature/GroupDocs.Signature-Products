...
############################# Head ############################
head_title: "Añadiendo firmas de imagen a archivos XLSX con JavaScript"
head_description: "Coloca la firma de imagen en archivos XLSX para Node.js utilizando unas pocas líneas de código. Utiliza la API de GroupDocs.Signature for Node.js via Java para agregar imágenes."

############################# Header ############################
title: "Firma archivos XLSX utilizando firmas de imagen" 
...
steps:
    enable: true
    title: "Guía para añadir imágenes en XLSX utilizando JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) permite a las aplicaciones Node.js via Java integrar firmas de imagen sin problemas en documentos XLSX. Mejora las capacidades de tu aplicación con nuestra biblioteca integral.
      
      1. Instancia Signature con el documento XLSX
