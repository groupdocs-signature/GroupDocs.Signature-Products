...
############################# Head ############################
head_title: "Aggiungere firme con immagini a file XLSX con JavaScript"
head_description: "Inserisci una firma con immagine nel file XLSX per Node.js utilizzando poche righe di codice. Utilizza l'API GroupDocs.Signature for Node.js via Java per aggiungere immagini."

############################# Header ############################
title: "Firma file XLSX utilizzando firme con immagini" 
...
steps:
    enable: true
    title: "Guida all'aggiunta di immagini in XLSX utilizzando JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) consente alle applicazioni Node.js via Java di integrare senza soluzione di continuità firme con immagini in documenti XLSX. Migliora le capacità della tua applicazione con la nostra libreria completa.
      
      1. Instanzia Signature con il documento XLSX
