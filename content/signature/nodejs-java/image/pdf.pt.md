...
############################# Head ############################
head_title: "Adicionando assinaturas de imagem ao arquivo PDF com JavaScript"
head_description: "Coloque uma assinatura de imagem no arquivo PDF para Node.js usando algumas linhas de código. Utilize a API GroupDocs.Signature for Node.js via Java para adicionar imagens."

############################# Header ############################
title: "Assine arquivos PDF utilizando assinaturas de imagem" 
...
steps:
    enable: true
    title: "Guia para adicionar imagens em PDF usando JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) capacita aplicações Node.js via Java a integrar assinaturas de imagem em documentos PDF de forma fluida. Amplie as capacidades da sua aplicação com nossa biblioteca abrangente.
      
      1. Instancie Signature com o documento PDF
