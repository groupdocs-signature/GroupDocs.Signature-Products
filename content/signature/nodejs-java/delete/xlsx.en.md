...
############################# Head ############################
head_title: "Efficiently Erase Signatures from XLSX Files Using JavaScript"
head_description: "Elevate your JavaScript applications by integrating GroupDocs.Signature for Node.js via Java, a powerful tool designed to seamlessly remove embedded signatures from XLSX files."

############################# Header ############################
title: "Effortlessly Erase Signatures from XLSX with JavaScript" 
...
steps:
    enable: true
    title: "Guidelines for Removing Text Signatures from XLSX using JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) enables Node.js via Java developers to efficiently remove text signatures in XLSX files by following a series of simple steps.
      
      1. Provide the XLSX file path to an instance of the Signature class.
    ...
    code:
      ...
      content: |
        ...
        if(signatures.size() > 0)
        {
            ...
            const result = signature.delete('output.xlsx', textSignature);
  ...
  code_samples:
    ...
    - title: "Remove All QR-Code Signatures"
      content: |
        ...
        // Erase all QR-code signatures
        const result = await signature.delete('output.xlsx', signatureLib.SignatureType.QrCode);
