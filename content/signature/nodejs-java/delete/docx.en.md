...
############################# Head ############################
head_title: "Delete signatures from DOCX via JavaScript"
head_description: "Deletion of Digital, Barcode, Text, Image, Metadata signatures from signed DOCX documents can be performed easily using GroupDocs.Signature for Node.js via Java."

############################# Header ############################
title: "Remove signatures placed in DOCX effortlessly" 
...
steps:
    enable: true
    title: "Guidelines for removing digital signatures from DOCX using JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) enables Node.js via Java developers to efficiently remove e-signatures in DOCX files by following a series of simple steps.
