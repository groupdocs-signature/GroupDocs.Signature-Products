...
############################# Head ############################
head_title: "Efficiently Erase Signatures from JPEG Files Using JavaScript"
head_description: "Elevate your JavaScript applications by integrating GroupDocs.Signature for Node.js via Java, a powerful tool designed to seamlessly remove embedded signatures from JPEG files."

############################# Header ############################
title: "Effortlessly Erase Signatures from JPEG with JavaScript" 
...
steps:
    enable: true
    title: "Guidelines for Removing Text Signatures from JPEG using JavaScript"
    content: |
      [GroupDocs.Signature](/signature/nodejs-java/) enables Node.js via Java developers to efficiently remove text signatures in JPEG files by following a series of simple steps.
      
      1. Provide the JPEG file path to an instance of the Signature class.
    ...
    code:
      ...
      content: |
        ...
        if(signatures.size() > 0)
        {
            ...
            const result = signature.delete('output.jpeg', textSignature);
  ...
  code_samples:
    ...
    - title: "Remove All QR-Code Signatures"
      content: |
        ...
        // Erase all QR-code signatures
        const result = await signature.delete('output.jpeg', signatureLib.SignatureType.QrCode);
