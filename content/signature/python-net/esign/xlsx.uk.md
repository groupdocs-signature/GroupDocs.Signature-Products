...
############################# Head ############################
head_title: "Електронний підпис XLSX документи з додатками Python"
head_description: "Використовуйте можливості API Python для електронного підпису та захисту документів XLSX, таких як PDF, Word файли, Excel таблиці, презентації та зображення."

############################# Header ############################
title: "Електронний підпис XLSX" 
...
steps:
    enable: true
    title: "Кроки для електронного підпису XLSX за допомогою Python"
    content: |
      З [GroupDocs.Signature](/signature/python-net/) розробники Python via .NET можуть безперешкодно інтегрувати функціонал підпису в документи XLSX. Додавайте кастомізовані підписи у ваші програми.
      
      1. Завантажте файл XLSX у екземпляр Signature.
