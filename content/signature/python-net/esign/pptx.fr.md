...
############################# Head ############################
head_title: "Signer électroniquement des documents PPTX avec des applications Python"
head_description: "Exploitez la puissance de l'API Python pour signer électroniquement et sécuriser des documents PPTX tels que des fichiers PDF, Word, des feuilles Excel, des présentations et des images."

############################# Header ############################
title: "Signer électroniquement des PPTX" 
...
steps:
    enable: true
    title: "Étapes pour signer électroniquement des PPTX en utilisant Python"
    content: |
      Avec [GroupDocs.Signature](/signature/python-net/), les développeurs Python via .NET peuvent intégrer facilement la fonctionnalité de signature dans les documents PPTX. Ajoutez des signatures personnalisées à vos applications.
      
      1. Chargez le fichier PPTX dans l'instance Signature.
