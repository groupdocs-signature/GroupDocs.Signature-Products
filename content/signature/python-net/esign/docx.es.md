...
############################# Head ############################
head_title: "Firma electrónicamente documentos DOCX con aplicaciones Python"
head_description: "Aprovecha el poder de la API Python para firmar electrónicamente y asegurar documentos DOCX como PDFs, archivos de Word, hojas de Excel, presentaciones e imágenes."

############################# Header ############################
title: "Firma electrónica de DOCX" 
...
steps:
    enable: true
    title: "Pasos para firmar electrónicamente DOCX usando Python"
    content: |
      Con [GroupDocs.Signature](/signature/python-net/), los desarrolladores de Python via .NET pueden integrar sin problemas la funcionalidad de firma en documentos DOCX. Agrega firmas personalizadas a tus aplicaciones.
      
      1. Carga el archivo DOCX en la instancia de Signature.
