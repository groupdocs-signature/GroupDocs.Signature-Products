...
############################# Head ############################
head_title: "Menyematkan kode batang dalam PPTX dengan Python"
head_description: "Tambahkan tanda tangan kode batang dengan efisien ke dokumen PPTX hanya dengan beberapa baris di Python. GroupDocs.Signature memberikan solusi penandatanganan yang mulus untuk berbagai format dokumen."

############################# Header ############################
title: "Buat kode batang untuk PPTX" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk menghasilkan dan menyisipkan kode batang dalam PPTX"
    content: |
      [GroupDocs.Signature](/signature/python-net/) memungkinkan Anda untuk menghasilkan dan menyematkan kode batang dalam dokumen PPTX dengan cepat dan efisien. Mendukung lebih dari 60 format kode batang, aplikasi Python via .NET dapat menambahkan fungsi penandatanganan kode batang dengan mengintegrasikan pustaka kami.
      
      1. Sediakan file atau stream PPTX untuk pemrosesan.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Buat dan tempatkan tanda tangan kode batang"
      content: |
        Contoh ini menunjukkan bagaimana cara menyisipkan kode batang kustom ke dalam dokumen PPTX.
      code:
        title: "Python"
        content: |
          ```python {style=abap}
