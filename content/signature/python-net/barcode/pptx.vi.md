...
############################# Head ############################
head_title: "Nhúng mã vạch vào PPTX với Python"
head_description: "Thêm chữ ký mã vạch vào tài liệu PPTX một cách hiệu quả chỉ với vài dòng mã trong Python. GroupDocs.Signature cung cấp giải pháp ký kết liền mạch cho nhiều định dạng tài liệu."
...
steps:
    enable: true
    title: "Bước để tạo và nhúng mã vạch vào PPTX"
    content: |
      [GroupDocs.Signature](/signature/python-net/) cho phép bạn nhanh chóng và hiệu quả tạo và nhúng mã vạch vào tài liệu PPTX. Hỗ trợ hơn 60 định dạng mã vạch, các ứng dụng Python via .NET có thể dễ dàng thêm chức năng ký mã vạch bằng cách tích hợp thư viện của chúng tôi.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Tạo và đặt chữ ký mã vạch"
      content: |
        Ví dụ này minh họa cách chèn một mã vạch tùy chỉnh vào tài liệu PPTX.
      code:
        title: "Python"
        content: |
          ```python {style=abap}
