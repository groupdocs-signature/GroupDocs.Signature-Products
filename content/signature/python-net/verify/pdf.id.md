...
############################# Head ############################
head_title: "Verifikasi tanda tangan digital PDF dengan Python"
head_description: "Manfaatkan GroupDocs.Signature for Python via .NET untuk memverifikasi tanda tangan dalam file PDF. Pastikan keaslian tanda tangan dalam PDF, Word, Excel, Presentasi, Gambar, dan file ZIP."
...
steps:
    enable: true
    title: "Cara memverifikasi tanda tangan PDF menggunakan Python"
    content: |
      [GroupDocs.Signature](/signature/python-net/) memverifikasi tanda tangan tertentu dalam dokumen PDF. Pengembang Python via .NET dapat meningkatkan aplikasi mereka dengan mengintegrasikan fitur verifikasi ini.
      
      1. Muat file PDF ke dalam instance Signature.
