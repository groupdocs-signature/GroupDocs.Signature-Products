...
############################# Head ############################
head_title: "Python アプリケーションで PPTX サインを編集"
head_description: "Python APIを使用して、PDF、Wordファイル、Excelシート、プレゼンテーション、画像を含むPPTX ドキュメント内のサインを変更します。"

############################# Header ############################
title: "PPTX サインを簡単に更新" 
...
steps:
    enable: true
    title: "Python を使用して PPTX のサインを編集する方法"
    content: |
      [GroupDocs.Signature](/signature/python-net/) は、Python via .NET 開発者が PPTX ファイルに既に埋め込まれたテキストサインを編集することを可能にします。Python via .NET アプリケーションに高度な機能を追加します。
      
      1. Signature インスタンスに PPTX ドキュメントをロードします。
