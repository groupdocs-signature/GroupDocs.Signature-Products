...
############################# Head ############################
head_title: "Adicione assinaturas de texto a PPTX usando Python"
head_description: "Utilize a API Python para incorporar assinaturas baseadas em texto em arquivos PPTX, suportando formatos como PDF, Word, Excel, PowerPoint, imagens e ZIP."
...
steps:
    enable: true
    title: "Como criar assinaturas de texto em PPTX com Python"
    content: |
      [GroupDocs.Signature](/signature/python-net/) possibilita a integração de assinaturas de texto em arquivos PPTX dentro de aplicativos Python via .NET. Adicione rapidamente funcionalidades aos seus produtos com esta solução.
      
      1. Forneça o documento PPTX ao construtor Signature.
