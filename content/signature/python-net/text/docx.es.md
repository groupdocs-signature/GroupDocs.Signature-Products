...
############################# Head ############################
head_title: "Añadir firmas de texto a DOCX usando Python"
head_description: "Aprovecha la API de Python para incrustar firmas basadas en texto en archivos DOCX, soportando formatos como PDF, Word, Excel, PowerPoint, imágenes y ZIP."

############################# Header ############################
title: "Añadir firmas de texto a DOCX" 
...
steps:
    enable: true
    title: "Cómo crear firmas de texto en DOCX con Python"
    content: |
      [GroupDocs.Signature](/signature/python-net/) permite una fácil integración de firma de texto en archivos DOCX dentro de aplicaciones Python via .NET. Añade rápidamente funcionalidad a tus productos con esta solución.
      
      1. Proporciona el documento DOCX al constructor de Signature.
