...
############################# Head ############################
head_title: "Remova assinaturas de XLSX usando Python"
head_description: "Remova digitalmente, códigos de barras, texto, imagens e assinaturas de metadados de documentos XLSX com GroupDocs.Signature for Python via .NET."

############################# Header ############################
title: "Remova assinaturas de XLSX" 
...
steps:
    enable: true
    title: "Passos para remover assinaturas eletrônicas de XLSX usando Python"
    content: |
      [GroupDocs.Signature](/signature/python-net/) permite que desenvolvedores Python via .NET removam assinaturas eletrônicas de arquivos XLSX seguindo estes passos simples:
      
      1. Carregue o documento XLSX na instância da classe Signature.
