...
############################# Head ############################
head_title: "Eliminar firmas de PDF usando Python"
head_description: "Elimina sin esfuerzo firmas digitales, de código de barras, texto, imagen y metadatos de documentos PDF con GroupDocs.Signature for Python via .NET."
...
steps:
    enable: true
    title: "Pasos para eliminar firmas electrónicas de PDF usando Python"
    content: |
      [GroupDocs.Signature](/signature/python-net/) permite a los desarrolladores de Python via .NET eliminar firmas electrónicas de archivos PDF siguiendo estos simples pasos:
      
      1. Carga el documento PDF en la instancia de la clase Signature.
