...
############################# Head ############################
head_title: "Elektronische Signaturen suchen in DOCX mit Python"
...
steps:
    enable: true
    title: "So suchen Sie nach Signaturen in DOCX mit Python"
    content: |
      [GroupDocs.Signature](/signature/python-net/) bietet eine leistungsstarke Engine zum Erkennen digitaler Signaturen in DOCX-Dateien. Python via .NET-Entwickler können ihre Apps problemlos um diese Funktionalität erweitern.
      
      1. Geben Sie den Dateipfad der DOCX Datei für die Signatursuche an.
