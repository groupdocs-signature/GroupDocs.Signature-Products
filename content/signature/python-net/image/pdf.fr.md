...
############################# Head ############################
head_title: "Insérez des signatures d'image dans des fichiers PDF avec Python"
head_description: "Intégrez des signatures d'image dans des documents PDF pour Python en utilisant seulement quelques lignes de code. Utilisez l'API GroupDocs.Signature for Python via .NET pour ajouter sans effort des signatures basées sur des images."

############################# Header ############################
title: "Ajoutez des signatures d'image à PDF" 
...
steps:
    enable: true
    title: "Comment insérer une signature d'image dans un fichier PDF en utilisant Python"
    content: |
      Utilisez [GroupDocs.Signature](/signature/python-net/) pour donner aux applications Python via .NET la capacité d'ajouter avec précision des signatures d'image n'importe où dans des documents PDF. Améliorez facilement votre produit en intégrant notre solution.
      
      1. Créez une instance de Signature avec le document PDF.
