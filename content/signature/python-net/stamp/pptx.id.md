...
############################# Head ############################
head_title: "Buat cap bulat dan persegi dalam PPTX menggunakan Python"
head_description: "Hasilkan dan masukkan cap yang dipersonalisasi ke dalam file PPTX menggunakan API GroupDocs.Signature for Python via .NET."

############################# Header ############################
title: "Buat cap untuk PPTX" 
...
steps:
    enable: true
    title: "Cara menambahkan cap ke PPTX menggunakan Python"
    content: |
      ...
      1. Berikan dokumen PPTX yang ingin Anda cap.
