...
############################# Head ############################
head_title: "Erstellen Sie runde und quadratische Stempel in PDF mit Python"
head_description: "Generieren und fügen Sie personalisierte Stempel in PDF-Dateien mit der GroupDocs.Signature for Python via .NET-API ein."

############################# Header ############################
title: "Stempel für PDF erstellen" 
...
steps:
    enable: true
    title: "So fügen Sie einen Stempel zu PDF mit Python hinzu"
    content: |
      ...
      1. Stellen Sie das PDF-Dokument bereit, das Sie stempeln möchten.
