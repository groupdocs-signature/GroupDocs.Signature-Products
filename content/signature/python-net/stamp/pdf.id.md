...
############################# Head ############################
head_title: "Buat cap bulat dan persegi dalam PDF menggunakan Python"
head_description: "Hasilkan dan masukkan cap yang dipersonalisasi ke dalam file PDF menggunakan API GroupDocs.Signature for Python via .NET."

############################# Header ############################
title: "Buat cap untuk PDF" 
...
steps:
    enable: true
    title: "Cara menambahkan cap ke PDF menggunakan Python"
    content: |
      ...
      1. Berikan dokumen PDF yang ingin Anda cap.
