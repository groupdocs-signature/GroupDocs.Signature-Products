...
############################# Head ############################
head_title: "Crea sellos redondos y cuadrados en DOCX usando Python"
head_description: "Genera e inserta sellos personalizados en archivos DOCX con la API GroupDocs.Signature for Python via .NET."

############################# Header ############################
title: "Crea sellos para DOCX" 
...
steps:
    enable: true
    title: "Cómo agregar un sello a DOCX usando Python"
    content: |
      ...
      1. Proporciona el documento DOCX que deseas sellar.
