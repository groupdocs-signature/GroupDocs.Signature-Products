...
############################# Head ############################
head_title: "Tạo dấu tròn và vuông trong DOCX bằng Python"
head_description: "Tạo và chèn các dấu cá nhân hóa vào tệp DOCX với API GroupDocs.Signature for Python via .NET."

############################# Header ############################
title: "Tạo dấu cho DOCX" 
...
steps:
    enable: true
    title: "Cách thêm một dấu vào DOCX bằng Python"
    content: |
      ...
      1. Cung cấp tài liệu DOCX mà bạn muốn đóng dấu.
