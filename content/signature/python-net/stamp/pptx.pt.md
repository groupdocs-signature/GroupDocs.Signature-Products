...
############################# Head ############################
head_title: "Crie selos redondos e quadrados em PPTX usando Python"
head_description: "Gere e insira selos personalizados em arquivos PPTX com a API GroupDocs.Signature for Python via .NET."

############################# Header ############################
title: "Crie selos para PPTX" 
...
steps:
    enable: true
    title: "Como adicionar um selo a PPTX usando Python"
    content: |
      ...
      1. Forneça o documento PPTX que deseja selar.
