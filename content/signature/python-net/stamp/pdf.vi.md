...
############################# Head ############################
head_title: "Tạo dấu tròn và vuông trong PDF bằng Python"
head_description: "Tạo và chèn các dấu cá nhân hóa vào tệp PDF với API GroupDocs.Signature for Python via .NET."

############################# Header ############################
title: "Tạo dấu cho PDF" 
...
steps:
    enable: true
    title: "Cách thêm một dấu vào PDF bằng Python"
    content: |
      ...
      1. Cung cấp tài liệu PDF mà bạn muốn đóng dấu.
