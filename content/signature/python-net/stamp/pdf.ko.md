...
############################# Head ############################
head_title: "Python를 사용하여 PDF에서 원형 및 사각 스탬프 만들기"
head_description: "GroupDocs.Signature for Python via .NET API를 사용하여 PDF 파일에 개인화된 스탬프를 생성하고 삽입하세요."
...
steps:
    enable: true
    title: "Python를 사용하여 PDF에 스탬프 추가하기"
    content: |
