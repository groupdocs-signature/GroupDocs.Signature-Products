...
############################# Head ############################
head_title: "Создайте цифровые подписи для PDF с использованием Python"
head_description: "Цифровая подпись документов PDF с использованием Python всего за несколько строк кода. Используйте GroupDocs.Signature for Python via .NET для подписи широкого спектра форматов файлов."

############################# Header ############################
title: "Цифровая подпись PDF" 
...
steps:
    enable: true
    title: "Как защитить PDF с цифровыми сертификатами в Python"
    content: |
      [GroupDocs.Signature](/signature/python-net/) помогает разработчикам Python via .NET защищать файлы PDF, добавляя цифровые подписи. Укрепите свои бизнес-приложения с помощью надежных функций защиты документов.
      
      1. Загрузите файл PDF в класс Signature.
