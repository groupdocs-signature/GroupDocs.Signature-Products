...
############################# Head ############################
head_title: "Genera codici QR per file PPTX utilizzando Python"
head_description: "Utilizza l'API GroupDocs.Signature per generare e incorporare codici QR nei file PPTX. Posiziona facilmente i codici QR su qualsiasi pagina per aggiungere funzionalità extra."
...
steps:
    enable: true
    title: "Passaggi per generare e inserire un codice QR in PPTX"
    content: |
      [GroupDocs.Signature](/signature/python-net/) ti consente di creare codici QR in formati popolari e posizionarli sulle pagine di PPTX. Con supporto per oltre 10 tipi di codici QR, puoi integrare senza soluzione di continuità questa funzionalità nelle applicazioni Python via .NET. Arricchisci i tuoi documenti con firme di codici QR utilizzando il nostro prodotto.
      
      1. Ottieni il file o lo stream PPTX in cui verrà aggiunto il codice QR.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Personalizza un codice QR generato"
      content: |
        Questo esempio mostra come posizionare un codice QR personalizzato su una pagina PPTX.
      code:
        title: "Python"
        content: |
          ```python {style=abap}
