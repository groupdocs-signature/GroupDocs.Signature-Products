...
############################# Head ############################
head_title: "Tạo mã QR cho các tệp JPEG bằng Python"
head_description: "Sử dụng API GroupDocs.Signature để tạo và nhúng mã QR vào các tệp JPEG. Đặt mã QR trên bất kỳ trang nào để thêm chức năng bổ sung."
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Tùy chỉnh Một Mã QR Được Tạo"
      content: |
        Ví dụ này cho thấy cách đặt một mã QR tùy chỉnh trên một trang JPEG.
      code:
        title: "Python"
        content: |
          ```python {style=abap}
