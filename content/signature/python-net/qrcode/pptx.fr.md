...
############################# Head ############################
head_title: "Générez des codes QR pour des fichiers PPTX en utilisant Python"
head_description: "Utilisez l'API GroupDocs.Signature pour générer et intégrer des codes QR dans des fichiers PPTX. Placez facilement des codes QR sur n'importe quelle page pour ajouter des fonctionnalités supplémentaires."
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Personnalisez un code QR généré"
      content: |
        Cet exemple montre comment placer un code QR personnalisé sur une page PPTX.
      code:
        title: "Python"
        content: |
          ```python {style=abap}
