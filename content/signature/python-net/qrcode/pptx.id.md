...
############################# Head ############################
head_title: "Hasilkan kode QR untuk file PPTX menggunakan Python"
head_description: "Gunakan API GroupDocs.Signature untuk menghasilkan dan menyematkan kode QR dalam file PPTX. Tempatkan kode QR di halaman mana pun untuk menambahkan fungsionalitas tambahan."
...
steps:
    enable: true
    title: "Langkah-langkah untuk menghasilkan dan menyisipkan kode QR di PPTX"
    content: |
      [GroupDocs.Signature](/signature/python-net/) memungkinkan Anda membuat kode QR dalam format populer dan menempatkannya di halaman PPTX. Dengan dukungan lebih dari 10 jenis kode QR, Anda dapat mengintegrasikan fungsionalitas ini ke dalam aplikasi Python via .NET. Tingkatkan dokumen Anda dengan tanda tangan kode QR menggunakan produk kami.
      
      1. Dapatkan file atau stream PPTX tempat kode QR akan ditambahkan.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Sesuaikan Kode QR yang Dihasilkan"
      content: |
        Contoh ini menunjukkan cara menempatkan kode QR yang disesuaikan di halaman PPTX.
      code:
        title: "Python"
        content: |
          ```python {style=abap}
